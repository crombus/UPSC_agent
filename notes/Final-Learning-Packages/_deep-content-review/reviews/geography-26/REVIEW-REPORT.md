# Deep Content Review — Geography 26: World Population and Demographic Transition

- **Command-start baseline locked:** `geography-26:learner-v2:g4` — 94/100
- **Final immutable successor:** `geography-26:learner-v2:g5` — 98/100
...
- `geography-26:learner-v2:g4` — command_start_baseline; approval false
- `geography-26:learner-v2:g5` — final_passed; approval false
