...
```closure-flow
SUBTOPIC: Political-party core idea
KEY TERMS / DEFINITIONS: association · aggregation · representation · government · opposition · accountability
MECHANISM / ARGUMENT: preferences -> programmes and candidates -> public power -> electoral and legislative accountability
UPSC TRAP / ANSWER-USE: public importance does not make a party a constitutional organ or extinguish Article 19(1)(c).
ANSWER-GRABBING FORMULATION: Regulate the party's public consequences while preserving its legitimate associational core.
```
...
**Plain-language definition:** Democratic functions and the missing comprehensive party code denotes the constitutional rules and institutional links organised around Political parties link citizens to government through representation, interest aggregation, candidate recruitment and legislative coordination.
