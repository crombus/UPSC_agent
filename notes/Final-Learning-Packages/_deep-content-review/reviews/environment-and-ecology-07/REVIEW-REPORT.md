# Deep Content Review — Environment and Ecology 07: Biosphere Reserves and Ramsar Sites

- **Command-start baseline locked:** `environment-and-ecology-07:learner-v2:g1` — 94/100
- **Final immutable successor:** `environment-and-ecology-07:learner-v2:g3` — 98/100
...
- `environment-and-ecology-07:learner-v2:g1` — command_start_baseline; approval false
- `environment-and-ecology-07:learner-v2:g2` — unpublished_intermediate_preserved; approval false
- `environment-and-ecology-07:learner-v2:g3` — final_passed; approval false
