# Deep Content Review — Environment and Ecology 09: CITES and Wildlife Trade

- **Command-start baseline locked:** `environment-and-ecology-09:learner-v2:g2` — 92/100
- **Final immutable successor:** `environment-and-ecology-09:learner-v2:g4` — 98/100
...
The successor adds topic-specific formulas, stock-flow classes, institutions, transmission chains,
data vintages, programme status and causal controls. Every detected solved answer has demand
...
- `environment-and-ecology-09:learner-v2:g2` — command_start_baseline; approval false
- `environment-and-ecology-09:learner-v2:g3` — failed_intermediate_preserved; approval false
- `environment-and-ecology-09:learner-v2:g4` — final_passed; approval false
