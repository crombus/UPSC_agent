# Essay deep review — essay-04

- Purpose: **Brainstorming and Dimensional Expansion**
- Baseline: `essay-04:learner-v2:g3`
- Immutable successor: `essay-04:learner-v2:g4`
- Contract: `essay-specific-guide-v2`
- Primary artifacts: indexed knowledge guide; question-only practice workbook; separate indexed solutions.
- Integrated aids: workflow-atlas PNG and matching ASCII workflow inside the guide; these are not forced into GS graphical/ASCII master folders.
