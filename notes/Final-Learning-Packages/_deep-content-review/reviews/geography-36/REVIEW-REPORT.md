# Deep Content Review — Geography 36: Contemporary Geographical Issues (India)

- **Command-start baseline locked:** `geography-36:learner-v2:g2` — 94/100
- **Final immutable successor:** `geography-36:learner-v2:g4` — 98/100
...
- `geography-36:learner-v2:g2` — command_start_baseline; approval false
- `geography-36:learner-v2:g3` — unpublished_intermediate_preserved; approval false
- `geography-36:learner-v2:g4` — final_passed; approval false
