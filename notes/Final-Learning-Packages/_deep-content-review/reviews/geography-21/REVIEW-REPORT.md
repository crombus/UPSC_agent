# Deep Content Review — Geography 21: Warm Temperate Eastern Margin China Type

- **Command-start baseline locked:** `geography-21:learner-v2:g3` — 94/100
- **Final immutable successor:** `geography-21:learner-v2:g4` — 98/100
...
- `geography-21:learner-v2:g3` — command_start_baseline; approval false
- `geography-21:learner-v2:g4` — final_passed; approval false
