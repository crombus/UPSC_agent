# Deep Content Review — Geography 22: Cool Temperate Western Margin British Type

- **Command-start baseline locked:** `geography-22:learner-v2:g3` — 94/100
- **Final immutable successor:** `geography-22:learner-v2:g4` — 98/100
...
- `geography-22:learner-v2:g3` — command_start_baseline; approval false
- `geography-22:learner-v2:g4` — final_passed; approval false
