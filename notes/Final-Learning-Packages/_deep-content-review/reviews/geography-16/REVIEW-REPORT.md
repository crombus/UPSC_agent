# Deep Content Review — Geography 16: Tropical Monsoon and Marine Climate

- **Command-start baseline locked:** `geography-16:learner-v2:g2` — 94/100
- **Final immutable successor:** `geography-16:learner-v2:g3` — 98/100
...
- `geography-16:learner-v2:g2` — command_start_baseline; approval false
- `geography-16:learner-v2:g3` — final_passed; approval false
