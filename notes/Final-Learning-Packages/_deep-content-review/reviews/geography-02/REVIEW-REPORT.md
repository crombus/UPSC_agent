# Deep Content Review — Geography 02: The Earth's Crust, Rocks / India Geological Structure

- **Command-start baseline locked:** `geography-02:learner-v2:g12` — 88/100
- **Final immutable successor:** `geography-02:learner-v2:g13` — 98/100
...
- Visual-first Core progression is incomplete: sessions=29, visual gateways=0.
...
- `geography-02:learner-v2:g12` — command_start_baseline; approval false
- `geography-02:learner-v2:g13` — final_passed; approval false
