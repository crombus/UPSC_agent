# Deep Content Review — Geography 27: Migration Theories and Patterns (India)

- **Command-start baseline locked:** `geography-27:learner-v2:g4` — 94/100
- **Final immutable successor:** `geography-27:learner-v2:g5` — 98/100
...
- `geography-27:learner-v2:g4` — command_start_baseline; approval false
- `geography-27:learner-v2:g5` — final_passed; approval false
