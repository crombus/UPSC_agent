# Deep Content Review — Geography 14: Climate Classification (Koppen) / India Climatic Regions

- **Command-start baseline locked:** `geography-14:learner-v2:g2` — 94/100
- **Final immutable successor:** `geography-14:learner-v2:g3` — 98/100
...
- `geography-14:learner-v2:g2` — command_start_baseline; approval false
- `geography-14:learner-v2:g3` — final_passed; approval false
