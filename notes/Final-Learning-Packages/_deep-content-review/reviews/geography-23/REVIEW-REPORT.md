# Deep Content Review — Geography 23: Cool Temperate Continental Siberian

- **Command-start baseline locked:** `geography-23:learner-v2:g3` — 94/100
- **Final immutable successor:** `geography-23:learner-v2:g4` — 98/100
...
- `geography-23:learner-v2:g3` — command_start_baseline; approval false
- `geography-23:learner-v2:g4` — final_passed; approval false
