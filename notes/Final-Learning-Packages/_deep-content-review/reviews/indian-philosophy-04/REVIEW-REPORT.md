# Deep Content Review — Nyaya–Vaisesika

## Identity

- Locked baseline: `philosophy-paper-i-indian-philosophy-04:learner-v2:g13`
- Repaired immutable successor: `philosophy-paper-i-indian-philosophy-04:learner-v2:g14`
...
- Baseline: graphical concise labels used truncation ellipses.
...
Pages: session 84; workbook 33. MCQs: 48. Answer-improvement blocks: 28.

## Evidence

- Official syllabus: `upsc-ai-kit\knowledge\Philosophy\OFFICIAL-UPSC-SYLLABUS-VERBATIM.md`
- Canonical owner: `upsc-ai-kit\knowledge\Philosophy\paper-1\indian\Nyaya-Vaisesika.md`
