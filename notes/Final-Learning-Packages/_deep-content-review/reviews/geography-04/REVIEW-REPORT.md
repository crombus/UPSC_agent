# Deep Content Review — Geography 04: Weathering, Mass Movement, Groundwater / India Erosion-Landslides-Groundwater

- **Command-start baseline locked:** `geography-04:learner-v2:g9` — 88/100
- **Final immutable successor:** `geography-04:learner-v2:g10` — 98/100
...
- Visual-first Core progression is incomplete: sessions=20, visual gateways=0.
...
- `geography-04:learner-v2:g9` — command_start_baseline; approval false
- `geography-04:learner-v2:g10` — final_passed; approval false
