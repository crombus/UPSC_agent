...
### SESSION 25 — SUPREME COURT AND CURRENT-LAW CONTROLS
...
### SESSION 26 — INDEPENDENCE AND ACCOUNTABILITY ASSESSMENT
...
### SESSION 27 — CRITIQUES, REPLIES AND REFORM PROPOSALS
...
### SESSION 28 — UPSC ANSWER ARCHITECTURE
...
### SESSION 29 — CURRENT-CONTROL AND SOURCE LEDGER
...
B. It is a constitutional court for corruption offences.  
C. It is the investigative division of the CVC.  
D. It is an executive body created only by a government resolution.
...
A. Absence of a recognised LoP automatically substitutes the Home Minister.  
...
D. The Search Committee becomes the appointing authority.
...
A. Six years or age 65, whichever earlier.  
B. Five years without age ceiling.  
...
B. The Chairperson may immediately contest for Parliament.  
C. A former Member may accept any Union office of profit.  
...
A. Policy disagreement with the Government.  
B. Being adjudged insolvent.  
C. Dissenting from another Member.  
D. Receiving an adverse media report.
...
B. It must be published after thirty days.  
C. Only the complainant may publish it.  
...
B. Every parliamentary speech may be investigated as corruption.  
C. MPs are completely outside Lokpal jurisdiction.  
...
A. Every category is sent directly to the Special Court.  
...
D. Departments conduct the final criminal trial.
...
B. Are covered only if re-employed.  
C. Are covered for every private act in their lifetime.  
...
A. Within three months in every case.  
B. Within six months with no extension.  
...
B. More than seven years after retirement only.  
C. More than three years after discovery.  
...
A. Prescribes one national composition for all Lokayuktas.  
...
D. Abolishes pre-existing State Lokayukta laws.
...
A. Both wings were fully staffed from 2014 by operation of the Act alone.  
B. Inquiry Wing conducts all criminal trials.  
...
A. Parliament directly fixes every State Lokayukta’s jurisdiction.  
B. State legislation determines the actual Lokayukta design within each State.  
C. The Lokpal Chairperson appoints all State Lokayuktas.  
...
A. CVC is subordinate to Lokpal for every function.  
...
D. CVC conducts the Special Court trial.
...
A. The Supreme Court finally upheld it.  
B. Parliament expressly amended section 14 to include them.  
...
A. The 2016 amendment eliminated the legal duty itself.  
...
C. *Lok Prahari* automatically restored the original section 44 form.  
...
A. Every removal requires one hundred MPs.  
B. Every removal requires only a presidential order.  
C. Lokpal itself finally removes a Member.  
...
B. Lokpal has no role after receiving a complaint.  
C. Every complaint automatically proves misconduct.  
D. Departmental action and criminal conviction are identical.
...
C. The complainant becomes the prosecutor.  
D. The agency may impose sentence.
...
B. Only Union Ministries can ever be covered.  
...
D. Foreign contribution is irrelevant to jurisdiction.
...
A. Lokpal convicts, CBI appeals, CVC pardons.  
B. CVC appoints Lokpal and Lokpal appoints judges.  
C. CBI controls every Lokpal bench.  
