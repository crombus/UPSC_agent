# Deep Content Review — Geography 29: Regional Development and Five Year Plans

- **Command-start baseline locked:** `geography-29:learner-v2:g4` — 94/100
- **Final immutable successor:** `geography-29:learner-v2:g5` — 98/100
...
- `geography-29:learner-v2:g4` — command_start_baseline; approval false
- `geography-29:learner-v2:g5` — final_passed; approval false
