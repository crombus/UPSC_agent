# Deep Content Review — Geography 24: Cool Temperate Eastern Margin Laurentian

- **Command-start baseline locked:** `geography-24:learner-v2:g3` — 94/100
- **Final immutable successor:** `geography-24:learner-v2:g4` — 98/100
...
- `geography-24:learner-v2:g3` — command_start_baseline; approval false
- `geography-24:learner-v2:g4` — final_passed; approval false
