# Deep Content Review — Geography 03: Vulcanism and Earthquakes / India Seismic Zones

- **Command-start baseline locked:** `geography-03:learner-v2:g8` — 88/100
- **Final immutable successor:** `geography-03:learner-v2:g9` — 98/100
...
- Visual-first Core progression is incomplete: sessions=19, visual gateways=0.
...
- `geography-03:learner-v2:g8` — command_start_baseline; approval false
- `geography-03:learner-v2:g9` — final_passed; approval false
