---
title: "NCRWC and Working of the Constitution — Learner-v2 Deep Reviewed"
topic_key: polity-52
---
...
### SESSION 10 — ANSWER ARCHITECTURE (10/15/20-MARK SUPPORT)
...
### SESSION 12 — UPSC TRAPS AND SOURCE DISCIPLINE
...
- B. A constituent body elected under Article 368.
- C. A permanent constitutional commission created by the 42nd Amendment.
- D. A parliamentary joint committee with power to amend the Constitution.
...
- A. The secretary was counted as a twelfth member.
- B. All members were serving Supreme Court judges.
- C. The Commission had only representatives of political parties.
...
- C. To adjudicate constitutional disputes between Union and States.
- D. To codify only election law.
...
- B. The NCRWC ratified the Constitution drafted by Parliament.
- C. The Assembly framed the Constitution; the NCRWC later offered non-binding reforms on its working.
- D. The Assembly was an executive advisory body.
...
- A. Binding force equal to a Supreme Court judgment.
- B. Constituent force superior to Article 368.
- C. Automatic statutory force after publication.
...
- A. Delete every duty because it is non-justiciable.
...
- D. Transfer all duties to Part III as absolute rights.
...
- A. A constitutional right to preventive detention without review.
...
- D. Abolition of access to courts.
...
- A. Delete property protection entirely.
- B. Restore an unrestricted Fundamental Right to property in its pre-1978 form.
- C. Permit deprivation by executive instruction without law.
...
- A. One member.
- B. Half of all State legislatures.
- C. Two-thirds of the Council of States.
...
- B. 15 per cent of both Houses combined.
- C. 20 per cent of the electorate.
...
- A. Restore the deleted one-third split exception.
- B. Give party presidents final judicial power.
- C. Defectors should resign and recontest, with disqualification questions decided by the Election Commission.
- D. Abolish every vote of conscience including issues outside confidence and money matters.
...
- A. Constitutionally require whips on every amendment and private member's bill.
- B. Give courts power to issue party whips.
- C. Prohibit parties from communicating voting positions.
...
- B. Only the Chief Election Commissioner.
- C. All Chief Ministers through the Inter-State Council.
- D. The Supreme Court collegium alone.
...
- C. Only recognised national parties should be permitted.
- D. Party registration under Section 29A should be abolished without replacement.
...
- A. It is the institution currently making appointments.
- B. It was created by the 99th Amendment before the NCRWC existed.
...
- A. Prime Minister and all Chief Ministers only.
- B. CJI and Attorney General only.
- C. President acting alone without consultation.
...
- B. 62 for both courts.
- C. 68 for High Courts and 65 for the Supreme Court.
- D. 70 for every constitutional office.
...
- A. Governors should be directly elected nationwide.
- B. The Chief Minister should be consulted before gubernatorial appointment.
- C. Governors should hold office without constitutional removal.
...
- B. Exact constitutional adoption of a Concurrent List transfer.
- C. Judicial invalidation of the NCRWC.
- D. A constitutional amendment to Article 368.
...
- A. Conclusive proof that all NCRWC rights proposals were enacted.
- B. A later reform requiring text-and-timing comparison, not automatic attribution from chronology.
- C. A repeal of the Commission's report.
- D. An executive action requiring no constitutional amendment.
...
- B. Judicial enforcement of the report.
- C. Constitutional convention created by the Commission.
...
- D. The age of the Constitution alone.
...
- A. Only the number of government bills passed.
- B. Only the size of the ruling majority.
- C. Only the length of the constitutional text.
...
- B. Uniformity of every State policy.
- C. Abolition of intergovernmental negotiation.
...
- A. Personal moral preferences of office-holders.
...
- D. Automatic obedience to every political majority.
...
- A. A power for the Commission to amend the Constitution.
- B. A rule that no constitutional provision can ever change.
- C. A substantive limit on permissible amendment, not a ban on every institutional reform.
- D. A doctrine applicable only to ordinary statutes.
...
- A. It created the NCRWC.
- B. It enacted the Commission's election proposals.
- C. It abolished Article 368.
...
- B. Treat DPSPs as automatically superior to every Fundamental Right.
- C. Treat Fundamental Rights as barring all welfare legislation.
- D. Use NCRWC recommendations to suspend both.
...
- A. Immediate replacement of parliamentary democracy.
- B. A constitutional amendment regardless of the legal text.
- C. Rules, staffing, technology, process and accountability repair.
- D. A referendum outside the constitutional scheme.
...
- A. Does the proposal sound desirable in the abstract?
- B. Was it printed in a commission report?
...
- C. Every recommendation violated basic structure.
- D. The report concerned only judicial appointments.
...
- A. Its recommendations automatically override statutes.
...
- D. Every proposal has already been adopted exactly.
...
- A. A second Constituent Assembly whose whole report is binding.
- B. An obsolete document because not every proposal was enacted.
