# Deep Content Review — Ethics 05: Emotional Intelligence in Administration

- **Command-start baseline locked:** `ethics-05:learner-v2:g1` — 92/100
- **Final immutable successor:** `ethics-05:learner-v2:g4` — 98/100
...
- `ethics-05:learner-v2:g1` — command_start_baseline; approval false
- `ethics-05:learner-v2:g2` — unpublished_intermediate_preserved; approval false
- `ethics-05:learner-v2:g3` — unpublished_intermediate_preserved; approval false
- `ethics-05:learner-v2:g4` — final_passed; approval false
