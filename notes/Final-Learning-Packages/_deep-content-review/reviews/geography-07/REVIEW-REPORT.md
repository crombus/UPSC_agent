# Deep Content Review — Geography 07: Arid Desert Landforms / Thar Desertification

- **Command-start baseline locked:** `geography-07:learner-v2:g3` — 94/100
- **Final immutable successor:** `geography-07:learner-v2:g4` — 98/100
...
- `geography-07:learner-v2:g3` — command_start_baseline; approval false
- `geography-07:learner-v2:g4` — final_passed; approval false
