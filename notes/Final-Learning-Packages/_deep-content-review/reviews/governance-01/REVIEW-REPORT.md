# Deep Content Review — Governance 01: Good Governance: Concepts and Frameworks

- **Command-start baseline locked:** `governance-01:learner-v2:g2` — 94/100
- **Final immutable successor:** `governance-01:learner-v2:g4` — 98/100
...
The successor adds topic-specific authority, implementation chains, federal boundaries, stakeholder maps,
indicators, remedies and evidentiary controls. Every detected solved answer has demand
...
- `governance-01:learner-v2:g2` — command_start_baseline; approval false
- `governance-01:learner-v2:g3` — failed_intermediate_preserved; approval false
- `governance-01:learner-v2:g4` — final_passed; approval false
