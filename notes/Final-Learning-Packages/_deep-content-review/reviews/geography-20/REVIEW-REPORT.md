# Deep Content Review — Geography 20: Temperate Continental Steppe Climate

- **Command-start baseline locked:** `geography-20:learner-v2:g3` — 94/100
- **Final immutable successor:** `geography-20:learner-v2:g4` — 98/100
...
- `geography-20:learner-v2:g3` — command_start_baseline; approval false
- `geography-20:learner-v2:g4` — final_passed; approval false
