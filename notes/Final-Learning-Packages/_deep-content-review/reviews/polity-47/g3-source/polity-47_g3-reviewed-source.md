...
### SESSION 16 — Answer architecture (10/15/20-mark support)
...
A. A common title proves identical power.
...
B. An uncodified constitution contains no written law.
...
A. Flexibility necessarily eliminates constitutionalism.
...
A. India adopted unlimited British parliamentary sovereignty.
B. India adopted parliamentary government within a supreme written Constitution.
C. UK courts routinely invalidate Westminster primary legislation.
...
B. Basic structure limits ordinary UK legislation.
C. India adopted parliamentary government within a supreme written Constitution.
D. India adopted unlimited British parliamentary sovereignty.
...
A. Basic structure limits ordinary UK legislation.
...
B. The US Tenth Amendment assigns residuary power to Congress.
C. Australia assigns all unenumerated power to its Commonwealth Parliament.
...
A. Australia assigns all unenumerated power to its Commonwealth Parliament.
...
A. Rajya Sabha gives every State equal seats.
B. Canada's Senate consists of provincial-government delegates.
...
A. Irish directive principles are enforced exactly like South African rights.
B. South Africa textually protects justiciable socio-economic rights, unlike Indian DPSPs.
C. Indian DPSPs are ordinary individual writ claims.
...
A. The US Constitution contains India's DPSP chapter.
...
C. Indian secularism authorises religious preference without equality review.
...
D. French laicite and Indian secularism are operationally identical.
...
C. The US President appoints Supreme Court judges without Senate participation.
...
C. Germany's Article 79(3) and India's basic structure have the same textual source.
...
B. Australia's section 128 requires no referendum.
C. Germany's Article 79(3) and India's basic structure have the same textual source.
D. Article V allows the US President to amend the Constitution.
...
A. An identical electoral formula is suitable for every head of state.
...
D. France elects its President through Indian-style weighted State voting.
...
B. France elects its President through Indian-style weighted State voting.
C. An identical electoral formula is suitable for every head of state.
...
B. India's President exercises Article 72 without ministerial advice.
C. The US pardon power covers impeachment.
...
A. Preemptive pardon means permission for future crimes.
B. India's President exercises Article 72 without ministerial advice.
C. The US federal pardon does not reach State offences and cannot license future offences.
D. The US pardon power covers impeachment.
...
B. Exceptional power has no effect on federal relations.
C. Judicial review is irrelevant to emergency design.
...
A. Judicial review is irrelevant to emergency design.
...
D. Exceptional power has no effect on federal relations.
...
A. Borrowed from means copied unchanged.
...
D. Foreign origin establishes present constitutional identity.
...
A. Institutional transplantation is independent of party systems.
B. Foreign origin establishes present constitutional identity.
C. Borrowed from means copied unchanged.
...
B. Foreign origin establishes present constitutional identity.
C. Borrowed from means copied unchanged.
D. Institutional transplantation is independent of party systems.
...
A. The best conclusion ranks countries without criteria.
...
B. Two separate country descriptions are sufficient comparison.
C. The best conclusion ranks countries without criteria.
