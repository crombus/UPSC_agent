# Repair handoff — Approaches, Behaviouralism and Post-Behaviouralism

Keep reviewed baseline `political-theory-08:learner-v2:g2` immutable. The freshly allocated
successor is `political-theory-08:learner-v2:g3` with score unset,
...
- The stored ASCII/graphical source contains 8 conclusive dangling sentence fragment(s), so the flows are not independently safe.

## Sources and affected artifacts

- Canonical Basic owner: `upsc-ai-kit\knowledge\Political-Theory\basic\08_Approaches-Behaviouralism-and-Post-Behaviouralism.md`
- Optional Advanced owner: `upsc-ai-kit\knowledge\Political-Theory\advanced\08_Approaches-Behaviouralism-and-Post-Behaviouralism.md`
