# Repair handoff — Salient Features

Keep reviewed baseline `polity-03:learner-v2:g18` immutable. The collision-free
successor is `polity-03:learner-v2:g19` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\03_Salient-Features_Complete-Topic-Package.md`
