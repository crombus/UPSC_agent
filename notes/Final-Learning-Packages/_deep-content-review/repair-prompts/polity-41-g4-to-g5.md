# Repair handoff — Public Services

Keep reviewed baseline `polity-41:learner-v2:g4` immutable. The collision-free
successor is `polity-41:learner-v2:g5` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\Public-Services.md`
