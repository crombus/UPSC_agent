# Repair handoff — UPSC and SPSC

Keep reviewed baseline `polity-28:learner-v2:g4` immutable. The collision-free
successor is `polity-28:learner-v2:g5` with fresh scores unset,
...
- Canonical Basic/Core owner: `upsc-ai-kit\knowledge\Polity\basic\UPSC-and-SPSC.md`
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\UPSC-and-SPSC.md`
- Optional Advanced owner: `upsc-ai-kit\knowledge\Polity\advanced\28_UPSC-and-SPSC.md`
