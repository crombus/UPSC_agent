# Repair handoff — Comparative Constitutional Design

Keep reviewed baseline `polity-47:learner-v2:g5` immutable. The collision-free
successor is `polity-47:learner-v2:g6` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\Comparative-Constitutional-Schemes.md`
