...
Keep reviewed baseline `medieval-indian-history-10:learner-v2:g4` immutable. The collision-free
successor is `medieval-indian-history-10:learner-v2:g5` with fresh scores unset,
`revalidation_pending` status and approval false.

## Defects to repair

- Original solved Mains practice is misplaced inside Basic MCQs instead of PYQS AND ANSWER PRACTICE.
