# Repair handoff — Citizenship and Its Critiques

Keep reviewed baseline `political-theory-16:learner-v2:g2` immutable. The freshly allocated
successor is `political-theory-16:learner-v2:g3` with score unset,
`revalidation_pending` status and approval false.

## Defects to repair

- All 7 solved PYQ/original Mains items lack explicit answer-specific `How to improve this answer` guidance.
- All 7 solved items lack explicit directive-and-demand decoding.
- All 7 solved items lack an executable mark-scaled compression plan.
...
- Canonical Basic owner: `upsc-ai-kit\knowledge\Political-Theory\basic\16_Citizenship-and-Its-Critiques.md`
- Optional Advanced owner: `upsc-ai-kit\knowledge\Political-Theory\advanced\16_Citizenship-and-Its-Critiques.md`
