# Repair handoff — Amendment and Basic Structure

Keep reviewed baseline `polity-10:learner-v2:g6` immutable. The collision-free
successor is `polity-10:learner-v2:g8` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\Amendment-and-Basic-Structure.md`
