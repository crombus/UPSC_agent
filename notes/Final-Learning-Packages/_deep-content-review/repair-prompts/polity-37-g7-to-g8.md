# Repair handoff — CVC and CBI

Keep reviewed baseline `polity-37:learner-v2:g7` immutable. The collision-free
successor is `polity-37:learner-v2:g8` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\CVC-and-CBI.md`
