# Repair handoff — NHRC and SHRC

Keep reviewed baseline `polity-35:learner-v2:g5` immutable. The collision-free
successor is `polity-35:learner-v2:g8` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\NHRC-and-SHRC.md`
