# Repair handoff — Scheduled and Tribal Areas

Keep reviewed baseline `polity-26:learner-v2:g4` immutable. The collision-free
successor is `polity-26:learner-v2:g5` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\Scheduled-and-Tribal-Areas.md`
