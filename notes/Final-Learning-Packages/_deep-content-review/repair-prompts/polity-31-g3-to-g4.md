# Repair handoff — National Commissions SC ST BC

Keep reviewed baseline `polity-31:learner-v2:g3` immutable. The collision-free
successor is `polity-31:learner-v2:g4` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\National-Commissions-SC-ST-BC.md`
