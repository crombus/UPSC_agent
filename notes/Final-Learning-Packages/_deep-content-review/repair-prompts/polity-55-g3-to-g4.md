# Repair handoff — Constitutional Interpretation Doctrines

Keep reviewed baseline `polity-55:learner-v2:g3` immutable. The collision-free
successor is `polity-55:learner-v2:g4` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\Constitutional-Interpretation-Doctrines.md`
