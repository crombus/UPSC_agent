# Repair handoff — Multilateral Environmental Conventions (CBD, Basel, Stockholm, Montreal)

Keep reviewed predecessor `environment-and-ecology-22:learner-v2:g2`
immutable. The collision-free successor is
`environment-and-ecology-22:learner-v2:g3` with fresh scores unset,
`revalidation_pending` status and approval false.

## Defects to repair

- **High:** Solved items use a generic examiner-model status pointer rather than a self-contained detailed model answer built from the named evidence.
...
- Canonical package owner: `upsc-ai-kit\knowledge\Environment-and-Ecology\learning-sessions\v2\subject-wide-syllabus\environment-and-ecology-22_Learning-Session.md`
