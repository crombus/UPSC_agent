# Repair handoff — Architecture Foundations and Harappan Urbanism

Keep reviewed baseline `indian-art-and-culture-01:learner-v2:g2` immutable. The collision-free
successor is `indian-art-and-culture-01:learner-v2:g5` with fresh scores unset,
...
- The package lacks a topic-specific Indian Art and Culture chronology, spatial distinction and evidence/historiography qualification control.
- Visual-first Core progression is incomplete: sessions=14, visual gateways=15.
...
- Canonical package owner: `upsc-ai-kit\knowledge\Indian-Art-and-Culture\basic\01_Architecture-Foundations-and-Harappan-Urbanism.md`
