# Repair handoff — Provincial & Regional Kingdoms (Bengal, Gujarat, Malwa, Jaunpur, Kashmir) + bounded Ahom/Assam Prelims extension

Keep reviewed baseline `medieval-indian-history-08:learner-v2:g2` immutable. The collision-free
successor is `medieval-indian-history-08:learner-v2:g3` with fresh scores unset,
...
- The package lacks a topic-specific Medieval chronology, close-distinction and evidence-qualification control derived from the reviewed Core.
...
- Canonical package owner: `upsc-ai-kit\knowledge\Medieval-Indian-History\basic\08_Provincial-Regional-Kingdoms.md`
