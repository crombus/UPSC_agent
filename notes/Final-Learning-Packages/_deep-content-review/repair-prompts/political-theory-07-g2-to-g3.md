# Repair handoff — Nature of Politics and Communitarianism

Keep reviewed baseline `political-theory-07:learner-v2:g2` immutable. The freshly allocated
successor is `political-theory-07:learner-v2:g3` with score unset,
...
- The stored ASCII/graphical source contains 4 conclusive dangling sentence fragment(s), so the flows are not independently safe.

## Sources and affected artifacts

- Canonical Basic owner: `upsc-ai-kit\knowledge\Political-Theory\basic\07_Nature-of-Politics-and-Communitarianism.md`
- Optional Advanced owner: `upsc-ai-kit\knowledge\Political-Theory\advanced\07_Nature-of-Politics-and-Communitarianism.md`
