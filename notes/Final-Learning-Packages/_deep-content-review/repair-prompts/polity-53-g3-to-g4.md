# Repair handoff — Special Provisions Relating to Certain Classes

Keep reviewed baseline `polity-53:learner-v2:g3` immutable. The collision-free
successor is `polity-53:learner-v2:g4` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\Special-Provisions-Relating-to-Certain-Classes.md`
