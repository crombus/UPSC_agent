# Repair handoff — Ecosystem Structure and Function

Keep reviewed baseline `environment-and-ecology-01:learner-v2:g2` immutable. The collision-free
successor is `environment-and-ecology-01:learner-v2:g4` with fresh scores unset,
...
- The package lacks a topic-specific Environment and Ecology chronology, spatial distinction and evidence/historiography qualification control.
...
- Canonical package owner: `upsc-ai-kit\knowledge\Environment-and-Ecology\learning-sessions\v2\subject-wide-syllabus\environment-and-ecology-01_Learning-Session.md`
