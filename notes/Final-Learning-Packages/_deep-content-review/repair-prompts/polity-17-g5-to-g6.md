# Repair handoff — Parliament

Keep reviewed baseline `polity-17:learner-v2:g5` immutable. The collision-free
successor is `polity-17:learner-v2:g6` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\Parliament.md`
