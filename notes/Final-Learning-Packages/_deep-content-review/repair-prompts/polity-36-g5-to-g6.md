# Repair handoff — CIC and SIC

Keep reviewed baseline `polity-36:learner-v2:g5` immutable. The collision-free
successor is `polity-36:learner-v2:g6` with fresh scores unset,
...
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\CIC-and-SIC.md`
