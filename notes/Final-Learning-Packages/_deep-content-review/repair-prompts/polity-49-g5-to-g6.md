# Repair handoff — Regulatory State and Quasi Judicial Institutions

Keep reviewed baseline `polity-49:learner-v2:g5` immutable. The collision-free
successor is `polity-49:learner-v2:g6` with fresh scores unset,
...
- Canonical Basic/Core owner: `upsc-ai-kit\knowledge\Polity\basic\Statutory-Regulatory-and-Quasi-Judicial-Bodies.md`
- Canonical package owner: `upsc-ai-kit\knowledge\Polity\basic\Statutory-Regulatory-and-Quasi-Judicial-Bodies.md`
- Optional Advanced owner: `upsc-ai-kit\knowledge\Polity\advanced\49_Regulatory-State-and-Quasi-Judicial-Institutions.md`
