...
Keep reviewed baseline `geography-30-primary-economic-activities-agriculture:learner-v2:g12` immutable. The collision-free
successor is `geography-30-primary-economic-activities-agriculture:learner-v2:g14` with fresh scores unset,
...
- Visual-first Core progression is incomplete: sessions=11, visual gateways=0.
