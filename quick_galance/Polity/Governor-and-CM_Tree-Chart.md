# Polity 19 — Governor, Chief Minister and State Council — Quick-Glance Tree Chart

```text
GOVERNOR, CHIEF MINISTER AND STATE COUNCIL
|
+-- CENTRAL RULE
|   Formal power: Governor | Political authority: CM-led Assembly-responsible Council
|   Discretion: only textually recognised or necessarily implied; never a general domain
|
+-- 01. CORE CONCEPT AND CONSTITUTIONAL ORIGIN
|   CENTRAL QUESTION
...
|
+-- 02. DECODED ARTICLES 153-162: OFFICE, TENURE, POWER AND CLEMENCY
|   ARTICLE 153: Governor for each State; same person may hold two or more distinct State offices.
...
|
+-- 03. APPOINTMENT, PLEASURE, TRANSFER AND IMMUNITY
|   ENTRY
...
|
+-- 04. UNION-STATE PARLIAMENTARY MIRRORS
|   FORMAL POWER
...
|
+-- 05. AID, ADVICE AND BOUNDED DISCRETION
|   DEFAULT
...
|
+-- 06. CHIEF MINISTER APPOINTMENT AND CONFIDENCE MECHANISM
|   CLEAR MAJORITY
...
|
+-- 07. ARTICLES 168, 171 AND 174-177: LEGISLATIVE INTERFACE
|   ARTICLE 168
...
|
+-- 08. ARTICLES 200-201 AFTER THE 2025 DOCTRINE
...
|
+-- 09. PUNJAB, TAMIL NADU AND THE ARTICLE 143 OPINION: PRECISE RELATIONSHIP
|   PUNJAB, 10 NOV 2023
...
|
+-- 10. ORDINANCE, CLEMENCY AND JUDICIAL-SERVICE CONTROLS
...
|   Governor: all six forms for State-field offences generally; cannot pardon a death sentence,
|             but may suspend, remit or commute it within that field; no court-martial power.
...
|
+-- 11. CHIEF MINISTER, COUNCIL, ADVOCATE GENERAL AND AMENDMENTS
...
|   Total ministers including CM <=15% of total Assembly membership; minimum twelve.
...
|
+-- 12. FEDERAL FRICTION, REFORMS, TRAPS AND ANSWER SPINE
|   FAULT LINE
...
+-- QUALIFIED CONCLUSION
    The Governor is legitimate as a neutral constitutional process guardian,
    not as a rival executive, personal veto-holder or agent of the Union party.
```
