---
title: "Empiricism (Locke, Berkeley, Hume) — Live Learning Session (Learner-First Edition)"
subject: "Philosophy Optional, Paper I, Section A — Western Philosophy, Syllabus Item 3"
...
roadmap_status: "frozen — 10 learner-facing lessons, accepted before drafting; internal Parts only within lessons 3, 5, 6, 7, 9 and 10"
generated_from:
  - "upsc-ai-kit/knowledge/Philosophy/paper-1/western/Empiricism.md (canonical owner, §§0-12, D, V, T, restored doctrine dossier, corpus-driven depth delta)"
  - "upsc-ai-kit/knowledge/Philosophy/paper-1/western/Kant.md §4 (cross-owned — 'Ideas of Reason', Transcendental Dialectic; Kant half of 2026 Q2(b))"
  - "upsc-ai-kit/knowledge/Philosophy/paper-1/western/Rationalism.md (cross-owned — Descartes' dispositional innatism, Locke's reply target)"
  - "upsc-ai-kit/knowledge/Philosophy/indian/Buddhism.md (cross-owned — anatta/nairatmyavada parallel to Hume's bundle self)"
  - "upsc-ai-kit/knowledge/Philosophy/paper-1/western/Logical-Positivism.md (cross-owned — Hume's Fork as verification-principle ancestor)"
  - "upsc-ai-kit/knowledge/Philosophy/paper-2/philosophy-of-religion/Proofs-for-God.md (cross-owned — Hume's design-argument critique, cross-paper PYQ)"
  - "upsc-ai-kit/knowledge/Philosophy/Western-Philosophy/learning-sessions/Empiricism/Empiricism_Layered-Complete-Learning-Session_2026-08-18.md (prior approved package — structural and practice base)"
  - "upsc-ai-kit/knowledge/Philosophy/Western-Philosophy/learning-sessions/Empiricism/Empiricism_Layered-Solved-Practice-Workbook_2026-08-18.md (verified mirror of the above session's own Part II)"
  - "upsc-ai-kit/knowledge/Philosophy/paper-1/_PYQ-Western-Philosophy-2018-2025.md (12 primary-owned Empiricism parts)"
  - "upsc-ai-kit/knowledge/Philosophy/paper-1/_PYQ-Western-Philosophy-2026.md (2026 Q1(b) primary; 2026 Q2(b) primary, Kant half cross-linked)"
---

# EMPIRICISM (LOCKE, BERKELEY, HUME) — Live Learning Session, Learner-First Edition

> **Syllabus (verbatim):** Empiricism (Locke, Berkeley, Hume): Theory of Knowledge; Substance and Qualities; Self
> and God; Scepticism.
...
| 10 | Advanced | Final Synthesis — Thinker Comparisons, Criticisms, All Solved PYQs Through 2026, Answer Architecture, Original Practice and Register Notes |
...
- Coverage discovered or restored during the mandatory gap audit below is integrated as **internal Parts** inside
  the frozen structure — no lesson is added, removed, merged or reordered to accommodate it. The full ledger is
  in the "Gap ledger" table below.
- Lesson 10 carries four internal parts so that "final synthesis" is delivered inside the frozen 10-lesson
  structure rather than as extra top-level lessons: **Part A** (comparative synthesis, criticisms, traps, keyword
  bank, directive decoder, graded verdict bank, translation/provenance discipline), **Part B** (the exact PYQ
  route map and marks-wise answer architecture), **Part C** (the complete solved-practice bank: 14 solved PYQs,
  40 rotation-checked MCQs, 3 original Mains questions with model answers) and **Part D** (the final consolidated
...
found). MCQs are answered after each question, not beside it, with every option explained; correct options
rotate strictly **A → B → C → D** throughout the 40-question bank without a consecutive repeat. **Empiricism must
never be flattened into one voice:** every doctrine below is taught per-philosopher first (Locke, then Berkeley,
then Hume) and compared only after each is independently precise — and the "slide" from Locke to Berkeley to
Hume is presented only with each added premise named, never as an automatic drift.

## Mandatory Gap Audit and Source Priority Note

- **Canonical owner (controlling doctrine):** `upsc-ai-kit/knowledge/Philosophy/paper-1/western/Empiricism.md` —
  read in full for this edition (§0 one-screen map; §0A source map/boundary; §1 theory of knowledge; §2
  substance/qualities including §§2.2A-2.2C; §3 self/God including §3.5A; §4 scepticism including the two
  reconstructed argument-sets and Kant's response; §5 the internal-logic "slide"; §6 inter-thinker debates; §7
  criticisms/replies; §7A owner/enrichment boundary; §8 traps; §9 keyword bank; the restored 2018/2020 doctrine
  dossier and corpus-driven depth delta; §10 PYQ routing 2018-2025 plus the **2026 additions** table; §11 answer
  architecture; §D directive decoder; §V graded verdict bank; §T translation/provenance discipline; §12
  link-outs; SOURCES).
- **Cross-owned canonical file:** `upsc-ai-kit/knowledge/Philosophy/paper-1/western/Kant.md` §4 ("Ideas of
  Reason — Transcendental Dialectic") — read in full; this file owns the full positive Kantian doctrine of the
  three transcendental Ideas (Soul/World/God), their regulative-not-constitutive status, the Paralogisms and the
  Ideal of Pure Reason. This live edition authors only the Humean half of 2026 Q2(b) and a compact, accurate
  summary of Kant's reply in Lesson 7, Part B, exactly as the routing table instructs ("Kant's reply cross-linked
  to `Kant.md`") — it does not reproduce Kant's full apparatus.
- **Cross-owned canonical files (brief, non-duplicating links):** `Rationalism.md` (Descartes' dispositional
  innatism — the position Locke's refutation must actually meet, in Lesson 2); `../indian/Buddhism.md` (anatta /
  *nairatmyavada* — the no-self doctrine paralleling Hume's bundle theory, in Lesson 8);
  `Logical-Positivism.md` (Hume's Fork as the direct ancestor of the verification principle, in Lesson 7);
  `../../paper-2/philosophy-of-religion/Proofs-for-God.md` (Hume's design-argument critique, cross-paper PYQ, in
  Lesson 9).
- **Prior approved package (structural and practice base):**
  `Empiricism_Layered-Complete-Learning-Session_2026-08-18.md` and its paired
  `Empiricism_Layered-Solved-Practice-Workbook_2026-08-18.md` (workbook content is a verified mirror of the
  session's own Part II, so it is cross-checked but not separately re-derived). That package organises its ten
  subtopics unit-by-unit in a **different grouping** from this live edition's accepted roadmap (its Unit 3
  combines Locke's abstraction with essence only, and its Unit 4 separately covers Locke's qualities/substance,
  where this edition's frozen Lesson 3 combines abstraction, essence, qualities, representative realism *and*
  substance into one lesson with internal Parts; its Units 6-7 split Berkeley differently from this edition's
  Lessons 5-6). This live edition preserves every doctrine, argument, objection, PYQ and MCQ from that package,
  reorganised into the accepted frozen roadmap, with pre-teach checklists added and every gap below restored.
- **Verified PYQ ledgers:** `_PYQ-Western-Philosophy-2018-2025.md` (12 primary-owned Empiricism parts, continuous
  2018-2025) and `_PYQ-Western-Philosophy-2026.md` (2026 Q1(b), primary-owned here, and 2026 Q2(b), primary-owned
  here with the Kant half cross-linked) — together giving continuous 2018-2026 coverage, all 14 parts solved in
  Lesson 10, Part C.
- **OCR-searchable local books** (`books/philosphy_books/`: Masih's *A Critical History of Western Philosophy*,
  Copleston's *A History of Philosophy* Vol. V (British Philosophers: Hobbes to Hume), Kenny's *A New History of
  Western Philosophy* Vol. III, Warburton's *Philosophy: The Classics*) were consulted for cross-checking
  terminology, citation discipline and standard secondary-literature framing — specifically for the restored
  Locke three-tier identity distinction (Lesson 4), the general theory of association (Lesson 7) and the
  liberty/necessity cross-link (Lesson 9). No claim in this file rests on a book alone without the canonical
  Markdown owner's support.
- **Official 2026 paper:** the 2026 PYQ ledger's transcription is already OCR-verified against
  ...
  Q1(b) and Q2(b)'s wording, year and marks.
- **Current affairs:** `web_search` was attempted for this file's drafting (topic-specific queries are recorded
  per lesson) and returned a repeated backend transport error (`HTTP 400 Bad Request: invalid session`) on every
  attempt made during drafting, including a general pre-drafting probe ("Locke Berkeley Hume empiricism UPSC
  current affairs 2026 India relevance"). No current-affairs anchor is fabricated or backfilled from memory; each
  checklist records this truthfully. This matches the identical, independently-encountered finding recorded in
  the sibling `01-Plato-Aristotle` and `02-Rationalism` live editions, and is consistent with the prior approved
  Empiricism package's own single labelled contemporary-application anchor (2026 AI-and-induction academic
  discussion, retained in Lesson 9 as a clearly labelled application, not doctrine).
...
|---|---|---|
| 2026 Q2(b) — Hume's account of "ideas of reason" and Kant's response — not yet taught anywhere as a standalone doctrine block; canonical file flags it only as a routing note ("primary — §1.3 + §3.5A; Kant's reply cross-linked") without full text | Canonical §10 "2026 additions" table, owner-block note only | Lesson 7, Part B (full deep teaching of both halves) and Lesson 10, Part C, Solved PYQ 14 |
| Locke's three-tier identity distinction (substance/mass of particles vs "man"/human animal vs "person") — canonical file states the distinction exists in one line but does not expand the "man" tier | Canonical §3.1, one sentence | Lesson 4, Layer 2, expanded three-tier table and worked contrast |
| General theory of association (resemblance, contiguity, cause-and-effect) as Hume's own named mechanism, not only as applied to the self-bundle — 2023 Q2(a) explicitly names "psychological principle of association" as part of the causation question, so it must be taught as a general doctrine before its causation-specific use | Canonical §1.3 (one clause) and §3.5 (applied only to self) | Lesson 7, Layer 2, dedicated block naming and explaining all three principles generally, with forward pointers to Lessons 8 and 9 for their specific applications |
| "Natural belief" as an explicitly named, general Humean doctrine (not only the mechanism behind the self-bundle) — covering continued/external existence (constancy/coherence) as well as the self and, later, induction | Canonical §2.3A, un-named as a general doctrine | Lesson 8, Layer 2, named and generalised, with the self and external-world cases taught together and an explicit forward link to induction's natural belief in Lesson 9 |
| Liberty/necessity (Hume's compatibilism about free will) — explicitly listed as "optional enrichment... outside this owner" in canonical §7A, yet the accepted roadmap's Lesson 9 title explicitly asks for it "where relevant" | Canonical §7A (flagged as out of scope) | Lesson 9, Part B — a compact, clearly labelled cross-owned box (Paper II/ethics is the full owner) sufficient to answer "where relevant" without duplicating that owner's full material |
| Berkeley's abstraction critique (nominalism) is textually embedded under Locke's own §1.1 in the canonical file, immediately after Locke's doctrine — the accepted roadmap deliberately separates Locke's doctrine (Lesson 3) from Berkeley's refutation (Lesson 6) so each thinker is taught independently before comparison | Canonical §1.1 (both halves adjacent) | Lesson 3 teaches only Locke's doctrine, with a one-line forward pointer; Lesson 6 teaches Berkeley's full refutation, Locke's reply table and the executable verdict |
| Representative realism is textually placed inside Locke's §1.1 (knowledge) in the canonical file; the accepted roadmap places it in Lesson 3 alongside qualities/substance, since it is the epistemic gap those doctrines jointly create | Canonical §1.1 | Lesson 3, Layer 2, positioned as the bridge between abstraction/essence and qualities/substance |

No lesson was added, removed, merged or reordered to accommodate any of the above; every restoration and every
reorganisation sits inside the frozen 10-lesson structure as an internal Part, an expanded block, or a relocated
subsection with an explicit cross-reference.
...
━━━ PRE-TEACH CHECKLIST ━━━━━━━━━━━━━━━━━━
Book context: [queried — canonical owner `upsc-ai-kit/knowledge/Philosophy/paper-1/western/Empiricism.md` §§0, 0A, 5; cross-checked against Masih's *A Critical History of Western Philosophy*, Copleston's *A History of Philosophy* Vol. V and Kenny's *A New History of Western Philosophy* Vol. III in `books/philosphy_books/` for the standard "British Empiricism" framing]
CA search: "empiricism basic tenets Locke Berkeley Hume UPSC current affairs India 2026"
...
### 0A. Source map and the common-project boundary ✅
...
5. **Conclusion (the slide, correctly stated):** each thinker's conclusion is *not* an arbitrary next opinion but
   ...
   actually live by — is exactly what **provokes Kant** (the cross-owned trigger for `Kant.md`) to add the a
...
- Endpoint provokes **Kant**'s a priori rescue (cross-owned `Kant.md`).
...
━━━ PRE-TEACH CHECKLIST ━━━━━━━━━━━━━━━━━━
Book context: [queried — canonical owner `Empiricism.md` §1.1 in full, including the dedicated "Degrees of
Knowledge" owner block; cross-checked against Masih and Copleston Vol. V for the standard *Essay* I-IV framing,
and against `Rationalism.md` §1.5A for Descartes' dispositional-innatism reply target]
CA search: "Locke innate ideas tabula rasa degrees of knowledge UPSC current affairs 2026"
CA found: None verifiable this session — the same repeated backend transport error (HTTP 400, invalid session)
recurred on this attempt. No substitute headline is invented. Locke's epistemology is a fixed early-modern text
...
rationalist claim (especially Descartes', cross-owned in `Rationalism.md` §1.5A) that certain ideas (God, logical
...
> for those routes (solved in full in Lesson 10, Part C).
...
#### Degrees of knowledge — intuitive vs demonstrative vs sensitive ✅ (owner block; 2026 Q1(b) routes here)
...
possess the idea of God; Descartes' considered view (cross-owned, `Rationalism.md` §1.5A) is **dispositional** —
...
- **2026 Q1(b), 10 marks (primary owner):** *Explain the distinction between Intuitive knowledge and
...
━━━ PRE-TEACH CHECKLIST ━━━━━━━━━━━━━━━━━━
Book context: [queried — canonical owner `Empiricism.md` §1.1 (abstraction subsection) and §2.1 in full; the
...
CA search: "Locke abstract ideas nominal essence primary secondary qualities UPSC current affairs 2026"
...
reply, and the executable verdict are taught in Lesson 6, Layer 2 — this lesson teaches only Locke's own positive
...
### How much of the primary/secondary distinction survives on its own?
...
- **2024 Q2(a), 20 marks** (primary-owned by Lesson 5-6's Berkeley material): the primary/secondary distinction
...
━━━ PRE-TEACH CHECKLIST ━━━━━━━━━━━━━━━━━━
Book context: [queried — canonical owner `Empiricism.md` §3.1-3.2 in full; the "man/person/substance" three-tier
...
CA search: "Locke personal identity prince cobbler memory theory UPSC current affairs 2026"
...
#### Locke's three-tier identity distinction — the restored expansion ✅ (a genuinely different question at each tier)
...
### Does Locke's demonstrative proof of God survive?
...
━━━ PRE-TEACH CHECKLIST ━━━━━━━━━━━━━━━━━━
Book context: [queried — canonical owner `Empiricism.md` §§1.2 (opening), 2.2 (Arguments 1-4 of the "five
...
CA search: "Berkeley esse est percipi immaterialism master argument UPSC current affairs 2026"
CA found: None verifiable this session — the same repeated transport error recurred. No fabricated anchor.
Berkeley's immaterialism is a fixed early-18th-century doctrine; its exam value is syllabus-anchored (2021 Q1(c),
2024 Q2(a)).
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
4. Therefore, the supposition is self-refuting; unperceived existence cannot even be entertained.
   ...
   - **Strongest objection ❓ (Russell; refined by Prior and Gallois):** a **scope/use-mention confusion**. What
...
self-cancelling. But Russell's rejoinder (refined by Prior and Gallois) isolates a **scope ambiguity**: "I cannot
...
unproblematic. Berkeley's only available reply — that there is no "object" left over once the idea is subtracted
...
### How much of Locke's quality distinction survives the parity attack?
...
- Master Argument's standard flaw: **scope/use-mention confusion** (Russell/Prior/Gallois).
...
━━━ PRE-TEACH CHECKLIST ━━━━━━━━━━━━━━━━━━
Book context: [queried — canonical owner `Empiricism.md` §§1.1 (Berkeley's demolition block), 2.2 (Argument 5,
continuity), 2.2A-2.2C, 3.3-3.4, 4.2; restored 2018/2020 doctrine dossier; cross-checked against Warburton and
Copleston Vol. V for the Moore/Russell secondary literature]
CA search: "Berkeley nominalism abstract ideas Moore Russell idealism UPSC current affairs 2026"
CA found: None verifiable this session — the same repeated transport error recurred. No fabricated anchor. This
...
### Moore and Russell against Berkeley — are they really the same reaction?
...
━━━ PRE-TEACH CHECKLIST ━━━━━━━━━━━━━━━━━━
Book context: [queried — canonical owner `Empiricism.md` §§1.3, 2.3, and the 2026-additions routing note in §10;
cross-owned `Kant.md` §4 ("Ideas of Reason") read in full for Part B; cross-checked against Copleston Vol. V for
...
CA search: "Hume ideas of reason Kant response 2026 UPSC Fork relations of ideas current affairs"
CA found: None verifiable this session — the same repeated transport error recurred. No fabricated anchor. The
...
#### Association — the general mechanism, restored as its own named doctrine ✅
...
- **Consequence:** any proposition that is *neither* a relation of ideas *nor* a matter of fact is *meaningless* —
  ...
  direct ancestor of Logical Positivism's verification principle (cross-owned, `Logical-Positivism.md`).
...
### PART B — 2026 Q2(b): Hume's account of "ideas of reason," and Kant's response ✅⚠️ (newly authored owner content)
...
- **2018 Q1(a), 10 marks:** *Are "the Sun will rise tomorrow" and "2+2=4" of the same necessity for Hume?* Pure
  ...
  same necessity (fully solved in Lesson 10, Part C).
- **2026 Q2(b), 15 marks (primary owner, Kant half cross-linked to `Kant.md`):** *How does Hume account for ideas
...
━━━ PRE-TEACH CHECKLIST ━━━━━━━━━━━━━━━━━━
Book context: [queried — canonical owner `Empiricism.md` §§3.5, 3.5A, 2.3A in full; restored 2018/2020 doctrine
dossier's "Humean identity and Kant's reply" block; cross-owned `../indian/Buddhism.md` for the anatta parallel,
consulted only for the cross-tradition bridge, not re-derived here]
CA search: "Hume bundle theory self personal identity natural belief Kant UPSC current affairs 2026"
CA found: None verifiable this session — the same repeated transport error recurred. No fabricated anchor. This
...
- ⚠️ **Cross-tradition parallel:** Hume's bundle theory strikingly resembles the Buddhist doctrine of
  *anatman/nairatmyavada* (no-self) — cross-owned in `../indian/Buddhism.md`. The examiner may reward this bridge
  when a comparative directive invites it, without importing the full Buddhist doctrine here.

### Natural belief — the general doctrine, named and generalised ✅ (restored as an explicit doctrine, not only the self-mechanism)
...
### Is "natural belief" a justification or merely an excuse?
...
- **Cross-tradition:** Buddhist anatta/*nairatmyavada* parallel (cross-owned, `Buddhism.md`) — usable, not
  required.
...
━━━ PRE-TEACH CHECKLIST ━━━━━━━━━━━━━━━━━━
Book context: [queried — canonical owner `Empiricism.md` §4.3 in full (causation, the two reconstructed
argument-sets, Kant's response, mitigated scepticism) and §3.6 (Hume's God); cross-checked against Copleston Vol.
V and Warburton for the standard causation/induction exposition; the liberty/necessity cross-link consulted
against Masih's summary of *Enquiry* VIII, consistent with canonical §7A's "optional enrichment, Paper
II/ethics owner" flag]
CA search: "Hume causation induction custom habit mitigated scepticism UPSC current affairs 2026"
CA found: A single, clearly labelled 2026 academic discussion was already identified in the prior approved
package and is retained here, not re-derived by fresh search (which itself returned the same repeated transport
error as every other lesson): *Artificial Intelligence and the Problem of Induction: A Critique of David Hume's
...
- PYQ 2023 Q2(a) 20m, 2021 Q1(e) 10m, 2019 Q4(b) 15m, 2025 Q2(c) 15m all demand this analysis (fully solved in
  Lesson 10, Part C).
...
rationality that induction constitutes (cross-owned, `Quine-Strawson.md`).
...
### PART C — Liberty and necessity where relevant (compact cross-owned box — full owner: Paper II/ethics) ⚠️
...
here, even though its full ethical development is outside this file's owner scope (canonical §7A). ✅
...
- The full ethical elaboration (its place in Hume's moral philosophy, sentiment-based ethics, and the
  is-ought problem) belongs to the Paper II/ethics owner file and is not reproduced here.
...
### Mitigated scepticism and Hume's God — and the labelled contemporary application
...
⚠️ **Contemporary application (clearly labelled, not doctrine).** A 2026 discussion, *Artificial Intelligence and
the Problem of Induction: A Critique of David Hume's Empiricism* (IIARD, Journal of Humanities and Social Policy,
Vol. 12 No. 1), notes that machine-learning prediction *operationalises* inductive expectation: a model
generalises from constant conjunctions in training data to expectations about unseen cases — a mechanical analogue
of Humean custom. But this **does not** establish a necessary connexion, and it **does not** solve Hume's
*logical* problem of induction: the model's reliability on new data still presupposes the uniformity it cannot
prove; "distributional shift" (a model's degraded performance when new data no longer resembles training data) is
a modern restatement of Hume's point, not a refutation of it. The lesson is Humean, not anti-Humean — powerful
prediction without rational insight into necessity. (Used sparingly; no figures invented; it illustrates, it does
not prove.)
...
- **2019 Q4(b), 15 marks; 2021 Q1(e), 10 marks; 2023 Q2(a), 20 marks; 2025 Q2(c), 15 marks:** all four demand the
  causation analysis above, at different marks-weights and directive words (all fully solved in Lesson 10, Part
  C).
- **2025 P-II Q6(a)** (cross-paper, primary-owned by `Proofs-for-God.md`): "Design argument for God's existence
...
- **Liberty/necessity (compact, cross-owned):** Hume redefines necessity as constant conjunction/inference from
...
- **Hume's God:** causal and design proofs fail; miracles argument; natural theology collapses into causal
  scepticism.
- ⚠️ **CA anchor:** ML operationalises inductive habit but neither proves necessity nor solves the logical problem
  (IIARD 2026, labelled application only).
...
━━━ PRE-TEACH CHECKLIST ━━━━━━━━━━━━━━━━━━
Book context: [queried — canonical owner `Empiricism.md` §§6, 7, 7A, 8, 9, restored 2018/2020 doctrine dossier,
corpus-driven depth delta, §10 PYQ routing (2018-2025) plus 2026 additions, §11 answer architecture, §D, §V, §T,
§12; cross-checked in full against both files of the prior approved package for completeness]
CA search: "Locke Berkeley Hume empiricism comparison criticisms UPSC PYQ 2026 current affairs"
CA found: None verifiable this session — the same repeated transport error recurred on this final attempt as on
...
**Plain-language start.** Every long Empiricism answer is, at bottom, a placement exercise: which thinker's
position on matter, qualities, substance, self, causation, God and scepticism does the question ask about, and
what is the *next* thinker's specific objection to it? This lesson assembles the complete comparison table, the
...
### A.1 Inter-thinker / inter-school debates ⚠️
...
synthetic a priori and the transcendental unity supplied to stop the slide — Lessons 7-9, cross-owned `Kant.md`).

### A.2 Criticisms and replies
...
**Core owner:** Locke, Berkeley and Hume on knowledge, substance/qualities, self/God and scepticism; Locke's
innate-idea critique, degrees of knowledge, abstraction, primary/secondary qualities, substratum and personal
identity; Berkeley's abstraction critique, immaterialism, spirits, God, continuity and idealism comparisons;
Hume's impressions/ideas, Fork, causation, induction, bundle self, external-world belief and mitigated
scepticism; all fourteen routed PYQs through 2026, including the required Moore/Russell, Hegel and Kant
responses.

**Optional enrichment (named, bounded, and where each appears in this file):** Locke's political philosophy and
detailed theory of language beyond abstract ideas/nominal essence are outside this owner entirely. Berkeley's
mathematics controversies and full philosophy of science are optional; the natural-law/sign theory (Lesson 5-6)
remains only to answer the science objection. Hume on passions, and his full liberty/necessity doctrine, is
optional here — Lesson 9, Part C gives only the compact cross-owned summary the roadmap's "where relevant"
demands, with the ethics owner file holding the full material. Hume's miracle argument (Lesson 9, Part D) is
secondary enrichment; his critique of God remains core because "God" is a printed syllabus term. Kant's positive
system belongs to `Kant.md` and appears here only as the explicitly routed response to Hume (Lessons 7 and 9).

### A.4 Common UPSC traps ⚠️
...
### A.5 Keyword and statement bank ⚠️
...
| 20 | Ideas of Reason (Kantian technical term) | Kant — 2026 Q2(b) cross-owned response |

### A.6 Directive decoder ⚠️ — what each command word obliges you to *do* here
...
# PART B — Exact PYQ route map and marks-wise answer architecture

## B.1 PYQ routing, 2018-2025 ✅

> ⚠️ **Corpus signal:** 12 primary-owned question-parts out of 112 in the continuous local Paper I corpus,
> 2018-2025. Cross-links do not create duplicate ownership.

| Year | Question | Marks | Exact demand | Primary lesson |
|---|---|---:|---|---|
| 2018 | Q1(a) | 10 | Are the two truths — 'The Sun will rise tomorrow' and '2+2=4' — of the same necessity for Hume? Give reasons in favour of your answer. | Lesson 7 |
| 2018 | Q3(a) | 20 | How does Berkeley establish that Mind and its ideas alone are real? How do Moore and Russell react to Berkeley's view in this regard? Do you find any difference between Moore's reaction and Russell's one? Discuss. | Lessons 5-6 |
| 2019 | Q4(b) | 15 | Is there any element of necessity in causal relations according to Hume? Discuss. | Lesson 9 |
| 2020 | Q2(a) | 20 | "I never can catch myself at any time without perception, and never can observe anything but the perception." How does this statement by Hume problematize the philosophical notion of personal identity? How does Kant deal with this problem in his Critique of Pure Reason? | Lesson 8 |
| 2021 | Q1(c) | 10 | "Sensible things are those only which are immediately perceived by sense." Explain Berkeley's theory of knowledge with reference to the above statement. | Lesson 5 |
| 2021 | Q1(d) | 10 | Examine the concept of personal identity by Locke. | Lesson 4 |
| 2021 | Q1(e) | 10 | "The relation between cause and effect is one of constant conjunction". Examine Hume's criticism of causation in the light of the above statement. | Lesson 9 |
| 2022 | Q4(c) | 15 | Why and how does John Locke refute the innate ideas? Elucidate the nature and source of knowledge in Locke's epistemology. | Lesson 2 |
| 2023 | Q2(a) | 20 | Critically analyse Hume's argument that causality is a matter of habit/custom involving psychological principle of association. | Lesson 9 (association general doctrine: Lesson 7) |
| 2024 | Q2(a) | 20 | Is rejection of Locke's notion of primary qualities instrumental in Berkeley's leaning towards idealism? In this context, also discuss how subjective idealism is different from the absolute idealism proposed by Hegel. | Lessons 3, 5-6 |
| 2025 | Q2(c) | 15 | Examine Hume's refutation of Causal relation and Kant's response to it. | Lesson 9 |
| 2025 | Q4(c) | 15 | Explain Berkeley's doctrine of nominalism and his refutation of Abstract ideas. | Lessons 3, 6 |

## B.2 PYQ routing, 2026 ✅

| Year | Question | Marks | Exact demand | Primary lesson | Owner status |
|---|---|---:|---|---|---|
| 2026 | Q1(b) | 10 | Explain the distinction between Intuitive knowledge and Demonstrative knowledge as propounded by Locke. | Lesson 2 | **primary** |
| 2026 | Q2(b) | 15 | How does Hume account for ideas of reason? How does Kant respond to Hume's views in this regard? Critically discuss. | Lesson 7, Part B | **primary** — Kant half cross-linked to `Kant.md` §4 |

## B.3 Cross-paper PYQ (owned elsewhere, taught here as required content)

| Paper | Question | Exact demand | Owner | Where taught in this file |
|---|---|---|---|---|
| Paper II, Philosophy of Religion | 2025 Q6(a) | Design argument for God's existence with David Hume's criticism | `Proofs-for-God.md` | Lesson 9, Part D |

## B.4 Marks-wise answer architecture

### 10-mark: "Locke's concept of personal identity" (2021 Q1d)

```text
Line 1: For Locke, personal identity consists in continuity of consciousness — a person
         at T2 is the same person as at T1 if and only if they are conscious of (can
         remember) having had T1's experiences.
Body  : (i) Not sameness of soul-substance (we might unknowingly get a new soul).
        (ii) Not sameness of body/"man" (bodies change constantly) — name the three-tier
             distinction (substance/man/person).
        (iii) Memory is the criterion; identity is a "forensic" concept tied to moral
              responsibility.
Obj   : Butler/Reid: memory presupposes identity (circularity). Reid's Brave Officer:
        transitivity of identity breaks.
Close : "Examine" = state + test with objection; close on the circularity problem's force.
```

### 15-mark: "Hume's refutation of causal relation and Kant's response" (2025 Q2c)

```text
Frame : Hume's challenge — causation is not rationally grounded; Kant's Copernican answer.
Body A: Hume: no impression of necessary connection; only constant conjunction + custom.
        Causation = psychological habit, not objective knowledge. Consequence: induction
        unjustified; science rests on "mere" feeling.
Body B: Kant's response: causation is an A PRIORI CATEGORY of the understanding. The mind
        *imposes* causal order on phenomena. "Every event has a cause" is synthetic a priori
        — necessarily true of all possible experience (because the mind so structures it).
        This rescues science without claiming knowledge of things-in-themselves.
Assess: Kant saves objectivity by making causation mind-dependent (transcendental idealism).
        But: does this work against Hume, or merely relocate the problem (why trust the mind)?
Close : Hume demolished dogmatic metaphysics; Kant rebuilt science on critical foundations.
```

### 15-mark: "How does Hume account for ideas of reason? How does Kant respond?" (2026 Q2b)

```text
Frame : Hume denies a separate rational faculty delivering necessary metaphysical content;
        Kant grants the negative premise but restores the Ideas as necessary and regulative.
Body A: Hume's Fork as exhaustive (relations of ideas / matters of fact); "ideas of reason"
        dissolved into relations of ideas (analytic, empty of existence) plus custom-driven
        belief (self, causation, God) mistaken for rational insight.
Body B: Kant's response: no impression/intuition of Soul/World/God, BUT these are necessary,
        structurally-generated products of reason's demand for the unconditioned; regulative,
        not constitutive; a third category the Fork's exhaustiveness never considered.
Assess: Hume's phenomenology stands (no impression); Kant's architectonic claim is itself
        open to a Humean-style challenge (does it explain, or merely relabel?).
Close : Critically discuss = deliver the graded verdict, not a bare juxtaposition.
```

### 20-mark: "Hume's argument that causality is habit/custom — critically analyse" (2023 Q2a)

```text
Frame : Causation is the hinge of empiricism's critique of metaphysics and science's
        rational basis.
Body A: Hume's full analysis — constant conjunction + temporal priority + contiguity; no
        impression of necessary connection; custom/habit as the source of the expectation;
        name the specific principle of ASSOCIATION (cause-and-effect) the question quotes.
Body B: The impression of reflection — the mind's felt compulsion after repeated experience.
        Hume does NOT deny that we *make* causal inferences; he denies they have a *rational*
        foundation. Distinction: practice of inference vs justification of inference.
Body C: Objections — (i) Kant: causality is a priori (see above). (ii) Pragmatic: science
        works — its success is evidence of real causal order. (iii) If causation is mere
        habit, Hume's own *arguments* lose force (self-refutation worry).
Assess: Hume succeeds in showing that *experience alone* cannot ground causal necessity.
        Whether the Kantian a priori solution or a pragmatic/naturalist solution is best
...
### 20-mark: "How does Berkeley establish that Mind and its ideas alone are real? Moore/Russell?" (2018 Q3a)

```text
Frame : Three demands in one question — establish, Moore's reaction, Russell's reaction,
        and the difference between the two reactions.
Body A: Establish — name all five arguments (semantic, likeness, parity, master, continuity/
        God); spirits known by notion; God sustains unperceived ideas.
Body B: Moore — act of awareness ≠ its object; common-sense direct realism restored.
Body C: Russell — logical constructions from sense-data; mind-independent structure sought
        by analysis, not by trusting ordinary objects.
Assess: The difference is a difference of METHOD (direct realism vs logical construction),
        not merely of emphasis.
Close : Berkeley's reply to each — question-begging against Moore's act/object distinction;
        "still ideas" against Russell's sense-data constructions.
```
...
## C.1 Solved PYQ bank — exactly 14 verified Empiricism questions, 2018-2026

> Exact wording, year and marks are parsed from the continuous local Western Philosophy Paper I bank, 2018-2025,
> and its 2026 supplement. Empiricism owns exactly 12 primary parts 2018-2025 plus 2 primary parts in 2026. The
> three "Two Dogmas of Empiricism" questions (2021 Q3c, 2024 Q4c, 2025 Q4b) are `Quine-Strawson.md`-owned and are
> deliberately excluded despite the shared word "empiricism."

### Solved PYQ 1 — 2018 Q1(a), 10 marks

**Question:** Are the two truths — "The Sun will rise tomorrow" and "2+2=4" — of the same necessity for Hume?
Give reasons in favour of your answer.

**Model solution.** **Thesis (directive: give reasons).** No. For Hume the two propositions are certain in
*different senses*: "2+2=4" is a **relation of ideas** (necessary), while "the Sun will rise tomorrow" is a
**matter of fact** (contingent). Treating them as the same necessity is precisely the confusion Hume's Fork
exists to prevent. **Doctrine — Hume's Fork.** Every object of human reason is either a *relation of ideas*
(known a priori by thought alone; denial is self-contradictory) or a *matter of fact* (known a posteriori; the
contrary is always conceivable). "2+2=4": to deny it is to contradict oneself; its necessity is demonstrative and
absolute, independent of what exists. "The Sun will rise tomorrow": "the Sun will not rise" implies **no**
contradiction — it is perfectly conceivable. It cannot be demonstrated; it rests on causal inference, and causal
inference rests on constant conjunction plus **custom**, never on logical necessity. **Analysis.** The felt
certainty of sunrise is a *psychological* assurance produced by habit and the presupposed uniformity of nature,
not a *logical* one. To rank it with "2+2=4" would smuggle demonstrative necessity into a merely probable belief —
the very slide from expectation to necessary connexion that Hume diagnoses. **Verdict.** Both may be called
"certain" in ordinary speech, but the certainties differ in kind: one is logical and unconditional, the other
customary and revisable. Naming the two prongs and applying the conceivability test is the whole answer.

### Solved PYQ 2 — 2018 Q3(a), 20 marks

**Question:** How does Berkeley establish that Mind and its ideas alone are real? How do Moore and Russell react
to Berkeley's view in this regard? Do you find any difference between Moore's reaction and Russell's one? Discuss.

**Model solution.** **Thesis.** Berkeley establishes that only minds and their ideas are real by a **set of
arguments**, not a bare slogan; Moore and Russell both reject the result, but by *different methods*, so there is
a real difference between their reactions. **How Berkeley establishes it.** (1) *Semantic*: sensible things just
are collections of immediately perceived ideas, so their being is being perceived (*esse est percipi*). (2)
*Likeness*: "an idea can be like nothing but an idea," so no idea can resemble an unperceiving material quality.
(3) *Parity/collapse*: every relativity Locke grants for secondary qualities applies to the primary, so all
qualities are ideas and matter has nothing left to be. (4) *Master Argument*: one cannot conceive an unconceived
object. (5) *Continuity*: the involuntary, orderly ideas of sense require an active cause — the infinite Mind,
God. Spirits are known not by ideas (which are passive) but by **notions**. **Moore's reaction.** In "The
Refutation of Idealism," Moore distinguishes the **act** of awareness from its **object**: the awareness of blue
is not identical with blue. Berkeley's inference illegitimately fuses sensing and sensed; once separated, the
object need not depend on the act, and common-sense realism stands. **Russell's reaction.** Russell also refuses
idealism but does not simply trust ordinary objects; he **reconstructs** physical objects by logical analysis as
constructions out of sense-data and their relations, seeking mind-independent structure. **Is there a
difference? Yes.** Moore keeps ordinary objects through the transparency of sensation (direct realism); Russell
replaces ordinary objects with logical constructions. The difference is one of method, not merely emphasis.
**Verdict.** Both deny that existence collapses into being-perceived. Berkeley's reply — that there is no object
over and above the idea — shows the Master Argument to be question-begging, but does not rescue the likeness
principle against structural (non-qualitative) resemblance.

### Solved PYQ 3 — 2019 Q4(b), 15 marks

**Question:** Is there any element of necessity in causal relations according to Hume? Discuss.

**Model solution.** **Thesis.** Yes and no — the answer must **split the locus** of necessity. In the *objects*
there is none; in the *mind* there is a genuine but merely psychological necessity. **In objects — no necessity.**
Applying the Copy Principle, a single instance of causation (one billiard ball striking another) delivers only
priority, contiguity and the succession of qualities; no impression of a *power* or *tie* is given, and repetition
adds nothing to the objects themselves. So causal necessity is not an objective relation in nature. **In the mind
— a subjective necessity.** Repetition does change the *mind*: after constant conjunction it is **determined** to
pass from the idea of A to the idea of B. That felt determination is an **impression of reflection**, and it is a
real, if psychological, necessity — a fact about us, not about things. From it flow the **two definitions** of
cause (philosophical: constant conjunction; natural: the mind's transition). **Analysis.** Hume therefore does not
*abolish* necessity; he **relocates** it from world to mind. The disciplined answer refuses to collapse the two
loci — "no necessity in objects" and "a subjective necessity in the mind" are both true. **Verdict.** There is
necessity in causation for Hume only as projected felt compulsion; objective necessary connexion is a fiction of
the imagination. Naming both definitions secures the marks.

### Solved PYQ 4 — 2020 Q2(a), 20 marks

**Question:** "I never can catch myself at any time without perception, and never can observe anything but the
perception." How does this statement by Hume problematize the philosophical notion of personal identity? How does
Kant deal with this problem in his Critique of Pure Reason?

**Model solution.** **Thesis.** Hume's confession problematizes personal identity by removing any *impression* of
a self, leaving only a **bundle**; Kant answers not by restoring a soul but by making the unity of the self a
**formal condition** of experience. **How Hume problematizes it.** By the Copy Principle every idea needs a
source impression. Introspection ("I never can catch myself… without a perception") finds only a flux of
particular perceptions, never an impression of a simple, continuing "I." So the self is "nothing but a bundle or
collection of different perceptions… in perpetual flux." The ascribed identity is a *fiction* produced by
imagination's habits of resemblance and causation — the same **natural belief** structure that also underwrites
belief in continued bodies. Hume's **Appendix** honestly retracts: he can find no principle that *unites* the
successive perceptions. **How Kant deals with it.** Kant grants that there is no *empirical intuition* of the
self. But the "**I think**" must be *able* to accompany all my representations, as the condition of their
belonging to one consciousness — the **transcendental unity of apperception**. This is a formal, a priori
condition of unified experience, not an observed inner object and not a Cartesian ego-substance. **Verdict.** Kant
concedes Hume's negative point (no impression of a self) while denying his conclusion (therefore no unifying
subject). The bundle is the last casualty of an atomism of impressions in which no relation can itself be
perceived; Kant's reply targets that atomism, relocating unity from something *found* to something *presupposed*.
(The Buddhist anatta parallel may be noted.)

### Solved PYQ 5 — 2021 Q1(c), 10 marks

**Question:** "Sensible things are those only which are immediately perceived by sense." Explain Berkeley's
theory of knowledge with reference to the above statement.

**Model solution.** **Thesis.** The quoted line states Berkeley's **semantic argument**: since sensible things are
*only* what is immediately perceived, their whole being is to be perceived — *esse est percipi*.
**Explanation.** For Berkeley the immediate objects of sense are **ideas**. What we call a "thing" (an apple, a
table) is a stable collection of such immediately perceived ideas — colours, tastes, shapes, sounds. Anything
"mediately" inferred behind them (a material substratum) is never itself perceived, so belief in it has no
experiential content and is meaningless. Hence, for sensible things, to be is to be perceived; and minds
(spirits), which do the perceiving, are known not by ideas but by **notions**. **Anti-sceptical point.** Because
there is no unperceivable matter behind our ideas, there is no "veil of perception" to breed doubt: we perceive
real things *directly* (they are ideas), and God's constant perception secures their continuity. **Verdict.** The
statement is the compressed form of the whole system: restrict reality to the immediately perceived, and idealism
follows without scepticism.

### Solved PYQ 6 — 2021 Q1(d), 10 marks

**Question:** Examine the concept of personal identity by Locke.

**Model solution.** **Thesis (directive: examine).** Locke's criterion is **continuity of consciousness**, not
sameness of soul or body/"man"; it is a genuine advance, but the examining eye must expose that memory alone
cannot carry the whole weight. **The doctrine.** Personal identity consists in the same *consciousness* extended
backwards through memory. It is neither sameness of material body/"man" (which changes through continued organic
life, not fixed particles) nor sameness of thinking substance/soul (which could be swapped unnoticed) — Locke's
three-tier distinction (substance/man/person) keeps these questions separate. The **prince and the cobbler**
isolate the thesis: transfer the prince's consciousness into the cobbler's body and the *person* of the prince
goes with the consciousness, though the "man" stays the cobbler's. **Examination — objections.** (i)
**Circularity** (Butler): I can remember only *my own* past experiences, so identity is presupposed before memory
can confirm it. (ii) **Transitivity failure** (Reid's **Brave Officer**): the general remembers the officer, the
officer the flogged boy, but the general not the boy; by Locke's rule general = officer = boy yet general is not
boy. Repair: **overlapping chains** of memory restore transitivity. **Verdict.** Locke rightly detaches the person
from both body and soul and ties identity to moral answerability; but memory is at best part of the criterion,
and later psychological-continuity theories are repairs of Locke, not replacements.

### Solved PYQ 7 — 2021 Q1(e), 10 marks

**Question:** "The relation between cause and effect is one of constant conjunction." Examine Hume's criticism
of causation in the light of the above statement.

**Model solution.** **Thesis.** The statement gives the purely Humean *objective* definition of cause: all that
"cause and effect" denotes in the objects is **constant conjunction** — there is no perceivable necessary
connexion. **Hume's criticism, in steps.** (1) In any single instance we observe only temporal priority, spatial
contiguity and the succession of qualities — never a *power* binding cause to effect. (2) Repetition adds nothing
to the objects; the hundredth collision is, in the objects, no different from the first. (3) What repetition
changes is the **mind**: after constant conjunction it is *determined* to expect B on seeing A. (4) That felt
determination is an **impression of reflection**, the true source of the idea of necessity. (5) Hence the **two
definitions** of cause — philosophical (constant conjunction) and natural (the mind's transition). **Analysis.**
"The relation… is one of constant conjunction" is therefore the *objective* half of the story: necessity is not
*in* the relation but **projected** onto it by custom/habit, "the great guide of human life." **Verdict / trap.**
Hume does not deny that we make causal inferences (custom compels them); he denies the *idea of necessary
connexion in objects*. Reading the line as "mere succession" is incomplete — it omits contiguity, priority and the
felt necessity.

### Solved PYQ 8 — 2022 Q4(c), 15 marks

**Question:** Why and how does John Locke refute the innate ideas? Elucidate the nature and source of knowledge
in Locke's epistemology.

**Model solution.** **Thesis.** Locke refutes innate ideas because, once experience is shown to supply every idea,
innate content is **unnecessary and unevidenced**; his positive epistemology then derives all knowledge from
**sensation and reflection**. **Why he refutes innate ideas.** (1) The **universal-consent** argument fails: if
principles like identity or "the whole is greater than the part" were innate, all would assent, yet children and
"idiots" show no awareness of them. (2) The dispositional rescue ("innate but not yet noticed") is ruled out by
Locke's stipulation that "to be in the mind" *is* "to be perceived by the mind" — an unperceived idea in the mind
is a contradiction. (3) Innate ideas are in any case **superfluous** once experience can account for the same
content. **How — the nature and source of knowledge.** The mind at birth is "**white paper, void of all
characters**" (*tabula rasa*). Two fountains supply ideas: **sensation** (the outer world) and **reflection** (the
mind observing its own operations). **Simple ideas** are received passively; the mind actively combines them into
**complex ideas** (modes, substances, relations). Knowledge is the perception of the agreement/disagreement of
ideas and comes in **degrees** — *intuitive* (most certain), *demonstrative* (via intervening ideas), *sensitive*
(of particular existents, least certain but reliable). **Verdict.** Locke's argument defeats a *naive* innatism
(fully formed conscious principles at birth). It does not touch the **dispositional** innatism that Descartes and
Leibniz actually held (Leibniz's "veined marble"). His enduring contribution is the derivation programme —
experience as the sole source, with reflection kept as an *active* second source so the mind is not merely
passive.

### Solved PYQ 9 — 2023 Q2(a), 20 marks

**Question:** Critically analyse Hume's argument that causality is a matter of habit/custom involving
psychological principle of association.

**Model solution.** **Thesis (directive: critically analyse).** Hume's reduction of causality to habit/custom,
powered by the psychological principle of **association**, is unanswerable *as a description of what perception
gives* — but it rests on contestable presuppositions, and its verdict must be qualified rather than simply
endorsed. **Exposition.** *Negatively*: by the Copy Principle no impression of *power* is found in any single
instance (billiard balls, bread nourishing); repetition adds nothing to the objects. *Positively*: repetition
determines the **mind** to pass from A to B; this felt determination is an **impression of reflection**. The
transition is governed by the principles of **association** — resemblance, contiguity and cause-effect — the
"gentle force" that carries the imagination from one idea to the next. Hence the **two definitions** of cause
(constant conjunction; mental transition) and the reduction of necessity to custom, "the great guide of human
life." **Critical analysis — presuppositions.** (P1) the Copy Principle is treated as exceptionless — yet Hume
himself concedes the **missing shade of blue**; (P2) causation must be *visible in a single instance* if it is
objective at all; (P3) impressions are **atomic and separable**, so no relation is given with its terms; (P4)
necessity must be either observed or projected, with no third option such as an inferred theoretical posit.
**Kant** attacks exactly this: causality is an a priori **category**, a condition of objective experience,
supplying the necessity perception cannot. **Verdict.** As phenomenology of the given, Hume is decisive; as
metaphysics, his atomism makes lawful, theoretical necessity look illegitimate *by fiat*. The graded position:
accept the psychological account, reject the atomist premise that rules out non-observational necessity.

### Solved PYQ 10 — 2024 Q2(a), 20 marks

**Question:** Is rejection of Locke's notion of primary qualities instrumental in Berkeley's leaning towards
idealism? In this context, also discuss how subjective idealism is different from the absolute idealism proposed
by Hegel.

**Model solution.** **Thesis.** Yes — with qualification. Rejecting the privileged status of Locke's **primary
qualities** removes matter's last foothold and is genuinely *instrumental* in Berkeley's idealism; but Berkeley's
**nominalism** does the deeper work. And Berkeley's *subjective* idealism differs **in kind** from Hegel's
*absolute* idealism. **The instrumental role.** Locke made primary qualities (extension, figure, motion) really
resemble our ideas, while secondary qualities were mere powers. Berkeley's **parity argument** shows that every
relativity used to subjectivise the secondary (variation with observer, organ, medium) applies equally to the
primary (apparent size, shape, motion vary too). So either all qualities are mind-dependent or none are; since
Locke concedes it for the secondary, parity drags the primary along. Once no quality is left to inhere in matter,
and the likeness principle ("an idea can be like nothing but an idea") blocks resemblance to an unperceiving
substratum, "matter" has nothing to be. In this precise sense rejecting primary qualities is instrumental —
though the argument is completed only by Berkeley's prior denial of **abstract ideas**. **Subjective vs absolute
idealism.** *Berkeley*: reality is **ideas in finite and divine minds** — things are mind-dependent, sustained by
God's perceiving; existence is being perceived. *Hegel*: reality is the **self-development of Absolute Spirit
(Geist) through dialectic** — Mind developing itself as the very substance of the world. So Berkeley's idealism is
*subjective* (depends on minds that already exist and perceive), Hegel's is *objective/absolute* (finite minds
and world alike are moments in one self-unfolding Absolute). **Verdict.** Instrumental, yes, but not sufficient
alone; and the two idealisms differ in **kind, not degree** — Hegel's Absolute is not "Berkeley writ large."

### Solved PYQ 11 — 2025 Q2(c), 15 marks

**Question:** Examine Hume's refutation of Causal relation and Kant's response to it.

**Model solution.** **Thesis.** Hume refutes the *objective* causal relation by finding no impression of
necessary connexion; Kant responds not by observing such a connexion but by making causality an a priori
**category** that constitutes objective experience. **Hume's refutation.** In any instance we perceive only
priority, contiguity and constant conjunction; no *power* or *tie* is given, and repetition adds nothing to the
objects. The idea of necessity is copied from an **impression of reflection** — the mind's felt determination to
pass from A to B after constant conjunction. Hence necessity is **projected**, not perceived; causal inference
rests on **custom/habit**, and two definitions of cause follow. Extended to induction, the Uniformity Principle
can be justified neither demonstratively (its denial is not contradictory) nor experientially (circular).
**Kant's response.** Awakened by Hume from "dogmatic slumber," Kant concedes that no *impression* of necessity
exists, but denies Hume's conclusion. The concept of cause is a **pure concept of the understanding** (a
category); the principle "every event has a cause" is a **synthetic a priori** condition without which objective,
ordered experience of a temporal world would be impossible. Necessity is real but its seat is the **mind's
constitution of objects**, not the objects in themselves (transcendental idealism). **Verdict.** Kant meets Hume
by relocating necessity from *habit* to the *a priori form* of experience — preserving science's lawfulness while
accepting Hume's point that necessity is not read off perception. The unresolved cost is that necessity holds only
for phenomena, not things-in-themselves.

### Solved PYQ 12 — 2025 Q4(c), 15 marks

**Question:** Explain Berkeley's doctrine of nominalism and his refutation of Abstract ideas.

**Model solution.** **Thesis.** Berkeley's **nominalism** — the denial of **abstract general ideas** — is the
indispensable first premise of immaterialism: there is no abstract idea of "matter" or "existence" apart from
being perceived. **Refutation of abstract ideas.** Against Locke, Berkeley argues that the mind simply **cannot
frame** an abstract general idea — for instance, an idea of a triangle that is "neither oblique nor rectangle,
equilateral nor scalene, but all and none of these at once." Every idea we actually have is fully **particular**
(this determinate colour, this determinate shape). Introspection never yields the indeterminate abstract image
Locke's doctrine requires. **How generality is preserved (nominalism).** Words are general, not ideas. A
**particular** idea becomes general by **representative function** — it *stands for* all other particulars of
the same sort. "Triangle" in a proof signifies any triangle because the particular figure drawn represents all;
the generality lies in the *use/sign*, not in a special abstract object. **Consequence for immaterialism.** Since
there is no abstract idea, there is no legitimate abstract idea of **existence unperceived**, nor of a quality
existing in an unthinking **substratum**. "Matter" is exposed as an empty abstraction — the very fiction Locke's
doctrine of abstraction had made to seem intelligible. So the refutation of abstract ideas clears the ground on
which *esse est percipi* is built. **Verdict.** Nominalism is not a side-doctrine but the **engine**: destroy
abstraction and the abstract idea of matter falls with it. This is why the examiner pairs "nominalism" and
"abstract ideas" — they are one movement.

### Solved PYQ 13 — 2026 Q1(b), 10 marks

**Question:** Explain the distinction between Intuitive knowledge and Demonstrative knowledge as propounded by
Locke.

**Model solution.** **Thesis.** Knowledge, for Locke, is the perception of the agreement or disagreement of ideas
(*Essay* IV.i.2); intuitive and demonstrative knowledge differ not in *subject matter* but in the **mode** by
which that agreement is perceived — immediately, or only through intervening ideas. **Intuitive knowledge.** The
mind perceives the agreement/disagreement of two ideas **immediately, without the intervention of any other
idea** — "white is not black"; "three is more than two"; one's own existence. It is the highest degree: irresistible,
leaving no room for doubt, and it is the "light" by which all other knowledge is seen. **Demonstrative
knowledge.** Where the agreement cannot be seen at once, the mind must find **intermediate ideas ("proofs")**
connecting the two termini — the paradigm is mathematical proof, and Locke also holds God's existence is
demonstrated (from one's own existence) and hopes morality could be demonstrative. Because each intervening step
is itself perceived intuitively, **demonstration is a chain of intuitions** — certain, but lower than intuition
because it is successive, requires attention, and depends on **memory** to hold earlier steps while later ones
are formed; error can enter through a missed or misremembered step. **Qualification.** Sensitive knowledge (of
the existence of particular things before the senses) is a third, anomalous degree, ranked lowest, since "this
thing exists" does not straightforwardly fit the agreement-of-ideas definition — but it is not required by this
specific demand. **Verdict.** The distinction is one of luminosity and mode of access, not a demotion of
demonstration to mere opinion: both are genuine knowledge, and Locke ranks them by how directly the mind sees the
connection.

### Solved PYQ 14 — 2026 Q2(b), 15 marks

**Question:** How does Hume account for ideas of reason? How does Kant respond to Hume's views in this regard?
Critically discuss.

**Model solution.** **Thesis.** Hume denies that "reason" is an independent faculty delivering necessary
metaphysical ideas at all: everything the rationalist tradition attributed to reason reduces, on his analysis, to
**relations of ideas** (empty of existential content) plus **custom-driven belief** mistaken for rational insight;
Kant grants Hume's negative premise but restores the Ideas of Reason as **necessary, structurally-generated,
regulative** products of reason's own architecture. **Hume's account.** Hume's Fork divides every object of human
enquiry into just two kinds — relations of ideas and matters of fact — leaving no third category of "truths of
pure reason." What the rationalists meant by reason's necessary ideas is fully captured by *relations of ideas*
(arithmetic, geometry): certain, but only because empty of any claim about existence. Where the tradition claimed
*further* rational ideas — a necessary causal connection, an immaterial simple self, a demonstrated first cause —
Hume's Copy Principle finds no answering impression, and what actually produces the felt conviction is **custom**,
the associative principle of cause-and-effect operating with such regularity that it masquerades as rational
insight. Hume thus "accounts for" ideas of reason by **dissolving the category**, not by explaining a genuine
third kind of idea. **Kant's response.** Kant agrees no impression or sensory intuition delivers the Soul,
World-totality or God as objects — they cannot be theoretically known. But he denies these Ideas are arbitrary
psychological accidents: they are **necessary products of reason's own drive** to seek the unconditioned
condition for anything the understanding gives it conditionally, arising systematically (Soul from the
paralogisms, World from the antinomies, God from the transcendental Ideal) rather than contingently, as a custom
could. Their function is **regulative, not constitutive** — indispensable guides to systematic enquiry, not
proofs of really-existing objects. **Critical discussion.** Kant thus supplies a **third category** the Fork's
apparent exhaustiveness never considered — necessary regulative Ideas that are neither empty relations of ideas
nor contingent matters of fact. Whether this is a genuine discovery about reason's structure or a relabelling of
the very custom-driven phenomena Hume already described remains the open question, exactly parallel to the
induction dispute (both concern whether Hume's two-box Fork was ever proven exhaustive). **Verdict.** Hume's
phenomenology of what is and is not given in experience stands; Kant's architectonic response is the strongest
available reply, but it succeeds only if reason's demand for the unconditioned is itself more than a
philosopher's redescription of a psychological tendency — a cost Kant accepts and Hume would resist.

---

## C.2 Original MCQ mastery set — exactly 40 questions

> Questions 1-24 are core coverage across all ten lessons; 25-32 are remedial items targeting the most common
> misreadings; 33-40 cover the 2026 questions and the restored gap-ledger material. Correct answers rotate
> strictly A → B → C → D across the whole sequence, with zero consecutive repeats, including at every
> ten-question join.
...
**Explanation:** Transfer the prince's consciousness into the cobbler's body and the person is the prince, though
the "man" (living body) is the cobbler; identity tracks consciousness, not the body.

### MCQ 12

Locke's three-tier identity distinction separates identity of substance, identity of "man," and identity of
"person" on the ground that:

A. all three tiers are answered by the same criterion of sameness
B. "man" identity requires the very same particles of matter throughout life
C. "person" identity requires an unchanging soul-substance
D. each tier asks a genuinely different question: same matter, same continued organic life, or same consciousness

**Correct answer: D**

**Explanation:** Substance identity is strict material sameness; "man" identity is continued organic life
organising changing matter; person identity is sameness of consciousness — three distinct questions, which is why
the prince-cobbler case can pull "man" and "person" apart.
...
A. every general word secretly names an abstract, indeterminate idea
B. generality is innate and requires no explanation
C. a particular idea is "made to represent or stand for" all other particulars of the same sort
D. only mathematicians can use general words correctly

**Correct answer: C**

**Explanation:** A determinate particular idea, selectively attended to, does duty for a class; the geometer
draws this triangle and proves a theorem about all triangles, with no abstract, indeterminate idea needed.
...
C. impressions from ideas
D. the act of awareness from its object

**Correct answer: D**

**Explanation:** The awareness of blue is not identical with blue; "esse is percipi" illegitimately fuses the
sensing and the sensed.
...
**Explanation:** They differ in kind, not degree: Hegel's Absolute is the world's self-unfolding substance, not
"Berkeley writ large."
...
Locke's demonstrative knowledge is ranked lower than intuitive knowledge because:

A. demonstration is really a chain of intuitions, dependent on memory and successive steps
B. demonstrative knowledge is not really knowledge at all
C. demonstration concerns only sensitive existence
D. intuition requires more time and attention than demonstration

**Correct answer: A**

**Explanation:** Each link in a demonstration is itself intuitive, but the chain as a whole takes time, attention
and reliable memory, making it more error-prone and less "clear and bright" than a single act of intuition.

### MCQ 34 (restored gap)

In Locke's three-tier identity distinction, sameness of "man" (the living human animal) consists in:

A. sameness of consciousness alone
B. one continued life organising a fit succession of changing particles, as with a plant or animal
C. an unchanging soul-substance
D. exactly the same mass of material particles throughout life

**Correct answer: B**

**Explanation:** This is a biological-continuity criterion, independent of consciousness, which is precisely why
the "man" and "person" tiers can diverge, as the prince-cobbler case shows.

### MCQ 35 (2026-topic)

According to Hume's account of "ideas of reason" (2026 Q2b), what the rationalist tradition called necessary
truths of reason is, for Hume:

A. delivered by a separate, non-empirical faculty of pure Reason
B. impossible to explain at all
C. fully captured by relations of ideas, which are certain only because empty of existential content
D. identical in every respect to matters of fact

**Correct answer: C**

**Explanation:** Hume's Fork leaves no third category; "reason's" necessary truths are relations of ideas, while
everything else the tradition credited to reason (causal necessity, the self, God) is custom-driven belief
...
C. relations of ideas in Hume's own sense
D. necessary, structurally-generated products of reason's demand for the unconditioned, serving a regulative function

**Correct answer: D**

**Explanation:** Kant grants Hume's negative point (no impression/intuition of these objects) but denies they are
psychological accidents; they arise systematically from reason's own architecture and guide, without
...
Berkeley's "metaphysical payload" argument shows that, once abstraction is refuted:

A. God's existence can no longer be inferred
B. Berkeley must therefore abandon his own immaterialism
C. Locke's "matter" is revealed to be an empty abstraction, not merely an unknown one, since nominalism is the deeper engine of immaterialism
D. primary qualities become more secure than before

**Correct answer: C**

**Explanation:** The abstract idea of "substance-in-general" plus the relative notion of "supporting" is exactly
the kind of abstract general idea Berkeley's nominalism rules out, so "matter" is meaningless, not merely
unknown, and immaterialism rests on nominalism rather than the reverse.

### MCQ 40 (restored gap)

Hume's own conceded exception to the strict Copy Principle is:

A. the idea of extension
B. the idea of God
C. the idea of a triangle
D. the missing shade of blue, which the imagination can supply without an antecedent impression

**Correct answer: D**

**Explanation:** A man who has seen every shade of blue but one can, Hume grants, imagine the missing shade,
showing the Copy Principle is an empirical generalisation with a conceded exception, not an exceptionless
analytic truth; Hume judges the case too singular to revise his general maxim.
...
**Model solution.** Locke's image denies innate ideas: the mind at birth carries no characters, and every idea
...
**Model solution.** Berkeley's paradox is that abolishing matter is meant to *save* ordinary belief. His case has
...
**Model solution.** The statement reads Hume not as breaking empiricism but as **completing** it. Locke admitted
...
> Last section by design: revise only after teaching and practice. One compressed block per lesson, topic-
> specific, retrieval-ready. Immediately followed only by the required coverage-lock matrix and source ledger.
...
- **Mitigated scepticism**: modest, evidence-proportioned enquiry, not Pyrrhonian suspension.
- **Liberty/necessity (compact, cross-owned):** necessity redefined as constant conjunction/inference from
  motives; liberty = freedom from constraint — compatibilism.
- **Hume's God**: causal and design proofs fail; miracles argument; natural theology collapses into causal
  scepticism.
- **Contemporary application (labelled):** machine-learning prediction operationalises inductive habit but
  neither proves necessity nor solves Hume's logical problem (IIARD 2026); an application, never doctrinal proof.
...
- Criticisms and replies for each thinker; marks-essential owner vs optional-enrichment boundary; ten UPSC traps;
...
- Fourteen solved PYQs (2018-2026), forty rotation-checked MCQs, three original Mains answers — all in Part C
  above.
...
|---|---|---|
| One-screen map; source map and common-project boundary | Section 0, Section 0A | 1 |
| Simple/complex ideas as shared vocabulary across all three thinkers | Section 1.1 (extracted), Section 1.3 (extracted) | 1 |
| Internal logic — why empiricism "slides" (atomism of impressions) | Section 5 | 1 |
| Attack on innate ideas (consent, no-unconscious-idea, genetic account) | Section 1.1 | 2 |
| Tabula rasa; sensation/reflection; simple/complex ideas (modes, substances, relations) | Section 1.1 | 2 |
| Degrees of knowledge — intuitive/demonstrative/sensitive (full argument, presuppositions, objection ledger, discrimination table) | Section 1.1 (owner block) | 2 |
| Abstract general ideas — Locke's positive doctrine, the general-triangle admission | Section 1.1 | 3 |
| Nominal essence / real essence | Section 2.1 | 3 |
| Representative realism ("veil of perception") | Section 1.1 | 3 |
| Primary vs secondary qualities | Section 2.1 | 3 |
| Substance as "something I know not what" | Section 2.1 | 3 |
| Personal identity — continuity of consciousness, prince-cobbler, forensic concept | Section 3.1 | 4 |
| Locke's three-tier identity distinction (substance/man/person) — restored expansion | Section 3.1 (one line), expanded here | 4 |
| Circularity (Butler) and transitivity/Brave Officer (Reid) objections | Section 3.1 | 4 |
| Locke's demonstrative proof of God | Section 3.2 | 4 |
| Berkeley's semantic, likeness, parity/collapse and Master arguments | Section 2.2 (Arguments 1-4) | 5 |
| Scope/agency/illusion/science machinery (notion vs idea; laws as signs) | Section 2.2A | 5, 6 |
| Argument 5 (continuity/God); spirits (self as active substance); God as cause | Section 2.2 (Argument 5), Section 3.3, Section 3.4 | 6 |
| Berkeley "saves" common sense; anti-sceptical idealism | Section 2.2, Section 4.2 | 6 |
| Berkeley's abstraction/nominalism demolition (7-step argument, Locke's reply table, executable verdict) | Section 1.1 (embedded), relocated | 6 |
| Moore and Russell against Berkeley; the 2018 comparison | Section 2.2C, restored dossier | 6 |
| Berkeley's subjective idealism vs Hegel's absolute idealism | Section 2.2B | 6 |
| Impressions/ideas; Copy Principle; missing-shade exception (first flagged) | Section 1.3 | 7 |
| Association — general theory (resemblance, contiguity, cause-and-effect) — restored as a named general doctrine | Section 1.3 (one clause), expanded here | 7 |
| Hume's Fork (relations of ideas vs matters of fact) | Section 1.3 | 7 |
| Substance dissolution (general statement, material and spiritual) | Section 2.3 | 7 |
| 2026 Q2(b) — Hume's account of "ideas of reason" and Kant's response — full newly-authored teaching | Section 10 (owner-block note only) | 7 (Part B) |
| Bundle theory of self; Appendix retraction; Buddhist anatta parallel | Section 3.5 | 8 |
| Natural belief — general doctrine (continued/external existence + self) — restored and named | Section 2.3A (un-named) | 8 |
| Kant's response to the bundle problem (transcendental unity of apperception) | Section 3.5A | 8 |
| Causation — full analysis, two definitions, Kant's response | Section 4.3 | 9 |
| Problem of induction; missing shade of blue (full deployment); mitigated scepticism | Section 4.3 | 9 |
| Liberty/necessity (Hume's compatibilism) — restored, compact, cross-owned | Section 7A (flagged out of scope) | 9 (Part C) |
| Hume's God (causal, design, miracles) | Section 3.6 | 9 (Part D) |
| Inter-thinker/inter-school comparison table (complete) | Section 6 | 10 (Part A) |
| Criticisms and replies (all three thinkers) | Section 7 | 10 (Part A) |
| Marks-essential owner vs optional enrichment | Section 7A | 10 (Part A), applied per lesson |
| Common UPSC traps (ten-row ledger) | Section 8 | 10 (Part A) |
| Keyword and statement bank (twenty items) | Section 9 | 10 (Part A) |
| Directive decoder | Section D | 10 (Part A) |
| Graded verdict bank | Section V | 10 (Part A) |
| Translation, quotation and provenance discipline | Section T | 10 (Part A) |

## PYQ coverage (14 parts, 2018-2026, all solved)

| Year | Q. | Marks | Primary lesson (teaching) | Solved in |
|---|---|---:|---|---|
| 2018 | Q1(a) | 10 | 7 | Lesson 10, Part C, Solved PYQ 1 |
| 2018 | Q3(a) | 20 | 5, 6 | Lesson 10, Part C, Solved PYQ 2 |
| 2019 | Q4(b) | 15 | 9 | Lesson 10, Part C, Solved PYQ 3 |
| 2020 | Q2(a) | 20 | 8 | Lesson 10, Part C, Solved PYQ 4 |
| 2021 | Q1(c) | 10 | 5 | Lesson 10, Part C, Solved PYQ 5 |
| 2021 | Q1(d) | 10 | 4 | Lesson 10, Part C, Solved PYQ 6 |
| 2021 | Q1(e) | 10 | 9 | Lesson 10, Part C, Solved PYQ 7 |
| 2022 | Q4(c) | 15 | 2 | Lesson 10, Part C, Solved PYQ 8 |
| 2023 | Q2(a) | 20 | 9 (association: 7) | Lesson 10, Part C, Solved PYQ 9 |
| 2024 | Q2(a) | 20 | 3, 5, 6 | Lesson 10, Part C, Solved PYQ 10 |
| 2025 | Q2(c) | 15 | 9 | Lesson 10, Part C, Solved PYQ 11 |
| 2025 | Q4(c) | 15 | 3, 6 | Lesson 10, Part C, Solved PYQ 12 |
| 2026 | Q1(b) | 10 | 2 | Lesson 10, Part C, Solved PYQ 13 |
| 2026 | Q2(b) | 15 | 7 (Part B) | Lesson 10, Part C, Solved PYQ 14 |

## Cross-paper PYQ (owned elsewhere, required content taught here)

| Paper | Q. | Owner | Content location |
|---|---|---|---|
| Paper II, Philosophy of Religion | 2025 Q6(a) | `Proofs-for-God.md` | Lesson 9, Part D |

## Practice coverage

| Practice element | Count | Location |
|---:|---:|---|
| Solved PYQs (verified, 2018-2026) | 14 | Lesson 10, Part C.1 |
| MCQs (conceptual, applied, comparative — core set) | 24 | Lesson 10, Part C.2, MCQ 1-24 |
| MCQs (remedial) | 8 | Lesson 10, Part C.2, MCQ 25-32 |
| MCQs (2026-topic and restored-gap) | 8 | Lesson 10, Part C.2, MCQ 33-40 |
...
| Source | Role |
|---|---|
| `upsc-ai-kit/knowledge/Philosophy/paper-1/western/Empiricism.md` | Canonical owner; read in full (Sections 0-12, D, V, T, restored 2018/2020 doctrine dossier, corpus-driven depth delta) |
| `upsc-ai-kit/knowledge/Philosophy/paper-1/western/Kant.md` Section 4 | Cross-owned canonical file for the "Ideas of Reason" comparison; read in full |
| `upsc-ai-kit/knowledge/Philosophy/paper-1/western/Rationalism.md` Section 1.5A | Cross-owned — Descartes' dispositional innatism, Locke's reply target (Lesson 2) |
| `upsc-ai-kit/knowledge/Philosophy/indian/Buddhism.md` | Cross-owned — anatta/nairatmyavada parallel (Lesson 8), consulted for the bridge only |
| `upsc-ai-kit/knowledge/Philosophy/paper-1/western/Logical-Positivism.md` | Cross-owned — Hume's Fork as verification-principle ancestor (Lesson 7) |
| `upsc-ai-kit/knowledge/Philosophy/paper-2/philosophy-of-religion/Proofs-for-God.md` | Cross-owned — Hume's design-argument critique, cross-paper PYQ (Lesson 9) |
| `Empiricism_Layered-Complete-Learning-Session_2026-08-18.md` | Prior approved package — structural and practice base; read in full |
| `Empiricism_Layered-Solved-Practice-Workbook_2026-08-18.md` | Verified as a mirror of the layered session's own Part II; cross-checked, not separately re-derived |
...
- **Mandatory gap audit:** the 2026 Q2(b) Hume/Kant "ideas of reason" content, the three-tier identity
  distinction, the general theory of association, the named "natural belief" doctrine, and the compact
  liberty/necessity cross-link are confirmed absent or under-taught in the canonical/prior-package sources and
  restored as internal Parts/expansions without altering the frozen roadmap. Result: **PASS**.
- **MCQ rotation:** 40 MCQs; correct answers verified to rotate strictly A to B to C to D across the whole
  sequence (A,B,C,D repeated ten times) with zero consecutive repeats, including at the MCQ 24/25 and MCQ 32/33
  joins. Result: **PASS**.
...
- No canonical, generated-package or PYQ-ledger source file listed above was modified while producing this live
  ...
  `live_sessions/Western-Philosophy/03-Empiricism/Learning-Session-Live-Edition.md`.
