# International Relations Semantic-Completeness Review 09 - Indian Diaspora, Consular Protection and Soft Power

**Topic key:** `international-relations-09`  
**Review date:** 6 September 2026  
**Result:** PASSED  
**Canonical Basic owner:** `upsc-ai-kit\knowledge\International-Relations\basic\09_Indian-Diaspora-Consular-Protection-and-Soft-Power.md`  
**Accepted identity:** `international-relations-09:learner-v2:g5`
...
Validation passed: 138 main pages,
85 workbook pages,
...
The authoritative queue advanced exactly one topic to `international-relations-10`.

Machine validation:
`upsc-ai-kit\manifests\exports\international-relations-09-semantic-validation-2026-09-06.json`

Inventory:
`upsc-ai-kit\manifests\exports\international-relations-09-semantic-completeness-2026-09-06-changed-files.txt`
