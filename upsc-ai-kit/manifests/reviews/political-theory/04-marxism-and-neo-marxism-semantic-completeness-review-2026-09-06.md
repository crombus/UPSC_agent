# Political Theory Semantic-Completeness Review 04 - Marxism and Neo-Marxism
...
**Accepted identity:** `political-theory-04:learner-v2:g5`
...
Validation passed: 44 main pages,
29 workbook pages,
...
The authoritative queue advanced exactly one topic to `political-theory-05`.

Machine validation:
`upsc-ai-kit\manifests\exports\political-theory-04-semantic-validation-2026-09-06.json`

Inventory:
`upsc-ai-kit\manifests\exports\political-theory-04-semantic-completeness-2026-09-06-changed-files.txt`
