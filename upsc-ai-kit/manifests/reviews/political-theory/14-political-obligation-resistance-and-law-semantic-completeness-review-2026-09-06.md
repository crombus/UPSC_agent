# Political Theory Semantic-Completeness Review 14 - Political Obligation, Resistance and Law

**Topic key:** `political-theory-14`  
**Review date:** 6 September 2026  
**Result:** PASSED  
**Canonical Basic owner:** `upsc-ai-kit\knowledge\Political-Theory\basic\14_Political-Obligation-Resistance-and-Law.md`  
**Accepted identity:** `political-theory-14:learner-v2:g4`
...
Approval remains false. PYQ status: 4 verified Philosophy Optional questions retained as explicitly cross-owned applications.

Validation passed: 56 main pages,
29 workbook pages,
10 solved blocks, 48 MCQs,
12/12 ASCII panels and
12/12 graphical stages. Targeted tests:
84; failures: 0.

The authoritative queue advanced exactly one topic to `political-theory-15`.

Machine validation:
`upsc-ai-kit\manifests\exports\political-theory-14-semantic-validation-2026-09-06.json`

Inventory:
`upsc-ai-kit\manifests\exports\political-theory-14-semantic-completeness-2026-09-06-changed-files.txt`
