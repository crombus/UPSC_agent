...
) / "Philosophy-Optional/Philosophy-Paper-I-—-Western-Philosophy/01-Plato-and-Aristotle"
FORMAL_SOURCES = {
    "session": SOURCE_DIR / "Learning-Session.md",
    "workbook": SOURCE_DIR / "Solved-Practice-Workbook.md",
}
CANONICAL = REPO / "knowledge/Philosophy/paper-1/western/Plato-Aristotle.md"
PYQ_LEDGERS = (
...
PANEL_REVIEW = {
    1: {
        "destinations": [
            ("CONCEPT SPINE — ENGLISH FIRST, GREEK IMMEDIATELY AFTER", ["transcendent form", "immanent", "substance"]),
            ("1. The matched comparison", ["separation", "universals"]),
        ],
        "propositions": [
            ("shared_problem", ["character", "knowledge"]),
            ("rival_answers", ["transcendent", "immanent"]),
            ("residual_costs", ["participation", "universals problem"]),
        ],
    },
    2: {
        "destinations": [
            ("ORIGIN AND CHRONOLOGY — THE MINIMUM NEEDED TO AVOID ANACHRONISM", ["socrates", "academy", "metaphysics"]),
        ],
        "propositions": [
            ("chronology", ["academy", "lyceum"]),
            ("textual_map", ["categories", "metaphysics"]),
            ("cautions", ["disputed", "parmenides"]),
        ],
    },
    3: {
        "destinations": [
            ("1. What a Form is — the definition, stated exactly", ["eternal", "immutable", "non-material", "separate"]),
        ],
        "propositions": [
            ("properties", ["eternal", "immutable", "non-material"]),
            ("separation", ["separate", "standard"]),
            ("cautions", ["concepts", "somewhere"]),
        ],
    },
    4: {
        "destinations": [
            ("2. The four arguments for the Forms", ["one-over-many", "knowledge", "opposites", "recollection"]),
        ],
        "propositions": [
            ("one_many", ["one-over-many"]),
            ("knowledge", ["knowledge", "unchanging"]),
            ("opposites", ["opposites", "relativity"]),
            ("recollection", ["recollection", "equality"]),
        ],
    },
    5: {
        "destinations": [
            ("4. Ideas are timeless and spaceless", ["timeless", "spaceless"]),
            ("5. Substance for Plato — the inversion to hold on to", ["substance", "universal", "derivative"]),
        ],
        "propositions": [
            ("timeless_spaceless", ["timeless", "spaceless"]),
            ("stability", ["generation", "alteration"]),
            ("platonic_substance", ["substance", "universal", "derivative"]),
        ],
    },
    6: {
        "destinations": [
            ("1. The Sun (Republic VI 507a–509c) — the principle", ["good", "knowability", "being"]),
            ("🖼️ VISUAL — the Divided Line, with the discriminator that decides the marks", ["eikasia", "pistis", "dianoia"]),
        ],
        "propositions": [
            ("sun", ["good", "knowability", "being"]),
            ("line", ["eikasia", "pistis", "dianoia"]),
            ("integrated_scale", ["visible", "intelligible"]),
        ],
    },
    7: {
        "destinations": [
            ("🖼️ VISUAL — the Divided Line, with the discriminator that decides the marks", ["hypotheses", "images", "dialectic"]),
            ("2. The Line (Republic VI 509d–511e) — the scale", ["segments", "ratio", "equal"]),
        ],
        "propositions": [
            ("primary_cut", ["segments", "ratio"]),
            ("method_difference", ["hypotheses", "images"]),
            ("dialectic", ["unhypothetical", "principle"]),
        ],
    },
    8: {
        "destinations": [
            ("3. The Cave (Republic VII 514a–517a) — the scale set in motion", ["shadows", "ascent", "sun"]),
            ("4. The two features the Cave adds — and that questions reward", ["pain", "compulsion", "return"]),
        ],
        "propositions": [
            ("line_narrated", ["shadows", "ascent", "sun"]),
            ("education", ["turning", "soul"]),
            ("political_return", ["return", "socrates"]),
        ],
    },
    9: {
        "destinations": [
            ("1. The relation, stated exactly", ["paradigm", "copy"]),
            ("2. The participation dilemma (*Parmenides* 131a–c)", ["whole", "part", "dilemma"]),
            ("3. The Third Man (*Parmenides* 132a–b)", ["self-predication", "non-identity", "regress"]),
            ("4. The third difficulty: causal impotence", ["causal", "mechanism"]),
            ("6. The dialogue map — attribute the argument to its text", ["parmenides", "sophist", "timaeus"]),
        ],
        "propositions": [
            ("relation", ["participation", "imitation"]),
            ("dilemma", ["whole", "part"]),
            ("third_man", ["self-predication", "non-identity", "regress"]),
            ("causal_impotence", ["causal", "mechanism"]),
            ("reply_status", ["later dialogues", "contested"]),
        ],
    },
    10: {
        "destinations": [
            ("5. Plato's wider causal resources — keep the dialogues distinct", ["good", "demiurge", "receptacle"]),
        ],
        "propositions": [
            ("causal_repertoire", ["forms", "good", "demiurge", "receptacle"]),
            ("dialogue_discipline", ["phaedo", "republic", "timaeus"]),
            ("accurate_objection", ["motion", "generation"]),
        ],
    },
    11: {
        "destinations": [
            ("1. The five objections, as arguments", ["duplication", "participation", "regress", "generation"]),
        ],
        "propositions": [
            ("duplication", ["duplication"]),
            ("relation", ["participation", "metaphor"]),
            ("regress", ["third man", "regress"]),
            ("change", ["generation", "coming-to-be"]),
            ("economy", ["duplication", "entities"]),
        ],
    },
    12: {
        "destinations": [
            ("2. The repair, in one sentence", ["form", "essence"]),
            ("3. What the repair buys — and what it costs", ["generation", "universals", "individual"]),
            ("4. The honest scorecard", ["separation", "particular", "universals"]),
        ],
        "propositions": [
            ("retained", ["form", "essence", "secondary substances"]),
            ("deleted", ["separation", "universal"]),
            ("benefits", ["actuality", "generation", "unity"]),
            ("costs", ["universals", "individual", "prime matter"]),
            ("verdict", ["separation", "form"]),
        ],
    },
    13: {
        "destinations": [
            ("1. Substance in the *Categories*", ["primary substance", "individual", "predication"]),
            ("2. Substance in the *Metaphysics* (Books VII–IX, Z–Θ)", ["matter", "form", "essence"]),
            ("3. The tension, stated sharply", ["categories", "metaphysics", "individual"]),
        ],
        "propositions": [
            ("categories", ["individual", "subject"]),
            ("metaphysics", ["form", "essence"]),
            ("two_questions", ["categories", "metaphysics"]),
        ],
    },
    14: {
        "destinations": [
            ("🖼️ VISUAL — the Z.3 shortlist and its verdicts", ["matter", "essence", "universal"]),
            ("4. The four available readings — name at least two", ["developmentalist", "frede", "owen"]),
        ],
        "propositions": [
            ("z3_candidates", ["matter", "essence", "universal", "genus"]),
            ("z17_reformulation", ["explanatory", "principle"]),
            ("readings", ["developmentalist", "frede", "owen"]),
        ],
    },
    15: {
        "destinations": [
            ("6. Substance and accident — the ten categories", ["substance", "accident", "quantity", "quality"]),
        ],
        "propositions": [
            ("dependence", ["accident", "substance"]),
            ("categories", ["quantity", "quality", "relation"]),
            ("examples", ["socrates", "taller"]),
        ],
    },
    16: {
        "destinations": [
            ...
            ("3. Form, matter and privation in change", ["subject", "form", "privation"]),
            ("4. Prime matter — how to present it safely", ["prime matter", "limit", "exists"]),
        ],
        "propositions": [
            ("hylomorphism", ["matter", "form", "substance"]),
            ("change_structure", ["subject", "form", "privation"]),
            ("prime_matter", ["prime matter", "limiting"]),
        ],
    },
    17: {
        "destinations": [
            ...
            ("2. Teleology — the primacy of the final cause", ["final cause", "nature"]),
            ("6. Does teleology survive the modern objection?", ["physics", "biology", "functional"]),
        ],
        "propositions": [
            ("four_cause_matrix", ["material", "formal", "efficient", "final"]),
            ("internal_teleology", ["final cause", "nature"]),
            ("modern_assessment", ["physics", "biology", "functional"]),
        ],
    },
    18: {
        "destinations": [
            ("3. Why the four causes answer the developmental-change question", ["matter", "form", "actuality"]),
            ("5. Identity and causes as processes — the 2022 answer", ["identity", "process", "form"]),
        ],
        "propositions": [
            ("development", ["development", "form", "end"]),
            ("identity", ["identity", "process"]),
            ("causal_roles", ["material", "formal", "efficient", "final"]),
        ],
    },
    19: {
        "destinations": [
            (
                "1. The doctrine",
                ["potentiality", "actuality", "change"],
                "SESSION 8 — POTENTIALITY AND ACTUALITY: CHANGE, PRIORITY AND PURE ACTUALITY",
            ),
            ("🖼️ VISUAL — how the pair defeats Parmenides and Heraclitus at once", ["parmenides", "heraclitus", "change"]),
        ],
        "propositions": [
            ("potency_act", ["potentiality", "actuality"]),
            ("change", ["potential", "actual"]),
            ("ancient_problem", ["parmenides", "heraclitus"]),
        ],
    },
    20: {
        "destinations": [
            ("3. The priority of actuality — three senses", ["definition", "time", "substance"]),
            ("4. Form over matter — the parallel priority", ["form", "matter", "priority"]),
            ("5. The Unmoved Mover — the terminus of the doctrine", ["unmoved mover", "pure actuality", "final cause"]),
        ],
        "propositions": [
            ("actuality_priority", ["definition", "time", "substance"]),
            ("form_priority", ["form", "matter"]),
            ("pure_act", ["unmoved mover", "pure actuality"]),
        ],
    },
    21: {
        "destinations": [
            ("1. The matched comparison", ["transcendent", "immanent", "causation"]),
            ("2. Criticisms against Plato, with replies", ["duplication", "causal"]),
            ("3. Criticisms against Aristotle, with replies", ["aristotle", "reply", "teleology"]),
            ("4. The graded verdict bank — closing positions you can execute", ["universal", "causation"]),
        ],
        "propositions": [
            ("axes", ["transcendent", "immanent"]),
            ("plato_pressure", ["duplication", "causal"]),
            ("aristotle_pressure", ["prime matter", "teleology"]),
            ("verdict", ["universal", "particular"]),
        ],
    },
    22: {
        "destinations": [
            ("5. PYQ routing, 2018–2026", ["2018", "2025", "form"]),
        ],
        "propositions": [
            ("continuous_corpus", ["2018", "2025"]),
            ("ownership", ["primary", "corpus"]),
            ("demands", ["cave", "potentiality", "form"]),
        ],
    },
    23: {
        "destinations": [
            ("1. Three answer skeletons", ["10", "15", "20"]),
            ("2. Text, translation and citation discipline", ["stephanus", "bekker", "translation"]),
            ("🖼️ VISUAL — the directive decoder for this syllabus item", ["elucidate", "discuss", "evaluate"]),
        ],
        "propositions": [
            ("answer_lengths", ["10", "15", "20"]),
            ("directives", ["elucidate", "discuss", "evaluate"]),
            ("citation", ["stephanus", "bekker"]),
        ],
    },
    24: {
        "destinations": [
            ("3. Attribution ledger — what must be reported as testimony", ["testimony", "third man", "mathematicals"]),
            ("L. Answer discipline, citation and the final trap sheet", ["concepts in the mind", "rejected forms", "four causes"]),
        ],
        "propositions": [
            ("third_man_provenance", ["third man", "aristotle"]),
            ("mathematicals", ["mathematicals", "testimony"]),
            ("trap_sheet", ["concepts in the mind", "unmoved mover"]),
        ],
    },
    25: {
        "destinations": [
            ("ANSWER-WORTHINESS — WHAT EARNS MARKS AND WHAT DOES NOT", ["cross-links", "enrichment", "exceptions"]),
            ("4. The graded verdict bank — closing positions you can execute", ["universal", "problem"]),
        ],
        "propositions": [
            ("ownership_boundary", ["cross-links", "enrichment"]),
            ("bounded_exceptions", ["recollection", "conversion", "living body"]),
            ("qualified_conclusion", ["universal", "problem"]),
        ],
    },
}
...
def manual_structural_mapping(block: dict) -> dict | None:
    ...
    if heading == "What this package contains":
        return {
            "mapping_strategy": "manual_structural_metadata",
            "review_basis": "Package inventory reconciled to the expanded 40-MCQ/14-PYQ metadata.",
            "minimum_aggregate_signature_overlap": .45,
            "required_propositions": [
                {"id": "practice_inventory", "witnesses": ["mcqs", "solved"]},
                {"id": "model_inventory", "witnesses": ["models", "original"]},
            ],
            "destinations": [
                manual_destination(
                    block, "COVERAGE-LEDGER.md", "## Source-accounting note", "coverage",
                    "Expanded package inventory and retained-source accounting",
                    ["mcqs", "solved", "models"],
                ),
                manual_destination(
                    block, "COVERAGE-LEDGER.md", "## Independent sizing audit", "coverage",
                    "Coverage-sized source-bank accounting",
                    ["remedial", "drills"],
                )
            ],
        }
    if heading == "BASIC MCQS / REMEDIATION":
        return {
            "mapping_strategy": "manual_structural_practice",
            "review_basis": "Practice umbrella split into question and solution documents.",
            "minimum_aggregate_signature_overlap": .50,
            "required_propositions": [
                {"id": "question_surface", "witnesses": ["questions", "option"]},
                {"id": "solution_surface", "witnesses": ["answer", "incorrect"]},
            ],
            "destinations": [
                manual_destination(
                    block, "MCQ-QUESTIONS.md", "Plato and Aristotle — MCQ Questions", "testing",
                    "Closed-book question-bank surface", ["questions", "option"],
                ),
                manual_destination(
                    block, "MCQ-SOLUTIONS.md", "Plato and Aristotle — MCQ Solutions", "solutions",
                    "Synchronized solved-bank surface", ["answer", "incorrect"],
                ),
            ],
        }
    if heading == "32 original MCQs — 24 core diagnostics and 8 remedial error-targeting drills":
        return {
            "mapping_strategy": "manual_source_bank_lineage",
            "review_basis": "The 32 authoritative source items are retained as Q1–32; Q33–40 are independently justified repairs.",
            "minimum_aggregate_signature_overlap": .45,
            "required_propositions": [
                {"id": "question_bank", "witnesses": ["questions", "option"]},
                {"id": "solution_bank", "witnesses": ["answer", "incorrect"]},
                {"id": "remedial_design", "witnesses": ["remedial", "drills"]},
            ],
            "destinations": [
                manual_destination(
                    block, "COVERAGE-LEDGER.md", "## Independent sizing audit", "coverage",
                    "Explicit Q1–32 retention and Q33–40 gap justification",
                    ["remedial", "drills"],
                ),
                manual_destination(
                    block, "MCQ-QUESTIONS.md", "Plato and Aristotle — MCQ Questions", "testing",
                    "Retained source questions", ["questions", "option"],
                ),
                manual_destination(
                    block, "MCQ-SOLUTIONS.md", "Plato and Aristotle — MCQ Solutions", "solutions",
                    "Retained source answers", ["answer", "incorrect"],
                )
            ],
        }
    if heading == "Twelve-part PYQ recall rail":
        return {
            "mapping_strategy": "manual_latest_paper_upgrade",
            "review_basis": "The authoritative 2018–2025 rail is retained and expanded with two verified 2026 owners.",
            "minimum_aggregate_signature_overlap": .55,
            "required_propositions": [
                {"id": "source_year_range", "witnesses": ["2018", "2025"]},
                {"id": "early_demands", "witnesses": ["line", "return"]},
                {"id": "later_demands", "witnesses": ["form", "hylomorphism"]},
            ],
            "destinations": [
                manual_destination(
                    block, "REVISION-GUIDE.md", "Fourteen-part PYQ recall rail", "teaching_revision",
                    "Latest-paper expansion of the same recall rail", ["2018", "2025", "form"],
                )
            ],
        }
    if heading == "COMPLETE TOPIC ASCII MASTER FLOW DIAGRAM":
        return {
            "mapping_strategy": "manual_master_flow_decomposition",
            "review_basis": "The umbrella flow is decomposed into the route map and block-specific panel mappings below.",
            "minimum_aggregate_signature_overlap": .50,
            "required_propositions": [
                {"id": "platonic_spine", "witnesses": ["forms", "substance"]},
                {"id": "aristotelian_spine", "witnesses": ["causation", "actuality"]},
            ],
            "destinations": [
                manual_destination(
                    block, "REVISION-GUIDE.md", "ONE-SCREEN ROUTE MAP", "teaching_revision",
                    "Continuous route across Forms, substance, causation and actuality",
                    ["forms", "substance", "causation", "actuality"],
                )
            ],
        }
    panel = re.search(r"PANEL (\d+)/25", heading)
    if panel:
        number = int(panel.group(1))
        review = PANEL_REVIEW[number]
        destinations = []
        for item in review["destinations"]:
            anchor, witnesses = item[:2]
            context_anchor = item[2] if len(item) == 3 else None
            destinations.append(
                manual_destination(
                    block, "REVISION-GUIDE.md", anchor, "teaching_revision",
                    f"Reviewed destination for composite ASCII panel {number}",
                    witnesses, context_anchor=context_anchor,
                )
            )
        return {
            "mapping_strategy": "manual_ascii_panel_reconciliation",
            "review_basis": f"Panel {number} manually decomposed across every relevant doctrinal/answer-writing section.",
            "minimum_aggregate_signature_overlap": .55,
            "required_propositions": [
                {"id": proposition_id, "witnesses": witnesses}
                for proposition_id, witnesses in review["propositions"]
            ],
            "destinations": destinations,
        }
    if heading == "5. Substance and accident — the ten categories":
        return {
            "mapping_strategy": "manual_latest_paper_upgrade",
            "review_basis": "The block is retained under renumbered §6 after insertion of the 2026 metaphysics spine.",
            "minimum_aggregate_signature_overlap": .65,
            "required_propositions": [
                {"id": "substance_accident", "witnesses": ["substance", "accident"]},
                {"id": "categories", "witnesses": ["quantity", "quality", "relation"]},
            ],
            "destinations": [
                manual_destination(
                    block, "REVISION-GUIDE.md", "6. Substance and accident — the ten categories",
                    "teaching_revision", "Renumbered but substantively preserved categories block",
                    ["substance", "accident", "categories"],
                )
            ],
        }
    if heading == "5. PYQ routing, 2018–2025":
        return {
            "mapping_strategy": "manual_latest_paper_upgrade",
            "review_basis": "The exact 2018–2025 route is retained inside the expanded 2018–2026 route.",
            "minimum_aggregate_signature_overlap": .65,
            "required_propositions": [
                {"id": "year_range", "witnesses": ["2018", "2025"]},
                {"id": "exam_demands", "witnesses": ["marks", "question"]},
            ],
            "destinations": [
                manual_destination(
                    block, "REVISION-GUIDE.md", "5. PYQ routing, 2018–2026",
                    "teaching_revision", "Latest-paper expansion of the same routing table",
                    ["2018", "2025", "marks"],
                )
            ],
        }
    if (
        heading == "6. Objections and replies"
        and block.get("context_heading")
        == "SESSION 8 — POTENTIALITY AND ACTUALITY: CHANGE, PRIORITY AND PURE ACTUALITY"
    ):
        return {
            "mapping_strategy": "manual_latest_paper_upgrade",
            "review_basis": "The objections/replies block is retained under renumbered §7 after insertion of the 2026 entelechy comparison.",
            "minimum_aggregate_signature_overlap": .65,
            "required_propositions": [
                {"id": "circularity", "witnesses": ["circular", "asymmetric"]},
                {"id": "explanatory_scope", "witnesses": ["process", "predict"]},
                {"id": "mover_problem", "witnesses": ["final cause", "physical motion"]},
            ],
            "destinations": [
                manual_destination(
                    block, "REVISION-GUIDE.md", "7. Objections and replies",
                    "teaching_revision", "Renumbered but substantively preserved critical block",
                    ["circular", "process", "final cause"],
                    context_anchor="SESSION 8 — POTENTIALITY AND ACTUALITY: CHANGE, PRIORITY AND PURE ACTUALITY",
                )
            ],
        }
    if heading == "A2. Aristotle on the focal meaning of being ❓":
        return {
            "mapping_strategy": "manual_heading_refinement",
            "review_basis": "The optional block is preserved under a clarified heading after 2026 core promotion.",
            "minimum_aggregate_signature_overlap": .65,
            "required_propositions": [
                {"id": "focal_meaning", "witnesses": ["focal", "substance"]},
                {"id": "unity_problem", "witnesses": ["being qua being", "many ways"]},
            ],
            "destinations": [
                manual_destination(
                    block, "REVISION-GUIDE.md",
                    "A2. Further depth on Aristotle's focal meaning of being ❓",
                    "teaching_revision", "Clarified optional refinement of focal being",
                    ["focal", "substance", "metaphysics"],
                )
            ],
        }
    return None
...
def reviewed_mapping(block: dict) -> dict | None:
    ...
    if mcq:
        ...
        for file, surface in (("MCQ-QUESTIONS.md", "testing"), ("MCQ-SOLUTIONS.md", "solutions")):
            ...
            if body and len(matched_witnesses) >= 2:
                destinations.append(
                    destination(
                        file, heading, surface,
                        "Reviewed split surface with independent source-body phrase witnesses",
                        matched_witnesses,
                    )
                )
        if len(destinations) == 2:
            return {
                ...
                "required_propositions": [
                    {"id": f"source_body_witness_{index}", "witnesses": [witness]}
                    for index, witness in enumerate(
                        list(dict.fromkeys(
                            witness
                            for destination_item in destinations
                            for witness in destination_item["witnesses"]
                        ))[:4],
                        1,
                    )
                ],
    ...
    pyq_context = next(
        (ancestor for ancestor in reversed(block["ancestor_headings"]) if re.match(r"20\d{2} · Q", ancestor)),
        None,
    )
    original_context = next(
        (ancestor for ancestor in reversed(block["ancestor_headings"]) if re.match(r"Original \d+ ·", ancestor)),
        None,
    )
    if re.match(r"20\d{2} · Q", heading) or pyq_context:
        mapped = exact_destination(
            block, "ANSWER-WRITING-TOOLKIT.md", "answer_writing",
            context_anchor=pyq_context if block["heading_level"] == 5 else None,
        )
        if mapped:
            return {
                "mapping_strategy": "reviewed_exact_pyq",
                "review_basis": "Exact owned PYQ heading/sub-block preserved in the solved toolkit.",
                "minimum_aggregate_signature_overlap": .60,
                "required_propositions": [
                    {"id": f"source_body_witness_{index}", "witnesses": [witness]}
                    for index, witness in enumerate(mapped["witnesses"], 1)
                ],
                "destinations": [mapped],
            }
        return None
    if re.match(r"Original \d+ ·", heading) or original_context:
        mapped = exact_destination(
            block, "ANSWER-WRITING-TOOLKIT.md", "answer_writing",
            context_anchor=original_context if block["heading_level"] == 5 else None,
        )
        if mapped:
            return {
                "mapping_strategy": "reviewed_exact_original_model",
                "review_basis": "Exact original model heading/sub-block preserved in the solved toolkit.",
                "minimum_aggregate_signature_overlap": .60,
                "required_propositions": [
                    {"id": f"source_body_witness_{index}", "witnesses": [witness]}
                    for index, witness in enumerate(mapped["witnesses"], 1)
    ...
    target = None
    if source == "session":
        if line < 1981 or 3350 <= line < 3581:
            target = ("REVISION-GUIDE.md", "teaching_revision")
        elif 2720 <= line < 3350:
            target = ("ANSWER-WRITING-TOOLKIT.md", "answer_writing")
    elif source == "workbook" and line >= 750:
        target = ("ANSWER-WRITING-TOOLKIT.md", "answer_writing")
    if target:
        context_anchor = None
        if block["heading_level"] >= 4 and block.get("context_heading"):
            target_text = (TOPIC / target[0]).read_text(encoding="utf-8")
            if find_heading_section(target_text, block["context_heading"]):
                context_anchor = block["context_heading"]
        mapped = exact_destination(block, *target, context_anchor=context_anchor)
        if mapped:
            return {
                "mapping_strategy": "reviewed_exact_heading",
                "review_basis": "Authoritative block heading and concept signature preserved in the destination section.",
                "minimum_aggregate_signature_overlap": .60,
                "required_propositions": [
                    {"id": f"source_body_witness_{index}", "witnesses": [witness]}
                    for index, witness in enumerate(mapped["witnesses"], 1)
...
def build_formal_audit() -> dict:
    ...
    return {
        ...
        "formal_block_definition": (
            ...
            "structural and 25-panel mappings require aggregate proposition coverage."
        ),
        "source_files": {
            code: {
...
def parse_owned_pyqs() -> list[dict]:
    ...
    for path in PYQ_LEDGERS:
        ...
        for line in path.read_text(encoding="utf-8").splitlines():
            ...
            match = re.match(
                r"^- \*\*(Q\d+\([a-z]\)) · (\d+) marks · \[Plato[–-]Aristotle\]\([^)]+\):\*\* (.+?)(?: → owner block:.*)?$",
                line,
            )
            if match and year:
                result.append(
...
def pdf_checks(path: Path, source_path: Path, regeneration_file: dict | None) -> dict:
    ...
    if source_path.name == "MCQ-QUESTIONS.md":
        source_specific["mcq_count"] = len(
            {int(number) for number in re.findall(r"\bMCQ (\d+)\.", extracted)}
        )
...
def regenerate_pdfs() -> dict:
    ...
    descriptors = {
        "Revision-Guide.pdf": "Philosophy Optional · Paper I · Western Philosophy · Topic 01",
    ...
    for pdf_name, source_name in PDF_SOURCES.items():
        ...
        unicode_markdown_pdf.build_pdf(
            ...
            footer_label=f"Plato and Aristotle | {source_name.removesuffix('.md')}",
        )
        files[pdf_name] = {
            "source": source_name,
