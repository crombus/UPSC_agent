...
SOURCE_DIR = (
    ...
    / "Philosophy-Optional/Philosophy-Paper-I-—-Western-Philosophy/08-Later-Wittgenstein"
)
LARGE_LEAF_MIN_PHYSICAL_LINES = 60
LARGE_LEAF_MIN_WORDS = 400
LARGE_LEAF_MIN_SEMANTIC_TOKENS = 250
EXPECTED_PANEL_TOTAL = 33
FORMAL_SOURCES = {
...
MCQ_RANDOMIZATION_SEED = "topic08-later-wittgenstein-20260924-15"
MCQ_RANDOMIZATION_SOURCE_KEY = (
    "BCABBCDBBDACCADADDACBABCACCDACBBCACADABBDBCDADCDADB"
)
...
PDF_DESCRIPTORS = {
    ...
    "MCQ-Questions.pdf": "51-question closed-book bank · no answer key",
    "MCQ-Solutions.pdf": "Option-specific explanations and examiner traps",
    "Answer-Writing-Toolkit.pdf": "Eight verified PYQs and nine original solved models",
}
PDF_GENERATION_PROFILE = {
    ...
    "footer_topic": "Later Wittgenstein",
    "profile_version": 1,
}
REQUIRED = [
    "README.md",
...
ROUTE_FORBIDDEN_ASSERTIONS = [
    {"id": "route-claims-topic08-primary-ownership", "pattern": r"topic 08\s+(?:is|remains|claims to be|acts as)(?:(?!\n).){0,80}(?:primary|sole) owner"},
    {"id": "route-imports-early-doctrine", "pattern": r"later wittgenstein(?:(?!\n).){0,140}(?:owns|establishes|proves)(?:(?!\n).){0,100}(?:saying and showing|picture theory|logical form)"},
]

CROSS_TOPIC_ROUTE_OBLIGATIONS = [
    {
        "id": "WP-2018-Q3C-SAYING-SHOWING",
        ...
        "bounded_scope": "Topic 08 supplies only the later plurality-of-methods contrast; Topic 06 owns saying/showing and the Tractatus account.",
        "status": "fulfilled_substantively",
        "source_owner_evidence": {"file": "../../../../../knowledge/Philosophy/paper-1/_PYQ-Western-Philosophy-2018-2025.md", "anchor": "2018 ✅", "witnesses": ["saying", "showing"]},
        "destination_evidence": [
            {"file": "../06-Moore-Russell-and-Early-Wittgenstein/ANSWER-WRITING-TOOLKIT.md", "anchor": "1. 2018 Q3(c) · 15 marks", "witnesses": ["saying", "showing", "logical form"], "required_semantic_assertions": [{"id": "topic06-saying-showing-owner", "term_groups": [["saying"], ["showing"], ["logical form", "Tractatus"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "../06-Moore-Russell-and-Early-Wittgenstein/ANSWER-WRITING-TOOLKIT.md", "anchor": "Inbound obligations from Topic 08", "witnesses": ["WP-2018-Q3C-SAYING-SHOWING", "primary owner", "plurality"], "required_semantic_assertions": [{"id": "topic06-saying-showing-inbound-id", "term_groups": [["WP-2018-Q3C-SAYING-SHOWING"], ["primary owner"], ["plurality", "methods"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "../06-Moore-Russell-and-Early-Wittgenstein/COVERAGE-LEDGER.md", "anchor": "Bounded route obligations", "witnesses": ["WP-2018-Q3C-SAYING-SHOWING", "Topic 06 primary", "Topic 08"], "required_semantic_assertions": [{"id": "topic06-saying-showing-ledger", "term_groups": [["WP-2018-Q3C-SAYING-SHOWING"], ["Topic 06 primary"], ["Topic 08"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "ANSWER-WRITING-TOOLKIT.md", "anchor": "Bounded route obligations", "witnesses": ["WP-2018-Q3C-SAYING-SHOWING", "Topic 06 owns", "plurality"], "required_semantic_assertions": [{"id": "topic08-saying-showing-boundary", "term_groups": [["WP-2018-Q3C-SAYING-SHOWING"], ["Topic 06 owns"], ["plurality", "methods"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "COVERAGE-LEDGER.md", "anchor": "Bounded route obligations", "witnesses": ["WP-2018-Q3C-SAYING-SHOWING", "Topic 06", "plurality"], "required_semantic_assertions": [{"id": "topic08-saying-showing-ledger", "term_groups": [["WP-2018-Q3C-SAYING-SHOWING"], ["Topic 06"], ["plurality", "methods"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
        ],
    },
    {
        "id": "WP-2021-Q4C-WHEREOF-SILENCE",
        "origin_primary_owner": "../06-Moore-Russell-and-Early-Wittgenstein",
        "paired_owner": ".",
        "verified_route_source": "../../../../../knowledge/Philosophy/paper-1/_PYQ-Western-Philosophy-2018-2025.md",
        "bounded_scope": "Topic 08 supplies only the later grammatical-therapy contrast; Topic 06 owns silence, the ladder and limits of the sayable.",
        "status": "fulfilled_substantively",
        "source_owner_evidence": {"file": "../../../../../knowledge/Philosophy/paper-1/_PYQ-Western-Philosophy-2018-2025.md", "anchor": "2021 ✅", "witnesses": ["Whereof one cannot speak", "silent"]},
        "destination_evidence": [
            {"file": "../06-Moore-Russell-and-Early-Wittgenstein/ANSWER-WRITING-TOOLKIT.md", "anchor": "7. 2021 Q4(c) · 15 marks", "witnesses": ["silent", "ladder", "logical form"], "required_semantic_assertions": [{"id": "topic06-silence-owner", "term_groups": [["silent"], ["ladder"], ["logical form", "Tractatus"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "../06-Moore-Russell-and-Early-Wittgenstein/ANSWER-WRITING-TOOLKIT.md", "anchor": "Inbound obligations from Topic 08", "witnesses": ["WP-2021-Q4C-WHEREOF-SILENCE", "primary owner", "therapy"], "required_semantic_assertions": [{"id": "topic06-silence-inbound-id", "term_groups": [["WP-2021-Q4C-WHEREOF-SILENCE"], ["primary owner"], ["grammar", "therapy"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "../06-Moore-Russell-and-Early-Wittgenstein/COVERAGE-LEDGER.md", "anchor": "Bounded route obligations", "witnesses": ["WP-2021-Q4C-WHEREOF-SILENCE", "Topic 06 primary", "Topic 08"], "required_semantic_assertions": [{"id": "topic06-silence-ledger", "term_groups": [["WP-2021-Q4C-WHEREOF-SILENCE"], ["Topic 06 primary"], ["Topic 08"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "ANSWER-WRITING-TOOLKIT.md", "anchor": "Bounded route obligations", "witnesses": ["WP-2021-Q4C-WHEREOF-SILENCE", "Topic 06 owns", "therapy"], "required_semantic_assertions": [{"id": "topic08-silence-boundary", "term_groups": [["WP-2021-Q4C-WHEREOF-SILENCE"], ["Topic 06 owns"], ["grammar", "therapy"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "COVERAGE-LEDGER.md", "anchor": "Bounded route obligations", "witnesses": ["WP-2021-Q4C-WHEREOF-SILENCE", "Topic 06", "therapy"], "required_semantic_assertions": [{"id": "topic08-silence-ledger", "term_groups": [["WP-2021-Q4C-WHEREOF-SILENCE"], ["Topic 06"], ["grammar", "therapy"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
        ],
    },
    {
        "id": "WP-2022-Q3C-PICTORIAL-LOGICAL-FORM",
        "origin_primary_owner": "../06-Moore-Russell-and-Early-Wittgenstein",
        "paired_owner": ".",
        "verified_route_source": "../../../../../knowledge/Philosophy/paper-1/_PYQ-Western-Philosophy-2018-2025.md",
        "bounded_scope": "Topic 08 supplies only the later practice-based contrast; Topic 06 owns pictorial form, logical form and representation.",
        "status": "fulfilled_substantively",
        "source_owner_evidence": {"file": "../../../../../knowledge/Philosophy/paper-1/_PYQ-Western-Philosophy-2018-2025.md", "anchor": "2022 ✅", "witnesses": ["pictorial form", "logical form"]},
        "destination_evidence": [
            {"file": "../06-Moore-Russell-and-Early-Wittgenstein/ANSWER-WRITING-TOOLKIT.md", "anchor": "9. 2022 Q3(c) · 15 marks", "witnesses": ["pictorial form", "logical form", "reality"], "required_semantic_assertions": [{"id": "topic06-picture-owner", "term_groups": [["pictorial form"], ["logical form"], ["language", "reality"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "../06-Moore-Russell-and-Early-Wittgenstein/ANSWER-WRITING-TOOLKIT.md", "anchor": "Inbound obligations from Topic 08", "witnesses": ["WP-2022-Q3C-PICTORIAL-LOGICAL-FORM", "primary owner", "practice"], "required_semantic_assertions": [{"id": "topic06-picture-inbound-id", "term_groups": [["WP-2022-Q3C-PICTORIAL-LOGICAL-FORM"], ["primary owner"], ["practice", "determinacy"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "../06-Moore-Russell-and-Early-Wittgenstein/COVERAGE-LEDGER.md", "anchor": "Bounded route obligations", "witnesses": ["WP-2022-Q3C-PICTORIAL-LOGICAL-FORM", "Topic 06 primary", "Topic 08"], "required_semantic_assertions": [{"id": "topic06-picture-ledger", "term_groups": [["WP-2022-Q3C-PICTORIAL-LOGICAL-FORM"], ["Topic 06 primary"], ["Topic 08"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "ANSWER-WRITING-TOOLKIT.md", "anchor": "Bounded route obligations", "witnesses": ["WP-2022-Q3C-PICTORIAL-LOGICAL-FORM", "Topic 06 owns", "practice"], "required_semantic_assertions": [{"id": "topic08-picture-boundary", "term_groups": [["WP-2022-Q3C-PICTORIAL-LOGICAL-FORM"], ["Topic 06 owns"], ["practice", "determinacy"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
            {"file": "COVERAGE-LEDGER.md", "anchor": "Bounded route obligations", "witnesses": ["WP-2022-Q3C-PICTORIAL-LOGICAL-FORM", "Topic 06", "practice"], "required_semantic_assertions": [{"id": "topic08-picture-ledger", "term_groups": [["WP-2022-Q3C-PICTORIAL-LOGICAL-FORM"], ["Topic 06"], ["practice", "determinacy"]]}], "forbidden_semantic_assertions": ROUTE_FORBIDDEN_ASSERTIONS},
        ],
    },
]

EXPECTED_ROUTED_DECISIONS = {
    "session-supporting-part-a-2018-q3-c-15-marks-owned-by-topic-06-moore-rus-01-9460047fc6": {
        "obligation_id": "WP-2018-Q3C-SAYING-SHOWING",
        "routed_owner": "../06-Moore-Russell-and-Early-Wittgenstein",
    },
    "workbook-supporting-part-a-2018-q3-c-15-marks-owned-by-topic-06-moore-rus-01-ecf016590b": {
        "obligation_id": "WP-2018-Q3C-SAYING-SHOWING",
        "routed_owner": "../06-Moore-Russell-and-Early-Wittgenstein",
    },
    "session-supporting-part-b-2021-q4-c-15-marks-owned-by-topic-06-moore-rus-01-556a392e6f": {
        "obligation_id": "WP-2021-Q4C-WHEREOF-SILENCE",
        "routed_owner": "../06-Moore-Russell-and-Early-Wittgenstein",
    },
    "workbook-supporting-part-b-2021-q4-c-15-marks-owned-by-topic-06-moore-rus-01-76bbb6be0a": {
        "obligation_id": "WP-2021-Q4C-WHEREOF-SILENCE",
        "routed_owner": "../06-Moore-Russell-and-Early-Wittgenstein",
    },
    "session-supporting-part-c-2022-q3-c-15-marks-owned-by-topic-06-moore-rus-01-73b69cede7": {
        "obligation_id": "WP-2022-Q3C-PICTORIAL-LOGICAL-FORM",
        "routed_owner": "../06-Moore-Russell-and-Early-Wittgenstein",
    },
    "workbook-supporting-part-c-2022-q3-c-15-marks-owned-by-topic-06-moore-rus-01-fe8eb29234": {
        "obligation_id": "WP-2022-Q3C-PICTORIAL-LOGICAL-FORM",
        "routed_owner": "../06-Moore-Russell-and-Early-Wittgenstein",
    },
}
EXPECTED_ROUTED_MULTIPLICITIES = {
    "WP-2018-Q3C-SAYING-SHOWING": 2,
    "WP-2021-Q4C-WHEREOF-SILENCE": 2,
    "WP-2022-Q3C-PICTORIAL-LOGICAL-FORM": 2,
}
...
def coverage_negative_test_results(
    ...
    grammar_block = next(
        ...
        == '🖼️ VISUAL — the three uses of the term, §23\'s list, and what "grammar" means here'
    )
    ...
    grammar_item["propositions"][1]["claim"] = (
        "Metaphysical requests for an object's nature are answered grammatically "
        "by mapping the established employment of its word."
    )
    ...
    pretence_block = next(
        block
        for block in blocks
        if "successful pretence" in normalise(block["block_body"])
        and review_decisions[block["id"]].get(
            "distributed_proposition_inventory"
        )
    )
    ...
    pretence_item["propositions"][1]["claim"] = (
        "Successful simulation defeats strict behavioural identity while preserving "
        "the defeasible grammatical dependence of psychological criteria."
    )
    ...
    form_of_life_block = next(
        ...
        for block in blocks
        if block["source_heading"]
        == '🖼️ VISUAL — the four things "form of life" is doing, and the two readings of it'
    )
    master = next(
        block
        for block in blocks
    ...
    form_target["claim"] = (
        "The human background makes linguistic practice possible but neither "
        "fixes truth nor seals historically different cultures from criticism."
    )
    ...
    live_malformed_mutations = [
        (
            ...
            "LIMB 3 - THE CRITIQUE OF PRIVATE LANGUAGE TARGET: a language whose words are given meaning by PRIVATE |.",
            ["malformed distributed claim family: dangling_pipe"],
        ),
        (
            "actual distinguishes content-core template",
            "Wittgenstein distinguishes content from core because meaning governs explained, whereas language constrains primitive through game.",
            ["malformed distributed claim family: distinguishes_because_governs"],
        ),
        (
            "actual distinguishes invented-primitive template",
            "Wittgenstein distinguishes invented from primitive because languages governs purpose, whereas training constrains words through use.",
            ["malformed distributed claim family: distinguishes_because_governs"],
        ),
        (
            "actual distinguishes wittgenstein-whether template",
            "Wittgenstein distinguishes wittgenstein from whether because could governs imagine, whereas language constrains person through experience.",
            ["malformed distributed claim family: distinguishes_because_governs"],
        ),
        (
            "actual panel-10 prevents-replacing salad",
        ...
        (
            ...
            "The relation between use and meaning requires grammar to guide practice; by contrast, rules constrain words through training.",
            ["malformed distributed claim family: relation_between_requires"],
        ),
        (
            "within-practice generated template",
            "Within the practice of language, meaning appears through rules that speakers follow during correction and training.",
            ["malformed distributed claim family: within_the_practice_of"],
        ),
        (
            "source-treats generated template",
            "The source treats private language as a problem whose answer depends on criteria supplied by public practice.",
            ["malformed distributed claim family: source_treats"],
        ),
        (
            "ellipsis fragment mutation",
            "Wittgenstein connects meaning with use, training, rules, and correction ...",
    ...
    for obligation in CROSS_TOPIC_ROUTE_OBLIGATIONS:
        for evidence in obligation["destination_evidence"]:
            ...
            contradiction = "Topic 08 is the sole primary owner of this routed doctrine."
            paraphrase = (
                "Later Wittgenstein establishes and owns the picture theory, logical form, "
                "saying and showing."
            )
    ...
    extra_route[extra_id].update(
        {
            ...
            "inbound_obligation_id": "WP-2021-Q4C-WHEREOF-SILENCE",
...
def formal_audit_checks() -> dict:
    ...
    ledger_topic_parts = re.findall(
        r"^- \*\*(Q\d+\([a-z]\)) · \d+ marks · \[Later Wittgenstein\]\([^)]+\):\*\*",
        ledger_2026,
        re.M,
    )
    latest_upgrade_rows = [
    ...
    latest_owner_assertion = {
        ...
        "pass": (
            ...
            and "## 8. 2026 Q3(c) · 15 marks" in toolkit_text
...
def pdf_generation_metadata(pdf_name: str, source_name: str) -> dict:
    return {
        **PDF_GENERATION_PROFILE,
        ...
        "footer_label": (
            f"Later Wittgenstein | {source_name.removesuffix('.md')}"
        ),
    }
...
def pdf_checks(path: Path, source_path: Path, regeneration_file: dict | None) -> dict:
    ...
    if source_path.name == "MCQ-QUESTIONS.md":
        ...
        source_specific["master_flow_panel_count"] = len(
            re.findall(
                r"(?m)^ASCII MASTER FLOW [—-] PANEL \d+/33:",
                extracted,
            )
        )
        source_specific["correction_overlay_present"] = (
            "2026 and interpretive correction overlay" in normalise(extracted)
        )
    passed = (
        pages > 0
        and not blank
