# Later Wittgenstein — Complete Offline Revision Guide

Syllabus boundary: Meaning and use; language-games; critique of private language.

Source discipline: The latest learner-v2 g5 session and workbook are checked against the canonical owner. Source-cell retention is checked mechanically through anchored headings, term witnesses and the coverage ledger; this does not prove semantic completeness. Repeated source apparatus is consolidated for offline revision. Markdown is canonical.

Current-affairs boundary: No direct verified current-affairs event is established for this conceptual topic. Contemporary relevance to pragmatics, philosophy of mind and artificial intelligence is analytical context, not a fabricated dated event.

PYQ update: The seven directly owned questions from 2018–2025 are joined by 2026 Q3(c). Topic 08 therefore owns eight verified parts through repository year 2026. Early Wittgenstein and Logical Positivism questions remain cross-links to Topics 06 and 07, not duplicate ownership.
...
**Preservation note:** the canonical doctrine is reorganised into layers. The validator checks the explicit source-cell inventory and named witnesses; interpretive adequacy and completeness still require human review.
...
> ⚠️ **Verdict to deploy:** Wittgenstein is anti-Cartesian without being reductively behaviourist: he rejects private-object grounding while retaining sensations and first-person avowals; criterial grammar's adequacy remains disputed.
...
- Four flips: picturing -> **use**; one essence -> **family resemblance**; one general factual form -> **varied ordinary practices**; private reference -> private ostension cannot found a language. - Reasons for the shift: **colour-exclusion problem (1929)**, the **Augustinian picture** is too narrow, philosophy needs **description not theory**. - Method slogan: **"Don't think, but look."** Philosophy **describes**, it does not explain. - **Provenance trap:** the *Investigations* was published posthumously in 1953; Anscombe translated and edited with Rhees; do not say "Wittgenstein published" it. - Ownership: **7** owned parts 2018-2025; **2021** is the empty year. - **Practice link:** MCQs 1-5; PYQs 2023 Q4(c), 2025 Q3(a).
...
- **Practice link:** MCQs 6-10; PYQs 2023 Q4(c), 2025 Q3(a), 2026 Q3(c).
...
- **Games** share no single feature - only "a complicated network of similarities overlapping and criss-crossing". Model: a **family** (nose, gait, temperament). - Consequence: **concepts need not have sharp boundaries**; definitions by necessary-and-sufficient conditions are not always possible - and that is fine. - Method: **"Don't think, but look!"** - describe the variety, do not posit an essence. - **Bridge:** because "game" has no essence, "language is a game" does not smuggle one in - it dissolves the search. (2018 link.) - **Trap:** treating "family resemblance" as itself the shared property; demanding sharp edges. - **Practice link:** MCQs 11-14; PYQ 2018 Q1(c).
...
- **Rules by training** (drill, example, correction), not by grasping a Platonic essence or hidden calculus. - Language is **living**: games are born and die. - **Chain:** many games -> no essence (family resemblance) -> rules by practice -> forms of life. - **Practice link:** MCQs 15-19; PYQs 2018 Q1(c), 2022 Q1(c), 2025 Q3(a).
...
- **Practice link:** MCQs 20-24; PYQ 2022 Q1(c).
...
- **Interpretive flag:** **Kripkenstein** = sceptical paradox + community solution; a reading, contested by Baker/Hacker - keep labelled. - **Practice link:** MCQs 25-30; feeds PYQs 2019 Q3(b), 2024 Q1(d), 2020 Q4(c).
...
- **Trap:** it does NOT deny inner life or claim "we can't know other minds." - **Practice link:** MCQs 31-38; PYQs 2019 Q3(b), 2020 Q4(c), 2024 Q1(d).
...
- **Trap:** "criteria are reliable symptoms" (collapses grammar into induction). - **Practice link:** MCQs 39-43; feeds PYQs 2020 Q4(c), 2019 Q3(b), 2026 Q3(c).
...
- **Aim:** "to show the fly the way out of the **fly-bottle**" (PI 309) - problems are **dissolved**, not solved. - **Self-limit (quietism):** "philosophy **leaves everything as it is**" (PI 124); no theses (PI 128); "puts everything before us" (PI 126). - **Plurality:** "not a philosophical method, though there are... **different therapies**" (PI 133). - **Objection/reply:** "no theses" looks self-refuting -> reply: reminders, not metaphysics; success = intellectual peace. - **Practice link:** MCQs 44-47; closing segment for PYQs 2023 Q4(c), 2025 Q3(a).
...
- **Payload:** perception is **technique-laden** - the mastery behind meaning-as-use reaches into how we see; anti-empiricist about "bare data + interpretation". - **Meaning-blindness** parallel: experiencing a word with a particular meaning. - **Provenance:** cite **PPF / Part II xi**, credit **Jastrow**; not a numbered Part I remark. - **Practice link:** MCQs 48-51; enrichment for PYQ 2025 Q3(a) and the 2026 mental-ideas demand.

---

#### CANONICAL EXAM APPARATUS

> The examiner apparatus below is reorganised from the canonical Later-Wittgenstein.md, with headings demoted and navigation links stripped. The validator checks specified anchors and witnesses; it does not certify word-for-word identity or semantic completeness.
...
- Moore-Russell-EarlyWittgenstein — the later work revises rather than simply repudiates the early programme: picture theory and a single logical architecture lose their governing role, while continuities in philosophical clarification and limits remain.
- Logical Positivism — the Vienna Circle was strongly influenced by and selectively appropriated the *Tractatus*, but the book was not their manifesto. Later Wittgenstein diverges from verificationist doctrine without thereby erasing every continuity of concern or method.
...
## 2026 OWNER ADDENDUM — WORDS, IDEAS AND THE MIND

### Exact new demand

The 2026 paper asks whether words may be viewed as ideas in the speaker's mind. Later
Wittgenstein rejects that general identification. A private image can accompany a word, but it
does not establish the norm governing correct and incorrect applications. The same image may
accompany different uses, different images may accompany the same use, and many expressions
have no plausible mental object. Understanding is therefore displayed in mastery of a technique
within a language-game rather than possession of an introspectible item.

```text
WORD -> alleged private idea -> no independent standard of sameness or correctness
WORD -> trained use -> criteria, correction, continuation and shared intelligibility
```

This does not deny imagery, intention or inner experience. It denies that an idea in one mind is
the semantic bearer that makes a word meaningful. The qualification matters: mental episodes
may causally prompt or accompany speech, while grammar and public-type practice determine what
counts as using the word correctly. This route connects PI 43, the rule-following discussion,
the diary case and first-person avowals without reducing mind to behaviour.

## OPTIONAL ADVANCED DEPTH
 — NOT REQUIRED FOR A CORE ANSWER
...
1. **Kripkenstein and rule-following scepticism — second-order layer** ❓
   - **✅ Core status (15 Aug 2026 — partial promotion executed):** the rule-following paradox, the regress of interpretations and a one-line summary of Kripke's sceptical reading (with its 1982 source and the caution that Kripke presents it as "Wittgenstein's argument as it struck Kripke") **now live in Core** at `Later-Wittgenstein.md`. A candidate can therefore take a defended side on Kripke's reading without opening this file.
