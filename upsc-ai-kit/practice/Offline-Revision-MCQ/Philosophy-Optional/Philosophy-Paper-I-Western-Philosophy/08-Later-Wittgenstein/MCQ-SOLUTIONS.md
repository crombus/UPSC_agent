# Later Wittgenstein — MCQ Solutions
...
**Repair action:** State continuity of therapeutic clarification and discontinuity about the source and structure of meaning.
...
**Repair action:** Present colour exclusion as an internal crack, then add the Augustinian and methodological criticisms.
...
**Repair action:** Attach 1921 or 1922 to the Tractatus and 1953 posthumously to the Investigations.
...
**Repair action:** Describe reminders, comparisons and perspicuous representation as philosophical work without making them a hidden calculus.
...
**Repair action:** Assign ownership by the principal doctrine demanded, and label comparisons without recounting them.
...
**Repair action:** Quote the hedge and define use as a role governed by a practice.
...
**Examiner trap 7:** Remembering the image while reversing the philosophical work it performs.

**Repair action:** Use the toolbox to compare linguistic functions such as ordering, asking, calculating and avowing.
...
**Repair action:** State that ostension functions inside an already developing language-game and method of comparison.
...
**Repair action:** Test mastery through appropriate continuation, correction and transfer rather than introspective accompaniment.
...
**Repair action:** Ask what the expression does in the concrete activity and what responses count as appropriate.
...
**Repair action:** Describe a network of similarities whose different strands connect different cases.
...
**Repair action:** Use examples to test whether the alleged common feature survives across the concept's applications.
...
**Repair action:** Separate fuzzy edges from the trained central applications that sustain a concept.
...
**Repair action:** Move from varied games to overlapping similarities and then to varied linguistic practices.
...
**Repair action:** Explain what makes this activity self-contained, then stress that it is one game among many.
...
**Repair action:** Look for stable teaching, correction and continuation rather than a complete rulebook.
...
**Repair action:** Describe innovation as norm-governed uptake within changing human activities.
...
**Repair action:** Identify the activity, expected uptake and standards that distinguish joking from reporting.
...
**Repair action:** Use the progression from use to games, family resemblance, forms of life, rules and private-language criticism.
...
**Repair action:** Define it minimally as the shared natural and cultural background in which games have a point.
...
**Repair action:** Use shared doing as the background that permits disagreement rather than eliminating it.
...
**Repair action:** Connect intelligibility to shared practices while preserving translation across sufficiently overlapping lives.
...
**Repair action:** Say that explanations end in established practice while right and wrong remain internal to that practice.
...
**Repair action:** Frame the issue as under-definition, then note shared natural reactions and cross-practice overlap.
...
**Repair action:** State the regress and then distinguish an interpretation from a practice of obeying and correcting.
...
**Repair action:** Show why each proposed interpretation requires another standard, then move to trained practice.
...
**Repair action:** Use training and correction as constitutive practices, not as mere statistical regularities.
...
**Examiner trap 28:** Presenting 'Kripkenstein' without labelling it as an interpretation.

**Repair action:** State Kripke's challenge, then note Baker, Hacker and the text's therapeutic framing.
...
**Repair action:** Look for teachability, correction, reasons and recognized mistakes across new cases.
...
**Repair action:** Distinguish logical availability of standards from the accidental presence of other speakers.
...
**Repair action:** Define the target through in-principle inaccessibility and private ostensive grounding.
...
**Repair action:** Show that memory cannot validate itself when the same present impression defines both rule and correctness.
...
**Repair action:** State the normative consequence: a sign cannot be governed when seeming and correctness are identical.
...
**Repair action:** Say that the box's content may vary or be empty while the shared word continues to function.
...
**Repair action:** Trace the solipsist's assertion to the need for rule-governed signs and then expose private ostension.
...
**Repair action:** Use the Robinson Crusoe distinction: actual isolation differs from essential privacy.
...
**Repair action:** Present the solitary-speaker challenge, then distinguish inherited public-type criteria from private ostension.
...
**Repair action:** Separate the existence of sensations from the semantic role assigned to private objects.
...
**Repair action:** Contrast grammatical justification with inductive evidence and preserve defeasibility.
...
**Repair action:** Use pretence to show constitutive relevance without reductive equivalence.
...
**Repair action:** State the semantic anchoring claim and explicitly reject behavioural identity.
...
**Repair action:** Contrast expressive first-person use with criterion-guided third-person attribution.
...
**Repair action:** Name both rejected poles and explain how criteria plus avowals occupy the middle.
...
**Repair action:** Show the home use, the illicit extension and the appearance produced by that extension.
...
**Repair action:** Use comparison tables, intermediate cases and reminders to make grammatical relations surveyable.
...
**Repair action:** Limit the slogan to nonrevisionary grammatical clarification and acknowledge the quietist objection.
...
**Repair action:** Connect diagnosis, reminders, perspicuous representation and the ability to stop.
...
**Repair action:** State that the marks remain constant while a conceptually informed aspect dawns.
...
**Examiner trap 49:** Allowing interesting enrichment to crowd out the assessed core or assigning it to the wrong period.

**Repair action:** Prioritize use, games and private language, then add aspects or hinges only where the demand invites them.
...
**Repair action:** Separate causal accompaniment from normative meaning and use examples lacking plausible mental objects.
...
**Repair action:** Conclude with explanatory gains and identify the specific unresolved seams rather than generic objections.

**Coverage mapping:** `C10`.

**PYQ linkage:** All PYQs.
