# 11 Quine and Strawson — Offline Revision Guide

> Syllabus boundary: Quine and Strawson: Critique of Empiricism; Theory of Basic Particulars and Persons.
>
> Source lineage: The latest g5 session/workbook, canonical owner file, earlier complete session/workbook and verified 2018–2026 PYQ ledgers were read. The canonical owner file is substantially retained where it was already final; source cells were reconciled, adapted and mapped, repeated teaching apparatus was consolidated, and new 2026/PYQ/validator controls were added. Mechanical overlap and witness checks do not prove semantic completeness.

## Release boundary and ownership

| Printed burden | Primary owner | Required result |
|---|---|---|
| Critique of empiricism | Quine | two dogmas, failed analyticity explications, reductionism, holism, revisability and qualified empiricism |
| Basic particulars | Strawson | descriptive metaphysics, public spatio-temporal identification and material bodies |
| Persons | Strawson | primitive person, M/P predicates, self-/other-ascription and anti-dualist consequence |

Quinean naturalism, holism and regimentation must not be merged with Strawsonian descriptive metaphysics. Russell's positive theory of descriptions remains Topic 06-owned; Logical Positivism's positive verification programme remains Topic 07-owned. Topic 11 owns the criticisms and rival analyses only where the principal burden is Quine or Strawson.

## Coverage roadmap

```text
QUINE
  Two Dogmas -> failed analyticity circle -> reductionism rejected
      -> corporate testing -> web of belief -> revisability with minimum mutilation
      -> naturalized epistemology / ontological commitment
      -> radical translation -> gavagai -> inscrutability / indeterminacy / relativity

STRAWSON
  descriptive metaphysics -> identification and re-identification
      -> one public spatio-temporal framework -> material bodies
      -> persons as primitive -> M + P predicates -> self/other ascription
      -> On Referring -> use, context and presupposition against Russell
```

# QUINE AND STRAWSON — Syllabus Item 11 (Paper I · Section A)
...
## 1. QUINE — CRITIQUE OF EMPIRICISM: "TWO DOGMAS OF EMPIRICISM" ✅
...
2. But the same stimulus meaning is equally compatible with:
   - "**undetached rabbit-parts**" — wherever a rabbit is present, undetached rabbit-parts are present, and conversely;
   - "**a temporal stage of a rabbit**" — likewise co-extensive;
   - "**rabbithood**" (an instantiation of the universal) — likewise;
...
```
State   : Logical positivists distinguish analytic (true by meaning) from synthetic (true by fact).
...
Result  : The principled analytic boundary fails; centrality explains differential
          practical revisability within the web, not a replacement definition of analyticity.
...
## T. QUOTATION, DATING & PROVENANCE DISCIPLINE ✅
...
| *The Bounds of Sense* | **1966** | The "**non-sequitur of numbing grossness**" charge against Kant's Second Analogy is here — see [`Kant.md`](Kant.md) §3.6.2. ✅ Safe verbatim; it is Strawson's own phrase. |
...
- Cross-paper: [Notions of God](../../paper-2/philosophy-of-religion/Notions-of-God.md) — ontological commitment (Quine) bears on whether "God" is a value of a bound variable.
...
## 11. 2026 ownership update and exact demand

**2026 Q3(a), 20 marks:** “Why are states of consciousness ascribed to anything at all and why are they ascribed to the same things to which we also ascribe physical properties? How does Strawson answer these questions in his work *Individuals*?”

This is directly owned by Strawson's theory of persons. The answer must connect the possibility of P-predication to one identifiable subject of both physical and psychological predicates; explain the asymmetry of self- and other-ascription; and show why an independently identifiable Cartesian ego cannot ground the practice. It is not an invitation to replace *Individuals* with reactive attitudes or a generic mind-body essay.

## 12. Additional precision controls

### Quine

- **Canonical notation:** first regiment the accepted theory; then inspect what its bound variables must range over. The slogan is a commitment criterion after theory choice, not noun-counting and not an ontology-selection algorithm.
- **Indispensability:** Quine's parsimony does not entail nominalism at any cost. Abstract commitment can follow indispensable quantification in best science; the broader Quine-Putnam argument is not identical with the slogan.
- **Proxy functions:** systematic object permutations can preserve sentence-level truth, strengthening the claim that reference is fixed only relative to a background interpretation.
- **Underdetermination:** evidential equivalence between scientific theories does not by itself yield translation indeterminacy. The latter adds Quine's contested naturalistic thesis that no further semantic fact selects a manual.
- **Logical laws:** the early essay includes logic in revisability in principle. Later Quine's minimum-mutilation conservatism and “change of logic, change of subject” warning qualify any casual appeal to quantum logic.

### Strawson

- **Subject-predicate framework:** ordinary predication normally presupposes successful identification of a subject. Feature-placing expressions complicate but do not abolish the framework.
- **Other minds:** public criteria for other-ascription are not reductive behaviourism. The same P-predicate is other-ascribed on behavioural/situational criteria and self-ascribed without observation.
- **Uniqueness and context:** “On Referring” distinguishes sentence meaning from a speaker's use on an occasion. Context can fix whom a speaker intends without making every uniqueness condition the conversational assertion.
- **Presupposition caution:** the meaningful sentence-type does not become meaningless. Strawson's original treatment concerns an unsuccessful use that ordinarily fails to make a true-or-false assertion; later theories vary.
- **Reactive attitudes:** *Freedom and Resentment* is source-recognized bounded enrichment, not printed core or independent PYQ ownership here.

## 13. Exact owned PYQs through 2026

| Year | Part | Marks | Primary demand |
|---|---|---:|---|
| 2018 | Q1(e) | 10 | Strawson's concept of person |
| 2018 | Q2(c) | 15 | Quine on the Kantian a priori |
| 2019 | Q1(e) | 10 | argument against analytic/synthetic distinction |
| 2020 | Q3(b) | 15 | spatio-temporal thinking and objective thought |
| 2021 | Q3(b) | 15 | material bodies and persons as basic particulars |
| 2021 | Q3(c) | 15 | empiricism without the dogmas |
| 2023 | Q4(a) | 20 | person as primitive and mind-body dualism |
| 2024 | Q4(c) | 15 | nature of the two dogmas |
| 2025 | Q4(b) | 15 | web of belief and revisability quotation |
| 2026 | Q3(a) | 20 | states of consciousness and physical properties in *Individuals* |

No Topic 11 question was primary-owned in 2022. Russell's 2023 Q4(b) and related description questions remain Topic 06-owned; Logical Positivism questions remain Topic 07-owned even where Quine supplies criticism.

## 14. Closed-book register

1. State the **two-project firewall** before comparison.
2. Reproduce the analyticity circle: meaning -> synonymy -> definition/interchangeability/necessity/semantical rules -> circularity or residual unclarity.
3. Derive holism from the rejection of sentence-by-sentence reduction.
4. Qualify universal revisability through pragmatic conservatism and later logical caution.
5. Separate commitment, indispensability, translation indeterminacy, reference inscrutability and ontological relativity.
6. Derive bodies from identification plus re-identification in one public space-time.
7. Derive persons from one subject of M- and P-predicates plus self-/other-ascription.
8. State the Russell-Strawson split as asserted existence/uniqueness versus presupposition in use, without calling the sentence meaningless.
9. End comparative answers with a layered verdict, not a fabricated Quine-Strawson school.

## 15. Recall prompts

- Can you explain why definition cannot create cognitive synonymy by stipulation alone?
- Can you derive `not-(H and A)` without pretending that evidence names the guilty conjunct?
- Can you distinguish stimulus meaning, observation sentence, analytical hypothesis, inscrutability and indeterminacy?
- Can you explain why “primitive person” is neither dualism, materialism nor a third substance?
- Can you state what descriptive metaphysics proves internally and what it leaves externally open?
- Can you answer the 2026 question without drifting into reactive attitudes?
