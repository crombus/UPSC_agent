...
[`basic/07`](../basic/07_Interpersonal-and-Communication-Skills.md); optional negotiation and
public-dealing depth resides in
[`advanced/07`](07_Interpersonal-Communication-Negotiation-and-Public-Dealing.md). This section
retains the interface with logical option elimination.
