...
- **Dated-source discipline:** The ARC's 4th Report is a **2007 document**. Its data, case
  ...
  **current enacted-law status verified as of 4 August 2026**. Distinguish four different things
  ...
  - Prevention of Corruption (Amendment) Act, 2018 — assent **26 July 2018**, brought into force
    the same day (S.O. 3662(E)); enacted *and* operative.
  ...
  - Prohibition of Benami Property Transactions Act, 1988 (as amended 2016, in force 1 November
    2016) — *Union of India v. Ganpati Dealcom* (23 August 2022) was **recalled in full** by the
    Supreme Court on **18 October 2024** and the appeal restored, so the retrospectivity question
    is open, not settled.
...
- **No duplication of constitutional-body detail:** composition, appointment and removal
  ...
  `Polity/advanced/36_CIC-and-SIC.md` and `Polity/advanced/41_Public-Services.md`. This folder links to
  them and teaches only the **ethics-specific** angle: jurisdiction debates, ethical dilemmas,
  probity and dilemma analysis.
- **No duplication of optional-depth philosophy:** classical positions of Aristotle, Kant, Mill,
  the Buddha and Indian darshanas are taught in depth in `Philosophy/paper-1/western/` and
  `Philosophy/paper-1/indian/`. This folder links to them and teaches only what GS-IV actually
  tests — usable definitions, thinker-to-administration translation and PYQ-quotation analysis.

## Topic map

| # | Topic | Core exam area |
|---|---|---|
| 01 | Ethics and Human Interface | Foundational definitions, essence, determinants |
| 02 | Human Values and Lessons from Leaders | Family/society/education, exemplars |
| 03 | Attitude: Content, Structure and Persuasion | Attitude vs values, influence on behaviour |
| 04 | Aptitude and Foundational Values for Civil Service | Integrity, impartiality, compassion |
| 05 | Emotional Intelligence in Administration | EQ theory and administrative use |
| 06 | Indian Moral Thinkers and Philosophers | Kautilya, Gandhi, Vivekananda, Buddha, Basava |
| 07 | Western Moral Philosophers and Thinkers | Socrates, Plato, Aristotle, Kant, Mill, Rawls |
| 08 | Moral Theories: Deontology, Consequentialism, Virtue Ethics | Applied ethical reasoning |
| 09 | Public Service Values, Status and Ethical Dilemmas | Nolan principles, dilemma resolution |
| 10 | Sources of Ethical Guidance: Laws, Rules, Conscience | Hierarchy and conflict of sources |
| 11 | Accountability and Ethical Governance | Accountability vs responsibility, CVC/CBI/Lokpal ethics angle |
| 12 | Corporate Governance and International Ethics | UNCAC, OECD-ADB, business ethics vs CSR |
| 13 | Emerging Ethics: Technology, AI and Environment | AI ethics, data, climate ethics |
| 14 | Probity: Concept and Philosophical Basis of Governance | Probity vs integrity vs honesty |
| 15 | Transparency, RTI and Information Sharing | RTI Act, Official Secrets Act, disclosure |
| 16 | Codes of Ethics and Codes of Conduct | Ministers, legislators, civil servants |
| 17 | Citizens' Charters, Work Culture and Service Delivery | Accountability tools, service standards |
| 18 | Utilization of Public Funds and Challenges of Corruption | Procurement, squandering, MPLADS |
...
| Official clause | Status | Primary owners | PYQ integration note |
|---|---|---|---|
...
| `Probity in Governance: Concept of public service;` | **COVERED** | [`basic/14_Probity-Concept-and-Philosophical-Basis-of-Governance.md`](basic/14_Probity-Concept-and-Philosophical-Basis-of-Governance.md), [`basic/09_Public-Service-Values-Status-and-Ethical-Dilemmas.md`](basic/09_Public-Service-Values-Status-and-Ethical-Dilemmas.md) | Topic 14 defines probity, and Topic 09 keeps it tied to public-service value practice. |
| `Philosophical basis of governance and probity;` | **COVERED** | [`basic/14_Probity-Concept-and-Philosophical-Basis-of-Governance.md`](basic/14_Probity-Concept-and-Philosophical-Basis-of-Governance.md), [`advanced/14_Probity-Concept-and-Philosophical-Basis-of-Governance.md`](advanced/14_Probity-Concept-and-Philosophical-Basis-of-Governance.md) | Topic 14 is the dedicated owner and already links probity to recent public-service/probity questions. |
| `Information sharing and transparency in government,` | **COVERED** | [`basic/15_Transparency-RTI-and-Information-Sharing.md`](basic/15_Transparency-RTI-and-Information-Sharing.md), [`advanced/15_Transparency-RTI-and-Information-Sharing.md`](advanced/15_Transparency-RTI-and-Information-Sharing.md) | Topic 15 routes transparency answers through RTI, MKSS and Parivartan. |
| `Right to Information,` | **COVERED** | [`basic/15_Transparency-RTI-and-Information-Sharing.md`](basic/15_Transparency-RTI-and-Information-Sharing.md), [`advanced/15_Transparency-RTI-and-Information-Sharing.md`](advanced/15_Transparency-RTI-and-Information-Sharing.md) | The RTI owner file already contains PYQ application notes and cross-links to Topic 23 cases. |
| `Codes of Ethics,` | **COVERED** | [`basic/16_Codes-of-Ethics-and-Codes-of-Conduct.md`](basic/16_Codes-of-Ethics-and-Codes-of-Conduct.md), [`advanced/16_Codes-of-Ethics-and-Codes-of-Conduct.md`](advanced/16_Codes-of-Ethics-and-Codes-of-Conduct.md) | Topic 16 explicitly routes 2025 Q5(a), preserving the ARC/2025 caveat on the dual-code gap. |
| `Codes of Conduct,` | **COVERED** | [`basic/16_Codes-of-Ethics-and-Codes-of-Conduct.md`](basic/16_Codes-of-Ethics-and-Codes-of-Conduct.md), [`advanced/16_Codes-of-Ethics-and-Codes-of-Conduct.md`](advanced/16_Codes-of-Ethics-and-Codes-of-Conduct.md) | Same recent 2025 Q5(a) route as above; the file keeps conduct and ethics codes distinct. |
| `Citizen's Charters,` | **COVERED** | [`basic/17_Citizens-Charters-Work-Culture-and-Service-Delivery.md`](basic/17_Citizens-Charters-Work-Culture-and-Service-Delivery.md), [`advanced/17_Citizens-Charters-Work-Culture-and-Service-Delivery.md`](advanced/17_Citizens-Charters-Work-Culture-and-Service-Delivery.md) | Topic 17 explicitly turns Citizens' Charters into Mains/Prelims-style practice. |
...
1. **Foundations (01-05):** what ethics is, how values/attitude/aptitude/EQ shape conduct.
2. **Thought traditions (06-08):** Indian and Western thinkers, then applied moral theories.
3. **Public-service core (09-12):** values, sources of guidance, accountability, corporate/global ethics.
4. **Contemporary and administrative machinery (13-18):** emerging ethics, probity, transparency,
   codes, service delivery, public-money integrity.
...
- ✅ Primary anchor: 2nd ARC, 4th Report, *Ethics in Governance* (2007) — read directly from the
  local PDF (`books/ethics4.pdf`), with paragraphs cited by number (e.g. `ARC 3.2.2`), boxes by
  box number (e.g. `Box 2.8`) and colloquium material by annexure (e.g. `Annexure-I(2)`).
- ✅ Recent complete PYQ anchors: UPSC GS-IV Mains 2024 and 2025 papers, and the 2024/2025 Essay
  papers, read directly from `books/mains/`. **Section A of GS-IV is Q1-Q6; Section B (case
  studies) is Q7-Q12 in both papers** — case studies are cited by their real paper numbers.
- ⚠️ Older direct questions are quoted only where verified against the official previous-paper
  record on upsc.gov.in; no PYQ number or year is invented.
- ⚠️ **Quotation discipline:** a UPSC paper proves that UPSC printed an attribution, not that the
  attribution is authentic. Where a set quotation cannot be traced to a primary source (e.g. the
  Sardar Patel and William James lines in the 2024/2025 papers, and the Vivekananda "strength of a
  society" line in 2025), the file says so explicitly and answers the *idea* rather than asserting
  the provenance.
- 📰 Current-law status (PC Act 2018, Lokpal, Whistle Blowers Protection Act, Benami, RTI/DPDP,
  Companies Act s.135, Mission Karmayogi/NPCSCB, India AI Governance Guidelines) verified against
  first-party sources (India Code, Supreme Court, DoPT/CVC/Lokpal, MCA, MeitY, UNODC/UN Treaty
  Collection) and date-stamped in each relevant file.
