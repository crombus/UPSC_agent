# Protecting Honest Officials and Vigilance Administration - MUST-DO
...
| ✅ **Whistleblower / protected disclosure** | A whistleblower reports reasonably believed wrongdoing in the public interest. Protection requires a lawful receiving channel, restricted identity access, evidence preservation, retaliation monitoring and independent follow-up; filing a complaint does not itself prove the allegation. The Whistle Blowers Protection Act, 2014 must be described by its verified commencement status, while PIDPI remains the relevant administrative channel for specified Central Government disclosures. |
