...
UPSC TRAP / ANSWER-USE: Do not replace selective cross-sector and multi-scale analysis with a generic GS-style catalogue.
...
EXACT TERMS: Purpose | scope | central | idea | common | misreading
...
UPSC TRAP / ANSWER-USE: Do not cross the ownership boundary: named evidence ownership belongs to 12.
ANSWER-GRABBING FORMULATION: a scaffold is useful only while it serves the exact proposition and remains qualified
```
...
EXACT TERMS: Basic | decomposition | questions | Dimension-expansion | grid | Technology
...
EXACT TERMS: Dimension-expansion | grid | India-first | illustration | starters | Scale-match
MECHANISM / ARGUMENT: connect Dimension-expansion grid — 3 and India-first illustration starters without changing the prompt or evidence status
...
EXACT TERMS: Dimension-expansion | grid | Thesis | options | selection | determine
...
```closure-flow
START / CONCEPT: Dimension-expansion grid — 3
EXACT TERMS: Dimension-expansion | grid | Simple | architecture | Typically | lens
...
EXACT TERMS: India-first | illustration | starters | Simple | architecture | Thesis
MECHANISM / ARGUMENT: connect Simple essay architecture — 2 without changing the prompt or evidence status
...
EXACT TERMS: Thesis | options | selection | Opening | body | closure
...
EXACT TERMS: Simple | architecture | Traps | repair | moves | Economically
MECHANISM / ARGUMENT: connect Traps and repair moves and Traps and repair moves — 2 without changing the prompt or evidence status
...
EXACT TERMS: Narrative | reflective | control | definition | taxonomy | next
...
B. Treat Dimension-expansion grid — 3 as a compulsory UPSC formula even when it distorts the prompt.
C. Replace Dimension-expansion grid — 3 with a familiar adjacent GS topic and maximise factual coverage.
...
A. Apply Dimension-expansion grid — 3 only after drafting, when topic drift can no longer be prevented.
...
C. Use Dimension-expansion grid — 3 while dropping the prompt's operator, qualifier or scale.
D. Let a striking anecdote or quotation determine Dimension-expansion grid — 3 regardless of thesis fit.
...
B. Treat Simple essay architecture — 2 as a compulsory UPSC formula even when it distorts the prompt.
C. Replace Simple essay architecture — 2 with a familiar adjacent GS topic and maximise factual coverage.
D. Use Simple essay architecture — 2 to add more headings or dimensions without testing coherence.
...
A. Apply Simple essay architecture — 2 only after drafting, when topic drift can no longer be prevented.
...
C. Use Simple essay architecture — 2 while dropping the prompt's operator, qualifier or scale.
D. Let a striking anecdote or quotation determine Simple essay architecture — 2 regardless of thesis fit.
...
A. Present Simple essay architecture — 2 as an official marking rule rather than a pedagogical scaffold.
B. Use Simple essay architecture — 2 to avoid stating a serious counter-case or qualification.
...
A. Maximise the number of outputs produced by Simple essay architecture — 2, even if they repeat one claim.
B. Allow an exception discovered through Simple essay architecture — 2 to replace the central proposition.
C. Silently tidy the printed prompt before applying Simple essay architecture — 2 to make it easier to answer.
