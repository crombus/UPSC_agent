...
EXACT TERMS: Purpose | ownership | prompt | fidelity | scope | central
MECHANISM / ARGUMENT: connect Purpose and scope and The central idea and common misreading without changing the prompt or evidence status
CONSEQUENCE / CONTRAST: State the exact demand and the bounded writing decision.
UPSC TRAP / ANSWER-USE: Do not replace macro-sequence, paragraph jobs and explicit logical movement with a generic GS-style catalogue.
...
EXACT TERMS: Purpose | scope | Basic | decomposition | questions | many
...
UPSC TRAP / ANSWER-USE: Do not cross the ownership boundary: counterargument design belongs to 08.
ANSWER-GRABBING FORMULATION: a scaffold is useful only while it serves the exact proposition and remains qualified
```
...
EXACT TERMS: central | idea | common | misreading | Dimension-expansion | grid
MECHANISM / ARGUMENT: connect Dimension-expansion grid without changing the prompt or evidence status
...
EXACT TERMS: Basic | decomposition | questions | Dimension-expansion | grid | PERSONAL
MECHANISM / ARGUMENT: connect Dimension-expansion grid — 2 without changing the prompt or evidence status
...
```closure-flow
START / CONCEPT: Dimension-expansion grid
EXACT TERMS: Dimension-expansion | grid | India-first | illustration | starters | Assign
...
```closure-flow
START / CONCEPT: Dimension-expansion grid — 2
EXACT TERMS: Dimension-expansion | grid | Thesis | options | selection | Simple
...
EXACT TERMS: Simple | architecture | Traps | repair | moves | include
...
EXACT TERMS: Opening | body | closure | moves | Timed | micro-drill
MECHANISM / ARGUMENT: connect Timed micro-drill and self-check without changing the prompt or evidence status
...
```closure-flow
START / CONCEPT: Traps and repair moves
EXACT TERMS: Traps | repair | moves | Timed | micro-drill | self-check
MECHANISM / ARGUMENT: connect Timed micro-drill and self-check — 2 and Semantic-completeness repair — 6 September 2026 without changing the prompt or evidence status
...
EXACT TERMS: knowledge | Advanced | proposition | boundary | transition | strong
...
EXACT TERMS: Narrative | reflective | control | definition | taxonomy | specific
...
MECHANISM / ARGUMENT: connect Tension pairs and hidden assumptions — 2 and Tension pairs and hidden assumptions — 3 without changing the prompt or evidence status
...
B. Treat Dimension-expansion grid as a compulsory UPSC formula even when it distorts the prompt.
...
B. Use Dimension-expansion grid to avoid stating a serious counter-case or qualification.
C. This base plan has 9 paragraphs ; one or two earned expansions make it 10–11. It is a planning heuristic, not a paper rule.
D. Support Dimension-expansion grid with an unverified statistic, attribution or current claim.
...
B. Treat Dimension-expansion grid — 2 as a compulsory UPSC formula even when it distorts the prompt.
C. Replace Dimension-expansion grid — 2 with a familiar adjacent GS topic and maximise factual coverage.
D. Use Dimension-expansion grid — 2 to add more headings or dimensions without testing coherence.
...
D. Let a striking anecdote or quotation determine Dimension-expansion grid — 2 regardless of thesis fit.
...
D. Support Dimension-expansion grid — 2 with an unverified statistic, attribution or current claim.
...
A. Maximise the number of outputs produced by Dimension-expansion grid — 2, even if they repeat one claim.
B. Allow an exception discovered through Dimension-expansion grid — 2 to replace the central proposition.
C. Silently tidy the printed prompt before applying Dimension-expansion grid — 2 to make it easier to answer.
...
**Answer: A.**
**Explanation:** Each body paragraph should: (a) open with a transition to the previous paragraph, (b) state its claim, (c) develop mechanism and illustration, (d) close with a qualification or a link forward to the next paragraph. See 06 for the essay-level opening/closing paragraphs specifically. The other options convert a qualified writing method into an official formula, permit topic drift, or reward quantity without coherence and evidence safety.
...
C. Use Timed micro-drill and self-check — 2 while dropping the prompt's operator, qualifier or scale.
...
A. Present Timed micro-drill and self-check — 2 as an official marking rule rather than a pedagogical scaffold.
B. Use Timed micro-drill and self-check — 2 to avoid stating a serious counter-case or qualification.
...
D. Support Timed micro-drill and self-check — 2 with an unverified statistic, attribution or current claim.
...
B. Treat Semantic-completeness repair — 6 September 2026 as a compulsory UPSC formula even when it distorts the prompt.
C. Replace Semantic-completeness repair — 6 September 2026 with a familiar adjacent GS topic and maximise factual coverage.
D. Use Semantic-completeness repair — 6 September 2026 to add more headings or dimensions without testing coherence.
...
A. Present Semantic-completeness repair — 6 September 2026 as an official marking rule rather than a pedagogical scaffold.
