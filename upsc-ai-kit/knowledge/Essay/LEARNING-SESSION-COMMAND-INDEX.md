...
|---:|---|---|---|---|---|
| 01 | **Paper Rules, Choice and Selection**<br>complete package available; `basic/01_Paper-Rules-Choice-and-Selection.md` | `Start Essay 01 - Paper Rules, Choice and Selection` | `Deep Essay 01` | `Test Essay 01` | `Revise Essay 01` |
...
| 08 | **Argument, Counterargument and Synthesis**<br>Core owner ready; `basic/08_Argument-Counterargument-and-Synthesis.md` | `Start Essay 08 - Argument, Counterargument and Synthesis` | `Deep Essay 08` | `Test Essay 08` | `Revise Essay 08` |
| 09 | **Evidence, Examples, Data and Quotation Discipline**<br>Core owner ready; `basic/09_Evidence-Examples-Data-and-Quotation-Discipline.md` | `Start Essay 09 - Evidence, Examples, Data and Quotation Discipline` | `Deep Essay 09` | `Test Essay 09` | `Revise Essay 09` |
| 10 | **Ethical and Philosophical Frameworks and Value Conflicts**<br>Core owner ready; `basic/10_Ethical-Philosophical-Frameworks-and-Value-Conflicts.md` | `Start Essay 10 - Ethical and Philosophical Frameworks and Value Conflicts` | `Deep Essay 10` | `Test Essay 10` | `Revise Essay 10` |
| 11 | **Cross-Sector Lenses and Scale**<br>Core owner ready; `basic/11_Cross-Sector-Lenses-and-Scale.md` | `Start Essay 11 - Cross-Sector Lenses and Scale` | `Deep Essay 11` | `Test Essay 11` | `Revise Essay 11` |
| 12 | **India-Centric Illustration Bank**<br>Core owner ready; `basic/12_India-Centric-Illustration-Bank.md` | `Start Essay 12 - India-Centric Illustration Bank` | `Deep Essay 12` | `Test Essay 12` | `Revise Essay 12` |
| 13 | **Time Management, Planning and Execution**<br>Core owner ready; `basic/13_Time-Management-Planning-and-Execution.md` | `Start Essay 13 - Time Management, Planning and Execution` | `Deep Essay 13` | `Test Essay 13` | `Revise Essay 13` |
| 14 | **Language, Style and Functional Visuals**<br>Core owner ready; `basic/14_Language-Style-and-Functional-Visuals.md` | `Start Essay 14 - Language, Style and Functional Visuals` | `Deep Essay 14` | `Test Essay 14` | `Revise Essay 14` |
| 15 | **Self-Evaluation and Internal Practice Rubric**<br>Core owner ready; `basic/15_Self-Evaluation-and-Internal-Practice-Rubric.md` | `Start Essay 15 - Self-Evaluation and Internal Practice Rubric` | `Deep Essay 15` | `Test Essay 15` | `Revise Essay 15` |
| 16 | **Practice Loops, PYQ Lab and Revision System**<br>Core owner ready; `basic/16_Practice-Loops-PYQ-Lab-and-Revision-System.md` | `Start Essay 16 - Practice Loops, PYQ Lab and Revision System` | `Deep Essay 16` | `Test Essay 16` | `Revise Essay 16` |

Use `Resume Essay` to continue the subject.
