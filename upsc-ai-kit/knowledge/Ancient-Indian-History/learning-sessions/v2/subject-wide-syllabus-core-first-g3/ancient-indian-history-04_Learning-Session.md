---
title: The Stone Age: Palaeolithic & Mesolithic
...
![The Stone Age: Palaeolithic & Mesolithic learning spine](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-04\ancient-indian-history-04-learning-spine.png)
...
```closure-flow
SUBTOPIC: Roadmap, Syllabus Boundary and Evidence Discipline
KEY TERMS / DEFINITIONS: FACT: Static foundation comes first from the authored Topic 04 basic and advanced files, then local OCR-searchable R.S.
...
```closure-flow
SUBTOPIC: Geological Context: Pleistocene, Holocene and Changing Landscapes
KEY TERMS / DEFINITIONS: CURRENT: The 2024 Retlapalle study and the 2026 South Asian Palaeolithic symposium show that chronology and environmental context remain active research fields rather than settled textbook tables.
...
```closure-flow
SUBTOPIC: Human Evolution and the Sparse Indian Hominin Record
KEY TERMS / DEFINITIONS: Human evolution is included only to the extent necessary for Indian prehistory.
...
```closure-flow
SUBTOPIC: Lithic Evidence Grammar: Artefact, Core, Flake, Debitage and Context
KEY TERMS / DEFINITIONS: A stone tool is the surviving product of a technological sequence.
...
```closure-flow
SUBTOPIC: Dating and Archaeological Methods: Building a Defensible Chronology
KEY TERMS / DEFINITIONS: FACT: Attirampakkam's Acheulian-to-Middle-Palaeolithic transition was dated by luminescence to about 385 +/- 64 ka in the cited research.
...
```closure-flow
SUBTOPIC: Lower Palaeolithic: Acheulian Landscapes and Large Cutting Tools
KEY TERMS / DEFINITIONS: The Lower Palaeolithic is marked by large core and flake tools, especially Acheulian handaxes and cleavers in peninsular India.
...
```closure-flow
SUBTOPIC: Raw Materials, Factory Sites and the Economics of Stone
KEY TERMS / DEFINITIONS: Grain, fracture quality, nodule size, distance and intended tool form shaped selection.
...
```closure-flow
SUBTOPIC: Attirampakkam and the Chronology Debate
KEY TERMS / DEFINITIONS: Attirampakkam in the Kortallaiyar basin is central because multidisciplinary excavation exposed a long fluvial sequence containing Acheulian and Middle Palaeolithic technologies.
...
```closure-flow
SUBTOPIC: Middle Palaeolithic: Flake Industries and Prepared-Core Planning
KEY TERMS / DEFINITIONS: FACT: The Levallois technique prepares core shape and striking platform before detaching a thin planned flake.
...
```closure-flow
SUBTOPIC: Upper Palaeolithic: Blades, Bone Tools and Symbolic Expansion
KEY TERMS / DEFINITIONS: The Upper Palaeolithic is conventionally associated with parallel-sided blades, burins, bone tools, ornaments and more visible symbolic evidence.
...
```closure-flow
SUBTOPIC: Technology as Adaptation: Core Tools to Microlithic Composites
KEY TERMS / DEFINITIONS: FACT: A microlith is generally under 5 cm and often made on short blades of cryptocrystalline stone.
...
```closure-flow
SUBTOPIC: Mobility, Settlement and Social Life of Palaeolithic Communities
KEY TERMS / DEFINITIONS: CURRENT: Landscape and raw-material studies increasingly reconstruct networks of sites rather than treating every artefact scatter as an isolated camp.
...
```closure-flow
SUBTOPIC: Subsistence and Climate-Ecology Adaptation
KEY TERMS / DEFINITIONS: FACT: Hunsgi ecological studies identified many wild edible plant species alongside small game and aquatic resources.
...
```closure-flow
SUBTOPIC: Palaeolithic Art, Ornament and Cult Evidence
KEY TERMS / DEFINITIONS: FACT: Patne and Bhimbetka yielded Upper Palaeolithic ostrich-eggshell beads.
...
```closure-flow
SUBTOPIC: Mesolithic Transition: Holocene Adaptation, Not a Single Revolution
KEY TERMS / DEFINITIONS: CURRENT: Recent regional microlithic research in the Lower Ganga Basin treats chronology and ecology together, reinforcing that the Mesolithic is regionally defined.
...
```closure-flow
SUBTOPIC: Microliths and Composite Technology
KEY TERMS / DEFINITIONS: CURRENT: The 2025 article 'Understanding the Microlithic Technology in the Lower Ganga Basin' examines microliths through chronological and ecological perspectives rather than treating them as a timeless fossil type.
...
```closure-flow
SUBTOPIC: Mesolithic Subsistence, Sedentariness and Domestication Debates
KEY TERMS / DEFINITIONS: Context: Sedentariness is a continuum.
...
```closure-flow
SUBTOPIC: Burials, Ritual and Social Organization
KEY TERMS / DEFINITIONS: CURRENT: The 2026 Ladakh aDNA study is later than the Stone Age, but it illustrates how burials can now be studied through osteology, radiocarbon, kinship and genome-wide data together.
...
```closure-flow
SUBTOPIC: Rock Art: Bhimbetka, Regional Traditions and Interpretation
KEY TERMS / DEFINITIONS: Bhimbetka's layered record shows hunting, animals, gathering, food preparation, dance, gendered activities and later historical scenes.
...
```closure-flow
SUBTOPIC: Major Indian Sites and Regional Traditions: A Text Map
KEY TERMS / DEFINITIONS: Indian prehistory is a mosaic of river valleys, plateaus, deserts, coasts, caves and alluvial plains.
...
```closure-flow
SUBTOPIC: Continuity and Change toward the Neolithic
KEY TERMS / DEFINITIONS: Contact can transfer pottery or copper without economic replacement.
...
```closure-flow
SUBTOPIC: Historiographical Debates, Source Limitations and Current Research
KEY TERMS / DEFINITIONS: The central historiographical shift is from a typological culture ladder to regional, behavioural and interdisciplinary prehistory.
