...
![Jainism and Buddhism learning spine](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-learning-spine.png)
...
KEY TERMS / DEFINITIONS: Jainism and Buddhism carry direct Prelims value (fifteen routed 2018-2026 questions on doctrine, sects, schools and sites) and strong Mains support through comparison, causation (spread/decline/persistence) and source-criticism questions.
...
```closure-flow
SUBTOPIC: Representative source ledger
KEY TERMS / DEFINITIONS: OCR-searchable books deepen doctrine, social history, institutions, art and historiography.
...
```closure-flow
SUBTOPIC: Roadmap, source order and evidence discipline — [CORE MAINS]
KEY TERMS / DEFINITIONS: This package treats Jainism and Buddhism as historical traditions with several layers: early teaching, institutional development, sectarian memory, canonical redaction, material evidence and modern textbook reconstruction.
...
### Sixth-century BCE setting: cities, states and intellectual ferment — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Sixth-century BCE setting: cities, states and intellectual ferment — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: These conditions widened their audience, but doctrine cannot be mechanically derived from iron or trade.
...
### The shramana field: heterodoxy without a false binary — [CORE PRELIMS + CORE MAINS]

![g3 visual -- The Sixth-Century BCE Shramana Field](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-shramana-context-map.png)
...
```closure-flow
SUBTOPIC: The shramana field: heterodoxy without a false binary — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: 'Shramana versus Brahmana' is a useful contrast of authority and practice, but historical interaction was continuous.
...
### Pre-Mahavira Jain tradition and the Tirthankaras — [CORE PRELIMS + SUPPORTING]
...
```closure-flow
SUBTOPIC: Pre-Mahavira Jain tradition and the Tirthankaras — [CORE PRELIMS + SUPPORTING]
KEY TERMS / DEFINITIONS: Historical confidence is unequal: Parshvanatha is the strongest pre-Mahavira candidate, while claims for very early figures belong primarily to sacred tradition.
...
### Mahavira: traditional biography and historical reconstruction — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Mahavira: traditional biography and historical reconstruction — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: Read the structure first; each arrow is a historical relationship, not an automatic law.
...
### Jain ontology: jiva, ajiva and a living cosmos — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Jain ontology: jiva, ajiva and a living cosmos — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: FACT: Jiva is conscious, potentially omniscient and capable of liberation; embodied jivas occupy many grades of sense-capacity.
...
### Jain karma, bondage and liberation — [CORE PRELIMS + CORE MAINS]

![g3 visual -- The Jain Liberation Chain](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-jain-liberation-chain.png)
...
```closure-flow
SUBTOPIC: Jain karma, bondage and liberation — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: Read bottom-to-top for the recurring exam question type: how a Jain soul is said to move from bondage toward moksha.
...
### Jain Triratna, five vows and ascetic-lay paths — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Jain Triratna, five vows and ascetic-lay paths — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: FACT: The Triratna are samyak-darshana, samyak-jnana and samyak-charitra: right faith/view, knowledge and conduct.
...
### Anekantavada, syadvada and nayavada — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Anekantavada, syadvada and nayavada — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: Anekantavada is the doctrine that reality has many aspects; nayavada analyzes partial standpoints; syadvada expresses qualified predication, conventionally through seven possible formulations.
...
### Jain sangha, women, social ethics and limits — [CORE MAINS + SUPPORTING]
...
```closure-flow
SUBTOPIC: Jain sangha, women, social ethics and limits — [CORE MAINS + SUPPORTING]
KEY TERMS / DEFINITIONS: FACT: Jain community structure recognizes sadhu, sadhvi, shravaka and shravika.
...
### Jain councils, canon and redaction traditions — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Jain councils, canon and redaction traditions — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: Jain canonical history is reconstructed differently by Shvetambara and Digambara traditions.
...
### Digambara, Shvetambara and bounded subsect history — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Digambara, Shvetambara and bounded subsect history — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: FACT: Digambara means 'sky-clad' and Shvetambara 'white-clad'; clothing is visible but not the only distinction.
...
### Jain spread, patrons, sites, art and literature — [CORE PRELIMS + SUPPORTING]
...
```closure-flow
SUBTOPIC: Jain spread, patrons, sites, art and literature — [CORE PRELIMS + SUPPORTING]
KEY TERMS / DEFINITIONS: Its history is visible in inscriptions, caves, image deposits, temples and manuscripts rather than one imperial mission.
...
### The Buddha: historical core and traditional life — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: The Buddha: historical core and traditional life — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: The Buddha is historically located in the fifth-century BCE Gangetic world, while detailed biographies were shaped over centuries.
...
### Four Noble Truths: diagnosis, cause, cessation and path — [CORE PRELIMS + CORE MAINS]

![g3 visual -- Four Noble Truths and the Eightfold Path](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-four-truths-eightfold-path.png)
...
```closure-flow
SUBTOPIC: Four Noble Truths: diagnosis, cause, cessation and path — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: The Four Noble Truths organize early Buddhist teaching as a practical analysis of dukkha rather than a claim that every experience is only pain.
...
### Eightfold Path, Middle Way and ethical discipline — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Eightfold Path, Middle Way and ethical discipline — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: Its eight factors are usually grouped into wisdom, ethical conduct and mental discipline; they are cultivated together rather than as a simple staircase.
...
### Dependent origination: process without a first cause — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Dependent origination: process without a first cause — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: Read the structure first; each arrow is a historical relationship, not an automatic law.
...
### Impermanence, no-self, aggregates, karma and nirvana — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Impermanence, no-self, aggregates, karma and nirvana — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: Early Buddhism links impermanence (anicca), unsatisfactoriness (dukkha) and no-self (anatta).
...
### Sangha, Vinaya, lay support and institutional life — [CORE PRELIMS + CORE MAINS]

![g3 visual -- Sangha-Laity Patronage Network](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-sangha-lay-patronage-network.png)
...
```closure-flow
SUBTOPIC: Sangha, Vinaya, lay support and institutional life — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: FACT: The Vinaya Pitaka preserves rules, origin stories, procedures, ordination and communal acts; Patimokkha recitation structures confession and discipline.
...
### Women, social access and the caste-varna question — [CORE MAINS + SUPPORTING]
...
```closure-flow
SUBTOPIC: Women, social access and the caste-varna question — [CORE MAINS + SUPPORTING]
KEY TERMS / DEFINITIONS: FACT: Therigatha verses preserve female renunciant voices, although the collection's redaction history must be remembered.
...
### Buddhist councils: conventional accounts with source caution — [CORE PRELIMS + CORE MAINS]

![g3 visual -- Buddhist and Jain Councils: An Evidence Ladder](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-councils-evidence-ladder.png)
...
```closure-flow
SUBTOPIC: Buddhist councils: conventional accounts with source caution — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: Climb this ladder before answering an 'assess the councils' Mains question; each rung is a caveat to state, not a fact to assert.
...
### Buddhist canons: Pali, Sanskrit, Chinese and Tibetan witnesses — [CORE PRELIMS + CORE MAINS]

![g3 visual -- Source and Canon Redaction Timeline](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-source-canon-timeline.png)
...
```closure-flow
SUBTOPIC: Buddhist canons: Pali, Sanskrit, Chinese and Tibetan witnesses — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: !g3 visual -- Source and Canon Redaction Timeline
...
### Early schools and the Theravada-Hinayana terminology firewall — [CORE PRELIMS + CORE MAINS]

![g3 visual -- Buddhist School Evolution: A Caution Map](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-sect-school-evolution-map.png)
...
```closure-flow
SUBTOPIC: Early schools and the Theravada-Hinayana terminology firewall — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: Modern Theravada is one surviving Sthavira-derived lineage, not a synonym for every early school.
...
### Mahayana, the Bodhisattva path, Maitreya and Paramitas — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Mahayana, the Bodhisattva path, Maitreya and Paramitas — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: FACT: A Bodhisattva seeks full Buddhahood for the benefit of beings; the ideal combines compassion and wisdom.
...
### Madhyamaka and Yogacara: bounded historical depth — [CORE MAINS + SUPPORTING]
...
```closure-flow
SUBTOPIC: Madhyamaka and Yogacara: bounded historical depth — [CORE MAINS + SUPPORTING]
KEY TERMS / DEFINITIONS: FACT: Nagarjuna, associated with Madhyamaka, analyzes all phenomena as empty (shunya) of independent inherent nature because they arise dependently.
...
### Vajrayana: later tantric development and institutional setting — [CORE MAINS + SUPPORTING]
...
```closure-flow
SUBTOPIC: Vajrayana: later tantric development and institutional setting — [CORE MAINS + SUPPORTING]
KEY TERMS / DEFINITIONS: Read the structure first; each arrow is a historical relationship, not an automatic law.
...
### Why the traditions became popular: language, ethics and networks — [CORE MAINS]
...
```closure-flow
SUBTOPIC: Why the traditions became popular: language, ethics and networks — [CORE MAINS]
KEY TERMS / DEFINITIONS: Neither tradition spread through doctrine alone.
...
### Patronage networks: Mauryan and post-Mauryan worlds — [CORE PRELIMS + CORE MAINS]
...
```closure-flow
SUBTOPIC: Patronage networks: Mauryan and post-Mauryan worlds — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: Ashoka is central but not the sole patron; post-Mauryan regional states, monks, nuns, merchants and artisans made Buddhism materially durable, while Jainism grew through different regional coalitions.
...
### Regional and international spread: a text map — [CORE PRELIMS + CORE MAINS]

![g3 visual -- Spread and Patronage Routes: Schematic](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-spread-patronage-routes.png)
...
```closure-flow
SUBTOPIC: Regional and international spread: a text map — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: Treat the arrows as relationships worth remembering, not as directions or distances; the prose names the actual regions and routes.
...
### Stupas, caves, monasteries, images and material evidence — [CORE PRELIMS + CORE MAINS]

![g3 visual -- Art, Symbol and Architecture Panel](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-art-symbol-architecture-panel.png)
...
```closure-flow
SUBTOPIC: Stupas, caves, monasteries, images and material evidence — [CORE PRELIMS + CORE MAINS]
KEY TERMS / DEFINITIONS: A quick-reference glossary for identifying symbols and structures in an image-based Prelims question; exact site dating stays in the prose.
...
![g3 visual -- Jain-Buddhist Doctrine Comparison Matrix](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-doctrine-comparison-matrix.png)
...
```closure-flow
SUBTOPIC: Jainism and Buddhism: a controlled comparison — [CORE MAINS]
KEY TERMS / DEFINITIONS: !g3 visual -- Jain-Buddhist Doctrine Comparison Matrix
...
### Buddhism's decline and transformation in India — [CORE MAINS]
...
```closure-flow
SUBTOPIC: Buddhism's decline and transformation in India — [CORE MAINS]
KEY TERMS / DEFINITIONS: Its institutional contraction was regionally uneven and multi-causal, while doctrines, images, pilgrimage and communities persisted or were absorbed into new configurations.
...
### Why Jainism persisted and how it transformed — [CORE MAINS]

![g3 visual -- Survival and Decline: A Multi-Causal Comparison](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-survival-decline-web.png)
...
```closure-flow
SUBTOPIC: Why Jainism persisted and how it transformed — [CORE MAINS]
KEY TERMS / DEFINITIONS: FACT: Jain communities became durable in Karnataka, Tamil regions, Gujarat, Rajasthan, Bundelkhand and other zones under changing patrons.
...
```closure-flow
SUBTOPIC: Historiography and evidence limits — [CORE MAINS + SUPPORTING]
KEY TERMS / DEFINITIONS: The history of Jainism and Buddhism is reconstructed from normative texts, rival accounts, inscriptions, monuments, art, manuscripts and later chronicles.
...
```closure-flow
SUBTOPIC: Contemporary heritage and conservation linkages — [SUPPORTING]
KEY TERMS / DEFINITIONS: RETRIEVED FACT: UNESCO describes Sanchi as a multi-period complex of stupas, temples, viharas and pillars documenting Buddhism from the third century BCE into the medieval period, with ASI protection and conservation.
...
```closure-flow
SUBTOPIC: Chronology, terminology and rapid UPSC distinctions — [CORE PRELIMS]
KEY TERMS / DEFINITIONS: This consolidation prevents the most common close-option errors: founder versus systematizer, early school versus Mahayana current, canon versus translation, tradition versus inscription, and doctrinal terms that look similar.
...
> 48 hard MCQs and 12 remedials. Correct options rotate strictly A -> B -> C -> D.
...
| B | Iron technology alone produced both religions. |
| C | Only merchant resentment created heterodoxy. |
...
- WHY THE DISTRACTORS FAIL: B ('Iron technology alone produced both religions') overclaims by turning a partial or context-bound truth into an absolute rule; C ('Only merchant resentment created heterodoxy') overclaims by turning a partial or context-bound truth into an absolute rule; D ('The movements arose outside towns and states') misstates the chronology or sequence of development.

> **Memory hook:** Q01 key A; logic: Second urbanisation, states and new elites supplied context; ideas and institutions still require independent explanation.
...
| C | Mahavira was the first Tirthankara. |
...
- WHY THE DISTRACTORS FAIL: A ('All twenty-four are securely dated by inscriptions') breaks the specific factual pairing the question is testing; C ('Mahavira was the first Tirthankara') misstates the chronology or sequence of development; D ('Rishabhanatha is proven by Harappan seals') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q02 key B; logic: Evidence confidence is graded: Mahavira is historical, Parshva plausible, and remote traditional chronology cannot be archaeologically asserted.
...
- WHY THE DISTRACTORS FAIL: A ('Gautama Buddha') breaks the specific factual pairing the question is testing; B ('Maitreya') breaks the specific factual pairing the question is testing; D ('Nagarjuna') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q03 key C; logic: The 2024 epithets PYQ tests this person-name firewall: Buddha is Shakyamuni/Tathagata; Mahavira is Nataputta.
...
- WHY THE DISTRACTORS FAIL: A ('The moral duty of a householder only') overclaims by turning a partial or context-bound truth into an absolute rule; B ('Karmic merit stored in a soul') breaks the specific factual pairing the question is testing; C ('The creator principle') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q04 key D; logic: Dharma and adharma as substances are media of motion and rest, not simply ethical good and evil.
...
- WHY THE DISTRACTORS FAIL: A ('Ahimsa') breaks the specific factual pairing the question is testing; C ('Asteya') breaks the specific factual pairing the question is testing; D ('Aparigraha') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q06 key B; logic: Right concentration is an Eightfold Path factor; Jain vows are ahimsa, satya, asteya, brahmacharya and aparigraha.
...
| Option | Choice |
| --- | --- |
| A | All three mean total scepticism. |
| B | Nayavada is the Jain theory of karmic matter. |
...
- WHY THE DISTRACTORS FAIL: A ('All three mean total scepticism') breaks the specific factual pairing the question is testing; B ('Nayavada is the Jain theory of karmic matter') misassigns the fact to the wrong tradition, sect or school; D ('Syadvada asserts contradictions in the same respect') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q07 key C; logic: The three doctrines form a linked epistemic method but have distinct functions.
...
- WHY THE DISTRACTORS FAIL: A ('Belief in karma versus no karma') breaks the specific factual pairing the question is testing; B ('Acceptance versus rejection of all Tirthankaras') breaks the specific factual pairing the question is testing; C ('Whether ahimsa is valuable') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q08 key D; logic: Digambara and Shvetambara differences go well beyond clothing.
...
- WHY THE DISTRACTORS FAIL: B ('An early Mahasanghika school') breaks the specific factual pairing the question is testing; C ('A Digambara canon council') misassigns the fact to the wrong tradition, sect or school; D ('A Buddhist cave order in Andhra') misassigns the fact to the wrong tradition, sect or school.

> **Memory hook:** Q09 key A; logic: It is Jain and Shvetambara; its history is much later than Mahavira.
...
- WHY THE DISTRACTORS FAIL: A ('The Buddha's first sermon') misstates the chronology or sequence of development; C ('Kanishka's Sarvastivada council') breaks the specific factual pairing the question is testing; D ('Ashoka's Kalinga war') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q10 key B; logic: Valabhi belongs to later Shvetambara canonical memory, not the lifetime of Mahavira.
...
- WHY THE DISTRACTORS FAIL: A ('The Pali council at Aluvihara') breaks the specific factual pairing the question is testing; B ('Buddha's enlightenment') breaks the specific factual pairing the question is testing; D ('Achaemenid rule in Gandhara') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q11 key C; logic: The site supplies material and inscriptional evidence for organized Jain life.
...
| Option | Choice |
| --- | --- |
| A | As a contemporary Mauryan inscription. |
| B | As proof that Digambara and Shvetambara formed in one meeting. |
...
- WHY THE DISTRACTORS FAIL: A ('As a contemporary Mauryan inscription') breaks the specific factual pairing the question is testing; B ('As proof that Digambara and Shvetambara formed in one meeting') misassigns the fact to the wrong tradition, sect or school; C ('As evidence that Jainism began in Karnataka') misassigns the fact to the wrong tradition, sect or school.

> **Memory hook:** Q12 key D; logic: Shravanabelagola's later epigraphic tradition cannot independently verify every early detail.
...
- WHY THE DISTRACTORS FAIL: A ('Deva') breaks the specific factual pairing the question is testing; C ('Manushya') breaks the specific factual pairing the question is testing; D ('Tiryancha') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q14 key B; logic: The four are gods, humans, hell beings and animals/plants; yaksha is not the fourth category.
...
- WHY THE DISTRACTORS FAIL: A ('A creator god') breaks the specific factual pairing the question is testing; B ('The permanent soul') breaks the specific factual pairing the question is testing; D ('Ritual sacrifice') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q15 key C; logic: Dukkha is broader than pain and is linked causally to craving and ignorance.
...
- WHY THE DISTRACTORS FAIL: A ('Events are fixed by fate') breaks the specific factual pairing the question is testing; B ('A permanent soul transmits unchanged') breaks the specific factual pairing the question is testing; C ('Craving is the first cosmic cause') misstates the chronology or sequence of development.

> **Memory hook:** Q16 key D; logic: Conditionality allows cessation and denies both fatalism and an independent self.
...
| B | No ethical consequences exist. |
| C | Nothing exists conventionally. |
| D | Every person has an eternal jiva. |
...
- WHY THE DISTRACTORS FAIL: B ('No ethical consequences exist') breaks the specific factual pairing the question is testing; C ('Nothing exists conventionally') breaks the specific factual pairing the question is testing; D ('Every person has an eternal jiva') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q17 key A; logic: Causal continuity and karma remain without a permanent atman.
...
- WHY THE DISTRACTORS FAIL: B ('Gargi and Maitreyi') breaks the specific factual pairing the question is testing; C ('Bhadrabahu and Sthulabhadra') breaks the specific factual pairing the question is testing; D ('Kharavela and Rudradaman') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q21 key A; logic: Textual examples should be supplemented by inscriptions from multi-social donors.
...
| Option | Choice |
| --- | --- |
| A | It legally abolished varna in all kingdoms. |
...
- WHY THE DISTRACTORS FAIL: A ('It legally abolished varna in all kingdoms') breaks the specific factual pairing the question is testing; C ('It accepted birth as the sole basis of worth') breaks the specific factual pairing the question is testing; D ('It admitted no lower-status followers') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q22 key B; logic: A nuanced answer distinguishes salvific access from total social revolution.
...
- WHY THE DISTRACTORS FAIL: A ('Ashoka's edicts') breaks the specific factual pairing the question is testing; B ('The Digambara canon') misassigns the fact to the wrong tradition, sect or school; D ('Kanishka's inscriptional council minutes') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q23 key C; logic: It offers female renunciant voices but remains a redacted textual source.
...
- WHY THE DISTRACTORS FAIL: A ('The first Jain council') misassigns the fact to the wrong tradition, sect or school; B ('Kanishka's northern council') breaks the specific factual pairing the question is testing; C ('The Valabhi redaction') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q24 key D; logic: The ten practices and exact schism relation vary in later accounts.
...
- WHY THE DISTRACTORS FAIL: A ('Theravada is a Jain sect') misassigns the fact to the wrong tradition, sect or school; B ('Theravada began under Kanishka') misassigns the fact to the wrong tradition, sect or school; C ('Hinayana means Vajrayana') misassigns the fact to the wrong tradition, sect or school.

> **Memory hook:** Q28 key D; logic: Use precise lineage and canon terms instead of a polemical shortcut.
...
- WHY THE DISTRACTORS FAIL: B ('Pali Visuddhimagga') breaks the specific factual pairing the question is testing; C ('Jain Acharanga') misassigns the fact to the wrong tradition, sect or school; D ('Rig Veda') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q29 key A; logic: He must be distinguished from Sanghabhadra and from Theravada.
...
- WHY THE DISTRACTORS FAIL: A ('Magadha') breaks the specific factual pairing the question is testing; C ('Gandhara') breaks the specific factual pairing the question is testing; D ('Kashmir') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q30 key B; logic: It belongs to the lower Krishna Buddhist zone and Mahasanghika context.
...
- WHY THE DISTRACTORS FAIL: A ('Kankali Tila') breaks the specific factual pairing the question is testing; B ('Sthanakvasi hall') breaks the specific factual pairing the question is testing; C ('Lumbini pillar alone') overclaims by turning a partial or context-bound truth into an absolute rule.

> **Memory hook:** Q36 key D; logic: Vikramashila belongs with Nalanda, Odantapuri and Somapura in late Buddhist institutional networks.
...
| B | Only one emperor converted Asia. |
| C | Only simple doctrine mattered. |
...
- WHY THE DISTRACTORS FAIL: B ('Only one emperor converted Asia') overclaims by turning a partial or context-bound truth into an absolute rule; C ('Only simple doctrine mattered') overclaims by turning a partial or context-bound truth into an absolute rule; D ('It avoided all royal contact') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q37 key A; logic: A network explanation handles regional and chronological diversity.
...
- WHY THE DISTRACTORS FAIL: A ('The complete Pali Abhidhamma') breaks the specific factual pairing the question is testing; C ('Compulsory conversion to Mahayana') misassigns the fact to the wrong tradition, sect or school; D ('A Jain council rule') misassigns the fact to the wrong tradition, sect or school.

> **Memory hook:** Q38 key B; logic: Buddhist patronage and sacred-site inscriptions do not make every dhamma edict sectarian doctrine.
...
- WHY THE DISTRACTORS FAIL: A ('A monastery founded and completed only by Buddha') overclaims by turning a partial or context-bound truth into an absolute rule; B ('An exclusively Gupta construction') breaks the specific factual pairing the question is testing; C ('A Jain canon council site') misassigns the fact to the wrong tradition, sect or school.

> **Memory hook:** Q40 key D; logic: UNESCO and inscriptional evidence emphasize phases, donors and long conservation history.
...
| C | Buddha images existed unchanged from his lifetime. |
| D | Amaravati produced no images. |
...
- WHY THE DISTRACTORS FAIL: B ('Gandhara alone invented the image at a known date') overclaims by turning a partial or context-bound truth into an absolute rule; C ('Buddha images existed unchanged from his lifetime') breaks the specific factual pairing the question is testing; D ('Amaravati produced no images') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q41 key A; logic: Material evidence resists a single-origin slogan.
...
- WHY THE DISTRACTORS FAIL: A ('A Jain soul and non-soul') misassigns the fact to the wrong tradition, sect or school; C ('A stupa relic and royal tax') breaks the specific factual pairing the question is testing; D ('A Pali sutta and Vinaya rule') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q42 key B; logic: Rock-cut complexes often combine the two forms.
...
| D | Buddhism never declined anywhere in India. |
...
- WHY THE DISTRACTORS FAIL: A ('One invasion caused total disappearance overnight') breaks the specific factual pairing the question is testing; B ('Vajrayana alone destroyed Buddhism') overclaims by turning a partial or context-bound truth into an absolute rule; D ('Buddhism never declined anywhere in India') overclaims by turning a partial or context-bound truth into an absolute rule.

> **Memory hook:** Q43 key C; logic: A multi-causal chronology avoids polemic and recognizes persistence.
...
| Option | Choice |
| --- | --- |
| A | Dependence on one giant university. |
| B | Rejection of all householders. |
...
- WHY THE DISTRACTORS FAIL: A ('Dependence on one giant university') breaks the specific factual pairing the question is testing; B ('Rejection of all householders') breaks the specific factual pairing the question is testing; C ('Absence of sectarian change') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q44 key D; logic: Continuity came through adaptation, not stasis.
...
- WHY THE DISTRACTORS FAIL: A ('A much later hagiography alone') overclaims by turning a partial or context-bound truth into an absolute rule; C ('A modern festival brochure') breaks the specific factual pairing the question is testing; D ('An undated analogy') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q46 key B; logic: Even inscriptions remain selective, but their date and context are stronger anchors.
...
| Option | Choice |
| --- | --- |
| A | The exact original composition year. |
| B | Proof the work was composed in China. |
...
- WHY THE DISTRACTORS FAIL: A ('The exact original composition year') breaks the specific factual pairing the question is testing; B ('Proof the work was composed in China') breaks the specific factual pairing the question is testing; D ('The Buddha's spoken wording') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q47 key C; logic: Translations are powerful chronological controls but not composition certificates.
...
| C | A modern proposal equals inscription on the list. |
...
- WHY THE DISTRACTORS FAIL: A ('World Heritage status proves every sacred biography') breaks the specific factual pairing the question is testing; B ('Restored fabric is always original') overclaims by turning a partial or context-bound truth into an absolute rule; C ('A modern proposal equals inscription on the list') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q48 key D; logic: Modern official sources must remain in a modern heritage evidence lane.
...
- WHY THE DISTRACTORS FAIL: B ('The first Tirthankara') misstates the chronology or sequence of development; C ('A Buddhist Bodhisattva') misassigns the fact to the wrong tradition, sect or school; D ('Founder of the Pali sangha') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q49 key A; logic: This corrects the common founder shortcut.
...
- WHY THE DISTRACTORS FAIL: A ('Anekantavada') breaks the specific factual pairing the question is testing; C ('Nayavada') breaks the specific factual pairing the question is testing; D ('Nirjara') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q50 key B; logic: Anekanta is many-sidedness, naya standpoint, syat qualification.
...
- WHY THE DISTRACTORS FAIL: A ('Anicca') breaks the specific factual pairing the question is testing; B ('Aparigraha') breaks the specific factual pairing the question is testing; D ('Ajiva') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q51 key C; logic: Anicca is impermanence; anatta is no-self.
...
- WHY THE DISTRACTORS FAIL: A ('Right faith, knowledge and conduct') breaks the specific factual pairing the question is testing; B ('Jiva, ajiva and karma') breaks the specific factual pairing the question is testing; C ('Dana, shila and prajna only') overclaims by turning a partial or context-bound truth into an absolute rule.

> **Memory hook:** Q52 key D; logic: Do not confuse the refuges with Jain Triratna.
...
- WHY THE DISTRACTORS FAIL: B ('A Jain subsect') misassigns the fact to the wrong tradition, sect or school; C ('A Gupta temple form') breaks the specific factual pairing the question is testing; D ('A Pala king') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q53 key A; logic: The 2020 PYQ tests this early-school distinction.
...
| C | As another name for Vajrayana. |
| D | For all pre-Mahayana texts without qualification. |
...
- WHY THE DISTRACTORS FAIL: A ('As the official name of modern Theravada') misassigns the fact to the wrong tradition, sect or school; C ('As another name for Vajrayana') misassigns the fact to the wrong tradition, sect or school; D ('For all pre-Mahayana texts without qualification') misassigns the fact to the wrong tradition, sect or school.

> **Memory hook:** Q54 key B; logic: Terminological care is mandatory.
...
- WHY THE DISTRACTORS FAIL: A ('A monk linked to China') breaks the specific factual pairing the question is testing; B ('Associated with Sarvastivada Vinaya commentary') breaks the specific factual pairing the question is testing; D ('A UPSC 2024 routed term') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q55 key C; logic: Similar names are a deliberate exam trap.
...
- WHY THE DISTRACTORS FAIL: A ('A past Buddha only') overclaims by turning a partial or context-bound truth into an absolute rule; B ('A Jain Tirthankara') misassigns the fact to the wrong tradition, sect or school; C ('The first Buddhist council president') misassigns the fact to the wrong tradition, sect or school.

> **Memory hook:** Q56 key D; logic: The tradition exists beyond Mahayana alone.
...
| B | Necessarily a monastic residence. |
...
- WHY THE DISTRACTORS FAIL: B ('Necessarily a monastic residence') breaks the specific factual pairing the question is testing; C ('Exclusively Buddhist in conceptual origin') misassigns the fact to the wrong tradition, sect or school; D ('A Jain canonical basket') misassigns the fact to the wrong tradition, sect or school.

> **Memory hook:** Q57 key A; logic: The 2023 PYQ turns on the overstatement in 'Buddhist in origin'.
...
| C | Completed everywhere by one fixed year. |
| D | Proof that Buddhism vanished from Asia. |
...
- WHY THE DISTRACTORS FAIL: A ('Caused only by Sanskrit') overclaims by turning a partial or context-bound truth into an absolute rule; C ('Completed everywhere by one fixed year') breaks the specific factual pairing the question is testing; D ('Proof that Buddhism vanished from Asia') misassigns the fact to the wrong tradition, sect or school.

> **Memory hook:** Q58 key B; logic: Use contraction, transformation, absorption, violence and survival.
...
- WHY THE DISTRACTORS FAIL: A ('Buddha's enlightenment') breaks the specific factual pairing the question is testing; B ('Ashoka's Kalinga edicts') breaks the specific factual pairing the question is testing; D ('The Mahasanghika centre Dhanyakataka') breaks the specific factual pairing the question is testing.

> **Memory hook:** Q59 key C; logic: This separates Jain canon history from Buddhist sacred geography.
...
| Option | Choice |
| --- | --- |
| A | Both are identical substances. |
| B | Only Jainism accepts consequences. |
...
- WHY THE DISTRACTORS FAIL: A ('Both are identical substances') breaks the specific factual pairing the question is testing; B ('Only Jainism accepts consequences') overclaims by turning a partial or context-bound truth into an absolute rule; C ('Only Buddhism accepts rebirth') overclaims by turning a partial or context-bound truth into an absolute rule.

> **Memory hook:** Q60 key D; logic: The ontology of the agent makes the contrast meaningful.
...
![g3 visual -- Answer Spine and Rapid Recall](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-10\ancient-indian-history-10-g3-answer-spine-rapid-recall.png)
