...
![The Later Vedic Phase learning spine](notes\Ancient-Indian-History\learning-session-v2\subject-wide-syllabus\assets\ancient-indian-history-09\ancient-indian-history-09-learning-spine.png)
...
- **Required scope:** Eastward expansion, iron, agriculture, state, varna, gender, ritual, text and settlement through continuity and change.
...
| Component | Count |
|---|---:|
| Relevant/adjacent verified PYQs | 4 |
...
|---|---|---|
| Repository Markdown | Topic 09 basic/advanced, README, Master Chronology, Revision Chart, syllabus/PYQ routing, Topic 08 comparison package and owners | Primary architecture, terminology, exact recent PYQ routes and controlled comparison |
