...
- A. Pattanam is conclusively Muziris;
...
- A. It began with Roman settlement;
...
- B. poems reveal no economy;
- C. inscriptions are always complete;
...
- A. Pliny's complaint alone;
- B. a single coin;
- C. Arikamedu's pre-trade and continued occupation;
- D. a modern tourist label.
...
- D. Copper plates + imperial temples
...
- C. A Roman commodity list
- D. A list of Ashokan officers
...
- A. It had an earlier settlement
- B. It yielded Mediterranean ceramics
- C. Trade involved intermediaries
...
- B. Chera pepper hinterland only
- C. imperial Chola local assemblies
- D. Gupta gold coinage
...
- A. Roman demand created agriculture
- B. Overseas trade amplified local agriculture, crafts and routes
- C. Trade eliminated barter
- D. Every coin was daily currency
...
- B. Exchange links can be investigated
...
- A. It was absent from all poetry
- B. It was known, but uniform four-varna practice cannot be assumed
- C. It proves later caste lists existed unchanged
...
- A. Poompuhar=Puhar
- B. Muchiri=Muziris tradition
- C. Korkai=Pandya port context
...
- B. Full Mauryan provincial control
- C. Imperial Chola administration
- D. Exact Sangam reign dates
...
- B. A dated inscription
- C. Black-and-red ware
- D. A stratified amphora
...
- A. They are identical states
- B. Both used Uttaramerur rules
- C. Both built Brihadisvara
...
- C. Inscriptions never require interpretation
- D. Archaeology gives personal motives
...
- A. They can aid chronology
- B. They can show authority/iconography
- C. They may circulate as bullion
...
- B. Rome created Tamilakam
- C. All three dynasties were empires
...
- A. Move to another fact
- B. Add a quotation of uncertain origin
- C. Ignore source limits
...
- B. It proves Roman sovereignty.
- C. It proves daily wages.
...
- D. Every occupation equals later caste.
...
- A. Every poem dates to 300 BCE.
- B. Every burial is Sangam.
- C. Every dynasty ruled continuously.
...
- B. Rome invented Tamil agriculture.
- C. Ports lacked hinterlands.
- D. Local pottery was absent.
...
- A. It was a Mauryan province.
- B. It was wholly stateless.
- C. Authority ranged from chiefship toward early states with uneven institutionalization.
- D. It was an imperial Chola bureaucracy.
...
- A. It has no foreign finds.
- B. It was inland.
- C. It proves every classical claim.
