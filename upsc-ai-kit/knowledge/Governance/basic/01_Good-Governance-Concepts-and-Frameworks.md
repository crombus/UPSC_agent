# Good Governance: Concepts and Frameworks - MUST-DO
...
- ✅ Good Governance Day is observed on 25 December, Atal Bihari Vajpayee's birth anniversary,
  since 2014.
- ✅ The Good Governance Index was launched by DARPG on 25 December 2019.
...
- ❌ GGI produces one single, static national ranking. -> GGI publishes sector-wise scores
  for states/UTs across three comparison categories, revised in each new edition; no single
  fixed state rank is asserted here, since the ranking changes with every edition.
