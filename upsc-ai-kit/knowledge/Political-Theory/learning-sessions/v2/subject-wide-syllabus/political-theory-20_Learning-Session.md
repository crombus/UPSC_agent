...
generation_identity: political-theory-20:learner-v2:g2
...
> *Companion: `Political-Theory/advanced/20_Diverse-Perspectives-on-Justice.md`.*
...
- ✅ Rawlsian liberal justice centres on primary goods, original position, equal basic liberties, fair equality of opportunity, and the difference principle. (PDF pp.447-450)
- ✅ Nozickian libertarian justice centres on self-ownership and justice in acquisition, transfer and rectification under a minimal state. (PDF pp.450-452)
- ✅ Marxist and democratic-socialist views shift attention from market distribution to exploitation, property relations, social ownership, welfare and democratic freedoms. (PDF pp.452-461)
- ✅ Anarchists attack coercive authority itself and imagine justice through voluntary cooperation, decentralization and anti-domination. (PDF pp.461-464)
...
- ✅ Communitarians criticize the isolated or unencumbered self and relocate justice within embedded selves, shared goods and community meanings. (PDF pp.469-473)
- ⚠️ UPSC key: every justice theory answers six hidden questions—who gets what, by what rule, through which state, with what property regime, in what kind of community, and against which injustice.
...
|---|---|
| Primary goods | ✅ Rawls's distributive object: rights, liberties, powers, opportunities, income, wealth and the social bases of self-respect. (PDF p.447) |
| Original position | ✅ Rawls's hypothetical starting point where rational persons choose principles of justice without knowing their actual social place. (PDF p.447) |
| Veil of ignorance | ✅ The condition in which parties lack knowledge of their particular wants, talents, class position and other discriminatory markers. (PDF p.447) |
| Equal basic liberties | ✅ Rawls's first principle: each person has an equal claim to the most extensive compatible liberty. (PDF p.448) |
| Fair equality of opportunity | ✅ Rawls's second-stage rule that offices and positions should be open on genuinely fair terms, not merely formal legal equality. (PDF p.448) |
| Difference principle | ✅ Rawls's rule that inequality is just only if it brings the greatest benefit to the least advantaged. (PDF p.448) |
...
### SESSION 2 — The Eight-Perspective Chapter Spine

#### 4. Core argument / chapter spine
- ✅ Gauba begins with the liberal perspective and presents Rawls as the major attempt to reconcile liberty with equality and fraternity within a broader liberal frame. (PDF p.446)
- ✅ Rawls rejects utilitarian sacrifice of some for aggregate happiness and instead asks what principles free and rational agents would choose under fairness conditions. (PDF pp.447-448)
- ✅ Gauba then shifts to the libertarian perspective, where Nozick opposes redistributive welfare and treats justice historically through titles and transfers, not patterned end-states. (PDF pp.450-452)
- ✅ The Marxist discussion rejects repair of capitalism through mere fairer shares and locates injustice in exploitation, surplus value and private ownership of major means of production. (PDF pp.452-459)
- ✅ Democratic socialism softens the revolutionary route, combines socialism with democratic freedoms, and seeks welfare plus civil liberties through constitutional politics. (PDF pp.459-461)
- ✅ Anarchism radicalizes suspicion of coercive authority by arguing that justice needs the shrinking or abolition of state power and domination. (PDF pp.461-464)
...
### SESSION 3 — Rawls, Nozick and Controlling Distinctions
...
- ✅ Communitarian criticism is not rejection of justice; it is a criticism of abstract selves, liberal neutrality and the neglect of common goods. (PDF pp.469-473)
...
- ✅ Rawls's anti-utilitarian point is illustrated by the possibility that aggregate happiness could rise even while a minority is enslaved; he rejects such trade-offs. (PDF p.447)
- ✅ Nozick's Wilt Chamberlain example shows why voluntary exchange may generate inequality without, in his view, making the outcome unjust. (PDF p.451)
- ✅ Nozick's water-source example shows that initial acquisition is not unlimited; control over an indispensable natural resource cannot rightfully make others worse off. (PDF p.451)
- ✅ Marxist surplus-value analysis illustrates injustice when labour creates more value than the worker receives back as wages. (PDF pp.453-455)
- ✅ Feminist justice is illustrated through historically denied rights to women's education, property, vote and occupations, followed by claims for compensatory measures. (PDF pp.465-468)
...
### SESSION 6 — The Six-Axis Comparative Matrix
...
### SESSION 7 — Trap Repair, Boundaries and PYQ Routes
...
- ❌ Communitarian criticism means justice should give way to blind conformity. -> ✅ The criticism is directed at the abstract self and ethical neutrality, not at the very idea of justice. (PDF pp.469-473)

#### 10. Cross-links and boundaries
- ⚠️ Read `Political-Theory/advanced/20_Diverse-Perspectives-on-Justice.md` for deeper criticism, Walzer's complex equality and thinker-by-thinker reconstruction.
- ⚠️ Conceptual prequel: `Political-Theory/basic/03_Liberalism-and-Neoliberalism.md` for liberal and libertarian background.
- ⚠️ Socialist and anarchist background: `Political-Theory/basic/04_Marxism-and-Neo-Marxism.md` and `Political-Theory/basic/05_Socialism-Fascism-Anarchism-and-Gandhism.md`.
- ⚠️ Gender and community background: `Political-Theory/basic/06_Feminism-Sex-and-Gender.md` and `Political-Theory/basic/07_Nature-of-Politics-and-Communitarianism.md`.
...
### SESSION 8 — Revision Spine and Directive Control
...
### SESSION 9 — Argument Reconstruction and Objection-Reply Chains
...
### SESSION 10 — Indian Applications, Quotation Safety and MCQ Ledger
...
- ✅ Nozick anchor pages: PDF pp.450-452.
- ✅ Marxist, democratic-socialist and anarchist anchor pages: PDF pp.452-464.
...
> **Source edition/cutoff:** Fifth Edition (2009); no post-2009 fact is assumed unless independently dated and tagged 📰.
> ✅ = source-grounded | ⚠️ = analytical inference/synthesis | 📰 = dated current anchor | ❌ = trap/misattribution.
> *Companion: `Political-Theory/basic/20_Diverse-Perspectives-on-Justice.md`.*

---

### 1. One-screen advanced map
- ✅ Gauba structures the chapter as a deliberate movement from liberal fairness, to libertarian entitlement, to socialist and anti-state critiques, and finally to feminist, subaltern and communitarian enlargements of justice. (PDF pp.446-473)
- ✅ Rawls tries to moralize distribution without abandoning liberal freedom. (PDF pp.446-450)
- ✅ Nozick historicizes holdings and moralizes property against welfare redistribution. (PDF pp.450-452)
- ✅ Marxism relocates injustice from pattern of shares to capitalist exploitation and class power. (PDF pp.452-459)
- ✅ Democratic socialism retains social justice but refuses dictatorship and insists on democratic freedoms. (PDF pp.459-461)
- ✅ Anarchism radicalizes anti-domination by treating coercive authority as itself the generator of injustice. (PDF pp.461-464)
- ✅ Feminist and subaltern perspectives expose how formally equal systems can still encode structured subordination. (PDF pp.464-469)
- ✅ Communitarianism attacks the abstract self and asks whether justice can be intelligible apart from historically situated communities and shared goods. (PDF pp.469-473)
- ⚠️ Advanced takeaway: the dispute is not merely about "who gets more," but about what counts as a person, a wrong, a good, and a legitimate site of distribution.

### 2. Scope, assumptions and conceptual boundary
- ✅ The chapter is about rival perspectives on justice, not a single authorial doctrine that settles them. (PDF p.446)
- ✅ Gauba's discussion of Rawls and Nozick belongs to late-20th-century Anglo-American debate, while Marxist, anarchist, feminist, subaltern and communitarian discussions widen the normative frame. (PDF pp.447-473)
- ⚠️ Gauba's chapter directly supplies distributive and anti-domination concerns; recognition is a later analytical bridge and must not be presented as his terminology.
- ⚠️ The chapter therefore has a widening logic: from fair shares, to title, to exploitation, to gender, to hegemony, to embedded community.
- ⚠️ Boundary: examples involving USSR, China, East Europe, UN reports and development rankings are book-period illustrations and cannot be silently updated into current evidence.
- ⚠️ Boundary: communitarian critique of abstract selves must not be turned into endorsement of authoritarian homogenization.

### 3. Direct-book argument reconstruction
- ✅ Gauba begins by saying modern political theory is deeply tied to the problem of justice and immediately lists eight major perspectives. (PDF p.446)
- ✅ He first presents Rawls because liberal justice tries to preserve liberty while accommodating equality and fraternity through a procedural device. (PDF pp.446-450)
- ✅ Rawls's method abstracts agents from social location through the original position and veil of ignorance so that chosen principles are fair to the least advantaged. (PDF pp.447-448)
- ✅ Gauba then turns to Nozick, who rejects patterned distribution and asks instead how specific persons came to hold specific goods. (PDF pp.450-452)
- ✅ The Marxist section shifts the terrain: if capitalist production rests on surplus extraction, then "fairer distribution" within capitalism may merely soften, not remove, injustice. (PDF pp.452-459)
- ✅ Democratic socialism revises Marxism by preferring evolutionary change, limited socialization and the coexistence of socio-economic justice with liberal freedoms. (PDF pp.459-461)
- ✅ Anarchism presses further by claiming the coercive state itself corrupts natural sociability and blocks just voluntary association. (PDF pp.461-464)
- ✅ Feminism and subaltern theory then insist that justice must see systematic subordination—gendered, classed, caste-like, cultural and hegemonic—not just contractual exchange. (PDF pp.464-469)
- ✅ Communitarianism closes the chapter by attacking liberal neutrality, the isolated self and one-size-fits-all distribution, and by recovering embedded selves, shared traditions and sphere-specific meanings of goods. (PDF pp.469-473)
...
| Simple equality / complex equality | ✅ Walzer rejects uniform equalization of all goods and instead prevents one sphere, especially money, from dominating all other spheres. (PDF pp.472-473) |
...
| Proudhon / Bakunin / Kropotkin / Tolstoy / Gandhi / Bookchin | ✅ These anarchist or anarchist-adjacent figures share suspicion of coercive authority, though they diverge on violence, property and moral regeneration. (PDF pp.462-464) |
| Wollstonecraft / J.S. Mill | ✅ Early feminism demands equal rational and civic standing for women against inherited legal-political exclusion. (PDF pp.465-466) |
| Gramsci | ✅ Subaltern analysis explains how domination persists through hegemony that presents elite rule as universal interest. (PDF pp.468-469) |
| MacIntyre / Sandel / Taylor / Walzer | ✅ Communitarian thinkers dispute the atomistic self, liberal neutrality and universal distributive formulas detached from community meanings. (PDF pp.470-473) |
...
- ✅ Feminism asks whether apparently neutral arrangements are actually built on gendered subordination and exclusion from power. (PDF pp.464-468)
- ✅ Subaltern theory asks who produces social wealth yet remains marginalized because elite hegemony naturalizes unequal reward. (PDF pp.467-469)
- ✅ Communitarianism asks whether justice can be understood without a prior account of shared ends, virtues and the meanings of goods in a community. (PDF pp.469-473)
- ⚠️ The progression also shows a movement from individual-centered justice theories to structurally and socially embedded justice theories.
- ⚠️ Together, these perspectives widen justice from distribution of goods to structures of ownership, authority, dignity and belonging; recognition remains a separately tagged extension.

### 7. Internal debates and criticisms
- ✅ Gauba records collectivist criticism that Rawls may legitimate capitalism by allowing large inequalities so long as the worst-off improve somewhat. (PDF p.448)
- ✅ He records Marxist criticism that Rawls's veil of ignorance detaches justice from real class and property relations. (PDF p.449)
...
- ✅ Walzer's communitarianism is criticized by Gauba for strong moral reasoning but weak political machinery. (PDF p.473)
- ⚠️ Feminist and subaltern critiques additionally expose a blind spot in many older distributive theories: persons enter distribution already marked by hierarchy, dependence and damaged status; "misrecognition" is later recognition-theory vocabulary, not Gauba's own term.
- ❌ Communitarian critique = rejection of rights. -> ✅ Gauba's communitarian section critiques liberal abstraction and neutrality, not the very possibility of norm-guided justice. (PDF pp.469-473)
...
| Feminist | ✅ Justice must redistribute rights, opportunities, education, representation and power to correct gendered disadvantage. (PDF pp.465-468) | ✅ State action is often necessary for rights, reservations, maternity support and equal participation. (PDF pp.466-468) | ✅ Historic exclusion from property and economic power is part of injustice. (PDF pp.465-468) | ✅ Equality includes effective status, empowerment and share in decision-making, not formal sameness alone. (PDF pp.466-468) | ✅ Community traditions are scrutinized when they naturalize patriarchal roles or deny autonomy. (PDF pp.465-467) | ✅ Challenges the translation of biological difference into social and political subordination. (PDF pp.465-468) |
| Subaltern | ✅ Justice requires equitable shares, protection of rights and restoration of dignity for oppressed groups. (PDF pp.467-469) | ✅ The state, public discourse and historiography must cease privileging elites and protect subaltern agency. (PDF pp.468-469) | ✅ Economic exploitation matters, but hegemony also works through non-property hierarchies such as caste, culture and region. (PDF pp.467-469) | ✅ Equality means ending permanent subordination and rewarding contribution fairly. (PDF pp.468-469) | ✅ Community is fractured by ruling-class hegemony unless subaltern voices organize and rewrite the social narrative. (PDF pp.468-469) | ✅ Exposes elite theory as ideological because it naturalizes unequal rule and reward. (PDF pp.468-469) |
| Communitarian | ✅ Justice is discovered within shared practices and sphere-specific meanings; Walzer prefers complex equality over uniform leveling. (PDF pp.469-473) | ✅ State may sustain common goods and prevent domination of one sphere by another, especially money over politics, education or health. (PDF pp.472-473) | ✅ Property has no right to colonize all other goods or social meanings. (PDF pp.472-473) | ✅ Equality is complex: inequality in one sphere should not automatically buy superiority in all others. (PDF pp.472-473) | ✅ Persons are situated, embodied and embedded selves constituted by ends discovered in community. (PDF pp.470-472) | ✅ Strong on moral diagnosis, weaker on enforceable political mechanism. (PDF p.473) |

### 9. Application without current-affairs dependence
- ⚠️ In a scholarship-distribution question, Rawls asks whether the rule protects fair opportunity and the least advantaged; Nozick asks whether anyone's earnings are being unjustly appropriated to fund it.
- ⚠️ In a land-reform question, Marxism asks whether ownership patterns institutionalize exploitation; democratic socialism asks how reform can be constitutional and welfare-enhancing.
- ⚠️ In a workplace-gender question, feminist justice asks whether apparently neutral rules reproduce exclusion from power, promotion or property.
- ⚠️ In a question on caste- or class-based exclusion, subaltern justice asks whether the dominant group's worldview has been normalized as universal interest.
- ⚠️ In a question on admission, office, health care or political office, Walzer's "complex equality" helps show why money should not purchase every social good.
- ⚠️ In a question on village self-rule or decentralization, anarchist and Gandhian strands can be contrasted with socialist and welfare-state expectations about regulation.

### 10. UPSC answer-engine prompts
- ⚠️ Prompt: "Compare Rawls and Nozick on justice." -> Organize by distributive object, method, liberty, property, state and treatment of inequality.
- ⚠️ Prompt: "Is justice mainly about distribution or domination?" -> Start with Rawls/Nozick, then widen to Marxist, feminist and subaltern critiques.
...
- ⚠️ Prompt: "Why is recognition central to justice?" -> First use feminist and subaltern sections to show how hierarchy distorts reward, status and dignity; then add Fraser/Honneth explicitly as a supplementary recognition-theory route.
...
- ⚠️ Foundation companion: `Political-Theory/basic/20_Diverse-Perspectives-on-Justice.md`.
- ⚠️ Liberal and libertarian background: `Political-Theory/advanced/03_Liberalism-and-Neoliberalism.md`.
- ⚠️ Socialist, anarchist and Gandhian background: `Political-Theory/advanced/04_Marxism-and-Neo-Marxism.md` and `Political-Theory/advanced/05_Socialism-Fascism-Anarchism-and-Gandhism.md`.
- ⚠️ Feminist and communitarian background: `Political-Theory/advanced/06_Feminism-Sex-and-Gender.md` and `Political-Theory/advanced/07_Nature-of-Politics-and-Communitarianism.md`.
- ⚠️ State-role boundary: `Political-Theory/advanced/10_State-Civil-Society-Nation-and-Internationalism.md`.
- ⚠️ Global, intergenerational and environmental-justice route: `Political-Theory/advanced/19_Justice-Concepts-and-Dimensions.md`.
- ⚠️ Module frame and topic map: `Political-Theory/00_Master-Framework.md` and `Political-Theory/README.md`.
- ⚠️ Exclusion: this file does not move into present-day welfare statistics, court doctrine or current policy design.

### 12. Factual-risk checks
- ✅ Gauba's descriptions of Soviet Russia, Maoist China, East Europe, UNDP ranking tables and late-20th-century market examples are historical or book-period anchors, not current data. (PDF pp.456-468)
...
- ✅ Primary source used directly: Gauba, Ch.20, PDF pp.446-473.
- ✅ Rawls and Nozick anchors: PDF pp.447-452.
- ✅ Marxist, democratic-socialist and anarchist anchors: PDF pp.453-464.
- ✅ Feminist, subaltern and communitarian anchors: PDF pp.465-473.
- ⚠️ All comparative compression, exam prompts and cross-perspective headings are explicitly marked as synthesis.
...
Perspective Map, Stakes and Essential Vocabulary
  [1] Gauba presents rival perspectives on justice rather than one settled formula.
        |
        v
  [2] Rawls, Nozick, Marxism, socialism, anarchism, feminism and communitarianism differ.
        |
        v
  [3] Every doctrine identifies a standard, an object, an institution and a remedy.
        |
        v
  [4] Objects include liberties, offices, holdings, labour, status, voice and common
      goods.
        |
        v
  [5] Institutions include the state, market, property regime, family and public culture.
        |
        v
  [6] Redistribution, rectification, transformation and recognition are not
      interchangeable.
        |
        v
  [7] The topic rewards comparison across rule, state, property, equality and community.
        |
        v
  [8] A strong answer names the justice standard before judging an outcome.
        |
        v
...
The Eight-Perspective Chapter Spine
  [1] Rawls tests institutions through fair choice and ordered distributive principles.
        |
        v
  [2] Nozick tests holdings through acquisition, transfer and rectification.
        |
        v
  [3] Marxism targets exploitation, surplus value and productive ownership.
        |
        v
  [4] Democratic socialism joins social justice to welfare, liberty and competition.
        |
        v
  [5] Anarchism treats coercive hierarchy and domination as the central danger.
        |
        v
  [6] Feminist justice exposes gendered burdens hidden by formally equal rules.
        |
        v
  [7] Subaltern justice centres dignity, contribution, voice and structural exclusion.
        |
        v
  [8] Communitarianism begins from embedded selves and socially interpreted goods.
        |
        v
...
Rawls, Nozick and Controlling Distinctions
  [1] Rawls does not defend simple equality of outcome.
        |
        v
  [2] Original position and veil of ignorance model fair choice under uncertainty.
        |
        v
  [3] Equal basic liberties come first, then fair opportunity, then difference.
        |
        v
  [4] Primary goods identify the liberties, opportunities and means being distributed.
        |
        v
  [5] Nozick does not deny justice; he denies patterned redistribution as the master test.
        |
        v
  [6] Entitlement theory turns on acquisition, transfer and rectification together.
        |
        v
  [7] Wilt Chamberlain attacks end-state patterning through voluntary exchange.
        |
        v
  [8] The water-source case shows that acquisition is not morally unlimited.
        |
        v
...
Thinkers and Rival Standards of Justice
  [1] Marxist critique targets exploitation, surplus value and productive control.
        |
        v
  [2] Democratic socialism keeps social justice but rejects dictatorship.
        |
        v
  [3] Anarchism values voluntary cooperation while questioning coercive authority.
        |
        v
  [4] Feminist justice tests burdens in property, care, work and representation.
        |
        v
  [5] Gramsci explains how hegemony can make inequality appear consensual.
        |
        v
  [6] Walzer's complex equality blocks dominance across distinct social spheres.
        |
        v
  [7] Sen's capability lens asks what resources enable persons actually to do.
        |
        v
  [8] Fraser's parity lens joins distribution, status and peer participation.
        |
        v
...
Illustrative Cases and Evidence Units
  [1] Wilt Chamberlain tests whether voluntary transfer may upset a pattern.
        |
        v
  [2] The sole water source tests whether acquisition worsens others' position.
        |
        v
  [3] A clean sale after dispossession shows why rectification cannot be omitted.
        |
        v
  [4] Unpaid labour captured in production illustrates the surplus-value critique.
        |
        v
  [5] A neutral rule with unequal care burdens illustrates feminist correction.
        |
        v
  [6] Cash transfers with continuing stigma illustrate mis-recognition.
        |
        v
  [7] Wealth purchasing office or education illustrates cross-sphere dominance.
        |
        v
  [8] Antyodaya is an Indian policy illustration, not proof of one justice theory.
        |
        v
...
The Six-Axis Comparative Matrix
  [1] Rule axis: patterned fairness, historical entitlement or anti-domination.
        |
        v
  [2] State axis: redistributive authority, minimal protection or decentralisation.
        |
        v
  [3] Property axis: primary goods, title history or productive control.
        |
        v
  [4] Equality axis: formal treatment, fair opportunity, capability or status parity.
        |
        v
  [5] Community axis: isolated chooser, embedded self or sphere-specific meanings.
        |
        v
  [6] Critique axis: abstraction, history, exploitation, patriarchy or hegemony.
        |
        v
  [7] The same policy can pass one axis while failing another.
        |
        v
  [8] A comparative answer should explain conflict before offering a graded synthesis.
        |
        v
...
Trap Repair, Boundaries and PYQ Routes
  [1] Trap: Rawls orders principles; he does not permit liberty-for-income trades.
        |
        v
  [2] Trap: Nozick includes rectification; recent consent does not cleanse old injustice.
        |
        v
  [3] Trap: Marxian exploitation is structural, not merely a complaint about low wages.
        |
        v
  [4] Trap: communitarian goods do not license cultural uniformity or silenced dissent.
        |
        v
  [5] Capability and parity are bounded extensions, not Gauba chapter vocabulary.
        |
        v
  [6] Postcolonial and global justice remain routed outside this owner.
        |
        v
  [7] Verified cross-applied PYQs retain their Philosophy Paper II ownership.
        |
        v
  [8] Democratisation, backsliding and movement processes remain Topic 23 bridges.
        |
        v
...
Revision Spine and Directive Control
  [1] Revise each perspective through standard, object, institution and remedy.
        |
        v
  [2] Define asks for conceptual boundaries before examples.
        |
        v
  [3] Compare requires a common axis and a point of real disagreement.
        |
        v
  [4] Discuss requires claim, support, objection and balanced conclusion.
        |
        v
  [5] Critically examine requires an internal limit, not a decorative criticism.
        |
        v
  [6] Use one evidence unit only after stating the mechanism it illustrates.
        |
        v
  [7] Route the answer through thesis, distinction, objection-reply and verdict.
        |
        v
  [8] Keep quotations paraphrased unless wording and ownership are verified.
        |
        v
...
Argument Reconstruction and Objection-Reply Chains
  [1] Rawls objection: abstract choice may understate history and social identity.
        |
        v
  [2] Rawls reply: the device models fair terms, not an empirical bargaining meeting.
        |
        v
  [3] Nozick objection: title history may be unknowable and background power unequal.
        |
        v
  [4] Nozick reply: uncertainty strengthens the need for rectification rather than
      patterning.
        |
        v
  [5] Marxist objection: centralised transformation may threaten liberty and opposition.
        |
        v
  [6] Anarchist objection: voluntary order faces scale, coordination and enforcement
      problems.
        |
        v
  [7] Communitarian objection: shared meanings may conceal hierarchy and exclusion.
        |
        v
  [8] Synthesis must preserve distribution, history, status and reviewable power.
        |
        v
...
Indian Applications, Quotation Safety and MCQ Ledger
  [1] Antyodaya illustrates targeted public action but proves no single doctrine.
        |
        v
  [2] Indian application should test resources, opportunity, dignity, voice and power.
        |
        v
  [3] The 44th-Amendment property bridge must not be cited as Gauba chapter evidence.
        |
        v
  [4] Capability and parity require explicit supplementary attribution.
        |
        v
  [5] Recognition language must remain a bridge rather than an invented chapter owner.
        |
        v
  [6] MCQ labels must preserve narrow distinctions among adjacent standards.
        |
        v
  [7] Current examples require dates and source limits before analytical use.
        |
        v
  [8] Quotation safety means named propositions are preferable to invented wording.
        |
        v
...
MCQ Remediation and Trap Repair
  [1] Primary goods and capability differ between distributed means and real freedom.
        |
        v
  [2] Original position and veil differ between a choice device and its information rule.
        |
        v
  [3] Liberty, fair opportunity and difference form an ordered Rawlsian sequence.
        |
        v
  [4] Entitlement, self-ownership and minimal state are related but non-identical.
        |
        v
  [5] Wilt, water-source and rectification cases test different historical questions.
        |
        v
  [6] Formal equality, feminist correction and parity test different exclusion mechanisms.
        |
        v
  [7] Embedded self and complex equality address identity and sphere dominance separately.
        |
        v
  [8] Close-option practice should identify the decisive threshold before selecting.
        |
        v
...
PYQ Ownership and Answer Practice
  [1] Six verified PYQs remain cross-applied under Philosophy ownership.
        |
        v
  [2] Rawls, Nozick, Sen, Plato and Mill route through Social and Political Ideals.
        |
        v
  [3] Political Theory borrows tested questions without claiming primary ownership.
        |
        v
  [4] Original Topic 20 practice must remain distinguishable from transferred PYQs.
        |
        v
  [5] A 10-mark answer needs definition, mechanism, one criticism and a tight verdict.
        |
        v
...
|---|---|
| Primary goods | Rawls's distributive object: rights, liberties, powers, opportunities, income, wealth and the social bases of self-respect. |
| Original position | Rawls's hypothetical starting point where rational persons choose principles of justice without knowing their actual social place. |
| Veil of ignorance | The condition in which parties lack knowledge of their particular wants, talents, class position and other discriminatory markers. |
| Equal basic liberties | Rawls's first principle: each person has an equal claim to the most extensive compatible liberty. |
| Fair equality of opportunity | Rawls's second-stage rule that offices and positions should be open on genuinely fair terms, not merely formal legal equality. |
| Difference principle | Rawls's rule that inequality is just only if it brings the greatest benefit to the least advantaged. |
| Entitlement theory | Nozick's view that holdings are just if they arise from just acquisition, voluntary transfer and, where needed, rectification. |
| Subaltern | Groups kept in subordinate, exploited or marginalized positions by structural inequalities and hegemonic domination. |
| Situated / embedded self | Communitarian idea that persons discover themselves within social roles, traditions and shared ends, not in abstraction from them. |
| John Rawls | Justice as fairness through two lexically ordered principles: equal basic liberties; then fair opportunity plus the difference principle, chosen in the original position. Gauba explains the second principle's two parts as separate steps (PDF pp.447-450). |
| Robert Nozick | Justice as entitlement grounded jointly in self-ownership, just initial acquisition, voluntary transfer and rectification under a minimal protective state (PDF pp.450-452). |
...
- Gauba opens the chapter by treating justice as a field of many rival perspectives rather than one settled formula. (PDF p.446)
- Feminist and subaltern perspectives insist that justice must also address structurally subordinated groups, not only formal market or contract rules. (PDF pp.464-469)
- Scope boundary: this canonical owner covers Gauba's eight chapter-framed perspectives. Capability and recognition are separately sourced extensions; multicultural, environmental/intergenerational, postcolonial and global justice remain external cross-routes unless independently sourced in their own owners.
- Rawlsian liberal justice centres on primary goods, original position, equal basic liberties, fair equality of opportunity, and the difference principle. (PDF pp.447-450)
- Nozickian libertarian justice centres on self-ownership and justice in acquisition, transfer and rectification under a minimal state. (PDF pp.450-452)
- Anarchists attack coercive authority itself and imagine justice through voluntary cooperation, decentralization and anti-domination. (PDF pp.461-464)
- Communitarians criticize the isolated or unencumbered self and relocate justice within embedded selves, shared goods and community meanings. (PDF pp.469-473)
- UPSC key: every justice theory answers six hidden questions—who gets what, by what rule, through which state, with what property regime, in what kind of community, and against which injustice.
- This chapter is the direct sequel to the conceptual discussion of justice because it asks how rival traditions operationalize justice in actual distribution. (PDF pp.446-447)
- It clarifies why justice debates cannot be reduced to one axis like liberty alone or equality alone. (PDF pp.448-450, 469-473)
...
- Trap repair: Nozick is anti-justice. -> Nozick proposes a full theory of justice, but one centred on entitlement rather than redistribution. (PDF pp.451-452)
- Trap repair: Any voluntary market transfer is just for Nozick. -> The transfer must rest on just title; acquisition, transfer and rectification form a connected historical test.
- Trap repair: Marxism has nothing to do with justice. -> Gauba says that would be too strong, because Marx condemns exploitation and endorses superior distributive principles in a classless order. (PDF p.453)
- Trap repair: Democratic socialism is just Marxism without elections. -> It explicitly insists on freedom of thought, multi-party competition and opposition rights. (PDF pp.460-461)
