...
title: Political Obligation, Resistance and Law — Complete Topic Package
generation_identity: political-theory-14:learner-v2:g2
...
✅ **Fact (Department of Justice/PIB, 29 March 2026):** The National Consultation on Tele-Law was held at Vigyan Bhawan under the DISHA scheme to strengthen technology-enabled pre-litigation legal advice, stakeholder participation and access to legal services.

⚠️ **Political-theory use:** Practical access to advice and remedies can strengthen rule-of-law legitimacy because citizens can understand, invoke and contest legal authority. The programme does not establish that every valid law or official act is morally justified; validity, legitimacy and obligation must still be distinguished.

**Official PIB source:** https://pib.gov.in/PressReleasePage.aspx?PRID=2246380&reg=3&lang=2
...
POLITICAL OBLIGATION
   ...
   |
   +--> ✅ anti-obligation views
           Marxist (against class-state) / anarchist (against coercive authority)

LAW
   |
   +--> ✅ prescriptive law in politics
   +--> ✅ natural / analytical / historical / sociological jurisprudence
   +--> ✅ law <-> morality
   +--> ✅ law <-> liberty
   +--> ✅ rule of law
...
- ⚠️ The core exam move is to separate **obedience**, **moral legitimacy**, **resistance**, and **legal validity**, instead of merging them into one idea.

#### 2. Why this topic matters
- ✅ This topic sits exactly at the junction where theory tests the limits of state authority and the citizen's right to disobey or resist (PDF pp.280-289).
...
- ⚠️ UPSC rewards answers that show civil disobedience is not casual law-breaking and that rule of law is not exhausted by mere procedure.
...
- ✅ **Unlimited vs limited vs anti-obligation:** some theories demand near-total obedience, some qualify obedience by rights or common good, and some deny obligation to the coercive state itself (PDF pp.280-287).
- ✅ **Political authority vs government officials:** Gauba's conclusion insists that abstract authority is encountered in practice through fallible government officials; this is why caution is necessary (PDF pp.287-288).
- ✅ **Legal validity vs moral legitimacy:** a law may be technically valid because properly enacted, yet still morally contestable (PDF pp.290-292, 295-296).
- ✅ **Civil disobedience vs ordinary law-breaking:** civil disobedience is principled, public, non-violent and penalty-accepting; casual illegality is not (PDF p.287).
...
- ✅ **Hobbes:** obligation is strong because people consent to a sovereign for self-preservation and cannot safely recover their natural powers without anarchy (PDF pp.283-284).

- ✅ **Locke:** government is a trust to protect life, liberty and property; when it fails, people may resist and replace it (PDF pp.283-284).

- ✅ **Rousseau:** obligation is owed to the general will, so obedience is framed as obedience to one's higher, civic self (PDF pp.283-284).

- ✅ **Hegel:** by identifying obedience with the realization of divine reason in the state, he tends toward unlimited political obligation (PDF p.284).

- ✅ **T.H. Green:** obligation is limited by the common good; unjust commands need not bind conscience (PDF pp.284-286).
...
- ✅ **Austin, Kelsen and Hart within legal positivism; Dworkin as a major interpretivist critic (PDF pp.291-292):**
...
- ✅ Gauba's own caution that failure to deliver full employment, universal education or medical care is not by itself sufficient ground for resistance is a useful example of how he limits the politics of disobedience (PDF p.288).
- ✅ Thoreau's refusal to pay taxes and imprisonment are used by Gauba as a classic illustration of principled disobedience (PDF p.287).
- ✅ Conscientious objection to military service during the First World War is cited as a case where legal duty and moral conscience can clash (PDF p.287).
- ✅ Gandhi's 1930 salt-law defiance is Gauba's clearest illustration of public, non-violent civil disobedience against colonial law (PDF p.287).
- ✅ Gauba's law chapter uses reform of child marriage, widow-burning, untouchability and bonded labour as historical examples of law leading social-moral reform (PDF p.296).
- ✅ Traffic regulation appears as Gauba's simple illustration of morally neutral but order-preserving law and of rule-of-law clarity (PDF pp.296, 300).
...
| ✅ **Anti-obligation / negative obligation** | ✅ Existing coercive state is not morally owed obedience as such (PDF p.286). | ✅ Marxist and anarchist positions (PDF p.286). | ⚠️ Strong critique, but difficult to institutionalize without transition problems. |

##### B. Resistance, revolution, conscientious objection, civil disobedience
| Mode | What it targets | Method | Relation to law |
|---|---|---|---|
| ✅ **Resistance** | ✅ Specific unjust command, policy or authority abuse (PDF pp.287-288). | ⚠️ Can range from protest to direct action. | ⚠️ May remain within or move against law. |
...
- ❌ **"A valid law is automatically a just law."** -> ✅ Legal validity and moral legitimacy can diverge; the whole discussion of natural law, equity and conscience depends on this (PDF pp.290-296).
- ❌ **"Rule of law means identical rights and duties in all situations."** -> ✅ Gauba's traffic example shows generality and clarity do not exclude differentiated regulation by relevant situation (PDF p.300).
...
- ✅ Use `Political-Theory/advanced/14_Political-Obligation-Resistance-and-Law.md` for fuller reconstruction, jurisprudence debate and answer-engine use.
- ✅ Use `Political-Theory/basic/13_Diverse-Perspectives-on-the-State.md` because the kind of state one imagines affects the scope of obedience one permits.
- ✅ Use `Political-Theory/basic/11_Sovereignty-and-Pluralism.md` for the earlier problem of where authority is located.
- ✅ Use `Political-Theory/basic/05_Socialism-Fascism-Anarchism-and-Gandhism.md` for ideological roots of anarchist and Gandhian positions.
- ✅ Use `Philosophy/paper-2/socio-political/Individual-and-State.md` and `Philosophy/paper-2/socio-political/Forms-of-Government.md` for Philosophy-optional parallels on state, authority and obligation.
- ✅ Use `Polity/advanced/10_Amendment-and-Basic-Structure.md` only for Indian constitutional application; this file does **not** reproduce statute/case detail.

#### 11. Revision capsule / answer spine
- ⚠️ Open with the question itself: political obligation asks why, when and how far one must obey political authority.
- ⚠️ Divide answers into three camps: unlimited, limited and anti-obligation.
- ⚠️ Contrast Hobbes with Locke first; then add Rousseau and Green to show why consent or common good can still justify obedience without blind submission.
- ⚠️ Use Gandhi to define principled resistance: unjust law, public protest, non-violence, acceptance of penalty, no sectional selfishness.
- ⚠️ In law answers, define prescriptive law, list the four schools, then distinguish legality from morality and liberty.
- ⚠️ End with rule of law: known law, general law, non-retrospective law and restrained government.
...
Which option correctly states the source-grounded meaning or position associated with **Political obligation**?
...
A. Unlimited vs limited vs anti-obligation
...
Which option correctly states the source-grounded meaning or position associated with **Force-based obligation**?
...
Which option correctly states the source-grounded meaning or position associated with **Consent**?
...
Which option correctly states the source-grounded meaning or position associated with **Common good basis**?
...
Which option correctly states the source-grounded meaning or position associated with **Civil disobedience**?
...
Which option correctly states the source-grounded meaning or position associated with **Conscientious objection**?
...
Which option correctly states the source-grounded meaning or position associated with **Prescriptive law**?
...
Which option correctly states the source-grounded meaning or position associated with **Natural law school**?
...
Which option correctly states the source-grounded meaning or position associated with **Analytical jurisprudence**?
...
Which option correctly states the source-grounded meaning or position associated with **Historical jurisprudence**?
...
Which option correctly states the source-grounded meaning or position associated with **Sociological jurisprudence**?
...
Which option correctly states the source-grounded meaning or position associated with **Rule of law**?
...
Which option correctly states the source-grounded meaning or position associated with **Retributive punishment**?
...
Which option correctly states the source-grounded meaning or position associated with **Deterrent punishment**?
...
Which option correctly states the source-grounded meaning or position associated with **Reformative punishment**?
...
Which option correctly states the source-grounded meaning or position associated with **Proportionality**?
...
Which option correctly states the source-grounded meaning or position associated with **Unlimited vs limited vs anti-obligation**?
...
Which option correctly states the source-grounded meaning or position associated with **Legal validity vs moral legitimacy**?
...
Which option correctly states the source-grounded meaning or position associated with **Civil disobedience vs ordinary law-breaking**?
...
Which option correctly states the source-grounded meaning or position associated with **Resistance vs revolution**?
...
Which option correctly states the source-grounded meaning or position associated with **Austin (command theory)**?
...
C. Legal validity vs moral legitimacy
D. Hart (critique of Austin; structure of rules)
...
Which option correctly states the source-grounded meaning or position associated with **Kelsen (Grundnorm/hierarchy)**?
...
Which option correctly states the source-grounded meaning or position associated with **Hart (critique of Austin; structure of rules)**?
...
Which option correctly states the source-grounded meaning or position associated with **Dworkin (principles in hard cases)**?
...
- ⚠️ The advanced theme is that neither legality nor obedience is morally self-authenticating.

### 2. Scope, assumptions and conceptual boundary
- ✅ Gauba frames political obligation as the problem of the logical and moral grounds of obeying political authority, including taxes, participation, jury service and military duty (PDF p.280).
- ✅ He then shifts to jurisprudence because the citizen's problem is not only whether to obey, but also what kind of norm law is and how it differs from morality and sheer force (PDF pp.289-300).
- ⚠️ This file is conceptual and normative: it does **not** catalogue Indian statutes, constitutional cases or administrative remedies.
- ✅ The chapter's practical assumption is anti-romantic: real obedience is demanded by governments staffed by fallible officials, not by abstract ideals alone (PDF pp.287-288).

### 3. Direct-book argument reconstruction
- ✅ Gauba first dismisses force majeure as a full theory of obligation because fear may secure compliance but cannot secure morally reasoned obedience (PDF pp.280-281).
- ✅ Divine-right theory fails on similar grounds: it sanctifies authority without allowing rational scrutiny of unjust rule (PDF p.281).
- ✅ Conservative thought improves matters by appealing to prudence, continuity and legitimacy, but it still leans toward obedience because disorder is seen as worse than many defects of government (PDF pp.281-282).
- ✅ Consent theory is the major liberal answer: people obey because authority is of their own making, yet Hobbes, Locke and Rousseau convert that premise into very different scopes of obligation (PDF pp.282-284).
- ✅ Idealism radicalizes obligation in Hegel but moderates it in Green, who ties obedience to common good and denies unconditional claims by government (PDF pp.284-286).
- ✅ Marxism and anarchism deny genuine political obligation to the coercive class-state, though Marxism ties duty to class struggle and anarchism to justice without government (PDF p.286).
- ✅ Gandhi then gives Gauba's most disciplined account of resistance: unjust law may be broken, but only openly, non-violently, after persuasion fails, with willingness to suffer penalty and without sectional selfishness (PDF p.287).
- ✅ Gauba's conclusion adds a final caution: resistance must be publicly reasoned, proportionate, constitutionally preceded and not so destructive that it unleashes chaos worse than the grievance itself (PDF pp.287-288).
- ✅ The law chapter then reclassifies the field: scientific law describes regularities, prescriptive law governs conduct, and jurisprudence debates whether law is moral reason, sovereign command, historical growth or social engineering (PDF pp.289-294).
- ✅ The final movement reconciles law with morality and liberty only conditionally: law may restrain to protect equal freedom and social welfare, but arbitrary or morally stagnant law becomes tyrannical; hence rule of law becomes crucial (PDF pp.295-300).

### 4. Definitions and distinctions
- ✅ **Political obligation:** a duty owed to political authority, not necessarily to every government action as such (PDF p.280).
- ✅ **Legitimacy:** though not fully theorized here, Gauba's conservative and rule-of-law discussions imply that rightful authority is different from naked power (PDF pp.281-282, 298-300).
- ✅ **Unlimited obligation:** obligation with no effective right of resistance or withdrawal, typical of force, divine-right and strong absolutist formulations (PDF pp.280-285).
- ✅ **Limited obligation:** obedience constrained by rights, common good, constitutional trust or conscience (PDF pp.283-287).
- ✅ **Negative obligation / anti-obligation:** refusal to concede moral obedience to the coercive class-state or organized authority as such (PDF p.286).
- ✅ **Civil disobedience:** public, principled, non-violent breach of unjust law with acceptance of punishment and general respect for law (PDF p.287).
- ✅ **Descriptive law:** a discovered regularity in nature or social science, tested as true or false (PDF p.289).
...
- ✅ **Hobbes:** obligation is broad because the sovereign is the rational antidote to insecurity; once natural powers are transferred, revolt reopens anarchy (PDF pp.283-284).
- ✅ **Locke:** obligation is conditional because government is a trust for protecting life, liberty and property; breach of trust legitimizes replacement (PDF pp.283-284).
- ✅ **Rousseau:** obligation is strict but self-imposed because sovereignty resides in the general will rather than an external ruler; civic freedom replaces raw natural liberty (PDF pp.283-284).
- ✅ **Hegel:** by elevating the state as divine reason embodied, he collapses moral freedom into obedience and risks unconditional statism (PDF p.284).
- ✅ **T.H. Green:** obligation is owed only to laws that serve the common good; society, not government alone, is the moral pivot (PDF pp.284-286).
- ✅ **Harold Laski:** Gauba uses him in conclusion to remind us that claims of state pre-eminence are in practice claims of fallible governments (PDF p.288).
- ✅ **Marxists:** obligation is redirected toward the working class and revolutionary solidarity, not toward the capitalist state (PDF p.286).
- ✅ **Anarchists:** the individual owes justice and cooperation but not obedience to organized coercive authority (PDF p.286).
- ✅ **Thoreau:** personal refusal to support injustice makes conscience a direct source of justified non-compliance (PDF p.287).
- ✅ **Gandhi:** civil disobedience must aim at change of heart, not destruction; it presupposes respect for law in general and opposition only to specific injustice (PDF p.287).
- ✅ **Austin:** law is sovereign command backed by sanction; international law becomes only positive morality on this test (PDF p.291).
- ✅ **Kelsen:** validity comes from proper promulgation and conformity to a basic norm within a hierarchy of norms (PDF pp.291-292).
- ✅ **Hart:** law is better understood as a structure of rules, not only coercive commands, and its standards of validity rest on social fact (PDF p.292).
- ✅ **Dworkin:** rules are insufficient in hard cases; judges also rely on principles that belong to law's working reality (PDF p.292).
- ✅ **Savigny / Maine / Pound:** law is historical growth, social evolution and social engineering, not merely command (PDF pp.292-294).

### 6. Competing perspectives
| Perspective | Ground of obligation / legality | What it gets right | What it misses |
|---|---|---|---|
| ✅ **Force theory** | ✅ Fear of superior coercion (PDF pp.280-281). | ✅ Explains compliance under domination. | ❌ Cannot explain moral obligation. |
| ✅ **Divine-right view** | ✅ Sacred source of rule (PDF p.281). | ✅ Explains traditional reverence. | ❌ Denies critical judgment and secular legitimacy. |
| ✅ **Conservative prudence** | ✅ Order, continuity and legitimacy are worth preserving (PDF pp.281-282). | ✅ Warns against reckless revolution. | ⚠️ Can tolerate too much injustice for the sake of order. |
| ✅ **Consent theory** | ✅ Authority is justified because it is self-imposed or agreed to (PDF pp.282-284). | ✅ Makes obedience intelligible in liberal terms. | ⚠️ Once-for-all consent is unstable unless continuously renewed. |
| ✅ **Idealist common-good view** | ✅ Obedience is owed to laws serving common good (PDF pp.284-286). | ✅ Reconnects law with morality. | ⚠️ Risks abstraction if common good is invoked by officials without public control. |
| ✅ **Marxist view** | ✅ No duty to class-state; real duty runs against domination (PDF p.286). | ✅ Reveals class bias behind "public" authority. | ⚠️ Underplays plural moral communities outside class. |
| ✅ **Anarchist view** | ✅ Organized authority lacks moral title (PDF p.286). | ✅ Keeps coercion under relentless suspicion. | ⚠️ Hard to institutionalize stable large-scale order. |
...
- ✅ Gauba's objection to force and divine-right theories is foundational: compliance under terror or theology is not yet moral obligation (PDF pp.281-282).
- ✅ Hobbes, Locke and Rousseau all use consent, but consent does not do the same work in each system; the same word masks radically different models of sovereignty and resistance (PDF pp.283-284).
- ✅ Gauba's own comparative judgment clearly favours Locke's version because it ties government to ongoing consent and rights-protection rather than one decisive original surrender (PDF p.284).
- ✅ Hegelian statism collapses state and moral reason too easily; Gauba explicitly warns how such thinking can be recruited by fascistic demands for blind obedience (PDF p.284).
- ✅ Green corrects idealism by relocating moral priority in society and common good, yet his view still presupposes a relatively unified moral consciousness that may be difficult to identify in plural societies (PDF pp.285-286).
- ✅ Marxist and anarchist positions are powerful as critiques of domination, but they raise the practical problem of what institutional order replaces the rejected authority (PDF p.286).
- ✅ Gandhi's doctrine solves part of that problem by insisting on publicity, non-violence and acceptance of punishment, thereby distinguishing principled resistance from opportunistic disorder (PDF p.287).
- ✅ In jurisprudence, positivism secures legal certainty, but Dworkin's critique shows that adjudication often relies on principles that cannot be reduced to rule-application alone (PDF p.292).
- ✅ Historical and sociological jurisprudence recover law's social roots and ends, but they also risk weakening the sharpness of legality if everything is absorbed into custom or social purpose (PDF pp.292-294).
- ✅ Gauba's rule-of-law discussion adds a final criticism of procedural minimalism: if law becomes unjust, opaque or arbitrary, legality alone cannot rescue it (PDF pp.298-300).

### 8. Comparative matrix
| Theme | Core form | Moral status | Citizen's stance | Key page anchor |
|---|---|---|---|---|
| ✅ **Unlimited obligation** | force, divine right, Hobbes/Hegelian excess | ❌ weak or over-centralized moral basis | obedience with little space for dissent | PDF pp.280-285 |
| ✅ **Limited obligation** | Locke, Green, cautious constitutionalism, Gandhi | ✅ stronger because rights/common good/conscience matter | obey, debate, resist if justified | PDF pp.283-287 |
| ✅ **Anti-obligation** | Marxist and anarchist | ⚠️ morality shifted away from state | organize against coercive order | PDF p.286 |
| ✅ **Civil disobedience** | public non-violent breach of unjust law | ✅ principled and morally disciplined | break law openly, accept punishment | PDF p.287 |
| ✅ **Natural-law jurisprudence** | law judged by higher right | ✅ keeps law answerable to justice | critique unjust enactment | PDF pp.290-291 |
| ✅ **Analytical jurisprudence** | law judged by source, form and sanction | ⚠️ valid law need not be just law | obey or challenge using legal criteria | PDF pp.291-292 |
| ✅ **Historical jurisprudence** | law as legal evolution | ⚠️ legitimacy grows from historical fit | interpret law through social past | PDF pp.292-293 |
| ✅ **Sociological jurisprudence** | law as social engineering | ⚠️ legitimacy linked to social purpose | judge law by social effects | PDF pp.293-294 |

### 9. Application without current-affairs dependence
- ⚠️ When faced with a hypothetical unjust emergency order, first ask: is the issue about legal validity, moral legitimacy, or both?
- ⚠️ When faced with a tax-resistance problem, distinguish Thoreau-style conscience, Gandhian civil disobedience and revolutionary anti-state politics.
- ⚠️ When faced with a law restricting conduct, ask whether the restraint protects equal liberty, resolves civil conflict, regulates economic abuse or secures welfare; this follows Gauba's own fourfold reasoning on law and liberty (PDF pp.297-298).
- ⚠️ When faced with a hard judicial case, note that positivist rule-application may be supplemented by principle-based reasoning, which is where Dworkin becomes useful (PDF p.292).
- ⚠️ When faced with a question on rule of law, move beyond slogan and list the operational tests: notification, generality, prospectivity and restrained power (PDF p.298).

### 10. UPSC answer-engine prompts
- ⚠️ **Prompt 1:** Why is Locke's theory of political obligation more sustainable for modern democracy than Hobbes's or Rousseau's?
- ⚠️ **Prompt 2:** Distinguish resistance, revolution, conscientious objection and civil disobedience without reducing them to simple illegality.
...
- ✅ Companion foundation file: `Political-Theory/basic/14_Political-Obligation-Resistance-and-Law.md`.
- ✅ Use `Political-Theory/basic/13_Diverse-Perspectives-on-the-State.md` because different state theories generate different scopes of obedience.
- ✅ Use `Political-Theory/basic/11_Sovereignty-and-Pluralism.md` for the location and diffusion of authority.
- ✅ Use `Political-Theory/basic/05_Socialism-Fascism-Anarchism-and-Gandhism.md` for ideological background to anarchism and Gandhism.
- ✅ Use `Philosophy/paper-2/socio-political/Individual-and-State.md` and `Philosophy/paper-2/socio-political/Forms-of-Government.md` for optional-paper parallels.
- ✅ Use `Polity/advanced/10_Amendment-and-Basic-Structure.md` only when shifting from conceptual tests to Indian constitutional doctrine.
- ✅ Exclusion: this file does **not** reproduce Indian statutory classifications, constitutional Articles, landmark judgments or protest-law case summaries.

### 12. Factual-risk checks
- ❌ Do **not** treat force-based compliance as the same thing as political obligation; Gauba rejects that equation (PDF pp.280-281).
- ❌ Do **not** say Hobbes, Locke and Rousseau all generate either fully unlimited or fully identical consent; Gauba's discussion sharply differentiates them (PDF pp.283-284).
- ❌ Do **not** describe civil disobedience as secret, violent, or penalty-evading; that would negate Gauba's Gandhi-Thoreau model (PDF p.287).
...
Theses and Directive-Specific Architecture
  [1] A political-obligation thesis must identify unlimited, limited or anti-obligation.
        |
        v
  [2] Directive control determines whether the answer distinguishes, discusses or
      evaluates.
        |
        v
  [3] Civil-disobedience answers must state publicity, non-violence and accepted penalty.
        |
        v
  [4] A jurisprudence answer must separate positivist reconstruction from Dworkin's
      critique.
        |
        v
...
Named Evidence for Obligation, Law and Resistance
  ...
  [3] Kelsen's Grundnorm and Dworkin's inheritance principle are jurisprudential evidence.
        |
        v
  [4] Traffic regulation illustrates clarity and relevant differentiation under rule of
      law.
        |
        v
...
Claim-Evidence-Limit and Mark-Scaled Answers
  ...
  [3] A 20-marker integrates validity, legitimacy, resistance and rule of law.
        |
        v
  [4] Every conclusion must specify the conditions under which obedience remains
      justified.
        |
        v
