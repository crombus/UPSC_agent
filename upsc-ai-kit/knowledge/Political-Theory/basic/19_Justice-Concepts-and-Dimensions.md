# Justice: Concepts and Dimensions - MUST-DO
...
```text
JUSTICE = fair allocation of benefits + burdens
        |
        +------------------------------+
        |                              |
        v                              v
...
|---|---|
| Justice | ✅ Justice is concerned with fair allocation of benefits and burdens in society, especially in situations of scarcity and open contestation (Gauba, PDF pp.432-433). |
...
| Substantive / distributive justice | ✅ Justice judged by whether actual outcomes improve the condition of the poor and underprivileged, not by procedure alone (Gauba, PDF pp.442-445). |
...
1. ✅ Justice becomes a political question where social advantages are scarce and where their allocation can be openly debated and revised (Gauba, PDF pp.432-433).
2. ✅ Gauba distinguishes good/bad from right/wrong and treats justice as aligned with the latter: a question of what is right and reasonable, not merely what is useful (Gauba, PDF pp.433-435).
...
| Substantive / distributive justice | ✅ It stresses whether the poor and underprivileged gain real opportunities to improve their lot, even if this requires altering background structures and not just policing rules (Gauba, PDF pp.444-445). |
...
- ✅ Gauba's own contrast between open society and authoritarian order shows that justice becomes a live issue only where allocation can be argued about and revised (Gauba, PDF pp.432-433).
...
- ✅ Justice concerns fair allocation of benefits and burdens under scarcity in an open society (Gauba, PDF pp.432-433).
