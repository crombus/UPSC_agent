...
# Medieval History 25 - Decline of the Mughal Empire & the Eighteenth Century - Premium Solved PYQ Workbook
...
![Visual 0: workbook cover](../../../../notes/Medieval-Indian-History/assets/25_Decline-of-the-Mughal-Empire-and-the-Eighteenth-Century/00_00_cover.png)
...
**Result:** `PYQ-INTEGRATION-AUDIT-2018-2023.md`, `PYQ-INTEGRATION-AUDIT-2024-2025.md` and `PYQ-INTEGRATION-AUDIT-2026.md` each explicitly list Medieval Topic 25 basic and advanced files as owning no routed question across their respective windows. No Prelims or Mains question in any checked ledger is routed to Topic 25.

**Workbook policy consequence:** there is no fabricated "Topic 25 PYQ" and no official key is claimed where none exists. The exercise set below is original practice, clearly marked as such throughout. If a future direct question is added to this cluster, preserve original option order and label any key as INFERRED ANSWER - NOT OFFICIALLY VERIFIED unless an official key is present.

**Adjacent evidence, not PYQ substitution:** three thematically adjacent items are used strictly as bounded bridge illustrations, each verified for exact wording and each explicitly routed elsewhere by this repository's own ledgers - they are never presented as "this topic's own question." (1) **2021 Prelims** ascending-size sequence of Pargana-Sarkar-Suba, routed to **Medieval Topic 16** (State and Government under Akbar); used only as a one-line administrative-hierarchy boundary reminder. (2) **2021 Prelims** statements on the Nizamat of Arcot, the Mysore Kingdom and Rohilkhand, routed to **Modern History Topic 02** (Indian States and Society, 18th Century); used as the best available bounded-bridge illustration for successor-state content. (3) **2022 Mains GS-I**, 10 marks/150 words, on why Company armies staffed mainly by Indian soldiers consistently defeated larger Indian armies, routed to **Modern History Topic 05** (British Territorial Expansion); used only as a forward bridge for the non-inevitability theme. No further PYQ is claimed for this topic.

## Compact evidence banks

### Bank 1 - Succession and the Sayyid wizarat

Bahadur Shah I (1707-12) conciliated Rajputs/Shahu but faced Banda Bahadur's Sikh revolt. Jahandar Shah (1712-13) was dominated by Zulfiqar Khan. Farrukhsiyar (1713-19) was raised and later deposed/killed by the Sayyid Brothers (Abdullah Khan, Hussain Ali Khan Barha); jizyah was abolished in 1713; the 1719 settlement recognised Shahu's chauth/sardeshmukhi claims for Maratha military help. Muhammad Shah (1719-48) followed after a 1720 coalition (including Nizam-ul-Mulk) overthrew the Sayyids; Nadir Shah's 1739 raid falls in his reign.

### Bank 2 - Jagirdari mechanics and Deccan exhaustion

Jama is the assessed revenue demand; hasil is what is actually collected; paibaqi is unassigned/reserve jagir land; be-jagiri is a shortage of productive, assignable jagir land relative to claimant nobles. The circa-1681-1707 Deccan campaigns absorbed Deccani/Maratha nobles into the mansabdari system, expanding claimants while the assignable land pool in a war-exhausted region shrank - this is the twenty-year "ulcer" that fed the post-1707 jagir-transfer crisis, not a single ruler's personal failing.

### Bank 3 - Successor states: Bengal, Awadh, Hyderabad

Bengal: Murshid Quli Khan's ijaradari (revenue-farming) settlement reduced disruptive jagir turnover and stabilised collection. Awadh: Saadat Khan built autonomy through accommodation with zamindars and taluqdars, retaining formal Mughal legitimacy. Hyderabad: Nizam-ul-Mulk converted Deccan subedari into de facto dynastic rule while still using Mughal titulature. All three keep khutba/sikka in the emperor's name - devolved administration and fiscal power, not formal secession.

### Bank 4 - External shocks and Panipat III

Nadir Shah (1739): won at Karnal against a considerably larger Mughal force, sacked Delhi, withdrew the same year with plunder - a severe fiscal shock, not an annexation. Ahmad Shah Abdali invaded repeatedly, 1748-1761, keeping the north-west frontier under sustained pressure. The Third Battle of Panipat (1761) pitted the Maratha confederacy against a coalition led by Abdali with Awadh's Shuja-ud-Daulah and Rohilla allies - a Maratha defeat that ended their bid for unchallenged paramountcy without installing any single successor in their place.

### Bank 5 - Continuity, historiography and non-inevitability

Jadunath Sarkar centred Aurangzeb's personal/religious policy; Satish Chandra centred the jama-hasil/jagir-transfer administrative-fiscal crisis (this cluster's central thread); regional/agrarian historians (Alam, Subrahmanyam) stress continuing trade, credit (Jagat Seth) and court patronage (Awadh, Hyderabad) alongside political fragmentation. Mughal fragmentation created a genuinely open, multi-polar order; British paramountcy was not predetermined from 1707, and this topic's own narrative closes at 1761, handing Buxar/Diwani forward to Modern History as a bounded bridge only.

![Visual 2 repeat: source method and the historiography ladder](../../../../notes/Medieval-Indian-History/assets/25_Decline-of-the-Mughal-Empire-and-the-Eighteenth-Century/02_02_source_method_wheel.png)

*Visual 2 repeat: source method and the historiography ladder. Original deterministic study visual; schematic maps are NOT TO SCALE where marked.*
