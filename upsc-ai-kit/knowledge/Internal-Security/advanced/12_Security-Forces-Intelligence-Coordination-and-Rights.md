# Security Forces, Intelligence Coordination and Rights - ADVANCED
...
- ⚠️ No GS-III Mains question in the audited 2024-2025 papers names
  ...
  should: (i) name the specific force/agency and its precise mandate,
  not a generic reference; (ii) diagnose which of the three structural
  gaps (state-police capacity, command multiplicity, accountability
  investment) is most relevant to the specific question asked; (iii)
  favour functional-reform over generic centralisation proposals, citing
  the NCTC precedent.
