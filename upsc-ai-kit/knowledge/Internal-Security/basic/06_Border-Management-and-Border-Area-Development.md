# Border Management and Border Area Development - MUST-DO
...
> Management in Border Areas*, PDF pp. 4-9, 21-30; `00_Master-Framework.md`
> Sections 4, 6; audited GS-III syllabus; MHA Border Management-II
> annexure (8 January 2026).
...
1. **Pakistan (3,323 km):** ✅ Comprises the Radcliffe Line, the Line of
   Control and the Actual Ground Position Line; porous, artificial terrain
   enables smuggling (heroin, FICN), infiltration and hawala networks
   (Singh, PDF pp. 121-122).
...
3. **Bangladesh (4,096 km, the longest):** ✅ Un-demarcated stretches,
   enclaves and adverse possessions cause friction; illegal migration,
   cattle smuggling and trans-border crime are the dominant challenges
   (Singh, PDF pp. 122-123).
...
6. **Myanmar (1,643 km):** ✅ Rugged, weakly demarcated in pockets; the
   Golden Triangle's edge facilitates drug trafficking. MHA announced on
   8 February 2024 its decision to scrap the FMR following security and
   demographic concerns; do not infer completed abolition without the
   latest formal notification (Singh, PDF pp. 123-124; VisionIAS, PDF pp.
   24-25).
...
- ✅ **Department of Border Management, MHA:** created following the Group
  of Ministers' recommendations; implements BADP and coordinates border
  infrastructure (VisionIAS, PDF p. 4).
...
- ✅ BSF guards the Pakistan and Bangladesh borders; ITBP guards the China
  ...
  Myanmar border.
- ✅ BADP covers villages within 0-10 km of the international border.
...
- ✅ **2024 Q19 (verbatim, local paper text reproduced verbatim):** "India
  ...
  - Structure: examine China border issues (disputed LAC, Galwan/Tawang
    ...
    undifferentiated "China-Pakistan" challenge → then describe BADP
    (village-level development) and BIM (infrastructure scheme),
    citing the current MHA document for scheme period/allocation.
