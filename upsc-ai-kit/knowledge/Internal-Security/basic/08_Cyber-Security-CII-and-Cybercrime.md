...
> **Core area:** Cybercrime vs. cyber warfare vs. cyber terrorism; Critical
> Information Infrastructure (CII); CERT-In and NCIIPC; the Digital
...
> Internal Security through Communication Network*, PDF pp. 3-4, 27;
> `00_Master-Framework.md` Sections 4, 6; audited GS-III syllabus; MeitY,
> DPDP Rules 2025 (13 November 2025); CERT-In Directions (28 April 2022).
...
| ✅ **Cyber terrorism** | Terrorist activity conducted through cyberspace by an organisation working independently of a nation-state (Singh, PDF p. 101). |
| ✅ **Critical Information Infrastructure (CII)** | Computer resources whose incapacitation/destruction would have a debilitating impact on national security, economy, public health or safety (Section 70, IT Act 2000). |
...
| ✅ **CERT-In** | Computer Emergency Response Team (India), the national nodal agency for cyber incident evaluation, prediction and alerts (VisionIAS, PDF p. 27). |
...
1. **Threat classification:** ✅ Singh's two-way split — cyber crime
   ...
   pp. 99, 101).
2. **CII interdependence:** ✅ CII spans energy, transport, banking/
   ...
   3).
3. **Internal vs. external threat sources:** ✅ Singh distinguishes
...
4. **Institutional response:** ✅ CERT-In handles incident response and
   alerts; NCIIPC, under NTRO, is the specific CII-protection nodal agency
   under Section 70A — the two institutions have distinct, non-
   overlapping mandates (Singh, PDF pp. 106, 110).
5. **Data-protection layer:** 📰 The DPDP Act, 2023 (context: replacing
...
- ✅ **NCIIPC:** nodal CII-protection agency under NTRO, per Section 70A of
  the IT Act, responsible for identifying critical sub-sectors, issuing
  cyber alerts, malware analysis and CII owner facilitation (Singh, PDF
  pp. 110-111).
- ✅ **CERT-In:** the national incident-response body, distinct from
  NCIIPC's CII-specific protective mandate.
- ✅ **I4C:** MHA's coordination platform for cybercrime prevention,
  ...
  CERT-In's incident-response and NCIIPC's CII-protection roles.
...
- ✅ CERT-In is India's national computer emergency response team,
  distinct from NCIIPC's CII-specific protective mandate.
- ✅ I4C coordinates cybercrime reporting, investigation support and
  capacity building under MHA.
...
- ⚠️ Where a question asks about "basics of cyber security" generally, use
  ...
  terrorism) and the CII definition as the structural anchor.
