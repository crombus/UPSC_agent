# Indo-Pacific, Indian Ocean and Maritime Security - MUST-DO

> **Subject:** International Relations | **Tier:** Must-Do (foundation) | **GS Paper:** GS-II.
> **Core area:** Indo-Pacific concept, SAGAR, sea lanes, UNCLOS, maritime domain
> awareness, HADR diplomacy and Maldives.
...
> value-added material; `00_Master-Framework.md` Sections 2 and 5.
...
Conclave | ReCAAP | UNCLOS framework
             |
             v
...
|---|---|
| ⚠️ **SAGAR (Security and Growth for All in the Region)** | India's stated maritime doctrine for the Indian Ocean Region, combining security cooperation with economic and developmental partnership for littoral and island states. |
| ✅ **UNCLOS** | The UN Convention on the Law of the Sea — the treaty framework governing territorial waters, exclusive economic zones and high-seas navigation rights that underpins all maritime-security diplomacy (World History/Polity own the treaty-law chronology and ratification detail; IR applies it to India's regional engagement). |
| ✅ **Indian Ocean Rim Association (IORA)** | A regional forum ✅ referenced in VisionIAS security material as a mechanism India works to strengthen, alongside linkages to the Indian Ocean Naval Symposium (IONS), for maritime-security cooperation among littoral states. |
| ✅ **Indian Ocean Naval Symposium (IONS)** | ✅ A voluntary initiative (established 2008) to increase maritime cooperation among navies of Indian Ocean littoral states. |
| ✅ **Information Fusion Centre-Indian Ocean Region (IFC-IOR)** | ✅ A regional maritime-security centre hosted by the Indian Navy, established in 2018 in Gurugram, for maritime domain awareness and information-sharing among partner states. |
...
| ⚠️ **HADR (Humanitarian Assistance and Disaster Relief) diplomacy** | Cooperative frameworks and readiness for disaster response at sea and among island/coastal states — IR owns the diplomatic architecture; Disaster Management (folder not yet created) would own the operational relief cycle. |
...
5. **Island-state partnership:** bilateral vision documents (e.g., the
   India-Maldives Vision, 7 October 2024) translate the SAGAR doctrine into
   specific economic and maritime-security commitments with individual island
   states.
...
- ✅ **IORA, IONS, IFC-IOR (2018, Gurugram)** — the institutional core of
  India's maritime domain-awareness architecture.
...
- 📰 **India-Maldives Vision for Comprehensive Economic and Maritime Security
  Partnership, 7 October 2024** — the anchor bilateral vision document for
  island-state maritime-security partnership (MEA).
...
- ⚠️ **UNCLOS** — treaty framework for maritime zones and navigation rights,
  applied diplomatically by India in regional maritime engagement.
...
- ✅ A strong answer to 2024 Q20 should cite the India-Maldives Vision for
  Comprehensive Economic and Maritime Security Partnership (7 October 2024) as
  the concrete, dated instrument, alongside SAGAR, IORA/IONS and the
...
- 📰 The India-Maldives Vision for Comprehensive Economic and Maritime Security
  Partnership was signed 7 October 2024.
- ✅ The Indian Navy's biennial "Milan" naval gathering, hosted at Port Blair,
  has run since 1995.

## 7. UPSC traps

- ❌ SAGAR is a formal treaty or alliance. -> It is a stated doctrine/vision
  guiding India's regional maritime engagement, not a binding treaty.
...
- ❌ IONS, IORA and IFC-IOR are interchangeable names for one body. -> They are
  three distinct mechanisms: IORA (regional forum), IONS (naval cooperation
  symposium) and IFC-IOR (information-sharing centre).

## 8. 📰 Current anchor

- 📰 The **India-Maldives Vision for Comprehensive Economic and Maritime
  Security Partnership (7 October 2024)** is the anchor current document for
  this topic — cite it as the concrete instrument translating SAGAR into a
  specific island-state partnership, and pair it with the "international
...
- ✅ **2024 Q20 (direct):** *Discuss the geopolitical and geostrategic
  ...
  energy flows; (2) the India-Maldives Vision (7 October 2024) as the concrete
  cooperation instrument; (3) SAGAR/IORA/IONS/IFC-IOR as the institutional
  backdrop; (4) external-power naval presence (Djibouti/Gwadar-type bases) as
...
- ⚠️ Always connect Maldives/Indo-Pacific questions to concrete trade and
  ...
  geopolitics.
- ⚠️ Use SAGAR plus a named institution (IORA, IONS or IFC-IOR) rather than
  asserting maritime cooperation in the abstract.
...
> sea-lane trade-and-energy dependence into a doctrine (SAGAR), an institutional
> architecture (IORA, IONS, IFC-IOR) and dated bilateral partnerships (the
> India-Maldives Vision, 7 October 2024), managing non-traditional threats and
> external-power competition without claiming an exclusive security guarantor
> role.
