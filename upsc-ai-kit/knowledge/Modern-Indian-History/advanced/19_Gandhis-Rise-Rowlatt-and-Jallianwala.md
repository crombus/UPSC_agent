# Gandhi's Rise; Rowlatt & Jallianwala Bagh (1917–1919) — ADVANCED

> **Subject:** History (Modern India) · **Tier:** Advanced (deeper understanding) · **GS Paper:** GS-I (also Prelims).
> **Grounded in:** Bipin Chandra, *Modern India* (Ch. XV) + *India's Struggle for Independence* (Gandhian mass mobilisation and early satyagrahas).
> ✅ = from source book · ⚠️ = inference / standard knowledge · 📰 = current affairs.
> *Companion: `basic/19_Gandhis-Rise-Rowlatt-and-Jallianwala.md`. Chronology spine: `00_Master-Chronology.md`.*
