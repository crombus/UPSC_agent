# Left, Peasant, Workers' & States' Peoples' Movements — ADVANCED

> **Subject:** History (Modern India) · **Tier:** Advanced (deeper understanding) · **GS Paper:** GS-I (also Prelims).
> **Grounded in:** Bipin Chandra, *Modern India* + *India's Struggle for Independence* — socialist, communist, labour, peasant and princely-state currents.
> ✅ = from source book · ⚠️ = inference / standard knowledge · 📰 = current affairs.
> *Companion: `basic/23_Left-Peasant-Workers-and-States-Peoples-Movements.md`. Chronology spine: `00_Master-Chronology.md`.*
