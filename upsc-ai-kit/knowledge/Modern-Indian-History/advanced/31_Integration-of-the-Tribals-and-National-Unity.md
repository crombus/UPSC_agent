# Integration of the Tribals & National Unity — ADVANCED

> **Subject:** History (Post-Independence India) · **Tier:** Advanced (deeper understanding) · **GS Paper:** GS-I (post-1947 consolidation) + Prelims.
> **Grounded in:** Bipan Chandra, Mridula Mukherjee, Aditya Mukherjee, *India After Independence, 1947–2000* — Ch. 7 and Ch. 9.
> ✅ = from source book · ⚠️ = inference / standard knowledge · 📰 = current affairs.
> *Companion: `basic/31_Integration-of-the-Tribals-and-National-Unity.md`. Chronology spine: `00_Master-Chronology.md`.*
...
⚠️ Chandra's account frames tribal integration as a broadly successful, humane project marred by implementation failures. Critics — subaltern and rights-based scholars — argue that the "development" paradigm itself dispossessed tribes (dams, mines, forests), that autonomous councils were captured by elites, and that Naxalite mobilisation in the tribal belt (see topic 38) reflects unresolved structural injustice, not mere administrative slippage. A strong answer credits the autonomy model of the North-East while acknowledging the developmental displacement critique. PYQ application: pair this with land/forest and Left-extremism prompts to show cause-and-effect across topics 31 and 38.
