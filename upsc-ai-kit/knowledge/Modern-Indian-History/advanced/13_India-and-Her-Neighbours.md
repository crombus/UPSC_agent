# India and Her Neighbours (Frontier Policy) — ADVANCED

> **Subject:** History (Modern India) · **Tier:** Advanced (deeper understanding) · **GS Paper:** GS-I (also Prelims).
> **Grounded in:** Bipin Chandra, *Modern India* (Ch. X) + *India's Struggle for Independence* (imperial context) — with historiography on frontier policy, the Great Game and buffer states.
> ✅ = from source book · ⚠️ = inference / standard knowledge · 📰 = current affairs.
> *Companion: `basic/13_India-and-Her-Neighbours.md`. Chronology spine: `00_Master-Chronology.md`.*
...
⚠️ Historians read frontier policy through two lenses: **imperial security** and **imperial overreach**. A balanced answer should say that British officials claimed defensive necessity against Russia and unstable frontiers, but their forward moves often created new conflicts, costly wars and artificial boundaries whose political consequences survived decolonisation.
