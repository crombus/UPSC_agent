# Administrative & Constitutional Changes after 1858 — MUST-DO

> **Subject:** History (Modern India) · **Tier:** Must-Do (foundation) · **GS Paper:** GS-I (also Prelims).
> **Grounded in:** Bipin Chandra, *Modern India* — Chapter IX, administrative and constitutional changes after 1858.
> ✅ = from source book · ⚠️ = inference / standard knowledge · 📰 = current affairs.
> *Companion: `advanced/12_Administrative-Changes-After-1858.md`. Chronology spine: `00_Master-Chronology.md`.*
...
> **Study link:** ⚠️ Earlier constitutional development from 1773 to 1858 → `basic/06_Structure-of-Government-and-Constitutional-Development.md`.
> **Study link:** ✅ Later nationalist demands for representation → `basic/14_Foundation-of-the-INC-and-the-Moderate-Phase.md` and `basic/18_First-World-War-the-Home-Rule-League-and-the-Lucknow-Pact.md`.
