---
cover_image: C:\Users\pulkitkundra\Downloads\pk-workspace\upsc-agent\notes\Modern-Indian-History\assets\07_Economic-Impact-of-British-Rule\00_00_cover.png
---
# Modern History 07 -- Economic Impact of British Rule: Drain, Deindustrialisation, Land Revenue, Famines -- Premium Solved PYQ Workbook

> Subject: Modern Indian History | GS-I | Prelims and Mains | Date: 2026-08-20. This is a separate solved-practice workbook; no verified direct owner PYQ is invented.

![Visual 0: workbook cover](C:\Users\pulkitkundra\Downloads\pk-workspace\upsc-agent\notes\Modern-Indian-History\assets\07_Economic-Impact-of-British-Rule\00_00_cover.png)

*Visual 0: workbook cover. Original deterministic study visual; schematic charts are NOT TO SCALE where marked.*

**Companion workbook to the Complete Learning Session dated 2026-08-20.** This file is a standalone, self-contained solved-practice companion: it does not repeat the full teaching narrative (Parts I-X of the main session), which lives in the paired Complete Learning Session file and the canonical knowledge-base package. It opens with the transparent PYQ audit, then six compact evidence banks that carry just enough locked fact to attempt every question below without returning to the main file, then reproduces the complete practice set -- fifteen drills and all three MCQ sets, each independently re-derived here with the same A -> B -> C -> D correct-answer cycle as the learning session but with its distractor options genuinely reordered -- and, finally, all twelve Mains model answers in full, plus the bounded bridge note on the one cross-cutting PYQ this topic does not fully own.

# PART XI -- SOURCES, PYQ AUDIT AND PRACTICE
...
**Audit result:** this topic owns, in full or in bounded form, the following verified items. Two Mains PYQs are owned and solved as full model answers below, clearly labelled Direct PYQ: **2022 GS-I, Q3** (spurt in famines since the mid-eighteenth century; 10 marks/150 words, solved as Mains 1) and **2024 GS-I, Q13** (Industrial Revolution and the decline of Indian handicrafts; 15 marks/250 words, solved as Mains 4). One Mains PYQ is cross-cutting and used only as a bounded bridge, not as a fully owned solved answer: **2018 GS-I, Q13** (indentured labour export and diaspora cultural identity; 15 marks/250 words), genuinely shared with Geography's own indentured-labour/diaspora coverage, addressed only in the bounded bridge note after Mains 12. Two Prelims objective PYQs are solved in full immediately below with exact wording and options: **2024 Prelims GS-I, Q57** (revenue collection under Cornwallis; officially dropped) and, as a bonus item, **2026 Prelims GS-I, Q2** (Hilton-Young Commission; provisional key only). Five further Prelims items are confirmed as routed to this topic by the ledgers and by `basic/07`'s own PYQ-integration blocks, but their exact official statement-level wording and option order are **not held in any locally available official question-paper file** for 2018 or 2020 (only 2024, 2025 and 2026 official Prelims papers are held locally) -- these five are therefore named and audited, but deliberately **not** reconstructed as full worked questions, to avoid inventing statement-level text that cannot be verified against a locally held official source: **2018 Prelims GS-I, Q51** (colonial government measures after the Santhal uprising subsided), **2018 Prelims GS-I, Q52** (economic results of British rule in nineteenth-century India), **2018 Prelims GS-I, Q68** (East India Company export commodities from Bengal, mid-century), **2020 Prelims GS-I, Q23** (Industrial Revolution's impact on India in the nineteenth century), and **2020 Prelims GS-I, Q33** (decline of indigo cultivation in the early twentieth century). No other PYQ is claimed for this topic, and no official key is invented for any item above where one is not held locally.

### PYQ 1 solved -- 2024 Prelims, GS-I, Q57 (Cornwallis / Permanent Settlement / Ryotwari; officially dropped)

**Question (exact, as recovered from local official OCR, Set A):** "With reference to revenue collection by Cornwallis, consider the following statements:
...
**Official key status:** held locally (`Ans-2024-GS1.pdf`, Series A) -- this question is recorded as **"X" -- officially dropped**; the Commission awarded no marks and applied no penalty to any option chosen by any candidate for this question. This status is read directly from the locally held official key and is not inferred.

**This workbook's own elimination reasoning (for study purposes only -- not a substitute for the official disposition above):** Statement 1 is **FALSE** on this topic's own evidence -- Ryotwari's periodic-revision mechanism kept the state's demand-setting power alive and produced recurring high-demand and over-assessment pressure; ryots were not, as a general rule, exempted from revenue payment for bad harvests or natural calamities, and this topic explicitly warns against describing Ryotwari as offering such a blanket exemption. Statement 2 is **TRUE** on this topic's own evidence -- this is precisely the Sunset Law mechanism: failure to pay the fixed demand by the specified date exposed the zamindari estate to sale/removal. Read as an ordinary statement-elimination exercise, this reasoning would point to (b) 2 only; **this workbook explicitly does not present that as the official answer**, because the official key marks the question "X" (dropped), and this package must not override a verified official disposition with its own inferred reasoning.

**Why this matters for exam technique:** this is the clearest available real-world instance of a well-formed-looking statement question nonetheless being officially withdrawn; the safe study use of this item is the underlying land-revenue content (Ryotwari's periodic-revision/high-demand reality versus the Permanent Settlement's Sunset Law mechanism), not a claimed official answer, since none exists for this question.

### PYQ 2 solved (bonus) -- 2026 Prelims, GS-I, Q2 (Hilton-Young Commission; provisional key only)

**Item as routed:** `_PYQ-ROUTING-PRELIMS-2026.md` routes 2026 Prelims GS-I, Q2 to this topic's `basic/07` file under the theme "Hilton-Young Commission rupee-sterling exchange rate and British fiscal rationale." The ledger's own policy statement is explicit: "Provisional 2026 Set-A key present locally (`Ans-2026-GS1-Provisional`); key is provisional -- no answer letter recorded or inferred here." This workbook follows that same caution.

**Locally held provisional key:** the provisional key PDF (`Ans-2026-GS1-Provisional.pdf`, Series A) records Q2 as key **"A"** -- reproduced here as a factual transcription of the locally held provisional document, explicitly flagged **provisional and subject to change** upon release of the final key, consistent with the ledger's own caution against treating it as settled.

**Content caution:** this topic's own sourced material supports only the qualitative point that the Hilton-Young Commission's recommended fixed rupee-sterling arrangement aided British remittance needs and India's international creditworthiness; it does **not** hold, and does not assert, the Commission's specific recommended or adopted exchange rate. Any option in this question turning on a specific numeric ratio is therefore evaluated here only via the verified qualitative mechanism and the separately verified 1930 nationalist demand for 1s 4d, not via an invented rate.

**Exactly two Prelims PYQs are solved in full for Topic 07, plus five further audited-only items and three bounded Mains items** -- see the full audit above for the complete methodology; nothing beyond this inventory is claimed anywhere in this workbook.

## Evidence Bank 1 -- Actors and motives (one line each)

| Actor | Role / motive |
|---|---|
| Lord Cornwallis | Governor-General who introduced the Permanent Settlement, 1793, in Bengal, Bihar and Orissa, making zamindars hereditary proprietors against a permanently fixed state demand |
| Alexander Read and Thomas Munro | Architects of the Ryotwari settlement, direct state-cultivator settlement without a zamindar intermediary, in Madras and Bombay |
| Holt Mackenzie | Formulated the 1822 Mahalwari framework, North-Western Provinces, settling revenue with the village/mahal as a jointly liable unit |
| R.M. Bird | Principal field administrator who implemented and revised Holt Mackenzie's Mahalwari framework in practice |
| Dadabhai Naoroji | Developed the Drain Theory in *Poverty and Un-British Rule in India*, its sharpest theoretical statement, central to the nationalist economic critique |
| R.C. Dutt | Wrote *Economic History of India* (early 1900s), integrating land revenue, trade policy and famine into one connected structural critique |
| M.G. Ranade | Nationalist economic critic emphasising industrial policy within the wider drain/deindustrialisation argument; fuller political ownership sits with Topic 14 |
| Morris D. Morris | Revisionist historian whose quantitative challenge questions the scale/measurement of deindustrialisation and the drain, without denying structural extraction outright |
| Daniel Thorner | Census-based evidence linked to the revisionist/quantitative debate on occupational and industrial change |
| Sekhar Bandyopadhyay | Source for this topic's regional/social-variation historiographical position, stressing uneven regional and social outcomes |
| Mahatma Gandhi | Named the 1s 4d rupee-sterling exchange-rate demand in his 1930 eleven-point ultimatum, the only verified specific exchange figure in this topic |
| Sir John Strachey | Chaired the Famine Commission that reported in 1880, the verified named famine-policy commission in this topic |

## Evidence Bank 2 -- Master date list

| Date | Event |
|---|---|
| 1765-72 | Diwani grant and Dual Government (Topic 04; referenced here only as this topic's own extraction/land-revenue trigger) |
| 1770 | Great Bengal Famine (bounded to Topic 04; background context only) |
| 1793 | Permanent Settlement, Cornwallis, Bengal-Bihar-Orissa: zamindars made proprietors, state demand fixed permanently |
| early 19th century | Ryotwari settlement progressively introduced by Read and Munro in Madras and Bombay (no single founding year fixed in this topic's sourced material) |
| 1806 | British attention turns to Indian forests for Royal Navy shipbuilding timber |
| 1813 | Charter Act ends the Company's trade monopoly except tea/China; India opened wider to British manufactures (constitutional mechanics owned by Topic 06) |
| 1822 | Holt Mackenzie's Mahalwari framework, North-Western Provinces |
| 1833 | Charter Act ends all Company commercial activity (constitutional mechanics owned by Topic 06) |
| 1859-60 | Indigo Revolt, Bengal |
| 1860-61 | Famine, western Uttar Pradesh |
| 1864 | Forest Department established |
| 1865 | Government Forests Act |
| 1865-66 | Famine, Orissa |
| 1873 onward | Pabna agrarian leagues |
| 1875 | Deccan Riots |
| 1876-78 | Major famine across southern and western India |
| 1878 | Indian Forest Act: reserved/protected/unclassified forest categories |
| 1879 | Rampa rebellion (forest and tax-triggered tribal resistance) |
| 1880 | Strachey Famine Commission reports |
| 1896-1900 | Severe late-19th-century famines |
| early 1900s (1901) | R.C. Dutt's *Economic History of India* published |
| c. 1900 | Roughly one-fifth of India's land area under government forest administration (figure bound to this year only) |
| 1910 | Maria-Muria resistance, Bastar |
| 1926 | Hilton-Young Commission, Royal Commission on Indian Currency and Finance (qualitative remittance-mechanism point only; no rate asserted) |
| 1930 | Gandhi's eleven-point ultimatum names the 1s 4d exchange-rate demand |
| 1943 | Bengal famine (referenced only as a later bounded culmination) |

## Evidence Bank 3 -- Key figures and terms (hold loosely, cite as named mechanisms, not sums, where marked)

- Permanent Settlement, 1793: the state's revenue demand fixed **in perpetuity**; enforced through the Sunset Law mechanism (sale/removal of a defaulting zamindari on missing the fixed payment date) -- never a rent cap on the cultivator.
- Ryotwari: settlement directly with the individual ryot, subject to **periodic measurement and revision**, producing recurring high-demand/uncertainty pressure -- never described here as unconditional proprietorship.
- Mahalwari: the village/mahal as a **jointly liable** revenue-responsible unit, subject to periodic revision -- joint liability transferred an individual defaulter's burden onto the whole village.
- Drain channels named (never quantified as a percentage or sum in this topic's own material): home charges; official salaries, pensions and furlough payments; profits and interest remitted on British-owned capital; stores purchased in Britain; military/imperial expenditure charged to Indian revenues.
- Forest administration: British attention from 1806 (Royal Navy timber); Forest Department (1864); Government Forests Act (1865); Indian Forest Act (1878, reserved/protected/unclassified categories); roughly one-fifth of India's land area under government forest administration by around 1900 (bound to that year only).
- Railways: financed under the **Guarantee System** (private capital with a state-guaranteed minimum return) -- no specific guarantee rate is asserted anywhere in this topic's material.
- Council Bills: the mechanism by which India's merchandise export surplus was substantially absorbed into financing home charges and remittances rather than returned as a bullion inflow -- described only at the precision actually supported, with no invented exchange figure.
- Hilton-Young Commission (1926): supports only the qualitative point that a fixed rupee-sterling arrangement aided British remittances and India's creditworthiness -- the commonly cited "1s 6d" figure is explicitly **not attested locally** and must never be asserted.
- Gandhi's 1930 ultimatum: the **only** verified specific rupee-sterling figure in this topic -- the nationalist demand for **1s 4d** -- used as the sole numeric anchor when a question turns on the exchange ratio.
- Strachey Famine Commission (1880): the verified named famine-policy commission in this topic; later commissions are referenced only where independently verified.

## Evidence Bank 4 -- Document and institution distinctions

- **Early conquest-period plunder vs systemic drain vs structural underdevelopment:** three sequential, analytically distinct mechanisms -- concentrated pre-settled-revenue extraction (Topic 04's trigger); an ongoing institutional transfer via named channels across the whole colonial period; and long-run consequences of the land-revenue order, deindustrialisation, commercialisation terms and imperial infrastructure design -- never interchangeable synonyms.
- **Permanent Settlement vs Ryotwari vs Mahalwari:** distinguished by legal unit (zamindar-proprietor / individual ryot / village-mahal), intermediary presence, revision pattern (fixed permanently / periodic / periodic) and region (Bengal-Bihar-Orissa / Madras-Bombay / North-Western Provinces-Punjab-parts of Central India) -- never collapse the architect-region-unit triad.
- **Drain of wealth vs deindustrialisation:** the drain is a unilateral resource transfer via named remittance channels; deindustrialisation is the decline of handicraft/textile output and employment via tariff asymmetry, machine-import competition, lost patronage and Company-era coercion -- causally distinct mechanisms operating within the same wider extraction-to-underdevelopment frame, never conflated.
- **Indigo Revolt (1859-60) vs Pabna leagues (from 1873) vs Deccan Riots (1875):** distinguished by target (European planters / zamindars / moneylenders) and repertoire (collective refusal / leagues and litigation / debt-bond destruction) -- all three bounded here strictly as economic-response case studies, with their fuller organised political-movement history belonging to Topic 23.
- **Holt Mackenzie's 1822 framework vs R.M. Bird's implementation:** the design and its operational field rollout are independently testable and must never be merged into one name or one date.
- **2024 Prelims Q57 vs 2026 Prelims Q2:** two different official-key statuses that must never be confused -- Q57 carries a locally held official key recording it as **"X", officially dropped** (no marks/penalty to any option); Q2's key is a locally held **provisional** key only, explicitly subject to change.

## Evidence Bank 5 -- Historiography quick-reference

| Lens | Associated historian(s) | Core emphasis |
|---|---|---|
| Nationalist drain/deindustrialisation position | Dadabhai Naoroji; R.C. Dutt; M.G. Ranade | Colonial rule as a systemic drain of wealth via named remittance channels, combined with deindustrialisation of Indian handicrafts and textiles under free-trade/tariff asymmetry |
| Marxist/structural dependent-development position | Not tied to a single named historian in this topic's own sourced material | Colonial India's economy structurally reorganised to serve British capitalism's needs (raw materials, market, capital-profit outlet), producing dependent underdevelopment rather than autonomous growth |
| Revisionist/quantitative position | Morris D. Morris; census-linked Daniel Thorner evidence | Uses quantitative output and census evidence to question the scale, and in some readings the extent, of large-scale deindustrialisation and the drain, prompting a genuine, ongoing measurement debate |
| Regional/social-variation position | Sekhar Bandyopadhyay | Agrarian outcomes, protest and social impact varied considerably by region and social group rather than following one uniform, all-India pattern |

**These four lenses are complementary emphases on the same evidentiary base, not four mutually exclusive accounts** -- this topic's own explicit balance is that the revisionist debate concerns the scale and precise measurement of deindustrialisation and the drain, not whether structural extraction and real, if regionally uneven, deindustrialisation occurred.

## Evidence Bank 6 -- Topic-boundary quick-reference

| Adjacent theme | Owning topic | This workbook's treatment |
|---|---|---|
| Diwani grant and Dual Government mechanics (1765-72) | Topic 04 | Referenced only as this topic's own extraction/land-revenue trigger |
| Charter Acts and constitutional/administrative government structure | Topic 06 | Referenced only for economic effect (1813 trade-monopoly end, 1833 commercial wind-up), not constitutional mechanics |
| Detailed administrative institutions (civil service, police, judiciary) implementing revenue and forest law | Topic 08 | Not analysed here |
| Education policy and social-reform legislation | Topic 09 | Not analysed here |
| Moderate-phase nationalist politics and the organised political use of the drain argument | Topic 14 | Naoroji, Dutt and Ranade named only for their own economic arguments, not their political programme |
| Later peasant and worker movements as organised political/social history | Topic 23 | Indigo/Pabna/Deccan used here strictly as economic-response case studies, not their fuller political-movement history |
| Full indentured-labour recruitment mechanics and diaspora cultural-identity history | Not owned by this topic | Bounded bridge note only (2018 GS-I Q13), after Mains 12 |
| Colonial reparations/restitution and global-inequality debate (contemporary) | Bounded current link only | Not reopened as a historiographical position in its own right |

**Exactly two verified Prelims PYQs and three Mains PYQs (two owned, one bounded bridge) are directly routed to Topic 07** across this repository's own ledgers -- see the full audit above for the complete methodology.

## Evidence and answer-writing drills

![Visual 25 (repeat): Topic-boundaries map, previewed before the drills below](C:\Users\pulkitkundra\Downloads\pk-workspace\upsc-agent\notes\Modern-Indian-History\assets\07_Economic-Impact-of-British-Rule\25_25_topic_boundaries_map.png)

*Visual 25 (repeat): Topic-boundaries map, previewed before the drills below. Original deterministic study visual; schematic charts are NOT TO SCALE where marked.*
...
B. An initial beneficial-development phase followed by a later extractive phase only after 1857

C. A purely twentieth-century phenomenon with no eighteenth or nineteenth-century roots

D. A single, unchanging extraction pattern from 1757 to 1947 with no internal phase distinction

**Answer: A. Early conquest-period plunder and revenue extraction; nineteenth-century free-trade-driven deindustrialisation and commercialisation; late-colonial railway/infrastructure-led integration with limited industrialisation**
...
**Answer: B. A specific, narrow, comparative claim: Indian cotton textiles were a leading global export commodity, supported by a developed merchant and artisan production system, without a broader claim about universal pre-colonial prosperity**
...
A. Warren Hastings; Punjab and the North-Western Provinces; a village-based collective demand

B. Lord William Bentinck; the Central Provinces; an individually negotiated demand with each cultivator
...
D. Lord Wellesley; Madras and Bombay; a periodically revised demand

**Answer: C. Lord Cornwallis; Bengal, Bihar and Orissa; a state revenue demand fixed in perpetuity, with zamindars recognised as property-holders**
...
A. The zamindar was granted an automatic one-year grace period with no penalty

B. The zamindari was transferred permanently to the cultivating ryots

C. The state reduced the following year's demand automatically
...
**Answer: D. The zamindari estate itself became liable to sale (the Sunset Law mechanism), potentially transferring the proprietary right to a new purchaser**
...
B. Holt Mackenzie and R.M. Bird; the North-Western Provinces

C. Warren Hastings; the whole of British India uniformly

D. Lord Cornwallis; Bengal and Bihar

**Answer: A. Thomas Munro and Alexander Read; chiefly Madras and Bombay presidencies**
...
A. The ryot held no cultivation right of any kind and worked purely as a wage labourer for the state
...
C. The ryot's revenue demand, once set, was never revised for the rest of the colonial period

D. The ryot held an unconditional freehold, entirely free of state revenue obligations

**Answer: B. The ryot held a registered right of occupancy conditional on regular payment and subject to periodic revision of the demand, not an unconditional or absolute proprietorship**
...
D. Thomas Munro's Madras minute

**Answer: C. Holt Mackenzie's 1822 framework, subsequently implemented and revised in practice chiefly under R.M. Bird**
...
A. The zamindari estate as a permanently fixed unit, as in the Permanent Settlement

B. The British administrative district as a whole

C. The individual cultivator (ryot), as in Ryotwari
...
**Answer: D. The village or mahal (estate/group of villages), with joint/collective responsibility for the assessed demand, subject to periodic revision**
...
**Answer: A. The nij system (planters cultivating on land under their own direct management) and the ryoti (or asami) system (cultivators growing indigo on their own land under advance/contract obligations to the planter)**
...
A. A movement demanding the abolition of the Permanent Settlement itself
...
C. A tribal forest-rights movement unrelated to commercial cultivation

D. An organised political movement led by the Indian National Congress

**Answer: B. A largely collective cultivator refusal to continue sowing indigo under coercive planter terms, targeting European planters specifically, distinct in target and repertoire from the Pabna and Deccan episodes**
...
**Answer: C. Zamindars attempting rent enhancement beyond legally recognised limits, resisted chiefly through collective leagues and litigation rather than violent confrontation**
...
A. European planters, through crop refusal

B. The colonial forest department, through law-defiance

C. Zamindars, through litigation
...
**Answer: D. Moneylenders (sahukars), targeted through direct action including the seizure and destruction of debt bonds and account books**
...
B. Both countries maintained identical, symmetric tariff regimes throughout the colonial period

C. Tariff policy played no role at all in deindustrialisation, which was driven solely by climate

D. India imposed high protective tariffs on British goods throughout the nineteenth century

**Answer: A. British manufactured imports entered India under a substantially freer-trade regime while comparable Indian goods faced restrictive tariffs or duties in the British market, a one-way asymmetry rather than a mutually symmetric free-trade arrangement**
...
A. Denying that the Industrial Revolution had any relevance to India's handicraft decline
...
C. Treating the question as answerable with only a list of affected craft sectors and no causal analysis

D. Attributing the decline entirely to the Industrial Revolution's mechanisation alone, with no role for colonial policy

**Answer: B. Crediting English mechanisation as a necessary background condition (falling unit costs, competitive imports) while separately crediting specific colonial-policy variables (tariff asymmetry, lost court patronage, later railway penetration, absence of protective policy) as the variables that determined the scale and shape of India's decline**
...
A. The general decline of Indian handicraft industries due to competition
...
D. Any and all revenue collected by the colonial state from Indian taxpayers

**Answer: C. A unilateral transfer of resources from India to Britain for which India received no direct economic equivalent in return, distinguished from ordinary taxation (which at least in principle funds domestic administration/services)**
...
**Answer: D. Poverty and Un-British Rule in India**
...
**Answer: A. An arrangement under which private British companies built and operated Indian railway lines while the colonial government guaranteed their investors a minimum return, substantially insulating private capital from commercial risk at the state's (and ultimately Indian taxpayers') expense**
...
A. Total state ownership of all factories with no private capital at all
...
C. Uniform, evenly distributed industrial growth across all regions of India

D. Complete absence of any Indian entrepreneurial participation

**Answer: B. A managing-agency system substantially weighted toward European (chiefly British and Scottish) capital and control in eastern-India industries such as jute, alongside genuine but comparatively later and smaller-scale Indian entrepreneurial capital, notably in Bombay's cotton-textile sector**
...
A. The Strachey Commission preceded and caused the 1860-61 famine

B. No famine commission of any kind was constituted during the colonial period
...
D. The 1876-78 famine, followed by the 1943 Bengal famine, followed by the Strachey Commission of 1880 (a chronologically impossible ordering)

**Answer: C. The 1876-78 famine (widespread, multi-region) was followed by the Strachey Commission's report in 1880, and later by the further 1896-1900 famine**
...
A. Full agreement with Naoroji's exact drain quantum estimates

B. A claim that British rule was purely beneficial to Indian industry in every respect
...
**Answer: D. A quantitative, census/output-based questioning of the scale (not the mere existence) of deindustrialisation, prompting a genuine ongoing measurement debate that this topic represents fairly without using it to deny structural extraction altogether**
...
### Q21. Consider the following statements about this topic's three-part economic-impact frame: 1. Early conquest-period "plunder" refers chiefly to direct extraction following the Diwani grant, prior to any settled revenue-administrative system. 2. "Systemic drain" refers to an ongoing institutional transfer operating through named channels across the colonial period as a whole, not confined to the earliest conquest years. 3. "Structural underdevelopment" refers to long-run consequences (deindustrialisation, an extraction-oriented revenue order, imperially designed infrastructure) rather than to a single transfer event. Which of the statements given above is/are correct?
...
**Explanation:** This topic's own three-part frame requires all three distinctions to be held simultaneously, precisely because a single "extraction" label would flatten mechanisms operating over different time-horizons.
...
A. That an artisan and merchant production system existed prior to large-scale British deindustrialisation
...
D. That Indian cotton textiles were exported before colonial industrial competition intensified

**Answer: B. That pre-colonial India was a uniformly prosperous, harmonious "golden age" society with no internal inequality, providing an implicit, unstated baseline against which "decline" is measured without evidentiary basis**
...
A. To eliminate zamindars entirely and replace them with a purely state-administered ryot settlement

B. To transfer full ownership of land to actual cultivating peasants directly
...
D. To directly maximise short-term annual revenue through continuous reassessment

**Answer: C. To create a stable, propertied, revenue-paying intermediary class (zamindars) with a fixed, predictable state demand, intended to encourage long-term investment in land improvement, while in practice often producing zamindar financial distress, absentee tendencies in some cases, and continued pressure passed down onto tenant-cultivators**
...
A. Cultivators had no rights of any kind, recognised or unrecognised, under the settlement

B. Tenant rights were uniformly and effectively enforced across all of Bengal from 1793 onward

C. Cultivators automatically became full legal proprietors of the land they tilled
...
**Answer: D. The settlement fixed the state's demand on the zamindar, but cultivator/tenant occupancy rights remained a distinct, only partially and unevenly protected question, addressed later and incompletely through separate tenancy legislation**
...
B. The system had no direct settlement with the cultivator at all, operating solely through zamindars

C. The system was confined exclusively to Bengal

D. The system provided complete revenue certainty to cultivators for the entire colonial period with no revision ever occurring

**Answer: A. Periodic measurement and revision of the revenue demand created recurring uncertainty for cultivators and, in practice, sustained pressure toward high assessment levels**
...
C. Liability was assigned solely to a single hereditary headman with no reference to the wider village

D. Each individual cultivator's revenue liability was entirely independent of every other cultivator in the village

**Answer: B. The village or mahal as a whole was held responsible for the aggregate assessed demand, so that default by some cultivators could increase pressure on others within the same revenue unit**
...
**Answer: C. Permanent Settlement -- zamindari estate (fixed forever); Ryotwari -- individual ryot (periodically revised); Mahalwari -- village/mahal (periodically revised, joint liability)**
...
A. Only the Permanent Settlement was ever revised, while Ryotwari and Mahalwari demands were fixed forever

B. Ryotwari and Mahalwari were confined solely to Bengal, while the Permanent Settlement operated across all of British India

C. All three systems shared identical revision schedules and an identical all-India geography
...
**Answer: D. The Permanent Settlement's demand was fixed in perpetuity (chiefly Bengal, Bihar, Orissa); Ryotwari's and Mahalwari's demands were both subject to periodic revision, with Ryotwari concentrated chiefly in Madras and Bombay and Mahalwari chiefly in the North-Western Provinces, Punjab and parts of the Central Provinces**
...
C. Only the Permanent Settlement's designers made any improvement-related claim

D. All three systems' designers made identical claims and all three achieved identical, fully successful outcomes

**Answer: A. Each system's designers claimed their approach would encourage agricultural improvement or investment, but this topic records that actual effects varied by region and often diverged from the stated design intention, rather than uniformly confirming the designers' own claims**
...
C. The question has no recorded official key status of any kind

D. Both statements are true, and the official key confirms answer (c)

**Answer: B. Statement 1 (an automatic bad-harvest exemption under Ryotwari) is false and statement 2 (a zamindari liable to sale/removal on non-payment under the Permanent Settlement) is true on this topic's own content-level reasoning, but the question's official key itself records it as "X" -- officially dropped, and this topic does not override that disposition with its own inferred elimination**
...
A. Commercial cultivation carried no risk of any kind for cultivators once advances were accepted

B. Commercialisation was confined exclusively to food-grain crops, with no involvement of indigo, cotton, opium, jute or tea
...
D. Commercial cultivation was inherently and uniformly harmful in every instance, with no cultivator ever benefiting from market access

**Answer: C. Commercialisation itself was not inherently harmful, since it connected cultivators to wider markets, but colonial-era terms (coercive advances, planter/trader-set prices, concentrated exposure to global price swings) skewed production and price risk onto the cultivator rather than distributing it more evenly**
...
A. Cotton cultivation had no connection whatsoever to the global market or to Lancashire's mills

B. Opium cultivation and export had no connection to colonial-era fiscal or trade policy

C. Tea plantations were entirely Indian-owned and Indian-managed from their nineteenth-century origin
...
**Answer: D. Several commercial crops (including indigo, cotton, opium and jute) connected Indian cultivators to global-market price movements over which they had no control, a dependence this topic names as a structural risk rather than attaching an unsupported export-share percentage to it**
...
B. All three movements were led by the same organisation across all three regions

C. None of the three movements had any connection to agrarian economic pressure

D. All three movements targeted the same group (zamindars) using an identical repertoire (litigation)

**Answer: A. The Indigo disturbances (1859-60) targeted European planters through collective crop refusal; the Pabna agrarian league (from 1873) targeted zamindars through leagues and litigation; the Deccan riots (1875) targeted moneylenders through direct debt-bond destruction -- three distinct targets and repertoires**
...
A. Topic 23 has no connection to any of these three episodes
...
C. Both topics claim identical, fully overlapping ownership with no distinction at all

D. This topic owns their complete political-history narrative, while Topic 23 owns only their economic background

**Answer: B. This topic uses all three strictly as economic-response case studies illustrating causal mechanisms, while their fuller political-movement history (organisation, leadership, longer-run political consequence) belongs to Topic 23's ownership of later peasant/worker movements**
...
B. It was abolished by law before the Indigo disturbances of 1859-60
...
D. It was a voluntary, no-obligation cash gift from planters/traders to cultivators with no expectation of a crop in return

**Answer: C. It provided cultivators an upfront payment or input in exchange for a binding commitment to grow and deliver a specified commercial crop on largely trader/planter-favourable terms, deepening dependence in subsequent seasons if the cultivator could not fully discharge the obligation**
...
A. The abolition of the Permanent Settlement's zamindari courts

B. A reduction in colonial judicial appointments
...
**Answer: D. The political displacement or reduced spending power of Indian royal and aristocratic courts, which had earlier provided a major domestic market for fine handicrafts, textiles and luxury manufactures**
...
B. Only export volumes, with no reference to output or employment at all

C. Only population growth, unrelated to any craft-sector variable

D. A single undifferentiated concept requiring no further distinction

**Answer: A. Decline in craft output, decline in craft employment, and the physical/occupational displacement of individual artisans into agriculture or other work, as three related but analytically separate effects**
...
A. Railways had no measurable relationship to deindustrialisation of any kind
...
D. Railways caused deindustrialisation entirely on their own, independent of tariff policy or machine-import competition

**Answer: B. Railway expansion, as it penetrated further inland from the mid-nineteenth century onward, extended and deepened market integration, in the process also widening the reach of machine-made import competition into interior craft markets that had previously been more insulated by transport cost**
...
A. Deindustrialisation affected only Bengal, with no other region experiencing any craft decline

B. Deindustrialisation affected only export-oriented crafts, never crafts serving purely domestic demand
...
D. Deindustrialisation proceeded at an identical pace and to an identical degree in every Indian region and every craft sector

**Answer: C. The scale, timing and severity of craft decline varied by region and by sector, and a strong answer should avoid treating "deindustrialisation" as one uniform, undifferentiated, all-India process**
...
A. Distinguishing output decline, employment decline and artisan displacement as separate effects

B. Naming regional and sectoral variation rather than treating decline as uniform

C. Naming both English mechanisation and specific colonial-policy variables
...
**Answer: D. Writing only a general narrative of "the British destroyed Indian industry" without naming the Industrial Revolution's own mechanisation logic or any specific colonial-policy variable**
...
C. Only the cost of maintaining Indian princely states

D. Only ordinary land-revenue collection used for domestic Indian administration

**Answer: A. Home charges, official salaries and pensions remitted to Britain, profits and interest on British capital invested in India, purchase of stores in Britain for Indian administrative/military use, and military/imperial expenditure charged to Indian revenues**
...
**Answer: B. "Plunder" describes concentrated, largely conquest-period extraction following the Diwani grant, while "systemic drain" describes an ongoing, institutionalised transfer operating through named administrative and financial channels across the colonial period as a whole**
...
**Answer: C. Both its character as a specifically named economic transfer mechanism (a set of channels moving resources out of India without equivalent return) and its historical role as a central nationalist political argument (associated with Naoroji, R.C. Dutt and, on industrial policy, Ranade, later carried into the Moderate political programme owned by Topic 14)**
...
A. The drain should never be discussed at all, even in qualitative or mechanism terms

B. Only Naoroji's own nineteenth-century estimate should be treated as the final, authoritative figure

C. The drain's exact percentage of national income is a settled, uncontroversial figure that may be freely cited
...
**Answer: D. The exact quantum of the drain is genuinely disputed among historians and is deliberately not quantified in this topic's own material; the analytically important claims are the channels through which it operated and its structural/political significance, not an invented percentage or sum**
...
B. The authorship of Economic History of India

C. A purely twentieth-century, post-independence economic theorist with no colonial-era relevance

D. The original formulation of drain theory, predating Naoroji's own work

**Answer: A. An economic critique of colonial industrial and tariff policy, situated within the broader Moderate nationalist tradition whose fuller political-organisational history belongs to Topic 14**
...
C. Council Bills were a form of Indian government borrowing from Indian private banks only

D. India ran a persistent trade deficit throughout the colonial period, requiring bullion imports

**Answer: B. India generally ran an export surplus in merchandise trade, but this surplus was substantially absorbed into financing home charges and remittances (via mechanisms including Council Bills) rather than returning to India as bullion or reinvested capital**
...
B. Connecting fiscal policy to the drain's institutional channels
...
D. Naming that public debt and taxation existed and had a fiscal role in colonial administration

**Answer: C. Asserting precise, unsupported figures for total public debt, detailed tax-head composition, or their exact share of government income**
...
**Answer: D. It states only the qualitative remittance-facilitation mechanism and the separately verified 1930 nationalist demand for a 1s 4d rate, explicitly declining to assert any adopted Hilton-Young rate as unattested in locally held sources**
...
C. A claim that railways had no economic or political significance of any kind

D. Only the designed imperial purposes, with no unintended consequence of any kind

**Answer: A. The colonial administration's own designed purposes (troop movement, raw-material evacuation to ports, distribution of manufactured imports, administrative control) together with unintended consequences (market integration, a more connected national economic space, and infrastructural facilitation of later nationalist political mobilisation)**
...
A. A claim that canals were built solely for recreational purposes
...
C. A claim that the telegraph had no administrative or military function

D. Only railways, with no reference to ports, roads, telegraph or canals

**Answer: B. Ports, roads, telegraph and canals alongside railways, each linked to the same combination of imperial administrative/commercial design purpose and incidental integrative effect, without asserting a numeric railway-guarantee rate this topic does not hold with precision**
...
A. Total absence of factory industry anywhere in colonial India

B. Industrial growth confined solely to Madras presidency
...
D. Uniform, evenly spread factory development across every Indian province by the early twentieth century

**Answer: C. Concentrated growth in specific regional clusters -- for example jute manufacturing concentrated around Calcutta/Bengal and cotton-textile manufacturing concentrated around Bombay and Ahmedabad -- rather than a spatially even national industrial pattern**
...
A. Technology and machinery were always freely and equally available to Indian and European-owned firms alike with no cost or access difference

B. State industrial policy actively subsidised Indian-owned enterprise ahead of European-owned firms throughout the colonial period
...
**Answer: D. Indian-owned enterprise generally faced comparatively later entry, narrower access to organised banking/managing-agency capital networks, and technology dependent on imported machinery, constraints not equally faced by longer-established European managing agencies**
...
B. Only colonial export policy, with no reference to any climatic trigger

C. A claim that famines had no connection whatsoever to climate or rainfall

D. Only a climatic shock, with no reference to any policy or governance variable

**Answer: A. A genuine climatic harvest shock as the immediate trigger, combined with named colonial-era structural amplifiers (rigid cash revenue demand, commercialisation/export exposure, transport serving price-signals rather than need, and a laissez-faire relief ideology and administrative delay), producing an entitlement/purchasing-power and governance failure rather than a simple food-availability collapse alone**
...
A. Transport infrastructure that functioned identically regardless of price signals
...
D. A complete absence of any transport infrastructure during famine periods

**Answer: B. Railway and transport capacity that could, in principle, have moved food toward famine-affected areas instead often carried grain away from deficit areas toward areas offering higher prices or toward export, since transport responded to price signals rather than to local subsistence need**
...
A. The Simon Commission of 1928

B. The Linlithgow Commission of 1943

C. The Strachey Commission, reporting in 1880, following the widespread famine of 1876-78

D. The Hunter Commission of 1857

**Answer: C. The Strachey Commission, reporting in 1880, following the widespread famine of 1876-78**
...
A. It is entirely excluded from this topic and belongs solely to a different topic

B. It is asserted to have had a single, exclusively climatic cause

C. It is treated as analytically identical in every respect to the nineteenth-century famine sequence, with no distinguishing feature
...
**Answer: D. It is named only as a later culmination, carrying an additional wartime causal layer (war-time administrative, military-logistics and price-control conditions) distinct from, though related to, the structural amplifiers named for the nineteenth-century case sequence**
...
C. It is the only famine case this topic addresses in any depth

D. It is this topic's own primary, most fully analysed famine case

**Answer: A. It is explicitly bounded to Topic 04's own ownership, referenced here (if at all) only as background context, not as a fully analysed case within this topic's own famine sequence**
...
C. A mechanism that reversed entirely by the mid-nineteenth century with no further growth thereafter

D. A mechanism entirely unconnected to the land-revenue and commercialisation material elsewhere in this topic

**Answer: B. A self-reinforcing cycle in which indebtedness led to the pledging of land or crop, deepening dependence on the same credit relationship, connected directly to the fixed/rigid revenue demand and the coercive-advance mechanisms named earlier in this topic**
...
B. The structural position rejects deindustrialisation entirely
...
D. Both positions are identical in every respect, with no meaningful distinction

**Answer: C. The nationalist position (Naoroji, Dutt, and on industrial policy Ranade) centred the drain and deindustrialisation as the core explanation of Indian poverty within a primarily political-economic argument, while the structural/dependent-development position frames colonial economic policy as a coherent systemic integration of India into world capitalism as a subordinate, dependent economy, a broader systemic framing associated in this topic with Bipan Chandra's own account**
...
A. That no regional variation of any kind is worth studying

B. That only the nationalist position has any evidentiary merit

C. That colonial economic impact was identical across every Indian region and social group
...
**Answer: D. That agrarian outcomes, social impact and protest varied considerably by region and social group, cautioning against treating colonial economic impact as one uniform, undifferentiated all-India pattern**
...
C. Treating extraction and transformation as entirely unrelated processes with no shared causal connection

D. Denying that any transformation occurred, since extraction was the only real process

**Answer: A. Holding both a persistent unrequited surplus transfer (the drain) and genuine structural transformation (in agrarian property relations, craft-versus-factory production, and infrastructure) as simultaneously true, rather than resolving the tension by choosing only one side**
...
**Answer: B. British rule introduced genuinely modern elements (railways, telegraph, canals, a unified currency/administrative-fiscal system, limited factory industry) while simultaneously blocking the autonomous industrial, technical-education and capital-formation policies that would have converted this modernisation into Indian-led development**
...
A. Topic 04 has no relevance to this topic whatsoever

B. This topic and Topic 04 claim fully overlapping, undifferentiated ownership of the same material
...
D. This topic re-derives the full Diwani grant and Dual Government mechanics (1765-72) in detail

**Answer: C. Topic 04 owns the Diwani grant and Dual Government mechanics in full; this topic uses that episode only as the historical trigger for the land-revenue system and the drain's own origin, without re-deriving its detailed mechanics**
...
A. This topic fully narrates the Moderate movement's political-organisational history

B. Topic 14 and this topic are simply identical in scope

C. Topic 14 has no connection to this topic's drain material at all
...
**Answer: D. Topic 14 owns the Moderate phase of nationalist politics and the political deployment of the drain argument as an organised programme; this topic names Naoroji, Dutt and Ranade only for their economic arguments, deferring the fuller political-organisational history to Topic 14**
...
**Answer: A. The Ryotwari cultivator held a registered right of occupancy conditional on regular revenue payment and subject to periodic reassessment, not an unconditional freehold -- precisely why the 2024 Prelims Q57 statement claiming an automatic bad-harvest exemption is false on this topic's own evidence**
...
A. The Permanent Settlement abolished all zamindars
...
C. The Permanent Settlement applied only in Madras

D. The statement is correct as written

**Answer: B. The Permanent Settlement recognised zamindars, not the actual cultivating peasants, as the property-holders responsible for the fixed revenue demand; cultivator/tenant occupancy rights remained a separate, less securely protected question**
...
A. Deindustrialisation refers only to the disappearance of agriculture, not craft production

B. Deindustrialisation only affected crafts producing for export markets
...
D. The statement is correct; no craft production of any kind survived

**Answer: C. Deindustrialisation refers to substantial, if regionally and sectorally uneven, decline in output/employment and displacement of many artisans into agriculture; it does not mean complete disappearance of every craft, and this topic explicitly warns against overstating it as total extinction**
...
**Answer: D. The exact quantum of the drain is genuinely disputed among historians and is deliberately not quantified in this topic's own material; the analytically important claims are its named channels and its structural/political significance, not an invented percentage**
...
B. Railways served no purpose at all, imperial or otherwise

C. Railways were built entirely by Indian private capital with no state guarantee involved

D. The statement is correct as written

**Answer: A. Railway construction was designed chiefly to serve imperial purposes (troop movement, raw-material evacuation to ports, distribution of manufactured imports, administrative control), while also producing unintended integrative consequences; it was not designed purely, or even primarily, for India's own developmental benefit**
...
A. Railways caused every famine directly and exclusively
...
D. The statement is correct; railways had no unintended consequence of any kind

**Answer: B. Alongside their imperial design purpose, railway construction also produced genuine unintended consequences -- market integration, a more connected national economic space, and infrastructural facilitation of later nationalist political mobilisation -- and this topic's synthesis states both the imperial design and the unintended consequence together, described as "modernisation without autonomous development," not a purely one-sided exploitation account**
...
B. Famines were caused solely by population growth
...
D. The statement is correct; only exports mattered

**Answer: C. Famine causation combined a genuine climatic harvest-shock trigger with named colonial-era structural amplifiers (rigid revenue demand, commercialisation/export exposure, transport-by-price-signal, laissez-faire relief ideology, administrative delay); this topic explicitly warns against a monocausal export-only account**
...
**Answer: D. A genuine climatic harvest shock was typically the immediate trigger, but this topic names specific colonial-era structural amplifiers (revenue rigidity, commercialisation/export exposure, transport-by-price-signal, laissez-faire relief ideology, administrative delay) that converted a climatic shock into a large-scale entitlement and governance failure; a purely climatic account omits this vulnerability layer**
...
C. Only the Indigo disturbances are historically verified to have occurred

D. The statement is correct; all three were identical

**Answer: A. Each targeted a different group through a different repertoire -- Indigo (1859-60) targeted European planters through collective crop refusal; Pabna (from 1873) targeted zamindars through leagues and litigation; the Deccan riots (1875) targeted moneylenders through direct debt-bond destruction -- and must not be treated as one undifferentiated movement**
...
A. Neither Naoroji nor Dutt wrote any book on Indian economic history
...
C. Ranade, not Naoroji or Dutt, wrote both books

D. The statement is correct as written

**Answer: B. The authorship is reversed: Dadabhai Naoroji wrote Poverty and Un-British Rule in India, while Romesh Chunder Dutt wrote Economic History of India; Ranade is named separately for his economic-policy critique within the Moderate tradition**
...
B. Neither system had any defined assessment unit
...
D. The statement is correct; both systems used an identical unit

**Answer: C. Mahalwari's assessment unit was the village or mahal, with joint/collective liability, not the individual cultivator; Ryotwari alone settled directly and individually with each ryot**
...
**Answer: D. The Permanent Settlement was introduced by Lord Cornwallis in 1793, chiefly in Bengal, Bihar and Orissa; Thomas Munro is instead associated with the Ryotwari system in Madras**
...
B. The Diwani grant has no connection to this topic at all

C. Topic 04 and this topic have no defined boundary

D. This topic should repeat Topic 04's full content in detail

**Answer: A. Topic 04 owns the Diwani grant and Dual Government mechanics in full; this topic (07) uses that episode only as the historical trigger for the land-revenue system and the drain's own origin, without re-deriving its detailed mechanics -- a student should consult Topic 04 for that detail, not expect it repeated here**
...
A. Topic 14 has no connection whatsoever to the drain argument
...
D. The statement is correct; this topic owns that full political history

**Answer: B. This topic names Naoroji, R.C. Dutt and Ranade only for their economic arguments (the drain mechanism and industrial-policy critique); the fuller political-organisational history of the Moderate movement and its political deployment of the drain argument is bounded to Topic 14's ownership**
...
A. The Bengal famine of 1770 never occurred
...
D. The statement is correct; 1770 is this topic's own primary case

**Answer: C. The Bengal famine of 1770 is explicitly bounded to Topic 04's ownership; this topic's own famine case sequence covers the 1860s/Orissa, 1876-78, 1896-1900 and 1943 as a later bounded culmination, referencing 1770 only as background, not as a fully analysed case here**
...
A. Revisionist scholarship should be excluded from this topic entirely

B. Only the nationalist position should be taught, with no reference to revisionist scholarship

C. The statement is correct; revisionist scholarship fully disproves both processes
...
**Answer: D. Revisionist/quantitative scholarship (Morris D. Morris; Daniel Thorner on census evidence) genuinely questions the precise scale and measurement of deindustrialisation, a real and fairly represented historiographical debate about magnitude; this topic explicitly states that this debate must not be used to deny that structural extraction and real (if regionally uneven) deindustrialisation occurred at all -- the dispute concerns "how much," not "whether"**
...
![Visual 26: Answer spine, 10 marks](C:\Users\pulkitkundra\Downloads\pk-workspace\upsc-agent\notes\Modern-Indian-History\assets\07_Economic-Impact-of-British-Rule\26_26_answer_spine_10mark.png)
...
![Visual 27: Answer spine, 15 marks](C:\Users\pulkitkundra\Downloads\pk-workspace\upsc-agent\notes\Modern-Indian-History\assets\07_Economic-Impact-of-British-Rule\27_27_answer_spine_15mark.png)
...
![Visual 28: Answer spine, 20 marks](C:\Users\pulkitkundra\Downloads\pk-workspace\upsc-agent\notes\Modern-Indian-History\assets\07_Economic-Impact-of-British-Rule\28_28_answer_spine_20mark.png)
