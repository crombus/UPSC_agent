...
```closure-flow
START / CONCEPT: Migration definition and data rule
EXACT TERMS: Migration | definition | data | rule
MECHANISM / ARGUMENT: connect Migration definition through process, place and time
CONSEQUENCE / CONTRAST: Open with the residence concept before using census or survey migration numbers.
UPSC TRAP / ANSWER-USE: Definition by usual residence matters before any analysis begins.
ANSWER-GRABBING FORMULATION: Migration definition and data rule converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: Push and pull factors
EXACT TERMS: Push | pull | factors | Push-pull | logic
MECHANISM / ARGUMENT: connect Push-pull logic through process, place and time
CONSEQUENCE / CONTRAST: Use distress and opportunity in one causal frame.
UPSC TRAP / ANSWER-USE: Push and pull operate together, not in isolation.
ANSWER-GRABBING FORMULATION: Push and pull factors converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: Ravenstein and short-distance logic
EXACT TERMS: Ravenstein | short-distance | logic | laws | Distance-decay | principle
MECHANISM / ARGUMENT: connect Ravenstein laws and Distance-decay principle through process, place and time
CONSEQUENCE / CONTRAST: Explain distance-decay, short moves and counter-streams together.
UPSC TRAP / ANSWER-USE: Ravenstein is a heuristic, not an iron law.
ANSWER-GRABBING FORMULATION: Ravenstein and short-distance logic converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: Lee framework and selectivity
EXACT TERMS: framework | selectivity | classification | causation | comparison | qualification
MECHANISM / ARGUMENT: connect Lee framework through process, place and time
CONSEQUENCE / CONTRAST: Convert a migration answer into a diagram with origin, destination and obstacles.
UPSC TRAP / ANSWER-USE: Do not forget intervening obstacles and personal selectivity.
ANSWER-GRABBING FORMULATION: Lee framework and selectivity converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: Step migration chain
EXACT TERMS: Step | migration | chain | classification | causation | comparison
MECHANISM / ARGUMENT: connect Step migration chain through process, place and time
CONSEQUENCE / CONTRAST: Use village-town-city-metropolis as the classic sequence.
UPSC TRAP / ANSWER-USE: Urbanisation often builds through stages, not one leap.
ANSWER-GRABBING FORMULATION: Step migration chain converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: Circular and seasonal migration
EXACT TERMS: Circular | seasonal | migration | classification | causation | comparison
MECHANISM / ARGUMENT: connect Circular and seasonal migration through process, place and time
CONSEQUENCE / CONTRAST: Use it to explain precarity, construction labour and welfare-portability issues.
UPSC TRAP / ANSWER-USE: Circular migration is mobility without final permanent settlement.
ANSWER-GRABBING FORMULATION: Circular and seasonal migration converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: Migration stream classification
EXACT TERMS: Migration | stream | classification | classification | causation | comparison
MECHANISM / ARGUMENT: connect Stream classification through process, place and time
CONSEQUENCE / CONTRAST: List rural-rural, rural-urban, urban-urban and urban-rural cleanly.
UPSC TRAP / ANSWER-USE: Separate administrative distance from rural-urban character.
ANSWER-GRABBING FORMULATION: Migration stream classification converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: Rural-rural and marriage migration
EXACT TERMS: Rural-rural | marriage | migration | dominance
MECHANISM / ARGUMENT: connect Rural-rural dominance and Marriage migration dominance through process, place and time
CONSEQUENCE / CONTRAST: Explain why marriage keeps rural-rural migration large in India.
UPSC TRAP / ANSWER-USE: Recorded migration totals are not identical to labour migration totals.
ANSWER-GRABBING FORMULATION: Rural-rural and marriage migration converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: Rural-urban and urbanisation
EXACT TERMS: Rural-urban | urbanisation | link | classification | causation | comparison
MECHANISM / ARGUMENT: connect Rural-urban urbanisation link through process, place and time
CONSEQUENCE / CONTRAST: Show why rural-urban flow remains the urban-growth stream.
UPSC TRAP / ANSWER-USE: Do not let marriage migration erase labour migration.
ANSWER-GRABBING FORMULATION: Rural-urban and urbanisation converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: Source and destination effects
EXACT TERMS: destination | effects | Source-destination | classification | causation | comparison
MECHANISM / ARGUMENT: connect Source-destination effects through process, place and time
CONSEQUENCE / CONTRAST: Balance remittances, labour gains, congestion and slum pressure together.
UPSC TRAP / ANSWER-USE: One-sided answers on cities or villages alone stay incomplete.
ANSWER-GRABBING FORMULATION: Source and destination effects converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: India's differentiated mobility
EXACT TERMS: India's | differentiated | mobility | classification | causation | comparison
MECHANISM / ARGUMENT: connect India's differentiated mobility through process, place and time
CONSEQUENCE / CONTRAST: Use this as the transition sentence from theory to India.
UPSC TRAP / ANSWER-USE: India is less mobile than some Western societies but highly varied internally.
ANSWER-GRABBING FORMULATION: India's differentiated mobility converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: MoSPI 2020-21 headline figures
EXACT TERMS: MoSPI | headline | figures | all-India | migration | rate
MECHANISM / ARGUMENT: connect MoSPI all-India migration rate and Rural and urban migration rates through process, place and time
CONSEQUENCE / CONTRAST: Quote all-India, rural and urban migration rates together.
UPSC TRAP / ANSWER-USE: Survey figures need the source and year label.
ANSWER-GRABBING FORMULATION: MoSPI 2020-21 headline figures converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: Intrastate versus interstate
EXACT TERMS: Intrastate | versus | interstate | classification | causation | comparison
MECHANISM / ARGUMENT: connect Intrastate versus interstate through process, place and time
CONSEQUENCE / CONTRAST: Use intrastate majority as the safest prelims firewall.
UPSC TRAP / ANSWER-USE: Interstate migration is not the dominant share in India.
ANSWER-GRABBING FORMULATION: Intrastate versus interstate converts physical process into a qualified spatial argument
```
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Do not describe migration as random movement across the map. — and conclude: Map agrarian sending regions against industrial and service corridors.
...
```closure-flow
START / CONCEPT: Net gainers and sending regions
EXACT TERMS: gainers | sending | regions | senders | Corridor | logic
MECHANISM / ARGUMENT: connect Net gainers and senders and Corridor logic through process, place and time
CONSEQUENCE / CONTRAST: Map agrarian sending regions against industrial and service corridors.
UPSC TRAP / ANSWER-USE: Do not describe migration as random movement across the map.
ANSWER-GRABBING FORMULATION: Net gainers and sending regions converts physical process into a qualified spatial argument
```
...
```closure-flow
START / CONCEPT: Remittances, undercount and urban stress
EXACT TERMS: Remittances | undercount | urban | stress | Remittance | labour
MECHANISM / ARGUMENT: connect Remittance and labour restructuring and Circular undercount and urban stress through process, place and time
CONSEQUENCE / CONTRAST: Conclude with remittances, undercount and welfare-portability pressure.
UPSC TRAP / ANSWER-USE: Migration supports households but also exposes data and service-delivery gaps.
ANSWER-GRABBING FORMULATION: Remittances, undercount and urban stress converts physical process into a qualified spatial argument
```
