---
title: "Geography 02 — The Earth’s Crust, Rocks / India Geological Structure"
topic_key: "geography-02"
variant: "learner-v2"
generation: 2
generation_date: "2026-08-22"
cover_image: "../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/01_master-roadmap.png"
---
...
![Master two-half roadmap](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/01_master-roadmap.png)
...
```closure-flow
SUBTOPIC: Source audit, syllabus ownership and evidence firewall
KEY TERMS / DEFINITIONS: Each half is taught independently and then connected through structure → process → surface consequences.
MECHANISM / ARGUMENT: Each half is taught independently and then connected through structure → process → surface consequences.
CONSEQUENCE / CONTRAST: GSI’s current official role is therefore used only through live primary releases.
UPSC TRAP / ANSWER-USE: Qdrant: not required; repository Markdown, OCR pages and primary sources were sufficient.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 2. Master vocabulary: what exactly are we studying?

**Classification: CORE PRELIMS + CORE MAINS**

![Scope terms](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/02_scope-terms.png)
...
```closure-flow
SUBTOPIC: Master vocabulary: what exactly are we studying?
KEY TERMS / DEFINITIONS: A rock aggregate is therefore not “a mineral”, and a landform cannot be inferred from a rock name alone.
MECHANISM / ARGUMENT: [ANALYSIS] Structure → process → surface: lithology, bedding, joints, faults and tectonic setting create a template; weathering, rivers, glaciers, waves and human use modify it.
...
### 3. Crust and lithosphere: related, not identical

**Classification: CORE PRELIMS + SUPPORTING MAINS**

![Crust and lithosphere](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/03_crust-lithosphere.png)
...
```closure-flow
SUBTOPIC: Crust and lithosphere: related, not identical
KEY TERMS / DEFINITIONS: Crust is compositional; lithosphere is mechanical and includes the crust plus rigid uppermost mantle.
...
### 4. The complete rock cycle: a network, not a conveyor belt

**Classification: CORE PRELIMS + CORE MAINS**

![Complete rock cycle](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/04_complete-rock-cycle.png)
...
```closure-flow
SUBTOPIC: The complete rock cycle: a network, not a conveyor belt
KEY TERMS / DEFINITIONS: Lithification means turning loose sediment into rock through compaction and cementation.
...
UPSC TRAP / ANSWER-USE: [TRAP] “Igneous → sedimentary → metamorphic” is one teaching path, not the only path.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 5. Igneous rocks: cooling history, composition and texture

**Classification: CORE PRELIMS + CORE MAINS**

![Igneous texture and composition tree](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/05_igneous-tree.png)
...
```closure-flow
SUBTOPIC: Igneous rocks: cooling history, composition and texture
KEY TERMS / DEFINITIONS: Porphyritic means large crystals embedded in a finer groundmass, showing two-stage cooling.
...
### 6. Sedimentary rocks: sediment pathway and field clues

**Classification: CORE PRELIMS + CORE MAINS**

![Sedimentary formation](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/06_sedimentary-process.png)
...
```closure-flow
SUBTOPIC: Sedimentary rocks: sediment pathway and field clues
KEY TERMS / DEFINITIONS: Bedding/stratification means depositional layering.
MECHANISM / ARGUMENT: ANSWER-GRABBING LINE — WRITE/ADAPT IN THE EXAM Sedimentary rocks convert weathered, transported or chemically and biologically produced material into layered rock through deposition, compaction and cementation, while preserving clues such as fossils, ripples and mud cracks.
...
### 7. Metamorphic rocks: protolith, grade and fabric

**Classification: CORE PRELIMS + CORE MAINS**

![Metamorphic grade and fabric](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/07_metamorphic-path.png)
...
```closure-flow
SUBTOPIC: Metamorphic rocks: protolith, grade and fabric
KEY TERMS / DEFINITIONS: Protolith means the parent rock before metamorphism.
MECHANISM / ARGUMENT: ANSWER-GRABBING LINE — WRITE/ADAPT IN THE EXAM Metamorphism changes a protolith in the solid state through heat, pressure, differential stress and reactive fluids, producing new minerals and fabrics without requiring complete melting.
...
### 8. Rock properties and applied geography

**Classification: CORE PRELIMS + CORE MAINS**

![Rock properties and applications](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/08_properties-applications.png)
...
```closure-flow
SUBTOPIC: Rock properties and applied geography
KEY TERMS / DEFINITIONS: Crystalline igneous and metamorphic rocks commonly have low primary pore space but can store groundwater in weathered zones, joints and fractures.
...
### 9. Continental drift: Wegener’s evidence and limitation

**Classification: CORE PRELIMS + CORE MAINS**

![Drift evidence](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/09_drift-evidence.png)
...
```closure-flow
SUBTOPIC: Continental drift: Wegener’s evidence and limitation
KEY TERMS / DEFINITIONS: Gondwana here means a southern palaeocontinent.
...
### 10. Sea-floor spreading: oceanic evidence and mass balance

**Classification: CORE PRELIMS + CORE MAINS**

![Sea-floor spreading](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/10_seafloor-spreading.png)
...
```closure-flow
SUBTOPIC: Sea-floor spreading: oceanic evidence and mass balance
KEY TERMS / DEFINITIONS: Ocean floor is geologically young relative to continental shields because it is recycled.
...
UPSC TRAP / ANSWER-USE: [TRAP] The Earth does not expand; ridge creation is balanced by trench destruction.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 11. Plate tectonics: boundary matrix and landform diagnosis

**Classification: CORE PRELIMS + CORE MAINS**

![Plate-boundary matrix](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/10b_plate-boundaries.png)
...
```closure-flow
SUBTOPIC: Plate tectonics: boundary matrix and landform diagnosis
KEY TERMS / DEFINITIONS: Plate-interior activity occurs at inherited faults, rifts, hot spots and intraplate stress concentrations; boundaries explain global clustering, not every event.
MECHANISM / ARGUMENT: ANSWER-GRABBING LINE — WRITE/ADAPT IN THE EXAM Plate boundaries are diagnosed by motion and products: divergence creates crust, subduction destroys oceanic crust, continent collision thickens crust, and transform motion conserves crust while generating shallow earthquakes.
...
### 12. Ocean-basin evolution: Wilson-cycle analogy

**Classification: CORE MAINS + SUPPORTING PRELIMS**

![Wilson-cycle analogy](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/11_wilson-cycle.png)
...
```closure-flow
SUBTOPIC: Ocean-basin evolution: Wilson-cycle analogy
KEY TERMS / DEFINITIONS: Active margins carry trenches, arcs, major earthquakes and volcanism.
...
### 13. Isostasy and orogeny

**Classification: CORE MAINS + SUPPORTING PRELIMS**

![Isostasy and orogeny](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/11b_isostasy-orogeny.png)
...
```closure-flow
SUBTOPIC: Isostasy and orogeny
KEY TERMS / DEFINITIONS: Isostasy means buoyant vertical equilibrium between crust/lithosphere and denser material beneath.
...
### 14. World-to-India transition: structure expressed as relief
...
```closure-flow
SUBTOPIC: World-to-India transition: structure expressed as relief
KEY TERMS / DEFINITIONS: [ANALYSIS] Structure controls broad relief and resource opportunity, while climate, weathering, rivers and human use modify it.
...
ANSWER-GRABBING FORMULATION: [ANALYSIS] Structure controls broad relief and resource opportunity, while climate, weathering, rivers and human use modify it.
```

### 15. Scope: geological structure versus physiography and geomorphology

**Classification: CORE PRELIMS + CORE MAINS**

![Three-province national skeleton](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/14_three-province-cross-section.png)
...
```closure-flow
SUBTOPIC: Scope: geological structure versus physiography and geomorphology
KEY TERMS / DEFINITIONS: [FACT] Geological structure means the age, lithology, stratigraphic order, folds, faults, joints, basins, cratons and plate-tectonic relations of rocks beneath a region.
...
UPSC TRAP / ANSWER-USE: [ANALYSIS] The three are linked but not interchangeable.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 16. Geological time, evidence and dating cautions

**Classification: CORE PRELIMS + CORE MAINS**

![Geological evidence ladder](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/12_geological-evidence-ladder.png)
...
```closure-flow
SUBTOPIC: Geological time, evidence and dating cautions
KEY TERMS / DEFINITIONS: [FACT] India's geological record spans ancient crystalline basement, Proterozoic basins, Gondwana continental successions, Mesozoic marine and volcanic episodes, Cenozoic collision-related strata and Quaternary alluvium.
MECHANISM / ARGUMENT: Correct: Usage varies by author and stratigraphic convention.
CONSEQUENCE / CONTRAST: [FACT] Relative dating uses superposition, cross-cutting relations, unconformities, fossils and correlation.
UPSC TRAP / ANSWER-USE: [FACT] Stratigraphy is not merely a rock-name list.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 17. Indian plate: Gondwana origin, break-up, drift and collision

**Classification: CORE PRELIMS + CORE MAINS**

![Indian plate journey](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/13_indian-plate-journey.png)
...
```closure-flow
SUBTOPIC: Indian plate: Gondwana origin, break-up, drift and collision
KEY TERMS / DEFINITIONS: [FACT] The Indian continental block formed part of Gondwana.
MECHANISM / ARGUMENT: [FACT] Sea-floor spreading creates oceanic lithosphere at ridges; subduction consumes it at trenches.
CONSEQUENCE / CONTRAST: [ANALYSIS] India is both an ancient continental fragment and part of an active plate system: this explains the contrast between old shield rocks and young Himalayan tectonic architecture.
UPSC TRAP / ANSWER-USE: [ANALYSIS] Collision was not a single instant across the whole margin.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 18. Cratons, shields and the stabilised Peninsular block

**Classification: CORE PRELIMS + CORE MAINS**

![Peninsular cratons and mobile belts](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/15_craton-mobile-belt-map.png)
...
```closure-flow
SUBTOPIC: Cratons, shields and the stabilised Peninsular block
KEY TERMS / DEFINITIONS: [FACT] Peninsular India is a mosaic of ancient cratonic nuclei and intervening mobile belts, later cut by faults, rifts and dykes and locally covered by younger sediments and basalt.
MECHANISM / ARGUMENT: [FACT] Peninsular India is a mosaic of ancient cratonic nuclei and intervening mobile belts, later cut by faults, rifts and dykes and locally covered by younger sediments and basalt.
CONSEQUENCE / CONTRAST: [FACT] Peninsular India is a mosaic of ancient cratonic nuclei and intervening mobile belts, later cut by faults, rifts and dykes and locally covered by younger sediments and basalt.
UPSC TRAP / ANSWER-USE: It does not mean flat, homogeneous, immobile or earthquake-free.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 19. Archaean and Dharwar systems: distribution and terminology control

**Classification: CORE PRELIMS + CORE MAINS**

![Archaean and Dharwar sequence](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/16_archaean-purana-sequence.png)
...
```closure-flow
SUBTOPIC: Archaean and Dharwar systems: distribution and terminology control
KEY TERMS / DEFINITIONS: [FACT] Older Indian geography texts distinguish fundamental gneiss-granite basement from Dharwar supracrustal and metamorphosed sediment-volcanic belts.
MECHANISM / ARGUMENT: [FACT] These belts contain schists, quartzites, iron formations, metavolcanics and associated intrusions; exact stratigraphic grouping varies by geological province.
CONSEQUENCE / CONTRAST: Mains use: [ANALYSIS] In a classification answer, give lithology, structure, distribution, significance and a terminology caution.
UPSC TRAP / ANSWER-USE: Modern geological usage is more refined, so the terms must not be collapsed.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 20. Proterozoic Purana basins: Cuddapah and Vindhyan

**Classification: CORE PRELIMS + CORE MAINS**

![Purana basin sequence](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/16_archaean-purana-sequence.png)
...
```closure-flow
SUBTOPIC: Proterozoic Purana basins: Cuddapah and Vindhyan
KEY TERMS / DEFINITIONS: [FACT] Cuddapah and Vindhyan are major Proterozoic sedimentary basin successions resting unconformably on older basement.
MECHANISM / ARGUMENT: [FACT] Vindhyan rocks form an extensive central Indian succession from eastern Rajasthan through Madhya Pradesh toward the Son valley, with other basin occurrences.
...
UPSC TRAP / ANSWER-USE: [ANALYSIS] Basin thickness and repeated unconformities show episodic subsidence and tectonic reorganisation rather than one uninterrupted quiet deposit.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 21. Gondwana Supergroup: rift basins, coal and continental sedimentation

**Classification: CORE PRELIMS + CORE MAINS**

![Gondwana rift basins](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/17_gondwana-basins.png)
...
```closure-flow
SUBTOPIC: Gondwana Supergroup: rift basins, coal and continental sedimentation
KEY TERMS / DEFINITIONS: [FACT] India's Gondwana successions accumulated mainly in fault-bounded continental basins within the Peninsular shield.
MECHANISM / ARGUMENT: [FACT] Lower parts of the succession include glacially influenced deposits in some basins, followed by coal-bearing sandstone-shale cycles and younger continental strata.
CONSEQUENCE / CONTRAST: They are distinct from Gondwana the palaeocontinent.
UPSC TRAP / ANSWER-USE: [LIMIT] Gondwana coalfields are not simply surface strips along modern rivers.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 22. Marine sedimentary basins, coasts and offshore petroleum logic

**Classification: CORE PRELIMS + CORE MAINS**

![Petroleum-system logic](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/18_petroleum-system.png)
...
```closure-flow
SUBTOPIC: Marine sedimentary basins, coasts and offshore petroleum logic
KEY TERMS / DEFINITIONS: [FACT] India also preserves marine sedimentary records in Kachchh, Rajasthan, Himalayan Tethyan sectors, east-coast basins and younger coastal/offshore basins.
MECHANISM / ARGUMENT: [ANALYSIS] Petroleum requires an effective source rock, burial and maturation, migration, porous reservoir, seal and trap.
CONSEQUENCE / CONTRAST: [ANALYSIS] Petroleum requires an effective source rock, burial and maturation, migration, porous reservoir, seal and trap.
UPSC TRAP / ANSWER-USE: [ANALYSIS] Petroleum requires an effective source rock, burial and maturation, migration, porous reservoir, seal and trap.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 23. Deccan Trap: flood-basalt province and bounded surface linkages

**Classification: CORE PRELIMS + CORE MAINS**

![Deccan Trap cross-section](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/19_deccan-trap-section.png)
...
```closure-flow
SUBTOPIC: Deccan Trap: flood-basalt province and bounded surface linkages
KEY TERMS / DEFINITIONS: [FACT] The Deccan Trap is a vast flood-basalt province built by repeated, mainly fissure-fed lava flows around the end-Cretaceous to earliest Cenozoic transition.
MECHANISM / ARGUMENT: [FACT] The Deccan Trap is a vast flood-basalt province built by repeated, mainly fissure-fed lava flows around the end-Cretaceous to earliest Cenozoic transition.
CONSEQUENCE / CONTRAST: [LIMIT] The cause, duration and environmental effects of Deccan volcanism remain active research fields.
UPSC TRAP / ANSWER-USE: [FACT] The Deccan Trap is a vast flood-basalt province built by repeated, mainly fissure-fed lava flows around the end-Cretaceous to earliest Cenozoic transition.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 24. Himalaya: from geosynclinal language to modern plate tectonics

**Classification: CORE PRELIMS + CORE MAINS**

![Himalayan structural order](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/20_himalayan-thrust-section.png)
...
```closure-flow
SUBTOPIC: Himalaya: from geosynclinal language to modern plate tectonics
KEY TERMS / DEFINITIONS: [FACT] Older texts describe Tethyan sediment accumulation in a geosyncline followed by folding.
MECHANISM / ARGUMENT: [FACT] Older texts describe Tethyan sediment accumulation in a geosyncline followed by folding.
CONSEQUENCE / CONTRAST: Mains use: [ANALYSIS] Contrast the historical geosynclinal description with the modern plate-tectonic mechanism; then draw a labelled cross-section.
UPSC TRAP / ANSWER-USE: [ANALYSIS] 'Geosyncline' can be retained as a historical descriptive term for a long subsiding sedimentary belt, but not as a self-sufficient causal theory.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 25. Indo-Ganga-Brahmaputra foreland basin and alluvial fill

**Classification: CORE PRELIMS + CORE MAINS**

![Foreland basin](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/21_foreland-plain.png)
...
```closure-flow
SUBTOPIC: Indo-Ganga-Brahmaputra foreland basin and alluvial fill
KEY TERMS / DEFINITIONS: [FACT] The Northern Plain occupies a foreland depression between the Himalayan orogen and Peninsular basement, filled by large volumes of Cenozoic and Quaternary sediment.
MECHANISM / ARGUMENT: [FACT] The Northern Plain occupies a foreland depression between the Himalayan orogen and Peninsular basement, filled by large volumes of Cenozoic and Quaternary sediment.
CONSEQUENCE / CONTRAST: Cross-link: Topic 05 drainage; Topic 04 groundwater; Topic 03 earthquake effects.
UPSC TRAP / ANSWER-USE: [LIMIT] The plain is not one uniform layer or one age.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 26. Coasts, offshore basins and island-arc versus coral-island distinction

**Classification: CORE PRELIMS + CORE MAINS**

![Coasts and islands](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/22_coasts-islands.png)
...
```closure-flow
SUBTOPIC: Coasts, offshore basins and island-arc versus coral-island distinction
KEY TERMS / DEFINITIONS: [FACT] India's coasts record rifting, passive-margin subsidence, sedimentation, faulting, volcanism and sea-level change.
MECHANISM / ARGUMENT: ANSWER-GRABBING LINE — WRITE/ADAPT IN THE EXAM Andaman-Nicobar belongs to an active subduction-related arc-forearc system, whereas Lakshadweep consists of coral atolls on a submarine volcanic-ridge foundation; Indian island geology is therefore not uniform.
...
### 27. Major lineaments, faults and rifts

**Classification: CORE PRELIMS + CORE MAINS**

![Faults and rifts](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/23_faults-rifts-lineaments.png)
...
```closure-flow
SUBTOPIC: Major lineaments, faults and rifts
KEY TERMS / DEFINITIONS: [FACT] Peninsular India contains major inherited structural corridors including the Narmada-Son lineament, Tapi trough, Cambay rift and the Godavari and Mahanadi basin systems.
MECHANISM / ARGUMENT: [FACT] Narmada and Tapi flow west through structurally controlled troughs.
CONSEQUENCE / CONTRAST: [FACT] The Narmada-Son structural zone crosses central India and is associated with faulting, rift-valley segments, basin development, magmatism and seismicity in different sectors.
UPSC TRAP / ANSWER-USE: Their valleys cannot be explained by regional eastward slope alone.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 28. Structural control of relief, drainage, groundwater and waterfalls

**Classification: CORE PRELIMS + CORE MAINS**

![Structure and surface applications](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/24_structure-applications.png)
...
```closure-flow
SUBTOPIC: Structural control of relief, drainage, groundwater and waterfalls
KEY TERMS / DEFINITIONS: [FACT] Resistant quartzite, granite, gneiss or basalt can form uplands and scarps, while weaker shale or weathered zones erode into valleys.
MECHANISM / ARGUMENT: Mains use: [ANALYSIS] Frame every example as structure -> process -> landform/water outcome -> local qualification.
...
### 29. Geology, minerals, coal and petroleum: association without determinism

**Classification: CORE PRELIMS + CORE MAINS**

![Geology and resources](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/24_structure-applications.png)
...
```closure-flow
SUBTOPIC: Geology, minerals, coal and petroleum: association without determinism
KEY TERMS / DEFINITIONS: [FACT] India's resource map reflects ancient shield mineralisation, Gondwana coal basins, sedimentary petroleum systems, coastal placers and weathering-derived ores.
MECHANISM / ARGUMENT: [FACT] Metallic ores such as iron, manganese, gold and base metals cluster in several ancient shield belts because of magmatic, hydrothermal, sedimentary and metamorphic histories.
CONSEQUENCE / CONTRAST: [FACT] Metallic ores such as iron, manganese, gold and base metals cluster in several ancient shield belts because of magmatic, hydrothermal, sedimentary and metamorphic histories.
UPSC TRAP / ANSWER-USE: It does not imply that all critical minerals lie in one geological province.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 30. Seismicity: Himalaya, Kachchh and peninsular intraplate events

**Classification: CORE PRELIMS + CORE MAINS**

![Bounded seismic application](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/24_structure-applications.png)
...
```closure-flow
SUBTOPIC: Seismicity: Himalaya, Kachchh and peninsular intraplate events
KEY TERMS / DEFINITIONS: [FACT] India's seismicity reflects active plate-boundary deformation in the Himalaya and north-east, subduction near Andaman-Nicobar, and intraplate reactivation in Kachchh and parts of the Peninsula.
MECHANISM / ARGUMENT: [LIMIT] Disaster response doctrine, building-code enforcement and preparedness are owned by Disaster Management; geology provides the source and site-condition framework.
CONSEQUENCE / CONTRAST: Mains use: [ANALYSIS] Explain source, path/site effect and vulnerability separately; do not equate tectonic activity with disaster magnitude.
UPSC TRAP / ANSWER-USE: [FACT] India's seismicity reflects active plate-boundary deformation in the Himalaya and north-east, subduction near Andaman-Nicobar, and intraplate reactivation in Kachchh and parts of the Peninsula.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 31. Regional comparisons, map skills and answer architecture

**Classification: CORE PRELIMS + CORE MAINS**

![Regional comparison and answer architecture](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/25_regional-ncmm-answer-spine.png)
...
```closure-flow
SUBTOPIC: Regional comparisons, map skills and answer architecture
KEY TERMS / DEFINITIONS: [ANALYSIS] Peninsula versus Himalaya: ancient composite shield with inherited structures versus active fold-thrust orogen; relative stability versus high convergence; exposed basement/mineral belts versus tectonic relief and sediment production.
MECHANISM / ARGUMENT: [FACT] Cross-sections show mechanism better than decorative maps.
CONSEQUENCE / CONTRAST: Mains use: [ANALYSIS] Use the spine: claim -> named geological evidence/region -> mechanism/significance -> limitation/qualification -> verdict.
UPSC TRAP / ANSWER-USE: [ANALYSIS] Gondwana basin versus Deccan Trap: fault-bounded continental sedimentary basin with coal measures versus extrusive flood-basalt province with stacked flows.
ANSWER-GRABBING FORMULATION: Classification: CORE PRELIMS + CORE MAINS
```

### 32. National Critical Mineral Mission: bounded current anchor

**Classification: CORE MAINS + CURRENT LINKAGE**

![NCMM bounded anchor and answer spine](../../../../../../notes/Geography/learning-session-v2/part-a-physical-geography/assets/geography-02/25_regional-ncmm-answer-spine.png)
...
```closure-flow
SUBTOPIC: National Critical Mineral Mission: bounded current anchor
KEY TERMS / DEFINITIONS: [FACT] The Union Cabinet approved NCMM on 29 January 2025.
...
CONSEQUENCE / CONTRAST: [FACT] The Union Cabinet approved NCMM on 29 January 2025.
UPSC TRAP / ANSWER-USE: [LIMIT] Mission targets cannot prove a deposit, grade, reserve or specific host rock.
