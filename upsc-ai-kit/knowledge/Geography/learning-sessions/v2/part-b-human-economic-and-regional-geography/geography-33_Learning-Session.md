...
**Plain-language definition:** Transport as the circulatory system of the economy explains how Transport as economic circulation shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, Transport as the circulatory system of the economy is the source-bounded relation among Transport as economic circulation, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Transport as the circulatory system of the economy must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Trade geography is inseparable from connectivity and cost. — and conclude: Open with movement of goods, labour, information and power before naming any mode.
...
```closure-flow
START / CONCEPT: Transport as the circulatory system of the economy
EXACT TERMS: Transport | circulatory | economy | economic | circulation
MECHANISM / ARGUMENT: connect Transport as economic circulation through process, place and time
CONSEQUENCE / CONTRAST: Open with movement of goods, labour, information and power before naming any mode.
UPSC TRAP / ANSWER-USE: Trade geography is inseparable from connectivity and cost.
ANSWER-GRABBING FORMULATION: Transport as the circulatory system of the economy converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** The six transport modes and their limits explains how Six modes and their limits shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, The six transport modes and their limits is the source-bounded relation among Six modes and their limits, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The six transport modes and their limits must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Every mode pairs a strength with a limitation. — and conclude: Set out modes as a suitability table rather than as an advantages list.
...
```closure-flow
START / CONCEPT: The six transport modes and their limits
EXACT TERMS: transport | modes | limits | classification | causation | comparison
MECHANISM / ARGUMENT: connect Six modes and their limits through process, place and time
CONSEQUENCE / CONTRAST: Set out modes as a suitability table rather than as an advantages list.
UPSC TRAP / ANSWER-USE: Every mode pairs a strength with a limitation.
ANSWER-GRABBING FORMULATION: The six transport modes and their limits converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Modal cost structure explains how Modal cost structure shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, Modal cost structure is the source-bounded relation among Modal cost structure, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Modal cost structure must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Terminal cost and per-kilometre cost behave differently. — and conclude: Explain cost as a structure so the comparison survives any cargo example.
...
```closure-flow
START / CONCEPT: Modal cost structure
EXACT TERMS: Modal | cost | structure | classification | causation | comparison
MECHANISM / ARGUMENT: connect Modal cost structure through process, place and time
CONSEQUENCE / CONTRAST: Explain cost as a structure so the comparison survives any cargo example.
UPSC TRAP / ANSWER-USE: Terminal cost and per-kilometre cost behave differently.
ANSWER-GRABBING FORMULATION: Modal cost structure converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Break-even distance and value density explains how Break-even and value density shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, Break-even distance and value density is the source-bounded relation among Break-even and value density, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Break-even distance and value density must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — The cheapest mode changes with haul length and value-to-weight ratio. — and conclude: Use break-even logic as the decisive rule in any modal-comparison answer.
...
```closure-flow
START / CONCEPT: Break-even distance and value density
EXACT TERMS: Break-even | distance | value | density
MECHANISM / ARGUMENT: connect Break-even and value density through process, place and time
CONSEQUENCE / CONTRAST: Use break-even logic as the decisive rule in any modal-comparison answer.
UPSC TRAP / ANSWER-USE: The cheapest mode changes with haul length and value-to-weight ratio.
ANSWER-GRABBING FORMULATION: Break-even distance and value density converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** The intermodal chain explains how Intermodal chain rule shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, The intermodal chain is the source-bounded relation among Intermodal chain rule, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The intermodal chain must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Freight is a chain, not a single modal choice. — and conclude: Shift the answer from modal tariffs to terminals and last-mile connectivity.
...
```closure-flow
START / CONCEPT: The intermodal chain
EXACT TERMS: intermodal | chain | rule | classification | causation | comparison
MECHANISM / ARGUMENT: connect Intermodal chain rule through process, place and time
CONSEQUENCE / CONTRAST: Shift the answer from modal tariffs to terminals and last-mile connectivity.
UPSC TRAP / ANSWER-USE: Freight is a chain, not a single modal choice.
ANSWER-GRABBING FORMULATION: The intermodal chain converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Reading a network: hinterland, node, corridor and break of bulk explains how Network vocabulary shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, Reading a network: hinterland, node, corridor and break of bulk is the source-bounded relation among Network vocabulary, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Reading a network: hinterland, node, corridor and break of bulk must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Break of bulk marks a cost step, not a mere transfer. — and conclude: Apply the network vocabulary to one continuous farm-to-market rail.
...
```closure-flow
START / CONCEPT: Reading a network: hinterland, node, corridor and break of bulk
EXACT TERMS: Reading | network | hinterland | node | corridor | break
MECHANISM / ARGUMENT: connect Network vocabulary through process, place and time
CONSEQUENCE / CONTRAST: Apply the network vocabulary to one continuous farm-to-market rail.
UPSC TRAP / ANSWER-USE: Break of bulk marks a cost step, not a mere transfer.
ANSWER-GRABBING FORMULATION: Reading a network: hinterland, node, corridor and break of bulk converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Port site versus port situation explains how Site versus situation shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, Port site versus port situation is the source-bounded relation among Site versus situation, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Port site versus port situation must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — An excellent site with a poor hinterland stays small. — and conclude: Separate the two terms explicitly before judging any port.
...
```closure-flow
START / CONCEPT: Port site versus port situation
EXACT TERMS: Port | site | versus | situation
MECHANISM / ARGUMENT: connect Site versus situation through process, place and time
CONSEQUENCE / CONTRAST: Separate the two terms explicitly before judging any port.
UPSC TRAP / ANSWER-USE: An excellent site with a poor hinterland stays small.
ANSWER-GRABBING FORMULATION: Port site versus port situation converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Why situation cannot be engineered explains how Site is engineerable, situation is not shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, Why situation cannot be engineered is the source-bounded relation among Site is engineerable, situation is not, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Why situation cannot be engineered must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Dredging corrects site; it cannot create a hinterland. — and conclude: Convert the distinction into a port policy conclusion about inland connectivity.
...
```closure-flow
START / CONCEPT: Why situation cannot be engineered
EXACT TERMS: situation | cannot | engineered | Site | engineerable
MECHANISM / ARGUMENT: connect Site is engineerable, situation is not through process, place and time
CONSEQUENCE / CONTRAST: Convert the distinction into a port policy conclusion about inland connectivity.
UPSC TRAP / ANSWER-USE: Dredging corrects site; it cannot create a hinterland.
ANSWER-GRABBING FORMULATION: Why situation cannot be engineered converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Hinterland competition between ports explains how Hinterland competition boundary shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, Hinterland competition between ports is the source-bounded relation among Hinterland competition boundary, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Hinterland competition between ports must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Hinterland boundaries move with freight rates, not with coastlines. — and conclude: Explain competing hinterlands before comparing two ports.
...
```closure-flow
START / CONCEPT: Hinterland competition between ports
EXACT TERMS: Hinterland | competition | between | ports
MECHANISM / ARGUMENT: connect Hinterland competition boundary through process, place and time
CONSEQUENCE / CONTRAST: Explain competing hinterlands before comparing two ports.
UPSC TRAP / ANSWER-USE: Hinterland boundaries move with freight rates, not with coastlines.
ANSWER-GRABBING FORMULATION: Hinterland competition between ports converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Containerisation and hub concentration explains how Containerisation and hub concentration shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, Containerisation and hub concentration is the source-bounded relation among Containerisation and hub concentration, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Containerisation and hub concentration must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Fewer ports handling more cargo is a hierarchy effect, not a statistic. — and conclude: Answer port-hierarchy questions with containerisation logic and no tonnage figures.
...
```closure-flow
START / CONCEPT: Containerisation and hub concentration
EXACT TERMS: Containerisation | concentration | classification | causation | comparison | qualification
MECHANISM / ARGUMENT: connect Containerisation and hub concentration through process, place and time
CONSEQUENCE / CONTRAST: Answer port-hierarchy questions with containerisation logic and no tonnage figures.
UPSC TRAP / ANSWER-USE: Fewer ports handling more cargo is a hierarchy effect, not a statistic.
ANSWER-GRABBING FORMULATION: Containerisation and hub concentration converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Chokepoints and route vulnerability explains how Chokepoint vulnerability shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, Chokepoints and route vulnerability is the source-bounded relation among Chokepoint vulnerability, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Chokepoints and route vulnerability must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — A chokepoint matters as route control, not as a water body. — and conclude: Show why disruption at a narrow passage becomes a global cost event.
...
```closure-flow
START / CONCEPT: Chokepoints and route vulnerability
EXACT TERMS: Chokepoints | route | vulnerability | Chokepoint
MECHANISM / ARGUMENT: connect Chokepoint vulnerability through process, place and time
CONSEQUENCE / CONTRAST: Show why disruption at a narrow passage becomes a global cost event.
UPSC TRAP / ANSWER-USE: A chokepoint matters as route control, not as a water body.
ANSWER-GRABBING FORMULATION: Chokepoints and route vulnerability converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** The two-way transport and development relation explains how Two-way transport-development relation shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, The two-way transport and development relation is the source-bounded relation among Two-way transport-development relation, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The two-way transport and development relation must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Density mirrors the economy as much as it creates it. — and conclude: State both directions before assessing any corridor programme.
...
```closure-flow
START / CONCEPT: The two-way transport and development relation
EXACT TERMS: two-way | transport | development | relation | transport-development
MECHANISM / ARGUMENT: connect Two-way transport-development relation through process, place and time
CONSEQUENCE / CONTRAST: State both directions before assessing any corridor programme.
UPSC TRAP / ANSWER-USE: Density mirrors the economy as much as it creates it.
ANSWER-GRABBING FORMULATION: The two-way transport and development relation converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Tunnel effect and backwash caveats explains how Tunnel and backwash caveats shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, Tunnel effect and backwash caveats is the source-bounded relation among Tunnel and backwash caveats, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Tunnel effect and backwash caveats must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — A corridor can cross a region without benefiting it. — and conclude: Add the distributional counterpoint that most infrastructure answers omit.
...
```closure-flow
START / CONCEPT: Tunnel effect and backwash caveats
EXACT TERMS: Tunnel | effect | backwash | caveats
MECHANISM / ARGUMENT: connect Tunnel and backwash caveats through process, place and time
CONSEQUENCE / CONTRAST: Add the distributional counterpoint that most infrastructure answers omit.
UPSC TRAP / ANSWER-USE: A corridor can cross a region without benefiting it.
ANSWER-GRABBING FORMULATION: Tunnel effect and backwash caveats converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** India's corridor and port programmes explains how India multimodal corridor programmes and India coastal trade contrast shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, India's corridor and port programmes is the source-bounded relation among India multimodal corridor programmes and India coastal trade contrast, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India's corridor and port programmes must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Corridor programmes redistribute accessibility rather than guarantee growth. — and conclude: Link Bharatmala, freight corridors and Sagarmala into one multimodal argument.
...
```closure-flow
START / CONCEPT: India's corridor and port programmes
EXACT TERMS: India's | corridor | port | programmes | multimodal | coastal
MECHANISM / ARGUMENT: connect India multimodal corridor programmes and India coastal trade contrast through process, place and time
CONSEQUENCE / CONTRAST: Link Bharatmala, freight corridors and Sagarmala into one multimodal argument.
UPSC TRAP / ANSWER-USE: Corridor programmes redistribute accessibility rather than guarantee growth.
ANSWER-GRABBING FORMULATION: India's corridor and port programmes converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Space as applied geography and the operational-orbit boundary explains how Space as observation instrument, Application-led space orientation, Space institutional ladder, GIS convergence rule and NVS-02 launch-versus-operations anchor shape the examinable geography of Transport, Trade and the Indian Space Programme.

**Technical definition:** In geographical analysis, Space as applied geography and the operational-orbit boundary is the source-bounded relation among Space as observation instrument, Application-led space orientation, Space institutional ladder, GIS convergence rule and NVS-02 launch-versus-operations anchor, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Space as applied geography and the operational-orbit boundary must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Launch success is not operational-constellation success. — and conclude: Close with observation, navigation and GIS integration under a dated operational caution.
...
```closure-flow
START / CONCEPT: Space as applied geography and the operational-orbit boundary
EXACT TERMS: Space | applied | operational-orbit | observation | instrument | Application-led
MECHANISM / ARGUMENT: connect Space as observation instrument, Application-led space orientation, Space institutional ladder, GIS convergence rule and NVS-02 launch-versus-operations anchor through process, place and time
CONSEQUENCE / CONTRAST: Close with observation, navigation and GIS integration under a dated operational caution.
UPSC TRAP / ANSWER-USE: Launch success is not operational-constellation success.
ANSWER-GRABBING FORMULATION: Space as applied geography and the operational-orbit boundary converts physical process into a qualified spatial argument
```
...
### Transport, Trade and the Indian Space Programme: PROCESS, FORM AND LOCATION LEDGER

1. **Transport as economic circulation:** Transport is the circulatory system of an economy because it moves raw materials, labour, finished goods, information and strategic power across space, and trade geography grows out of connectivity, cost, time and chokepoints.
2. **Six modes and their limits:** Road, rail, sea, inland waterway, air and pipeline each pair a distinct strength with a distinct limitation, so no mode is best in general and air is not best for bulk merely because it is fastest.
3. **Modal cost structure:** Road has low terminal cost and high cost per kilometre, rail has higher terminal and lower per-kilometre cost, water has the highest terminal and lowest per-kilometre cost, air is expensive throughout, and pipeline has very high fixed with very low operating cost.
4. **Break-even and value density:** The cheapest mode is the one whose terminal cost is recovered over the haul length involved, so the road-rail break-even distance and the value-to-weight ratio together decide modal choice.
5. **Intermodal chain rule:** Modern freight is a chain of road collection, rail or water trunk haul and road distribution, so container handling, multimodal terminals and last-mile connectivity determine actual logistics cost more than headline modal tariffs.
6. **Network vocabulary:** Hinterland, node, corridor, break of bulk and hub-and-spoke are the standard concepts for reading any transport network from mine or farm through roadhead and rail corridor to port and world market.
7. **Site versus situation:** A port's site is its own physical setting of depth, shelter, tidal range, foreshore, expansion land and siltation risk, while its situation is its position relative to a hinterland and to shipping routes, and situation normally decides which ports grow.
8. **Site is engineerable, situation is not:** Depth and shelter can be dredged and engineered while hinterland productivity and connectivity cannot, which makes dedicated freight corridors and inland container depots a port policy instrument rather than a merely transport one.
9. **Hinterland competition boundary:** Two ports serving the same interior compete, and the boundary between their hinterlands shifts with rail freight rates, road quality and inland container facilities.
10. **Containerisation and hub concentration:** Containerisation standardised the cargo unit, collapsed handling time and cost, made intermodal transfer routine, permitted fragmentation of production across countries, and concentrated traffic at fewer deep-draught, high-crane-productivity, well-connected hubs with feeder services.
11. **Chokepoint vulnerability:** Canals and straits matter because they shorten or control routes, so a disruption at one narrow passage lengthens voyages and raises freight and insurance costs far beyond the affected region.
12. **Two-way transport-development relation:** Transport lowers input and output costs and widens markets, while development generates the traffic that justifies investment, so network density mirrors economic geography as much as it creates it.
13. **Tunnel and backwash caveats:** A corridor can pass through a region without benefiting it when there are no junctions, no local loading and no complementary investment, and better connectivity can also expose weak local producers to outside competition and accelerate out-migration of the young and skilled.
14. **India multimodal corridor programmes:** Bharatmala builds economic corridors, inter-corridors, border and port connectivity, Dedicated Freight Corridors separate freight from passenger congestion, Sagarmala pursues port modernisation with port-led industrialisation, and PM Gati Shakti replaces mode-wise planning with network integration.
15. **India coastal trade contrast:** India's trade is coast-oriented but hinterland-dependent, with the western seaboard acting as the gateway for container and petroleum flows and the eastern coast tied to bulk minerals, coal, fertilizers and East Asian links.
16. **Space as observation instrument:** Satellite systems are the primary observation instrument of modern geography, supplying land-use and land-cover mapping, crop acreage and condition assessment, forest and water-body monitoring, glacier and coastline change detection, and cyclone and monsoon tracking for warning systems.
17. **Application-led space orientation:** India's space programme has been organised around application in communication, meteorology, resource survey, navigation, education and disaster support rather than around prestige, and that orientation is what makes it a geography topic rather than a technology one.
18. **Space institutional ladder:** ISRO, the Satish Dhawan Space Centre at Sriharikota with its east-coast over-sea launch safety advantage, URSC, VSSC and LPSC, NSIL for commercialisation, IN-SPACe for non-governmental participation and NavIC for indigenous navigation form India's space-geography institutional ladder.
19. **GIS convergence rule:** Remote-sensing imagery becomes usable planning information only when combined in a geographic information system with terrain, infrastructure, administrative and socio-economic layers, which is what supports site selection, corridor alignment, watershed and command-area planning and disaster damage assessment.
20. **NVS-02 launch-versus-operations anchor:** GSLV-F15 placed NVS-02 in transfer orbit on 29 January 2025, but its orbit-raising propulsion could not be used and the satellite did not enter its intended NavIC slot, which shows that launch success and operational-constellation success are not identical.

### Transport, Trade and the Indian Space Programme: CLOSE-OPTION FIREWALLS
...
### Transport, Trade and the Indian Space Programme: MAP-AND-ANSWER SPINE
...
### Transport, Trade and the Indian Space Programme: VERIFIED CURRENT-LINK BOUNDARY

The only dated current anchor used is the GSLV-F15 flight of 29 January 2025, which placed NVS-02 in transfer orbit while the orbit-raising propulsion could not be used, so the satellite did not enter its intended NavIC slot. That status is recorded in the repository owner and was confirmed against the official ISRO mission page. Ministry, Sagarmala and PIB portals are named only as the correct source class for corridor, port and space updates. No port tonnage, container throughput, highway or railway length, freight share, satellite count or programme outlay is quoted from memory, and no launch is presented as an operational-constellation outcome.
