...
**Plain-language definition:** The core vocabulary of political geography explains how Core political-geography vocabulary shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, The core vocabulary of political geography is the source-bounded relation among Core political-geography vocabulary, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The core vocabulary of political geography must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — A frontier is a zone while a boundary is a line. — and conclude: Define all five terms before naming any place or dispute.
...
```closure-flow
START / CONCEPT: The core vocabulary of political geography
EXACT TERMS: core | vocabulary | political | political-geography
MECHANISM / ARGUMENT: connect Core political-geography vocabulary through process, place and time
CONSEQUENCE / CONTRAST: Define all five terms before naming any place or dispute.
UPSC TRAP / ANSWER-USE: A frontier is a zone while a boundary is a line.
ANSWER-GRABBING FORMULATION: The core vocabulary of political geography converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** How a boundary is made, stage by stage explains how Four stages of boundary making and Delimitation-demarcation gap shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, How a boundary is made, stage by stage is the source-bounded relation among Four stages of boundary making and Delimitation-demarcation gap, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> How a boundary is made, stage by stage must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Delimitation is on the map; demarcation is on the ground. — and conclude: Use the four-stage sequence to locate exactly where a dispute originates.
...
```closure-flow
START / CONCEPT: How a boundary is made, stage by stage
EXACT TERMS: made | stage | Four | stages | making | Delimitation-demarcation
MECHANISM / ARGUMENT: connect Four stages of boundary making and Delimitation-demarcation gap through process, place and time
CONSEQUENCE / CONTRAST: Use the four-stage sequence to locate exactly where a dispute originates.
UPSC TRAP / ANSWER-USE: Delimitation is on the map; demarcation is on the ground.
ANSWER-GRABBING FORMULATION: How a boundary is made, stage by stage converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Natural and geometric boundary types explains how Natural and geometric boundary types shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, Natural and geometric boundary types is the source-bounded relation among Natural and geometric boundary types, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Natural and geometric boundary types must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — A straight line is a political artefact, not a physical feature. — and conclude: Classify the line physically before judging its stability.
...
```closure-flow
START / CONCEPT: Natural and geometric boundary types
EXACT TERMS: Natural | geometric | types | classification | causation | comparison
MECHANISM / ARGUMENT: connect Natural and geometric boundary types through process, place and time
CONSEQUENCE / CONTRAST: Classify the line physically before judging its stability.
UPSC TRAP / ANSWER-USE: A straight line is a political artefact, not a physical feature.
ANSWER-GRABBING FORMULATION: Natural and geometric boundary types converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** The genetic classification and what it predicts explains how Genetic classification of boundaries shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, The genetic classification and what it predicts is the source-bounded relation among Genetic classification of boundaries, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The genetic classification and what it predicts must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Genesis timing predicts the dispute type that follows. — and conclude: Name antecedent, subsequent, superimposed or relict, then predict the friction.
...
```closure-flow
START / CONCEPT: The genetic classification and what it predicts
EXACT TERMS: genetic | classification | what | predicts | boundaries
MECHANISM / ARGUMENT: connect Genetic classification of boundaries through process, place and time
CONSEQUENCE / CONTRAST: Name antecedent, subsequent, superimposed or relict, then predict the friction.
UPSC TRAP / ANSWER-USE: Genesis timing predicts the dispute type that follows.
ANSWER-GRABBING FORMULATION: The genetic classification and what it predicts converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Frontier interaction against boundary sovereignty explains how Frontier as zone, boundary as line shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, Frontier interaction against boundary sovereignty is the source-bounded relation among Frontier as zone, boundary as line, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Frontier interaction against boundary sovereignty must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Converting a frontier into a boundary is itself a dispute origin. — and conclude: Answer interaction questions from frontier geography, not from the line.
...
```closure-flow
START / CONCEPT: Frontier interaction against boundary sovereignty
EXACT TERMS: Frontier | interaction | against | sovereignty | zone | line
MECHANISM / ARGUMENT: connect Frontier as zone, boundary as line through process, place and time
CONSEQUENCE / CONTRAST: Answer interaction questions from frontier geography, not from the line.
UPSC TRAP / ANSWER-USE: Converting a frontier into a boundary is itself a dispute origin.
ANSWER-GRABBING FORMULATION: Frontier interaction against boundary sovereignty converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** A typology of boundary-dispute causes explains how Typology of dispute causes shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, A typology of boundary-dispute causes is the source-bounded relation among Typology of dispute causes, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> A typology of boundary-dispute causes must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Positional, territorial and functional disputes need different remedies. — and conclude: Match the dispute mechanism to its remedy instead of listing disputed places.
...
```closure-flow
START / CONCEPT: A typology of boundary-dispute causes
EXACT TERMS: typology | boundary-dispute | causes | dispute
MECHANISM / ARGUMENT: connect Typology of dispute causes through process, place and time
CONSEQUENCE / CONTRAST: Match the dispute mechanism to its remedy instead of listing disputed places.
UPSC TRAP / ANSWER-USE: Positional, territorial and functional disputes need different remedies.
ANSWER-GRABBING FORMULATION: A typology of boundary-dispute causes converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Why no boundary type is intrinsically stable explains how Neither type is intrinsically stable shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, Why no boundary type is intrinsically stable is the source-bounded relation among Neither type is intrinsically stable, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Why no boundary type is intrinsically stable must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Rivers migrate and straight lines divide communities. — and conclude: Reject the assumption that natural boundaries are inherently peaceful.
...
```closure-flow
START / CONCEPT: Why no boundary type is intrinsically stable
EXACT TERMS: type | intrinsically | stable | Neither
MECHANISM / ARGUMENT: connect Neither type is intrinsically stable through process, place and time
CONSEQUENCE / CONTRAST: Reject the assumption that natural boundaries are inherently peaceful.
UPSC TRAP / ANSWER-USE: Rivers migrate and straight lines divide communities.
ANSWER-GRABBING FORMULATION: Why no boundary type is intrinsically stable converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Classical geopolitical lenses explains how Classical geopolitical lenses shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, Classical geopolitical lenses is the source-bounded relation among Classical geopolitical lenses, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Classical geopolitical lenses must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Treat Heartland, Rimland and Sea Power as lenses, not laws. — and conclude: Use each lens to isolate the spatial variable it actually identifies.
...
```closure-flow
START / CONCEPT: Classical geopolitical lenses
EXACT TERMS: Classical | geopolitical | lenses | classification | causation | comparison
MECHANISM / ARGUMENT: connect Classical geopolitical lenses through process, place and time
CONSEQUENCE / CONTRAST: Use each lens to isolate the spatial variable it actually identifies.
UPSC TRAP / ANSWER-USE: Treat Heartland, Rimland and Sea Power as lenses, not laws.
ANSWER-GRABBING FORMULATION: Classical geopolitical lenses converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** What the classical lenses omit explains how What the classical theories omit shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, What the classical lenses omit is the source-bounded relation among What the classical theories omit, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> What the classical lenses omit must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Geography conditions strategy without determining it. — and conclude: Add the omissions immediately after deploying any classical theory.
...
```closure-flow
START / CONCEPT: What the classical lenses omit
EXACT TERMS: What | classical | lenses | omit | theories
MECHANISM / ARGUMENT: connect What the classical theories omit through process, place and time
CONSEQUENCE / CONTRAST: Add the omissions immediately after deploying any classical theory.
UPSC TRAP / ANSWER-USE: Geography conditions strategy without determining it.
ANSWER-GRABBING FORMULATION: What the classical lenses omit converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** India's dual continental and maritime character explains how India's dual strategic character shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, India's dual continental and maritime character is the source-bounded relation among India's dual strategic character, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India's dual continental and maritime character must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Assigning India to one school hides the resource trade-off. — and conclude: Argue duality and the trade-off it imposes rather than a single orientation.
...
```closure-flow
START / CONCEPT: India's dual continental and maritime character
EXACT TERMS: India's | dual | continental | maritime | character | strategic
MECHANISM / ARGUMENT: connect India's dual strategic character through process, place and time
CONSEQUENCE / CONTRAST: Argue duality and the trade-off it imposes rather than a single orientation.
UPSC TRAP / ANSWER-USE: Assigning India to one school hides the resource trade-off.
ANSWER-GRABBING FORMULATION: India's dual continental and maritime character converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** India's sector-by-terrain border framework explains how Sector-by-terrain management framework shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, India's sector-by-terrain border framework is the source-bounded relation among Sector-by-terrain management framework, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India's sector-by-terrain border framework must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — The terrain sets the management problem in each sector. — and conclude: Move sector by sector, stating the management consequence each time.
...
```closure-flow
START / CONCEPT: India's sector-by-terrain border framework
EXACT TERMS: India's | sector-by-terrain | border | framework | management
MECHANISM / ARGUMENT: connect Sector-by-terrain management framework through process, place and time
CONSEQUENCE / CONTRAST: Move sector by sector, stating the management consequence each time.
UPSC TRAP / ANSWER-USE: The terrain sets the management problem in each sector.
ANSWER-GRABBING FORMULATION: India's sector-by-terrain border framework converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Why uniform border instruments fail explains how Why uniform instruments fail and Enclave and exchange logic shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, Why uniform border instruments fail is the source-bounded relation among Why uniform instruments fail and Enclave and exchange logic, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Why uniform border instruments fail must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Hardening a line without livelihoods creates the alienation it targets. — and conclude: Close border-management answers with differentiated management, not uniform fencing.
...
```closure-flow
START / CONCEPT: Why uniform border instruments fail
EXACT TERMS: uniform | border | instruments | fail | Enclave | exchange
MECHANISM / ARGUMENT: connect Why uniform instruments fail and Enclave and exchange logic through process, place and time
CONSEQUENCE / CONTRAST: Close border-management answers with differentiated management, not uniform fencing.
UPSC TRAP / ANSWER-USE: Hardening a line without livelihoods creates the alienation it targets.
ANSWER-GRABBING FORMULATION: Why uniform border instruments fail converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** India's neighbour set and its adjacency types explains how India's neighbour set shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, India's neighbour set and its adjacency types is the source-bounded relation among India's neighbour set, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India's neighbour set and its adjacency types must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Sri Lanka and the Maldives are maritime, not land, neighbours. — and conclude: State adjacency type before discussing any neighbour relationship.
...
```closure-flow
START / CONCEPT: India's neighbour set and its adjacency types
EXACT TERMS: India's | neighbour | adjacency | types
MECHANISM / ARGUMENT: connect India's neighbour set through process, place and time
CONSEQUENCE / CONTRAST: State adjacency type before discussing any neighbour relationship.
UPSC TRAP / ANSWER-USE: Sri Lanka and the Maldives are maritime, not land, neighbours.
ANSWER-GRABBING FORMULATION: India's neighbour set and its adjacency types converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** High-yield boundary lines and the category firewall explains how High-yield boundary lines and Category firewall for control lines shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, High-yield boundary lines and the category firewall is the source-bounded relation among High-yield boundary lines and Category firewall for control lines, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> High-yield boundary lines and the category firewall must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — International Boundary, Line of Control and Line of Actual Control are distinct. — and conclude: Name the correct legal category before describing any sector.
...
```closure-flow
START / CONCEPT: High-yield boundary lines and the category firewall
EXACT TERMS: High-yield | lines | category | firewall | control
MECHANISM / ARGUMENT: connect High-yield boundary lines and Category firewall for control lines through process, place and time
CONSEQUENCE / CONTRAST: Name the correct legal category before describing any sector.
UPSC TRAP / ANSWER-USE: International Boundary, Line of Control and Line of Actual Control are distinct.
ANSWER-GRABBING FORMULATION: High-yield boundary lines and the category firewall converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** India-China sectors, the Bangladesh settlement and force mandates explains how India-China three-sector division, Land Boundary Agreement chain and Border-force geographic mandates shape the examinable geography of Indian Political Geography: Boundaries and Neighbours.

**Technical definition:** In geographical analysis, India-China sectors, the Bangladesh settlement and force mandates is the source-bounded relation among India-China three-sector division, Land Boundary Agreement chain and Border-force geographic mandates, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India-China sectors, the Bangladesh settlement and force mandates must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Cartographic settlement is as much political geography as conflict is. — and conclude: Close with sectors, the enclave settlement chain and terrain-linked mandates.
...
```closure-flow
START / CONCEPT: India-China sectors, the Bangladesh settlement and force mandates
EXACT TERMS: India-China | sectors | Bangladesh | settlement | force | mandates
MECHANISM / ARGUMENT: connect India-China three-sector division, Land Boundary Agreement chain and Border-force geographic mandates through process, place and time
CONSEQUENCE / CONTRAST: Close with sectors, the enclave settlement chain and terrain-linked mandates.
UPSC TRAP / ANSWER-USE: Cartographic settlement is as much political geography as conflict is.
ANSWER-GRABBING FORMULATION: India-China sectors, the Bangladesh settlement and force mandates converts physical process into a qualified spatial argument
```
...
### Indian Political Geography: Boundaries and Neighbours: PROCESS, FORM AND LOCATION LEDGER

1. **Core political-geography vocabulary:** A boundary is a recognised line separating the territory or jurisdiction of two states, a frontier is a wider borderland zone of transition, a borderland is the human-use space on either side of the line, an enclave is territory enclosed by another state, and an exclave is a detached part of a state separated from its main territory.
2. **Four stages of boundary making:** Boundaries are made through allocation as a political decision, delimitation as the map and text drawing, demarcation as physical marking on the ground, and administration through check posts, patrols, crossings and settlements.
3. **Delimitation-demarcation gap:** Many disputes persist because delimitation exists on paper while demarcation on the ground is incomplete, or because a river or channel used as the defining feature later shifts.
4. **Natural and geometric boundary types:** A natural or physical boundary follows a mountain, river, watershed, desert or sea, while an artificial or geometric boundary follows a straight or coordinate-based line, and straight-line boundaries are usually more political than physical.
5. **Genetic classification of boundaries:** Antecedent, subsequent, superimposed and relict is a genetic classification that sorts boundaries by when they were drawn relative to the human landscape, and it is that timing which predicts the kind of dispute that follows.
6. **Frontier as zone, boundary as line:** A boundary separates sovereignty as a precise line, while a frontier explains interaction, friction, migration, exchange and strategic depth as a zone, so converting a historical frontier into a modern boundary is itself a common origin of disputes.
7. **Typology of dispute causes:** Boundary disputes arise from positional disagreement about where an agreed line runs, territorial disagreement about who owns a defined area, resource or functional contest over use across the line, antecedent and superimposed line problems, relict boundary effects and geomorphic instability of the defining feature.
8. **Neither type is intrinsically stable:** A natural boundary is not automatically more peaceful than a geometric one, because a river migrates and is hard to demarcate while a straight line divides communities and resources.
9. **Classical geopolitical lenses:** Mackinder's Heartland argument on Eurasian interior depth, Spykman's Rimland argument on coastal margins and Mahan's Sea Power argument on naval access and sea lanes are historical lenses, each identifying a genuine spatial variable rather than a predictive law.
10. **What the classical theories omit:** The classical lenses omit air and space power, cyber and submarine-cable infrastructure, economic interdependence, non-state actors and nuclear deterrence, which together mean geography conditions strategy without determining it.
11. **India's dual strategic character:** India's position is genuinely dual: a continental frontier requiring mountain and plains defence, and a peninsular maritime position astride major sea lanes with island territories extending its maritime reach, and recognising that duality is stronger than assigning India to any one school.
12. **Sector-by-terrain management framework:** India's boundary management differs by terrain: high-altitude glaciated sectors face inaccessibility and watershed ambiguity, densely populated plains sectors face smuggling and divided fields, riverine and deltaic sectors face migrating channels and shifting char lands, forested hill sectors face cross-border ethnic continuity, desert sectors face surveillance over long distances with shifting markers, and the maritime boundary raises zone delimitation, island baselines and fishing questions.
13. **Why uniform instruments fail:** Because India's border problem is several problems differing by terrain, settlement density, legal status of the line and the nature of cross-border activity, uniform instruments such as blanket fencing or a single force posture cannot fit all sectors.
14. **Enclave and exchange logic:** An enclave leaves residents cut off from their own state's administration, services and law enforcement, which is why enclave exchange is the standard remedy and why this is a geographic problem before it is a diplomatic one.
15. **India's neighbour set:** The source text treats India as sharing boundaries with Afghanistan through its claimed far north-west position, Pakistan, China, Nepal, Bhutan, Myanmar and Bangladesh, while Sri Lanka lies across the Palk Strait and Gulf of Mannar and the Maldives is the atoll neighbour across the Eight Degree Channel from Lakshadweep.
16. **High-yield boundary lines:** The Radcliffe Line of 1947 framed the partition boundary with Pakistan, the McMahon Line of the 1914 framework concerns the eastern India-China sector, the Durand Line of 1893 is the Afghanistan-Pakistan line rather than an India-Pakistan line, and the 1949 Ceasefire Line became the Line of Control in 1972.
17. **Category firewall for control lines:** International Boundary, the Line of Control and the Line of Actual Control are not interchangeable categories, because the first defines sovereignty, the second is a military control line and the third is a control reality over an undemarcated high-mountain frontier.
18. **India-China three-sector division:** The India-China boundary is divided into a western sector in the Ladakh, Karakoram and Aksai Chin space, a middle sector along the Himachal Pradesh and Uttarakhand frontier, and an eastern sector along the Sikkim and Arunachal Pradesh frontier where the McMahon Line chiefly applies.
19. **Land Boundary Agreement chain:** The 1974 Land Boundary Agreement, the 2011 Protocol and the 2015 implementation with its exchange of letters on 6 June and appointed day of 31 July resolved enclaves, adverse possessions and undemarcated stretches on the India-Bangladesh alluvial border.
20. **Border-force geographic mandates:** The geographic mandates are the Border Security Force on the India-Pakistan and India-Bangladesh borders, the Indo-Tibetan Border Police on the India-China frontier, the Sashastra Seema Bal on the India-Nepal and India-Bhutan borders, the Assam Rifles on the India-Myanmar border and the Indian Coast Guard in the maritime surveillance space.

### Indian Political Geography: Boundaries and Neighbours: CLOSE-OPTION FIREWALLS
...
### Indian Political Geography: Boundaries and Neighbours: MAP-AND-ANSWER SPINE
...
### Indian Political Geography: Boundaries and Neighbours: VERIFIED CURRENT-LINK BOUNDARY

The dated official linkages used are deliberately narrow. The India-Bangladesh Land Boundary Agreement chain of 1974, the 2011 Protocol and the 2015 implementation with its 6 June exchange of letters and 31 July appointed day is taken from the Ministry of External Affairs material recorded in the repository owner. The Press Information Bureau release of 7 July 2025 on the Kaladan Multi-Modal Transit Transport Project is retained only to illustrate that a boundary is accompanied by a wider frontier of hills, rivers, roads, ports and communities. No boundary length, number of border districts, disputed area in square kilometres, patrol figure or claimed alignment is stated from memory, and the legal status of any disputed sector is left to cited official sources.
