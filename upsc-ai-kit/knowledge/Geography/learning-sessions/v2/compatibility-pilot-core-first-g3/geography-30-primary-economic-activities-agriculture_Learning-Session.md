...
title: "Geography 30 — Primary Economic Activities: Agriculture"
cover_image: "../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/01_topic-roadmap.png"
variant: learner-v2
...
![Roadmap from primary-activity basics to location, systems, change and exam application](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/01_topic-roadmap.png)
...
```closure-flow
SUBTOPIC: Start here — the learning path and evidence safety
KEY TERMS / DEFINITIONS: !Roadmap from primary-activity basics to location, systems, change and exam application
...
![Primary activities classified by direct dependence on nature](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/02_primary-activity-taxonomy.png)
...
```closure-flow
SUBTOPIC: What agricultural geography studies
KEY TERMS / DEFINITIONS: !Primary activities classified by direct dependence on nature
...
![Physical and human controls that jointly shape agricultural location](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/07_physical-controls-matrix.png)
...
```closure-flow
SUBTOPIC: The six controls of agriculture
KEY TERMS / DEFINITIONS: Fertile soil alone is not sufficient.
...
![Farming systems compared by subsistence, labour, scale and market orientation](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/03_farming-system-classification.png)
...
```closure-flow
SUBTOPIC: Major agricultural systems
KEY TERMS / DEFINITIONS: Commercial orientation asks how strongly production is aimed at the market.
...
![Classical Von Thunen rings around a central market](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/05_von-thunen-classical-rings.png)
...
![Modern transport and cold chains stretch rather than erase distance effects](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/06_von-thunen-modified-model.png)
...
```closure-flow
SUBTOPIC: Von Thunen — why distance still matters
KEY TERMS / DEFINITIONS: The exact classical rings rarely survive today, but the mechanism survives.
...
![World agricultural regions linked to climate, labour and markets](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/08_global-farming-systems.png)
...
![A decision tree for linking crop needs to a plausible location](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/11_crop-location-decision-tree.png)
...
```closure-flow
SUBTOPIC: World agricultural regions and crop requirements
KEY TERMS / DEFINITIONS: World regions become memorable when each is tied to one climate pattern, one production
...
![Inputs, farm decisions, outputs and feedbacks in an agroecosystem](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/04_agroecosystem-flow.png)
...
```closure-flow
SUBTOPIC: From subsistence to commercialisation
KEY TERMS / DEFINITIONS: A vegetable-growing district can commercialise only when production is matched by roads,
...
![Official-data status ladder and the labels that must not be collapsed](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/29_current-data-status-firewall.png)
...
```closure-flow
SUBTOPIC: Reading agriculture current affairs without data mistakes
KEY TERMS / DEFINITIONS: What is the reference year and unit?
...
```closure-flow
SUBTOPIC: Non-farm primary activities — the physiography principle
KEY TERMS / DEFINITIONS: Primary activities extract or harvest directly from nature.
...
```closure-flow
SUBTOPIC: Fishing
KEY TERMS / DEFINITIONS: Fishing geography depends on the width and depth of the continental shelf, nutrient supply,
...
```closure-flow
SUBTOPIC: Forestry and forest produce
KEY TERMS / DEFINITIONS: Forestry is controlled not only by the existence of trees but by species, slope, distance and
...
```closure-flow
SUBTOPIC: Mining and quarrying
KEY TERMS / DEFINITIONS: Write geology -> occurrence -> accessibility -> extraction -> social/ecological consequence.
...
![A Geography answer spine from claim and map logic to qualification and verdict](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/30_upsc-answer-spine.png)
...
```closure-flow
SUBTOPIC: Answer architecture and technology-led transformation
KEY TERMS / DEFINITIONS: The Green Revolution is the clearest illustration: it strengthened national grain security
...
```closure-flow
SUBTOPIC: Core exam map
KEY TERMS / DEFINITIONS: Prelims: farming-system distinctions; crop-climate links; Von Thunen; primary-activity
...
![Kharif, Rabi and Zaid read as different climate and water geographies](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/09_india-seasons-calendar.png)

![India's major agricultural mosaics from irrigated plains to drylands and plantation highlands](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/10_agro-climatic-regionalisation.png)
...
![Landholding definitions and the distinction between ownership and operation](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/15_landholding-tenure-firewall.png)

![Schematic crop belts for foodgrains and fibres; not a current ranking chart](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/12_major-crop-belts-foodgrains-fibres.png)
...
![The Green Revolution as a package with spatially selective preconditions and outcomes](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/14_green-revolution-chain.png)
...
![From price recommendation and announcement to geographically selective procurement](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/20_msp-procurement-chain.png)

![Production, procurement, central-pool movement and distribution kept as distinct stages](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/22_food-security-architecture.png)
...
![The feedback between cheap pumping, aquifer decline, energy use and crop choice](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/16_irrigation-and-groundwater-energy-nexus.png)
...
![Current agriculture policies mapped to income, risk, water, markets, infrastructure, data and transition](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/27_current-schemes-architecture.png)

![Status ladder for distinguishing policy activity from outcome and impact](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/29_current-data-status-firewall.png)
...
![Claim, evidence, analysis, qualification and verdict for a high-scoring Geography answer](../../../../../../notes/Geography/assets/30_Primary-Economic-Activities-Agriculture/30_upsc-answer-spine.png)
