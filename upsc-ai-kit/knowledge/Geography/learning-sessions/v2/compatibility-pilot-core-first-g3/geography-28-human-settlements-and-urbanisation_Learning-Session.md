---
title: "Geography 28 — Human Settlements and Urbanisation"
topic_key: "geography-28-human-settlements-and-urbanisation"
variant: "learner-v2"
generation_date: "2026-08-20"
cover_image: "../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/01_settlement-system-roadmap.png"
---
...
### 1. Roadmap: what you are about to learn

![Settlement-system roadmap](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/01_settlement-system-roadmap.png)
...
```closure-flow
SUBTOPIC: Roadmap: what you are about to learn
KEY TERMS / DEFINITIONS: then how it is arranged, what it does and how it connects to other places.
...
### 2. Settlement geography: site, situation, function and hierarchy

![Site, situation and settlement reading](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/02_site-situation-patterns.png)
...
```closure-flow
SUBTOPIC: Settlement geography: site, situation, function and hierarchy
KEY TERMS / DEFINITIONS: Site is the exact ground; situation is the settlement's relative position in a larger region.
...
### 3. Rural settlement forms: how closely do people live?

![Rural settlement morphology](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/03_rural-settlement-morphology.png)
...
```closure-flow
SUBTOPIC: Rural settlement forms: how closely do people live?
KEY TERMS / DEFINITIONS: compactness may reflect security or concentrated water rather than urban character.
...
### 4. Settlement patterns: what geometry appears on the ground?
...
```closure-flow
SUBTOPIC: Settlement patterns: what geometry appears on the ground?
KEY TERMS / DEFINITIONS: Pattern is the visible arrangement of streets and dwellings; it is not the same as function.
...
### 5. Urbanisation and the rural-urban continuum

![Rural-urban continuum](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/12_rural-urban-continuum.png)
...
```closure-flow
SUBTOPIC: Urbanisation and the rural-urban continuum
KEY TERMS / DEFINITIONS: Urbanisation means a rising share of people living in urban places and an expansion of urban
...
### 6. Model firewall: models simplify; they do not photograph reality

![Urban-model firewall](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/04_urban-models-firewall.png)
...
```closure-flow
SUBTOPIC: Model firewall: models simplify; they do not photograph reality
KEY TERMS / DEFINITIONS: A model is a thinking tool, not a universal map.
...
### 7. Christaller's central-place theory: threshold, range and hierarchy

![Central-place logic](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/10_central-place-logic.png)
...
```closure-flow
SUBTOPIC: Christaller's central-place theory: threshold, range and hierarchy
KEY TERMS / DEFINITIONS: A periodic market is a particularly clear South Asian response: when local demand is
...
### 8. Applying central-place logic to India
...
```closure-flow
SUBTOPIC: Applying central-place logic to India
KEY TERMS / DEFINITIONS: This comparison is the visual: use it to move from “model fits” to “model is selectively useful.”
...
### 9. Rank-size, primate city and India's multi-metropolitan system

![Rank-size and primate-city comparison](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/11_rank-size-primate-city.png)
...
```closure-flow
SUBTOPIC: Rank-size, primate city and India's multi-metropolitan system
KEY TERMS / DEFINITIONS: The rank-size rule says that, in a well-integrated urban system, a city's population is roughly
...
### 10. Burgess: the concentric-zone model

![Burgess concentric-zone model](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/05_burgess-concentric-model.png)
...
```closure-flow
SUBTOPIC: Burgess: the concentric-zone model
KEY TERMS / DEFINITIONS: Growth occurs through invasion and succession: expanding activities enter an adjacent ring and
...
### 11. Hoyt: the sector model

![Hoyt sector model](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/06_hoyt-sector-model.png)
...
```closure-flow
SUBTOPIC: Hoyt: the sector model
KEY TERMS / DEFINITIONS: well-connected and environmentally attractive direction.
...
### 12. Harris and Ullman: the multiple-nuclei model

![Multiple-nuclei model](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/07_multiple-nuclei-model.png)
...
```closure-flow
SUBTOPIC: Harris and Ullman: the multiple-nuclei model
KEY TERMS / DEFINITIONS: some activities require special sites;
...
### 13. India's urban definitions: statistical urbanisation and administrative urbanisation

![Statutory town, census town and urban agglomeration](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/13_statutory-census-UA-firewall.png)
...
```closure-flow
SUBTOPIC: India's urban definitions: statistical urbanisation and administrative urbanisation
KEY TERMS / DEFINITIONS: The central Indian distinction is between urban status by law and urban status by
...
### 14. India's urban problem set: sprawl, housing and mobility

![Sprawl typology](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/17_land-use-sprawl-typology.png)
...
![Housing and informality firewall](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/18_housing-slum-informality-firewall.png)
...
![Mobility and transit-oriented development](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/25_mobility-TOD-system.png)
...
```closure-flow
SUBTOPIC: India's urban problem set: sprawl, housing and mobility
KEY TERMS / DEFINITIONS: Sprawl is peripheral expansion that outruns boundaries, infrastructure and coordinated land-use
...
### 15. India's urban problem set: floods, heat, water and sanitation

![Urban-flood resilience chain](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/27_urban-flood-resilience.png)
...
![Urban heat-island mechanism](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/26_urban-heat-resilience.png)
...
![Water and sanitation service chain](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/23_water-sewerage-service-chain.png)
...
```closure-flow
SUBTOPIC: India's urban problem set: floods, heat, water and sanitation
KEY TERMS / DEFINITIONS: radiation and human activity adds waste heat.
...
### 16. India's urban problem set: governance fragmentation
...
```closure-flow
SUBTOPIC: India's urban problem set: governance fragmentation
KEY TERMS / DEFINITIONS: This is why well-known technical solutions often fail at implementation.
...
### 17. Basic answer architecture: turn knowledge into marks

![UPSC answer spine](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/31_UPSC-answer-spine.png)
...
```closure-flow
SUBTOPIC: Basic answer architecture: turn knowledge into marks
KEY TERMS / DEFINITIONS: The reusable sequence is definition and scale → mechanism → named evidence → analysis →
...
```closure-flow
SUBTOPIC: Basic mastery recap
KEY TERMS / DEFINITIONS: Basic verdict: settlement geography moves from the ground under a habitation to the regional
...
A. Site is the exact ground; situation is the settlement's relative location  
B. Site is economic function; situation is street geometry  
C. Site is legal status; situation is population rank  
D. Site is a market threshold; situation is a service range

**Answer: A.** Site is local ground, while situation is relational position.

**Common-error remediation:** If you chose B, C or D, return to the four-question settlement
...
B. A close cluster of dwellings  
C. A merged group of metropolitan regions  
...
C. Rectangular — streets meeting roughly at right angles  
D. Irregular — a mandatory planned grid
...
A. Increase in the number of buildings only  
B. Expansion of a municipal boundary only  
C. Migration to one metropolitan city only  
D. Rising urban share together with occupational, service and network change
...
B. The minimum demand needed to sustain a good or service  
C. The legal boundary of a service centre  
...
A. They reproduce real district borders exactly  
B. They prove consumers always choose the nearest centre  
C. They represent circular municipal boundaries  
D. They cover an ideal plain without the gaps or overlaps created by circles
...
B. The urban system and comparable boundaries are first defined  
C. The largest city is assumed to be primate  
D. Population rank is replaced by legal status
...
A. India has one unchallenged national primate city  
B. Every state follows rank-size perfectly  
C. India is multi-metropolitan nationally, while state-level primacy may occur  
D. Primacy cannot be discussed below the world scale
...
A. Transport wedges  
B. Several specialised nuclei  
C. Hexagonal market areas  
D. Concentric rings and invasion-succession
...
A. Directional growth along transport corridors  
B. A fixed administrative K = 7 hierarchy  
C. Only isolated farmsteads  
...
B. Specialised nodes, clustering benefits and incompatible land uses  
C. City growth must form perfect rings  
...
C. Pre-colonial, colonial and later planned/unplanned layers coexist  
D. Informal settlement is absent outside the CBD
...
A. Must be a million-plus city  
B. Must contain several statutory towns  
C. Is created only through municipal law  
D. Can meet demographic-economic urban criteria without an urban local body
...
A. Continuous built-up spread involving a town and outgrowths or contiguous towns  
B. State-level city primacy  
C. Minimum consumer demand  
...
A. It always increases density  
B. dispersed peripheral development extends networks and travel distances  
C. it automatically creates statutory towns  
D. it shortens every commute
...
A. A cultural preference for unsafe land  
B. A direct synonym for homelessness  
C. A housing-market, tenure and service-governance failure  
D. A result of urbanisation stopping
...
A. Higher threshold → lower range → less travel  
B. Municipal notification → lower rent → less traffic  
C. Greater clustering → shorter networks → no vehicles  
D. Land-use separation → longer trips → vehicle dependence → emissions
...
A. A sanctioned project is enough  
B. Pipe length alone is enough  
C. Source, continuity, quality, affordability, collection and treatment all matter  
D. Groundwater extraction has no regional effect
...
A. A compact settlement can still be rural  
B. Every compact settlement is a metropolis  
...
A. One ideal model should fully map every Indian city  
B. Assumptions need not be stated  
C. A model explains a selected mechanism and requires Indian qualification  
D. Informality always occupies one predicted zone
...
C. They satisfy demographic-economic criteria  
D. They exist only after receiving an urban local body
...
A. Urban flooding reflects the interaction of rainfall with land-use change, drainage loss and exposed development  
B. Cities flood only because rainfall is high  
...
A. Automatic distant relocation  
B. Safe in-situ upgrading where feasible, supported by services and tenure security  
...
A. Cities produce only diseconomies  
B. Urban growth should stop  
C. Cities can raise productivity and non-farm opportunity, but outcomes depend on planning and capacity  
D. Population concentration automatically guarantees inclusion
...
A. Use more schemes  
B. Build more roads everywhere  
C. Copy one Western model  
...
![Answer-writing spine](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/31_UPSC-answer-spine.png)
...
![India urban baseline and system dashboard](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/15_india-urban-system-dashboard.png)
...
![India's urban transition](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/14_india-urban-transition.png)
...
![Metropolitanisation and peri-urbanisation](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/16_metropolitanisation-periurbanisation.png)
...
![Housing, slums and informality](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/18_housing-slum-informality-firewall.png)
...
![Urban mission architecture](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/28_urban-mission-architecture.png)
...
![Agglomeration gains and diseconomies](../../../../../../notes/Geography/assets/28_Human-Settlements-and-Urbanisation/19_agglomeration-economies-diseconomies.png)
