...
title: Geography 32 - Industries and Industrial Regions - Learner-First V2
variant: learner-v2
...
### 1. Learning road map: ask the location question in the right order

![Road map from definitions to location, regions and answers](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/01_topic-roadmap.png)
...
```closure-flow
SUBTOPIC: Learning road map: ask the location question in the right order
KEY TERMS / DEFINITIONS: Visual first: the topic moves from precise terms to factors, theory, regions, persistence, policy and answer writing.
...
### 2. Terminology firewall: industry, manufacturing, factory and industrial region

![Terminology and classification firewall](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/02_industry-classification-firewall.png)
...
```closure-flow
SUBTOPIC: Terminology firewall: industry, manufacturing, factory and industrial region
KEY TERMS / DEFINITIONS: Visual first: activity, establishment and region are different units and should not be mixed.
...
### 3. Main location factors: build a ranked factor system

![Industrial location factor wheel](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/03_location-factor-wheel.png)
...
```closure-flow
SUBTOPIC: Main location factors: build a ranked factor system
KEY TERMS / DEFINITIONS: Visual first: location results from interacting material, energy, labour, market, transport, water, capital and technology pulls.
...
### 4. Weber's least-cost theory: learn it in six steps

![Weber material index, transport minimum and isodapane](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/04_weber-material-index-isodapane.png)
...
```closure-flow
SUBTOPIC: Weber's least-cost theory: learn it in six steps
KEY TERMS / DEFINITIONS: Alfred Weber's 1909 model asks: where can a factory minimise the combined burden of transport cost, labour cost and agglomeration/deglomeration effects?
...
### 5. Types of industrial orientation: compare stages, not labels

![Stage-by-factor matrix for industrial orientation](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/40_sector-location-matrix.png)
...
```closure-flow
SUBTOPIC: Types of industrial orientation: compare stages, not labels
KEY TERMS / DEFINITIONS: !Stage-by-factor matrix for industrial orientation
...
### 6. Major world industrial regions: map the mechanism behind each belt

![Schematic major world industrial regions](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/10_global-industrial-regions.png)
...
```closure-flow
SUBTOPIC: Major world industrial regions: map the mechanism behind each belt
KEY TERMS / DEFINITIONS: Visual first: the world's major regions represent different combinations of resources, ports, markets, labour and state-supported infrastructure; the map is schematic and not to scale.
...
### 7. Agglomeration, deglomeration and industrial inertia

![Agglomeration economies and diseconomies](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/07_agglomeration-diseconomy.png)
...
![Location lock-in, shock and relocation](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/37_location-lockin-relocation.png)
...
```closure-flow
SUBTOPIC: Agglomeration, deglomeration and industrial inertia
KEY TERMS / DEFINITIONS: Agglomeration means firms cluster because they share:
...
### 8. Actors, institutions and planned location: the state can support, not invent, every linkage

![Corridor and logistics architecture](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/25_corridor-logistics-architecture.png)
...
```closure-flow
SUBTOPIC: Actors, institutions and planned location: the state can support, not invent, every linkage
KEY TERMS / DEFINITIONS: This is an example of deliberate corridor-linked, multimodal and plug-and-play industrial space.
...
### 9. What changed after Weber - and what did not

![Evolution from classical location theory to modern risk and capability](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/36_theory-evolution-tree.png)
...
```closure-flow
SUBTOPIC: What changed after Weber - and what did not
KEY TERMS / DEFINITIONS: What changes is the content of those burdens.
...
### 10. Basic answer architecture and evidence units

![UPSC industrial-geography answer spine](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/35_upsc-answer-spine.png)
...
```closure-flow
SUBTOPIC: Basic answer architecture and evidence units
KEY TERMS / DEFINITIONS: Evidence: Coal-and-iron cores retained manufacturing through skills, engineering and repair ecosystems, transport and urban markets.
...
- (C) An industrial region contains no services.
- (D) A factory must cover several states.
...
- (D) Policy determines every location.
...
- (A) It has no location requirements.
- (B) It must locate beside a mine.
...
- (A) Any increase in city population.
- (B) A legal factory registration.
- (C) A movement of every plant to rural land.
...
- (A) industrialisation always requires domestic ore;
- (B) ports and markets can substitute for domestic mineral abundance through imported inputs;
- (C) shipping risk is irrelevant;
- (D) urban markets weaken industry.
...
- (A) Jute has no geographic origin.
- (B) The belt lacks labour and transport.
- (C) Port access, labour, machinery, trading networks and industrial inertia also matter.
- (D) Only a modern semiconductor incentive explains it.
...
- (D) Scheme list without a spatial mechanism.
...
- (A) Transport no longer matters anywhere.
...
- (C) Every modern industry is market-oriented.
- (D) Agglomeration has disappeared.
...
- (B) only a highway is announced;
- (C) incentives permanently replace productivity;
...
- (B) It proves source location.
- (C) It eliminates freight.
- (D) It makes the activity tertiary.
...
- (A) Inertia never exists.
- (B) Raw materials never weaken.
...
- (D) Every old region becomes a corridor.
...
- (B) Weber perfectly predicts every modern plant.
- (C) Global value chains remove transport.
- (D) Agglomeration is unrelated to Weber.
...
- (D) Coastal industry has no market link.
...
- (A) Corridors contain no roads.
- (B) Highways cannot carry goods.
...
- (B) Add unverified production figures.
...
![36. Current official evidence dashboard as of 20 August 2026](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/33_monitoring-dashboard.png)
...
![Schematic industrial regions of India](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/12_india-industrial-regions.png)
...
![India corridor nodes and broad alignments](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/26_india-corridor-nodes.png)
...
![PLI status chain from outlay to outcome](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/24_pli-status-chain.png)
...
![Spread and backwash effects of industrial concentration](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/38_spread-backwash.png)
...
![Current-status and claim firewall](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/34_current-status-firewall.png)
...
![Answer route for advanced industrial geography](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/35_upsc-answer-spine.png)
...
![Core Basic answer and recall spine](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/35_upsc-answer-spine.png)
...
![Optional Advanced India industrial geography](../../../../../../notes/Geography/assets/32_Industries-and-Industrial-Regions/12_india-industrial-regions.png)
