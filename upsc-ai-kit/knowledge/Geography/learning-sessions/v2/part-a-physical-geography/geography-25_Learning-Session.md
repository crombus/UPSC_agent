...
**Plain-language definition:** Polar climate location and subdivisions explains how Polar climate location and Tundra distribution shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, Polar climate location and subdivisions is the source-bounded relation among Polar climate location and Tundra distribution, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Polar climate location and subdivisions must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Ice-cap and tundra are not the same subdivision. — and conclude: Map the polar zone north of the Arctic Circle and distinguish ice-cap from tundra.
...
```closure-flow
START / CONCEPT: Polar climate location and subdivisions
EXACT TERMS: Polar | climate | location | subdivisions | Tundra | distribution
MECHANISM / ARGUMENT: connect Polar climate location and Tundra distribution through process, place and time
CONSEQUENCE / CONTRAST: Map the polar zone north of the Arctic Circle and distinguish ice-cap from tundra.
UPSC TRAP / ANSWER-USE: Ice-cap and tundra are not the same subdivision.
ANSWER-GRABBING FORMULATION: Polar climate location and subdivisions converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Temperature and precipitation character explains how Temperature character and Cold desert precipitation shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, Temperature and precipitation character is the source-bounded relation among Temperature character and Cold desert precipitation, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Temperature and precipitation character must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Polar climate is a cold desert with low precipitation, not heavy snowfall. — and conclude: Explain the sub-10-degree warmest month and low snow precipitation.
...
```closure-flow
START / CONCEPT: Temperature and precipitation character
EXACT TERMS: Temperature | precipitation | character | Cold | desert
MECHANISM / ARGUMENT: connect Temperature character and Cold desert precipitation through process, place and time
CONSEQUENCE / CONTRAST: Explain the sub-10-degree warmest month and low snow precipitation.
UPSC TRAP / ANSWER-USE: Polar climate is a cold desert with low precipitation, not heavy snowfall.
ANSWER-GRABBING FORMULATION: Temperature and precipitation character converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Tundra vegetation and ecology explains how Tundra vegetation and Brief summer flowering shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, Tundra vegetation and ecology is the source-bounded relation among Tundra vegetation and Brief summer flowering, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Tundra vegetation and ecology must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Tundra is treeless; reindeer moss is a lichen, not a moss. — and conclude: Describe the stunted vegetation, lichen pasture and brief summer flowering.
...
```closure-flow
START / CONCEPT: Tundra vegetation and ecology
EXACT TERMS: Tundra | vegetation | ecology | Brief | summer | flowering
MECHANISM / ARGUMENT: connect Tundra vegetation and Brief summer flowering through process, place and time
CONSEQUENCE / CONTRAST: Describe the stunted vegetation, lichen pasture and brief summer flowering.
UPSC TRAP / ANSWER-USE: Tundra is treeless; reindeer moss is a lichen, not a moss.
ANSWER-GRABBING FORMULATION: Tundra vegetation and ecology converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Arctic-Antarctic asymmetry explains how Arctic-Antarctic asymmetry shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, Arctic-Antarctic asymmetry is the source-bounded relation among Arctic-Antarctic asymmetry, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Arctic-Antarctic asymmetry must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Arctic is an ocean; Antarctica is a continent. — and conclude: Open any polar answer with the fundamental asymmetry.
...
```closure-flow
START / CONCEPT: Arctic-Antarctic asymmetry
EXACT TERMS: Arctic-Antarctic | asymmetry | classification | causation | comparison | qualification
MECHANISM / ARGUMENT: connect Arctic-Antarctic asymmetry through process, place and time
CONSEQUENCE / CONTRAST: Open any polar answer with the fundamental asymmetry.
UPSC TRAP / ANSWER-USE: Arctic is an ocean; Antarctica is a continent.
ANSWER-GRABBING FORMULATION: Arctic-Antarctic asymmetry converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Ice-albedo feedback mechanism explains how Ice-albedo feedback mechanism shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, Ice-albedo feedback mechanism is the source-bounded relation among Ice-albedo feedback mechanism, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Ice-albedo feedback mechanism must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — This is a self-reinforcing loop, not a one-time event. — and conclude: Trace the feedback from ice retreat through albedo change to further warming.
...
```closure-flow
START / CONCEPT: Ice-albedo feedback mechanism
EXACT TERMS: Ice-albedo | feedback | classification | causation | comparison | qualification
MECHANISM / ARGUMENT: connect Ice-albedo feedback mechanism through process, place and time
CONSEQUENCE / CONTRAST: Trace the feedback from ice retreat through albedo change to further warming.
UPSC TRAP / ANSWER-USE: This is a self-reinforcing loop, not a one-time event.
ANSWER-GRABBING FORMULATION: Ice-albedo feedback mechanism converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Permafrost carbon feedback explains how Permafrost thaw and carbon shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, Permafrost carbon feedback is the source-bounded relation among Permafrost thaw and carbon, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Permafrost carbon feedback must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Dry conditions release CO2, waterlogged conditions release methane. — and conclude: Explain the second feedback loop alongside the albedo mechanism.
...
```closure-flow
START / CONCEPT: Permafrost carbon feedback
EXACT TERMS: Permafrost | carbon | feedback | thaw
MECHANISM / ARGUMENT: connect Permafrost thaw and carbon through process, place and time
CONSEQUENCE / CONTRAST: Explain the second feedback loop alongside the albedo mechanism.
UPSC TRAP / ANSWER-USE: Dry conditions release CO2, waterlogged conditions release methane.
ANSWER-GRABBING FORMULATION: Permafrost carbon feedback converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Sea-level grounded-ice rule explains how Sea-level rule shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, Sea-level grounded-ice rule is the source-bounded relation among Sea-level rule, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Sea-level grounded-ice rule must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Floating sea-ice melt does not raise sea level. — and conclude: Distinguish grounded from floating ice and explain the buttressing role of ice shelves.
...
```closure-flow
START / CONCEPT: Sea-level grounded-ice rule
EXACT TERMS: Sea-level | grounded-ice | rule | classification | causation | comparison
MECHANISM / ARGUMENT: connect Sea-level rule through process, place and time
CONSEQUENCE / CONTRAST: Distinguish grounded from floating ice and explain the buttressing role of ice shelves.
UPSC TRAP / ANSWER-USE: Floating sea-ice melt does not raise sea level.
ANSWER-GRABBING FORMULATION: Sea-level grounded-ice rule converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Arctic shipping and practical constraints explains how Arctic shipping prospects shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, Arctic shipping and practical constraints is the source-bounded relation among Arctic shipping prospects, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Arctic shipping and practical constraints must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Do not present the Arctic as an accomplished trade route. — and conclude: Balance the shorter-route advantage against the severe practical limitations.
...
```closure-flow
START / CONCEPT: Arctic shipping and practical constraints
EXACT TERMS: Arctic | shipping | practical | constraints | prospects
MECHANISM / ARGUMENT: connect Arctic shipping prospects through process, place and time
CONSEQUENCE / CONTRAST: Balance the shorter-route advantage against the severe practical limitations.
UPSC TRAP / ANSWER-USE: Do not present the Arctic as an accomplished trade route.
ANSWER-GRABBING FORMULATION: Arctic shipping and practical constraints converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Arctic governance and India explains how Arctic governance shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, Arctic governance and India is the source-bounded relation among Arctic governance, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Arctic governance and India must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — India has observer status, not territorial claims. — and conclude: Map maritime-law claims, the Arctic forum and India's role.
...
```closure-flow
START / CONCEPT: Arctic governance and India
EXACT TERMS: Arctic | governance | classification | causation | comparison | qualification
MECHANISM / ARGUMENT: connect Arctic governance through process, place and time
CONSEQUENCE / CONTRAST: Map maritime-law claims, the Arctic forum and India's role.
UPSC TRAP / ANSWER-USE: India has observer status, not territorial claims.
ANSWER-GRABBING FORMULATION: Arctic governance and India converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Indigenous peoples explains how Arctic Indigenous peoples shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, Indigenous peoples is the source-bounded relation among Arctic Indigenous peoples, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Indigenous peoples must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Use Inuit, Sami and Nenets, not older exonyms. — and conclude: Identify Arctic Indigenous communities and their diverse livelihoods.
...
```closure-flow
START / CONCEPT: Indigenous peoples
EXACT TERMS: Indigenous | peoples | Arctic | classification | causation | comparison
MECHANISM / ARGUMENT: connect Arctic Indigenous peoples through process, place and time
CONSEQUENCE / CONTRAST: Identify Arctic Indigenous communities and their diverse livelihoods.
UPSC TRAP / ANSWER-USE: Use Inuit, Sami and Nenets, not older exonyms.
ANSWER-GRABBING FORMULATION: Indigenous peoples converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** India cold desert Ladakh explains how India cold desert Ladakh and Ladakh cold desert mechanism shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, India cold desert Ladakh is the source-bounded relation among India cold desert Ladakh and Ladakh cold desert mechanism, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India cold desert Ladakh must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Ladakh is arid due to rain-shadow and altitude, not heat. — and conclude: Explain the rain-shadow and radiative-cooling mechanism.
...
```closure-flow
START / CONCEPT: India cold desert Ladakh
EXACT TERMS: cold | desert | Ladakh | classification | causation | comparison
MECHANISM / ARGUMENT: connect India cold desert Ladakh and Ladakh cold desert mechanism through process, place and time
CONSEQUENCE / CONTRAST: Explain the rain-shadow and radiative-cooling mechanism.
UPSC TRAP / ANSWER-USE: Ladakh is arid due to rain-shadow and altitude, not heat.
ANSWER-GRABBING FORMULATION: India cold desert Ladakh converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** Ladakh land use and Changpa explains how Ladakh land use shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, Ladakh land use and Changpa is the source-bounded relation among Ladakh land use, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Ladakh land use and Changpa must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Irrigated agriculture and pastoral economy are the priorities. — and conclude: Map water-harvesting, pashmina goats and yak herding.
...
```closure-flow
START / CONCEPT: Ladakh land use and Changpa
EXACT TERMS: Ladakh | land | Changpa | classification | causation | comparison
MECHANISM / ARGUMENT: connect Ladakh land use through process, place and time
CONSEQUENCE / CONTRAST: Map water-harvesting, pashmina goats and yak herding.
UPSC TRAP / ANSWER-USE: Irrigated agriculture and pastoral economy are the priorities.
ANSWER-GRABBING FORMULATION: Ladakh land use and Changpa converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** India polar research programme explains how India polar research stations and India Arctic and Himalayan stations shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, India polar research programme is the source-bounded relation among India polar research stations and India Arctic and Himalayan stations, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India polar research programme must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Dakshin Gangotri is decommissioned; Bharati and Maitri are Antarctic. — and conclude: Enumerate stations with correct locations and operational status.
...
```closure-flow
START / CONCEPT: India polar research programme
EXACT TERMS: polar | research | programme | stations | Arctic | Himalayan
MECHANISM / ARGUMENT: connect India polar research stations and India Arctic and Himalayan stations through process, place and time
CONSEQUENCE / CONTRAST: Enumerate stations with correct locations and operational status.
UPSC TRAP / ANSWER-USE: Dakshin Gangotri is decommissioned; Bharati and Maitri are Antarctic.
ANSWER-GRABBING FORMULATION: India polar research programme converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** India polar legal framework explains how India polar legal framework shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, India polar legal framework is the source-bounded relation among India polar legal framework, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India polar legal framework must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — Antarctic Treaty 1983, Antarctic Act 2022, Arctic Policy 2022. — and conclude: Connect the legal-policy framework to the teleconnection research focus.
...
```closure-flow
START / CONCEPT: India polar legal framework
EXACT TERMS: polar | legal | framework | classification | causation | comparison
MECHANISM / ARGUMENT: connect India polar legal framework through process, place and time
CONSEQUENCE / CONTRAST: Connect the legal-policy framework to the teleconnection research focus.
UPSC TRAP / ANSWER-USE: Antarctic Treaty 1983, Antarctic Act 2022, Arctic Policy 2022.
ANSWER-GRABBING FORMULATION: India polar legal framework converts physical process into a qualified spatial argument
```
...
**Plain-language definition:** 2021 PYQ demand and answer spine explains how 2021 GS-I PYQ ownership shape the examinable geography of Arctic or Polar Climate.

**Technical definition:** In geographical analysis, 2021 PYQ demand and answer spine is the source-bounded relation among 2021 GS-I PYQ ownership, classified by process, form, spatial setting, temporal change and human consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> 2021 PYQ demand and answer spine must be explained as a process-to-pattern chain, not as an unconnected catalogue of landforms, places or schemes.
...
**How to use them:** Define the process, locate its spatial expression, cite named evidence, apply this limit — This is the only verified PYQ owned by this topic. — and conclude: Close with the verified PYQ demand and the four-channel answer spine.
...
```closure-flow
START / CONCEPT: 2021 PYQ demand and answer spine
EXACT TERMS: demand | spine | GS-I | ownership
MECHANISM / ARGUMENT: connect 2021 GS-I PYQ ownership through process, place and time
CONSEQUENCE / CONTRAST: Close with the verified PYQ demand and the four-channel answer spine.
UPSC TRAP / ANSWER-USE: This is the only verified PYQ owned by this topic.
ANSWER-GRABBING FORMULATION: 2021 PYQ demand and answer spine converts physical process into a qualified spatial argument
```
...
### Arctic or Polar Climate: PROCESS, FORM AND LOCATION LEDGER

1. **Polar climate location:** The polar type of climate and vegetation is found mainly north of the Arctic Circle in the Northern Hemisphere, with two subdivisions: ice-cap covering Greenland and high-latitude highlands under permanent snow, and tundra covering lowlands with a few ice-free months.
2. **Tundra distribution:** Tundra covers coastal Greenland, the barren grounds of northern Canada and Alaska, and the Arctic seaboard of Eurasia; these lowlands have a few months above freezing when snow melts and vegetation appears.
3. **Temperature character:** Mean annual temperature is very low; the warmest month in June or July seldom exceeds about 10 degrees Celsius; no more than about four months rise above freezing and winters are long and severe, colder in the interior.
4. **Cold desert precipitation:** Precipitation is low and mostly snow, making the polar climate a cold desert; blizzards are wind-and-snow events caused by wind redistributing existing snow into drifts, not simply heavy snowfall.
5. **Tundra vegetation:** Tundra is treeless; in sheltered spots stunted birches, dwarf willows and undersized alders survive; coastal lowlands carry hardy grasses and reindeer moss which is actually a lichen providing the only pasturage for reindeer.
6. **Brief summer flowering:** In the brief polar summer snow melts and berry-bushes and Arctic flowers bloom briefly before the return of continuous cold; this short growing season controls the entire ecological calendar.
7. **Arctic-Antarctic asymmetry:** The Arctic is an ocean surrounded by continents while Antarctica is a continent surrounded by ocean; the Arctic carries mainly floating sea ice plus the Greenland ice sheet, while Antarctica holds a vast grounded ice sheet with floating ice shelves at its margins.
8. **Ice-albedo feedback mechanism:** Arctic amplification works through the ice-albedo feedback: as warming causes sea ice and snow to retreat, bright high-albedo surfaces are replaced by dark ocean and bare ground, absorbing far more solar radiation and causing further warming in a self-reinforcing loop.
9. **Permafrost thaw and carbon:** Permafrost thaw releases stored carbon as carbon dioxide under dry conditions and methane under waterlogged conditions; this creates a second self-reinforcing feedback loop alongside the ice-albedo mechanism.
10. **Sea-level rule:** Floating sea-ice melt does not raise sea level; only grounded ice loss from Greenland and Antarctica transfers mass to the ocean; ice-shelf loss removes buttressing and can accelerate grounded-ice discharge.
11. **Arctic shipping prospects:** Retreating summer sea ice lengthens the navigable season along Arctic coasts on routes shorter than Suez or Panama between NE Asia and NW Europe, but practical constraints including mobile ice, incomplete charting, thin rescue capacity, costly insurance and sparse ports limit near-term traffic to resource export and destination shipping.
12. **Arctic governance:** Coastal states' rights over the Arctic seabed depend on maritime law including continental-shelf extensions on geological evidence; regional cooperation operates through a state-led forum with observer participation by non-Arctic states including India.
13. **India cold desert Ladakh:** India's cold-desert analogue is Ladakh and adjoining trans-Himalayan valleys; the Greater Himalaya blocks the southwest monsoon creating a rain-shadow, while high altitude produces intense insolation by day and sharp radiative cooling by night.
14. **Ladakh cold desert mechanism:** Ladakh is a desert because of rain-shadow plus high altitude, not because it is hot; winter western disturbances bring the light snow that is the main precipitation; Husain classes it with the cold desert biome alongside the Sierra Nevada and the Andes.
15. **Ladakh land use:** In the cold deserts of Ladakh and Spiti, priority goes to irrigated agriculture and animal husbandry with water-harvesting devices; the Changpa rear pashmina goats and yak on high pastures, and allied activities include milk, poultry and horticulture.
16. **India polar research stations:** India's polar research is coordinated by NCPOR in Goa; Antarctic stations are Maitri at Schirmacher Oasis since 1989 and Bharati at Larsemann Hills since 2012; Dakshin Gangotri was the first station from 1983 but was later decommissioned.
17. **India Arctic and Himalayan stations:** India's Arctic station is Himadri at Ny-Alesund in Svalbard since 2008; the Himalayan station Himansh in Spiti, Himachal Pradesh conducts glacier studies; Dakshin Gangotri is not operational.
18. **India polar legal framework:** India acceded to the Antarctic Treaty in 1983, has the Indian Antarctic Act 2022 and an Arctic Policy 2022 with six pillars; the research focus is on teleconnections between Arctic sea-ice loss and disruption of the Indian monsoon.
19. **Arctic Indigenous peoples:** Arctic Indigenous communities include the Inuit in Greenland, Canada and Alaska, the Sami in northern Fennoscandia and the Nenets and other peoples in Arctic Russia; these communities have diverse livelihoods adapted to the polar environment.
20. **2021 GS-I PYQ ownership:** The 2021 GS-I Q15 demand on melting Arctic ice and Antarctic glaciers and weather patterns is the only verified PYQ owned by this topic; it requires the Arctic-Antarctic distinction, the amplification mechanism and four transmission channels with confidence grading.

### Arctic or Polar Climate: CLOSE-OPTION FIREWALLS
...
### Arctic or Polar Climate: MAP-AND-ANSWER SPINE
...
### Arctic or Polar Climate: VERIFIED CURRENT-LINK BOUNDARY

NOAA Arctic Report Card, NSIDC Sea Ice News and NCPOR expedition data are used only to establish Arctic amplification and India's polar research as live current anchors. No specific sea-ice extent, mass-loss rate or warming multiple is quoted without a dated source.
