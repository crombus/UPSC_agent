...
>
> **Evidence key:** [FACT] source-grounded constitutional, statutory or judicial proposition; [ANALYSIS] exam synthesis; [CURRENT] dated current-law control; [LIMIT] qualification preventing overstatement.
...
- Digital Personal Data Protection Act, 2023: official MeitY/Gazette text; no unverified Rules claim.
...
- Practice counts: 21 verified routed PYQs; 36 original hard MCQs; 12 remedial MCQs; 9 original solved Mains questions across 10, 15 and 20 marks.
...
[CURRENT] This package states no final post-2023 Supreme Court disposition because none was independently secured from a primary source during the dated verification. The IPC has since been repealed for new offences under the new criminal-code framework.
...
[LIMIT] This package does not assert the contents or operative status of later DPDP Rules without primary official verification. In a Mains answer, use the Act as a statutory response to informational privacy, not as proof that every constitutional privacy concern is solved.
...
[LIMIT] This package makes no claim about the later review/reference's 2026 hearing or final status because that was not independently secured from a primary source for this export.
...
| State-recognised or State-aided | instruction/worship cannot be compelled without consent |
...
| BNS section 152, operative 1 Jul 2024 | different successor ingredients focused on secession/rebellion/subversion/separatism/sovereignty | not called a simple renaming; no unverified final constitutional judgment |
| DPDP Act, 2023 | enacted statutory informational-privacy framework | no unverified DPDP Rules or commencement claim |
...
| equality vs exploitation | untouchability is Article 17 in equality; begar is Article 23 |
...
## PART III - Solved verified previous-year questions
...
**Explanation:** Article 17 lies within Articles 14-18, the Right to Equality. Article 23, not Article 17, addresses begar and forced labour.
...
> Correct options rotate strictly A -> B -> C -> D, repeated nine times.
...
## PART V - Remedial MCQs for recurring errors

> This separate remedial set also rotates A -> B -> C -> D.
...
### R9. A candidate writes, "Article 27 prevents government from collecting any fee connected with a pilgrimage or religious institution." The correction is:
...
### R10. A student writes, "Article 29 is only for minorities and Article 30 prevents all regulation." The best correction is:
...
### R11. A candidate writes, "A Ninth Schedule law cannot be reviewed by any court." The correction is:
...
### R12. A student states, "Article 359 suspends the Fundamental Right itself, including Articles 20 and 21." The correct position is:
...
## PART VI - Original Mains practice with examiner-grade model answers
...
## Final consolidated register notes - Fundamental Rights
...
- DPDP Act 2023: statutory data framework; no unverified Rules claim.
...
- Article 23: trafficking, begar, similar forced labour; State/private; all persons.
...
- Sabarimala 2018 majority stated; no unverified 2026 hearing/final claim.
