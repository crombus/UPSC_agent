# Polity 04 - Preamble - Complete Topic Package
...
- [FACT] directly supported by the repository Core/Advanced Preamble owners, locally OCR-searchable M. Laxmikanth Chapter 4, the constitutional text itself, the official Supreme Court judgment PDF, or verbatim UPSC question papers held locally.
- [ANALYSIS] exam-oriented synthesis, inference or answer strategy built on those facts.
- [LIMIT] an ownership, status or interpretive boundary that must not be crossed in an answer.
- Source order actually followed: (1) `upsc-ai-kit/knowledge/Polity/basic/Preamble.md` and `advanced/04_Preamble.md`; (2) locally OCR-searchable `books/Indian Polity by M Laxmikant.pdf`, Chapter 4, and the local official UPSC Prelims and Mains paper PDFs read verbatim; (3) the official Supreme Court judgment PDF in *Dr Balram Singh v. Union of India* for the live status control; (4) Qdrant was treated as optional and was not used, and it did not block or delay this package.
- Ownership boundaries respected: the full doctrine of basic structure and Article 368 procedure belongs to the Amendment topic; the sociology of communalism and religious conversion belongs to Indian Society; detailed comparison of foreign constitutions belongs to the comparative-polity topic; the Directive Principles' welfare content belongs to the DPSP topic. This package uses those only to the depth a Preamble answer requires.
- Provenance discipline: every PYQ below is marked either **verbatim-verified** (read directly out of a local official paper PDF) or **routing-ledger sourced** (carried from the repository's audited PYQ routing files). Where an official Prelims answer key is not held locally, the solution is labelled `INFERRED ANSWER - NOT OFFICIALLY VERIFIED` with confidence and full elimination logic.
- Original visual assets: 12 deterministic, fact-checked PNG schematics under `notes/Polity/assets/04_Preamble/`, all rendered compact so that no page is occupied by a single isolated diagram.
...
![Objectives Resolution to Preamble: how the promise became text](../../../notes/Polity/assets/04_Preamble/02_objectives_resolution_to_preamble.png)
...
![Preamble: the four-ingredient architecture](../../../notes/Polity/assets/04_Preamble/01_four_ingredient_architecture.png)
...
## 6. Sovereign
![Sovereign: what the word does and does not concede](../../../notes/Polity/assets/04_Preamble/09_sovereignty_dimensions.png)
...
## 8. Secular
![Indian positive secularism against the American wall of separation](../../../notes/Polity/assets/04_Preamble/10_secular_models_india_us.png)
...
![The value chain: justice, liberty, equality, fraternity as a union of trinity](../../../notes/Polity/assets/04_Preamble/08_value_chain_trinity.png)
...
![Legal status of the Preamble: Berubari to Kesavananda to LIC to 2024](../../../notes/Polity/assets/04_Preamble/04_legal_status_timeline.png)
...
![How the Preamble actually bites: interpretive force without justiciability](../../../notes/Polity/assets/04_Preamble/06_interpretive_force_mechanism.png)
...
![Amendment power and the basic-structure boundary around the Preamble](../../../notes/Polity/assets/04_Preamble/05_amendment_basic_structure_boundary.png)
...
![Socialism and secularism: the challenge-and-reply matrix](../../../notes/Polity/assets/04_Preamble/07_socialism_secularism_debate_matrix.png)
...
![GS-II answer spine for any Preamble question](../../../notes/Polity/assets/04_Preamble/11_gs2_answer_spine.png)
...
This is the complete practice block for the Preamble. Work it in the order given: verified previous-year questions first, so that the examiner's actual framing is fixed in mind; then the two hard MCQ loops, which between them touch nearly every subtopic taught above; then the remedial set, which drills only the errors that recur; and finally the original Mains practice with full model answers. Every model answer follows the pattern **claim, named evidence, analysis, qualification**, and each carries a `Why this earns marks` note so the scoring logic is visible rather than assumed.

## PART II - Solved verified previous-year questions
...
Twenty-four questions across two loops, covering nearly every subtopic taught in Part I. Attempt a full loop before checking any answer.

### Q1. Consider the following statements about the Objectives Resolution.
...
### Q2. The Preamble was voted upon and enacted after the rest of the Constitution had been enacted. The principal constitutional reason was that
...
### Q3. Which one of the following most accurately states the holding of the Berubari Union case (1960) on the Preamble?
...
### Q4. The Preamble to the Constitution of India can most accurately be described as
...
### Q5. Which of the following were inserted into the Preamble by the Constitution (Forty-second Amendment) Act, 1976?
1. Socialist
2. Secular
3. Integrity
4. Fraternity
...
### Q6. What was the exact constitutional description of India in the Preamble as it stood on 26 January 1950?
...
### Q7. Consider the following pairs of Preamble ideals and their acknowledged historical source.
...
### Q8. The Preamble secures to citizens liberty of which of the following?
1. Thought
2. Expression
3. Association
...
### Q9. Consider the following statements regarding India's sovereignty.
...
### Q10. Cession of Indian territory to a foreign State, as the Berubari episode established, requires
...
### Q11. Which of the following are devices of direct democracy that India has NOT adopted?
1. Referendum
2. Initiative
3. Recall
4. Plebiscite
...
### Q12. The term "Republic" in the Preamble implies which of the following?
...
### Q13. In the context of the Preamble, "distributive justice" refers to the combination of
...
### Q14. Consider the following pairs of the equality dimension and its principal constitutional anchor.
...
### Q15. Consider the following statements about fraternity in the Preamble.
...
### Q16. With reference to the amendability of the Preamble, which one of the following is correct?
...
### Q18. In *Dr Balram Singh v. Union of India* (2024), the Supreme Court held with respect to the word "socialist" in the Preamble that it
...
### Q19. Which one of the following statements best reflects the Supreme Court's 2024 characterisation of Indian secularism?
...
### Q20. Consider the following pairs of description and author.
...
### Q21. Which of the following are features of Indian secularism that distinguish it from the American model?
...
### Q22. Consider the following statements about the socialist character of the Indian State.
...
### Q23. The Preamble exerts legal force principally through which of the following routes?
...
### Q24. Consider the following pairs of date and event.
...
## PART III(B) - Remedial MCQs
These eight questions target only the errors that recur most often. Attempt them after checking the loops above.

### R1. A candidate writes that "the Preamble has been amended twice - in 1976 and again by the 44th Amendment, 1978". The correct position is that the Preamble has been amended
...
### R2. A candidate writes that "the Preamble declares the ideal of a Welfare State". The correct position is that the welfare-State ideal is declared by
...
### R3. A candidate writes that "because the Preamble is now a part of the Constitution, its clauses can be enforced in court like Fundamental Rights". The correct position is that
...
### R4. A candidate writes that "Indian secularism means the State must keep entirely out of religion". The correct position is that Indian secularism
...
### R5. A candidate writes that "the Preamble guarantees liberty of thought, expression, belief, faith, worship and association". The error is that
...
### R6. A candidate writes that "the Preamble was the first part of the Constitution to be adopted, as its opening statement of intent". The correct position is that the Preamble was
...
### R7. A candidate writes that "the 2024 Supreme Court decision struck down the insertion of 'socialist' and 'secular'". The correct position is that the Court
...
### R8. A candidate writes that "the Preamble's ideals of Justice, Liberty, Equality and Fraternity were all drawn from the French Revolution". The correct position is that
...
## PART IV - Original Mains practice with examiner-grade model answers
![GS-II answer spine for any Preamble question](../../../notes/Polity/assets/04_Preamble/11_gs2_answer_spine.png)
*Use the spine to choose the branch, then write to the mark scale below.*

### OQ1. The Preamble is a part of the Constitution, yet it confers no power and bars none. Examine. (10 marks, 150 words)
