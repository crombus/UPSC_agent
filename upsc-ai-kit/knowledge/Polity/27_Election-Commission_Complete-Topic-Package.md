---
title: Polity 27 - Election Commission - Complete Topic Package
subject: Polity
gs_paper: GS-II
...
## 01. Why an independent election manager is constitutionally necessary
...
## 02. Article 324: exact field of control
...
## 03. Part XV master map: Articles 324-329
...
## 04. ECI versus State Election Commission
...
## 06. Composition under the Constitution and the 2023 Act
...
## 07. Current collegial composition
...
## 09. Appointment before and after *Anoop Baranwal*
...
## 10. The 2023 Act: official-title and section map
...
## 11. Eligibility under section 5
...
## 12. Search Committee under section 6
...
## 13. Selection Committee under sections 7 and 8
...
## 14. Appointment debate and current challenge
...
## 16. Salary and service conditions
...
## 17. Removal: CEC, EC and Regional Commissioner
...
## 19. Protection under section 16
...
## 20. Election administration: constitutional body, distributed machinery
...
## 21. Schedule and notification: distinguish announcement from legal notification
...
## 22. Electoral rolls: constitutional equality plus statutory eligibility
...
## 23. Qualifying dates and enrolment controls
...
## 24. Roll-revision answer discipline
...
## 25. Delimitation: ECI assists; it is not the ordinary sole delimiting authority
...
## 26. The 2024 Prelims fact: four Delimitation Commissions
...
## 27. Candidate nominations and scrutiny
...
## 28. Advising on disqualification
...
## 29. Observers and field neutrality
...
## 30. Election expenditure monitoring
...
## 31. Repoll, adjournment and countermand: lawful powers only
...
## 32. Voter education and inclusion
...
## 33. Registration of political parties versus recognition
...
## 35. Model Code of Conduct: origin and evolution
...
## 38. MCC enforcement strengths and limits
...
## 39. EVM-VVPAT: functional architecture
...
## 40. 2024 Supreme Court EVM-VVPAT control
...
## 41. How to discuss technology without amplifying unsupported claims
...
## 42. Article 324 plenary power: the correct doctrine
...
## 43. Natural justice in election administration
...
## 45. NOTA: right not to choose, not a right to reject the result
...
## 46. Candidate disclosure and political-finance transparency
...
## 47. Article 329 and the election-dispute boundary
...
## 48. President and Vice-President election boundary
...
## 49. Independence safeguards and deficits
...
## 50. Budget and charged-expenditure nuance
...
## 51. Equal removal protection debate
...
## 53. Enforcement-accountability reform
...
## 54. Electoral-roll reform options
...
## 56. Technology and audit reform
...
## 57. What the ECI cannot lawfully do
...
## 58. Integrated answer-writing framework
...
## Polity 27 - Election Commission - PYQ, practice and solved workbook

[FACT] This practice section begins at an H2 deliberately so that `markdown_learning_pdf.py --mode workbook` detects it. It contains every Election Commission demand directly routed in the local ledgers, two routed Prelims demands, 36 original MCQs, 12 remedials and eight original solved Mains questions.

[LIMIT] Exact wording is reproduced only from a readable locally held official paper or an exact quotation already preserved in the local owner. Where the ledger stores a neutral rendering, that status is explicit.
...
D. Election to a cooperative society
...
A. all residence requirements for enrolment.  
B. every electoral disqualification.  
C. exclusion from or claim to a special roll only on religion, race, caste or sex.  
D. Parliament from making election law.
...
A. Article 324 fixes a six-year term.  
B. Article 324 fixes retirement at 65.  
C. The Constitution mandates exactly two ECs.  
...
C. fixed by the Chief Justice of India.  
D. fixed by each State legislature.
...
C. prior service as a Returning Officer in three elections.  
D. a constitutional-law doctorate.
...
A. can only accept the first-ranked panel name.  
B. must return the panel if the LoP dissents.  
C. may consider a person outside the Search Committee panel.  
D. must disclose its vote publicly before appointment.
...
A. the candidate lacks section 5 eligibility.  
B. the President did not issue a warrant.  
C. there was no Selection Committee recommendation.  
...
B. a fresh six-year CEC term automatically begins.  
C. retirement age rises to 68.  
D. reappointment is permitted once.
...
B. The CEC serves during presidential pleasure.  
C. The CEC has the SC-judge route; another EC requires the CEC's recommendation.  
D. Regional Commissioners have no removal protection.
...
B. the CEC's view automatically prevails.  
C. the matter must remain undecided.  
...
A. The MCC waits until polling begins.  
B. Returning Officers independently choose national dates.  
C. ECI announces the schedule, while statutory notifications form part of the legal election process.  
D. Courts announce the timetable.
...
A. deletion accuracy alone defines integrity.  
B. inclusion alone defines integrity.  
C. aggregate numbers matter more than individual remedy.  
...
C. applies only to local elections.  
D. makes citizenship irrelevant.
...
C. has no connection with delimitation.  
D. may disregard final delimitation orders.
...
A. Registration automatically creates national-party status.  
...
D. Recognition is decided by Parliament resolution.
...
B. Parliament enacted the MCC in 1960.  
C. the Supreme Court wrote the entire MCC in 1968.  
D. the MCC began only after EVMs.
...
A. on filing of the first nomination.  
...
A. Every MCC breach is automatically a criminal offence.  
B. The MCC has no enforceable consequence of any kind.  
C. The MCC is non-statutory, but overlapping conduct may violate penal/election law.  
D. Only the Supreme Court may enforce it.
...
A. abolish all rapid directions.  
B. criminalise every campaign disagreement.  
C. make decisions secret to avoid controversy.  
...
B. a paper receipt for the voter to take home.  
C. online publication of each vote.  
D. automatic recount of every constituency.
...
A. ordered return to paper ballots.  
B. retained EVM-VVPAT and added SLU/microcontroller safeguards.  
C. ordered 100% VVPAT counting.  
D. found systematic tampering.
...
A. any voter at any time.  
B. only the winning candidate.  
C. candidates placed second or third, within the prescribed seven-day period.  
D. only a High Court after an election petition.
...
A. NOTA is ignored and not counted.  
B. NOTA is a candidate.  
...
C. permanent immunity from judicial review.  
D. ECI trial of election petitions.
...
A. may ignore Conduct of Election Rules.  
B. supplements but cannot supplant an occupied statutory field.  
C. can create criminal offences by instruction.  
D. controls local-body elections.
...
A. the ECI.  
B. the District Election Officer.  
C. the High Court.  
D. Parliament's privileges committee.
...
A. Removal protection alone guarantees independence.  
B. Appointment alone determines every outcome.  
...
B. power to veto both ECs.  
C. power to remove ECs directly.  
D. exclusive power to allocate every symbol.
...
A. only through the same parliamentary address as the CEC.  
B. only on the CEC's recommendation.  
C. at the Prime Minister's pleasure.  
D. by majority vote of the Commission.
...
A. The Search Committee appoints the CEC.  
B. The President prepares the five-name panel.  
C. The Search Committee prepares a panel; the Selection Committee recommends.  
D. The Supreme Court confirms the appointment.
...
A. Every ECI expense is constitutionally charged because salary equals an SC judge's.  
B. Article 322 directly covers ECI.  
C. Demand No. 66 proves permanent constitutional charging.  
...
B. automatic mass deletion.  
C. postponement of all elections.  
...
A. may replace it with Y whenever administratively convenient.  
B. may disregard it during a close election.  
C. must seek the CJI's permission.  
...
A. The Supreme Court has finally upheld section 7.  
...
D. *Anoop Baranwal* permanently bars parliamentary law.
...
A. accusation -> slogan -> prediction.  
