# Concept of the Constitution — CORE / EXAM-COMPLETE
...
> **Status legend:** ✅ constitutional/textual or settled static fact · 📜 statute/rule ·
> ⚖️ judicial holding · 🧾 non-binding recommendation · ⚠️ analytical inference.
...
|---|---|---|
| Defines the political community | Who governs whom and within what territory? | ✅ "India, that is Bharat, shall be a Union of States" (Art 1) |
| Creates institutions | Establishes legislature, executive and judiciary | ✅ Parts V and VI |
| Allocates power | Horizontal and territorial distribution | ✅ Arts 73/162; Arts 245–255; Seventh Schedule |
| Limits government | Rights, procedures and judicial review | ✅ Part III; Arts 13, 32 and 226 |
| Expresses identity and values | Political morality and collective purpose | ✅ Preamble |
| States duties and goals | Directs public action and civic responsibility | ✅ Parts IV and IVA |
| Manages change | Preserves continuity while permitting reform | ✅ Art 368 plus other amendment routes |
| Resolves conflict | Supplies authoritative institutions and rules | ✅ Courts, federal provisions and constitutional remedies |

⚠️ A constitution therefore performs both a **constitutive** function—creating power—and a
...
✅ In India, constitutional supremacy means Parliament is **not sovereign in the British sense**.
...
| **Mixed** | Different provisions use different procedures | ✅ India: simple majority, special majority, and special majority plus half-State ratification |
...
✅ India combines federal division with strong Union features. Use **federal with a centralising or
...
- A **prescriptive constitution** also commits the State to substantive social, economic or
  developmental goals.
- ✅ India combines both: institutional procedure and rights coexist with the Preamble, DPSPs and
...
⚠️ The key design tension is **stability versus adaptability**. India's differentiated amendment
system and judicial interpretation allow change while the basic structure protects constitutional
identity.

---

## 6. Constitutionalism and constitutional government
...
✅ The Indian mechanisms include the Preamble, Fundamental Rights, parliamentary responsibility,
federal division, judicial review, independent constitutional bodies and amendment limits.

⚠️ Constitutional government means more than government acting **under the words** of a
...
- **Claim:** a constitution both constitutes and limits power. **Evidence:** ✅ Arts 79/124 create
...
- **Claim:** India is neither wholly rigid nor wholly flexible. **Evidence:** ✅ Art 368 and the
...
- **Claim:** a constitution does not guarantee constitutionalism. **Evidence:** ⚠️ legal powers can
...
- ✅ India has an **enacted, codified and supreme** Constitution.
- ✅ It combines rigidity and flexibility through differentiated amendment procedures.
- ✅ Constitutionalism means **limited government**, not merely government according to a document.
- ✅ Federal/unitary classification concerns territorial distribution of power; parliamentary/
  presidential classification concerns the executive-legislature relationship.
- ✅ A convention is constitutionally relevant but not automatically judicially enforceable.
- ⚖️ Basic structure limits the amending power; it is not an express list in the Constitution.
- ⚠️ Constitution-making, constitutional law and day-to-day constitutional practice are related but
  distinct levels.
...
- Write separately: ✅ "the Constitution provides"; 📜 "the Act/rule provides"; ⚖️ "the Court
  held"; 🧾 "the commission recommended"; ⚠️ "this implies".
