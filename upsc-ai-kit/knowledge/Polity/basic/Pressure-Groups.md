# Pressure Groups — BASIC

> **Subject:** Polity · **Tier:** Basic (foundation) · **GS-II / GS-I**
> ✅ = from book · 📰 = current link · 🔑 = mnemonic. *Deep dive → `advanced/44_Pressure-Groups.md`.*
...
> 🔑 **Party vs Pressure group:** parties **capture power**; pressure groups **influence** it.
> 🔑 Odegard: **E-L-P → Electioneering · Lobbying · Propagandizing**.
> 🔑 **Anomic** groups (Almond & Powell) = **spontaneous** (riots, ULFA, JKLF).
