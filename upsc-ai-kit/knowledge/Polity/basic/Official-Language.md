...
> ✅ = from book · 📰 = current link · 🔑 = mnemonic. *Deep dive → `advanced/40_Official-Language.md`.*
...
> 🔑 SC/HC + authoritative laws = **English**; HC *proceedings* can be Hindi (Governor + President's nod), **not judgments**.
...
- ✅ **Art 351:** Centre's duty to promote Hindi as the lingua franca.
