...
# PART A — THE HIGH COURT (Art 214–231)
...
no minimum age). Oath before the **Governor**. Retires at **62** (SC = 65). Removal = **same as SC** (special
majority, Judges Enquiry Act 1968). Also vacates on elevation to SC or **transfer to another HC**. ⚠️ A judge
can be **transferred** by the President (after consulting CJI).
...
# PART B — SUBORDINATE COURTS (Art 233–237) ⭐
✅ Structure laid down by **states**; broadly **three tiers** below the HC:
...
## UPSC Traps
- ❌ There are 25 HCs, one per state → **25 HCs** but some are **common** to 2+ states/UTs (not 1-per-state).
- ❌ A "distinguished jurist" can be an HC judge → **only for the SC**, not HC.
- ❌ HC judge retires at 65 → **62** (SC = 65).
- ❌ HC writ jurisdiction is narrower than SC's → **wider** (Art 226 covers FRs **and** other purposes).
- ❌ HC judge takes oath before the President → before the **Governor**.
- ❌ District judge is appointed by the HC → by the **Governor in consultation with the HC** (Art 233).
