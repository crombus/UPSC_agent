...
![Topic-specific visual map: Snapshot.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/01_snapshot.png)
| Item | Fact |
|---|---|
...
![Topic-specific visual map: Core idea.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/02_core_idea.png)
...
![Topic-specific visual map: Current link.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/03_current_link.png)
...
![Topic-specific visual map: 5.1 Demand and directive map.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/04_5_1_demand_and_directive_map.png)
...
![Topic-specific visual map: 5.3 Mark-scaled structures.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/05_5_3_mark_scaled_structures.png)
...
### 09. 5.4 Bank A — The constitutional interface of foreign policy (Claim → provision → mechanism → limitation)
...
### 10. 5.5 Bank B — Treaty-making power and the oversight critique
...
The decisive contrast is between Constitutional rule and Constitutional rule.
The exam-safe limitation is that constitutional rule.
![Topic-specific visual map: 5.5 Bank B — Treaty-making power and the oversight critique.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/06_5_5_bank_b_treaty_making_power_and_the_oversight_cri.png)
...
### 11. 5.6 Bank C — Territory, boundaries and integration by reorganisation
...
### 12. 5.7 Bank D — Institutions and duties of integration
...
The decisive contrast is between Constitutional rule and Constitutional rule.
The exam-safe limitation is that constitutional rule.
![Topic-specific visual map: 5.7 Bank D — Institutions and duties of integration.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/07_5_7_bank_d_institutions_and_duties_of_integration.png)
...
### 13. 5.8 Bank E — Integration as assimilation vs accommodation (the analytical core)
...
### 14. 5.9 Mechanism, incentives and consequences
...
The decisive contrast is between Constitutional rule and Constitutional rule.
The exam-safe limitation is that constitutional rule.
![Topic-specific visual map: 5.9 Mechanism, incentives and consequences.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/08_5_9_mechanism_incentives_and_consequences.png)
...
### 15. 5.10 Criticism, counter-argument and variation
...
The decisive contrast is between Constitutional rule and Constitutional rule.
The exam-safe limitation is that constitutional rule.
![Topic-specific visual map: 5.11 Verdict scaffolds.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/09_5_11_verdict_scaffolds.png)
...
### 17. 5.12 Prelims close-option distinctions
...
![Topic-specific visual map: 5.13 Factual-risk and current-status controls.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/10_5_13_factual_risk_and_current_status_controls.png)
...
### 19. National-integration challenge map without security sensationalism
...
![Topic-specific visual map: National-integration challenge map without security sensationalism.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/11_national_integration_challenge_map_without_security_.png)
...
### 20. Foreign-policy doctrine and the integration link
...
![Topic-specific visual map: Foreign-policy doctrine and the integration link.](../../../../../../notes/Polity/assets/45_National-Integration-and-Foreign-Policy/12_foreign_policy_doctrine_and_the_integration_link.png)
DOCTRINE RAIL
...
- A. Unity and integrity operate with justice, liberty, equality and fraternity.
- B. Integrity overrides every Fundamental Right.
...
- A. Single citizenship coexists with federal distribution, linguistic States and asymmetric provisions.
- B. Federalism requires dual citizenship.
- C. Asymmetry is necessarily anti-national.
...
- A. Articles 29 and 30 protect cultural and educational interests within the integrative constitutional order.
- B. Minority rights are exceptions to citizenship.
- C. Article 30 creates secession rights.
- D. Only linguistic majorities can establish institutions.
...
- A. Article 51 is a non-justiciable DPSP on peace, international law and arbitration.
- B. It gives courts a power to ratify treaties.
...
- A. Article 73 supports Union executive action; Article 253 enables Parliament to implement international obligations even in State fields.
- B. Treaties automatically amend every domestic law.
- C. States ratify Union treaties under Article 253.
...
- A. Berubari Union (1960) requires constitutional amendment for cession, while boundary settlement without cession is distinct.
- B. Article 3 alone cedes territory abroad.
- C. Every boundary clarification needs Article 368.
- D. The executive may cede territory by press release.
...
- A. Panchsheel and non-alignment are historical policy principles, not enforceable constitutional commands.
- B. Panchsheel is in the Seventh Schedule.
...
- A. Diaspora, development and climate diplomacy connect external policy with domestic rights, economy and federal implementation.
- B. Diaspora members are governed only by Indian law abroad.
- C. Climate commitments automatically override statutes.
...
- A. Borders, sovereignty, diaspora and treaty effects make national integration and foreign policy mutually connected.
- B. Foreign policy is unrelated to federalism.
- C. National integration is only an internal-security subject.
- D. Border communities have no constitutional interests.
...
- A. National integration combines equal citizenship, constitutional loyalty, fraternity and accommodation of diversity.
- B. It is identical to territorial conquest.
- C. It suspends minority rights.
- D. It requires cultural uniformity.
...
- A. Unity and integrity operate with justice, liberty, equality and fraternity.
- B. Fraternity is only a foreign-policy doctrine.
...
- C. State boundaries are constitutionally indestructible.
...
- D. Minority rights are exceptions to citizenship.
...
- C. It fixes India's alliances.
- D. It gives courts a power to ratify treaties.
...
- C. Article 73 abolishes parliamentary accountability.
...
- D. Article 3 alone cedes territory abroad.
...
- A. Panchsheel and non-alignment are historical policy principles, not enforceable constitutional commands.
- B. NAM requires neutrality in every conflict.
...
- C. States have treaty-making competence.
...
- D. Foreign policy is unrelated to federalism.
