...
- [CURRENT] **Live official refresh, 5 September 2026:** The CAG's DPC Act, Audit Regulations, Auditing Standards, performance-audit guidance, CDMA page and parliamentary committee routes were rechecked on 5 September 2026. Current reports are examples only; the current officeholder is K. Sanjay Murthy from 21 November 2024; no volatile report count or headline loss figure is frozen.
...
![Topic-specific visual map: Why does a constitutional democracy need public audit?.](../../../../../../notes/Polity/assets/32_CAG/01_why_does_a_constitutional_democracy_need_public_audi.png)
...
![Topic-specific visual map: Constitutional architecture: Articles 148-151.](../../../../../../notes/Polity/assets/32_CAG/02_constitutional_architecture_articles_148_151.png)
...
![Topic-specific visual map: Appointment, oath, tenure, resignation and removal.](../../../../../../notes/Polity/assets/32_CAG/03_appointment_oath_tenure_resignation_and_removal.png)
...
![Topic-specific visual map: Independence: design strengths and operational limits.](../../../../../../notes/Polity/assets/32_CAG/04_independence_design_strengths_and_operational_limits.png)
...
![Topic-specific visual map: “Comptroller” or auditor? The audit-account-control distinction.](../../../../../../notes/Polity/assets/32_CAG/05_comptroller_or_auditor_the_audit_account_control_dis.png)
...
![Topic-specific visual map: DPC Act map: duties, powers and audit reach.](../../../../../../notes/Polity/assets/32_CAG/06_dpc_act_map_duties_powers_and_audit_reach.png)
...
![Topic-specific visual map: Audit types: legal foundation, purpose and limits.](../../../../../../notes/Polity/assets/32_CAG/07_audit_types_legal_foundation_purpose_and_limits.png)
...
![Topic-specific visual map: Government companies and statutory corporations.](../../../../../../notes/Polity/assets/32_CAG/08_government_companies_and_statutory_corporations.png)
...
![Topic-specific visual map: Public-private nexus and controlled judicial doctrine.](../../../../../../notes/Polity/assets/32_CAG/09_public_private_nexus_and_controlled_judicial_doctrin.png)
...
![Topic-specific visual map: From audit finding to legislative accountability.](../../../../../../notes/Polity/assets/32_CAG/10_from_audit_finding_to_legislative_accountability.png)
...
![Topic-specific visual map: Local bodies, Finance Commissions and public audit.](../../../../../../notes/Polity/assets/32_CAG/11_local_bodies_finance_commissions_and_public_audit.png)
...
![Topic-specific visual map: Limits, reforms and current digital controls.](../../../../../../notes/Polity/assets/32_CAG/12_limits_reforms_and_current_digital_controls.png)
...
C. by Parliament through a joint resolution  
...
A. Article 148 itself fixes five years  
B. Article 149 fixes six years without an age limit  
C. Section 4 of the DPC Act fixes six years or age 65, whichever is earlier  
D. tenure continues during the President's pleasure
...
A. may become a Governor but not a Union Minister  
B. may accept a State post after a cooling-off period  
C. may hold another office if Parliament approves  
...
B. by the President on Cabinet advice without legislative action  
C. by a simple majority of the Lok Sabha  
D. by the Chief Justice of India after inquiry
...
A. only State contingency grants and private deposits  
B. only Consolidated Fund withdrawals  
C. municipal social audits and cooperative elections  
...
C. Rs 1 crore with no proportion test in every case  
D. any amount approved by the PAC
...
A. election expenditure of political parties  
B. procedures by which a sanctioning authority assures compliance with specific-purpose grant/loan conditions  
C. every transaction of an unfinanced private company  
D. the constitutional validity of taxation
...
A. receipts of private associations unrelated to government  
B. only GST Council recommendations  
...
A. authority to inspect relevant offices  
B. power to call for relevant documents  
C. power to seek information from responsible officers  
...
C. the auditor's preferred policy  
D. only accounting estimates
...
A. equality, entitlement and enforcement  
B. economy, equity and ethics  
C. economy, efficiency and effectiveness  
D. evidence, enforcement and expenditure
...
A. propriety audit is prohibited by the DPC Act  
B. propriety audit lets CAG choose policy for the government  
C. propriety and legality are identical  
...
B. PAC  
C. the Finance Ministry without CAG involvement  
D. CoPU
...
C. Section 15 of the DPC Act alone  
D. Article 324
...
A. a universal identical model for all corporations  
B. private agreement alone  
C. its governing legislation read with DPC Act Section 19(2)  
D. a PAC resolution creating jurisdiction
...
A. no consultation with CAG  
B. automatic application to all NGOs  
C. only a newspaper allegation  
...
B. audit every private company for every purpose  
C. replace TRAI as sector regulator  
D. impose licence penalties directly
...
A. abolished performance audit  
B. upheld CAG examination of economy, efficiency and effectiveness  
C. made every CAG recommendation binding  
D. created a collegium for CAG appointment
...
A. a CAG report has no public value  
B. PAC must accept every audit paragraph  
C. a CAG report commands respect but is subject to parliamentary scrutiny and is not automatically final proof  
D. courts may never read a CAG report
...
A. the voting chairperson  
B. a ministerial representative  
...
A. CAG is automatically the sole primary auditor of every local body  
...
D. social audit is identical to CAG audit
...
A. appointing local auditors  
B. directly levying municipal tax  
C. replacing State Finance Commissions  
...
B. the CAG from all legislative scrutiny  
C. every audit recommendation from rejection  
D. every State local-fund auditor
...
C. a private statutory auditor association  
...
A. field audit has legally ceased  
...
B. allow CAG to stop any policy it dislikes  
C. transfer PAC's conclusions to CAG  
...
B. appointment by presidential warrant  
C. no further government office  
...
A. Section 14 automatically covers every PPP  
B. any grant amount creates permanent CAG jurisdiction  
C. Section 14 uses statutory finance tests and applicable-law qualifications  
D. Section 14 concerns only tax receipts
...
C. a presidential-election dispute  
D. no audit concern
...
A. whether the auditor prefers a different ideology  
B. economy, efficiency, effectiveness and implementation/results  
C. criminal guilt beyond reasonable doubt  
...
A. PAC appoints the company auditor  
...
D. government companies are outside public audit
...
A. public-resource revenue accountability  
B. verification of licence-fee revenue share  
C. audit access tied to Consolidated-Fund receipts  
...
B. CAG votes in PAC  
C. PAC cannot hear a ministry response  
...
A. automatic abolition of State local-fund auditors  
B. standards, training, test checks and quality support under applicable arrangements  
C. direct CAG control over local elections  
...
A. an alternate executive controlling policy  
B. a court whose reports are decrees  
C. a private financial consultant  
