---
title: Polity 36 - CIC and SIC - Complete Topic Package
subject: Polity
gs_paper: GS-II
...
### 01. Identity: constitutional right, statutory machinery
...
![Topic-specific visual map: Identity: constitutional right, statutory machinery.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/01_identity_constitutional_right_statutory_machinery.png)
...
### 02. The RTI vocabulary that controls every answer
...
![Topic-specific visual map: The RTI vocabulary that controls every answer.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/02_the_rti_vocabulary_that_controls_every_answer.png)
...
### 03. Section 4: transparency before a citizen asks
...
![Topic-specific visual map: Section 4: transparency before a citizen asks.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/03_section_4_transparency_before_a_citizen_asks.png)
...
### 04. The access route: PIO, SPIO and APIO
...
### 05. Transfer, time, fee and deemed refusal
...
![Topic-specific visual map: Transfer, time, fee and deemed refusal.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/04_transfer_time_fee_and_deemed_refusal.png)
...
### 06. Four routes that candidates must not flatten
...
![Topic-specific visual map: Four routes that candidates must not flatten.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/05_four_routes_that_candidates_must_not_flatten.png)
...
### 07. CIC composition and appointment
...
![Topic-specific visual map: CIC composition and appointment.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/06_cic_composition_and_appointment.png)
...
### 08. SIC composition and appointment
...
![Topic-specific visual map: SIC composition and appointment.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/07_sic_composition_and_appointment.png)
...
### 09. Eligibility and disqualifications
...
### 10. The 2019 amendment: Act versus delegated rules
...
![Topic-specific visual map: The 2019 amendment: Act versus delegated rules.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/08_the_2019_amendment_act_versus_delegated_rules.png)
...
### 11. Pay and service conditions under the 2019 Rules
...
### 12. Removal, direct grounds and suspension
...
![Topic-specific visual map: Removal, direct grounds and suspension.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/09_removal_direct_grounds_and_suspension.png)
...
![Topic-specific visual map: Section 18 inquiry powers.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/10_section_18_inquiry_powers.png)
...
### 14. Section 19 appellate powers and binding force
...
![Topic-specific visual map: Section 19 appellate powers and binding force.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/11_section_19_appellate_powers_and_binding_force.png)
...
### 15. Penalty, compensation and disciplinary recommendation
...
![Topic-specific visual map: Penalty, compensation and disciplinary recommendation.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/12_penalty_compensation_and_disciplinary_recommendation.png)
...
### 16. Exemptions: sections 8 and 9
...
![Topic-specific visual map: Exemptions: sections 8 and 9.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/13_exemptions_sections_8_and_9.png)
...
### 17. Sections 10 and 11: severability and third-party procedure
...
### 18. Section 24 security organisations and section 22 override
...
![Topic-specific visual map: Section 24 security organisations and section 22 override.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/14_section_24_security_organisations_and_section_22_ove.png)
...
### 20. Constitutional privacy after the textual change
...
### 21. Case law: exact proposition and caution
...
![Topic-specific visual map: Case law: exact proposition and caution.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/15_case_law_exact_proposition_and_caution.png)
...
### 22. Independence and accountability: the real institutional test
...
![Topic-specific visual map: Answer-writing frameworks.](../../../../../../notes/Polity/assets/36_CIC-and-SIC/16_answer_writing_frameworks.png)
...
B. A constitutional court for transparency disputes  
C. An executive grievance portal  
D. A tribunal created under Article 323B
...
A. Compelling a department to create a new expert report  
B. Requiring a minister to answer a hypothetical question  
C. Taking certified samples of material  
D. Ordering the grant of a service entitlement
...
B. performing any socially useful work  
C. receiving one minor government grant  
...
B. exempt all Cabinet material permanently  
C. replace the PIO system with social audit  
D. authorise the Commission to legislate disclosure rules
...
A. shortens the period by five days  
B. adds five days in computing the response period  
C. converts it into a first appeal  
...
A. within 48 hours in all cases  
B. within 30 days  
C. as soon as practicable and not later than five days  
D. only after CIC approval
...
A. the application lapses  
B. the applicant must pay a higher copying fee  
C. only a section 18 complaint is possible  
...
A. the applicant  
B. the third party in every case  
C. the PIO who denied the request  
D. the Commission registry
...
A. section 18 was repealed  
B. complaints can never trigger penalty  
C. first appeals are optional in every case  
...
C. eleven members apart from the Chief  
D. a Chief and unlimited commissioners
...
A. five years for Central and three for State  
B. six years  
...
A. Rs 2,50,000  
B. Rs 2,25,000  
C. whatever the State Cabinet chooses case by case  
...
A. by the President after a High Court inquiry  
B. by the Chief Minister without inquiry  
...
B. the Prime Minister alone suspends  
C. suspension is constitutionally impossible  
D. the Lok Sabha Speaker suspends
...
A. A decision adverse to government  
...
B. strike down section 8  
C. summon witnesses and require evidence on oath  
D. execute compensation as a civil decree
...
A. Amending the RTI Act  
B. Sentencing a public servant  
C. Granting the underlying pension  
...
B. Parliament  
C. the public authority as a corporate fine  
D. the applicant
...
A. an absolute exemption for all third-party records  
B. a privacy chapter overriding section 8(2)  
C. a veto vested in every third party  
...
C. third-party consent in every request  
...
C. is decided only by Parliament  
D. must be supplied in 48 hours
...
A. the old public-activity/unwarranted-invasion formulation  
B. the Parliament-parity proviso only  
...
B. Every binding body is a constitutional court.  
C. CIC is an executive committee.  
D. CIC is a tribunal under Article 323A.
...
A. “Why did you personally dislike my representation?”  
B. “Provide the recorded file noting and order on my representation.”  
C. “Create a new comparative policy study.”  
D. “Sanction my claim immediately.”
...
A. The Commission can summon witnesses during a section 18 inquiry.  
B. The Commission can direct disclosure in second appeal.  
C. The Commission can compensate loss under section 19(8).  
...
B. Every IC automatically becomes Chief.  
C. The President may waive all tenure rules.  
...
A. State Chief salary equals the CEC by the Act.  
B. The 2019 Rules fix Rs 2,25,000 for both State Chief and State IC.  
C. Every State separately fixes salary.  
D. No salary is prescribed.
...
A. compensation—PIO personally; penalty—public authority  
...
A. Every DPDP right and duty became operational in November 2025.  
...
D. Section 44(2) amended RTI section 8(1)(j).
...
A. Privacy always defeats disclosure.  
B. The old clause remains current.  
C. Section 8(2) makes the substitution meaningless.  
