...
### 01. Why does India need a Finance Commission?
...
![Topic-specific visual map: Why does India need a Finance Commission?.](../../../../../../notes/Polity/assets/29_Finance-Commission/01_why_does_india_need_a_finance_commission.png)
...
### 02. Constitutional architecture: the article chain
...
![Topic-specific visual map: Constitutional architecture: the article chain.](../../../../../../notes/Polity/assets/29_Finance-Commission/02_constitutional_architecture_the_article_chain.png)
...
### 03. Article 280: constitutional core
...
![Topic-specific visual map: Article 280: constitutional core.](../../../../../../notes/Polity/assets/29_Finance-Commission/03_article_280_constitutional_core.png)
...
### 04. Composition and the Finance Commission Act, 1951
...
![Topic-specific visual map: Composition and the Finance Commission Act, 1951.](../../../../../../notes/Polity/assets/29_Finance-Commission/04_composition_and_the_finance_commission_act_1951.png)
...
### 05. Procedure, evidence and powers
...
![Topic-specific visual map: Procedure, evidence and powers.](../../../../../../notes/Polity/assets/29_Finance-Commission/05_procedure_evidence_and_powers.png)
...
### 06. Workflow: from constitution to implementation
...
![Topic-specific visual map: Workflow: from constitution to implementation.](../../../../../../notes/Polity/assets/29_Finance-Commission/06_workflow_from_constitution_to_implementation.png)
...
![Topic-specific visual map: Tax-devolution mechanics.](../../../../../../notes/Polity/assets/29_Finance-Commission/07_tax_devolution_mechanics.png)
...
### 09. Horizontal devolution: equity and efficiency
...
![Topic-specific visual map: Horizontal devolution: equity and efficiency.](../../../../../../notes/Polity/assets/29_Finance-Commission/08_horizontal_devolution_equity_and_efficiency.png)
...
![Topic-specific visual map: Grants architecture.](../../../../../../notes/Polity/assets/29_Finance-Commission/09_grants_architecture.png)
...
### 11. Local-body finance and the State Finance Commission link
...
![Topic-specific visual map: Local-body finance and the State Finance Commission link.](../../../../../../notes/Polity/assets/29_Finance-Commission/10_local_body_finance_and_the_state_finance_commission_.png)
...
![Topic-specific visual map: Disaster-risk finance.](../../../../../../notes/Polity/assets/29_Finance-Commission/11_disaster_risk_finance.png)
...
### 13. Evolution: Fourteenth to Sixteenth Finance Commission
...
![Topic-specific visual map: Evolution: Fourteenth to Sixteenth Finance Commission.](../../../../../../notes/Polity/assets/29_Finance-Commission/12_evolution_fourteenth_to_sixteenth_finance_commission.png)
...
### 14. Fourteenth Finance Commission: autonomy with transition costs
...
### 15. Fifteenth Finance Commission: formula and fiscal context
...
### 16. Sixteenth Finance Commission: verified current control
...
![Topic-specific visual map: Sixteenth Finance Commission: verified current control.](../../../../../../notes/Polity/assets/29_Finance-Commission/13_sixteenth_finance_commission_verified_current_contro.png)
...
### 17. Sixteenth FC grants: categories and status
...
### 19. Cesses and surcharges: the divisible-pool debate
...
![Topic-specific visual map: Cesses and surcharges: the divisible-pool debate.](../../../../../../notes/Polity/assets/29_Finance-Commission/14_cesses_and_surcharges_the_divisible_pool_debate.png)
...
### 20. Centrally sponsored schemes and transfer composition
...
![Topic-specific visual map: Institutional comparisons.](../../../../../../notes/Polity/assets/29_Finance-Commission/15_institutional_comparisons.png)
...
### 22. Constitutional cases and interpretation controls
...
### 23. Critiques and reform agenda
...
![Topic-specific visual map: Answer-writing framework.](../../../../../../notes/Polity/assets/29_Finance-Commission/16_answer_writing_framework.png)
...
### 25. Integrated revision before assessment
...
B. only after every general election.  
C. annually before the Union Budget.  
D. whenever the GST Council recommends it.
...
A. who is a serving Supreme Court judge.  
B. with ten years as a State Finance Minister.  
C. possessing only a doctorate in economics.  
...
C. tax revenue minus all grants.  
...
C. GST Council.  
D. Parliament's Public Accounts Committee.
...
C. Article 271 surcharges.  
D. Union market borrowings.
...
A. judicial decrees.  
B. automatically enforceable State debts.  
C. binding GST law.  
...
**Explanation:** [FACT] Article 280(3)(b) refers to grants under Article 275.

#### OM14. Article 282

Which statement is correct?

A. Article 282 is identical to Article 275.  
B. It permits Union or State grants for any public purpose, subject to constitutional controls.  
C. It abolishes appropriations.  
...
A. enforced constitutional law.  
B. a Supreme Court direction.  
C. an automatic textual deletion.  
...
A. current total fertility rate alone.  
B. current population density.  
C. life expectancy change.  
...
C. a population-density multiplier.  
D. an equal share for every State.
...
A. one year's actual release.  
B. a State's individual share.  
C. the five-year recommended award envelope.  
D. the Union's gross tax revenue.
...
A. constitutionally vetoed the Commission.  
B. rejected Article 275.  
...
C. both exactly Rs 1.4 lakh crore.  
D. no disaster allocation was recommended.
...
B. automatically constitutionalised.  
C. left for separate examination by Government.  
D. accepted as an Article 271 surcharge.
...
A. It mandated immediate inclusion of every cess.  
B. It imposed a 10 per cent surcharge cap.  
C. It abolished Article 271.  
...
B. both are periodic judicial tribunals.  
C. NITI Aayog appoints both.  
...
A. created by Article 280.  
B. an executive policy institution rather than the constitutional tax-devolution body.  
C. the final certifier of net proceeds.  
D. constituted every fifth year by the President.
...
B. Article 279 CAG certification.  
C. member disqualification under the 1951 Act.  
...
B. 41 per cent of all Union receipts.  
C. 41 per cent of GDP.  
D. 41 per cent of every cess and surcharge.
...
A. It is constituted every ten years.  
B. Article 280 permits earlier constitution if the President considers it necessary.  
C. only Parliament may constitute it early.  
D. the CAG fixes the date.
...
C. abolition of horizontal devolution.  
D. inclusion of all cesses.
...
A. It makes Article 280 awards binding.  
B. It fixes 41 per cent devolution.  
C. It prescribes the horizontal formula.  
