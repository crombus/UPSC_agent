# Ecosystem Structure and Function - Complete Topic Package

> **Subject:** Environment and Ecology | **Paper:** GS-III

## Complete foundation and advanced source

# Ecosystem Structure and Function - MUST-DO
...
# Ecosystem Structure and Function - ADVANCED
...
### Q1. Which statement correctly resolves this common misconception: "Energy cycles like nutrients in an ecosystem."?
- A. Energy flows one-way and dissipates;
- B. Energy cycles like nutrients in an ecosystem.
- C. Habitat and niche are the same thing.
- D. Decomposers are only bacteria.
**Answer: A**
**Explanation:** Energy flows one-way and dissipates;

### Q2. Which statement correctly resolves this common misconception: "Habitat and niche are the same thing."?
- A. Habitat and niche are the same thing.
- B. Habitat is the address; niche is the functional
- C. Decomposers are only bacteria.
- D. A food chain and a food web are interchangeable terms.
**Answer: B**
**Explanation:** Habitat is the address; niche is the functional

### Q3. Which statement correctly resolves this common misconception: "Decomposers are only bacteria."?
- A. Decomposers are only bacteria.
- B. A food chain and a food web are interchangeable terms.
- C. Fungi and detritivores (e.g., earthworms, dung
- D. Producers are always green plants.
**Answer: C**
**Explanation:** Fungi and detritivores (e.g., earthworms, dung

### Q4. Which statement correctly resolves this common misconception: "A food chain and a food web are interchangeable terms."?
- A. A food chain and a food web are interchangeable terms.
- B. Producers are always green plants.
- C. An ecotone is simply a boundary line.
- D. A food web is the sum of
**Answer: D**
**Explanation:** A food web is the sum of

### Q5. Which statement correctly resolves this common misconception: "Producers are always green plants."?
- A. Chemosynthetic bacteria (e.g., at hydrothermal
- B. Producers are always green plants.
- C. An ecotone is simply a boundary line.
- D. "Biomass" means the live weight of organisms.
**Answer: A**
**Explanation:** Chemosynthetic bacteria (e.g., at hydrothermal

### Q6. Which statement correctly resolves this common misconception: "An ecotone is simply a boundary line."?
- A. An ecotone is simply a boundary line.
- B. It is a *zone* of variable width and a zone of
- C. "Biomass" means the live weight of organisms.
- D. A stable-looking ecosystem is automatically resilient.
**Answer: B**
**Explanation:** It is a *zone* of variable width and a zone of

### Q7. Which statement correctly resolves this common misconception: ""Biomass" means the live weight of organisms."?
- A. "Biomass" means the live weight of organisms.
- B. A stable-looking ecosystem is automatically resilient.
- C. It is conventionally the **net dry
- D. Energy cycles like nutrients in an ecosystem.
**Answer: C**
**Explanation:** It is conventionally the **net dry

### Q8. Which statement correctly resolves this common misconception: "A stable-looking ecosystem is automatically resilient."?
- A. A stable-looking ecosystem is automatically resilient.
- B. Energy cycles like nutrients in an ecosystem.
- C. Habitat and niche are the same thing.
- D. Stability (resistance to
**Answer: D**
**Explanation:** Stability (resistance to

## Solved answer-writing practice

- **10 marks:** Explain the central concepts and distinctions in Ecosystem Structure and Function.
- **15 marks:** Analyse Ecosystem Structure and Function with applications and limitations.
- **20 marks:** Critically examine Ecosystem Structure and Function and provide a balanced judgement.
