...
|---|---|
| ✅ **Drone / UAS** | Unmanned aircraft system including platform, control and associated components. |
| ✅ **Nano / Micro / Small / Medium / Large** | Weight-based categories under Drone Rules 2021. |
| ✅ **Digital Sky** | Official digital governance platform for compliance, registration and airspace-linked permissions. |
...
| ✅ **BVLOS** | Beyond Visual Line of Sight operation; more complex and more tightly governed than ordinary VLOS operations. |
...
| 📰 **29 Nov 2022:** operational guidelines for drone PLI. **Status:** implementation framework issued. | Helps connect regulatory easing with manufacturing-support architecture. |
| 📰 **16 Jul 2026:** Digital Sky portal/FAQ remained live. **Status:** operational digital-governance interface visible. | Useful for demonstrating that India’s drone policy relies on platformized compliance and airspace management. |
