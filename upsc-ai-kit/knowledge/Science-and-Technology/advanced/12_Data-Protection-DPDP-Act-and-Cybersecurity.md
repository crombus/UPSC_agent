...
1. A Data Fiduciary processes digital personal data on grounds recognized by the DPDP Act.
2. The Data Principal can access, correct, erase, grieve and withdraw consent.
3. Consent Managers create an interoperable layer for managing consent on behalf of individuals.
4. SDFs face additional obligations like India-based Data Protection Officers, data audits and impact assessments.
5. The Board addresses compliance-related matters under the Act.
6. Separate from this, cyber incidents trigger operational security responsibilities, reporting and defensive action under CERT-In / NCIIPC / sectoral arrangements.
...
- ⚠️ **Board design and independence:** effectiveness will depend on how the Board functions in practice, especially in digital proceedings and enforcement.
- ⚠️ **Cross-border transfer model:** India did not adopt an absolute data-localisation model in the reviewed Act text; instead it retained a notification-based restriction power.
- ⚠️ **Regulatory overlap debate:** DPDP compliance, IT Act obligations, sectoral cyber norms and platform policies may overlap operationally.
- ⚠️ **Strategy gap debate:** official sources reviewed clearly show active institutions (CERT-In/NCIIPC), but a later formally published National Cyber Security Strategy replacing the older policy was not located in final notified form.
...
| 📰 **13 Nov 2025:** India Code materials show notification of the DPDP Rules, 2025. | Use to argue that the privacy architecture has moved from statutory design to implementation stage. |
| 📰 **28 Apr 2022:** CERT-In directions under section 70B remain a major operational cyber benchmark. | Use to show that cybersecurity obligations pre-date DPDP and continue on a separate legal track. |
