# Space Programme, ISRO, Launch Vehicles and Space Governance - Complete Topic Package

> **Subject:** Science and Technology | **Paper:** GS-III

## Complete foundation and advanced source

# Space Programme, ISRO, Launch Vehicles and Space Governance - MUST-DO
...
# Space Programme, ISRO, Launch Vehicles and Space Governance - ADVANCED
...
- ⚠️ Advanced questions may ask whether India’s space reform should be judged by “more private players” or by deeper metrics such as domestic value chains, launch throughput and strategic autonomy.
- ⚠️ Prelims traps can revolve around who authorises, who commercialises and who develops the underlying launch technology.
- ⚠️ GS-III answers can compare launch capability as strategic infrastructure in the same way ports, power grids or digital rails are treated in development policy.
...
- A. ISRO is the public agency; NSIL is the commercial PSU; IN-SPACe is the authorisation/promotional interface for private activity.
- B. ISRO, NSIL and IN-SPACe are just three names for the same organisation.
- C. PSLV, GSLV and LVM3 differ only by payload size.
- D. SSLV is simply a renamed PSLV variant.
**Answer: A**
**Explanation:** ISRO is the public agency; NSIL is the commercial PSU; IN-SPACe is the authorisation/promotional interface for private activity.

### Q2. Which statement correctly resolves this common misconception: "PSLV, GSLV and LVM3 differ only by payload size."?
- A. PSLV, GSLV and LVM3 differ only by payload size.
- B. Payload matters, but orbit profile, cryogenic capability and mission architecture also differentiate them.
- C. SSLV is simply a renamed PSLV variant.
- D. Space Policy 2023 means the government has withdrawn from the space sector.
**Answer: B**
**Explanation:** Payload matters, but orbit profile, cryogenic capability and mission architecture also differentiate them.

### Q3. Which statement correctly resolves this common misconception: "SSLV is simply a renamed PSLV variant."?
- A. SSLV is simply a renamed PSLV variant.
- B. Space Policy 2023 means the government has withdrawn from the space sector.
- C. SSLV is a separate small-satellite launcher concept with different market logic and infrastructure needs.
- D. NGLV or the Third Launch Pad should be described as already operational.
**Answer: C**
**Explanation:** SSLV is a separate small-satellite launcher concept with different market logic and infrastructure needs.

### Q4. Which statement correctly resolves this common misconception: "Space Policy 2023 means the government has withdrawn from the space sector."?
- A. Space Policy 2023 means the government has withdrawn from the space sector.
- B. NGLV or the Third Launch Pad should be described as already operational.
- C. "GSLV puts satellites into geostationary orbit."
- D. The policy separates public, regulatory and commercial roles; it does not abolish state leadership.
**Answer: D**
**Explanation:** The policy separates public, regulatory and commercial roles; it does not abolish state leadership.

### Q5. Which statement correctly resolves this common misconception: "NGLV or the Third Launch Pad should be described as already operational."?
- A. They are approved/future-capacity items, not current operational launch vehicles.
- B. NGLV or the Third Launch Pad should be described as already operational.
- C. "GSLV puts satellites into geostationary orbit."
- D. "Cryogenic and semi-cryogenic are the same thing."
**Answer: A**
**Explanation:** They are approved/future-capacity items, not current operational launch vehicles.

### Q6. Which statement correctly resolves this common misconception: ""GSLV puts satellites into geostationary orbit.""?
- A. "GSLV puts satellites into geostationary orbit."
- B. It injects them into **geosynchronous transfer orbit**; the satellite's own propulsion completes the circularisation.
- C. "Cryogenic and semi-cryogenic are the same thing."
- D. "Indian Space Policy 2023 is India's space law."
**Answer: B**
**Explanation:** It injects them into **geosynchronous transfer orbit**; the satellite's own propulsion completes the circularisation.

### Q7. Which statement correctly resolves this common misconception: ""Cryogenic and semi-cryogenic are the same thing.""?
- A. "Cryogenic and semi-cryogenic are the same thing."
- B. "Indian Space Policy 2023 is India's space law."
- C. Cryogenic = LOX + liquid **hydrogen** (flying on GSLV/LVM3 upper stages); semi-cryogenic = LOX + **kerosene**, still under development in India.
- D. ISRO, NSIL and IN-SPACe are just three names for the same organisation.
**Answer: C**
**Explanation:** Cryogenic = LOX + liquid **hydrogen** (flying on GSLV/LVM3 upper stages); semi-cryogenic = LOX + **kerosene**, still under development in India.

### Q8. Which statement correctly resolves this common misconception: ""Indian Space Policy 2023 is India's space law.""?
- A. "Indian Space Policy 2023 is India's space law."
- B. ISRO, NSIL and IN-SPACe are just three names for the same organisation.
- C. PSLV, GSLV and LVM3 differ only by payload size.
- D. It is executive policy. India's binding obligations flow from the Outer Space Treaty family; there is no comprehensive domestic space statute yet.
**Answer: D**
**Explanation:** It is executive policy. India's binding obligations flow from the Outer Space Treaty family; there is no comprehensive domestic space statute yet.

## Solved answer-writing practice

- **10 marks:** Explain the central concepts and distinctions in Space Programme, ISRO, Launch Vehicles and Space Governance.
- **15 marks:** Analyse Space Programme, ISRO, Launch Vehicles and Space Governance with applications and limitations.
- **20 marks:** Critically examine Space Programme, ISRO, Launch Vehicles and Space Governance and provide a balanced judgement.
