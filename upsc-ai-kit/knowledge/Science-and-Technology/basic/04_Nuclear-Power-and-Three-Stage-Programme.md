...
|---|---|---|
| PHWR | Heavy water moderator/coolant; natural uranium advantage | Core of India’s Stage 1 strategy |
| BWR | Water boils in reactor vessel itself | Steam goes directly to turbine |
...
3. Control rods, moderator behaviour, coolant systems and containment architecture together regulate the chain reaction and safety envelope.
...
- ✅ **BHAVINI:** DAE company tasked with the Prototype Fast Breeder Reactor and Stage 2 implementation logic.
...
- 📰 **07 Apr 2026 | PFBR at Kalpakkam - first criticality achieved.** PIB said the indigenously built Prototype Fast Breeder Reactor entered sustained chain-reaction stage on 6 April 2026, marking a major Stage 2 milestone.
