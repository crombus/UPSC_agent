# Emerging Materials, Rare Earths and Critical Minerals - MUST-DO
...
- ⚠️ Prelims can test the distinction between **REEs** and **critical minerals**.
- ⚠️ GS-III can ask why material security is essential for EVs, semiconductors, defence and clean-energy transitions.
- ⚠️ UPSC may also ask whether overseas acquisition alone is sufficient, or whether refining and recycling capability are equally necessary.
- ⚠️ Another likely angle is strategic competition and supply-chain resilience rather than geology alone.
...
| Year | Paper | Q | PYQ demand (neutral rendering) | Directive / format | Source status | Owner requirement |
|---:|---|---|---|---|---|---|
| 2025 | Prelims GS-I | 6 | Minerals Security Partnership; critical minerals; MMDR Act 2023 amendment | Objective question; official Set-A key available locally, answer not inferred | Key available locally (official Set-A answer key present); answer not recorded here | Cover the named fact/concept and its likely statement-level distinctions. |
| 2025 | Prelims GS-I | 43 | Elements making up EV battery cathodes (cobalt, graphite, lithium, nickel) | Objective question; official Set-A key available locally, answer not inferred | Key available locally (official Set-A answer key present); answer not recorded here | Cover the named fact/concept and its likely statement-level distinctions. |
| 2025 | Prelims GS-I | 81 | Uses and properties of rare earth elements | Objective question; official Set-A key available locally, answer not inferred | Key available locally (official Set-A answer key present); answer not recorded here | Cover the named fact/concept and its likely statement-level distinctions. |

### What this owner must now support

- Minerals Security Partnership; critical minerals; MMDR Act 2023 amendment
- Elements making up EV battery cathodes (cobalt, graphite, lithium, nickel)
- Uses and properties of rare earth elements
