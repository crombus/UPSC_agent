...
|---|---|
| ✅ **Drone / UAV / UAS** | Unmanned aircraft system operating without onboard pilot. |
| ✅ **Payload** | Device or material carried by a drone in addition to the flying platform itself. |
| ✅ **Digital Sky** | Official online platform for drone permissions, registrations and airspace-related compliance. |
| ✅ **Nano / Micro / Small / Medium / Large** | Weight-based regulatory categories under India’s drone rules. |
...
3. ✅ Before flight, airspace and permissions are checked through the Digital Sky ecosystem where applicable.
...
- ✅ **DGCA:** regulatory authority overseeing civil-drone compliance architecture.
- ✅ **Digital Sky platform:** online permission, registration and airspace-management interface.
- ✅ **PLI for drones and drone components:** manufacturing-support measure for domestic ecosystem development.
- ✅ **Drone training and certification ecosystem:** important where pilot skills and safe operations are required.
...
- 📰 **16 Jul 2026 | Drone Rules official page access date | Status: core framework remains in force online.** The 2021 rules page continued to serve as the official reference point.
