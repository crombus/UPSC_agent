...
|---:|---|---|---|---|---|---|
| 2026 | Prelims GS-I | 47 | Drone swarm communication, autonomous coordination, and electronic countermeasure techniques | Objective question; provisional 2026 Set-A key present locally, answer not inferred | Provisional 2026 Set-A key present locally (`Ans-2026-GS1-Provisional`); key is provisional - no answer letter recorded or inferred here | Cover the named fact/concept and its likely statement-level distinctions. |

### What this owner must now support

- Drone swarm communication, autonomous coordination, and electronic countermeasure techniques
...
| Year | Paper | Q | PYQ demand (neutral rendering) | Directive / format | Source status | Owner requirement |
|---:|---|---|---|---|---|---|
| 2025 | Prelims GS-I | 42 | Unmanned Aerial Vehicles - capabilities of different types | Objective question; official Set-A key available locally, answer not inferred | Key available locally (official Set-A answer key present); answer not recorded here | Cover the named fact/concept and its likely statement-level distinctions. |

### What this owner must now support

- Unmanned Aerial Vehicles - capabilities of different types
