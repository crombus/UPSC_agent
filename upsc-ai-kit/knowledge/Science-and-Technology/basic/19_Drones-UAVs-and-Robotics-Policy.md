...
|---:|---|---:|---|---|---|---|
| 2020 | Prelims GS-I | 42 | Drone applications in agriculture volcano and wildlife research | Objective question; official key unavailable locally | Routed; key unavailable locally | Cover the named fact/concept and its likely statement-level distinctions. |
