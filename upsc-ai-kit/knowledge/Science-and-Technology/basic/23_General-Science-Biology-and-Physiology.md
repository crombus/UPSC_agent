# General Science: Biology and Physiology - MUST-DO
...
- ⚠️ UPSC repeatedly tests DNA vs RNA, innate vs adaptive immunity and virus vs bacteria through close statement comparison.
- ⚠️ Endocrine questions often hinge on gland-hormone matching and the distinction between nervous and hormonal control.
- ⚠️ Physiology questions reward process understanding: where digestion happens, how oxygen is transported, what insulin does, why respiration matters.
- ⚠️ Plant physiology items usually test simple but precise distinctions: photosynthesis vs respiration, xylem vs phloem, chlorophyll vs stomata role.
