# General Science: Chemistry Fundamentals - MUST-DO
...
- ⚠️ Biomolecule questions are often classification-based and reward candidates who keep chemistry and physiology treatments separate.
...
|---:|---|---|---|---|---|---|
| 2024 | Prelims GS-I | 36 | Uses of hydrogels | Objective question; official Set-A key available locally, answer not inferred | Key available locally (official Set-A answer key present); answer not recorded here | Cover the named fact/concept and its likely statement-level distinctions. |
| 2025 | Prelims GS-I | 45 | Coal gasification technology - what it can produce | Objective question; official Set-A key available locally, answer not inferred | Key available locally (official Set-A answer key present); answer not recorded here | Cover the named fact/concept and its likely statement-level distinctions. |

### What this owner must now support

- Uses of hydrogels
- Coal gasification technology - what it can produce
