# Defence Indigenization, Atmanirbhar and Procurement - MUST-DO
...
- ⚠️ GS-III questions can ask whether defence self-reliance is a matter of R&D alone or of acquisition design, supply chains and industrial depth.
- ⚠️ Prelims may test DAP categories, strategic partnership logic, corridor location or the meaning of indigenisation lists.
- ⚠️ A balanced answer separates **policy architecture** from **weapons-platform description**.
- ⚠️ Another recurring UPSC angle is whether defence industrial policy should be judged by import substitution alone or by long-term design and export capacity.
...
| Year | Paper | Q | PYQ demand (neutral rendering) | Directive / format | Source status | Owner requirement |
|---:|---|---|---|---|---|---|
| 2024 | Prelims GS-I | 35 | Fifth-generation fighter aircraft (Rafale, MiG-29, Tejas MK-1) | Objective question; official Set-A key available locally, answer not inferred | Key available locally (official Set-A answer key present); answer not recorded here | Cover the named fact/concept and its likely statement-level distinctions. |
| 2024 | Prelims GS-I | 69 | Equivalent ranks in the three services of the armed forces | Objective question; official Set-A key available locally, answer not inferred | Key available locally (official Set-A answer key present); answer not recorded here | Cover the named fact/concept and its likely statement-level distinctions. |
| 2024 | Prelims GS-I | 77 | Chief of Defence Staff (CDS) as Head of the Department of Military Affairs - role and duties | Objective question; official Set-A key available locally, answer not inferred | Key available locally (official Set-A answer key present); answer not recorded here | Cover the named fact/concept and its likely statement-level distinctions. |
| 2025 | Prelims GS-I | 84 | India's defence aircraft type-description pairs (Dornier-228, IL-76, C-17) | Objective question; official Set-A key available locally, answer not inferred | Key available locally (official Set-A answer key present); answer not recorded here | Cover the named fact/concept and its likely statement-level distinctions. |

### What this owner must now support

- Fifth-generation fighter aircraft (Rafale, MiG-29, Tejas MK-1)
- Equivalent ranks in the three services of the armed forces
- Chief of Defence Staff (CDS) as Head of the Department of Military Affairs - role and duties
- India's defence aircraft type-description pairs (Dornier-228, IL-76, C-17)
