# Electric Vehicles, Batteries and Alternative Fuels - MUST-DO
...
- ⚠️ Prelims can test the difference among **BEV, hybrid and FCV** or ask about battery components.
- ⚠️ GS-III can connect EV policy with industrial policy, charging infrastructure and critical-mineral dependence.
- ⚠️ Alternative-fuel questions may combine E20, biodiesel, hydrogen, CNG/LNG and transport-sector decarbonization.
- ⚠️ Another likely angle is whether mobility transition is only a subsidy issue or also a manufacturing and standards issue.
