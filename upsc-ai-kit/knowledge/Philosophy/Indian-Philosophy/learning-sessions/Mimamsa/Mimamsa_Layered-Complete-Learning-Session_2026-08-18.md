---
cover_image: assets/07_Mimamsa-Hermeneutic-Knowledge-Map.png
---
# MIMAMSA - Layered Complete Learning Session - Syllabus Item 18
...
Progress: 1 / 8  |  Philosophy Layered Session  |  Subtopic: The Mimamsa Project: Knowledge in the Service of Dharma
...
qualified agent performs the rite
      |
APURVA carries efficacy beyond the visible act
      |
...
| Term | Easy meaning |
|---|---|
| Dharma | Supersensible duty |
| Codana / vidhi | Vedic injunction |
| Bhavana | Impelling and productive force |
| Niyoga | Binding to-be-done |
| Apurva | Unseen link between act and fruit |
...
```text
MIMAMSA = inquiry into dharma through Vedic injunction
        |
        +-- REALIST BACKGROUND
        |   +-- real world, enduring self, karmic continuity
        |
        +-- EPISTEMIC THESIS
        |   +-- svatah-pramanya = validity intrinsic
        |   +-- paratah-apramanya = invalidity discovered later
        |
        +-- PRAMANAS
        |   +-- Prabhakara: 5
        ...
        |
        +-- KEY SPECIALTIES
        |   +-- arthapatti = compelled postulation
        |   +-- anupalabdhi = knowledge of absence
        |   +-- akhyati vs viparita-khyati
        |   +-- triputi-samvit vs jnatata
        |   +-- abhihitanvaya vs anvitabhidhana
        |
        +-- HERMENEUTIC GOAL
        |   +-- codana -> duty -> action -> apurva -> fruit
        |
        +-- VEDIC CLAIM
            +-- Veda is apauruseya, eternal, self-valid for dharma
```

> ✅ The school is not "ritualism plus a few epistemic ideas." Its epistemology, semantics and anti-theistic theology are all designed to secure objective knowledge of dharma.
...
✅ The intellectual center is **dharma-jijñāsā**. Jaimini's project is not to speculate first about God or Brahman, but to ask how duty is known, how injunction binds, how ritual yields fruit, and why Vedic testimony should be trusted when dharma is supersensible.
...
| **Kumārila Bhaṭṭa** | Bhāṭṭa line; stronger realist and polemical style | six pramāṇas, anupalabdhi, jñātatā, viparīta-khyāti |
| **Prabhākara Miśra** | Prābhākara line; greater economy | five pramāṇas, tripuṭī-samvit, akhyāti, anvitābhidhāna |
...
2. ✅ It refuses to reduce all mediate knowledge to inference, thereby protecting **arthāpatti** and, for Bhāṭṭa, **anupalabdhi**.
...
- ✅ Karma must connect an act and its later fruit.
- ✅ Dharma is supersensible and therefore unavailable to mere perception.
- ✅ Hence epistemology, semantics and ritual hermeneutics are structurally connected.

## 2. VISUAL - KNOWLEDGE IN DEFENCE OF DHARMA

![Mimamsa: knowledge in defence of dharma](assets/07_Mimamsa-Hermeneutic-Knowledge-Map.png)

The visual keeps the whole optional route in view: epistemology protects Vedic authority, Vedic authority grounds duty, duty becomes action through injunction, and action yields fruit through apurva without needing a creator-God.

## 3. DHARMA, CODANA, VIDHI, APURVA, BHAVANA, NIYOGA

> ✅ **Jaimini's formula:** `codana-laksano'rtho dharmah` - dharma is that end or object characterized by Vedic injunction.

### 3.1 Dharma is known as what ought to be done

✅ Mīmāṃsā does not define dharma as bare moral feeling. It defines dharma as what the Veda **enjoins**. Therefore its central sentence-type is **vidhi** (injunction), complemented by **niṣedha** (prohibition).

| Term | Meaning | Why it matters |
|---|---|---|
| **Dharma** | supersensible duty known through Vedic injunction | gives the entire school its objective |
| **Codanā / vidhi** | impelling Vedic command | makes the sentence action-guiding rather than merely descriptive |
| **Niṣedha** | prohibition | marks what ought not to be done |
| **Apūrva** | unseen potency generated by correct ritual action | links a perishing act to a delayed fruit |
| **Śābdī bhāvanā** | linguistic impelling force of the injunction | explains how the word motivates action |
| **Ārthī bhāvanā** | real productive force of the agent's performance | explains how action leads to result |
| **Niyoga** | the binding “to-be-done” | central to Prābhākara duty theory |
...
real productive force (arthi bhavana) operates
        ->
apurva persists after the visible act ends
        ->
promised fruit matures later
```
...
The school's unity lies in its governing problem. Dharma cannot be perceived, while ordinary inference cannot independently establish ritual obligation. Vedic injunction therefore supplies normative knowledge, semantics explains sentence-unity, and apurva explains delayed efficacy.
...
- Connect codana -> bhavana/niyoga -> action -> apurva -> fruit.
...
- Dharma is known through injunction.
- Apurva explains delayed ritual efficacy without God.
- Trap: Mimamsa's primary project is not proof of Brahman or creator God.

---

Progress: 2 / 8  |  Philosophy Layered Session  |  Subtopic: Intrinsic Validity and the Pramana Architecture
...
## 4. VALIDITY AND PRAMĀṆA ARCHITECTURE

### 4.1 Svataḥ-prāmāṇya and parataḥ-aprāmāṇya
...
### 4.3 Nyāya contrast - parataḥ-prāmāṇya
...
| **Prābhākara Mīmāṃsā** | perception, inference, comparison, testimony, arthāpatti |
| **Bhāṭṭa Mīmāṃsā** | perception, inference, comparison, testimony, arthāpatti, anupalabdhi |

### 4.5 Why memory is not a pramāṇa
...
| can count as pramā | can be true, but is not a pramāṇa |
| basis of present disclosure | basis of re-presentation |

### 4.6 Two master warnings

1. ⚠️ **Svataḥ-prāmāṇya** is a thesis about **validity**, not automatically about **self-awareness**.
...
- **2020 Q5(c), 2024 Q8(c):** memory may be true but is not a pramana because it lacks novelty.
- **2025 Q5(c):** compare intrinsic and extrinsic validity by origin, ascertainment, regress and correction.
- State both: svatah-pramanya and paratah-apramanya.
...
- Prabhakara has five pramanas; Bhatta has six.
- Memory re-presents prior content.
- Trap: validity theory is not automatically a theory of self-awareness.

---

Progress: 3 / 8  |  Philosophy Layered Session  |  Subtopic: Arthapatti and Anupalabdhi: Explanatory Necessity and Absence
...
facts cannot stand together unaided
        |
POSTULATE NIGHT EATING        = ARTHAPATTI

WELL-LIT EMPTY TABLE
+ JAR WOULD BE SEEN IF PRESENT
        |
JAR IS ABSENT                 = ANUPALABDHI
```

**In simple words:** arthapatti supplies the fact required to make accepted data coherent. Anupalabdhi knows absence when all conditions for seeing a present object are satisfied.

> **Memory line:** explanatory compulsion is not mere guess; meaningful non-perception is not mere ignorance.

## LAYER 2 - CORE UPSC

## 5. ARTHĀPATTI AND ANUPALABDHI

### 5.1 Arthāpatti - compelled explanatory postulation

✅ Arthāpatti is not a guess and not a loose “best explanation.” It is the **necessary postulation** of an unseen fact without which accepted facts would remain incompatible.
...
⚠️ The safest verdict is: **arthāpatti is the epistemology of explanatory compulsion**.
...
### 5.5 Anupalabdhi - knowledge of absence

✅ **Bhāṭṭa Mīmāṃsā** alone among the two sub-schools grants **anupalabdhi** independent pramāṇa-status. It is knowledge of absence through **non-apprehension of what would be apprehended if present**.

### 5.6 Yogyānupalabdhi - the limiting condition
...
### 5.7 Nature of abhāva and its knowledge

| View | What is absent? | How known? |
|---|---|---|
| **Bhāṭṭa** | abhāva is real and structured by a counterpositive | known through anupalabdhi |
| **Prābhākara** | what is directly given is the bare locus unqualified by the missing object | no separate pramāṇa needed |
| **Nyāya** | absence is a real category | often treated as perceptible or inferable, not requiring a separate anupalabdhi |
...
Nyaya reconstructs arthapatti as inference, but Mimamsa argues that the alleged universal relation is extracted from the very explanatory tension that needs resolution. The cognition moves from incompatible accepted facts to a necessary supplement rather than from a known sign to a probandum.

Bhatta grants absence structured objecthood and an independent means of knowledge. *Yogyanupalabdhi* limits the claim: only an object perceptible under available conditions can be known absent through non-apprehension. This blocks arguments from failure to perceive intrinsically imperceptible entities.

Prabhakara explains the same case through cognition of the bare locus, while Nyaya accepts absence but resists a new pramana. Bhatta best preserves determinate negative judgment; the rivals purchase greater economy.

## LAYER 4 - EXAM APPLICATION

### Exam route

- **2022 Q6(c):** state Nyaya's inferential reduction fairly, then give incompatibility, missing vyapti and structural objections.
- **2024 Q8(b):** apply the candidate-success example without turning arthapatti into loose speculation.
- **2021 Q6(c), 2023 Q6(b), 2025 Q6(c):** define abhava, yogyata and the Bhatta-Prabhakara divide.
...
- Arthapatti = compelled explanatory postulation.
- Devadatta is the standard example.
- Bhatta alone accepts anupalabdhi independently.
- Yogyata makes non-perception evidential.
- Trap: not seeing an imperceptible entity does not establish its absence.

---

Progress: 4 / 8  |  Philosophy Layered Session  |  Subtopic: Self-Awareness and Error: Triputi, Jnatata and Two Mimamsa Theories
...
|---|---|---|
| **Prābhākara** | cognition reveals knower, known and itself together | **tripuṭī-samvit** |
| **Bhāṭṭa** | cognition is inferred from the cognizedness of the object | **jñātatā** |
...
### 6.4 Error theory - akhyāti versus viparīta-khyāti
...
| Name | **akhyāti / vivekākhyāti** | **viparīta-khyāti** |
...
|---|---|---|
| **Prābhākara** | akhyāti | non-discrimination between valid perception and valid memory |
| **Bhāṭṭa** | viparīta-khyāti | positive misapprehension caused by defect |
...
Triputi-samvit directly blocks regress by making cognition manifest with knower and object. Nyaya gains analytic clarity through second-order awareness but must explain why reflection does not require endless reflection. Bhatta's *jnatata* preserves object-centred realism but may look like an extra posit.

Prabhakara's akhyati protects the truth of each constituent: present "this" perception and remembered silver. Error is failure to discriminate. Its weakness is the assertive force of "this is silver." Bhatta's viparita-khyati explains that force through a genuinely false synthesis caused by defects while retaining default validity under normal conditions.
...
- **2024 Q8(a):** compare triputi-samvit, jnatata and Nyaya anuvyavasaya.
- Use shell-silver for both error accounts, but do not confuse Bhatta viparita-khyati with Nyaya anyatha-khyati.
...
- Prabhakara: triputi-samvit and akhyati.
- Bhatta: jnatata and viparita-khyati.
- Nyaya: anuvyavasaya and anyatha-khyati.
- Akhyati means non-discrimination, not no cognition.
- Trap: error theory and validity theory answer different questions.

---

Progress: 5 / 8  |  Philosophy Layered Session  |  Subtopic: Word Meaning, Sentence Meaning and Ritual Hermeneutics
...
## 7. ŚABDA, WORD-MEANING, SENTENCE-MEANING, AND RITUAL HERMENEUTICS
...
### 7.3 Abhihitānvayavāda versus anvitābhidhānavāda
...
| Usual label | **abhihitānvayavāda** | **anvitābhidhānavāda** |
...
Progress: 6 / 8  |  Philosophy Layered Session  |  Subtopic: Authorless Veda, Anti-Theism, Karma and Later Moksa
...
MIMAMSA EXCLUDES AUTHORSHIP
        |
eternal word-meaning relation + unique access to dharma
        |
VEDIC AUTHORITY

ritual action -> apurva -> fruit
...
## 8. APAURUṢEYATVA, VEDIC AUTHORITY, SELF, WORLD, GOD, KARMA, MOKṢA

### 8.1 Why Vedic authority matters

✅ Perception shows visible things. Inference extends from marks to unobserved correlates. But **dharma** is neither visibly given nor inferable from ordinary worldly signs. Therefore **śabda**, especially Vedic śabda, becomes indispensable.

### 8.2 Apauruṣeyatva and śabda-nityatva
...
| Issue | Mīmāṃsā | Nyāya |
|---|---|---|
| source of scriptural authority | authorless eternal Veda | omniscient reliable author (āpta), ultimately Īśvara |
...
- ✅ Karma requires continuity between deed and consequence.
- ✅ Apūrva is the unseen link between a perishing act and a delayed fruit.
...
2. ✅ God would become a redundant extra alongside karma and apūrva.
3. ✅ If God dispenses according to karma, karma does the real work.
4. ✅ If God dispenses independently of karma, divine partiality appears.
...
### 8.6 Mokṣa in Mimamsa

❓ Early Mīmāṃsā is more **svarga-oriented** than liberation-oriented. Later presentations, however, clearly describe mokṣa as cessation of pain, embodiment and karmic entanglement.

✅ Sharma is explicit that later Mīmāṃsakas treat mokṣa negatively - as release from bondage and suffering rather than as Advaitic identity with Brahman. That caution is important: **do not Vedāntize Mīmāṃsā mokṣa**.

## LAYER 3 - ADVANCED

### Advanced objective normativity without God

Apauruseyatva, word-eternity and an inherent word-meaning relation secure Vedic testimony in its special domain of supersensible duty. The strategy is anti-sceptical but historically and linguistically demanding: conventionalists challenge eternal language and natural semantic relations.

The school remains orthodox because orthodoxy means Vedic fidelity, not creator-theism. Karma and apurva explain fruit; God either becomes redundant if he follows karma or partial if he overrides it. Ritual deities remain procedure-bound rather than sovereign creators.

An enduring self is required to connect action and later experience. Later Mimamsa moksa is largely cessation of pain, embodiment and karmic entanglement; it should not be transformed into Advaitic Brahman-identity.

## LAYER 4 - EXAM APPLICATION

### Exam route

- **2019 Q5(e):** establish Vedic authority through authorlessness, word-eternity and unique access to dharma.
...
- Qualify moksa historically: early stress on dharma and heaven, later negative liberation.
...
- Trap: later moksa is not merger with Brahman.

---

Progress: 7 / 8  |  Philosophy Layered Session  |  Subtopic: Comparisons, Criticisms, Traps and the Contemporary Sanskrit Context
...
```text
NYAYA    -> validity and special pramanas can be reduced externally
...
MIMAMSA  -> default trust + textual rules + apurva preserve duty
```

**In simple words:** Mimamsa gains a powerful impersonal theory of normativity, but pays for it through eternal language, special pramanas, structured absences and unseen ritual potency.
...
| special pramāṇas | arthāpatti; Bhāṭṭa adds anupalabdhi | reduces them where possible | often accepts six pramāṇas in later Advaita |
| cognition of cognition | tripuṭī-samvit or jñātatā | anuvyavasāya | self-luminous consciousness |
| Veda | authorless and eternal | reliable because of Īśvara | Upaniṣads reveal siddha-vastu |
| God | no creator or fruit-dispenser needed | theistic realism | empirical Īśvara, ultimate non-dual Brahman |
| mokṣa | later negative release from suffering and embodiment | release from pain | knowledge of identity of ātman and Brahman |
...
| arthāpatti is hidden inference | explanatory compulsion is not the same as sign-based inference | Nyāya can still simulate many cases inferentially |
| anupalabdhi reifies negatives | determinate absence-cognition needs an object and a pramāṇa | ontological economy is sacrificed |
...
| karma needs an intelligent administrator | apūrva and beginningless order suffice | many still find unconscious potency obscure |

### 9.3 High-value UPSC traps

1. ⚠️ **Prābhākara has five pramāṇas, not six.**
2. ⚠️ **Svataḥ-prāmāṇya is not infallibilism.**
3. ⚠️ **Bhāṭṭa can deny self-luminosity and still defend intrinsic validity.**
4. ⚠️ **Akhyāti means non-discrimination, not total absence of cognition.**
5. ⚠️ **Anupalabdhi is a Bhāṭṭa specialty.**
...
8. ⚠️ **Mokṣa in Mīmāṃsā is not merger into Brahman.**
9. ⚠️ **Apūrva is the link between act and fruit; it is not identical with God, fate or visible physical causation.**
...
> ⚠️ **Why this is a legitimate Mimamsa linkage:** it does **not** prove Mīmāṃsā doctrine and should never be presented as evidence for apauruṣeyatva, svataḥ-prāmāṇya or ritual efficacy. It is relevant only because Mīmāṃsā lives in a world of Sanskrit textual transmission, publication, teaching, commentary, and interpretive training. A modern state-supported Sanskrit ecosystem keeps alive the language-and-text conditions within which Vedic hermeneutics remains publicly meaningful.

## LAYER 3 - ADVANCED

### Advanced critical balance

Intrinsic validity avoids regress and explains ordinary epistemic confidence, but critics ask whether default authority merely postpones certification. Arthapatti captures explanatory compulsion, yet Nyaya can often simulate it inferentially. Anupalabdhi preserves negative judgments at the cost of a new pramana and richer ontology.

Authorless language removes authorial defect but leaves the problem of how meaning and normativity arise without intention. Apurva links act and fruit but can look like a theoretical placeholder replacing divine administration.
...
1. Prabhakara has five pramanas.
2. Intrinsic validity is defeasible.
3. Anupalabdhi belongs independently to Bhatta.
4. Mimamsa secures Veda without God.
5. Apurva is neither fate nor God in disguise.
...
- Main costs: eternal words, apurva, absence ontology and special pramanas.
...
- ✅ Chatterjee and Datta, **Chapter IX - The Mimamsa Philosophy**, local OCR-searchable PDF `books\philosphy_books\Chatterjeedatta_introductionToIndianPhilosophy.pdf`, especially file pages **379-409** for the two-fold role of Mīmāṃsā, the list of pramāṇas, arthāpatti, Vedic authorlessness and the non-creator stance.
- ✅ C.D. Sharma, **Purva-Mimamsa** discussion in `books\philosphy_books\Indian-Philosophy-A-Critical-Survey.pdf`, especially searchable file pages around **203** and **233-236** for arthāpatti, jñātatā, later mokṣa doctrine and Kumārila's historical role.
- ✅ Radhakrishnan, **The Purva Mimamsa** chapter in `books\philosphy_books\Indian Philosophy Vol. 2 by Radhakrishnan.pdf`, especially file pages **383-414** for pramāṇas, tripuṭī-samvit, jñātatā, Veda, and anti-theistic argument.
...
Mimamsa appears in every year from 2018 through 2025. The recurrence is structured rather than random: validity, memory, arthapatti, absence, self-awareness, error, semantics and Vedic authority form reusable modules.
...
The final register notes should be used after solving practice. They preserve the integrated chain from validity and language to duty and apurva rather than replacing the arguments.
...
| Prompt | Recall spine |
|---|---|
| Dharma | injunction -> action -> apurva -> fruit |
| Validity | intrinsic authority, extrinsic defeat |
| Arthapatti | explanatory incompatibility |
| Absence | yogyata and Bhatta anupalabdhi |
| Awareness | triputi vs jnatata vs anuvyavasaya |
| Error | akhyati vs viparita-khyati |
...
DEFAULT TRUST IN COGNITION
                |
                v
SPECIAL PRAMANAS FOR WHAT INFERENCE OR PERCEPTION CANNOT EXHAUST
                |
                +--> arthapatti -> explanatory supplementation
                +--> anupalabdhi -> determinate absence
                +--> sabda -> supersensible duty
                |
                v
LANGUAGE + HERMENEUTICS + ACTION
                |
                v
APURVA, KARMA, DUTY, AND LATER MOKSA
```

> **Master distinction:** Mīmāṃsā is strongest when read as a theory of **knowledge in the service of duty**. If you separate pramāṇa theory from injunction, Vedic authority, language and apurva, the system starts looking like a disconnected list of doctrines.

## Visual - Hermeneutic Knowledge Map

![Mimamsa: knowledge in defence of dharma](assets/07_Mimamsa-Hermeneutic-Knowledge-Map.png)

The same map should be mentally reused in answers: validity -> pramāṇa -> language -> injunction -> apurva -> criticism.

## Rapid Retrieval Matrix

| Prompt | One-line recall spine |
|---|---|
| Orientation | inquiry into dharma through Vedic injunction |
| Validity | intrinsic validity, extrinsic invalidity |
| Pramāṇas | 5 Prābhākara / 6 Bhāṭṭa |
| Memory | not pramāṇa because no novelty |
| Arthāpatti | explanatory compulsion, Devadatta case |
| Anupalabdhi | non-perception of what would be perceived if present |
| Self-awareness | tripuṭī-samvit vs jñātatā vs anuvyavasāya |
| Error | akhyāti vs viparīta-khyāti |
| Semantics | abhihitānvaya vs anvitābhidhāna |
| Veda | apauruṣeya, eternal, self-valid for dharma |
| Anti-theism | karma and apurva make creator-God redundant |
| Mokṣa | later negative release, not Brahman-identity |
...
**Why this earns marks:** It states the three core supports - apauruṣeyatva, eternality and unique revelatory scope - and directly contrasts the Mimamsa strategy with Nyāya's God-author model.
...
**Conclusion:** memory is not false simply because it is memory; it is excluded because it lacks the novelty required of a pramāṇa.
...
**Question:** What, according to Mīmāṃsakas, is the ontological status of abhāva (absence) and how does one know it? Explain and examine.

**Model solution**

For the **Bhāṭṭa Mīmāṃsakas**, **abhāva** is real enough to be the object of determinate cognition. When I say, “there is no jar on the floor,” I am not merely ignorant of a jar; I positively know its absence. That cognition is structured by a **pratiyogin**, the counterpositive whose absence is at issue.

Bhāṭṭa therefore accepts **anupalabdhi** as an independent pramāṇa. The classic formula is: absence is known through **non-apprehension of what would be apprehended if present**. This requires **yogyānupalabdhi** - fitness conditions such as proper light, functioning sense-organ, available locus and appropriate attention. Only then does non-perception disclose absence.

**Prābhākara** resists a separate anupalabdhi. He explains the case as perception of the bare locus unqualified by the absent object. **Nyāya** also rejects an independent anupalabdhi, though it accepts absence as ontologically significant and handles it through perception or inference.

| View | Status of abhāva | How known? |
|---|---|---|
| Bhāṭṭa | real negative entity/content | anupalabdhi |
| Prābhākara | not denied, but no new pramāṇa required | bare-locus cognition |
| Nyāya | real category | perception or inference, not separate anupalabdhi |

**Examination:** Bhāṭṭa preserves the determinacy of negative cognition very well, but at the price of both a richer ontology and a new pramāṇa. Prābhākara is more economical, but critics ask whether “bare locus” really explains the judgment “the jar is absent.”
...
Mīmāṃsā treats **arthāpatti** as a distinct pramāṇa because it arises from **explanatory compulsion**, not from the sign-based structure of inference. The standard case is: “Devadatta is stout, and Devadatta does not eat during the day.” To preserve both accepted facts, one must postulate that Devadatta eats at night.
...
Mīmāṃsā objects on three grounds. First, the alleged **vyāpti** is not independently known; it is abstracted from the very explanatory tension that arthāpatti is supposed to solve. Second, inference moves from **hetu** to **sādhya**, whereas arthāpatti moves from **incompatible accepted facts** to a postulate that alone makes them coherent. Third, the arthāpatti case lacks the normal **pakṣa-hetu-sādhya** structure.

Kumārila therefore insists that arthāpatti is not a weak guess or provisional hypothesis. It yields the one fact without which the data remain untenable. Chatterjee and Datta put the point sharply: a hypothesis remains tentative, but arthāpatti carries conviction as the only viable explanation.

**Critical discussion:** Nyāya can often reconstruct such cases inferentially, and that is why the debate survives. But the Mimamsa claim is that the inferential reconstruction is parasitic on a prior recognition of explanatory incompatibility. If that is right, arthāpatti deserves independent status.

**Verdict:** arthāpatti is best defended as the epistemic form of explanatory necessity; whether one grants it full independence depends on whether one thinks inferential reformulation captures or merely redescribes that necessity.
...
Both Prabhākara and Kumārila accept **svataḥ-prāmāṇya**: cognition is prima facie valid and does not need prior external certification. Yet they diverge because they explain error in different ways.

For **Prabhākara**, the central issue is to preserve the truth of each constituent cognition. In shell-silver illusion, the present shining object is genuinely perceived as “this,” while previously seen silver is genuinely remembered. The error lies in **non-discrimination** between these two valid cognitions. This is **akhyāti** or, more precisely, **vivekākhyāti** - failure to apprehend the difference. No single false cognition needs to be posited.

For **Kumārila**, this is too weak to explain the assertive force of illusion. The subject does not merely have a perception plus a memory; the subject really judges, “this is silver.” Bhāṭṭa Mīmāṃsā therefore accepts a positive misapprehension, **viparīta-khyāti**. A false cognition occurs, but only under defective conditions - poor light, similarity, distance or other causal disturbance. Intrinsic validity is preserved because falsity is not basic; it is **extrinsically occasioned** and later disclosed through correction.
...
| Name of theory | akhyāti / vivekākhyāti | viparīta-khyāti |
...
**Question:** Present Bhaṭṭa’s view of anupalabdhi (non-cognition) as a valid means of knowledge.

**Model solution**

Bhāṭṭa Mīmāṃsā accepts **anupalabdhi** as an independent pramāṇa because determinate absence-cognition cannot, in its view, be reduced either to perception or to inference. When I judge, “the jar is not on the floor,” I do not merely fail to see a jar; I positively know its absence.

The key formula is **yogyānupalabdhi**: non-apprehension of an object that **would** be apprehended if it were present. Four features matter - perceptibility of the object, availability of the locus, functioning sense-organ, and fit conditions such as light and attention. Under these conditions, non-perception becomes cognitively significant.
...
| How known? | by an independent pramāṇa, anupalabdhi |
| Limiting condition | only under yogyatā / fitness |
| Why not perception? | no present positive object is contacted |
| Why not inference? | inferential force already presupposes anupalabdhi |

**Critical note:** the theory preserves ordinary negative judgments very well, but it multiplies both ontology and pramāṇas. This is why Prābhākara and Nyāya resist it.

**Verdict:** Bhaṭṭa's anupalabdhi is strongest when one insists that absence-cognition is both determinate and irreducible.
...
The difference is captured by the two classic labels **abhihitānvayavāda** and **anvitābhidhānavāda**.
...
|---|---|---|
| Theory name | abhihitānvayavāda | anvitābhidhānavāda |
...
**Prābhākara** accepts **tripuṭī-samvit**. In every cognition, three things are simultaneously revealed: the knower, the known and the cognition. Awareness is self-manifest in the very act of presenting the object. This blocks regress: if cognition required another cognition to reveal it, an infinite chain would follow.

**Bhāṭṭa Mīmāṃsā** denies that cognition is self-luminous. What becomes directly available is the object's **jñātatā** or cognizedness - its being-known. From that state one infers that a cognition has occurred. Reflexive awareness is therefore mediated, not immediate.
...
| Bhāṭṭa | object is known; cognition leaves cognizedness in the object | cognition inferred from jñātatā | preserves object-realism and avoids self-luminous episodes | critics call jñātatā an unnecessary extra entity |
...
**Why this earns marks:** It recognizes the example as a modern arthāpatti test-case, presents both explanations fairly, and explains why the dispute survives instead of giving a one-line winner.
...
Both Prābhākaras and Naiyāyikas reject memory as a pramāṇa because memory lacks the **novel presentational force** that belongs to genuine means of knowledge. It depends on a prior cognition and a residual mental trace.

For the **Prābhākaras**, a pramāṇa must produce fresh cognition of an object. Memory simply reproduces what has already been known. It does not disclose an object as presently given; rather, it recalls what was previously apprehended. Its dependence on earlier knowledge is therefore intrinsic to its non-pramāṇic character.

The **Naiyāyikas** reach a similar conclusion from a different angle. Valid cognition must arise from the proper operation of a pramāṇa such as perception, inference, comparison or testimony. Memory does not arise from present contact with an object, a current inferential mark, a live comparison or a fresh utterance. It arises from a **saṃskāra** left by earlier cognition. Therefore it may be true, but it is not knowledge newly generated by a pramāṇa.
...
| Issue | Svataḥ-prāmāṇya | Parataḥ-prāmāṇya |
|---|---|---|
...
The debate turns on two linked questions: **what is abhāva?** and **how is it known?**

The **Bhāṭṭa Mīmāṃsakas** hold that non-existence is a real negative content capable of cognition. If I know that the jar is absent from the floor, the absence is not merely a linguistic convenience; it is an object structured by the relation to its counterpositive, the jar. Since perception requires contact with a present object, and inference requires a sign, Bhāṭṭa treats absence-cognition as requiring a distinct pramāṇa: **anupalabdhi**.

The **Prābhākaras** refuse both the extra ontology and the extra pramāṇa. What is directly cognized is the locus itself, unqualified by the absent object. The floor is simply presented as jar-less. Hence there is no need to introduce a separate means of knowledge.

| Issue | Bhāṭṭa | Prābhākara |
|---|---|---|
| nature of abhāva | real negative content | no denial of the judgment, but no independent negative entity is needed |
| knowledge of absence | anupalabdhi | ordinary cognition of the bare locus |
| motivation | preserve the determinacy of negative cognition | preserve epistemic and ontological economy |
| main problem | multiplies pramāṇas and objects | may not fully explain the determinacy of “absence of X” |
...
**Why this earns marks:** It centers the answer on the exact two-fold debate - nature and knowledge of abhāva - and concludes with the underlying methodological contrast between the two sub-schools.

## Original MCQ Bank - 32 Questions

| Q | Question and options | Key | Explanation |
|---:|---|:---:|---|
| 1 | Mīmāṃsā begins with: A. inquiry into dharma B. proof of God C. denial of self D. mystical union | A | The school starts from dharma-jijñāsā, not from speculative theology. |
| 2 | In the Mimamsa context, **codanā** means: A. memory of duty B. impelling Vedic injunction C. comparison-based cognition D. prior non-existence | B | Codanā is the command-form that makes duty action-guiding. |
| 3 | Which school accepts six pramāṇas? A. Nyāya B. Prābhākara Mīmāṃsā C. Bhāṭṭa Mīmāṃsā D. Sāṃkhya | C | Bhāṭṭa adds anupalabdhi to the five accepted by Prābhākara. |
...
| 5 | Svataḥ-prāmāṇya says that cognition is: A. prima facie valid by its own occurrence B. permanently infallible C. created by language D. valid only after success | A | Intrinsic validity means default trust, not incorrigibility. |
| 6 | Parataḥ-aprāmāṇya means that invalidity is known through: A. intuition alone B. later contradiction or discovery of defect C. universals only D. deep sleep | B | Falsity is externally disclosed. |
| 7 | The stout Devadatta case is the classical example of: A. anupalabdhi B. anuvyavasāya C. arthāpatti D. sphoṭa | C | The conclusion is compelled explanatory postulation. |
| 8 | Nyāya's reduction of arthāpatti relies most on a prior: A. niyoga B. apūrva C. akhyāti D. vyāpti | D | It tries to convert the case into standard inference. |
| 9 | Yogyānupalabdhi requires that the absent object: A. would be perceivable if present B. be eternal C. be remembered from childhood D. be scripturally revealed | A | Non-perception counts only when perception should have occurred. |
| 10 | According to Bhāṭṭa Mīmāṃsā, abhāva is: A. mere grammar B. a real negative content known by anupalabdhi C. impossible to cognize D. always inferential only | B | Bhāṭṭa grants both objecthood and a separate pramāṇa. |
| 11 | Tripuṭī-samvit means simultaneous manifestation of: A. three Vedas B. word, meaning and sentence C. knower, known and cognition D. duty, fruit and God | C | This is the Prābhākara answer to metacognition. |
| 12 | Jñātatā refers to the object's: A. falsity B. universality C. ritual purity D. cognizedness, from which cognition is inferred | D | Kumārila denies self-luminosity of cognition and infers it from jñātatā. |
| 13 | Akhyāti explains illusion as: A. non-discrimination between perception and memory B. divine deception C. pure non-being D. only linguistic confusion | A | Prābhākara keeps the constituent cognitions valid. |
| 14 | Viparīta-khyāti holds that illusion involves: A. only recollection B. a positive misapprehension under defect C. no cognition at all D. mere verbal error | B | Bhāṭṭa allows a false cognition without abandoning intrinsic validity. |
| 15 | Abhihitānvayavāda states that: A. words mean only particulars B. Veda has a divine author C. words first denote separate meanings and then get connected D. sentences alone are primary | C | This is the Bhāṭṭa theory of sentence meaning. |
| 16 | Anvitābhidhānavāda states that words convey: A. only remembered objects B. abstract sounds without meaning C. bare universals alone D. meanings as already connected in sentential use | D | This is the Prābhākara contextualist position. |
...
| 19 | Apauruṣeyatva primarily protects the Veda from: A. ritual complexity B. historical transmission C. authorial defect D. sentence-unity | C | No human or divine author means no author-based error. |
| 20 | The strongest Mimamsa reason to reject a creator-God is that God would: A. abolish perception B. destroy universals C. remove duty D. become redundant beside karma and apūrva or introduce partiality | D | This is the classic anti-theistic pressure point. |
| 21 | Śābdī bhāvanā is the: A. linguistic impelling force of the injunction B. bare-locus cognition of absence C. theory of memory D. post-mokṣa bliss | A | It explains how the Vedic word moves the agent to act. |
| 22 | Ārthī bhāvanā is the: A. eternity of words B. real productive force of the performed act C. relation between universal and particular D. later reflective cognition | B | It explains how action brings about the result. |
...
| 24 | Apūrva is best described as: A. a visible ritual fire B. a universal C. God in hidden form D. an unseen potency linking act and later fruit | D | It explains delayed ritual efficacy without theism. |
...
| 27 | The self in Mimamsa must be: A. momentary B. identical with language C. enduring as knower, agent and enjoyer D. unreal like illusion | C | Without continuity, karma and ritual fruit collapse. |
| 28 | Later Mimamsa mokṣa is best stated as: A. union with Īśvara B. absorption into language C. public ritual prestige D. cessation of suffering and embodiment, not Brahman-identity | D | The doctrine is largely negative and should not be Vedāntized. |
...
| 30 | Nyāya explains awareness of cognition through: A. apūrva B. anuvyavasāya C. codanā D. akhyāti | B | A higher-order cognition reflects on the first act of knowing. |
...
| 32 | The safest one-line summary of the topic is: A. theology in search of omniscience B. skepticism about all knowledge C. mysticism without duty D. knowledge in the service of dharma | D | That formula keeps epistemology tied to language, duty and ritual action. |
...
| 2 | “Prābhākara accepts six pramāṇas like Bhāṭṭa.” | Say: Prābhākara accepts **five**; Bhāṭṭa alone adds **anupalabdhi**. | This is one of the most repeated factual traps. |
| 3 | “Arthāpatti is just a fancy name for guesswork.” | Say: it is **compelled postulation** produced by otherwise unresolved incompatibility. | The exam asks for its irreducible logic, not its superficial plausibility. |
| 4 | “Akhyāti means there is no cognition at all in illusion.” | Say: there are valid cognitions, but their **difference is not discriminated**. | Without this, Prābhākara's theory collapses into absurdity. |
| 5 | “Bhāṭṭa accepts self-luminous cognition.” | Say: Bhāṭṭa defends intrinsic validity but knows cognition through **jñātatā**. | This is the decisive distinction between manifestation and validity. |
| 6 | “Mīmāṃsā proves Veda by invoking God.” | Say: it secures the Veda by **excluding** divine authorship and defending apauruṣeyatva. | This preserves the school's distinctive orthodoxy-without-theism. |
| 7 | “Niyoga and desire for fruit mean the same thing.” | Say: Prābhākara makes obligation categorical, while Bhāṭṭa allows a stronger place for phala-motivation. | This prevents flattening the Bhāṭṭa-Prābhākara ethical divide. |
| 8 | “Mokṣa in Mimamsa is merger into Brahman.” | Say: later Mimamsa generally presents mokṣa negatively, as release from pain and embodiment. | This blocks Vedāntic importation into a ritual-epistemic school. |

## Original Mains Practice

### Practice 1 - 10 marks

**Question:** Explain how codanā, bhāvanā and apūrva together make Mīmāṃsā a theory of duty rather than a mere theory of knowledge.

**Model solution**

**Codanā** makes Vedic language prescriptive: dharma is known as what the Veda enjoins. **Bhāvanā** explains how that injunction works. In Bhāṭṭa terms, **śābdī bhāvanā** impels the qualified agent to act, while **ārthī bhāvanā** belongs to the actual performance that produces the result. **Apūrva** then links the visible but perishing act to a later unseen fruit.

These three ideas therefore form one chain. Codanā gives duty its linguistic form, bhāvanā gives injunction its motivational and productive structure, and apūrva secures delayed efficacy without requiring a creator-God. Without codanā, the Veda would become descriptive; without bhāvanā, command would not generate action; without apūrva, the gap between act and fruit would remain unexplained.

A Vedāntin may object that this subordinates too much scriptural meaning to action. Mīmāṃsā accepts the price because its project is not metaphysical disclosure first, but the determination of dharma.
...
**Question:** Is Prābhākara's tripuṭī-samvit a stronger account of self-awareness than Nyāya anuvyavasāya and Bhāṭṭa jñātatā? Evaluate.

**Model solution**

Prābhākara's **tripuṭī-samvit** is powerful because it meets the regress objection most directly. If cognition were not somehow manifest in the very act of knowing, another cognition would be needed to reveal it, and that second cognition would need a third. By holding that knower, known and cognition are given together, Prābhākara preserves immediacy.
...
**Bhāṭṭa** avoids both full self-luminosity and explicit second-order reflection by appealing to **jñātatā**. Cognition is inferred from the object's cognizedness. This preserves a stronger object-realism, but critics complain that jñātatā looks like an extra entity introduced only to avoid self-manifest cognition.

**Evaluation:** tripuṭī-samvit is strongest if anti-regress economy is treated as decisive. Nyāya is strongest if reflective structure is prioritized. Bhāṭṭa is strongest if one wants reflexive awareness without granting self-luminous episodes. No single theory is cost-free.
...
- Pūrva-Mīmāṃsā = inquiry into **dharma**, not first into Brahman or God.
...
### Dharma, codanā and ritual efficacy

- `codana-laksano'rtho dharmah` = dharma is known through Vedic injunction.
- **Vidhi** enjoins; **niṣedha** prohibits.
- **Śābdī bhāvanā** impels the agent; **ārthī bhāvanā** is productive activity.
- **Apūrva** links act and future fruit.
- **Niyoga** = directly binding “to-be-done,” especially in Prābhākara.
- **Aṃśa-traya** = what, by what means, and how.

### Validity and pramāṇas

- **Svataḥ-prāmāṇya** = intrinsic validity; **parataḥ-aprāmāṇya** = extrinsic invalidity.
- Belief is normal; disbelief is exceptional.
- Nyāya counter = parataḥ-prāmāṇya through validation.
- Pramāṇas:
  - Prābhākara = 5
  - Bhāṭṭa = 6
...
- **Arthāpatti** = explanatory necessity, not guess.
- Standard example: stout Devadatta who does not eat by day -> must eat at night.
- **Anupalabdhi** = non-perception of what would be perceived if present.
- **Yogyatā** is decisive.
- Bhāṭṭa grants abhāva real objecthood and a separate pramāṇa; Prābhākara chooses economy.

### Self-awareness and error

| Problem | Prābhākara | Bhāṭṭa | Nyāya |
|---|---|---|---|
| cognition of cognition | tripuṭī-samvit | jñātatā-inference | anuvyavasāya |
| illusion | akhyāti | viparīta-khyāti | anyathā-khyāti |

- Akhyāti = non-discrimination between valid perception and valid memory.
- Viparīta-khyāti = positive misapprehension under defect.
- Shell-silver is the standard test-case.

### Word and sentence meaning

- Sentence-unity depends on **ākāṅkṣā**, **yogyatā**, **sannidhi**.
- **Abhihitānvayavāda**: words first denote separately, then connect.
- **Anvitābhidhānavāda**: words denote already-connected meanings.
...
- Karma + apūrva do the explanatory work.
- Ritual deities remain inside procedure, but are not sovereign dispensers of result.

### Self, world, karma and mokṣa

- World is real.
- Self is enduring knower, agent and enjoyer.
- Ritual fruit presupposes continuity of self.
- Later mokṣa = cessation of pain and embodiment; do not import Advaita's Brahman-identity.
- Early stress remains stronger on **dharma** and **svarga**.

### PYQ route map

- 2018: self-luminosity versus intrinsic validity.
- 2019: Vedic authority.
- 2020: memory not pramāṇa.
- 2021: abhāva and its knowledge.
- 2022: arthāpatti vs inference; error within intrinsic validity.
- 2023: anupalabdhi; universals versus particulars.
...
4. Arthāpatti is not mere guess.
5. Anupalabdhi is Bhāṭṭa's distinct contribution.
6. Akhyāti is not no-cognition.
...
9. Apūrva is not visible causation and not God-in-disguise.
