# KANT — Syllabus Item 4 (Paper I · Section A)
...
4. ∴ The categories are necessarily valid for all objects of experience — not because they correspond to things-in-themselves, but because *experience cannot occur without them*. ✅
...
- [`../_themes/A-priori-a-posteriori-knowledge.md`](../_themes/A-priori-a-posteriori-knowledge.md) — the a priori/a posteriori distinction and synthetic a priori across traditions.
- [`../_themes/Critiques-of-metaphysics.md`](../_themes/Critiques-of-metaphysics.md) — Kant's antinomies as the first great systematic critique of metaphysics (alongside Hume's Fork, the verification principle, Quine's holism).
- [`../_themes/Causation-across-schools.md`](../_themes/Causation-across-schools.md) — Kant's category of causality vs Hume's custom vs satkāryavāda.
- [`Empiricism.md`](Empiricism.md) — Hume's causation analysis (the trigger for Kant).
- [`Rationalism.md`](Rationalism.md) — Descartes' ontological argument (refuted by Kant); the rationalist claim to a priori metaphysics.
- [`Hegel.md`](Hegel.md) — Hegel's critique of phenomena/noumena; dialectical method as response to Kantian limits.
- [`Logical-Positivism.md`](Logical-Positivism.md) — the verification principle as a post-Kantian anti-metaphysics move.
- Cross-paper: [`../../paper-2/philosophy-of-religion/Proofs-for-God.md`](../../paper-2/philosophy-of-religion/Proofs-for-God.md) — Kant's refutations in the Religion context.
