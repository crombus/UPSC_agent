# EMPIRICISM (Locke, Berkeley, Hume) — Syllabus Item 3 (Paper I · Section A)
...
## 2. SUBSTANCE AND QUALITIES ✅

### 2.1 LOCKE — Substance and Qualities
...
### 2.2 BERKELEY — Substance and Qualities
...
| Criticism | Source | Reply |
|---|---|---|
| Common sense: surely tables exist unperceived! | Samuel Johnson (kicks stone: "I refute it thus!") | Berkeley: the table *does* exist unperceived (by you) — God perceives it. His theory *saves* common sense, not destroys it. |
| Solipsism threat: if reality = my ideas, other minds? | Critics | Berkeley: other minds (spirits) are known by *analogy*; God guarantees the whole system. |
...
| How is Berkeley's idealism different from Hegel's absolute idealism? (PYQ 2024 Q2a) | Examiner | Berkeley: reality = ideas in *finite and divine minds*; Hegel: reality = the self-development of *Absolute Spirit/Geist* through dialectic. Berkeley's idealism is *subjective* (mind-dependent); Hegel's is *objective/absolute* (Mind developing itself as the world's substance). ⚠️ |
...
| 3 | Primary / Secondary qualities | Locke — the quality distinction |
| 4 | "Something I know not what" | Locke — substance as unknown substratum |
| 5 | Real essence / Nominal essence | Locke — classification and limits of knowledge |
| 6 | *Esse est percipi* — "to be is to be perceived" | Berkeley — idealism's formula |
| 7 | Abstract general ideas (rejected) | Berkeley — nominalism |
| 8 | Impressions / Ideas (Hume's sense) | Hume — the Copy Principle |
| 9 | Hume's Fork — relations of ideas vs matters of fact | Hume — demarcation of knowledge |
| 10 | Constant conjunction + custom/habit | Hume — causation |
| 11 | "Necessary connexion" — an impression of reflection | Hume — subjective necessity |
| 12 | Bundle theory — "a bundle or collection of different perceptions" | Hume — self |
| 13 | Mitigated scepticism | Hume — his positive recommendation |
| 14 | "Commit it to the flames" | Hume — anti-metaphysics |
...
### Hume: demonstrative necessity versus causal expectation
- ✅ “2+2=4” expresses a relation of ideas whose denial is contradictory; “the Sun will rise tomorrow” is a matter of fact whose denial remains conceivable.
- ✅ Repetition supplies custom and expectation, not an impression of necessary connexion. The inference to tomorrow therefore presupposes the uniformity of nature, which cannot be non-circularly proved by experience.
- ❌ Do not say Hume assigns both propositions the same probability or necessity.
...
- ⚠️ **Priority:** Primary ownership rises to 12 of 112 parts and now occurs in every year.
- ✅ **Required doctrinal depth:** New burdens are Hume’s different treatment of “the Sun will rise” and “2+2=4”, Berkeley’s idealism under Moore/Russell criticism, and Humean personal identity answered by Kant’s transcendental unity.
- ❌ **Trap / answer consequence:** Do not collapse relations of ideas into matters of fact, or treat Kant’s response as Hume’s own doctrine; comparison answers must complete the empiricist argument before the secondary reply.
...
|---|---|---:|---|
| 2018 | Q1(a) | 10 marks | Are the two truths—'The Sun will rise tomorrow' and '2+2=4' of the same necessity for Hume? Give reasons in favour of your answer. |
| 2018 | Q3(a) | 20 marks | How does Berkeley establish that Mind and its ideas alone are real? How do Moore and Russell react to Berkeley's view in this regard? Do you find any difference between Moore's reaction and Russell's one? Discuss. |
| 2019 | Q4(b) | 15 marks | Is there any element of necessity in causal relations according to Hume? Discuss. |
| 2020 | Q2(a) | 20 marks | “I never can catch myself at any time without perception, and never can observe anything but the perception.” How does this statement by Hume problematize the philosophical notion of personal identity? How does Kant deal with this problem in his Critique of Pure Reason? |
| 2021 | Q1(c) | 10 marks | “Sensible things are those only which are immediately perceived by sense.” Explain Berkeley’s theory of knowledge with reference to the above statement. |
| 2021 | Q1(d) | 10 marks | Examine the concept of personal identity by Locke. |
| 2021 | Q1(e) | 10 marks | “The relation between cause and effect is one of constant conjunction”. Examine Hume’s criticism of causation in the light of the above statement. |
| 2022 | Q4(c) | 15 marks | Why and how does John Locke refute the innate ideas? Elucidate the nature and source of knowledge in Locke’s epistemology. |
| 2023 | Q2(a) | 20 marks | Critically analyse Hume’s argument that causality is a matter of habit/custom involving psychological principle of association. |
| 2024 | Q2(a) | 20 marks | Is rejection of Locke’s notion of primary qualities instrumental in Berkeley’s leaning towards idealism? In this context, also discuss how subjective idealism is different from the absolute idealism proposed by Hegel. |
| 2025 | Q2(c) | 15 marks | Examine Hume’s refutation of Causal relation and Kant’s response to it. |
...
Line 1: For Locke, personal identity consists in continuity of consciousness — a person
         at T₂ is the same person as at T₁ if and only if they are conscious of (can
         remember) having had T₁'s experiences.
Body  : (i) Not sameness of soul-substance (we might unknowingly get a new soul).
        (ii) Not sameness of body (bodies change constantly).
...
### 15-mark: "Hume's refutation of causal relation and Kant's response" (2025)
```
...
### 20-mark: "Hume's argument that causality is habit/custom — critically analyse" (2023)
```
...
- [`../_themes/Substance-across-western.md`](../_themes/Substance-across-western.md) — Locke's "know-not-what," Berkeley's denial, Hume's dissolution.
- [`../_themes/A-priori-a-posteriori-knowledge.md`](../_themes/A-priori-a-posteriori-knowledge.md) — empiricist denial of the a priori (except Hume's relations of ideas).
- [`../_themes/Causation-across-schools.md`](../_themes/Causation-across-schools.md) — Hume's constant conjunction vs Kant's category vs satkāryavāda.
- [`Rationalism.md`](Rationalism.md) — the rival tradition; Descartes' innate ideas refuted by Locke.
- [`Kant.md`](Kant.md) — the synthesis that Hume "awoke from dogmatic slumber."
- [`Logical-Positivism.md`](Logical-Positivism.md) — Hume's Fork → verification principle (anti-metaphysics ancestor).
- [`../indian/Buddhism.md`](../indian/Buddhism.md) — Hume's bundle self ↔ Buddhist *nairātmyavāda* (no-self).
...
- Masih, Y., *A Critical History of Western Philosophy* — chapters on Locke, Berkeley, Hume.
- Copleston, F., *A History of Philosophy*, Vol. V (British Philosophers: Hobbes to Hume).
- Kenny, A., *A New History of Western Philosophy*, Vol. III — chapters on British Empiricism.
- Warburton, N., *Philosophy: The Classics* — chapters on the *Essay*, *Principles*, *Treatise/Enquiry*.
- Primary texts referenced: Locke, *An Essay Concerning Human Understanding* (1690); Berkeley, *A Treatise Concerning the Principles of Human Knowledge* (1710), *Three Dialogues between Hylas and Philonous* (1713); Hume, *A Treatise of Human Nature* (1739–40), *An Enquiry Concerning Human Understanding* (1748), *Dialogues Concerning Natural Religion* (pub. 1779).
