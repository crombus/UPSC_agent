# PHENOMENOLOGY (Husserl) — Syllabus Item 9 (Paper I · Section A)
...
- This attitude has a **general thesis** (*Generalthesis*): the world exists, has always existed, and would continue to exist without me. ✅
- The natural attitude encompasses not only naïve common sense but also the natural sciences — physics, biology, psychology all *presuppose* that they investigate an independently existing domain.
...
1. It explains how the *same* sensory material can found **different** objects — the duck-rabbit case belongs here as much as to Wittgenstein (see [`Later-Wittgenstein.md`](Later-Wittgenstein.md) §5B).
2. It shows that Husserl is **not** a sense-datum theorist: hyletic data are never the *objects* of perception, so there is no "veil of ideas" and no inference from data to world. This directly separates him from Locke and Russell.
...
4. ❓ **Standing difficulty:** if hyletic data are non-intentional, they cannot be given *as* anything — so on Husserl's own principle of principles, in what sense are they given at all? Husserl's later genetic phenomenology largely absorbs the hyle into passive synthesis, which is a tacit concession.
...
- The **eidetic reduction** moves from the factual instance to its **eidos** (essence) via the technique of **free imaginative variation** (§2).
- Purpose: phenomenology aims to be not an empirical chronicle of experiences but a science of the **essential structures** of consciousness and its objects. ⚠️
...
- **Formal ontology** vs **material (regional) ontology:**
  - *Formal ontology* deals with the most general categorical forms (object, property, relation, state of affairs, whole-part) that apply to *every* region. It is analogous to formal logic.
  - *Material ontology* deals with the specific essential structures of *each* region.
- Husserl envisions phenomenology as the *foundational science* that grounds all regional ontologies by clarifying how their objects are constituted in consciousness. ⚠️
...
- **The charge:** after the *Ideas* (1913), Husserl locates all meaning-constitution in the **transcendental ego**. If truth is "constituted in transcendental subjectivity," have we not made it subject-dependent again — i.e., re-introduced psychologism at the transcendental level?
...
2. **Within it, my body is unique.** My **lived body** (*Leib*) is the only physical thing that is also an organ of will, a field of sensings, and the absolute "**here**" from which everything else is "there." Every other body is a mere *Körper* (physical body).
...
5. **Appresentation (*Appräsentation*).** On the basis of the pairing, the other's subjectivity is **appresented** — co-intended without being itself presented, exactly as the unseen back of a table is appresented in seeing its front. ⚠️ **This is analogy in the sense of an analogising transfer of sense, not an argument from analogy.** Husserl explicitly denies that it is an inference.
...
- **P3** Pairing is genuinely passive and pre-predicative, not a disguised inference.
- **P4** The order of constitution is asymmetrical: I am constituted first, others through me.
...
| **The Other is not known by appresentation but encountered in the Look**: the other reveals himself by making *me* an object, in shame — an experience of my being-for-others, not a constitution of his being-for-me. | **Sartre**, *Being and Nothingness* (1943), Part III | Sartre describes a *modality* of encountering the other that itself presupposes the constituted sense "other subject." | ⚠️ Strong and genuinely rival; see [`Existentialism.md`](Existentialism.md). |
...
- ⚠️ **Priority:** Primary ownership is 7 of 112 parts; 2018 has no primary-owned part, though epoché is a secondary premise in the Heidegger question.
- ✅ **Required doctrinal depth:** The restored 2020 question requires the anti-psychologism argument: logical validity and ideal meanings cannot be reduced to contingent psychological events, and phenomenological method must preserve their normativity.
- ❌ **Trap / answer consequence:** Do not confuse avoiding psychologism with excluding consciousness; Husserl studies intentional acts while refusing to make logical truth depend on empirical mental laws.
...
```
Defn  : Psychologism = logic is a branch of empirical psychology; logical laws are generalisations
        about how we in fact think.
Args  : (i) necessary ≠ probable; (ii) ideal content ≠ real act; (iii) relativism is self-refuting;
        (iv) conditions of thinking ≠ grounds of validity.
Avoid : Transcendental phenomenology avoids it because the transcendental ego is NOT the empirical
...
Close  : Husserl's criticism of the natural attitude inaugurates a new mode of philosophising —
         not "about" the world but about the *meaning-structures* within which any world appears.
```
...
Close : Yes — hallucination is paradigmatically intentional; this shows that intentionality is about
...
- [../_themes/Critiques-of-metaphysics.md](../_themes/Critiques-of-metaphysics.md) — Husserl's peculiar position: he *critiques* naïve metaphysics (bracketing) yet *retains* essences.
...
- Husserl, Edmund. *Logical Investigations* (1900–01), esp. Vol. I: *Prolegomena to Pure Logic* (psychologism refutation) and Vol. VI (categorial intuition).
- Husserl, Edmund. *Ideas Pertaining to a Pure Phenomenology and to a Phenomenological Philosophy, First Book* (*Ideas I*, 1913) — epoché, reductions, intentionality, principle of principles.
- Husserl, Edmund. *Cartesian Meditations* (1931) — transcendental ego, Fifth Meditation on intersubjectivity.
- Husserl, Edmund. *The Crisis of European Sciences and Transcendental Phenomenology* — Parts I–II published 1936 (*Philosophia*, Belgrade); complete text posthumous 1954 (*Husserliana* VI, ed. Biemel); Eng. tr. David Carr, 1970 — Lebenswelt, critique of scientific objectivism.
- Husserl, Edmund. *On the Phenomenology of the Consciousness of Internal Time* — lectures 1893–1917; edited by Edith Stein and published by Heidegger, 1928 — retention, primal impression, protention.
...
- Mohanty, J. N. *Husserl and Frege* (1982) — the standard corrective to the claim that Frege's review caused Husserl's anti-psychologistic turn.
