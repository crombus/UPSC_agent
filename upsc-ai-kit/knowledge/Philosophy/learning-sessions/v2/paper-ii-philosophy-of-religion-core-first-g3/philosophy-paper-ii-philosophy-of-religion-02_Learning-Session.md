...
KEY TERMS / DEFINITIONS: [FACT] marks retained repository doctrine/question data. [INFERENCE] marks the learner-facing organisation and graded verdict.
MECHANISM / ARGUMENT: This ledger maps source units to the final location rather than merely asserting reconciliation.
CONSEQUENCE / CONTRAST: Proof structures, named proponents, school-specific arguments and core critiques are CORE PAPER II.
UPSC TRAP / ANSWER-USE: This ledger maps source units to the final location rather than merely asserting reconciliation.
ANSWER-GRABBING FORMULATION: [FACT] marks retained repository doctrine/question data. [INFERENCE] marks the learner-facing organisation and graded verdict.
```
...
KEY TERMS / DEFINITIONS: Evidence key used throughout: ✅ canonical doctrine directly grounded in the authored knowledge file or a local source text · ⚠️ analytical synthesis / inference for exam use · ❓ contested or textually variable · 📰 dated contemporary anchor only, never authority.
MECHANISM / ARGUMENT: The retained source sequence moves from what counts as a proof, through Western and Indian argument families, to comparison and answer construction.
...
UPSC TRAP / ANSWER-USE: Notions of God, evil, experience, faith and language appear only as bounded links or targets of a premise; they are not silently absorbed into this topic.
ANSWER-GRABBING FORMULATION: The retained source sequence moves from what counts as a proof, through Western and Indian argument families, to comparison and answer construction.
```
