...
cover_image: ../../../Indian-Philosophy/learning-sessions/Samkhya/assets/05_Samkhya-One-Three-TwentyFive.png
---
...
THREE PRAMĀṆAS
      ->
ONE UNCONSCIOUS PRAKṚTI + MANY CONSCIOUS PURUṢAS
      ->
GUṆA DISEQUILIBRIUM
      ->
EVOLUTION OF 23 FURTHER TATTVAS
      ->
EXPERIENCE AND MISIDENTIFICATION
      ->
...
![Samkhya system map](../../../Indian-Philosophy/learning-sessions/Samkhya/assets/05_Samkhya-One-Three-TwentyFive.png)
...
```closure-flow
SUBTOPIC: 1 The three-pramāṇa scheme
KEY TERMS / DEFINITIONS: Statement. ✅ Sāṃkhya admits exactly three pramāṇas (valid means of knowledge): dṛṣṭa / pratyakṣa (perception), anumāna (inference) and āptavacana / śabda (reliable testimony).
MECHANISM / ARGUMENT: Exam use. ⚠️ This epistemology is the hinge of the whole system: because mūla-prakṛti (root Prakṛti) and puruṣa are not sense-objects, Sāṃkhya must show how they can still be known without multiplying pramāṇas.
CONSEQUENCE / CONTRAST: Exam use. ⚠️ This epistemology is the hinge of the whole system: because mūla-prakṛti (root Prakṛti) and puruṣa are not sense-objects, Sāṃkhya must show how they can still be known without multiplying pramāṇas.
UPSC TRAP / ANSWER-USE: Statement. ✅ Other proposed pramāṇas — upamāna (comparison), arthāpatti (postulation), anupalabdhi (non-apprehension), sambhava (inclusion/probability) and aitihya (traditional report) — are not rejected as useless; they are reduced to, or included within, these three.
ANSWER-GRABBING FORMULATION: Statement. ✅ Sāṃkhya admits exactly three pramāṇas (valid means of knowledge): dṛṣṭa / pratyakṣa (perception), anumāna (inference) and āptavacana / śabda (reliable testimony).
```
...
```closure-flow
SUBTOPIC: 2 Definitions of the three pramāṇas
KEY TERMS / DEFINITIONS: Statement. ✅ Dṛṣṭa / pratyakṣa is the prativiṣayādhyavasāya (ascertainment with respect to a presented object) of objects through the sense-capacities in contact with them.
MECHANISM / ARGUMENT: Statement. ✅ Dṛṣṭa / pratyakṣa is the prativiṣayādhyavasāya (ascertainment with respect to a presented object) of objects through the sense-capacities in contact with them.
CONSEQUENCE / CONTRAST: Statement. ✅ Āptavacana / śabda is the word of a trustworthy source, pre-eminently Veda / śruti, where the speaker or text is not defective and the object is not otherwise easily known.
UPSC TRAP / ANSWER-USE: Statement. ✅ Āptavacana / śabda is the word of a trustworthy source, pre-eminently Veda / śruti, where the speaker or text is not defective and the object is not otherwise easily known.
ANSWER-GRABBING FORMULATION: Statement. ✅ Dṛṣṭa / pratyakṣa is the prativiṣayādhyavasāya (ascertainment with respect to a presented object) of objects through the sense-capacities in contact with them.
```
...
```closure-flow
SUBTOPIC: 4 Why sāmānyato-dṛṣṭa inference is decisive
KEY TERMS / DEFINITIONS: Statement. ✅ Avyakta / mūla-prakṛti and puruṣa are both atīndriya (beyond the senses): neither is an object of ordinary perception.
MECHANISM / ARGUMENT: Distinction. ✅ Sāṃkhya lists standard causes of non-perception: excessive distance, excessive proximity, defect of the organ, inattention of mind, subtlety, obstruction by an intervening object, being overpowered by something else, and admixture with like things.
CONSEQUENCE / CONTRAST: Conclusion. ⚠️ Therefore the five arguments for Prakṛti and the arguments for Puruṣa are not rhetorical flourishes; they discharge an epistemological obligation created by Sāṃkhya's own three-pramāṇa scheme.
UPSC TRAP / ANSWER-USE: Statement. ✅ Their imperceptibility is not proof of non-existence; the standard non-perception discussion assigns mūla-prakṛti's imperceptibility to saukṣmya (subtlety), and Puruṣa is likewise atīndriya rather than non-existent.
ANSWER-GRABBING FORMULATION: Statement. ✅ Avyakta / mūla-prakṛti and puruṣa are both atīndriya (beyond the senses): neither is an object of ordinary perception.
```
...
```closure-flow
SUBTOPIC: 5 Presupposition and objections
KEY TERMS / DEFINITIONS: Objection. ❓ Cārvāka: vyāpti cannot be secured for a term never perceived; therefore inference to mūla-prakṛti or puruṣa is speculative.
MECHANISM / ARGUMENT: Objection. ❓ Cārvāka: vyāpti cannot be secured for a term never perceived; therefore inference to mūla-prakṛti or puruṣa is speculative.
CONSEQUENCE / CONTRAST: Objection. ❓ Cārvāka: vyāpti cannot be secured for a term never perceived; therefore inference to mūla-prakṛti or puruṣa is speculative.
UPSC TRAP / ANSWER-USE: Presupposition. ⚠️ Sāṃkhya presupposes that inference from general correlation can legitimately reach an entity of a kind never itself observed as a sense-object.
ANSWER-GRABBING FORMULATION: Presupposition. ⚠️ Sāṃkhya presupposes that inference from general correlation can legitimately reach an entity of a kind never itself observed as a sense-object.
```
...
```closure-flow
SUBTOPIC: 6 Theory of cognition: antaḥkaraṇa and reflection
KEY TERMS / DEFINITIONS: Statement. ✅ The full trayodaśa-karaṇa (thirteen-fold instrument) consists of 3 internal organs + 5 buddhīndriyas / jñānendriyas (cognitive sense-capacities) + 5 karmendriyas (action-capacities).
MECHANISM / ARGUMENT: Distinction. ✅ The external faculties function as dvāra (doors), while the inner organ functions as dvārin (doorkeeper/door-supervisor) because it receives, coordinates and determines what enters cognition.
CONSEQUENCE / CONTRAST: Argument. ✅ Buddhi is sattva-predominant and therefore transparent; it reflects Puruṣa's consciousness through puruṣa-cchāyā-āpatti / buddhi-pratibimba (falling of Puruṣa's shadow/reflection in buddhi).
UPSC TRAP / ANSWER-USE: Exam use. ⚠️ For Sāṃkhya, the mind does not know by itself and Puruṣa does not act by itself; empirical knowing is a reflected-consciousness event in buddhi.
ANSWER-GRABBING FORMULATION: Statement. ✅ The antaḥkaraṇa (inner instrument) has three functions: buddhi (determinative intellect), ahaṃkāra (I-maker) and manas (coordinating mind).
```
...
KEY TERMS / DEFINITIONS: ✅ Prakṛti (prakriti) is the unmanifest, unconscious, primordial material principle from which the entire objective and psycho-physical world evolves.
MECHANISM / ARGUMENT: ✅ It is also called pradhāna (chief principle) because it is the primary material basis of all empirical manifestation.
CONSEQUENCE / CONTRAST: ✅ It is called avyakta (unmanifest) because in its primordial condition it is not yet differentiated into manifest tattvas.
UPSC TRAP / ANSWER-USE: ✅ It is called avyakta (unmanifest) because in its primordial condition it is not yet differentiated into manifest tattvas.
ANSWER-GRABBING FORMULATION: ✅ Prakṛti (prakriti) is the unmanifest, unconscious, primordial material principle from which the entire objective and psycho-physical world evolves.
```
...
```closure-flow
SUBTOPIC: 2 Why Sāṃkhya needs Prakṛti
KEY TERMS / DEFINITIONS: ✅ The world is marked by plurality, transformation, dependence, teleology and structured manifestation.
MECHANISM / ARGUMENT: ✅ The world is marked by plurality, transformation, dependence, teleology and structured manifestation.
CONSEQUENCE / CONTRAST: ✅ A school that accepts real effects, real bondage and real liberation needs a real material source from which empirical diversity emerges.
UPSC TRAP / ANSWER-USE: ✅ Since Puruṣa is changeless and inactive, it cannot itself become the world.
ANSWER-GRABBING FORMULATION: ✅ The world is marked by plurality, transformation, dependence, teleology and structured manifestation.
```
...
```closure-flow
SUBTOPIC: 3 The five arguments for the existence of Prakṛti
KEY TERMS / DEFINITIONS: The standard cluster of arguments is central to UPSC.
MECHANISM / ARGUMENT: ✅ Sāṃkhya argues for Prakṛti by inference.
CONSEQUENCE / CONTRAST: The standard cluster of arguments is central to UPSC.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Sāṃkhya argues for Prakṛti by inference.
ANSWER-GRABBING FORMULATION: ✅ Sāṃkhya argues for Prakṛti by inference.
```
...
```closure-flow
SUBTOPIC: (1) bhedānāṃ parimāṇāt — from the finitude and determinateness of things
KEY TERMS / DEFINITIONS: ✅ What is finite and determinate points beyond itself to a more fundamental source from which such determinate forms arise.
MECHANISM / ARGUMENT: ✅ The manifold world therefore requires a common antecedent material ground.
CONSEQUENCE / CONTRAST: ✅ The manifold world therefore requires a common antecedent material ground.
UPSC TRAP / ANSWER-USE: ⚠️ The force of the argument is not merely "every effect has a cause," but "the limited and differentiated presuppose a subtler ground from which limitation and differentiation emerge."
ANSWER-GRABBING FORMULATION: ✅ Empirical things are many, finite, delimited and measurable.
```
...
```closure-flow
SUBTOPIC: (2) samanvayāt — from the uniformity / homogeneity running through effects
KEY TERMS / DEFINITIONS: ⚠️ This is an argument from coordinated diversity: if effects hang together, they are likely rooted in one underlying matrix.
MECHANISM / ARGUMENT: ✅ Diverse products nevertheless reveal continuity of constitution and dependence.
CONSEQUENCE / CONTRAST: ✅ Effects display an underlying order and common pattern.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Effects display an underlying order and common pattern.
ANSWER-GRABBING FORMULATION: ✅ Effects display an underlying order and common pattern.
```
...
```closure-flow
SUBTOPIC: (3) kāryataḥ pravṛtteḥ — from purposive activity directed toward effects
KEY TERMS / DEFINITIONS: ✅ The empirical order is not inert chaos; it is a field of production, activity and transformation.
MECHANISM / ARGUMENT: ✅ Therefore there must be an underlying productive principle possessing the capacity for manifestation.
CONSEQUENCE / CONTRAST: ✅ Productive activity presupposes a causal potency capable of issuing in determinate effects.
UPSC TRAP / ANSWER-USE: ✅ The empirical order is not inert chaos; it is a field of production, activity and transformation.
ANSWER-GRABBING FORMULATION: ✅ The empirical order is not inert chaos; it is a field of production, activity and transformation.
```
...
```closure-flow
SUBTOPIC: (4) kāraṇa-kārya-vibhāgāt — from the distinction between cause and effect
KEY TERMS / DEFINITIONS: ⚠️ The point is not total disconnection: cause and effect are distinguishable without being unrelated.
MECHANISM / ARGUMENT: ✅ If effects are manifest, multiple and differentiated, their cause must be a more basic, prior and subtler condition.
CONSEQUENCE / CONTRAST: ✅ Cause and effect are distinguishable stages: the unmanifest source and the manifest product are not identical in appearance.
UPSC TRAP / ANSWER-USE: ✅ Cause and effect are distinguishable stages: the unmanifest source and the manifest product are not identical in appearance.
ANSWER-GRABBING FORMULATION: ✅ Cause and effect are distinguishable stages: the unmanifest source and the manifest product are not identical in appearance.
```
...
```closure-flow
SUBTOPIC: (5) avibhāgāt vaiśvarūpyasya — from the undivided source of the diversified universe
KEY TERMS / DEFINITIONS: ✅ The world is astonishingly diverse, yet this diversity forms one interconnected cosmos.
MECHANISM / ARGUMENT: ✅ Therefore there must be an original unmanifest, undivided root of the whole world-process.
CONSEQUENCE / CONTRAST: ✅ Therefore there must be an original unmanifest, undivided root of the whole world-process.
UPSC TRAP / ANSWER-USE: ✅ A diversified whole points back to an undivided source in which later differentiations are not yet separated.
ANSWER-GRABBING FORMULATION: ✅ The world is astonishingly diverse, yet this diversity forms one interconnected cosmos.
```
...
```closure-flow
SUBTOPIC: 4 Which proof establishes that there can be only one Prakṛti?
KEY TERMS / DEFINITIONS: ✅ The proof is avibhāgāt vaiśvarūpyasya.
MECHANISM / ARGUMENT: ✅ Reason: if the entire articulated universe emerges from an undivided source, that source must itself be singular, not many independent primal materials.
CONSEQUENCE / CONTRAST: ⚠️ In a 10-marker, do not merely name the proof.
UPSC TRAP / ANSWER-USE: ✅ Reason: if the entire articulated universe emerges from an undivided source, that source must itself be singular, not many independent primal materials.
ANSWER-GRABBING FORMULATION: ✅ The proof is avibhāgāt vaiśvarūpyasya.
```
...
```closure-flow
SUBTOPIC: 5 The three guṇas (gunas)
KEY TERMS / DEFINITIONS: ✅ Sattva is luminous, clear and upward-moving; it makes cognition and manifestation possible.
MECHANISM / ARGUMENT: ✅ Rajas is dynamic, agitating and projective; it supplies motion, effort and transition.
CONSEQUENCE / CONTRAST: ✅ Tamas is heavy, obscuring and resistant; it produces inertia, concealment and confusion.
UPSC TRAP / ANSWER-USE: ⚠️ The guṇas are not three separable substances but three inseparable constitutive tendencies within one Prakṛti.
ANSWER-GRABBING FORMULATION: ✅ Sattva is luminous, clear and upward-moving; it makes cognition and manifestation possible.
```
...
```closure-flow
SUBTOPIC: 6 Equilibrium and disturbance
KEY TERMS / DEFINITIONS: ✅ In this state Prakṛti is avyakta, unmanifest.
MECHANISM / ARGUMENT: ✅ In this state Prakṛti is avyakta, unmanifest.
CONSEQUENCE / CONTRAST: ✅ Manifest evolution begins when this equilibrium is disturbed in the presence of Puruṣa.
UPSC TRAP / ANSWER-USE: ⚠️ Disturbance should not be imagined as mechanical collision; Sāṃkhya speaks of functional activation in proximity.
ANSWER-GRABBING FORMULATION: ✅ Before manifestation, the three guṇas exist in equilibrium called sāmyāvasthā.
```
...
```closure-flow
SUBTOPIC: sarūpa-pariṇāma — homogeneous transformation
KEY TERMS / DEFINITIONS: ✅ This is sarūpa-pariṇāma, same-form transformation.
MECHANISM / ARGUMENT: ✅ This is sarūpa-pariṇāma, same-form transformation.
CONSEQUENCE / CONTRAST: ⚠️ It preserves the idea that Prakṛti is dynamic even in the unmanifest state without yet producing differentiated effects.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ In equilibrium, each guṇa transforms within its own nature.
ANSWER-GRABBING FORMULATION: ✅ In equilibrium, each guṇa transforms within its own nature.
```
...
```closure-flow
SUBTOPIC: virūpa-pariṇāma — heterogeneous transformation
KEY TERMS / DEFINITIONS: ✅ When equilibrium is disturbed, the guṇas enter asymmetrical relations and produce differentiated evolutes.
MECHANISM / ARGUMENT: ✅ This is virūpa-pariṇāma, heterogeneous transformation.
CONSEQUENCE / CONTRAST: ✅ Actual cosmological evolution belongs to virūpa-pariṇāma.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ When equilibrium is disturbed, the guṇas enter asymmetrical relations and produce differentiated evolutes.
ANSWER-GRABBING FORMULATION: ✅ When equilibrium is disturbed, the guṇas enter asymmetrical relations and produce differentiated evolutes.
```
...
```closure-flow
SUBTOPIC: 8 Prakṛti as pradhāna and avyakta
KEY TERMS / DEFINITIONS: ✅ Pradhāna emphasizes that Prakṛti is the chief material principle.
MECHANISM / ARGUMENT: ⚠️ An exam-safe definition: Prakṛti is the avyakta pradhāna, the unmanifest chief material principle constituted by the three guṇas.
CONSEQUENCE / CONTRAST: ⚠️ An exam-safe definition: Prakṛti is the avyakta pradhāna, the unmanifest chief material principle constituted by the three guṇas.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Pradhāna emphasizes that Prakṛti is the chief material principle.
ANSWER-GRABBING FORMULATION: ✅ Pradhāna emphasizes that Prakṛti is the chief material principle.
```
...
```closure-flow
SUBTOPIC: 1 Statement
KEY TERMS / DEFINITIONS: ✅ Puruṣa (purusha) is pure consciousness, self-luminous, inactive, changeless and beyond the guṇas.
MECHANISM / ARGUMENT: ✅ Consciousness is not a quality in Puruṣa; it is Puruṣa's very essence.
CONSEQUENCE / CONTRAST: ✅ Puruṣa is witness, seer and experiencer, but not agent in the productive sense.
UPSC TRAP / ANSWER-USE: ✅ Consciousness is not a quality in Puruṣa; it is Puruṣa's very essence.
ANSWER-GRABBING FORMULATION: ✅ Puruṣa (purusha) is pure consciousness, self-luminous, inactive, changeless and beyond the guṇas.
```
...
```closure-flow
SUBTOPIC: 2 The five arguments for the existence of Puruṣa
KEY TERMS / DEFINITIONS: Statement. ✅ Sāṃkhya argues for Puruṣa as a distinct conscious principle because the entire objective complex is unconscious, instrumental and presented to experience.
...
CONSEQUENCE / CONTRAST: Statement. ✅ Sāṃkhya argues for Puruṣa as a distinct conscious principle because the entire objective complex is unconscious, instrumental and presented to experience.
UPSC TRAP / ANSWER-USE: Answer-use: Statement. ✅ Sāṃkhya argues for Puruṣa as a distinct conscious principle because the entire objective complex is unconscious, instrumental and presented to experience.
ANSWER-GRABBING FORMULATION: Statement. ✅ Sāṃkhya argues for Puruṣa as a distinct conscious principle because the entire objective complex is unconscious, instrumental and presented to experience.
```
...
```closure-flow
SUBTOPIC: (1) saṅghāta-parārthatvāt — aggregates exist for another
KEY TERMS / DEFINITIONS: Argument. ✅ Aggregates function instrumentally; an instrument is for a user or beneficiary distinct from it.
MECHANISM / ARGUMENT: Argument. ✅ Aggregates function instrumentally; an instrument is for a user or beneficiary distinct from it.
CONSEQUENCE / CONTRAST: Conclusion. ✅ Hence there must be a conscious Puruṣa for whose experience and release the aggregate functions.
UPSC TRAP / ANSWER-USE: Answer-use: Statement. ✅ Body, senses, mind and buddhi are saṅghāta (aggregates/complexes).
ANSWER-GRABBING FORMULATION: Statement. ✅ Body, senses, mind and buddhi are saṅghāta (aggregates/complexes).
```
...
```closure-flow
SUBTOPIC: (2) triguṇādi-viparyayāt — the witness must be other than the guṇas
KEY TERMS / DEFINITIONS: Statement. ✅ The guṇas are objective, mutable and characterized by pleasure, pain and delusion.
MECHANISM / ARGUMENT: Statement. ✅ The guṇas are objective, mutable and characterized by pleasure, pain and delusion.
CONSEQUENCE / CONTRAST: Conclusion. ✅ Therefore a non-guṇic conscious principle must be admitted.
UPSC TRAP / ANSWER-USE: Argument. ✅ The knower of pleasure, pain and delusion cannot be reducible to the same changing guṇic states that are known.
ANSWER-GRABBING FORMULATION: Statement. ✅ The guṇas are objective, mutable and characterized by pleasure, pain and delusion.
```
...
```closure-flow
SUBTOPIC: (3) adhiṣṭhānāt — organized experience requires a presiding locus
KEY TERMS / DEFINITIONS: Conclusion. ✅ This is not a God-proof; it is an inference to Puruṣa as the presiding witness of lived order.
MECHANISM / ARGUMENT: Argument. ⚠️ Sāṃkhya infers a conscious support in whose presence the unconscious system becomes an experienced order.
...
UPSC TRAP / ANSWER-USE: Statement. ✅ Psychophysical life displays coordinated functioning rather than disconnected flashes.
ANSWER-GRABBING FORMULATION: Statement. ✅ Psychophysical life displays coordinated functioning rather than disconnected flashes.
```
...
```closure-flow
SUBTOPIC: (4) bhoktṛ-bhāvāt — experience requires an enjoyer
KEY TERMS / DEFINITIONS: Statement. ✅ Pleasure, pain and delusion are experienced.
MECHANISM / ARGUMENT: Argument. ✅ Since these are presented as objects or states, there must be a bhoktṛ (experiencer/enjoyer) distinct from them.
CONSEQUENCE / CONTRAST: Conclusion. ✅ Unconscious Prakṛti can present experience, but it cannot be the subject for whom experience appears.
UPSC TRAP / ANSWER-USE: Conclusion. ✅ Unconscious Prakṛti can present experience, but it cannot be the subject for whom experience appears.
ANSWER-GRABBING FORMULATION: Statement. ✅ Pleasure, pain and delusion are experienced.
```
...
```closure-flow
SUBTOPIC: (5) kaivalyārthaṃ pravṛtteḥ — striving for liberation presupposes a liberable witness
KEY TERMS / DEFINITIONS: Statement. ✅ Human striving for release from suffering is a central fact for Sāṃkhya.
MECHANISM / ARGUMENT: Argument. ✅ Such striving would be unintelligible if there were no conscious principle distinct from bondage-producing Prakṛti.
CONSEQUENCE / CONTRAST: Conclusion. ✅ The orientation toward kaivalya presupposes Puruṣa.
UPSC TRAP / ANSWER-USE: Answer-use: Statement. ✅ Human striving for release from suffering is a central fact for Sāṃkhya.
ANSWER-GRABBING FORMULATION: Statement. ✅ Human striving for release from suffering is a central fact for Sāṃkhya.
```
...
```closure-flow
SUBTOPIC: 3 Evaluation of the five proofs
KEY TERMS / DEFINITIONS: ⚠️ Their epistemic form is sāmānyato-dṛṣṭa anumāna: from the general structure of objectifiable experience to a witness that is never itself an object.
MECHANISM / ARGUMENT: ⚠️ Together they argue that aggregates are instrumental, guṇas are objectifiable, experience requires a witness, and liberation presupposes a self.
CONSEQUENCE / CONTRAST: ⚠️ Their epistemic form is sāmānyato-dṛṣṭa anumāna: from the general structure of objectifiable experience to a witness that is never itself an object.
UPSC TRAP / ANSWER-USE: ⚠️ The proofs are cumulative, not isolated.
ANSWER-GRABBING FORMULATION: ⚠️ The proofs are cumulative, not isolated.
```
...
```closure-flow
SUBTOPIC: 4 Plurality of Puruṣas
KEY TERMS / DEFINITIONS: Distinction. ⚠️ Plurality does not mean qualitative difference among Puruṣas; each Puruṣa is pure, inactive consciousness, but they are numerically many.
MECHANISM / ARGUMENT: Distinction. ⚠️ Plurality does not mean qualitative difference among Puruṣas; each Puruṣa is pure, inactive consciousness, but they are numerically many.
CONSEQUENCE / CONTRAST: Distinction. ⚠️ Plurality does not mean qualitative difference among Puruṣas; each Puruṣa is pure, inactive consciousness, but they are numerically many.
UPSC TRAP / ANSWER-USE: Statement. ✅ Sāṃkhya holds that Puruṣas are many, not one.
ANSWER-GRABBING FORMULATION: Statement. ✅ Sāṃkhya holds that Puruṣas are many, not one.
```
...
```closure-flow
SUBTOPIC: 1 Standard arguments for plurality
KEY TERMS / DEFINITIONS: Argument. ✅ From diversity of birth, death and sense-faculties: if there were only one Puruṣa, the birth or death of one body would be the birth or death of all, and all would be blind when one is blind.
MECHANISM / ARGUMENT: Argument. ✅ From non-simultaneity of activity: beings act at different times and in different ways; if there were one self, all embodied streams would act together.
CONSEQUENCE / CONTRAST: Argument. ✅ From differential distribution of the three guṇas: beings differ as sattvic, rajasic or tamasic in temperament; this supports distinct centres of experience rather than one undifferentiated experiencer.
UPSC TRAP / ANSWER-USE: Argument. ✅ From differential distribution of the three guṇas: beings differ as sattvic, rajasic or tamasic in temperament; this supports distinct centres of experience rather than one undifferentiated experiencer.
ANSWER-GRABBING FORMULATION: Argument. ✅ From diversity of birth, death and sense-faculties: if there were only one Puruṣa, the birth or death of one body would be the birth or death of all, and all would be blind when one is blind.
```
...
```closure-flow
SUBTOPIC: 3 Objections and replies
KEY TERMS / DEFINITIONS: Objection. ❓ Advaita / Śaṃkara: every difference cited is a difference in upādhis (limiting adjuncts — bodies, minds, guṇa-configurations), not in consciousness itself.
MECHANISM / ARGUMENT: Pure consciousness, being without attribute, part, action or spatial location, admits no principle of individuation; therefore Sāṃkhya proves at most a plurality of cittas (mental streams), not Puruṣas.
CONSEQUENCE / CONTRAST: Pure consciousness, being without attribute, part, action or spatial location, admits no principle of individuation; therefore Sāṃkhya proves at most a plurality of cittas (mental streams), not Puruṣas.
UPSC TRAP / ANSWER-USE: Objection. ❓ Advaita / Śaṃkara: every difference cited is a difference in upādhis (limiting adjuncts — bodies, minds, guṇa-configurations), not in consciousness itself.
ANSWER-GRABBING FORMULATION: Objection. ❓ Advaita / Śaṃkara: every difference cited is a difference in upādhis (limiting adjuncts — bodies, minds, guṇa-configurations), not in consciousness itself.
```
...
```closure-flow
SUBTOPIC: 4 Teleology of Prakṛti for Puruṣa
KEY TERMS / DEFINITIONS: Statement. ✅ Prakṛti acts for puruṣārtha — the sake of Puruṣa — by providing experience and finally the possibility of discriminative release.
MECHANISM / ARGUMENT: Statement. ✅ Prakṛti acts for puruṣārtha — the sake of Puruṣa — by providing experience and finally the possibility of discriminative release.
CONSEQUENCE / CONTRAST: Example. ✅ Puruṣa and Prakṛti cooperate like the lame man and the blind man: Puruṣa can see but not act; Prakṛti can act but not see.
UPSC TRAP / ANSWER-USE: Example. ✅ Puruṣa and Prakṛti cooperate like the lame man and the blind man: Puruṣa can see but not act; Prakṛti can act but not see.
ANSWER-GRABBING FORMULATION: Statement. ✅ Prakṛti acts for puruṣārtha — the sake of Puruṣa — by providing experience and finally the possibility of discriminative release.
```
...
```closure-flow
SUBTOPIC: 5 Nature of Puruṣa
KEY TERMS / DEFINITIONS: ✅ Puruṣa does not become bound in its own nature; bondage belongs to misidentification.
MECHANISM / ARGUMENT: ✅ Puruṣa does not produce the world; all production belongs to Prakṛti.
CONSEQUENCE / CONTRAST: ✅ Puruṣa does not produce the world; all production belongs to Prakṛti.
UPSC TRAP / ANSWER-USE: ✅ Puruṣa does not become bound in its own nature; bondage belongs to misidentification.
ANSWER-GRABBING FORMULATION: ✅ Puruṣa does not become bound in its own nature; bondage belongs to misidentification.
```
...
```closure-flow
SUBTOPIC: 6 Jīva vs Puruṣa
KEY TERMS / DEFINITIONS: ✅ Puruṣa is the metaphysical reality: pure, inactive, changeless consciousness.
MECHANISM / ARGUMENT: ✅ Jīva is Puruṣa as empirically appearing through identification with buddhi, ahaṃkāra, mind, body and karmic stream.
CONSEQUENCE / CONTRAST: ✅ Thus jīva is the conditioned empirical self, while Puruṣa is the unconditioned conscious reality behind it.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Puruṣa is the metaphysical reality: pure, inactive, changeless consciousness.
ANSWER-GRABBING FORMULATION: ✅ Puruṣa is the metaphysical reality: pure, inactive, changeless consciousness.
```
...
```closure-flow
SUBTOPIC: 3 Mahat, buddhi and ahaṃkāra
KEY TERMS / DEFINITIONS: ✅ Mahat is the cosmic aspect or name.
MECHANISM / ARGUMENT: ✅ Therefore the sequence is Prakṛti → mahat/buddhi → ahaṃkāra.
CONSEQUENCE / CONTRAST: ✅ Therefore the sequence is Prakṛti → mahat/buddhi → ahaṃkāra.
UPSC TRAP / ANSWER-USE: Never write mahat and buddhi as two separate stages.
ANSWER-GRABBING FORMULATION: ✅ Mahat and buddhi are the SAME tattva.
```
...
```closure-flow
SUBTOPIC: 4 Buddhi
KEY TERMS / DEFINITIONS: ✅ It is the locus where reflected consciousness is most conspicuous in empirical life.
MECHANISM / ARGUMENT: ✅ It is the locus where reflected consciousness is most conspicuous in empirical life.
CONSEQUENCE / CONTRAST: ⚠️ In psychology: manas coordinates, ahaṃkāra appropriates, buddhi determines.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Buddhi determines, judges, ascertains and discriminates.
ANSWER-GRABBING FORMULATION: ✅ Buddhi determines, judges, ascertains and discriminates.
```
...
```closure-flow
SUBTOPIC: 5 Ahaṃkāra
KEY TERMS / DEFINITIONS: ✅ Ahaṃkāra is the I-maker, the principle of individuation.
MECHANISM / ARGUMENT: ⚠️ It is central to bondage because false selfhood crystallizes here.
CONSEQUENCE / CONTRAST: ⚠️ It is central to bondage because false selfhood crystallizes here.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Ahaṃkāra is the I-maker, the principle of individuation.
ANSWER-GRABBING FORMULATION: ✅ Ahaṃkāra is the I-maker, the principle of individuation.
```
...
```closure-flow
SUBTOPIC: 6 Sāttvika line
KEY TERMS / DEFINITIONS: ✅ From the sāttvika aspect of ahaṃkāra arise manas, five jñānendriyas, and five karmendriyas.
MECHANISM / ARGUMENT: ✅ This line accounts for the cognitive and conative equipment of empirical life.
CONSEQUENCE / CONTRAST: ✅ This line accounts for the cognitive and conative equipment of empirical life.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ From the sāttvika aspect of ahaṃkāra arise manas, five jñānendriyas, and five karmendriyas.
ANSWER-GRABBING FORMULATION: ✅ From the sāttvika aspect of ahaṃkāra arise manas, five jñānendriyas, and five karmendriyas.
```
...
```closure-flow
SUBTOPIC: 7 Tāmasa line
KEY TERMS / DEFINITIONS: ✅ From the tāmasa aspect of ahaṃkāra arise the five tanmātras.
MECHANISM / ARGUMENT: ✅ From the five tanmātras arise the five mahābhūtas.
CONSEQUENCE / CONTRAST: ✅ This line accounts for subtle-to-gross material manifestation.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ From the tāmasa aspect of ahaṃkāra arise the five tanmātras.
ANSWER-GRABBING FORMULATION: ✅ From the tāmasa aspect of ahaṃkāra arise the five tanmātras.
```
...
```closure-flow
SUBTOPIC: 8 Rājasa factor
KEY TERMS / DEFINITIONS: ✅ Rajas supplies activity, energy and operative force to both lines.
MECHANISM / ARGUMENT: ⚠️ This must be written explicitly because it is repeatedly confused.
CONSEQUENCE / CONTRAST: ⚠️ This must be written explicitly because it is repeatedly confused.
UPSC TRAP / ANSWER-USE: ✅ Rājasa ahaṃkāra does not produce a separate set of tattvas.
ANSWER-GRABBING FORMULATION: ✅ Rajas supplies activity, energy and operative force to both lines.
```
...
```closure-flow
SUBTOPIC: 9 Why this sequence matters philosophically
KEY TERMS / DEFINITIONS: ✅ The same Prakṛti that yields matter also yields the faculties through which matter is experienced.
MECHANISM / ARGUMENT: ✅ The same Prakṛti that yields matter also yields the faculties through which matter is experienced.
CONSEQUENCE / CONTRAST: ⚠️ UPSC 2024 as a 20-marker is exactly about narrating this structure cleanly and then explaining the buddhi/mahat/ahaṃkāra distinction.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ The sequence shows that cosmology and psychology are internally linked in Sāṃkhya.
ANSWER-GRABBING FORMULATION: ✅ The sequence shows that cosmology and psychology are internally linked in Sāṃkhya.
```
...
```closure-flow
SUBTOPIC: 1 Statement
KEY TERMS / DEFINITIONS: ✅ Production is manifestation, not creation out of sheer non-being.
MECHANISM / ARGUMENT: ✅ Production is manifestation, not creation out of sheer non-being.
CONSEQUENCE / CONTRAST: ✅ Satkāryavāda holds that the effect pre-exists in its material cause.
UPSC TRAP / ANSWER-USE: ✅ Production is manifestation, not creation out of sheer non-being.
ANSWER-GRABBING FORMULATION: ✅ Satkāryavāda holds that the effect pre-exists in its material cause.
```
...
```closure-flow
SUBTOPIC: 2 The five arguments for satkāryavāda
KEY TERMS / DEFINITIONS: Statement. ✅ The standard Sāṃkhya set gives five reasons for holding that the effect pre-exists in its material cause.
MECHANISM / ARGUMENT: Statement. ✅ The standard Sāṃkhya set gives five reasons for holding that the effect pre-exists in its material cause.
CONSEQUENCE / CONTRAST: Statement. ✅ The standard Sāṃkhya set gives five reasons for holding that the effect pre-exists in its material cause.
UPSC TRAP / ANSWER-USE: Answer-use: Statement. ✅ The standard Sāṃkhya set gives five reasons for holding that the effect pre-exists in its material cause.
ANSWER-GRABBING FORMULATION: Statement. ✅ The standard Sāṃkhya set gives five reasons for holding that the effect pre-exists in its material cause.
```
...
```closure-flow
SUBTOPIC: (1) asadakaraṇāt — because what does not exist cannot be brought into being
KEY TERMS / DEFINITIONS: Statement. ✅ A sheer non-entity cannot be produced.
MECHANISM / ARGUMENT: Argument. ✅ No amount of causal operation can produce a hare's horn or oil from sand; production presupposes something determinate to be produced.
CONSEQUENCE / CONTRAST: Reply. ⚠️ Sāṃkhya presses that the "not-yet-existent" effect must still be something in the material cause, otherwise the operation would have no determinate terminus.
UPSC TRAP / ANSWER-USE: Statement. ✅ A sheer non-entity cannot be produced.
ANSWER-GRABBING FORMULATION: Statement. ✅ A sheer non-entity cannot be produced.
```
...
```closure-flow
SUBTOPIC: (2) upādāna-grahaṇāt — because a determinate material cause is taken up
KEY TERMS / DEFINITIONS: Reply. ⚠️ Sāṃkhya replies that causal capacity in the required determinate sense just is the latent presence of that effect in that material continuum.
MECHANISM / ARGUMENT: Objection. ❓ The restriction may be explained by causal capacity rather than by the pre-existence of the effect.
CONSEQUENCE / CONTRAST: Statement. ✅ Specific effects require specific material causes.
UPSC TRAP / ANSWER-USE: Argument. ✅ One who wants curd takes milk, not water; one who wants cloth takes threads, not clay.
ANSWER-GRABBING FORMULATION: Statement. ✅ Specific effects require specific material causes.
```
...
```closure-flow
SUBTOPIC: (3) sarvasambhavābhāvāt — because everything cannot arise from everything
KEY TERMS / DEFINITIONS: Argument. ✅ Non-existence as such is indistinguishable; therefore it cannot explain why curd arises from milk and not from water.
MECHANISM / ARGUMENT: Argument. ✅ Non-existence as such is indistinguishable; therefore it cannot explain why curd arises from milk and not from water.
CONSEQUENCE / CONTRAST: Statement. ✅ If effects were wholly non-existent before production, any cause could produce any effect.
UPSC TRAP / ANSWER-USE: Argument. ✅ Non-existence as such is indistinguishable; therefore it cannot explain why curd arises from milk and not from water.
ANSWER-GRABBING FORMULATION: Statement. ✅ If effects were wholly non-existent before production, any cause could produce any effect.
```
...
```closure-flow
SUBTOPIC: (4) śaktasya śakya-karaṇāt — because the efficient can produce only what it is capable of producing
KEY TERMS / DEFINITIONS: Argument. ✅ A potency for X is unintelligible unless X is in some manner already there as the object of that potency.
MECHANISM / ARGUMENT: Argument. ✅ A potency for X is unintelligible unless X is in some manner already there as the object of that potency.
CONSEQUENCE / CONTRAST: Statement. ✅ A cause has a determinate śakti (potency) directed toward a determinate effect.
UPSC TRAP / ANSWER-USE: Example. ✅ Milk has the potency for curd, not for cloth; threads have the potency for cloth, not for curd.
ANSWER-GRABBING FORMULATION: Statement. ✅ A cause has a determinate śakti (potency) directed toward a determinate effect.
```
...
```closure-flow
SUBTOPIC: (5) kāraṇa-bhāvāt — because the effect has the nature/being of the cause
KEY TERMS / DEFINITIONS: Statement. ✅ The effect is non-different from the cause in substance.
MECHANISM / ARGUMENT: Argument. ✅ Cloth is nothing over and above threads in a certain arrangement; it has the same material basis, weight and guṇa-continuity.
CONSEQUENCE / CONTRAST: Statement. ✅ The effect is non-different from the cause in substance.
UPSC TRAP / ANSWER-USE: Reply. ⚠️ Sāṃkhya replies that the new properties are new saṃsthāna (arrangements/configurations), not new substances created out of non-being.
ANSWER-GRABBING FORMULATION: Statement. ✅ The effect is non-different from the cause in substance.
```
...
```closure-flow
SUBTOPIC: 3 Why Sāṃkhya's satkāryavāda is pariṇāmavāda
KEY TERMS / DEFINITIONS: Statement. ✅ Sāṃkhya's satkāryavāda is specifically pariṇāmavāda: the effect is a real transformation of the cause.
MECHANISM / ARGUMENT: Distinction. ✅ It is not vivartavāda, because the world is not a mere appearance superimposed on an unchanged cause; it is the real evolution of Prakṛti.
...
UPSC TRAP / ANSWER-USE: Distinction. ✅ It is not vivartavāda, because the world is not a mere appearance superimposed on an unchanged cause; it is the real evolution of Prakṛti.
ANSWER-GRABBING FORMULATION: Statement. ✅ Sāṃkhya's satkāryavāda is specifically pariṇāmavāda: the effect is a real transformation of the cause.
```
...
```closure-flow
SUBTOPIC: 4 Contrast with Advaita vivartavāda
KEY TERMS / DEFINITIONS: ✅ Both may be placed under a broad satkārya orientation, but their accounts of transformation differ radically.
MECHANISM / ARGUMENT: ✅ Both may be placed under a broad satkārya orientation, but their accounts of transformation differ radically.
CONSEQUENCE / CONTRAST: ✅ Both may be placed under a broad satkārya orientation, but their accounts of transformation differ radically.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Both may be placed under a broad satkārya orientation, but their accounts of transformation differ radically.
ANSWER-GRABBING FORMULATION: ✅ Both may be placed under a broad satkārya orientation, but their accounts of transformation differ radically.
```
...
```closure-flow
SUBTOPIC: 5 Contrast with Nyāya asatkāryavāda
KEY TERMS / DEFINITIONS: ✅ This contrast is directly relevant to the 2023 cross-link question on Nyāya prāgabhāva and Sāṃkhya causation.
MECHANISM / ARGUMENT: ✅ This contrast is directly relevant to the 2023 cross-link question on Nyāya prāgabhāva and Sāṃkhya causation.
CONSEQUENCE / CONTRAST: ✅ This contrast is directly relevant to the 2023 cross-link question on Nyāya prāgabhāva and Sāṃkhya causation.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ This contrast is directly relevant to the 2023 cross-link question on Nyāya prāgabhāva and Sāṃkhya causation.
ANSWER-GRABBING FORMULATION: ✅ This contrast is directly relevant to the 2023 cross-link question on Nyāya prāgabhāva and Sāṃkhya causation.
```
...
```closure-flow
SUBTOPIC: 6 Contrast with Buddhist pratītyasamutpāda
KEY TERMS / DEFINITIONS: ⚠️ A crisp contrast line is often enough unless the question explicitly asks for Buddhist comparison.
MECHANISM / ARGUMENT: ✅ Buddhism explains becoming through dependent origination rather than an enduring unmanifest material root.
CONSEQUENCE / CONTRAST: ⚠️ A crisp contrast line is often enough unless the question explicitly asks for Buddhist comparison.
UPSC TRAP / ANSWER-USE: ✅ Buddhism explains becoming through dependent origination rather than an enduring unmanifest material root.
ANSWER-GRABBING FORMULATION: ✅ Buddhism explains becoming through dependent origination rather than an enduring unmanifest material root.
```
...
```closure-flow
SUBTOPIC: 1 Bondage as aviveka
KEY TERMS / DEFINITIONS: ✅ Bondage in Sāṃkhya is aviveka, non-discrimination between Puruṣa and Prakṛti.
MECHANISM / ARGUMENT: ✅ Buddhi reflects consciousness, and this reflection creates false identification.
CONSEQUENCE / CONTRAST: ✅ The self then appears as agent, enjoyer, sufferer and knower in the empirical sense.
UPSC TRAP / ANSWER-USE: ⚠️ Bondage is not real alteration in Puruṣa but mistaken identification through reflected consciousness.
ANSWER-GRABBING FORMULATION: ✅ Bondage in Sāṃkhya is aviveka, non-discrimination between Puruṣa and Prakṛti.
```
...
```closure-flow
SUBTOPIC: 2 Liberation as viveka-jñāna
KEY TERMS / DEFINITIONS: ✅ Liberation is viveka-jñāna, discriminative knowledge that "I am not Prakṛti."
MECHANISM / ARGUMENT: ✅ When the distinction between witness-consciousness and guṇic evolutes becomes steady, false identification ends.
CONSEQUENCE / CONTRAST: ✅ This state is kaivalya, the aloneness or isolation of Puruṣa.
UPSC TRAP / ANSWER-USE: ✅ Liberation is viveka-jñāna, discriminative knowledge that "I am not Prakṛti."
ANSWER-GRABBING FORMULATION: ✅ Liberation is viveka-jñāna, discriminative knowledge that "I am not Prakṛti."
```
...
```closure-flow
SUBTOPIC: 3 Lame-and-blind analogy
KEY TERMS / DEFINITIONS: ✅ Puruṣa is like the lame: conscious but inactive.
MECHANISM / ARGUMENT: ✅ Together they explain empirical process.
CONSEQUENCE / CONTRAST: ✅ Together they explain empirical process.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Puruṣa is like the lame: conscious but inactive.
ANSWER-GRABBING FORMULATION: ✅ Puruṣa is like the lame: conscious but inactive.
```
...
```closure-flow
SUBTOPIC: 4 Dancer analogy
KEY TERMS / DEFINITIONS: ✅ Prakṛti is like a dancer who stops after being seen by Puruṣa.
MECHANISM / ARGUMENT: ✅ Prakṛti is like a dancer who stops after being seen by Puruṣa.
CONSEQUENCE / CONTRAST: ⚠️ This is the neatest canonical image for liberation through fulfilled disclosure.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Prakṛti is like a dancer who stops after being seen by Puruṣa.
ANSWER-GRABBING FORMULATION: ✅ Prakṛti is like a dancer who stops after being seen by Puruṣa.
```
...
```closure-flow
SUBTOPIC: 5 Jīvanmukti and videhamukti
KEY TERMS / DEFINITIONS: ✅ Jīvanmukti refers to liberation while the body still continues due to prior momentum.
MECHANISM / ARGUMENT: ✅ The standard analogy is the potter's wheel that keeps turning even after the impulse ceases.
CONSEQUENCE / CONTRAST: ✅ Videhamukti is the final cessation of embodiment when the body falls and residual momentum ends.
UPSC TRAP / ANSWER-USE: ⚠️ In Sāṃkhya this remains isolation of consciousness, not union with God.
ANSWER-GRABBING FORMULATION: ✅ Jīvanmukti refers to liberation while the body still continues due to prior momentum.
```
...
```closure-flow
SUBTOPIC: 6 Nirīśvara character of liberation
KEY TERMS / DEFINITIONS: ✅ No God is required for either bondage or liberation in classical Sāṃkhya.
MECHANISM / ARGUMENT: ✅ Prakṛti's teleological evolution for Puruṣa's experience and release is treated as sufficient.
CONSEQUENCE / CONTRAST: ⚠️ This is why classical Sāṃkhya must be clearly separated from theistic Yoga.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ No God is required for either bondage or liberation in classical Sāṃkhya.
ANSWER-GRABBING FORMULATION: ✅ No God is required for either bondage or liberation in classical Sāṃkhya.
```
...
KEY TERMS / DEFINITIONS: ✅ If Puruṣa is inactive and Prakṛti is unconscious, how can they relate at all?
MECHANISM / ARGUMENT: ✅ Yet the entire system depends on some relation between them to explain evolution, bondage and liberation.
CONSEQUENCE / CONTRAST: ✅ This is the famous contact problem, asked in 2023.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ If Puruṣa is inactive and Prakṛti is unconscious, how can they relate at all?
ANSWER-GRABBING FORMULATION: ✅ If Puruṣa is inactive and Prakṛti is unconscious, how can they relate at all?
```
...
```closure-flow
SUBTOPIC: 2 Sāṃkhya response: proximity, not physical contact
KEY TERMS / DEFINITIONS: ✅ Sāṃkhya answers that the relation is sānnidhya, mere proximity or presence, not gross physical contact.
MECHANISM / ARGUMENT: ✅ Puruṣa does not push or alter Prakṛti by action.
CONSEQUENCE / CONTRAST: ✅ Prakṛti becomes active in the mere presence of Puruṣa.
UPSC TRAP / ANSWER-USE: ✅ Sāṃkhya answers that the relation is sānnidhya, mere proximity or presence, not gross physical contact.
ANSWER-GRABBING FORMULATION: ✅ Sāṃkhya answers that the relation is sānnidhya, mere proximity or presence, not gross physical contact.
```
...
```closure-flow
SUBTOPIC: 3 Analogies
KEY TERMS / DEFINITIONS: ✅ Magnet and iron: as a magnet moves iron without deliberative willing, Puruṣa's presence occasions Prakṛti's activity.
MECHANISM / ARGUMENT: ✅ Crystal and flower: as a clear crystal appears coloured by a nearby flower without itself changing, Puruṣa appears affected by Prakṛti without real transformation.
CONSEQUENCE / CONTRAST: ⚠️ The first analogy explains activation by presence; the second explains apparent contamination without real change.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Magnet and iron: as a magnet moves iron without deliberative willing, Puruṣa's presence occasions Prakṛti's activity.
ANSWER-GRABBING FORMULATION: ✅ Magnet and iron: as a magnet moves iron without deliberative willing, Puruṣa's presence occasions Prakṛti's activity.
```
...
```closure-flow
SUBTOPIC: 4 Śaṃkara's attack
KEY TERMS / DEFINITIONS: ✅ Śaṃkara argues that if Puruṣa is truly inactive and Prakṛti truly unconscious, no intelligible real relation is possible.
MECHANISM / ARGUMENT: ✅ The magnet analogy fails because even a magnet exerts force; if Puruṣa were like that, it would not be wholly inactive.
CONSEQUENCE / CONTRAST: ✅ Therefore Sāṃkhya dualism appears unstable: either it collapses toward monism or it requires a third mediating principle.
UPSC TRAP / ANSWER-USE: ✅ The magnet analogy fails because even a magnet exerts force; if Puruṣa were like that, it would not be wholly inactive.
ANSWER-GRABBING FORMULATION: ✅ Śaṃkara argues that if Puruṣa is truly inactive and Prakṛti truly unconscious, no intelligible real relation is possible.
```
...
```closure-flow
SUBTOPIC: 1 Closest systematic rival
KEY TERMS / DEFINITIONS: ✅ Sāṃkhya is the most sophisticated non-Vedāntic rival to Advaita at the level of ultimate explanation.
MECHANISM / ARGUMENT: ✅ It explains world, self, bondage, liberation and causation through a coherent metaphysical system.
CONSEQUENCE / CONTRAST: ⚠️ It is therefore not marginal but philosophically near enough to require detailed refutation.
UPSC TRAP / ANSWER-USE: ⚠️ It is therefore not marginal but philosophically near enough to require detailed refutation.
ANSWER-GRABBING FORMULATION: ✅ Sāṃkhya is the most sophisticated non-Vedāntic rival to Advaita at the level of ultimate explanation.
```
...
```closure-flow
SUBTOPIC: 2 Pariṇāmavāda versus vivartavāda
KEY TERMS / DEFINITIONS: ✅ Sāṃkhya's pariṇāmavāda is the nearest rival to Advaita's vivartavāda.
MECHANISM / ARGUMENT: ✅ Both aim to explain the world from an ultimate principle, but Sāṃkhya takes transformation as real while Advaita takes it as apparent.
CONSEQUENCE / CONTRAST: ⚠️ This causal proximity is one reason Śaṃkara treats Sāṃkhya as chief opponent.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Sāṃkhya's pariṇāmavāda is the nearest rival to Advaita's vivartavāda.
ANSWER-GRABBING FORMULATION: ✅ Sāṃkhya's pariṇāmavāda is the nearest rival to Advaita's vivartavāda.
```
...
```closure-flow
SUBTOPIC: 3 Shared appeal to a single ultimate explanatory ground
KEY TERMS / DEFINITIONS: ⚠️ Because both are large-scale metaphysical explanations, the contest is direct.
MECHANISM / ARGUMENT: ✅ Sāṃkhya explains the world through one primal material principle, Prakṛti/pradhāna.
CONSEQUENCE / CONTRAST: ⚠️ Because both are large-scale metaphysical explanations, the contest is direct.
UPSC TRAP / ANSWER-USE: ✅ Advaita too seeks a single ultimate explanatory ground, though in the form of conscious Brahman rather than unconscious matter.
ANSWER-GRABBING FORMULATION: ✅ Sāṃkhya explains the world through one primal material principle, Prakṛti/pradhāna.
```
...
```closure-flow
SUBTOPIC: 4 Śaṃkara's objections
KEY TERMS / DEFINITIONS: ✅ Unconscious prakṛti cannot be the Upaniṣadic cause because the Upaniṣadic source is described as conscious, knowing and sat-cit in character.
MECHANISM / ARGUMENT: ✅ Unconscious prakṛti cannot be the Upaniṣadic cause because the Upaniṣadic source is described as conscious, knowing and sat-cit in character.
CONSEQUENCE / CONTRAST: ✅ Teleology cannot be explained without consciousness: if Prakṛti evolves "for the sake of" Puruṣa, purposiveness seems to require intelligence.
UPSC TRAP / ANSWER-USE: ✅ Unconscious prakṛti cannot be the Upaniṣadic cause because the Upaniṣadic source is described as conscious, knowing and sat-cit in character.
ANSWER-GRABBING FORMULATION: ✅ Unconscious prakṛti cannot be the Upaniṣadic cause because the Upaniṣadic source is described as conscious, knowing and sat-cit in character.
```
...
```closure-flow
SUBTOPIC: 5 Exam conclusion
KEY TERMS / DEFINITIONS: ⚠️ Śaṃkara calls Sāṃkhya his chief opponent because it is the strongest rival causal-metaphysical system; he rejects it because the ultimate cause must be conscious, teleology cannot rest on unconscious Prakṛti, and the puruṣa–prakṛti relation remains unstable.
MECHANISM / ARGUMENT: ⚠️ Śaṃkara calls Sāṃkhya his chief opponent because it is the strongest rival causal-metaphysical system; he rejects it because the ultimate cause must be conscious, teleology cannot rest on unconscious Prakṛti, and the puruṣa–prakṛti relation remains unstable.
CONSEQUENCE / CONTRAST: ⚠️ Śaṃkara calls Sāṃkhya his chief opponent because it is the strongest rival causal-metaphysical system; he rejects it because the ultimate cause must be conscious, teleology cannot rest on unconscious Prakṛti, and the puruṣa–prakṛti relation remains unstable.
UPSC TRAP / ANSWER-USE: ⚠️ Śaṃkara calls Sāṃkhya his chief opponent because it is the strongest rival causal-metaphysical system; he rejects it because the ultimate cause must be conscious, teleology cannot rest on unconscious Prakṛti, and the puruṣa–prakṛti relation remains unstable.
ANSWER-GRABBING FORMULATION: ⚠️ Śaṃkara calls Sāṃkhya his chief opponent because it is the strongest rival causal-metaphysical system; he rejects it because the ultimate cause must be conscious, teleology cannot rest on unconscious Prakṛti, and the puruṣa–prakṛti relation remains unstable.
```
...
```closure-flow
SUBTOPIC: INTER-THINKER DEBATES
KEY TERMS / DEFINITIONS: ⚠️ In cross-school answers, Sāṃkhya is often the benchmark for real causation and strict consciousness–matter dualism.
MECHANISM / ARGUMENT: ⚠️ In cross-school answers, Sāṃkhya is often the benchmark for real causation and strict consciousness–matter dualism.
CONSEQUENCE / CONTRAST: ⚠️ In cross-school answers, Sāṃkhya is often the benchmark for real causation and strict consciousness–matter dualism.
UPSC TRAP / ANSWER-USE: Answer-use: ⚠️ In cross-school answers, Sāṃkhya is often the benchmark for real causation and strict consciousness–matter dualism.
ANSWER-GRABBING FORMULATION: ⚠️ In cross-school answers, Sāṃkhya is often the benchmark for real causation and strict consciousness–matter dualism.
```
...
```closure-flow
SUBTOPIC: 1 Criticism: teleology without intelligence
KEY TERMS / DEFINITIONS: ❓ How can unconscious Prakṛti evolve purposively for Puruṣa's sake?
MECHANISM / ARGUMENT: ✅ Sāṃkhya reply: purposive functioning need not involve conscious planning; the guṇa-structure itself yields ordered manifestation in the presence of Puruṣa.
CONSEQUENCE / CONTRAST: ⚠️ This reply preserves system-internal sufficiency but remains vulnerable to Vedāntic criticism.
UPSC TRAP / ANSWER-USE: ✅ Sāṃkhya reply: purposive functioning need not involve conscious planning; the guṇa-structure itself yields ordered manifestation in the presence of Puruṣa.
ANSWER-GRABBING FORMULATION: ❓ How can unconscious Prakṛti evolve purposively for Puruṣa's sake?
```
...
```closure-flow
SUBTOPIC: 2 Criticism: relation between two absolutes
KEY TERMS / DEFINITIONS: ⚠️ This is partly explanatory and partly analogical; critics see it as the school's weakest point.
MECHANISM / ARGUMENT: ✅ Sāṃkhya reply: through proximity, reflection and false attribution rather than real fusion.
CONSEQUENCE / CONTRAST: ⚠️ This is partly explanatory and partly analogical; critics see it as the school's weakest point.
UPSC TRAP / ANSWER-USE: ✅ Sāṃkhya reply: through proximity, reflection and false attribution rather than real fusion.
ANSWER-GRABBING FORMULATION: ❓ If Puruṣa and Prakṛti are radically different, how can misidentification occur?
```
...
```closure-flow
SUBTOPIC: 3 Criticism: multiplicity of Puruṣas is unnecessary
KEY TERMS / DEFINITIONS: ❓ Could not one consciousness appear as many?
MECHANISM / ARGUMENT: ✅ Sāṃkhya reply: non-simultaneous liberation, individual experience and differentiated embodiment support plurality.
CONSEQUENCE / CONTRAST: ✅ Sāṃkhya reply: non-simultaneous liberation, individual experience and differentiated embodiment support plurality.
UPSC TRAP / ANSWER-USE: ❓ Could not one consciousness appear as many?
ANSWER-GRABBING FORMULATION: ❓ Could not one consciousness appear as many?
```
...
```closure-flow
SUBTOPIC: 4 Criticism: satkāryavāda removes novelty
KEY TERMS / DEFINITIONS: ❓ If effect already exists, production is redundant.
MECHANISM / ARGUMENT: ✅ Sāṃkhya reply: production is manifestation from latent to patent, not pointless repetition.
CONSEQUENCE / CONTRAST: ❓ If effect already exists, production is redundant.
UPSC TRAP / ANSWER-USE: ✅ Sāṃkhya reply: production is manifestation from latent to patent, not pointless repetition.
ANSWER-GRABBING FORMULATION: ❓ If effect already exists, production is redundant.
```
...
KEY TERMS / DEFINITIONS: ✅ Mahat and buddhi are the SAME tattva — mahat is the cosmic name, buddhi is the individual/psychological name.
MECHANISM / ARGUMENT: ✅ Kaivalya ≠ mokṣa (Advaita) ≠ apavarga (Nyāya): kaivalya = isolation/aloneness of Puruṣa; mokṣa in Advaita = identity with Brahman; apavarga in Nyāya = cessation of suffering.
CONSEQUENCE / CONTRAST: ✅ Classical Sāṃkhya is nirīśvara (atheistic) — no God.
UPSC TRAP / ANSWER-USE: ✅ Jīva is NOT a separate tattva — it is Puruṣa as empirically conditioned.
ANSWER-GRABBING FORMULATION: ✅ Mahat and buddhi are the SAME tattva — mahat is the cosmic name, buddhi is the individual/psychological name.
```
...
```closure-flow
SUBTOPIC: 1 Keywords
KEY TERMS / DEFINITIONS: ✅ prakṛti · pradhāna · avyakta · mūla-prakṛti · guṇa · sattva · rajas · tamas · sāmyāvasthā
MECHANISM / ARGUMENT: ✅ pratyakṣa · anumāna · āptavacana · śabda · sāmānyato-dṛṣṭa · saukṣmya · atīndriya
CONSEQUENCE / CONTRAST: ✅ sarūpa-pariṇāma · virūpa-pariṇāma · Puruṣa · saṅghāta-parārthatvāt
UPSC TRAP / ANSWER-USE: Answer-use: ✅ prakṛti · pradhāna · avyakta · mūla-prakṛti · guṇa · sattva · rajas · tamas · sāmyāvasthā
ANSWER-GRABBING FORMULATION: ✅ prakṛti · pradhāna · avyakta · mūla-prakṛti · guṇa · sattva · rajas · tamas · sāmyāvasthā
```
...
```closure-flow
SUBTOPIC: 2 Statement bank
KEY TERMS / DEFINITIONS: ⚠️ Sāṃkhya is a dualist realism in which one unconscious Prakṛti evolves for the experience and liberation of many conscious Puruṣas.
MECHANISM / ARGUMENT: ⚠️ Prakṛti is inferred as the avyakta pradhāna, the unmanifest chief material principle constituted by the three guṇas.
CONSEQUENCE / CONTRAST: ⚠️ Puruṣa is pure consciousness — changeless, inactive and beyond the guṇas.
UPSC TRAP / ANSWER-USE: Answer-use: ⚠️ Sāṃkhya is a dualist realism in which one unconscious Prakṛti evolves for the experience and liberation of many conscious Puruṣas.
ANSWER-GRABBING FORMULATION: ⚠️ Sāṃkhya is a dualist realism in which one unconscious Prakṛti evolves for the experience and liberation of many conscious Puruṣas.
```
...
```closure-flow
SUBTOPIC: Why Puruṣas are many
KEY TERMS / DEFINITIONS: ✅ Plurality is inferred from distinct births/deaths and sense-organ allotments, non-simultaneous activity, divergent guṇa-configurations and different destinies toward liberation.
MECHANISM / ARGUMENT: ❓ The inference moves from empirical difference to transcendental plurality; an Advaitin can argue that one consciousness appears many through limiting adjuncts.
CONSEQUENCE / CONTRAST: ❓ The inference moves from empirical difference to transcendental plurality; an Advaitin can argue that one consciousness appears many through limiting adjuncts.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Plurality is inferred from distinct births/deaths and sense-organ allotments, non-simultaneous activity, divergent guṇa-configurations and different destinies toward liberation.
ANSWER-GRABBING FORMULATION: ✅ Plurality is inferred from distinct births/deaths and sense-organ allotments, non-simultaneous activity, divergent guṇa-configurations and different destinies toward liberation.
```
...
```closure-flow
SUBTOPIC: Prakṛtipariṇāmavāda and the mango seed
KEY TERMS / DEFINITIONS: ✅ Satkāryavāda holds that the effect pre-exists latently in its material cause; production is manifestation/transformation under suitable conditions.
MECHANISM / ARGUMENT: The mango tree arises from a mango seed because a determinate causal potency—not any arbitrary effect—is present in that material continuum.
CONSEQUENCE / CONTRAST: ✅ Satkāryavāda holds that the effect pre-exists latently in its material cause; production is manifestation/transformation under suitable conditions.
UPSC TRAP / ANSWER-USE: The mango tree arises from a mango seed because a determinate causal potency—not any arbitrary effect—is present in that material continuum.
ANSWER-GRABBING FORMULATION: ✅ Satkāryavāda holds that the effect pre-exists latently in its material cause; production is manifestation/transformation under suitable conditions.
```
...
KEY TERMS / DEFINITIONS: ⚠️ Priority: Primary ownership rises to 10 of 112 parts and occurs in every year.
MECHANISM / ARGUMENT: ✅ Required doctrinal depth: The restored questions require plurality of Puruṣas, a defence of Prakṛtipariṇāmavāda against Advaita and application of satkāryavāda to the mango-seed example while rejecting rival causation theories.
CONSEQUENCE / CONTRAST: ❌ Trap / answer consequence: Do not confuse one Prakṛti with one Puruṣa, or say the gross tree pre-exists visibly in the seed; reconstruct latent effect, material continuity and transformation.
UPSC TRAP / ANSWER-USE: ❌ Trap / answer consequence: Do not confuse one Prakṛti with one Puruṣa, or say the gross tree pre-exists visibly in the seed; reconstruct latent effect, material continuity and transformation.
ANSWER-GRABBING FORMULATION: ⚠️ Priority: Primary ownership rises to 10 of 112 parts and occurs in every year.
```
...
KEY TERMS / DEFINITIONS: Sāṃkhya vs Advaita on satkāryavāda. ⚠️ Both can be treated as satkāryavādins because both deny sheer creation from non-being; the decisive difference is pariṇāma versus vivarta.
...
CONSEQUENCE / CONTRAST: Sāṃkhya vs Yoga. ⚠️ Yoga is a friendly amendment to Sāṃkhya: it retains the broad metaphysics of Prakṛti, guṇas and many Puruṣas, but adds Īśvara, stronger practical discipline, Īśvara-praṇidhāna and yogi-pratyakṣa; hence Sāṃkhya is nirīśvara and more theoretical, while Yoga is seśvara and more practical.
UPSC TRAP / ANSWER-USE: Answer-use: Sāṃkhya vs Advaita on satkāryavāda. ⚠️ Both can be treated as satkāryavādins because both deny sheer creation from non-being; the decisive difference is pariṇāma versus vivarta.
ANSWER-GRABBING FORMULATION: Sāṃkhya vs Advaita on satkāryavāda. ⚠️ Both can be treated as satkāryavādins because both deny sheer creation from non-being; the decisive difference is pariṇāma versus vivarta.
```
...
KEY TERMS / DEFINITIONS: Rubric. ⚠️ Western parallels are illustrative only, never a substitute for the Sāṃkhya argument; use at most one or two lines after the Indian case is complete.
MECHANISM / ARGUMENT: Rubric. ⚠️ Western parallels are illustrative only, never a substitute for the Sāṃkhya argument; use at most one or two lines after the Indian case is complete.
CONSEQUENCE / CONTRAST: Rubric. ⚠️ Western parallels are illustrative only, never a substitute for the Sāṃkhya argument; use at most one or two lines after the Indian case is complete.
UPSC TRAP / ANSWER-USE: Rubric. ⚠️ Western parallels are illustrative only, never a substitute for the Sāṃkhya argument; use at most one or two lines after the Indian case is complete.
ANSWER-GRABBING FORMULATION: Rubric. ⚠️ Western parallels are illustrative only, never a substitute for the Sāṃkhya argument; use at most one or two lines after the Indian case is complete.
```
...
KEY TERMS / DEFINITIONS: ✅ Sāṃkhya is a rigorously argued non-theistic realism rather than a loose mythology of evolution.
MECHANISM / ARGUMENT: ✅ Satkāryavāda is a genuinely powerful causal thesis because it explains determinate production and material continuity.
CONSEQUENCE / CONTRAST: ✅ Satkāryavāda is a genuinely powerful causal thesis because it explains determinate production and material continuity.
UPSC TRAP / ANSWER-USE: ✅ Sāṃkhya is a rigorously argued non-theistic realism rather than a loose mythology of evolution.
ANSWER-GRABBING FORMULATION: ✅ Sāṃkhya is a rigorously argued non-theistic realism rather than a loose mythology of evolution.
```
...
KEY TERMS / DEFINITIONS: ⚠️ The puruṣa–prakṛti relation is under-explained because inactive consciousness and unconscious matter must somehow generate experience.
MECHANISM / ARGUMENT: ⚠️ The puruṣa–prakṛti relation is under-explained because inactive consciousness and unconscious matter must somehow generate experience.
CONSEQUENCE / CONTRAST: ⚠️ Individuation of attributeless Puruṣas is the weakest point in the plurality doctrine.
UPSC TRAP / ANSWER-USE: ⚠️ The beginning of bondage is obscure because Puruṣa is never really modified and Prakṛti is beginningless.
ANSWER-GRABBING FORMULATION: ⚠️ The puruṣa–prakṛti relation is under-explained because inactive consciousness and unconscious matter must somehow generate experience.
```
...
KEY TERMS / DEFINITIONS: ❓ Whether kaivalya is purely negative isolation or has a positive phenomenological character is disputed.
MECHANISM / ARGUMENT: ❓ Whether kaivalya is purely negative isolation or has a positive phenomenological character is disputed.
CONSEQUENCE / CONTRAST: ❓ The relation between the Kārikā tradition and later Sūtra tradition is historically and doctrinally contested.
UPSC TRAP / ANSWER-USE: Answer-use: ❓ Whether early Sāṃkhya was originally theistic or consistently nirīśvara remains debated.
ANSWER-GRABBING FORMULATION: ❓ Whether early Sāṃkhya was originally theistic or consistently nirīśvara remains debated.
```
...
KEY TERMS / DEFINITIONS: 10 marks. ⚠️ Sāṃkhya is strongest as a concise dualist realism: one Prakṛti explains the world, many Puruṣas explain experience, and viveka explains liberation.
MECHANISM / ARGUMENT: 15 marks. ⚠️ Sāṃkhya's power lies in the mutual fit of pramāṇa, satkāryavāda, guṇa theory and kaivalya, though its contact problem invites Vedāntic criticism.
...
UPSC TRAP / ANSWER-USE: Answer-use: 10 marks. ⚠️ Sāṃkhya is strongest as a concise dualist realism: one Prakṛti explains the world, many Puruṣas explain experience, and viveka explains liberation.
ANSWER-GRABBING FORMULATION: 10 marks. ⚠️ Sāṃkhya is strongest as a concise dualist realism: one Prakṛti explains the world, many Puruṣas explain experience, and viveka explains liberation.
```
...
```closure-flow
SUBTOPIC: 1 10-mark format
KEY TERMS / DEFINITIONS: ⚠️ Start with the technical thesis in one line.
MECHANISM / ARGUMENT: ⚠️ Give the numbered proof / sequence / distinction directly.
CONSEQUENCE / CONTRAST: ⚠️ End with a judgement tied to the directive word.
UPSC TRAP / ANSWER-USE: Answer-use: ⚠️ Start with the technical thesis in one line.
ANSWER-GRABBING FORMULATION: ⚠️ Start with the technical thesis in one line.
```
...
```closure-flow
SUBTOPIC: 2 15-mark format
KEY TERMS / DEFINITIONS: ⚠️ Expose the doctrine in ordered points.
MECHANISM / ARGUMENT: ⚠️ Add distinction, comparison or criticism required by the question.
CONSEQUENCE / CONTRAST: ⚠️ Add distinction, comparison or criticism required by the question.
UPSC TRAP / ANSWER-USE: Answer-use: ⚠️ Frame the doctrinal problem in 2-3 lines.
ANSWER-GRABBING FORMULATION: ⚠️ Frame the doctrinal problem in 2-3 lines.
```
...
```closure-flow
SUBTOPIC: 3 20-mark format
KEY TERMS / DEFINITIONS: ⚠️ Body A: full doctrine in sequence.
MECHANISM / ARGUMENT: ⚠️ Body A: full doctrine in sequence.
CONSEQUENCE / CONTRAST: ⚠️ Body B: strongest rival or criticism.
UPSC TRAP / ANSWER-USE: ⚠️ Frame Sāṃkhya as a full metaphysical system, not a school-summary.
ANSWER-GRABBING FORMULATION: ⚠️ Frame Sāṃkhya as a full metaphysical system, not a school-summary.
```
...
KEY TERMS / DEFINITIONS: ✅ Search result, 16 August 2026: No reliable official development specifically applying or revising Samkhya doctrine was verified for February-August 2026.
MECHANISM / ARGUMENT: A web result claiming adoption of a national "Samkhya Paradigm" in mental-health policy was not supported by an official government source and is excluded.
CONSEQUENCE / CONTRAST: ✅ Search result, 16 August 2026: No reliable official development specifically applying or revising Samkhya doctrine was verified for February-August 2026.
...
ANSWER-GRABBING FORMULATION: ✅ Search result, 16 August 2026: No reliable official development specifically applying or revising Samkhya doctrine was verified for February-August 2026.
```
...
> Questions 1–40 diagnose core doctrine and exam traps. Correct options rotate strictly A → B → C → D.

#### 1. Which set exhausts the pramāṇas admitted by classical Sāṃkhya?

A. Pratyakṣa, anumāna and āptavacana/śabda
B. Pratyakṣa alone
C. Pratyakṣa, anumāna, upamāna and śabda
D. Six pramāṇas including anupalabdhi

**Answer: A. Pratyakṣa, anumāna and āptavacana/śabda**
...
A. Many conscious Prakṛtis and one Puruṣa
B. One conscious Prakṛti and many active Puruṣas
C. One unconscious Prakṛti and many inactive conscious Puruṣas
D. One Brahman appearing as both

**Answer: C. One unconscious Prakṛti and many inactive conscious Puruṣas**
...
A. Scripture makes inference unnecessary
B. Prakṛti is a gross element
C. Puruṣa perceives it as an object
...
C. That effects are illusory
D. That atoms are conscious
...
B. Qualities inhering in Puruṣa
C. Inseparable constitutive strands of Prakṛti
D. Three independent substances

**Answer: C. Inseparable constitutive strands of Prakṛti**
...
A. Rajas dominating both branches
B. Liberation of all Puruṣas
C. Ahaṃkāra appropriating cognition
D. Equilibrium of sattva, rajas and tamas in unmanifest Prakṛti

**Answer: D. Equilibrium of sattva, rajas and tamas in unmanifest Prakṛti**
...
A. Homogeneous change of each guṇa compatible with equilibrium
B. Apparent transformation of Brahman
C. New production from prior absence
D. Destruction of the guṇas

**Answer: A. Homogeneous change of each guṇa compatible with equilibrium**
...
A. Puruṣa chooses to create
B. Guṇa equilibrium is disturbed and unequal predominance develops
C. All karmic traces end
D. Mahat becomes conscious
...
A. Two successive evolutes
B. One tattva viewed cosmically and psychologically
C. Two names of ahaṃkāra
D. Two halves of Puruṣa

**Answer: B. One tattva viewed cosmically and psychologically**
...
B. Ahaṃkāra → manas → gross elements
C. Ahaṃkāra → buddhi → Puruṣa
D. Ahaṃkāra → five tanmātras → five mahābhūtas

**Answer: D. Ahaṃkāra → five tanmātras → five mahābhūtas**
...
A. Each proves many Puruṣas deductively
B. They prove an active creator
C. They prove only Prakṛti
D. Cumulatively they support a subject-pole more strongly than many eternal inactive Puruṣas

**Answer: D. Cumulatively they support a subject-pole more strongly than many eternal inactive Puruṣas**
...
C. Puruṣa empirically conditioned through buddhi, ahaṃkāra and subtle body
D. The single cosmic Prakṛti

**Answer: C. Puruṣa empirically conditioned through buddhi, ahaṃkāra and subtle body**
...
A. Puruṣa intentionally starts evolution
B. Puruṣa transforms into buddhi
C. Puruṣa judges mentally
D. Agency belongs to Prakṛti’s evolutes while Puruṣa witnesses

**Answer: D. Agency belongs to Prakṛti’s evolutes while Puruṣa witnesses**
...
B. The effect is wholly new
C. All change is illusory
...
A. Every cause is conscious
B. What is absolutely non-existent cannot be produced
C. Effect wholly differs from cause
D. Only atoms are eternal
...
B. Scriptural command
C. Puruṣa’s will
D. Destruction of prior absence
...
A. Cause and effect are unrelated
B. The effect retains the material nature of its cause
C. Only form persists
D. Causation requires God
...
A. Both deny any world
B. Advaita accepts many Prakṛtis
C. Sāṃkhya affirms real material transformation; Advaita, apparent transformation
D. Sāṃkhya makes Brahman the material cause
...
B. A miniature gross tree is spatially hidden in the seed
...
C. Videhamukti destroys Prakṛti universally
...
A. It denies consciousness
B. Its world-process and liberation do not require a creator God
C. It identifies Puruṣa with Īśvara
D. It rejects inference
...
A. Complementarity: consciousness without action and action without consciousness
B. Identity of Puruṣa and Prakṛti
C. Puruṣa as efficient cause
...
> Questions 41–48 target recurring conceptual and directive errors while continuing A → B → C → D.

#### 41. Why does Śaṃkara reject the magnet–iron analogy as a complete solution?

A. It proves too many Puruṣas
B. It denies continuity
C. A magnet exerts causal force, whereas Puruṣa is wholly inactive
D. Iron is conscious

**Answer: A. It proves too many Puruṣas**
...
A. Ordered functioning can arise from inherent guṇa-nature in Puruṣa’s presence without planning
B. Puruṣa secretly acts
C. Prakṛti is conscious
D. World is illusion

**Answer: A. Ordered functioning can arise from inherent guṇa-nature in Puruṣa’s presence without planning**
...
B. Sāṃkhya accepts pariṇāma; Advaita protects Brahman through vivarta
C. Advaita accepts many Prakṛtis
D. Sāṃkhya makes māyā sole cause

**Answer: B. Sāṃkhya accepts pariṇāma; Advaita protects Brahman through vivarta**
