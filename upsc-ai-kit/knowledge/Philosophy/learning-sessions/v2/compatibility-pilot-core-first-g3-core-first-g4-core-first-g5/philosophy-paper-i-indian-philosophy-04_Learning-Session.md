...
cover_image: ../../../Indian-Philosophy/learning-sessions/Nyaya-Vaisesika/assets/04_Nyaya-Vaisesika-Realist-System.png
---
...
![Nyaya-Vaisesika realist system](../../../Indian-Philosophy/learning-sessions/Nyaya-Vaisesika/assets/04_Nyaya-Vaisesika-Realist-System.png)
...
```closure-flow
SUBTOPIC: 1 Nyāya
KEY TERMS / DEFINITIONS: ✅ Nyāya is the school of logic, epistemology and critical debate, classically associated with Gautama's Nyāya-sūtra.
MECHANISM / ARGUMENT: ✅ Its concern is not logic in an abstract formalist sense alone, but valid cognition as a means to the removal of error and finally liberation.
CONSEQUENCE / CONTRAST: ✅ Its concern is not logic in an abstract formalist sense alone, but valid cognition as a means to the removal of error and finally liberation.
...
ANSWER-GRABBING FORMULATION: ✅ Nyāya is the school of logic, epistemology and critical debate, classically associated with Gautama's Nyāya-sūtra.
```
...
```closure-flow
SUBTOPIC: 2 Vaiśeṣika
KEY TERMS / DEFINITIONS: ✅ Vaiśeṣika, associated with Kaṇāda's Vaiśeṣika-sūtra, is primarily an ontological school.
MECHANISM / ARGUMENT: ✅ It classifies reality into padārthas and develops atomism.
CONSEQUENCE / CONTRAST: ✅ It classifies reality into padārthas and develops atomism.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Vaiśeṣika, associated with Kaṇāda's Vaiśeṣika-sūtra, is primarily an ontological school.
ANSWER-GRABBING FORMULATION: ✅ Vaiśeṣika, associated with Kaṇāda's Vaiśeṣika-sūtra, is primarily an ontological school.
```
...
```closure-flow
SUBTOPIC: 3 Their convergence
KEY TERMS / DEFINITIONS: ⚠️ In UPSC, it is usually best to treat them together while still noting where a point is distinctly Nyāya (e.g. pramāṇa, anyathākhyāti) or distinctly Vaiśeṣika (e.g. padārtha, atomism).
MECHANISM / ARGUMENT: ✅ Later Navya-Nyāya, especially through Gaṅgeśa, sharpens the analytic and technical vocabulary of the tradition.
CONSEQUENCE / CONTRAST: ⚠️ In UPSC, it is usually best to treat them together while still noting where a point is distinctly Nyāya (e.g. pramāṇa, anyathākhyāti) or distinctly Vaiśeṣika (e.g. padārtha, atomism).
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Over time the two schools converge into a synthetic Nyāya-Vaiśeṣika system.
ANSWER-GRABBING FORMULATION: ✅ Over time the two schools converge into a synthetic Nyāya-Vaiśeṣika system.
```
...
KEY TERMS / DEFINITIONS: ✅ Padārtha means what is nameable and knowable.
MECHANISM / ARGUMENT: ✅ Classical Vaiśeṣika finally recognizes seven padārthas.
CONSEQUENCE / CONTRAST: ❓ Historically, Kaṇāda's older list is often taken as six, with abhāva added later.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Padārtha means what is nameable and knowable.
ANSWER-GRABBING FORMULATION: ✅ Padārtha means what is nameable and knowable.
```
...
```closure-flow
SUBTOPIC: Statement
KEY TERMS / DEFINITIONS: ✅ Dravya is that in which qualities and actions inhere and which can serve as a material or ontological base.
MECHANISM / ARGUMENT: ✅ Dravya is that in which qualities and actions inhere and which can serve as a material or ontological base.
CONSEQUENCE / CONTRAST: ✅ Dravya is that in which qualities and actions inhere and which can serve as a material or ontological base.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Dravya is that in which qualities and actions inhere and which can serve as a material or ontological base.
ANSWER-GRABBING FORMULATION: ✅ Dravya is that in which qualities and actions inhere and which can serve as a material or ontological base.
```
...
KEY TERMS / DEFINITIONS: ⚠️ A common trap is to forget that ākāśa, kāla and dik are themselves substances, not merely abstract conditions.
MECHANISM / ARGUMENT: ⚠️ A common trap is to forget that ākāśa, kāla and dik are themselves substances, not merely abstract conditions.
CONSEQUENCE / CONTRAST: ⚠️ A common trap is to forget that ākāśa, kāla and dik are themselves substances, not merely abstract conditions.
UPSC TRAP / ANSWER-USE: ⚠️ A common trap is to forget that ākāśa, kāla and dik are themselves substances, not merely abstract conditions.
ANSWER-GRABBING FORMULATION: ⚠️ A common trap is to forget that ākāśa, kāla and dik are themselves substances, not merely abstract conditions.
```
...
```closure-flow
SUBTOPIC: Example
KEY TERMS / DEFINITIONS: ✅ A pot is a substance because colour, number, conjunction and motion can inhere in it.
MECHANISM / ARGUMENT: ✅ A pot is a substance because colour, number, conjunction and motion can inhere in it.
CONSEQUENCE / CONTRAST: ✅ A pot is a substance because colour, number, conjunction and motion can inhere in it.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ A pot is a substance because colour, number, conjunction and motion can inhere in it.
ANSWER-GRABBING FORMULATION: ✅ A pot is a substance because colour, number, conjunction and motion can inhere in it.
```
...
```closure-flow
SUBTOPIC: Statement
KEY TERMS / DEFINITIONS: ✅ Guṇa is a dependent ontological feature that inheres in a substance but does not itself possess further qualities or actions in the same way.
MECHANISM / ARGUMENT: ✅ The traditional list gives twenty-four qualities:
CONSEQUENCE / CONTRAST: saṃskāra (dispositional tendency/momentum)
UPSC TRAP / ANSWER-USE: ✅ Guṇa is a dependent ontological feature that inheres in a substance but does not itself possess further qualities or actions in the same way.
ANSWER-GRABBING FORMULATION: ✅ Guṇa is a dependent ontological feature that inheres in a substance but does not itself possess further qualities or actions in the same way.
```
...
KEY TERMS / DEFINITIONS: ⚠️ The list is notable because mental items like cognition, desire and pleasure are treated as qualities, not as the essence of self.
MECHANISM / ARGUMENT: ⚠️ The list is notable because mental items like cognition, desire and pleasure are treated as qualities, not as the essence of self.
CONSEQUENCE / CONTRAST: ⚠️ The list is notable because mental items like cognition, desire and pleasure are treated as qualities, not as the essence of self.
UPSC TRAP / ANSWER-USE: ⚠️ The list is notable because mental items like cognition, desire and pleasure are treated as qualities, not as the essence of self.
ANSWER-GRABBING FORMULATION: ⚠️ The list is notable because mental items like cognition, desire and pleasure are treated as qualities, not as the essence of self.
```
...
```closure-flow
SUBTOPIC: 5 Karma (motion/action)
KEY TERMS / DEFINITIONS: ✅ Karma here means physical motion/action, not moral karma.
MECHANISM / ARGUMENT: ✅ Motion is important because it generates conjunction and disjunction, central to causation.
CONSEQUENCE / CONTRAST: ✅ Motion is important because it generates conjunction and disjunction, central to causation.
UPSC TRAP / ANSWER-USE: ✅ Karma here means physical motion/action, not moral karma.
ANSWER-GRABBING FORMULATION: ✅ Karma here means physical motion/action, not moral karma.
```
...
```closure-flow
SUBTOPIC: Statement
KEY TERMS / DEFINITIONS: ✅ Sāmānya is the real universal, one-in-many, eternal and present in multiple particulars.
MECHANISM / ARGUMENT: ✅ Universals may be discussed through higher and lower ordering, often expressed as para and apara distinctions.
CONSEQUENCE / CONTRAST: ✅ Universals may be discussed through higher and lower ordering, often expressed as para and apara distinctions.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Sāmānya is the real universal, one-in-many, eternal and present in multiple particulars.
ANSWER-GRABBING FORMULATION: ✅ Sāmānya is the real universal, one-in-many, eternal and present in multiple particulars.
```
...
```closure-flow
SUBTOPIC: Argument
KEY TERMS / DEFINITIONS: 2. ✅ Mere resemblance is insufficient unless some objective commonness grounds the classification.
MECHANISM / ARGUMENT: 3. ✅ Therefore a universal must be real.
CONSEQUENCE / CONTRAST: 3. ✅ Therefore a universal must be real.
UPSC TRAP / ANSWER-USE: Answer-use: 1. ✅ We genuinely classify many individuals under one concept: "cow", "pot", "substance".
ANSWER-GRABBING FORMULATION: 1. ✅ We genuinely classify many individuals under one concept: "cow", "pot", "substance".
```
...
KEY TERMS / DEFINITIONS: ⚠️ The argument presupposes realist semantics: common predication reflects objective common structure in the world.
MECHANISM / ARGUMENT: ⚠️ The argument presupposes realist semantics: common predication reflects objective common structure in the world.
CONSEQUENCE / CONTRAST: ⚠️ The argument presupposes realist semantics: common predication reflects objective common structure in the world.
UPSC TRAP / ANSWER-USE: Answer-use: ⚠️ The argument presupposes realist semantics: common predication reflects objective common structure in the world.
ANSWER-GRABBING FORMULATION: ⚠️ The argument presupposes realist semantics: common predication reflects objective common structure in the world.
```
...
```closure-flow
SUBTOPIC: Distinction
KEY TERMS / DEFINITIONS: ✅ Vaiśeṣika realism here opposes the Buddhist apoha theory, which explains universals through exclusion rather than real common entities.
MECHANISM / ARGUMENT: ✅ Vaiśeṣika realism here opposes the Buddhist apoha theory, which explains universals through exclusion rather than real common entities.
CONSEQUENCE / CONTRAST: ✅ Vaiśeṣika realism here opposes the Buddhist apoha theory, which explains universals through exclusion rather than real common entities.
UPSC TRAP / ANSWER-USE: ✅ Vaiśeṣika realism here opposes the Buddhist apoha theory, which explains universals through exclusion rather than real common entities.
ANSWER-GRABBING FORMULATION: ✅ Vaiśeṣika realism here opposes the Buddhist apoha theory, which explains universals through exclusion rather than real common entities.
```
...
```closure-flow
SUBTOPIC: Example
KEY TERMS / DEFINITIONS: ✅ "Cow-ness" is one universal present in many cows.
MECHANISM / ARGUMENT: ✅ "Cow-ness" is one universal present in many cows.
CONSEQUENCE / CONTRAST: ✅ "Cow-ness" is one universal present in many cows.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ "Cow-ness" is one universal present in many cows.
ANSWER-GRABBING FORMULATION: ✅ "Cow-ness" is one universal present in many cows.
```
...
```closure-flow
SUBTOPIC: Objection
KEY TERMS / DEFINITIONS: ❓ If the universal is one, how can it be wholly present in many places?
MECHANISM / ARGUMENT: ❓ If the universal is one, how can it be wholly present in many places?
CONSEQUENCE / CONTRAST: ❓ If the universal is one, how can it be wholly present in many places?
UPSC TRAP / ANSWER-USE: Answer-use: ❓ If the universal is one, how can it be wholly present in many places?
ANSWER-GRABBING FORMULATION: ❓ If the universal is one, how can it be wholly present in many places?
```
...
```closure-flow
SUBTOPIC: Reply
KEY TERMS / DEFINITIONS: ✅ The universal is not spatially divided like a physical thing; it is a single eternal entity instantiated in many particulars through samavāya (inherence).
MECHANISM / ARGUMENT: ✅ The universal is not spatially divided like a physical thing; it is a single eternal entity instantiated in many particulars through samavāya (inherence).
CONSEQUENCE / CONTRAST: ✅ The universal is not spatially divided like a physical thing; it is a single eternal entity instantiated in many particulars through samavāya (inherence).
UPSC TRAP / ANSWER-USE: ✅ The universal is not spatially divided like a physical thing; it is a single eternal entity instantiated in many particulars through samavāya (inherence).
ANSWER-GRABBING FORMULATION: ✅ The universal is not spatially divided like a physical thing; it is a single eternal entity instantiated in many particulars through samavāya (inherence).
```
...
```closure-flow
SUBTOPIC: 7 Jāti-bādhaka: six impediments to universalhood
KEY TERMS / DEFINITIONS: Not every general term names a real universal (jāti, class-universal); where a proposed jāti is blocked, Nyāya-Vaiśeṣika treats it as an imposed property or limiting condition (upādhi, adjunct), not as a new padārtha.
MECHANISM / ARGUMENT: Universals are perceived in determinate perception (savikalpaka-pratyakṣa) such as "this is a cow"; their presence is by samavāya, not by spatial containment; and apoha is circular because exclusion of non-cows presupposes a stable cow-class or at least stable exclusion-domains.
CONSEQUENCE / CONTRAST: Dignāga and Dharmakīrti-style apoha theory argues that universals are unperceived, causally inert, and cannot be wholly present in many places at once.
UPSC TRAP / ANSWER-USE: Not every general term names a real universal (jāti, class-universal); where a proposed jāti is blocked, Nyāya-Vaiśeṣika treats it as an imposed property or limiting condition (upādhi, adjunct), not as a new padārtha.
ANSWER-GRABBING FORMULATION: Not every general term names a real universal (jāti, class-universal); where a proposed jāti is blocked, Nyāya-Vaiśeṣika treats it as an imposed property or limiting condition (upādhi, adjunct), not as a new padārtha.
```
...
```closure-flow
SUBTOPIC: 8 Viśeṣa (particularity)
KEY TERMS / DEFINITIONS: Viśeṣa is the ultimate individuator residing only in eternal substances: the paramāṇus of earth, water, fire and air, and the eternal instances of ākāśa, kāla, dik, ātman and manas.
MECHANISM / ARGUMENT: Two atoms of earth may be alike in all universals and ordinary qualities; without viśeṣa they would be indistinguishable and, by the identity of indiscernibles, would collapse into one.
CONSEQUENCE / CONTRAST: Viśeṣa gives the Vaiśeṣika school its name because the system explains plurality through irreducible particularity.
UPSC TRAP / ANSWER-USE: Answer-use: Viśeṣa is the ultimate individuator residing only in eternal substances: the paramāṇus of earth, water, fire and air, and the eternal instances of ākāśa, kāla, dik, ātman and manas.
ANSWER-GRABBING FORMULATION: Viśeṣa is the ultimate individuator residing only in eternal substances: the paramāṇus of earth, water, fire and air, and the eternal instances of ākāśa, kāla, dik, ātman and manas.
```
...
```closure-flow
SUBTOPIC: Objection: regress of differentiators
KEY TERMS / DEFINITIONS: Critics argue that "self-differentiating" names the stopping point rather than proving it; viśeṣa is a stipulated terminus of individuation.
MECHANISM / ARGUMENT: Viśeṣas are svato-vyāvartaka (self-differentiating): they distinguish both their loci and themselves by their own nature.
CONSEQUENCE / CONTRAST: Viśeṣas are svato-vyāvartaka (self-differentiating): they distinguish both their loci and themselves by their own nature.
UPSC TRAP / ANSWER-USE: Critics argue that "self-differentiating" names the stopping point rather than proving it; viśeṣa is a stipulated terminus of individuation.
ANSWER-GRABBING FORMULATION: If viśeṣa differentiates one atom from another, what differentiates one viśeṣa from another?
```
...
```closure-flow
SUBTOPIC: Objection: imperceptible ontological IOU
KEY TERMS / DEFINITIONS: Viśeṣa is imperceptible and appears to be posited solely to do the explanatory job of individuating exactly similar eternals.
MECHANISM / ARGUMENT: Nyāya-Vaiśeṣika frames the posit inferentially: plurality of exactly similar eternal substances is otherwise inexplicable, and Nyāya reduces arthāpatti (postulation) to inference rather than making it a separate pramāṇa.
CONSEQUENCE / CONTRAST: Jaina, Buddhist and Advaita critiques often target viśeṣa and samavāya as the weakest joints of the system; Śrīharṣa’s Khaṇḍanakhaṇḍakhādya attacks Nyāya definitions systematically.
UPSC TRAP / ANSWER-USE: Nyāya-Vaiśeṣika frames the posit inferentially: plurality of exactly similar eternal substances is otherwise inexplicable, and Nyāya reduces arthāpatti (postulation) to inference rather than making it a separate pramāṇa.
ANSWER-GRABBING FORMULATION: Viśeṣa is imperceptible and appears to be posited solely to do the explanatory job of individuating exactly similar eternals.
```
...
```closure-flow
SUBTOPIC: 9 Samavāya (inherence)
KEY TERMS / DEFINITIONS: Samavāya is the eternal, single, imperceptible-yet-inferred inseparable relation (ayutasiddha-sambandha) that holds where relata cannot be established as separable in the relevant ontological mode.
MECHANISM / ARGUMENT: It holds between five standard pairs: part–whole, substance–quality, substance–motion, universal–particular, and eternal substance–its viśeṣa.
CONSEQUENCE / CONTRAST: Later exposition calls samavāya one and not locally multiplied; "all-pervading" should be read as one relation operating wherever the required relata obtain, not as a tenth spatial substance.
UPSC TRAP / ANSWER-USE: Samavāya is the eternal, single, imperceptible-yet-inferred inseparable relation (ayutasiddha-sambandha) that holds where relata cannot be established as separable in the relevant ontological mode.
ANSWER-GRABBING FORMULATION: Samavāya is the eternal, single, imperceptible-yet-inferred inseparable relation (ayutasiddha-sambandha) that holds where relata cannot be established as separable in the relevant ontological mode.
```
...
```closure-flow
SUBTOPIC: Distinction from saṃyoga
KEY TERMS / DEFINITIONS: Inseparability is necessary for samavāya, but ⚠️ not by itself sufficient unless the specific ontological dependence relation is shown; mere closeness is not inherence.
MECHANISM / ARGUMENT: Inseparability is necessary for samavāya, but ⚠️ not by itself sufficient unless the specific ontological dependence relation is shown; mere closeness is not inherence.
CONSEQUENCE / CONTRAST: Inseparability is necessary for samavāya, but ⚠️ not by itself sufficient unless the specific ontological dependence relation is shown; mere closeness is not inherence.
UPSC TRAP / ANSWER-USE: Inseparability is necessary for samavāya, but ⚠️ not by itself sufficient unless the specific ontological dependence relation is shown; mere closeness is not inherence.
ANSWER-GRABBING FORMULATION: Inseparability is necessary for samavāya, but ⚠️ not by itself sufficient unless the specific ontological dependence relation is shown; mere closeness is not inherence.
```
...
```closure-flow
SUBTOPIC: Objection: relation-regress
KEY TERMS / DEFINITIONS: Samavāya is svarūpa-sambandha (self-linking relation): it relates by its own nature and needs no further relator.
MECHANISM / ARGUMENT: Samavāya is svarūpa-sambandha (self-linking relation): it relates by its own nature and needs no further relator.
CONSEQUENCE / CONTRAST: This is a stipulated terminus; every relational ontology must stop somewhere, and critics such as Buddhists and Śrīharṣa press the charge that Nyāya stops regress here while using regress against opponents.
UPSC TRAP / ANSWER-USE: Answer-use: If samavāya relates A and B, a further relation seems needed to relate samavāya to A and to B, generating anavasthā (infinite regress).
ANSWER-GRABBING FORMULATION: If samavāya relates A and B, a further relation seems needed to relate samavāya to A and to B, generating anavasthā (infinite regress).
```
...
```closure-flow
SUBTOPIC: Objection: one or many samavāyas?
KEY TERMS / DEFINITIONS: Samavāya is one and eternal; parsimony is the Vaiśeṣika reason for not multiplying inherence-relations.
MECHANISM / ARGUMENT: If samavāya is one, it is hard to explain why it relates this quality to this substance rather than to all substances.
CONSEQUENCE / CONTRAST: The relata themselves determine the relation’s operation: samavāya is not a free-floating glue but the inseparable tie manifest only where the relevant terms exist.
UPSC TRAP / ANSWER-USE: Samavāya is one and eternal; parsimony is the Vaiśeṣika reason for not multiplying inherence-relations.
ANSWER-GRABBING FORMULATION: Samavāya is one and eternal; parsimony is the Vaiśeṣika reason for not multiplying inherence-relations.
```
...
```closure-flow
SUBTOPIC: Statement
KEY TERMS / DEFINITIONS: ✅ Abhāva is the category of absence or non-existence.
MECHANISM / ARGUMENT: 1. prāgabhāva — prior non-existence
CONSEQUENCE / CONTRAST: 2. pradhvaṃsābhāva — posterior non-existence/destruction
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Abhāva is the category of absence or non-existence.
ANSWER-GRABBING FORMULATION: ✅ Abhāva is the category of absence or non-existence.
```
...
```closure-flow
SUBTOPIC: (a) Prāgabhāva
KEY TERMS / DEFINITIONS: ✅ It has no beginning, but ends when the effect is produced.
MECHANISM / ARGUMENT: ✅ It has no beginning, but ends when the effect is produced.
CONSEQUENCE / CONTRAST: ✅ The non-existence of an effect before its production.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ The non-existence of an effect before its production.
ANSWER-GRABBING FORMULATION: ✅ The non-existence of an effect before its production.
```
...
```closure-flow
SUBTOPIC: (b) Pradhvaṃsābhāva
KEY TERMS / DEFINITIONS: ✅ The non-existence of a thing after its destruction.
MECHANISM / ARGUMENT: ✅ It begins with destruction and has no end.
CONSEQUENCE / CONTRAST: ✅ It begins with destruction and has no end.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ The non-existence of a thing after its destruction.
ANSWER-GRABBING FORMULATION: ✅ The non-existence of a thing after its destruction.
```
...
```closure-flow
SUBTOPIC: (c) Atyantābhāva
KEY TERMS / DEFINITIONS: ✅ Absolute non-existence: a thing is absent in a locus for all times.
MECHANISM / ARGUMENT: ✅ Absolute non-existence: a thing is absent in a locus for all times.
CONSEQUENCE / CONTRAST: ✅ Absolute non-existence: a thing is absent in a locus for all times.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Absolute non-existence: a thing is absent in a locus for all times.
ANSWER-GRABBING FORMULATION: ✅ Absolute non-existence: a thing is absent in a locus for all times.
```
...
```closure-flow
SUBTOPIC: (d) Anyonyābhāva
KEY TERMS / DEFINITIONS: ✅ "A pot is not a cloth" means pot and cloth are different entities.
MECHANISM / ARGUMENT: ✅ "A pot is not a cloth" means pot and cloth are different entities.
CONSEQUENCE / CONTRAST: ✅ "A pot is not a cloth" means pot and cloth are different entities.
UPSC TRAP / ANSWER-USE: ✅ "A pot is not a cloth" means pot and cloth are different entities.
ANSWER-GRABBING FORMULATION: ✅ Mutual non-existence or reciprocal difference.
```
...
```closure-flow
SUBTOPIC: 2024 distinction: air does not have heat vs air is not fire
KEY TERMS / DEFINITIONS: ✅ "Air does not have heat" is best treated as atyantābhāva with respect to heat in air.
MECHANISM / ARGUMENT: ✅ "Air is not fire" is anyonyābhāva, because it expresses difference between two entities.
CONSEQUENCE / CONTRAST: ⚠️ Therefore they are not the same kind of absence.
UPSC TRAP / ANSWER-USE: ✅ "Air does not have heat" is best treated as atyantābhāva with respect to heat in air.
ANSWER-GRABBING FORMULATION: ✅ "Air does not have heat" is best treated as atyantābhāva with respect to heat in air.
```
...
```closure-flow
SUBTOPIC: 2023 issue: counterpositive (pratiyogin)
KEY TERMS / DEFINITIONS: ✅ Every absence is the absence of something; that absent positive term is the pratiyogin or counterpositive.
MECHANISM / ARGUMENT: ⚠️ This shows abhāva is not sheer blankness; it has structured intentional content.
CONSEQUENCE / CONTRAST: ⚠️ This shows abhāva is not sheer blankness; it has structured intentional content.
UPSC TRAP / ANSWER-USE: ⚠️ This shows abhāva is not sheer blankness; it has structured intentional content.
ANSWER-GRABBING FORMULATION: ✅ Every absence is the absence of something; that absent positive term is the pratiyogin or counterpositive.
```
...
```closure-flow
SUBTOPIC: Gautama's definition (2025)
KEY TERMS / DEFINITIONS: ✅ The classical Nyāya definition states in substance: "indriyārtha-sannikarṣa-utpannaṃ jñānam avyapadeśyam avyabhicāri vyavasāyātmakam pratyakṣam".
MECHANISM / ARGUMENT: ✅ UPSC expects clause-by-clause unpacking.
CONSEQUENCE / CONTRAST: ✅ UPSC expects clause-by-clause unpacking.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ The classical Nyāya definition states in substance: "indriyārtha-sannikarṣa-utpannaṃ jñānam avyapadeśyam avyabhicāri vyavasāyātmakam pratyakṣam".
ANSWER-GRABBING FORMULATION: ✅ The classical Nyāya definition states in substance: "indriyārtha-sannikarṣa-utpannaṃ jñānam avyapadeśyam avyabhicāri vyavasāyātmakam pratyakṣam".
```
...
```closure-flow
SUBTOPIC: Clause-by-clause analysis
KEY TERMS / DEFINITIONS: 1. indriyārtha-sannikarṣa — sense-object contact
MECHANISM / ARGUMENT: ✅ Perception is not constituted by words as words.
CONSEQUENCE / CONTRAST: ⚠️ This marks perception as causally immediate relative to the relevant sense relation.
UPSC TRAP / ANSWER-USE: 3. avyapadeśyam — non-verbal / not dependent on testimony
ANSWER-GRABBING FORMULATION: 1. indriyārtha-sannikarṣa — sense-object contact
```
...
```closure-flow
SUBTOPIC: Nirvikalpaka and savikalpaka perception
KEY TERMS / DEFINITIONS: ✅ Nirvikalpaka perception is indeterminate, pre-predicative awareness.
MECHANISM / ARGUMENT: ✅ Savikalpaka perception is determinate: qualified, nameable awareness such as "this is a blue pot".
CONSEQUENCE / CONTRAST: ⚠️ The tradition often uses nirvikalpaka to explain how raw awareness can ground determinate judgment.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Nirvikalpaka perception is indeterminate, pre-predicative awareness.
ANSWER-GRABBING FORMULATION: ✅ Nirvikalpaka perception is indeterminate, pre-predicative awareness.
```
...
```closure-flow
SUBTOPIC: The six sannikarṣas
KEY TERMS / DEFINITIONS: 2. saṃyukta-samavāya — inherence in what is conjoined
MECHANISM / ARGUMENT: 2. saṃyukta-samavāya — inherence in what is conjoined
CONSEQUENCE / CONTRAST: 3. saṃyukta-samaveta-samavāya — inherence in what inheres in what is conjoined
UPSC TRAP / ANSWER-USE: ⚠️ These are technical tools for explaining how the senses can apprehend not just substances, but also qualities, universals and absences.
ANSWER-GRABBING FORMULATION: ✅ Nyāya elaborates six sense-object relations:
```
...
```closure-flow
SUBTOPIC: Extraordinary perception (alaukika) (2023, 2019)
KEY TERMS / DEFINITIONS: perception through the universal; by apprehending a universal one can perceptually relate to all its instances in a distinctive way.
MECHANISM / ARGUMENT: perception through the universal; by apprehending a universal one can perceptually relate to all its instances in a distinctive way.
CONSEQUENCE / CONTRAST: a case where prior cognition mediates present perception; e.g. one may in a derivative sense "see" sandalwood as fragrant.
UPSC TRAP / ANSWER-USE: ⚠️ This supports Nyāya realism about universals: universals are perceived, not merely inferred.
ANSWER-GRABBING FORMULATION: perception through the universal; by apprehending a universal one can perceptually relate to all its instances in a distinctive way.
```
...
```closure-flow
SUBTOPIC: Statement
KEY TERMS / DEFINITIONS: ✅ Anumāna is knowledge arising through a sign (liṅga/hetu, probans) known to be invariably related to the probandum (sādhya).
MECHANISM / ARGUMENT: ✅ Anumāna is knowledge arising through a sign (liṅga/hetu, probans) known to be invariably related to the probandum (sādhya).
CONSEQUENCE / CONTRAST: ✅ Anumāna is knowledge arising through a sign (liṅga/hetu, probans) known to be invariably related to the probandum (sādhya).
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Anumāna is knowledge arising through a sign (liṅga/hetu, probans) known to be invariably related to the probandum (sādhya).
ANSWER-GRABBING FORMULATION: ✅ Anumāna is knowledge arising through a sign (liṅga/hetu, probans) known to be invariably related to the probandum (sādhya).
```
...
```closure-flow
SUBTOPIC: Five members of inference
KEY TERMS / DEFINITIONS: 3. ✅ udāharaṇa — wherever there is smoke, there is fire, as in a kitchen.
MECHANISM / ARGUMENT: 5. ✅ nigamana — therefore the hill has fire.
CONSEQUENCE / CONTRAST: 5. ✅ nigamana — therefore the hill has fire.
UPSC TRAP / ANSWER-USE: Answer-use: 3. ✅ udāharaṇa — wherever there is smoke, there is fire, as in a kitchen.
ANSWER-GRABBING FORMULATION: 3. ✅ udāharaṇa — wherever there is smoke, there is fire, as in a kitchen.
```
...
```closure-flow
SUBTOPIC: Five characteristics of a valid hetu
KEY TERMS / DEFINITIONS: 1. ✅ pakṣadharmatā — the hetu is present in the subject under consideration.
MECHANISM / ARGUMENT: 4. ✅ abādhita — the sādhya is not contradicted by stronger knowledge.
CONSEQUENCE / CONTRAST: 3. ✅ vipakṣa-asattva — the hetu is absent in dissimilar negative instances.
UPSC TRAP / ANSWER-USE: 4. ✅ abādhita — the sādhya is not contradicted by stronger knowledge.
ANSWER-GRABBING FORMULATION: 1. ✅ pakṣadharmatā — the hetu is present in the subject under consideration.
```
...
```closure-flow
SUBTOPIC: 4 Vyāpti-grahaṇa: grasping invariable concomitance
KEY TERMS / DEFINITIONS: Vyāpti-grahaṇa is the chain by which Nyāya claims to know the universal relation required for inference; it is the core reply to Cārvāka scepticism about anumāna.
MECHANISM / ARGUMENT: Vyāpti-grahaṇa is the chain by which Nyāya claims to know the universal relation required for inference; it is the core reply to Cārvāka scepticism about anumāna.
CONSEQUENCE / CONTRAST: Vyāpti-grahaṇa is the chain by which Nyāya claims to know the universal relation required for inference; it is the core reply to Cārvāka scepticism about anumāna.
UPSC TRAP / ANSWER-USE: Answer-use: Vyāpti-grahaṇa is the chain by which Nyāya claims to know the universal relation required for inference; it is the core reply to Cārvāka scepticism about anumāna.
ANSWER-GRABBING FORMULATION: Vyāpti-grahaṇa is the chain by which Nyāya claims to know the universal relation required for inference; it is the core reply to Cārvāka scepticism about anumāna.
```
...
```closure-flow
SUBTOPIC: Vyāpti defined
KEY TERMS / DEFINITIONS: Vyāpti is invariable, unconditional concomitance (avinābhāva-niyama) between the hetu/liṅga (probans, e.g. smoke) and the sādhya (probandum, e.g. fire).
MECHANISM / ARGUMENT: Viṣamavyāpti / asamavyāpti is unequal extension: all smoke is pervaded by fire, but not all fire is pervaded by smoke.
CONSEQUENCE / CONTRAST: Viṣamavyāpti / asamavyāpti is unequal extension: all smoke is pervaded by fire, but not all fire is pervaded by smoke.
UPSC TRAP / ANSWER-USE: Viṣamavyāpti / asamavyāpti is unequal extension: all smoke is pervaded by fire, but not all fire is pervaded by smoke.
ANSWER-GRABBING FORMULATION: Vyāpti is invariable, unconditional concomitance (avinābhāva-niyama) between the hetu/liṅga (probans, e.g. smoke) and the sādhya (probandum, e.g. fire).
```
...
```closure-flow
SUBTOPIC: Bhūyodarśana: repeated positive and negative observation
KEY TERMS / DEFINITIONS: The knower also observes co-absence (vyatireka) in negative instances: where fire is absent, smoke is absent.
MECHANISM / ARGUMENT: Bhūyodarśana alone is not sufficient, because repeated observation remains a finite sample and cannot by itself yield an unrestricted universal.
CONSEQUENCE / CONTRAST: Bhūyodarśana alone is not sufficient, because repeated observation remains a finite sample and cannot by itself yield an unrestricted universal.
UPSC TRAP / ANSWER-USE: Bhūyodarśana alone is not sufficient, because repeated observation remains a finite sample and cannot by itself yield an unrestricted universal.
ANSWER-GRABBING FORMULATION: The knower observes co-presence (anvaya) in many positive instances: smoke with fire in kitchens, hearths and similar cases.
```
...
```closure-flow
SUBTOPIC: Vyabhicāra-adarśana: absence of counter-instance
KEY TERMS / DEFINITIONS: The investigator searches for deviation (vyabhicāra) and does not find a case where the hetu occurs without the sādhya.
MECHANISM / ARGUMENT: This strengthens the universal but still needs the removal of hidden conditions.
CONSEQUENCE / CONTRAST: This strengthens the universal but still needs the removal of hidden conditions.
UPSC TRAP / ANSWER-USE: The investigator searches for deviation (vyabhicāra) and does not find a case where the hetu occurs without the sādhya.
ANSWER-GRABBING FORMULATION: The investigator searches for deviation (vyabhicāra) and does not find a case where the hetu occurs without the sādhya.
```
...
```closure-flow
SUBTOPIC: Upādhi-nirāsa: removal of conditioning adjunct
KEY TERMS / DEFINITIONS: Upādhi is a conditioning adjunct: sādhya-vyāpakatve sati sādhana-avyāpakaḥ — that which pervades the sādhya but does not pervade the hetu.
MECHANISM / ARGUMENT: In the bad inference "the hill has smoke because it has fire", wet fuel (ārdra-indhana) is the upādhi: wherever there is smoke there is wet fuel, but not wherever there is fire is there wet fuel.
CONSEQUENCE / CONTRAST: Therefore fire does not unconditionally pervade smoke; the fire-to-smoke inference is conditional and fails.
UPSC TRAP / ANSWER-USE: Upādhi is a conditioning adjunct: sādhya-vyāpakatve sati sādhana-avyāpakaḥ — that which pervades the sādhya but does not pervade the hetu.
ANSWER-GRABBING FORMULATION: Upādhi is a conditioning adjunct: sādhya-vyāpakatve sati sādhana-avyāpakaḥ — that which pervades the sādhya but does not pervade the hetu.
```
...
```closure-flow
SUBTOPIC: Tarka: reductive doubt-removal
KEY TERMS / DEFINITIONS: Tarka is hypothetical or counterfactual reasoning that removes residual doubt by showing the unacceptable consequence of the contrary supposition.
MECHANISM / ARGUMENT: Tarka is hypothetical or counterfactual reasoning that removes residual doubt by showing the unacceptable consequence of the contrary supposition.
CONSEQUENCE / CONTRAST: Tarka is pramāṇa-anugrāhaka (an aid to pramāṇas), not an independent pramāṇa; it supports perception and inference by eliminating the rival supposition.
UPSC TRAP / ANSWER-USE: If smoke were not pervaded by fire, smoke could occur without fire; this contradicts uniform experience and would make the causal order unintelligible.
ANSWER-GRABBING FORMULATION: Tarka is hypothetical or counterfactual reasoning that removes residual doubt by showing the unacceptable consequence of the contrary supposition.
```
...
```closure-flow
SUBTOPIC: Sāmānyalakṣaṇa-pratyakṣa: universal-mediated perception
KEY TERMS / DEFINITIONS: As noted in §3.2, sāmānyalakṣaṇa-pratyakṣa is extraordinary (alaukika) perception through the universal.
MECHANISM / ARGUMENT: As noted in §3.2, sāmānyalakṣaṇa-pratyakṣa is extraordinary (alaukika) perception through the universal.
CONSEQUENCE / CONTRAST: This is the specifically Nyāya move against the problem of induction: because jāti is real, the universal can be cognitively grasped, not merely guessed from samples.
UPSC TRAP / ANSWER-USE: This is the specifically Nyāya move against the problem of induction: because jāti is real, the universal can be cognitively grasped, not merely guessed from samples.
ANSWER-GRABBING FORMULATION: As noted in §3.2, sāmānyalakṣaṇa-pratyakṣa is extraordinary (alaukika) perception through the universal.
```
...
```closure-flow
SUBTOPIC: Pakṣadharmatā and parāmarśa
KEY TERMS / DEFINITIONS: The immediate cause (karaṇa) of inferential cognition is the subsumptive reflection: "this hill possesses smoke which is pervaded by fire".
MECHANISM / ARGUMENT: The immediate cause (karaṇa) of inferential cognition is the subsumptive reflection: "this hill possesses smoke which is pervaded by fire".
CONSEQUENCE / CONTRAST: The five-membered syllogism makes parāmarśa communicable: pratijñā states the thesis, hetu states the sign, udāharaṇa states vyāpti with example, upanaya applies it to the pakṣa, and nigamana states the conclusion.
UPSC TRAP / ANSWER-USE: Answer-use: The hetu must be known to exist in the pakṣa: this hill has smoke.
ANSWER-GRABBING FORMULATION: The hetu must be known to exist in the pakṣa: this hill has smoke.
```
...
```closure-flow
SUBTOPIC: Hetvābhāsa as the negative test of vyāpti
KEY TERMS / DEFINITIONS: Savyabhicāra violates vipakṣa-asattva, asiddha violates pakṣadharmatā, bādhita violates abādhita, satpratipakṣa violates asatpratipakṣa, and viruddha reverses the direction of vyāpti itself.
MECHANISM / ARGUMENT: Savyabhicāra violates vipakṣa-asattva, asiddha violates pakṣadharmatā, bādhita violates abādhita, satpratipakṣa violates asatpratipakṣa, and viruddha reverses the direction of vyāpti itself.
CONSEQUENCE / CONTRAST: Savyabhicāra violates vipakṣa-asattva, asiddha violates pakṣadharmatā, bādhita violates abādhita, satpratipakṣa violates asatpratipakṣa, and viruddha reverses the direction of vyāpti itself.
UPSC TRAP / ANSWER-USE: Answer-use: Savyabhicāra violates vipakṣa-asattva, asiddha violates pakṣadharmatā, bādhita violates abādhita, satpratipakṣa violates asatpratipakṣa, and viruddha reverses the direction of vyāpti itself.
ANSWER-GRABBING FORMULATION: Savyabhicāra violates vipakṣa-asattva, asiddha violates pakṣadharmatā, bādhita violates abādhita, satpratipakṣa violates asatpratipakṣa, and viruddha reverses the direction of vyāpti itself.
```
...
```closure-flow
SUBTOPIC: Objection: Cārvāka and the Humean parallel
KEY TERMS / DEFINITIONS: No finite observation licenses a universal; upādhi-elimination can never be completed; tarka presupposes inference and is circular; and sāmānyalakṣaṇa-pratyakṣa looks like an ad hoc posit.
MECHANISM / ARGUMENT: The parallel is that observed regularity alone does not logically entail future or universal necessity.
CONSEQUENCE / CONTRAST: The parallel is that observed regularity alone does not logically entail future or universal necessity.
UPSC TRAP / ANSWER-USE: No finite observation licenses a universal; upādhi-elimination can never be completed; tarka presupposes inference and is circular; and sāmānyalakṣaṇa-pratyakṣa looks like an ad hoc posit.
ANSWER-GRABBING FORMULATION: No finite observation licenses a universal; upādhi-elimination can never be completed; tarka presupposes inference and is circular; and sāmānyalakṣaṇa-pratyakṣa looks like an ad hoc posit.
```
...
```closure-flow
SUBTOPIC: Reply: Nyāya answer
KEY TERMS / DEFINITIONS: The demand for mathematical certainty from empirical universals is misplaced; Nyāya claims warranted cognition, not omniscient enumeration by ordinary knowers.
MECHANISM / ARGUMENT: The demand for mathematical certainty from empirical universals is misplaced; Nyāya claims warranted cognition, not omniscient enumeration by ordinary knowers.
CONSEQUENCE / CONTRAST: Sāmānyalakṣaṇa-pratyakṣa is not ad hoc within Nyāya ontology, because universals are real padārthas and can be presented in cognition.
UPSC TRAP / ANSWER-USE: The demand for mathematical certainty from empirical universals is misplaced; Nyāya claims warranted cognition, not omniscient enumeration by ordinary knowers.
ANSWER-GRABBING FORMULATION: The demand for mathematical certainty from empirical universals is misplaced; Nyāya claims warranted cognition, not omniscient enumeration by ordinary knowers.
```
...
```closure-flow
SUBTOPIC: 5 Upamāna (comparison)
KEY TERMS / DEFINITIONS: ✅ If one is told that a gavaya resembles a cow, later encountering such an animal yields knowledge that this is what the word denotes.
MECHANISM / ARGUMENT: ✅ Upamāna gives knowledge of the relation between a word and its referent through resemblance.
CONSEQUENCE / CONTRAST: ⚠️ The point is semantic acquisition via similarity.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Upamāna gives knowledge of the relation between a word and its referent through resemblance.
ANSWER-GRABBING FORMULATION: ✅ Upamāna gives knowledge of the relation between a word and its referent through resemblance.
```
...
```closure-flow
SUBTOPIC: Statement
KEY TERMS / DEFINITIONS: ✅ Śabda is valid verbal testimony, classically understood as āptavākya, the statement of an āpta — a trustworthy competent person.
MECHANISM / ARGUMENT: ✅ Śabda is valid verbal testimony, classically understood as āptavākya, the statement of an āpta — a trustworthy competent person.
CONSEQUENCE / CONTRAST: ✅ Śabda is valid verbal testimony, classically understood as āptavākya, the statement of an āpta — a trustworthy competent person.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Śabda is valid verbal testimony, classically understood as āptavākya, the statement of an āpta — a trustworthy competent person.
ANSWER-GRABBING FORMULATION: ✅ Śabda is valid verbal testimony, classically understood as āptavākya, the statement of an āpta — a trustworthy competent person.
```
...
```closure-flow
SUBTOPIC: Argument
KEY TERMS / DEFINITIONS: 1. ✅ Many things cannot be directly perceived by each knower.
MECHANISM / ARGUMENT: 1. ✅ Many things cannot be directly perceived by each knower.
CONSEQUENCE / CONTRAST: 3. ✅ Therefore testimony must be recognized as an independent pramāṇa when it comes from a trustworthy source.
UPSC TRAP / ANSWER-USE: 1. ✅ Many things cannot be directly perceived by each knower.
ANSWER-GRABBING FORMULATION: 1. ✅ Many things cannot be directly perceived by each knower.
```
...
```closure-flow
SUBTOPIC: Vedic testimony
KEY TERMS / DEFINITIONS: ✅ In later Nyāya, its authority is often connected with God as omniscient author.
MECHANISM / ARGUMENT: ✅ In later Nyāya, its authority is often connected with God as omniscient author.
CONSEQUENCE / CONTRAST: ✅ In later Nyāya, its authority is often connected with God as omniscient author.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Nyāya accepts the Veda as valid testimony.
ANSWER-GRABBING FORMULATION: ✅ Nyāya accepts the Veda as valid testimony.
```
...
```closure-flow
SUBTOPIC: 7 Why memory (smṛti) is not a pramāṇa (2024)
KEY TERMS / DEFINITIONS: ✅ A pramāṇa must produce fresh, true cognition of what is not already known in that mode.
MECHANISM / ARGUMENT: ⚠️ Therefore memory may be psychologically useful but is not epistemically pramāṇa in the technical sense.
CONSEQUENCE / CONTRAST: ⚠️ Therefore memory may be psychologically useful but is not epistemically pramāṇa in the technical sense.
UPSC TRAP / ANSWER-USE: ✅ Memory reproduces a past cognition; it does not generate novel knowledge.
ANSWER-GRABBING FORMULATION: ✅ Memory reproduces a past cognition; it does not generate novel knowledge.
```
...
```closure-flow
SUBTOPIC: 8 Svataḥ and parataḥ prāmāṇya (2025)
KEY TERMS / DEFINITIONS: ✅ That means both validity and invalidity of cognition are known through external conditions or later confirmation/disconfirmation.
MECHANISM / ARGUMENT: ✅ That means both validity and invalidity of cognition are known through external conditions or later confirmation/disconfirmation.
CONSEQUENCE / CONTRAST: ✅ Contrast: Mīmāṃsā generally takes validity to be self-manifest (svataḥ) while invalidity is known later.
UPSC TRAP / ANSWER-USE: ⚠️ This is a standard UPSC trap: Nyāya is not merely parataḥ for invalidity; it is parataḥ for both.
ANSWER-GRABBING FORMULATION: ✅ Nyāya defends parataḥ-prāmāṇya and parataḥ-aprāmāṇya.
```
...
```closure-flow
SUBTOPIC: 9 Naiyāyika-Buddhist debate on pramāṇa and pramāṇaphala (2025)
KEY TERMS / DEFINITIONS: The pramāṇa is the instrument or means; the resulting true cognition is its fruit.
MECHANISM / ARGUMENT: The pramāṇa is the instrument or means; the resulting true cognition is its fruit.
CONSEQUENCE / CONTRAST: The pramāṇa is the instrument or means; the resulting true cognition is its fruit.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Nyāya: pramāṇa and pramāṇa-phala / pramiti are different.
ANSWER-GRABBING FORMULATION: ✅ Nyāya: pramāṇa and pramāṇa-phala / pramiti are different.
```
...
```closure-flow
SUBTOPIC: 1 Anyathākhyāti stated precisely
KEY TERMS / DEFINITIONS: ⚠️ Error is therefore misplacement or wrong synthesis, not apprehension of a non-entity.
MECHANISM / ARGUMENT: ✅ Nyāya explains illusion through anyathākhyāti.
CONSEQUENCE / CONTRAST: ⚠️ Error is therefore misplacement or wrong synthesis, not apprehension of a non-entity.
UPSC TRAP / ANSWER-USE: ⚠️ Error is therefore misplacement or wrong synthesis, not apprehension of a non-entity.
ANSWER-GRABBING FORMULATION: ✅ Nyāya explains illusion through anyathākhyāti.
```
...
```closure-flow
SUBTOPIC: 2 Mechanism
KEY TERMS / DEFINITIONS: 2. ✅ A past impression of silver is activated.
MECHANISM / ARGUMENT: 3. ✅ Through jñānalakṣaṇa-pratyakṣa, the silver becomes present to consciousness in a derivative extraordinary perceptual way.
CONSEQUENCE / CONTRAST: 5. ✅ The erroneous cognition "this is silver" results.
UPSC TRAP / ANSWER-USE: Answer-use: 1. ✅ A present perceptual base exists — e.g. shell.
ANSWER-GRABBING FORMULATION: 1. ✅ A present perceptual base exists — e.g. shell.
```
...
```closure-flow
SUBTOPIC: 3 Presupposition
KEY TERMS / DEFINITIONS: ⚠️ Nyāya preserves realism even in illusion: cognition goes wrong, but the world is not ontologically downgraded into dream-stuff.
MECHANISM / ARGUMENT: ⚠️ Nyāya preserves realism even in illusion: cognition goes wrong, but the world is not ontologically downgraded into dream-stuff.
CONSEQUENCE / CONTRAST: ⚠️ Nyāya preserves realism even in illusion: cognition goes wrong, but the world is not ontologically downgraded into dream-stuff.
UPSC TRAP / ANSWER-USE: ⚠️ Nyāya preserves realism even in illusion: cognition goes wrong, but the world is not ontologically downgraded into dream-stuff.
ANSWER-GRABBING FORMULATION: ⚠️ Nyāya preserves realism even in illusion: cognition goes wrong, but the world is not ontologically downgraded into dream-stuff.
```
...
```closure-flow
SUBTOPIC: 5 Jñānalakṣaṇa-pratyakṣa and anyathākhyāti (2019)
KEY TERMS / DEFINITIONS: ✅ Nyāya uses jñānalakṣaṇa-pratyakṣa to explain how the silver can be experientially present without being physically present in that location.
MECHANISM / ARGUMENT: ⚠️ It bridges memory and presentative awareness while preserving realism.
CONSEQUENCE / CONTRAST: ⚠️ It bridges memory and presentative awareness while preserving realism.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Nyāya uses jñānalakṣaṇa-pratyakṣa to explain how the silver can be experientially present without being physically present in that location.
ANSWER-GRABBING FORMULATION: ✅ Nyāya uses jñānalakṣaṇa-pratyakṣa to explain how the silver can be experientially present without being physically present in that location.
```
...
```closure-flow
SUBTOPIC: 6 Naiyāyika response to anirvacanīya-khyāti (2021)
KEY TERMS / DEFINITIONS: ✅ Nyāya objects that the Advaitin's "neither real nor unreal" status is obscure and violates classical logical alternatives.
MECHANISM / ARGUMENT: ✅ For Nyāya, the error-object must be explainable using real entities and cognitive misrelation; no third ontological status is needed.
CONSEQUENCE / CONTRAST: ✅ For Nyāya, the error-object must be explainable using real entities and cognitive misrelation; no third ontological status is needed.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Nyāya objects that the Advaitin's "neither real nor unreal" status is obscure and violates classical logical alternatives.
ANSWER-GRABBING FORMULATION: ✅ Nyāya objects that the Advaitin's "neither real nor unreal" status is obscure and violates classical logical alternatives.
```
...
```closure-flow
SUBTOPIC: 1 Statement
KEY TERMS / DEFINITIONS: ✅ The self (ātman) is a real enduring substance distinct from body, senses and mind.
MECHANISM / ARGUMENT: ✅ Consciousness is not its essence but an adventitious quality arising under proper conditions.
CONSEQUENCE / CONTRAST: ✅ Consciousness is not its essence but an adventitious quality arising under proper conditions.
UPSC TRAP / ANSWER-USE: ✅ Consciousness is not its essence but an adventitious quality arising under proper conditions.
ANSWER-GRABBING FORMULATION: ✅ The self (ātman) is a real enduring substance distinct from body, senses and mind.
```
...
```closure-flow
SUBTOPIC: 2 Six Nyāya arguments for the self (2024)
KEY TERMS / DEFINITIONS: The following six-track presentation is the standard exam-ready arrangement.
MECHANISM / ARGUMENT: The following six-track presentation is the standard exam-ready arrangement.
CONSEQUENCE / CONTRAST: 1. ✅ From desire (icchā) and aversion (dveṣa)
UPSC TRAP / ANSWER-USE: Answer-use: ❓ Secondary sources sometimes present the grouping slightly differently.
ANSWER-GRABBING FORMULATION: ❓ Secondary sources sometimes present the grouping slightly differently.
```
...
```closure-flow
SUBTOPIC: 3 Manas (mind)
KEY TERMS / DEFINITIONS: ✅ Manas is an atomic internal organ.
MECHANISM / ARGUMENT: ✅ Because mind is atomic, the self attends to one sense-cognition at a time.
CONSEQUENCE / CONTRAST: ✅ Because mind is atomic, the self attends to one sense-cognition at a time.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Manas is an atomic internal organ.
ANSWER-GRABBING FORMULATION: ✅ Manas is an atomic internal organ.
```
...
```closure-flow
SUBTOPIC: 4 Distinction from Advaita
KEY TERMS / DEFINITIONS: ✅ Nyāya: consciousness is a quality of self.
MECHANISM / ARGUMENT: ✅ Advaita: consciousness is the very nature of the self.
CONSEQUENCE / CONTRAST: ⚠️ This is one of the most examinable contrasts in Indian philosophy.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Nyāya: consciousness is a quality of self.
ANSWER-GRABBING FORMULATION: ✅ Nyāya: consciousness is a quality of self.
```
...
```closure-flow
SUBTOPIC: 5 Objection
KEY TERMS / DEFINITIONS: ❓ If self without cognition can still exist, does it become an empty abstraction?
MECHANISM / ARGUMENT: ❓ If self without cognition can still exist, does it become an empty abstraction?
CONSEQUENCE / CONTRAST: ❓ If self without cognition can still exist, does it become an empty abstraction?
UPSC TRAP / ANSWER-USE: Answer-use: ❓ If self without cognition can still exist, does it become an empty abstraction?
ANSWER-GRABBING FORMULATION: ❓ If self without cognition can still exist, does it become an empty abstraction?
```
...
```closure-flow
SUBTOPIC: 6 Reply
KEY TERMS / DEFINITIONS: ✅ Nyāya accepts that the self can exist without manifest cognition, as in deep sleep or liberation, because cognition depends on conjunction with mind, senses and objects.
MECHANISM / ARGUMENT: ✅ Nyāya accepts that the self can exist without manifest cognition, as in deep sleep or liberation, because cognition depends on conjunction with mind, senses and objects.
CONSEQUENCE / CONTRAST: ✅ Nyāya accepts that the self can exist without manifest cognition, as in deep sleep or liberation, because cognition depends on conjunction with mind, senses and objects.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Nyāya accepts that the self can exist without manifest cognition, as in deep sleep or liberation, because cognition depends on conjunction with mind, senses and objects.
ANSWER-GRABBING FORMULATION: ✅ Nyāya accepts that the self can exist without manifest cognition, as in deep sleep or liberation, because cognition depends on conjunction with mind, senses and objects.
```
...
```closure-flow
SUBTOPIC: 1 Statement
KEY TERMS / DEFINITIONS: ✅ Apavarga is absolute cessation of pain: duḥkha-atyanta-nivṛtti.
MECHANISM / ARGUMENT: ✅ It is not primarily a positive bliss-state in Nyāya's standard formulation.
CONSEQUENCE / CONTRAST: ✅ It is not primarily a positive bliss-state in Nyāya's standard formulation.
UPSC TRAP / ANSWER-USE: ✅ It is not primarily a positive bliss-state in Nyāya's standard formulation.
ANSWER-GRABBING FORMULATION: ✅ Apavarga is absolute cessation of pain: duḥkha-atyanta-nivṛtti.
```
...
```closure-flow
SUBTOPIC: 2 Ladder to liberation
KEY TERMS / DEFINITIONS: ⚠️ Knowledge matters not because it reveals identity with Brahman, but because it removes error that sustains bondage-producing activity.
MECHANISM / ARGUMENT: ⚠️ Knowledge matters not because it reveals identity with Brahman, but because it removes error that sustains bondage-producing activity.
CONSEQUENCE / CONTRAST: ⚠️ Knowledge matters not because it reveals identity with Brahman, but because it removes error that sustains bondage-producing activity.
UPSC TRAP / ANSWER-USE: ⚠️ Knowledge matters not because it reveals identity with Brahman, but because it removes error that sustains bondage-producing activity.
ANSWER-GRABBING FORMULATION: tattva-jñāna → removal of mithyā-jñāna → cessation of doṣa (rāga, dveṣa, moha) → cessation of pravṛtti → cessation of janma → cessation of duḥkha → apavarga
```
...
```closure-flow
SUBTOPIC: 3 Nature of the liberated self
KEY TERMS / DEFINITIONS: ✅ In mokṣa the self remains as a pure substance without pleasure, pain, desire, aversion or even ordinary cognition.
MECHANISM / ARGUMENT: ✅ Consciousness ceases because the required conjunction of self, mind, senses and objects ceases.
CONSEQUENCE / CONTRAST: ✅ Consciousness ceases because the required conjunction of self, mind, senses and objects ceases.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ In mokṣa the self remains as a pure substance without pleasure, pain, desire, aversion or even ordinary cognition.
ANSWER-GRABBING FORMULATION: ✅ In mokṣa the self remains as a pure substance without pleasure, pain, desire, aversion or even ordinary cognition.
```
...
```closure-flow
SUBTOPIC: 4 The stone-like liberation objection
KEY TERMS / DEFINITIONS: ✅ Critics object that such liberation is "stone-like": why seek a state devoid of consciousness or bliss?
MECHANISM / ARGUMENT: ✅ Critics object that such liberation is "stone-like": why seek a state devoid of consciousness or bliss?
CONSEQUENCE / CONTRAST: ✅ Critics object that such liberation is "stone-like": why seek a state devoid of consciousness or bliss?
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Critics object that such liberation is "stone-like": why seek a state devoid of consciousness or bliss?
ANSWER-GRABBING FORMULATION: ✅ Critics object that such liberation is "stone-like": why seek a state devoid of consciousness or bliss?
```
...
```closure-flow
SUBTOPIC: 5 Nyāya reply
KEY TERMS / DEFINITIONS: ✅ The aim is freedom from suffering, not acquisition of bliss.
MECHANISM / ARGUMENT: ⚠️ Bliss may itself be relational and capable of engendering attachment; apavarga is secure because it is sheer release from all suffering-conditions.
CONSEQUENCE / CONTRAST: ⚠️ Bliss may itself be relational and capable of engendering attachment; apavarga is secure because it is sheer release from all suffering-conditions.
UPSC TRAP / ANSWER-USE: ✅ The aim is freedom from suffering, not acquisition of bliss.
ANSWER-GRABBING FORMULATION: ✅ The aim is freedom from suffering, not acquisition of bliss.
```
...
```closure-flow
SUBTOPIC: 1 Statement
KEY TERMS / DEFINITIONS: ✅ God is the nimitta-kāraṇa (efficient cause), not the material cause of the world.
MECHANISM / ARGUMENT: ✅ God is the nimitta-kāraṇa (efficient cause), not the material cause of the world.
CONSEQUENCE / CONTRAST: ✅ The material cause remains atoms.
UPSC TRAP / ANSWER-USE: ✅ God is the nimitta-kāraṇa (efficient cause), not the material cause of the world.
ANSWER-GRABBING FORMULATION: ✅ Nyāya-Vaiśeṣika affirms Īśvara as an eternal, omniscient, omnipotent being.
```
...
```closure-flow
SUBTOPIC: 2 Nature of God
KEY TERMS / DEFINITIONS: ✅ God is often characterized as a special self never bound by karma.
MECHANISM / ARGUMENT: ✅ God is often characterized as a special self never bound by karma.
CONSEQUENCE / CONTRAST: ✅ He orders atoms at creation, dispenses karmic fruits, and in later Nyāya authors the Veda.
UPSC TRAP / ANSWER-USE: ✅ God is often characterized as a special self never bound by karma.
ANSWER-GRABBING FORMULATION: ✅ God is often characterized as a special self never bound by karma.
```
...
```closure-flow
SUBTOPIC: 3 Distinction
KEY TERMS / DEFINITIONS: ⚠️ Nyāya God is not Advaita's non-dual Brahman and not Sāṃkhya's rejected superfluity.
MECHANISM / ARGUMENT: He is a real personal-intelligent governor within a pluralist realist metaphysics.
CONSEQUENCE / CONTRAST: He is a real personal-intelligent governor within a pluralist realist metaphysics.
UPSC TRAP / ANSWER-USE: ⚠️ Nyāya God is not Advaita's non-dual Brahman and not Sāṃkhya's rejected superfluity.
ANSWER-GRABBING FORMULATION: ⚠️ Nyāya God is not Advaita's non-dual Brahman and not Sāṃkhya's rejected superfluity.
```
...
```closure-flow
SUBTOPIC: 1 Udayana's project
KEY TERMS / DEFINITIONS: ❓ The exact naming and count vary somewhat across secondary presentations.
MECHANISM / ARGUMENT: ❓ The exact naming and count vary somewhat across secondary presentations.
CONSEQUENCE / CONTRAST: UPSC usually expects the major four and may reward mention of the extended list.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Udayana, especially in Nyāyakusumāñjali, develops systematic arguments for God.
ANSWER-GRABBING FORMULATION: ✅ Udayana, especially in Nyāyakusumāñjali, develops systematic arguments for God.
```
...
```closure-flow
SUBTOPIC: (a) Kāryāt — from effect
KEY TERMS / DEFINITIONS: ✅ The world is an effect because it is composite and made of parts.
MECHANISM / ARGUMENT: ✅ The world is an effect because it is composite and made of parts.
CONSEQUENCE / CONTRAST: ✅ The world is an effect because it is composite and made of parts.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ The world is an effect because it is composite and made of parts.
ANSWER-GRABBING FORMULATION: ✅ The world is an effect because it is composite and made of parts.
```
...
```closure-flow
SUBTOPIC: (b) Āyojanāt — from combination/arrangement
KEY TERMS / DEFINITIONS: ✅ Therefore an intelligent arranger is required: God.
MECHANISM / ARGUMENT: ✅ Therefore an intelligent arranger is required: God.
CONSEQUENCE / CONTRAST: ✅ Therefore an intelligent arranger is required: God.
UPSC TRAP / ANSWER-USE: ✅ Unintelligent atoms cannot purposively initiate ordered combination.
ANSWER-GRABBING FORMULATION: ✅ At the beginning of creation, atoms must first combine.
```
...
```closure-flow
SUBTOPIC: (c) Dhṛtyādeḥ — from support/sustenance
KEY TERMS / DEFINITIONS: ✅ The order, maintenance and dissolution of the cosmos suggest sustaining intelligence.
MECHANISM / ARGUMENT: ⚠️ This moves from bare origination to continuing governance.
CONSEQUENCE / CONTRAST: ⚠️ This moves from bare origination to continuing governance.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ The order, maintenance and dissolution of the cosmos suggest sustaining intelligence.
ANSWER-GRABBING FORMULATION: ✅ The order, maintenance and dissolution of the cosmos suggest sustaining intelligence.
```
...
```closure-flow
SUBTOPIC: (d) Śruteḥ — from scripture
KEY TERMS / DEFINITIONS: ✅ The Veda is authoritative knowledge.
MECHANISM / ARGUMENT: ✅ Such authoritative revelation implies an omniscient source.
CONSEQUENCE / CONTRAST: ✅ Such authoritative revelation implies an omniscient source.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ The Veda is authoritative knowledge.
ANSWER-GRABBING FORMULATION: ✅ The Veda is authoritative knowledge.
```
...
```closure-flow
SUBTOPIC: 3 Additional arguments often cited
KEY TERMS / DEFINITIONS: 5. ✅ Padāt — from words / linguistic convention
MECHANISM / ARGUMENT: 6. ✅ Pratyayataḥ — from cognition/authoritative knowledge structure
CONSEQUENCE / CONTRAST: 7. ✅ Vākyāt — from meaningful sentences, especially Vedic sentences
UPSC TRAP / ANSWER-USE: Answer-use: 5. ✅ Padāt — from words / linguistic convention
ANSWER-GRABBING FORMULATION: 5. ✅ Padāt — from words / linguistic convention
```
...
```closure-flow
SUBTOPIC: 4 Presuppositions
KEY TERMS / DEFINITIONS: ⚠️ These proofs presuppose that order, meaningfulness and purposiveness require intelligence rather than being emergent or brute.
MECHANISM / ARGUMENT: ⚠️ These proofs presuppose that order, meaningfulness and purposiveness require intelligence rather than being emergent or brute.
CONSEQUENCE / CONTRAST: ⚠️ These proofs presuppose that order, meaningfulness and purposiveness require intelligence rather than being emergent or brute.
UPSC TRAP / ANSWER-USE: ⚠️ These proofs presuppose that order, meaningfulness and purposiveness require intelligence rather than being emergent or brute.
ANSWER-GRABBING FORMULATION: ⚠️ These proofs presuppose that order, meaningfulness and purposiveness require intelligence rather than being emergent or brute.
```
...
```closure-flow
SUBTOPIC: Objection 1: Sāṃkhya
KEY TERMS / DEFINITIONS: ✅ Prakṛti can explain the world; God is unnecessary.
MECHANISM / ARGUMENT: ✅ Nyāya reply: unconscious prakṛti or atoms cannot account for purposive order and karmic allocation unaided.
CONSEQUENCE / CONTRAST: ✅ Nyāya reply: unconscious prakṛti or atoms cannot account for purposive order and karmic allocation unaided.
UPSC TRAP / ANSWER-USE: ✅ Nyāya reply: unconscious prakṛti or atoms cannot account for purposive order and karmic allocation unaided.
ANSWER-GRABBING FORMULATION: ✅ Prakṛti can explain the world; God is unnecessary.
```
...
```closure-flow
SUBTOPIC: Objection 2: Mīmāṃsā
KEY TERMS / DEFINITIONS: ✅ The Veda is authorless; scriptural authority does not imply God.
MECHANISM / ARGUMENT: ✅ Nyāya reply: intelligible authoritative sentences point better to omniscient authorship.
CONSEQUENCE / CONTRAST: ✅ Nyāya reply: intelligible authoritative sentences point better to omniscient authorship.
UPSC TRAP / ANSWER-USE: ✅ The Veda is authorless; scriptural authority does not imply God.
ANSWER-GRABBING FORMULATION: ✅ The Veda is authorless; scriptural authority does not imply God.
```
...
```closure-flow
SUBTOPIC: Objection 3: Problem of evil
KEY TERMS / DEFINITIONS: ✅ If God is omnipotent and benevolent, why suffering?
MECHANISM / ARGUMENT: ✅ Nyāya reply: karmic order distributes fruits; God is dispenser, not arbitrary tyrant.
CONSEQUENCE / CONTRAST: ✅ Nyāya reply: karmic order distributes fruits; God is dispenser, not arbitrary tyrant.
UPSC TRAP / ANSWER-USE: ✅ Nyāya reply: karmic order distributes fruits; God is dispenser, not arbitrary tyrant.
ANSWER-GRABBING FORMULATION: ✅ If God is omnipotent and benevolent, why suffering?
```
...
```closure-flow
SUBTOPIC: 6 Udayana's cumulative structure: not one isolated proof
KEY TERMS / DEFINITIONS: Udayana's Nyāyakusumāñjali is best read as a reply to successive objections, not as one solitary proof mechanically added to Nyāya metaphysics.
MECHANISM / ARGUMENT: The work removes obstacles to theism step by step: that there is no unseen cause, that an unseen cause needs no intelligent controller, that Vedic authority can stand without an author, and that karma or atoms can function without governance.
CONSEQUENCE / CONTRAST: A strong answer presents Udayana's proofs as a converging or cumulative-case argument: each strand alone can be challenged, but together they are said to converge on one explanatory hypothesis.
UPSC TRAP / ANSWER-USE: Udayana's Nyāyakusumāñjali is best read as a reply to successive objections, not as one solitary proof mechanically added to Nyāya metaphysics.
ANSWER-GRABBING FORMULATION: Udayana's Nyāyakusumāñjali is best read as a reply to successive objections, not as one solitary proof mechanically added to Nyāya metaphysics.
```
...
```closure-flow
SUBTOPIC: The explanatory hypothesis
KEY TERMS / DEFINITIONS: ✅ Thesis. Īśvara is an omniscient, eternal, bodiless agent who is the efficient (nimitta) but not material cause of the world.
MECHANISM / ARGUMENT: ✅ Cosmic role. Īśvara conjoins atoms at the beginning of a creative cycle through volition operating with the adṛṣṭa of souls.
CONSEQUENCE / CONTRAST: ✅ Moral role. Īśvara dispenses karmic fruits because unconscious adṛṣṭa cannot intelligently allot results by itself.
UPSC TRAP / ANSWER-USE: ✅ Thesis. Īśvara is an omniscient, eternal, bodiless agent who is the efficient (nimitta) but not material cause of the world.
ANSWER-GRABBING FORMULATION: ✅ Thesis. Īśvara is an omniscient, eternal, bodiless agent who is the efficient (nimitta) but not material cause of the world.
```
...
```closure-flow
SUBTOPIC: Inferential forms of the main proofs
KEY TERMS / DEFINITIONS: The proofs are commonly enumerated in different lists; where the exact traditional label is uncertain, write "commonly enumerated as" rather than inventing a fixed count.
MECHANISM / ARGUMENT: The proofs are commonly enumerated in different lists; where the exact traditional label is uncertain, write "commonly enumerated as" rather than inventing a fixed count.
CONSEQUENCE / CONTRAST: The proofs are commonly enumerated in different lists; where the exact traditional label is uncertain, write "commonly enumerated as" rather than inventing a fixed count.
UPSC TRAP / ANSWER-USE: The proofs are commonly enumerated in different lists; where the exact traditional label is uncertain, write "commonly enumerated as" rather than inventing a fixed count.
ANSWER-GRABBING FORMULATION: The proofs are commonly enumerated in different lists; where the exact traditional label is uncertain, write "commonly enumerated as" rather than inventing a fixed count.
```
...
```closure-flow
SUBTOPIC: Statement
KEY TERMS / DEFINITIONS: ✅ The effect does not pre-exist in its cause; it is a genuinely new beginning.
MECHANISM / ARGUMENT: ✅ The effect does not pre-exist in its cause; it is a genuinely new beginning.
CONSEQUENCE / CONTRAST: ✅ The effect does not pre-exist in its cause; it is a genuinely new beginning.
UPSC TRAP / ANSWER-USE: ✅ The effect does not pre-exist in its cause; it is a genuinely new beginning.
ANSWER-GRABBING FORMULATION: ✅ Nyāya-Vaiśeṣika defends asatkāryavāda, also called ārambhavāda.
```
...
```closure-flow
SUBTOPIC: Argument
KEY TERMS / DEFINITIONS: 1. ✅ Before production, the effect is absent.
MECHANISM / ARGUMENT: 3. ✅ Production therefore brings forth a new entity.
CONSEQUENCE / CONTRAST: 1. ✅ Before production, the effect is absent.
UPSC TRAP / ANSWER-USE: 4. ✅ Cloth is not simply threads under another description; it is a new whole produced from them.
ANSWER-GRABBING FORMULATION: 1. ✅ Before production, the effect is absent.
```
...
```closure-flow
SUBTOPIC: Presupposition
KEY TERMS / DEFINITIONS: ⚠️ The argument assumes that causal production should explain novelty, not merely manifestation.
MECHANISM / ARGUMENT: ⚠️ The argument assumes that causal production should explain novelty, not merely manifestation.
CONSEQUENCE / CONTRAST: ⚠️ The argument assumes that causal production should explain novelty, not merely manifestation.
UPSC TRAP / ANSWER-USE: ⚠️ The argument assumes that causal production should explain novelty, not merely manifestation.
ANSWER-GRABBING FORMULATION: ⚠️ The argument assumes that causal production should explain novelty, not merely manifestation.
```
...
```closure-flow
SUBTOPIC: Distinction
KEY TERMS / DEFINITIONS: ✅ Contrast Sāṃkhya's satkāryavāda, where the effect pre-exists in the cause in latent form.
MECHANISM / ARGUMENT: ✅ Contrast Sāṃkhya's satkāryavāda, where the effect pre-exists in the cause in latent form.
CONSEQUENCE / CONTRAST: ✅ Contrast Sāṃkhya's satkāryavāda, where the effect pre-exists in the cause in latent form.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Contrast Sāṃkhya's satkāryavāda, where the effect pre-exists in the cause in latent form.
ANSWER-GRABBING FORMULATION: ✅ Contrast Sāṃkhya's satkāryavāda, where the effect pre-exists in the cause in latent form.
```
...
```closure-flow
SUBTOPIC: 2 Three kinds of cause
KEY TERMS / DEFINITIONS: 1. ✅ Samavāyi-kāraṇa — inherent/material cause
MECHANISM / ARGUMENT: 2. ✅ Asamavāyi-kāraṇa — non-inherent cause
CONSEQUENCE / CONTRAST: e.g. qualities or conjunctions in the material cause that help produce the effect.
UPSC TRAP / ANSWER-USE: Answer-use: 1. ✅ Samavāyi-kāraṇa — inherent/material cause
ANSWER-GRABBING FORMULATION: 1. ✅ Samavāyi-kāraṇa — inherent/material cause
```
...
```closure-flow
SUBTOPIC: 3 Seed and tree (2021)
KEY TERMS / DEFINITIONS: ✅ The tree is a new effect produced from the seed under appropriate conditions.
MECHANISM / ARGUMENT: ✅ The tree is a new effect produced from the seed under appropriate conditions.
CONSEQUENCE / CONTRAST: ✅ The tree is a new effect produced from the seed under appropriate conditions.
UPSC TRAP / ANSWER-USE: ⚠️ So the seed is causal ground, not a concealed miniature tree in metaphysical latency.
ANSWER-GRABBING FORMULATION: ✅ Asked whether the seed contains the tree, Nyāya says no in the satkāryavāda sense.
```
...
```closure-flow
SUBTOPIC: 4 Prāgabhāva against Sāṃkhya (2023)
KEY TERMS / DEFINITIONS: ✅ This prior absence shows the effect is genuinely absent before production.
MECHANISM / ARGUMENT: ⚠️ Therefore prāgabhāva becomes a sharp weapon against satkāryavāda.
CONSEQUENCE / CONTRAST: ✅ Before the effect arises, it has prāgabhāva — prior non-existence.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Before the effect arises, it has prāgabhāva — prior non-existence.
ANSWER-GRABBING FORMULATION: ✅ Before the effect arises, it has prāgabhāva — prior non-existence.
```
...
```closure-flow
SUBTOPIC: 1 Paramāṇu
KEY TERMS / DEFINITIONS: ✅ The basic physical unit is the paramāṇu — atom.
MECHANISM / ARGUMENT: ✅ It is eternal, partless, indivisible, imperceptible, and often described as minute/spherical (parimāṇḍalya).
CONSEQUENCE / CONTRAST: ✅ It is eternal, partless, indivisible, imperceptible, and often described as minute/spherical (parimāṇḍalya).
UPSC TRAP / ANSWER-USE: Answer-use: ✅ The basic physical unit is the paramāṇu — atom.
ANSWER-GRABBING FORMULATION: ✅ The basic physical unit is the paramāṇu — atom.
```
...
```closure-flow
SUBTOPIC: Argument
KEY TERMS / DEFINITIONS: 1. ✅ If every part had further parts without end, no ultimate physical unit would remain.
MECHANISM / ARGUMENT: 3. ✅ Therefore atoms must be indivisible.
CONSEQUENCE / CONTRAST: 3. ✅ Therefore atoms must be indivisible.
UPSC TRAP / ANSWER-USE: Answer-use: 1. ✅ If every part had further parts without end, no ultimate physical unit would remain.
ANSWER-GRABBING FORMULATION: 1. ✅ If every part had further parts without end, no ultimate physical unit would remain.
```
...
```closure-flow
SUBTOPIC: 3 Combination sequence
KEY TERMS / DEFINITIONS: ✅ Atoms combine into dvyaṇuka (dyads).
MECHANISM / ARGUMENT: ✅ Dyads combine into larger units such as tryaṇuka / trasareṇu, marking the threshold toward perceptibility in standard textbook exposition.
CONSEQUENCE / CONTRAST: ✅ Gross objects arise from increasingly complex combinations.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Atoms combine into dvyaṇuka (dyads).
ANSWER-GRABBING FORMULATION: ✅ Atoms combine into dvyaṇuka (dyads).
```
...
```closure-flow
SUBTOPIC: 4 Initiation of motion
KEY TERMS / DEFINITIONS: ✅ At dissolution, atoms remain but compounds break apart.
MECHANISM / ARGUMENT: ✅ At creation, first motion must begin again.
CONSEQUENCE / CONTRAST: ✅ Nyāya-Vaiśeṣika often invokes adṛṣṭa (unseen moral force) and the will of God as the initiator of this first motion.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ At dissolution, atoms remain but compounds break apart.
ANSWER-GRABBING FORMULATION: ✅ At dissolution, atoms remain but compounds break apart.
```
...
```closure-flow
SUBTOPIC: 5 Cycles of creation and dissolution
KEY TERMS / DEFINITIONS: ✅ Creation (sṛṣṭi) and dissolution (pralaya) occur cyclically.
MECHANISM / ARGUMENT: ✅ God wills; atoms combine; the world appears.
CONSEQUENCE / CONTRAST: ✅ God wills or cosmic conditions reverse; compounds disintegrate; dissolution occurs.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Creation (sṛṣṭi) and dissolution (pralaya) occur cyclically.
ANSWER-GRABBING FORMULATION: ✅ Creation (sṛṣṭi) and dissolution (pralaya) occur cyclically.
```
...
```closure-flow
SUBTOPIC: 1 Words signify universals or particulars? (2023)
KEY TERMS / DEFINITIONS: ✅ Nyāya generally leans toward words signifying objects through universals and qualificative structures, not bare particulars alone.
MECHANISM / ARGUMENT: ✅ Nyāya generally leans toward words signifying objects through universals and qualificative structures, not bare particulars alone.
CONSEQUENCE / CONTRAST: ⚠️ In UPSC, answer by showing Nyāya's realist semantics: universals are objective and hence linguistically significant.
UPSC TRAP / ANSWER-USE: ✅ Nyāya generally leans toward words signifying objects through universals and qualificative structures, not bare particulars alone.
ANSWER-GRABBING FORMULATION: ✅ Nyāya generally leans toward words signifying objects through universals and qualificative structures, not bare particulars alone.
```
...
```closure-flow
SUBTOPIC: 2 Naiyāyika response to Cārvāka objections against anumāna (2022)
KEY TERMS / DEFINITIONS: ⚠️ The Nyāya point is not infallibilism but disciplined justificatory practice.
MECHANISM / ARGUMENT: ✅ Cārvāka attacks inference by doubting universal relation.
CONSEQUENCE / CONTRAST: ⚠️ The Nyāya point is not infallibilism but disciplined justificatory practice.
UPSC TRAP / ANSWER-USE: ⚠️ The Nyāya point is not infallibilism but disciplined justificatory practice.
ANSWER-GRABBING FORMULATION: ✅ Cārvāka attacks inference by doubting universal relation.
```
...
```closure-flow
SUBTOPIC: 1 Against universals
KEY TERMS / DEFINITIONS: ✅ Nyāya-Vaiśeṣika reply: exclusion presupposes stable classes; real commonness is required.
MECHANISM / ARGUMENT: ✅ Nyāya-Vaiśeṣika reply: exclusion presupposes stable classes; real commonness is required.
CONSEQUENCE / CONTRAST: ✅ Nyāya-Vaiśeṣika reply: exclusion presupposes stable classes; real commonness is required.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Buddhist objection: universals are unnecessary; exclusion explains classification.
ANSWER-GRABBING FORMULATION: ✅ Buddhist objection: universals are unnecessary; exclusion explains classification.
```
...
```closure-flow
SUBTOPIC: 2 Against samavāya
KEY TERMS / DEFINITIONS: ✅ Objection: inherence multiplies entities unnecessarily.
MECHANISM / ARGUMENT: ✅ Reply: without a distinct inseparable relation, whole-part and quality-substance relations remain unexplained.
CONSEQUENCE / CONTRAST: ✅ Reply: without a distinct inseparable relation, whole-part and quality-substance relations remain unexplained.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Objection: inherence multiplies entities unnecessarily.
ANSWER-GRABBING FORMULATION: ✅ Objection: inherence multiplies entities unnecessarily.
```
...
```closure-flow
SUBTOPIC: 3 Against stone-like mokṣa
KEY TERMS / DEFINITIONS: ✅ Objection: desire for unconscious liberation is incoherent.
MECHANISM / ARGUMENT: ✅ Reply: complete removal of pain is a sufficient rational goal.
CONSEQUENCE / CONTRAST: ✅ Reply: complete removal of pain is a sufficient rational goal.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Objection: desire for unconscious liberation is incoherent.
ANSWER-GRABBING FORMULATION: ✅ Objection: desire for unconscious liberation is incoherent.
```
...
```closure-flow
SUBTOPIC: 4 Against God proofs
KEY TERMS / DEFINITIONS: ✅ Objection: order can be explained without God.
MECHANISM / ARGUMENT: ✅ Reply: Nyāya insists purposive order, moral dispensation and linguistic normativity are not adequately explained by blind atoms alone.
CONSEQUENCE / CONTRAST: ✅ Reply: Nyāya insists purposive order, moral dispensation and linguistic normativity are not adequately explained by blind atoms alone.
UPSC TRAP / ANSWER-USE: ✅ Reply: Nyāya insists purposive order, moral dispensation and linguistic normativity are not adequately explained by blind atoms alone.
ANSWER-GRABBING FORMULATION: ✅ Objection: order can be explained without God.
```
...
KEY TERMS / DEFINITIONS: ⚠️ Trap 1: saying Nyāya is parataḥ-prāmāṇya only for invalidity.
MECHANISM / ARGUMENT: Nyāya allows their perception through sāmānyalakṣaṇa-pratyakṣa.
CONSEQUENCE / CONTRAST: It denies pre-existent effect, not causal production.
UPSC TRAP / ANSWER-USE: ⚠️ Trap 1: saying Nyāya is parataḥ-prāmāṇya only for invalidity.
ANSWER-GRABBING FORMULATION: ⚠️ Trap 1: saying Nyāya is parataḥ-prāmāṇya only for invalidity.
```
...
KEY TERMS / DEFINITIONS: ✅ Pratyakṣa: perceptual cognition from sense-object contact.
MECHANISM / ARGUMENT: ✅ Dravya: substance, locus of guṇa and karma.
CONSEQUENCE / CONTRAST: ✅ Asatkāryavāda / ārambhavāda: effect is a new beginning.
UPSC TRAP / ANSWER-USE: Answer-use: ✅ Padārtha: knowable/nameable category.
ANSWER-GRABBING FORMULATION: ✅ Padārtha: knowable/nameable category.
```
...
KEY TERMS / DEFINITIONS: ⚠️ "Nyāya realism extends even to error: illusion is not contact with nothing, but misrelation among reals."
MECHANISM / ARGUMENT: ⚠️ "Vaiśeṣika multiplies categories only where explanatory need demands them."
CONSEQUENCE / CONTRAST: ⚠️ "Nyāya self is enduring, but consciousness in it is episodic and conditioned."
UPSC TRAP / ANSWER-USE: ⚠️ "Nyāya realism extends even to error: illusion is not contact with nothing, but misrelation among reals."
ANSWER-GRABBING FORMULATION: ⚠️ "Nyāya realism extends even to error: illusion is not contact with nothing, but misrelation among reals."
```
...
```closure-flow
SUBTOPIC: Brown table and book on table: samavāya versus saṃyoga
KEY TERMS / DEFINITIONS: ❌ Spatial closeness is not the criterion of inherence; ontological inseparability and the relata's category relation are decisive.
MECHANISM / ARGUMENT: ✅ Brown colour inheres in the table through samavāya, an inseparable relation of quality and substance; the book stands on the table through saṃyoga, a contingent conjunction whose relata can exist separately.
CONSEQUENCE / CONTRAST: ❌ Spatial closeness is not the criterion of inherence; ontological inseparability and the relata's category relation are decisive.
UPSC TRAP / ANSWER-USE: ❌ Spatial closeness is not the criterion of inherence; ontological inseparability and the relata's category relation are decisive.
ANSWER-GRABBING FORMULATION: ✅ Brown colour inheres in the table through samavāya, an inseparable relation of quality and substance; the book stands on the table through saṃyoga, a contingent conjunction whose relata can exist separately.
```
...
```closure-flow
SUBTOPIC: Anyathāsiddha and ananyathāsiddha
KEY TERMS / DEFINITIONS: ✅ A causal condition is ananyathāsiddha when its relevance to the effect is not established otherwise; an anyathāsiddha condition is accidental, remote or already explained through another causal factor and is excluded from the definition of cause.
MECHANISM / ARGUMENT: ✅ A causal condition is ananyathāsiddha when its relevance to the effect is not established otherwise; an anyathāsiddha condition is accidental, remote or already explained through another causal factor and is excluded from the definition of cause.
CONSEQUENCE / CONTRAST: ✅ A causal condition is ananyathāsiddha when its relevance to the effect is not established otherwise; an anyathāsiddha condition is accidental, remote or already explained through another causal factor and is excluded from the definition of cause.
UPSC TRAP / ANSWER-USE: ✅ A causal condition is ananyathāsiddha when its relevance to the effect is not established otherwise; an anyathāsiddha condition is accidental, remote or already explained through another causal factor and is excluded from the definition of cause.
ANSWER-GRABBING FORMULATION: ✅ A causal condition is ananyathāsiddha when its relevance to the effect is not established otherwise; an anyathāsiddha condition is accidental, remote or already explained through another causal factor and is excluded from the definition of cause.
```
...
```closure-flow
SUBTOPIC: Viśeṣa and comparative theism
KEY TERMS / DEFINITIONS: Classical Yoga's Īśvara is a special puruṣa and an object/support of practice; it is not established by exactly the same creator inference.
MECHANISM / ARGUMENT: Classical Yoga's Īśvara is a special puruṣa and an object/support of practice; it is not established by exactly the same creator inference.
CONSEQUENCE / CONTRAST: ✅ Nyāya infers an intelligent maker/orderer from effects, atomic conjunction and governance.
UPSC TRAP / ANSWER-USE: Classical Yoga's Īśvara is a special puruṣa and an object/support of practice; it is not established by exactly the same creator inference.
ANSWER-GRABBING FORMULATION: ✅ Viśeṣa individuates eternal atoms and selves of the same class; without it numerical plurality would collapse.
```
...
KEY TERMS / DEFINITIONS: ⚠️ Priority: Primary ownership rises to 22 of 112 parts, the largest Indian owner.
MECHANISM / ARGUMENT: ✅ Required doctrinal depth: The restored papers add samavāya versus saṃyoga through table examples, Buddhist/Nyāya absence-cognition, Nyāya versus Yoga proofs of God, anyathāsiddha/ananyathāsiddha and the logical/metaphysical role of viśeṣa.
CONSEQUENCE / CONTRAST: ❌ Trap / answer consequence: Do not treat every relation as inherence, every absence as a separate pramāṇa in Nyāya, or Yoga’s Īśvara as established by the full Nyāya creator inference.
UPSC TRAP / ANSWER-USE: ❌ Trap / answer consequence: Do not treat every relation as inherence, every absence as a separate pramāṇa in Nyāya, or Yoga’s Īśvara as established by the full Nyāya creator inference.
ANSWER-GRABBING FORMULATION: ⚠️ Priority: Primary ownership rises to 22 of 112 parts, the largest Indian owner.
```
...
KEY TERMS / DEFINITIONS: Nyāya is primarily epistemology, logic and debate, organized around sixteen topics of inquiry and proof; Vaiśeṣika is primarily ontology, organized around padārthas of being.
MECHANISM / ARGUMENT: Nyāya is primarily epistemology, logic and debate, organized around sixteen topics of inquiry and proof; Vaiśeṣika is primarily ontology, organized around padārthas of being.
CONSEQUENCE / CONTRAST: Their later fusion is not identity from the start but a division of labour: Nyāya supplies pramāṇa and dialectic, Vaiśeṣika supplies categories, atomism and viśeṣa-samavāya ontology, and Navya-Nyāya refines both into a highly technical analytic idiom.
UPSC TRAP / ANSWER-USE: Their later fusion is not identity from the start but a division of labour: Nyāya supplies pramāṇa and dialectic, Vaiśeṣika supplies categories, atomism and viśeṣa-samavāya ontology, and Navya-Nyāya refines both into a highly technical analytic idiom.
ANSWER-GRABBING FORMULATION: ✅ Nyāya vs Vaiśeṣika division of labour.
```
...
KEY TERMS / DEFINITIONS: Western parallels are illustrative only, never a substitute for the Indian argument; use at most one or two lines after the Nyāya case is complete.
MECHANISM / ARGUMENT: Western parallels are illustrative only, never a substitute for the Indian argument; use at most one or two lines after the Nyāya case is complete.
CONSEQUENCE / CONTRAST: Western parallels are illustrative only, never a substitute for the Indian argument; use at most one or two lines after the Nyāya case is complete.
UPSC TRAP / ANSWER-USE: Western parallels are illustrative only, never a substitute for the Indian argument; use at most one or two lines after the Nyāya case is complete.
ANSWER-GRABBING FORMULATION: Western parallels are illustrative only, never a substitute for the Indian argument; use at most one or two lines after the Nyāya case is complete.
```
...
```closure-flow
SUBTOPIC: Strong points
KEY TERMS / DEFINITIONS: Its account of vyāpti-grahaṇa is a serious realist reply to Cārvāka-style and induction-style scepticism.
MECHANISM / ARGUMENT: Its account of vyāpti-grahaṇa is a serious realist reply to Cārvāka-style and induction-style scepticism.
CONSEQUENCE / CONTRAST: Vaiśeṣika does not merely multiply entities; checks such as jāti-bādhaka show an internal economy of universals.
UPSC TRAP / ANSWER-USE: Vaiśeṣika does not merely multiply entities; checks such as jāti-bādhaka show an internal economy of universals.
ANSWER-GRABBING FORMULATION: Nyāya offers the most developed Indian account of inference, debate, hetu-testing and fallacy-analysis.
```
...
```closure-flow
SUBTOPIC: Weak points
KEY TERMS / DEFINITIONS: Both function as stipulated termini against regress, so critics can call them explanatory placeholders.
MECHANISM / ARGUMENT: Apavarga as absence of pleasure, pain and ordinary cognition invites the stone-like liberation objection.
CONSEQUENCE / CONTRAST: Making God dispense fruits according to beginningless karma protects justice but limits divine independence.
UPSC TRAP / ANSWER-USE: Answer-use: Both function as stipulated termini against regress, so critics can call them explanatory placeholders.
ANSWER-GRABBING FORMULATION: Both function as stipulated termini against regress, so critics can call them explanatory placeholders.
```
...
```closure-flow
SUBTOPIC: Genuinely contested points
KEY TERMS / DEFINITIONS: It is contested whether universal-mediated perception is genuine perception or an ad hoc device for induction.
MECHANISM / ARGUMENT: Nyāya and Vaiśeṣika are historically distinct but later fused; UPSC answers must preserve both facts.
CONSEQUENCE / CONTRAST: It is contested whether an embodied artisan analogy can bear the weight of proving a bodiless cosmic maker.
UPSC TRAP / ANSWER-USE: Answer-use: It is contested whether universal-mediated perception is genuine perception or an ad hoc device for induction.
ANSWER-GRABBING FORMULATION: It is contested whether universal-mediated perception is genuine perception or an ad hoc device for induction.
```
...
```closure-flow
SUBTOPIC: Ready verdict lines
KEY TERMS / DEFINITIONS: "Nyāya-Vaiśeṣika is strongest as a realist logic-ontology, but its primitive relations and particularizers remain vulnerable."
MECHANISM / ARGUMENT: "Its achievement is systematic: pramāṇa secures knowledge, padārtha secures being and Īśvara secures order; its weakness is that samavāya, viśeṣa and unconscious mokṣa are asserted as much as proved."
CONSEQUENCE / CONTRAST: "A fair verdict is graded: Nyāya-Vaiśeṣika gives Indian philosophy its most rigorous realism, inference-theory and natural theology, yet the very devices that make the system complete—samavāya, viśeṣa, sāmānyalakṣaṇa and karma-bound Īśvara—are also its deepest contested points."
UPSC TRAP / ANSWER-USE: Answer-use: "Nyāya-Vaiśeṣika is strongest as a realist logic-ontology, but its primitive relations and particularizers remain vulnerable."
ANSWER-GRABBING FORMULATION: "Nyāya-Vaiśeṣika is strongest as a realist logic-ontology, but its primitive relations and particularizers remain vulnerable."
```
...
```closure-flow
SUBTOPIC: CURRENT LINKAGE STATUS
KEY TERMS / DEFINITIONS: Ongoing Indian Knowledge Systems activity remains a broad educational context, not evidence for any doctrine.
MECHANISM / ARGUMENT: This package therefore uses no decorative current-affairs claim.
CONSEQUENCE / CONTRAST: ✅ Search result, 16 August 2026: No fresh official India-wide development specifically concerning Nyaya, Vaisesika, or classical Indian logic was verifiable for February-August 2026.
UPSC TRAP / ANSWER-USE: Ongoing Indian Knowledge Systems activity remains a broad educational context, not evidence for any doctrine.
ANSWER-GRABBING FORMULATION: ✅ Search result, 16 August 2026: No fresh official India-wide development specifically concerning Nyaya, Vaisesika, or classical Indian logic was verifiable for February-August 2026.
```
...
A. Nyāya initially foregrounded pramāṇa and debate, Vaiśeṣika categories and ontology; later they formed an integrated realist system
...
D. The two schools remained doctrinally unrelated

**Answer: A. Nyāya initially foregrounded pramāṇa and debate, Vaiśeṣika categories and ontology; later they formed an integrated realist system**
...
B. Moral merit and demerit alone
C. The universal relation between cause and effect
D. The unseen allocator of karmic fruit
...
A. Because every word must denote one eternal sound
B. Because recurrent classification and common predication require an objective one-in-many ground
C. Because universals are spatial wholes divided among instances
D. Because only universals possess causal motion
...
B. samavāya and saṃyoga
C. two instances of samavāya
D. two instances of saṃyoga
...
A. Prior, mutual, conjunctional and inherential absence
B. Prior, posterior, absolute and mutual absence
C. Temporary, permanent, perceptual and inferential absence
D. Antecedent, efficient, material and non-inherent absence
...
B. Perception, inference, testimony and postulation
C. Perception, inference, memory and doubt
...
B. Avyapadeśya excludes inference; avyabhicāri excludes testimony; vyavasāyātmaka excludes memory
C. All three terms merely repeat sense–object contact
D. Vyavasāyātmaka means that every valid perception is indeterminate
...
A. Ordinary perception is always verbal; extraordinary perception is always inferential
...
C. Ordinary perception reaches universals only; extraordinary perception reaches particulars only
...
A. how a word acquires meaning by resemblance
B. how yogic discipline reveals remote objects
...
A. the non-existent shell
B. a direct proof that the world is unreal
...
B. ordinary internal perception of pleasure by manas
C. inference from disciplined breathing
...
A. Hetu, pratijñā, upanaya, udāharaṇa, nigamana
B. Pratijñā, hetu, udāharaṇa, upanaya, nigamana
C. Pratijñā, udāharaṇa, hetu, nigamana, upanaya
D. Udāharaṇa, vyāpti, pakṣa, hetu, conclusion

**Answer: B. Pratijñā, hetu, udāharaṇa, upanaya, nigamana**
...
A. Any example supporting a universal
B. The subject in which the hetu occurs
C. A condition pervading the sādhya but not the hetu, making an apparent concomitance conditional
D. A counter-reason proving the opposite conclusion

**Answer: C. A condition pervading the sādhya but not the hetu, making an apparent concomitance conditional**
...
A. All perceptions are verbal
B. Finite observations cannot establish exceptionless vyāpti, and unknown upādhis may remain
C. Every inference has exactly five members
D. Inference is valid only in scripture

**Answer: B. Finite observations cannot establish exceptionless vyāpti, and unknown upādhis may remain**
...
A. any grammatically complete utterance
B. memory of an old sentence
C. only an authorless Vedic sentence
...
B. apprehension of a wholly non-existent object
C. non-apprehension of two valid cognitions only
D. appearance of an entity neither real nor unreal
...
A. Atoms require dyadic combination
...
D. The Veda must have an omniscient author
...
D. isolation of puruṣa from prakṛti through citta-nirodha
...
A. God transforms divine substance into the world
B. God is identical with all selves
C. God is unnecessary once atoms are admitted
...
C. yogic absorption to puruṣa-viśeṣa
...
C. why words exclude non-referents
D. why liberated selves retain cognition
...
C. Padāt—prior absence; pratyayataḥ—mutual absence
D. Padāt—yogic perception; pratyayataḥ—comparison
...
B. Yoga chiefly presents a special puruṣa, untouched by kleśa and karma, serving as teacher and meditative aid
C. Yoga denies Īśvara altogether
D. Yoga proves God solely from atom-combination

**Answer: B. Yoga chiefly presents a special puruṣa, untouched by kleśa and karma, serving as teacher and meditative aid**
...
B. the effect eternally exists in the cause but is concealed
C. the effect as effect is newly produced rather than already actual in the cause
D. production is only an illusion of language
...
B. The tree is absolutely impossible before it appears
C. The tree and seed are numerically identical
D. The tree arises without material conditions
...
A. Nyāya denies results while Buddhism denies instruments
B. both identify pramāṇa with an eternal self
...
D. both regard memory as the only pramāṇa
...
B. Give only objections because “critical” means rejection
C. Compare with Western philosophy before explaining the Indian doctrine
...
B. Because every conjunction is eternal
C. Because qualities exist independently of all substances
D. Because samavāya relates only two atoms in contact
...
C. Both are atyantābhāva
D. Both are anyonyābhāva
...
A. It is distinct from body, senses and manas
B. It is the locus of cognition, desire, pleasure and pain
C. Consciousness is its eternally manifest essence
D. It persists in liberation even when ordinary cognition ceases
...
A. God administers karmic fruits
B. God is the intelligent efficient cause
...
A. Bādhita violates pakṣadharmatā; asiddha violates abādhitatva
...
D. Viruddha is simply absence of testimony
...
A. Threads are nimitta; weaving is samavāyi; colour is the fourth independent cause
...
B. answer a nearby doctrine that has more notes
C. treat every directive as “describe”
