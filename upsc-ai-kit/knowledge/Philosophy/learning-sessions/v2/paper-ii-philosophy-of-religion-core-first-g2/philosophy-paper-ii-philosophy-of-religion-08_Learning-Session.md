...
MECHANISM / ARGUMENT: Nietzsche requires both the death-of-God diagnosis and genealogy of morality.
CONSEQUENCE / CONTRAST: DCT, Euthyphro, Kantian autonomy, modified DCT, natural law, dharma/karma and non-theistic ethics are CORE ANSWER.
UPSC TRAP / ANSWER-USE: Do not reduce the topic to “religion teaches morality.” Do not merge justification with motivation or causal influence with logical dependence.
...
```closure-flow
SUBTOPIC: Contemporary India anchor — constitutional morality and religious practice [SUPPORTING]
KEY TERMS / DEFINITIONS: ✅ Fact: Reporting on the 2026 Sabarimala review hearings describes the Supreme Court’s renewed examination of equality, religious freedom, essential religious practices and constitutional morality.
...
```closure-flow
SUBTOPIC: Visual gateway — identify the relation before arguing
KEY TERMS / DEFINITIONS: Master verdict: Morality is not conceptually reducible to religion, but religion can supply motivation, formation and cosmic significance; morality in turn remains an indispensable internal and external critic of religious life.
