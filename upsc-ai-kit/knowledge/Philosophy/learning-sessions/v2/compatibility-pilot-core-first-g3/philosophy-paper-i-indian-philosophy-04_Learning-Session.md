...
KEY TERMS / DEFINITIONS: Broad IKS revival is context only, not evidence for doctrine.
MECHANISM / ARGUMENT: Navya-Nyāya refinements, the pramāṇa–pramāṇaphala debate and detailed rival objections are CORE SUPPORTING DEPTH when tied to the question.
CONSEQUENCE / CONTRAST: Broad IKS revival is context only, not evidence for doctrine.
UPSC TRAP / ANSWER-USE: Broad IKS revival is context only, not evidence for doctrine.
ANSWER-GRABBING FORMULATION: The seven categories, four pramāṇas, perception and inference, anyathākhyāti, self, apavarga, Īśvara, Udayana’s proofs, asatkāryavāda and atomism are CORE SYLLABUS.
```
...
KEY TERMS / DEFINITIONS: ✅ Search finding: A live August 2026 search located broad educational and academic discussion of Indian Knowledge Systems and classical Indian logic, but no sufficiently direct official doctrinal development specific to Nyāya–Vaiśeṣika.
...
KEY TERMS / DEFINITIONS: Master verdict: Nyāya–Vaiśeṣika is a realist system in which a detailed ontology is disclosed through valid cognition, error is a misrelation among real factors, and liberation follows removal of false knowledge.
