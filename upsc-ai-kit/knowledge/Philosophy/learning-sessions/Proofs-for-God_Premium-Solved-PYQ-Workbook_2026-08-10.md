# Proofs for the Existence of God — Premium Solved-PYQ and Practice Workbook

**UPSC Philosophy Optional · Paper II · Section B · Philosophy of Religion · Syllabus item 2 · 2026 Edition**

**Companion to:** *Proofs for the Existence of God and their Critique — Complete Learning Session (10 August 2026)*

## How to use this workbook

1. Read the **demand decoding** table, then close the model answer and write to time.
...
4. In every Mains answer, preserve the philosophical sequence: **classify → reconstruct as premises → expose a presupposition → objection → reply → graded verdict**.
5. Never conflate the four things a critique may attack: **validity**, **soundness of the premises**, **the attributes of the being reached**, and **the passage from that being to the God of religion**.

> **Note on exam stage.** Philosophy is a Mains-only Optional. It has no Prelims paper and no GS-overlap objective component, so **no Prelims PYQs are included or required**. Part I therefore contains the complete set of verified Mains PYQs owned by this topic; the MCQs in Part II are original diagnostic instruments, not past objective questions.

---

# Part I — All 12 Verified Topic-Owned PYQs (2018–2025)
...
## MCQ 1 — The three tiers of assessment
...
## MCQ 2 — Classifying the proof-families
...
C. A watch found on a heath obliges us to postulate a watchmaker

D. The stick moves the stone only while the hand moves the stick

**Answer: A**

**Explanation:** The thaler illustration is Kant's own, and it isolates precisely the step Anselm and Descartes need — that adding existence to a concept makes it *greater*. Chatterjee and Datta restate the same point with a hundred rupees imagined in one's pocket. B is Descartes' analogy *for* the argument, not against it; C is Paley; D is Aquinas' illustration of an essentially ordered series.

> 🔑 **Trap:** Kant's objection is a diagnosis of the concept of existence, not a parody like Gaunilo's.

---

## MCQ 6 — The modal ontological argument
...
## MCQ 10 — The Third Way's weak step
...
## MCQ 11 — Aquinas on the eternity of the world
...
## MCQ 13 — Kant against the cosmological argument
...
## MCQ 14 — Aquinas' Fifth Way and Paley
...
## MCQ 15 — Paley's supplementary points
...
## MCQ 16 — Hume's Epicurean hypothesis
...
A. A concession that design is probable but not certain
...
## MCQ 18 — Proportioning cause to effect
...
## MCQ 19 — The exact scope of Darwin's defeat
...
## MCQ 20 — Fine-tuning and its rivals
...
## MCQ 22 — The role of "ought implies can"
...
## MCQ 23 — Newman's conscience argument
...
## MCQ 25 — Nyāya's divine causation
...
C. God creates the world at a moment and thereafter has no concern with it, intervening only in emergencies

D. God is both the efficient and the material cause, the world and selves forming His body

**Answer: A**

**Explanation:** Nyāya's God is a *demiurgus* or builder, not a material source. B is a Vedāntic transformation model; C is deism, which Chatterjee and Datta explicitly distinguish from Nyāya theism on the ground that God maintains a continuous relation with the world; D is Rāmānuja's Viśiṣṭādvaita.

> 🔑 **Trap:** calling Nyāya's God the material cause is the topic's most heavily penalised factual error.

---

## MCQ 26 — The *kāryāt* argument's internal steps
...
## MCQ 27 — The argument from *adṛṣṭa*
...
## MCQ 28 — The Veda–God circularity
...
## MCQ 30 — The Buddhist immutability argument

The Buddhist argument that a permanent, immutable God cannot be the creator of the world proceeds by claiming that:

A. An immutable being cannot be omniscient, since knowledge of a changing world would change it
...
**Explanation:** This is the Dharmakīrti-type line, and it targets the compatibility of immutability with successive production. A and C are distinct objections about omniscience and goodness respectively, which the tradition raises separately. D is a Nyāya-internal thesis about material causation, not a Buddhist argument against a creator.
...
## MCQ 31 — Mīmāṃsā's twin displacement of God
...
B. *Pratītyasamutpāda* and *anātman*
...
**Explanation:** These two doctrines strike Nyāya's third proof and its *adṛṣṭa* proof simultaneously. Mīmāṃsā adds that Nyāya's route is cumbersome, requiring one first to prove God exists, then that God is omniscient, then that God intends truth. A is Jaina, B Buddhist, D Advaitic.

> 🔑 **Trap:** *apūrva* is Mīmāṃsā's technical substitute for a fruit-dispensing God; do not call it "karma" loosely.

---

## MCQ 32 — Comparative synthesis
...
# Part III — Remedial MCQs and Notes on Recurring Category Errors
...
B. Kant **postulated** God as a condition of the real possibility of the highest good; a postulate of practical reason is theoretically undemonstrable and is an object of rational faith, not knowledge
...
**Answer: B** · **Note:** the *Critique of Pure Reason* denies speculative theology; the *Critique of Practical Reason* supplies postulates, not proofs. Writing "Kant proves God" is the topic's single most penalised sentence.
...
B. Aquinas' argument concerns **present, simultaneous dependence** and explanatory priority; he holds that the temporal beginning of the world is known by faith rather than demonstrated, and it is the **Kalām** argument that asserts a beginning
...
**Answer: B** · **Note:** if you write only one sentence about Aquinas, make it this one.
...
B. Hume proved that natural selection explains adaptation

C. Hume's target is the **strength of the inference** and the **attributes** of the being inferred; in the *Dialogues*, Philo himself concedes a remote and undefined analogy between the cause of order and human intelligence

D. Hume abandoned the design argument in favour of the cosmological argument

**Answer: C** · **Note:** B is Darwin, seventy years later. A is one of Hume's dialectical alternatives, not his conclusion.
...
B. The universe resembles a vegetable as much as a machine, so the analogy required by the argument is too weak to support the inference

C. The cause established need not be one rather than many

D. A first cause need not be morally good

**Answer: B** · **Note:** A, C and D all grant an inference and question the attributes of its terminus. Sorting objections by tier is the fastest route to an evaluative conclusion.
...
> **Distribution:** three 10-markers, four 15-markers, three 20-markers. Each carries demand decoding, a model answer written to the appropriate length, and a top-answer checklist.
...
**Question:** Explain why Nyāya holds that adṛṣṭa cannot operate without God, and state the strongest objection to this claim. **(10 marks, 150 words)**

### Demand decoding

| Element | Requirement |
|---|---|
| Directive | *Explain* and *state* — reconstruction plus one targeted objection |
| Core issue | Whether an unconscious moral residue can allot determinate consequences |
| Ideal thesis | Nyāya's claim rests on unconsciousness; Mīmāṃsā's *apūrva* is its strongest rival |

### Model answer (≈155 words)

Differences in human fortune are events and must have causes; those causes are our own past actions, in this or a previous life. But consequences are often separated from acts by long intervals — "a sinner in the heyday of youth may be a sufferer in the infirmity of old age." Nyāya therefore posits a persisting stock of merit (*puṇya*) and demerit (*pāpa*), called **adṛṣṭa**.

The decisive step follows: *adṛṣṭa* is an **unintelligent** principle, and cannot by itself produce precisely the kind and degree of joy and sorrow deserved. Individual selves cannot direct it either, since they neither know their own adṛṣṭa nor can control it. Hence an eternal, omniscient and omnipotent dispenser is required — God as **karmaphaladātā**.

The **strongest objection** is Mīmāṃsā's: *apūrva*, the unseen potency generated by correctly performed ritual, persists and matures into its own fruit without any dispenser. If an unconscious potency can be intrinsically fruit-directed, Nyāya's premise fails — and with it the argument.

### Top-answer checklist

- The time-gap problem stated as the reason for positing *adṛṣṭa*.
- *Puṇya* and *pāpa* named.
- Unconsciousness identified as the load-bearing premise.
- *Karmaphaladātā* used.
- The Mīmāṃsā *apūrva* counter given as the objection, not a generic "karma suffices".
...
**Question:** "The failure of the theistic proofs establishes atheism." Critically examine. **(15 marks, 240 words)**

### Demand decoding

| Element | Requirement |
|---|---|
| Directive | *Critically examine* a stated thesis; you must adjudicate it |
| Core issue | The logical relation between failed arguments and the falsity of their conclusion |
| Ideal thesis | The claim commits the fallacy of arguing from failed argument to false conclusion |

### Model answer (≈250 words)

The thesis is false, and its falsity is instructive.

Formally, the inference from "the arguments for p have failed" to "p is false" is invalid. Failure of an argument shows only that *that route* does not establish its conclusion; the conclusion may still be true, and may be supported otherwise. Every proof examined here fails at a definable point — Anselm at the comparative premise, Aquinas at the exclusion of regress or the identification with God, Paley at the analogy, Kant at the transition from postulate to knowledge, Nyāya at the artefact model and the sufficiency of karma. None of these failures is a demonstration that no God exists.

The tradition itself supports this. Chatterjee and Datta, having concluded with Kant and Lotze that God cannot be deduced from anterior premises — since God, being ultimate, is "the highest of all premises" — draw an **experiential**, not atheistic, conclusion: God must be known through direct experience. Lotze's formulation is that all proofs are "pleas put forward in justification of our faith". Hume's Philo likewise concedes a remote analogy between the cause of order and intelligence even while dismantling the design inference.

Two qualifications are owed to the thesis. First, if all *available* routes fail, that may lower the rational credibility of theism, and an evidentialist can reasonably say so. Second, arguments *against* theism — most seriously the evidential problem of evil — are independent, and their force is untouched by the present point.

**Verdict:** the failure of the proofs establishes the failure of natural theology as demonstration, not atheism. It relocates the question from proof to experience, testimony, cumulative probability and the problem of evil.

### Top-answer checklist

- The invalid inference named and explained.
- Each family's specific point of failure identified, not merely asserted.
- The Chatterjee–Datta/Lotze experiential conclusion cited.
- Philo's concession noted.
- Two honest qualifications granted before the verdict.

---

## Original 15-marker 4

**Question:** Compare Kant's postulation of God from the highest good with Nyāya's inference of God as karmaphaladātā. **(15 marks, 250 words)**

### Demand decoding

| Element | Requirement |
|---|---|
| Directive | *Compare* — sustained axis-by-axis, not two summaries |
| Core issue | Two responses to the same problem — the disproportion of virtue and happiness |
| Ideal thesis | Same problem, different epistemic ambition: Kant claims rational hope, Nyāya claims knowledge |

### Model answer (≈255 words)

Both address one problem: **nature does not proportion happiness to desert**. Their responses diverge in epistemic ambition, and that divergence determines their respective vulnerabilities.

**Kant.** Having demolished the speculative proofs, he argues that the moral law commands us to promote the highest good, virtue together with proportionate happiness; "ought implies can" requires that this be really possible; but a finite agent cannot secure the harmony of virtue and happiness, nor achieve holiness in finite time. Hence the postulates of **freedom, immortality and God**. A postulate is practically necessary and theoretically undemonstrable — rational faith, not knowledge.

**Nyāya.** Differences of fortune require causes; karma supplies them; the time-gap requires a persisting stock of merit and demerit, *adṛṣṭa*; and *adṛṣṭa*, being unconscious, cannot allot determinate results, while selves neither know nor control it. Hence God as **karmaphaladātā**, "the impartial dispenser of the fruits of our actions". Strikingly, Chatterjee and Datta gloss this in Kant's own idiom: "it is God who combines happiness with virtue and misery with vice."

The **convergence** is therefore substantive, not verbal: both make God the guarantor of moral proportion, and both treat that proportioning as beyond the powers of finite agents.

The **divergence** is decisive. Kant postulates a God who *could* proportion; Nyāya infers a God who *does*. Kant's conclusion is modest and correspondingly hard to refute — one may decline the postulate, but not refute it. Nyāya's is bolder and correspondingly exposed: it must defeat the Mīmāṃsā claim that *apūrva* is self-fructifying, and it must survive the charge, pressed by C. D. Sharma, that a God chained by *adṛṣṭa* is a supervisor the system could do without.

**Verdict:** Kant secures less and risks less; Nyāya claims more and stakes more. Neither reaches the God of developed religion.

### Top-answer checklist

- The shared problem stated in the opening line.
- Kant's derivation given as steps, with all three postulates.
- *Adṛṣṭa*, *karmaphaladātā* and the unconsciousness premise present.
- The Chatterjee–Datta gloss quoted as evidence of a genuine parallel.
- The epistemic-ambition contrast made the axis of the verdict.
...
**Question:** Assess the claim that no single argument for God's existence establishes the God of developed religion, and consider whether a cumulative case can repair the deficiency. **(20 marks, 350 words)**

### Demand decoding

| Element | Requirement |
|---|---|
| Directive | *Assess* and *consider* — a two-part evaluative task |
| Core issue | The adequacy gap, and whether aggregation closes it |
| Ideal thesis | The claim is correct; cumulation raises probability and adds attributes but cannot convert probable inference into demonstration |

### Model answer (≈360 words)

The claim is correct, and its correctness is visible argument by argument.

The **ontological** argument, if it worked, would establish a maximally great being — but only conditionally, since the possibility premise is unestablished, and Kant's objection denies that existence can function as a great-making property at all. The **cosmological** arguments establish, at most, an unmoved mover, a first efficient cause or a necessary being; Kant's objection is precisely that the identification of that terminus with the ens realissimum is imported from the ontological argument. The **teleological** argument establishes an orderer, but Hume's proportioning principle blocks the inference from a finite world to an infinite, unique and perfectly good designer. The **moral** argument, in Kant's hands, is a postulate rather than a proof, and, as Hick observes, moral values cannot be said to point all the way to the infinite, self-existent personal creator. **Nyāya's** Īśvara is explicitly limited: an efficient cause only, ordering eternal atoms, morally constrained by *adṛṣṭa*, and — as C. D. Sharma presses — "reduced to the status of a supervisor".

The **cumulative-case** strategy is the natural repair, and it has independent pedigree in both traditions. Udayana multiplies inferential routes in the *Nyāyakusumāñjali* rather than resting on *kāryāt* alone; modern Western defenders combine cosmological, teleological, moral, experiential and fine-tuning considerations into an inference to the best explanation. The strategy is genuinely powerful in one respect: it addresses **adequacy** directly, since different arguments contribute different attributes — necessity from contingency reasoning, intelligence from order, moral government from desert.

But three limits are decisive. First, cumulation of individually weak inferences yields strength only if the routes are **evidentially independent**; where they share a premise, such as the principle of sufficient reason or the artefact analogy, their conjunction inherits a single vulnerability. Second, cumulation changes the quantity of support, never its **logical type**: many probable arguments still yield probability, not demonstration. Third, adversarial cumulation is symmetrical — the evidential problem of evil, divine hiddenness and religious diversity accumulate on the other side.

**Verdict:** no single argument reaches the God of developed religion, and a cumulative case improves the epistemic position without transforming it. The rational upshot is that natural theology yields, at best, a reasonable overall judgement rather than a proof — which is why Thomist, Kantian and Nyāya traditions alike supplement argument with revelation, postulation or, as Chatterjee and Datta conclude, direct experience.

### Top-answer checklist

- Each family's specific terminus stated, then the gap identified.
- Both Udayana and the Western cumulative case named as parallel strategies.
- The three limits on cumulation set out as distinct points.
- Symmetry with anti-theistic cumulation acknowledged.
- A conclusion naming the criterion — reasonable judgement, not proof.

---

# Part V — Philosophy Optional High-Score Answer Protocol
