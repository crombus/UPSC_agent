...
```
        PROOFS FOR GOD
   A PRIORI (from concept)        A POSTERIORI (from experience/world)
   ─────────────────────         ────────────────────────────────
   ONTOLOGICAL                   COSMOLOGICAL  |  TELEOLOGICAL  |  MORAL
   (Anselm, Descartes)           (first cause;    (design;         (Kant: God as
   "perfect being must exist"     Aquinas 1-3,     Aquinas 5,       postulate of
                                   Kalam)           Paley's watch)   morality)
        │                              │                │
   critique: Kant — "existence     critique: Hume (design weak, evil, analogy),
   is not a predicate"; Gaunilo    Kant (cosmological hides ontological)
   INDIAN: Nyāya Īśvara-anumāna (inference: the world (kārya) needs an intelligent maker) ✅
   critique: Cārvāka, Buddhism, Mīmāṃsā (no need of God)
```
...
### (a) Ontological (a priori — Anselm, Descartes)
- **Anselm:** God = *"that than which nothing greater can be conceived."* A being that exists *in reality* is greater than one existing only *in the mind* → God must exist in reality (else not the greatest). **Descartes:** existence is a perfection; a supremely perfect being cannot lack it. ✅
...
## 2. INDIAN PROOFS — Nyāya (2023, 2025 PYQ) ✅
- **Nyāya's Īśvara-anumāna (inference to God):** the world (earth, mountains, etc.) is an **effect (kārya)** — a composite arrangement of atoms; every effect needs an **intelligent efficient cause** who knows and combines the atoms → **Īśvara (God)**. ✅ (A cosmological-teleological hybrid.)
- **Further Nyāya grounds:** the authority of the **Vedas** needs an author (God); the law of **karma** needs an intelligent dispenser (God as *karmādhyakṣa*) to allot fruits. ✅
- **God in Nyāya-Vaiśeṣika:** eternal, omniscient, the **efficient (not material)** cause of creation; combines eternal atoms per adṛṣṭa/karma. ✅
- **Critique of Nyāya proofs:** ✅
...
## 3. A PRIORI vs A POSTERIORI (2022 PYQ) ⚠️
| | A priori | A posteriori |
|---|---|---|
| Basis | concept of God alone | facts of the world |
| Example | Ontological | Cosmological, Teleological, Nyāya |
| Strength | if valid, gives a necessary God | connects to observable reality |
| Weakness | Kant: existence not a predicate | at best a probable/finite designer |
> ⚠️ **Which to prefer?** A posteriori arguments are more persuasive (rooted in experience) but yield only a *probable, finite* God; the ontological, if it worked, would give a *necessary* God but commits the existence-predicate fallacy. Most philosophers find **none demonstrative** — hence the turn to faith/experience.

---

## 4. STATEMENT / QUOTE BANK ⚠️
1. ✅ Anselm: God = *"that than which nothing greater can be conceived."*
2. ✅ Kant: *"Existence is not a real predicate."*
3. ✅ Paley: the watch implies a watchmaker.
4. ✅ Hume: from a finite world you can infer at most a finite, imperfect cause.
5. ✅ Nyāya: the world is an *effect (kārya)* → needs an intelligent maker (Īśvara).

---

## 5. APPLIED-QUESTION DRILLS ⚠️
1. **[Design + Hume]** "Design argument + Hume's criticism." (2025, 20m) → §1(c).
2. **[Nyāya]** "Nyāya's proofs for God's existence; evaluate." (2023, 2025) → §2.
3. **[Ontological]** "Ontological proof + criticism." (2024) → §1(a).
4. **[Five Ways]** "Aquinas' Five Ways; which is most interesting?" (2022) → §1(a-c).
5. **[a priori/a posteriori]** "Distinguish a priori & a posteriori proofs; which preferred?" (2022) → §3.
6. **[Jainism]** "Proofs for God's existence as propounded in Jainism." (2019, 10m) → §8.6 + skeleton 6.3.
7. **[Buddhism]** "Buddhistic arguments against God as creator of the world." (2018, 15m) → §8.7 + skeleton 6.4.
...
## 5A. INDIAN–WESTERN PARITY BENCH (use whenever the stem says "critically" or "compare") ⚠️

| Function | Western | Indian pro-theistic | Indian anti-theistic |
|---|---|---|---|
| From effect to maker | Aquinas Way 2; Paley | Nyāya *kāryāt*, *āyojanāt* | Buddhist attack on the *vyāpti*; Jain regress |
| From order/governance | Aquinas Way 5 | Udayana *dhṛtyādeḥ* | Jain *svabhāva*; Sāṃkhya's unconscious prakṛti |
...
### 6.1 — "Design argument + Hume's criticism." (2025, 20m)
```
...
### 6.2 — "Nyāya's arguments for the existence of God; evaluate." (2023, 20m)
```
Intro : Nyāya offers a rational, inferential theism (Īśvara-anumāna).
Body  : world = effect → intelligent efficient cause; Veda needs author; karma needs dispenser.
Crit  : Cārvāka (no perception), Buddhism/Jainism (karma without God),
        Mīmāṃsā (Vedas authorless), Advaita (only saguṇa, not absolute).
Assess: a genuine cosmological-teleological proof; shares the a-posteriori limits (Hume-type).
Concl : rationally suggestive, not conclusive — mirrors the Western proofs' fate.
```

### 6.3 — "State and evaluate the proofs for the existence of God as propounded in Jainism." (2019, 10m)
```
Line 1: correct the stem — Jainism propounds NO proof of a creator; it propounds arguments
        against one, plus a doctrine of divinity as the soul's achieved perfection.
Body  : (i) motive argument — a perfect being has no want, hence no reason to create;
        (ii) regress — if all needs a maker, so does the maker;
        (iii) no material/instrument/space before creation;
        (iv) moral — a compassionate creator would not produce this distribution of suffering;
        (v) redundancy — karma + six dravyas already explain order (lāghava);
        (vi) svabhāva — things act by their own nature.
Positive: arihanta/kevalin → tīrthaṅkara (re-founds the fourfold tīrtha, 24 per half-cycle)
        → siddha (disembodied, ananta-catuṣṭaya, siddhaśilā). Vītarāga: worship is
        commemorative, never petitionary — the object does not respond.
Crit  : Nyāya — unconscious adṛṣṭa cannot allot fruits; classical theism — creation is a
        non-needy diffusion of goodness, not the satisfaction of a lack.
Concl : powerful against an anthropomorphic creator; weaker against a non-needy classical theism.
```

### 6.4 — "Critically evaluate the Buddhistic arguments against God as creator." (2018, 15m)
```
Intro : three strata — canonical-critical, causal-metaphysical, moral.
B1    : Brahmajāla Sutta (Brahmā's honest mistake); Aggañña Sutta's cyclic account;
        avyākata + poisoned-arrow — cosmogony is soteriologically idle. [Diagnosis, not refutation.]
B2    : Dharmakīrti/Śāntarakṣita — reality is causal efficacy; a PERMANENT cause must act
        all-at-once or successively; all-at-once collapses the world into one instant,
        successively requires change in God (krama-akrama-virodha); auxiliaries → not sole cause;
        vyāpti "effect → conscious maker" holds only for artifacts; pratītyasamutpāda suffices.
B3    : Moral — this quantum of suffering counts against a benevolent omnipotent maker;
        Devadaha Sutta: any doctrine that voids present effort destroys the moral life.
Crit  : Nyāya reply — eternal divine will, effects timed by adṛṣṭa; demanding perception begs
        the question against inference. Buddhist rejoinder: a will timed by another is not sole cause.
Concl : strongest as metaphysics, weakest as genealogy — explaining the belief is not refuting it.
```
