# Plato and Aristotle - Complete Topic Package

> **Subject:** Philosophy | **Paper:** Philosophy Optional

## Complete foundation and advanced source

# Plato and Aristotle - Complete Detailed Learning Session and Solved Practice

> **Repository edition:** cleaned reusable source for teaching and PDF regeneration.
> **Coverage:** complete core doctrine, detailed expansions, all verified 2018-2025 PYQs,
> topic-balanced MCQs, remedial practice, solutions, advanced refinements, and register notes.
> **Excluded:** chat turns, tool logs, navigation messages, and duplicate operational output.

## Part I - Verified Core Knowledge Owner

# PLATO & ARISTOTLE — Syllabus Item 1 (Paper I · Section A)
...
> **Placement:** The opening item of Western Philosophy, with 12 primary-owned parts and at least one in every paper from 2018 through 2025. Plato supplies the metaphysical *problem* (the reality of universals, the relation of knowledge to being); Aristotle supplies the rival *solution* (immanent form, hylomorphism, teleological causation, potentiality-actuality). The examiner's favourite pivot is the **contrast** between their conceptions of Form.
...
- Stace, W.T., *A Critical History of Greek Philosophy* — chapters on Plato's Theory of Ideas and Aristotle's Metaphysics.
- Masih, Y., *A Critical History of Western Philosophy* — chapters on Greek philosophy.
- Copleston, F., *A History of Philosophy*, Vol. I (Greece and Rome) — Plato (chs. 18–25) and Aristotle (chs. 27–34).
- Kenny, A., *A New History of Western Philosophy*, Vol. I — sections on Plato and Aristotle.
- Warburton, N., *Philosophy: The Classics* — chapters on the *Republic* and *Nicomachean Ethics*.
- Primary texts referred to: Plato, *Republic*, *Phaedo*, *Parmenides*, *Timaeus*; Aristotle, *Categories*, *Metaphysics* (esp. VII–IX), *Physics* III, *De Anima*.


# Part II - Detailed Learning Expansion, Solved PYQs, and Integrated Practice
...
## Solved PYQ 2018 - Idea and World

**Verified PYQ:** Is the relation between the Idea and the World as discussed by Plato logically consistent? Discuss Aristotle's views regarding this and also give arguments in favour of your answer. (15 marks)
...
## Solved PYQ 2019A - Allegory of the Cave

**Verified PYQ:** What does Plato want to prove by his Allegory of Cave? (10 marks)
...
## Solved PYQ 2019B - Developmental Change

**Verified PYQ:** What are the reasons for developmental changes in substance according to Aristotle? Discuss. (15 marks)
...
## Solved PYQ 2020 - Priority of Form and Actuality

**Verified PYQ:** How does Aristotle argue for the priority of Form over Matter and Actuality over Potentiality? Critically discuss. (10 marks)
...
## Solved PYQ 2021A - The Red Chair

**Verified PYQ:** There is a red chair. How would Plato explain this statement with the use of his theory of forms? Examine. (10 marks)
...
## Solved PYQ 2021B - Potentiality Is Indefinable

**Verified PYQ:** Potentiality is indefinable according to Aristotle. Explain the relationship between potentiality and actuality using a wooden table. (10 marks)
...
## Solved PYQ 2022A - Epistemology and Metaphysics

**Verified PYQ:** How does Plato use the theory of forms to establish the relation between epistemology and metaphysics? Discuss. (10 marks)
...
## Solved PYQ 2022B - Identity and Causes as Processes

**Verified PYQ:** Is Aristotle's view of the nature of identity in consonance with his metaphysical view of causes as processes? Discuss with examples. (15 marks)
...
## Solved PYQ 2023 - Being and Becoming

**Verified PYQ:** Present Aristotle's distinction between actuality and potentiality. Does it provide a solution to the problem of being and becoming? Discuss with examples. (15 marks)
...
## Solved PYQ 2024 - Conceptions of Form

**Verified PYQ:** Differentiate between Plato's and Aristotle's conceptions of form. (10 marks)
...
## Solved PYQ 2025A - Timeless and Spaceless Ideas

**Verified PYQ:** Ideas are timeless and spaceless. Elucidate this statement with reference to Plato. (10 marks)
...
## Solved PYQ 2025B - Matter and Form Compound

**Verified PYQ:** In the empirical world, everything is a compound of Matter and Form. Evaluate this statement with reference to Aristotle. (10 marks)
...
## Integrated MCQ Loop 1 - Plato and Aristotle's Critique

Attempt every question before reading the final column. The correct-option sequence follows the anti-bias rotation.

### Key Table

| Question and options | Key | Solution |
| --- | --- | --- |
| 1. Which best states the Form of the Good?<br>A. Highest condition of intelligibility and value<br>B. A physical source of light<br>C. A mental generalisation<br>D. Aristotle's efficient cause | A | The Good plays epistemological, ontological, and evaluative roles; the sun is its analogy. |
| 2. Third Man requires which key premise?<br>A. Matter is unreal<br>B. The Form is itself predicated F<br>C. All causes are efficient<br>D. Knowledge is perception | B | Self-predication allows the Form to join particulars in a new many, triggering regress. |
| 3. Aristotle's central repair is to make form:<br>A. A name only<br>B. A second particular<br>C. Immanent in concrete substance<br>D. Identical with prime matter | C | Aristotle retains intelligible form but rejects its separate existence. |
| 4. Which is NOT one of the five critique routes?<br>A. Duplication<br>B. Participation obscurity<br>C. Failure to explain motion<br>D. Rejection of every universal predicate | D | Aristotle rejects separate universals, not universal predication or definition. |

### Detailed Teaching

- **Practice rule:** state why each rejected option fails, not only why the key is correct.
- **Mastery gate:** move ahead after two consecutive correct answers or two correct out of three.

> **Memory hook:** RECALL -> CHOOSE -> JUSTIFY -> CORRECT THE DISTRACTOR.

### Must-Know Facts

- Every distractor targets a documented UPSC trap.
- Return to the relevant doctrine card after an incorrect response.

### UPSC Traps

- **Wrong:** Memorise only the answer letter. **Correct:** Memorise the discriminating concept that defeats the distractors.

**Mains judgement:** Use wrong answers to identify whether the weakness is definition, relation, example, or evaluation.

**Study link:** Integrated practice loop; the separate workbook contains the extended bank.

---

## Integrated MCQ Loop 2 - Substance and Hylomorphism
...
| Question and options | Key | Solution |
| --- | --- | --- |
| 5. A primary substance is:<br>A. This individual horse<br>B. The genus animal<br>C. The quality pale<br>D. Prime matter alone | A | Primary substance is the concrete ultimate subject of predication. |
| 6. Humanity is a secondary substance because it:<br>A. Exists as a separate Form<br>B. Says what individual humans are<br>C. Is an accidental colour<br>D. Is pure matter | B | Species and genus classify the primary substance substantially. |
| 7. Synolon means:<br>A. Separate universal<br>B. Efficient cause<br>C. Matter-form compound<br>D. Statistical possibility | C | The concrete natural substance is the unified compound. |
| 8. Prime matter should be understood as:<br>A. Modern atomic matter<br>B. A separately existing object<br>C. A highest Form<br>D. A limiting principle of pure receptivity | D | Prime matter never exists independently and has no determinate character of its own. |
...
## Integrated MCQ Loop 3 - Causes and Potency-Act
...
| Question and options | Key | Solution |
| --- | --- | --- |
| 9. The material cause answers:<br>A. Out of what?<br>B. What end?<br>C. What structure?<br>D. What first principle? | A | Material cause identifies the relevant material or substratum. |
| 10. The carpenter's craft is primarily:<br>A. Final cause<br>B. Active potentiality<br>C. Passive potentiality<br>D. Prime matter | B | The craft is a capacity to produce change; wood has the passive capacity. |
| 11. Energeia most strongly emphasises:<br>A. Bare possibility<br>B. Spatial location<br>C. Being-at-work or activity<br>D. Separate universality | C | Energeia highlights active actuality; entelecheia highlights fulfilment. |
| 12. Aristotle solves becoming by treating it as:<br>A. Being from absolute nothing<br>B. Illusion<br>C. Random conjunction<br>D. Potential being becoming actual | D | A grounded capacity becomes actual, preserving both continuity and novelty. |
...
## Remedial Loop - High-Risk Confusions

Attempt every question before reading the final column. These items repair high-risk confusions.

### Key Table

| Question and options | Key | Solution |
| --- | --- | --- |
| R1. Plato's sensible world is best described as:<br>A. Derivative and changing reality<br>B. Absolute non-being<br>C. Identical with Forms<br>D. Pure matter | A | Particulars are inferior copies or participants, not sheer nothing. |
| R2. Actuality is prior to potentiality primarily because:<br>A. It always occurs first in an individual<br>B. Potential X is defined through actual X<br>C. Matter is temporally unreal<br>D. Every end is conscious | B | Definitional and explanatory priority must be distinguished from simple temporal order. |
| R3. The Unmoved Mover moves the cosmos chiefly as:<br>A. Material cause<br>B. Mechanical efficient push<br>C. Final cause<br>D. Passive potentiality | C | It attracts as the perfect object of desire and thought. |
| R4. Which statement is incorrect?<br>A. Matter is relative to a level of form<br>B. Form is more than external shape<br>C. Four causes are explanatory dimensions<br>D. Potentiality is statistical probability | D | Dynamis is a grounded capacity, not a probability estimate. |
...
## Consolidated Register Notes - Complete Session

Revise this only after completing doctrine, solved PYQs, and practice loops.

### Final Revision Network

**Centre:** FORM CONNECTS KNOWLEDGE, SUBSTANCE, CAUSE, AND CHANGE
- **Plato:** Separate universal standard.
- **Aristotle:** Immanent essence and actuality.
- **Substance:** Concrete bearer of accidents.
- **Causes:** Four explanatory becauses.
- **Potentiality:** Grounded capacity.
- **Actuality:** Activity and fulfilment.

### Key Table

| Trigger | Recall formula | Judgement |
| --- | --- | --- |
| Forms | Flux -> stable object -> universal standard | Knowledge gained; separation cost |
| Substance | Individual -> essence -> accidents | Identity through change |
| Hylomorphism | Matter + immanent form = synolon | Unity gained; prime-matter difficulty |
| Causes | Out of / what / source / end | Rich explanation; teleology debated |
| Potency-act | Capacity -> activity -> fulfilment | Being and becoming reconciled |
| Comparison | Location -> reality -> knowledge -> cause -> change | Transformation, not total defeat |

### Detailed Teaching

- **Plato:** Forms are timeless, spaceless, universal, intelligible, and primary; particulars participate or imitate.
- **Good:** sun-like condition of knowability, order, and value; culmination of education.
- **Third Man:** one-over-many + self-predication + non-identity can generate regress.
- **Aristotle's five objections:** duplication, participation, regress, motion, separated essence.
- **Substance:** this individual is primary; species/genus are secondary; accidents depend upon substance.
- **Hylomorphism:** synolon is matter informed by immanent form; matter is relative; prime matter is a limit.
- **Causes:** material, formal, efficient, final are four explanatory answers.
- **Potency-act:** dynamis is grounded capacity; kinesis actualises it; energeia works; entelecheia completes.
- **Powers:** active capacity produces change; passive capacity undergoes it.
- **Unmoved Mover:** immaterial pure act, eternal intellectual activity, final cause.
- **Comparison:** Plato secures universal standards; Aristotle explains concrete unity and development.
- **Answer rule:** define, reconstruct, apply, debate, evaluate.

> **Memory hook:** UP - IN - FOUR - FLOW: PLATO UP, ARISTOTLE IN, FOUR CAUSES, POTENCY FLOWS TO ACT.

### Must-Know Facts

- The verified 2018-2025 corpus contains 12 owned Plato-Aristotle question-parts.
- Every major doctrine has at least one example, objection, reply, and qualified judgement.
- The separate workbook expands all model answers and practice solutions.

### UPSC Traps

- **Wrong:** Plato's particulars are absolute non-being. **Correct:** They possess derivative reality.
- **Wrong:** Aristotle rejects universality. **Correct:** He rejects separate universal Forms.
- **Wrong:** Four causes are sequential events. **Correct:** They are explanatory dimensions.
- **Wrong:** Potentiality is probability. **Correct:** It is grounded capacity.

**Mains judgement:** Aristotle internalises Plato's intelligible Form and turns metaphysics toward concrete substance and development without eliminating the universal-particular problem.

**Study link:** Next topic: Rationalism - Descartes, Spinoza, and Leibniz.

---

# Part III - Extended Solved MCQ and Remedial Workbook

## Topic-Balanced MCQ Practice - Questions 1-4

Attempt each item before reading the key and explanation. The correct options follow strict A-B-C-D rotation.

### Key Table

| Question and options | Key | Detailed solution |
| --- | --- | --- |
| <b>Q1 [Forms]</b><br>Which claim best states Plato's view of Forms?<br>A. Transcendent and immutable universals<br>B. Sensory impressions only<br>C. Linguistic conventions<br>D. Material atoms | A | <b>Why:</b> Forms are non-sensible, stable realities; particulars possess derivative intelligibility through them.<br><b>Discriminator:</b> Transcendent and immutable universals |
| <b>Q2 [Good]</b><br>In the Cave and Sun analogies, the sun symbolises:<br>A. Sensory opinion<br>B. The Form of the Good<br>C. Bodily desire<br>D. The material sun alone | B | <b>Why:</b> The Good makes intelligible objects knowable as the sun makes visible objects visible.<br><b>Discriminator:</b> The Form of the Good |
| <b>Q3 [Participation]</b><br>Participation in Plato most nearly means:<br>A. A Form is a physical part inside each object<br>B. Forms are invented by minds<br>C. Particulars derive character and intelligibility from a Form<br>D. Matter produces universals without form | C | <b>Why:</b> Methexis names the dependence of particular F-things upon Form F, though the relation remains underexplained.<br><b>Discriminator:</b> Particulars derive character and intelligibility from a Form |
| <b>Q4 [Substance]</b><br>In Aristotle's Categories, primary substance is:<br>A. Genus<br>B. Species<br>C. Quality<br>D. The individual concrete thing | D | <b>Why:</b> A primary substance, such as this person or this horse, is the ultimate subject of predication.<br><b>Discriminator:</b> The individual concrete thing |

### Detailed Teaching

- **Practice method:** identify the exact doctrinal distinction tested.
- **Error correction:** explain why each rejected option fails.
- **Mastery gate:** revisit the doctrine after an error and attempt the next remedial item.

### Must-Know Facts

- The key sequence is anti-bias controlled.
- Every item covers a documented syllabus concept or common trap.

### UPSC Traps

- **Wrong:** Memorise only the option letter. **Correct:** Retain the discriminating doctrine stated in the solution.

**Mains judgement:** Convert every MCQ explanation into a two-sentence Mains-ready distinction.

**Study link:** Return to the complete learning-session PDF for doctrine and diagrams.

---

## Topic-Balanced MCQ Practice - Questions 5-8
...
| Question and options | Key | Detailed solution |
| --- | --- | --- |
| <b>Q5 [Hylomorphism]</b><br>Hylomorphism states that a natural substance is:<br>A. A unified matter-form compound<br>B. Only matter<br>C. Only separate form<br>D. A bundle of accidents without a subject | A | <b>Why:</b> Synolon is the concrete composite whose matter is organised and actualised by form.<br><b>Discriminator:</b> A unified matter-form compound |
| <b>Q6 [Causation]</b><br>Aristotle's four causes are best understood as:<br>A. Four temporal stages<br>B. Four dimensions of complete explanation<br>C. Four sensory qualities<br>D. Four rival substances | B | <b>Why:</b> They answer out-of-what, what-it-is, source-of-change, and for-the-sake-of-what.<br><b>Discriminator:</b> Four dimensions of complete explanation |
| <b>Q7 [Causation]</b><br>The final cause identifies:<br>A. The material substratum<br>B. Only the external maker<br>C. The end, function, or fulfilled state<br>D. An accidental colour | C | <b>Why:</b> Telos explains the outcome or activity toward which a process or organised thing is directed.<br><b>Discriminator:</b> The end, function, or fulfilled state |
| <b>Q8 [Actuality]</b><br>Actuality is:<br>A. Bare latent capacity<br>B. Indeterminate matter alone<br>C. Statistical likelihood<br>D. The realised activity or fulfilment of a potential | D | <b>Why:</b> Energeia stresses being-at-work; entelecheia stresses achieved fulfilment.<br><b>Discriminator:</b> The realised activity or fulfilment of a potential |
...
## Topic-Balanced MCQ Practice - Questions 9-12
...
| Question and options | Key | Detailed solution |
| --- | --- | --- |
| <b>Q9 [Priority]</b><br>Actuality is prior to potentiality in definition because:<br>A. Potential X is understood through actual X<br>B. Every actual thing appears earlier in time<br>C. Potentiality is unreal<br>D. Matter has no role in substances | A | <b>Why:</b> One understands potentially-a-table only by already understanding what an actual table is.<br><b>Discriminator:</b> Potential X is understood through actual X |
| <b>Q10 [Third Man]</b><br>Which premise helps generate the Third Man regress?<br>A. Matter is absolutely unreal<br>B. The Form of F is itself predicated F<br>C. All causes are efficient<br>D. Knowledge is identical with perception | B | <b>Why:</b> Self-predication lets particulars and their first Form constitute a new many requiring another Form.<br><b>Discriminator:</b> The Form of F is itself predicated F |
| <b>Q11 [Critique]</b><br>Aristotle argues that separated Forms:<br>A. Eliminate every universal predicate<br>B. Are identical with matter<br>C. Duplicate reality without adequately explaining concrete change<br>D. Make perception infallible | C | <b>Why:</b> A second inventory of entities does not explain generation, constitution, or motion in particulars.<br><b>Discriminator:</b> Duplicate reality without adequately explaining concrete change |
| <b>Q12 [Change]</b><br>Potentiality becomes actuality through:<br>A. Mere verbal redefinition<br>B. Absolute creation from nothing<br>C. The disappearance of every subject<br>D. The process of actualisation or motion | D | <b>Why:</b> Kinesis is actuality of what is potential precisely insofar as it is potential.<br><b>Discriminator:</b> The process of actualisation or motion |
...
## Topic-Balanced MCQ Practice - Questions 13-16
...
| Question and options | Key | Detailed solution |
| --- | --- | --- |
| <b>Q13 [Epistemology]</b><br>Plato links knowledge with Forms because:<br>A. Strict knowledge requires a stable intelligible object<br>B. Knowledge is sensation alone<br>C. Being and knowing are unrelated<br>D. Universals are arbitrary sounds | A | <b>Why:</b> Episteme corresponds to stable Forms, while changing sensibles yield doxa.<br><b>Discriminator:</b> Strict knowledge requires a stable intelligible object |
| <b>Q14 [Form]</b><br>Aristotle's form is primarily:<br>A. A transcendent separate object<br>B. The immanent essence and actuality of a substance<br>C. Bare prime matter<br>D. A subjective image | B | <b>Why:</b> Aristotle relocates form within the concrete substance as its organising principle.<br><b>Discriminator:</b> The immanent essence and actuality of a substance |
| <b>Q15 [Prime matter]</b><br>Prime matter is best described as:<br>A. A fully actual separate thing<br>B. A modern atomic particle<br>C. A limiting principle of pure receptivity<br>D. The Form of the Good | C | <b>Why:</b> Prime matter never exists alone and has no determinate character apart from form.<br><b>Discriminator:</b> A limiting principle of pure receptivity |
| <b>Q16 [Unmoved Mover]</b><br>The Unmoved Mover moves chiefly as:<br>A. A mechanical efficient push<br>B. A material ingredient<br>C. A passive potentiality<br>D. A final cause | D | <b>Why:</b> It attracts as the perfect object of desire and thought rather than producing motion mechanically.<br><b>Discriminator:</b> A final cause |
...
## Topic-Balanced MCQ Practice - Questions 17-20
...
| Question and options | Key | Detailed solution |
| --- | --- | --- |
| <b>Q17 [Form priority]</b><br>Form has explanatory priority over matter because it:<br>A. Makes the substance intelligible as the kind of thing it is<br>B. Is always older in clock time<br>C. Is less real than matter<br>D. Is only exterior shape | A | <b>Why:</b> Form supplies essence, organisation, characteristic activity, and fulfilled determination.<br><b>Discriminator:</b> Makes the substance intelligible as the kind of thing it is |
| <b>Q18 [Development]</b><br>Developmental change in Aristotle is most directly explained by:<br>A. The permanence of every accident<br>B. The actualisation of a grounded potential under causal conditions<br>C. Indivisible atoms alone<br>D. A purely linguistic shift | B | <b>Why:</b> Matter provides capacity; efficient, formal, and final causes explain the ordered process.<br><b>Discriminator:</b> The actualisation of a grounded potential under causal conditions |
| <b>Q19 [Forms]</b><br>Which is true of Platonic Forms?<br>A. They are local physical objects<br>B. They perish with their instances<br>C. They are timeless and spaceless<br>D. They are accidental qualities | C | <b>Why:</b> Their non-temporal and non-spatial character underwrites their stability as objects of knowledge.<br><b>Discriminator:</b> They are timeless and spaceless |
| <b>Q20 [Accidents]</b><br>The substance-accident distinction means:<br>A. Accidents are independent subjects<br>B. Substance is merely a word<br>C. Accidents are more primary than substances<br>D. Substance exists in its own right while accidents depend on it | D | <b>Why:</b> Pale or seated exists only as a feature of a substance such as Socrates.<br><b>Discriminator:</b> Substance exists in its own right while accidents depend on it |
...
## Topic-Balanced MCQ Practice - Questions 21-24
...
| Question and options | Key | Detailed solution |
| --- | --- | --- |
| <b>Q21 [One-over-many]</b><br>The one-over-many argument begins from:<br>A. A common character predicated of many particulars<br>B. The absence of all universals<br>C. The identity of matter and form<br>D. The claim that only names exist | A | <b>Why:</b> Many F-things suggest one Form F that grounds their shared intelligibility.<br><b>Discriminator:</b> A common character predicated of many particulars |
| <b>Q22 [Good]</b><br>The highest organising principle in Plato's Republic is:<br>A. Prime matter<br>B. The Form of the Good<br>C. The genus animal<br>D. An efficient creator | B | <b>Why:</b> The Good grounds knowability, order, and value and completes the educational ascent.<br><b>Discriminator:</b> The Form of the Good |
| <b>Q23 [Wooden table]</b><br>The wooden-table example demonstrates:<br>A. Sensation replacing knowledge<br>B. A regress of Forms<br>C. A material capacity becoming actual through an organised process<br>D. Matter existing without form | C | <b>Why:</b> Wood has passive potential; the carpenter has active potential; construction actualises table-form.<br><b>Discriminator:</b> A material capacity becoming actual through an organised process |
| <b>Q24 [Process]</b><br>To call Aristotle's causes processual is to say that they:<br>A. Are merely four events in sequence<br>B. Are mental habits only<br>C. Eliminate formal explanation<br>D. Jointly explain how a substance develops while retaining structured identity | D | <b>Why:</b> The causes integrate material continuity, source of change, organisation, and completed end.<br><b>Discriminator:</b> Jointly explain how a substance develops while retaining structured identity |
...
## Topic-Balanced MCQ Practice - Questions 25-28
...
| Question and options | Key | Detailed solution |
| --- | --- | --- |
| <b>Q25 [Knowledge]</b><br>Plato's distinction between episteme and doxa contrasts:<br>A. Knowledge of stable intelligible reality with opinion about changing sensibles<br>B. Matter with efficient cause<br>C. Active with passive potentiality<br>D. Substance with prime matter | A | <b>Why:</b> The distinction mirrors Plato's metaphysical hierarchy between Forms and particulars.<br><b>Discriminator:</b> Knowledge of stable intelligible reality with opinion about changing sensibles |
| <b>Q26 [Identity]</b><br>Aristotle's form is the principle of identity because it:<br>A. Is exterior appearance only<br>B. Organises matter into this determinate kind of substance<br>C. Exists in a separate realm<br>D. Is an accidental predicate | B | <b>Why:</b> Form supplies the essence and characteristic operations of the concrete compound.<br><b>Discriminator:</b> Organises matter into this determinate kind of substance |
| <b>Q27 [Being and becoming]</b><br>Aristotle reconciles being and becoming through:<br>A. Absolute non-being<br>B. The denial of all change<br>C. Potential being<br>D. Unstructured flux | C | <b>Why:</b> The acorn is not actually but is potentially an oak, so becoming is not from nothing.<br><b>Discriminator:</b> Potential being |
| <b>Q28 [Recollection]</b><br>Plato's recollection argument explains:<br>A. Why accidents exist independently<br>B. Why matter is pure actuality<br>C. Why every cause is efficient<br>D. How imperfect instances can prompt recognition of perfect standards | D | <b>Why:</b> Recognition of equality presupposes a standard not fully supplied by sensible equals.<br><b>Discriminator:</b> How imperfect instances can prompt recognition of perfect standards |
...
## Topic-Balanced MCQ Practice - Questions 29-30
...
| Question and options | Key | Detailed solution |
| --- | --- | --- |
| <b>Q29 [Comparison]</b><br>The most accurate causal comparison is:<br>A. Plato offers paradigmatic explanation; Aristotle develops fourfold processual explanation<br>B. Both recognise only efficient causes<br>C. Aristotle denies formal cause<br>D. Plato gives a complete theory of natural development | A | <b>Why:</b> Plato's Forms are models; Aristotle adds material, efficient, formal, and final dimensions.<br><b>Discriminator:</b> Plato offers paradigmatic explanation; Aristotle develops fourfold processual explanation |
| <b>Q30 [Empirical world]</b><br>For Aristotle, an ordinary empirical substance is:<br>A. Pure matter<br>B. A compound of matter and form<br>C. Only potentiality<br>D. A separated universal | B | <b>Why:</b> The empirical natural thing is synolon, though pure actuality and prime matter require qualification.<br><b>Discriminator:</b> A compound of matter and form |
...
## Remedial Practice - Questions 31-34
...
| Question and options | Key | Detailed solution |
| --- | --- | --- |
| <b>Q31 [Remedial - form]</b><br>Which correction is best? Aristotle's form is:<br>A. Separate in a second world<br>B. Merely a mental image<br>C. Immanent in the substance<br>D. Identical with prime matter | C | <b>Why:</b> Aristotle's central move is to internalise form within the concrete compound.<br><b>Discriminator:</b> Immanent in the substance |
| <b>Q32 [Remedial - potentiality]</b><br>Potentiality is best understood as:<br>A. Statistical likelihood<br>B. Anything imaginable<br>C. A moral preference<br>D. A real ontological capacity grounded in the thing | D | <b>Why:</b> An acorn can become an oak but not an elephant; genuine potential is constrained.<br><b>Discriminator:</b> A real ontological capacity grounded in the thing |
| <b>Q33 [Remedial - Plato]</b><br>Which statement correctly qualifies Plato's sensible world?<br>A. It has derivative and changing reality rather than being absolute nothing<br>B. It is the only reality<br>C. It is identical with Forms<br>D. It is self-sufficient | A | <b>Why:</b> Particulars are inferior copies or participants, not sheer non-being.<br><b>Discriminator:</b> It has derivative and changing reality rather than being absolute nothing |
| <b>Q34 [Remedial - mover]</b><br>The Unmoved Mover moves the cosmos:<br>A. By physically pushing matter<br>B. As the final object of desire and thought<br>C. As a material element<br>D. By undergoing change | B | <b>Why:</b> Its causal role is final, not a temporal mechanical intervention.<br><b>Discriminator:</b> As the final object of desire and thought |
...
## Remedial Practice - Questions 35-38
...
| Question and options | Key | Detailed solution |
| --- | --- | --- |
| <b>Q35 [Remedial - substance]</b><br>In the Categories, primary substance is:<br>A. Species<br>B. Genus<br>C. The individual thing<br>D. Predicate | C | <b>Why:</b> This human or this horse is primary; species and genus are secondary substances.<br><b>Discriminator:</b> The individual thing |
| <b>Q36 [Remedial - essence]</b><br>In the Metaphysics, the strongest explanatory candidate for what a thing is is:<br>A. Its market value<br>B. An accidental colour<br>C. A social label<br>D. Form or essence | D | <b>Why:</b> Form explains the what-it-is-to-be of the concrete substance.<br><b>Discriminator:</b> Form or essence |
| <b>Q37 [Remedial - priority]</b><br>Actuality is prior to potentiality chiefly in:<br>A. Definition, explanation, substance, and end<br>B. Every individual temporal sequence<br>C. Spatial location only<br>D. Statistical frequency | A | <b>Why:</b> Actuality need not precede each individual potential stage in clock time.<br><b>Discriminator:</b> Definition, explanation, substance, and end |
| <b>Q38 [Remedial - timelessness]</b><br>Platonic Forms are:<br>A. Spatial and perishable<br>B. Timeless, spaceless, and intelligible<br>C. Dependent on sensation<br>D. Material compounds | B | <b>Why:</b> Their stability is what makes them suitable objects of episteme.<br><b>Discriminator:</b> Timeless, spaceless, and intelligible |
...
## Final Answer Key and Topic Diagnostic

Use the key only after completing the questions. Wrong answers should be classified by concept.

### Key Table

| Questions | Keys | Diagnostic focus |
| --- | --- | --- |
| 1-4 | A, B, C, D | Forms, Good, participation, primary substance |
| 5-8 | A, B, C, D | Hylomorphism, causes, telos, actuality |
| 9-12 | A, B, C, D | Priority, Third Man, critique, motion |
| 13-16 | A, B, C, D | Knowledge, immanent form, prime matter, Mover |
| 17-20 | A, B, C, D | Form priority, development, timelessness, accidents |
| 21-24 | A, B, C, D | One-over-many, Good, table, causal process |
| 25-28 | A, B, C, D | Episteme, identity, becoming, recollection |
| 29-32 | A, B, C, D | Comparison, compound, remedial form and potency |
| 33-36 | A, B, C, D | Derivative reality, Mover, substance, essence |
| 37-38 | A, B | Priority and timeless-spaceless Forms |

### Detailed Teaching

- **Definition errors:** revisit the terminology register.
- **Relation errors:** redraw participation, hylomorphism, or potency-act flow.
- **Comparison errors:** use the six-axis Plato-Aristotle matrix.
- **Evaluation errors:** write objection, reply, and residual problem.

### Must-Know Facts

- Thirty core MCQs cover all syllabus subparts.
- Eight remedial MCQs target the highest-risk confusions.
- All twelve verified 2018-2025 PYQs have model-solution structures.

### UPSC Traps

- **Wrong:** Treat a high score as proof of answer-writing readiness. **Correct:** Complete at least two timed PYQ answers after the MCQs.

**Mains judgement:** After diagnosis, write one 10-marker and one 15-marker under timed conditions.

**Study link:** Complete session -> solved PYQs -> MCQs -> remedial loop -> timed writing.
...
- **10 marks:** Explain the central concepts and distinctions in Plato and Aristotle.
- **15 marks:** Analyse Plato and Aristotle with applications and limitations.
- **20 marks:** Critically examine Plato and Aristotle and provide a balanced judgement.
...
- ⚠️ **Priority:** Primary ownership is 12 of 112 Western parts, with at least one part in every year of the complete corpus.
- ✅ **Required doctrinal depth:** The restored papers add the logical consistency of Plato’s Idea–world relation under Aristotle’s critique and Aristotle’s arguments for the priority of form over matter and actuality over potentiality.
- ../_themes/Substance-across-western.md — Aristotle's *ousia* as the starting point of the entire Western substance thread.
- Rationalism.md — Descartes/Spinoza/Leibniz on substance (the thread continues from Aristotle).
- Kant.md — Kant's categories (causality) and critique of dogmatic metaphysics (both Platonic and Aristotelian).
- ../_themes/Causation-across-schools.md — Aristotle's four causes vs Hume's constant conjunction vs Kant's category vs Indian satkāryavāda.
- ../indian/Nyaya-Vaisesika.md — Nyāya's atomistic theory of creation + God as efficient cause (compare Unmoved Mover).
- ../indian/Samkhya.md — Sāṃkhya's satkāryavāda (effect pre-exists in cause) parallels Aristotle's potentiality.
- Cross-paper: ../../paper-2/socio-political/Forms-of-Government.md (Plato on democracy/philosopher-king).
- Cross-paper: ../../paper-2/philosophy-of-religion/Proofs-for-God.md (Aristotle's Unmoved Mover → Aquinas's cosmological argument).
