# SOCIO-POLITICAL DOSSIER — Optional Advanced Enrichment

> **Status:** Optional layer only. This file is controlled by the firewall in
> [README.md](README.md), [Coverage-Matrix.md](Coverage-Matrix.md),
> [Depth-Map.md](Depth-Map.md), the verbatim
> [official syllabus](../OFFICIAL-UPSC-SYLLABUS-VERBATIM.md), and the
> [2018–2025 socio-political PYQ bank](../paper-2/_PYQ-SocioPolitical-2018-2025.md).

## Non-negotiable firewall

- Named syllabus terms stay in the ten owner files.
- Every 2018–2025 PYQ demand stays answerable from Core.
- Standard arguments, objections, comparisons, India examples, and 10/15/20-mark architecture stay in Core.
