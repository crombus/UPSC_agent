# Industrial, Chemical, Nuclear and CBRN Emergencies - ADVANCED
...
- ⚠️ No GS-III Mains question in the audited 2024-2025 papers directly
  tests this topic (the 2023 oil-pollution question falls outside the
  audited 2024-2025 window). An advanced answer using an industrial/
  chemical case as an illustrative example for 2024 Q17 (resilience)
  should name the NaTech cascading-risk category (Section 2) and the
  enforcement-versus-legislation gap (Section 1) as genuinely advanced
  analytical points.
