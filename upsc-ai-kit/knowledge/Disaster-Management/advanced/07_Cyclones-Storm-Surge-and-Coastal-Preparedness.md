# Cyclones, Storm Surge and Coastal Preparedness - ADVANCED
...
- ⚠️ No GS-III Mains question in the audited 2024-2025 papers directly
  tests cyclone/storm-surge management. An advanced answer to 2024 Q17
  (resilience) using cyclone preparedness as an illustrative case should
  name the warning-to-action conversion gap (Section 2) as a distinct,
  source-evidenced resilience-framework weakness — a stronger point than
  a basic answer's description of NCRMP alone.
...
|---:|---|---:|---|---|---|---|
| 2022 | GS-I | 5 | Colour-coded weather warnings by IMD for cyclone prone areas | Discuss the meaning · 10 marks · 150 words | Routed to owning topic | Prepare context, core dimensions, evidence/examples, counterpoint and a concise conclusion. |
