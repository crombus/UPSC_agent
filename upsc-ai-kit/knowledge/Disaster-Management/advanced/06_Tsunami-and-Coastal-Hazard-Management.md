# Tsunami and Coastal Hazard Management - ADVANCED
...
- ⚠️ No GS-III Mains question in the audited 2024-2025 papers directly
  ...
  question is honestly recorded as adjacent-only (Master Framework
  Section 7). An advanced answer using tsunami risk as an illustrative
  case for 2024 Q17 (resilience) should name the low-frequency/
  readiness-decay dynamic (Section 2) as a distinguishing feature of
  this hazard's resilience challenge, rather than treating all hazards'
  resilience needs as identical.
