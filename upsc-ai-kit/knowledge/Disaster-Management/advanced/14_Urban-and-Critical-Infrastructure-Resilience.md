# Urban and Critical Infrastructure Resilience - ADVANCED
...
- ✅ 2024 Q18 (quoted fully in topic `08`) requires "policies and
  frameworks... that aim at tackling such floods." An advanced answer
  distinguishes itself by naming CDRI's precise institutional purpose
  and its distinction from domestic operational coordination (Section
  3), the cascading cross-lifeline failure pattern (Section 2), and the
  retrofitting-versus-new-build and management-system-reform trade-offs
  (Section 7) — going well beyond a basic answer's naming of CDRI and
  the Urban Flooding Cell alone.
