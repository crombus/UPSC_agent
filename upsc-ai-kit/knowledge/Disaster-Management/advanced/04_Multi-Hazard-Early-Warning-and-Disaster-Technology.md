# Multi-Hazard Early Warning and Disaster Technology - ADVANCED
...
- ⚠️ No GS-III Mains question in the audited 2024-2025 papers directly
  tests early-warning technology. An advanced answer to 2024 Q18 (urban
  flood) should analyse the last-mile/authority-centralisation trade-off
  (Sections 2-3) as part of "policies and frameworks... that aim at
  tackling such floods," rather than only listing forecasting tools; an
  advanced 2024 Q17 (resilience) answer should name "understanding
  risk"/early warning as a resilience element while noting the detection-
  versus-last-mile distinction as evidence of genuine analytical depth.
