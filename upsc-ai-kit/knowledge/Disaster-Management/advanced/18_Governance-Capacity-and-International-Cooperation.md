# Governance, Capacity and International Cooperation - ADVANCED
...
- ✅ **2024 Q17** requires Sendai's global targets (Section 2 of the
  basic file). An advanced answer distinguishes itself by naming the
  national-visibility-versus-localisation gap (Section 2 above) as a
  critical addition to a basic description of Sendai's priorities/
  targets, and by using the precise 2018 UPSC Hyogo-Sendai comparative
  framing (Section 4) as a template for structuring the answer, even
  though that specific question falls outside the audited 2024-2025
  window.
