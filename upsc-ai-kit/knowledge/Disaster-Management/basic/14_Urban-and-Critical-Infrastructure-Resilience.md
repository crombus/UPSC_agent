# Urban and Critical Infrastructure Resilience - MUST-DO
...
- ✅ **2024 Q18** (verbatim, quoted fully in topic `08`) requires
  "policies and frameworks in India that aim at tackling such floods."
  This topic supplies two additional, precisely named frameworks beyond
  topic `08`'s flood-specific tools: **CDRI** (with its four thematic
  areas) and the **Urban Flooding Cell/ULB coordination structure**
  (recommended by NDMA's 2010 guidelines) — both should be named
  explicitly in a complete answer, alongside a note that the 2025
  Amendment Act's Urban DM Authority provision is now operative law and
  would strengthen this institutional layer further where a State has
  actually constituted the authority under it.
