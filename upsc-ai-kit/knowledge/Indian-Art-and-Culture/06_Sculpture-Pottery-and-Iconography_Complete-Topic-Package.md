...
**Plain-language definition:** How to read sculpture is the part of Sculpture, Pottery and Iconography that explains how Six-variable sculpture method fit into one examinable idea.

**Technical definition:** In art-historical analysis, How to read sculpture denotes the source-bounded relationship among Six-variable sculpture method, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> How to read sculpture should be analysed as a relation among Six-variable sculpture method, not as an isolated list of names.
...
**How to use them:** Define read, sculpture, Six-variable; cite material as named evidence; then apply this qualification: Description must connect form to evidence and its limits. Conclude by showing how the distinction supports this answer route: Use the six variables as the method for the whole topic..
...
```closure-flow
START / CONCEPT: How to read sculpture
EXACT TERMS: read | sculpture | Six-variable | material | posture | gesture
MECHANISM / ARGUMENT: relate Six-variable sculpture method through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that use the six variables as the method for the whole topic.
UPSC TRAP / ANSWER-USE: LIMIT: Description must connect form to evidence and its limits.
ANSWER-GRABBING FORMULATION: How to read sculpture converts named evidence into a qualified argument
```
...
**Plain-language definition:** Lost-wax bronze and Harappan labels is the part of Sculpture, Pottery and Iconography that explains how Cire-perdue technique and Harappan label caution fit into one examinable idea.

**Technical definition:** In art-historical analysis, Lost-wax bronze and Harappan labels denotes the source-bounded relationship among Cire-perdue technique and Harappan label caution, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Lost-wax bronze and Harappan labels should be analysed as a relation among Cire-perdue technique and Harappan label caution, not as an isolated list of names.
...
**How to use them:** Define Lost-wax, bronze, Harappan; cite labels as named evidence; then apply this qualification: Technique is fact; object identity remains interpretive. Conclude by showing how the distinction supports this answer route: Separate secure manufacture from disputed meaning..
...
```closure-flow
START / CONCEPT: Lost-wax bronze and Harappan labels
EXACT TERMS: Lost-wax | bronze | Harappan | labels | Cire-perdue | technique
MECHANISM / ARGUMENT: relate Cire-perdue technique and Harappan label caution through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that separate secure manufacture from disputed meaning.
UPSC TRAP / ANSWER-USE: LIMIT: Technique is fact; object identity remains interpretive.
ANSWER-GRABBING FORMULATION: Lost-wax bronze and Harappan labels converts named evidence into a qualified argument
```
...
**Plain-language definition:** Pottery as chronological evidence is the part of Sculpture, Pottery and Iconography that explains how Pottery sequence and Northern Black Polished Ware fit into one examinable idea.

**Technical definition:** In art-historical analysis, Pottery as chronological evidence denotes the source-bounded relationship among Pottery sequence and Northern Black Polished Ware, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Pottery as chronological evidence should be analysed as a relation among Pottery sequence and Northern Black Polished Ware, not as an isolated list of names.
...
**How to use them:** Define Pottery, chronological, sequence; cite Northern as named evidence; then apply this qualification: Harappan Red Ware, Black-and-Red Ware and NBPW are distinct. Conclude by showing how the distinction supports this answer route: Build a material-culture sequence..
...
```closure-flow
START / CONCEPT: Pottery as chronological evidence
EXACT TERMS: Pottery | chronological | sequence | Northern | Black | Polished
MECHANISM / ARGUMENT: relate Pottery sequence and Northern Black Polished Ware through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that build a material-culture sequence.
UPSC TRAP / ANSWER-USE: LIMIT: Harappan Red Ware, Black-and-Red Ware and NBPW are distinct.
ANSWER-GRABBING FORMULATION: Pottery as chronological evidence converts named evidence into a qualified argument
```
...
**Plain-language definition:** Yaksha and auspicious tree figures is the part of Sculpture, Pottery and Iconography that explains how Yaksha, Yakshi and Shalabhanjika fit into one examinable idea.

**Technical definition:** In art-historical analysis, Yaksha and auspicious tree figures denotes the source-bounded relationship among Yaksha, Yakshi and Shalabhanjika, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Yaksha and auspicious tree figures should be analysed as a relation among Yaksha, Yakshi and Shalabhanjika, not as an isolated list of names.
...
**How to use them:** Define Yaksha, auspicious, tree; cite figures as named evidence; then apply this qualification: Absorption across religions does not erase local cult roots. Conclude by showing how the distinction supports this answer route: Use motif continuity without claiming unchanged meaning..
...
```closure-flow
START / CONCEPT: Yaksha and auspicious tree figures
EXACT TERMS: Yaksha | auspicious | tree | figures | Yakshi | Shalabhanjika
MECHANISM / ARGUMENT: relate Yaksha, Yakshi and Shalabhanjika through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that use motif continuity without claiming unchanged meaning.
UPSC TRAP / ANSWER-USE: LIMIT: Absorption across religions does not erase local cult roots.
ANSWER-GRABBING FORMULATION: Yaksha and auspicious tree figures converts named evidence into a qualified argument
```
...
**Plain-language definition:** Gandhara's layered idiom is the part of Sculpture, Pottery and Iconography that explains how Gandhara school fit into one examinable idea.

**Technical definition:** In art-historical analysis, Gandhara's layered idiom denotes the source-bounded relationship among Gandhara school, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Gandhara's layered idiom should be analysed as a relation among Gandhara school, not as an isolated list of names.
...
**How to use them:** Define Gandhara's, layered, idiom; cite Gandhara as named evidence; then apply this qualification: Name Greco-Bactrian and Central Asian strands separately. Conclude by showing how the distinction supports this answer route: Prepare the direct 2019 route..
...
```closure-flow
START / CONCEPT: Gandhara's layered idiom
EXACT TERMS: Gandhara's | layered | idiom | Gandhara | school | sculpture
MECHANISM / ARGUMENT: relate Gandhara school through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that prepare the direct 2019 route.
UPSC TRAP / ANSWER-USE: LIMIT: Name Greco-Bactrian and Central Asian strands separately.
ANSWER-GRABBING FORMULATION: Gandhara's layered idiom converts named evidence into a qualified argument
```
...
**Plain-language definition:** Mathura's indigenous breadth is the part of Sculpture, Pottery and Iconography that explains how Mathura school fit into one examinable idea.

**Technical definition:** In art-historical analysis, Mathura's indigenous breadth denotes the source-bounded relationship among Mathura school, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mathura's indigenous breadth should be analysed as a relation among Mathura school, not as an isolated list of names.
...
**How to use them:** Define Mathura's, indigenous, breadth; cite Mathura as named evidence; then apply this qualification: Religious plurality is a key discriminator. Conclude by showing how the distinction supports this answer route: Contrast material, scope and attribute grammar..
...
```closure-flow
START / CONCEPT: Mathura's indigenous breadth
EXACT TERMS: Mathura's | indigenous | breadth | Mathura | school | developed
MECHANISM / ARGUMENT: relate Mathura school through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that contrast material, scope and attribute grammar.
UPSC TRAP / ANSWER-USE: LIMIT: Religious plurality is a key discriminator.
ANSWER-GRABBING FORMULATION: Mathura's indigenous breadth converts named evidence into a qualified argument
```
...
**Plain-language definition:** Amaravati's narrative dynamism is the part of Sculpture, Pottery and Iconography that explains how Amaravati school fit into one examinable idea.

**Technical definition:** In art-historical analysis, Amaravati's narrative dynamism denotes the source-bounded relationship among Amaravati school, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Amaravati's narrative dynamism should be analysed as a relation among Amaravati school, not as an isolated list of names.
...
**How to use them:** Define Amaravati's, narrative, dynamism; cite Amaravati as named evidence; then apply this qualification: Do not borrow Gandhara's foreign-influence formula. Conclude by showing how the distinction supports this answer route: Complete the three-school comparison..
...
```closure-flow
START / CONCEPT: Amaravati's narrative dynamism
EXACT TERMS: Amaravati's | narrative | dynamism | Amaravati | school | Vengi
MECHANISM / ARGUMENT: relate Amaravati school through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that complete the three-school comparison.
UPSC TRAP / ANSWER-USE: LIMIT: Do not borrow Gandhara's foreign-influence formula.
ANSWER-GRABBING FORMULATION: Amaravati's narrative dynamism converts named evidence into a qualified argument
```
...
**Plain-language definition:** Aniconism and the iconic shift is the part of Sculpture, Pottery and Iconography that explains how Aniconic symbolism and Parallel iconic shift fit into one examinable idea.

**Technical definition:** In art-historical analysis, Aniconism and the iconic shift denotes the source-bounded relationship among Aniconic symbolism and Parallel iconic shift, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Aniconism and the iconic shift should be analysed as a relation among Aniconic symbolism and Parallel iconic shift, not as an isolated list of names.
...
**How to use them:** Define Aniconism, iconic, shift; cite Aniconic as named evidence; then apply this qualification: A symbol is not absence, and priority remains debated. Conclude by showing how the distinction supports this answer route: Explain representational change cautiously..
...
```closure-flow
START / CONCEPT: Aniconism and the iconic shift
EXACT TERMS: Aniconism | iconic | shift | Aniconic | symbolism | Parallel
MECHANISM / ARGUMENT: relate Aniconic symbolism and Parallel iconic shift through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that explain representational change cautiously.
UPSC TRAP / ANSWER-USE: LIMIT: A symbol is not absence, and priority remains debated.
ANSWER-GRABBING FORMULATION: Aniconism and the iconic shift converts named evidence into a qualified argument
```
...
**Plain-language definition:** Gupta restraint and dating limits is the part of Sculpture, Pottery and Iconography that explains how Gupta Sarnath idiom fit into one examinable idea.

**Technical definition:** In art-historical analysis, Gupta restraint and dating limits denotes the source-bounded relationship among Gupta Sarnath idiom, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Gupta restraint and dating limits should be analysed as a relation among Gupta Sarnath idiom, not as an isolated list of names.
...
**How to use them:** Define Gupta, restraint, dating; cite limits as named evidence; then apply this qualification: Late or post-Gupta is safer for Sultanganj. Conclude by showing how the distinction supports this answer route: Add a chronological bridge to southern sculpture..
...
```closure-flow
START / CONCEPT: Gupta restraint and dating limits
EXACT TERMS: Gupta | restraint | dating | limits | Sarnath | idiom
MECHANISM / ARGUMENT: relate Gupta Sarnath idiom through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that add a chronological bridge to southern sculpture.
UPSC TRAP / ANSWER-USE: LIMIT: Late or post-Gupta is safer for Sultanganj.
ANSWER-GRABBING FORMULATION: Gupta restraint and dating limits converts named evidence into a qualified argument
```
...
**Plain-language definition:** Nataraja from Aihole to Chola is the part of Sculpture, Pottery and Iconography that explains how Nataraja origin and peak and Nataraja attribute system fit into one examinable idea.

**Technical definition:** In art-historical analysis, Nataraja from Aihole to Chola denotes the source-bounded relationship among Nataraja origin and peak and Nataraja attribute system, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Nataraja from Aihole to Chola should be analysed as a relation among Nataraja origin and peak and Nataraja attribute system, not as an isolated list of names.
...
**How to use them:** Define Nataraja, from, Aihole; cite Chola as named evidence; then apply this qualification: Distinguish origin, peak and iconographic meaning. Conclude by showing how the distinction supports this answer route: Build a full named-image answer..
...
```closure-flow
START / CONCEPT: Nataraja from Aihole to Chola
EXACT TERMS: Nataraja | from | Aihole | Chola | origin | peak
MECHANISM / ARGUMENT: relate Nataraja origin and peak and Nataraja attribute system through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that build a full named-image answer.
UPSC TRAP / ANSWER-USE: LIMIT: Distinguish origin, peak and iconographic meaning.
ANSWER-GRABBING FORMULATION: Nataraja from Aihole to Chola converts named evidence into a qualified argument
```
...
**Plain-language definition:** Lion and bull across media is the part of Sculpture, Pottery and Iconography that explains how Lion and bull programme and Nandi as architecture fit into one examinable idea.

**Technical definition:** In art-historical analysis, Lion and bull across media denotes the source-bounded relationship among Lion and bull programme and Nandi as architecture, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Lion and bull across media should be analysed as a relation among Lion and bull programme and Nandi as architecture, not as an isolated list of names.
...
**How to use them:** Define Lion, bull, media; cite programme as named evidence; then apply this qualification: Keep Harappan, Buddhist and imperial claims source-separated. Conclude by showing how the distinction supports this answer route: Prepare the direct 2022 animal-symbol route..
...
```closure-flow
START / CONCEPT: Lion and bull across media
EXACT TERMS: Lion | bull | media | programme | Nandi | architecture
MECHANISM / ARGUMENT: relate Lion and bull programme and Nandi as architecture through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that prepare the direct 2022 animal-symbol route.
UPSC TRAP / ANSWER-USE: LIMIT: Keep Harappan, Buddhist and imperial claims source-separated.
ANSWER-GRABBING FORMULATION: Lion and bull across media converts named evidence into a qualified argument
```
...
**Plain-language definition:** Nandi, Yali and Vyala is the part of Sculpture, Pottery and Iconography that explains how Nandi as architecture and Yali and Vyala distinction fit into one examinable idea.

**Technical definition:** In art-historical analysis, Nandi, Yali and Vyala denotes the source-bounded relationship among Nandi as architecture and Yali and Vyala distinction, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Nandi, Yali and Vyala should be analysed as a relation among Nandi as architecture and Yali and Vyala distinction, not as an isolated list of names.
...
**How to use them:** Define Nandi, Yali, Vyala; cite architecture as named evidence; then apply this qualification: Placed architecture and hybrid ornament solve different problems. Conclude by showing how the distinction supports this answer route: Link iconography to temple planning..
...
```closure-flow
START / CONCEPT: Nandi, Yali and Vyala
EXACT TERMS: Nandi | Yali | Vyala | architecture | distinction | Shaiva
MECHANISM / ARGUMENT: relate Nandi as architecture and Yali and Vyala distinction through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that link iconography to temple planning.
UPSC TRAP / ANSWER-USE: LIMIT: Placed architecture and hybrid ornament solve different problems.
ANSWER-GRABBING FORMULATION: Nandi, Yali and Vyala converts named evidence into a qualified argument
```
...
**Plain-language definition:** Sculpture as social evidence is the part of Sculpture, Pottery and Iconography that explains how Temple sculpture as social evidence fit into one examinable idea.

**Technical definition:** In art-historical analysis, Sculpture as social evidence denotes the source-bounded relationship among Temple sculpture as social evidence, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Sculpture as social evidence should be analysed as a relation among Temple sculpture as social evidence, not as an isolated list of names.
...
**How to use them:** Define Sculpture, social, Temple; cite Dancers as named evidence; then apply this qualification: Commissioned visibility is not representative social data. Conclude by showing how the distinction supports this answer route: Prepare the direct 2022 social-life route..
...
```closure-flow
START / CONCEPT: Sculpture as social evidence
EXACT TERMS: Sculpture | social | Temple | Dancers | musicians | teachers
MECHANISM / ARGUMENT: relate Temple sculpture as social evidence through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that prepare the direct 2022 social-life route.
UPSC TRAP / ANSWER-USE: LIMIT: Commissioned visibility is not representative social data.
ANSWER-GRABBING FORMULATION: Sculpture as social evidence converts named evidence into a qualified argument
```
...
**Plain-language definition:** Terracotta's long material arc is the part of Sculpture, Pottery and Iconography that explains how Terracotta continuity fit into one examinable idea.

**Technical definition:** In art-historical analysis, Terracotta's long material arc denotes the source-bounded relationship among Terracotta continuity, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Terracotta's long material arc should be analysed as a relation among Terracotta continuity, not as an isolated list of names.
...
**How to use them:** Define Terracotta's, long, material; cite Terracotta as named evidence; then apply this qualification: Object continuity does not prove unchanged community or meaning. Conclude by showing how the distinction supports this answer route: Add the pottery and living-material dimension..
...
```closure-flow
START / CONCEPT: Terracotta's long material arc
EXACT TERMS: Terracotta's | long | material | Terracotta | continuity | moves
MECHANISM / ARGUMENT: relate Terracotta continuity through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that add the pottery and living-material dimension.
UPSC TRAP / ANSWER-USE: LIMIT: Object continuity does not prove unchanged community or meaning.
ANSWER-GRABBING FORMULATION: Terracotta's long material arc converts named evidence into a qualified argument
```
...
**Plain-language definition:** Verified PYQs and final answer spine is the part of Sculpture, Pottery and Iconography that explains how Verified sculpture PYQ routes and Six-variable sculpture method fit into one examinable idea.

**Technical definition:** In art-historical analysis, Verified PYQs and final answer spine denotes the source-bounded relationship among Verified sculpture PYQ routes and Six-variable sculpture method, classified by form, medium, patronage, performance context and evidentiary limit.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Verified PYQs and final answer spine should be analysed as a relation among Verified sculpture PYQ routes and Six-variable sculpture method, not as an isolated list of names.
...
**How to use them:** Define PYQs, spine, sculpture; cite routes as named evidence; then apply this qualification: Do not solve the provisional 2026 objective route. Conclude by showing how the distinction supports this answer route: Integrate method, evidence, comparison and qualification..
...
```closure-flow
START / CONCEPT: Verified PYQs and final answer spine
EXACT TERMS: PYQs | spine | sculpture | routes | Six-variable | routed
MECHANISM / ARGUMENT: relate Verified sculpture PYQ routes and Six-variable sculpture method through form, context and patronage
CONSEQUENCE / CONTRAST: This relation supports the answer route that integrate method, evidence, comparison and qualification.
UPSC TRAP / ANSWER-USE: LIMIT: Do not solve the provisional 2026 objective route.
ANSWER-GRABBING FORMULATION: Verified PYQs and final answer spine converts named evidence into a qualified argument
```
...
### Sculpture, Pottery and Iconography: RAPID CHRONOLOGY AND ARGUMENT MAP

1. **Six-variable sculpture method:** Read sculpture through material, posture or gesture, iconographic attribute, patron, site context and cross-site comparison; this converts visual description into bounded historical analysis.
2. **Cire-perdue technique:** In lost-wax casting a wax model is clay-coated, heated so the wax drains away, and filled with molten metal; the technique is evidenced from the Indus tradition and later enabled free-standing bronzes.
3. **Harappan label caution:** Pashupati, Mother Goddess and Priest-King are modern interpretive labels for Harappan objects, not identities read from the undeciphered script.
4. **Pottery sequence:** The source spine runs from Neolithic hand-made coarse ware through Chalcolithic painted wares, Harappan Red Ware and Painted Grey Ware to Northern Black Polished Ware.
5. **Northern Black Polished Ware:** NBPW is fine lustrous tableware associated especially with early historic urbanisation; it is not exclusively a Mauryan court product and is not the same as Black-and-Red Ware.
6. **Yaksha, Yakshi and Shalabhanjika:** Yaksha and Yakshi figures connect water, fertility, trees and wilderness with multiple religions; the Shalabhanjika is a tree-holding yakshi used as an auspicious bracket figure.
7. **Gandhara school:** Gandhara sculpture used bluish-grey sandstone and later stucco for a mainly Buddhist programme whose drapery, hair and body modelling show Hellenistic, Parthian and Central Asian layers.
8. **Mathura school:** Mathura developed in spotted red sandstone, served Buddhist, Hindu and Jain patrons, and used attributes or avayudhas and emphatic halos within an indigenous visual grammar.
9. **Amaravati school:** Amaravati or Vengi sculpture used dynamic narrative relief, greenish-white limestone and extensive tribhanga within a mainly Buddhist Satavahana and later Ikshvaku setting.
10. **Aniconic symbolism:** Early Buddhist programmes marked the Buddha through symbols such as the empty throne, Bodhi tree, wheel, footprints and stupa; an empty seat is a presence-marker, not a missing figure.
11. **Parallel iconic shift:** Anthropomorphic Buddha images emerged in broadly overlapping early-CE contexts at Gandhara and Mathura, so neither school should be declared the uncontested sole origin.
12. **Gupta Sarnath idiom:** The Sarnath school used cream-coloured sandstone and metal for subtly modelled, thinly draped figures; the Sultanganj copper Buddha is safer described as late or post-Gupta.
13. **Nataraja origin and peak:** The earliest known Nataraja example in the owner is at Ravana Phadi, Aihole, under early Chalukya rule; Chola bronzes perfected and ritualised the form rather than originating it.
14. **Nataraja attribute system:** Damaru signifies creation, fire destruction, abhaya reassurance, the raised foot release, Apasmara ignorance and the surrounding aureole cyclical time; each attribute must be read in position.
15. **Lion and bull programme:** Rampurva preserves an inscribed Ashokan lion pillar and an uninscribed bull pillar, while the Sarnath abacus places lion and bull within a wider Buddhist and imperial symbol system.
16. **Nandi as architecture:** At Shaiva temples the bull is not merely ornament: a Nandi mandapa or pavilion stands axially before the sanctum, as at Brihadishvara, Ellora Kailasa and Ramappa.
17. **Yali and Vyala distinction:** Yali is a composite lion-based guardian associated especially with Vijayanagara pillars and Nayaka identity, while Khajuraho Vyalas are hybrid imaginary animals with lions' bodies.
18. **Temple sculpture as social evidence:** Dancers, musicians, teachers, couples and ritual scenes show what patrons selected for visibility; carvings are commissioned representations, not statistical photographs of medieval society.
19. **Terracotta continuity:** Terracotta moves from Harappan figurines and plough models to Chandraketugarh craft, Gupta plaques and Bengal architectural relief, linking domestic objects, urban workshops and façades.
20. **Verified sculpture PYQ routes:** The routed direct Mains cluster comprises 2019 Gandhara external elements and the 2022 demands on medieval temple sculpture as social evidence and lion-bull significance.

### Sculpture, Pottery and Iconography: CLOSE-OPTION AND CAUSAL TRAPS
...
### Sculpture, Pottery and Iconography: ANSWER-WRITING SPINE
...
### Sculpture, Pottery and Iconography: CURRENT-LINK BOUNDARY

No directly relevant live official item was verified for this topic on 2026-09-01. The package therefore says 'no verified live item' and does not invent a date, status, project or figure.
