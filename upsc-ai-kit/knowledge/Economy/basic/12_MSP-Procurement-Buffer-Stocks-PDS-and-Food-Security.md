# MSP, Procurement, Buffer Stocks, PDS and Food Security - MUST-DO
...
- ✅ Food security has availability, access, utilisation or nutrition and stability
  dimensions.
- ✅ CACP uses more than one cost concept in MSP analysis; do not equate the broader
  C2 measure with A2+FL or assume that an announced MSP itself creates procurement.
...
- 📰 The Survey reports 49,796 storage projects sanctioned as of 31 Dec 2025.
- 📰 The Survey emphasises storage, market linkages, productivity and climate-risk management
  in food policy.
- 📰 The 2024 GS-III PYQ asked the role and storage challenges of buffer stocks.

⚠️ **Interpretation caution:** Expanding procurement without crop and regional
diversification can intensify water stress and stock imbalance.
...
- ⚠️ **Millet route:** link climate resilience and lower input needs (where locally
  suitable) with dietary diversity and micronutrients, then add the constraints of
  yield, processing, consumer demand, procurement and market access.

## 10. Mains angles

- ⚠️ Frame reform around remunerative production, efficient procurement, scientific storage
  and nutritional access.
- ⚠️ Distinguish income support from price support and physical procurement.
- ⚠️ Recommend diversified procurement, modern silos, transparent releases and nutrition-
  sensitive PDS.
