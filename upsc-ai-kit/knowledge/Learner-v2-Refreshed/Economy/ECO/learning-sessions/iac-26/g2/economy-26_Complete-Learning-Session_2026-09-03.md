---
title: "Economic Survey Synthesis and Current Macro Dashboard — Learner-v2 Refreshed"
topic_key: economy-26
cover_image: assets/economy-26_Teaching-Navigation_2026-09-03.png
---
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Economy\basic\26_Economic-Survey-Synthesis-and-Current-Macro-Dashboard.md`  
**Substantive canonical provenance owner:** `upsc-ai-kit\knowledge\Economy\26_Economic-Survey-Synthesis-and-Current-Macro-Dashboard_Learner-V2-Complete-Topic-Package.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Economy\advanced\26_Economic-Survey-Synthesis-and-Current-Macro-Dashboard.md`  
...
![Refreshed teaching navigation](assets/economy-26_Teaching-Navigation_2026-09-03.png)
...
- **Must remember:** A current macro dashboard must reconcile growth, inflation, employment, fiscal, monetary, external and sectoral indicators using compatible vintages; Economic Survey analysis is distinct from Budget accounting and policy authority.
- **Close distinction:** Survey projection is not Budget estimate, advance estimate is not final actual, calendar year is not financial year, nominal level is not real growth, and one high-frequency indicator is not the whole economy.
- **Formula / status / evidence / causal limit:** Attach source, release date, reference period, unit, denominator and provisional/revised/final status to every number; never mix Budget or Survey editions and distinguish diagnosis/recommendation from enacted policy.
...
MUST REMEMBER: A current macro dashboard must reconcile growth, inflation, employment,...
```
...
CLOSE DISTINCTION: Survey projection is not Budget estimate, advance estimate is not...
```
...
EVIDENCE LIMIT: FORMULA / STATUS / CAUSATION: Attach source, release date, reference...
```
