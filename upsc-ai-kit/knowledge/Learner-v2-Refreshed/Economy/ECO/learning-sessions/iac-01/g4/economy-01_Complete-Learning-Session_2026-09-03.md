...
### ECONOMY EVIDENCE AND CURRENT-STATUS CONTROL
...
### SESSION 1 — FOUNDATION — DOMESTIC PRODUCTION AND RESIDENT INCOME

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** GDP follows production within domestic territory, whereas GNP follows income accruing to normal residents; the sign of net factor income from abroad determines whether GNP is above or below GDP.

**Technical definition:** GDP at market prices can be read from final expenditure as C + I + G + (X - M); imports are subtracted because consumption and investment totals can contain foreign production.
...
**How to use them:** Frame the answer through FOUNDATION; define Domestic production, connect resident income with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.

#### VISUAL FIRST

```text
DOMESTIC PRODUCTION AND RESIDENT INCOME
...
#### CLOSING RECALL FLOW — FOUNDATION — DOMESTIC PRODUCTION AND RESIDENT INCOME

```text
START / CONCEPT: FOUNDATION — Domestic production and resident income
        |
        v
EXACT TERMS: FOUNDATION · Domestic production · resident income · Mechanism chain · Qualified use · GDP
        |
        v
MECHANISM / ARGUMENT: GDP at market prices can be read from final expenditure as C + I + G + (X - M); imports are subtracted because consumption and investment totals can contain foreign production.
        |
        v
CONSEQUENCE / CONTRAST: Do not treat every market transaction as current production; old-asset resale and transfers are excluded.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: territory-residence boundary - GDP expenditure identity Qualified use.
        |
        v
ANSWER-GRABBING FORMULATION: GDP follows production within domestic territory, whereas GNP follows income accruing to normal residents; the sign of net factor income from abroad determines whether GNP is above or below GDP.
```
### SESSION 2 — FOUNDATION — FINAL EXPENDITURE IDENTITY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: GDP-GVA reconciliation Qualified use: Separate measurement change from real economic change before drawing a growth conclusion.

**Technical definition:** GDP at market prices equals GVA at basic prices plus product taxes minus product subsidies, so changing net product taxes can make GDP and GVA growth diverge.
...
- **FOUNDATION**
- **Final expenditure identity**
- **Mechanism chain**
- **Qualified use**
- **GDP**
- **GVA**

**How to use them:** Frame the answer through FOUNDATION; define Final expenditure identity, connect Mechanism chain with Qualified use to explain the mechanism, and use GDP for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — FINAL EXPENDITURE IDENTITY

```text
START / CONCEPT: FOUNDATION — Final expenditure identity
        |
        v
EXACT TERMS: FOUNDATION · Final expenditure identity · Mechanism chain · Qualified use · GDP · GVA
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: GDP-GVA reconciliation Qualified use: Separate measurement change from real economic change before drawing a growth conclusion.
        |
        v
CONSEQUENCE / CONTRAST: GDP at market prices equals GVA at basic prices plus product taxes minus product subsidies, so changing net product taxes can make GDP and GVA growth diverge.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: do not equate domestic territory with resident income.
        |
        v
ANSWER-GRABBING FORMULATION: Do not equate domestic territory with resident income; GDP and GNP answer different boundary questions.
```
### SESSION 3 — FOUNDATION — PRODUCER VALUE ADDED AND PURCHASER PRICES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: Gross-net distinction Qualified use: Use one named Indian revision, one method limitation and one welfare qualification.

**Technical definition:** Mains: Use one named Indian revision, one method limitation and one welfare qualification.
...
**How to use them:** Frame the answer through FOUNDATION; define Producer value added, connect purchaser prices with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — PRODUCER VALUE ADDED AND PURCHASER PRICES

```text
START / CONCEPT: FOUNDATION — Producer value added and purchaser prices
        |
        v
EXACT TERMS: FOUNDATION · Producer value added · purchaser prices · Mechanism chain · Qualified use · Gross
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Gross-net distinction Qualified use: Use one named Indian revision, one method limitation and one welfare qualification.
        |
        v
CONSEQUENCE / CONTRAST: Do not say net measures include depreciation; net measures deduct consumption of fixed capital.
        |
        v
UPSC TRAP / ANSWER-USE: Mains: Use one named Indian revision, one method limitation and one welfare qualification.
        |
        v
ANSWER-GRABBING FORMULATION: Gross measures include consumption of fixed capital, while NDP equals GDP minus depreciation and NNP equals GNP minus depreciation.
```
### SESSION 4 — CORE — GROSS OUTPUT AND DEPRECIATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Production or value-added, income and expenditure methods should theoretically converge because produced output creates income and is purchased as final expenditure; each method has a different data risk.

**Technical definition:** Mechanism chain: Three measurement methods Qualified use: Open with the accounting boundary, reconcile the formula, and only then assess performance.
...
**How to use them:** Frame the answer through Gross output; define depreciation, connect Mechanism chain with Qualified use to explain the mechanism, and use 2011-12 for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — GROSS OUTPUT AND DEPRECIATION

```text
START / CONCEPT: CORE — Gross output and depreciation
        |
        v
EXACT TERMS: Gross output · depreciation · Mechanism chain · Qualified use · 2011-12 · 2022-23
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Three measurement methods Qualified use: Open with the accounting boundary, reconcile the formula, and only then assess performance.
        |
        v
CONSEQUENCE / CONTRAST: Do not splice 2011-12-base and 2022-23-base growth or levels without an official comparable series.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: do not splice 2011-12-base and 2022-23-base growth or levels without an official comparable series.
        |
        v
ANSWER-GRABBING FORMULATION: Production or value-added, income and expenditure methods should theoretically converge because produced output creates income and is purchased as final expenditure; each method has a different data risk.
```
### SESSION 5 — CORE — THREE ROUTES TO THE SAME AGGREGATE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: Double-counting boundary Qualified use: Separate measurement change from real economic change before drawing a growth conclusion.

**Technical definition:** Technically, CORE — Three routes to the same aggregate is analysed by relating Three routes to the same aggregate to Mechanism chain, then testing the relationship through Qualified use and GDP.
...
**How to use them:** Frame the answer through Three routes to the same aggregate; define Mechanism chain, connect Qualified use with GDP to explain the mechanism, and use Double-counting for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — THREE ROUTES TO THE SAME AGGREGATE

```text
START / CONCEPT: CORE — Three routes to the same aggregate
        |
        v
EXACT TERMS: Three routes to the same aggregate · Mechanism chain · Qualified use · GDP · Double-counting · Qualified
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Double-counting boundary Qualified use: Separate measurement change from real economic change before drawing a growth conclusion.
        |
        v
CONSEQUENCE / CONTRAST: The production method sums value added at each stage rather than gross sales, preventing the value of intermediate inputs from being counted again inside final output.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: do not use nominal GDP growth as proof of volume growth or welfare improvement.
        |
        v
ANSWER-GRABBING FORMULATION: Do not use nominal GDP growth as proof of volume growth or welfare improvement.
```
### SESSION 6 — CORE — VALUE ADDED, INCOME COVERAGE AND INFORMALITY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: Income-side coverage - Expenditure-side boundary Qualified use: Use one named Indian revision, one method limitation and one welfare qualification.

**Technical definition:** The income method adds wages, profits, rent and mixed income, but India's large informal sector requires survey, administrative and benchmark-indicator estimation rather than complete enterprise accounts.
...
**How to use them:** Frame the answer through Value added; define income coverage, connect informality with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.

#### VISUAL FIRST

```text
VALUE ADDED, INCOME COVERAGE AND INFORMALITY
...
#### CLOSING RECALL FLOW — CORE — VALUE ADDED, INCOME COVERAGE AND INFORMALITY

```text
START / CONCEPT: CORE — Value added, income coverage and informality
        |
        v
EXACT TERMS: Value added · income coverage · informality · Mechanism chain · Qualified use · India's
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Income-side coverage - Expenditure-side boundary Qualified use: Use one named Indian revision, one method limitation and one welfare qualification.
        |
        v
CONSEQUENCE / CONTRAST: Do not describe every intangible outlay as investment; national-accounting capitalisation has a defined boundary.
        |
        v
UPSC TRAP / ANSWER-USE: Mains: Use one named Indian revision, one method limitation and one welfare qualification.
        |
        v
ANSWER-GRABBING FORMULATION: The income method adds wages, profits, rent and mixed income, but India's large informal sector requires survey, administrative and benchmark-indicator estimation rather than complete enterprise accounts.
```
### SESSION 7 — CORE — FINAL EXPENDITURE AND INTERMEDIATE EXCLUSION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Nominal GDP uses current prices, real GDP uses constant or base-year prices, and the GDP deflator equals nominal GDP divided by real GDP multiplied by 100.

**Technical definition:** Mechanism chain: Nominal-real-deflator triangle Qualified use: Open with the accounting boundary, reconcile the formula, and only then assess performance.
...
**How to use them:** Frame the answer through Final expenditure; define intermediate exclusion, connect Mechanism chain with Qualified use to explain the mechanism, and use Nominal GDP for the decisive comparison or qualification.

#### VISUAL FIRST

```text
FINAL EXPENDITURE AND INTERMEDIATE EXCLUSION
...
#### CLOSING RECALL FLOW — CORE — FINAL EXPENDITURE AND INTERMEDIATE EXCLUSION

```text
START / CONCEPT: CORE — Final expenditure and intermediate exclusion
        |
        v
EXACT TERMS: Final expenditure · intermediate exclusion · Mechanism chain · Qualified use · Nominal GDP · GDP
        |
        v
MECHANISM / ARGUMENT: The operative mechanism is that nominal GDP uses current prices, real GDP uses constant or base-year prices.
        |
        v
CONSEQUENCE / CONTRAST: Mechanism chain: Nominal-real-deflator triangle Qualified use: Open with the accounting boundary, reconcile the formula, and only then assess performance.
        |
        v
UPSC TRAP / ANSWER-USE: Do not compare PPP and market-exchange-rate ranks without the reference year and purpose.
        |
        v
ANSWER-GRABBING FORMULATION: Nominal GDP uses current prices, real GDP uses constant or base-year prices, and the GDP deflator equals nominal GDP divided by real GDP multiplied by 100.
```
### SESSION 8 — CORE — NOMINAL OUTPUT, REAL OUTPUT AND THE DEFLATOR

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: Production boundary Qualified use: Separate measurement change from real economic change before drawing a growth conclusion.

**Technical definition:** Current final goods and services, applicable imputations and government services valued mainly by production cost enter GDP; intermediate goods already embodied in final output do not.
...
**How to use them:** Frame the answer through Nominal output; define real output, connect the deflator with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — NOMINAL OUTPUT, REAL OUTPUT AND THE DEFLATOR

```text
START / CONCEPT: CORE — Nominal output, real output and the deflator
        |
        v
EXACT TERMS: Nominal output · real output · the deflator · Mechanism chain · Qualified use · GDP
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Production boundary Qualified use: Separate measurement change from real economic change before drawing a growth conclusion.
        |
        v
CONSEQUENCE / CONTRAST: Do not treat a First Advance Estimate or projection as a final actual.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: current final goods and services, applicable imputations and government services valued mainly by production...
        |
        v
ANSWER-GRABBING FORMULATION: Current final goods and services, applicable imputations and government services valued mainly by production cost enter GDP; intermediate goods already embodied in final output do not.
```
### SESSION 9 — CORE — INSIDE THE PRODUCTION BOUNDARY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Pure transfer payments and resale of an existing asset do not add current production, although the current brokerage or service associated with a resale can add value.

**Technical definition:** Mechanism chain: Transfer and resale exclusions Qualified use: Use one named Indian revision, one method limitation and one welfare qualification.
...
**How to use them:** Frame the answer through Inside the production boundary; define Mechanism chain, connect Qualified use with Pure to explain the mechanism, and use Indian for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — INSIDE THE PRODUCTION BOUNDARY

```text
START / CONCEPT: CORE — Inside the production boundary
        |
        v
EXACT TERMS: Inside the production boundary · Mechanism chain · Qualified use · Pure · Indian · Transfer
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Transfer and resale exclusions Qualified use: Use one named Indian revision, one method limitation and one welfare qualification.
        |
        v
CONSEQUENCE / CONTRAST: Do not count intermediate inputs again inside final output.
        |
        v
UPSC TRAP / ANSWER-USE: Mains: Use one named Indian revision, one method limitation and one welfare qualification.
        |
        v
ANSWER-GRABBING FORMULATION: Pure transfer payments and resale of an existing asset do not add current production, although the current brokerage or service associated with a resale can add value.
```
### SESSION 10 — CORE — TRANSFERS, RESALES AND CURRENT SERVICES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Conventional GDP excludes much unpaid household work and does not directly measure distribution, ecological depletion, service quality or every dimension of welfare.

**Technical definition:** Mechanism chain: Unpaid work and welfare limit Qualified use: Open with the accounting boundary, reconcile the formula, and only then assess performance.
...
**How to use them:** Frame the answer through Transfers; define resales, connect current services with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — TRANSFERS, RESALES AND CURRENT SERVICES

```text
START / CONCEPT: CORE — Transfers, resales and current services
        |
        v
EXACT TERMS: Transfers · resales · current services · Mechanism chain · Qualified use · Conventional GDP
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Unpaid work and welfare limit Qualified use: Open with the accounting boundary, reconcile the formula, and only then assess performance.
        |
        v
CONSEQUENCE / CONTRAST: Do not infer that high saving guarantees high growth when ICOR and implementation quality can weaken conversion.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: conventional GDP excludes much unpaid household work and does not directly measure distribution, ecological...
        |
        v
ANSWER-GRABBING FORMULATION: Conventional GDP excludes much unpaid household work and does not directly measure distribution, ecological depletion, service quality or every dimension of welfare.
```
### SESSION 11 — CORE — UNPAID WORK, WELFARE AND THE 2015 REVISION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: 2015 national-accounts revision - 2026 series revision Qualified use: Separate measurement change from real economic change before drawing a growth conclusion.

**Technical definition:** India's 2015 revision shifted the national-accounts base to 2011-12 and expanded use of corporate administrative data, improving relevance while creating a comparability need for a reliable back series.
...
**How to use them:** Frame the answer through Unpaid work; define welfare, connect the 2015 revision with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.

#### VISUAL FIRST

```text
UNPAID WORK, WELFARE AND THE 2015 REVISION
...
#### CLOSING RECALL FLOW — CORE — UNPAID WORK, WELFARE AND THE 2015 REVISION

```text
START / CONCEPT: CORE — Unpaid work, welfare and the 2015 revision
        |
        v
EXACT TERMS: Unpaid work · welfare · the 2015 revision · Mechanism chain · Qualified use · 2011-12
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: 2015 national-accounts revision - 2026 series revision Qualified use: Separate measurement change from real economic change before drawing a growth conclusion.
        |
        v
CONSEQUENCE / CONTRAST: Do not treat potential GDP as directly observed; it is method-dependent.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: moSPI released the 2022-23-base GDP series on 27 February 2026 with revised coverage, sources...
        |
        v
ANSWER-GRABBING FORMULATION: India's 2015 revision shifted the national-accounts base to 2011-12 and expanded use of corporate administrative data, improving relevance while creating a comparability need for a reliable back series.
```
### SESSION 12 — CORE — THE 2022-23-BASE NATIONAL-ACCOUNTS SERIES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Potential GDP is sustainable capacity implied by labour, capital and productivity, while the output gap compares actual output with that estimated capacity; potential output is not directly observed.

**Technical definition:** Mechanism chain: Potential GDP and output gap Qualified use: Use one named Indian revision, one method limitation and one welfare qualification.
...
- **The 2022-23-base national-accounts series**
- **Mechanism chain**
- **Qualified use**
- **Potential GDP**
- **GDP**
...
**How to use them:** Frame the answer through The 2022-23-base national-accounts series; define Mechanism chain, connect Qualified use with Potential GDP to explain the mechanism, and use GDP for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — THE 2022-23-BASE NATIONAL-ACCOUNTS SERIES

```text
START / CONCEPT: CORE — The 2022-23-base national-accounts series
        |
        v
EXACT TERMS: The 2022-23-base national-accounts series · Mechanism chain · Qualified use · Potential GDP · GDP · 2022-23
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Potential GDP and output gap Qualified use: Use one named Indian revision, one method limitation and one welfare qualification.
        |
        v
CONSEQUENCE / CONTRAST: Do not infer welfare, distribution or ecological sustainability from GDP alone.
        |
        v
UPSC TRAP / ANSWER-USE: Mains: Use one named Indian revision, one method limitation and one welfare qualification.
        |
        v
ANSWER-GRABBING FORMULATION: Potential GDP is sustainable capacity implied by labour, capital and productivity, while the output gap compares actual output with that estimated capacity; potential output is not directly observed.
```
### SESSION 13 — CORE SYNTHESIS — POTENTIAL GDP AND THE OUTPUT GAP

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The Incremental Capital-Output Ratio links additional capital to additional output; a higher ICOR signals weaker aggregate investment efficiency, so high saving or investment need not produce high growth.

**Technical definition:** Mechanism chain: ICOR and investment efficiency Qualified use: Open with the accounting boundary, reconcile the formula, and only then assess performance.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define Potential GDP, connect the output gap with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — POTENTIAL GDP AND THE OUTPUT GAP

```text
START / CONCEPT: CORE SYNTHESIS — Potential GDP and the output gap
        |
        v
EXACT TERMS: CORE SYNTHESIS · Potential GDP · the output gap · Mechanism chain · Qualified use · The Incremental Capital-Output Ratio
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: ICOR and investment efficiency Qualified use: Open with the accounting boundary, reconcile the formula, and only then assess performance.
        |
        v
CONSEQUENCE / CONTRAST: Do not treat every market transaction as current production; old-asset resale and transfers are excluded.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the Incremental Capital-Output Ratio links additional capital to additional output.
        |
        v
ANSWER-GRABBING FORMULATION: The Incremental Capital-Output Ratio links additional capital to additional output; a higher ICOR signals weaker aggregate investment efficiency, so high saving or investment need not produce high growth.
```
### SESSION 14 — CORE SYNTHESIS — ICOR, PPP AND CAPITAL PRODUCTIVITY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: PPP versus market exchange rate - Intangible capital formation Qualified use: Separate measurement change from real economic change before drawing a growth conclusion.

**Technical definition:** Research and development, software and databases, mineral exploration and artistic originals can be gross fixed capital formation, while advertising, routine training and much brand creation remain intermediate consumption.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define ICOR, connect PPP with capital productivity to explain the mechanism, and use Mechanism chain for the decisive comparison or qualification.

#### VISUAL FIRST

```text
ICOR, PPP AND CAPITAL PRODUCTIVITY
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — ICOR, PPP AND CAPITAL PRODUCTIVITY

```text
START / CONCEPT: CORE SYNTHESIS — ICOR, PPP and capital productivity
        |
        v
EXACT TERMS: CORE SYNTHESIS · ICOR · PPP · capital productivity · Mechanism chain · Qualified use
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: PPP versus market exchange rate - Intangible capital formation Qualified use: Separate measurement change from real economic change before drawing a growth conclusion.
        |
        v
CONSEQUENCE / CONTRAST: Purchasing Power Parity uses a common price basket for real purchasing-power comparison, whereas market-exchange-rate GDP is suited to external trade, debt and market-size comparison; ranks are reference-year specific.
        |
        v
UPSC TRAP / ANSWER-USE: Do not equate domestic territory with resident income; GDP and GNP answer different boundary questions.
        |
        v
ANSWER-GRABBING FORMULATION: Research and development, software and databases, mineral exploration and artistic originals can be gross fixed capital formation, while advertising, routine training and much brand creation remain intermediate consumption.
```
### SESSION 15 — CORE SYNTHESIS — INTANGIBLES, SECTOR CLASSIFICATION AND ESTIMATE VINTAGE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** A national-accounts number must retain its period, series base and estimate vintage such as First Advance Estimate, later advance estimate or revised estimate; a projection or old-series estimate is not an actual on a new series.

**Technical definition:** Limitation: ICOR is an aggregate diagnostic and does not identify the sector or institutional cause by itself. ✅ Claim: National accounts must estimate, not merely record, a large part of the economy.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define Intangibles, connect sector classification with estimate vintage to explain the mechanism, and use Mechanism chain for the decisive comparison or qualification.

#### VISUAL FIRST

```text
INTANGIBLES, SECTOR CLASSIFICATION AND ESTIMATE VINTAGE
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — INTANGIBLES, SECTOR CLASSIFICATION AND ESTIMATE VINTAGE

```text
START / CONCEPT: CORE SYNTHESIS — Intangibles, sector classification and estimate vintage
        |
        v
EXACT TERMS: CORE SYNTHESIS · Intangibles · sector classification · estimate vintage · Mechanism chain · Qualified use
        |
        v
MECHANISM / ARGUMENT: Limitation: ICOR is an aggregate diagnostic and does not identify the sector or institutional cause by itself. ✅ Claim: National accounts must estimate, not merely record, a large part of the economy.
        |
        v
CONSEQUENCE / CONTRAST: Reasoned verdict: GDP is indispensable for measuring production, but its interpretation is marks-worthy only when the series, price basis, estimate vintage, coverage and welfare limits are stated explicitly.
        |
        v
UPSC TRAP / ANSWER-USE: Limitation: valuing and depreciating intangible assets is harder than for physical assets because some intangible outlays, including advertising, brand creation, staff training and much organisational capital, are not capitalised under national-accounting rules and remain treated as intermediate consumption.
        |
        v
ANSWER-GRABBING FORMULATION: A national-accounts number must retain its period, series base and estimate vintage such as First Advance Estimate, later advance estimate or revised estimate; a projection or old-series estimate is not an actual on a new series.
```
