---
title: "NPAs, Basel Norms, Resolution and Financial Inclusion — Learner-v2 Refreshed"
topic_key: economy-06
cover_image: assets/economy-06_Teaching-Navigation_2026-09-03.png
---
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Economy\basic\06_NPAs-Basel-Norms-Resolution-and-Financial-Inclusion.md`  
**Substantive canonical provenance owner:** `upsc-ai-kit\knowledge\Economy\06_NPAs-Basel-Norms-Resolution-and-Financial-Inclusion_Learner-V2-Complete-Topic-Package.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Economy\advanced\06_NPAs-Basel-Norms-Resolution-and-Financial-Inclusion.md`  
...
![Refreshed teaching navigation](assets/economy-06_Teaching-Navigation_2026-09-03.png)
...
**Plain-language definition:** Term-loan overdue NPA recognition explains how NPA recognition and Gross and net NPA fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Term-loan overdue NPA recognition separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Term-loan overdue NPA recognition must be read through NPA recognition and Gross and net NPA, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Term-loan, overdue, recognition; attach Gross to its named source, period and status; then qualify the answer with this limit: Do not classify every weak borrower as an NPA without applying the prudential trigger.
...
```closure-flow
START / CONCEPT: Term-loan overdue NPA recognition
EXACT TERMS: Term-loan | overdue | recognition | Gross | term | loan
MECHANISM / ARGUMENT: connect NPA recognition and Gross and net NPA through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Sequence recognition, loss absorption, resolution, recapitalisation and governance repair.
UPSC TRAP / ANSWER-USE: Do not classify every weak borrower as an NPA without applying the prudential trigger.
ANSWER-GRABBING FORMULATION: Term-loan overdue NPA recognition converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Provisioning, write-off and waiver explains how Provisioning and write-off fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Provisioning, write-off and waiver separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Provisioning, write-off and waiver must be read through Provisioning and write-off, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Provisioning, write-off, waiver; attach charges to its named source, period and status; then qualify the answer with this limit: Do not equate gross NPA, net NPA, provisioning, write-off and waiver.
...
```closure-flow
START / CONCEPT: Provisioning, write-off and waiver
EXACT TERMS: Provisioning | write-off | waiver | charges | expected | loss
MECHANISM / ARGUMENT: connect Provisioning and write-off through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Compare legal tools by secured claim, collective action, tribunal and value-preservation purpose.
UPSC TRAP / ANSWER-USE: Do not equate gross NPA, net NPA, provisioning, write-off and waiver.
ANSWER-GRABBING FORMULATION: Provisioning, write-off and waiver converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Risk-weighted capital adequacy explains how Risk-weighted capital fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Risk-weighted capital adequacy separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Risk-weighted capital adequacy must be read through Risk-weighted capital, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Risk-weighted, capital, adequacy; attach measured to its named source, period and status; then qualify the answer with this limit: Do not quote Basel or RBI ratios without the circular date and covered-bank perimeter.
...
```closure-flow
START / CONCEPT: Risk-weighted capital adequacy
EXACT TERMS: Risk-weighted | capital | adequacy | measured | assets | needs
MECHANISM / ARGUMENT: connect Risk-weighted capital through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Judge inclusion by active, suitable and protected use rather than headline account counts.
UPSC TRAP / ANSWER-USE: Do not quote Basel or RBI ratios without the circular date and covered-bank perimeter.
ANSWER-GRABBING FORMULATION: Risk-weighted capital adequacy converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Basel global floor and RBI India overlay explains how Basel and RBI minima fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Basel global floor and RBI India overlay separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Basel global floor and RBI India overlay must be read through Basel and RBI minima, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Basel, global, floor; attach overlay to its named source, period and status; then qualify the answer with this limit: Do not equate secured recovery under SARFAESI with collective insolvency under IBC.
...
```closure-flow
START / CONCEPT: Basel global floor and RBI India overlay
EXACT TERMS: Basel | global | floor | overlay | minima | records
MECHANISM / ARGUMENT: connect Basel and RBI minima through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Sequence recognition, loss absorption, resolution, recapitalisation and governance repair.
UPSC TRAP / ANSWER-USE: Do not equate secured recovery under SARFAESI with collective insolvency under IBC.
ANSWER-GRABBING FORMULATION: Basel global floor and RBI India overlay converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Capital Conservation Buffer and dated perimeter explains how Capital Conservation Buffer fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Capital Conservation Buffer and dated perimeter separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Capital Conservation Buffer and dated perimeter must be read through Capital Conservation Buffer, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Capital, Conservation, Buffer; attach dated to its named source, period and status; then qualify the answer with this limit: Do not claim that transfer to an ARC or NARCL eliminates the economic loss.
...
```closure-flow
START / CONCEPT: Capital Conservation Buffer and dated perimeter
EXACT TERMS: Capital | Conservation | Buffer | dated | perimeter | records
MECHANISM / ARGUMENT: connect Capital Conservation Buffer through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Compare legal tools by secured claim, collective action, tribunal and value-preservation purpose.
UPSC TRAP / ANSWER-USE: Do not claim that transfer to an ARC or NARCL eliminates the economic loss.
ANSWER-GRABBING FORMULATION: Capital Conservation Buffer and dated perimeter converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Twin Balance Sheet and Asset Quality Review explains how Twin Balance Sheet diagnosis and Asset Quality Review fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Twin Balance Sheet and Asset Quality Review separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Twin Balance Sheet and Asset Quality Review must be read through Twin Balance Sheet diagnosis and Asset Quality Review, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Twin, Balance, Sheet; attach Asset to its named source, period and status; then qualify the answer with this limit: Do not call an Inter-Creditor Agreement a tribunal or statutory insolvency process.
...
```closure-flow
START / CONCEPT: Twin Balance Sheet and Asset Quality Review
EXACT TERMS: Twin | Balance | Sheet | Asset | Quality | Review
MECHANISM / ARGUMENT: connect Twin Balance Sheet diagnosis and Asset Quality Review through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Judge inclusion by active, suitable and protected use rather than headline account counts.
UPSC TRAP / ANSWER-USE: Do not call an Inter-Creditor Agreement a tribunal or statutory insolvency process.
ANSWER-GRABBING FORMULATION: Twin Balance Sheet and Asset Quality Review converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** SARFAESI secured recovery explains how SARFAESI perimeter fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, SARFAESI secured recovery separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> SARFAESI secured recovery must be read through SARFAESI perimeter, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define SARFAESI, secured, recovery; attach perimeter to its named source, period and status; then qualify the answer with this limit: Do not use Interest Coverage Ratio as the legal NPA definition.
...
```closure-flow
START / CONCEPT: SARFAESI secured recovery
EXACT TERMS: SARFAESI | secured | recovery | perimeter | centred | enforcement
MECHANISM / ARGUMENT: connect SARFAESI perimeter through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Sequence recognition, loss absorption, resolution, recapitalisation and governance repair.
UPSC TRAP / ANSWER-USE: Do not use Interest Coverage Ratio as the legal NPA definition.
ANSWER-GRABBING FORMULATION: SARFAESI secured recovery converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** DRT and NCLT institutional separation explains how DRT and NCLT distinction fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, DRT and NCLT institutional separation separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> DRT and NCLT institutional separation must be read through DRT and NCLT distinction, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define NCLT, institutional, separation; attach distinction to its named source, period and status; then qualify the answer with this limit: Do not reduce financial inclusion to account opening without usage and quality.
...
```closure-flow
START / CONCEPT: DRT and NCLT institutional separation
EXACT TERMS: NCLT | institutional | separation | distinction | Debt | Recovery
MECHANISM / ARGUMENT: connect DRT and NCLT distinction through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Compare legal tools by secured claim, collective action, tribunal and value-preservation purpose.
UPSC TRAP / ANSWER-USE: Do not reduce financial inclusion to account opening without usage and quality.
ANSWER-GRABBING FORMULATION: DRT and NCLT institutional separation converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** IBC collective insolvency explains how IBC architecture fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, IBC collective insolvency separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> IBC collective insolvency must be read through IBC architecture, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define collective, insolvency, architecture; attach Bankruptcy to its named source, period and status; then qualify the answer with this limit: Do not treat every restructuring or temporary forbearance as fraud.
...
```closure-flow
START / CONCEPT: IBC collective insolvency
EXACT TERMS: collective | insolvency | architecture | Bankruptcy | Code | uses
MECHANISM / ARGUMENT: connect IBC architecture through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Judge inclusion by active, suitable and protected use rather than headline account counts.
UPSC TRAP / ANSWER-USE: Do not treat every restructuring or temporary forbearance as fraud.
ANSWER-GRABBING FORMULATION: IBC collective insolvency converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** ARC and NARCL stressed-asset transfer explains how ARC and NARCL fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, ARC and NARCL stressed-asset transfer separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> ARC and NARCL stressed-asset transfer must be read through ARC and NARCL, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define NARCL, stressed-asset, transfer; attach Asset to its named source, period and status; then qualify the answer with this limit: Do not present the Twin Balance Sheet diagnosis as a current ratio or scheme.
...
```closure-flow
START / CONCEPT: ARC and NARCL stressed-asset transfer
EXACT TERMS: NARCL | stressed-asset | transfer | Asset | Reconstruction | Companies
MECHANISM / ARGUMENT: connect ARC and NARCL through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Sequence recognition, loss absorption, resolution, recapitalisation and governance repair.
UPSC TRAP / ANSWER-USE: Do not present the Twin Balance Sheet diagnosis as a current ratio or scheme.
ANSWER-GRABBING FORMULATION: ARC and NARCL stressed-asset transfer converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** PCA, 4R and Inter-Creditor Agreements explains how PCA and 4R and Inter-Creditor Agreement fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, PCA, 4R and Inter-Creditor Agreements separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> PCA, 4R and Inter-Creditor Agreements must be read through PCA and 4R and Inter-Creditor Agreement, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Inter-Creditor, Agreements, Agreement; attach Prompt to its named source, period and status; then qualify the answer with this limit: Do not classify every weak borrower as an NPA without applying the prudential trigger.
...
```closure-flow
START / CONCEPT: PCA, 4R and Inter-Creditor Agreements
EXACT TERMS: Inter-Creditor | Agreements | Agreement | Prompt | Corrective | Action
MECHANISM / ARGUMENT: connect PCA and 4R and Inter-Creditor Agreement through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Compare legal tools by secured claim, collective action, tribunal and value-preservation purpose.
UPSC TRAP / ANSWER-USE: Do not classify every weak borrower as an NPA without applying the prudential trigger.
ANSWER-GRABBING FORMULATION: PCA, 4R and Inter-Creditor Agreements converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Interest Coverage Ratio explains how Interest Coverage Ratio fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Interest Coverage Ratio separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Interest Coverage Ratio must be read through Interest Coverage Ratio, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Interest, Coverage, Ratio; attach compares to its named source, period and status; then qualify the answer with this limit: Do not equate gross NPA, net NPA, provisioning, write-off and waiver.
...
```closure-flow
START / CONCEPT: Interest Coverage Ratio
EXACT TERMS: Interest | Coverage | Ratio | compares | earnings | obligations
MECHANISM / ARGUMENT: connect Interest Coverage Ratio through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Judge inclusion by active, suitable and protected use rather than headline account counts.
UPSC TRAP / ANSWER-USE: Do not equate gross NPA, net NPA, provisioning, write-off and waiver.
ANSWER-GRABBING FORMULATION: Interest Coverage Ratio converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** FI-Index: Access, Usage and Quality explains how FI-Index dimensions fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, FI-Index: Access, Usage and Quality separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> FI-Index: Access, Usage and Quality must be read through FI-Index dimensions, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define FI-Index, Access, Usage; attach Quality to its named source, period and status; then qualify the answer with this limit: Do not quote Basel or RBI ratios without the circular date and covered-bank perimeter.
...
```closure-flow
START / CONCEPT: FI-Index: Access, Usage and Quality
EXACT TERMS: FI-Index | Access | Usage | Quality | dimensions | RBI's
MECHANISM / ARGUMENT: connect FI-Index dimensions through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Sequence recognition, loss absorption, resolution, recapitalisation and governance repair.
UPSC TRAP / ANSWER-USE: Do not quote Basel or RBI ratios without the circular date and covered-bank perimeter.
ANSWER-GRABBING FORMULATION: FI-Index: Access, Usage and Quality converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** PMJDY and SHG-Bank Linkage explains how PMJDY platform and SHG-Bank Linkage fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, PMJDY and SHG-Bank Linkage separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> PMJDY and SHG-Bank Linkage must be read through PMJDY platform and SHG-Bank Linkage, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define PMJDY, SHG-Bank, Linkage; attach platform to its named source, period and status; then qualify the answer with this limit: Do not equate secured recovery under SARFAESI with collective insolvency under IBC.
...
```closure-flow
START / CONCEPT: PMJDY and SHG-Bank Linkage
EXACT TERMS: PMJDY | SHG-Bank | Linkage | platform | Pradhan | Mantri
MECHANISM / ARGUMENT: connect PMJDY platform and SHG-Bank Linkage through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Compare legal tools by secured claim, collective action, tribunal and value-preservation purpose.
UPSC TRAP / ANSWER-USE: Do not equate secured recovery under SARFAESI with collective insolvency under IBC.
ANSWER-GRABBING FORMULATION: PMJDY and SHG-Bank Linkage converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** WaterCredit, evergreening and forbearance explains how WaterCredit and Evergreening and forbearance fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, WaterCredit, evergreening and forbearance separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> WaterCredit, evergreening and forbearance must be read through WaterCredit and Evergreening and forbearance, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define WaterCredit, evergreening, forbearance; attach microfinance-oriented to its named source, period and status; then qualify the answer with this limit: Do not claim that transfer to an ARC or NARCL eliminates the economic loss.
...
```closure-flow
START / CONCEPT: WaterCredit, evergreening and forbearance
EXACT TERMS: WaterCredit | evergreening | forbearance | microfinance-oriented | model | water
MECHANISM / ARGUMENT: connect WaterCredit and Evergreening and forbearance through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Judge inclusion by active, suitable and protected use rather than headline account counts.
UPSC TRAP / ANSWER-USE: Do not claim that transfer to an ARC or NARCL eliminates the economic loss.
ANSWER-GRABBING FORMULATION: WaterCredit, evergreening and forbearance converts a precise economic distinction into a qualified conclusion
```
...
- **Must remember:** Asset-quality stress moves from repayment weakness to recognition, provisioning, capital impact, restructuring or resolution; Basel standards govern risk-sensitive capital/liquidity while inclusion requires affordable, usable and protected access.
- **Close distinction:** Gross NPA is not net NPA, provision is not write-off, write-off is not waiver, recapitalisation is not recovery, IBC admission is not resolution, and account opening is not financial inclusion.
- **Formula / status / evidence / causal limit:** Use ratio numerator/denominator and date, distinguish regulatory standard from Indian implementation, and trace lender-borrower-resolution-professional-tribunal roles, haircuts, recovery timing, moral hazard and consumer outcomes.
...
**Demand decoding:** The directive **answer** requires a direct position on “Distinguish NPA recognition, provisioning, write-off and waiver. Answer in about 150 words.”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** **Claim:** NPA recognition. **Named evidence/example:** For a term loan, the standard RBI prudential test is interest or principal overdue for more than 90 days; the legal classification must not be replaced by a general idea of borrower weakness. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Gross and net NPA. **Named evidence/example:** Gross NPA records the classified stressed exposure, while net NPA deducts provisions and specified adjustments to show the uncovered portion. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Provisioning and write-off. **Named evidence/example:** Provisioning charges expected loss against income, whereas a write-off removes the loan from the active loan book without necessarily ending recovery rights or waiving the debt. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source.

**Analytical body:**

1. **Claim and named evidence:** For a term loan, the standard RBI prudential test is interest or principal overdue for more than 90 days; the legal classification must not be replaced by a general idea of borrower weakness. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** Gross NPA records the classified stressed exposure, while net NPA deducts provisions and specified adjustments to show the uncovered portion. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
3. **Claim and named evidence:** Provisioning charges expected loss against income, whereas a write-off removes the loan from the active loan book without necessarily ending recovery rights or waiving the debt. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**Demand decoding:** The directive **answer** requires a direct position on “Why is capital adequacy measured against risk-weighted assets? Answer in about 150 words.”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** **Claim:** Risk-weighted capital. **Named evidence/example:** Capital adequacy is measured against risk-weighted assets, so capital needs depend on asset risk rather than only on total balance-sheet size. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Basel and RBI minima. **Named evidence/example:** The owner records Basel III global minima of CET1 4.5 per cent, Tier 1 6 per cent and total capital 8 per cent, while RBI's 1 April 2025 Master Circular records India-specific minima of CET1 5.5 per cent, Tier 1 7 per cent and total CRAR 9 per cent for its stated bank perimeter. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Capital Conservation Buffer. **Named evidence/example:** The owner records a 2.5 per cent Capital Conservation Buffer met with CET1, taking the stated effective CET1 minimum to 8 per cent and effective total CRAR to 11.5 per cent; current use must retain the applicable RBI circular and bank perimeter. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source.

**Analytical body:**

1. **Claim and named evidence:** Capital adequacy is measured against risk-weighted assets, so capital needs depend on asset risk rather than only on total balance-sheet size. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** The owner records Basel III global minima of CET1 4.5 per cent, Tier 1 6 per cent and total capital 8 per cent, while RBI's 1 April 2025 Master Circular records India-specific minima of CET1 5.5 per cent, Tier 1 7 per cent and total CRAR 9 per cent for its stated bank perimeter. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
3. **Claim and named evidence:** The owner records a 2.5 per cent Capital Conservation Buffer met with CET1, taking the stated effective CET1 minimum to 8 per cent and effective total CRAR to 11.5 per cent; current use must retain the applicable RBI circular and bank perimeter. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**How to improve this answer:** For “Why is capital adequacy measured against risk-weighted assets? Answer in about 150 words.”, replace the weakest catalogue point with one exact formula or classification, named institution/instrument, balance-sheet or incentive channel, lag, measurable outcome, distribution/federal effect and qualification.
...
**Demand decoding:** The directive **compare** requires a direct position on “Compare SARFAESI, DRT, IBC and Inter-Creditor Agreements. Answer in about 250 words.”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** **Claim:** SARFAESI perimeter. **Named evidence/example:** The SARFAESI Act, 2002 is centred on enforcement of secured assets and is not a substitute for the entire insolvency system. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** DRT and NCLT distinction. **Named evidence/example:** Debt Recovery Tribunals are specialised recovery forums, whereas the NCLT-based IBC route addresses collective corporate insolvency and resolution. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** IBC architecture. **Named evidence/example:** The Insolvency and Bankruptcy Code, 2016 uses a creditor-in-committee process under the NCLT framework to pursue resolution or value-maximising exit rather than one lender's isolated recovery. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Inter-Creditor Agreement. **Named evidence/example:** An Inter-Creditor Agreement coordinates lenders and reduces holdout problems in stressed resolution, but it is not itself a court or insolvency tribunal. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source.

**Analytical body:**

1. **Claim and named evidence:** The SARFAESI Act, 2002 is centred on enforcement of secured assets and is not a substitute for the entire insolvency system. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** Debt Recovery Tribunals are specialised recovery forums, whereas the NCLT-based IBC route addresses collective corporate insolvency and resolution. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
3. **Claim and named evidence:** The Insolvency and Bankruptcy Code, 2016 uses a creditor-in-committee process under the NCLT framework to pursue resolution or value-maximising exit rather than one lender's isolated recovery. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
4. **Claim and named evidence:** An Inter-Creditor Agreement coordinates lenders and reduces holdout problems in stressed resolution, but it is not itself a court or insolvency tribunal. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**How to improve this answer:** For “Compare SARFAESI, DRT, IBC and Inter-Creditor Agreements. Answer in about 250 words.”, replace the weakest catalogue point with one exact formula or classification, named institution/instrument, balance-sheet or incentive channel, lag, measurable outcome, distribution/federal effect and qualification.
...
**Demand decoding:** The directive **explain** requires a direct position on “Explain why access, usage and quality must be separated in financial inclusion. Answer in…”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** **Claim:** FI-Index dimensions. **Named evidence/example:** RBI's annual Financial Inclusion Index uses Access, Usage and Quality and has no base year, so it cannot be reduced to a count of accounts opened. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** PMJDY platform. **Named evidence/example:** Pradhan Mantri Jan Dhan Yojana expanded account access and links to payments and transfers, but dormancy and low activity show why access does not automatically become effective inclusion. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** SHG-Bank Linkage. **Named evidence/example:** SHG-Bank Linkage connects commonly women-led savings groups to formal banking channels; a self-help group is not itself a bank. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** WaterCredit. **Named evidence/example:** WaterCredit is a microfinance-oriented model for water and sanitation access and illustrates targeted inclusion beyond plain account opening or general consumption credit. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source.

**Analytical body:**

1. **Claim and named evidence:** RBI's annual Financial Inclusion Index uses Access, Usage and Quality and has no base year, so it cannot be reduced to a count of accounts opened. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** Pradhan Mantri Jan Dhan Yojana expanded account access and links to payments and transfers, but dormancy and low activity show why access does not automatically become effective inclusion. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
3. **Claim and named evidence:** SHG-Bank Linkage connects commonly women-led savings groups to formal banking channels; a self-help group is not itself a bank. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
4. **Claim and named evidence:** WaterCredit is a microfinance-oriented model for water and sanitation access and illustrates targeted inclusion beyond plain account opening or general consumption credit. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**Demand decoding:** The directive **evaluate** requires a direct position on “Evaluate India's balance-sheet cleanup architecture from recognition to resolution. Answer in…”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** **Claim:** Twin Balance Sheet diagnosis. **Named evidence/example:** Economic Survey 2016-17 used the Twin Balance Sheet framing for simultaneous corporate over-leverage and bank stress; it is a dated diagnostic, not a statute or scheme. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Asset Quality Review. **Named evidence/example:** RBI's Asset Quality Review pushed recognition of previously under-reported stress, which could worsen reported ratios initially while improving information and provisioning discipline. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** SARFAESI perimeter. **Named evidence/example:** The SARFAESI Act, 2002 is centred on enforcement of secured assets and is not a substitute for the entire insolvency system. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** IBC architecture. **Named evidence/example:** The Insolvency and Bankruptcy Code, 2016 uses a creditor-in-committee process under the NCLT framework to pursue resolution or value-maximising exit rather than one lender's isolated recovery. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** ARC and NARCL. **Named evidence/example:** Asset Reconstruction Companies acquire stressed assets for recovery or resolution, while NARCL represents India's specialised bad-bank aggregation concept; transfer does not erase the underlying loss. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** PCA and 4R. **Named evidence/example:** Prompt Corrective Action is supervisory intervention for weak banks, while the 4R approach denotes Recognition, Resolution, Recapitalization and Reforms; neither is a deposit-insurance payout. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source.

**Analytical body:**

1. **Claim and named evidence:** Economic Survey 2016-17 used the Twin Balance Sheet framing for simultaneous corporate over-leverage and bank stress; it is a dated diagnostic, not a statute or scheme. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** RBI's Asset Quality Review pushed recognition of previously under-reported stress, which could worsen reported ratios initially while improving information and provisioning discipline. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
3. **Claim and named evidence:** The SARFAESI Act, 2002 is centred on enforcement of secured assets and is not a substitute for the entire insolvency system. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
4. **Claim and named evidence:** The Insolvency and Bankruptcy Code, 2016 uses a creditor-in-committee process under the NCLT framework to pursue resolution or value-maximising exit rather than one lender's isolated recovery. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
5. **Claim and named evidence:** Asset Reconstruction Companies acquire stressed assets for recovery or resolution, while NARCL represents India's specialised bad-bank aggregation concept; transfer does not erase the underlying loss. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
6. **Claim and named evidence:** Prompt Corrective Action is supervisory intervention for weak banks, while the 4R approach denotes Recognition, Resolution, Recapitalization and Reforms; neither is a deposit-insurance payout. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**How to improve this answer:** For “Evaluate India's balance-sheet cleanup architecture from recognition to resolution. Answer in…”, replace the weakest catalogue point with one exact formula or classification, named institution/instrument, balance-sheet or incentive channel, lag, measurable outcome, distribution/federal effect and qualification.
...
**Demand decoding:** The directive **answer** requires a direct position on “How can prudential stability and responsible financial inclusion reinforce each other? Answer…”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.
...
4. **Claim and named evidence:** RBI's annual Financial Inclusion Index uses Access, Usage and Quality and has no base year, so it cannot be reduced to a count of accounts opened. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
5. **Claim and named evidence:** Pradhan Mantri Jan Dhan Yojana expanded account access and links to payments and transfers, but dormancy and low activity show why access does not automatically become effective inclusion. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
6. **Claim and named evidence:** Evergreening uses fresh finance to conceal unviable old dues, while temporary forbearance may bridge a shock; prolonged concealment creates zombie lending and misallocated credit. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**How to improve this answer:** For “How can prudential stability and responsible financial inclusion reinforce each other? Answer…”, replace the weakest catalogue point with one exact formula or classification, named institution/instrument, balance-sheet or incentive channel, lag, measurable outcome, distribution/federal effect and qualification.
...
MUST REMEMBER: Asset-quality stress moves from repayment weakness to recognition,...
```
...
CLOSE DISTINCTION: Gross NPA is not net NPA, provision is not write-off, write-off is not...
```
...
EVIDENCE LIMIT: FORMULA / STATUS / CAUSATION: Use ratio numerator/denominator and date,...
```
