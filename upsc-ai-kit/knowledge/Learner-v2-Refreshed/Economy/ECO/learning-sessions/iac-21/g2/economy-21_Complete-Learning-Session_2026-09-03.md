---
title: "IMF, World Bank, ADB, AIIB, NDB and Global Governance — Learner-v2 Refreshed"
topic_key: economy-21
cover_image: assets/economy-21_Teaching-Navigation_2026-09-03.png
---
...
![Refreshed teaching navigation](assets/economy-21_Teaching-Navigation_2026-09-03.png)
...
**Plain-language definition:** International institutions must be compared by mandate, client, instrument, governance, conditionality and lending window rather than grouped as one pool of external finance.

**Technical definition:** Mechanism chain: Institution-comparison frame - IMF mandate Qualified use: Compare mandate, borrower, lending window, governance and conditionality before evaluating performance.
...
**How to use them:** Frame the answer through FOUNDATION; define How to compare international economic institutions, connect Mechanism chain with Qualified use to explain the mechanism, and use International for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — HOW TO COMPARE INTERNATIONAL ECONOMIC INSTITUTIONS

```text
START / CONCEPT: FOUNDATION — How to compare international economic institutions
        |
        v
EXACT TERMS: FOUNDATION · How to compare international economic institutions · Mechanism chain · Qualified use · International · The IMF
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Institution-comparison frame - IMF mandate Qualified use: Compare mandate, borrower, lending window, governance and conditionality before evaluating performance.
        |
        v
CONSEQUENCE / CONTRAST: The IMF supports monetary cooperation, surveillance and balance-of-payments financing; its core function is not long-lived project construction.
        |
        v
UPSC TRAP / ANSWER-USE: Do not describe IMF balance-of-payments support as ordinary infrastructure project lending.
        |
        v
ANSWER-GRABBING FORMULATION: International institutions must be compared by mandate, client, instrument, governance, conditionality and lending window rather than grouped as one pool of external finance.
```
### SESSION 2 — FOUNDATION — IMF MANDATE AND SURVEILLANCE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: IMF quota functions Qualified use: Separate reserve assets, stabilisation finance, development loans and guarantees.

**Technical definition:** An IMF member's quota relates to financial contribution, voting power, access to resources and its share in general SDR allocations; the current numerical share requires a dated IMF source.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mechanism chain: IMF quota functions Qualified use: Separate reserve assets, stabilisation finance, development loans and guarantees.
...
**How to use them:** Frame the answer through FOUNDATION; define IMF mandate, connect surveillance with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — IMF MANDATE AND SURVEILLANCE

```text
START / CONCEPT: FOUNDATION — IMF mandate and surveillance
        |
        v
EXACT TERMS: FOUNDATION · IMF mandate · surveillance · Mechanism chain · Qualified use · An IMF
        |
        v
MECHANISM / ARGUMENT: The operative mechanism is that separate reserve assets, stabilisation finance, development loans and guarantees.
        |
        v
CONSEQUENCE / CONTRAST: An IMF member's quota relates to financial contribution, voting power, access to resources and its share in general SDR allocations; the current numerical share requires a dated IMF source.
        |
        v
UPSC TRAP / ANSWER-USE: Do not quote quota, voting, membership or finance figures without a dated institutional source.
        |
        v
ANSWER-GRABBING FORMULATION: Mechanism chain: IMF quota functions Qualified use: Separate reserve assets, stabilisation finance, development loans and guarantees.
```
### SESSION 3 — FOUNDATION — IMF QUOTAS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** A Special Drawing Right is an IMF-created international reserve asset valued from a currency basket; it is neither retail currency, budget revenue nor automatically an IMF loan.

**Technical definition:** Mechanism chain: SDR boundary Qualified use: Judge reform through representation, policy ownership, additionality, safeguards and debt sustainability.
...
**How to use them:** Frame the answer through FOUNDATION; define IMF quotas, connect Mechanism chain with Qualified use to explain the mechanism, and use A Special Drawing Right for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — IMF QUOTAS

```text
START / CONCEPT: FOUNDATION — IMF quotas
        |
        v
EXACT TERMS: FOUNDATION · IMF quotas · Mechanism chain · Qualified use · A Special Drawing Right · Special Drawing Right
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: SDR boundary Qualified use: Judge reform through representation, policy ownership, additionality, safeguards and debt sustainability.
        |
        v
CONSEQUENCE / CONTRAST: Do not call SDRs currency, budget revenue or an IMF loan.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: do not call SDRs currency, budget revenue or an IMF loan.
        |
        v
ANSWER-GRABBING FORMULATION: A Special Drawing Right is an IMF-created international reserve asset valued from a currency basket; it is neither retail currency, budget revenue nor automatically an IMF loan.
```
### SESSION 4 — CORE — SPECIAL DRAWING RIGHTS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** A reserve tranche position is a member's liquid claim on the IMF arising from quota resources and is treated as a reserve asset; it is distinct from conditional programme borrowing.

**Technical definition:** Mechanism chain: Reserve tranche position Qualified use: Compare mandate, borrower, lending window, governance and conditionality before evaluating performance.
...
- **Mechanism chain**
- **Qualified use**
- **A reserve tranche position**
- **IMF**
- **Reserve**

**How to use them:** Frame the answer through Special Drawing Rights; define Mechanism chain, connect Qualified use with A reserve tranche position to explain the mechanism, and use IMF for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — SPECIAL DRAWING RIGHTS

```text
START / CONCEPT: CORE — Special Drawing Rights
        |
        v
EXACT TERMS: Special Drawing Rights · Mechanism chain · Qualified use · A reserve tranche position · IMF · Reserve
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Reserve tranche position Qualified use: Compare mandate, borrower, lending window, governance and conditionality before evaluating performance.
        |
        v
CONSEQUENCE / CONTRAST: Do not treat gold tranche and reserve tranche position as separate facilities.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: do not treat gold tranche and reserve tranche position as separate facilities.
        |
        v
ANSWER-GRABBING FORMULATION: A reserve tranche position is a member's liquid claim on the IMF arising from quota resources and is treated as a reserve asset; it is distinct from conditional programme borrowing.
```
### SESSION 5 — CORE — RESERVE TRANCHE POSITION AND GOLD TRANCHE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Gold tranche is the historical name associated with what modern IMF usage calls the reserve tranche position, not an additional separate lending facility.

**Technical definition:** Mechanism chain: Gold tranche terminology Qualified use: Separate reserve assets, stabilisation finance, development loans and guarantees.
...
**How to use them:** Frame the answer through Reserve tranche position; define gold tranche, connect Mechanism chain with Qualified use to explain the mechanism, and use Gold for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — RESERVE TRANCHE POSITION AND GOLD TRANCHE

```text
START / CONCEPT: CORE — Reserve tranche position and gold tranche
        |
        v
EXACT TERMS: Reserve tranche position · gold tranche · Mechanism chain · Qualified use · Gold · IMF
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Gold tranche terminology Qualified use: Separate reserve assets, stabilisation finance, development loans and guarantees.
        |
        v
CONSEQUENCE / CONTRAST: Do not merge RFI emergency support with phased SBA or EFF programme lending.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: gold tranche is the historical name associated with what modern IMF usage calls the...
        |
        v
ANSWER-GRABBING FORMULATION: Gold tranche is the historical name associated with what modern IMF usage calls the reserve tranche position, not an additional separate lending facility.
```
### SESSION 6 — CORE — RAPID FINANCING INSTRUMENT AND PROGRAMME ARRANGEMENTS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The Rapid Financing Instrument provides urgent balance-of-payments support with limited ex-post programme structure, while arrangements such as the SBA or EFF involve phased access and programme reviews.

**Technical definition:** Mechanism chain: RFI and programme lending - World Bank boundary Qualified use: Judge reform through representation, policy ownership, additionality, safeguards and debt sustainability.
...
**How to use them:** Frame the answer through Rapid Financing Instrument; define programme arrangements, connect Mechanism chain with Qualified use to explain the mechanism, and use The Rapid Financing Instrument for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — RAPID FINANCING INSTRUMENT AND PROGRAMME ARRANGEMENTS

```text
START / CONCEPT: CORE — Rapid Financing Instrument and programme arrangements
        |
        v
EXACT TERMS: Rapid Financing Instrument · programme arrangements · Mechanism chain · Qualified use · The Rapid Financing Instrument · SBA
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: RFI and programme lending - World Bank boundary Qualified use: Judge reform through representation, policy ownership, additionality, safeguards and debt sustainability.
        |
        v
CONSEQUENCE / CONTRAST: The term World Bank commonly refers to IBRD and IDA, while the World Bank Group also includes institutions with private-investment and guarantee mandates.
        |
        v
UPSC TRAP / ANSWER-USE: Do not use World Bank and World Bank Group as exact synonyms.
        |
        v
ANSWER-GRABBING FORMULATION: The Rapid Financing Instrument provides urgent balance-of-payments support with limited ex-post programme structure, while arrangements such as the SBA or EFF involve phased access and programme reviews.
```
### SESSION 7 — CORE — WORLD BANK AND WORLD BANK GROUP

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: IBRD and IDA Qualified use: Compare mandate, borrower, lending window, governance and conditionality before evaluating performance.

**Technical definition:** IBRD and IDA both support sovereign development but on different eligibility and financing terms; they must not be presented as identical lending windows.
...
**How to use them:** Frame the answer through World Bank; define World Bank Group, connect Mechanism chain with Qualified use to explain the mechanism, and use IBRD for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — WORLD BANK AND WORLD BANK GROUP

```text
START / CONCEPT: CORE — World Bank and World Bank Group
        |
        v
EXACT TERMS: World Bank · World Bank Group · Mechanism chain · Qualified use · IBRD · IDA
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: IBRD and IDA Qualified use: Compare mandate, borrower, lending window, governance and conditionality before evaluating performance.
        |
        v
CONSEQUENCE / CONTRAST: Do not merge IBRD, IDA, IFC and MIGA clients or instruments.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: iBRD and IDA both support sovereign development but on different eligibility and financing terms.
        |
        v
ANSWER-GRABBING FORMULATION: IBRD and IDA both support sovereign development but on different eligibility and financing terms; they must not be presented as identical lending windows.
```
### SESSION 8 — CORE — IBRD AND IDA

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** IFC supports private-sector development through finance and mobilisation, while MIGA provides political-risk insurance or credit enhancement; neither is an IMF stabilisation window.

**Technical definition:** Mechanism chain: IFC and MIGA Qualified use: Separate reserve assets, stabilisation finance, development loans and guarantees.
...
**How to use them:** Frame the answer through IBRD; define IDA, connect Mechanism chain with Qualified use to explain the mechanism, and use IFC for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — IBRD AND IDA

```text
START / CONCEPT: CORE — IBRD and IDA
        |
        v
EXACT TERMS: IBRD · IDA · Mechanism chain · Qualified use · IFC · MIGA
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: IFC and MIGA Qualified use: Separate reserve assets, stabilisation finance, development loans and guarantees.
        |
        v
CONSEQUENCE / CONTRAST: Do not treat ADB, AIIB and NDB as interchangeable or as replacements for the IMF.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: iFC supports private-sector development through finance and mobilisation.
        |
        v
ANSWER-GRABBING FORMULATION: IFC supports private-sector development through finance and mobilisation, while MIGA provides political-risk insurance or credit enhancement; neither is an IMF stabilisation window.
```
### SESSION 9 — CORE — IFC AND MIGA

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The Asian Development Bank is a regional development bank serving Asia and the Pacific through sovereign, private-sector, knowledge and technical-assistance operations.

**Technical definition:** Mechanism chain: ADB mandate Qualified use: Judge reform through representation, policy ownership, additionality, safeguards and debt sustainability.
...
**How to use them:** Frame the answer through IFC; define MIGA, connect Mechanism chain with Qualified use to explain the mechanism, and use The Asian Development Bank for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — IFC AND MIGA

```text
START / CONCEPT: CORE — IFC and MIGA
        |
        v
EXACT TERMS: IFC · MIGA · Mechanism chain · Qualified use · The Asian Development Bank · Asia
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: ADB mandate Qualified use: Judge reform through representation, policy ownership, additionality, safeguards and debt sustainability.
        |
        v
CONSEQUENCE / CONTRAST: Do not equate DSSI payment suspension with Common Framework debt treatment.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: do not equate DSSI payment suspension with Common Framework debt treatment.
        |
        v
ANSWER-GRABBING FORMULATION: The Asian Development Bank is a regional development bank serving Asia and the Pacific through sovereign, private-sector, knowledge and technical-assistance operations.
```
### SESSION 10 — CORE — ASIAN DEVELOPMENT BANK

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The Asian Infrastructure Investment Bank is a multilateral development bank focused on sustainable infrastructure and connectivity; current membership or voting figures require a dated institutional source.

**Technical definition:** Mechanism chain: AIIB mandate Qualified use: Compare mandate, borrower, lending window, governance and conditionality before evaluating performance.
...
**How to use them:** Frame the answer through Asian Development Bank; define Mechanism chain, connect Qualified use with The Asian Infrastructure Investment Bank to explain the mechanism, and use PYQ for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — ASIAN DEVELOPMENT BANK

```text
START / CONCEPT: CORE — Asian Development Bank
        |
        v
EXACT TERMS: Asian Development Bank · Mechanism chain · Qualified use · The Asian Infrastructure Investment Bank · PYQ · AIIB
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: AIIB mandate Qualified use: Compare mandate, borrower, lending window, governance and conditionality before evaluating performance.
        |
        v
CONSEQUENCE / CONTRAST: Do not infer an objective PYQ answer letter from a routed concept.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the Asian Infrastructure Investment Bank is a multilateral development bank focused on sustainable infrastructure...
        |
        v
ANSWER-GRABBING FORMULATION: The Asian Infrastructure Investment Bank is a multilateral development bank focused on sustainable infrastructure and connectivity; current membership or voting figures require a dated institutional source.
```
### SESSION 11 — CORE — AIIB

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The Nature Solutions Finance Hub for Asia and the Pacific is an ADB initiative, an audited 2025 Prelims concept; any current financing total or project count requires a dated ADB source.

**Technical definition:** The New Development Bank was founded by BRICS countries to mobilise resources for infrastructure and sustainable development in member emerging and developing economies.
...
- **BRICS**
- **The Nature Solutions Finance Hub**

**How to use them:** Frame the answer through Aiib; define Mechanism chain, connect Qualified use with The New Development Bank to explain the mechanism, and use BRICS for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — AIIB

```text
START / CONCEPT: CORE — AIIB
        |
        v
EXACT TERMS: Aiib · Mechanism chain · Qualified use · The New Development Bank · BRICS · The Nature Solutions Finance Hub
        |
        v
MECHANISM / ARGUMENT: The New Development Bank was founded by BRICS countries to mobilise resources for infrastructure and sustainable development in member emerging and developing economies.
        |
        v
CONSEQUENCE / CONTRAST: Do not describe IMF balance-of-payments support as ordinary infrastructure project lending.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: nDB mandate - Nature Solutions Finance Hub Qualified use.
        |
        v
ANSWER-GRABBING FORMULATION: The Nature Solutions Finance Hub for Asia and the Pacific is an ADB initiative, an audited 2025 Prelims concept; any current financing total or project count requires a dated ADB source.
```
### SESSION 12 — CORE — NEW DEVELOPMENT BANK

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: Conditionality and safeguards Qualified use: Judge reform through representation, policy ownership, additionality, safeguards and debt sustainability.

**Technical definition:** Macroeconomic programme conditionality, project procurement rules and environmental-social safeguards serve different purposes and should not be collapsed into one generic lender condition.
...
**How to use them:** Frame the answer through New Development Bank; define Mechanism chain, connect Qualified use with Macroeconomic to explain the mechanism, and use Conditionality for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — NEW DEVELOPMENT BANK

```text
START / CONCEPT: CORE — New Development Bank
        |
        v
EXACT TERMS: New Development Bank · Mechanism chain · Qualified use · Macroeconomic · Conditionality · Qualified
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Conditionality and safeguards Qualified use: Judge reform through representation, policy ownership, additionality, safeguards and debt sustainability.
        |
        v
CONSEQUENCE / CONTRAST: Do not quote quota, voting, membership or finance figures without a dated institutional source.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: macroeconomic programme conditionality, project procurement rules and environmental-social safeguards serve different purposes and should...
        |
        v
ANSWER-GRABBING FORMULATION: Macroeconomic programme conditionality, project procurement rules and environmental-social safeguards serve different purposes and should not be collapsed into one generic lender condition.
```
### SESSION 13 — CORE SYNTHESIS — NATURE SOLUTIONS FINANCE HUB

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: Project and policy-based lending Qualified use: Compare mandate, borrower, lending window, governance and conditionality before evaluating performance.

**Technical definition:** Technically, CORE SYNTHESIS — Nature Solutions Finance Hub is analysed by relating CORE SYNTHESIS to Nature Solutions Finance Hub, then testing the relationship through Mechanism chain and Qualified use.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define Nature Solutions Finance Hub, connect Mechanism chain with Qualified use to explain the mechanism, and use SDRs for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — NATURE SOLUTIONS FINANCE HUB

```text
START / CONCEPT: CORE SYNTHESIS — Nature Solutions Finance Hub
        |
        v
EXACT TERMS: CORE SYNTHESIS · Nature Solutions Finance Hub · Mechanism chain · Qualified use · SDRs · IMF
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Project and policy-based lending Qualified use: Compare mandate, borrower, lending window, governance and conditionality before evaluating performance.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that do not call SDRs currency, budget revenue or an IMF loan.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: do not call SDRs currency, budget revenue or an IMF loan.
        |
        v
ANSWER-GRABBING FORMULATION: Do not call SDRs currency, budget revenue or an IMF loan.
```
### SESSION 14 — CORE SYNTHESIS — DEVELOPMENT LENDING, GUARANTEES AND CURRENCY RISK

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** A guarantee absorbs specified risks and co-financing combines institutions or financiers; neither means that one lender funds or bears every project risk.

**Technical definition:** Foreign-currency development finance can be concessional or long-term yet still create exchange-rate exposure for a borrower whose revenues are in domestic currency.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define Development lending, connect guarantees with currency risk to explain the mechanism, and use Mechanism chain for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — DEVELOPMENT LENDING, GUARANTEES AND CURRENCY RISK

```text
START / CONCEPT: CORE SYNTHESIS — Development lending, guarantees and currency risk
        |
        v
EXACT TERMS: CORE SYNTHESIS · Development lending · guarantees · currency risk · Mechanism chain · Qualified use
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Guarantees and co-financing - Currency-risk boundary Qualified use: Separate reserve assets, stabilisation finance, development loans and guarantees.
        |
        v
CONSEQUENCE / CONTRAST: Do not treat gold tranche and reserve tranche position as separate facilities.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: a guarantee absorbs specified risks and co-financing combines institutions or financiers.
        |
        v
ANSWER-GRABBING FORMULATION: Foreign-currency development finance can be concessional or long-term yet still create exchange-rate exposure for a borrower whose revenues are in domestic currency.
```
### SESSION 15 — CORE SYNTHESIS — DSSI, COMMON FRAMEWORK AND GLOBAL-GOVERNANCE REFORM

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** ✅ Claim: IMF quotas determine both financial contribution and voting power, and reform of this system is a live governance debate.

**Technical definition:** Mechanism chain: DSSI and Common Framework - Global-governance reform Qualified use: Judge reform through representation, policy ownership, additionality, safeguards and debt sustainability.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mechanism chain: DSSI and Common Framework - Global-governance reform Qualified use: Judge reform through representation, policy ownership, additionality, safeguards and debt sustainability.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define DSSI, connect Common Framework with global-governance reform to explain the mechanism, and use Mechanism chain for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — DSSI, COMMON FRAMEWORK AND GLOBAL-GOVERNANCE REFORM

```text
START / CONCEPT: CORE SYNTHESIS — DSSI, Common Framework and global-governance reform
        |
        v
EXACT TERMS: CORE SYNTHESIS · DSSI · Common Framework · global-governance reform · Mechanism chain · Qualified use
        |
        v
MECHANISM / ARGUMENT: Limitation/status caution: Specific access limits, review frequencies and programme durations are periodically revised by the IMF Executive Board; state only the qualitative conditionality/structure distinction here and verify any current numerical limit from a dated IMF factsheet. ✅ Claim: The G20 Common Framework for Debt Treatment is a distinct, broader successor mechanism to the Debt Service Suspension Initiative (DSSI), not merely an extension of it, and its implementation record remains uneven rather than a settled success.
        |
        v
CONSEQUENCE / CONTRAST: Evidence The DSSI (2020) offered eligible low-income countries only a temporary suspension of official bilateral debt-service payments and formally ended in December 2021; the G20 Common Framework for Debt Treatment beyond the DSSI (agreed November 2020) instead aims at actual case-by-case debt restructuring (not just suspension), coordinating official bilateral creditors (including, notably, non-Paris-Club creditors such as China) and seeking "comparable treatment" from private creditors, for eligible low-income countries that request it.
        |
        v
UPSC TRAP / ANSWER-USE: ✅ IMF mainly addresses macroeconomic and external stability; development banks primarily finance projects and development policy. ✅ World Bank Group institutions have different mandates; the term World Bank commonly refers to IBRD and IDA. ✅ SDRs are reserve assets allocated by the IMF; they are not IMF loans, a national currency or ordinary budget revenue. ✅ Voting power, quotas, capital contributions and governance arrangements differ across institutions. ✅ Conditionality can protect programme credibility but raises ownership and social-impact debates. ✅ Multilateral development banks can mobilise private capital through guarantees and co financing. ✅ ADB launched the Nature Solutions Finance Hub for Asia and the Pacific at COP28 (December 2023) to catalyse blended finance for nature-based solutions across the region. ✅ Reserve assets, development loans and trade rules belong to different institutional architectures. ✅ "Gold tranche" and "reserve tranche position" are the same concept under an old and a current name (the reserve-asset-funded portion of quota, drawable without conditionality as part of a member's own reserves), not two separate IMF facilities. ✅ The IMF's Rapid Financing Instrument is a low-conditionality, single-disbursement emergency facility, distinct from phased, conditionality-linked programme arrangements such as the Stand-By Arrangement or Extended Fund Facility. ✅ The G20 Common Framework for Debt Treatment beyond the DSSI targets actual case-by-case debt restructuring (not mere payment suspension) for eligible low-income countries, coordinating official bilateral and private creditors; implementation to date has covered only a small number of countries and remains slow and uneven.
        |
        v
ANSWER-GRABBING FORMULATION: Mechanism chain: DSSI and Common Framework - Global-governance reform Qualified use: Judge reform through representation, policy ownership, additionality, safeguards and debt sustainability.
```
