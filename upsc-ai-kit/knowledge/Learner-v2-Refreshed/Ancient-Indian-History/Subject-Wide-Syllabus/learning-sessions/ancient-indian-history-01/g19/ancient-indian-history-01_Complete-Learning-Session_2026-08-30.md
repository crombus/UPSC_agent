...
```ascii-master
EVIDENCE LADDER
1. ✅ = from source book · ⚠️ = inference / standard knowledge · 📰 = current...
2. Study link: ⚠️ Use with basic/02 Sources-of-Ancient-Indian-History.md...
...
```ascii-master
CLOSE DISTINCTIONS
1. Contested issues Competing interpretations are attributed, evidenced and...
...
```ascii-master
ANSWER SPINE
1. Legacy preservation Substantive teaching, verified PYQ audit, 32 original...
2. Answer standard Demand decoding + claim -> named evidence -> analysis ->...
3. Practice contract Every solved item has demand decoding, an examiner-grade...
