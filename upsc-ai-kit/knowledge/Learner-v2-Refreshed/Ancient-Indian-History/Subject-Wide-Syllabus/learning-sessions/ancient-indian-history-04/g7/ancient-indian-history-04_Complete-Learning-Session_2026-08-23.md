...
**Plain-language definition:** Context: The textbook equation Palaeolithic equals Pleistocene and Mesolithic equals Holocene is a useful first approximation, not a rigid law.

**Technical definition:** FACT: Thar evidence indicates more surface water during much of the Pleistocene and increased mid-Holocene rainfall in some phases.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Context: The textbook equation Palaeolithic equals Pleistocene and Mesolithic equals Holocene is a useful first approximation, not a rigid law.
...
**How to use them:** Use Geological Context to define the issue, connect Pleistocene with Holocene to explain it, and use Changing Landscapes to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: Mains angle: Explain climate as mechanism, not master cause: climate - water/biota - resource distribution - technological and mobility response.
        |
        v
CONSEQUENCE / CONTRAST: FACT: The impact of the Toba super-eruption on South Asian populations remains debated.
        |
        v
UPSC TRAP / ANSWER-USE: FACT: Thar evidence indicates more surface water during much of the Pleistocene and increased mid-Holocene rainfall in some phases.
        |
        v
ANSWER-GRABBING FORMULATION: Context: The textbook equation Palaeolithic equals Pleistocene and Mesolithic equals Holocene is a useful first approximation, not a rigid law.
```
...
**Technical definition:** Correct: It refers to an archaic human population first identified through remains and DNA from Denisova Cave.
...
**How to use them:** Use Human Evolution to define the issue, connect The Sparse Indian Hominin Record with Mains angle to explain it, and use Study link to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: Correct: It refers to an archaic human population first identified through remains and DNA from Denisova Cave.
        |
        v
CONSEQUENCE / CONTRAST: Context: South Asia has a rich lithic record but a meagre authenticated hominin fossil record.
        |
        v
...
**Plain-language definition:** A stone tool is the surviving product of a technological sequence.

**Technical definition:** CURRENT: Retlapalle's published lithic analysis counted cores, flakes, retouched pieces, cortex, scars, platforms and reduction strategies, illustrating how modern prehistory moves beyond naming a few finished tools.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> A stone tool is the surviving product of a technological sequence.
...
**How to use them:** Use Lithic Evidence Grammar to define the issue, connect Artefact with Flake to explain it, and use Debitage to distinguish or qualify the conclusion.
...
EXACT TERMS: Lithic Evidence Grammar · Artefact · Flake · Debitage · Mains angle · Study link
        |
        v
MECHANISM / ARGUMENT: CURRENT: Retlapalle's published lithic analysis counted cores, flakes, retouched pieces, cortex, scars, platforms and reduction strategies, illustrating how modern prehistory moves beyond naming a few finished tools.
        |
        v
CONSEQUENCE / CONTRAST: Correct: It can establish distribution, but behaviour and chronology require stronger context.
        |
        v
UPSC TRAP / ANSWER-USE: Archaeologists reconstruct procurement, preparation, production, use, repair and discard from cores, flakes, unfinished pieces, hammerstones, waste and use-wear.
        |
        v
ANSWER-GRABBING FORMULATION: A stone tool is the surviving product of a technological sequence.
```
...
**Technical definition:** FACT: Rock art can be approached through superimposition, style, associated deposits, pigment/accretion radiocarbon, luminescence and uranium-series methods.
...
**How to use them:** Use Dating to define the issue, connect Archaeological Methods with Building A Defensible Chronology to explain it, and use Mains angle to distinguish or qualify the conclusion.
...
EXACT TERMS: Dating · Archaeological Methods · Building A Defensible Chronology · Mains angle · Study link · Stratigraphy
        |
        v
MECHANISM / ARGUMENT: FACT: Rock art can be approached through superimposition, style, associated deposits, pigment/accretion radiocarbon, luminescence and uranium-series methods.
        |
        v
CONSEQUENCE / CONTRAST: INFERENCE: Precision is not the same as accuracy; a narrow date on the wrong event is misleading.
        |
        v
UPSC TRAP / ANSWER-USE: CURRENT: Tamil Nadu's recent scientific-dating programme and the 2024 Retlapalle study demonstrate the expanding use of luminescence and laboratory analysis in Indian archaeology.
        |
        v
...
**Technical definition:** Mains angle: Compare textbook chronology with newer site dates, then explain the phase through landscape, manufacture and mobility rather than a list of tools.
...
**How to use them:** Use Lower Palaeolithic to define the issue, connect Acheulian Landscapes with Large Cutting Tools to explain it, and use Mains angle to distinguish or qualify the conclusion.
...
EXACT TERMS: Lower Palaeolithic · Acheulian Landscapes · Large Cutting Tools · Mains angle · Study link · Diagnostic tools
        |
        v
MECHANISM / ARGUMENT: Mains angle: Compare textbook chronology with newer site dates, then explain the phase through landscape, manufacture and mobility rather than a list of tools.
        |
        v
CONSEQUENCE / CONTRAST: FACT: Upinder Singh notes that Palaeolithic tools are widespread but excavated habitation sites are comparatively few.
        |
        v
UPSC TRAP / ANSWER-USE: Correct: The old contrast based on supposed absence of pebble tools has been rejected.
        |
        v
...
**Plain-language definition:** Wrong: Local stone means no mobility.

**Technical definition:** INFERENCE: Raw-material distance can indicate direct procurement, seasonal rounds, exchange or embedded travel; it does not identify one mechanism automatically.
...
**How to use them:** Use Raw Materials to define the issue, connect ory Sites with The Economics Of Stone to explain it, and use Mains angle to distinguish or qualify the conclusion.
...
EXACT TERMS: Raw Materials · ory Sites · The Economics Of Stone · Mains angle · Study link · Quartzite
        |
        v
MECHANISM / ARGUMENT: Scarcity can produce conservation, resharpening and long-distance procurement.
        |
        v
CONSEQUENCE / CONTRAST: Stone was not an undifferentiated resource.
        |
        v
UPSC TRAP / ANSWER-USE: FACT: Mahadaha's microlithic stone had to be transported across the Ganga from Vindhyan sources.
        |
        v
ANSWER-GRABBING FORMULATION: INFERENCE: Raw-material distance can indicate direct procurement, seasonal rounds, exchange or embedded travel; it does not identify one mechanism automatically.
```
### SESSION 7 — ATTIRAMPAKKAM AND THE CHRONOLOGY DEBATE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mains angle: Attirampakkam is a model case for how new dates revise periodization without eliminating uncertainty.
...
**How to use them:** Use Attirampakkam to define the issue, connect The Chronology Debate with Mains angle to explain it, and use Study link to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: Attirampakkam in the Kortallaiyar basin is central because multidisciplinary excavation exposed a long fluvial sequence containing Acheulian and Middle Palaeolithic technologies.
        |
        v
CONSEQUENCE / CONTRAST: Context: The site does not prove which hominin species made the tools.
        |
        v
UPSC TRAP / ANSWER-USE: METHOD: Do not attach the transition to Homo sapiens without fossil evidence.
        |
        v
ANSWER-GRABBING FORMULATION: Mains angle: Attirampakkam is a model case for how new dates revise periodization without eliminating uncertainty.
```
### SESSION 8 — MIDDLE PALAEOLITHIC: FLAKE INDUSTRIES AND PREPARED-CORE PLANNING

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Correct: It is a prepared-core reduction strategy that produces planned flakes.

**Technical definition:** Mains angle: Describe the phase as reorganization of the toolkit, raw-material use and reduction planning, not as a sudden replacement.
...
**How to use them:** Use Middle Palaeolithic to define the issue, connect Flake Industries with Prepared-Core Planning to explain it, and use Mains angle to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: Correct: It is a prepared-core reduction strategy that produces planned flakes.
        |
        v
CONSEQUENCE / CONTRAST: Mains angle: Describe the phase as reorganization of the toolkit, raw-material use and reduction planning, not as a sudden replacement.
        |
        v
...
**Technical definition:** INFERENCE: Symbolic evidence expands, yet does not justify reconstructing a formal religion.
...
**How to use them:** Use Upper Palaeolithic to define the issue, connect Blades with Bone Tools to explain it, and use Symbolic Expansion to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: Wrong: Upper Palaeolithic means only stone blades.
        |
        v
CONSEQUENCE / CONTRAST: INFERENCE: Symbolic evidence expands, yet does not justify reconstructing a formal religion.
        |
        v
UPSC TRAP / ANSWER-USE: INFERENCE: Ornament production implies skill, social communication and non-utilitarian value, but exact identity messages are unknown.
        |
        v
...
**Plain-language definition:** FACT: A microlith is generally under 5 cm and often made on short blades of cryptocrystalline stone.

**Technical definition:** Heavy and small tools can coexist because they solve different problems.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> It must not be read as a universal ladder of intelligence or a clean replacement sequence.
...
**How to use them:** Use Technology As Adaptation to define the issue, connect Core Tools To Microlithic Composites with Mains angle to explain it, and use Study link to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: Heavy and small tools can coexist because they solve different problems.
        |
        v
CONSEQUENCE / CONTRAST: INFERENCE: Miniaturization can support mobility and task diversity, not merely scarcity of stone.
        |
        v
UPSC TRAP / ANSWER-USE: Correct: Tool size reflects task, raw material and design, not a simple cognitive scale.
        |
        v
ANSWER-GRABBING FORMULATION: It must not be read as a universal ladder of intelligence or a clean replacement sequence.
```
### SESSION 11 — MOBILITY, SETTLEMENT AND SOCIAL LIFE OF PALAEOLITHIC COMMUNITIES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Context: Band society is a cautious ethnographic model: small kin-based groups, reciprocal sharing, flexible leadership and division of labour.

**Technical definition:** FACT: Bhimbetka and Hunsgi include evidence for long or repeated occupation.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Context: Band society is a cautious ethnographic model: small kin-based groups, reciprocal sharing, flexible leadership and division of labour.
...
**How to use them:** Use Mobility to define the issue, connect Settlement with Social Life Of Palaeolithic Communities to explain it, and use Mains angle to distinguish or qualify the conclusion.
...
EXACT TERMS: Mobility · Settlement · Social Life Of Palaeolithic Communities · Mains angle · Study link · Quarry/factory
        |
        v
MECHANISM / ARGUMENT: INFERENCE: Mobility was a knowledge-intensive adaptation involving routes, seasons and social ties.
        |
        v
CONSEQUENCE / CONTRAST: INFERENCE: Reciprocity and sharing are plausible in small mobile groups, but status and gender cannot be reconstructed solely from analogy.
        |
        v
UPSC TRAP / ANSWER-USE: It is not direct evidence for every prehistoric community.
        |
        v
ANSWER-GRABBING FORMULATION: Context: Band society is a cautious ethnographic model: small kin-based groups, reciprocal sharing, flexible leadership and division of labour.
```
### SESSION 12 — SUBSISTENCE AND CLIMATE-ECOLOGY ADAPTATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** INFERENCE: 'Broad-spectrum adaptation' describes diversification without assuming farming.

**Technical definition:** Context: Organic evidence preserves unevenly, so lithic function, faunal cut marks, grinding stones, starch/residue, seasonality and environmental proxies must be combined.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Hunting matters, but gathering, fishing, shellfish collection, scavenging, plant processing and small-animal capture may have supplied substantial food.
...
**How to use them:** Use Subsistence to define the issue, connect Climate-Ecology Adaptation with Mains angle to explain it, and use Study link to distinguish or qualify the conclusion.
...
EXACT TERMS: Subsistence · Climate-Ecology Adaptation · Mains angle · Study link · River/lake · Fish, turtle, wetland animals and plants
        |
        v
MECHANISM / ARGUMENT: FACT: Kachchh shell middens preserve discarded shells from food consumption and were dated through AMS carbon-14 research.
        |
        v
CONSEQUENCE / CONTRAST: INFERENCE: Resource diversity can support longer residence, but settlement permanence must be demonstrated independently.
        |
        v
UPSC TRAP / ANSWER-USE: Palaeolithic and Mesolithic subsistence was broad and ecologically specific.
        |
        v
ANSWER-GRABBING FORMULATION: Hunting matters, but gathering, fishing, shellfish collection, scavenging, plant processing and small-animal capture may have supplied substantial food.
```
...
**Technical definition:** Indian Palaeolithic symbolic evidence includes cupules, engravings, beads, unusual discs, ochre and the debated Baghor I platform.
...
**How to use them:** Use Palaeolithic Art to define the issue, connect Ornament with Cult Evidence to explain it, and use Mains angle to distinguish or qualify the conclusion.
...
UPSC TRAP / ANSWER-USE: Continuity with present communities can inspire questions but cannot prove unchanged belief.
        |
        v
ANSWER-GRABBING FORMULATION: Mains angle: Use symbolic evidence to challenge the stereotype of purely utilitarian Stone Age life, while explicitly bounding ritual inference.
```
...
**Technical definition:** It was neither merely a gap between two important ages nor an automatic farming stage.
...
**How to use them:** Use Mesolithic Transition to define the issue, connect Holocene Adaptation with Not A Single Revolution to explain it, and use Mains angle to distinguish or qualify the conclusion.
...
EXACT TERMS: Mesolithic Transition · Holocene Adaptation · Not A Single Revolution · Mains angle · Study link · Geological setting
        |
        v
MECHANISM / ARGUMENT: FACT: The Mesolithic record is larger and more socially detailed than the Indian Palaeolithic record.
        |
        v
CONSEQUENCE / CONTRAST: FACT: Pottery is absent at many Mesolithic sites but occurs at some.
        |
        v
UPSC TRAP / ANSWER-USE: INFERENCE: Transition means changing proportions and combinations, not universal replacement.
        |
        v
...
**Plain-language definition:** Mains angle: Explain why microliths are a technological system: production + backing + hafting + replaceability + functional diversity.

**Technical definition:** Function must be tested through wear, residue, experimental replication and ethnographic comparison.
...
**How to use them:** Use Microliths to define the issue, connect Composite Technology with Mains angle to explain it, and use Study link to distinguish or qualify the conclusion.
...
EXACT TERMS: Microliths · Composite Technology · Mains angle · Study link · Backed bladelet · Knife or projectile insert
        |
        v
MECHANISM / ARGUMENT: Function must be tested through wear, residue, experimental replication and ethnographic comparison.
        |
        v
CONSEQUENCE / CONTRAST: INFERENCE: Bow-and-arrow use is plausible at many sites but should be supported by impact and contextual evidence.
        |
        v
UPSC TRAP / ANSWER-USE: METHOD: Do not date an undated surface microlith merely by typology.
        |
        v
ANSWER-GRABBING FORMULATION: Mains angle: Explain why microliths are a technological system: production + backing + hafting + replaceability + functional diversity.
```
### SESSION 16 — MESOLITHIC SUBSISTENCE, SEDENTARINESS AND DOMESTICATION DEBATES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** FACT: Adamgarh domestication claims are questioned because of uncertain dates and stratigraphy.

**Technical definition:** Thick deposits, huts, heavy grinding stones, commensal species, seasonality evidence and cemeteries can demonstrate repeated or year-round residence without a fully agricultural economy.
...
**How to use them:** Use Mesolithic Subsistence to define the issue, connect Sedentariness with Domestication Debates to explain it, and use Mains angle to distinguish or qualify the conclusion.
...
EXACT TERMS: Mesolithic Subsistence · Sedentariness · Domestication Debates · Mains angle · Study link · Chopani Mando
        |
        v
MECHANISM / ARGUMENT: INFERENCE: Pottery and copper can enter forager communities through interaction.
        |
        v
CONSEQUENCE / CONTRAST: Some sites report domesticated animals, pottery or cultivated plants, but identification, stratigraphy and dating are frequently contested.
        |
        v
UPSC TRAP / ANSWER-USE: Thick deposits, huts, heavy grinding stones, commensal species, seasonality evidence and cemeteries can demonstrate repeated or year-round residence without a fully agricultural economy.
        |
        v
ANSWER-GRABBING FORMULATION: FACT: Adamgarh domestication claims are questioned because of uncertain dates and stratigraphy.
```
...
**Technical definition:** Mains angle: Use burials to connect settlement permanence, social memory and ritual while distinguishing evidence from interpretation.
...
**How to use them:** Use Burials to define the issue, connect Ritual with Social Organization to explain it, and use Mains angle to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: CURRENT: The 2026 Ladakh aDNA study is later than the Stone Age, but it illustrates how burials can now be studied through osteology, radiocarbon, kinship and genome-wide data together.
        |
        v
CONSEQUENCE / CONTRAST: INFERENCE: Unequal grave goods may signal social difference, but a hereditary hierarchy is not demonstrated.
        |
        v
UPSC TRAP / ANSWER-USE: Burial is an action by survivors, not a transparent portrait of the deceased.
        |
        v
ANSWER-GRABBING FORMULATION: Mains angle: Use burials to connect settlement permanence, social memory and ritual while distinguishing evidence from interpretation.
```
### SESSION 18 — ROCK ART: BHIMBETKA, REGIONAL TRADITIONS AND INTERPRETATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Wrong: All Bhimbetka paintings are Mesolithic.

**Technical definition:** Mains angle: Bhimbetka should be used as a combined history-art-conservation case: evidence of life, limits of meaning, and heritage-management ethics.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Bhimbetka's layered record shows hunting, animals, gathering, food preparation, dance, gendered activities and later historical scenes.
...
**How to use them:** Use Rock Art to define the issue, connect Bhimbetka with Regional Traditions to explain it, and use Interpretation to distinguish or qualify the conclusion.
...
EXACT TERMS: Rock Art · Bhimbetka · Regional Traditions · Interpretation · Mains angle · Study link
        |
        v
MECHANISM / ARGUMENT: Mains angle: Bhimbetka should be used as a combined history-art-conservation case: evidence of life, limits of meaning, and heritage-management ethics.
        |
        v
CONSEQUENCE / CONTRAST: INFERENCE: Tourism can improve interpretation and funding but increases touch, moisture, litter and infrastructure risks.
        |
        v
UPSC TRAP / ANSWER-USE: It is an archaeological source, not a picture-book transcript.
        |
        v
ANSWER-GRABBING FORMULATION: Bhimbetka's layered record shows hunting, animals, gathering, food preparation, dance, gendered activities and later historical scenes.
```
...
**Technical definition:** INFERENCE: Site clusters should be read as regional systems connected by movement and exchange.
...
**How to use them:** Use Major Indian Sites to define the issue, connect Regional Traditions with A Text Map to explain it, and use Mains angle to distinguish or qualify the conclusion.
...
EXACT TERMS: Major Indian Sites · Regional Traditions · A Text Map · Mains angle · Study link · North-west/Soan-Siwalik
        |
        v
MECHANISM / ARGUMENT: INFERENCE: Site clusters should be read as regional systems connected by movement and exchange.
        |
        v
CONSEQUENCE / CONTRAST: FACT: Isampur is a major manufacturing and habitation centre in the Hunsgi valley.
        |
        v
UPSC TRAP / ANSWER-USE: Mains angle: Use a north-west to south-east map spine and attach one diagnostic phrase to every site.
        |
        v
...
**Plain-language definition:** INFERENCE: The Neolithic threshold is a bundle of processes, not a single invention.

**Technical definition:** FACT: Bagor's later Mesolithic phase includes increased plant processing and traces of copper interaction.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Context: Neolithic markers include domesticated plants/animals, cultivation, more settled village life, polished tools and often pottery, but these features do not always arrive together.
...
**How to use them:** Use Continuity to define the issue, connect Change Toward The Neolithic with Mains angle to explain it, and use Study link to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: Correct: Pottery can occur among foragers and may be acquired through contact.
        |
        v
CONSEQUENCE / CONTRAST: INFERENCE: The Neolithic threshold is a bundle of processes, not a single invention.
        |
        v
UPSC TRAP / ANSWER-USE: Mesolithic communities could experiment with plant intensification, animal management, pottery, storage and longer residence while continuing to hunt, gather and fish.
        |
        v
ANSWER-GRABBING FORMULATION: Context: Neolithic markers include domesticated plants/animals, cultivation, more settled village life, polished tools and often pottery, but these features do not always arrive together.
```
...
**Technical definition:** Mains angle: Conclude: Indian prehistory is no longer a single march from crude to refined tools; it is a regionally varied history of adaptation reconstructed through converging but incomplete evidence.
...
**How to use them:** Use Historiographical Debates to define the issue, connect Source Limitations with Current Research to explain it, and use Mains angle to distinguish or qualify the conclusion.
...
EXACT TERMS: Historiographical Debates · Source Limitations · Current Research · Mains angle · Study link · Periodization
        |
        v
MECHANISM / ARGUMENT: Mains angle: Conclude: Indian prehistory is no longer a single march from crude to refined tools; it is a regionally varied history of adaptation reconstructed through converging but incomplete evidence.
        |
        v
CONSEQUENCE / CONTRAST: FACT: The 2026 Ladakh study recovered genome-wide data from 10 unique individuals and demonstrates current South Asian aDNA capacity, while remaining chronologically later than this topic.
        |
        v
UPSC TRAP / ANSWER-USE: Tools remain essential, but they are now integrated with geomorphology, palaeoclimate, use-wear, residue, fauna, burials, aDNA and heritage science.
        |
        v
...
| B | It is based only on metal use |
...
| D | Contains the earliest Indian pottery |
...
| B | The Mature Harappan |
| C | The Iron Age |
| D | The historic survival of celts |
...
| C | Adamgarh proves a fixed 5000 BCE date |
| D | Pottery proves cultivation |
...
|   DEFINITION / TERMS : FACT: Thar evidence indicates more surface water during much of the Pleistocene and increased mid-Holocene rainfall in some phases.
|   MECHANISM / ARGUMENT: Mains angle: Explain climate as mechanism, not master cause: climate - water/biota - resource distribution - technological and mobility response.
|   CONSEQUENCE / CONTRAST: FACT: The impact of the Toba super-eruption on South Asian populations remains debated.
|   TRAP / ANSWER-USE: FACT: Thar evidence indicates more surface water during much of the Pleistocene and increased mid-Holocene rainfall in some phases.
|   EXAM OPENING: Context: The textbook equation Palaeolithic equals Pleistocene and Mesolithic equals Holocene is a useful first approximation, not a rigid law.
+--
        |
        v
+-- SESSION 02: HUMAN EVOLUTION AND THE SPARSE INDIAN HOMININ RECORD
|   DEFINITION / TERMS : Correct: It refers to an archaic human population first identified through remains and DNA from Denisova Cave.
|   MECHANISM / ARGUMENT: Correct: It refers to an archaic human population first identified through remains and DNA from Denisova Cave.
|   CONSEQUENCE / CONTRAST: Context: South Asia has a rich lithic record but a meagre authenticated hominin fossil record.
...
|   DEFINITION / TERMS : CURRENT: Retlapalle's published lithic analysis counted cores, flakes, retouched pieces, cortex, scars, platforms and reduction strategies, illustrating how modern prehistory moves beyond naming a few finished tools.
|   MECHANISM / ARGUMENT: CURRENT: Retlapalle's published lithic analysis counted cores, flakes, retouched pieces, cortex, scars, platforms and reduction strategies, illustrating how modern prehistory moves beyond naming a few finished tools.
|   CONSEQUENCE / CONTRAST: Correct: It can establish distribution, but behaviour and chronology require stronger context.
|   TRAP / ANSWER-USE: Archaeologists reconstruct procurement, preparation, production, use, repair and discard from cores, flakes, unfinished pieces, hammerstones, waste and use-wear.
|   EXAM OPENING: A stone tool is the surviving product of a technological sequence.
+--
        |
        v
+-- SESSION 04: DATING AND ARCHAEOLOGICAL METHODS: BUILDING A DEFENSIBLE CHRONOLOGY
|   DEFINITION / TERMS : FACT: Rock art can be approached through superimposition, style, associated deposits, pigment/accretion radiocarbon, luminescence and uranium-series methods.
|   MECHANISM / ARGUMENT: FACT: Rock art can be approached through superimposition, style, associated deposits, pigment/accretion radiocarbon, luminescence and uranium-series methods.
|   CONSEQUENCE / CONTRAST: INFERENCE: Precision is not the same as accuracy; a narrow date on the wrong event is misleading.
|   TRAP / ANSWER-USE: CURRENT: Tamil Nadu's recent scientific-dating programme and the 2024 Retlapalle study demonstrate the expanding use of luminescence and laboratory analysis in Indian archaeology.
...
|   DEFINITION / TERMS : Mains angle: Compare textbook chronology with newer site dates, then explain the phase through landscape, manufacture and mobility rather than a list of tools.
|   MECHANISM / ARGUMENT: Mains angle: Compare textbook chronology with newer site dates, then explain the phase through landscape, manufacture and mobility rather than a list of tools.
|   CONSEQUENCE / CONTRAST: FACT: Upinder Singh notes that Palaeolithic tools are widespread but excavated habitation sites are comparatively few.
|   TRAP / ANSWER-USE: Correct: The old contrast based on supposed absence of pebble tools has been rejected.
...
|   DEFINITION / TERMS : INFERENCE: Raw-material distance can indicate direct procurement, seasonal rounds, exchange or embedded travel; it does not identify one mechanism automatically.
|   MECHANISM / ARGUMENT: Scarcity can produce conservation, resharpening and long-distance procurement.
|   CONSEQUENCE / CONTRAST: Stone was not an undifferentiated resource.
|   TRAP / ANSWER-USE: FACT: Mahadaha's microlithic stone had to be transported across the Ganga from Vindhyan sources.
|   EXAM OPENING: INFERENCE: Raw-material distance can indicate direct procurement, seasonal rounds, exchange or embedded travel; it does not identify one mechanism automatically.
+--
        |
        v
...
|   MECHANISM / ARGUMENT: Attirampakkam in the Kortallaiyar basin is central because multidisciplinary excavation exposed a long fluvial sequence containing Acheulian and Middle Palaeolithic technologies.
|   CONSEQUENCE / CONTRAST: Context: The site does not prove which hominin species made the tools.
|   TRAP / ANSWER-USE: METHOD: Do not attach the transition to Homo sapiens without fossil evidence.
|   EXAM OPENING: Mains angle: Attirampakkam is a model case for how new dates revise periodization without eliminating uncertainty.
+--
        |
        v
+-- SESSION 08: MIDDLE PALAEOLITHIC: FLAKE INDUSTRIES AND PREPARED-CORE PLANNING
|   DEFINITION / TERMS : Mains angle: Describe the phase as reorganization of the toolkit, raw-material use and reduction planning, not as a sudden replacement.
|   MECHANISM / ARGUMENT: Correct: It is a prepared-core reduction strategy that produces planned flakes.
|   CONSEQUENCE / CONTRAST: Mains angle: Describe the phase as reorganization of the toolkit, raw-material use and reduction planning, not as a sudden replacement.
...
|   DEFINITION / TERMS : INFERENCE: Symbolic evidence expands, yet does not justify reconstructing a formal religion.
|   MECHANISM / ARGUMENT: Wrong: Upper Palaeolithic means only stone blades.
|   CONSEQUENCE / CONTRAST: INFERENCE: Symbolic evidence expands, yet does not justify reconstructing a formal religion.
|   TRAP / ANSWER-USE: INFERENCE: Ornament production implies skill, social communication and non-utilitarian value, but exact identity messages are unknown.
...
+--
        ...
        v
+-- SESSION 10: TECHNOLOGY AS ADAPTATION: CORE TOOLS TO MICROLITHIC COMPOSITES
|   DEFINITION / TERMS : Heavy and small tools can coexist because they solve different problems.
|   MECHANISM / ARGUMENT: Heavy and small tools can coexist because they solve different problems.
|   CONSEQUENCE / CONTRAST: INFERENCE: Miniaturization can support mobility and task diversity, not merely scarcity of stone.
|   TRAP / ANSWER-USE: Correct: Tool size reflects task, raw material and design, not a simple cognitive scale.
|   EXAM OPENING: It must not be read as a universal ladder of intelligence or a clean replacement sequence.
+--
        |
        v
+-- SESSION 11: MOBILITY, SETTLEMENT AND SOCIAL LIFE OF PALAEOLITHIC COMMUNITIES
|   DEFINITION / TERMS : FACT: Bhimbetka and Hunsgi include evidence for long or repeated occupation.
|   MECHANISM / ARGUMENT: INFERENCE: Mobility was a knowledge-intensive adaptation involving routes, seasons and social ties.
|   CONSEQUENCE / CONTRAST: INFERENCE: Reciprocity and sharing are plausible in small mobile groups, but status and gender cannot be reconstructed solely from analogy.
|   TRAP / ANSWER-USE: It is not direct evidence for every prehistoric community.
|   EXAM OPENING: Context: Band society is a cautious ethnographic model: small kin-based groups, reciprocal sharing, flexible leadership and division of labour.
+--
        |
        v
+-- SESSION 12: SUBSISTENCE AND CLIMATE-ECOLOGY ADAPTATION
|   DEFINITION / TERMS : Context: Organic evidence preserves unevenly, so lithic function, faunal cut marks, grinding stones, starch/residue, seasonality and environmental proxies must be combined.
|   MECHANISM / ARGUMENT: FACT: Kachchh shell middens preserve discarded shells from food consumption and were dated through AMS carbon-14 research.
|   CONSEQUENCE / CONTRAST: INFERENCE: Resource diversity can support longer residence, but settlement permanence must be demonstrated independently.
|   TRAP / ANSWER-USE: Palaeolithic and Mesolithic subsistence was broad and ecologically specific.
|   EXAM OPENING: Hunting matters, but gathering, fishing, shellfish collection, scavenging, plant processing and small-animal capture may have supplied substantial food.
+--
        |
        v
+-- SESSION 13: PALAEOLITHIC ART, ORNAMENT AND CULT EVIDENCE
|   DEFINITION / TERMS : Indian Palaeolithic symbolic evidence includes cupules, engravings, beads, unusual discs, ochre and the debated Baghor I platform.
|   MECHANISM / ARGUMENT: CURRENT: Conservation science and direct/indirect dating remain crucial because claims about 'oldest art' are especially vulnerable to overstatement.
|   CONSEQUENCE / CONTRAST: These finds show non-utilitarian behaviour but do not permit a complete reconstruction of religion.
|   TRAP / ANSWER-USE: Continuity with present communities can inspire questions but cannot prove unchanged belief.
|   EXAM OPENING: Mains angle: Use symbolic evidence to challenge the stereotype of purely utilitarian Stone Age life, while explicitly bounding ritual inference.
+--
        |
        v
+-- SESSION 14: MESOLITHIC TRANSITION: HOLOCENE ADAPTATION, NOT A SINGLE REVOLUTION
|   DEFINITION / TERMS : It was neither merely a gap between two important ages nor an automatic farming stage.
|   MECHANISM / ARGUMENT: FACT: The Mesolithic record is larger and more socially detailed than the Indian Palaeolithic record.
|   CONSEQUENCE / CONTRAST: FACT: Pottery is absent at many Mesolithic sites but occurs at some.
|   TRAP / ANSWER-USE: INFERENCE: Transition means changing proportions and combinations, not universal replacement.
...
+--
        ...
        v
+-- SESSION 15: MICROLITHS AND COMPOSITE TECHNOLOGY
|   DEFINITION / TERMS : Function must be tested through wear, residue, experimental replication and ethnographic comparison.
|   MECHANISM / ARGUMENT: Function must be tested through wear, residue, experimental replication and ethnographic comparison.
|   CONSEQUENCE / CONTRAST: INFERENCE: Bow-and-arrow use is plausible at many sites but should be supported by impact and contextual evidence.
|   TRAP / ANSWER-USE: METHOD: Do not date an undated surface microlith merely by typology.
|   EXAM OPENING: Mains angle: Explain why microliths are a technological system: production + backing + hafting + replaceability + functional diversity.
+--
        |
        v
+-- SESSION 16: MESOLITHIC SUBSISTENCE, SEDENTARINESS AND DOMESTICATION DEBATES
|   DEFINITION / TERMS : Thick deposits, huts, heavy grinding stones, commensal species, seasonality evidence and cemeteries can demonstrate repeated or year-round residence without a fully agricultural economy.
|   MECHANISM / ARGUMENT: INFERENCE: Pottery and copper can enter forager communities through interaction.
|   CONSEQUENCE / CONTRAST: Some sites report domesticated animals, pottery or cultivated plants, but identification, stratigraphy and dating are frequently contested.
|   TRAP / ANSWER-USE: Thick deposits, huts, heavy grinding stones, commensal species, seasonality evidence and cemeteries can demonstrate repeated or year-round residence without a fully agricultural economy.
|   EXAM OPENING: FACT: Adamgarh domestication claims are questioned because of uncertain dates and stratigraphy.
+--
        |
        v
+-- SESSION 17: BURIALS, RITUAL AND SOCIAL ORGANIZATION
|   DEFINITION / TERMS : Mains angle: Use burials to connect settlement permanence, social memory and ritual while distinguishing evidence from interpretation.
|   MECHANISM / ARGUMENT: CURRENT: The 2026 Ladakh aDNA study is later than the Stone Age, but it illustrates how burials can now be studied through osteology, radiocarbon, kinship and genome-wide data together.
|   CONSEQUENCE / CONTRAST: INFERENCE: Unequal grave goods may signal social difference, but a hereditary hierarchy is not demonstrated.
|   TRAP / ANSWER-USE: Burial is an action by survivors, not a transparent portrait of the deceased.
|   EXAM OPENING: Mains angle: Use burials to connect settlement permanence, social memory and ritual while distinguishing evidence from interpretation.
+--
        |
        v
+-- SESSION 18: ROCK ART: BHIMBETKA, REGIONAL TRADITIONS AND INTERPRETATION
|   DEFINITION / TERMS : Mains angle: Bhimbetka should be used as a combined history-art-conservation case: evidence of life, limits of meaning, and heritage-management ethics.
|   MECHANISM / ARGUMENT: Mains angle: Bhimbetka should be used as a combined history-art-conservation case: evidence of life, limits of meaning, and heritage-management ethics.
|   CONSEQUENCE / CONTRAST: INFERENCE: Tourism can improve interpretation and funding but increases touch, moisture, litter and infrastructure risks.
|   TRAP / ANSWER-USE: It is an archaeological source, not a picture-book transcript.
|   EXAM OPENING: Bhimbetka's layered record shows hunting, animals, gathering, food preparation, dance, gendered activities and later historical scenes.
+--
        |
        v
+-- SESSION 19: MAJOR INDIAN SITES AND REGIONAL TRADITIONS: A TEXT MAP
|   DEFINITION / TERMS : INFERENCE: Site clusters should be read as regional systems connected by movement and exchange.
|   MECHANISM / ARGUMENT: INFERENCE: Site clusters should be read as regional systems connected by movement and exchange.
|   CONSEQUENCE / CONTRAST: FACT: Isampur is a major manufacturing and habitation centre in the Hunsgi valley.
|   TRAP / ANSWER-USE: Mains angle: Use a north-west to south-east map spine and attach one diagnostic phrase to every site.
|   EXAM OPENING: Indian prehistory is a mosaic of river valleys, plateaus, deserts, coasts, caves and alluvial plains.
+--
        |
        v
+-- SESSION 20: CONTINUITY AND CHANGE TOWARD THE NEOLITHIC
|   DEFINITION / TERMS : FACT: Bagor's later Mesolithic phase includes increased plant processing and traces of copper interaction.
|   MECHANISM / ARGUMENT: Correct: Pottery can occur among foragers and may be acquired through contact.
|   CONSEQUENCE / CONTRAST: INFERENCE: The Neolithic threshold is a bundle of processes, not a single invention.
...
|   EXAM OPENING: Context: Neolithic markers include domesticated plants/animals, cultivation, more settled village life, polished tools and often pottery, but these features do not always arrive together.
+--
        |
        v
+-- SESSION 21: HISTORIOGRAPHICAL DEBATES, SOURCE LIMITATIONS AND CURRENT RESEARCH
|   DEFINITION / TERMS : Mains angle: Conclude: Indian prehistory is no longer a single march from crude to refined tools; it is a regionally varied history of adaptation reconstructed through converging but incomplete evidence.
|   MECHANISM / ARGUMENT: Mains angle: Conclude: Indian prehistory is no longer a single march from crude to refined tools; it is a regionally varied history of adaptation reconstructed through converging but incomplete evidence.
|   CONSEQUENCE / CONTRAST: FACT: The 2026 Ladakh study recovered genome-wide data from 10 unique individuals and demonstrates current South Asian aDNA capacity, while remaining chronologically later than this topic.
|   TRAP / ANSWER-USE: Tools remain essential, but they are now integrated with geomorphology, palaeoclimate, use-wear, residue, fauna, burials, aDNA and heritage science.
