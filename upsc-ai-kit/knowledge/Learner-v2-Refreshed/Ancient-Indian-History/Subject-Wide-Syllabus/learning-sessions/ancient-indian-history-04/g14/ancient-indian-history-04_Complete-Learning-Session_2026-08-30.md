...
2. Adamgarh (MP) and Bagor (Rajasthan) provide early evidence for...
3. Bhimbetka is a key rock-art and prehistoric occupation site.
...
```ascii-master
CLOSE DISTINCTIONS
1. B-04 Domestication and Sambhar claims with caution Cards 13, 17 and 21
2. A-06 Rock art and cult evidence with caution Cards 14 and 19
3. Contested issues Competing interpretations are attributed, evidenced...
...
```ascii-master
ANSWER SPINE
1. Practice contract Every solved item has demand decoding, an examiner-...
2. [Interpretation] Dating, regionality, continuity, debates and UPSC...
3. METHOD: Facts from sources are labelled FACT; analytical synthesis is...
