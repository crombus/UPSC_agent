---
title: "Intellectual Property Rights and Patents — Learner-v2 Refreshed"
topic_key: science-and-technology-17
cover_image: assets/Teaching-Navigation.png
---
# Intellectual Property Rights and Patents — Learner-v2 Complete Learning Session
...
- **PYQ integrity:** Audited ledgers route the 2019 Prelims demand on the Indian Patents Act and IPAB, the 2019 GS-III traditional-knowledge protection demand and the 2024 GS-III life-material IPR and commercialisation demand to this owner. Three representative cards preserve those routes without inventing an objective key, a patent count or a case outcome.
- **Live-link boundary:** Official IP India, WIPO, WTO and TKDL-source attempts were made on 2026-09-04. They confirm the patentability criteria, limited territorial patent bargain, PCT-national-phase boundary and TRIPS-WTO architecture where substantive text was retrieved. Exact section claims remain owner-bounded; no filing/grant count, commercialisation rate, case outcome or blanket software rule is asserted.
...
- https://ipindia.gov.in/basics-of-patents - fetched 2026-09-04; substantive IP India text confirmed the limited statutory patent right, product-or-process scope, novelty, inventive step, industrial application and the section 3/4 exclusion boundary. It supplied no filing, grant, commercialisation or litigation count.
- https://ipindia.gov.in/pages/patents/chapter - fetched 2026-09-04; the official page identified the Patents Act, 1970 and warned that Gazette text prevails over the e-version. No unverified amendment effect, current form deadline or procedural statistic was imported.
- https://ipindia.gov.in/storage/uploads/docs-operator/73b5bf10-b04e-4f45-abef-87ff117315dc.pdf - attempted 2026-09-04; the official PDF was retrievable only as raw PDF bytes through the live tool. Exact section propositions are therefore retained only where already supported by the audited Basic and Advanced owners.
- https://www.wipo.int/en/web/pct-system/faqs/faqs - fetched 2026-09-04; substantive WIPO text confirmed that the PCT is an international application route, publication normally follows the 18-month point, national or regional offices control grant, and patents remain territorial. No 'world patent' claim was imported.
- https://www.wto.org/english/tratop_e/trips_e/intel2_e.htm - fetched 2026-09-04; substantive WTO text confirmed TRIPS minimum standards, enforcement and WTO dispute-settlement architecture across named IP fields. TRIPS was not described as a filing office or patent grant.
- https://www.tkdl.res.in/tkdl/langdefault/common/Abouttkdl.asp - attempted 2026-09-04; retrieval failed at the transport layer. The CSIR-Ministry of Ayush defensive-prior-art proposition is retained from the audited owner, with no database-size or patent-outcome count.
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Science-and-Technology\basic\17_Intellectual-Property-Rights-and-Patents.md`  
**Substantive canonical provenance owner:** `upsc-ai-kit\knowledge\Science-and-Technology\learning-sessions\v2\subject-wide-syllabus\science-and-technology-17_Learning-Session.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Science-and-Technology\advanced\17_Intellectual-Property-Rights-and-Patents.md`  
...
### SESSION 1 — FOUNDATION — PATENT BARGAIN NOVELTY INVENTIVE STEP AND INDUSTRIAL APPLICATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** A patent is a limited statutory exclusion granted in exchange for disclosure; the claimed invention must be novel, involve an inventive step, be capable of industrial application and avoid the exclusions in sections 3 and 4.

**Technical definition:** Read Patent bargain novelty inventive step and industrial application as a sequence: identify Patent bargain and criteria, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
...
- **FOUNDATION**
- **Patent bargain novelty inventive step**
- **industrial application**
- **Mechanism chain**
- **Qualified use**
- **A patent**

**How to use them:** Frame the answer through FOUNDATION; define Patent bargain novelty inventive step, connect industrial application with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.

#### VISUAL FIRST

```text
PATENT BARGAIN NOVELTY INVENTIVE STEP AND INDUSTRIAL APPLICATION
01. Patent bargain and criteria
    |
    v
02. Invention-discovery boundary
STATUS / CATEGORY FIREWALL -> Do not treat novelty, inventive step and industrial applicability as optional alternatives.
```
...
A patent is a limited statutory exclusion granted in exchange for disclosure; the claimed invention must be novel, involve an inventive step, be capable of industrial application and avoid the exclusions in sections 3 and 4. Patent law protects a qualifying new product or process, not a bare discovery; finding a natural fact, known property or known use does not by itself establish an invention, and Section 3(d) supplies a specific known-substance filter.

#### SIMPLE SYSTEM EXAMPLE

Read Patent bargain novelty inventive step and industrial application as a sequence: identify Patent bargain and criteria, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### TECHNICAL DISTINCTION

The decisive boundary is Do not treat novelty, inventive step and industrial applicability as optional alternatives. This keeps Patent bargain and criteria and Invention-discovery boundary in the correct scientific category, institution and unit of measurement.
...
- **Mains:** Open with the disclosure-for-exclusion bargain and apply all three criteria.

#### MINI RECAP

- **Mechanism chain:** Patent bargain and criteria -> Invention-discovery boundary
- **Qualified use:** Open with the disclosure-for-exclusion bargain and apply all three criteria.

#### CLOSING RECALL FLOW — FOUNDATION — PATENT BARGAIN NOVELTY INVENTIVE STEP AND INDUSTRIAL APPLICATION

```text
START / CONCEPT: FOUNDATION — Patent bargain novelty inventive step and industrial application
        |
        v
EXACT TERMS: FOUNDATION · Patent bargain novelty inventive step · industrial application · Mechanism chain · Qualified use · A patent
        |
        v
MECHANISM / ARGUMENT: Read Patent bargain novelty inventive step and industrial application as a sequence: identify Patent bargain and criteria, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
        |
        v
CONSEQUENCE / CONTRAST: The decisive boundary is Do not treat novelty, inventive step and industrial applicability as optional alternatives.
        |
        v
UPSC TRAP / ANSWER-USE: Do not treat novelty, inventive step and industrial applicability as optional alternatives.
        |
        v
ANSWER-GRABBING FORMULATION: A patent is a limited statutory exclusion granted in exchange for disclosure; the claimed invention must be novel, involve an inventive step, be capable of industrial application and avoid the exclusions in sections 3 and 4.
```
### SESSION 2 — FOUNDATION — INVENTION DISCOVERY PRODUCT AND PROCESS BOUNDARIES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The decisive boundary is Do not call a discovery patentable merely because it is useful.

**Technical definition:** Read Invention discovery product and process boundaries as a sequence: identify Product-process boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Read Invention discovery product and process boundaries as a sequence: identify Product-process boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### MUST-WRITE KEYWORDS

- **FOUNDATION**
- **Invention discovery product**
- **process boundaries**
- **Mechanism chain**
- **Qualified use**
- **Read Invention**

**How to use them:** Frame the answer through FOUNDATION; define Invention discovery product, connect process boundaries with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.

#### VISUAL FIRST

```text
INVENTION DISCOVERY PRODUCT AND PROCESS BOUNDARIES
01. Product-process boundary
STATUS / CATEGORY FIREWALL -> Do not call a discovery patentable merely because it is useful.
```
...
The decisive boundary is Do not call a discovery patentable merely because it is useful. This keeps Product-process boundary in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Classify discovery, product and process before discussing legal protection.

#### MINI RECAP

- **Mechanism chain:** Product-process boundary
- **Qualified use:** Classify discovery, product and process before discussing legal protection.

#### CLOSING RECALL FLOW — FOUNDATION — INVENTION DISCOVERY PRODUCT AND PROCESS BOUNDARIES

```text
START / CONCEPT: FOUNDATION — Invention discovery product and process boundaries
        |
        v
EXACT TERMS: FOUNDATION · Invention discovery product · process boundaries · Mechanism chain · Qualified use · Read Invention
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Product-process boundary Qualified use: Classify discovery, product and process before discussing legal protection.
        |
        v
CONSEQUENCE / CONTRAST: The decisive boundary is Do not call a discovery patentable merely because it is useful.
        |
        v
UPSC TRAP / ANSWER-USE: Do not call a discovery patentable merely because it is useful.
        |
        v
ANSWER-GRABBING FORMULATION: Read Invention discovery product and process boundaries as a sequence: identify Product-process boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
```
### SESSION 3 — FOUNDATION — PATENT TERM TERRITORIALITY AND INTERNATIONAL PROTECTION CHOICES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The patent term is 20 years from filing and is not indefinitely renewable; protection is territorial, so an Indian grant is not a world right and foreign protection requires national or regional routes.

**Technical definition:** Read Patent term territoriality and international protection choices as a sequence: identify Term-territoriality boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Read Patent term territoriality and international protection choices as a sequence: identify Term-territoriality boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### MUST-WRITE KEYWORDS

- **FOUNDATION**
- **Patent term territoriality**
- **international protection choices**
- **Mechanism chain**
- **Qualified use**
- **The patent term**

**How to use them:** Frame the answer through FOUNDATION; define Patent term territoriality, connect international protection choices with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.

#### VISUAL FIRST

```text
PATENT TERM TERRITORIALITY AND INTERNATIONAL PROTECTION CHOICES
01. Term-territoriality boundary
STATUS / CATEGORY FIREWALL -> Do not merge product protection with a protected manufacturing process.
```
...
The decisive boundary is Do not merge product protection with a protected manufacturing process. This keeps Term-territoriality boundary in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** State term and territoriality before selecting direct, Paris or PCT routes.

#### MINI RECAP

- **Mechanism chain:** Term-territoriality boundary
- **Qualified use:** State term and territoriality before selecting direct, Paris or PCT routes.

#### CLOSING RECALL FLOW — FOUNDATION — PATENT TERM TERRITORIALITY AND INTERNATIONAL PROTECTION CHOICES

```text
START / CONCEPT: FOUNDATION — Patent term territoriality and international protection choices
        |
        v
EXACT TERMS: FOUNDATION · Patent term territoriality · international protection choices · Mechanism chain · Qualified use · The patent term
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Term-territoriality boundary Qualified use: State term and territoriality before selecting direct, Paris or PCT routes.
        |
        v
CONSEQUENCE / CONTRAST: The patent term is 20 years from filing and is not indefinitely renewable; protection is territorial, so an Indian grant is not a world right and foreign protection requires national or regional routes.
        |
        v
UPSC TRAP / ANSWER-USE: The decisive boundary is Do not merge product protection with a protected manufacturing process.
        |
        v
ANSWER-GRABBING FORMULATION: Read Patent term territoriality and international protection choices as a sequence: identify Term-territoriality boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
```
### SESSION 4 — CORE — APPLICATION PUBLICATION EXAMINATION OPPOSITION AND GRANT

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Filing creates an application, publication discloses it, examination occurs on request, opposition may test it, and grant follows only if the legal requirements are met; application, publication, examination and grant are not interchangeable status verbs.

**Technical definition:** Read Application publication examination opposition and grant as a sequence: identify Application-publication-examination-grant ladder, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
...
- **Application publication examination opposition**
- **grant**
- **Mechanism chain**
- **Qualified use**
- **Filing**
...
**How to use them:** Frame the answer through Application publication examination opposition; define grant, connect Mechanism chain with Qualified use to explain the mechanism, and use Filing for the decisive comparison or qualification.

#### VISUAL FIRST

```text
APPLICATION PUBLICATION EXAMINATION OPPOSITION AND GRANT
01. Application-publication-examination-grant ladder
STATUS / CATEGORY FIREWALL -> Do not call a 20-year territorial patent perpetual or global.
```
...
Read Application publication examination opposition and grant as a sequence: identify Application-publication-examination-grant ladder, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### TECHNICAL DISTINCTION

The decisive boundary is Do not call a 20-year territorial patent perpetual or global. This keeps Application-publication-examination-grant ladder in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Move through every procedural rung without upgrading the status verb.

#### MINI RECAP

- **Mechanism chain:** Application-publication-examination-grant ladder
- **Qualified use:** Move through every procedural rung without upgrading the status verb.

#### CLOSING RECALL FLOW — CORE — APPLICATION PUBLICATION EXAMINATION OPPOSITION AND GRANT

```text
START / CONCEPT: CORE — Application publication examination opposition and grant
        |
        v
EXACT TERMS: Application publication examination opposition · grant · Mechanism chain · Qualified use · Filing · Read Application
        |
        v
MECHANISM / ARGUMENT: Read Application publication examination opposition and grant as a sequence: identify Application-publication-examination-grant ladder, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
        |
        v
CONSEQUENCE / CONTRAST: The decisive boundary is Do not call a 20-year territorial patent perpetual or global.
        |
        v
UPSC TRAP / ANSWER-USE: Do not call a 20-year territorial patent perpetual or global.
        |
        v
ANSWER-GRABBING FORMULATION: Filing creates an application, publication discloses it, examination occurs on request, opposition may test it, and grant follows only if the legal requirements are met; application, publication, examination and grant are not interchangeable status verbs.
```
### SESSION 5 — CORE — CONTROLLER GENERAL INDIAN PATENT OFFICE AND INSTITUTIONAL ROUTING

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The Controller General of Patents, Designs and Trade Marks is the administrative apex for patents, designs, trade marks and GIs, while the Indian Patent Office handles patent administration; CGPDTM does not administer copyright or plant-variety rights.

**Technical definition:** Read Controller General Indian Patent Office and institutional routing as a sequence: identify Controller and Patent Office roles, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
...
- **Controller General Indian Patent Office**
...
**How to use them:** Frame the answer through Controller General Indian Patent Office; define institutional routing, connect Mechanism chain with Qualified use to explain the mechanism, and use The Controller General for the decisive comparison or qualification.

#### VISUAL FIRST

```text
CONTROLLER GENERAL INDIAN PATENT OFFICE AND INSTITUTIONAL ROUTING
01. Controller and Patent Office roles
STATUS / CATEGORY FIREWALL -> Do not convert filing, publication or examination into grant.
```
...
Read Controller General Indian Patent Office and institutional routing as a sequence: identify Controller and Patent Office roles, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### TECHNICAL DISTINCTION

The decisive boundary is Do not convert filing, publication or examination into grant. This keeps Controller and Patent Office roles in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Separate policy, administration, registry and appellate functions.

#### MINI RECAP

- **Mechanism chain:** Controller and Patent Office roles
- **Qualified use:** Separate policy, administration, registry and appellate functions.

#### CLOSING RECALL FLOW — CORE — CONTROLLER GENERAL INDIAN PATENT OFFICE AND INSTITUTIONAL ROUTING

```text
START / CONCEPT: CORE — Controller General Indian Patent Office and institutional routing
        |
        v
EXACT TERMS: Controller General Indian Patent Office · institutional routing · Mechanism chain · Qualified use · The Controller General · Patents
        |
        v
MECHANISM / ARGUMENT: Read Controller General Indian Patent Office and institutional routing as a sequence: identify Controller and Patent Office roles, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
        |
        v
CONSEQUENCE / CONTRAST: Mechanism chain: Controller and Patent Office roles Qualified use: Separate policy, administration, registry and appellate functions.
        |
        v
UPSC TRAP / ANSWER-USE: The decisive boundary is Do not convert filing, publication or examination into grant.
        |
        v
ANSWER-GRABBING FORMULATION: The Controller General of Patents, Designs and Trade Marks is the administrative apex for patents, designs, trade marks and GIs, while the Indian Patent Office handles patent administration; CGPDTM does not administer copyright or plant-variety rights.
```
### SESSION 6 — CORE — COMPULSORY LICENSING SECTIONS 84 AND 92

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Section 84 permits an application after three years from grant where public requirements are unmet, the invention is not reasonably affordable or it is not worked in India; Section 92 covers notified emergency, extreme-urgency or public non-commercial-use circumstances.

**Technical definition:** Read Compulsory licensing Sections 84 and 92 as a sequence: identify Compulsory-licensing boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
...
- **Compulsory licensing Sections 84**
- **Mechanism chain**
- **Qualified use**
- **Section**
- **India**
...
**How to use them:** Frame the answer through Compulsory licensing Sections 84; define Mechanism chain, connect Qualified use with Section to explain the mechanism, and use India for the decisive comparison or qualification.

#### VISUAL FIRST

```text
COMPULSORY LICENSING SECTIONS 84 AND 92
01. Compulsory-licensing boundary
    |
    v
02. Section 3(d) two-limb filter
STATUS / CATEGORY FIREWALL -> Do not make CGPDTM the administrator of copyright or plant varieties.
```
...
Section 84 permits an application after three years from grant where public requirements are unmet, the invention is not reasonably affordable or it is not worked in India; Section 92 covers notified emergency, extreme-urgency or public non-commercial-use circumstances. Section 3(d) treats a new property or new use of a known substance as no invention and allows a new form of a known substance only where it differs significantly in properties with regard to efficacy; enhanced efficacy does not rescue a mere new-use claim.

#### SIMPLE SYSTEM EXAMPLE

Read Compulsory licensing Sections 84 and 92 as a sequence: identify Compulsory-licensing boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### TECHNICAL DISTINCTION

The decisive boundary is Do not make CGPDTM the administrator of copyright or plant varieties. This keeps Compulsory-licensing boundary and Section 3(d) two-limb filter in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** State trigger, timing and grounds before evaluating public-interest use.

#### MINI RECAP

- **Mechanism chain:** Compulsory-licensing boundary -> Section 3(d) two-limb filter
- **Qualified use:** State trigger, timing and grounds before evaluating public-interest use.

#### CLOSING RECALL FLOW — CORE — COMPULSORY LICENSING SECTIONS 84 AND 92

```text
START / CONCEPT: CORE — Compulsory licensing Sections 84 and 92
        |
        v
EXACT TERMS: Compulsory licensing Sections 84 · Mechanism chain · Qualified use · Section · India · Read Compulsory
        |
        v
MECHANISM / ARGUMENT: Read Compulsory licensing Sections 84 and 92 as a sequence: identify Compulsory-licensing boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
        |
        v
CONSEQUENCE / CONTRAST: Section 3(d) treats a new property or new use of a known substance as no invention and allows a new form of a known substance only where it differs significantly in properties with regard to efficacy; enhanced efficacy does not rescue a mere new-use claim.
        |
        v
UPSC TRAP / ANSWER-USE: The decisive boundary is Do not make CGPDTM the administrator of copyright or plant varieties.
        |
        v
ANSWER-GRABBING FORMULATION: Section 84 permits an application after three years from grant where public requirements are unmet, the invention is not reasonably affordable or it is not worked in India; Section 92 covers notified emergency, extreme-urgency or public non-commercial-use circumstances.
```
### SESSION 7 — CORE — SECTION 3(D) EVERGREENING AND KNOWN-SUBSTANCE CLAIMS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Read Section 3(d) evergreening and known-substance claims as a sequence: identify Bolar and research discipline, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

**Technical definition:** Section 107A permits acts solely and reasonably related to developing and submitting regulatory information and also covers the owner-supported parallel-import limb; the Bolar route must not be inflated into an unlimited exemption for every activity labelled research.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Read Section 3(d) evergreening and known-substance claims as a sequence: identify Bolar and research discipline, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### MUST-WRITE KEYWORDS

- **Section 3(d) evergreening**
- **known-substance claims**
- **Mechanism chain**
- **Qualified use**
- **Section**
- **Bolar**

**How to use them:** Frame the answer through Section 3(d) evergreening; define known-substance claims, connect Mechanism chain with Qualified use to explain the mechanism, and use Section for the decisive comparison or qualification.

#### VISUAL FIRST

```text
SECTION 3(D) EVERGREENING AND KNOWN-SUBSTANCE CLAIMS
01. Bolar and research discipline
STATUS / CATEGORY FIREWALL -> Do not describe compulsory licensing as automatic cancellation of the patent.
```
...
The decisive boundary is Do not describe compulsory licensing as automatic cancellation of the patent. This keeps Bolar and research discipline in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Apply the new-use and new-form limbs separately and preserve efficacy logic.

#### MINI RECAP

- **Mechanism chain:** Bolar and research discipline
- **Qualified use:** Apply the new-use and new-form limbs separately and preserve efficacy logic.

#### CLOSING RECALL FLOW — CORE — SECTION 3(D) EVERGREENING AND KNOWN-SUBSTANCE CLAIMS

```text
START / CONCEPT: CORE — Section 3(d) evergreening and known-substance claims
        |
        v
EXACT TERMS: Section 3(d) evergreening · known-substance claims · Mechanism chain · Qualified use · Section · Bolar
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Bolar and research discipline Qualified use: Apply the new-use and new-form limbs separately and preserve efficacy logic.
        |
        v
CONSEQUENCE / CONTRAST: Section 107A permits acts solely and reasonably related to developing and submitting regulatory information and also covers the owner-supported parallel-import limb; the Bolar route must not be inflated into an unlimited exemption for every activity labelled research.
        |
        v
UPSC TRAP / ANSWER-USE: The decisive boundary is Do not describe compulsory licensing as automatic cancellation of the patent.
        |
        v
ANSWER-GRABBING FORMULATION: Read Section 3(d) evergreening and known-substance claims as a sequence: identify Bolar and research discipline, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
```
### SESSION 8 — CORE — BOLAR REGULATORY USE PARALLEL IMPORT AND RESEARCH LIMITS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Read Bolar regulatory use parallel import and research limits as a sequence: identify PCT-WIPO boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

**Technical definition:** Mechanism chain: PCT-WIPO boundary Qualified use: Tie permitted conduct to regulatory submission and reject an unlimited research claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Read Bolar regulatory use parallel import and research limits as a sequence: identify PCT-WIPO boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### MUST-WRITE KEYWORDS

- **Bolar regulatory use parallel import**
- **research limits**
- **Mechanism chain**
- **Qualified use**
...
**How to use them:** Frame the answer through Bolar regulatory use parallel import; define research limits, connect Mechanism chain with Qualified use to explain the mechanism, and use The Patent Cooperation Treaty for the decisive comparison or qualification.

#### VISUAL FIRST

```text
BOLAR REGULATORY USE PARALLEL IMPORT AND RESEARCH LIMITS
01. PCT-WIPO boundary
STATUS / CATEGORY FIREWALL -> Do not apply enhanced-efficacy language to rescue a mere new use under Section 3(d).
```
...
The decisive boundary is Do not apply enhanced-efficacy language to rescue a mere new use under Section 3(d). This keeps PCT-WIPO boundary in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Tie permitted conduct to regulatory submission and reject an unlimited research claim.

#### MINI RECAP

- **Mechanism chain:** PCT-WIPO boundary
- **Qualified use:** Tie permitted conduct to regulatory submission and reject an unlimited research claim.

#### CLOSING RECALL FLOW — CORE — BOLAR REGULATORY USE PARALLEL IMPORT AND RESEARCH LIMITS

```text
START / CONCEPT: CORE — Bolar regulatory use parallel import and research limits
        |
        v
EXACT TERMS: Bolar regulatory use parallel import · research limits · Mechanism chain · Qualified use · The Patent Cooperation Treaty · WIPO
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: PCT-WIPO boundary Qualified use: Tie permitted conduct to regulatory submission and reject an unlimited research claim.
        |
        v
CONSEQUENCE / CONTRAST: The decisive boundary is Do not apply enhanced-efficacy language to rescue a mere new use under Section 3(d).
        |
        v
UPSC TRAP / ANSWER-USE: Do not apply enhanced-efficacy language to rescue a mere new use under Section 3(d).
        |
        v
ANSWER-GRABBING FORMULATION: Read Bolar regulatory use parallel import and research limits as a sequence: identify PCT-WIPO boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
```
### SESSION 9 — CORE — PCT WIPO NATIONAL PHASE AND TERRITORIAL GRANT

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** TRIPS is the WTO minimum-standards and flexibilities framework for intellectual property, backed by WTO monitoring and dispute settlement; it neither receives ordinary patent applications nor grants patents.

**Technical definition:** Read PCT WIPO national phase and territorial grant as a sequence: identify TRIPS-WTO boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mechanism chain: TRIPS-WTO boundary Qualified use: Explain filing, search, publication and national phase without inventing global grant.

#### MUST-WRITE KEYWORDS

- **PCT WIPO national phase**
- **territorial grant**
- **Mechanism chain**
- **Qualified use**
- **TRIPS**
...
**How to use them:** Frame the answer through PCT WIPO national phase; define territorial grant, connect Mechanism chain with Qualified use to explain the mechanism, and use TRIPS for the decisive comparison or qualification.

#### VISUAL FIRST

```text
PCT WIPO NATIONAL PHASE AND TERRITORIAL GRANT
01. TRIPS-WTO boundary
STATUS / CATEGORY FIREWALL -> Do not turn the Bolar provision into an unlimited general research defence.
```
...
Read PCT WIPO national phase and territorial grant as a sequence: identify TRIPS-WTO boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### TECHNICAL DISTINCTION

The decisive boundary is Do not turn the Bolar provision into an unlimited general research defence. This keeps TRIPS-WTO boundary in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Explain filing, search, publication and national phase without inventing global grant.

#### MINI RECAP

- **Mechanism chain:** TRIPS-WTO boundary
- **Qualified use:** Explain filing, search, publication and national phase without inventing global grant.

#### CLOSING RECALL FLOW — CORE — PCT WIPO NATIONAL PHASE AND TERRITORIAL GRANT

```text
START / CONCEPT: CORE — PCT WIPO national phase and territorial grant
        |
        v
EXACT TERMS: PCT WIPO national phase · territorial grant · Mechanism chain · Qualified use · TRIPS · WTO
        |
        v
MECHANISM / ARGUMENT: Read PCT WIPO national phase and territorial grant as a sequence: identify TRIPS-WTO boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
        |
        v
CONSEQUENCE / CONTRAST: Mains: Explain filing, search, publication and national phase without inventing global grant.
        |
        v
UPSC TRAP / ANSWER-USE: The decisive boundary is Do not turn the Bolar provision into an unlimited general research defence.
        |
        v
ANSWER-GRABBING FORMULATION: Mechanism chain: TRIPS-WTO boundary Qualified use: Explain filing, search, publication and national phase without inventing global grant.
```
### SESSION 10 — CORE — TRIPS WTO DOHA FLEXIBILITIES AND INSTITUTIONAL SEPARATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Read TRIPS WTO Doha flexibilities and institutional separation as a sequence: identify Traditional knowledge and TKDL, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

**Technical definition:** Mechanism chain: Traditional knowledge and TKDL Qualified use: Separate WTO obligations and flexibilities from WIPO treaty administration.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Read TRIPS WTO Doha flexibilities and institutional separation as a sequence: identify Traditional knowledge and TKDL, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### MUST-WRITE KEYWORDS

- **TRIPS WTO Doha flexibilities**
...
**How to use them:** Frame the answer through TRIPS WTO Doha flexibilities; define institutional separation, connect Mechanism chain with Qualified use to explain the mechanism, and use The Traditional Knowledge Digital Library for the decisive comparison or qualification.

#### VISUAL FIRST

```text
TRIPS WTO DOHA FLEXIBILITIES AND INSTITUTIONAL SEPARATION
01. Traditional knowledge and TKDL
STATUS / CATEGORY FIREWALL -> Do not call the PCT a world patent or WIPO a national granting office.
```
...
The decisive boundary is Do not call the PCT a world patent or WIPO a national granting office. This keeps Traditional knowledge and TKDL in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Separate WTO obligations and flexibilities from WIPO treaty administration.

#### MINI RECAP

- **Mechanism chain:** Traditional knowledge and TKDL
- **Qualified use:** Separate WTO obligations and flexibilities from WIPO treaty administration.

#### CLOSING RECALL FLOW — CORE — TRIPS WTO DOHA FLEXIBILITIES AND INSTITUTIONAL SEPARATION

```text
START / CONCEPT: CORE — TRIPS WTO Doha flexibilities and institutional separation
        |
        v
EXACT TERMS: TRIPS WTO Doha flexibilities · institutional separation · Mechanism chain · Qualified use · The Traditional Knowledge Digital Library · CSIR
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Traditional knowledge and TKDL Qualified use: Separate WTO obligations and flexibilities from WIPO treaty administration.
        |
        v
CONSEQUENCE / CONTRAST: The Traditional Knowledge Digital Library, built by CSIR with the Ministry of Ayush, makes codified traditional medicinal knowledge available as searchable prior art for defensive protection against wrongful patent claims; it is not a patent over the knowledge.
        |
        v
UPSC TRAP / ANSWER-USE: The decisive boundary is Do not call the PCT a world patent or WIPO a national granting office.
        |
        v
ANSWER-GRABBING FORMULATION: Read TRIPS WTO Doha flexibilities and institutional separation as a sequence: identify Traditional knowledge and TKDL, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
```
### SESSION 11 — CORE — TRADITIONAL KNOWLEDGE BIOPIRACY AND TKDL DEFENSIVE PRIOR ART

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Read Traditional knowledge biopiracy and TKDL defensive prior art as a sequence: identify IP-instrument boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

**Technical definition:** Mechanism chain: IP-instrument boundary - Life-material patentability boundary Qualified use: Trace prior-art documentation to defensive protection and benefit-sharing concerns.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Read Traditional knowledge biopiracy and TKDL defensive prior art as a sequence: identify IP-instrument boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
...
**How to use them:** Frame the answer through Traditional knowledge biopiracy; define TKDL defensive prior art, connect Mechanism chain with Qualified use to explain the mechanism, and use Section for the decisive comparison or qualification.

#### VISUAL FIRST

```text
TRADITIONAL KNOWLEDGE BIOPIRACY AND TKDL DEFENSIVE PRIOR ART
01. IP-instrument boundary
    |
    v
02. Life-material patentability boundary
STATUS / CATEGORY FIREWALL -> Do not make TRIPS a WIPO treaty or a patent-filing route.
```
...
Patents protect qualifying inventions, copyright protects original expression rather than ideas, trademarks identify commercial source, GIs protect collective origin-linked goods, and designs protect visual appearance rather than technical function. Section 3(j) excludes plants and animals in whole or part other than micro-organisms, including seeds, varieties, species and essentially biological processes; plant varieties follow the PPV&FR Act, 2001 sui-generis route rather than ordinary patent ownership.
...
The decisive boundary is Do not make TRIPS a WIPO treaty or a patent-filing route. This keeps IP-instrument boundary and Life-material patentability boundary in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Trace prior-art documentation to defensive protection and benefit-sharing concerns.

#### MINI RECAP

- **Mechanism chain:** IP-instrument boundary -> Life-material patentability boundary
- **Qualified use:** Trace prior-art documentation to defensive protection and benefit-sharing concerns.

#### CLOSING RECALL FLOW — CORE — TRADITIONAL KNOWLEDGE BIOPIRACY AND TKDL DEFENSIVE PRIOR ART

```text
START / CONCEPT: CORE — Traditional knowledge biopiracy and TKDL defensive prior art
        |
        v
EXACT TERMS: Traditional knowledge biopiracy · TKDL defensive prior art · Mechanism chain · Qualified use · Section · PPV
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: IP-instrument boundary - Life-material patentability boundary Qualified use: Trace prior-art documentation to defensive protection and benefit-sharing concerns.
        |
        v
CONSEQUENCE / CONTRAST: The decisive boundary is Do not make TRIPS a WIPO treaty or a patent-filing route.
        |
        v
UPSC TRAP / ANSWER-USE: Do not make TRIPS a WIPO treaty or a patent-filing route.
        |
        v
ANSWER-GRABBING FORMULATION: Read Traditional knowledge biopiracy and TKDL defensive prior art as a sequence: identify IP-instrument boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
```
### SESSION 12 — CORE — PATENT GI COPYRIGHT TRADEMARK AND DESIGN BOUNDARIES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The decisive boundary is Do not describe TKDL as ownership of all traditional knowledge.

**Technical definition:** Read Patent GI copyright trademark and design boundaries as a sequence: identify Software-claim discipline, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Read Patent GI copyright trademark and design boundaries as a sequence: identify Software-claim discipline, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### MUST-WRITE KEYWORDS

- **Patent GI copyright trademark**
- **design boundaries**
- **Mechanism chain**
- **Qualified use**
- **IPR**
...
**How to use them:** Frame the answer through Patent GI copyright trademark; define design boundaries, connect Mechanism chain with Qualified use to explain the mechanism, and use IPR for the decisive comparison or qualification.

#### VISUAL FIRST

```text
PATENT GI COPYRIGHT TRADEMARK AND DESIGN BOUNDARIES
01. Software-claim discipline
STATUS / CATEGORY FIREWALL -> Do not describe TKDL as ownership of all traditional knowledge.
```
...
The decisive boundary is Do not describe TKDL as ownership of all traditional knowledge. This keeps Software-claim discipline in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Match each asset to the correct right, holder, duration logic and statute.

#### MINI RECAP

- **Mechanism chain:** Software-claim discipline
- **Qualified use:** Match each asset to the correct right, holder, duration logic and statute.

#### CLOSING RECALL FLOW — CORE — PATENT GI COPYRIGHT TRADEMARK AND DESIGN BOUNDARIES

```text
START / CONCEPT: CORE — Patent GI copyright trademark and design boundaries
        |
        v
EXACT TERMS: Patent GI copyright trademark · design boundaries · Mechanism chain · Qualified use · IPR · Read Patent GI
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Software-claim discipline Qualified use: Match each asset to the correct right, holder, duration logic and statute.
        |
        v
CONSEQUENCE / CONTRAST: The audited owners link software ecosystems to IPR but do not support a blanket proposition that every software-labelled claim is patentable or unpatentable; classify the claimed technical subject matter under the applicable patent criteria and exclusions before concluding.
        |
        v
UPSC TRAP / ANSWER-USE: The decisive boundary is Do not describe TKDL as ownership of all traditional knowledge.
        |
        v
ANSWER-GRABBING FORMULATION: Read Patent GI copyright trademark and design boundaries as a sequence: identify Software-claim discipline, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
```
### SESSION 13 — CORE SYNTHESIS — BIOTECHNOLOGY LIFE MATERIALS SOFTWARE AND EXCLUDED SUBJECT MATTER

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Read Biotechnology life materials software and excluded subject matter as a sequence: identify Access-innovation balance, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

**Technical definition:** Mechanism chain: Access-innovation balance Qualified use: Classify plants, micro-organisms, varieties and software claims without blanket rules.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Read Biotechnology life materials software and excluded subject matter as a sequence: identify Access-innovation balance, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### MUST-WRITE KEYWORDS

- **CORE SYNTHESIS**
- **Biotechnology life materials software**
- **excluded subject matter**
- **Mechanism chain**
- **Qualified use**
- **Patents**

**How to use them:** Frame the answer through CORE SYNTHESIS; define Biotechnology life materials software, connect excluded subject matter with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.

#### VISUAL FIRST

```text
BIOTECHNOLOGY LIFE MATERIALS SOFTWARE AND EXCLUDED SUBJECT MATTER
01. Access-innovation balance
STATUS / CATEGORY FIREWALL -> Do not treat GI, trademark, copyright, design and patent as interchangeable.
```
...
The decisive boundary is Do not treat GI, trademark, copyright, design and patent as interchangeable. This keeps Access-innovation balance in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Classify plants, micro-organisms, varieties and software claims without blanket rules.

#### MINI RECAP

- **Mechanism chain:** Access-innovation balance
- **Qualified use:** Classify plants, micro-organisms, varieties and software claims without blanket rules.

#### CLOSING RECALL FLOW — CORE SYNTHESIS — BIOTECHNOLOGY LIFE MATERIALS SOFTWARE AND EXCLUDED SUBJECT MATTER

```text
START / CONCEPT: CORE SYNTHESIS — Biotechnology life materials software and excluded subject matter
        |
        v
EXACT TERMS: CORE SYNTHESIS · Biotechnology life materials software · excluded subject matter · Mechanism chain · Qualified use · Patents
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Access-innovation balance Qualified use: Classify plants, micro-organisms, varieties and software claims without blanket rules.
        |
        v
CONSEQUENCE / CONTRAST: Patents can support disclosure, investment and technology transfer, while Section 3(d), compulsory licensing, opposition, Bolar use and TRIPS flexibilities protect competition, public health and access; neither maximal exclusivity nor routine override is a complete policy.
        |
        v
UPSC TRAP / ANSWER-USE: The decisive boundary is Do not treat GI, trademark, copyright, design and patent as interchangeable.
        |
        v
ANSWER-GRABBING FORMULATION: Read Biotechnology life materials software and excluded subject matter as a sequence: identify Access-innovation balance, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
```
### SESSION 14 — CORE SYNTHESIS — ACCESS INNOVATION COMMERCIALISATION AND TECHNOLOGY TRANSFER

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** A filing or grant is only an input: commercialisation also requires market validation, proof of concept, technology-transfer capacity, pilot and scale-up finance, industry absorption, regulatory pathways and enforceable licensing arrangements.

**Technical definition:** Read Access innovation commercialisation and technology transfer as a sequence: identify Commercialisation-chain boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Read Access innovation commercialisation and technology transfer as a sequence: identify Commercialisation-chain boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### MUST-WRITE KEYWORDS

- **CORE SYNTHESIS**
- **Access innovation commercialisation**
- **technology transfer**
- **Mechanism chain**
- **Qualified use**
- **A filing or grant**

**How to use them:** Frame the answer through CORE SYNTHESIS; define Access innovation commercialisation, connect technology transfer with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.

#### VISUAL FIRST

```text
ACCESS INNOVATION COMMERCIALISATION AND TECHNOLOGY TRANSFER
01. Commercialisation-chain boundary
    |
    v
02. Opposition-revocation-status boundary
STATUS / CATEGORY FIREWALL -> Do not patent-label every life material; apply Section 3(j) and the PPV&FR route.
```
...
The decisive boundary is Do not patent-label every life material; apply Section 3(j) and the PPV&FR route. This keeps Commercialisation-chain boundary and Opposition-revocation-status boundary in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Follow filing through technology transfer, scale-up, regulation, market and access.

#### MINI RECAP

- **Mechanism chain:** Commercialisation-chain boundary -> Opposition-revocation-status boundary
- **Qualified use:** Follow filing through technology transfer, scale-up, regulation, market and access.

#### CLOSING RECALL FLOW — CORE SYNTHESIS — ACCESS INNOVATION COMMERCIALISATION AND TECHNOLOGY TRANSFER

```text
START / CONCEPT: CORE SYNTHESIS — Access innovation commercialisation and technology transfer
        |
        v
EXACT TERMS: CORE SYNTHESIS · Access innovation commercialisation · technology transfer · Mechanism chain · Qualified use · A filing or grant
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Commercialisation-chain boundary - Opposition-revocation-status boundary Qualified use: Follow filing through technology transfer, scale-up, regulation, market and access.
        |
        v
CONSEQUENCE / CONTRAST: Mains: Follow filing through technology transfer, scale-up, regulation, market and access.
        |
        v
UPSC TRAP / ANSWER-USE: The decisive boundary is Do not patent-label every life material; apply Section 3(j) and the PPV&FR route.
        |
        v
ANSWER-GRABBING FORMULATION: Read Access innovation commercialisation and technology transfer as a sequence: identify Commercialisation-chain boundary, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
```
### SESSION 15 — CORE SYNTHESIS — OPPOSITION REVOCATION IPAB PYQ AND STATUS DISCIPLINE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Application, publication, examination request, opposition, grant, working statement, licence, commercialisation, revocation and expiry are separate evidence rungs; no patent count, case outcome, market success or current legal status should be inferred from another rung.

**Technical definition:** Read Opposition revocation IPAB PYQ and status discipline as a sequence: identify IPAB date discipline, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Read Opposition revocation IPAB PYQ and status discipline as a sequence: identify IPAB date discipline, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.

#### MUST-WRITE KEYWORDS

- **CORE SYNTHESIS**
- **Opposition revocation IPAB PYQ**
- **status discipline**
- **Mechanism chain**
- **Qualified use**
- **Subject**

**How to use them:** Frame the answer through CORE SYNTHESIS; define Opposition revocation IPAB PYQ, connect status discipline with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.

#### VISUAL FIRST

```text
OPPOSITION REVOCATION IPAB PYQ AND STATUS DISCIPLINE
01. IPAB date discipline
    |
    v
02. Evidence and status firewall
STATUS / CATEGORY FIREWALL -> Do not assert a blanket software-patent rule beyond the audited owners.
```
...
The decisive boundary is Do not assert a blanket software-patent rule beyond the audited owners. This keeps IPAB date discipline and Evidence and status firewall in the correct scientific category, institution and unit of measurement.
...
- **Prelims:** Keep institution, system, platform, service, process, legal instrument, unit and status in their exact category.
- **Mains:** Answer at the PYQ date and distinguish every challenge and terminal status.

#### MINI RECAP

- **Mechanism chain:** IPAB date discipline -> Evidence and status firewall
- **Qualified use:** Answer at the PYQ date and distinguish every challenge and terminal status.
...
| IP instrument | Protects what? | Typical holder | Duration logic |
|---|---|---|---|
| ✅ **Patent** | New invention (product/process) meeting legal criteria | Inventor / assignee | 20 years from filing; not renewable forever |
| ✅ **Trademark** | Brand identifier distinguishing goods/services | Individual, firm or company proprietor | 10 years, renewable indefinitely |
| ✅ **GI** | Goods whose quality/reputation is tied to place of origin | Collective/community/association-based right | 10 years, renewable indefinitely |
| ✅ **Copyright** | Original literary, artistic, musical and related works | Author / rights holder | Term differs by work type |
| ✅ **Design** | Visual features of shape, pattern, ornament or composition | Registered proprietor | Separate design-law route |
| ✅ **Trade secret** | Confidential business information with competitive value | Enterprise / lawful possessor | No fixed statutory term; lasts while secrecy is maintained |

**Core proposition:** UPSC repeatedly tests whether the candidate can distinguish **patent**, **trademark** and **GI** as three legally different IP tools rather than treating all “rights” as one category.

#### 2. Essential definitions

| Concept | Exam-ready meaning |
|---|---|
| ✅ **Patent** | Exclusive right granted for an invention that is new, involves inventive step and is capable of industrial application. |
...
- ✅ **Patents:** important in pharmaceuticals, manufacturing, biotechnology, electronics and deep-tech innovation.
- ✅ **Trademarks:** crucial for brand identity, market signalling and consumer trust.
- ✅ **GIs:** protect region-linked products such as Darjeeling Tea, Kanchipuram Silk or other place-based goods.
- ✅ **National IPR Policy 2016:** stresses awareness, stronger administration, commercialization and balance with public interest.
- ⚠️ **Limitation 1:** strong rights on paper do not automatically ensure fast enforcement or low litigation cost.
- ⚠️ **Limitation 2:** domestic innovators, MSMEs and producer groups may face knowledge and procedural barriers.
- ⚠️ **Limitation 3:** patent protection can encourage innovation, but public-health access questions remain central in sectors like pharma.

#### 6. Must-Know Facts for Prelims

- ✅ A **patent** protects an invention; a **trademark** protects a brand identifier; a **GI** protects place-linked goods with collective regional character.
- ✅ Patentability in India requires **novelty, inventive step and industrial applicability**.
- ✅ Section 3(d) is significant because it prevents routine evergreening claims over known substances without enhanced efficacy.
- ✅ Section 84 allows compulsory licensing after three years from grant on specific public-interest grounds.
- ✅ The Basics of Trademarks page says a registered trademark is valid for **10 years** and is renewable indefinitely for further 10-year periods.
- ✅ GI registration also runs for **10 years** and can be renewed in further 10-year blocks.
- ✅ WIPO’s PCT system is an international filing mechanism; it does **not** itself grant a world patent.
- ✅ India is a PCT contracting state under the WIPO-administered system.

#### 7. UPSC traps

- ❌ **Patent, GI and trademark are interchangeable IPR labels.** -> They protect different subject matter, have different holders and work through different legal logic.
- ❌ **A GI belongs to one private company like a trademark.** -> A GI is a place-based collective right tied to producer groups and origin.
- ❌ **A patent can be renewed indefinitely like a trademark.** -> Patent protection is time-bound; trademarks can be renewed indefinitely.
- ❌ **Section 3(d) bans all pharma patents.** -> It targets evergreening-type claims lacking enhanced efficacy, not every pharmaceutical invention.
- ❌ **PCT gives one global patent valid everywhere.** -> It provides a common filing route, after which national/regional phase procedures still matter.
- ❌ **Compulsory licensing means abolition of patent rights.** -> It is a statutory public-interest exception with conditions, not full patent cancellation.

#### 8. 📰 Current anchor

- 📰 **FY 2024-25 | IP India Annual Report | Status: report published.** The CGPDTM annual report records continued growth in filings and administrative modernization.
...
- ⚠️ Start with the IPR ecosystem, then separate **patent / trademark / GI** clearly.
- ⚠️ Mention patentability criteria and the role of Section 3(d).
- ⚠️ Add compulsory licensing as a legally recognized public-interest flexibility.
- ⚠️ Bring in DPIIT, CGPDTM, WIPO, PCT and TRIPS.
- ⚠️ Conclude with commercialization and public-interest balance rather than taking an extreme pro- or anti-IP stance.

> **Answer thesis:** India’s IPR regime should be read as a differentiated legal architecture—patents for inventions, trademarks for brands and GIs for place-linked goods—while patent law itself contains public-interest filters such as Section 3(d) and compulsory licensing to balance innovation with access and welfare.

#### 11. Probable questions

- ⚠️ **Practice Prelims:** Which one of the following correctly distinguishes a patent from a geographical indication and a trademark?
- ⚠️ **Practice Mains (10 marks):** Explain the significance of Section 3(d) of the Patents Act, 1970. *Answer in 150 words.*
- ⚠️ **Practice Mains (15 marks):** Discuss the role of India’s IPR framework in promoting innovation while safeguarding public interest, with special reference to patents, compulsory licensing and GI protection.

#### 12. Study links

- ✅ Advanced companion: `advanced/17_Intellectual-Property-Rights-and-Patents.md`.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — OPPOSITION REVOCATION IPAB PYQ AND STATUS DISCIPLINE

```text
START / CONCEPT: CORE SYNTHESIS — Opposition revocation IPAB PYQ and status discipline
        |
        v
EXACT TERMS: CORE SYNTHESIS · Opposition revocation IPAB PYQ · status discipline · Mechanism chain · Qualified use · Subject
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: IPAB date discipline - Evidence and status firewall Qualified use: Answer at the PYQ date and distinguish every challenge and terminal status.
        |
        v
CONSEQUENCE / CONTRAST: Application, publication, examination request, opposition, grant, working statement, licence, commercialisation, revocation and expiry are separate evidence rungs; no patent count, case outcome, market success or current legal status should be inferred from another rung.
        |
        v
UPSC TRAP / ANSWER-USE: The Intellectual Property Appellate Board was a statutory appellate body when the 2019 Prelims question was asked, but the Tribunals Reforms Act, 2021 abolished specified appellate bodies including IPAB and transferred functions to courts; answer old questions at their date.
        |
        v
ANSWER-GRABBING FORMULATION: Read Opposition revocation IPAB PYQ and status discipline as a sequence: identify IPAB date discipline, follow the named mechanism to its user or output, and stop at the last verified status rather than assuming the next stage.
```
### SCIENCE AND TECHNOLOGY DEEP-REVIEW CORE CONTROL

- **Must remember:** Patent analysis separates patentable subject matter, novelty, inventive step, industrial applicability, specification, examination, grant, opposition, licensing, enforcement and commercialisation.
- **Close distinction:** Discovery is not invention, filing is not grant, patent is not permission to market, product is not process claim, copyright is not patent, and compulsory licensing is not automatic confiscation of ownership.
- **Mechanism / status / evidence limit:** Cite the relevant Act/provision, jurisdiction, filing/grant/status date and claim scope; distinguish legal right, regulatory approval, technology transfer, domestic manufacture, access and observed innovation outcome.
...
> **Core area:** Patent-law architecture, public-interest safeguards and strategic IP governance.
> **Grounded in:** IP India Patents Act page (https://ipindia.gov.in/pages/patents/chapter — verified 16 Jul 2026); Patents Act PDF used for Section 3(d), Section 84 and related text (https://ipindia.gov.in/storage/uploads/docs-operator/73b5bf10-b04e-4f45-abef-87ff117315dc.pdf — verified 16 Jul 2026); Basics of Trademarks page (https://ipindia.gov.in/basics-of-trademarks — verified 16 Jul 2026); GI introduction and filing process pages (https://ipindia.gov.in/gi-introduction and https://ipindia.gov.in/gi-filing-process-step-by-step — verified 16 Jul 2026); CIPAM National IPR Policy summary (https://cipam.gov.in/en/about/national-IPR-policy — verified 16 Jul 2026); WIPO PCT contracting states page and India profile references (https://www.wipo.int/en/web/pct-system/pct-contracting-states — verified 16 Jul 2026).
> **Additionally verified 2 Aug 2026:** WIPO Global Innovation Index 2025 results, India ranked 38th (https://www.wipo.int/web-publications/global-innovation-index-2025/en/gii-2025-results.html); Patents (Amendment) Rules, 2024 of 15 and 16 Mar 2024 as listed by IP India (https://ipindia.gov.in/storage/uploads/docs-operator/17e7b633-4b6f-4737-9408-8c8fe72c9cfc.pdf); CGPDTM Annual Report 2024-25 located but tables not machine-readable (https://ipindia.gov.in/storage/uploads/media/English_Annual_Report_2024-25.pdf) — no filing/grant statistic is asserted in this file.
> ✅ = source-grounded | ⚠️ = inference/analysis | 📰 = current/dated development.
> *Companion: `basic/17_Intellectual-Property-Rights-and-Patents.md`.*

#### 1. Architecture

```text
innovation / creativity / reputation / origin-based identity
                     |
                     v
 patents / trademarks / copyrights / designs / GIs / trade secrets
                     |
                     v
 filing + examination + registration + enforcement + commercialization
                     |
                     +--> incentives for innovation and branding
                     +--> protection of regional goods and creators
                     +--> public-interest safeguards and legal flexibilities
```

**Analytical claim:** India’s IPR regime is best understood not as blanket “pro-IP” policy but as a differentiated legal architecture that protects distinct kinds of value while retaining public-interest correctives, especially in patent law.

#### 2. Concepts and distinctions

| Concept | Precise meaning |
|---|---|
| ✅ **Patent** | Time-bound exclusive right (20 years from filing) for an invention satisfying **novelty, inventive step and industrial applicability** and not excluded by s.3/s.4. ⚠️ Distinguish a **product patent** (over the substance itself, restored in India from 1 Jan 2005) from a **process patent** (over a route of manufacture, the sole regime for pharmaceuticals/food/chemicals in India from 1970 to 2004) — the shift that created and then constrained India's generics industry. |
| ✅ **Trademark** | Distinctive sign identifying commercial source of goods/services. |
| ✅ **GI** | Place-linked collective indication for goods whose reputation/quality is attributable to origin. |
| ✅ **Section 3(d)** | Two-limbed patentability filter. A **new use or new property** of a known substance, or mere use of a known process/machine, is **not an invention at all**; a **new form** of a known substance is patentable **only if it differs significantly in properties with regard to efficacy** (read as therapeutic efficacy in *Novartis*, 2013). ⚠️ Enhanced efficacy is the exception for a **new form**, not for a **new use** — collapsing the two limbs is the standard error. |
| ⚠️ **Section 3(j)** | Excludes plants and animals in whole or part (other than micro-organisms), including seeds, varieties and species, and essentially biological processes — the reason plant varieties are protected under the **PPV&FR Act, 2001** rather than by patent, exercising the TRIPS Art. 27.3(b) *sui generis* option. |
| ⚠️ **Sections 84 / 92 / 107A** | **s.84** compulsory licence after three years on three grounds (public requirements unmet, price not reasonably affordable, invention not worked in India) — India's only granted case being **Natco v. Bayer (2012)**; **s.92** government-notified compulsory licence in national emergency, extreme urgency or public non-commercial use; **s.107A** Bolar exemption for regulatory-approval research plus parallel importation. |
| ⚠️ **Pre- and post-grant opposition (s.25(1) and s.25(2))** | A two-stage challenge system — any person before grant, an interested person within a year after — that functions as a public-interest filter on patent quality, and is one of the features most criticised by foreign rights-holders. |
| ✅ **Compulsory licence** | Statutory permission to exploit a patent under specified public-interest conditions. |
| ✅ **PCT** | WIPO-managed international filing route, not a universal patent grant. |
| ✅ **TRIPS** | WTO minimum-standards framework for IPR protection with flexibilities. |
| ✅ **Trade secret** | Confidential business information protected mainly through secrecy and legal/confidentiality mechanisms rather than ordinary registration. |

#### 3. Detailed mechanism / how it works

1. ✅ Patent law rewards inventions that are new, non-obvious and industrially applicable.
2. ✅ Section 3 exclusions narrow what can be patented, ensuring that every incremental claim does not become monopolizable subject matter.
3. ✅ Section 3(d) is especially important in pharmaceuticals because it bars patents on **new forms** of known substances that show no significant difference in efficacy, and treats a **new use** of a known substance as no invention at all.
4. ✅ Section 84 allows compulsory licensing after three years from grant if public requirements are unmet, price is not reasonably affordable or the invention is not worked in India.
5. ✅ Trademark law protects commercial distinctiveness; GI law protects origin-linked collective identity and regional reputation.
6. ✅ WIPO’s PCT route lowers procedural complexity for international filing, but substantive patent rights still depend on national/regional phase decisions.

##### Deeper analytical layer

- ⚠️ Strong IPR does not mean identical treatment across all IP types; patents, trademarks and GIs solve different economic problems.
- ⚠️ India’s patent system reflects a balancing design: it seeks innovation incentives without mechanically accepting evergreening or unaffordable exclusion.
- ⚠️ GI protection is also a development and rural-economy tool, not merely a legal badge.

#### 4. Institutions and programmes

- ✅ **CGPDTM:** administrative apex within India’s IP-office structure.
- ✅ **Patent Office, Trade Marks Registry and GI Registry:** specialized operational arms.
- ✅ **DPIIT / CIPAM:** policy coordination under the National IPR Policy 2016.
- ✅ **WIPO:** treaty and international-cooperation layer for PCT and broader IP governance.
- ✅ **WTO/TRIPS:** multilateral trade-law layer shaping minimum standards and flexibilities.

#### 5. Strategic significance, applications and implementation constraints

- ✅ Patents matter for deep technology, pharmaceuticals, manufacturing, biotech and electronics.
- ✅ Trademarks support market identity, goodwill and commercialization.
- ✅ GIs help region-linked producers capture reputation value in domestic and export markets.
- ⚠️ **Strategic significance:** rising domestic filing and faster administration improve innovation confidence and commercial signaling.
- ⚠️ **Constraint 1:** enforcement costs and procedural delays can reduce the real value of formal rights.
- ⚠️ **Constraint 2:** smaller innovators and producer groups may struggle with legal capability, evidence-building and market monetization.
- ⚠️ **Constraint 3:** international treaties create opportunities, but also require administrative capacity and policy coherence.

#### 6. Governance debates, ethics and public-interest considerations

- ⚠️ **Access to medicines vs evergreening:** Section 3(d) is central because it filters out weak pharmaceutical extension claims while preserving genuine invention protection.
- ⚠️ **Compulsory licensing debate:** it is neither anti-innovation by definition nor a routine policy substitute; it is a calibrated legal flexibility.
- ⚠️ **GI commercialization debate:** registration alone does not guarantee producer incomes unless branding, quality control and market access improve.
- ⚠️ **Trade secret gap:** unlike patents/trademarks, India lacks a standalone comprehensive trade-secret statute, so protection is more fragmented.
- ⚠️ **Digital governance debate:** modernization of search, examination and filing systems helps access, but quality and enforcement remain crucial.

#### 7. Must-Know Facts for Advanced Prelims

- ✅ The Patents Act defines invention in terms of novelty, inventive step and industrial applicability.
- ✅ Section 3(d) specifically bars patents on **new forms** of known substances absent a significant difference in efficacy, and excludes **new uses/new properties** from being inventions at all; *Novartis v. Union of India* (2013) read "efficacy" as therapeutic efficacy.
- ✅ **Section 3(j)** excludes plants, animals and essentially biological processes from patentability; plant varieties are instead protected under the **PPV&FR Act, 2001**, which also preserves farmers' rights to save, use, exchange and sell farm-saved seed.
- ✅ **s.84** compulsory licence (three-year bar; three grounds; **Natco v. Bayer, 2012**) and **s.92** emergency/public non-commercial licences; **s.107A** provides the Bolar exemption and parallel importation.
- ✅ **Pre-grant (s.25(1)) and post-grant (s.25(2)) opposition** are distinct stages with different standing requirements.
- ✅ **CGPDTM administers patents, designs, trade marks and GIs — not copyright (Copyright Office/DPIIT) or plant varieties (PPV&FR Authority).** **WIPO** administers treaties; the **WTO** enforces TRIPS.
- ✅ **India ranked 38th in WIPO's Global Innovation Index 2025** — quote the edition with the rank.
- ✅ The **Patents (Amendment) Rules, 2024** are dated **15 Mar 2024**, with a second amendment on **16 Mar 2024**. ⚠️ Their detailed effects could not be verified from the official text at the verification date.
- ✅ Section 84 lists three compulsory-licence grounds: unmet public requirements, lack of reasonably affordable price, and non-working in India.
- ✅ Trademark registration is valid for 10 years and renewable indefinitely in further 10-year periods.
- ✅ GI registration is also renewable in 10-year blocks, but the right is origin-linked and collective in character.
- ✅ India is a contracting state of the WIPO-administered PCT system.
- ✅ The National IPR Policy 2016 explicitly emphasizes awareness, administration, commercialization and public-interest balance.

#### 8. Advanced UPSC traps

- ❌ **More patents always mean better innovation outcomes in every sector.** -> Patent quality, commercialization, public interest and enforcement matter too.
- ❌ **Section 3(d) and compulsory licensing are anti-patent provisions.** -> They are balancing devices within the patent system itself.
- ❌ **A GI is just a rural trademark.** -> A GI is a legally distinct, origin-linked collective right.
- ❌ **PCT membership means patents automatically become global rights.** -> National or regional phase examination still determines enforceable rights.
- ❌ **National IPR Policy is only about stronger monopolies.** -> It also speaks of awareness, modernization, commercialization and public interest.

#### 9. 📰 Current anchor -> analytical use

| Verified current anchor | Topic-specific analytical use |
|---|---|
| 📰 **FY 2024-25:** IP India annual report shows continued filing growth and administrative modernization. **Status:** reported. | Use it to show that IPR is becoming a larger innovation-governance infrastructure issue, not a niche legal topic. |
| 📰 **18 Jul 2024 and 07 Dec 2024:** NIPAM event listings remained active. **Status:** awareness/outreach ongoing. | Useful to argue that the state is trying to broaden IP literacy, not just process elite filings. |
| 📰 **01 Jul 2026:** WIPO India PCT guide validity reference. **Status:** current international filing guidance in force. | Helps connect India’s domestic innovation ecosystem with international patent procedure. |

*Current as of 16 Jul 2026; verify for later updates.*

#### 11. Mains framework / angles

- ⚠️ Start by differentiating IP instruments.
- ⚠️ Explain patentability criteria and the special importance of Section 3(d).
- ⚠️ Add compulsory licensing and TRIPS flexibilities as public-interest correctives.
- ⚠️ Bring in GIs as regional-development instruments.
- ⚠️ Conclude with modernization, commercialization and access-to-justice/enforcement challenges.

> **Answer thesis:** India’s IPR architecture is intentionally differentiated: it protects inventions, brands and place-linked goods through distinct legal tools, while patent law itself embeds public-interest safeguards such as Section 3(d) and compulsory licensing to prevent a simplistic monopoly-maximization approach.

#### 12. Probable questions

- ⚠️ **Practice Prelims:** Which of the following correctly identifies the legal distinction among patent, trademark and geographical indication?
- ⚠️ **Practice Mains (10 marks):** Why is Section 3(d) considered a significant public-interest feature of India’s patent law? *Answer in 150 words.*
- ⚠️ **Practice Mains (15 marks):** Discuss the evolution of India’s IPR regime with special reference to innovation promotion, GI protection and access-to-medicines concerns.

#### 13. Study links

- ✅ Foundation companion: `basic/17_Intellectual-Property-Rights-and-Patents.md`.
- ✅ `09_Artificial-Intelligence-Governance-and-IndiaAI.md` — frontier-tech capability will increasingly intersect with IP and licensing questions.
- ✅ `08_Digital-India-and-India-Stack-UPI-Aadhaar.md` — platform economy, branding and software ecosystems interact with IPR governance.
- ✅ `07_Defence-Indigenization-Atmanirbhar-and-Procurement.md` — indigenous technology development also has a patent/commercialization angle.

<!-- BEGIN GENERATED PYQ INTEGRATION: 2018-2023 -->

## CONSOLIDATED REGISTER NOTES

### Intellectual Property Rights and Patents: PATENTABILITY, INVENTION AND PROCEDURAL STATUS MAP

1. **Patent bargain and criteria:** A patent is a limited statutory exclusion granted in exchange for disclosure; the claimed invention must be novel, involve an inventive step, be capable of industrial application and avoid the exclusions in sections 3 and 4.
2. **Invention-discovery boundary:** Patent law protects a qualifying new product or process, not a bare discovery; finding a natural fact, known property or known use does not by itself establish an invention, and Section 3(d) supplies a specific known-substance filter.
3. **Product-process boundary:** A product patent protects the claimed product, whereas a process patent protects the claimed method; India used process-only protection for pharmaceuticals, food and chemicals from 1970 to 2004 and restored product patents from 1 January 2005.
4. **Term-territoriality boundary:** The patent term is 20 years from filing and is not indefinitely renewable; protection is territorial, so an Indian grant is not a world right and foreign protection requires national or regional routes.
5. **Application-publication-examination-grant ladder:** Filing creates an application, publication discloses it, examination occurs on request, opposition may test it, and grant follows only if the legal requirements are met; application, publication, examination and grant are not interchangeable status verbs.
6. **Controller and Patent Office roles:** The Controller General of Patents, Designs and Trade Marks is the administrative apex for patents, designs, trade marks and GIs, while the Indian Patent Office handles patent administration; CGPDTM does not administer copyright or plant-variety rights.
7. **Compulsory-licensing boundary:** Section 84 permits an application after three years from grant where public requirements are unmet, the invention is not reasonably affordable or it is not worked in India; Section 92 covers notified emergency, extreme-urgency or public non-commercial-use circumstances.
8. **Section 3(d) two-limb filter:** Section 3(d) treats a new property or new use of a known substance as no invention and allows a new form of a known substance only where it differs significantly in properties with regard to efficacy; enhanced efficacy does not rescue a mere new-use claim.
9. **Bolar and research discipline:** Section 107A permits acts solely and reasonably related to developing and submitting regulatory information and also covers the owner-supported parallel-import limb; the Bolar route must not be inflated into an unlimited exemption for every activity labelled research.
10. **PCT-WIPO boundary:** The Patent Cooperation Treaty is administered by WIPO and provides a common international filing, search, publication and optional preliminary-examination route; national or regional offices retain control over substantive grant.
11. **TRIPS-WTO boundary:** TRIPS is the WTO minimum-standards and flexibilities framework for intellectual property, backed by WTO monitoring and dispute settlement; it neither receives ordinary patent applications nor grants patents.
12. **Traditional knowledge and TKDL:** The Traditional Knowledge Digital Library, built by CSIR with the Ministry of Ayush, makes codified traditional medicinal knowledge available as searchable prior art for defensive protection against wrongful patent claims; it is not a patent over the knowledge.
13. **IP-instrument boundary:** Patents protect qualifying inventions, copyright protects original expression rather than ideas, trademarks identify commercial source, GIs protect collective origin-linked goods, and designs protect visual appearance rather than technical function.
14. **Life-material patentability boundary:** Section 3(j) excludes plants and animals in whole or part other than micro-organisms, including seeds, varieties, species and essentially biological processes; plant varieties follow the PPV&FR Act, 2001 sui-generis route rather than ordinary patent ownership.
15. **Software-claim discipline:** The audited owners link software ecosystems to IPR but do not support a blanket proposition that every software-labelled claim is patentable or unpatentable; classify the claimed technical subject matter under the applicable patent criteria and exclusions before concluding.
16. **Access-innovation balance:** Patents can support disclosure, investment and technology transfer, while Section 3(d), compulsory licensing, opposition, Bolar use and TRIPS flexibilities protect competition, public health and access; neither maximal exclusivity nor routine override is a complete policy.
17. **Commercialisation-chain boundary:** A filing or grant is only an input: commercialisation also requires market validation, proof of concept, technology-transfer capacity, pilot and scale-up finance, industry absorption, regulatory pathways and enforceable licensing arrangements.
18. **Opposition-revocation-status boundary:** Pre-grant opposition under Section 25(1), post-grant opposition under Section 25(2) and revocation are challenge routes with different timing and legal consequences; none should be confused with rejection, expiry, lapse, compulsory licence or voluntary licensing.
19. **IPAB date discipline:** The Intellectual Property Appellate Board was a statutory appellate body when the 2019 Prelims question was asked, but the Tribunals Reforms Act, 2021 abolished specified appellate bodies including IPAB and transferred functions to courts; answer old questions at their date.
20. **Evidence and status firewall:** Application, publication, examination request, opposition, grant, working statement, licence, commercialisation, revocation and expiry are separate evidence rungs; no patent count, case outcome, market success or current legal status should be inferred from another rung.

### Intellectual Property Rights and Patents: PUBLIC-INTEREST SAFEGUARDS AND IP-INSTRUMENT FIREWALLS
...
### Intellectual Property Rights and Patents: IPR, ACCESS AND COMMERCIALISATION ANSWER SPINE
...
### Intellectual Property Rights and Patents: LIFE MATERIALS, PYQ-DATE ROUTES AND LIVE-SOURCE BOUNDARY

Official IP India, WIPO, WTO and TKDL-source attempts were made on 2026-09-04. They confirm the patentability criteria, limited territorial patent bargain, PCT-national-phase boundary and TRIPS-WTO architecture where substantive text was retrieved. Exact section claims remain owner-bounded; no filing/grant count, commercialisation rate, case outcome or blanket software rule is asserted.

### COMPLETE TOPIC ASCII MASTER FLOW DIAGRAM

#### ASCII MASTER FLOW — PANEL 1/12: Patentability decision tree
...
#### ASCII MASTER FLOW — PANEL 2/12: Discovery invention product process matrix
...
#### ASCII MASTER FLOW — PANEL 3/12: Term and territoriality map
...
#### ASCII MASTER FLOW — PANEL 4/12: Indian patent procedure rail
...
#### ASCII MASTER FLOW — PANEL 5/12: Institution and forum router
...
#### ASCII MASTER FLOW — PANEL 6/12: Public-interest safeguard ladder
...
#### ASCII MASTER FLOW — PANEL 7/12: Section 3(d) twin-limb gate
...
#### ASCII MASTER FLOW — PANEL 8/12: PCT WIPO TRIPS WTO split
...
#### ASCII MASTER FLOW — PANEL 9/12: Traditional knowledge protection chain
...
#### ASCII MASTER FLOW — PANEL 10/12: IP boundary wheel
...
MUST REMEMBER: Patent analysis separates patentable subject matter, novelty, inventive...
MUST REMEMBER: Patent analysis separates patentable subject matter, novelty, inventive...
```

#### ASCII MASTER FLOW — PANEL 11/12: Life material and software filter
...
CLOSE DISTINCTION: Discovery is not invention, filing is not grant, patent is not...
CLOSE DISTINCTION: Discovery is not invention, filing is not grant, patent is not...
```

#### ASCII MASTER FLOW — PANEL 12/12: Innovation access and status spine
...
EVIDENCE LIMIT: MECHANISM / STATUS / CAUSATION: Cite the relevant Act/provision,...
EVIDENCE LIMIT: MECHANISM / STATUS / CAUSATION: Cite the relevant Act/provision,...
```
