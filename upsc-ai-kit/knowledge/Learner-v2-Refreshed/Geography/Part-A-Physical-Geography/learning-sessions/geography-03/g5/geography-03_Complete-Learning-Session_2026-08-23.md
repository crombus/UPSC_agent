...
KEY TERMS: • transform margin • subduction
        ...
        How should the complete structure of Geography 03 — Vulcanism and Earthquakes / India…
...
├────────────────────────┼───────────────────────────────┼───────────────────────────────┤
│ INTRUSIVE AND          │ Product classification is     │ UPSC Prelims 2024 asked       │
│ EXTRUSIVE FORMS        │ also a risk map: ballistic    │ whether pyroclastic debris,   │
│                        │ blocks…                       │ ash and dust…                 │
├────────────────────────┼───────────────────────────────┼───────────────────────────────┤
│ ERUPTION STYLES,       │ A volcano with no historical  │ “Active, dormant and extinct” │
│ VOLCANO TYPES AND      │ eruption may still be capable │ are descriptive status        │
│ ACTIVITY STATUS        │ of…                           │ classes, not a…               │
├────────────────────────┼───────────────────────────────┼───────────────────────────────┤
│ PLATE-SETTING          │ The Ring of Fire includes     │ The Mediterranean–Himalayan   │
│ VOLCANISM, RING OF     │ trenches, island arcs,        │ belt is not one uniform       │
│ FIRE AND MID-OCEAN     │ continental arcs…             │ volcanic arc                  │
│ RIDGES                 │                               │                               │
├────────────────────────┼───────────────────────────────┼───────────────────────────────┤
│ MANTLE PLUMES, HOT     │ Flood basalts erupt mainly    │ Hot spots can supply a        │
│ SPOTS AND FLOOD        │ from fissures and build       │ reference frame for plate     │
│ BASALTS                │ plateaux through…             │ direction and…                │
└────────────────────────┴───────────────────────────────┴───────────────────────────────┘
                                  │
                                  ▼
...
CAUSE / CONDITION 1: The climatic effect depends on what reaches the stratosphere…
          │
          ├── MECHANISM
          │   Short-lived cooling after a major explosive eruption is principally…
          │
          └── EFFECT / CONTRAST
              Ash can eventually contribute nutrients, but fresh ash may…
          │
          ▼
CAUSE / CONDITION 2: The 2001 Bhuj earthquake demonstrates severe intraplate risk…
          │
          ├── MECHANISM
          │   The 2001 Bhuj earthquake demonstrates severe intraplate risk in…
          │
          └── EFFECT / CONTRAST
...
CAUSE / CONDITION 3: Microzonation must feed building regulation, land use…
          │
          ├── MECHANISM
          │   Because the corresponding adopted BIS standard/map could not be…
          │
          └── EFFECT / CONTRAST
              Microzonation must feed building regulation, land use, lifeline…
          │
          ▼
CAUSE / CONDITION 4: Institutions, Resilient Construction, Early Warning Limits…
          ...
          │
          └── EFFECT / CONTRAST
              The implementation gap is often the decisive risk multiplier: a…
          │
          ▼
SYSTEM RESULT: causes interact; mechanism explains why the outcome follows.
```
...
├── Do not treat every convergent belt as volcanically identical…
├── “Richter scale” properly refers to local magnitude developed for a…
├── Narcondam is volcanic but should not be substituted for Barren…
├── retrofitting may add confinement, bracing, shear walls, jacketing…
│
├── Exact wording is reproduced from the routed local UPSC question papers
├── VERIFIED PYQ 1 — UPSC Prelims 2018 GS-I Q85: Barren Island
├── Why this PYQ matters: UPSC combines activity status, map location and…
├── VERIFIED PYQ 2 — UPSC Prelims 2023 GS-I Q65: P and S waves
│
└── Plate tectonics explains why earthquakes, volcanism and mountain…
└── Strike-slip movement with little vertical displacement is less…
└── Institutions, Resilient Construction, Early Warning Limits And…
                                  │
                                  ▼
