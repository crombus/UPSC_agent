...
- B. Mercury, Venus, Uranus and Neptune
...
- D. Earth rotates 366 times every year.
...
- C. Carbon dioxide — the only auroral colour source
...
- A. The local slope of a settlement
...
- D. Rajasthan → Gujarat → Madhya Pradesh → Odisha → Jharkhand → Assam → Tripura → Mizoram
...
- A. Earth stops rotating over the peninsula.
...
- B. India legally owns all three chokepoints.
...
- C. All Indian islands are coral atolls.
...
- A. Area 2.4 sq km; land border 82.5 km
...
- C. Every high-tide line was legally redrawn.
...
- D. India controls every Indian Ocean route.
