...
- C. Only igneous rock can weather.
- D. Sedimentary rock cannot melt.
...
- D. It cannot precipitate chemically.
...
- B. Granite→sandstone→coal
- C. Basalt→limestone→chalk
...
- A. It is a Gondwana coal measure.
- B. It is uniformly impermeable.
...
- B. Mission policy replaces exploration.
- C. Every target is a reserve.
- D. All critical minerals occur in Deccan basalt.
...
|   MECHANISM / ARGUMENT: A rock aggregate is therefore not “a mineral”, and a landform cannot be inferred from a rock name alone.
|   CONSEQUENCE / CONTRAST: Structure → process → surface: lithology, bedding, joints, faults and tectonic setting create a template; weathering, rivers, glaciers, waves and human use modify it.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: a rock aggregate is therefore not “a mineral”.
...
|   EXAM OPENING: The crust is Earth’s outer compositional shell, whereas the lithosphere is the stronger mechanical layer comprising the crust plus the rigid uppermost mantle.
+--
        |
        v
...
|   MECHANISM / ARGUMENT: Lithification means turning loose sediment into rock through compaction and cementation.
|   CONSEQUENCE / CONTRAST: “Igneous → sedimentary → metamorphic” is one teaching path, not the only path.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: metamorphism normally occurs without complete melting.
|   EXAM OPENING: The rock cycle is an open network in which melting, crystallisation, weathering, lithification, metamorphism and uplift can connect any rock family through multiple pathways rather than one fixed sequence.
+--
        |
        v
...
|   MECHANISM / ARGUMENT: Porphyritic means large crystals embedded in a finer groundmass, showing two-stage cooling.
|   CONSEQUENCE / CONTRAST: It does not mean every igneous exposure is oldest or economically primary.
|   TRAP / ANSWER-USE: India anchor: Deccan basalt is extrusive flood basalt; Peninsular granites and gneisses have different histories and should not be merged with the Deccan province.
|   EXAM OPENING: “Primary rock” is an older genetic phrase for igneous rock because crystallisation creates the original mineral framework.
+--
        |
        v
+-- SESSION 05: SEDIMENTARY ROCKS: SEDIMENT PATHWAY AND FIELD CLUES
|   DEFINITION / TERMS : Conglomerate has rounded gravel clasts; sandstone is sand-sized; shale is fine mud-rich rock.
|   MECHANISM / ARGUMENT: Conglomerate has rounded gravel clasts; sandstone is sand-sized; shale is fine mud-rich rock.
|   CONSEQUENCE / CONTRAST: Limestone has several origins; do not call every limestone exclusively organic or chemical.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: fossils, ripple marks, mud cracks and cross-bedding can reveal environment, current direction, drying or...
|   EXAM OPENING: They are sediments/deposits unless lithification into rock is demonstrated.
+--
        |
        v
...
|   MECHANISM / ARGUMENT: Metamorphic grade means intensity of temperature–pressure conditions.
|   CONSEQUENCE / CONTRAST: Exam-safe paths: shale/mudstone → slate → phyllite → schist → gneiss is a common increasing-grade teaching sequence, not a universal compulsory path.
|   TRAP / ANSWER-USE: Graphite may form from carbon-rich material, but “coal → graphite” is not a universal one-step rule.
|   EXAM OPENING: Protolith means the parent rock before metamorphism.
+--
        |
        v
+-- SESSION 07: ROCK PROPERTIES AND APPLIED GEOGRAPHY
|   DEFINITION / TERMS : Crystalline igneous and metamorphic rocks commonly have low primary pore space but can store groundwater in weathered zones, joints and fractures.
|   MECHANISM / ARGUMENT: Crystalline igneous and metamorphic rocks commonly have low primary pore space but can store groundwater in weathered zones, joints and fractures.
|   CONSEQUENCE / CONTRAST: Basalt aquifers are heterogeneous: vesicular tops and flow contacts may transmit water; compact interiors may not.
...
|   EXAM OPENING: Rock name alone never determines land use: porosity, permeability, fractures, weathering, structure and site conditions jointly control groundwater, soils, foundations, dams and slope behaviour.
+--
        |
        v
+-- SESSION 08: CONTINENTAL DRIFT: WEGENER’S EVIDENCE AND LIMITATION
|   DEFINITION / TERMS : Technically, Continental Drift: Wegener’S Evidence And Limitation is analysed by relating Continental Drift to Wegener’S Evidence, then testing the relationship through Limitation and Pangaea.
|   MECHANISM / ARGUMENT: It must later be distinguished from India’s Gondwana Supergroup of rocks.
|   CONSEQUENCE / CONTRAST: His evidence was powerful, but proposed driving forces were inadequate.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: gondwana here means a southern palaeocontinent.
|   EXAM OPENING: Continental drift became persuasive because shelf-edge fit, matching rock belts, fossils, palaeoclimate and palaeomagnetism independently point to former continental connections, even though Wegener lacked an adequate mechanism.
+--
        |
        v
+-- SESSION 09: SEA-FLOOR SPREADING: OCEANIC EVIDENCE AND MASS BALANCE
|   DEFINITION / TERMS : Ocean floor is geologically young relative to continental shields because it is recycled.
|   MECHANISM / ARGUMENT: Ocean floor is geologically young relative to continental shields because it is recycled.
|   CONSEQUENCE / CONTRAST: The Earth does not expand; ridge creation is balanced by trench destruction.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: magnetic reversals create matching stripe patterns on both ridge flanks.
...
|   MECHANISM / ARGUMENT: Plate-interior activity occurs at inherited faults, rifts, hot spots and intraplate stress concentrations; boundaries explain global clustering, not every event.
|   CONSEQUENCE / CONTRAST: Andes and Himalaya are both mountains but arise from different convergence types.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: plate boundaries are diagnosed by motion and products.
...
+--
        ...
        v
+-- SESSION 11: OCEAN-BASIN EVOLUTION: WILSON-CYCLE ANALOGY
|   DEFINITION / TERMS : The Wilson cycle is an analogy for rifting, ocean opening, subduction, closure and suturing, not a fixed destiny that every ocean basin must complete.
|   MECHANISM / ARGUMENT: A basin can stall, reorganise or avoid the ideal sequence; the examples are analogies, not timestamps.
|   CONSEQUENCE / CONTRAST: Passive margins can accumulate thick sediment wedges and host offshore petroleum systems.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: a basin can stall, reorganise or avoid the ideal sequence.
...
+--
        ...
        v
+-- SESSION 12: ISOSTASY AND OROGENY
|   DEFINITION / TERMS : Orogeny means mountain building through convergence, folding, thrusting, metamorphism, crustal thickening and uplift.
|   MECHANISM / ARGUMENT: Orogeny means mountain building through convergence, folding, thrusting, metamorphism, crustal thickening and uplift.
|   CONSEQUENCE / CONTRAST: Erosion removes mass, exposes deeper rocks and can produce isostatic response; high relief is therefore dynamic, not a one-time construction.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: isostasy means buoyant vertical equilibrium between crust/lithosphere and denser material beneath.
...
+--
        ...
        v
+-- SESSION 13: WORLD-TO-INDIA TRANSITION: STRUCTURE EXPRESSED AS RELIEF
|   DEFINITION / TERMS : At the highest school-geography scale, India’s six broad physiographic divisions are the Himalaya/Northern Mountains, Northern Plain, Peninsular Plateau, Indian Desert, Coastal Plains and Islands.
|   MECHANISM / ARGUMENT: At the highest school-geography scale, India’s six broad physiographic divisions are the Himalaya/Northern Mountains, Northern Plain, Peninsular Plateau, Indian Desert, Coastal Plains and Islands.
|   CONSEQUENCE / CONTRAST: They are used here only as structural expressions, not as substitutes for the later detailed physiography owners.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: structure controls broad relief and resource opportunity.
...
+--
        ...
        v
+-- SESSION 14: SCOPE: GEOLOGICAL STRUCTURE VERSUS PHYSIOGRAPHY AND GEOMORPHOLOGY
|   DEFINITION / TERMS : Technically, Scope: Geological Structure Versus Physiography And Geomorphology is analysed by relating Scope to Geological Structure Versus Physiography, then testing the relationship through Geomorphology and Cross-link.
|   MECHANISM / ARGUMENT: This package supplies their geological mechanism and clearly identifies those cross-links.
|   CONSEQUENCE / CONTRAST: Exam method: identify the hidden structure, name a region, explain the mechanism, state a surface/resource/hazard consequence, then qualify the relationship.
...
+--
        ...
        v
+-- SESSION 15: GEOLOGICAL TIME, EVIDENCE AND DATING CAUTIONS
|   DEFINITION / TERMS : Numerical boundaries and formation ages are revised as dating improves.
|   MECHANISM / ARGUMENT: Relative dating uses superposition, cross-cutting relations, unconformities, fossils and correlation.
|   CONSEQUENCE / CONTRAST: Fossils are especially useful in sedimentary correlations, but many ancient Indian crystalline and Proterozoic successions are unfossiliferous or sparsely fossiliferous.
|   TRAP / ANSWER-USE: Stratigraphy is not merely a rock-name list.
|   EXAM OPENING: A safe geological chronology combines superposition, cross-cutting relations, unconformities, fossils, radiometric event ages, palaeomagnetism and geophysics; relative order is often safer than memorised numerical ages.
+--
        |
        v
+-- SESSION 16: INDIAN PLATE: GONDWANA ORIGIN, BREAK-UP, DRIFT AND COLLISION
|   DEFINITION / TERMS : India is both an ancient continental fragment and part of an active plate system: this explains the contrast between old shield rocks and young Himalayan tectonic architecture.
|   MECHANISM / ARGUMENT: Rifting separated blocks, oceanic crust formed between them, and the Indian plate moved northward before colliding progressively with Eurasia.
|   CONSEQUENCE / CONTRAST: Collision was not a single instant across the whole margin.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: india is both an ancient continental fragment and part of an active plate system.
...
|   MECHANISM / ARGUMENT: Peninsular India is a mosaic of ancient cratonic nuclei and intervening mobile belts, later cut by faults, rifts and dykes and locally covered by younger sediments and basalt.
|   CONSEQUENCE / CONTRAST: Metallic-mineral provinces are strongly associated with ancient shield geology, but ore localisation requires specific magmatic, hydrothermal, sedimentary or metamorphic processes.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: commonly recognised shield blocks include Dharwar in the south, Bastar in central India, Singhbhum...
...
+--
        ...
        v
+-- SESSION 19: PROTEROZOIC PURANA BASINS: CUDDAPAH AND VINDHYAN
|   DEFINITION / TERMS : Cuddapah and Vindhyan are major Proterozoic sedimentary basin successions resting unconformably on older basement.
|   MECHANISM / ARGUMENT: Cuddapah and Vindhyan are major Proterozoic sedimentary basin successions resting unconformably on older basement.
|   CONSEQUENCE / CONTRAST: Resource links must be bounded: a whole system is not uniformly mineralised, and Panna diamonds do not make every Vindhyan sandstone diamond-bearing.
...
+--
        ...
        v
+-- SESSION 20: GONDWANA SUPERGROUP: RIFT BASINS, COAL AND CONTINENTAL SEDIMENTATION
|   DEFINITION / TERMS : Coal linkage is mechanistic: vegetation accumulation in suitable low-oxygen settings, burial during basin subsidence, compaction and coalification, followed by preservation from erosion.
|   MECHANISM / ARGUMENT: Lower parts of the succession include glacially influenced deposits in some basins, followed by coal-bearing sandstone-shale cycles and younger continental strata.
|   CONSEQUENCE / CONTRAST: Coal presence is not automatic in every Gondwana unit or every rift.
...
+--
        ...
        v
+-- SESSION 21: MARINE SEDIMENTARY BASINS, COASTS AND OFFSHORE PETROLEUM LOGIC
|   DEFINITION / TERMS : Offshore occurrence is therefore geological, not simply because an area is under the sea.
|   MECHANISM / ARGUMENT: Mains use: Explain offshore concentration through basin evolution, not a memorised field list.
|   CONSEQUENCE / CONTRAST: Offshore occurrence is therefore geological, not simply because an area is under the sea.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: coastal and offshore sedimentary basins include Cambay, Mumbai Offshore, Assam-Arakan, Krishna-Godavari, Cauvery and other...
|   EXAM OPENING: Do not claim every named basin is equally productive or that all offshore oil is young.
+--
        |
        v
+-- SESSION 22: DECCAN TRAP: FLOOD-BASALT PROVINCE AND BOUNDED SURFACE LINKAGES
...
|   MECHANISM / ARGUMENT: The Deccan Trap is a vast flood-basalt province built by repeated, mainly fissure-fed lava flows around the end-Cretaceous to earliest Cenozoic transition.
|   CONSEQUENCE / CONTRAST: Deccan Trap is a volcanic province, not a soil type.
|   TRAP / ANSWER-USE: Black soil linkage is strong but not monocausal.
...
+--
        ...
        v
+-- SESSION 23: HIMALAYA: FROM GEOSYNCLINAL LANGUAGE TO MODERN PLATE TECTONICS
|   DEFINITION / TERMS : The Himalaya is a continent-collision fold-thrust orogen containing sedimentary, metamorphic and crystalline belts; unlike the Andes, it is not primarily a volcanic subduction arc.
|   MECHANISM / ARGUMENT: Modern plate tectonics explains the driving mechanism through subduction of oceanic domains, collision, shortening, thrusting, metamorphism and uplift.
|   CONSEQUENCE / CONTRAST: Mains use: Contrast the historical geosynclinal description with the modern plate-tectonic mechanism; then draw a labelled cross-section.
|   TRAP / ANSWER-USE: The Himalaya is not one simple fold.
...
+--
        ...
        v
+-- SESSION 24: INDO-GANGA-BRAHMAPUTRA FORELAND BASIN AND ALLUVIAL FILL
|   DEFINITION / TERMS : Technically, Indo-Ganga-Brahmaputra Foreland Basin And Alluvial Fill is analysed by relating Indo-Ganga-Brahmaputra Foreland Basin to Alluvial Fill, then testing the relationship through Cross-link and Flexural subsidence.
|   MECHANISM / ARGUMENT: Correct: It is a sediment-filled foreland basin.
|   CONSEQUENCE / CONTRAST: Thick unconsolidated sediment explains level relief, fertile alluvial soils, major aquifers and dense settlement, but also flood, erosion, subsidence and liquefaction sensitivity.
...
+--
        ...
        v
+-- SESSION 25: COASTS, OFFSHORE BASINS AND ISLAND-ARC VERSUS CORAL-ISLAND DISTINCTION
|   DEFINITION / TERMS : Western India includes the Cambay rift and faulted margin sectors; parts of the west coast show submergent features.
|   MECHANISM / ARGUMENT: The emergent islands are coral, unlike the tectonic island-arc setting of Andaman-Nicobar.
|   CONSEQUENCE / CONTRAST: The island chain also includes sedimentary and uplifted components; it is not simply a row of volcanic cones.
|   TRAP / ANSWER-USE: Do not miss this limiting distinction: western India includes the Cambay rift and faulted margin sectors.
...
+--
        ...
        v
+-- SESSION 26: MAJOR LINEAMENTS, FAULTS AND RIFTS
|   DEFINITION / TERMS : A lineament mapped from imagery is not automatically a proven active fault.
|   MECHANISM / ARGUMENT: Mains use: Use one map plus one mechanism paragraph; avoid asserting current activity without evidence.
|   CONSEQUENCE / CONTRAST: A lineament mapped from imagery is not automatically a proven active fault.
|   TRAP / ANSWER-USE: Lineament does not automatically mean active fault.
...
+--
        ...
        v
+-- SESSION 27: STRUCTURAL CONTROL OF RELIEF, DRAINAGE, GROUNDWATER AND WATERFALLS
|   DEFINITION / TERMS : In hard-rock terrain groundwater is concentrated in weathered zones, fractures and contacts.
|   MECHANISM / ARGUMENT: Hard-rock groundwater depends on secondary openings.
|   CONSEQUENCE / CONTRAST: Correct: Lithologic contrast, rejuvenation and lava contacts are alternative controls.
...
+--
        ...
        v
+-- SESSION 28: GEOLOGY, MINERALS, COAL AND PETROLEUM: ASSOCIATION WITHOUT DETERMINISM
|   DEFINITION / TERMS : Coal follows basin history; petroleum follows petroleum-system completeness.
|   MECHANISM / ARGUMENT: India's resource map reflects ancient shield mineralisation, Gondwana coal basins, sedimentary petroleum systems, coastal placers and weathering-derived ores.
|   CONSEQUENCE / CONTRAST: It does not imply that all critical minerals lie in one geological province.
...
+--
        ...
        v
+-- SESSION 29: SEISMICITY: HIMALAYA, KACHCHH AND PENINSULAR INTRAPLATE EVENTS
|   DEFINITION / TERMS : Andaman-Nicobar seismicity is linked to the Sunda-Andaman subduction system and includes tsunami-generating megathrust potential.
|   MECHANISM / ARGUMENT: India's seismicity reflects active plate-boundary deformation in the Himalaya and north-east, subduction near Andaman-Nicobar, and intraplate reactivation in Kachchh and parts of the Peninsula.
|   CONSEQUENCE / CONTRAST: Kachchh is an intraplate high-hazard region with inherited rift faults and damaging historical earthquakes, including the 2001 Bhuj event.
|   TRAP / ANSWER-USE: Mains use: Explain source, path/site effect and vulnerability separately; do not equate tectonic activity with disaster magnitude.
