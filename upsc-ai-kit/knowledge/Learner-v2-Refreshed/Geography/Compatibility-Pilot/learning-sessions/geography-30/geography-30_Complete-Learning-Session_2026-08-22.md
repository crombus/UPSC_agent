---
title: "Geography 30 — Primary Economic Activities: Agriculture — Learner-v2 Refreshed"
topic_key: geography-30-primary-economic-activities-agriculture
cover_image: assets/geography-30_Teaching-Navigation_2026-08-22.png
variant: learner-v2
...
![Refreshed teaching navigation](assets/geography-30_Teaching-Navigation_2026-08-22.png)

*Distinct embedded teaching-navigation image. The separate continuous Cārvāka-style flowchart package remains an independent at-a-glance artifact.*

### SESSION 1 — START HERE — THE LEARNING PATH AND EVIDENCE SAFETY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** !Roadmap from primary-activity basics to location, systems, change and exam application

**Technical definition:** Start here — the learning path and evidence safety: The topic is easiest when read as one chain
...
**How to use them:** !Roadmap from primary-activity basics to location, systems, change and exam application

#### Visual first

![Roadmap from primary-activity basics to location, systems, change and exam application](assets/01_topic-roadmap.png)
...
#### CLOSING RECALL FLOW — START HERE — THE LEARNING PATH AND EVIDENCE SAFETY

```text
START / CONCEPT: Start here — the learning path and evidence safety
        |
        v
EXACT TERMS: 2026 · 2025 · 3765 · 430 · 059
        |
        v
MECHANISM / ARGUMENT: activity spaces, but each is explained by a different combination of ecology, labour,
        |
        v
CONSEQUENCE / CONTRAST: Agriculture is not a list of crops.
        |
        v
UPSC TRAP / ANSWER-USE: Agriculture is not a list of crops.
        |
        v
ANSWER-GRABBING FORMULATION: !Roadmap from primary-activity basics to location, systems, change and exam application
```
### SESSION 2 — WHAT AGRICULTURAL GEOGRAPHY STUDIES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** !Primary activities classified by direct dependence on nature

**Technical definition:** What agricultural geography studies: Agriculture is a leading primary activity because it draws directly on land, water, climate,
...
- **Why does that location and seasonal pattern make sense?**
- **location, seasonality, organisation and change**
- **What agricultural geography studies**

**How to use them:** !Primary activities classified by direct dependence on nature

#### Visual first

![Primary activities classified by direct dependence on nature](assets/02_primary-activity-taxonomy.png)
...
START / CONCEPT: What agricultural geography studies
        |
        v
EXACT TERMS: What is produced? · Where is it produced? · Why does that location and seasonal pattern make sense? · location, seasonality, organisation and change · What agricultural geography studies
        |
        v
MECHANISM / ARGUMENT: !Primary activities classified by direct dependence on nature
        |
        v
CONSEQUENCE / CONTRAST: Agricultural geography therefore asks three simple questions
        |
        v
UPSC TRAP / ANSWER-USE: cannot explain the location; water control and incentives complete the answer.
        |
        v
ANSWER-GRABBING FORMULATION: !Primary activities classified by direct dependence on nature
```
### SESSION 3 — THE SIX CONTROLS OF AGRICULTURE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** !Physical and human controls that jointly shape agricultural location

**Technical definition:** The six controls of agriculture: Fertile soil alone is not sufficient.
...
**How to use them:** !Physical and human controls that jointly shape agricultural location

#### Visual first

![Physical and human controls that jointly shape agricultural location](assets/07_physical-controls-matrix.png)
...
START / CONCEPT: The six controls of agriculture
        |
        v
EXACT TERMS: physical controls · human controls · multi-control system · The six controls of agriculture
        |
        v
MECHANISM / ARGUMENT: No single control creates an agricultural region.
        |
        v
CONSEQUENCE / CONTRAST: Think of six filters working together
        |
        v
UPSC TRAP / ANSWER-USE: water, labour or access does not automatically become a productive farming belt.
        |
        v
ANSWER-GRABBING FORMULATION: !Physical and human controls that jointly shape agricultural location
```
### SESSION 4 — MAJOR AGRICULTURAL SYSTEMS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** !Farming systems compared by subsistence, labour, scale and market orientation

**Technical definition:** Major agricultural systems: Commercial orientation asks how strongly production is aimed at the market.
...
**How to use them:** !Farming systems compared by subsistence, labour, scale and market orientation

#### Visual first

![Farming systems compared by subsistence, labour, scale and market orientation](assets/03_farming-system-classification.png)
...
START / CONCEPT: Major agricultural systems
        |
        v
EXACT TERMS: Intensity · Commercial orientation · climate base, labour/scale, market link · resource base + labour and scale + market orientation · Major agricultural systems
        |
        v
MECHANISM / ARGUMENT: !Farming systems compared by subsistence, labour, scale and market orientation
        |
        v
CONSEQUENCE / CONTRAST: Intensity asks how much labour/capital and output occur per unit land.
        |
        v
UPSC TRAP / ANSWER-USE: Intensive does not always mean mechanised.
        |
        v
ANSWER-GRABBING FORMULATION: !Farming systems compared by subsistence, labour, scale and market orientation
```
### SESSION 5 — VON THUNEN — WHY DISTANCE STILL MATTERS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** !Classical Von Thunen rings around a central market

**Technical definition:** Von Thunen is a location model, not a climate classification.
...
- **transport cost, perishability and land rent still shape location**
- **Von Thunen — why distance still matters**

**How to use them:** !Classical Von Thunen rings around a central market

#### Visual first

![Classical Von Thunen rings around a central market](assets/05_von-thunen-classical-rings.png)
...
![Modern transport and cold chains stretch rather than erase distance effects](assets/06_von-thunen-modified-model.png)
...
START / CONCEPT: Von Thunen — why distance still matters
        |
        v
EXACT TERMS: transport cost, perishability and land rent still shape location · Von Thunen — why distance still matters
        |
        v
MECHANISM / ARGUMENT: Von Thunen imagined one market surrounded by uniform land.
        |
        v
CONSEQUENCE / CONTRAST: !Modern transport and cold chains stretch rather than erase distance effects
        |
        v
UPSC TRAP / ANSWER-USE: !Modern transport and cold chains stretch rather than erase distance effects
        |
        v
ANSWER-GRABBING FORMULATION: !Classical Von Thunen rings around a central market
```
### SESSION 6 — WORLD AGRICULTURAL REGIONS AND CROP REQUIREMENTS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** !World agricultural regions linked to climate, labour and markets

**Technical definition:** World regions become memorable when each is tied to one climate pattern, one production
...
**How to use them:** !World agricultural regions linked to climate, labour and markets

#### Visual first

![World agricultural regions linked to climate, labour and markets](assets/08_global-farming-systems.png)
...
![A decision tree for linking crop needs to a plausible location](assets/11_crop-location-decision-tree.png)
...
START / CONCEPT: World agricultural regions and crop requirements
        |
        v
EXACT TERMS: crop - climate - soil/drainage - region · bundle of suitability · World agricultural regions and crop requirements
        |
        v
MECHANISM / ARGUMENT: World regions become memorable when each is tied to one climate pattern, one production
        |
        v
CONSEQUENCE / CONTRAST: system and one market or labour feature.
        |
        v
UPSC TRAP / ANSWER-USE: Crop requirements are broad guides, not rigid thresholds
        |
        v
ANSWER-GRABBING FORMULATION: !World agricultural regions linked to climate, labour and markets
```
### SESSION 7 — FROM SUBSISTENCE TO COMMERCIALISATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** !Inputs, farm decisions, outputs and feedbacks in an agroecosystem

**Technical definition:** From subsistence to commercialisation: A vegetable-growing district can commercialise only when production is matched by roads,
...
**How to use them:** !Inputs, farm decisions, outputs and feedbacks in an agroecosystem

#### Visual first

![Inputs, farm decisions, outputs and feedbacks in an agroecosystem](assets/04_agroecosystem-flow.png)
...
START / CONCEPT: From subsistence to commercialisation
        |
        v
EXACT TERMS: sequence of linked capabilities · water + technology + connectivity + institutions + demand · From subsistence to commercialisation
        |
        v
MECHANISM / ARGUMENT: Institutions matter because they organise water, information and exchange.
        |
        v
CONSEQUENCE / CONTRAST: Institutions matter because they organise water, information and exchange.
        |
        v
UPSC TRAP / ANSWER-USE: Explain commercialisation as a sequence of linked capabilities, not as a simple shift from
        |
        v
ANSWER-GRABBING FORMULATION: !Inputs, farm decisions, outputs and feedbacks in an agroecosystem
```
### SESSION 8 — READING AGRICULTURE CURRENT AFFAIRS WITHOUT DATA MISTAKES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** !Official-data status ladder and the labels that must not be collapsed

**Technical definition:** Reading agriculture current affairs without data mistakes: Is it an estimate, a final value, a target or an administrative count?

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> !Official-data status ladder and the labels that must not be collapsed
...
**How to use them:** !Official-data status ladder and the labels that must not be collapsed

#### Visual first

![Official-data status ladder and the labels that must not be collapsed](assets/29_current-data-status-firewall.png)
...
#### CLOSING RECALL FLOW — READING AGRICULTURE CURRENT AFFAIRS WITHOUT DATA MISTAKES

```text
START / CONCEPT: Reading agriculture current affairs without data mistakes
        |
        v
EXACT TERMS: status + date + unit + measure · 2025 · Reading agriculture current affairs without data mistakes
        |
        v
MECHANISM / ARGUMENT: Agriculture news often places several unlike numbers side by side.
        |
        v
CONSEQUENCE / CONTRAST: Agriculture news often places several unlike numbers side by side.
        |
        v
UPSC TRAP / ANSWER-USE: !Official-data status ladder and the labels that must not be collapsed
        |
        v
ANSWER-GRABBING FORMULATION: !Official-data status ladder and the labels that must not be collapsed
```
### SESSION 9 — NON-FARM PRIMARY ACTIVITIES — THE PHYSIOGRAPHY PRINCIPLE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Primary activities extract or harvest directly from nature.

**Technical definition:** Non-farm primary activities — the physiography principle: Their location is tightly constrained because the resource cannot be shifted to any chosen

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Primary activities extract or harvest directly from nature.
...
**How to use them:** Primary activities extract or harvest directly from nature.
...
START / CONCEPT: Non-farm primary activities — the physiography principle
        |
        v
EXACT TERMS: fishing, forestry and gathering, mining and quarrying · where the resource can exist · whether and how it is used · 2025 · Non-farm primary activities — the physiography principle
        |
        v
MECHANISM / ARGUMENT: Their location is tightly constrained because the resource cannot be shifted to any chosen
        |
        v
CONSEQUENCE / CONTRAST: Their location is tightly constrained because the resource cannot be shifted to any chosen
        |
        v
UPSC TRAP / ANSWER-USE: Their location is tightly constrained because the resource cannot be shifted to any chosen
        |
        v
ANSWER-GRABBING FORMULATION: Primary activities extract or harvest directly from nature.
```
### SESSION 10 — FISHING

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Fishing geography depends on the width and depth of the continental shelf, nutrient supply,

**Technical definition:** Fishing: current mixing, upwelling, sheltered landing sites, estuaries and inland water bodies.
...
**How to use them:** Fishing geography depends on the width and depth of the continental shelf, nutrient supply,
...
START / CONCEPT: Fishing
        |
        v
EXACT TERMS: water-body form + nutrients + shelter + access · Fishing
        |
        v
MECHANISM / ARGUMENT: Link every example to a mechanism: shelf - marine potential; floodplain/reservoir - inland
        |
        v
CONSEQUENCE / CONTRAST: Mangrove-estuarine margins are nursery habitats but can also face aquaculture pressure.
        |
        v
UPSC TRAP / ANSWER-USE: floodplains and peninsular reservoirs also show why a major fish-producing area need not be
        |
        v
ANSWER-GRABBING FORMULATION: Fishing geography depends on the width and depth of the continental shelf, nutrient supply,
```
### SESSION 11 — FORESTRY AND FOREST PRODUCE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Forestry is controlled not only by the existence of trees but by species, slope, distance and

**Technical definition:** Forestry is controlled not only by the existence of trees but by species, slope, distance and
...
**How to use them:** Forestry is controlled not only by the existence of trees but by species, slope, distance and
...
START / CONCEPT: Forestry and forest produce
        |
        v
EXACT TERMS: forest ecology - accessibility - product - livelihood/institutional issue · forest type, slope, accessibility and rights · Forestry and forest produce
        |
        v
MECHANISM / ARGUMENT: Forestry is controlled not only by the existence of trees but by species, slope, distance and
        |
        v
CONSEQUENCE / CONTRAST: Diverse tropical forests are also less suited to uniform mechanised extraction than
        |
        v
UPSC TRAP / ANSWER-USE: Forestry is controlled not only by the existence of trees but by species, slope, distance and
        |
        v
ANSWER-GRABBING FORMULATION: Forestry is controlled not only by the existence of trees but by species, slope, distance and
```
### SESSION 12 — MINING AND QUARRYING

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Geology decides occurrence, while grade, relief, transport, power and processing decide

**Technical definition:** Mining and quarrying: Bulky low-value-per-tonne ores are especially sensitive to transport cost.
...
**How to use them:** Geology decides occurrence, while grade, relief, transport, power and processing decide
...
START / CONCEPT: Mining and quarrying
        |
        v
EXACT TERMS: transport and institutions convert deposit into production · Mining and quarrying
        |
        v
MECHANISM / ARGUMENT: Geology decides occurrence, while grade, relief, transport, power and processing decide
        |
        v
CONSEQUENCE / CONTRAST: Quarrying may be widespread, but riverbed mining and hill cutting can destabilise channels and
        |
        v
UPSC TRAP / ANSWER-USE: Mineral richness does not guarantee local prosperity.
        |
        v
ANSWER-GRABBING FORMULATION: Geology decides occurrence, while grade, relief, transport, power and processing decide
```
### SESSION 13 — ANSWER ARCHITECTURE AND TECHNOLOGY-LED TRANSFORMATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** !A Geography answer spine from claim and map logic to qualification and verdict

**Technical definition:** Answer architecture and technology-led transformation: The Green Revolution is the clearest illustration: it strengthened national grain security
...
**How to use them:** !A Geography answer spine from claim and map logic to qualification and verdict

#### Visual first

![A Geography answer spine from claim and map logic to qualification and verdict](assets/30_upsc-answer-spine.png)
...
#### CLOSING RECALL FLOW — ANSWER ARCHITECTURE AND TECHNOLOGY-LED TRANSFORMATION

```text
START / CONCEPT: Answer architecture and technology-led transformation
        |
        v
EXACT TERMS: Answer · architecture
        |
        v
MECHANISM / ARGUMENT: unevenly because water, level land, credit, inputs and purchase outlets are unevenly
        |
        v
CONSEQUENCE / CONTRAST: extension and procurement—can raise yields and cropping intensity quickly.
        |
        v
UPSC TRAP / ANSWER-USE: Do not narrate a technology package without explaining spatial selectivity.
        |
        v
ANSWER-GRABBING FORMULATION: !A Geography answer spine from claim and map logic to qualification and verdict
```
### SESSION 14 — CORE EXAM MAP

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Prelims: farming-system distinctions; crop-climate links; Von Thunen; primary-activity

**Technical definition:** Core exam map: classification; official-data labels.
...
**How to use them:** Prelims: farming-system distinctions; crop-climate links; Von Thunen; primary-activity
...
START / CONCEPT: Core exam map
        |
        v
EXACT TERMS: Prelims · GS-I · GS-III · Study link · Core exam map
        |
        v
MECHANISM / ARGUMENT: classification; official-data labels.
        |
        v
CONSEQUENCE / CONTRAST: GS-I: world agricultural regions; location models; physiography of non-farm primary
        |
        v
UPSC TRAP / ANSWER-USE: Answer-use: Prelims: farming-system distinctions; crop-climate links; Von Thunen; primary-activity
        |
        v
ANSWER-GRABBING FORMULATION: Prelims: farming-system distinctions; crop-climate links; Von Thunen; primary-activity
```
...
![Kharif, Rabi and Zaid read as different climate and water geographies](assets/09_india-seasons-calendar.png)

![India's major agricultural mosaics from irrigated plains to drylands and plantation highlands](assets/10_agro-climatic-regionalisation.png)
...
![Landholding definitions and the distinction between ownership and operation](assets/15_landholding-tenure-firewall.png)

![Schematic crop belts for foodgrains and fibres; not a current ranking chart](assets/12_major-crop-belts-foodgrains-fibres.png)
...
![The Green Revolution as a package with spatially selective preconditions and outcomes](assets/14_green-revolution-chain.png)
...
![From price recommendation and announcement to geographically selective procurement](assets/20_msp-procurement-chain.png)

![Production, procurement, central-pool movement and distribution kept as distinct stages](assets/22_food-security-architecture.png)
...
![The feedback between cheap pumping, aquifer decline, energy use and crop choice](assets/16_irrigation-and-groundwater-energy-nexus.png)
...
![Current agriculture policies mapped to income, risk, water, markets, infrastructure, data and transition](assets/27_current-schemes-architecture.png)

![Status ladder for distinguishing policy activity from outcome and impact](assets/29_current-data-status-firewall.png)
...
![Claim, evidence, analysis, qualification and verdict for a high-scoring Geography answer](assets/30_upsc-answer-spine.png)
...
```ascii-master
Geography 30 — Primary Economic Activities: Agriculture — COMPLETE TOPIC ASCII MASTER FLOW DIAGRAM

START / CENTRAL QUESTION
  Start here — the learning path and evidence safety: The topic is easiest when read as one chain
        |
        v
+-- SESSION 01: START HERE — THE LEARNING PATH AND EVIDENCE SAFETY
|   DEFINITION / TERMS : Start here — the learning path and evidence safety: The topic is easiest when read as one chain
|   MECHANISM / ARGUMENT: activity spaces, but each is explained by a different combination of ecology, labour,
|   CONSEQUENCE / CONTRAST: Agriculture is not a list of crops.
|   TRAP / ANSWER-USE: Agriculture is not a list of crops.
|   EXAM OPENING: !Roadmap from primary-activity basics to location, systems, change and exam application
+--
        |
        v
+-- SESSION 02: WHAT AGRICULTURAL GEOGRAPHY STUDIES
|   DEFINITION / TERMS : What agricultural geography studies: Agriculture is a leading primary activity because it draws directly on land, water, climate,
|   MECHANISM / ARGUMENT: !Primary activities classified by direct dependence on nature
|   CONSEQUENCE / CONTRAST: Agricultural geography therefore asks three simple questions
|   TRAP / ANSWER-USE: cannot explain the location; water control and incentives complete the answer.
|   EXAM OPENING: !Primary activities classified by direct dependence on nature
+--
        |
        v
+-- SESSION 03: THE SIX CONTROLS OF AGRICULTURE
|   DEFINITION / TERMS : The six controls of agriculture: Fertile soil alone is not sufficient.
|   MECHANISM / ARGUMENT: No single control creates an agricultural region.
|   CONSEQUENCE / CONTRAST: Think of six filters working together
|   TRAP / ANSWER-USE: water, labour or access does not automatically become a productive farming belt.
|   EXAM OPENING: !Physical and human controls that jointly shape agricultural location
+--
        |
        v
+-- SESSION 04: MAJOR AGRICULTURAL SYSTEMS
|   DEFINITION / TERMS : Major agricultural systems: Commercial orientation asks how strongly production is aimed at the market.
|   MECHANISM / ARGUMENT: !Farming systems compared by subsistence, labour, scale and market orientation
|   CONSEQUENCE / CONTRAST: Intensity asks how much labour/capital and output occur per unit land.
|   TRAP / ANSWER-USE: Intensive does not always mean mechanised.
|   EXAM OPENING: !Farming systems compared by subsistence, labour, scale and market orientation
+--
        |
        v
+-- SESSION 05: VON THUNEN — WHY DISTANCE STILL MATTERS
|   DEFINITION / TERMS : Von Thunen is a location model, not a climate classification.
|   MECHANISM / ARGUMENT: Von Thunen imagined one market surrounded by uniform land.
|   CONSEQUENCE / CONTRAST: !Modern transport and cold chains stretch rather than erase distance effects
|   TRAP / ANSWER-USE: !Modern transport and cold chains stretch rather than erase distance effects
|   EXAM OPENING: !Classical Von Thunen rings around a central market
+--
        |
        v
+-- SESSION 06: WORLD AGRICULTURAL REGIONS AND CROP REQUIREMENTS
|   DEFINITION / TERMS : World regions become memorable when each is tied to one climate pattern, one production
|   MECHANISM / ARGUMENT: World regions become memorable when each is tied to one climate pattern, one production
|   CONSEQUENCE / CONTRAST: system and one market or labour feature.
|   TRAP / ANSWER-USE: Crop requirements are broad guides, not rigid thresholds
|   EXAM OPENING: !World agricultural regions linked to climate, labour and markets
+--
        |
        v
+-- SESSION 07: FROM SUBSISTENCE TO COMMERCIALISATION
|   DEFINITION / TERMS : From subsistence to commercialisation: A vegetable-growing district can commercialise only when production is matched by roads,
|   MECHANISM / ARGUMENT: Institutions matter because they organise water, information and exchange.
|   CONSEQUENCE / CONTRAST: Institutions matter because they organise water, information and exchange.
|   TRAP / ANSWER-USE: Explain commercialisation as a sequence of linked capabilities, not as a simple shift from
|   EXAM OPENING: !Inputs, farm decisions, outputs and feedbacks in an agroecosystem
+--
        |
        v
+-- SESSION 08: READING AGRICULTURE CURRENT AFFAIRS WITHOUT DATA MISTAKES
|   DEFINITION / TERMS : Reading agriculture current affairs without data mistakes: Is it an estimate, a final value, a target or an administrative count?
|   MECHANISM / ARGUMENT: Agriculture news often places several unlike numbers side by side.
|   CONSEQUENCE / CONTRAST: Agriculture news often places several unlike numbers side by side.
|   TRAP / ANSWER-USE: !Official-data status ladder and the labels that must not be collapsed
|   EXAM OPENING: !Official-data status ladder and the labels that must not be collapsed
+--
        |
        v
+-- SESSION 09: NON-FARM PRIMARY ACTIVITIES — THE PHYSIOGRAPHY PRINCIPLE
|   DEFINITION / TERMS : Non-farm primary activities — the physiography principle: Their location is tightly constrained because the resource cannot be shifted to any chosen
|   MECHANISM / ARGUMENT: Their location is tightly constrained because the resource cannot be shifted to any chosen
|   CONSEQUENCE / CONTRAST: Their location is tightly constrained because the resource cannot be shifted to any chosen
|   TRAP / ANSWER-USE: Their location is tightly constrained because the resource cannot be shifted to any chosen
|   EXAM OPENING: Primary activities extract or harvest directly from nature.
+--
        |
        v
+-- SESSION 10: FISHING
|   DEFINITION / TERMS : Fishing: current mixing, upwelling, sheltered landing sites, estuaries and inland water bodies.
|   MECHANISM / ARGUMENT: Link every example to a mechanism: shelf - marine potential; floodplain/reservoir - inland
|   CONSEQUENCE / CONTRAST: Mangrove-estuarine margins are nursery habitats but can also face aquaculture pressure.
|   TRAP / ANSWER-USE: floodplains and peninsular reservoirs also show why a major fish-producing area need not be
|   EXAM OPENING: Fishing geography depends on the width and depth of the continental shelf, nutrient supply,
+--
        |
        v
+-- SESSION 11: FORESTRY AND FOREST PRODUCE
|   DEFINITION / TERMS : Forestry is controlled not only by the existence of trees but by species, slope, distance and
|   MECHANISM / ARGUMENT: Forestry is controlled not only by the existence of trees but by species, slope, distance and
|   CONSEQUENCE / CONTRAST: Diverse tropical forests are also less suited to uniform mechanised extraction than
|   TRAP / ANSWER-USE: Forestry is controlled not only by the existence of trees but by species, slope, distance and
|   EXAM OPENING: Forestry is controlled not only by the existence of trees but by species, slope, distance and
+--
        |
        v
+-- SESSION 12: MINING AND QUARRYING
|   DEFINITION / TERMS : Mining and quarrying: Bulky low-value-per-tonne ores are especially sensitive to transport cost.
|   MECHANISM / ARGUMENT: Geology decides occurrence, while grade, relief, transport, power and processing decide
|   CONSEQUENCE / CONTRAST: Quarrying may be widespread, but riverbed mining and hill cutting can destabilise channels and
|   TRAP / ANSWER-USE: Mineral richness does not guarantee local prosperity.
|   EXAM OPENING: Geology decides occurrence, while grade, relief, transport, power and processing decide
+--
        |
        v
+-- SESSION 13: ANSWER ARCHITECTURE AND TECHNOLOGY-LED TRANSFORMATION
|   DEFINITION / TERMS : Answer architecture and technology-led transformation: The Green Revolution is the clearest illustration: it strengthened national grain security
|   MECHANISM / ARGUMENT: unevenly because water, level land, credit, inputs and purchase outlets are unevenly
|   CONSEQUENCE / CONTRAST: extension and procurement—can raise yields and cropping intensity quickly.
|   TRAP / ANSWER-USE: Do not narrate a technology package without explaining spatial selectivity.
|   EXAM OPENING: !A Geography answer spine from claim and map logic to qualification and verdict
+--
        |
        v
+-- SESSION 14: CORE EXAM MAP
|   DEFINITION / TERMS : Core exam map: classification; official-data labels.
|   MECHANISM / ARGUMENT: classification; official-data labels.
|   CONSEQUENCE / CONTRAST: GS-I: world agricultural regions; location models; physiography of non-farm primary
|   TRAP / ANSWER-USE: Answer-use: Prelims: farming-system distinctions; crop-climate links; Von Thunen; primary-activity
|   EXAM OPENING: Prelims: farming-system distinctions; crop-climate links; Von Thunen; primary-activity
+--
        |
        v
