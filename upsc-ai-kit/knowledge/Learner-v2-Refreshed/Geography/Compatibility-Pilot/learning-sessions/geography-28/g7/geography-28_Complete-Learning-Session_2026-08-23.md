...
cover_image: assets/geography-28_Teaching-Navigation_2026-08-23.png
variant: "learner-v2"
...
![Refreshed teaching navigation](assets/geography-28_Teaching-Navigation_2026-08-23.png)
...
**Plain-language definition:** Site is the exact ground; situation is the settlement's relative position in a larger region.
...
**How to use them:** Use Settlement Geography to define the issue, connect Site with Situation to explain it, and use Function to distinguish or qualify the conclusion.
...
CONSEQUENCE / CONTRAST: By contrast, a Himalayan village may have a secure terrace site but remain small because steep relief limits expansion and connectivity.
        |
        v
UPSC TRAP / ANSWER-USE: A good water site may remain small if it is isolated; a modest site may grow rapidly if its situation becomes a major transport junction.
        |
        v
ANSWER-GRABBING FORMULATION: Site is the exact ground; situation is the settlement's relative position in a larger region.
```
...
**How to use them:** Use Rural Settlement Forms to define the issue, connect form with Compact / nucleated to explain it, and use Semi-compact to distinguish or qualify the conclusion.
...
EXACT TERMS: Rural Settlement Forms · form · Compact / nucleated · Semi-compact · Hamleted · Dispersed
        |
        v
MECHANISM / ARGUMENT: Correction: dispersed settlement can be a functional adaptation to large farms or rugged terrain.
        |
        v
CONSEQUENCE / CONTRAST: Form is not a development ranking.
        |
        v
UPSC TRAP / ANSWER-USE: Rural settlement form describes how houses are grouped.
        |
        v
...
**Plain-language definition:** The most dependable textbook example is a linear settlement following a road, canal, river or coast.
...
> The most dependable textbook example is a linear settlement following a road, canal, river or coast.
...
**How to use them:** Use Settlement Patterns to define the issue, connect Linear with Rectangular / grid to explain it, and use Radial to distinguish or qualify the conclusion.
...
EXACT TERMS: Settlement Patterns · Linear · Rectangular / grid · Radial · Circular · Irregular
        |
        v
MECHANISM / ARGUMENT: Ribbon development along a national highway is linear even when the settlement contains shops, homes and workshops.
        |
        v
CONSEQUENCE / CONTRAST: Pattern is the visible arrangement of streets and dwellings; it is not the same as function.
        |
        v
UPSC TRAP / ANSWER-USE: Form measures clustering; pattern shows geometry; function explains economic role.
        |
        v
ANSWER-GRABBING FORMULATION: The most dependable textbook example is a linear settlement following a road, canal, river or coast.
```
...
**How to use them:** Use Urbanisation to define the issue, connect The Rural-Urban Continuum with continuum to explain it, and use Urban agglomeration (UA) to distinguish or qualify the conclusion.
...
CONSEQUENCE / CONTRAST: Urbanisation changes population share, occupation, services, connectivity and land use—not just the number of buildings.
        |
        v
UPSC TRAP / ANSWER-USE: ✅ Current policy debate still depends on the Census distinction between statutory towns, census towns and urban agglomerations because a newer full census-based national urban baseline has not yet replaced Census 2011 in the reused sources.
        |
        v
...
**Technical definition:** Use a model in four steps: assumption → mechanism → Indian application → limitation.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> ❌ Wrong: “The city follows Model X.” ✅ Better: “Model X explains this part of the pattern, while history, informality and polycentric growth require qualification.”.
...
**How to use them:** Use Model Firewall to define the issue, connect Models Simplify with They Do Not Photograph Reality to explain it, and use Christaller to distinguish or qualify the conclusion.
...
CONSEQUENCE / CONTRAST: A model is a thinking tool, not a universal map.
        |
        v
UPSC TRAP / ANSWER-USE: Delhi can be read through a historic core, colonial New Delhi, industrial corridors, satellite centres and NCR commuting.
        |
        v
ANSWER-GRABBING FORMULATION: ❌ Wrong: “The city follows Model X.” ✅ Better: “Model X explains this part of the pattern, while history, informality and polycentric growth require qualification.”.
```
...
**How to use them:** Use Christaller'S Central-Place Theory to define the issue, connect Threshold with Range to explain it, and use Hierarchy to distinguish or qualify the conclusion.
...
**Technical definition:** Use the variables, not the ideal geometry, as the main Indian application.
...
**How to use them:** Use Applying Central-Place Logic To India to define the issue, connect hierarchy collapse with variables to explain it, and use Great alluvial plains to distinguish or qualify the conclusion.
...
START / CONCEPT: APPLYING CENTRAL-PLACE LOGIC TO INDIA
        |
        v
EXACT TERMS: Applying Central-Place Logic To India · hierarchy collapse · variables · Great alluvial plains · Service-facility planning · Periodic markets
        |
        v
MECHANISM / ARGUMENT: This comparison is the visual: use it to move from “model fits” to “model is selectively useful.”.
        |
        v
CONSEQUENCE / CONTRAST: Do not draw a perfect hexagonal map of India.
        |
        v
UPSC TRAP / ANSWER-USE: Christaller's most useful contemporary application is hierarchy collapse.
        |
        v
ANSWER-GRABBING FORMULATION: Use the variables, not the ideal geometry, as the main Indian application.
```
### SESSION 8 — RANK-SIZE, PRIMATE CITY AND INDIA'S MULTI-METROPOLITAN SYSTEM

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The rank-size rule says that, in a well-integrated urban system, a city's population is roughly the largest city's population divided by its rank.

**Technical definition:** India is not strongly primate at the national scale because several very large metropolitan centres coexist.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The rank-size rule says that, in a well-integrated urban system, a city's population is roughly the largest city's population divided by its rank.
...
**How to use them:** Use Rank-Size to define the issue, connect Primate City with India'S Multi-Metropolitan System to explain it, and use rank-size rule to distinguish or qualify the conclusion.
...
EXACT TERMS: Rank-Size · Primate City · India'S Multi-Metropolitan System · rank-size rule · national · Correction
        |
        v
MECHANISM / ARGUMENT: India is not strongly primate at the national scale because several very large metropolitan centres coexist.
        |
        v
CONSEQUENCE / CONTRAST: A primate city is far larger and more dominant than the rank-size expectation.
        |
        v
UPSC TRAP / ANSWER-USE: Rank-size suggests a smooth city-size distribution; primacy signals disproportionate dominance.
        |
        v
ANSWER-GRABBING FORMULATION: The rank-size rule says that, in a well-integrated urban system, a city's population is roughly the largest city's population divided by its rank.
```
### SESSION 9 — BURGESS: THE CONCENTRIC-ZONE MODEL

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The transition zone is not a universal “slum ring.”.

**Technical definition:** Growth occurs through invasion and succession: expanding activities enter an adjacent ring and push older uses outward.
...
**How to use them:** Use Burgess to define the issue, connect The Concentric-Zone Model with central business district to explain it, and use transition zone to distinguish or qualify the conclusion.
...
CONSEQUENCE / CONTRAST: The transition zone is not a universal “slum ring.”.
        |
        v
UPSC TRAP / ANSWER-USE: Use Burgess to explain an age-status gradient, then immediately qualify the single-centre and uniform-transport assumptions.
        |
        v
...
**How to use them:** Use Hoyt to define the issue, connect The Sector Model with wedges to explain it, and use corridor to distinguish or qualify the conclusion.
...
UPSC TRAP / ANSWER-USE: Industrial uses may extend along rail or highway corridors, while higher-income housing follows a well-connected and environmentally attractive direction.
        |
        v
ANSWER-GRABBING FORMULATION: Do not call every transport corridor a complete sector model.
```
...
**How to use them:** Use Harris to define the issue, connect Ullman with The Multiple-Nuclei Model to explain it, and use specialisation + clustering + incompatibility + decentralisation to distinguish or qualify the conclusion.
...
CONSEQUENCE / CONTRAST: Polycentricity is not automatically good governance.
        |
        v
UPSC TRAP / ANSWER-USE: Multiple nuclei best captures specialisation + clustering + incompatibility + decentralisation.
        |
        v
...
**Technical definition:** Correction: it is statistically urban by demographic-economic criteria even without an urban local body.
...
**How to use them:** Use India'S Urban Definitions to define the issue, connect Statistical Urbanisation with Administrative Urbanisation to explain it, and use Statutory town to distinguish or qualify the conclusion.
...
EXACT TERMS: India'S Urban Definitions · Statistical Urbanisation · Administrative Urbanisation · Statutory town · Census town · Urban agglomeration
        |
        v
MECHANISM / ARGUMENT: Correction: it is statistically urban by demographic-economic criteria even without an urban local body.
        |
        v
...
**Technical definition:** Correction: the mechanism includes land prices, formal supply, tenure and service exclusion.
...
**How to use them:** Use India'S Urban Problem Set to define the issue, connect Sprawl with Housing to explain it, and use Mobility to distinguish or qualify the conclusion.
...
**Technical definition:** The exact local mechanism differs, but the catchment principle is common.
...
**How to use them:** Use India'S Urban Problem Set to define the issue, connect Floods with Heat to explain it, and use Water to distinguish or qualify the conclusion.
...
EXACT TERMS: India'S Urban Problem Set · Floods · Heat · Water · Sanitation · volume and speed
        |
        v
MECHANISM / ARGUMENT: Exposure combines with housing quality, occupation, age, health and access to cooling, so the same temperature produces unequal harm.
        |
        v
CONSEQUENCE / CONTRAST: The exact local mechanism differs, but the catchment principle is common.
        |
        v
UPSC TRAP / ANSWER-USE: Dark surfaces store heat, reduced vegetation limits evaporative cooling, built geometry traps radiation and human activity adds waste heat.
        |
        v
...
**Technical definition:** Use governance fragmentation as the underlying mechanism connecting sprawl, flooding, service stress and weak maintenance.
...
**How to use them:** Use India'S Urban Problem Set to define the issue, connect Governance Fragmentation with functional city to explain it, and use governed city to distinguish or qualify the conclusion.
...
START / CONCEPT: INDIA'S URBAN PROBLEM SET: GOVERNANCE FRAGMENTATION
        |
        v
EXACT TERMS: India'S Urban Problem Set · Governance Fragmentation · functional city · governed city · Correction · This
        |
        v
MECHANISM / ARGUMENT: Use governance fragmentation as the underlying mechanism connecting sprawl, flooding, service stress and weak maintenance.
        |
        v
CONSEQUENCE / CONTRAST: Floodwater, air pollution, commuters and waste do not stop at a municipal border.
        |
        v
UPSC TRAP / ANSWER-USE: the built-up or commuting region crosses municipal boundaries; several parastatal agencies control water, transport, housing or development; local bodies lack adequate functions, staff or finance; and peri-urban land remains under rural authorities despite urban pressures.
        |
        v
...
**How to use them:** Use Basic Mastery Recap to define the issue, connect Basic verdict with Exact ground versus relational location to explain it, and use Clustering versus geometry versus activity to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: Urban problems emerge when land use, services and government no longer match the functional city.
        |
        v
CONSEQUENCE / CONTRAST: Basic verdict: settlement geography moves from the ground under a habitation to the regional network that sustains it.
        |
        v
UPSC TRAP / ANSWER-USE: Basic verdict: settlement geography moves from the ground under a habitation to the regional network that sustains it.
        |
        v
...
A. Site is legal status; situation is population rank
B. Site is the exact ground; situation is the settlement's relative location
C. Site is a market threshold; situation is a service range
D. Site is economic function; situation is street geometry

**Answer: B.** Site is local ground, while situation is relational position.

**Common-error remediation:** If you chose D, A or C, return to the four-question settlement
...
A. A legally notified municipality
B. A merged group of metropolitan regions
C. A close cluster of dwellings
D. A settlement with only non-farm work
...
A. Linear — houses around a central open space
B. Radial — houses following one canal
...
A. Expansion of a municipal boundary only
B. Rising urban share together with occupational, service and network change
C. Migration to one metropolitan city only
D. Increase in the number of buildings only
...
A. The maximum distance a consumer will travel
B. The legal boundary of a service centre
...
B. They reproduce real district borders exactly
C. They prove consumers always choose the nearest centre
...
B. A statutory conversion of a village
C. A primate-city effect
...
A. Every settlement is treated as one national system
B. The largest city is assumed to be primate
...
A. Every state follows rank-size perfectly
B. Primacy cannot be discussed below the world scale
C. India has one unchallenged national primate city
...
A. A fixed administrative K = 7 hierarchy
B. Only isolated farmsteads
...
B. Is created only through municipal law
C. Must be a million-plus city
D. Must contain several statutory towns
...
B. it automatically creates statutory towns
C. it shortens every commute
D. It always increases density
...
A. A result of urbanisation stopping
B. A cultural preference for unsafe land
C. A direct synonym for homelessness
...
B. Higher threshold → lower range → less travel
C. Municipal notification → lower rent → less traffic
D. Greater clustering → shorter networks → no vehicles
...
C. City population rank alone
D. Municipal status alone
...
A. Groundwater extraction has no regional effect
B. Source, continuity, quality, affordability, collection and treatment all matter
C. A sanctioned project is enough
D. Pipe length alone is enough
...
A. Informality always occupies one predicted zone
B. One ideal model should fully map every Indian city
C. A model explains a selected mechanism and requires Indian qualification
D. Assumptions need not be stated
...
B. They may remain under rural governance
C. They exist only after receiving an urban local body
D. They satisfy demographic-economic criteria
...
C. Smart technology has eliminated flood risk
D. A list of missions without a causal thesis
...
C. Demolition without alternatives
D. Housing supply without transport access
...
A. Urban growth should stop
B. Population concentration automatically guarantees inclusion
C. Cities produce only diseconomies
...
A. Copy one Western model
B. Use more schemes
C. Build more roads everywhere
...
START / CENTRAL QUESTION
  An urban settlement is generally larger, functionally diversified and dominated by non-primary activities.
        |
        v
+-- SESSION 01: SETTLEMENT GEOGRAPHY: SITE, SITUATION, FUNCTION AND HIERARCHY
|   DEFINITION / TERMS : An urban settlement is generally larger, functionally diversified and dominated by non-primary activities.
|   MECHANISM / ARGUMENT: An urban settlement is generally larger, functionally diversified and dominated by non-primary activities.
|   CONSEQUENCE / CONTRAST: By contrast, a Himalayan village may have a secure terrace site but remain small because steep relief limits expansion and connectivity.
|   TRAP / ANSWER-USE: A good water site may remain small if it is isolated; a modest site may grow rapidly if its situation becomes a major transport junction.
|   EXAM OPENING: Site is the exact ground; situation is the settlement's relative position in a larger region.
+--
        |
        v
+-- SESSION 02: RURAL SETTLEMENT FORMS: HOW CLOSELY DO PEOPLE LIVE?
|   DEFINITION / TERMS : Rural form answers “how closely?”; it does not by itself answer “how urban?”.
|   MECHANISM / ARGUMENT: Correction: dispersed settlement can be a functional adaptation to large farms or rugged terrain.
|   CONSEQUENCE / CONTRAST: Form is not a development ranking.
|   TRAP / ANSWER-USE: Rural settlement form describes how houses are grouped.
|   EXAM OPENING: Rural form answers “how closely?”; it does not by itself answer “how urban?”.
+--
        |
        v
+-- SESSION 03: SETTLEMENT PATTERNS: WHAT GEOMETRY APPEARS ON THE GROUND?
|   DEFINITION / TERMS : Ribbon development along a national highway is linear even when the settlement contains shops, homes and workshops.
|   MECHANISM / ARGUMENT: Ribbon development along a national highway is linear even when the settlement contains shops, homes and workshops.
|   CONSEQUENCE / CONTRAST: Pattern is the visible arrangement of streets and dwellings; it is not the same as function.
|   TRAP / ANSWER-USE: Form measures clustering; pattern shows geometry; function explains economic role.
|   EXAM OPENING: The most dependable textbook example is a linear settlement following a road, canal, river or coast.
+--
        |
        v
+-- SESSION 04: URBANISATION AND THE RURAL-URBAN CONTINUUM
|   DEFINITION / TERMS : Urbanisation is a process of people + work + services + networks + land-use change.
|   MECHANISM / ARGUMENT: A village near a metropolitan edge may still have a panchayat but increasingly depend on commuting, warehouses, rental rooms and urban land markets.
|   CONSEQUENCE / CONTRAST: Urbanisation changes population share, occupation, services, connectivity and land use—not just the number of buildings.
|   TRAP / ANSWER-USE: ✅ Current policy debate still depends on the Census distinction between statutory towns, census towns and urban agglomerations because a newer full census-based national urban baseline has not yet replaced Census 2011 in the reused sources.
|   EXAM OPENING: The rural-urban boundary is therefore a continuum, not a clean wall.
+--
        |
        v
+-- SESSION 05: MODEL FIREWALL: MODELS SIMPLIFY; THEY DO NOT PHOTOGRAPH REALITY
|   DEFINITION / TERMS : Use a model in four steps: assumption → mechanism → Indian application → limitation.
|   MECHANISM / ARGUMENT: Use a model in four steps: assumption → mechanism → Indian application → limitation.
|   CONSEQUENCE / CONTRAST: A model is a thinking tool, not a universal map.
|   TRAP / ANSWER-USE: Delhi can be read through a historic core, colonial New Delhi, industrial corridors, satellite centres and NCR commuting.
|   EXAM OPENING: ❌ Wrong: “The city follows Model X.” ✅ Better: “Model X explains this part of the pattern, while history, informality and polycentric growth require qualification.”.
+--
        |
        v
+-- SESSION 06: CHRISTALLER'S CENTRAL-PLACE THEORY: THRESHOLD, RANGE AND HIERARCHY
|   DEFINITION / TERMS : The theory explains a nested hierarchy of service centres through the minimum demand needed and the maximum distance consumers will travel.
|   MECHANISM / ARGUMENT: The theory explains a nested hierarchy of service centres through the minimum demand needed and the maximum distance consumers will travel.
|   CONSEQUENCE / CONTRAST: Real plains are not uniform; relief, rivers, resources and historic routes matter.
|   TRAP / ANSWER-USE: The model is static, while technology and population change continuously.
|   EXAM OPENING: Never stop at “settlements form a hierarchy.” Explain threshold → range → service order → nested centres, then qualify the geometry.
+--
        |
        v
+-- SESSION 07: APPLYING CENTRAL-PLACE LOGIC TO INDIA
|   DEFINITION / TERMS : Use the variables, not the ideal geometry, as the main Indian application.
|   MECHANISM / ARGUMENT: This comparison is the visual: use it to move from “model fits” to “model is selectively useful.”.
|   CONSEQUENCE / CONTRAST: Do not draw a perfect hexagonal map of India.
|   TRAP / ANSWER-USE: Christaller's most useful contemporary application is hierarchy collapse.
|   EXAM OPENING: Use the variables, not the ideal geometry, as the main Indian application.
+--
        |
        v
+-- SESSION 08: RANK-SIZE, PRIMATE CITY AND INDIA'S MULTI-METROPOLITAN SYSTEM
|   DEFINITION / TERMS : India is not strongly primate at the national scale because several very large metropolitan centres coexist.
|   MECHANISM / ARGUMENT: India is not strongly primate at the national scale because several very large metropolitan centres coexist.
|   CONSEQUENCE / CONTRAST: A primate city is far larger and more dominant than the rank-size expectation.
|   TRAP / ANSWER-USE: Rank-size suggests a smooth city-size distribution; primacy signals disproportionate dominance.
|   EXAM OPENING: The rank-size rule says that, in a well-integrated urban system, a city's population is roughly the largest city's population divided by its rank.
+--
        |
        v
+-- SESSION 09: BURGESS: THE CONCENTRIC-ZONE MODEL
|   DEFINITION / TERMS : Growth occurs through invasion and succession: expanding activities enter an adjacent ring and push older uses outward.
|   MECHANISM / ARGUMENT: Growth occurs through invasion and succession: expanding activities enter an adjacent ring and push older uses outward.
|   CONSEQUENCE / CONTRAST: The transition zone is not a universal “slum ring.”.
|   TRAP / ANSWER-USE: Use Burgess to explain an age-status gradient, then immediately qualify the single-centre and uniform-transport assumptions.
|   EXAM OPENING: Burgess explains rings well; it explains polycentric and corridor growth poorly.
+--
        |
        v
+-- SESSION 10: HOYT: THE SECTOR MODEL
|   DEFINITION / TERMS : The sector model argues that industry, housing and high-status residential areas grow outward in wedges.
|   MECHANISM / ARGUMENT: The sector model argues that industry, housing and high-status residential areas grow outward in wedges.
|   CONSEQUENCE / CONTRAST: Hoyt is stronger than Burgess when direction and transport corridors matter, but it still assumes one main centre and underplays later suburban nodes.
|   TRAP / ANSWER-USE: Industrial uses may extend along rail or highway corridors, while higher-income housing follows a well-connected and environmentally attractive direction.
|   EXAM OPENING: Do not call every transport corridor a complete sector model.
+--
        |
        v
+-- SESSION 11: HARRIS AND ULLMAN: THE MULTIPLE-NUCLEI MODEL
|   DEFINITION / TERMS : The result may include an old CBD, industrial node, university area, airport corridor, wholesale market and suburban business district.
|   MECHANISM / ARGUMENT: The result may include an old CBD, industrial node, university area, airport corridor, wholesale market and suburban business district.
|   CONSEQUENCE / CONTRAST: Polycentricity is not automatically good governance.
|   TRAP / ANSWER-USE: Multiple nuclei best captures specialisation + clustering + incompatibility + decentralisation.
|   EXAM OPENING: The model is descriptive rather than strongly predictive: it identifies multiple nodes but does not fully explain when and why each one will arise.
+--
        |
        v
+-- SESSION 12: INDIA'S URBAN DEFINITIONS: STATISTICAL URBANISATION AND ADMINISTRATIVE URBANISATION
|   DEFINITION / TERMS : Correction: it is statistically urban by demographic-economic criteria even without an urban local body.
|   MECHANISM / ARGUMENT: Correction: it is statistically urban by demographic-economic criteria even without an urban local body.
|   CONSEQUENCE / CONTRAST: A census town may have dense non-farm activity but remain governed as a rural panchayat, with rural service norms and funding arrangements.
|   TRAP / ANSWER-USE: A fast-growing settlement outside a city may host factories, warehouses, rented housing and daily commuters but lack municipal planning, drainage and property-management capacity.
|   EXAM OPENING: The key Indian issue is a mismatch between statistical urbanisation and administrative urbanisation.
+--
        |
        v
+-- SESSION 13: INDIA'S URBAN PROBLEM SET: SPRAWL, HOUSING AND MOBILITY
|   DEFINITION / TERMS : Correction: the mechanism includes land prices, formal supply, tenure and service exclusion.
|   MECHANISM / ARGUMENT: raises per-person infrastructure costs; lengthens commutes; converts farmland; separates housing from jobs; and leaves peri-urban areas under fragmented jurisdiction.
|   CONSEQUENCE / CONTRAST: Informal settlement is best understood as a housing-market and governance failure, not as a moral failure of migrants.
|   TRAP / ANSWER-USE: Restrictive land and building rules can limit supply, while insecure tenure discourages household investment.
|   EXAM OPENING: Urban sprawl is low-density or discontinuous outward growth beyond the effective reach of the municipal plan.
+--
        |
        v
+-- SESSION 14: INDIA'S URBAN PROBLEM SET: FLOODS, HEAT, WATER AND SANITATION
|   DEFINITION / TERMS : The exact local mechanism differs, but the catchment principle is common.
|   MECHANISM / ARGUMENT: Exposure combines with housing quality, occupation, age, health and access to cooling, so the same temperature produces unequal harm.
|   CONSEQUENCE / CONTRAST: The exact local mechanism differs, but the catchment principle is common.
|   TRAP / ANSWER-USE: Dark surfaces store heat, reduced vegetation limits evaporative cooling, built geometry traps radiation and human activity adds waste heat.
|   EXAM OPENING: Urban ecology is infrastructure: wetlands store water, vegetation cools and water bodies support drainage, recharge and habitat.
+--
        |
        v
+-- SESSION 15: INDIA'S URBAN PROBLEM SET: GOVERNANCE FRAGMENTATION
|   DEFINITION / TERMS : Use governance fragmentation as the underlying mechanism connecting sprawl, flooding, service stress and weak maintenance.
|   MECHANISM / ARGUMENT: Use governance fragmentation as the underlying mechanism connecting sprawl, flooding, service stress and weak maintenance.
|   CONSEQUENCE / CONTRAST: Floodwater, air pollution, commuters and waste do not stop at a municipal border.
|   TRAP / ANSWER-USE: the built-up or commuting region crosses municipal boundaries; several parastatal agencies control water, transport, housing or development; local bodies lack adequate functions, staff or finance; and peri-urban land remains under rural authorities despite urban pressures.
|   EXAM OPENING: The problem is not only knowledge; it is the mismatch between the functional city and the governed city.
+--
        |
        v
+-- SESSION 16: BASIC MASTERY RECAP
|   DEFINITION / TERMS : Urban problems emerge when land use, services and government no longer match the functional city.
|   MECHANISM / ARGUMENT: Urban problems emerge when land use, services and government no longer match the functional city.
|   CONSEQUENCE / CONTRAST: Basic verdict: settlement geography moves from the ground under a habitation to the regional network that sustains it.
|   TRAP / ANSWER-USE: Basic verdict: settlement geography moves from the ground under a habitation to the regional network that sustains it.
|   EXAM OPENING: Basic verdict: settlement geography moves from the ground under a habitation to the regional network that sustains it.
+--
        |
        v
