---
title: "Geography 02 — The Earth’s Crust, Rocks / India Geological Structure — Learner-v2 Refreshed"
topic_key: geography-02
cover_image: assets/geography-02_Teaching-Navigation_2026-08-23.png
variant: "learner-v2"
generation: 2
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Geography\basic\02_The-Earths-Crust-Rocks.md`  
**Canonical topic owner:** `upsc-ai-kit\knowledge\Geography\basic\02_The-Earths-Crust-Rocks.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Geography\advanced\02_India-Geological-Structure.md`  
...
- **Current-status note, rechecked 2026-09-01:** NCMM remains a Cabinet-approved whole-value-chain mission dated 29 January 2025; GSI’s 2 April 2026 release confirms continued critical-resource assessment and a 2026–27 field roadmap. BIS public material retains Zones II–V. Mission objectives are not treated as proof of a deposit or reserve.

**Live/official context sources recorded by the predecessor generation:**

- `Cabinet/PIB, Ministry of Mines — National Critical Mineral Mission approval, 29 January 2025 (checked through 2026-08-22)`
- `Geological Survey of India/PIB — Field Season 2025–26 conclusion and FS 2026–27 roadmap, 2 April 2026`
- `Bureau of Indian Standards — public earthquake-resistance/seismic-zone material retaining Zones II, III, IV and V (checked 2026-08-22)`



![Refreshed teaching navigation](assets/geography-02_Teaching-Navigation_2026-08-23.png)
...
![Master two-half roadmap](assets/01_master-roadmap.png)
...
- **Majid Husain, Geography of India, PDF pages 9–23:** recovered the geological-structure rationale, Archaean–Dharwar–Cuddapah–Vindhyan–Gondwana–Deccan sequence, Himalayan evolution and Quaternary plain context.
...
```text
MASTER VOCABULARY: WHAT EXACTLY ARE WE STUDYING?
...
**How to use them:** Frame the answer through Master Vocabulary; define Mineral, connect Rock with Lithology to explain the mechanism, and use Petrology for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Scope terms](assets/02_scope-terms.png)
...
CONSEQUENCE / CONTRAST: Structure → process → surface: lithology, bedding, joints, faults and tectonic setting create a template; weathering, rivers, glaciers, waves and human use modify it.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: a rock aggregate is therefore not “a mineral”.
        |
        v
...
```text
CRUST AND LITHOSPHERE: RELATED, NOT IDENTICAL
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**How to use them:** Frame the answer through Crust; define Lithosphere, connect Related with Not Identical to explain the mechanism, and use Asthenosphere for the decisive comparison or qualification.

**Classification: CORE PRELIMS + SUPPORTING MAINS**

![Crust and lithosphere](assets/03_crust-lithosphere.png)
...
```text
THE COMPLETE ROCK CYCLE: A NETWORK, NOT A CONVEYOR BELT
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**How to use them:** Frame the answer through The Complete Rock Cycle; define A Network, connect Not A Conveyor Belt with Lithification to explain the mechanism, and use Metamorphism for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Complete rock cycle](assets/04_complete-rock-cycle.png)

```text
MELTING
   ↓
MAGMA/LAVA ── cooling and crystallisation ──> IGNEOUS ROCK
   ↑                                              │
   │                                              ├─ weathering, erosion, transport
   │                                              ↓
   └─ deep burial / melting <─ METAMORPHIC <─ SEDIMENTARY
                                  ↑                ↑
...
CONSEQUENCE / CONTRAST: “Igneous → sedimentary → metamorphic” is one teaching path, not the only path.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: metamorphism normally occurs without complete melting.
        |
        v
...
```text
IGNEOUS ROCKS: COOLING HISTORY, COMPOSITION AND TEXTURE
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Plain-language definition:** “Primary rock” is an older genetic phrase for igneous rock because crystallisation creates the original mineral framework.

**Technical definition:** Porphyritic means large crystals embedded in a finer groundmass, showing two-stage cooling.
...
**How to use them:** Frame the answer through Igneous Rocks; define Cooling History, connect Composition with Texture to explain the mechanism, and use Felsic for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Igneous texture and composition tree](assets/05_igneous-tree.png)
...
```text
SEDIMENTARY ROCKS: SEDIMENT PATHWAY AND FIELD CLUES
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Plain-language definition:** They are sediments/deposits unless lithification into rock is demonstrated.

**Technical definition:** Conglomerate has rounded gravel clasts; sandstone is sand-sized; shale is fine mud-rich rock.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> They are sediments/deposits unless lithification into rock is demonstrated.
...
**How to use them:** Frame the answer through Sedimentary Rocks; define Sediment Pathway, connect Field Clues with Bedding/stratification to explain the mechanism, and use Loess for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Sedimentary formation](assets/06_sedimentary-process.png)
...
EXACT TERMS: Sedimentary Rocks · Sediment Pathway · Field Clues · Bedding/stratification · Loess · moraine
        |
        v
MECHANISM / ARGUMENT: Conglomerate has rounded gravel clasts; sandstone is sand-sized; shale is fine mud-rich rock.
        |
        v
CONSEQUENCE / CONTRAST: Limestone has several origins; do not call every limestone exclusively organic or chemical.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: fossils, ripple marks, mud cracks and cross-bedding can reveal environment, current direction, drying or...
        |
        v
ANSWER-GRABBING FORMULATION: They are sediments/deposits unless lithification into rock is demonstrated.
```
...
```text
METAMORPHIC ROCKS: PROTOLITH, GRADE AND FABRIC
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Plain-language definition:** Protolith means the parent rock before metamorphism.
...
**How to use them:** Frame the answer through Metamorphic Rocks; define Protolith, connect Grade with Fabric to explain the mechanism, and use differential stress for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Metamorphic grade and fabric](assets/07_metamorphic-path.png)
...
MECHANISM / ARGUMENT: Metamorphic grade means intensity of temperature–pressure conditions.
        |
        v
CONSEQUENCE / CONTRAST: Exam-safe paths: shale/mudstone → slate → phyllite → schist → gneiss is a common increasing-grade teaching sequence, not a universal compulsory path.
        |
        v
UPSC TRAP / ANSWER-USE: Graphite may form from carbon-rich material, but “coal → graphite” is not a universal one-step rule.
        |
        v
ANSWER-GRABBING FORMULATION: Protolith means the parent rock before metamorphism.
```
...
**Plain-language definition:** Rock name alone never determines land use: porosity, permeability, fractures, weathering, structure and site conditions jointly control groundwater, soils, foundations, dams and slope behaviour.

**Technical definition:** Crystalline igneous and metamorphic rocks commonly have low primary pore space but can store groundwater in weathered zones, joints and fractures.
...
**How to use them:** Frame the answer through Rock Properties; define Applied Geography, connect Porosity with amount of void space to explain the mechanism, and use voids may be disconnected for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Rock properties and applications](assets/08_properties-applications.png)
...
```text
CONTINENTAL DRIFT: WEGENER’S EVIDENCE AND LIMITATION
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Plain-language definition:** Continental Drift: Wegener’S Evidence And Limitation comprises Continental Drift, Wegener’S Evidence and Limitation as its core connected dimensions.

**Technical definition:** Technically, Continental Drift: Wegener’S Evidence And Limitation is analysed by relating Continental Drift to Wegener’S Evidence, then testing the relationship through Limitation and Pangaea.
...
**How to use them:** Frame the answer through Continental Drift; define Wegener’S Evidence, connect Limitation with Pangaea to explain the mechanism, and use Laurasia for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Drift evidence](assets/09_drift-evidence.png)
...
CONSEQUENCE / CONTRAST: His evidence was powerful, but proposed driving forces were inadequate.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: gondwana here means a southern palaeocontinent.
        |
        v
...
```text
SEA-FLOOR SPREADING: OCEANIC EVIDENCE AND MASS BALANCE
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Plain-language definition:** Sea-floor spreading creates young oceanic crust at mid-ocean ridges, records symmetrical magnetic stripes and balances creation by consuming older lithosphere at trenches, so the Earth does not expand.

**Technical definition:** Ocean floor is geologically young relative to continental shields because it is recycled.
...
**How to use them:** Frame the answer through Sea-Floor Spreading; define Oceanic Evidence, connect Mass Balance with Magnetic to explain the mechanism, and use Ocean floor for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Sea-floor spreading](assets/10_seafloor-spreading.png)

```text
UPWELLING AT MID-OCEAN RIDGE
        ↓
MAGMA SOLIDIFIES AS NEW OCEANIC CRUST
        ↓ records magnetic polarity
...
CONSEQUENCE / CONTRAST: The Earth does not expand; ridge creation is balanced by trench destruction.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: magnetic reversals create matching stripe patterns on both ridge flanks.
        |
        v
...
```text
PLATE TECTONICS: BOUNDARY MATRIX AND LANDFORM DIAGNOSIS
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**How to use them:** Frame the answer through Plate Tectonics; define Boundary Matrix, connect Landform Diagnosis with Divergent to explain the mechanism, and use plates separate for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Plate-boundary matrix](assets/10b_plate-boundaries.png)
...
CONSEQUENCE / CONTRAST: Andes and Himalaya are both mountains but arise from different convergence types.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: plate boundaries are diagnosed by motion and products.
        |
        v
...
```text
OCEAN-BASIN EVOLUTION: WILSON-CYCLE ANALOGY
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Plain-language definition:** A basin can stall, reorganise or avoid the ideal sequence; the examples are analogies, not timestamps.

**Technical definition:** The Wilson cycle is an analogy for rifting, ocean opening, subduction, closure and suturing, not a fixed destiny that every ocean basin must complete.
...
**How to use them:** Frame the answer through Ocean-Basin Evolution; define Wilson-Cycle Analogy, connect Embryonic with continental doming and rifting to explain the mechanism, and use East African Rift for the decisive comparison or qualification.

**Classification: CORE MAINS + SUPPORTING PRELIMS**

![Wilson-cycle analogy](assets/11_wilson-cycle.png)
...
EXACT TERMS: Ocean-Basin Evolution · Wilson-Cycle Analogy · Embryonic · continental doming and rifting · East African Rift · Juvenile
        |
        v
MECHANISM / ARGUMENT: A basin can stall, reorganise or avoid the ideal sequence; the examples are analogies, not timestamps.
        |
        v
CONSEQUENCE / CONTRAST: Passive margins can accumulate thick sediment wedges and host offshore petroleum systems.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: a basin can stall, reorganise or avoid the ideal sequence.
        |
        v
...
**Technical definition:** Orogeny means mountain building through convergence, folding, thrusting, metamorphism, crustal thickening and uplift.
...
**How to use them:** Frame the answer through Isostasy; define Orogeny, connect Airy concept with Pratt concept to explain the mechanism, and use Post-glacial for the decisive comparison or qualification.

**Classification: CORE MAINS + SUPPORTING PRELIMS**

![Isostasy and orogeny](assets/11b_isostasy-orogeny.png)
...
CONSEQUENCE / CONTRAST: Erosion removes mass, exposes deeper rocks and can produce isostatic response; high relief is therefore dynamic, not a one-time construction.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: isostasy means buoyant vertical equilibrium between crust/lithosphere and denser material beneath.
        |
        v
...
```text
WORLD-TO-INDIA TRANSITION: STRUCTURE EXPRESSED AS RELIEF
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Plain-language definition:** Structure controls broad relief and resource opportunity, while climate, weathering, rivers and human use modify it.

**Technical definition:** At the highest school-geography scale, India’s six broad physiographic divisions are the Himalaya/Northern Mountains, Northern Plain, Peninsular Plateau, Indian Desert, Coastal Plains and Islands.
...
**How to use them:** Frame the answer through World-To-India Transition; define Structure Expressed As Relief, connect six broad physiographic divisions with Himalaya to explain the mechanism, and use continent collision, shortening and uplift for the decisive comparison or qualification.
...
CONSEQUENCE / CONTRAST: They are used here only as structural expressions, not as substitutes for the later detailed physiography owners.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: structure controls broad relief and resource opportunity.
        |
        v
...
```text
SCOPE: GEOLOGICAL STRUCTURE VERSUS PHYSIOGRAPHY AND GEOMORPHOLOGY
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Technical definition:** Technically, Scope: Geological Structure Versus Physiography And Geomorphology is analysed by relating Scope to Geological Structure Versus Physiography, then testing the relationship through Geomorphology and Cross-link.
...
**How to use them:** Frame the answer through Scope; define Geological Structure Versus Physiography, connect Geomorphology with Cross-link to explain the mechanism, and use Geology for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Three-province national skeleton](assets/14_three-province-cross-section.png)
...
START / CONCEPT: SCOPE: GEOLOGICAL STRUCTURE VERSUS PHYSIOGRAPHY AND GEOMORPHOLOGY
        |
        v
EXACT TERMS: Scope · Geological Structure Versus Physiography · Geomorphology · Cross-link · Geology · rock age, type, structure and tectonic history
        |
        v
...
```text
GEOLOGICAL TIME, EVIDENCE AND DATING CAUTIONS
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Technical definition:** Numerical boundaries and formation ages are revised as dating improves.
...
**How to use them:** Frame the answer through Geological Time; define Dating Cautions, connect Cross-link with Lithology/structure to explain the mechanism, and use rock character and relations for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Geological evidence ladder](assets/12_geological-evidence-ladder.png)
...
```text
INDIAN PLATE: GONDWANA ORIGIN, BREAK-UP, DRIFT AND COLLISION
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Technical definition:** India is both an ancient continental fragment and part of an active plate system: this explains the contrast between old shield rocks and young Himalayan tectonic architecture.
...
**How to use them:** Frame the answer through Indian Plate; define Gondwana Origin, connect Break-Up with Drift to explain the mechanism, and use Collision for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Indian plate journey](assets/13_indian-plate-journey.png)
...
EXACT TERMS: Indian Plate · Gondwana Origin · Break-Up · Drift · Collision · Cross-link
        |
        v
MECHANISM / ARGUMENT: Rifting separated blocks, oceanic crust formed between them, and the Indian plate moved northward before colliding progressively with Eurasia.
        |
        v
CONSEQUENCE / CONTRAST: Collision was not a single instant across the whole margin.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: india is both an ancient continental fragment and part of an active plate system.
        |
        v
...
```text
CRATONS, SHIELDS AND THE STABILISED PENINSULAR BLOCK
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**How to use them:** Frame the answer through Cratons; define Shields, connect The Stabilised Peninsular Block with Cross-link to explain the mechanism, and use Dharwar for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Peninsular cratons and mobile belts](assets/15_craton-mobile-belt-map.png)
...
CONSEQUENCE / CONTRAST: Metallic-mineral provinces are strongly associated with ancient shield geology, but ore localisation requires specific magmatic, hydrothermal, sedimentary or metamorphic processes.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: commonly recognised shield blocks include Dharwar in the south, Bastar in central India, Singhbhum...
        |
        v
...
```
### SESSION 18 — ARCHAEAN AND DHARWAR SYSTEMS: DISTRIBUTION AND TERMINOLOGY CONTROL

#### VISUAL FIRST

```text
ARCHAEAN AND DHARWAR SYSTEMS: DISTRIBUTION AND TERMINOLOGY CONTROL
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Plain-language definition:** Archaean And Dharwar Systems: Distribution And Terminology Control comprises Archaean, Dharwar Systems and Distribution as its core connected dimensions.
...
**How to use them:** Frame the answer through Archaean; define Dharwar Systems, connect Distribution with Terminology Control to explain the mechanism, and use Cross-link for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Archaean and Dharwar sequence](assets/16_archaean-purana-sequence.png)
...
#### CLOSING RECALL FLOW — ARCHAEAN AND DHARWAR SYSTEMS: DISTRIBUTION AND TERMINOLOGY CONTROL

```text
START / CONCEPT: ARCHAEAN AND DHARWAR SYSTEMS: DISTRIBUTION AND TERMINOLOGY CONTROL
        |
        v
...
```text
PROTEROZOIC PURANA BASINS: CUDDAPAH AND VINDHYAN
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Technical definition:** Cuddapah and Vindhyan are major Proterozoic sedimentary basin successions resting unconformably on older basement.
...
**How to use them:** Frame the answer through Proterozoic Purana Basins; define Cuddapah, connect Vindhyan with Cross-link to explain the mechanism, and use quartzite, shale, limestone, sandstone; local intrusions for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Purana basin sequence](assets/16_archaean-purana-sequence.png)
...
```text
GONDWANA SUPERGROUP: RIFT BASINS, COAL AND CONTINENTAL SEDIMENTATION
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Technical definition:** Coal linkage is mechanistic: vegetation accumulation in suitable low-oxygen settings, burial during basin subsidence, compaction and coalification, followed by preservation from erosion.
...
**How to use them:** Frame the answer through Gondwana Supergroup; define Rift Basins, connect Coal with Continental Sedimentation to explain the mechanism, and use Cross-link for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Gondwana rift basins](assets/17_gondwana-basins.png)
...
```text
MARINE SEDIMENTARY BASINS, COASTS AND OFFSHORE PETROLEUM LOGIC
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Plain-language definition:** Names are map anchors; resource status must come from current official basin data.

**Technical definition:** Offshore occurrence is therefore geological, not simply because an area is under the sea.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Do not claim every named basin is equally productive or that all offshore oil is young.
...
**How to use them:** Frame the answer through Marine Sedimentary Basins; define Coasts, connect Offshore Petroleum Logic with Cross-link to explain the mechanism, and use Rift/onshore basin for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Petroleum-system logic](assets/18_petroleum-system.png)
...
MECHANISM / ARGUMENT: Mains use: Explain offshore concentration through basin evolution, not a memorised field list.
        |
        v
CONSEQUENCE / CONTRAST: Offshore occurrence is therefore geological, not simply because an area is under the sea.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: coastal and offshore sedimentary basins include Cambay, Mumbai Offshore, Assam-Arakan, Krishna-Godavari, Cauvery and other...
        |
        v
ANSWER-GRABBING FORMULATION: Do not claim every named basin is equally productive or that all offshore oil is young.
```
...
```text
DECCAN TRAP: FLOOD-BASALT PROVINCE AND BOUNDED SURFACE LINKAGES
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**How to use them:** Frame the answer through Deccan Trap; define Flood-Basalt Province, connect Bounded Surface Linkages with Cross-link to explain the mechanism, and use Step relief for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Deccan Trap cross-section](assets/19_deccan-trap-section.png)
...
CONSEQUENCE / CONTRAST: Deccan Trap is a volcanic province, not a soil type.
        |
        v
UPSC TRAP / ANSWER-USE: Black soil linkage is strong but not monocausal.
        |
        v
...
```text
HIMALAYA: FROM GEOSYNCLINAL LANGUAGE TO MODERN PLATE TECTONICS
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Technical definition:** The Himalaya is a continent-collision fold-thrust orogen containing sedimentary, metamorphic and crystalline belts; unlike the Andes, it is not primarily a volcanic subduction arc.
...
**How to use them:** Frame the answer through Himalaya; define From Geosynclinal Language To Modern Plate Tectonics, connect Cross-link with Siwalik/Sub-Himalaya to explain the mechanism, and use young foreland molasse, folded foothills for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Himalayan structural order](assets/20_himalayan-thrust-section.png)
...
START / CONCEPT: HIMALAYA: FROM GEOSYNCLINAL LANGUAGE TO MODERN PLATE TECTONICS
        |
        v
EXACT TERMS: Himalaya · From Geosynclinal Language To Modern Plate Tectonics · Cross-link · Siwalik/Sub-Himalaya · young foreland molasse, folded foothills · HFT/MFT at front; MBT to north
        |
        v
...
CONSEQUENCE / CONTRAST: Mains use: Contrast the historical geosynclinal description with the modern plate-tectonic mechanism; then draw a labelled cross-section.
        |
        v
UPSC TRAP / ANSWER-USE: The Himalaya is not one simple fold.
        |
        v
...
```text
INDO-GANGA-BRAHMAPUTRA FORELAND BASIN AND ALLUVIAL FILL
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Technical definition:** Technically, Indo-Ganga-Brahmaputra Foreland Basin And Alluvial Fill is analysed by relating Indo-Ganga-Brahmaputra Foreland Basin to Alluvial Fill, then testing the relationship through Cross-link and Flexural subsidence.
...
**How to use them:** Frame the answer through Indo-Ganga-Brahmaputra Foreland Basin; define Alluvial Fill, connect Cross-link with Flexural subsidence to explain the mechanism, and use foredeep/accommodation space for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Foreland basin](assets/21_foreland-plain.png)
...
```text
COASTS, OFFSHORE BASINS AND ISLAND-ARC VERSUS CORAL-ISLAND DISTINCTION
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Technical definition:** Western India includes the Cambay rift and faulted margin sectors; parts of the west coast show submergent features.
...
**How to use them:** Frame the answer through Coasts; define Offshore Basins, connect Island-Arc Versus Coral-Island Distinction with Cross-link to explain the mechanism, and use Andaman-Nicobar for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Coasts and islands](assets/22_coasts-islands.png)
...
CONSEQUENCE / CONTRAST: The island chain also includes sedimentary and uplifted components; it is not simply a row of volcanic cones.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: western India includes the Cambay rift and faulted margin sectors.
        |
        v
...
```text
MAJOR LINEAMENTS, FAULTS AND RIFTS
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Plain-language definition:** A rift is an extensional crustal zone, a graben is a down-dropped fault block, and a lineament is a mapped linear feature that is not automatically an active fault.

**Technical definition:** A lineament mapped from imagery is not automatically a proven active fault.
...
**How to use them:** Frame the answer through Major Lineaments; define Faults, connect Rifts with Cross-link to explain the mechanism, and use Narmada-Son for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Faults and rifts](assets/23_faults-rifts-lineaments.png)
...
CONSEQUENCE / CONTRAST: A lineament mapped from imagery is not automatically a proven active fault.
        |
        v
UPSC TRAP / ANSWER-USE: Lineament does not automatically mean active fault.
        |
        v
...
```text
STRUCTURAL CONTROL OF RELIEF, DRAINAGE, GROUNDWATER AND WATERFALLS
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Technical definition:** In hard-rock terrain groundwater is concentrated in weathered zones, fractures and contacts.
...
**How to use them:** Frame the answer through Structural Control Of Relief; define Drainage, connect Groundwater with Waterfalls to explain the mechanism, and use Cross-link for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Structure and surface applications](assets/24_structure-applications.png)
...
```text
GEOLOGY, MINERALS, COAL AND PETROLEUM: ASSOCIATION WITHOUT DETERMINISM
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Plain-language definition:** Coal is concentrated in Gondwana structural basins; younger coal also occurs in parts of the north-east.

**Technical definition:** Coal follows basin history; petroleum follows petroleum-system completeness.
...
**How to use them:** Frame the answer through Geology; define Minerals, connect Coal with Petroleum to explain the mechanism, and use Association Without Determinism for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Geology and resources](assets/24_structure-applications.png)
...
```text
SEISMICITY: HIMALAYA, KACHCHH AND PENINSULAR INTRAPLATE EVENTS
INITIAL CONDITION / DRIVER
        ↓
PHYSICAL MECHANISM OR CIRCULATION
        ↓
...
**Technical definition:** Andaman-Nicobar seismicity is linked to the Sunda-Andaman subduction system and includes tsunami-generating megathrust potential.
...
**How to use them:** Frame the answer through Seismicity; define Himalaya, connect Kachchh with Peninsular Intraplate Events to explain the mechanism, and use Cross-link for the decisive comparison or qualification.

**Classification: CORE PRELIMS + CORE MAINS**

![Bounded seismic application](assets/24_structure-applications.png)
...
![Regional comparison and answer architecture](assets/25_regional-ncmm-answer-spine.png)
...
![NCMM bounded anchor and answer spine](assets/25_regional-ncmm-answer-spine.png)
...
MECHANISM / ARGUMENT: India's seismicity reflects active plate-boundary deformation in the Himalaya and north-east, subduction near Andaman-Nicobar, and intraplate reactivation in Kachchh and parts of the Peninsula.
        |
        v
CONSEQUENCE / CONTRAST: Kachchh is an intraplate high-hazard region with inherited rift faults and damaging historical earthquakes, including the 2001 Bhuj event.
        |
        v
UPSC TRAP / ANSWER-USE: Mains use: Explain source, path/site effect and vulnerability separately; do not equate tectonic activity with disaster magnitude.
        |
        v
...
- **Must remember:** Crustal analysis connects seismic evidence, compositional and rheological layers, rock cycle, plate boundaries and Wilson-cycle logic to India's cratons, mobile belts, Gondwana basins, Deccan volcanics, Himalaya and Indo-Gangetic foredeep.
- **Close distinction:** Crust is compositional while lithosphere is mechanical; continental crust is generally granitic and less dense, oceanic crust basaltic and denser, and a shield, craton, platform, basin and plate are not interchangeable map units.
- **Evidence / causal limit:** Present relief is a multi-stage tectonic-denudational product; rock age, orogeny, mineralisation and surface form need not coincide, so geological association supports probability rather than deterministic resource claims.
...
- A. It proves every coal seam metamorphosed.
- B. It is always igneous.
...
- A. All basalt aquifers are identical.
- B. Climate is irrelevant.
- C. Every dark rock makes black soil.
...
- A. absence of continental fit.
- B. an inadequate physical mechanism.
- C. lack of fossil evidence.
- D. denial of Pangaea.
...
- A. Several evidence types should be combined.
...
- C. only density variation with no roots.
...
- B. Himalaya→passive margin→mid-ocean ridge
...
- D. Lakshadweep—active subduction arc
...
- A. Every Gondwana layer has coal.
- B. Every basin contains oil.
- C. Every shield is an ore body.
...
- B. Structure concerns climate zones.
...
- A. Oceanic crust never ages.
- B. Magnetic stripes are unrelated.
- C. Ridges destroy continents.
...
**Explanation:** Kachchh, Koyna and Latur disprove the aseismic-peninsula shortcut.
...
[CLAIM] Primary rocks are igneous rocks formed when magma or lava cools and crystallises, providing much of the original mineral material later reworked into sedimentary and metamorphic rocks. [EVIDENCE] Intrusive or plutonic rocks such as granite, diorite and gabbro cool slowly below the surface and commonly develop coarse crystals. [ANALYSIS] Insulation delays heat loss, allowing crystal growth; later uplift and denudation expose them. [EVIDENCE] Extrusive rocks such as rhyolite, andesite and basalt cool rapidly at or near the surface and are commonly fine-grained; very rapid cooling can produce glass, while gas escape produces vesicles and explosive fragmentation produces pyroclastic rocks. [EVIDENCE] Composition ranges from felsic to mafic and helps explain colour, density, viscosity and weathering. India’s Deccan flood basalts and Peninsular granitic terrains illustrate the two modes. [LIMIT] “Primary” is genetic, not a claim that every igneous exposure is the oldest or most valuable. [VERDICT] Mode of occurrence, cooling texture and composition together provide the complete classification.
...
**Demand decoding:** The directive **answer** requires a direct position on ““In how many of the above rows is the given information correctly matched?” A. Only one · B.…”, all clauses and scales, a process chain, spatial reconstruction, named India/world evidence, a counter-condition and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the physical-geography demand in ““In how many of the above rows is the given information correctly matched?” A. Only one · B. Only two · C. Only three · D. All four.”.

**Analytical body:**

1. **Claim and named evidence:** Audited PYQ ledger: nine genuinely relevant or adjacent routes **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
2. **Claim and named evidence:** 1 2022 GS-I Q4 Primary rocks Direct; exact local official paper; UPSC publishes no model answer **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
3. **Claim and named evidence:** 2 2025 GS-I Q16 Continents/ocean basins Direct; exact local official paper; independent model **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
4. **Claim and named evidence:** 3 2024 Prelims Q10 Fold/block mountains Direct; local official Set-A paper and key B **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
5. **Claim and named evidence:** 4 2025 Prelims Q25 Drift evidence Direct; local official Set-A paper and key C **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
...
**Qualified conclusion:** The answer must resolve the physical-geography demand in ““In how many of the above rows is the given information correctly matched?” A. Only one · B. Only two · C. Only three · D. All four.”.
...
**How to improve this answer:** For ““In how many of the above rows is the given information correctly matched?” A. Only one · B.…”, replace the weakest generalisation with one labelled process arrow or map anchor and state the scale, exception or evidence needed before extending the conclusion.
...
**Demand decoding:** The directive **explain** requires a direct position on “Original 10-marker 1 — “The rock cycle is a network, not a one-way sequence.” Explain with…”, all clauses and scales, a process chain, spatial reconstruction, named India/world evidence, a counter-condition and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the physical-geography demand in “Original 10-marker 1 — “The rock cycle is a network, not a one-way sequence.” Explain with geographical implications.”.

**Analytical body:**

1. **Claim and named evidence:** Original 10-marker 1 — “The rock cycle is a network, not a one-way sequence.” Explain with geographical implications. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
2. **Claim and named evidence:** Why this earns marks: It explains pathways, uses Indian evidence, makes a geographic link and avoids the linear-cycle trap. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.

**Counter-position / limit:** A spatial association, one event, one model or one map layer does not establish a sufficient or timeless cause; test energy, material, structure, circulation, scale and human mediation.

**Qualified conclusion:** The answer must resolve the physical-geography demand in “Original 10-marker 1 — “The rock cycle is a network, not a one-way sequence.” Explain with geographical implications.”.

**Executable exam-length answer / compression plan:** For a 15-mark answer, spend about one-sixth of the time decoding and drawing the map/flow; open with definition and thesis; organise five process-spatial points as claim → named evidence → analysis → qualification; compress examples before mechanisms and reserve the final minute for the causal limit.

**How to improve this answer:** For “Original 10-marker 1 — “The rock cycle is a network, not a one-way sequence.” Explain with…”, replace the weakest generalisation with one labelled process arrow or map anchor and state the scale, exception or evidence needed before extending the conclusion.
...
**Demand decoding:** The directive **answer** requires a direct position on “Original 10-marker 2 — Distinguish India’s geological structure from its physiographic…”, all clauses and scales, a process chain, spatial reconstruction, named India/world evidence, a counter-condition and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the physical-geography demand in “Original 10-marker 2 — Distinguish India’s geological structure from its physiographic divisions. Illustrate with two regions.”.

**Analytical body:**

1. **Claim and named evidence:** Original 10-marker 2 — Distinguish India’s geological structure from its physiographic divisions. Illustrate with two regions. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
2. **Claim and named evidence:** Why this earns marks: It defines both terms, uses two regions, explains mechanisms and qualifies determinism. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.

**Counter-position / limit:** A spatial association, one event, one model or one map layer does not establish a sufficient or timeless cause; test energy, material, structure, circulation, scale and human mediation.

**Qualified conclusion:** The answer must resolve the physical-geography demand in “Original 10-marker 2 — Distinguish India’s geological structure from its physiographic divisions. Illustrate with two regions.”.

**Executable exam-length answer / compression plan:** For a 15-mark answer, spend about one-sixth of the time decoding and drawing the map/flow; open with definition and thesis; organise five process-spatial points as claim → named evidence → analysis → qualification; compress examples before mechanisms and reserve the final minute for the causal limit.

**How to improve this answer:** For “Original 10-marker 2 — Distinguish India’s geological structure from its physiographic…”, replace the weakest generalisation with one labelled process arrow or map anchor and state the scale, exception or evidence needed before extending the conclusion.
...
**Demand decoding:** The directive **analyse** requires a direct position on “Original 15-marker 1 — Analyse how rock properties control groundwater and engineering…”, all clauses and scales, a process chain, spatial reconstruction, named India/world evidence, a counter-condition and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the physical-geography demand in “Original 15-marker 1 — Analyse how rock properties control groundwater and engineering suitability.”.

**Analytical body:**

1. **Claim and named evidence:** Original 15-marker 1 — Analyse how rock properties control groundwater and engineering suitability. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
2. **Claim and named evidence:** Why this earns marks: It covers aquifers and engineering, gives three named settings, explains mechanism and ends with investigation discipline. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.

**Counter-position / limit:** A spatial association, one event, one model or one map layer does not establish a sufficient or timeless cause; test energy, material, structure, circulation, scale and human mediation.

**Qualified conclusion:** The answer must resolve the physical-geography demand in “Original 15-marker 1 — Analyse how rock properties control groundwater and engineering suitability.”.

**Executable exam-length answer / compression plan:** For a 15-mark answer, spend about one-sixth of the time decoding and drawing the map/flow; open with definition and thesis; organise five process-spatial points as claim → named evidence → analysis → qualification; compress examples before mechanisms and reserve the final minute for the causal limit.

**How to improve this answer:** For “Original 15-marker 1 — Analyse how rock properties control groundwater and engineering…”, replace the weakest generalisation with one labelled process arrow or map anchor and state the scale, exception or evidence needed before extending the conclusion.
...
**Demand decoding:** The directive **explain** requires a direct position on “Original 15-marker 2 — Explain how Peninsular evolution controls metallic minerals, coal and…”, all clauses and scales, a process chain, spatial reconstruction, named India/world evidence, a counter-condition and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the physical-geography demand in “Original 15-marker 2 — Explain how Peninsular evolution controls metallic minerals, coal and groundwater.”.

**Analytical body:**

1. **Claim and named evidence:** Original 15-marker 2 — Explain how Peninsular evolution controls metallic minerals, coal and groundwater. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
2. **Claim and named evidence:** Why this earns marks: All three demands receive named regions, distinct mechanisms and an economic-hydrological qualification. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.

**Counter-position / limit:** A spatial association, one event, one model or one map layer does not establish a sufficient or timeless cause; test energy, material, structure, circulation, scale and human mediation.

**Qualified conclusion:** The answer must resolve the physical-geography demand in “Original 15-marker 2 — Explain how Peninsular evolution controls metallic minerals, coal and groundwater.”.

**Executable exam-length answer / compression plan:** For a 15-mark answer, spend about one-sixth of the time decoding and drawing the map/flow; open with definition and thesis; organise five process-spatial points as claim → named evidence → analysis → qualification; compress examples before mechanisms and reserve the final minute for the causal limit.

**How to improve this answer:** For “Original 15-marker 2 — Explain how Peninsular evolution controls metallic minerals, coal and…”, replace the weakest generalisation with one labelled process arrow or map anchor and state the scale, exception or evidence needed before extending the conclusion.
...
**Demand decoding:** The directive **trace** requires a direct position on “Original 20-marker 1 — Trace the tectonic cycle from continental rifting to collision and…”, all clauses and scales, a process chain, spatial reconstruction, named India/world evidence, a counter-condition and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the physical-geography demand in “Original 20-marker 1 — Trace the tectonic cycle from continental rifting to collision and assess its relevance to India.”.

**Analytical body:**

1. **Claim and named evidence:** Original 20-marker 1 — Trace the tectonic cycle from continental rifting to collision and assess its relevance to India. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
2. **Claim and named evidence:** Why this earns marks: It traces the full mechanism, identifies evidence, applies it to India and delivers resource, relief and hazard significance with qualification. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.

**Counter-position / limit:** A spatial association, one event, one model or one map layer does not establish a sufficient or timeless cause; test energy, material, structure, circulation, scale and human mediation.

**Qualified conclusion:** The answer must resolve the physical-geography demand in “Original 20-marker 1 — Trace the tectonic cycle from continental rifting to collision and assess its relevance to India.”.

**Executable exam-length answer / compression plan:** For a 15-mark answer, spend about one-sixth of the time decoding and drawing the map/flow; open with definition and thesis; organise five process-spatial points as claim → named evidence → analysis → qualification; compress examples before mechanisms and reserve the final minute for the causal limit.

**How to improve this answer:** For “Original 20-marker 1 — Trace the tectonic cycle from continental rifting to collision and…”, replace the weakest generalisation with one labelled process arrow or map anchor and state the scale, exception or evidence needed before extending the conclusion.
...
**Demand decoding:** The directive **analyse** requires a direct position on “Original 20-marker 2 — “India’s geological stability is relative, spatially uneven and…”, all clauses and scales, a process chain, spatial reconstruction, named India/world evidence, a counter-condition and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the physical-geography demand in “Original 20-marker 2 — “India’s geological stability is relative, spatially uneven and socially consequential.” Analyse.”.

**Analytical body:**

1. **Claim and named evidence:** Original 20-marker 2 — “India’s geological stability is relative, spatially uneven and socially consequential.” Analyse. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
2. **Claim and named evidence:** Why this earns marks: It interprets every word of the quotation, compares four settings, links process to society/resources and ends with a qualified planning verdict. **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
3. **Claim and named evidence:** Practice route Non-negotiable opening Visual/structure to reproduce Qualification that prevents overclaim **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
4. **Claim and named evidence:** 10-marker: rock cycle network of multiple pathways compact cycle with uplift/exposure return climate, structure and time modify outcomes **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.
5. **Claim and named evidence:** 10-marker: geology versus physiography define both terms before comparison Peninsula and foreland examples surface form is modified, not mechanically predetermined **Analysis:** Trace the driver → mechanism → spatial expression → consequence chain and connect the named place, map or observation to the directive. **Qualification:** State the scale, threshold, interacting control, exception or source/date boundary.

**Counter-position / limit:** A spatial association, one event, one model or one map layer does not establish a sufficient or timeless cause; test energy, material, structure, circulation, scale and human mediation.

**Qualified conclusion:** The answer must resolve the physical-geography demand in “Original 20-marker 2 — “India’s geological stability is relative, spatially uneven and socially consequential.” Analyse.”.

**Executable exam-length answer / compression plan:** For a 15-mark answer, spend about one-sixth of the time decoding and drawing the map/flow; open with definition and thesis; organise five process-spatial points as claim → named evidence → analysis → qualification; compress examples before mechanisms and reserve the final minute for the causal limit.

**How to improve this answer:** For “Original 20-marker 2 — “India’s geological stability is relative, spatially uneven and…”, replace the weakest generalisation with one labelled process arrow or map anchor and state the scale, exception or evidence needed before extending the conclusion.
...
#### ASCII MASTER FLOW — PANEL 1/12: Crust, lithosphere and the rock-cycle network

```ascii-master
+---------------- EARTH MATERIAL SYSTEM ----------------+
| mineral -> rock -> lithology -> petrology -> geology   |
+---------------------------------------------------------+
...
Asthenosphere = weaker mechanical layer below
       ...
       +-----------------+------------------+
       |                                    |
 magma --crystallisation--> IGNEOUS          |
       |                    |                |
       |            weathering + transport  |
       |                    v                |
       +<---- melting -- METAMORPHIC <-- SEDIMENTARY
                         ^              |
                 heat + pressure   compaction + cementation
                         |
                 uplift and exposure reconnect all paths

The cycle is a network: no rock family has one compulsory next stage.
MUST REMEMBER: Crustal analysis connects seismic evidence, compositional and rheological
  layers, rock cycle, plate boundaries and Wilson-cycle logic to India's cratons, mobile
  belts, Gondwana basins, Deccan volcanics, Himalaya and Indo-Gangetic foredeep.
```

#### ASCII MASTER FLOW — PANEL 2/12: Igneous, sedimentary and metamorphic diagnostic matrix

```ascii-master
+--------------+----------------------+---------------------------+
| FAMILY       | PROCESS              | FIELD CLUES               |
+--------------+----------------------+---------------------------+
| Igneous      | magma/lava cooling   | crystals, glass, vesicles |
| intrusive    | slow cooling         | coarse texture            |
| extrusive    | fast cooling         | fine or glassy texture    |
| Sedimentary  | deposit + lithify    | beds, fossils, ripples    |
| Metamorphic  | solid-state change   | grade, new minerals       |
| foliated     | differential stress  | aligned fabric            |
+--------------+----------------------+---------------------------+
Composition pairs:
granite-rhyolite = felsic | diorite-andesite = intermediate
gabbro-basalt = mafic

FIREWALLS
bedding is not foliation | loess and moraine are deposits until lithified
porosity is void space | permeability is connected flow capacity
```

#### ASCII MASTER FLOW — PANEL 3/12: From continental drift to plate tectonics and Wilson-cycle closure

```ascii-master
WEGENER'S DRIFT CLAIM
   |
   +-> shelf-edge fit      +-> matching rocks and fossils
   +-> palaeoclimate       +-> later palaeomagnetic support
   |
limitation: no adequate driving mechanism
   |
SEA-FLOOR SPREADING
ridge creation -> magnetic stripes -> older/deeper floor outward
   |                                      |
   +---------------- trench destruction --+
                         |
                  PLATE TECTONICS
      +------------------+-------------------+
      |                  |                   |
divergence          subduction           transform
creates crust       destroys oceanic     conserves crust
      |                  |                   |
ridge/rift          trench + arc          shallow quakes
                         |
rift -> narrow sea -> ocean -> subduction -> collision -> suture
                         |
Wilson cycle is an analogy, not a compulsory destiny for every ocean.
```

#### ASCII MASTER FLOW — PANEL 4/12: Indian Plate journey and the three-part geological skeleton
...
Gondwana rifting -> northward Indian Plate drift -> Tethys closure
        ...
        +--------------------+---------------+-------------------+
        |                    |                                   |
 ancient Peninsula     Himalayan fold-thrust belt       foreland basin
 cratons + belts       shortening + thickening          flexure + sediment
        |                    |                                   |
...
EVIDENCE LADDER
superposition -> cross-cutting -> unconformity -> fossil correlation
              -> radiometric event age -> palaeomagnetism -> geophysics

Stable Peninsula means relatively stable, not uniform, flat or aseismic.
```

#### ASCII MASTER FLOW — PANEL 5/12: Indian rock systems, basins and resource associations

```ascii-master
+------------------+-------------------------+----------------------+
| SYSTEM           | INDIAN EXPRESSION       | SAFE ASSOCIATION     |
+------------------+-------------------------+----------------------+
| Archaean/Dharwar | gneiss + supracrustals  | process-specific ore |
| Proterozoic      | Cuddapah, Vindhyan      | stone; bounded ores  |
| Gondwana         | faulted inland basins   | coal, not universal  |
| Marine basins    | coasts and offshore     | petroleum potential  |
| Deccan Trap      | stacked flood basalts   | soil, stone, water   |
+------------------+-------------------------+----------------------+

GONDWANA BASINS: Damodar | Son-Mahanadi | Satpura | Godavari
PETROLEUM SYSTEM:
source -> maturation -> migration -> reservoir -> seal -> trap -> timing
DECCAN ARCHITECTURE:
flow top / vesicles / fractures / weathered contact / dense flow interior

Association is not determinism: grade, preservation, exploration,
technology, economics and environmental limits decide usable resources.
```

#### ASCII MASTER FLOW — PANEL 6/12: Himalaya, foreland, coasts, islands and structural controls

```ascii-master
                         HIMALAYA
 collision orogen: HFT/MFT -> MBT -> MCT -> suture framework
                             |
                 FORELAND FLEXURE AND FILL
        Bhabar -> Terai -> bhangar/khadar alluvial expressions
                             |
+----------------------------+-------------------------------+
| PENINSULAR STRUCTURES      | COASTS AND ISLANDS            |
| Narmada-Son and Tapi rifts | west: rifted-margin sectors   |
| Cambay and Kachchh         | east: deltaic sediment basins |
| Godavari rift basin        | Andaman: active island arc    |
| joints, faults, bedding    | Lakshadweep: coral atolls     |
+----------------------------+-------------------------------+
                             |
structure guides relief, drainage, waterfalls and groundwater
                             |
climate + erosion + base level + human action modify expression

Rift = extensional zone | graben = down-dropped block
Lineament = mapped linear feature, not automatically an active fault.
```

#### ASCII MASTER FLOW — PANEL 7/12: India seismic expression and geology-to-risk translation
...
TECTONIC AND INHERITED STRUCTURE
       ...
       +--------+--------+----------------+
       |                 |                |
Himalaya / NE       Andaman arc       Kachchh / Peninsula
active collision    subduction        inherited faults/rifts
       |                 |                |
strong shaking      quake + tsunami   intraplate reactivation
       +--------+--------+----------------+
                |
...
#### ASCII MASTER FLOW — PANEL 8/12: Map-answer and Mains spine for India's geological architecture
...
3. SEQUENCE: Gondwana rift -> drift -> collision -> uplift -> sediment fill
                             |
4. MAP NAMED UNITS
   cratons | Purana basins | Gondwana basins | Deccan | coasts | islands
                             |
5. LINK PROCESS TO CONSEQUENCE
   structure -> relief/drainage/water/resource/seismic expression
                             |
6. QUALIFY
   association is not reserve; stable is not aseismic; alluvium has structure
                             |
7. VERDICT
   inherited geology is filtered through tectonics, climate, erosion and use
...
CLOSE DISTINCTION: Crust is compositional while lithosphere is mechanical; continental crust
  is generally granitic and less dense, oceanic crust basaltic and denser, and a shield,
  craton, platform, basin and plate are not interchangeable map units.
```
...
EVIDENCE LIMIT: Present relief is a multi-stage tectonic-denudational product; rock age,
  orogeny, mineralisation and surface form need not coincide, so geological association
  supports probability rather than deterministic resource claims.
```
