---
title: "Centre State and Inter State Relations — Learner-v2 Refreshed"
topic_key: polity-13
cover_image: assets/polity-13_Teaching-Navigation_2026-08-28.png
---
---
---
...
> **Subject:** Indian Polity | **Topic:** 13 | **GS-II + Prelims** | **Content control:** 2026-08-28
>
...
![Refreshed teaching navigation](assets/polity-13_Teaching-Navigation_2026-08-28.png)
...
**How to use them:** Frame the answer through legislative relations; define administrative relations, connect financial relations with inter-State relations to explain the mechanism, and use constitutional allocation for the decisive comparison or qualification.

![Centre-State relations operate through legislative, administrative, financial and inter-State channels.](assets/01_four_dimensions.png)
...
#### CLOSING RECALL FLOW — CONSTITUTIONAL MAP: FOUR DIMENSIONS

```text
START / CONCEPT: Constitutional map: four dimensions
        |
        v
EXACT TERMS: legislative relations · administrative relations · financial relations · inter-State relations · constitutional allocation · federal coordination
        |
        v
MECHANISM / ARGUMENT: Identify the field, constitutional route, institutional check and remedy.
        |
        v
CONSEQUENCE / CONTRAST: The same policy dispute can combine legal competence, implementation and finance.
        |
        v
UPSC TRAP / ANSWER-USE: Do not reduce federal relations to the Seventh Schedule alone.
        |
        v
ANSWER-GRABBING FORMULATION: A high-scoring answer identifies the dimension before diagnosing conflict.
```
...
**How to use them:** Frame the answer through Article 245; define Article 246, connect Seventh Schedule with territorial nexus to explain the mechanism, and use Article 248 for the decisive comparison or qualification.

![A competence dispute should be solved by identifying substance, locating the entry and reconciling before applying supremacy.](assets/02_legislative_hierarchy.png)
...
#### CLOSING RECALL FLOW — LEGISLATIVE RELATIONS: COMPETENCE BEFORE CONFLICT

```text
START / CONCEPT: Legislative relations: competence before conflict
        |
        v
EXACT TERMS: Article 245 · Article 246 · Seventh Schedule · territorial nexus · Article 248 · legislative competence
        |
        v
MECHANISM / ARGUMENT: Classify the law by true nature, locate the entry and then test overlap.
        |
        v
CONSEQUENCE / CONTRAST: Valid incidental overlap can survive while residuary matters belong to Parliament.
        |
        v
UPSC TRAP / ANSWER-USE: Do not invoke Article 254 for a conflict outside the Concurrent field.
        |
        v
ANSWER-GRABBING FORMULATION: Competence comes before supremacy in every legislative-relations answer.
```
...
**How to use them:** Frame the answer through Article 249; define Article 250, connect Article 252 with Article 253 to explain the mechanism, and use Article 356 for the decisive comparison or qualification.

![Five routes permit Parliament to legislate on State subjects for different triggers and durations.](assets/03_state_list_routes.png)
...
#### CLOSING RECALL FLOW — PARLIAMENT IN THE STATE FIELD

```text
START / CONCEPT: Parliament in the State field
        |
        v
EXACT TERMS: Article 249 · Article 250 · Article 252 · Article 253 · Article 356
        |
        v
MECHANISM / ARGUMENT: Match national interest, emergency, State request, treaty or breakdown to its exact provision.
        |
        v
CONSEQUENCE / CONTRAST: National coordination is possible without permanently transferring the State List.
        |
        v
UPSC TRAP / ANSWER-USE: Article 249 does not require an Emergency and Article 252 begins with State resolutions.
        |
        v
ANSWER-GRABBING FORMULATION: The State List is primary, but its constitutional doors are not interchangeable.
```
...
**How to use them:** Frame the answer through Article 200; define Article 201, connect Article 304(b) with prior sanction to explain the mechanism, and use reservation for the decisive comparison or qualification.

![Union control can arise before introduction, through reservation, or through presidential consideration.](assets/04_state_legislation_control.png)
...
#### CLOSING RECALL FLOW — UNION CONTROL OVER STATE LEGISLATION

```text
START / CONCEPT: Union control over State legislation
        |
        v
EXACT TERMS: Article 200 · Article 201 · Article 304(b) · prior sanction · reservation · Governor assent
        |
        v
MECHANISM / ARGUMENT: Identify when permission is needed, who reserves the Bill and which options remain with the President.
        |
        v
CONSEQUENCE / CONTRAST: State legislation may face Union review without every reserved Bill becoming invalid.
        |
        v
UPSC TRAP / ANSWER-USE: Do not carry forward superseded fixed assent timelines or deemed assent as current law.
        |
        v
ANSWER-GRABBING FORMULATION: Prior sanction and reservation occur at different stages and produce different consequences.
```
...
**How to use them:** Frame the answer through pith and substance; define harmonious construction, connect Article 254 with repugnancy to explain the mechanism, and use M. Karunanidhi for the decisive comparison or qualification.

![Overlap doctrines protect both jurisdictions before Union predominance resolves an irreconcilable conflict.](assets/05_doctrine_matrix.png)
...
#### CLOSING RECALL FLOW — FEDERAL SUPREMACY AND HARMONIOUS CONSTRUCTION

```text
START / CONCEPT: Federal supremacy and harmonious construction
        |
        v
EXACT TERMS: pith and substance · harmonious construction · Article 254 · repugnancy · M. Karunanidhi · federal supremacy
        |
        v
MECHANISM / ARGUMENT: Find true nature, reconcile entries and test direct Concurrent-field conflict.
        |
        v
CONSEQUENCE / CONTRAST: This approach protects autonomy while preventing contradictory legal commands.
        |
        v
UPSC TRAP / ANSWER-USE: Presidential assent cannot cure legislation outside State competence.
        |
        v
ANSWER-GRABBING FORMULATION: Harmonious construction is the preservation rule; federal supremacy is the tie-breaker.
```
...
**How to use them:** Frame the answer through Article 256; define Article 257, connect Union directions with Article 365 to explain the mechanism, and use railway protection for the decisive comparison or qualification.

![Union directions move from implementation duties to a possible Article 365 consequence, but President's Rule remains separately controlled.](assets/06_administrative_chain.png)
...
#### CLOSING RECALL FLOW — ADMINISTRATIVE RELATIONS: IMPLEMENTATION, DIRECTIONS AND CONSEQUENCE

```text
START / CONCEPT: Administrative relations: implementation, directions and consequence
        |
        v
EXACT TERMS: Article 256 · Article 257 · Union directions · Article 365 · railway protection · constitutional compliance
        |
        v
MECHANISM / ARGUMENT: Trace duty, direction, alleged non-compliance and the separate emergency safeguard.
        |
        v
CONSEQUENCE / CONTRAST: The Union can secure implementation without converting States into field offices.
        |
        v
UPSC TRAP / ANSWER-USE: Article 365 is evidentiary, not self-executing President’s Rule.
        |
        v
ANSWER-GRABBING FORMULATION: A direction is not the same as an automatic Article 356 proclamation.
```
...
**How to use them:** Frame the answer through Article 258; define Article 258A, connect Article 312 with All-India Services to explain the mechanism, and use CBI consent for the decisive comparison or qualification.

![Shared administration combines delegation, common services, integrated institutions and consent-based central investigation.](assets/07_services_and_agencies.png)
...
#### CLOSING RECALL FLOW — DELEGATION, SERVICES AND AGENCIES

```text
START / CONCEPT: Delegation, services and agencies
        |
        v
EXACT TERMS: Article 258 · Article 258A · Article 312 · All-India Services · CBI consent · DSPE Act
        |
        v
MECHANISM / ARGUMENT: Separate consensual delegation, statutory duties, common cadres and investigative jurisdiction.
        |
        v
CONSEQUENCE / CONTRAST: National standards and cross-border investigation coexist with State executive autonomy.
        |
        v
UPSC TRAP / ANSWER-USE: Indian Forest Service is an All-India Service; Indian Foreign Service is not.
        |
        v
ANSWER-GRABBING FORMULATION: Delegation, services and agencies work only when Union-State control and accountability remain genuinely joint.
```
...
**How to use them:** Frame the answer through Article 355; define Article 356, connect Article 357 with Article 360 to explain the mechanism, and use Article 365 for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — EMERGENCY-LINKED CENTRE-STATE CONSEQUENCES: ARTICLES 355-365

```text
START / CONCEPT: Emergency-linked Centre-State consequences: Articles 355-365
        |
        v
EXACT TERMS: Article 355 · Article 356 · Article 357 · Article 360 · Article 365 · S.R. Bommai
        |
        v
MECHANISM / ARGUMENT: Test material, proclamation, parliamentary control, judicial review and temporary consequences separately.
        |
        v
CONSEQUENCE / CONTRAST: Constitutional breakdown can alter ordinary relations while safeguards preserve federal status.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: article 360 is separate from ordinary Article 293 borrowing consent.
        |
        v
ANSWER-GRABBING FORMULATION: Emergency-linked Centre-State consequences under Articles 355-365 separate Union duty, exceptional remedy and fiscal emergency.
```
...
**How to use them:** Frame the answer through Article 265; define Article 270, connect Article 271 with Article 275 to explain the mechanism, and use Article 280 for the decisive comparison or qualification.

![Tax authority, revenue assignment, grants, the Finance Commission and borrowing create fiscal interdependence.](assets/08_financial_article_map.png)
...
#### CLOSING RECALL FLOW — FINANCIAL RELATIONS: CONSTITUTIONAL ARCHITECTURE

```text
START / CONCEPT: Financial relations: constitutional architecture
        |
        v
EXACT TERMS: Article 265 · Article 270 · Article 271 · Article 275 · Article 280 · Article 293
        |
        v
MECHANISM / ARGUMENT: Distinguish assigned taxes, divisible-pool distribution, surcharges, grants and borrowing.
        |
        v
CONSEQUENCE / CONTRAST: The Union and States remain fiscally interdependent despite separate tax fields.
        |
        v
UPSC TRAP / ANSWER-USE: GST competence comes from Article 246A, not a general Concurrent List tax entry.
        |
        v
ANSWER-GRABBING FORMULATION: The constitutional architecture of financial relations gives State autonomy practical meaning through usable revenue.
```
...
**How to use them:** Frame the answer through Planning Commission; define NITI Aayog, connect Finance Commission with divisible pool to explain the mechanism, and use cesses and surcharges for the decisive comparison or qualification.

![Fiscal relations moved from plan-era discretion toward Finance Commission, GST and NITI-based interdependence.](assets/09_fiscal_evolution.png)
...
#### CLOSING RECALL FLOW — EVOLUTION OF FISCAL FEDERALISM

```text
START / CONCEPT: Evolution of fiscal federalism
        |
        v
EXACT TERMS: Planning Commission · NITI Aayog · Finance Commission · divisible pool · cesses and surcharges · vertical imbalance
        |
        v
MECHANISM / ARGUMENT: Compare plan-era discretion, post-2015 institutions and the total transfer design.
        |
        v
CONSEQUENCE / CONTRAST: Rules-based sharing increased while non-shareable levies and conditions can re-centralise finance.
        |
        v
UPSC TRAP / ANSWER-USE: Distinguish the divisible-pool share from gross Union tax revenue.
        |
        v
ANSWER-GRABBING FORMULATION: The evolution of fiscal federalism cannot be measured by a devolution percentage alone.
```
### SESSION 11 — SIXTEENTH FINANCE COMMISSION: ACCEPTED 2026-31 CONTROL

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The Sixteenth Finance Commission governs constitutional tax devolution and major grants for 2026-31.
...
**How to use them:** Frame the answer through Sixteenth Finance Commission; define 41 percent, connect income distance with demographic performance to explain the mechanism, and use forest and ecology for the decisive comparison or qualification.

![The horizontal formula combines equalisation, population, demographic, ecological and output considerations.](assets/10_16fc_formula.png)
...
#### CLOSING RECALL FLOW — SIXTEENTH FINANCE COMMISSION: ACCEPTED 2026-31 CONTROL

```text
START / CONCEPT: Sixteenth Finance Commission: accepted 2026-31 control
        |
        v
EXACT TERMS: Sixteenth Finance Commission · 41 percent · income distance · demographic performance · forest and ecology · contribution to GDP
        |
        v
MECHANISM / ARGUMENT: Separate vertical share from the horizontal distribution formula and grant channels.
        |
        v
CONSEQUENCE / CONTRAST: Predictability improves, but formula choices redistribute bargaining gains among States.
        |
        v
UPSC TRAP / ANSWER-USE: Do not describe contribution to GDP as ten percent of national GDP; it is a formula weight.
        |
        v
ANSWER-GRABBING FORMULATION: The Sixteenth Finance Commission formula for 2026-31 distributes a fixed vertical share through explicit horizontal trade-offs.
```
### SESSION 12 — GST COUNCIL AND FISCAL NEGOTIATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The GST Council is a joint constitutional forum for negotiated indirect-tax coordination.

**Technical definition:** Article 279A combines weighted voting with recommendatory decisions and separate legislative authority under Article 246A.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> GST turns tax autonomy into structured bargaining rather than extinguishing federal choice.
...
**How to use them:** Frame the answer through Article 279A; define Article 246A, connect weighted voting with consensus to explain the mechanism, and use Mohit Minerals for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — GST COUNCIL AND FISCAL NEGOTIATION

```text
START / CONCEPT: GST Council and fiscal negotiation
        |
        v
EXACT TERMS: Article 279A · Article 246A · weighted voting · consensus · Mohit Minerals · recommendatory
        |
        v
MECHANISM / ARGUMENT: Explain composition, voting, recommendation and legislative implementation as separate steps.
        |
        v
CONSEQUENCE / CONTRAST: Common-market coordination depends politically on consensus despite legal autonomy.
        |
        v
UPSC TRAP / ANSWER-USE: Council recommendations are not binding statutes or judicial orders.
        |
        v
ANSWER-GRABBING FORMULATION: GST turns tax autonomy into structured bargaining rather than extinguishing federal choice.
```
...
**How to use them:** Frame the answer through Article 262; define ISRWD Act 1956, connect River Boards Act 1956 with tribunal to explain the mechanism, and use jurisdiction exclusion for the decisive comparison or qualification.

![The controlling system remains negotiation followed by dispute-specific tribunal adjudication.](assets/11_water_dispute_process.png)
...
#### CLOSING RECALL FLOW — INTER-STATE WATER DISPUTES: ARTICLE 262

```text
START / CONCEPT: Inter-State water disputes: Article 262
        |
        v
EXACT TERMS: Article 262 · ISRWD Act 1956 · River Boards Act 1956 · tribunal · jurisdiction exclusion · basin governance
        |
        v
MECHANISM / ARGUMENT: Trace negotiation, tribunal reference, decision publication and implementation.
        |
        v
CONSEQUENCE / CONTRAST: Specialisation can reduce parallel litigation but delays and compliance disputes persist.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: no permanent tribunal is current law.
        |
        v
ANSWER-GRABBING FORMULATION: An award needs data, implementation and basin cooperation, not adjudication alone.
```
...
**How to use them:** Frame the answer through Article 263; define Inter-State Council, connect Zonal Councils with States Reorganisation Act 1956 to explain the mechanism, and use North Eastern Council for the decisive comparison or qualification.

![The Inter-State Council, Zonal Councils, NEC and NITI differ in constitutional and statutory status.](assets/12_intergovernmental_forums.png)
...
#### CLOSING RECALL FLOW — INTER-STATE COUNCIL AND ZONAL COUNCILS

```text
START / CONCEPT: Inter-State Council and Zonal Councils
        |
        v
EXACT TERMS: Article 263 · Inter-State Council · Zonal Councils · States Reorganisation Act 1956 · North Eastern Council · consultation
        |
        v
MECHANISM / ARGUMENT: Classify each forum by source, composition, scale and recommendatory function.
        |
        v
CONSEQUENCE / CONTRAST: Regional councils can solve operational disputes while the ISC addresses national coordination.
        |
        v
UPSC TRAP / ANSWER-USE: The NEC is not a sixth Zonal Council and Zonal Councils are not constitutional bodies.
        |
        v
ANSWER-GRABBING FORMULATION: Legal status determines mandate, not whether a body is commonly called a council.
```
...
**How to use them:** Frame the answer through Article 261; define full faith and credit, connect public acts with public records to explain the mechanism, and use judicial proceedings for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FULL FAITH AND CREDIT: ARTICLE 261

```text
START / CONCEPT: Full faith and credit: Article 261
        |
        v
EXACT TERMS: Article 261 · full faith and credit · public acts · public records · judicial proceedings · civil judgments
        |
        v
MECHANISM / ARGUMENT: Separate recognition, proof/effect and execution of civil judgments.
        |
        v
CONSEQUENCE / CONTRAST: Citizens and institutions can rely on legal acts beyond the originating State.
        |
        v
UPSC TRAP / ANSWER-USE: Do not convert clause 3 into nationwide operation of every criminal or penal law.
        |
        v
ANSWER-GRABBING FORMULATION: Full faith and credit under Article 261 preserves recognition across State borders without merging jurisdictions.
```
...
**How to use them:** Frame the answer through Article 301; define Article 302, connect Article 303 with Article 304(a) to explain the mechanism, and use Article 304(b) for the decisive comparison or qualification.

![Part XIII creates a common market while allowing public-interest and non-discriminatory regulation.](assets/13_common_market.png)
...
#### CLOSING RECALL FLOW — FREEDOM OF TRADE, COMMERCE AND INTERCOURSE

```text
START / CONCEPT: Freedom of trade, commerce and intercourse
        |
        v
EXACT TERMS: Article 301 · Article 302 · Article 303 · Article 304(a) · Article 304(b) · Jindal Stainless
        |
        v
MECHANISM / ARGUMENT: Test competence, discrimination, public interest and previous presidential sanction where applicable.
        |
        v
CONSEQUENCE / CONTRAST: States retain regulatory space while hostile interstate protectionism is constrained.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: article 304(a) taxation and Article 304(b) restrictions are distinct routes.
        |
        v
ANSWER-GRABBING FORMULATION: Freedom of trade, commerce and intercourse secures economic unity through non-discrimination, not tax immunity.
```
...
**How to use them:** Frame the answer through MMDR Act; define minor minerals, connect Section 3(e) with Section 15 to explain the mechanism, and use Central notification for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — MINOR MINERALS: UNION NOTIFICATION, STATE RULE-MAKING

```text
START / CONCEPT: Minor minerals: Union notification, State rule-making
        |
        v
EXACT TERMS: MMDR Act · minor minerals · Section 3(e) · Section 15 · Central notification
        |
        v
MECHANISM / ARGUMENT: Identify the parliamentary framework, notification power and State concession rules.
        |
        v
CONSEQUENCE / CONTRAST: The arrangement demonstrates layered rather than exclusive regulatory control.
        |
        v
UPSC TRAP / ANSWER-USE: Do not infer that State Governments have no power merely because the Centre defines the category.
        |
        v
ANSWER-GRABBING FORMULATION: Central classification power does not erase State rule-making authority.
```
...
**How to use them:** Frame the answer through Rajamannar Committee; define Sarkaria Commission, connect Punchhi Commission with Article 356 to explain the mechanism, and use Governor neutrality for the decisive comparison or qualification.
...
![Trust is an institutional product of diagnosis, constitutional anchoring, evidence, commission guidance and a balanced reform.](assets/14_trust_answer_spine.png)
...
#### CLOSING RECALL FLOW — COMMISSIONS ON CENTRE-STATE RELATIONS

```text
START / CONCEPT: Commissions on Centre-State relations
        |
        v
EXACT TERMS: Rajamannar Committee · Sarkaria Commission · Punchhi Commission · Article 356 · Governor neutrality · Inter-State Council
        |
        v
MECHANISM / ARGUMENT: Match each commission to autonomy, cooperative safeguards or modern institutional reform.
        |
        v
CONSEQUENCE / CONTRAST: The recurring reform theme is consultation before compulsion and reasoned, reviewable discretion.
        |
        v
UPSC TRAP / ANSWER-USE: Do not present unimplemented commission recommendations as binding law.
        |
        v
ANSWER-GRABBING FORMULATION: Commission proposals are marks-worthy when tied to the exact diagnosed institution.
```
...
CENTRE-STATE AND INTER-STATE RELATIONS
  +-- LEGISLATIVE: Articles 245-255 and Seventh Schedule
  +-- ADMINISTRATIVE: Articles 256-263
  +-- FINANCIAL: Articles 265-293 plus 246A / 269A / 279A
  +-- INTER-STATE / MARKET: Articles 261-263 and 301-307

METHOD: identify field -> constitutional route -> check -> remedy.
```

#### ASCII MASTER FLOW — PANEL 2/12: Legislative competence and State-field entry

```ascii-master
COMPETENCE FIRST
Article 245 reach -> Article 246 lists -> Article 248 residue
  +-- Union 100 | State 61 | Concurrent 52
  +-- Article 246A: special GST competence

PARLIAMENT IN STATE FIELD
249 Rajya Sabha | 250 Emergency | 252 State request | 253 treaty | 356 breakdown
Each route has a separate trigger, duration and amendment consequence.
```

#### ASCII MASTER FLOW — PANEL 3/12: Doctrines, repugnancy and State Bills

```ascii-master
TRUE NATURE -> ENTRY -> RECONCILIATION -> CONFLICT
pith and substance -> harmonious construction -> Article 254 repugnancy
*M. Karunanidhi* (1979): real, direct and irreconcilable Concurrent-field conflict

STATE BILL CONTROLS
prior presidential sanction != Governor reservation under Article 200
Article 201 presidential consideration; no automatic assent after State reconsideration.
```

#### ASCII MASTER FLOW — PANEL 4/12: Administrative cooperation and central agencies

```ascii-master
ARTICLES 256-257
State compliance + no impediment -> bounded Union directions
ARTICLES 258 / 258A -> reciprocal entrustment
ARTICLE 312 -> Rajya Sabha route for IAS / IPS / Indian Forest Service

CBI / DSPE ACT
State consent for ordinary operation; Articles 32/226 court orders remain possible
2024 West Bengal ruling: Article 131 suit maintainable at preliminary stage, merits open.
```

#### ASCII MASTER FLOW — PANEL 5/12: Articles 355-365 and judicial limits

```ascii-master
DUTY -> REMEDY -> TEMPORARY CONSEQUENCE
Article 355 Union duty
Article 356 exceptional proclamation + Parliament + review
Article 357 temporary exercise of State legislative power
Article 360 separate financial-emergency route
Article 365 non-compliance may supply material, never automatic rule

*State of Rajasthan* (1977) -> review not wholly excluded
*S.R. Bommai* (1994) -> federalism, review and floor-test discipline.
```

#### ASCII MASTER FLOW — PANEL 6/12: Fiscal architecture from tax to borrowing

```ascii-master
ARTICLE 265: authority of law
268 / 269 / 269A -> assigned and apportioned revenue
270 -> divisible pool | 271 -> Union surcharge outside sharing
275 -> constitutional grants | 282 -> any-public-purpose grants
280 -> Finance Commission | 292 / 293 -> borrowing
285 / 289 -> reciprocal property and income tax immunities with exceptions.
```

#### ASCII MASTER FLOW — PANEL 7/12: Fiscal evolution, Sixteenth Finance Commission and GST

```ascii-master
PLAN ERA -> FC / GST / NITI ERA
Planning Commission discretion -> NITI has no devolution power
Sixteenth Finance Commission 2026-31 -> 41% vertical share
horizontal weights include income distance, demography, ecology and GDP contribution

GST: Articles 246A + 269A + 279A
Union one-third votes | States two-thirds | three-fourths decision threshold
*Mohit Minerals* (2022): Council recommendations are recommendatory, not binding.
```

#### ASCII MASTER FLOW — PANEL 8/12: River-water dispute route and jurisdiction

```ascii-master
ARTICLE 262 + 1956 ACT
negotiation -> dispute-specific tribunal -> publication -> implementation
Parliament may exclude court jurisdiction over the defined water dispute
Article 131 does not displace the special Article 262 statutory bar

CURRENT CONTROL
2019 Amendment Bill lapsed with the Seventeenth Lok Sabha
A revised permanent-tribunal proposal is not enacted law
Cauvery implementation uses the 2018 Scheme and management institutions.
```

#### ASCII MASTER FLOW — PANEL 9/12: Intergovernmental forums and current operation

```ascii-master
ARTICLE 263 INTER-STATE COUNCIL
President establishes when public interest requires; inquiry, discussion, recommendation
1990 presidential order | PM chair | advisory

ZONAL COUNCILS
Five statutory councils under States Reorganisation Act 1956 | Home Minister chair
NEC is separate under 1971 Act, not a sixth Zonal Council
2026 official activity: Central, Northern, Eastern and Southern zonal mechanisms.
```

#### ASCII MASTER FLOW — PANEL 10/12: Common market, recognition and layered regulation

```ascii-master
ARTICLE 261 -> recognition of public acts, records and proceedings; civil execution
ARTICLES 301-304 -> free trade with bounded regulation and non-discrimination
*Jindal Stainless* (2016): no tax-free promise; Article 304(a) targets discrimination

MINOR MINERALS
MMDR Section 3(e) Centre notifies category
Section 15 States make concession rules -> layered power, not State exclusion.
```

#### ASCII MASTER FLOW — PANEL 11/12: Commissions, eleven PYQs and Prelims firewalls

```ascii-master
REFORM EVIDENCE
Rajamannar -> State autonomy | Sarkaria -> cooperative safeguards | Punchhi -> modern machinery

ELEVEN PYQ ROUTES
2019 doctrines | 2020 centralisation | 2021 CBI | 2022 parties/autonomy
2023 Article 356 + GST | 2024 relations reform + list trap
2025 fiscal federalism + constitutional-body + minor-mineral traps

FIREWALLS: Article 365 is not automatic; GST is not a Concurrent-list tax entry;
Zonal Councils are statutory; the 2019 water Bill is not law.
```

#### ASCII MASTER FLOW — PANEL 12/12: Marks-scaled answer spine and qualified verdict

```ascii-master
10 MARKS: definition -> 2-3 anchors -> qualification -> verdict
15 MARKS: thesis -> dimensions -> evidence/case -> counterpoint -> reform
20 MARKS: legislative + administrative + fiscal + inter-State -> diagnosis -> reform

EVIDENCE CHAIN
claim -> Article/institution -> operation -> State/Union counterpoint -> commission remedy

VERDICT
Strong Union power is constitutionally bounded; durable relations require consultation
before compulsion, predictable finance, shared data and reviewable discretion.
```
