...
topic_key: polity-06
cover_image: assets/polity-06_Teaching-Navigation_2026-08-28.png
---
# Citizenship — Learner-v2 Source-Complete Learning Session

> **Catalogue identity:** Polity · Subject-wide Syllabus · `polity-06`  
> **Generation identity:** `polity-06:learner-v2:g16` · generated 28 August 2026 · supersedes `polity-06:learner-v2:g15` · approval remains false.
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Polity\basic\Citizenship.md`  
**Canonical topic owner:** `upsc-ai-kit\knowledge\Polity\06_Citizenship_Complete-Topic-Package.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Polity\advanced\06_Citizenship.md`  
...
- **Current-status note, rechecked 2026-09-05:** Rechecked 2026-09-05: official MHA/India Code materials retain the Citizenship Act, 1955, the 2019 amendment and 2024 Rules. The 19 August 2026 Rule/Order changes specified Section 6B administration to Collectors without changing the class or 31 December 2014 cut-off. Section 6A remains valid under the 17 October 2024 four-to-one judgment; no later final CAA constitutional judgment was located on the official record.
...
![Refreshed teaching navigation](assets/polity-06_Teaching-Navigation_2026-08-28.png)
...
- [FACT] The MHA's current Foreigners Division law listing continues to publish the Citizenship Act,
  1955, the Citizenship (Amendment) Act, 2019 and the Citizenship (Amendment) Rules, 2024. The 19 August 2026 amendment changes the competent authority and process for a specified subset of Section 6B applicants, without altering the five acquisition routes, three loss routes, Section 6A, the CAA class or the 2014 cut-off.
...
```text
MEMBERSHIP + CITIZEN/ALIEN CAVEAT + RIGHTS TEXT
  -> CITIZENSHIP / DOMICILE / RESIDENCE + SINGLE CITIZENSHIP
  -> ARTICLES 5-11: COMMENCEMENT ROUTES -> DISQUALIFIER -> CONTINUITY -> PARLIAMENT
  -> CITIZENSHIP ACT: BIRTH / DESCENT / REGISTRATION / NATURALISATION / INCORPORATION
  -> LOSS: RENUNCIATION / TERMINATION / CATEGORY-LIMITED DEPRIVATION
  -> ASSAM ACCORD -> SECTION 6A -> NRC DATE -> 2024 MAJORITY / DISSENT -> MONITORING
  -> OCI / PIO EVOLUTION -> NOTIFIED RIGHTS -> RESTRICTIONS -> CANCELLATION
  -> CAA CLASS -> RULES 2024 -> ARTICLE 14 / SECULARISM -> 2025 IMMIGRATION CAUTION
  -> DOCUMENT PROOF -> PYQ ROUTES -> 10/15/20-MARK ANSWER SPINES -> FINAL VERDICT
```
...
9. **CURRENT STATUS:** As verified on the located official record through 28 August 2026, the 2019 Act, 2024 Rules and 19 August 2026 procedural amendment are operative; specified Section 6B applications now follow the Collector route, the CAA constitutional challenges have no located final judgment, and Section 6A remains valid under the 4:1 decision with implementation monitoring.
...
```
### SESSION 19 — IN RE: SECTION 6A (2024) (17 OCTOBER 2024) - THE CONTROLLING 4:1 JUDGMENT
...
#### CLOSING RECALL FLOW — IN RE: SECTION 6A (2024) (17 OCTOBER 2024) - THE CONTROLLING 4:1 JUDGMENT

```text
START / CONCEPT: In Re: Section 6A (2024) (17 October 2024) - the controlling 4:1 judgment
        |
        v
...
START / CONCEPT: OCI and PIO evolution - diaspora connection without citizenship
        |
        v
EXACT TERMS: OCI · PIO evolution - diaspora connection without citizenship · CONTENT CLASSIFICATION · not Indian citizenship · foreigner · 11 August 2025
        |
        v
...
```
### 21A. Post-2024 current-law control: immigration exemption is not citizenship
...
- **Must remember:** Separate the commencement settlement in Articles 5-11 from the continuing statutory regime under the Citizenship Act, 1955, and state each migration, birth, descent, registration, naturalisation, loss, Section 6A, OCI and Section 6B rule with its exact trigger and date.
- **Close distinction:** Article 9 is confined to citizenship by virtue of Articles 5, 6 or 8; the present no-dual-citizenship position also depends on Section 9. OCI is a statutory card, while the CAA and the 2025 immigration exemption use different cut-offs and produce different legal consequences.
- **Legal/source limit:** Current procedure must follow the 2024 Rules and the 19 August 2026 Collector-route notifications. Section 6A remains valid under the 17 October 2024 majority; no unlocated final CAA judgment may be invented.
...
### Current-law rapid controls — 28 August 2026
...
#### ASCII MASTER FLOW — PANEL 1/12: Citizenship: membership, rights and single national status

```ascii-master
PERSON WITHIN INDIA
  +-- CITIZEN: political membership and citizen-specific constitutional rights
  |     Articles 15, 16, 19 and 29 use citizen/citizens
  |     Article 30 uses minorities; do not add a citizen-only word absent from the text
  +-- NON-CITIZEN: Articles 14, 20, 21 and 25 protect persons
        Article 22(3)(a) excludes enemy aliens only from clauses (1)-(2)

CITIZENSHIP = membership | DOMICILE = permanent legal home | RESIDENCE = factual link
SINGLE CITIZENSHIP does not erase constitutionally authorised regional protection.
CASE CONTROL: Pradeep Jain (1984) explains one Indian domicile, not State citizenship.
MUST REMEMBER: Separate the commencement settlement in Articles 5-11 from the continuing
  statutory regime under the Citizenship Act, 1955, and state each migration, birth, descent,
  registration, naturalisation, loss, Section 6A, OCI and Section 6B rule with its exact
  trigger and date.
```

#### ASCII MASTER FLOW — PANEL 2/12: Articles 5-7: commencement citizenship decision tree

```ascii-master
AT COMMENCEMENT: 26 JANUARY 1950
  +-- ARTICLE 5: domicile in India + birth | parentage | five-year residence
  +-- ARTICLE 6: Pakistan-to-India migration
  |     before 19 Jul 1948 -> residence since migration
  |     on/after 19 Jul 1948 -> application, six-month residence and registration
  +-- ARTICLE 7: India-to-Pakistan migration after 1 Mar 1947 -> excluded
        permit for resettlement/permanent return -> post-19 Jul Article 6 route

TRAP: residence alone never replaced Article 5 domicile.
```

#### ASCII MASTER FLOW — PANEL 3/12: Articles 8-11: diaspora, disqualification, continuity and Parliament
...
#### ASCII MASTER FLOW — PANEL 4/12: Five acquisition routes and their exact gates
...
#### ASCII MASTER FLOW — PANEL 5/12: Birth, descent and registration: date-and-category drill

```ascii-master
BIRTH IN INDIA
1950-before 1 Jul 1987 -> birth generally sufficient, subject to exceptions
1 Jul 1987-before 3 Dec 2004 -> either parent a citizen
from 3 Dec 2004 -> both citizens OR one citizen + other not illegal migrant

DESCENT OUTSIDE INDIA
before 10 Dec 1992 -> paternal rule | later -> either parent
from 3 Dec 2004 -> consular registration plus statutory declaration controls

REGISTRATION -> category first; seven-year formula is 12 months + 6 of prior 8 years.
```

#### ASCII MASTER FLOW — PANEL 6/12: Loss, safeguards and OCI cancellation are category-specific

```ascii-master
RENUNCIATION -> full-age citizen declaration; minor follows with resumption window
TERMINATION -> voluntary acquisition of foreign citizenship; Section 9 controls
DEPRIVATION -> eligible category + listed ground + public-good finding + procedure
  fraud | disloyalty | enemy dealing | specified conviction | seven years abroad

OCI IS NOT CITIZENSHIP
Section 7D requires a hearing. The 11 Aug 2025 Section 7D(da) notification adds:
  sentence of at least two years OR charge-sheet for an offence punishable by seven years.
CLOSE DISTINCTION: Article 9 is confined to citizenship by virtue of Articles 5, 6 or 8; the
  present no-dual-citizenship position also depends on Section 9. OCI is a statutory card,
  while the CAA and the 2025 immigration exemption use different cut-offs and produce
  different legal consequences.
```

#### ASCII MASTER FLOW — PANEL 7/12: Assam Section 6A: three streams and the controlling judgment

```ascii-master
ASSAM-SPECIFIC SECTION 6A
  before 1 Jan 1966 -> deemed citizens from 1 Jan 1966
  1 Jan 1966-before 25 Mar 1971 -> detection + registration + ten-year vote exclusion
  on/after 25 Mar 1971 -> no Section 6A protection
...
NRC reference: midnight of 24 March 1971; do not confuse it with CAA 2014.
```

#### ASCII MASTER FLOW — PANEL 8/12: CAA class and the 19 August 2026 Collector procedure
...
#### ASCII MASTER FLOW — PANEL 9/12: CAA equality debate and territorial protections

```ascii-master
ARTICLE 14 TEST
  comparator -> intelligible differentia -> rational nexus -> arbitrariness
...
SECTION 6B DOES NOT APPLY IN
  Sixth Schedule tribal areas of Assam, Meghalaya, Mizoram and Tripura
  areas under the notified Inner Line

STATUS THROUGH 28 AUG 2026: law/rules operate; no located final merits judgment.
```

#### ASCII MASTER FLOW — PANEL 10/12: Documents and exact PYQ controls
...
2021 PRELIMS GS-I Q89: one citizenship/domicile; birth-only President; deprivation
  exact options yield 1 only; repository solution remains qualified if official key is absent.
```

#### ASCII MASTER FLOW — PANEL 11/12: Executable 10, 15 and 20-mark answer architecture

```ascii-master
10 MARKS / 150 WORDS
define demand -> 3 legal anchors -> one caveat/current point -> qualified verdict

15 MARKS / 250 WORDS
thesis -> Articles 5-11 -> statutory mechanism -> judgment/debate -> balance -> verdict

20 MARKS / 250 WORDS
exact class/doctrine -> argument and counterargument -> named evidence -> federal impact
...
#### ASCII MASTER FLOW — PANEL 12/12: Qualified synthesis: membership under constitutional supervision

```ascii-master
INDIAN CITIZENSHIP
  constitutional founding settlement
        + parliamentary statutory administration
        + judicial review under equality, liberty and natural justice

BALANCE
  equal membership + fraternity
  lawful migration control + regional protection
  diaspora access without political citizenship
  humanitarian facilitation without arbitrary classification
...
LEGAL/SOURCE LIMIT: Current procedure must follow the 2024 Rules and the 19 August 2026
  Collector-route notifications. Section 6A remains valid under the 17 October 2024 majority;
  no unlocated final CAA judgment may be invented.
```
