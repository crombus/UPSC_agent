...
topic_key: polity-07
cover_image: assets/polity-07_Teaching-Navigation_2026-08-23.png
---
...
![Refreshed teaching navigation](assets/polity-07_Teaching-Navigation_2026-08-23.png)
...
**Plain-language definition:** Articles 12-13 and 31A-35 are in Part III, but they are not separately counted among the six present Fundamental Rights.

**Technical definition:** Enforcement: Article 32 guarantees access to the Supreme Court for Fundamental Rights; Article 226 supplies wider High Court writ power.
...
**How to use them:** Use Part Iii As An Architecture to define the issue, connect Rights with Limits to explain it, and use Remedies to distinguish or qualify the conclusion.
...
CONSEQUENCE / CONTRAST: Part III is not merely a list of entitlements.
        |
        v
UPSC TRAP / ANSWER-USE: Articles 12-13 and 31A-35 are in Part III, but they are not separately counted among the six present Fundamental Rights.
        |
        v
...
**How to use them:** Use Beneficiaries to define the issue, connect Vertical with Horizontal Reach to explain it, and use Positive to distinguish or qualify the conclusion.
...
START / CONCEPT: BENEFICIARIES, VERTICAL AND HORIZONTAL REACH, POSITIVE AND NEGATIVE DUTIES
        |
        v
EXACT TERMS: Beneficiaries · Vertical · Horizontal Reach · Positive · Negative Duties · CONTENT CLASSIFICATION
        |
        v
...
**Technical definition:** Always begin with the Article's text; proportionality disciplines the chosen means.
...
**How to use them:** Use Qualified Rights to define the issue, connect Reasonable Restrictions with Proportionality to explain it, and use CONTENT CLASSIFICATION to distinguish or qualify the conclusion.
...
START / CONCEPT: QUALIFIED RIGHTS, REASONABLE RESTRICTIONS AND PROPORTIONALITY
        |
        v
EXACT TERMS: Qualified Rights · Reasonable Restrictions · Proportionality · CONTENT CLASSIFICATION · Legality · Legitimate constitutional aim
        |
        v
...
CONSEQUENCE / CONTRAST: "Reasonable restriction" and proportionality are related but not interchangeable slogans.
        |
        v
UPSC TRAP / ANSWER-USE: Necessity: Is a less rights-restrictive but equally effective measure available?
        |
        v
...
**Plain-language definition:** The later approach in Pradeep Kumar Biswas asks whether the body is financially, functionally and administratively dominated by or under government control of a pervasive character.

**Technical definition:** Article 12 looks beyond legal form to governmental domination: an entity may be State when its financial, functional and administrative relationship reveals pervasive governmental control, while Article 226 may separately reach a non-State body performing a public duty.
...
**How to use them:** Use Article 12 - The State to define the issue, connect The Instrumentality Inquiry with CONTENT CLASSIFICATION to explain it, and use public duty to distinguish or qualify the conclusion.
...
CONSEQUENCE / CONTRAST: Therefore, "not State under Article 12" does not always mean "immune from writ jurisdiction.".
        |
        v
UPSC TRAP / ANSWER-USE: registration as a society or company neither automatically includes nor excludes a body from Article 12.
        |
        v
...
**Technical definition:** Article 13(1): pre-Constitution laws are void to the extent of inconsistency with Fundamental Rights.
...
**How to use them:** Use Article 13 - Law to define the issue, connect Judicial Review with The Voidness Doctrines to explain it, and use CONTENT CLASSIFICATION to distinguish or qualify the conclusion.
...
```
### SESSION 6 — ARTICLE 14 - TWIN EQUALITY, CLASSIFICATION AND ANTI-ARBITRARINESS
...
**How to use them:** Use Article 14 - Twin Equality to define the issue, connect Anti-Arbitrariness with CONTENT CLASSIFICATION to explain it, and use class legislation to distinguish or qualify the conclusion.
...
```
### SESSION 7 — ARTICLES 15 AND 16 - NON-DISCRIMINATION AND PROTECTIVE DISCRIMINATION
...
**How to use them:** Use Articles 15 to define the issue, connect Protective Discrimination with CONTENT CLASSIFICATION to explain it, and use only to distinguish or qualify the conclusion.
...
EXACT TERMS: Articles 15 · Protective Discrimination · CONTENT CLASSIFICATION · only · special provisions for women and children · 16 - Non-Discrimination
        |
        v
MECHANISM / ARGUMENT: shops, public restaurants, hotels and places of public entertainment; and wells, tanks, bathing ghats, roads and places of public resort maintained wholly/partly from State funds or dedicated to public use.
        |
        v
CONSEQUENCE / CONTRAST: This clause has direct horizontal force.
        |
        v
UPSC TRAP / ANSWER-USE: Article 15(4) followed State of Madras v.
        |
        v
ANSWER-GRABBING FORMULATION: Articles 15(4) and 16(4) are not grudging exceptions to equality.
```
### SESSION 8 — RESERVATION DOCTRINE: CREAMY LAYER, CEILING, PROMOTION, EFFICIENCY, EWS AND SC SUB-CLASSIFICATION
...
**How to use them:** Use Reservation Doctrine to define the issue, connect Creamy Layer with Ceiling to explain it, and use Promotion to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: Efficiency is not a veto owned by the unreserved category.
        |
        v
CONSEQUENCE / CONTRAST: Do not automatically state that a single identical creamy-layer rule now governs every SC/ST reservation context.
        |
        v
UPSC TRAP / ANSWER-USE: Jarnail Singh removed the requirement that the State prove backwardness of SCs/STs afresh, while retaining data-based inadequacy and efficiency controls.
        |
        v
...
```
### SESSION 9 — ARTICLES 17 AND 18 - ANTI-UNTOUCHABILITY AND ANTI-TITLE GUARANTEES
...
**How to use them:** Use Articles 17 to define the issue, connect Anti-Title Guarantees with CONTENT CLASSIFICATION to explain it, and use Article 17 to distinguish or qualify the conclusion.
...
START / CONCEPT: ARTICLES 17 AND 18 - ANTI-UNTOUCHABILITY AND ANTI-TITLE GUARANTEES
        |
        v
EXACT TERMS: Articles 17 · Anti-Title Guarantees · CONTENT CLASSIFICATION · Article 17 · 18 - Anti-Untouchability · 1955
        |
        v
...
```
### SESSION 10 — ARTICLE 19 - SIX FREEDOMS AND EXACT RESTRICTION GROUNDS
...
**Technical definition:** The restrictions must be imposed by law and be reasonable.
...
**How to use them:** Use Article 19 - Six Freedoms to define the issue, connect Exact Restriction Grounds with CONTENT CLASSIFICATION to explain it, and use within India to distinguish or qualify the conclusion.
...
START / CONCEPT: ARTICLE 19 - SIX FREEDOMS AND EXACT RESTRICTION GROUNDS
        |
        v
EXACT TERMS: Article 19 - Six Freedoms · Exact Restriction Grounds · CONTENT CLASSIFICATION · within India · Speech · Assembly
        |
        v
...
```
### SESSION 11 — SPEECH, PRESS, RIGHT TO KNOW AND THE FIRST AMENDMENT SETTLEMENT
...
**Technical definition:** The First Amendment both widened the State's grounds and strengthened judicial control through the reasonableness requirement.
...
**How to use them:** Use Speech to define the issue, connect Press with Right To Know to explain it, and use The First Amendment Settlement to distinguish or qualify the conclusion.
...
START / CONCEPT: SPEECH, PRESS, RIGHT TO KNOW AND THE FIRST AMENDMENT SETTLEMENT
        |
        v
EXACT TERMS: Speech · Press · Right To Know · The First Amendment Settlement · reasonable · 1950
        |
        v
...
CONSEQUENCE / CONTRAST: Do not quote them as if present Article 19(2) lacked "public order.".
        |
        v
UPSC TRAP / ANSWER-USE: inserted the word reasonable before restrictions; added public order, friendly relations with foreign States and incitement to an offence; and responded to the 1950 decisions.
        |
        v
...
```
### SESSION 12 — SEDITION LINEAGE, BNS SECTION 152 AND SPEECH-INCITEMENT DISCIPLINE
...
**Technical definition:** The Supreme Court upheld IPC section 124A only by reading it down to speech involving incitement to violence or a tendency/intention to create public disorder.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> On 11 May 2022, the Supreme Court placed use of IPC section 124A in abeyance while reconsideration occurred.
...
**How to use them:** Use Sedition Lineage to define the issue, connect Bns Section 152 with Speech-Incitement Discipline to explain it, and use not to distinguish or qualify the conclusion.
...
START / CONCEPT: SEDITION LINEAGE, BNS SECTION 152 AND SPEECH-INCITEMENT DISCIPLINE
        |
        v
EXACT TERMS: Sedition Lineage · Bns Section 152 · Speech-Incitement Discipline · not · 1962 · 2022
        |
        v
MECHANISM / ARGUMENT: [CURRENT] BNS section 152 targets purposeful/knowing acts through words, signs, visible representation, electronic communication, financial means or otherwise that.
        |
        v
CONSEQUENCE / CONTRAST: The Supreme Court upheld IPC section 124A only by reading it down to speech involving incitement to violence or a tendency/intention to create public disorder.
        |
        v
UPSC TRAP / ANSWER-USE: "sedition was simply renamed" is inaccurate; and "all sedition-type criminalisation disappeared" is also inaccurate.
        |
        v
ANSWER-GRABBING FORMULATION: On 11 May 2022, the Supreme Court placed use of IPC section 124A in abeyance while reconsideration occurred.
```
### SESSION 13 — DIGITAL SPEECH: SHREYA SINGHAL, INTERNET SHUTDOWNS AND CRIMINAL DEFAMATION
...
**Technical definition:** A critical answer should still note the chilling effect, criminal-process burden and availability of civil remedies, while accurately stating the binding holding.
...
**How to use them:** Use Digital Speech to define the issue, connect Shreya Singhal with Internet Shutdowns to explain it, and use Criminal Defamation to distinguish or qualify the conclusion.
...
START / CONCEPT: DIGITAL SPEECH: SHREYA SINGHAL, INTERNET SHUTDOWNS AND CRIMINAL DEFAMATION
        |
        v
EXACT TERMS: Digital Speech · Shreya Singhal · Internet Shutdowns · Criminal Defamation · through · 2015
        |
        v
...
CONSEQUENCE / CONTRAST: A critical answer should still note the chilling effect, criminal-process burden and availability of civil remedies, while accurately stating the binding holding.
        |
        v
UPSC TRAP / ANSWER-USE: publication of restriction orders; proportionality review; periodic review; rejection of indefinite suspension; and careful use of section 144-type powers.
        |
        v
...
```
### SESSION 14 — ARTICLE 20 - EX POST FACTO LAW, DOUBLE JEOPARDY AND SELF-INCRIMINATION
...
**How to use them:** Use Article 20 - Ex Post Facto Law to define the issue, connect Double Jeopardy with Self-Incrimination to explain it, and use CONTENT CLASSIFICATION to distinguish or qualify the conclusion.
...
START / CONCEPT: ARTICLE 20 - EX POST FACTO LAW, DOUBLE JEOPARDY AND SELF-INCRIMINATION
        |
        v
EXACT TERMS: Article 20 - Ex Post Facto Law · Double Jeopardy · Self-Incrimination · CONTENT CLASSIFICATION · Article 20 · Article 21
        |
        v
...
```
### SESSION 15 — ARTICLE 21 - GOPALAN TO MANEKA: FAIR PROCEDURE AND THE DIGNITY CHARTER

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** India did not textually replace "procedure established by law" with the American phrase "due process." The exam-safe formulation is that Maneka imported a due-process standard of fairness and non-arbitrariness.

**Technical definition:** Article 21 became a dignity charter when Maneka Gandhi required fair, just and reasonable procedure and linked liberty with Articles 14 and 19, enabling named protections without turning every policy aspiration into an unlimited entitlement.
...
**How to use them:** Use Article 21 - Gopalan To Maneka to define the issue, connect Fair Procedure with The Dignity Charter to explain it, and use CONTENT CLASSIFICATION to distinguish or qualify the conclusion.
...
START / CONCEPT: ARTICLE 21 - GOPALAN TO MANEKA: FAIR PROCEDURE AND THE DIGNITY CHARTER
        |
        v
EXACT TERMS: Article 21 - Gopalan To Maneka · Fair Procedure · The Dignity Charter · CONTENT CLASSIFICATION · standard · speedy trial
        |
        v
MECHANISM / ARGUMENT: India did not textually replace "procedure established by law" with the American phrase "due process." The exam-safe formulation is that Maneka imported a due-process standard of fairness and non-arbitrariness.
        |
        v
CONSEQUENCE / CONTRAST: The qualification is equally important: named rights often secure fair process and minimum protection, not an unlimited judicially supplied welfare entitlement.
        |
        v
UPSC TRAP / ANSWER-USE: Maneka Gandhi (1978) completed the turn: procedure must be fair, just and reasonable, and Articles 14, 19 and 21 interlock.
        |
        v
...
```
### SESSION 16 — PRIVACY, PROPORTIONALITY, DNA TESTING AND DATA PROTECTION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** law; legitimate State aim; proportionality between means and aim; and procedural safeguards against abuse.

**Technical definition:** [CURRENT] The Digital Personal Data Protection Act, 2023 supplies a statutory framework for digital personal data processing, consent/legitimate uses, data-principal rights, data-fiduciary obligations and enforcement.
...
**How to use them:** Use Privacy to define the issue, connect Proportionality with Dna Testing to explain it, and use Data Protection to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: A nine-judge Bench held unanimously that privacy is a Fundamental Right protected as an intrinsic part of life and personal liberty under Article 21 and as part of the freedoms guaranteed by Part III.
        |
        v
CONSEQUENCE / CONTRAST: Notification is not full implementation: informational privacy remains constitutionally reviewable under Puttaswamy.
        |
        v
...
```
### SESSION 17 — ARTICLE 21A - EDUCATION AS A FUNDAMENTAL RIGHT
...
**How to use them:** Use Article 21A - Education As A Fundamental Right to define the issue, connect CONTENT CLASSIFICATION with Article 21A to explain it, and use Article 30 to distinguish or qualify the conclusion.
...
MECHANISM / ARGUMENT: recast Article 45 toward early childhood care and education below six years; and added Article 51A(k), a parental/guardian duty to provide educational opportunity to children aged six to fourteen.
        |
        v
CONSEQUENCE / CONTRAST: Article 21A demonstrates a shift from judge-developed Article 21 content to an express, age-bounded Fundamental Right implemented by statute.
        |
        v
UPSC TRAP / ANSWER-USE: Article 21A demonstrates a shift from judge-developed Article 21 content to an express, age-bounded Fundamental Right implemented by statute.
        |
        v
...
```
### SESSION 18 — ARTICLE 22 - ORDINARY ARREST, PREVENTIVE DETENTION AND THE UNENFORCED 44TH AMENDMENT CLAUSE
...
**How to use them:** Use Article 22 - Ordinary Arrest to define the issue, connect Preventive Detention with The Unenforced 44Th Amendment Clause to explain it, and use CONTENT CLASSIFICATION to distinguish or qualify the conclusion.
...
```
### SESSION 19 — ARTICLES 23-24 - EXPLOITATION, FORCED LABOUR AND CHILD LABOUR
...
**How to use them:** Use Articles 23-24 - Exploitation to define the issue, connect Forced Labour with Child Labour to explain it, and use CONTENT CLASSIFICATION to distinguish or qualify the conclusion.
...
START / CONCEPT: ARTICLES 23-24 - EXPLOITATION, FORCED LABOUR AND CHILD LABOUR
        |
        v
EXACT TERMS: Articles 23-24 - Exploitation · Forced Labour · Child Labour · CONTENT CLASSIFICATION · Article 23 · Article 24
        |
        v
MECHANISM / ARGUMENT: Union of India (Asiad Workers), payment below the legal minimum in conditions of economic compulsion could amount to forced labour.
        |
        v
CONSEQUENCE / CONTRAST: Article 24's text is narrower than a complete ban on every kind of child work, while the amended statute creates broader prohibitions and defined exceptions.
        |
        v
UPSC TRAP / ANSWER-USE: Article 24's text is narrower than a complete ban on every kind of child work, while the amended statute creates broader prohibitions and defined exceptions.
        |
        v
...
```
### SESSION 20 — ARTICLES 25-28 - CONSCIENCE, DENOMINATION, SECULAR REGULATION AND PRINCIPLED DISTANCE
...
**How to use them:** Use Articles 25-28 - Conscience to define the issue, connect Denomination with Secular Regulation to explain it, and use Principled Distance to distinguish or qualify the conclusion.
...
START / CONCEPT: ARTICLES 25-28 - CONSCIENCE, DENOMINATION, SECULAR REGULATION AND PRINCIPLED DISTANCE
        |
        v
EXACT TERMS: Articles 25-28 - Conscience · Denomination · Secular Regulation · Principled Distance · CONTENT CLASSIFICATION · wholly maintained from State funds
        |
        v
...
CONSEQUENCE / CONTRAST: A bounded official-source check through 21 August 2026 located no final later decision that this package can securely use; it therefore states only the 2018 majority holding and does not speculate about the review/reference.
        |
        v
UPSC TRAP / ANSWER-USE: Article 27 distinguishes a tax for religious promotion from a regulatory fee or a general tax whose expenditure may incidentally benefit religious institutions.
        |
        v
...
```
### SESSION 21 — ARTICLES 29-30 - CULTURAL CONSERVATION AND MINORITY EDUCATIONAL AUTONOMY
...
**Technical definition:** acquisition law must not make the Article 30(1) guarantee illusory; State aid cannot discriminate merely because the institution is minority-managed; and regulation for academic standards, sanitation, teacher qualifications, fairness and excellence can be valid.
...
**How to use them:** Use Articles 29-30 - Cultural Conservation to define the issue, connect Minority Educational Autonomy with CONTENT CLASSIFICATION to explain it, and use Qualified rule to distinguish or qualify the conclusion.
...
START / CONCEPT: ARTICLES 29-30 - CULTURAL CONSERVATION AND MINORITY EDUCATIONAL AUTONOMY
        |
        v
EXACT TERMS: Articles 29-30 - Cultural Conservation · Minority Educational Autonomy · CONTENT CLASSIFICATION · Qualified rule · Article 29 · Article 30
        |
        v
...
CONSEQUENCE / CONTRAST: Aided minority institutions retain Article 30 identity but cannot treat State aid as a licence to ignore every admission-related constitutional obligation.
        |
        v
UPSC TRAP / ANSWER-USE: Xavier's College and Malankara Syrian Catholic College: regulatory excellence is valid, but the State cannot destroy the minority management's core.
        |
        v
...
```
### SESSION 22 — ARTICLE 32 AND THE FIVE WRITS
...
**How to use them:** Use Article 32 to define the issue, connect The Five Writs with CONTENT CLASSIFICATION to explain it, and use Habeas corpus to distinguish or qualify the conclusion.
...
CONSEQUENCE / CONTRAST: It means the constitutional guarantee cannot be abolished or reduced to ordinary legislative grace.
        |
        v
UPSC TRAP / ANSWER-USE: Detailed PIL growth, epistolary jurisdiction and institutional criticism are cross-linked to Polity 18.
        |
        v
...
```
### SESSION 23 — ARTICLES 31A, 31B AND 31C - SAVING PROVISIONS WITHOUT BLANKET IMMUNITY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** It is not a general immunity for every property-related law.

**Technical definition:** Articles 31A-31C, 33-35 create defined constitutional controls rather than rights-free zones: their field, purpose and legislative competence remain text-bound and subject to basic-structure review where applicable.
...
**How to use them:** Use Articles 31A to define the issue, connect CONTENT CLASSIFICATION with Article 31A to explain it, and use 31B to distinguish or qualify the conclusion.
...
CONSEQUENCE / CONTRAST: It is not a general immunity for every property-related law.
        |
        v
UPSC TRAP / ANSWER-USE: Ninth Schedule placement is not absolute immunity after I.R. Coelho.
        |
        v
...
```
### SESSION 24 — RIGHT TO PROPERTY: ARTICLE 31 TRANSITION TO ARTICLE 300A

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 300A is a constitutional right, though not a Fundamental Right.

**Technical definition:** Article 300A now provides: no person shall be deprived of property save by authority of law.
...
- **Right To Property**
- **Article 31 Transition To Article 300A**
- **CONTENT CLASSIFICATION**
- **constitutional right**
- **Location**
- **Part III**

**How to use them:** Use Right To Property to define the issue, connect Article 31 Transition To Article 300A with CONTENT CLASSIFICATION to explain it, and use constitutional right to distinguish or qualify the conclusion.
...
START / CONCEPT: RIGHT TO PROPERTY: ARTICLE 31 TRANSITION TO ARTICLE 300A
        |
        v
EXACT TERMS: Right To Property · Article 31 Transition To Article 300A · CONTENT CLASSIFICATION · constitutional right · Location · Part III
        |
        v
MECHANISM / ARGUMENT: Article 300A now provides: no person shall be deprived of property save by authority of law.
        |
        v
CONSEQUENCE / CONTRAST: Calling property merely a "legal right" is incomplete.
        |
        v
...
**Technical definition:** Parliament may indemnify persons for acts done in connection with maintenance/restoration of order where martial law was in force and validate sentences or acts.
...
**How to use them:** Use Articles 33-35 to define the issue, connect Martial Law with Constitutional basis to explain it, and use implicit recognition through Article 34; term undefined to distinguish or qualify the conclusion.
...
CONSEQUENCE / CONTRAST: Parliament may determine the extent to which Fundamental Rights are restricted or abrogated for.
        |
        v
UPSC TRAP / ANSWER-USE: Parliament has exclusive legislative competence over specified Part III matters, including.
        |
        v
...
**Technical definition:** Article 358 automatically displaces Article 19 constraints only during war or external-aggression Emergency within its conditions, whereas Article 359 requires a Presidential order suspending court enforcement of specified rights and can never include Articles 20 or 21.
...
**How to use them:** Use Articles 358 to define the issue, connect CONTENT CLASSIFICATION with war or external aggression to explain it, and use Trigger to distinguish or qualify the conclusion.
...
START / CONCEPT: ARTICLES 358 AND 359 - TWO DIFFERENT EMERGENCY MECHANISMS
        |
        v
EXACT TERMS: Articles 358 · CONTENT CLASSIFICATION · war or external aggression · Trigger · Emergency based on war/external aggression · 359 - Two Different Emergency Mechanisms
        |
        v
...
```
### SESSION 27 — ARTICLE 359: THE NON-DEROGABLE ARTICLES 20 AND 21 CORE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Rapid recall: property moved out of Part III; criminal safeguards and life/personal liberty became non-derogable under Article 359.

**Technical definition:** Rapid recall: property moved out of Part III; criminal safeguards and life/personal liberty became non-derogable under Article 359.
...
- **Article 359**
- **The Non-Derogable Articles 20**
- **CONTENT CLASSIFICATION**
- **Rapid recall**
- **Rapid**
- **359**

**How to use them:** Use Article 359 to define the issue, connect The Non-Derogable Articles 20 with CONTENT CLASSIFICATION to explain it, and use Rapid recall to distinguish or qualify the conclusion.
...
START / CONCEPT: ARTICLE 359: THE NON-DEROGABLE ARTICLES 20 AND 21 CORE
        |
        v
EXACT TERMS: Article 359 · The Non-Derogable Articles 20 · CONTENT CLASSIFICATION · Rapid recall · Rapid · 359
        |
        v
MECHANISM / ARGUMENT: Rapid recall: property moved out of Part III; criminal safeguards and life/personal liberty became non-derogable under Article 359.
        |
        v
CONSEQUENCE / CONTRAST: Rapid recall: property moved out of Part III; criminal safeguards and life/personal liberty became non-derogable under Article 359.
        |
        v
UPSC TRAP / ANSWER-USE: Rapid recall: property moved out of Part III; criminal safeguards and life/personal liberty became non-derogable under Article 359.
        |
        v
ANSWER-GRABBING FORMULATION: Rapid recall: property moved out of Part III; criminal safeguards and life/personal liberty became non-derogable under Article 359.
```
### CURRENT-LAW DASHBOARD - SECURELY VERIFIED POSITIONS ONLY
...
### GS-II ANSWER ARCHITECTURE AND QUALIFIED CONCLUSIONS
...
- B. Every right available to all persons necessarily applies directly against private actors.
...
- D. Every invalid part necessarily destroys the entire Act.
...
- B. The 24th Amendment deleted Article 13.
...
- D. Anti-arbitrariness abolished all classification analysis.
...
- A. A residence requirement for State employment made by a State executive order
- B. A title conferred for social service
- C. Preventive detention without statutory authority
...
- A. It applies to private employment generally.
- B. It abolishes the Article 335 efficiency consideration.
- C. It enables the State to reserve appointments/posts for a backward class inadequately represented in State services.
- D. It creates an enforceable individual right to reservation in every service.
...
- A. Article 17 belongs to exploitation; Article 18 abolishes academic degrees.
...
- D. Article 17 covers only government untouchability; national awards are always prohibited.
...
- B. Movement - friendly relations with foreign States under Article 19(2)
...
- A. only the Scheme's administrative circular, not enabling provisions, was invalid.
...
- D. political funding lies wholly outside Article 19(1)(a).
...
- A. Their wording and punishment are identical.
...
- B. It held all offensive speech punishable.
- C. It upheld section 66A but struck down section 69A.
- D. It created a standalone Fundamental Right to internet access.
...
- A. Article 20(2) bars every departmental proceeding after a criminal case.
...
- D. Article 21 does not protect bodily integrity.
...
- B. It applies only to citizens over fourteen.
- C. It was inserted by the Forty-fourth Amendment.
- D. It guarantees university education to every person.
...
- D. Article 26 protects only individuals, not denominations.
...
- A. Any practice asserted by a believer is automatically essential.
- B. ERP eliminates Article 25(2) reform power.
- C. ERP originated in the Sabarimala case.
...
- A. Article 226 cannot reach a private body performing public duty.
...
- D. Article 32 enforces all legal rights; Article 226 only Fundamental Rights.
...
**Explanation:** The judgment rejects both the no-private-resource extreme and the all-private-resource extreme. Surviving Article 31C is tied to 39(a)/(c).
...
- D. Article 359 deletes the specified rights permanently.
...
- A. Article 27 applies only to citizens.
...
- A. Every Article protects companies in exactly the same manner.
...
- C. Citizenship is irrelevant throughout Part III.
- D. Only Article 21 protects non-citizens.
...
- A. Every State may cross it without reasons.
- B. There is no ceiling doctrine at all.
...
- D. The ceiling applies only to EWS.
...
- A. It removed the State's telecom-suspension power entirely.
...
- B. It abolished preventive detention.
- C. It increased the period to six months.
- D. It transferred the power to courts.
...
START / CENTRAL QUESTION
  Enforcement: Article 32 guarantees access to the Supreme Court for Fundamental Rights; Article 226 supplies wider High Court writ power.
        |
        v
+-- SESSION 01: PART III AS AN ARCHITECTURE: RIGHTS, LIMITS, REMEDIES AND SPECIAL CONTROLS
|   DEFINITION / TERMS : Enforcement: Article 32 guarantees access to the Supreme Court for Fundamental Rights; Article 226 supplies wider High Court writ power.
|   MECHANISM / ARGUMENT: Articles 12-13 and 31A-35 are in Part III, but they are not separately counted among the six present Fundamental Rights.
|   CONSEQUENCE / CONTRAST: Part III is not merely a list of entitlements.
|   TRAP / ANSWER-USE: Articles 12-13 and 31A-35 are in Part III, but they are not separately counted among the six present Fundamental Rights.
...
+--
        |
        v
+-- SESSION 02: BENEFICIARIES, VERTICAL AND HORIZONTAL REACH, POSITIVE AND NEGATIVE DUTIES
|   DEFINITION / TERMS : Positive duty: equal protection may require protection from private violence; Article 21 can require legal aid, custodial safeguards and fair investigation; Article 17 requires abolition backed by penal law.
|   MECHANISM / ARGUMENT: Positive duty: equal protection may require protection from private violence; Article 21 can require legal aid, custodial safeguards and fair investigation; Article 17 requires abolition backed by penal law.
|   CONSEQUENCE / CONTRAST: Negative duty: the State must not censor speech outside Article 19(2), discriminate only on prohibited grounds, or deprive liberty through unfair procedure.
...
+--
        |
        v
+-- SESSION 03: QUALIFIED RIGHTS, REASONABLE RESTRICTIONS AND PROPORTIONALITY
|   DEFINITION / TERMS : Always begin with the Article's text; proportionality disciplines the chosen means.
|   MECHANISM / ARGUMENT: Legality: Is the restriction authorised by valid law rather than unsupported executive preference?
|   CONSEQUENCE / CONTRAST: "Reasonable restriction" and proportionality are related but not interchangeable slogans.
|   TRAP / ANSWER-USE: Necessity: Is a less rights-restrictive but equally effective measure available?
...
+--
        |
        v
+-- SESSION 04: ARTICLE 12 - THE STATE AND THE INSTRUMENTALITY INQUIRY
|   DEFINITION / TERMS : Article 12 looks beyond legal form to governmental domination: an entity may be State when its financial, functional and administrative relationship reveals pervasive governmental control, while Article 226 may separately reach a non-State body performing a public duty.
|   MECHANISM / ARGUMENT: The later approach in Pradeep Kumar Biswas asks whether the body is financially, functionally and administratively dominated by or under government control of a pervasive character.
|   CONSEQUENCE / CONTRAST: Therefore, "not State under Article 12" does not always mean "immune from writ jurisdiction.".
|   TRAP / ANSWER-USE: registration as a society or company neither automatically includes nor excludes a body from Article 12.
...
+--
        |
        v
+-- SESSION 05: ARTICLE 13 - LAW, JUDICIAL REVIEW AND THE VOIDNESS DOCTRINES
|   DEFINITION / TERMS : Article 13(1): pre-Constitution laws are void to the extent of inconsistency with Fundamental Rights.
|   MECHANISM / ARGUMENT: Article 13(4): inserted by the Twenty-fourth Amendment; Article 13 does not apply to constitutional amendments under Article 368.
|   CONSEQUENCE / CONTRAST: Article 13(2): the State shall not make law taking away or abridging Fundamental Rights; contravening law is void to the extent of contravention.
|   TRAP / ANSWER-USE: Bhikaji Narain Dhakras explains that a conflicting pre-Constitution law is not erased for all purposes; it lies dormant against the Fundamental Right and can revive if the constitutional shadow is removed.
...
+--
        |
        v
+-- SESSION 06: ARTICLE 14 - TWIN EQUALITY, CLASSIFICATION AND ANTI-ARBITRARINESS
|   DEFINITION / TERMS : Intelligible differentia: the included group must be distinguishable from the excluded group.
|   MECHANISM / ARGUMENT: Intelligible differentia: the included group must be distinguishable from the excluded group.
|   CONSEQUENCE / CONTRAST: These are constitutionally or legally structured immunities, not proof that rule of law is absent.
|   TRAP / ANSWER-USE: A high-scoring answer does not abandon classification for arbitrariness.
|   EXAM OPENING: classification tests the structure of differentiation; arbitrariness tests irrational, capricious or disproportionate State power even where a neat class is difficult to identify.
+--
        |
        v
+-- SESSION 07: ARTICLES 15 AND 16 - NON-DISCRIMINATION AND PROTECTIVE DISCRIMINATION
|   DEFINITION / TERMS : Article 15(4) followed State of Madras v.
|   MECHANISM / ARGUMENT: shops, public restaurants, hotels and places of public entertainment; and wells, tanks, bathing ghats, roads and places of public resort maintained wholly/partly from State funds or dedicated to public use.
|   CONSEQUENCE / CONTRAST: This clause has direct horizontal force.
|   TRAP / ANSWER-USE: Article 15(4) followed State of Madras v.
|   EXAM OPENING: Articles 15(4) and 16(4) are not grudging exceptions to equality.
+--
        |
        v
+-- SESSION 08: RESERVATION DOCTRINE: CREAMY LAYER, CEILING, PROMOTION, EFFICIENCY, EWS AND SC SUB-CLASSIFICATION
|   DEFINITION / TERMS : Efficiency is not a veto owned by the unreserved category.
|   MECHANISM / ARGUMENT: Efficiency is not a veto owned by the unreserved category.
|   CONSEQUENCE / CONTRAST: Do not automatically state that a single identical creamy-layer rule now governs every SC/ST reservation context.
|   TRAP / ANSWER-USE: Jarnail Singh removed the requirement that the State prove backwardness of SCs/STs afresh, while retaining data-based inadequacy and efficiency controls.
...
+--
        |
        v
+-- SESSION 09: ARTICLES 17 AND 18 - ANTI-UNTOUCHABILITY AND ANTI-TITLE GUARANTEES
|   DEFINITION / TERMS : Article 17 is transformative: it does not merely restrain government classification; it constitutionally abolishes a social hierarchy and requires public enforcement.
|   MECHANISM / ARGUMENT: Untouchability is abolished; its practice in any form is forbidden; enforcement of any disability arising from it is an offence punishable by law.
|   CONSEQUENCE / CONTRAST: Article 17 is transformative: it does not merely restrain government classification; it constitutionally abolishes a social hierarchy and requires public enforcement.
...
+--
        ...
        v
+-- SESSION 10: ARTICLE 19 - SIX FREEDOMS AND EXACT RESTRICTION GROUNDS
|   DEFINITION / TERMS : The restrictions must be imposed by law and be reasonable.
|   MECHANISM / ARGUMENT: The restrictions must be imposed by law and be reasonable.
|   CONSEQUENCE / CONTRAST: "Offensiveness", administrative convenience or vague hurt sentiment is not an independent Article 19(2) ground.
|   TRAP / ANSWER-USE: The right to form an association does not automatically include a right to government recognition or to achieve every object of the association.
...
+--
        ...
        v
+-- SESSION 11: SPEECH, PRESS, RIGHT TO KNOW AND THE FIRST AMENDMENT SETTLEMENT
|   DEFINITION / TERMS : The First Amendment both widened the State's grounds and strengthened judicial control through the reasonableness requirement.
|   MECHANISM / ARGUMENT: The First Amendment both widened the State's grounds and strengthened judicial control through the reasonableness requirement.
|   CONSEQUENCE / CONTRAST: Do not quote them as if present Article 19(2) lacked "public order.".
|   TRAP / ANSWER-USE: inserted the word reasonable before restrictions; added public order, friendly relations with foreign States and incitement to an offence; and responded to the 1950 decisions.
|   EXAM OPENING: State of Madras (1950): circulation is part of speech; the ban failed under the original narrow Article 19(2).
+--
        |
        v
+-- SESSION 12: SEDITION LINEAGE, BNS SECTION 152 AND SPEECH-INCITEMENT DISCIPLINE
|   DEFINITION / TERMS : The Supreme Court upheld IPC section 124A only by reading it down to speech involving incitement to violence or a tendency/intention to create public disorder.
|   MECHANISM / ARGUMENT: [CURRENT] BNS section 152 targets purposeful/knowing acts through words, signs, visible representation, electronic communication, financial means or otherwise that.
|   CONSEQUENCE / CONTRAST: The Supreme Court upheld IPC section 124A only by reading it down to speech involving incitement to violence or a tendency/intention to create public disorder.
|   TRAP / ANSWER-USE: "sedition was simply renamed" is inaccurate; and "all sedition-type criminalisation disappeared" is also inaccurate.
|   EXAM OPENING: On 11 May 2022, the Supreme Court placed use of IPC section 124A in abeyance while reconsideration occurred.
+--
        |
        v
+-- SESSION 13: DIGITAL SPEECH: SHREYA SINGHAL, INTERNET SHUTDOWNS AND CRIMINAL DEFAMATION
|   DEFINITION / TERMS : A critical answer should still note the chilling effect, criminal-process burden and availability of civil remedies, while accurately stating the binding holding.
|   MECHANISM / ARGUMENT: struck down IT Act section 66A for vagueness and overbreadth; distinguished protected discussion and advocacy from punishable incitement; upheld section 69A blocking power because of its structured safeguards; and read down intermediary liability under section 79 so "actual knowledge" was tied to court/government process.
|   CONSEQUENCE / CONTRAST: A critical answer should still note the chilling effect, criminal-process burden and availability of civil remedies, while accurately stating the binding holding.
|   TRAP / ANSWER-USE: publication of restriction orders; proportionality review; periodic review; rejection of indefinite suspension; and careful use of section 144-type powers.
|   EXAM OPENING: [CURRENT] The current criminal provision is BNS section 356, not the repealed IPC sections 499-500.
+--
        |
        v
+-- SESSION 14: ARTICLE 20 - EX POST FACTO LAW, DOUBLE JEOPARDY AND SELF-INCRIMINATION
|   DEFINITION / TERMS : Article 20 creates three person-protective criminal shields against retrospective penal liability, repeated prosecution-and-punishment for the same offence, and compelled testimonial self-incrimination.
|   MECHANISM / ARGUMENT: Article 20(3) is not a blanket right to suppress every material derived from the body.
|   CONSEQUENCE / CONTRAST: No person may be convicted for an act that was not an offence when done.
|   TRAP / ANSWER-USE: Departmental proceedings are not automatically a prior criminal prosecution.
...
+--
        ...
        v
+-- SESSION 15: ARTICLE 21 - GOPALAN TO MANEKA: FAIR PROCEDURE AND THE DIGNITY CHARTER
|   DEFINITION / TERMS : Article 21 became a dignity charter when Maneka Gandhi required fair, just and reasonable procedure and linked liberty with Articles 14 and 19, enabling named protections without turning every policy aspiration into an unlimited entitlement.
|   MECHANISM / ARGUMENT: India did not textually replace "procedure established by law" with the American phrase "due process." The exam-safe formulation is that Maneka imported a due-process standard of fairness and non-arbitrariness.
|   CONSEQUENCE / CONTRAST: The qualification is equally important: named rights often secure fair process and minimum protection, not an unlimited judicially supplied welfare entitlement.
|   TRAP / ANSWER-USE: Maneka Gandhi (1978) completed the turn: procedure must be fair, just and reasonable, and Articles 14, 19 and 21 interlock.
...
+--
        ...
        v
+-- SESSION 16: PRIVACY, PROPORTIONALITY, DNA TESTING AND DATA PROTECTION
|   DEFINITION / TERMS : [CURRENT] The Digital Personal Data Protection Act, 2023 supplies a statutory framework for digital personal data processing, consent/legitimate uses, data-principal rights, data-fiduciary obligations and enforcement.
|   MECHANISM / ARGUMENT: A nine-judge Bench held unanimously that privacy is a Fundamental Right protected as an intrinsic part of life and personal liberty under Article 21 and as part of the freedoms guaranteed by Part III.
|   CONSEQUENCE / CONTRAST: Notification is not full implementation: informational privacy remains constitutionally reviewable under Puttaswamy.
|   TRAP / ANSWER-USE: Courts do not order it as a routine fishing inquiry.
|   EXAM OPENING: 843(E), as of 21 August 2026 the definition and Data Protection Board/institutional provisions specified in the notification are operative.
+--
        |
        v
+-- SESSION 17: ARTICLE 21A - EDUCATION AS A FUNDAMENTAL RIGHT
|   DEFINITION / TERMS : recast Article 45 toward early childhood care and education below six years; and added Article 51A(k), a parental/guardian duty to provide educational opportunity to children aged six to fourteen.
|   MECHANISM / ARGUMENT: recast Article 45 toward early childhood care and education below six years; and added Article 51A(k), a parental/guardian duty to provide educational opportunity to children aged six to fourteen.
|   CONSEQUENCE / CONTRAST: Article 21A demonstrates a shift from judge-developed Article 21 content to an express, age-bounded Fundamental Right implemented by statute.
|   TRAP / ANSWER-USE: Article 21A demonstrates a shift from judge-developed Article 21 content to an express, age-bounded Fundamental Right implemented by statute.
|   EXAM OPENING: Article 21A demonstrates a shift from judge-developed Article 21 content to an express, age-bounded Fundamental Right implemented by statute.
+--
        |
        v
+-- SESSION 18: ARTICLE 22 - ORDINARY ARREST, PREVENTIVE DETENTION AND THE UNENFORCED 44TH AMENDMENT CLAUSE
|   DEFINITION / TERMS : Article 22 separates ordinary arrest from preventive detention: the first carries grounds, counsel and twenty-four-hour production safeguards, while the second follows a distinct regime whose current no-Advisory-Board ceiling remains three months.
|   MECHANISM / ARGUMENT: Beyond that, an Advisory Board must report sufficient cause, subject to parliamentary law under clauses (4)-(7).
|   CONSEQUENCE / CONTRAST: This does not mean preventive detainees have no constitutional protection.
|   TRAP / ANSWER-USE: Clauses (1) and (2) do not apply to.
...
+--
        ...
        v
+-- SESSION 19: ARTICLES 23-24 - EXPLOITATION, FORCED LABOUR AND CHILD LABOUR
|   DEFINITION / TERMS : Union of India (Asiad Workers), payment below the legal minimum in conditions of economic compulsion could amount to forced labour.
|   MECHANISM / ARGUMENT: Union of India (Asiad Workers), payment below the legal minimum in conditions of economic compulsion could amount to forced labour.
|   CONSEQUENCE / CONTRAST: Article 24's text is narrower than a complete ban on every kind of child work, while the amended statute creates broader prohibitions and defined exceptions.
|   TRAP / ANSWER-USE: Article 24's text is narrower than a complete ban on every kind of child work, while the amended statute creates broader prohibitions and defined exceptions.
|   EXAM OPENING: Article 24's text is narrower than a complete ban on every kind of child work, while the amended statute creates broader prohibitions and defined exceptions.
+--
        |
        v
+-- SESSION 20: ARTICLES 25-28 - CONSCIENCE, DENOMINATION, SECULAR REGULATION AND PRINCIPLED DISTANCE
|   DEFINITION / TERMS : identify whether the claimant is an individual or denomination; distinguish religious practice from associated secular activity; examine essentiality where the doctrine is invoked; apply public order, morality, health, reform and other-FR limits; and state the criticism that secular judges may become arbiters of theology.
|   MECHANISM / ARGUMENT: Propagation is not a right to convert another person by force, fraud or allurement.
|   CONSEQUENCE / CONTRAST: A bounded official-source check through 21 August 2026 located no final later decision that this package can securely use; it therefore states only the 2018 majority holding and does not speculate about the review/reference.
|   TRAP / ANSWER-USE: Article 27 distinguishes a tax for religious promotion from a regulatory fee or a general tax whose expenditure may incidentally benefit religious institutions.
...
+--
        ...
        v
+-- SESSION 21: ARTICLES 29-30 - CULTURAL CONSERVATION AND MINORITY EDUCATIONAL AUTONOMY
|   DEFINITION / TERMS : acquisition law must not make the Article 30(1) guarantee illusory; State aid cannot discriminate merely because the institution is minority-managed; and regulation for academic standards, sanitation, teacher qualifications, fairness and excellence can be valid.
|   MECHANISM / ARGUMENT: acquisition law must not make the Article 30(1) guarantee illusory; State aid cannot discriminate merely because the institution is minority-managed; and regulation for academic standards, sanitation, teacher qualifications, fairness and excellence can be valid.
|   CONSEQUENCE / CONTRAST: Aided minority institutions retain Article 30 identity but cannot treat State aid as a licence to ignore every admission-related constitutional obligation.
|   TRAP / ANSWER-USE: Xavier's College and Malankara Syrian Catholic College: regulatory excellence is valid, but the State cannot destroy the minority management's core.
...
+--
        ...
        v
+-- SESSION 22: ARTICLE 32 AND THE FIVE WRITS
|   DEFINITION / TERMS : "Supreme Court cannot refuse Article 32" does not mean every petition must receive final relief despite alternate remedy, disputed facts or absence of a Fundamental Right.
|   MECHANISM / ARGUMENT: "Supreme Court cannot refuse Article 32" does not mean every petition must receive final relief despite alternate remedy, disputed facts or absence of a Fundamental Right.
|   CONSEQUENCE / CONTRAST: It means the constitutional guarantee cannot be abolished or reduced to ordinary legislative grace.
|   TRAP / ANSWER-USE: Detailed PIL growth, epistolary jurisdiction and institutional criticism are cross-linked to Polity 18.
...
+--
        ...
        v
+-- SESSION 23: ARTICLES 31A, 31B AND 31C - SAVING PROVISIONS WITHOUT BLANKET IMMUNITY
|   DEFINITION / TERMS : Articles 31A-31C, 33-35 create defined constitutional controls rather than rights-free zones: their field, purpose and legislative competence remain text-bound and subject to basic-structure review where applicable.
|   MECHANISM / ARGUMENT: Do not say Article 39(b) converts all private property into community property.
|   CONSEQUENCE / CONTRAST: It is not a general immunity for every property-related law.
|   TRAP / ANSWER-USE: Ninth Schedule placement is not absolute immunity after I.R. Coelho.
...
+--
        ...
        v
+-- SESSION 24: RIGHT TO PROPERTY: ARTICLE 31 TRANSITION TO ARTICLE 300A
|   DEFINITION / TERMS : Article 300A now provides: no person shall be deprived of property save by authority of law.
|   MECHANISM / ARGUMENT: Article 300A now provides: no person shall be deprived of property save by authority of law.
|   CONSEQUENCE / CONTRAST: Calling property merely a "legal right" is incomplete.
|   TRAP / ANSWER-USE: Article 300A is a constitutional right, though not a Fundamental Right.
|   EXAM OPENING: Article 300A is a constitutional right, though not a Fundamental Right.
+--
        |
        v
+-- SESSION 25: ARTICLES 33-35 AND MARTIAL LAW
|   DEFINITION / TERMS : Parliament may indemnify persons for acts done in connection with maintenance/restoration of order where martial law was in force and validate sentences or acts.
|   MECHANISM / ARGUMENT: Parliament may indemnify persons for acts done in connection with maintenance/restoration of order where martial law was in force and validate sentences or acts.
|   CONSEQUENCE / CONTRAST: Parliament may determine the extent to which Fundamental Rights are restricted or abrogated for.
|   TRAP / ANSWER-USE: Parliament has exclusive legislative competence over specified Part III matters, including.
|   EXAM OPENING: Martial law does not automatically erase habeas corpus or create unlimited military power.
+--
        |
        v
+-- SESSION 26: ARTICLES 358 AND 359 - TWO DIFFERENT EMERGENCY MECHANISMS
|   DEFINITION / TERMS : Article 358 automatically displaces Article 19 constraints only during war or external-aggression Emergency within its conditions, whereas Article 359 requires a Presidential order suspending court enforcement of specified rights and can never include Articles 20 or 21.
|   MECHANISM / ARGUMENT: During a National Emergency based on war or external aggression, Article 19 does not restrict State power to make/take otherwise inconsistent law/executive action within Article 358's conditions.
|   CONSEQUENCE / CONTRAST: the specified right is not textually deleted; its judicial enforcement is suspended; Articles 20 and 21 cannot be included; the order must identify the rights and duration/area; and Article 359(1A) contains law/action protections with constitutional conditions.
|   TRAP / ANSWER-USE: "All Fundamental Rights are automatically suspended in Emergency" is wrong.
...
+--
        ...
        v
+-- SESSION 27: ARTICLE 359: THE NON-DEROGABLE ARTICLES 20 AND 21 CORE
|   DEFINITION / TERMS : Rapid recall: property moved out of Part III; criminal safeguards and life/personal liberty became non-derogable under Article 359.
|   MECHANISM / ARGUMENT: Rapid recall: property moved out of Part III; criminal safeguards and life/personal liberty became non-derogable under Article 359.
|   CONSEQUENCE / CONTRAST: Rapid recall: property moved out of Part III; criminal safeguards and life/personal liberty became non-derogable under Article 359.
|   TRAP / ANSWER-USE: Rapid recall: property moved out of Part III; criminal safeguards and life/personal liberty became non-derogable under Article 359.
|   EXAM OPENING: Rapid recall: property moved out of Part III; criminal safeguards and life/personal liberty became non-derogable under Article 359.
+--
        |
        v
