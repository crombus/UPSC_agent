...
**Plain-language definition:** India has no single comprehensive political-parties code.

**Technical definition:** Plain-language definition: Political parties are voluntary associations that aggregate interests, contest elections, recruit leaders and coordinate government or opposition.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India has no single comprehensive political-parties code.

#### MUST-WRITE KEYWORDS

- **Political-Party Core Idea**
- **Plain-language definition**
- **Technical definition**
- **Section 29A, RPA 1951**
- **Election Symbols Order 1968**
- **Sections 29B-29C and connected laws**

**How to use them:** Frame the answer through Political-Party Core Idea; define Plain-language definition, connect Technical definition with Section 29A, RPA 1951 to explain the mechanism, and use Election Symbols Order 1968 for the decisive comparison or qualification.
...
START / CONCEPT: POLITICAL-PARTY CORE IDEA
        |
        v
EXACT TERMS: Political-Party Core Idea · Plain-language definition · Technical definition · Section 29A, RPA 1951 · Election Symbols Order 1968 · Sections 29B-29C and connected laws
        |
        v
MECHANISM / ARGUMENT: Plain-language definition: Political parties are voluntary associations that aggregate interests, contest elections, recruit leaders and coordinate government or opposition.
        |
        v
CONSEQUENCE / CONTRAST: This creates internal-democracy and coordination gaps, but it does not authorise the ECI to invent unlimited supervisory or deregistration powers.
        |
        v
UPSC TRAP / ANSWER-USE: Technical definition: They are not constitutional organs.
        |
        v
ANSWER-GRABBING FORMULATION: India has no single comprehensive political-parties code.
```
