...
```text
START / CONCEPT: CORE IDEA
        |
        v
EXACT TERMS: multi-party system · "Congress system" · ECI · national/state · poll performance · reserved symbol
        |
        v
...
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the decisive contrast is between India has a multi-party system (largest in the world)...
        |
        v
ANSWER-GRABBING FORMULATION: Core idea denotes the constitutional rules and institutional links organised around India has a multi-party system (largest in the world) that evolved from the "Congress system" to competitive.
```
...
START / CONCEPT: DEMAND AND DIRECTIVE MAP
        |
        v
EXACT TERMS: Demand · Directive Map · Constitutional/statutory basis of parties · Party finance & transparency · "money power", "electoral bonds", "opacity", Critically examine · Criminalisation of politics
        |
        v
...
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the decisive contrast is between Demand family Typical directive signals Answer spine to use...
        |
        v
ANSWER-GRABBING FORMULATION: 5.1 Demand and directive map denotes the constitutional rules and institutional links organised around Demand family Typical directive signals Answer spine to use.
```
...
START / CONCEPT: PRELIMS CLOSE-OPTION DISTINCTIONS
        |
        v
EXACT TERMS: Prelims Close-Option Distinctions · Section 29A, RPA 1951 · not · Tenth Schedule · anti-defection · Election Symbols (Reservation and Allotment) Order, 1968
        |
        v
MECHANISM / ARGUMENT: 5.10 Prelims close-option distinctions denotes the constitutional rules and institutional links organised around Confusion pair Correct discrimination.
        |
        v
CONSEQUENCE / CONTRAST: Its principal consequence is that RPA Section 77 permits 40 star campaigners for a recognised political party and 20 for another political party.
        |
        v
UPSC TRAP / ANSWER-USE: The decisive contrast is between Lily Thomas (2013) Struck Sec 8(4) RPA → immediate disqualification of convicted sitting members; it is not the electoral-bonds case and Electoral-bonds case ADR v.
        |
        v
ANSWER-GRABBING FORMULATION: 5.10 Prelims close-option distinctions operates through Where parties are registered Section 29A, RPA 1951 (a statute) — not the Constitution, connected with Where parties are first named in the Constitution The Tenth Schedule (52nd Amendment, 1985), for anti-defection only.
```
...
> Democratic functions and the missing comprehensive party code denotes the constitutional rules and institutional links organised around Political parties link citizens to government through representation,.
...
START / CONCEPT: DEMOCRATIC FUNCTIONS AND THE MISSING COMPREHENSIVE PARTY CODE
        |
        v
EXACT TERMS: Democratic Functions · The Missing Comprehensive Party Code · Article 19 · Democratic functions and the missing comprehensive party code · Democratic · Political
        |
        v
...
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that tenth Schedule later constitutionalised a narrow defection relationship.
        |
        v
ANSWER-GRABBING FORMULATION: Democratic functions and the missing comprehensive party code denotes the constitutional rules and institutional links organised around Political parties link citizens to government through representation,.
```
