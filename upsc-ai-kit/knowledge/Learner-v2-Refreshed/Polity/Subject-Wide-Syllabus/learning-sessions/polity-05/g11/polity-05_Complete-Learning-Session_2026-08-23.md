...
- C. Approval by the Supreme Court under Article 143

- D. Prior ratification by at least half the States
...
- A. the President may abolish a State by ordinance

- B. Union Territories are treated as States for all constitutional purposes

- C. for clauses (a) to (e), 'State' includes a Union Territory, but not in the proviso requiring legislature-reference

- D. States and UTs have identical representation in Rajya Sabha
...
- A. Hyderabad was a Part A State

- B. Manipur and Tripura were Part B States

- C. Delhi was the sole Part D territory
...
- A. The First Schedule did not require amendment

- B. Only West Bengal's territorial entry was affected

- C. India transferred 51 enclaves and received 111 under the Ninth Amendment alone
...
- A. Pondicherry -> Lakshadweep, 2006

- B. United Provinces -> Uttar Pradesh, 1950

- C. Mysore -> Tamil Nadu, 1973

- D. Orissa -> Odisha, 2000
...
- A. 9 Part A and 9 Part B States

- B. 16 States and 3 UTs

- C. 14 States and 6 UTs

- D. 28 States and 8 UTs
...
- A. the President may validate acquisition by ordinance
- B. contemporary international law and the UN Charter sharply constrain acquisition by force
- C. acquired territory must immediately become a full State
- D. conquest remains unrestricted whenever Parliament passes an Article 3 law
...
- A. Integration began only after the States Reorganisation Act, 1956
...
- A. Manipur 18th, Tripura 19th, Meghalaya 20th
- B. Telangana 28th, Jharkhand 29th
- C. Gujarat 15th, Nagaland 16th, Haryana 17th
- D. Haryana 16th, Nagaland 17th, Himachal Pradesh 18th
...
- A. Topic boundaries are irrelevant because all three topics are identical
- B. Topic 05 owns every detail of Lieutenant-Governor administration
...
- D. Topic 22 owns the complete Article 3 chronology
...
- A. First Schedule changes are done only by executive notification

- B. Rajya Sabha approval replaces Parliament's ordinary law-making process

- C. The First Schedule can never be changed
...
- A. Article 1 alone authorises State creation

- B. Article 2 applies because Telangana had a separate movement

- C. Telangana was formed from an existing State, so Article 3 was the relevant territorial power

- D. Article 368 alone applies whenever a new State is created
...
- D. Berubari is a State-creation case; the 1969 principle is a renaming rule
...
- A. The question was dropped

- B. Tripura was never a Part C unit
...
#### ASCII MASTER FLOW — PANEL 1/8: Union and Territory: central question and analytical axes

```ascii-master
UNION AND TERRITORY — CONCEPTUAL ATLAS


KEY TERMS: Constitutional Conception • Why Article 1 Says 'Union Of States' • Article 1 •
KEY TERMS: Article 3 • India • CONSTITUTIONAL CONCEPTION: WHY ARTICLE…
                         CENTRAL QUESTION / ROOT
        How should the complete structure of Union and Territory
        be defined, related, compared and evaluated?
                                  │
                                  ▼
                       "Indestructible Union of destructible States" is a powerful…
                                  │
          ┌───────────────────────┼───────────────────────┐
          ▼                       ▼                       ▼
AXIS 1: CONSTITUTIONAL CONCEPTION: WHY ARTICLE 1 SAYS 'UNION OF STATES'
  • Constitutional Conception
  • India is not unitary because powers are constitutionally…
AXIS 2: ARTICLE 4: SUPPLEMENTAL, INCIDENTAL AND CONSEQUENTIAL PROVISIONS…
  • Article 4
  • Article 4(1) allows a law under Articles 2 or 3 to do more than…
AXIS 3: LINGUISTIC REORGANISATION: DHAR, JVP, ANDHRA AND THE FAZL ALI /…
  • Linguistic Reorganisation
  • After Potti Sriramulu's death following a prolonged fast, Andhra…
          └───────────────────────┼───────────────────────┘
                                  ▼
                         CROSS-PANEL CONTROL
  Constitutional Conception • Why Article 1 Says 'Union Of States' • Article 1 • Article 3
                                  │
                                  ▼
          Definition → relation → mechanism → comparison → verdict
```

#### ASCII MASTER FLOW — PANEL 2/8: Union of States and Articles 1–4 architecture

```ascii-master
UNION OF STATES AND ARTICLES 1–4 ARCHITECTURE
│
...
│   └── India
│
├── CONSTITUTIONAL CONCEPTION: WHY ARTICLE 1 SAYS 'UNION OF STATES'
│   ├─ TERMS: "Indestructible Union of destructible States" is a powerful…
│   ├─ LOGIC: India is not unitary because powers are constitutionally distributed
│   └─ RESULT: "Indestructible Union of destructible States" is a powerful…
├── ARTICLES 1 TO 4 CLAUSE-BY-CLAUSE: THE CONSTITUTIONAL…
│   ├─ TERMS: The schedule is the formal list of State and Union Territory names…
│   ├─ LOGIC: Article 1(1) also captures the famous naming compromise: "India"…
│   └─ RESULT: The schedule is the formal list of State and Union Territory names…
├── ARTICLE 2 AND ARTICLE 3 ARE NOT THE SAME POWER
│   ├─ TERMS: Article 3 is conceptually about internal readjustment among units…
│   ├─ LOGIC: Explanation II says that clause (a) includes the power to form a…
│   └─ RESULT: Do not force uncertain examples of Article 2 when the safer…
│
└── CONVERGENCE
...
#### ASCII MASTER FLOW — PANEL 3/8: Article 3 procedure, Article 4 consequence and First Schedule

```ascii-master
ARTICLE 3 PROCEDURE, ARTICLE 4 CONSEQUENCE AND FIRST SCHEDULE


KEY TERMS: Article 3 Procedure • Consultation Without Consent • Article 3 • Article 4 •
KEY TERMS: Article • ARTICLE 3 PROCEDURE: CONSULTATION…
STAGE 01  ARTICLE 3 PROCEDURE: CONSULTATION WITHOUT CONSENT
  ├─ CONDITION / TERM: Article 3 does not permit a free-floating private or
  ├─ CONDITION / TERM: ordinary parliamentary initiative
  ├─ CHANGE / MECHANISM: The constitutional formula is consultation without
  ├─ CHANGE / MECHANISM: consent
  └─ OUTCOME: Article 3 does not permit a free-floating private or ordinary…
                  │
                  ▼
STAGE 02  ARTICLE 4: SUPPLEMENTAL, INCIDENTAL AND CONSEQUENTIAL PROVISIONS…
  ├─ CONDITION / TERM: Article 4 is the constitutional lubricant of reorganisation
  ├─ CHANGE / MECHANISM: Article 4(1) allows a law under Articles 2 or 3 to do
  ├─ CHANGE / MECHANISM: more than…
  └─ OUTCOME: Article 4 does not erase the sovereignty line
                  │
                  ▼
STAGE 03  THE FIRST SCHEDULE AS A LIVING TERRITORIAL LEDGER
  ├─ CONDITION / TERM: Whenever a unit is created, renamed, merged, split or
  ├─ CONDITION / TERM: ceded, the…
  ├─ CHANGE / MECHANISM: Whenever a unit is created, renamed, merged, split or
  ├─ CHANGE / MECHANISM: ceded, the…
  └─ OUTCOME: The schedule's exam value is twofold: it anchors territorial facts…
                  │
                  ▼
SEQUENCE CONTROL: chronology is evidence-led, not a bare dynasty/date list.
```

#### ASCII MASTER FLOW — PANEL 4/8: Acquisition/cession, Berubari and boundary-settlement doctrine

```ascii-master
ACQUISITION/CESSION, BERUBARI AND BOUNDARY-SETTLEMENT DOCTRINE


KEY TERMS: Acquisition • Cession • Boundary Settlement • Berubari • The 1969 Distinction •
KEY TERMS: The 100Th Amendment
CAUSE / CONDITION 1: The sovereignty test separates cession from boundary…
          │
          ├── MECHANISM
          │   A modern answer must qualify the historical list: contemporary…
          │
          └── EFFECT / CONTRAST
              In a later 1969 ruling, the Supreme Court distinguished a boundary…
          │
          ▼
CAUSE / CONDITION 2: West Bengal is not the governing authority for cession or the…
          │
          ├── MECHANISM
          │   West Bengal is not the governing authority for cession or the…
          │
          └── EFFECT / CONTRAST
              States were not treated as sovereign entities possessing a residual…
          │
          ▼
CAUSE / CONDITION 3: Hyderabad, Junagadh and Jammu and Kashmir are highlighted…
          │
          ├── MECHANISM
          │   Hyderabad, Junagadh and Jammu and Kashmir are highlighted because…
          │
          └── EFFECT / CONTRAST
              India was divided into Part A, Part B, Part C and Part D units…
          │
          ▼
SYSTEM RESULT: causes interact; mechanism explains why the outcome follows.
```

#### ASCII MASTER FLOW — PANEL 5/8: Integration, linguistic reorganisation and post-1956 state creation

```ascii-master
INTEGRATION, LINGUISTIC REORGANISATION AND POST-1956 STATE CREATION


KEY TERMS: Linguistic Reorganisation • Dhar • Jvp • Andhra • The Fazl Ali / Src Settlement •
KEY TERMS: Kerala combined Travancore-Cochin…
CAUSE / CONDITION 1: The States Reorganisation Act, 1956 and the Seventh Amendment…
          │
          ├── MECHANISM
          │   After Potti Sriramulu's death following a prolonged fast, Andhra…
          │
          ...
          │
          ▼
CAUSE / CONDITION 2: Reorganisation after 1956 proves that Article 3 is not a…
          │
          ├── MECHANISM
          │   Goa, Daman and Diu, after the end of Portuguese rule in December…
          │
          └── EFFECT / CONTRAST
              Reorganisation after 1956 proves that Article 3 is not a one-time…
          │
          ▼
CAUSE / CONDITION 3: The presence of a UT legislature does not convert that…
          │
          ├── MECHANISM
          │   Explanation II says the clause (a) power includes forming a new…
          │
          └── EFFECT / CONTRAST
              Explanation I says that "State" includes a Union Territory for…
          │
          ▼
SYSTEM RESULT: causes interact; mechanism explains why the outcome follows.
```

#### ASCII MASTER FLOW — PANEL 6/8: J&K, new-state demands, federal consent and territorial integrity

```ascii-master
J&K, NEW-STATE DEMANDS, FEDERAL CONSENT AND TERRITORIAL INTEGRITY


KEY TERMS: J&K Reorganisation As An Article 3… • Topic 05 owns • Topic 25 owns • Topic 22
KEY TERMS: owns • Article 370 • Article 3
                 CLAIM / SYSTEM UNDER EXAMINATION
                                  │
                                  ▼
PROBLEM / OBJECTION 1
  ├─ ISSUE: Its detailed subject competence, Lieutenant-Governor relationship…
  ├─ RESPONSE / CONTROL: Justice Sanjiv Khanna's concurrence stressed that
  ├─ RESPONSE / CONTROL: State-to-UT…
  └─ QUALIFIED VERDICT: The Jammu and Kashmir Reorganisation Act, 2019 took effect
  └─ QUALIFIED VERDICT: on 31…
                  │
                  ▼
PROBLEM / OBJECTION 2
  ├─ ISSUE: qualified verdict: smaller is not automatically better
  ├─ RESPONSE / CONTROL: Test every demand against democratic support across
  ├─ RESPONSE / CONTROL: affected…
  └─ QUALIFIED VERDICT: Statehood can improve representation and focus, but
  └─ QUALIFIED VERDICT: without…
                  │
                  ▼
PROBLEM / OBJECTION 3
  ├─ ISSUE: Prelims traps to recite before any objective question: Article 2 is…
  ├─ RESPONSE / CONTROL: Because affected States cannot stop reorganisation, and
  ├─ RESPONSE / CONTROL: because UT…
  └─ QUALIFIED VERDICT: India's territorial Constitution works best when
  └─ QUALIFIED VERDICT: parliamentary…
                                  │
                                  ▼
FINAL CONTROL: preserve the strongest insight while stating its limit.
```

#### ASCII MASTER FLOW — PANEL 7/8: Union and Territory: traps, PYQ routes and applied recall

```ascii-master
UNION AND TERRITORY: TRAPS, PYQ ROUTES AND APPLIED RECALL
...
├── "Union of States" means a unitary State
├── that is why different kinds of legal instruments change the same…
├── the States Reorganisation Act, 1956 and the Seventh Amendment…
├── Prelims traps to recite before any objective question: Article 2 is…
│
├── PYQ provenance audit
├── PYQ Verification status Treatment in this package
├── [LIMIT] Repository-wide searches of every 2018–2026 central PYQ routing and…
├── no additional directly relevant verified PYQ for this topic
│
└── India is a constitutionally indestructible Union whose internal…
└── Use the case for the strong-Centre thesis, especially when you need…
└── Article 3 is a centralising safety valve: its flexibility can…
                                  │
                                  ▼
CONTROL: identify demand → select exact evidence → expose trap → qualify.
```

#### ASCII MASTER FLOW — PANEL 8/8: Union and Territory: integrated revision and answer-writing spine

```ascii-master
UNION AND TERRITORY — ANSWER / REVISION SPINE
...
3. EXPLAIN THE MECHANISM / ARGUMENT / CAUSAL LINK
   └─ Whenever a unit is created, renamed, merged, split or ceded, the…
                  │
                  ▼
