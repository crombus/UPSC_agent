...
topic_key: polity-11
cover_image: assets/polity-11_Teaching-Navigation_2026-08-24.png
---
# Parliamentary System — Complete Uncompressed Learning Session
...
- [CURRENT] **Six-month live official anchor, accessed 24 August 2026:** the Cabinet Secretariat states that it administers the Transaction of Business and Allocation of Business Rules, assists the Cabinet and Cabinet Committees, and coordinates ministries. This anchors how Cabinet government operates institutionally; it does not alter Articles 74-75 or parliamentary responsibility.
- [CURRENT] Digital Sansad was also accessed on 24 August 2026. The package retains the previously verified status that the 129th Amendment Bill remains a committee-stage proposal; proposed Article 82A is not current constitutional text.
...
![Refreshed teaching navigation](assets/polity-11_Teaching-Navigation_2026-08-24.png)
...
> “Cabinet government” may name the constitutional form, while “cabinet dominance” or “prime-ministerial government” are later analytical claims about the internal distribution of power.
...
```closure-flow
SUBTOPIC: Definition: classify government by the executive-legislature relationship
KEY TERMS / DEFINITIONS: classify government by the executive-legislature relationship · parliamentary government · presidential government · responsibility, tenure and institutional relationship · Core thesis · Executive survives through lower-House confidence
...
ANSWER-GRABBING FORMULATION: “Cabinet government” may name the constitutional form, while “cabinet dominance” or “prime-ministerial government” are later analytical claims about the internal distribution of power.
```
...
```closure-flow
SUBTOPIC: Constitutional architecture at Union and State levels
KEY TERMS / DEFINITIONS: Constitutional architecture at Union · aid and advise · once · whether any, and if so what, advice · Collective responsibility · Individual responsibility
...
> Courts may review the action on constitutional grounds while Article 74(2) protects the advice itself from inquiry.
...
```closure-flow
SUBTOPIC: Nominal and real executive: form, advice and accountability
KEY TERMS / DEFINITIONS: Nominal · real executive · form · advice · accountability · nominal, de jure or formal executive
...
ANSWER-GRABBING FORMULATION: Courts may review the action on constitutional grounds while Article 74(2) protects the advice itself from inquiry.
```
...
> The President is normally a nominal executive, but bounded discretion and information rights prevent the office from becoming constitutionally irrelevant.
...
```closure-flow
SUBTOPIC: The eight classic features: mechanism plus caveat
KEY TERMS / DEFINITIONS: The eight classic features · mechanism plus caveat · majority support · Article 75 · Article 78 · Caveat
...
ANSWER-GRABBING FORMULATION: The President is normally a nominal executive, but bounded discretion and information rights prevent the office from becoming constitutionally irrelevant.
```
...
> In the Article 356 context, legislative majority should ordinarily be tested on the Assembly floor rather than inferred from subjective claims outside the House; proclamation material is judicially reviewable.
...
**How to use them:** Frame the answer through Collective responsibility as the bedrock; define Lok Sabha, connect supply with every to explain the mechanism, and use Confidence for the decisive comparison or qualification.
...
```closure-flow
SUBTOPIC: Collective responsibility as the bedrock
KEY TERMS / DEFINITIONS: Collective responsibility as the bedrock · Lok Sabha · supply · every · Confidence · Solidarity
...
ANSWER-GRABBING FORMULATION: In the Article 356 context, legislative majority should ordinarily be tested on the Assembly floor rather than inferred from subjective claims outside the House; proclamation material is judicially reviewable.
```
...
> Secretaries are accountable within the executive and subject to oversight, law and confirmation structures, but the President's tenure does not depend on lower-House confidence.
...
```closure-flow
SUBTOPIC: Parliamentary versus presidential government: exact axes
KEY TERMS / DEFINITIONS: Parliamentary versus presidential government · exact axes · Kitchen cabinet · Executive structure · Dual: formal head plus real ministry · Single political executive combines head of State/government roles
...
ANSWER-GRABBING FORMULATION: Secretaries are accountable within the executive and subject to oversight, law and confirmation structures, but the President's tenure does not depend on lower-House confidence.
```
...
> India chose a responsible executive dependent on legislative confidence because continuous accountability and coordination were preferred to an independently fixed presidential tenure.
...
```closure-flow
SUBTOPIC: Why India adopted the parliamentary system
KEY TERMS / DEFINITIONS: Why India adopted the parliamentary system · Qualified verdict · Limited · The defensible point · K.M · This
...
ANSWER-GRABBING FORMULATION: India chose a responsible executive dependent on legislative confidence because continuous accountability and coordination were preferred to an independently fixed presidential tenure.
```
...
> India experienced several short-lived Union governments in the late 1970s, 1989-91 and 1996-98, demonstrating the instability risk.
...
```closure-flow
SUBTOPIC: Merits, demerits and the Indian experience
KEY TERMS / DEFINITIONS: Merits · demerits · the Indian experience · conditional · Executive-legislative harmony · Harmony can become domination
...
ANSWER-GRABBING FORMULATION: India experienced several short-lived Union governments in the late 1970s, 1989-91 and 1996-98, demonstrating the instability risk.
```
...
> Article 123 permits temporary legislation when Parliament is not in session, but repeated or strategic ordinances can bypass deliberation and weaken legislative accountability.
...
```closure-flow
SUBTOPIC: Cabinet and PM dominance: how Parliament may be marginalised
KEY TERMS / DEFINITIONS: Cabinet · PM dominance · how Parliament may be marginalised · effective control and deliberation · Majority support · Whip and Tenth Schedule
...
ANSWER-GRABBING FORMULATION: Article 123 permits temporary legislation when Parliament is not in session, but repeated or strategic ordinances can bypass deliberation and weaken legislative accountability.
```
...
> Declining deliberation calls for stronger sittings, committees and scrutiny practices, not abandonment of a parliamentary system whose accountability mechanisms remain constitutionally available.
...
```closure-flow
SUBTOPIC: Accountability correctives: Parliament is not powerless
KEY TERMS / DEFINITIONS: Accountability correctives · Parliament is not powerless · No-confidence/confidence vote · Tests the ministry's authority to govern · Majority discipline may predetermine result · Question Hour and debates
...
ANSWER-GRABBING FORMULATION: Declining deliberation calls for stronger sittings, committees and scrutiny practices, not abandonment of a parliamentary system whose accountability mechanisms remain constitutionally available.
```
...
```closure-flow
SUBTOPIC: India, Britain and the United States: comparative precision
KEY TERMS / DEFINITIONS: India · Britain · the United States · comparative precision · constitutional supremacy plus parliamentary government · parliamentary sovereignty plus responsible cabinet government
...
**Plain-language definition:** Chaudhary. [CURRENT] PRS and Digital Sansad continued to show the Bills under committee consideration; no enacted constitutional amendment or final implementation scheme is claimed here.
...
> Simultaneous-election Bills remained under committee consideration at the control date, so reform debate cannot be presented as an enacted constitutional scheme.
...
- **More predictable electoral calendar**
- **Remainder terms after premature dissolution may be short**
- **17 December 2024**

**How to use them:** Frame the answer through Current control; define simultaneous elections as a system-design debate, connect Joint Committee of Parliament with More predictable electoral calendar to explain the mechanism, and use Remainder terms after premature dissolution may be short for the decisive comparison or qualification.
...
```closure-flow
SUBTOPIC: Current control: simultaneous elections as a system-design debate
KEY TERMS / DEFINITIONS: Current control · simultaneous elections as a system-design debate · Joint Committee of Parliament · More predictable electoral calendar · Remainder terms after premature dissolution may be short · 17 December 2024
...
ANSWER-GRABBING FORMULATION: Simultaneous-election Bills remained under committee consideration at the control date, so reform debate cannot be presented as an enacted constitutional scheme.
```
...
```closure-flow
SUBTOPIC: Prelims close-option traps and qualified verdicts
KEY TERMS / DEFINITIONS: Prelims close-option traps · qualified verdicts · Lok Sabha · System choice · Cabinet dominance · Coalitions
...
![A high-scoring answer defines the relationship, anchors it in law, explains mechanism, adds evidence, qualifies and gives a graded verdict.](assets/12_mains_answer_spine.png)
...
A. Article 166 - President's rules for Union business
B. Article 88 - State Council's responsibility to Assembly
C. Article 77 - collective responsibility to Lok Sabha
D. Article 167 - Chief Minister's communication duties to the Governor
...
A. The minister may vote only on government bills.
B. The minister may speak and vote because executive office overrides membership.
C. The minister may speak and participate but cannot vote in Lok Sabha.
D. The minister cannot speak because the minister is not a Lok Sabha member.
...
A. Article 53 allows the President to govern without a Council.
B. All gubernatorial discretion is unconstitutional.
C. The President has a personal popular mandate equal to Lok Sabha.
D. President and Governor are formal heads ordinarily acting on responsible advice, subject to constitutionally recognised Governor discretion.
...
A. The Council continues because Article 74 remains mandatory even while confidence cannot be tested in a dissolved House.
B. The President governs alone until elections.
...
A. A Rajya Sabha member cannot become PM.
B. Only an existing Lok Sabha member can become PM.
...
A. It gives Governors unrestricted discretion to assess support privately.
...
A. Rajya Sabha may dismiss the Council through no-confidence.
B. Cabinet disagreement is legally prohibited even inside meetings.
C. The ministry must retain Lok Sabha confidence and publicly stand by settled cabinet policy as a team.
...
B. Rajya Sabha rejection of a Money Bill dismisses the Council.
C. Express confidence defeat or denial of essential supply is decisive/grave; ordinary legislative defeat requires contextual assessment.
...
A. negotiated consensus around a common programme rather than identical ideology.
B. a prohibition on regional parties entering government.
C. a constitutional requirement that every minister belong to one party.
...
A. Secrecy protects candid deliberation but coexists with legislative, judicial, audit and statutory accountability.
B. Secrecy is merely a political convention with no constitutional oath.
C. Cabinet secrecy prevails over every court order.
D. The oath of secrecy eliminates Parliament's right to seek information.
...
A. Lower-House confidence with President unable to dissolve it in any circumstance.
B. Separate executive selection with ministerial membership of Congress.
C. Fixed executive tenure, collective responsibility and fusion.
D. Confidence-dependent ministry, legislative membership and possible lower-House dissolution.
...
A. US secretaries remain members of Congress while serving.
...
A. Preference for daily responsibility
B. Desire to make Parliament legally sovereign over the Constitution
C. Accommodation of plural representation
D. Familiarity with responsible institutions
...
A. Single-party governments cannot produce cabinet dominance.
B. Coalitions can be unstable, but full-term coalitions show instability is conditional rather than inherent.
...
A. Federalism -> fixed tenure -> no dissolution
B. Rajya Sabha no-confidence -> PM dismissal
C. Majority + whip -> agenda/time control -> reduced scrutiny, qualified by committees and confidence power
...
A. The 129th Amendment Bill remains a proposal under Joint Committee consideration.
B. Parliament has enacted a mandatory implementation year.
C. Article 82A is operative constitutional law.
D. The Joint Committee has conclusively upheld every provision.
...
A. Article 77 - State business; Article 78 - Governor discretion.
B. Article 77 - no-confidence; Article 78 - ministerial oath.
C. Article 77 - parliamentary privilege; Article 78 - dissolution.
D. Article 77 - form/authentication/allocation of Union business; Article 78 - PM's information duties to President.
...
A. Governor may permanently reject reconsidered advice in all matters.
B. State Council is collectively responsible to Legislative Council wherever one exists.
C. A non-legislator State minister has a twelve-month window.
D. It is collectively responsible to the Legislative Assembly, and the 15% cap is subject to a minimum of 12 ministers.
...
A. Collective responsibility concerns the team before Lok Sabha; individual tenure operates through pleasure/PM advice; India lacks the British universal countersignature model.
B. Individual responsibility means Rajya Sabha can dismiss one minister.
C. Legal responsibility and collective responsibility are identical.
...
B. These are analytical labels for power distribution and must not be treated as constitutional rules.
C. “Cabinet dictatorship” is a binding Supreme Court doctrine.
D. “Elective dictatorship” abolishes the need for elections.
...
B. The President may refer it to Rajya Sabha.
...
A. receives automatic Rajya Sabha membership.
...
A. India follows British parliamentary sovereignty.
...
A. Rajya Sabha alone determines Union confidence.
...
A. The President has notified the first simultaneous cycle.
B. Article 82A remains proposed text in a pending constitutional-amendment Bill.
C. The Supreme Court has approved a final implementation year.
D. Article 82A has already shortened every Assembly term.
...
#### ASCII MASTER FLOW — PANEL 1/9: Responsible government: the constitutional architecture

```ascii-master
PARLIAMENTARY GOVERNMENT
  +-- real executive is drawn from and responsible to the legislature
  +-- survival depends on confidence of the popularly elected House

UNION ARCHITECTURE
Articles 74-75 -> PM-led Council; collective responsibility to Lok Sabha
Article 77     -> conduct of Union business
Article 78     -> PM's duties toward the President

STATE PARALLELS
Articles 163-164 -> CM-led Council; responsibility to Legislative Assembly
Articles 166-167 -> State business and CM-Governor information duties

SYSTEM LOGIC
popular election -> legislative majority -> ministry -> continuing confidence -> accountability

TRAP: Parliament does not elect every minister separately.
```

#### ASCII MASTER FLOW — PANEL 2/9: Nominal and real executive: advice, office and limited discretion

```ascii-master
PRESIDENT: CONSTITUTIONAL HEAD
  +-- formal executive authority is vested in the President
  +-- normal exercise follows Article 74 ministerial advice
        |
PRIME MINISTER + COUNCIL: REAL POLITICAL EXECUTIVE
  +-- formulates policy and controls administration
  +-- remains responsible to Lok Sabha
        |
ADVICE CONTROL
  +-- President may once require reconsideration
  +-- reconsidered advice binds
  +-- Article 74(2) protects inquiry into advice, not every underlying act

LIMITED DISCRETION / CONVENTION ZONES
  +-- appoint PM where no clear majority exists
  +-- test confidence on the floor
  +-- assess dissolution where an alternative government may be possible
```

#### ASCII MASTER FLOW — PANEL 3/9: The parliamentary mechanism: fusion, membership and responsibility

```ascii-master
CLASSIC FEATURES
  +-- dual executive: nominal head + real ministry
  +-- majority-party / coalition government
  +-- collective responsibility to Lok Sabha
  +-- political homogeneity or negotiated common programme
  +-- double membership: executive drawn from legislature
  +-- PM leadership
  +-- lower-House dissolution possibility
  +-- secrecy and Cabinet solidarity

COLLECTIVE RESPONSIBILITY
Cabinet decision -> all ministers publicly support or resign
loss of Lok Sabha confidence -> entire ministry resigns or seeks lawful dissolution

INDIVIDUAL RESPONSIBILITY
personal misconduct / departmental failure may trigger resignation without government fall

FUSION != absence of checks; courts, bicameralism, committees and elections remain.
```

#### ASCII MASTER FLOW — PANEL 4/9: Confidence, no-confidence, dissolution and caretaker government

```ascii-master
GOVERNMENT FORMS
  +-- majority ministry
  +-- coalition ministry
  +-- minority ministry with outside support
        |
CONTINUING TEST: DOES THE MINISTRY COMMAND LOK SABHA CONFIDENCE?
  +-- no-confidence motion
  +-- confidence motion
  +-- defeat on an issue expressly treated as confidence
  +-- floor test where majority is disputed
        |
IF CONFIDENCE IS LOST
  +-- resign
  +-- or advise dissolution, subject to assessment of alternatives
        |
CARETAKER CONVENTION
  +-- continuity until successor takes office
  +-- restraint in major irreversible policy unless necessity demands

TRAP: an internal party setback is not automatically loss of House confidence.
```

#### ASCII MASTER FLOW — PANEL 5/9: Cabinet, Council of Ministers and Prime Ministerial leadership

```ascii-master
COUNCIL OF MINISTERS: THE WIDER CONSTITUTIONAL BODY
  +-- Cabinet Ministers
  +-- Ministers of State, independent charge or attached
  +-- all ranks share collective responsibility

CABINET: SMALLER INNER DECISION CORE
  +-- major policy, legislation, budget, appointments and crisis decisions
  +-- supported by Cabinet Committees and Secretariat coordination

PRIME MINISTER
  +-- selects / allocates portfolios through advice
  +-- chairs Cabinet and coordinates ministries
  +-- leads majority or coalition and government business in Parliament
  +-- communicates between President and ministry under Article 78

DOMINANCE RISKS
party control + agenda control + ordinance / delegated legislation + weak scrutiny

LIMIT: presidentialisation is an analytical label; responsibility remains parliamentary.
```

#### ASCII MASTER FLOW — PANEL 6/9: Parliamentary accountability: the corrective ecosystem

```ascii-master
DAILY / PERIODIC SCRUTINY
  +-- Question Hour, debates, calling-attention devices and motions
  +-- budget, demands for grants, cut motions and financial control
  +-- committee examination of Bills, ministries and delegated legislation

FINANCIAL ACCOUNTABILITY
CAG reports -> Public Accounts Committee / other financial committees -> government response

POLITICAL ACCOUNTABILITY
opposition + media + federal second chamber + constituency pressure + elections

LEGAL / CONSTITUTIONAL ACCOUNTABILITY
judicial review + constitutional offices + statutory transparency and audit

WHY CONTROL MAY WEAKEN
whip and anti-defection pressure -> limited dissent
compressed sittings / rushed Bills -> reduced deliberation
executive information advantage -> scrutiny gap

REFORM: time, information, committee capacity and opposition rights.
```

#### ASCII MASTER FLOW — PANEL 7/9: Parliamentary and presidential systems compared precisely

```ascii-master
AXIS                 PARLIAMENTARY                    PRESIDENTIAL
executive-legislature  fusion / interdependence         organisational separation
survival               continuing House confidence      fixed constitutional term
executive form         nominal + real executive         generally single real executive
membership             ministers usually legislators    executive normally outside legislature
removal                 political no-confidence          exceptional impeachment process
strength                continuous accountability        tenure stability
risk                    dominance / instability          deadlock / rigid mandate

INDIA
  +-- parliamentary responsibility + written supreme Constitution
  +-- federalism, judicial review and rights limit legislative majorities

UK contrast: orthodox parliamentary sovereignty and constitutional monarchy
US contrast: separately elected President and stronger personnel separation.
```

#### ASCII MASTER FLOW — PANEL 8/9: Indian adaptation: stability, coalition and current design debate

```ascii-master
WHY ADOPTED
familiar institutions + diversity accommodation + daily accountability + flexible change

MERITS                              DEMERITS
executive-legislature coordination  Cabinet / PM dominance
continuous responsibility           instability in fragmented Houses
adaptable coalition bargaining      short-term politics and secrecy
easy peaceful replacement           weak separation and limited expertise

INDIAN ADAPTATIONS
coalition agreements -> common programme -> coordination committees
minority government -> issue-based confidence -> bargaining and instability risks
anti-defection -> stability support, but reduced legislative independence

CURRENT CONTROL
129th Amendment Bill, 2024 remains a committee-stage proposal.
Proposed Article 82A is not current law; use only for stability-accountability analysis.
```
...
```ascii-master
PRELIMS CONTROL
Articles 74-75 -> Union                Articles 163-164 -> States
collective responsibility -> Lok Sabha / Assembly, not both Houses
non-member minister -> maximum six consecutive months
Cabinet != entire Council of Ministers
no-confidence removes ministry, not Lok Sabha
President normally acts on advice; reconsideration is once

VERIFIED PYQS
2020 Prelims Q11; 2021 Prelims Q77
2018 GS-II Q13; 2023 GS-II Q4; 2024 GS-II Q3
Historical objective keys remain explicitly inferred; no key is fabricated.

MAINS SPINE
1 define responsible government through executive-legislature relationship
2 map Articles, nominal-real executive and confidence
3 explain responsibility and accountability instruments
4 compare presidential system; add Indian adaptation and dominance risks
5 propose scrutiny reforms and conclude: stability must serve responsibility.
```