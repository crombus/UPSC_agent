...
UPSC TRAP / ANSWER-USE: The 1892 Act enlarged non-official membership but retained official majorities.
        |
        v
ANSWER-GRABBING FORMULATION: Mains route: Trace the move from consultation to scrutiny while emphasising that association was designed to strengthen colonial legitimacy, not surrender executive control.
```
...
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the Federal List had 59, Provincial List 54 and Concurrent List 36 entries in...
        |
        v
ANSWER-GRABBING FORMULATION: The 1935 Act proposed an All-India Federation of provinces and acceding princely states, distributed powers through Federal, Provincial and Concurrent Lists, abolished provincial dyarchy and introduced provincial autonomy.
```
...
> Judiciary evolved alongside executive dominance; independence is a constitutional transformation, not a simple inheritance.
...
UPSC TRAP / ANSWER-USE: Correct: The Constitution retained forms but changed source, limits and accountability.
        |
        v
ANSWER-GRABBING FORMULATION: Judiciary evolved alongside executive dominance; independence is a constitutional transformation, not a simple inheritance.
```
