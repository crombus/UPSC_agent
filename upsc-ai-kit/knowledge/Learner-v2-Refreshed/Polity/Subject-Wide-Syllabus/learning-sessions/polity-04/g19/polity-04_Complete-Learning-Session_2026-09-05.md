...
|---|---|---|---|
| Berubari Union (1960) | 1960 | Presidential reference, Art 143 | Key to the makers' minds and an aid to interpretation, but NOT a part of the Constitution. |
| Kesavananda Bharati (1973) | 1973 | Writ; 13-judge bench | Preamble IS a part of the Constitution; the Constitution must be read in its light. |
...
- [FACT] The Court's reasoning, recorded in *Kesavananda Bharati (1973)*, is that the edifice of the Constitution is **based upon the basic elements mentioned in the Preamble**; if any of these elements are removed, the structure will not survive and it will not be the same Constitution, or it cannot maintain its identity.
...
- [FACT] **Route two - identification of basic features.** *Kesavananda Bharati (1973)* held that the edifice of the Constitution is based upon the basic elements mentioned in the Preamble; those elements therefore limit the amending power itself.
...
| Assembly deliberately excluded "secular" | The word was thought imprecise in 1949; India then developed its own secularism, now a basic feature. | *Kesavananda Bharati (1973)*; *S. R. Bommai* (1994). |
