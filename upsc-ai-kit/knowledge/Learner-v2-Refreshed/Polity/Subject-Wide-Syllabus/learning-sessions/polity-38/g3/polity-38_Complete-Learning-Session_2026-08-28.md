---
title: "Lokpal and Lokayuktas — Learner-v2 Refreshed"
topic_key: polity-38
cover_image: assets/polity-38_Teaching-Navigation_2026-08-28.png
---
# Polity 38 — Lokpal and Lokayuktas — Deep-Reviewed Source

## BASIC LEARNING SESSION

![Refreshed teaching navigation](assets/polity-38_Teaching-Navigation_2026-08-28.png)

*Distinct embedded teaching-navigation image. The separate continuous Cārvāka-style flowchart package remains an independent at-a-glance artifact.*

### SESSION 1 — CORE IDEA AND LEGAL IDENTITY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The ombudsman idea supplies the accountability logic, but the enacted Indian model is more than a classical recommendatory grievance office.

**Technical definition:** The Lokpal is a statutory body, established for the Union by the Lokpal and Lokayuktas Act, 2013.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The ombudsman idea supplies the accountability logic, but the enacted Indian model is more than a classical recommendatory grievance office.
...
**How to use them:** Frame the answer through Legal Identity; define statutory body, connect Parliamentary statute with Lokpal and Lokayuktas Act, 2013 to explain the mechanism, and use Not a constitutional body for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE IDEA AND LEGAL IDENTITY

```text
START / CONCEPT: CORE IDEA AND LEGAL IDENTITY
        |
        v
EXACT TERMS: Legal Identity · statutory body · Parliamentary statute · Lokpal and Lokayuktas Act, 2013 · Not a constitutional body · Section 2(1)(e)
        |
        v
MECHANISM / ARGUMENT: The Lokpal is a statutory body, established for the Union by the Lokpal and Lokayuktas Act, 2013.
        |
        v
CONSEQUENCE / CONTRAST: It is not created by the Constitution and is not a constitutional court, police force or general public-grievance commission.
        |
        v
UPSC TRAP / ANSWER-USE: These powers do not make Lokpal the final judge of criminal guilt.
        |
        v
ANSWER-GRABBING FORMULATION: The ombudsman idea supplies the accountability logic, but the enacted Indian model is more than a classical recommendatory grievance office.
```
### SESSION 2 — EVOLUTION: OMBUDSMAN TO THE 2013 ACT

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The modern ombudsman institution is conventionally traced to Sweden in 1809.

**Technical definition:** Technically, Evolution: Ombudsman To The 2013 Act is analysed by relating Evolution to Ombudsman To The 2013 Act, then testing the relationship through Lokpal at the Union level and Lokayuktas at the State level.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The modern ombudsman institution is conventionally traced to Sweden in 1809.
...
| 2017 | *Common Cause* holds Act workable despite LoP vacancy | Appointment blockage rejected |
...
```text
START / CONCEPT: EVOLUTION: OMBUDSMAN TO THE 2013 ACT
        |
        v
EXACT TERMS: Evolution · Ombudsman To The 2013 Act · Lokpal at the Union level · Lokayuktas at the State level · 1 January 2014 · 16 January 2014
        |
        v
MECHANISM / ARGUMENT: Local Polity sources explain its diffusion to other jurisdictions as a mechanism for receiving complaints about administrative wrongdoing.
        |
        v
CONSEQUENCE / CONTRAST: Civil-society mobilisation explains political salience; it is not the legal source of the institution.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: successive Lokpal Bills beginning in 1968 repeatedly lapsed, were withdrawn or failed to complete...
        |
        v
ANSWER-GRABBING FORMULATION: The modern ombudsman institution is conventionally traced to Sweden in 1809.
```
### SESSION 3 — STATUTORY ARCHITECTURE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The Act creates a multi-stage system: Lokpal benches decide how complaints proceed; the Inquiry Wing undertakes preliminary inquiry; the CVC receives prescribed categories; investigating agencies conduct investigation; the Prosecution Wing or agency prosecutes; Special Courts adjudicate.

**Technical definition:** Technically, Statutory Architecture is analysed by relating Filing/scrutiny to Registry and Lokpal bench, then testing the relationship through Form, jurisdiction, maintainability and Criminal guilt.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The Act creates a multi-stage system: Lokpal benches decide how complaints proceed; the Inquiry Wing undertakes preliminary inquiry; the CVC receives prescribed categories; investigating agencies conduct investigation; the Prosecution Wing or agency prosecutes; Special Courts adjudicate.
...
```text
START / CONCEPT: STATUTORY ARCHITECTURE
        |
        v
EXACT TERMS: Statutory Architecture · Filing/scrutiny · Registry and Lokpal bench · Form, jurisdiction, maintainability · Criminal guilt · Preliminary inquiry
        |
        v
MECHANISM / ARGUMENT: The operative mechanism is that the Act creates a multi-stage system.
        |
        v
CONSEQUENCE / CONTRAST: This reduces the danger of a single institution controlling every stage, but creates coordination, delay and responsibility-diffusion risks.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: this reduces the danger of a single institution controlling every stage.
        |
        v
ANSWER-GRABBING FORMULATION: The Act creates a multi-stage system: Lokpal benches decide how complaints proceed; the Inquiry Wing undertakes preliminary inquiry; the CVC receives prescribed categories; investigating agencies conduct investigation; the Prosecution Wing or agency prosecutes; Special Courts adjudicate.
```
### SESSION 4 — COMPOSITION UNDER SECTION 3

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Composition Under Section 3 comprises Chairperson plus not more than eight Members, Judicial membership and Members as its core connected dimensions.

**Technical definition:** The statutory percentage applies to the Members, not to a combined denominator that automatically includes the Chairperson.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Section 3 provides a Chairperson plus not more than eight Members.
...
```text
START / CONCEPT: COMPOSITION UNDER SECTION 3
        |
        v
EXACT TERMS: Composition Under Section 3 · Chairperson plus not more than eight Members · Judicial membership · Members · “At least half of the whole Lokpal” · 50% shall be Judicial Members
        |
        v
MECHANISM / ARGUMENT: The statutory percentage applies to the Members, not to a combined denominator that automatically includes the Chairperson.
        |
        v
CONSEQUENCE / CONTRAST: Not less than fifty per cent of the Members must be from among persons belonging to the Scheduled Castes, Scheduled Tribes, Other Backward Classes, minorities and women.
        |
        v
UPSC TRAP / ANSWER-USE: “Maximum eight” is a ceiling, not a permanent guarantee that every seat is always filled.
        |
        v
ANSWER-GRABBING FORMULATION: Section 3 provides a Chairperson plus not more than eight Members.
```
### SESSION 5 — ELIGIBILITY, EXPERTISE AND DISQUALIFICATIONS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** A Chairperson may be a person who is or has been Chief Justice of India, is or has been a Supreme Court Judge, or is an eminent person satisfying the non-judicial expertise condition.
...
> A Chairperson may be a person who is or has been Chief Justice of India, is or has been a Supreme Court Judge, or is an eminent person satisfying the non-judicial expertise condition.
...
```text
START / CONCEPT: ELIGIBILITY, EXPERTISE AND DISQUALIFICATIONS
        |
        v
EXACT TERMS: Eligibility · Expertise · Disqualifications · twenty-five years · forty-five years · Chairperson — judicial route
        |
        v
MECHANISM / ARGUMENT: A non-judicial Member must be a person of impeccable integrity and outstanding ability with at least twenty-five years of special knowledge and expertise in anti-corruption policy, public administration, vigilance, finance including insurance and banking, law and management.
        |
        v
CONSEQUENCE / CONTRAST: A Judicial Member must be or have been a Supreme Court Judge or Chief Justice of a High Court.
        |
        v
UPSC TRAP / ANSWER-USE: An appointee cannot hold another office of trust or profit, be affiliated with a political party, carry on business or practise a profession; existing conflicting engagements must be severed before entry into office.
        |
        v
ANSWER-GRABBING FORMULATION: A Chairperson may be a person who is or has been Chief Justice of India, is or has been a Supreme Court Judge, or is an eminent person satisfying the non-judicial expertise condition.
```
### SESSION 6 — APPOINTMENT: SELECTION COMMITTEE AND SEARCH COMMITTEE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Section 4(2) instead states that no appointment is invalid merely because of a vacancy in the Selection Committee.

**Technical definition:** Technically, Appointment: Selection Committee And Search Committee is analysed by relating Appointment to Selection Committee, then testing the relationship through Search Committee and Leader of Opposition.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Section 4(2) instead states that no appointment is invalid merely because of a vacancy in the Selection Committee.
...
#### Visual 15 — Vacancy Rule and *Common Cause*
...
```text
START / CONCEPT: APPOINTMENT: SELECTION COMMITTEE AND SEARCH COMMITTEE
        |
        v
EXACT TERMS: Appointment · Selection Committee · Search Committee · Leader of Opposition · at least seven persons · Prime Minister
        |
        v
MECHANISM / ARGUMENT: It does not insert the leader of the single largest opposition party as a statutory substitute for Lokpal appointments.
        |
        v
CONSEQUENCE / CONTRAST: Not less than fifty per cent of its members must come from the same listed diversity categories.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: it does not insert the leader of the single largest opposition party as a...
        |
        v
ANSWER-GRABBING FORMULATION: Section 4(2) instead states that no appointment is invalid merely because of a vacancy in the Selection Committee.
```
### SESSION 7 — TENURE, REAPPOINTMENT AND POST-TENURE RESTRICTIONS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** On leaving office, the Chairperson and every Member are ineligible for reappointment as Chairperson or Member, diplomatic assignment, Union Territory administrator or another presidential-warrant assignment, and further office of profit under Union or State government.

**Technical definition:** A Member may be appointed Chairperson if the aggregate tenure as Member and Chairperson does not exceed five years.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> On leaving office, the Chairperson and every Member are ineligible for reappointment as Chairperson or Member, diplomatic assignment, Union Territory administrator or another presidential-warrant assignment, and further office of profit under Union or State government.
...
```text
START / CONCEPT: TENURE, REAPPOINTMENT AND POST-TENURE RESTRICTIONS
        |
        v
EXACT TERMS: Tenure · Reappointment · Post-Tenure Restrictions · Reappointment to Lokpal · Ineligible, subject to Member-to-Chair aggregate exception · Diplomatic/UT administrator/specified presidential appointment
        |
        v
MECHANISM / ARGUMENT: A Member may be appointed Chairperson if the aggregate tenure as Member and Chairperson does not exceed five years.
        |
        v
CONSEQUENCE / CONTRAST: Section 6 fixes the term at five years from entering office or until age seventy, whichever is earlier.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: a Member may be appointed Chairperson if the aggregate tenure as Member and Chairperson...
        |
        v
ANSWER-GRABBING FORMULATION: On leaving office, the Chairperson and every Member are ineligible for reappointment as Chairperson or Member, diplomatic assignment, Union Territory administrator or another presidential-warrant assignment, and further office of profit under Union or State government.
```
### SESSION 8 — REMOVAL AND SUSPENSION UNDER SECTION 37

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** For removal on misbehaviour, the route is: a petition signed by at least one hundred Members of Parliament; Presidential reference to the Supreme Court; Supreme Court inquiry and report that removal is warranted; Presidential removal order.

**Technical definition:** Section 37 has its own threshold, grounds and judicial-reference architecture.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> For removal on misbehaviour, the route is: a petition signed by at least one hundred Members of Parliament; Presidential reference to the Supreme Court; Supreme Court inquiry and report that removal is warranted; Presidential removal order.
...
```text
START / CONCEPT: REMOVAL AND SUSPENSION UNDER SECTION 37
        |
        v
EXACT TERMS: Removal · Suspension Under Section 37 · misbehaviour · one hundred Members of Parliament · Section 37(2) · Yes
        |
        v
MECHANISM / ARGUMENT: The President may directly remove a Chairperson or Member who is adjudged insolvent, engages in paid employment outside official duties during the term, or is considered unfit by reason of infirmity of mind or body.
        |
        v
CONSEQUENCE / CONTRAST: Do not import the removal procedures of CVC, NHRC or Election Commission.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: section 37 has its own threshold, grounds and judicial-reference architecture.
        |
        v
ANSWER-GRABBING FORMULATION: For removal on misbehaviour, the route is: a petition signed by at least one hundred Members of Parliament; Presidential reference to the Supreme Court; Supreme Court inquiry and report that removal is warranted; Presidential removal order.
```
### SESSION 9 — JURISDICTION: PERSONS AND ENTITIES COVERED

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Section 14(3) can reach another person involved in abetting, bribe giving, bribe taking or conspiracy connected with a corruption allegation against a covered person, subject to State consent where the person serves State affairs.

**Technical definition:** Former public servants remain covered for conduct during the period in which they held or served in the relevant capacity.
...
```text
START / CONCEPT: JURISDICTION: PERSONS AND ENTITIES COVERED
        |
        v
EXACT TERMS: Jurisdiction · Persons · Entities Covered · Sitting/former Prime Minister · Yes · Special exclusions and procedure
        |
        v
MECHANISM / ARGUMENT: Because that threshold can be notification-dependent, it is not frozen here.
        |
        v
CONSEQUENCE / CONTRAST: Former public servants remain covered for conduct during the period in which they held or served in the relevant capacity.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: because that threshold can be notification-dependent, it is not frozen here.
        |
        v
...
```
### SESSION 10 — PRIME MINISTER: INCLUDED, BUT SPECIALLY RING-FENCED

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Section 14(1)(a) includes a person who is or has been Prime Minister.

**Technical definition:** Technically, Prime Minister: Included, But Specially Ring-Fenced is analysed by relating Prime Minister to Included, then testing the relationship through But Specially Ring-Fenced and two-thirds of its Members.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Section 14(1)(a) includes a person who is or has been Prime Minister.
...
```text
START / CONCEPT: PRIME MINISTER: INCLUDED, BUT SPECIALLY RING-FENCED
        |
        v
EXACT TERMS: Prime Minister · Included · But Specially Ring-Fenced · two-thirds of its Members · in camera · Inquiry itself
        |
        v
MECHANISM / ARGUMENT: Initiation requires a full bench consisting of the Chairperson and all Members, and at least two-thirds of its Members must approve.
        |
        v
CONSEQUENCE / CONTRAST: The inquiry must be held in camera.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the model is neither total immunity nor ordinary parity.
        |
        v
ANSWER-GRABBING FORMULATION: Section 14(1)(a) includes a person who is or has been Prime Minister.
```
### SESSION 11 — MPS, ARTICLE 105(2) AND THE BRIBERY BOUNDARY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The provisions can be harmonised through a functional boundary: bona fide speech and vote remain protected, but a separate criminal bargain to sell that function is not converted into protected legislative activity.

**Technical definition:** Technically, Mps, Article 105(2) And The Bribery Boundary is analysed by relating Mps to Article 105(2), then testing the relationship through The Bribery Boundary and Section 14(2) exclusion applies.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> It held that a legislator who accepts a bribe for a speech or vote receives no Article 105/194 immunity; bribery is complete on acceptance.
...
- **Continue**
- **Sita Soren denies privilege immunity**
...
[FACT] In ***Sita Soren v Union of India* (2024 INSC 161)**, a unanimous seven-judge Supreme Court bench overruled the relevant majority position in *P.V. Narasimha Rao*. It held that a legislator who accepts a bribe for a speech or vote receives no Article 105/194 immunity; bribery is complete on acceptance.
...
[LIMIT] *Sita Soren* did not abolish parliamentary freedom of speech or ordinary vote immunity. It removed the claimed shield for bribery.
...
SEPARATE ACCEPTANCE OF BRIBE FOR SPEECH/VOTE
                |
       Sita Soren: no privilege immunity
```
...
| Is there an independent allegation of bribery/bargain? | *Sita Soren* denies privilege immunity | Ordinary jurisdiction test |
...
```text
START / CONCEPT: MPS, ARTICLE 105(2) AND THE BRIBERY BOUNDARY
        |
        v
EXACT TERMS: Mps · Article 105(2) · The Bribery Boundary · Section 14(2) exclusion applies · Continue · Sita Soren denies privilege immunity
        |
        v
MECHANISM / ARGUMENT: The provisions can be harmonised through a functional boundary: bona fide speech and vote remain protected, but a separate criminal bargain to sell that function is not converted into protected legislative activity.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that the provisions can be harmonised through a functional boundary.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the provisions can be harmonised through a functional boundary.
        |
        v
ANSWER-GRABBING FORMULATION: It held that a legislator who accepts a bribe for a speech or vote receives no Article 105/194 immunity; bribery is complete on acceptance.
```
### SESSION 12 — STATE-CONNECTED PERSONS AND CONSENT

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Section 14 contains consent protections where a person connected with Union service or a Union-linked entity is working in connection with State affairs or a State-established/financed/controlled entity.

**Technical definition:** Technically, State-Connected Persons And Consent is analysed by relating Consent to Section, then testing the relationship through Union and Union-linked.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Section 14 contains consent protections where a person connected with Union service or a Union-linked entity is working in connection with State affairs or a State-established/financed/controlled entity.
...
- **Union**
- **Union-linked**
- **These provisions recognise that Lokpal**
- **These**

**How to use them:** Frame the answer through Consent; define Section, connect Union with Union-linked to explain the mechanism, and use These provisions recognise that Lokpal for the decisive comparison or qualification.
...
```text
START / CONCEPT: STATE-CONNECTED PERSONS AND CONSENT
        |
        v
EXACT TERMS: Consent · Section · Union · Union-linked · These provisions recognise that Lokpal · These
        |
        v
MECHANISM / ARGUMENT: These provisions recognise that Lokpal is a Union institution and cannot automatically convert every State-linked corruption allegation into central jurisdiction.
        |
        v
CONSEQUENCE / CONTRAST: Section 14(3) also requires State consent before action against a connected person serving in State affairs.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: this is distinct from DSPE Act section 6 consent for CBI territorial operation.
        |
        v
ANSWER-GRABBING FORMULATION: Section 14 contains consent protections where a person connected with Union service or a Union-linked entity is working in connection with State affairs or a State-established/financed/controlled entity.
```
### SESSION 13 — COMPLAINT ENTRY: FORM, IDENTITY, AFFIDAVIT AND SCRUTINY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Complaint Entry: Form, Identity, Affidavit And Scrutiny comprises Complaint Entry, Form and Identity as its core connected dimensions.

**Technical definition:** Required annexures include identity proof, organisational registration/incorporation and authorisation where relevant, the specified affidavit, and a duly signed detailed statement of allegation.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> It states that a complaint not in the prescribed form will not be entertained on merits until defects are removed; the Registry scrutinises form and relevant information, assigns diary/complaint numbers and places the matter for bench allocation.
...
```text
START / CONCEPT: COMPLAINT ENTRY: FORM, IDENTITY, AFFIDAVIT AND SCRUTINY
        |
        v
EXACT TERMS: Complaint Entry · Form · Identity · Affidavit · Scrutiny · Illegible
        |
        v
MECHANISM / ARGUMENT: Required annexures include identity proof, organisational registration/incorporation and authorisation where relevant, the specified affidavit, and a duly signed detailed statement of allegation.
        |
        v
CONSEQUENCE / CONTRAST: Where filed electronically, a hard copy must be submitted within fifteen days; the Rules also state that a complete electronic complaint should not be kept pending merely for that reason.
        |
        v
UPSC TRAP / ANSWER-USE: A formal defect is not a finding that the allegation is false.
        |
        v
ANSWER-GRABBING FORMULATION: It states that a complaint not in the prescribed form will not be entertained on merits until defects are removed; the Registry scrutinises form and relevant information, assigns diary/complaint numbers and places the matter for bench allocation.
```
### SESSION 14 — PRELIMINARY INQUIRY IS NOT INVESTIGATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Preliminary inquiry is a threshold assessment.

**Technical definition:** Investigation is the evidence-gathering criminal-process stage.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Preliminary inquiry is a threshold assessment.
...
```text
START / CONCEPT: PRELIMINARY INQUIRY IS NOT INVESTIGATION
        |
        v
EXACT TERMS: Preliminary Inquiry Is Not Investigation · preliminary inquiry · investigation · Purpose · Determine prima facie case · Collect evidence for criminal report
        |
        v
MECHANISM / ARGUMENT: Before ordering investigation, Lokpal must call for the public servant’s explanation to determine whether a prima facie case exists.
        |
        v
CONSEQUENCE / CONTRAST: This does not interfere with necessary search and seizure.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: investigation is the evidence-gathering criminal-process stage.
        |
        v
ANSWER-GRABBING FORMULATION: Preliminary inquiry is a threshold assessment.
```
### SESSION 15 — CVC ROUTING FOR GROUPS A-D

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** If Lokpal decides to proceed through preliminary inquiry, section 20 requires reference of complaints or categories involving Groups A, B, C or D to the CVC by general or special order.

**Technical definition:** Section 25(2) requires the CVC to send statements at intervals directed by Lokpal about action on referred complaints; Lokpal may issue guidelines for effective and expeditious disposal.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> If Lokpal decides to proceed through preliminary inquiry, section 20 requires reference of complaints or categories involving Groups A, B, C or D to the CVC by general or special order.
...
**How to use them:** Frame the answer through Cvc Routing For Groups A-D; define If Lokpal, connect Groups with CVC to explain the mechanism, and use Section for the decisive comparison or qualification.
...
```text
START / CONCEPT: CVC ROUTING FOR GROUPS A-D
        |
        v
EXACT TERMS: Cvc Routing For Groups A-D · If Lokpal · Groups · CVC · Section · Lokpal
        |
        v
MECHANISM / ARGUMENT: Section 25(2) requires the CVC to send statements at intervals directed by Lokpal about action on referred complaints; Lokpal may issue guidelines for effective and expeditious disposal.
        |
        v
CONSEQUENCE / CONTRAST: Lokpal remains the high-level complaint-routing institution, while CVC has category-specific preliminary-inquiry and vigilance functions.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: this is neither a simple hierarchy nor duplication.
        |
        v
ANSWER-GRABBING FORMULATION: If Lokpal decides to proceed through preliminary inquiry, section 20 requires reference of complaints or categories involving Groups A, B, C or D to the CVC by general or special order.
```
### SESSION 16 — TIMELINES AND NATURAL JUSTICE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Timelines And Natural Justice comprises Timelines, Natural Justice and sixty days from receipt of the reference as its core connected dimensions.
...
> Timelines And Natural Justice comprises Timelines, Natural Justice and sixty days from receipt of the reference as its core connected dimensions.
...
```text
START / CONCEPT: TIMELINES AND NATURAL JUSTICE
        |
        v
EXACT TERMS: Timelines · Natural Justice · sixty days from receipt of the reference · ninety days · six months · at a time
        |
        v
MECHANISM / ARGUMENT: Every preliminary inquiry should ordinarily be completed within ninety days, extendable for recorded reasons by a further ninety days from receipt of the complaint.
        |
        v
CONSEQUENCE / CONTRAST: Investigation should be completed within six months from Lokpal’s order.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: every preliminary inquiry should ordinarily be completed within ninety days, extendable for recorded reasons...
        |
        v
ANSWER-GRABBING FORMULATION: Timelines And Natural Justice comprises Timelines, Natural Justice and sixty days from receipt of the reference as its core connected dimensions.
```
### SESSION 17 — INVESTIGATION, REPORT, SANCTION AND PROSECUTION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** “Sanction” is procedural authorisation to prosecute; it is not a merits verdict.

**Technical definition:** Where the investigation concerns the Prime Minister, Union Minister or MP and discloses a Prevention of Corruption Act offence, section 24 permits Lokpal to file a case in the Special Court and requires the report/findings to be sent to the competent authority.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> “Sanction” is procedural authorisation to prosecute; it is not a merits verdict.
...
```text
START / CONCEPT: INVESTIGATION, REPORT, SANCTION AND PROSECUTION
        |
        v
EXACT TERMS: Investigation · Report · Sanction · Prosecution · Prima facie routing · Yes
        |
        v
MECHANISM / ARGUMENT: Likewise, a charge-sheet is an accusation supported by investigative material, not a conviction.
        |
        v
CONSEQUENCE / CONTRAST: Where the investigation concerns the Prime Minister, Union Minister or MP and discloses a Prevention of Corruption Act offence, section 24 permits Lokpal to file a case in the Special Court and requires the report/findings to be sent to the competent authority.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: “Sanction” is procedural authorisation to prosecute.
        |
        v
ANSWER-GRABBING FORMULATION: “Sanction” is procedural authorisation to prosecute; it is not a merits verdict.
```
### SESSION 18 — INQUIRY WING AND PROSECUTION WING: MANDATE AND VERIFIED STATUS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** They do not, by themselves, prove that every sanctioned post is filled, that the wings possess complete independent operational capacity, or any particular level of case output.

**Technical definition:** Section 11 requires an Inquiry Wing headed by the Director of Inquiry to conduct preliminary inquiries into alleged Prevention of Corruption Act offences by public servants.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> They do not, by themselves, prove that every sanctioned post is filled, that the wings possess complete independent operational capacity, or any particular level of case output.
...
```text
START / CONCEPT: INQUIRY WING AND PROSECUTION WING: MANDATE AND VERIFIED STATUS
        |
        v
EXACT TERMS: Inquiry Wing · Prosecution Wing · Mandate · Verified Status · 6 June 2025 · 13 June 2025
        |
        v
MECHANISM / ARGUMENT: Section 11 requires an Inquiry Wing headed by the Director of Inquiry to conduct preliminary inquiries into alleged Prevention of Corruption Act offences by public servants.
        |
        v
CONSEQUENCE / CONTRAST: Officers not below Under Secretary rank have specified civil-court powers for this purpose.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: section 12 requires Lokpal, by notification, to constitute a Prosecution Wing headed by the...
        |
        v
ANSWER-GRABBING FORMULATION: They do not, by themselves, prove that every sanctioned post is filled, that the wings possess complete independent operational capacity, or any particular level of case output.
```
### SESSION 19 — SUPERVISORY AND INVESTIGATIVE-PROCESS POWERS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Lokpal cannot use that power to require an agency to investigate or dispose of a case in a particular manner.

**Technical definition:** Section 25 gives Lokpal superintendence and direction over DSPE in matters Lokpal refers for preliminary inquiry or investigation.
...
```text
START / CONCEPT: SUPERVISORY AND INVESTIGATIVE-PROCESS POWERS
        |
        v
EXACT TERMS: Supervisory · Investigative-Process Powers · Direct DSPE in referred matter · Yes · Cannot dictate particular investigation/disposal · Transfer approval for referred-case investigator
        |
        v
MECHANISM / ARGUMENT: Section 25 gives Lokpal superintendence and direction over DSPE in matters Lokpal refers for preliminary inquiry or investigation.
        |
        v
CONSEQUENCE / CONTRAST: This creates operational insulation for referred cases, not general command over every CBI investigation.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: this creates operational insulation for referred cases, not general command over every CBI investigation.
        |
        v
...
```
### SESSION 20 — SEARCH, CIVIL-COURT POWERS, ATTACHMENT AND CONFISCATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Section 31 separately permits Special Court confiscation in special circumstances on prima facie evidence until acquittal, with restoration/value plus statutory interest if the order is annulled or the public servant is acquitted.

**Technical definition:** Technically, Search, Civil-Court Powers, Attachment And Confiscation is analysed by relating Civil-Court Powers to Attachment, then testing the relationship through Confiscation and ninety days.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Section 31 separately permits Special Court confiscation in special circumstances on prima facie evidence until acquittal, with restoration/value plus statutory interest if the order is annulled or the public servant is acquitted.
...
```text
START / CONCEPT: SEARCH, CIVIL-COURT POWERS, ATTACHMENT AND CONFISCATION
        |
        v
EXACT TERMS: Civil-Court Powers · Attachment · Confiscation · ninety days · thirty days · Yes
        |
        v
MECHANISM / ARGUMENT: Proceedings before Lokpal are deemed judicial proceedings for the false-evidence provision referenced by the Act.
        |
        v
CONSEQUENCE / CONTRAST: This does not transform Lokpal into a criminal court.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: under section 30, the Prosecution Wing must apply within thirty days for confirmation.
        |
        v
ANSWER-GRABBING FORMULATION: Section 31 separately permits Special Court confiscation in special circumstances on prima facie evidence until acquittal, with restoration/value plus statutory interest if the order is annulled or the public servant is acquitted.
```
### SESSION 21 — ASSETS, SECTION 44 AMENDMENT AND SECTION 45 PRESUMPTION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Section 45 provides a rebuttable presumption where a public servant wilfully or without justifiable reason fails to declare assets, or supplies misleading information and is found possessing undisclosed/misdescribed assets.

**Technical definition:** In the official DoPT/Lokpal material located for this control check, no later fresh section 44 form-and-manner rules were located.
...
[LIMIT] ***Lok Prahari v Union of India* (2018)** concerned election-candidate/legislator disclosure, sources of income, voter information and a permanent monitoring mechanism. It did not judicially restore the original section 44 format.
...
```text
START / CONCEPT: ASSETS, SECTION 44 AMENDMENT AND SECTION 45 PRESUMPTION
        |
        v
EXACT TERMS: Assets · Section 44 Amendment · Section 45 Presumption · Lokpal and Lokayuktas (Amendment) Act, 2016 · Detail in Act · Extensive declaration/publication architecture
        |
        v
MECHANISM / ARGUMENT: The last sentence is a controlled search result, not a claim that no document could exist outside the official repositories checked.
        |
        v
CONSEQUENCE / CONTRAST: Do not use the original 2014 public-disclosure design as if it remains the current statutory text.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: in the official DoPT/Lokpal material located for this control check, no later fresh section...
        |
        v
...
```
### SESSION 22 — SEVEN-YEAR LIMITATION AND FALSE-COMPLAINT SAFEGUARDS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The false-complaint provision protects public servants against abuse, but can chill legitimate complainants if failure of proof is wrongly equated with bad faith.

**Technical definition:** Section 46 does not apply to complaints made in good faith; the Act defines good faith through due care, caution and responsibility or mistake of fact under the stated criminal-law provision.
...
```text
START / CONCEPT: SEVEN-YEAR LIMITATION AND FALSE-COMPLAINT SAFEGUARDS
        |
        v
EXACT TERMS: Seven-Year Limitation · False-Complaint Safeguards · Complaint dismissed for lack of evidence · No · Public servant acquitted · Filing defect
        |
        v
MECHANISM / ARGUMENT: Section 46 does not apply to complaints made in good faith; the Act defines good faith through due care, caution and responsibility or mistake of fact under the stated criminal-law provision.
        |
        v
CONSEQUENCE / CONTRAST: Closure, acquittal or an unproved allegation does not automatically establish a false, frivolous or vexatious complaint.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: section 53 bars Lokpal inquiry or investigation where the complaint is made after seven...
        |
        v
...
```
### SESSION 23 — LOKPAL–CVC–CBI RELATIONSHIP

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Lokpal is the complaint-routing and decision institution under its Act.

**Technical definition:** The relationship is functional, not a single command pyramid.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Lokpal is the complaint-routing and decision institution under its Act.
...
```text
START / CONCEPT: LOKPAL–CVC–CBI RELATIONSHIP
        |
        v
EXACT TERMS: Lokpal · Cvc · Cbi Relationship · Receive prescribed Lokpal complaint · Yes · Referred route
        |
        v
MECHANISM / ARGUMENT: The relationship is functional, not a single command pyramid.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that the relationship is functional, not a single command pyramid.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the relationship is functional, not a single command pyramid.
        |
        v
ANSWER-GRABBING FORMULATION: Lokpal is the complaint-routing and decision institution under its Act.
```
### SESSION 24 — LOKAYUKTAS AND FEDERAL DIVERSITY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Section 63 requires every State, if it had not already done so, to establish a Lokayukta by a law of the State Legislature within one year from commencement of the Union Act.

**Technical definition:** Federal flexibility permits adaptation and also produces uneven accountability capacity.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Section 63 requires every State, if it had not already done so, to establish a Lokayukta by a law of the State Legislature within one year from commencement of the Union Act.
...
```text
START / CONCEPT: LOKAYUKTAS AND FEDERAL DIVERSITY
        |
        v
EXACT TERMS: Lokayuktas · Federal Diversity · Jurisdiction · Broad high-office and official coverage with narrow exclusions · Wide exclusions · Appointment
        |
        v
MECHANISM / ARGUMENT: Federal flexibility permits adaptation and also produces uneven accountability capacity.
        |
        v
CONSEQUENCE / CONTRAST: Section 63 does not prescribe a uniform national composition, selection panel, jurisdiction, tenure, removal process, investigation wing, binding force or Upalokayukta model.
        |
        v
UPSC TRAP / ANSWER-USE: The Union Act creates a minimum institutional obligation, but State legislation determines design quality.
        |
        v
ANSWER-GRABBING FORMULATION: Section 63 requires every State, if it had not already done so, to establish a Lokayukta by a law of the State Legislature within one year from commencement of the Union Act.
```
### SUPREME COURT AND CURRENT-LAW CONTROLS

#### 25.1 *Common Cause v Union of India* (2017)
...
#### 25.2 *Lok Prahari v Union of India* (2018)
...
#### 25.3 *Sita Soren v Union of India* (2024)
...
|---|---|---|
| 2017 | *Common Cause* | Act workable; LoP vacancy not a legal blockade |
| 2018 | *Lok Prahari* | Electoral asset/source disclosure and monitoring |
| 2024 | *Sita Soren* | No legislative-privilege immunity for bribery |
...
### SESSION 25 — INDEPENDENCE AND ACCOUNTABILITY ASSESSMENT

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Independence-supporting features include multi-institutional selection, fixed tenure, protected removal, post-tenure restrictions, expenditure charged on the Consolidated Fund of India, diverse membership, own statutory wings and referred-case control over DSPE transfers.

**Technical definition:** Constraints include an executive-heavy Selection Committee, no general suo motu complaint power, prescribed-form barriers, reliance on external investigation, coordination delays, confidentiality tensions, the seven-year bar, uncertain asset-rule implementation and uneven State models.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Independence-supporting features include multi-institutional selection, fixed tenure, protected removal, post-tenure restrictions, expenditure charged on the Consolidated Fund of India, diverse membership, own statutory wings and referred-case control over DSPE transfers.
...
```text
START / CONCEPT: INDEPENDENCE AND ACCOUNTABILITY ASSESSMENT
        |
        v
EXACT TERMS: Independence · Accountability Assessment · Appointment · Multiple constitutional/institutional actors · PM-led committee; vacancy politics · Tenure
        |
        v
MECHANISM / ARGUMENT: The operative mechanism is that independence-supporting features include multi-institutional selection, fixed tenure, protected removal, post-tenure restrictions, expenditure charged on...
        |
        v
CONSEQUENCE / CONTRAST: Constraints include an executive-heavy Selection Committee, no general suo motu complaint power, prescribed-form barriers, reliance on external investigation, coordination delays, confidentiality tensions, the seven-year bar, uncertain asset-rule implementation and uneven State models.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: over-secrecy can weaken legitimacy; over-disclosure can prejudice inquiry.
        |
        v
ANSWER-GRABBING FORMULATION: Independence-supporting features include multi-institutional selection, fixed tenure, protected removal, post-tenure restrictions, expenditure charged on the Consolidated Fund of India, diverse membership, own statutory wings and referred-case control over DSPE transfers.
```
### SESSION 26 — CRITIQUES, REPLIES AND REFORM PROPOSALS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Any proposal for suo motu power should include a recorded-reasons threshold, conflict/recusal rules, natural justice and judicial review.

**Technical definition:** Technically, Critiques, Replies And Reform Proposals is analysed by relating Critiques to Replies, then testing the relationship through Reform Proposals and “No teeth”.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Any proposal for suo motu power should include a recorded-reasons threshold, conflict/recusal rules, natural justice and judicial review.
...
```text
START / CONCEPT: CRITIQUES, REPLIES AND REFORM PROPOSALS
        |
        v
EXACT TERMS: Critiques · Replies · Reform Proposals · “No teeth” · No general suo motu complaint route; agency dependence · “Executive capture”
        |
        v
MECHANISM / ARGUMENT: A model State Lokayukta law could propose minimum jurisdiction, appointment diversity, tenure protection, investigation safeguards, response deadlines and reporting standards while leaving States room to legislate.
        |
        v
CONSEQUENCE / CONTRAST: More power without procedure can politicise the institution it seeks to strengthen.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: publishing anonymised reasons for closure and aggregate stage-wise data could improve legitimacy without freezing...
        |
        v
ANSWER-GRABBING FORMULATION: Any proposal for suo motu power should include a recorded-reasons threshold, conflict/recusal rules, natural justice and judicial review.
```
...
| MPs wholly immune | Protected speech/vote; bribery not immunised after *Sita Soren* |
...
|---|---|---|
| Composition, appointment, jurisdiction, procedure, powers | Current India Code PDF | Checked 19 Aug 2026 |
...
| LoP vacancy | *Common Cause* official judgment | Exact holding used |
| Legislative bribery | *Sita Soren* official judgment | Exact privilege boundary used |
...
- `[FACT]` India Code, **Lokpal and Lokayuktas Act, 2013**, current official consolidated PDF checked on 19 August 2026.
...
- `[FACT]` Supreme Court, ***Common Cause v Union of India***, W.P.(C) 245/2014, judgment dated 27 April 2017.
- `[FACT]` Supreme Court, ***Lok Prahari v Union of India***, W.P.(C) 784/2015, judgment dated 16 February 2018.
- `[FACT]` Supreme Court, ***Sita Soren v Union of India***, 2024 INSC 161, judgment dated 4 March 2024.
...
A. A Chairperson and not more than ten Members.
B. A Chairperson and not more than eight Members.
C. A Chairperson and exactly eight Members.
D. A Chairperson, eight Members and the CVC as an ex officio Member.
...
A. The representation rule applies only to non-judicial Members.
B. Half of the whole institution, including the Chairperson, must be judicial.
...
D. At least half of the Members must be serving judges.
...
A. Only a former Chief Justice of India.
B. Only a Supreme Court Judge.
...
B. Thirty years in any occupation.
C. Ten years of judicial office.
D. Twenty years as an MP.
...
B. It makes the final presidential appointment.
C. It can consider only serving judges.
D. It consists of exactly five constitutional office-holders.
...
Under current section 4 and *Common Cause*:
...
**Explanation:** `[FACT]` Section 4(2) is the vacancy-validity rule. *Common Cause* held the Act workable; it did not enact a new substitute seat.
...
Which proposition correctly reconciles section 14(2) with *Sita Soren*?
...
A. Only United Nations grants.
B. Any domestic donation.
C. Foreign-source donations exceeding ten lakh rupees in a year or a higher notified amount.
D. Any government grant, however small, without further condition.
...
A. Preliminary inquiry is always by a court.
B. Preliminary inquiry tests prima facie basis; investigation gathers evidence for the criminal report.
C. Investigation is only departmental.
D. Both are final trials.
...
A. Preliminary report in 90 days; investigation cannot be extended.
B. Every inquiry and trial must finish within six months.
C. Report within 60 days of reference; ordinary inquiry 90 days with further 90 days for recorded reasons.
D. Preliminary inquiry always ends in 30 days; investigation in 90 days.
...
A. Amend the Prevention of Corruption Act.
B. Convict the public servant.
C. Dissolve the department.
...
B. Seven years.
C. Thirty days without extension.
D. One year without extension.
...
A. Eliminates all federal consent requirements.
B. Applies to matters Lokpal refers, but cannot dictate investigation/disposal in a particular manner.
C. Covers every CBI case in India.
D. Converts Lokpal into the CBI Director.
...
A. Search is barred before investigation.
B. Lokpal personally conducts every physical search.
C. CVC issues all search warrants.
...
B. Declaring statutes unconstitutional.
C. Exercising a general contempt jurisdiction.
D. Awarding criminal sentences.
...
A. Indefinitely at Lokpal’s discretion.
B. Up to ninety days, followed by Special Court control.
C. Until retirement of the public servant.
D. Thirty days with no court role.
...
A. Applies without any statutory conditions to every constitutional office-holder.
B. Replaces the Special Court.
C. Authorises prosecution under the section 20 route, subject to section 23’s qualifications.
D. Is identical to a conviction.
...
A. Applies only to MPs.
B. Requires declaration in the form and manner to be prescribed.
C. Abolishes all asset declarations.
D. Automatically republishes the original detailed format.
...
A. *Lok Prahari* automatically restored the original section 44 form.
...
**Explanation:** `[FACT]` Section 44 was substituted. `[LIMIT]` *Lok Prahari* concerned electoral disclosure and monitoring; it is not a substitute for rules under the amended provision.
...
2. Article 105(2) and section 14(2); *Sita Soren* on bribery.
3. PM provisos.
...
Breadth is nevertheless qualified. A PM complaint cannot concern the listed sovereign domains and requires a full-bench, two-thirds decision, in-camera inquiry and special control over dismissed records. For MPs, section 14(2) respects Article 105(2) for anything said or any vote given in Parliament. After *Sita Soren*, bribery is not protected merely because it relates to a legislative vote, but genuine speech/vote functions remain privileged.
...
**Why this earns marks:** The answer organises breadth and filters around persons, PM safeguards, privilege after *Sita Soren*, entity conditions and limitation.
...
- *Common Cause*, *Sita Soren*, *Lok Prahari* boundary and 2025 High Court-judge stay.
...
[FACT] *Common Cause v Union of India*: the Act remained workable despite absence of a recognised LoP; a truncated committee could proceed.
...
[FACT] *Sita Soren v Union of India* (2024): bribery is not immunised merely because it is connected to a legislative vote or speech.
...
[FACT] *Lok Prahari* addresses candidate/legislator electoral asset disclosure and monitoring; it does not itself supply rules under amended section 44.
...
|---|---|
| *Common Cause v Union of India* | Act workable despite LoP vacancy; appointment not invalid merely for vacancy |
| *Sita Soren v Union of India* | Bribery not protected by legislative privilege |
| *Lok Prahari v Union of India* | Electoral asset disclosure/monitoring context; not restoration of original section 44 |
...
#### ASCII MASTER FLOW — PANEL 1/12: Ombudsman evolution and statutory identity
...
#### ASCII MASTER FLOW — PANEL 2/12: Composition and eligibility

```ascii-master
COMPOSITION
Chairperson + not more than eight Members.
50% judicial | at least 50% from named social categories.

ELIGIBILITY
judicial and eminent-person routes have distinct statutory conditions.

TRAP
representation applies to Members; it is not an extra seat count.
```

#### ASCII MASTER FLOW — PANEL 3/12: Selection, tenure and removal

```ascii-master
SELECTION
PM | Speaker | LoP | CJI/nominee | eminent jurist.
Search Committee assists; President appoints on recommendation.

TENURE
five years or age seventy | no reappointment.

REMOVAL
misbehaviour: President -> Supreme Court inquiry.
Specified direct-removal grounds remain separate.

Common Cause v. Union of India (2017): vacancy did not make the Act unworkable.
```

#### ASCII MASTER FLOW — PANEL 4/12: Jurisdiction over persons and entities

```ascii-master
PERSONS
PM | Ministers | MPs | Groups A-D | former covered functionaries.

ENTITIES
government-linked bodies and specified donation/foreign-contribution recipients,
subject to statutory thresholds.

TRAP
coverage is conditional; Lokpal has no general private-sector jurisdiction.
```

#### ASCII MASTER FLOW — PANEL 5/12: Prime Minister and parliamentary privilege

```ascii-master
PM FILTER
excluded domains: international relations | security | public order | atomic energy | space.
Full bench + two-thirds approval | in camera | record controls.

MP RULE
section 14(2) preserves genuine speech/vote functions.
Sita Soren (2024): bribery is not immunised merely because linked to a vote.
```

#### ASCII MASTER FLOW — PANEL 6/12: Complaint and preliminary inquiry

```ascii-master
PRESCRIBED COMPLAINT
identity + affidavit + particulars + supporting material -> scrutiny.

LOKPAL CHOICE
preliminary inquiry | investigation | lawful closure.

INQUIRY
prima facie screen -> public-servant hearing -> reasoned report.
Inquiry is not investigation and allegation is not guilt.
```

#### ASCII MASTER FLOW — PANEL 7/12: Investigation, prosecution and Special Court

```ascii-master
INVESTIGATION
CBI/other agency gathers evidence within statutory timelines.

LOKPAL BENCH
closure | departmental action | sanction/prosecution route.

PROSECUTION WING
files and conducts prosecution when directed.

SPECIAL COURT
adjudicates guilt; target one year with recorded extensions, total two years.
```

#### ASCII MASTER FLOW — PANEL 8/12: Inquiry Wing, CVC and CBI interfaces
...
#### ASCII MASTER FLOW — PANEL 9/12: Powers, assets and limitation
...
#### ASCII MASTER FLOW — PANEL 10/12: Lokayuktas and federal diversity
...
#### ASCII MASTER FLOW — PANEL 11/12: Cases and current legal controls

```ascii-master
Common Cause v. Union of India (2017) -> Act workable despite committee vacancy.
Lok Prahari v. Union of India (2018) -> electoral disclosure, not section 44 restoration.
Sita Soren (2024) -> bribery outside privilege immunity.

2025 HIGH COURT-JUDGE ISSUE
Supreme Court stayed the Lokpal order; no final merits holding.

CURRENT CLAIMS
use dated primary sources; do not freeze transient statistics.
```

#### ASCII MASTER FLOW — PANEL 12/12: UPSC traps and answer synthesis
