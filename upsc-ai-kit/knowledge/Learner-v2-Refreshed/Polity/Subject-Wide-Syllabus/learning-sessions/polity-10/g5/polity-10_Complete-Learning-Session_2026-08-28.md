...
> Kesavananda replaced an absolute rights lock with an identity-based limit.
...
START / CONCEPT: Doctrine chronology: from Fundamental Rights amendability to constitutional identity
        |
        v
EXACT TERMS: Doctrine chronology · from Fundamental Rights amendability to constitutional identity · prospective overruling · Shankari Prasad v. Union of India (1951) · Upheld the First Amendment · Sajjan Singh v. State of Rajasthan (1965)
        |
        v
...
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: kesavananda replaced an absolute rights lock with an identity-based limit.
        |
        v
ANSWER-GRABBING FORMULATION: Kesavananda replaced an absolute rights lock with an identity-based limit.
```
...
```text
START / CONCEPT: Kesavananda Bharati: holding architecture
        |
        v
EXACT TERMS: Kesavananda Bharati · holding architecture · Memory formula · Article 368 · The power · 13-judge Bench
        |
        v
...
START / CONCEPT: Basic-structure elements: illustrative and case-attributed
        |
        v
EXACT TERMS: Basic-structure elements · illustrative · case-attributed · degree and effect · Supremacy of the Constitution · Kesavananda opinions
        |
        v
...
```text
START / CONCEPT: The Anjum Kadari boundary: what basic structure does not do
        |
        v
EXACT TERMS: The Anjum Kadari boundary · solely · High-value correction · Union · India · INSC
        |
        v
...
B. *Bommai* - mandatory Presidential assent; *Anjum Kadari* - unlimited constituent power
