---
title: "Amendment and Basic Structure — Learner-v2 Refreshed"
topic_key: polity-10
cover_image: assets/polity-10_Teaching-Navigation_2026-08-28.png
---
...
- [CURRENT] *Anjum Kadari (2024) v. Union of India*, 2024 INSC 831, supplies the controlling technical boundary: an ordinary statute cannot be invalidated solely for violating an undefined “basic structure”; invalidity must be traced to legislative incompetence, Part III or another constitutional provision.
...
- Official judgments or Supreme Court records: *Shankari Prasad (1951)*, *Sajjan Singh (1964)* (1965), *I.C. Golak Nath* (1967), *Kesavananda Bharati (1973)* (24 April 1973), *Indira Nehru Gandhi* (1975), *Minerva Mills (1980)*, *Waman Rao (1980)* (1981), *S.R. Bommai* (1994), *L. Chandra Kumar* (1997), *I.R. Coelho (2007)*, the NJAC judgment (2015), and *Anjum Kadari (2024)* (5 November 2024).
...
| Basic features | Illustrative and case-attributed elements, not a closed Kesavananda Bharati (1973) list | Improves analytical precision |
| Ninth Schedule | Articles 31A/31B, Waman Rao (1980) cut-off and I.R. Coelho (2007) impact test | Prevents immunity overstatement |
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Polity\basic\Amendment-and-Basic-Structure.md`  
**Canonical topic owner:** `upsc-ai-kit\knowledge\Polity\basic\Amendment-and-Basic-Structure.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Polity\advanced\10_Amendment-and-Basic-Structure.md`  
...
- **Current-status note, rechecked 2026-09-05:** Rechecked 2026-09-05: Article 368 and its proviso remain controlling. Anjum Kadari (2024) confines free-standing basic-structure invalidation to constitutional amendments. The 131st Bill was negatived and never became law. S.O. 1922(E) commenced the 106th Amendment on 16 April 2026, but Article 334A's census-publication and delimitation gates remain operative.
...
![Refreshed teaching navigation](assets/polity-10_Teaching-Navigation_2026-08-28.png)

*Distinct embedded teaching-navigation image. The separate continuous Cārvāka-style flowchart package remains an independent at-a-glance artifact.*

### SESSION 1 — CONSTITUTIONAL DESIGN: CHANGE WITHOUT CONSTITUTIONAL DESTRUCTION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Qualified thesis: India permits constitutional adaptation through graded procedures, but neither an ordinary majority nor an Article 368 super-majority is legally sovereign.

**Technical definition:** The legally accurate contrast is constitutional supremacy versus parliamentary sovereignty, not “judiciary versus democracy”.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India does not adopt the United Kingdom's ordinary-legislation model for every constitutional change or the United States' high federal ratification threshold for every amendment.
...
**How to use them:** Frame the answer through Constitutional design; define change without constitutional destruction, connect Part XX with constituent power to explain the mechanism, and use Qualified thesis for the decisive comparison or qualification.

![India occupies a graded middle position: ordinary-law flexibility, Article 368 entrenchment and a judicially enforced substantive ceiling.](assets/01_flexibility_rigidity_spectrum.png)
...
- [ANALYSIS] The design is flexible in subject coverage but rigid in procedure. *Kesavananda Bharati (1973)* later added a substantive identity limit.
...
- [FACT] Courts exercise judicial review under constitutional authority. *Minerva Mills (1980)* treats judicial review and limited amending power as basic features.
...
#### CLOSING RECALL FLOW — CONSTITUTIONAL DESIGN: CHANGE WITHOUT CONSTITUTIONAL DESTRUCTION

```text
START / CONCEPT: Constitutional design: change without constitutional destruction
        |
        v
EXACT TERMS: Constitutional design · change without constitutional destruction · Part XX · constituent power · Qualified thesis · constitutional supremacy versus parliamentary sovereignty
        |
        v
MECHANISM / ARGUMENT: Qualified thesis: India permits constitutional adaptation through graded procedures, but neither an ordinary majority nor an Article 368 super-majority is legally sovereign.
        |
        v
CONSEQUENCE / CONTRAST: The legally accurate contrast is constitutional supremacy versus parliamentary sovereignty, not “judiciary versus democracy”.
        |
        v
UPSC TRAP / ANSWER-USE: It does not answer the separate substantive question whether a change destroys the Constitution's identity.
        |
        v
ANSWER-GRABBING FORMULATION: India does not adopt the United Kingdom's ordinary-legislation model for every constitutional change or the United States' high federal ratification threshold for every amendment.
```
### SESSION 2 — ORDINARY LEGISLATIVE POWER AND CONSTITUENT POWER

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Ordinary legislative power makes law within the existing Constitution, whereas constituent power changes the constitutional text through the amendment authority and procedure in Article 368.

**Technical definition:** Constituent power under Article 368 operates by addition, variation or repeal of constitutional provisions, while ordinary legislative power remains limited by legislative competence and the unchanged constitutional framework.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The Constitution distinguishes law-making under distributed legislative competence from constitution-amending constituent power, because changing an ordinary rule is not the same as altering the higher legal framework.
...
**How to use them:** Define ordinary legislative power through legislative competence, contrast it with constituent power under Article 368, and use addition and variation to show how constitutional amendment differs from ordinary law-making.

![Ordinary statutes and constitutional amendments operate in different fields and face different validity tests.](assets/02_constituent_vs_legislative_power.png)
...
| Basic-structure doctrine | Not a free-standing invalidation ground after *Anjum Kadari (2024)* | Direct substantive control |
...
#### CLOSING RECALL FLOW — ORDINARY LEGISLATIVE POWER AND CONSTITUENT POWER

```text
START / CONCEPT: Ordinary legislative power and constituent power
        |
        v
EXACT TERMS: ordinary legislative power · constituent power · Article 368 · legislative competence · addition · variation
        |
        v
MECHANISM / ARGUMENT: Ordinary legislation remains valid only within the Constitution, while an Article 368 amendment changes constitutional text through an entrenched constituent procedure.
        |
        v
CONSEQUENCE / CONTRAST: The distinction explains why simple-majority constitutional changes may be legally excluded from Article 368 and why ordinary statutes cannot claim the status of constitutional amendments.
        |
        v
UPSC TRAP / ANSWER-USE: Do not describe every Act of Parliament as constituent power or assume that every constitutional change must follow Article 368.
        |
        v
ANSWER-GRABBING FORMULATION: The Constitution distinguishes law-making under distributed legislative competence from constitution-amending constituent power, because changing an ordinary rule is not the same as altering the higher legal framework.
```
### SESSION 3 — THREE CONSTITUTIONAL CHANGE ROUTES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The Constitution uses three routes for change: simple-majority changes outside Article 368, Article 368 special-majority amendments, and amendments that additionally require ratification by at least half of the States.

**Technical definition:** The route depends on the provision changed: ordinary legislative form for expressly excluded matters, the dual special majority for most Article 368 amendments, and the proviso's federal ratification for its closed subject list.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India's amendment design combines flexibility and rigidity by matching the degree of entrenchment to the constitutional importance and federal sensitivity of the provision being changed.
...
**How to use them:** Begin with simple majority outside Article 368, explain special majority through total membership and present and voting, then add State ratification only for the Article 368 proviso subjects.

![The route is selected from the enabling constitutional provision, not from the political importance of the proposed change.](assets/03_three_route_decision_tree.png)
...
#### CLOSING RECALL FLOW — THREE CONSTITUTIONAL CHANGE ROUTES

```text
START / CONCEPT: Three constitutional change routes
        |
        v
EXACT TERMS: simple majority · special majority · total membership · present and voting · Article 368 proviso
        |
        v
MECHANISM / ARGUMENT: Increasing entrenchment moves from ordinary parliamentary passage to two simultaneous House-majority limbs and finally to a federal consent stage.
        |
        v
CONSEQUENCE / CONTRAST: The graded routes permit routine institutional adjustment while protecting constitutional and federal fundamentals from easy alteration.
        |
        v
UPSC TRAP / ANSWER-USE: Do not call a simple-majority change an Article 368 amendment or assume that every federal-looking amendment requires State ratification.
        |
        v
ANSWER-GRABBING FORMULATION: India's amendment design combines flexibility and rigidity by matching the degree of entrenchment to the constitutional importance and federal sensitivity of the provision being changed.
```
### SESSION 4 — EXACT ARTICLE 368 PROCEDURE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** There is no joint sitting under Article 108 for a constitutional-amendment deadlock or rejection.

**Technical definition:** Article 107(5) states that a Bill pending in Rajya Sabha which Lok Sabha has not passed does not lapse merely because Lok Sabha is dissolved.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> There is no joint sitting under Article 108 for a constitutional-amendment deadlock or rejection.

#### MUST-WRITE KEYWORDS

- **Exact Article 368 procedure**
- **Minister or a private member**
- **No prior recommendation of the President**
- **separately**
- **no joint sitting**
- **before**

**How to use them:** Frame the answer through Exact Article 368 procedure; define Minister or a private member, connect No prior recommendation of the President with separately to explain the mechanism, and use no joint sitting for the decisive comparison or qualification.

![The procedure contains sequential veto points; failure in either House cannot be cured by a joint sitting.](assets/04_article_368_procedure.png)
...
#### CLOSING RECALL FLOW — EXACT ARTICLE 368 PROCEDURE

```text
START / CONCEPT: Exact Article 368 procedure
        |
        v
EXACT TERMS: Exact Article 368 procedure · Minister or a private member · No prior recommendation of the President · separately · no joint sitting · before
        |
        v
MECHANISM / ARGUMENT: Article 107(5) states that a Bill pending in Rajya Sabha which Lok Sabha has not passed does not lapse merely because Lok Sabha is dissolved.
        |
        v
CONSEQUENCE / CONTRAST: If the Bill changes a proviso subject, ratification by not less than half of the State legislatures must occur before presentation to the President.
        |
        v
UPSC TRAP / ANSWER-USE: Do not turn the narrow rule into “constitutional-amendment Bills never lapse”.
        |
        v
ANSWER-GRABBING FORMULATION: There is no joint sitting under Article 108 for a constitutional-amendment deadlock or rejection.
```
### SESSION 5 — FEDERAL RATIFICATION: THE EXACT PROVISO LIST

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Conditions of the Governor's office are not in the proviso list.

**Technical definition:** The proviso uses the two exact Judiciary Chapters and separately names Article 241.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Conditions of the Governor's office are not in the proviso list.

#### MUST-WRITE KEYWORDS

- **Federal ratification**
- **the exact proviso list**
- **Articles 54 and 55**
- **Articles 73 and 162**
- **Article 241**
- **Article 279A**

**How to use them:** Frame the answer through Federal ratification; define the exact proviso list, connect Articles 54 and 55 with Articles 73 and 162 to explain the mechanism, and use Article 241 for the decisive comparison or qualification.

![The exact Article, Chapter and Schedule groups are safer than the loose “SC/HC and federal provisions” shorthand.](assets/06_federal_ratification_list.png)
...
#### CLOSING RECALL FLOW — FEDERAL RATIFICATION: THE EXACT PROVISO LIST

```text
START / CONCEPT: Federal ratification: the exact proviso list
        |
        v
EXACT TERMS: Federal ratification · the exact proviso list · Articles 54 and 55 · Articles 73 and 162 · Article 241 · Article 279A
        |
        v
MECHANISM / ARGUMENT: An amendment must be ratified by not less than half of the State legislatures if it seeks to change.
        |
        v
CONSEQUENCE / CONTRAST: “Supreme Court and High Courts” is useful shorthand but incomplete.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the proviso uses the two exact Judiciary Chapters and separately names Article 241.
        |
        v
ANSWER-GRABBING FORMULATION: Conditions of the Governor's office are not in the proviso list.
```
### SESSION 6 — DUAL SPECIAL-MAJORITY ARITHMETIC: THE 2026 DEFEATED BILL

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Dual special-majority arithmetic: the 2026 defeated Bill comprises Dual special-majority arithmetic, the 2026 defeated Bill and negatived in Lok Sabha as its core connected dimensions.

**Technical definition:** The Bill proposed, among other changes, substituting Article 81(1) with ceilings of up to 815 directly elected members from States and 35 members for Union territories - a combined proposed ceiling of 850. [CURRENT] The Bill was put to a division on 17 April 2026: 298 ayes, 230 noes, 528 present and voting.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The Bill's 298 ayes failed this limb. [CURRENT] The Bill was therefore negatived in Lok Sabha.

#### MUST-WRITE KEYWORDS

- **Dual special-majority arithmetic**
- **the 2026 defeated Bill**
- **negatived in Lok Sabha**
- **16 April 2026**
- **17 April 2026**
- **298 ayes, 230 noes, 528 present and voting**

**How to use them:** Frame the answer through Dual special-majority arithmetic; define the 2026 defeated Bill, connect negatived in Lok Sabha with 16 April 2026 to explain the mechanism, and use 17 April 2026 for the decisive comparison or qualification.

![The 2026 division cleanly demonstrates that an ordinary governing majority is not an amending majority.](assets/05_dual_majority_arithmetic.png)
...
#### CLOSING RECALL FLOW — DUAL SPECIAL-MAJORITY ARITHMETIC: THE 2026 DEFEATED BILL

```text
START / CONCEPT: Dual special-majority arithmetic: the 2026 defeated Bill
        |
        v
EXACT TERMS: Dual special-majority arithmetic · the 2026 defeated Bill · negatived in Lok Sabha · 16 April 2026 · 17 April 2026 · 298 ayes, 230 noes, 528 present and voting
        |
        v
MECHANISM / ARGUMENT: The Bill proposed, among other changes, substituting Article 81(1) with ceilings of up to 815 directly elected members from States and 35 members for Union territories - a combined proposed ceiling of 850. [CURRENT] The Bill was put to a division on 17 April 2026: 298 ayes, 230 noes, 528 present and voting.
        |
        v
CONSEQUENCE / CONTRAST: Exam line: The 2026 division separates ordinary political control from constituent capacity: 298 votes were enough for the total-membership limb but not for the two-thirds present-and-voting limb.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: majority of total Lok Sabha membership (543) requires at least 272.
        |
        v
ANSWER-GRABBING FORMULATION: The Bill's 298 ayes failed this limb. [CURRENT] The Bill was therefore negatived in Lok Sabha.
```
### SESSION 7 — DOCTRINE CHRONOLOGY: FROM FUNDAMENTAL RIGHTS AMENDABILITY TO CONSTITUTIONAL IDENTITY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Kesavananda Bharati (1973) replaced an absolute rights lock with an identity-based limit.

**Technical definition:** Technically, Doctrine chronology: from Fundamental Rights amendability to constitutional identity is analysed by relating Doctrine chronology to from Fundamental Rights amendability to constitutional identity, then testing the relationship through prospective overruling and Shankari Prasad (1951) v. Union of India (1951).

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Kesavananda Bharati (1973) replaced an absolute rights lock with an identity-based limit.

#### MUST-WRITE KEYWORDS

- **Doctrine chronology**
- **from Fundamental Rights amendability to constitutional identity**
- **prospective overruling**
- **Shankari Prasad (1951) v. Union of India (1951)**
- **Upheld the First Amendment**
- **Sajjan Singh (1964) v. State of Rajasthan (1965)**

**How to use them:** Frame the answer through Doctrine chronology; define from Fundamental Rights amendability to constitutional identity, connect prospective overruling with Shankari Prasad (1951) v. Union of India (1951) to explain the mechanism, and use Upheld the First Amendment for the decisive comparison or qualification.

![The chronology moves from unrestricted amendability, through Golak Nath's rights lock, to Kesavananda Bharati (1973)'s identity limit and later applications.](assets/07_doctrine_case_timeline.png)

| Case / amendment | Exact holding or constitutional response | Exam qualification |
|---|---|---|
| *Shankari Prasad (1951) v. Union of India* (1951) | Parliament could amend Fundamental Rights; a constitutional amendment under Article 368 was not “law” for Article 13(2) | Upheld the First Amendment |
| *Sajjan Singh (1964) v. State of Rajasthan* (1965) | Reaffirmed *Shankari Prasad (1951)* and upheld Parliament's power to amend Fundamental Rights | Separate opinions raised early doubts about alteration of basic features |
...
| *Kesavananda Bharati (1973) v. State of Kerala* (1973) | Parliament may amend any part, including Fundamental Rights, but cannot damage or destroy the basic structure | 13 judges; 7:6; judgment on 24 April 1973 |
| 39th Amendment (1975) and *Indira Nehru Gandhi v. Raj Narain (1975)* | Attempted to insulate specified high-office election disputes; the Court struck the offending part and applied basic features including free and fair elections, rule of law and judicial review | Do not confuse the 39th Amendment with the 44th |
...
| *Minerva Mills (1980) v. Union of India* (1980) | Struck Article 368(4) and (5); limited amending power and judicial review are basic; harmony between Fundamental Rights and Directive Principles is basic | Also invalidated the 42nd Amendment's expanded Article 31C |
| *Waman Rao (1980) v. Union of India* (1981) | Applied the doctrine prospectively to Ninth Schedule insertions after 24 April 1973 | The cut-off concerns constitutional amendments placing laws in the Schedule |
...
| *I.R. Coelho (2007) v. State of Tamil Nadu* (2007) | Post-24 April 1973 Ninth Schedule insertions are reviewable for their impact on Part III rights forming the basic structure | No automatic invalidity of every post-1973 law |
...
| *Anjum Kadari (2024) v. Union of India* (2024 INSC 831) | Ordinary legislation cannot be invalidated solely for violating basic structure; the defect must be traced to competence, Part III or another constitutional provision | Major technical boundary for current answers |
...
4. *Kesavananda Bharati (1973)* replaced an absolute rights lock with an identity-based limit.
5. *Indira Nehru Gandhi v. Raj Narain (1975)*, *Minerva Mills (1980)*, *Coelho* and NJAC demonstrated that the ceiling is judicially enforceable.
6. *Anjum Kadari (2024)* prevented the doctrine from becoming an undefined free-standing attack on ordinary statutes.

#### CLOSING RECALL FLOW — DOCTRINE CHRONOLOGY: FROM FUNDAMENTAL RIGHTS AMENDABILITY TO CONSTITUTIONAL IDENTITY

```text
START / CONCEPT: Doctrine chronology: from Fundamental Rights amendability to constitutional identity
        |
        v
EXACT TERMS: Doctrine chronology · from Fundamental Rights amendability to constitutional identity · prospective overruling · Shankari Prasad (1951) v. Union of India (1951) · Upheld the First Amendment · Sajjan Singh (1964) v. State of Rajasthan (1965)
        |
        v
MECHANISM / ARGUMENT: Indira Nehru Gandhi v. Raj Narain (1975), Minerva Mills (1980), Coelho and NJAC demonstrated that the ceiling is judicially enforceable.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that Kesavananda Bharati (1973) replaced an absolute rights lock with an identity-based limit.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: Kesavananda Bharati (1973) replaced an absolute rights lock with an identity-based limit.
        |
        v
ANSWER-GRABBING FORMULATION: Kesavananda Bharati (1973) replaced an absolute rights lock with an identity-based limit.
```
### SESSION 8 — KESAVANANDA BHARATI (1973): HOLDING ARCHITECTURE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The power is nevertheless limited: an amendment cannot damage, destroy or abrogate the Constitution's basic structure or framework.

**Technical definition:** Technically, Kesavananda Bharati (1973): holding architecture is analysed by relating Kesavananda Bharati (1973) to holding architecture, then testing the relationship through Memory formula and Article 368.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The power is nevertheless limited: an amendment cannot damage, destroy or abrogate the Constitution's basic structure or framework.
...
**How to use them:** Frame the answer through Kesavananda Bharati (1973); define holding architecture, connect Memory formula with Article 368 to explain the mechanism, and use The power for the decisive comparison or qualification.

![Kesavananda Bharati (1973) protects constitutional adaptability and constitutional identity at the same time.](assets/08_kesavananda_holding_architecture.png)
...
#### CLOSING RECALL FLOW — KESAVANANDA BHARATI (1973): HOLDING ARCHITECTURE

```text
START / CONCEPT: Kesavananda Bharati (1973): holding architecture
        |
        v
EXACT TERMS: Kesavananda Bharati (1973) · holding architecture · Memory formula · Article 368 · The power · 13-judge Bench
        |
        v
MECHANISM / ARGUMENT: The 24th Amendment's restoration of amending power was upheld subject to this limitation.
        |
        v
CONSEQUENCE / CONTRAST: The doctrine shifts the question from “which provision is absolutely unamendable?” to “does the amendment preserve the Constitution's identity after change?”.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: an amendment cannot damage, destroy or abrogate the Constitution's basic structure or framework.
        |
        v
ANSWER-GRABBING FORMULATION: The power is nevertheless limited: an amendment cannot damage, destroy or abrogate the Constitution's basic structure or framework.
```
### SESSION 9 — BASIC-STRUCTURE ELEMENTS: ILLUSTRATIVE AND CASE-ATTRIBUTED

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The list remains illustrative and judicially evolving.

**Technical definition:** Different judges in Kesavananda Bharati (1973) proposed overlapping lists; the narrow majority ratio is the limitation on destruction of basic structure, not one unanimous catalogue.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The list remains illustrative and judicially evolving.
...
- **Kesavananda Bharati (1973) opinions**

**How to use them:** Frame the answer through Basic-structure elements; define illustrative, connect case-attributed with degree and effect to explain the mechanism, and use Supremacy of the Constitution for the decisive comparison or qualification.

![Recognised elements emerged across cases; attribution is safer than reciting a closed list.](assets/09_elements_case_attribution_matrix.png)

| Feature | Principal attribution / use | Safe formulation |
|---|---|---|
| Supremacy of the Constitution | *Kesavananda Bharati (1973)* opinions | Parliament remains constitutionally limited |
| Republican and democratic form | *Kesavananda Bharati (1973)* opinions | Elections alone do not exhaust democracy |
| Secularism | *Kesavananda Bharati (1973)*; strongly reaffirmed in *S.R. Bommai* | State neutrality/equal concern is constitutionally entrenched |
| Federalism | *Kesavananda Bharati (1973)*; *S.R. Bommai* | Indian federalism may be asymmetric yet cannot be destroyed |
| Separation of powers | *Kesavananda Bharati (1973)* and later cases | Functional overlap is permitted; institutional obliteration is not |
| Rule of law | *Indira Nehru Gandhi* and later cases | Public power remains governed by law and review |
| Judicial review | *Indira Nehru Gandhi v. Raj Narain (1975)*, *Minerva Mills (1980)*, *L. Chandra Kumar* | Review is an essential constitutional control |
...
| Dignity, liberty and equality essence | *Kesavananda Bharati (1973)* opinions; Part III impact cases including *Coelho* | Not every textual detail is frozen, but rights identity cannot be destroyed |
| Fundamental Rights-Directive Principles harmony | *Minerva Mills (1980)* | Neither liberty nor social transformation may annihilate the other |
| Limited amending power | *Minerva Mills (1980)* | Parliament cannot enlarge a limited power into an unlimited one |
...
| Unity and integrity | *Kesavananda Bharati (1973)* opinions | Constitutional unity must coexist with federalism and pluralism |
...
- [LIMIT] Different judges in *Kesavananda Bharati (1973)* proposed overlapping lists; the narrow majority ratio is the limitation on destruction of basic structure, not one unanimous catalogue.
...
#### CLOSING RECALL FLOW — BASIC-STRUCTURE ELEMENTS: ILLUSTRATIVE AND CASE-ATTRIBUTED

```text
START / CONCEPT: Basic-structure elements: illustrative and case-attributed
        |
        v
EXACT TERMS: Basic-structure elements · illustrative · case-attributed · degree and effect · Supremacy of the Constitution · Kesavananda Bharati (1973) opinions
        |
        v
MECHANISM / ARGUMENT: Courts examine the degree and effect of a constitutional amendment: adjustment is permitted; damage or destruction is not.
        |
        v
CONSEQUENCE / CONTRAST: Different judges in Kesavananda Bharati (1973) proposed overlapping lists; the narrow majority ratio is the limitation on destruction of basic structure, not one unanimous catalogue.
        |
        v
UPSC TRAP / ANSWER-USE: A feature's inclusion does not mean every policy touching it is unconstitutional.
        |
        v
ANSWER-GRABBING FORMULATION: The list remains illustrative and judicially evolving.
```
### SESSION 10 — NINTH SCHEDULE ARCHITECTURE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Constitutional amendments inserting laws into the Ninth Schedule after that date are open to basic-structure scrutiny.

**Technical definition:** The Ninth Schedule and Article 31B were introduced by the First Amendment Act, 1951.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Constitutional amendments inserting laws into the Ninth Schedule after that date are open to basic-structure scrutiny.

#### MUST-WRITE KEYWORDS

- **Ninth Schedule architecture**
...
**How to use them:** Frame the answer through Ninth Schedule architecture; define First Amendment Act, 1951, connect reviewable with Polity 07 to explain the mechanism, and use Polity 08 for the decisive comparison or qualification.

![Waman Rao (1980) supplies the temporal cut-off; I.R. Coelho (2007) supplies the rights-to-basic-structure impact test.](assets/10_ninth_schedule_review_flow.png)
...
#### Waman Rao (1980) cut-off

- [FACT] *Waman Rao (1980)* treated **24 April 1973**, the date of *Kesavananda Bharati (1973)*, as the prospective dividing line.
...
#### I.R. Coelho (2007) impact test

- [FACT] *I.R. Coelho (2007)* unanimously rejected blanket post-1973 immunity.
...
#### CLOSING RECALL FLOW — NINTH SCHEDULE ARCHITECTURE

```text
START / CONCEPT: Ninth Schedule architecture
        |
        v
EXACT TERMS: Ninth Schedule architecture · First Amendment Act, 1951 · reviewable · Polity 07 · Polity 08 · 24 April 1973
        |
        v
MECHANISM / ARGUMENT: The Ninth Schedule and Article 31B were introduced by the First Amendment Act, 1951.
        |
        v
CONSEQUENCE / CONTRAST: Article 31A and Article 31B are connected property-reform protections but are not identical mechanisms.
        |
        v
UPSC TRAP / ANSWER-USE: The proposition is not “every pre-1973 law is perfect” or “every post-1973 law is void”.
        |
        v
ANSWER-GRABBING FORMULATION: Constitutional amendments inserting laws into the Ninth Schedule after that date are open to basic-structure scrutiny.
```
### SESSION 11 — THE ANJUM KADARI (2024) BOUNDARY: WHAT BASIC STRUCTURE DOES NOT DO

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** High-value correction: “The Act violates the basic structure” is incomplete.

**Technical definition:** If secularism or another basic feature is invoked against a statute, the infringement must be traced to the constitutional provisions that embody that feature.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> High-value correction: “The Act violates the basic structure” is incomplete.

#### MUST-WRITE KEYWORDS

- **The Anjum Kadari (2024) boundary**
- **solely**
...
**How to use them:** Frame the answer through The Anjum Kadari (2024) boundary; define solely, connect High-value correction with Union to explain the mechanism, and use India for the decisive comparison or qualification.

![The 2024 judgment requires an express constitutional hook when ordinary legislation is challenged.](assets/11_anjum_kadari_boundary.png)

#### Controlling proposition

- [FACT] *Anjum Kadari (2024) v. Union of India*, 2024 INSC 831, held that a statute can be struck down for:
...
#### CLOSING RECALL FLOW — THE ANJUM KADARI (2024) BOUNDARY: WHAT BASIC STRUCTURE DOES NOT DO

```text
START / CONCEPT: The Anjum Kadari (2024) boundary: what basic structure does not do
        |
        v
EXACT TERMS: The Anjum Kadari (2024) boundary · solely · High-value correction · Union · India · INSC
        |
        v
MECHANISM / ARGUMENT: Union of India, 2024 INSC 831, held that a statute can be struck down for lack of legislative competence; or violation of Part III or another constitutional provision.
        |
        v
CONSEQUENCE / CONTRAST: The NJAC litigation involved the 99th Constitutional Amendment as the primary basic-structure target; the dependent Act did not create a general free-standing statute test.
        |
        v
UPSC TRAP / ANSWER-USE: Tribunal cases may use separation of powers and judicial independence, but the statutory defect should be connected to Articles governing judicial review, equality, court substitution or another express constitutional command.
        |
        v
ANSWER-GRABBING FORMULATION: High-value correction: “The Act violates the basic structure” is incomplete.
```
### SESSION 12 — CURRENT CONTROL I: 106TH AMENDMENT - COMMENCED, NOT OPERATIONAL

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 334A(1) states that the reservation provisions come into effect after publication of the relevant figures of the first census taken after commencement; and a delimitation exercise undertaken for this purpose. [CURRENT] Therefore, as of 28 August 2026, the Act has commenced but the reservation is not operational.

**Technical definition:** Quote the constitutional phrase “fifteen years from such commencement” when duration is relevant.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 334A(1) states that the reservation provisions come into effect after publication of the relevant figures of the first census taken after commencement; and a delimitation exercise undertaken for this purpose. [CURRENT] Therefore, as of 28 August 2026, the Act has commenced but the reservation is not operational.
...
- **106th Amendment - commenced**
- **16 April 2026**

**How to use them:** Frame the answer through Current control I; define not operational, connect S.O. 1922(E) with first census taken after commencement to explain the mechanism, and use 106th Amendment - commenced for the decisive comparison or qualification.

![Article 334A separates legal commencement from the later census-publication and delimitation gates.](assets/12_106th_commencement_vs_operation.png)
...
#### CLOSING RECALL FLOW — CURRENT CONTROL I: 106TH AMENDMENT - COMMENCED, NOT OPERATIONAL

```text
START / CONCEPT: Current control I: 106th Amendment - commenced, not operational
        |
        v
EXACT TERMS: Current control I · not operational · S.O. 1922(E) · first census taken after commencement · 106th Amendment - commenced · 16 April 2026
        |
        v
MECHANISM / ARGUMENT: Do not state an implementation election, implementation year, delimitation date or census final-publication date.
        |
        v
CONSEQUENCE / CONTRAST: Do not compute the reservation's end date.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: quote the constitutional phrase “fifteen years from such commencement” when duration is relevant.
        |
        v
ANSWER-GRABBING FORMULATION: Article 334A(1) states that the reservation provisions come into effect after publication of the relevant figures of the first census taken after commencement; and a delimitation exercise undertaken for this purpose. [CURRENT] Therefore, as of 28 August 2026, the Act has commenced but the reservation is not operational.
```
### SESSION 13 — CURRENT CONTROL II: THE 2023 ANNIVERSARY AND SOVEREIGNTY DEBATE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** These remarks are a political and institutional debate.

**Technical definition:** Technically, Current control II: the 2023 anniversary and sovereignty debate is analysed by relating Current control II to the 2023 anniversary, then testing the relationship through sovereignty debate and Article 368.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> These remarks are a political and institutional debate.

#### MUST-WRITE KEYWORDS

- **Current control II**
- **the 2023 anniversary**
- **sovereignty debate**
- **Article 368**
- **These remarks**
- **These**

**How to use them:** Frame the answer through Current control II; define the 2023 anniversary, connect sovereignty debate with Article 368 to explain the mechanism, and use These remarks for the decisive comparison or qualification.

- [CURRENT] 24 April 2023 marked fifty years since the *Kesavananda Bharati (1973)* judgment.
...
- [LIMIT] These remarks are a political and institutional debate. They did not change Article 368, overrule *Kesavananda Bharati (1973)* or remove judicial review.
...
#### CLOSING RECALL FLOW — CURRENT CONTROL II: THE 2023 ANNIVERSARY AND SOVEREIGNTY DEBATE

```text
START / CONCEPT: Current control II: the 2023 anniversary and sovereignty debate
        |
        v
EXACT TERMS: Current control II · the 2023 anniversary · sovereignty debate · Article 368 · These remarks · These
        |
        v
MECHANISM / ARGUMENT: The strongest answer does not caricature the dispute criticism: an unelected Court polices the work of elected super-majorities through an unwritten doctrine; response: Indian Parliament is not legally sovereign, and electoral mandate cannot authorise destruction of democratic competition, rights, federalism or judicial review.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that the strongest answer does not caricature the dispute criticism.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the strongest answer does not caricature the dispute criticism.
        |
        v
ANSWER-GRABBING FORMULATION: These remarks are a political and institutional debate.
```
### SESSION 14 — EVALUATION: GUARDIAN OF CONSTITUTIONALISM OR JUDICIAL OVERREACH?

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Qualified verdict: The doctrine is best defended as a necessary form of judicial review under constitutional supremacy, but its legitimacy depends on disciplined attribution, a demanding damage test and refusal to use “basic structure” as an all-purpose policy objection.

**Technical definition:** If feature identification becomes impressionistic, judicial review can drift toward judicial supremacy.
...
- **Evaluation**
- **Qualified verdict**
- **Enforces constitutional limits through text, structure and precedent**
- **Treats judicial preference as sufficient**
- **Gives reasons and identifies the damaged feature**
- **Substitutes the Court for the amending body**

**How to use them:** Frame the answer through Evaluation; define Qualified verdict, connect Enforces constitutional limits through text, structure and precedent with Treats judicial preference as sufficient to explain the mechanism, and use Gives reasons and identifies the damaged feature for the decisive comparison or qualification.

![The doctrine is defensible as judicial review only if courts remain text-linked, reasoned and institutionally restrained.](assets/13_doctrine_criticism_defence.png)
...
3. [FACT] *Minerva Mills (1980)* demonstrates the self-defeating nature of unlimited amendment: a limited power cannot enlarge itself into an unlimited one.
...
#### CLOSING RECALL FLOW — EVALUATION: GUARDIAN OF CONSTITUTIONALISM OR JUDICIAL OVERREACH?

```text
START / CONCEPT: Evaluation: guardian of constitutionalism or judicial overreach?
        |
        v
EXACT TERMS: Evaluation · Qualified verdict · Enforces constitutional limits through text, structure and precedent · Treats judicial preference as sufficient · Gives reasons and identifies the damaged feature · Substitutes the Court for the amending body
        |
        v
MECHANISM / ARGUMENT: A court can invalidate an amendment passed by national and federal super-majorities, creating a counter-majoritarian concern.
        |
        v
CONSEQUENCE / CONTRAST: The Constitution does not enumerate a “basic structure” list or expressly state the doctrine.
        |
        v
UPSC TRAP / ANSWER-USE: The doctrine gives the judiciary the final institutional word on constitutional identity even though judges are not electorally accountable.
        |
        v
ANSWER-GRABBING FORMULATION: Qualified verdict: The doctrine is best defended as a necessary form of judicial review under constitutional supremacy, but its legitimacy depends on disciplined attribution, a demanding damage test and refusal to use “basic structure” as an all-purpose policy objection.
```
### SESSION 15 — PRELIMS CLOSE-OPTION CONTROLS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 368 is in Part XX, not Part III or Part XI.

**Technical definition:** Technically, Prelims close-option controls is analysed by relating Part XX to addition, variation and repeal, then testing the relationship through either House and or private member.
...
- **Part XX**
- **addition, variation and repeal**
- **either House**
- **or private member**
- **not**

**How to use them:** Frame the answer through Prelims close-option controls; define Part XX, connect addition, variation and repeal with either House to explain the mechanism, and use or private member for the decisive comparison or qualification.
...
- Basic structure was propounded in **Kesavananda Bharati (1973)**, not *Golak Nath*.
...
- Ordinary laws are not invalid solely for violating basic structure after *Anjum Kadari (2024)*.
- 131st Amendment Bill, 2026 was **defeated**, not enacted.
- 106th Amendment has **commenced** but the reservation is **not operational**.

#### CLOSING RECALL FLOW — PRELIMS CLOSE-OPTION CONTROLS

```text
START / CONCEPT: Prelims close-option controls
        |
        v
EXACT TERMS: Prelims close-option controls · Part XX · addition, variation and repeal · either House · or private member · not
        |
        v
MECHANISM / ARGUMENT: It may be introduced by a Minister or private member.
        |
        v
CONSEQUENCE / CONTRAST: State ratification applies only to the exact proviso list and uses resolutions of not less than half the States.
        |
        v
UPSC TRAP / ANSWER-USE: State ratification uses a simple majority, not Article 368 special majority.
        |
        v
ANSWER-GRABBING FORMULATION: Article 368 is in Part XX, not Part III or Part XI.
```
### 16. Answer-writing architecture

![A complete answer moves from power and procedure to doctrine, applications, evaluation and a constitutional-supremacy verdict.](assets/14_mains_answer_spine.png)
...
| Examine procedural and substantive limits | Dual majority, ratification, no joint sitting, assent -> *Kesavananda Bharati (1973)*, *Minerva*, applications | Treating basic structure as a procedural rule |
...
- **Doctrine chronology:** Shankari Prasad (1951), Sajjan Singh (1964) (decision 1964,
  reporting 1965), Golak Nath (1967), 24th Amendment (1971), Kesavananda Bharati (1973)
  (24 April 1973), Indira Nehru Gandhi (1975), Minerva Mills (1980), Waman Rao (1980)
...
- **Basic structure:** the list is illustrative and case-attributed, not a closed
  list announced wholesale in Kesavananda Bharati (1973). Limited amending power and judicial
  review prevent constitutional destruction while allowing broad amendment.
- **Ninth Schedule:** Waman Rao (1980) fixes 24 April 1973 as the cut-off; I.R. Coelho (2007)
...
B. Parliament exercises sovereign power once half the States have ratified every amendment.
C. Parliament exercises constituent power that is immune from judicial review after Presidential assent.
D. Parliament exercises ordinary legislative power and may amend only provisions outside Part III.
...
**Explanation:** Article 368(1) expressly uses constituent power and the three forms of amendment. *Kesavananda Bharati (1973)* and *Minerva Mills (1980)* deny immunity or unlimited power.
...
C. 164, because two-thirds of total membership is mandatory.
D. 91, because a majority of those present is sufficient if no member abstains.
...
A. Parliament and the State Assembly both use an ordinary majority.
B. The Governor creates or abolishes the Council after Parliament approves a resolution.
...
D. It is completed by an Article 368 amendment ratified by half the States.
...
B. Articles 54, 55 and conditions of the Governor's office
...
C. It must be referred to a joint sitting after the new Lok Sabha is constituted.
D. It is deemed passed by Rajya Sabha and may be sent directly to the President.
...
A. Amending Fundamental Rights; Directive Principles; and the Preamble
...
D. Altering Article 368; changing State representation in Parliament; amending List I
...
**Explanation:** These are separately authorised ordinary-law fields. Options D and B require the federal route; D normally requires Article 368 special majority.
...
**Explanation:** B is *Golak Nath*; C is *Kesavananda Bharati (1973)*; D is *Minerva Mills (1980)*.
...
C. Applying basic structure only to future Ninth Schedule laws
D. Suspending the judgment until a constitutional convention was held
...
Which statement best captures the *Kesavananda Bharati (1973)* settlement?
...
Why are Article 368(4) and (5), inserted by the 42nd Amendment, central to *Minerva Mills (1980)*?

A. They made the Preamble the only review standard.
B. They required ratification by three-fourths of States.
C. They transferred amendment power to a constitutional convention.
...
**Explanation:** *Minerva Mills (1980)* struck them because limited amending power and judicial review are basic features.

#### Original hard MCQ 13

The principal significance of *Waman Rao (1980)* for Ninth Schedule analysis is:

A. It fixed 24 April 1973 as the prospective cut-off for basic-structure scrutiny of later insertions.
B. It extended the *Golak Nath* rule to ordinary statutes.
C. It held every Ninth Schedule law void.
D. It abolished Article 31B prospectively.

**Answer: A. It fixed 24 April 1973 as the prospective cut-off for basic-structure scrutiny of later insertions.**

**Explanation:** The date is that of *Kesavananda Bharati (1973)*. Reviewability after the cut-off does not mean automatic invalidity.
...
A. The basic-structure doctrine no longer applies to Ninth Schedule amendments.
...
D. Every ordinary statute affecting secularism is immune from review.
...
A. It removed Parliament's power to legislate on court administration.
B. It created a rule that all judicial statutes violate basic structure.
C. It upheld the 99th Amendment because appointments are political questions.
...
A. *Indira Nehru Gandhi* - free and fair elections; *Minerva Mills (1980)* - Fundamental Rights-Directive Principles harmony
B. *Bommai* - mandatory Presidential assent; *Anjum Kadari (2024)* - unlimited constituent power
C. *Golak Nath* - judicial independence; *Waman Rao (1980)* - secularism
D. *Sajjan Singh (1964)* - Ninth Schedule impact test; *Coelho* - prospective overruling

**Answer: A. *Indira Nehru Gandhi* - free and fair elections; *Minerva Mills (1980)* - Fundamental Rights-Directive Principles harmony.**

**Explanation:** The remaining pairings transpose unrelated holdings.

#### Original hard MCQ 18

An ordinary State law is alleged to destroy federalism. After *Anjum Kadari (2024)*, the court should first ask:

A. Whether half the States ratified the ordinary law
...
C. Whether the President gave mandatory assent under Article 368
D. Whether federalism appears in any judge's basic-feature list
...
B. It became operational when the 131st Amendment Bill was introduced.
...
D. It became operational immediately on Presidential assent in 2023.
...
A. 42nd Amendment -> creation of NJAC -> NJAC judgment
B. 39th Amendment -> attempted insulation of specified election disputes -> *Indira Nehru Gandhi*
C. 24th Amendment -> Ninth Schedule cut-off -> *Waman Rao (1980)*
D. 44th Amendment -> insulation of Prime Ministerial election -> *Indira Nehru Gandhi*
...
A. Withdrawal is never valid after the first State ratifies.
B. Withdrawal is always valid until Presidential assent.
...
B. The text includes every tribunal and subordinate court.
C. The text excludes the Union Judiciary Chapter.
D. The text covers only appointment of judges, not court powers.
...
Which combination correctly states two central targets of *Minerva Mills (1980)*?

A. Article 31B and the Ninth Schedule as inserted in 1951
B. Articles 54 and 55 as amended by the 39th Amendment
...
A. the President delayed assent
B. the Bill was introduced by a Minister
C. every State ratified the amendment
...
> These target the highest-frequency errors. Rotation continues **A -> C -> A -> D**, repeated twice.
...
D. It always needs Article 368 and half-State ratification.
...
A. Refer the law for State ratification.
B. Strike it down because every basic-feature allegation is self-proving.
...
**Explanation:** *Anjum Kadari (2024)* rejects a free-standing ordinary-statute basic-structure test.
...
C. Article 31B was repealed by *I.R. Coelho (2007)*.
D. Every post-1973 Ninth Schedule law is automatically void.
...
A. a provision operationalised by the 106th Amendment
B. a proposal in the defeated 131st Amendment Bill, 2026
C. the current constitutional maximum
D. a binding precedent from the 2026 Lok Sabha division
...
A. Introduction of delimitation Bill -> automatic reservation
B. Commencement -> Presidential order selecting an election year
C. Commencement -> publication of relevant first-post-commencement census figures -> delimitation -> reservation effect
D. Assent -> immediate reservation -> later census
...
A. by State legislatures using the Article 368 dual special majority
B. by State referendums
C. by Governors acting collectively
...
Applications confirm the rule: *Indira Nehru Gandhi* protected free and fair elections and review; *I.R. Coelho (2007)* opened post-1973 Ninth Schedule insertions to impact review; the NJAC judgment protected judicial independence.
...
**Why this earns marks:** It answers the precise “expanding its own power” issue, uses the 42nd Amendment-*Minerva Mills (1980)* evidence chain, explains rather than merely lists *Kesavananda Bharati (1973)*, and ends with a direct graded verdict.

**How to improve this answer:** In the exam, compress the opening to one sentence and draw a
three-link margin chain — `Art. 368(4)-(5) -> Minerva Mills (1980) -> limited power cannot become
...
**Demand decoding:** The directive **answer** requires a direct position on ““Parliament's power to amend the Constitution is a limited power and it cannot be enlarged…”, all clauses, a sociological mechanism, historical trajectory, intersectional and regional variation, named Indian evidence, constitutional/institutional boundaries and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in ““Parliament's power to amend the Constitution is a limited power and it cannot be enlarged into absolute power.” In the light of this statement…”.

**Analytical body:**

1. **Claim and named evidence:** Applications confirm the rule: Indira Nehru Gandhi protected free and fair elections and review; I.R. Coelho (2007) opened post-1973 Ninth Schedule insertions to impact review; the NJAC judgment protected judicial independence. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** Why this earns marks: It answers the precise “expanding its own power” issue, uses the 42nd Amendment- Minerva Mills (1980) evidence chain, explains rather than merely lists Kesavananda Bharati (1973) , and ends with a direct graded verdict. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** How to improve this answer: In the exam, compress the opening to one sentence and draw a **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** three-link margin chain — Art. 368(4)-(5) -> Minerva Mills (1980) -> limited power cannot become **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
5. **Claim and named evidence:** unlimited . If space permits, add one sentence distinguishing amendment from constitutional **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in ““Parliament's power to amend the Constitution is a limited power and it cannot be enlarged into absolute power.” In the light of this statement…”.
...
*Kesavananda Bharati (1973)* permits amendment of every provision but forbids damage to the basic
structure. *Minerva Mills (1980)* protects limited amending power and judicial review; later applications
...
proviso groups plus “the remaining exact proviso subjects”, while retaining *Kesavananda Bharati (1973)*,
*Minerva Mills (1980)* and the 2026 division arithmetic.

### B. Solved Prelims PYQs

**Demand decoding:** The directive **answer** requires a direct position on “Indian Constitution has conferred the amending power on the ordinary legislative institutions…”, all clauses, a sociological mechanism, historical trajectory, intersectional and regional variation, named Indian evidence, constitutional/institutional boundaries and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Indian Constitution has conferred the amending power on the ordinary legislative institutions with a few procedural hurdles. In view of this…”.

**Analytical body:**

1. **Claim and named evidence:** The Constitution entrusts amendment to Parliament, but Article 368 limits both how constituent **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** power is exercised and what it may accomplish. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** A Bill originates only in either House, may be ministerial or private-member, and needs no prior **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** Each House must separately satisfy a majority of total membership and not less than two-thirds present and voting. There is no joint sitting. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
5. **Claim and named evidence:** The exact federal proviso subjects require ratification by not less than half the State **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Indian Constitution has conferred the amending power on the ordinary legislative institutions with a few procedural hurdles. In view of this…”.
...
**Explanation:** Parliament places a law in the Ninth Schedule through a constitutional amendment, so Statement 1 is correct. Statement 2 is absolute and false. *Waman Rao (1980)* and *I.R. Coelho (2007)* establish that post-24 April 1973 insertions are reviewable for basic-structure impact. Reviewability does not mean every inserted law is invalid.

**Demand decoding:** Treat “Prelims PYQ 1 - 2018 GS-I Q5” as a definition, category, constitutional boundary, institution, mechanism and source-date-status problem. Test each statement.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Prelims PYQ 1 - 2018 GS-I Q5”.

**Analytical body:**

1. **Claim and named evidence:** The Parliament of India can place a particular law in the Ninth Schedule of the Constitution of India. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
...
4. **Claim and named evidence:** INFERRED ANSWER - NOT OFFICIALLY VERIFIED. The official 2018 key is unavailable locally. Confidence: high. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Prelims PYQ 1 - 2018 GS-I Q5”.
...
**How to improve this answer:** For “Prelims PYQ 1 - 2018 GS-I Q5”, state why the nearest distractor fails on definition, group variation, causation, constitutional boundary, date or status.
...
**Demand decoding:** Treat “Prelims PYQ 2 - 2019 GS-I Q45” as a definition, category, constitutional boundary, institution, mechanism and source-date-status problem. Test each statement.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Prelims PYQ 2 - 2019 GS-I Q45”.

**Analytical body:**

1. **Claim and named evidence:** The 44th Amendment to the Constitution of India introduced an Article placing the election of the Prime Minister beyond judicial review. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** The Supreme Court of India struck down the 99th Amendment to the Constitution of India as being violative of the independence of judiciary. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** Which of the statements given above is/are correct? **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** INFERRED ANSWER - NOT OFFICIALLY VERIFIED. The official 2019 key is unavailable locally. Confidence: high. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Prelims PYQ 2 - 2019 GS-I Q45”.

**Executable exam-length answer / compression plan:** Fix the comparison axis; separate social category from legal status, right from institution and scheme from outcome; test the closest homogenisation, causation or stale-data distractor.

**Why this earns marks:** It prevents a familiar label or aggregate statistic from replacing the exact concept, institutional mandate, mechanism or evidence status.

**How to improve this answer:** For “Prelims PYQ 2 - 2019 GS-I Q45”, state why the nearest distractor fails on definition, group variation, causation, constitutional boundary, date or status.
...
**Demand decoding:** Treat “Prelims PYQ 3 - 2019 GS-I Q47” as a definition, category, constitutional boundary, institution, mechanism and source-date-status problem. Test each statement.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Prelims PYQ 3 - 2019 GS-I Q47”.

**Analytical body:**

1. **Claim and named evidence:** The Ninth Schedule was introduced in the Constitution of India during the prime ministership of **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** INFERRED ANSWER - NOT OFFICIALLY VERIFIED. The official 2019 key is unavailable locally. Confidence: high. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** Explanation: Article 31B and the Ninth Schedule were introduced by the First Amendment Act, 1951, during Jawaharlal Nehru's prime ministership. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Prelims PYQ 3 - 2019 GS-I Q47”.

**Executable exam-length answer / compression plan:** Fix the comparison axis; separate social category from legal status, right from institution and scheme from outcome; test the closest homogenisation, causation or stale-data distractor.

**Why this earns marks:** It prevents a familiar label or aggregate statistic from replacing the exact concept, institutional mandate, mechanism or evidence status.

**How to improve this answer:** For “Prelims PYQ 3 - 2019 GS-I Q47”, state why the nearest distractor fails on definition, group variation, causation, constitutional boundary, date or status.
...
**Demand decoding:** Treat “Prelims PYQ 4 - 2020 GS-I Q13” as a definition, category, constitutional boundary, institution, mechanism and source-date-status problem. Test each statement.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Prelims PYQ 4 - 2020 GS-I Q13”.

**Analytical body:**

1. **Claim and named evidence:** The Constitution of India defines its “basic structure” in terms of federalism, secularism, Fundamental Rights and democracy. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** The Constitution of India provides for judicial review to safeguard the citizens' liberties and to preserve the ideals on which the Constitution is based. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** Which of the statements given above is/are correct? **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** INFERRED ANSWER - NOT OFFICIALLY VERIFIED. The official 2020 key is unavailable locally. Confidence: high. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Prelims PYQ 4 - 2020 GS-I Q13”.

**Executable exam-length answer / compression plan:** Fix the comparison axis; separate social category from legal status, right from institution and scheme from outcome; test the closest homogenisation, causation or stale-data distractor.

**Why this earns marks:** It prevents a familiar label or aggregate statistic from replacing the exact concept, institutional mandate, mechanism or evidence status.

**How to improve this answer:** For “Prelims PYQ 4 - 2020 GS-I Q13”, state why the nearest distractor fails on definition, group variation, causation, constitutional boundary, date or status.
...
**Demand decoding:** Treat “Prelims PYQ 5 - 2022 GS-I Q13” as a definition, category, constitutional boundary, institution, mechanism and source-date-status problem. Test each statement.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Prelims PYQ 5 - 2022 GS-I Q13”.

**Analytical body:**

1. **Claim and named evidence:** A bill amending the Constitution requires a prior recommendation of the President of India. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** When a Constitution Amendment Bill is presented to the President of India, it is obligatory for the President of India to give his/her assent. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** A Constitution Amendment Bill must be passed by both the Lok Sabha and the Rajya Sabha by a special majority and there is no provision for joint sitting. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
...
5. **Claim and named evidence:** INFERRED ANSWER - NOT OFFICIALLY VERIFIED. The official 2022 key is unavailable locally. Confidence: high. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Prelims PYQ 5 - 2022 GS-I Q13”.

**Executable exam-length answer / compression plan:** Fix the comparison axis; separate social category from legal status, right from institution and scheme from outcome; test the closest homogenisation, causation or stale-data distractor.

**Why this earns marks:** It prevents a familiar label or aggregate statistic from replacing the exact concept, institutional mandate, mechanism or evidence status.

**How to improve this answer:** For “Prelims PYQ 5 - 2022 GS-I Q13”, state why the nearest distractor fails on definition, group variation, causation, constitutional boundary, date or status.
...
**Demand decoding:** Treat “Prelims PYQ 6 - 2023 GS-I Q34” as a definition, category, constitutional boundary, institution, mechanism and source-date-status problem. Test each statement.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Prelims PYQ 6 - 2023 GS-I Q34”.

**Analytical body:**

1. **Claim and named evidence:** In India, which one of the following Constitutional Amendments was widely believed to be enacted to overcome the judicial interpretations of the Fundamental Rights? **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** INFERRED ANSWER - NOT OFFICIALLY VERIFIED. The official 2023 key is unavailable locally. Confidence: high. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Prelims PYQ 6 - 2023 GS-I Q34”.

**Executable exam-length answer / compression plan:** Fix the comparison axis; separate social category from legal status, right from institution and scheme from outcome; test the closest homogenisation, causation or stale-data distractor.

**Why this earns marks:** It prevents a familiar label or aggregate statistic from replacing the exact concept, institutional mandate, mechanism or evidence status.

**How to improve this answer:** For “Prelims PYQ 6 - 2023 GS-I Q34”, state why the nearest distractor fails on definition, group variation, causation, constitutional boundary, date or status.
...
**Demand decoding:** Treat “Prelims PYQ 7 - 2024 GS-I Q66” as a definition, category, constitutional boundary, institution, mechanism and source-date-status problem. Test each statement.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Prelims PYQ 7 - 2024 GS-I Q66”.

**Analytical body:**

1. **Claim and named evidence:** As per Article 368 of the Constitution of India, the Parliament may amend any provision of the Constitution by way of **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
...
3. **Claim and named evidence:** OFFICIAL LOCAL KEY VERIFIED. The official 2024 Set-A key directly records Q66 as D . **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** Explanation: Article 368(1) expressly uses all three forms: addition, variation or repeal. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Prelims PYQ 7 - 2024 GS-I Q66”.

**Executable exam-length answer / compression plan:** Fix the comparison axis; separate social category from legal status, right from institution and scheme from outcome; test the closest homogenisation, causation or stale-data distractor.

**Why this earns marks:** It prevents a familiar label or aggregate statistic from replacing the exact concept, institutional mandate, mechanism or evidence status.

**How to improve this answer:** For “Prelims PYQ 7 - 2024 GS-I Q66”, state why the nearest distractor fails on definition, group variation, causation, constitutional boundary, date or status.
...
**Demand decoding:** Treat “Prelims PYQ 8 - 2025 GS-I Q58” as a definition, category, constitutional boundary, institution, mechanism and source-date-status problem. Test each statement.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Prelims PYQ 8 - 2025 GS-I Q58”.

**Analytical body:**

1. **Claim and named evidence:** Consider the following subjects under the Constitution of India **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** I. List I - Union List, in the Seventh Schedule **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** For a constitutional amendment with respect to which of the above is ratification by the Legislatures of not less than one-half of the States required before presenting the Bill to the President of India for assent? **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** OFFICIAL LOCAL KEY VERIFIED. The official 2025 Set-A key directly records Q58 as A . **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
5. **Claim and named evidence:** Explanation: Any Seventh Schedule List and Article 162, concerning the extent of State executive power, are in the Article 368 proviso. Conditions of the Governor's office are not. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Prelims PYQ 8 - 2025 GS-I Q58”.

**Executable exam-length answer / compression plan:** Fix the comparison axis; separate social category from legal status, right from institution and scheme from outcome; test the closest homogenisation, causation or stale-data distractor.

**Why this earns marks:** It prevents a familiar label or aggregate statistic from replacing the exact concept, institutional mandate, mechanism or evidence status.

**How to improve this answer:** For “Prelims PYQ 8 - 2025 GS-I Q58”, state why the nearest distractor fails on definition, group variation, causation, constitutional boundary, date or status.
...
constitutional text and federally rigid for the Union-State compact. *Kesavananda Bharati (1973)* adds a
...
route. Keep *Kesavananda Bharati (1973)* as the final substantive-rigidity sentence rather than opening a case
chronology.

**Demand decoding:** The directive **explain** requires a direct position on “Explain how India's constitutional amendment design synthesises flexibility and rigidity. (10…”, all clauses, a sociological mechanism, historical trajectory, intersectional and regional variation, named Indian evidence, constitutional/institutional boundaries and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Explain how India's constitutional amendment design synthesises flexibility and rigidity. (10 marks, 150 words)”.

**Analytical body:**

1. **Claim and named evidence:** India uses graded entrenchment rather than one amendment threshold. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** First, constitutionally authorised ordinary laws operate outside Article 368—for example, State **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** reorganisation under Articles 2-4 and citizenship law under Article 11. Second, most entrenched **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** provisions require in each House a majority of total membership plus two-thirds present and voting **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
5. **Claim and named evidence:** no joint sitting cures failure. Third, alteration of the exact federal proviso subjects additionally **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Explain how India's constitutional amendment design synthesises flexibility and rigidity. (10 marks, 150 words)”.
...
**Demand decoding:** The directive **discuss** requires a direct position on “The role of States in constitutional amendment is significant but narrowly confined. Discuss.…”, all clauses, a sociological mechanism, historical trajectory, intersectional and regional variation, named Indian evidence, constitutional/institutional boundaries and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “The role of States in constitutional amendment is significant but narrowly confined. Discuss. (10 marks, 150 words)”.

**Analytical body:**

1. **Claim and named evidence:** States cannot introduce an Article 368 Bill and do not ratify most amendments. Their voice becomes **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** decisive only for the exact proviso subjects: named executive-power Articles; Article 241 and **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** Article 279A; specified Judiciary and legislative-relations Chapters; Seventh Schedule Lists **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** After both Houses pass the dual special majority, resolutions of not less than half the State **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
5. **Claim and named evidence:** legislatures are required before Presidential assent. Ratification uses an ordinary/simple **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “The role of States in constitutional amendment is significant but narrowly confined. Discuss. (10 marks, 150 words)”.
...
**Why the criticism has force.** *Kesavananda Bharati (1973)* was a 7:6 decision without one exhaustive feature list. Later cases added free and fair elections (*Indira Nehru Gandhi*), limited amending power and rights-DPSP harmony (*Minerva Mills (1980)*), federalism and secularism (*S.R. Bommai*), and judicial independence (NJAC). An open list gives unelected judges the final word over amendments passed by parliamentary and, sometimes, State super-majorities. An impressionistic test could convert disagreement with institutional design into invalidity.

**Why review remains defensible.** Indian Parliament is not legally sovereign; Article 368 is a Constitution-created power. *Minerva Mills (1980)* exposed the contradiction in permitting that limited power to make itself unlimited through Article 368(4) and (5). Democracy also includes fair future elections, opposition rights, federal voice, liberty and independent courts, not only a present electoral mandate. *I.R. Coelho (2007)* shows disciplined impact review rather than automatic invalidity.

**Necessary restraint.** Courts should identify the feature's textual and precedential basis, demand actual damage rather than policy inconvenience, and tailor remedies narrowly. *Anjum Kadari (2024)* reinforces discipline by refusing a free-standing basic-structure attack on ordinary statutes.
...
**Demand decoding:** The directive **critically examine** requires a direct position on “Critically examine the claim that the basic-structure doctrine converts judicial review into…”, all clauses, a sociological mechanism, historical trajectory, intersectional and regional variation, named Indian evidence, constitutional/institutional boundaries and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Critically examine the claim that the basic-structure doctrine converts judicial review into judicial supremacy. (15 marks, 250 words)”.

**Analytical body:**

1. **Claim and named evidence:** Why this earns marks: It accepts the counter-majoritarian objection, answers it with named cases and constitutional theory, and gives judicially administrable safeguards rather than a one-sided defence. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** How to improve this answer: Use a two-column criticism/defence mini-table if handwriting **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** allows, then make the restraint test executable: textual basis, settled precedent, actual damage **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** and narrow remedy. Avoid presenting S.R. Bommai as a direct amendment-invalidating case. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Critically examine the claim that the basic-structure doctrine converts judicial review into judicial supremacy. (15 marks, 250 words)”.

**Executable exam-length answer / compression plan:** For a 15-mark answer, spend about one-sixth of the time decoding the directive and drawing the mechanism; define and state a thesis; organise five points as claim → named evidence → analysis → qualification; compress examples before mechanisms and reserve the final minute for causation, group variation and legal-outcome limits.

#### Original Mains 4 - 15 marks, 250 words

**Question:** Explain the significance of *Anjum Kadari (2024) v. Union of India* (2024) for the scope of the basic-structure doctrine. **(15 marks, 250 words)**
...
**Doctrinal basis.** Article 368 constituent power alters the constitutional framework; *Kesavananda Bharati (1973)* therefore subjects it to an identity-preserving basic-structure ceiling. Ordinary legislation operates within that framework. Its validity is tested through legislative entries, Article 13 and other express constitutional limits. The Court drew on the majority reasoning in *Indira Nehru Gandhi*, *State of Karnataka* and *Kuldip Nayar*, while addressing contrary or broader observations in tribunal and NJAC cases.
...
**Ninth Schedule qualification.** Post-1973 placement is accomplished through a constitutional amendment, so *Waman Rao (1980)* and *I.R. Coelho (2007)* basic-structure scrutiny remains available.

**Conclusion:** *Anjum Kadari (2024)* narrows rhetoric, not constitutional control. It preserves amendment review while making ordinary-law adjudication text-linked, predictable and consistent with separation of powers.
...
qualification to two sentences so the answer remains focused on *Anjum Kadari (2024)* rather than
becoming a general basic-structure essay.

**Demand decoding:** The directive **explain** requires a direct position on “Explain the significance of Anjum Kadari (2024) v. Union of India (2024) for the scope of the basic-…”, all clauses, a sociological mechanism, historical trajectory, intersectional and regional variation, named Indian evidence, constitutional/institutional boundaries and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Explain the significance of Anjum Kadari (2024) v. Union of India (2024) for the scope of the basic-structure doctrine. (15 marks, 250 words)”.

**Analytical body:**

1. **Claim and named evidence:** Anjum Kadari (2024) INSC 831, supplies an important technical boundary between review of constitutional amendments and review of ordinary legislation. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** Ninth Schedule qualification. Post-1973 placement is accomplished through a constitutional amendment, so Waman Rao (1980) and I.R. Coelho (2007) basic-structure scrutiny remains available. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** Conclusion: Anjum Kadari (2024) narrows rhetoric, not constitutional control. It preserves amendment review while making ordinary-law adjudication text-linked, predictable and consistent with separation of powers. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** Why this earns marks: It states the holding, explains the amendment-statute distinction, handles apparent case tension, preserves express-provision review and identifies the Ninth Schedule exception. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
5. **Claim and named evidence:** How to improve this answer: Lead with the one-line holding and then apply it to one concrete **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Explain the significance of Anjum Kadari (2024) v. Union of India (2024) for the scope of the basic-structure doctrine. (15 marks, 250 words)”.

**Executable exam-length answer / compression plan:** For a 15-mark answer, spend about one-sixth of the time decoding the directive and drawing the mechanism; define and state a thesis; organise five points as claim → named evidence → analysis → qualification; compress examples before mechanisms and reserve the final minute for causation, group variation and legal-outcome limits.

#### Original Mains 5 - 15 marks, 250 words

**Question:** Ninth Schedule protection is neither fictitious nor absolute. Analyse with reference to *Waman Rao (1980)* and *I.R. Coelho (2007)*. **(15 marks, 250 words)**
...
**Temporal control.** *Waman Rao (1980)* (1981) applied the basic-structure doctrine prospectively to constitutional amendments made after **24 April 1973**, the date of *Kesavananda Bharati (1973)*. The cut-off protected constitutional finality for earlier insertions while warning Parliament that future immunising amendments were reviewable.
...
**Conclusion:** The Ninth Schedule remains a real protective mechanism, but after *Waman Rao (1980)* and *Coelho* it operates under constitutional supremacy, not as an exclusion zone from the basic structure.
...
**Demand decoding:** The directive **analyse** requires a direct position on “Ninth Schedule protection is neither fictitious nor absolute. Analyse with reference to Waman…”, all clauses, a sociological mechanism, historical trajectory, intersectional and regional variation, named Indian evidence, constitutional/institutional boundaries and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Ninth Schedule protection is neither fictitious nor absolute. Analyse with reference to Waman Rao (1980) and I.R. Coelho (2007). (15 marks, 250 words)”.

**Analytical body:**

1. **Claim and named evidence:** Conclusion: The Ninth Schedule remains a real protective mechanism, but after Waman Rao (1980) and Coelho it operates under constitutional supremacy, not as an exclusion zone from the basic structure. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** Why this earns marks: It distinguishes Articles 31A/31B, explains both temporal and impact tests, rejects both immunity and automatic-invalidity extremes, and follows a clear analytical sequence. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** How to improve this answer: Draw the review sequence as insertion date -> affected Part III **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** right -> underlying basic feature -> degree of damage . State expressly that the constitutional **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
5. **Claim and named evidence:** amendment inserting the law, not merely the listed statute in isolation, attracts the **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Ninth Schedule protection is neither fictitious nor absolute. Analyse with reference to Waman Rao (1980) and I.R. Coelho (2007). (15 marks, 250 words)”.
...
**Initial breadth.** *Shankari Prasad (1951)* held that a constitutional amendment was not “law” under Article 13(2), permitting amendment of Fundamental Rights. *Sajjan Singh (1964)* (1965) reaffirmed this, though separate opinions foreshadowed concern about basic features.
...
**Enforcement and refinement.** *Indira Nehru Gandhi* invalidated election-dispute insulation; the 42nd Amendment's attempt to declare unlimited power was struck in *Minerva Mills (1980)*, which protected limited power, judicial review and rights-DPSP harmony. *Waman Rao (1980)* and *I.R. Coelho (2007)* applied the ceiling to post-1973 Ninth Schedule protection. The NJAC judgment protected judicial independence.

**Evaluation.** The doctrine is unwritten and counter-majoritarian, yet it prevents a temporary super-majority from abolishing the conditions of future democracy. *Anjum Kadari (2024)* adds restraint by confining the free-standing doctrine to amendments.
...
*Shankari/Sajjan -> Golak Nath -> 24th Amendment -> Kesavananda Bharati (1973) -> Minerva Mills (1980)*, then use
*Coelho* or NJAC as one application. A short timeline saves words for the evaluation demanded by
the question.

**Demand decoding:** The directive **trace** requires a direct position on “Trace the evolution of Parliament's power to amend Fundamental Rights and evaluate how the…”, all clauses, a sociological mechanism, historical trajectory, intersectional and regional variation, named Indian evidence, constitutional/institutional boundaries and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in “Trace the evolution of Parliament's power to amend Fundamental Rights and evaluate how the Supreme Court constructed a limited constituent power. (20…”.

**Analytical body:**

1. **Claim and named evidence:** The amendment controversy evolved from a binary question - whether Fundamental Rights were amendable - into an identity question - how far any constitutional provision may be changed. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** Constitutional response. The 24th Amendment (1971) expressly affirmed Parliament's constituent power, excluded Article 368 amendments from Article 13 and required Presidential assent. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** Conclusion: The Court did not make Fundamental Rights textually immutable; it made Parliament's constituent power broad, reviewable and incapable of constitutional self-destruction. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** Why this earns marks: It traces every doctrinal turn, links amendments to cases, explains why the final doctrine differs from Golak Nath , and ends with a balanced institutional assessment. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
5. **Claim and named evidence:** How to improve this answer: In a 250-word response, retain only the turning points **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in “Trace the evolution of Parliament's power to amend Fundamental Rights and evaluate how the Supreme Court constructed a limited constituent power. (20…”.
...
**Substantive identity safeguard.** *Kesavananda Bharati (1973)* upheld power over every provision but prohibited damage to the basic structure. Justice Khanna's continuity reasoning distinguishes alteration from destruction. *Minerva Mills (1980)* then invalidated the 42nd Amendment's attempt to convert a limited power into an unlimited one. Applications protected free and fair elections (*Indira Nehru Gandhi*), judicial review and rights-DPSP harmony (*Minerva Mills (1980)*), the post-1973 rights core against Ninth Schedule insulation (*I.R. Coelho (2007)*) and judicial independence (NJAC).
...
**Demand decoding:** The directive **discuss** requires a direct position on ““A constitutional amendment may change the Constitution, but it cannot replace its identity.”…”, all clauses, a sociological mechanism, historical trajectory, intersectional and regional variation, named Indian evidence, constitutional/institutional boundaries and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** The answer must resolve the sociological demand in ““A constitutional amendment may change the Constitution, but it cannot replace its identity.” Discuss the proposition using the amendment procedure,…”.

**Analytical body:**

1. **Claim and named evidence:** Article 368 authorises amendment by addition, variation or repeal. The breadth of those verbs permits major institutional change, but the word “amendment” presupposes continuity of the constitutional order. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
2. **Claim and named evidence:** Conclusion: India's Constitution is transformable but not self-cancelling. Procedure protects deliberation and federal consent; basic structure protects continuity of constitutional identity. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
3. **Claim and named evidence:** Why this earns marks: It integrates procedure, doctrine, current verified examples and critique; each example proves a distinct part of the argument and the conclusion directly resolves amendment versus replacement. **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
4. **Claim and named evidence:** How to improve this answer: Allocate roughly 70 words to procedure, 120 to doctrine and **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.
5. **Claim and named evidence:** applications, 60 to current controls/critique, and 30 to the verdict. Label the 131st Bill **Analysis:** Connect structure or institution → norm/incentive/power/agency mechanism → differentiated social outcome → feedback or policy implication. **Qualification:** State internal group variation, regional/historical scope, correlation-versus-causation or legal-norm-versus-lived-outcome boundary.

**Counter-position / limit:** Neither a constitutional provision, one scheme, aggregate correlation nor a single community example establishes uniform implementation, causation or national experience; test institutions, power, agency, intersectionality, region, period and evidence status.

**Qualified conclusion:** The answer must resolve the sociological demand in ““A constitutional amendment may change the Constitution, but it cannot replace its identity.” Discuss the proposition using the amendment procedure,…”.
...
- [FACT] Justice H.R. Khanna's *Kesavananda Bharati (1973)* reasoning emphasised survival of the old Constitution without loss of identity.
...
### 20. Institutional restraint after Anjum Kadari (2024)

- [ANALYSIS] *Anjum Kadari (2024)* narrows doctrinal rhetoric without weakening ordinary constitutional review.
...
|---:|---|---|
| 1951 | *Shankari Prasad (1951)* | Amendment not Article 13 law; FR amendable |
| 1965 | *Sajjan Singh (1964)* | Reaffirmed; early basic-feature doubts in separate opinions |
...
| 1973 | *Kesavananda Bharati (1973)* | 13 judges, 7:6; every part amendable, basic structure indestructible |
...
| 1980 | *Minerva Mills (1980)* | Limited power, judicial review and FR-DPSP harmony protected |
| 1981 | *Waman Rao (1980)* | 24 April 1973 Ninth Schedule cut-off |
| 1994 | *S.R. Bommai* | Secularism and federalism |
| 1997 | *L. Chandra Kumar* | Articles 32 and 226/227 review powers basic |
| 2007 | *I.R. Coelho (2007)* | Post-cut-off Ninth Schedule rights/basic-structure impact test |
| 2015 | NJAC | 99th Amendment invalid; judicial independence basic |
| 2024 | *Anjum Kadari (2024)* | Ordinary statutes need competence/express-provision challenge |

#### Kesavananda Bharati (1973) architecture
...
- *Kesavananda Bharati (1973)* opinions: constitutional supremacy; republican-democratic form; secularism; separation of powers; federalism; unity/integrity; dignity/liberty.
- *Indira Nehru Gandhi*: free and fair elections; rule of law; judicial review.
- *Minerva Mills (1980)*: limited amending power; judicial review; FR-DPSP harmony.
- *S.R. Bommai*: federalism and secularism.
- *L. Chandra Kumar*: Articles 32 and 226/227 judicial review powers.
- *I.R. Coelho (2007)*: rights/basic-structure impact in post-1973 Ninth Schedule review.
...
- **Never write:** one exhaustive list unanimously delivered in *Kesavananda Bharati (1973)*.
...
- *Waman Rao (1980)* -> 24 April 1973 prospective cut-off.
- *I.R. Coelho (2007)* -> post-cut-off insertions reviewable.
- Test:
...
#### Anjum Kadari (2024) technical boundary
...
- **2019 GS-II:** limited power cannot enlarge itself -> *Kesavananda Bharati (1973)* + 42nd Amendment + *Minerva Mills (1980)*.
...
- 39th Amendment, not 44th, in *Indira Nehru Gandhi v. Raj Narain (1975)* election dispute.
- Post-1973 Ninth Schedule: reviewable, not automatically invalid.
- Ordinary law: express constitutional hook after *Anjum Kadari (2024)*.
...
#### ASCII MASTER FLOW — PANEL 1/11: Constitutional change: flexible routes, entrenched identity
...
#### ASCII MASTER FLOW — PANEL 2/11: Article 368 procedure: separate Houses, no shortcuts
...
#### ASCII MASTER FLOW — PANEL 4/11: From Shankari Prasad (1951) to Minerva Mills (1980): the core doctrine chain
...
INDIRA NEHRU GANDHI V. RAJ NARAIN (1975)   -> free and fair elections / judicial review protect
  democracy
...
#### ASCII MASTER FLOW — PANEL 5/11: Basic-structure elements: non-exhaustive and case-attributed
...
#### ASCII MASTER FLOW — PANEL 6/11: Ninth Schedule: insertion is not immunity after the 1973 cut-off
...
#### ASCII MASTER FLOW — PANEL 7/11: The Anjum Kadari (2024) boundary: amendments versus ordinary statutes
...
#### ASCII MASTER FLOW — PANEL 8/11: Current evidence: defeated proposal versus commenced framework
...
#### ASCII MASTER FLOW — PANEL 9/11: Doctrine evaluation: guardian of identity or judicial supremacy?
...
#### ASCII MASTER FLOW — PANEL 10/11: Prelims traps and verified PYQ control
...
ratification -> exact proviso + at least half      Article 241 and 279A are separately named
basic structure -> non-exhaustive                  ordinary-statute boundary applies
Ninth Schedule -> reviewable after cut-off         not automatically invalid
...
#### ASCII MASTER FLOW — PANEL 11/11: Marks-scaled Mains execution: 10, 15 and 20 marks
