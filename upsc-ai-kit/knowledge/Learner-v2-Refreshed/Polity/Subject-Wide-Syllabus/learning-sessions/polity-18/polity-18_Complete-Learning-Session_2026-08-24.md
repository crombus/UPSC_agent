---
title: "Supreme Court — Learner-v2 Refreshed"
topic_key: polity-18
cover_image: assets/polity-18_Teaching-Navigation_2026-08-24.png
...
---
# Supreme Court — Complete Uncompressed Learning Session

> **Subject:** Indian Polity | **Topic:** 18 | **GS-II + Prelims** | **Export date:** 2026-08-24
>
> **Approval:** false - awaiting explicit user approval.
>
> **Evidence key:** [FACT] verified constitutional, judicial or official proposition; [ANALYSIS] reasoned exam synthesis; [CURRENT] dated live control; [LIMIT] qualification preventing overstatement.
...
- [CURRENT] **Live official refresh, 24 August 2026:** Official Supreme Court pages rechecked on 24 August 2026 continue to publish the current judges, Collegium Resolutions and annual-report portals; no undated pendency or vacancy total is frozen.
...
![Refreshed teaching navigation](assets/polity-18_Teaching-Navigation_2026-08-24.png)

*Distinct embedded teaching-navigation image. The separate continuous Cārvāka-style flowchart package remains an independent at-a-glance artifact.*

### SESSION 1 — HISTORICAL TRANSITION AND THE INTEGRATED JUDICIARY
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Historical transition and the integrated judiciary denotes the constitutional rules and institutional links organised around Privy Council in London.

**Technical definition:** The transition marks constitutional self-government: final legal authority moved from an imperial appellate body to a court created and limited by the Constitution of India.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India replaced Privy Council appeals with a constitutionally integrated judiciary, making the Supreme Court the final national court without displacing High Court control below.

#### MUST-WRITE KEYWORDS

- **Historical transition**
- **the integrated judiciary**
- **integrated or single judiciary**
- **Core thesis**
- **28 January 1950**
- **124-147 in Part V**

**How to use them:** Frame the answer through Historical transition; define the integrated judiciary, connect integrated or single judiciary with Core thesis to explain the mechanism, and use 28 January 1950 for the decisive comparison or qualification.

Historical transition and the integrated judiciary denotes the constitutional rules and institutional links organised around Privy Council in London.
Historical transition and the integrated judiciary operates through Federal Court of India, 1937, connected with Constitution commences, 26 January 1950.
The operative mechanism matters because supreme Court inaugurated, 28 January 1950.
Its principal consequence is that final constitutional + civil + criminal appellate court.
The decisive contrast is between [FACT] It was inaugurated on 28 January 1950 and [FACT] Articles 124-147 in Part V establish the Union Judiciary.
The exam-safe limitation is that constitutional and final apex.
![Topic-specific visual map: Historical transition and the integrated judiciary.](assets/01_historical_transition_and_the_integrated_judiciary.png)
...
Federal Court of India, 1937
        |
        v
Constitution commences, 26 January 1950
        |
        v
...
```text
                         SUPREME COURT
                  constitutional and final apex
                              |
                    HIGH COURTS OF STATES
              writ + appellate + supervisory courts
                              |
                 DISTRICT / SUBORDINATE COURTS
                     ordinary trial hierarchy
                              |
          Both Union law and State law enforced in one system
```
...
#### CLOSING RECALL FLOW — HISTORICAL TRANSITION AND THE INTEGRATED JUDICIARY

```closure-flow
SUBTOPIC: Historical transition and the integrated judiciary
KEY TERMS / DEFINITIONS: Historical transition · the integrated judiciary · integrated or single judiciary · Core thesis · 28 January 1950 · 124-147 in Part V
MECHANISM / ARGUMENT: The transition marks constitutional self-government: final legal authority moved from an imperial appellate body to a court created and limited by the Constitution of India.
CONSEQUENCE / CONTRAST: The decisive contrast is between It was inaugurated on 28 January 1950 and Articles 124-147 in Part V establish the Union Judiciary.
UPSC TRAP / ANSWER-USE: Core thesis: The Supreme Court is the apex of one judicial system, but constitutional justice is delivered through a distributed network of High Courts and subordinate courts.
ANSWER-GRABBING FORMULATION: India replaced Privy Council appeals with a constitutionally integrated judiciary, making the Supreme Court the final national court without displacing High Court control below.
```
### SESSION 2 — CONSTITUTIONAL LOCATION, COMPOSITION, SEAT AND BENCHES
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Constitutional location, composition, seat and benches denotes the constitutional rules and institutional links organised around Feature Stable constitutional or statutory control.

**Technical definition:** The decisive contrast is between Principal seat Delhi under Article 130 and Other place of sitting CJI may appoint with the President's approval.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 130 places the Court in Delhi but permits another place or places when the CJI, with presidential approval, so appoints.
...
**How to use them:** Frame the answer through Constitutional location; define composition, connect seat with benches to explain the mechanism, and use Supreme Court (Number of Judges) Amendment Act, 2019 for the decisive comparison or qualification.
...
The exam-safe limitation is that constitution Bench [FACT] Minimum five judges under Article 145(3).
![Topic-specific visual map: Constitutional location, composition, seat and benches.](assets/02_constitutional_location_composition_seat_and_benches.png)
...
#### CLOSING RECALL FLOW — CONSTITUTIONAL LOCATION, COMPOSITION, SEAT AND BENCHES

```closure-flow
SUBTOPIC: Constitutional location, composition, seat and benches
KEY TERMS / DEFINITIONS: Constitutional location · composition · seat · benches · Supreme Court (Number of Judges) Amendment Act, 2019 · five judges
MECHANISM / ARGUMENT: The decisive contrast is between Principal seat Delhi under Article 130 and Other place of sitting CJI may appoint with the President's approval.
CONSEQUENCE / CONTRAST: Every constitutional argument does not automatically require a Constitution Bench.
UPSC TRAP / ANSWER-USE: Bench strength is an authority rule: a larger bench does not merely have more judges; it has greater precedential weight.
ANSWER-GRABBING FORMULATION: Article 130 places the Court in Delhi but permits another place or places when the CJI, with presidential approval, so appoints.
```
### SESSION 3 — APPOINTMENT ARCHITECTURE AND THE CJI CONVENTION
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Appointment architecture and the CJI convention denotes the constitutional rules and institutional links organised around Constitutional text: President appoints under Article 124.

**Technical definition:** The Constitution uses consultation language; the controlling appointment mechanism is the judicially created collegium.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Formal appointment remains executive, but decisive selection is judicial in order to insulate adjudication from executive dominance.
...
- **Article 124**
- **Appointment architecture and the CJI convention**
- **Appointment**

**How to use them:** Frame the answer through Appointment architecture; define the CJI convention, connect President under Article 124 with Article 124 to explain the mechanism, and use Appointment architecture and the CJI convention for the decisive comparison or qualification.

Appointment architecture and the CJI convention denotes the constitutional rules and institutional links organised around Constitutional text: President appoints under Article 124.
Appointment architecture and the CJI convention operates through judicially developed collegium, connected with recommendation - Union processing - President appoints.
The operative mechanism matters because executive may return a name once for reconsideration.
Its principal consequence is that reiterated recommendation carries binding judicial weight.
The decisive contrast is between [FACT] Supreme Court judges are appointed by the President under Article 124 and [FACT] The Constitution uses consultation language; the controlling appointment mechanism is the judicially created collegium.
The exam-safe limitation is that [LIMIT] The collegium is not written into the Constitution and should never be described as a constitutional body.
...
#### CLOSING RECALL FLOW — APPOINTMENT ARCHITECTURE AND THE CJI CONVENTION

```closure-flow
SUBTOPIC: Appointment architecture and the CJI convention
KEY TERMS / DEFINITIONS: Appointment architecture · the CJI convention · President under Article 124 · Article 124 · Appointment architecture and the CJI convention · Appointment
MECHANISM / ARGUMENT: Appointment architecture and the CJI convention operates through judicially developed collegium, connected with recommendation - Union processing - President appoints.
CONSEQUENCE / CONTRAST: The decisive contrast is between Supreme Court judges are appointed by the President under Article 124 and The Constitution uses consultation language; the controlling appointment mechanism is the judicially created collegium.
UPSC TRAP / ANSWER-USE: Formal appointment remains executive, but decisive selection is judicial in order to insulate adjudication from executive dominance.
ANSWER-GRABBING FORMULATION: Formal appointment remains executive, but decisive selection is judicial in order to insulate adjudication from executive dominance.
```
### SESSION 4 — THE JUDGES CASES, COLLEGIUM EVOLUTION AND NJAC
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The Judges Cases, collegium evolution and NJAC denotes the constitutional rules and institutional links organised around 1981: First Judges Case.

**Technical definition:** The decisive contrast is between plural consultation; SC collegium = CJI + 4 senior-most judges and 2014: 99th Amendment + NJAC Act.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The Judges Cases shifted appointment primacy toward the collegium, while the NJAC judgment protected judicial independence without declaring every alternative appointments model unconstitutional.
...
**How to use them:** Frame the answer through The Judges Cases; define collegium evolution, connect NJAC with accountable independence to explain the mechanism, and use First Judges Case for the decisive comparison or qualification.

The Judges Cases, collegium evolution and NJAC denotes the constitutional rules and institutional links organised around 1981: First Judges Case.
The Judges Cases, collegium evolution and NJAC operates through "consultation" - executive primacy, connected with 1993: Second Judges Case.
The operative mechanism matters because "consultation" - concurrence; collegium born.
Its principal consequence is that 1998: Third Judges Case.
The decisive contrast is between plural consultation; SC collegium = CJI + 4 senior-most judges and 2014: 99th Amendment + NJAC Act.
The exam-safe limitation is that commission model enacted.
![Topic-specific visual map: The Judges Cases, collegium evolution and NJAC.](assets/03_the_judges_cases_collegium_evolution_and_njac.png)
...
|---|---|---|
| First Judges Case | *S.P. Gupta v. Union of India* (1981) | [FACT] Consultation did not mean concurrence; executive primacy |
| Second Judges Case | *Supreme Court Advocates-on-Record Association* (1993) | [FACT] Judicial primacy; collegium created |
...
| Fourth Judges Case | *SCAORA v. Union of India* (2015) | [FACT] Amendment and Act struck down; judicial independence/basic structure |
...
#### CLOSING RECALL FLOW — THE JUDGES CASES, COLLEGIUM EVOLUTION AND NJAC

```closure-flow
SUBTOPIC: The Judges Cases, collegium evolution and NJAC
KEY TERMS / DEFINITIONS: The Judges Cases · collegium evolution · NJAC · accountable independence · First Judges Case · S.P. Gupta v. Union of India (1981)
MECHANISM / ARGUMENT: The decisive contrast is between plural consultation; SC collegium = CJI + 4 senior-most judges and 2014: 99th Amendment + NJAC Act.
CONSEQUENCE / CONTRAST: Its principal consequence is that 1998: Third Judges Case.
UPSC TRAP / ANSWER-USE: The central debate is not independence versus accountability as mutually exclusive values.
ANSWER-GRABBING FORMULATION: The Judges Cases shifted appointment primacy toward the collegium, while the NJAC judgment protected judicial independence without declaring every alternative appointments model unconstitutional.
```
### SESSION 5 — QUALIFICATIONS, OATH, TENURE, SALARY AND EXIT
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Qualifications, oath, tenure, salary and exit denotes the constitutional rules and institutional links organised around 5 years as HC judge.

**Technical definition:** The decisive contrast is between security of tenure + protected conditions and retirement at 65 / resignation to President / removal under Article 124(4).

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 124(6) requires an oath or affirmation to bear true faith and allegiance to the Constitution, uphold sovereignty and integrity, and perform duties without fear or favour, affection or ill-will.
...
**How to use them:** Frame the answer through Qualifications; define oath, connect tenure with salary to explain the mechanism, and use exit for the decisive comparison or qualification.

Qualifications, oath, tenure, salary and exit denotes the constitutional rules and institutional links organised around 5 years as HC judge.
Qualifications, oath, tenure, salary and exit operates through OR 10 years as HC advocate, connected with OR distinguished jurist in President's opinion.
The operative mechanism matters because president under Article 124.
Its principal consequence is that president or person appointed by President.
The decisive contrast is between security of tenure + protected conditions and retirement at 65 / resignation to President / removal under Article 124(4).
The exam-safe limitation is that [FACT] There is no minimum age for appointment.
![Topic-specific visual map: Qualifications, oath, tenure, salary and exit.](assets/04_qualifications_oath_tenure_salary_and_exit.png)
...
100 Lok Sabha members OR 50 Rajya Sabha members
        |
Speaker / Chairman may admit or refuse
        |
Three-member inquiry committee
SC judge + HC Chief Justice + distinguished jurist
        |
Charge of proved misbehaviour or incapacity established
        |
Each House passes address by special majority
...
#### CLOSING RECALL FLOW — QUALIFICATIONS, OATH, TENURE, SALARY AND EXIT

```closure-flow
SUBTOPIC: Qualifications, oath, tenure, salary and exit
KEY TERMS / DEFINITIONS: Qualifications · oath · tenure · salary · exit · no minimum age
MECHANISM / ARGUMENT: Its principal consequence is that president or person appointed by President.
CONSEQUENCE / CONTRAST: The decisive contrast is between security of tenure + protected conditions and retirement at 65 / resignation to President / removal under Article 124(4).
UPSC TRAP / ANSWER-USE: “Impeachment of judges” is common journalistic usage but technically imprecise.
ANSWER-GRABBING FORMULATION: Article 124(6) requires an oath or affirmation to bear true faith and allegiance to the Constitution, uphold sovereignty and integrity, and perform duties without fear or favour, affection or ill-will.
```
### SESSION 6 — CONSTITUTIONAL SAFEGUARDS OF JUDICIAL INDEPENDENCE
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Constitutional safeguards of judicial independence denotes the constitutional rules and institutional links organised around INDEPENDENT ADJUDICATION.

**Technical definition:** Judicial independence and judicial review are basic-structure features.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Independence without reasoned accountability can produce opacity; accountability without insulation can produce political compliance.

#### MUST-WRITE KEYWORDS

- **Constitutional safeguards of judicial independence**
- **Difficult removal**
- **Article 124(4) special majority**
- **Can make lesser accountability difficult**
- **Salary/conditions protected**
- **Article 125; charged expenditure**

**How to use them:** Frame the answer through Constitutional safeguards of judicial independence; define Difficult removal, connect Article 124(4) special majority with Can make lesser accountability difficult to explain the mechanism, and use Salary/conditions protected for the decisive comparison or qualification.

Constitutional safeguards of judicial independence denotes the constitutional rules and institutional links organised around INDEPENDENT ADJUDICATION.
Constitutional safeguards of judicial independence operates through +---------------+---------------+------------+, connected with Appointment Security of Financial Conduct Institutional.
The operative mechanism matters because insulation tenure protection restraint authority.
Its principal consequence is that collegium Art 124(4) Arts 125/146 Art 121 Arts 129/141.
The decisive contrast is between autonomy from political reward, punishment and annual bargaining and Safeguard Mechanism Qualification.
The exam-safe limitation is that difficult removal Article 124(4) special majority [ANALYSIS] Can make lesser accountability difficult.
![Topic-specific visual map: Constitutional safeguards of judicial independence.](assets/05_constitutional_safeguards_of_judicial_independence.png)
...
```text
      ...
      +------------+---------------+---------------+------------+
      |            |               |               |            |
 Appointment   Security of     Financial       Conduct       Institutional
 insulation    tenure          protection      restraint     authority
 collegium     Art 124(4)      Arts 125/146    Art 121       Arts 129/141
      |            |               |               |            |
   autonomy from political reward, punishment and annual bargaining
```
...
#### CLOSING RECALL FLOW — CONSTITUTIONAL SAFEGUARDS OF JUDICIAL INDEPENDENCE

```closure-flow
SUBTOPIC: Constitutional safeguards of judicial independence
KEY TERMS / DEFINITIONS: Constitutional safeguards of judicial independence · Difficult removal · Article 124(4) special majority · Can make lesser accountability difficult · Salary/conditions protected · Article 125; charged expenditure
MECHANISM / ARGUMENT: The decisive contrast is between autonomy from political reward, punishment and annual bargaining and Safeguard Mechanism Qualification.
CONSEQUENCE / CONTRAST: Independence is functional, not personal privilege: it exists so judges can decide according to law.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that collegium Art 124(4) Arts 125/146 Art 121 Arts 129/141.
ANSWER-GRABBING FORMULATION: Independence without reasoned accountability can produce opacity; accountability without insulation can produce political compliance.
```
### SESSION 7 — ACCOUNTABILITY, ETHICS AND THE IN-HOUSE PROCESS
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Accountability, ethics and the in-house process denotes the constitutional rules and institutional links organised around Reasoned judgments + open courts + appeals/review.

**Technical definition:** The in-house process is not equivalent to a transparent statutory disciplinary code and does not create a full graded-sanction framework.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The in-house process is not equivalent to a transparent statutory disciplinary code and does not create a full graded-sanction framework.
...
**How to use them:** Frame the answer through Accountability; define ethics, connect the in-house process with Restatement of Values of Judicial Life (1997) to explain the mechanism, and use in-house procedure (1999) for the decisive comparison or qualification.

Accountability, ethics and the in-house process denotes the constitutional rules and institutional links organised around Reasoned judgments + open courts + appeals/review.
Accountability, ethics and the in-house process operates through recusal norms + disclosure + professional ethics, connected with Restatement of Values of Judicial Life, 1997.
The operative mechanism matters because in-house procedure, adopted 1999.
Its principal consequence is that article 124(4) removal for proved misconduct/incapacity.
The decisive contrast is between [FACT] The Restatement of Values of Judicial Life (1997) and the in-house procedure (1999) are non-statutory accountability mechanisms and [FACT] The Judicial Standards and Accountability Bill, 2010 lapsed ; it must not be cited as law.
The exam-safe limitation is that [ANALYSIS] Open hearings, published reasons, review, professional criticism and recusal practice provide everyday accountability.
...
#### CLOSING RECALL FLOW — ACCOUNTABILITY, ETHICS AND THE IN-HOUSE PROCESS

```closure-flow
SUBTOPIC: Accountability, ethics and the in-house process
KEY TERMS / DEFINITIONS: Accountability · ethics · the in-house process · Restatement of Values of Judicial Life (1997) · in-house procedure (1999) · Judicial Standards and Accountability Bill, 2010 lapsed
MECHANISM / ARGUMENT: The Restatement of Values of Judicial Life (1997) and the in-house procedure (1999) are non-statutory accountability mechanisms.
CONSEQUENCE / CONTRAST: The decisive contrast is between The Restatement of Values of Judicial Life (1997) and the in-house procedure (1999) are non-statutory accountability mechanisms and The Judicial Standards and Accountability Bill, 2010 lapsed ; it must not be cited as law.
UPSC TRAP / ANSWER-USE: The Judicial Standards and Accountability Bill, 2010 lapsed; it must not be cited as law.
ANSWER-GRABBING FORMULATION: The in-house process is not equivalent to a transparent statutory disciplinary code and does not create a full graded-sanction framework.
```
### SESSION 8 — MASTER JURISDICTION MAP
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Master jurisdiction map denotes the constitutional rules and institutional links organised around +-----------+---+---+-----------+-----------+.

**Technical definition:** The decisive contrast is between A strong answer classifies the gateway before discussing the outcome and Article 142 is a remedial power within a cause before the Court, not a freestanding head of jurisdiction.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The Supreme Court's original, appellate, writ, advisory and review powers arise through distinct constitutional gateways, while Article 142 supplies relief within jurisdiction rather than creating jurisdiction itself.

#### MUST-WRITE KEYWORDS

- **Master jurisdiction map**
- **Article 142**
- **Master**
...
**How to use them:** Frame the answer through Master jurisdiction map; define Article 142, connect Master with Its principal consequence to explain the mechanism, and use Its for the decisive comparison or qualification.

Master jurisdiction map denotes the constitutional rules and institutional links organised around +-----------+---+---+-----------+-----------+.
Master jurisdiction map operates through Original Writ Appellate Advisory Review Record/, connected with Art 131 Art 32 132-136 Art 143 Art 137 contempt 129.
The operative mechanism matters because federal FR remedy appeal/SLP opinion self- precedent.
Its principal consequence is that disputes correction protection.
The decisive contrast is between [ANALYSIS] A strong answer classifies the gateway before discussing the outcome and [LIMIT] Article 142 is a remedial power within a cause before the Court, not a freestanding head of jurisdiction.
The exam-safe limitation is that +-----------+---+---+-----------+-----------+.
![Topic-specific visual map: Master jurisdiction map.](assets/06_master_jurisdiction_map.png)
...
```text
   ...
   +-----------+-----------+---+---+-----------+-----------+
   |           |           |       |           |           |
Original     Writ       Appellate  Advisory   Review     Record/
Art 131      Art 32     132-136    Art 143    Art 137   contempt 129
   |           |           |       |           |           |
federal     FR remedy   appeal/SLP opinion    self-       precedent
disputes                                      correction  protection
```
...
#### CLOSING RECALL FLOW — MASTER JURISDICTION MAP

```closure-flow
SUBTOPIC: Master jurisdiction map
KEY TERMS / DEFINITIONS: Master jurisdiction map · Article 142 · Master · Its principal consequence · Its · 132-136
MECHANISM / ARGUMENT: The decisive contrast is between A strong answer classifies the gateway before discussing the outcome and Article 142 is a remedial power within a cause before the Court, not a freestanding head of jurisdiction.
CONSEQUENCE / CONTRAST: Article 142 is a remedial power within a cause before the Court, not a freestanding head of jurisdiction.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that disputes correction protection.
ANSWER-GRABBING FORMULATION: The Supreme Court's original, appellate, writ, advisory and review powers arise through distinct constitutional gateways, while Article 142 supplies relief within jurisdiction rather than creating jurisdiction itself.
```
### SESSION 9 — ORIGINAL JURISDICTION UNDER ARTICLE 131
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Original jurisdiction under Article 131 denotes the constitutional rules and institutional links organised around Does the dispute involve a legal right?.

**Technical definition:** Original jurisdiction under Article 131 operates through Are the parties constitutionally federal?, connected with Union v State(s) / State v State.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 131 makes the Court a federal umpire, but only for legal controversy, not political mediation.
...
**How to use them:** Frame the answer through Original jurisdiction under Article 131; define legal right, connect Article 131 with Article 262 to explain the mechanism, and use Original for the decisive comparison or qualification.

Original jurisdiction under Article 131 denotes the constitutional rules and institutional links organised around Does the dispute involve a legal right?.
Original jurisdiction under Article 131 operates through Are the parties constitutionally federal?, connected with Union v State(s) / State v State.
The operative mechanism matters because is it excluded by constitutional/statutory design?.
Its principal consequence is that pre-Constitution covenant exception / inter-State water route under Art 262.
The decisive contrast is between Supreme Court exclusive original jurisdiction and [FACT] The dispute must involve the existence or extent of a legal right.
The exam-safe limitation is that [FACT] The jurisdiction is original and exclusive.
![Topic-specific visual map: Original jurisdiction under Article 131.](assets/07_original_jurisdiction_under_article_131.png)
...
#### CLOSING RECALL FLOW — ORIGINAL JURISDICTION UNDER ARTICLE 131

```closure-flow
SUBTOPIC: Original jurisdiction under Article 131
KEY TERMS / DEFINITIONS: Original jurisdiction under Article 131 · legal right · Article 131 · Article 262 · Original · Article
MECHANISM / ARGUMENT: Original jurisdiction under Article 131 operates through Are the parties constitutionally federal?, connected with Union v State(s) / State v State.
CONSEQUENCE / CONTRAST: The decisive contrast is between Supreme Court exclusive original jurisdiction and The dispute must involve the existence or extent of a legal right.
UPSC TRAP / ANSWER-USE: Purely political disagreement without a legal-right issue does not satisfy the Article.
ANSWER-GRABBING FORMULATION: Article 131 makes the Court a federal umpire, but only for legal controversy, not political mediation.
```
### SESSION 10 — ARTICLE 32, THE FIVE WRITS AND ARTICLE 226 COMPARISON
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 32, the five writs and Article 226 comparison denotes the constitutional rules and institutional links organised around Illegal detention?

**Technical definition:** “Article 226 is wider” means wider in purpose, not unlimited territorial reach.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 32 guarantees remedies for Fundamental Rights, whereas Article 226 extends to other legal rights; the latter is wider in purpose, not territorially unlimited.

#### MUST-WRITE KEYWORDS

- **Article 32**
- **the five writs**
- **Article 226 comparison**
- **and any other purpose**
- **in purpose**
- **Habeas corpus**

**How to use them:** Frame the answer through Article 32; define the five writs, connect Article 226 comparison with and any other purpose to explain the mechanism, and use in purpose for the decisive comparison or qualification.

Article 32, the five writs and Article 226 comparison denotes the constitutional rules and institutional links organised around Illegal detention? HABEAS CORPUS.
Article 32, the five writs and Article 226 comparison operates through Public duty not performed? MANDAMUS, connected with Lower court/tribunal about to exceed power? PROHIBITION.
The operative mechanism matters because illegal order already made? CERTIORARI.
Its principal consequence is that public office unlawfully occupied? QUO WARRANTO.
The decisive contrast is between Writ Core purpose High-yield boundary and Habeas corpus Produce detained person and test legality May operate against private detention.
The exam-safe limitation is that mandamus Command performance of public duty Not ordinarily against private duty or President/Governor personally.
![Topic-specific visual map: Article 32, the five writs and Article 226 comparison.](assets/08_article_32_the_five_writs_and_article_226_comparison.png)
...
| Quo warranto | Test lawful entitlement to substantive public office | Applicant need not show personal injury |
...
#### CLOSING RECALL FLOW — ARTICLE 32, THE FIVE WRITS AND ARTICLE 226 COMPARISON

```closure-flow
SUBTOPIC: Article 32, the five writs and Article 226 comparison
KEY TERMS / DEFINITIONS: Article 32 · the five writs · Article 226 comparison · and any other purpose · in purpose · Habeas corpus
MECHANISM / ARGUMENT: The decisive contrast is between Writ Core purpose High-yield boundary and Habeas corpus Produce detained person and test legality May operate against private detention.
CONSEQUENCE / CONTRAST: “Article 226 is wider” means wider in purpose, not unlimited territorial reach.
UPSC TRAP / ANSWER-USE: Article 32 is not a bypass for every legal grievance; a Fundamental Right injury must be shown.
ANSWER-GRABBING FORMULATION: Article 32 guarantees remedies for Fundamental Rights, whereas Article 226 extends to other legal rights; the latter is wider in purpose, not territorially unlimited.
```
### SESSION 11 — APPELLATE JURISDICTION: ARTICLES 132-136
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Appellate jurisdiction: Articles 132-136 denotes the constitutional rules and institutional links organised around Subordinate court / tribunal.

**Technical definition:** Article 136 is discretionary, not a regular right of appeal.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Articles 132 to 135 structure defined appellate routes, while Article 136 remains an exceptional discretionary doorway for correcting grave injustice rather than a regular appeal.
...
- **HC certificate involving substantial constitutional interpretation**
- **Civil appeal**

**How to use them:** Frame the answer through Appellate jurisdiction; define Articles 132-136, connect discretionary with Constitutional appeal to explain the mechanism, and use HC certificate involving substantial constitutional interpretation for the decisive comparison or qualification.

Appellate jurisdiction: Articles 132-136 denotes the constitutional rules and institutional links organised around Subordinate court / tribunal.
Appellate jurisdiction: Articles 132-136 operates through +---------+----------------+, connected with Art 132 Art 133 Art 134.
The operative mechanism matters because constitutional civil criminal.
Its principal consequence is that question appeal appeal.
The decisive contrast is between Residual exceptional doorway: Article 136 Special Leave and Article Gateway Core condition.
The exam-safe limitation is that 132 Constitutional appeal HC certificate involving substantial constitutional interpretation.
![Topic-specific visual map: Appellate jurisdiction: Articles 132-136.](assets/09_appellate_jurisdiction_articles_132_136.png)
...
Subordinate court / tribunal
 ...
 +--------+---------+----------------+
 |                  |                |
Art 132           Art 133          Art 134
constitutional    civil            criminal
question          appeal           appeal
          \          |             /
             certificate route
                  Art 134A
                     |
...
#### CLOSING RECALL FLOW — APPELLATE JURISDICTION: ARTICLES 132-136

```closure-flow
SUBTOPIC: Appellate jurisdiction: Articles 132-136
KEY TERMS / DEFINITIONS: Appellate jurisdiction · Articles 132-136 · discretionary · Constitutional appeal · HC certificate involving substantial constitutional interpretation · Civil appeal
MECHANISM / ARGUMENT: Article 136 is discretionary, not a regular right of appeal.
CONSEQUENCE / CONTRAST: The decisive contrast is between Residual exceptional doorway: Article 136 Special Leave and Article Gateway Core condition.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that question appeal appeal.
ANSWER-GRABBING FORMULATION: Articles 132 to 135 structure defined appellate routes, while Article 136 remains an exceptional discretionary doorway for correcting grave injustice rather than a regular appeal.
```
### SESSION 12 — ADVISORY JURISDICTION UNDER ARTICLE 143
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Advisory jurisdiction under Article 143 denotes the constitutional rules and institutional links organised around President identifies question.

**Technical definition:** The decisive contrast is between Court shall report its opinion and Under Article 143(1), the President may refer a question of law or fact of public importance; the Court may report its opinion.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Under Article 143(2), the specified pre-Constitution treaty/covenant class is subject to a mandatory reporting formulation.
...
**How to use them:** Frame the answer through Advisory jurisdiction under Article 143; define not binding, connect Article 143 with Article 142 to explain the mechanism, and use Advisory for the decisive comparison or qualification.

Advisory jurisdiction under Article 143 denotes the constitutional rules and institutional links organised around President identifies question.
Advisory jurisdiction under Article 143 operates through of law/fact of public importance, connected with Supreme Court may hear and report opinion.
The operative mechanism matters because opinion is advisory and non-binding.
Its principal consequence is that pre-Constitution treaty/covenant class.
The decisive contrast is between Court shall report its opinion and [FACT] Under Article 143(1), the President may refer a question of law or fact of public importance; the Court may report its opinion.
The exam-safe limitation is that [FACT] Under Article 143(2), the specified pre-Constitution treaty/covenant class is subject to a mandatory reporting formulation.
![Topic-specific visual map: Advisory jurisdiction under Article 143.](assets/10_advisory_jurisdiction_under_article_143.png)
**Visual 18 - Advisory route**

```text
President identifies question
of law/fact of public importance
             |
         Article 143(1)
             |
Supreme Court may hear and report opinion
             |
Opinion is advisory and non-binding

Pre-Constitution treaty/covenant class
             |
         Article 143(2)
             |
Court shall report its opinion
```
...
#### CLOSING RECALL FLOW — ADVISORY JURISDICTION UNDER ARTICLE 143

```closure-flow
SUBTOPIC: Advisory jurisdiction under Article 143
KEY TERMS / DEFINITIONS: Advisory jurisdiction under Article 143 · not binding · Article 143 · Article 142 · Advisory · Article
MECHANISM / ARGUMENT: The operative mechanism matters because opinion is advisory and non-binding.
CONSEQUENCE / CONTRAST: The decisive contrast is between Court shall report its opinion and Under Article 143(1), the President may refer a question of law or fact of public importance; the Court may report its opinion.
UPSC TRAP / ANSWER-USE: An advisory opinion is not binding in the manner of a judgment inter partes.
ANSWER-GRABBING FORMULATION: Under Article 143(2), the specified pre-Constitution treaty/covenant class is subject to a mandatory reporting formulation.
```
### SESSION 13 — REVIEW UNDER ARTICLE 137 AND THE CURATIVE PETITION
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Review under Article 137 and the curative petition denotes the constitutional rules and institutional links organised around Supreme Court judgment.

**Technical definition:** The decisive contrast is between final exceptional correction, not another appeal and Article 137 authorises the Supreme Court to review its judgments or orders, subject to law and rules.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Finality preserves certainty, while review and curative jurisdiction prevent finality from becoming institutional infallibility.
...
- **Article 137**
- **Review under Article 137 and the curative petition**
- **Review**
- **Article**

**How to use them:** Frame the answer through Review under Article 137; define the curative petition, connect Article 137 with Review under Article 137 and the curative petition to explain the mechanism, and use Review for the decisive comparison or qualification.

Review under Article 137 and the curative petition denotes the constitutional rules and institutional links organised around Supreme Court judgment.
Review under Article 137 and the curative petition operates through Review petition, Article 137, connected with error apparent / governing review grounds.
The operative mechanism matters because curative petition, Rupa Ashok Hurra (2002).
Its principal consequence is that rare natural-justice or judicial-bias failure.
The decisive contrast is between final exceptional correction, not another appeal and [FACT] Article 137 authorises the Supreme Court to review its judgments or orders, subject to law and rules.
The exam-safe limitation is that [FACT] A review is narrow and is not a full rehearing merely because a party disagrees.
...
#### CLOSING RECALL FLOW — REVIEW UNDER ARTICLE 137 AND THE CURATIVE PETITION

```closure-flow
SUBTOPIC: Review under Article 137 and the curative petition
KEY TERMS / DEFINITIONS: Review under Article 137 · the curative petition · Article 137 · Review under Article 137 and the curative petition · Review · Article
MECHANISM / ARGUMENT: The exam-safe limitation is that A review is narrow and is not a full rehearing merely because a party disagrees.
CONSEQUENCE / CONTRAST: The decisive contrast is between final exceptional correction, not another appeal and Article 137 authorises the Supreme Court to review its judgments or orders, subject to law and rules.
UPSC TRAP / ANSWER-USE: Curative jurisdiction is exceptional, especially for denial of natural justice or reasonable apprehension of bias; it is not a routine second review.
ANSWER-GRABBING FORMULATION: Finality preserves certainty, while review and curative jurisdiction prevent finality from becoming institutional infallibility.
```
### SESSION 14 — COURT OF RECORD AND CONTEMPT UNDER ARTICLE 129
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Court of record and contempt under Article 129 denotes the constitutional rules and institutional links organised around Court-of-record function Meaning Constitutional purpose.

**Technical definition:** Its principal consequence is that Article 129 declares the Supreme Court a court of record with power to punish for contempt of itself.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 129 protects the Supreme Court's records and contempt authority, but fair institutional criticism remains compatible with democratic scrutiny.

#### MUST-WRITE KEYWORDS

- **Court of record**
- **contempt under Article 129**
- **not cut down the constitutional contempt power**
- **Authoritative record**
- **Institutional memory and legal certainty**
- **Precedential authority**

**How to use them:** Frame the answer through Court of record; define contempt under Article 129, connect not cut down the constitutional contempt power with Authoritative record to explain the mechanism, and use Institutional memory and legal certainty for the decisive comparison or qualification.

Court of record and contempt under Article 129 denotes the constitutional rules and institutional links organised around Court-of-record function Meaning Constitutional purpose.
Court of record and contempt under Article 129 operates through Authoritative record Proceedings and acts retained as enduring record Institutional memory and legal certainty, connected with Precedential authority Decisions guide and bind under Article 141 Uniformity.
The operative mechanism matters because contempt power Punishes interference with justice Protects adjudication and compliance.
Its principal consequence is that [FACT] Article 129 declares the Supreme Court a court of record with power to punish for contempt of itself.
The decisive contrast is between [FACT] The Contempt of Courts Act, 1971 distinguishes civil and criminal contempt and regulates procedure and [FACT] Truth may be permitted as a defence when bona fide and in the public interest.
The exam-safe limitation is that [FACT] The statutory framework does not cut down the constitutional contempt power.
...
#### CLOSING RECALL FLOW — COURT OF RECORD AND CONTEMPT UNDER ARTICLE 129

```closure-flow
SUBTOPIC: Court of record and contempt under Article 129
KEY TERMS / DEFINITIONS: Court of record · contempt under Article 129 · not cut down the constitutional contempt power · Authoritative record · Institutional memory and legal certainty · Precedential authority
MECHANISM / ARGUMENT: Court of record and contempt under Article 129 operates through Authoritative record Proceedings and acts retained as enduring record Institutional memory and legal certainty, connected with Precedential authority Decisions guide and bind under Article 141 Uniformity.
CONSEQUENCE / CONTRAST: Its principal consequence is that Article 129 declares the Supreme Court a court of record with power to punish for contempt of itself.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the decisive contrast is between The Contempt of Courts Act, 1971 distinguishes civil and...
ANSWER-GRABBING FORMULATION: Article 129 protects the Supreme Court's records and contempt authority, but fair institutional criticism remains compatible with democratic scrutiny.
```
### SESSION 15 — ARTICLES 141, 142, 144 AND 145
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Articles 141, 142, 144 and 145 denotes the constitutional rules and institutional links organised around law declared binds all courts.

**Technical definition:** Article 142 is not an unlimited source of legislation, does not create freestanding jurisdiction and cannot override substantive constitutional/statutory limits.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 142 supplements jurisdiction to do complete justice but cannot displace substantive law, while the 2025 Article 143 opinion rejected deemed assent and rigid timelines.
...
**How to use them:** Frame the answer through Articles 141; define ratio decidendi, connect supplementary, not supplanting with Article 141 to explain the mechanism, and use Article 142 for the decisive comparison or qualification.

Articles 141, 142, 144 and 145 denotes the constitutional rules and institutional links organised around law declared binds all courts.
Articles 141, 142, 144 and 145 operates through complete-justice order in cause before Court, connected with all civil and judicial authorities act in aid.
The operative mechanism matters because court frames rules; bench and procedure discipline.
Its principal consequence is that article 141: precedent.
The decisive contrast is between [FACT] The law declared by the Supreme Court binds all courts within India and [FACT] The binding component is the ratio decidendi , not every observation.
The exam-safe limitation is that [FACT] A smaller bench cannot overrule a larger bench; conflict should be referred appropriately.
![Topic-specific visual map: Articles 141, 142, 144 and 145.](assets/11_articles_141_142_144_and_145.png)
...
#### CLOSING RECALL FLOW — ARTICLES 141, 142, 144 AND 145

```closure-flow
SUBTOPIC: Articles 141, 142, 144 and 145
KEY TERMS / DEFINITIONS: Articles 141 · ratio decidendi · supplementary, not supplanting · Article 141 · Article 142 · Article 143
MECHANISM / ARGUMENT: Article 144 supplies the cooperation bridge because the Court has neither an independent purse nor an enforcement bureaucracy.
CONSEQUENCE / CONTRAST: Article 142 is not an unlimited source of legislation, does not create freestanding jurisdiction and cannot override substantive constitutional/statutory limits.
UPSC TRAP / ANSWER-USE: Article 144 requires legal aid to Court orders; it does not remove the constitutional competences of other authorities.
ANSWER-GRABBING FORMULATION: Article 142 supplements jurisdiction to do complete justice but cannot displace substantive law, while the 2025 Article 143 opinion rejected deemed assent and rigid timelines.
```
### SESSION 16 — ACTING, AD HOC AND RETIRED JUDGES
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Acting, ad hoc and retired judges denotes the constitutional rules and institutional links organised around Provision Device Trigger and control.

**Technical definition:** An Article 128 judge sits and acts with the relevant powers while requested but is not thereby treated as a permanently serving judge.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> An Article 128 judge sits and acts with the relevant powers while requested but is not thereby treated as a permanently serving judge.
...
**How to use them:** Frame the answer through Acting; define ad hoc, connect retired judges with Article 126 to explain the mechanism, and use Acting CJI for the decisive comparison or qualification.

Acting, ad hoc and retired judges denotes the constitutional rules and institutional links organised around Provision Device Trigger and control.
Acting, ad hoc and retired judges operates through Article 126 Acting CJI Office vacant or CJI unable to perform; President appoints another SC judge, connected with Article 127 Ad hoc judge Lack of quorum; CJI with President's prior consent and consultation requests qualified HC judge.
The operative mechanism matters because article 124(7) Post-retirement practice bar Former SC judge cannot plead or act before any court or authority in India.
Its principal consequence is that [ANALYSIS] Retired-judge deployment can add expertise and short-term capacity.
The decisive contrast is between [LIMIT] It is a stop-gap, not a substitute for timely regular appointments and [FACT] Article 124(7) bars pleading or acting; it does not textually bar every public appointment, arbitration or commission role.
The exam-safe limitation is that provision Device Trigger and control.
...
#### CLOSING RECALL FLOW — ACTING, AD HOC AND RETIRED JUDGES

```closure-flow
SUBTOPIC: Acting, ad hoc and retired judges
KEY TERMS / DEFINITIONS: Acting · ad hoc · retired judges · Article 126 · Acting CJI · Article 127
MECHANISM / ARGUMENT: The decisive contrast is between It is a stop-gap, not a substitute for timely regular appointments and Article 124(7) bars pleading or acting; it does not textually bar every public appointment, arbitration or commission role.
CONSEQUENCE / CONTRAST: Article 124(7) bars pleading or acting; it does not textually bar every public appointment, arbitration or commission role.
UPSC TRAP / ANSWER-USE: An Article 128 judge sits and acts with the relevant powers while requested but is not thereby treated as a permanently serving judge.
ANSWER-GRABBING FORMULATION: An Article 128 judge sits and acts with the relevant powers while requested but is not thereby treated as a permanently serving judge.
```
### SESSION 17 — JUDICIAL REVIEW, BASIC STRUCTURE AND THE NINTH SCHEDULE
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Judicial review, basic structure and the Ninth Schedule denotes the constitutional rules and institutional links organised around Ordinary law / executive action.

**Technical definition:** The decisive contrast is between rights impact - underlying basic feature - damage test and Judicial review flows from the constitutional structure and provisions including Articles 13, 32, 131-136, 226, 246 and 372.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> An ordinary law is not invalid merely because someone labels it contrary to basic structure; the challenge must connect to competence, Part III or another constitutional provision.
...
**How to use them:** Frame the answer through Judicial review; define basic structure, connect the Ninth Schedule with reviewable to explain the mechanism, and use 24 April 1973 for the decisive comparison or qualification.

Judicial review, basic structure and the Ninth Schedule denotes the constitutional rules and institutional links organised around Ordinary law / executive action.
Judicial review, basic structure and the Ninth Schedule operates through competence + Fundamental Rights + other constitutional limits, connected with constitutional amendment.
The operative mechanism matters because article 368 procedure + basic-structure limit.
Its principal consequence is that ninth Schedule insertion after 24 April 1973.
The decisive contrast is between rights impact - underlying basic feature - damage test and [FACT] Judicial review flows from the constitutional structure and provisions including Articles 13, 32, 131-136, 226, 246 and 372.
The exam-safe limitation is that [FACT] Kesavananda Bharati (1973) held that Parliament's amending power cannot damage or destroy the basic structure.
![Topic-specific visual map: Judicial review, basic structure and the Ninth Schedule.](assets/12_judicial_review_basic_structure_and_the_ninth_schedu.png)
...
#### CLOSING RECALL FLOW — JUDICIAL REVIEW, BASIC STRUCTURE AND THE NINTH SCHEDULE

```closure-flow
SUBTOPIC: Judicial review, basic structure and the Ninth Schedule
KEY TERMS / DEFINITIONS: Judicial review · basic structure · the Ninth Schedule · reviewable · 24 April 1973 · 131-136
MECHANISM / ARGUMENT: The decisive contrast is between rights impact - underlying basic feature - damage test and Judicial review flows from the constitutional structure and provisions including Articles 13, 32, 131-136, 226, 246 and 372.
CONSEQUENCE / CONTRAST: Its principal consequence is that ninth Schedule insertion after 24 April 1973.
UPSC TRAP / ANSWER-USE: An ordinary law is not invalid merely because someone labels it contrary to basic structure; the challenge must connect to competence, Part III or another constitutional provision.
ANSWER-GRABBING FORMULATION: An ordinary law is not invalid merely because someone labels it contrary to basic structure; the challenge must connect to competence, Part III or another constitutional provision.
```
### SESSION 18 — TRIBUNALS AND THE BASIC-STRUCTURE FLOOR
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Tribunals and the basic-structure floor denotes the constitutional rules and institutional links organised around Specialised tribunal.

**Technical definition:** The exam-safe limitation is that Tribunals may supplement courts but cannot supplant constitutional judicial review.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The efficiency test is institutional: shifting cases without judges, members, staff and digital records shifts delay rather than cures it.

#### MUST-WRITE KEYWORDS

- **Tribunals**
- **the basic-structure floor**
- **Tribunals and the basic-structure floor**
- **Specialised**
- **Its principal consequence**
- **Its**

**How to use them:** Frame the answer through Tribunals; define the basic-structure floor, connect Tribunals and the basic-structure floor with Specialised to explain the mechanism, and use Its principal consequence for the decisive comparison or qualification.

Tribunals and the basic-structure floor denotes the constitutional rules and institutional links organised around Specialised tribunal.
Tribunals and the basic-structure floor operates through expertise + flexible procedure, connected with first-instance adjudication.
The operative mechanism matters because high Court Division Bench.
Its principal consequence is that articles 226/227 review.
The decisive contrast is between appeal / SLP where legally available and [FACT] Articles 323A and 323B enable specialised tribunals in different fields.
The exam-safe limitation is that [ANALYSIS] Tribunals may supplement courts but cannot supplant constitutional judicial review.
...
#### CLOSING RECALL FLOW — TRIBUNALS AND THE BASIC-STRUCTURE FLOOR

```closure-flow
SUBTOPIC: Tribunals and the basic-structure floor
KEY TERMS / DEFINITIONS: Tribunals · the basic-structure floor · Tribunals and the basic-structure floor · Specialised · Its principal consequence · Its
MECHANISM / ARGUMENT: Union of India (1997) held that review under Articles 226/227 and 32 is part of the basic structure; tribunal decisions remain reviewable by a High Court Division Bench.
CONSEQUENCE / CONTRAST: The decisive contrast is between appeal / SLP where legally available and Articles 323A and 323B enable specialised tribunals in different fields.
UPSC TRAP / ANSWER-USE: The exam-safe limitation is that Tribunals may supplement courts but cannot supplant constitutional judicial review.
ANSWER-GRABBING FORMULATION: The efficiency test is institutional: shifting cases without judges, members, staff and digital records shifts delay rather than cures it.
```
### SESSION 19 — PIL, LOCUS STANDI, EPISTOLARY JURISDICTION AND CONTINUING MANDAMUS
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** PIL, locus standi, epistolary jurisdiction and continuing mandamus denotes the constitutional rules and institutional links organised around Traditional standing.

**Technical definition:** The decisive contrast is between epistolary jurisdiction and letter treated as petition in appropriate case.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> PIL relaxed standing and enabled continuing supervision for rights deprivation, but it does not dispense with evidence, bona fides or separation-of-powers discipline.
...
- **continuing mandamus**
- **Disadvantaged group unable to litigate**
- **Private rivalry dressed as public cause**

**How to use them:** Frame the answer through PIL; define locus standi, connect epistolary jurisdiction with continuing mandamus to explain the mechanism, and use Disadvantaged group unable to litigate for the decisive comparison or qualification.

PIL, locus standi, epistolary jurisdiction and continuing mandamus denotes the constitutional rules and institutional links organised around Traditional standing.
PIL, locus standi, epistolary jurisdiction and continuing mandamus operates through personally injured litigant, connected with post-Emergency rights expansion.
The operative mechanism matters because relaxed locus standi.
Its principal consequence is that public-spirited petitioner for disadvantaged groups.
The decisive contrast is between epistolary jurisdiction and letter treated as petition in appropriate case.
The exam-safe limitation is that continuing mandamus.
![Topic-specific visual map: PIL, locus standi, epistolary jurisdiction and continuing mandamus.](assets/13_pil_locus_standi_epistolary_jurisdiction_and_continu.png)
...
#### CLOSING RECALL FLOW — PIL, LOCUS STANDI, EPISTOLARY JURISDICTION AND CONTINUING MANDAMUS

```closure-flow
SUBTOPIC: PIL, locus standi, epistolary jurisdiction and continuing mandamus
KEY TERMS / DEFINITIONS: PIL · locus standi · epistolary jurisdiction · continuing mandamus · Disadvantaged group unable to litigate · Private rivalry dressed as public cause
MECHANISM / ARGUMENT: The decisive contrast is between epistolary jurisdiction and letter treated as petition in appropriate case.
CONSEQUENCE / CONTRAST: PIL is not a licence to bypass evidence, standing discipline or separation of powers.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that public-spirited petitioner for disadvantaged groups.
ANSWER-GRABBING FORMULATION: PIL relaxed standing and enabled continuing supervision for rights deprivation, but it does not dispense with evidence, bona fides or separation-of-powers discipline.
```
### SESSION 20 — JUDICIAL ACTIVISM, RESTRAINT AND JUDICIAL LEGISLATION
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Judicial activism, restraint and judicial legislation denotes the constitutional rules and institutional links organised around RESTRAINT ---------------- REVIEW ---------------- ACTIVISM ---------------- GOVERNANCE.

**Technical definition:** Judicial activism is assertive interpretation or remedy in defence of constitutional values; judicial restraint emphasises institutional competence and democratic choice.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> A court crosses from adjudication toward governance when it designs policy without a constitutional hook, lacks administrable standards or continues management after lawful institutions can act.
...
- **Article 141**
- **Article 142**
- **Judicial activism, restraint and judicial legislation**

**How to use them:** Frame the answer through Judicial activism; define restraint, connect judicial legislation with Article 141 to explain the mechanism, and use Article 142 for the decisive comparison or qualification.

Judicial activism, restraint and judicial legislation denotes the constitutional rules and institutional links organised around RESTRAINT ---------------- REVIEW ---------------- ACTIVISM ---------------- GOVERNANCE.
Judicial activism, restraint and judicial legislation operates through deference legality testing strong remedies policy administration, connected with presumption of invalidate unlawful fill rights-linked risk of replacing.
The operative mechanism matters because constitutionality action vacuum temporarily elected branches.
Its principal consequence is that [FACT] Indian separation of powers is functional rather than absolutely watertight.
The decisive contrast is between Judicial legislation and Rights injury + legislative vacuum.
The exam-safe limitation is that vishaka v State of Rajasthan , 1997.
**Visual 30 - Institutional spectrum**

```text
RESTRAINT ---------------- REVIEW ---------------- ACTIVISM ---------------- GOVERNANCE
deference             legality testing        strong remedies          policy administration
   |                        |                       |                         |
presumption of       invalidate unlawful      fill rights-linked       risk of replacing
constitutionality    action                   vacuum temporarily       elected branches
```
...
```text
Rights injury + legislative vacuum
             |
*Vishaka v State of Rajasthan*, 1997
             |
interim binding guidelines under Article 141
"until legislation is enacted"
             |
2013 workplace sexual-harassment statute
             |
statutory framework supersedes interim court norms
```
...
#### CLOSING RECALL FLOW — JUDICIAL ACTIVISM, RESTRAINT AND JUDICIAL LEGISLATION

```closure-flow
SUBTOPIC: Judicial activism, restraint and judicial legislation
KEY TERMS / DEFINITIONS: Judicial activism · restraint · judicial legislation · Article 141 · Article 142 · Judicial activism, restraint and judicial legislation
MECHANISM / ARGUMENT: Judicial activism is assertive interpretation or remedy in defence of constitutional values; judicial restraint emphasises institutional competence and democratic choice.
CONSEQUENCE / CONTRAST: The decisive contrast is between Judicial legislation and Rights injury + legislative vacuum.
UPSC TRAP / ANSWER-USE: Its principal consequence is that Indian separation of powers is functional rather than absolutely watertight.
ANSWER-GRABBING FORMULATION: A court crosses from adjudication toward governance when it designs policy without a constitutional hook, lacks administrable standards or continues management after lawful institutions can act.
```
### SESSION 21 — ENVIRONMENTAL CONSTITUTIONALISM
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Environmental constitutionalism denotes the constitutional rules and institutional links organised around Article 21: life and dignity.

**Technical definition:** The exam-safe limitation is that subhash Kumar (1991) Article 21 includes pollution-free environment Not a substitute for every statutory route.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Courts can compel legality and supervise failure, but cannot replace scientific regulators, local consultation and continuous administration.

#### MUST-WRITE KEYWORDS

- **Environmental constitutionalism**
- **Subhash Kumar (1991)**
- **Article 21 includes pollution-free environment**
- **Not a substitute for every statutory route**
- **M.C. Mehta - Oleum Gas Leak (1987)**
- **Absolute liability for hazardous enterprises**

**How to use them:** Frame the answer through Environmental constitutionalism; define Subhash Kumar (1991), connect Article 21 includes pollution-free environment with Not a substitute for every statutory route to explain the mechanism, and use M.C. Mehta - Oleum Gas Leak (1987) for the decisive comparison or qualification.

Environmental constitutionalism denotes the constitutional rules and institutional links organised around Article 21: life and dignity.
Environmental constitutionalism operates through Article 48A: State environmental duty, connected with Article 51A(g): citizen duty.
The operative mechanism matters because judicial interpretation.
Its principal consequence is that pollution-free environment + liability + preventive principles.
The decisive contrast is between regulatory enforcement by executive, CPCB/SPCBs, NGT and courts and Case Named proposition Qualification.
The exam-safe limitation is that subhash Kumar (1991) [FACT] Article 21 includes pollution-free environment Not a substitute for every statutory route.
**Visual 32 - Constitutionalisation chain**

```text
Article 21: life and dignity
        +
Article 48A: State environmental duty
        +
...
|---|---|---|
| *Subhash Kumar* (1991) | [FACT] Article 21 includes pollution-free environment | Not a substitute for every statutory route |
| *M.C. Mehta* - Oleum Gas Leak (1987) | [FACT] Absolute liability for hazardous enterprises | Distinct from English strict liability |
| *Vellore Citizens* (1996) | [FACT] Precautionary principle, polluter pays and sustainable development | Principles require contextual application |
| *M.C. Mehta v. Kamal Nath* (1997) | [FACT] Public-trust doctrine | State holds key resources in trust |
| *T.N. Godavarman* (1996 onward) | [FACT] Broad forest approach and continuing mandamus | Standard example of long judicial supervision |
...
#### CLOSING RECALL FLOW — ENVIRONMENTAL CONSTITUTIONALISM

```closure-flow
SUBTOPIC: Environmental constitutionalism
KEY TERMS / DEFINITIONS: Environmental constitutionalism · Subhash Kumar (1991) · Article 21 includes pollution-free environment · Not a substitute for every statutory route · M.C. Mehta - Oleum Gas Leak (1987) · Absolute liability for hazardous enterprises
MECHANISM / ARGUMENT: The decisive contrast is between regulatory enforcement by executive, CPCB/SPCBs, NGT and courts and Case Named proposition Qualification.
CONSEQUENCE / CONTRAST: The exam-safe limitation is that subhash Kumar (1991) Article 21 includes pollution-free environment Not a substitute for every statutory route.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that pollution-free environment + liability + preventive principles.
ANSWER-GRABBING FORMULATION: Courts can compel legality and supervise failure, but cannot replace scientific regulators, local consultation and continuous administration.
```
### SESSION 22 — WOMEN AND DIVERSITY IN THE HIGHER JUDICIARY
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Women and diversity in the higher judiciary denotes the constitutional rules and institutional links organised around Bar entry and retention.

**Technical definition:** The “merit versus diversity” binary is false where opportunity, briefing patterns, senior designation and appointment criteria shape who becomes visible as meritorious. [CURRENT] This package does not freeze a current number or percentage of women judges.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Diversity in the higher judiciary affects legitimacy and perspective, but current representation must be established through dated data rather than static percentages.

#### MUST-WRITE KEYWORDS

- **Women**
- **diversity in the higher judiciary**
- **Attrition and caregiving barriers**
- **Fair workplace conditions, predictable listing and anti-harassment enforcement**
- **Unequal professional visibility**
- **Transparent briefing, designation and evaluation standards**

**How to use them:** Frame the answer through Women; define diversity in the higher judiciary, connect Attrition and caregiving barriers with Fair workplace conditions, predictable listing and anti-harassment enforcement to explain the mechanism, and use Unequal professional visibility for the decisive comparison or qualification.

Women and diversity in the higher judiciary denotes the constitutional rules and institutional links organised around Bar entry and retention.
Women and diversity in the higher judiciary operates through briefing opportunities / designation / leadership, connected with High Court appointment pool.
The operative mechanism matters because supreme Court collegium consideration.
Its principal consequence is that bench diversity + institutional legitimacy.
The decisive contrast is between [FACT] Justice M. Fathima Beevi became the first woman judge of the Supreme Court in 1989 and [LIMIT] Diversity is not a claim that identity predetermines judgments or replaces merit.
The exam-safe limitation is that [CURRENT] This package does not freeze a current number or percentage of women judges.
...
#### CLOSING RECALL FLOW — WOMEN AND DIVERSITY IN THE HIGHER JUDICIARY

```closure-flow
SUBTOPIC: Women and diversity in the higher judiciary
KEY TERMS / DEFINITIONS: Women · diversity in the higher judiciary · Attrition and caregiving barriers · Fair workplace conditions, predictable listing and anti-harassment enforcement · Unequal professional visibility · Transparent briefing, designation and evaluation standards
MECHANISM / ARGUMENT: Greater representation is supported by equality, legitimacy, role-model effects and a wider range of lived experience in adjudication.
CONSEQUENCE / CONTRAST: The “merit versus diversity” binary is false where opportunity, briefing patterns, senior designation and appointment criteria shape who becomes visible as meritorious. [CURRENT] This package does not freeze a current number or percentage of women judges.
UPSC TRAP / ANSWER-USE: The exam-safe limitation is that [CURRENT] This package does not freeze a current number or percentage of women judges.
ANSWER-GRABBING FORMULATION: Diversity in the higher judiciary affects legitimacy and perspective, but current representation must be established through dated data rather than static percentages.
```
### SESSION 23 — INDIA AND THE UNITED KINGDOM: JUDICIAL SYSTEMS
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** India and the United Kingdom: judicial systems denotes the constitutional rules and institutional links organised around Dimension India United Kingdom.

**Technical definition:** The exam-safe limitation is that executive review Strong judicial review Strong review of executive/administrative legality.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> UK courts ordinarily cannot strike down primary Westminster legislation; a declaration of incompatibility does not itself nullify the Act.
...
**How to use them:** Frame the answer through India; define the United Kingdom, connect judicial systems with uncodified to explain the mechanism, and use Constitutional order for the decisive comparison or qualification.

India and the United Kingdom: judicial systems denotes the constitutional rules and institutional links organised around Dimension India United Kingdom.
India and the United Kingdom: judicial systems operates through Constitutional order Written, supreme Constitution Uncodified constitution; parliamentary sovereignty, connected with Apex court Supreme Court of India UK Supreme Court.
The operative mechanism matters because review of primary legislation Courts may invalidate unconstitutional laws Courts ordinarily cannot invalidate a Westminster Act.
Its principal consequence is that rights technique Strong-form constitutional remedies Interpretation and declaration mechanisms under Human Rights Act framework.
The decisive contrast is between Federal role Constitutional umpire in Union-State disputes Devolution questions across distinct UK legal systems and Precedent Common-law doctrine plus Article 141 Common-law precedent.
The exam-safe limitation is that executive review Strong judicial review Strong review of executive/administrative legality.
...
#### CLOSING RECALL FLOW — INDIA AND THE UNITED KINGDOM: JUDICIAL SYSTEMS

```closure-flow
SUBTOPIC: India and the United Kingdom: judicial systems
KEY TERMS / DEFINITIONS: India · the United Kingdom · judicial systems · uncodified · Constitutional order · Written, supreme Constitution
MECHANISM / ARGUMENT: The decisive contrast is between Federal role Constitutional umpire in Union-State disputes Devolution questions across distinct UK legal systems and Precedent Common-law doctrine plus Article 141 Common-law precedent.
CONSEQUENCE / CONTRAST: Its principal consequence is that rights technique Strong-form constitutional remedies Interpretation and declaration mechanisms under Human Rights Act framework.
UPSC TRAP / ANSWER-USE: UK courts ordinarily cannot strike down primary Westminster legislation; a declaration of incompatibility does not itself nullify the Act.
ANSWER-GRABBING FORMULATION: UK courts ordinarily cannot strike down primary Westminster legislation; a declaration of incompatibility does not itself nullify the Act.
```
### SESSION 24 — INDIA AND THE USA: APPOINTMENTS AND JUDICIAL POWER
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** India and the USA: appointments and judicial power denotes the constitutional rules and institutional links organised around Formal appointer President President.

**Technical definition:** India maximises insulation but under-produces public reasons; the USA maximises visible political accountability but risks partisan capture.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> India maximises insulation but under-produces public reasons; the USA maximises visible political accountability but risks partisan capture.
...
**How to use them:** Frame the answer through India; define the USA, connect appointments with judicial power to explain the mechanism, and use Formal appointer for the decisive comparison or qualification.

India and the USA: appointments and judicial power denotes the constitutional rules and institutional links organised around Formal appointer President President.
India and the USA: appointments and judicial power operates through Decisive process Collegium recommendation; executive processing Presidential nomination + Senate advice and consent, connected with Public legislative hearing No constitutionally required confirmation Public Senate confirmation.
The operative mechanism matters because tenure Until age 65 During good behaviour, effectively life tenure.
Its principal consequence is that primary gain Insulation from executive dominance Visible inter-branch accountability.
The decisive contrast is between Primary risk Opacity and delay Partisan polarisation and ideological confirmation and Dimension India USA.
The exam-safe limitation is that court system Integrated Dual federal and State systems.
...
#### CLOSING RECALL FLOW — INDIA AND THE USA: APPOINTMENTS AND JUDICIAL POWER

```closure-flow
SUBTOPIC: India and the USA: appointments and judicial power
KEY TERMS / DEFINITIONS: India · the USA · appointments · judicial power · Formal appointer · President
MECHANISM / ARGUMENT: India maximises insulation but under-produces public reasons; the USA maximises visible political accountability but risks partisan capture.
CONSEQUENCE / CONTRAST: The decisive contrast is between Primary risk Opacity and delay Partisan polarisation and ideological confirmation and Dimension India USA.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that primary gain Insulation from executive dominance Visible inter-branch accountability.
ANSWER-GRABBING FORMULATION: India maximises insulation but under-produces public reasons; the USA maximises visible political accountability but risks partisan capture.
```
### SESSION 25 — ADVOCATES ACT, BAR COUNCIL AND PROFESSIONAL REGULATION
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Advocates Act, Bar Council and professional regulation denotes the constitutional rules and institutional links organised around Advocates Act, 1961.

**Technical definition:** The Bar Council of India is a statutory body under the Advocates Act, 1961, not a constitutional body.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The Bar Council of India is statutory under the Advocates Act, so its powers and reform route depend on legislation rather than constitutional entrenchment.
...
- **Advocates Act, Bar Council and professional regulation**
- **Its principal consequence**

**How to use them:** Frame the answer through Advocates Act; define Bar Council, connect professional regulation with Bar Council of India to explain the mechanism, and use Advocates Act, Bar Council and professional regulation for the decisive comparison or qualification.

Advocates Act, Bar Council and professional regulation denotes the constitutional rules and institutional links organised around Advocates Act, 1961.
Advocates Act, Bar Council and professional regulation operates through +-------------------+, connected with Bar Council of India State Bar Councils.
The operative mechanism matters because national standards enrolment + first disciplinary layer.
Its principal consequence is that professional conduct.
The decisive contrast is between appellate discipline and advocates practise subject to law and court rules.
The exam-safe limitation is that supreme Court Rules / Advocate-on-Record system.
...
national standards      enrolment + first disciplinary layer
legal education
professional conduct
appellate discipline
        |
advocates practise subject to law and court rules
        |
Supreme Court Rules / Advocate-on-Record system
```
...
#### CLOSING RECALL FLOW — ADVOCATES ACT, BAR COUNCIL AND PROFESSIONAL REGULATION

```closure-flow
SUBTOPIC: Advocates Act, Bar Council and professional regulation
KEY TERMS / DEFINITIONS: Advocates Act · Bar Council · professional regulation · Bar Council of India · Advocates Act, Bar Council and professional regulation · Its principal consequence
MECHANISM / ARGUMENT: Senior Advocate designation is a court-conferred distinction governed by law and judicial standards.
CONSEQUENCE / CONTRAST: The Bar Council of India is a statutory body under the Advocates Act, 1961, not a constitutional body.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the decisive contrast is between appellate discipline and advocates practise subject to law and...
ANSWER-GRABBING FORMULATION: The Bar Council of India is statutory under the Advocates Act, so its powers and reform route depend on legislation rather than constitutional entrenchment.
```
### SESSION 26 — PENDENCY, ACCESS TO JUSTICE AND E-COURTS REFORM
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Pendency, access to justice and e-Courts reform denotes the constitutional rules and institutional links organised around large and varied inflow.

**Technical definition:** The decisive contrast is between delay - cost - unequal access - weaker enforcement and [CURRENT] No comprehensive 2025-26 annual report was visible by 17 August 2026; no unverified pendency total is used.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The Supreme Court is among the world's strongest constitutional courts in legal authority, yet constitutional justice depends on affordable access, timely adjudication and executive compliance.
...
- **Distance from Delhi**
- **Legal cost**
- **Legal services, efficient admission filtering and predictable procedure**

**How to use them:** Frame the answer through Pendency; define access to justice, connect e-Courts reform with Distance from Delhi to explain the mechanism, and use Legal cost for the decisive comparison or qualification.

Pendency, access to justice and e-Courts reform denotes the constitutional rules and institutional links organised around large and varied inflow.
Pendency, access to justice and e-Courts reform operates through government litigation, connected with vacancies / uneven capacity.
The operative mechanism matters because adjournments / procedural complexity.
Its principal consequence is that sLP-heavy apex docket.
The decisive contrast is between delay - cost - unequal access - weaker enforcement and [CURRENT] No comprehensive 2025-26 annual report was visible by 17 August 2026; no unverified pendency total is used.
The exam-safe limitation is that [ANALYSIS] Delay is not merely administrative. A remedy delivered too late can hollow out liberty, livelihood and federal certainty.
![Topic-specific visual map: Pendency, access to justice and e-Courts reform.](assets/14_pendency_access_to_justice_and_e_courts_reform.png)
**Visual 39 - Delay chain**

```text
large and varied inflow
       +
government litigation
       +
vacancies / uneven capacity
       +
adjournments / procedural complexity
       +
SLP-heavy apex docket
       |
       v
delay -> cost -> unequal access -> weaker enforcement
```
...
#### CLOSING RECALL FLOW — PENDENCY, ACCESS TO JUSTICE AND E-COURTS REFORM

```closure-flow
SUBTOPIC: Pendency, access to justice and e-Courts reform
KEY TERMS / DEFINITIONS: Pendency · access to justice · e-Courts reform · Distance from Delhi · Legal cost · Legal services, efficient admission filtering and predictable procedure
MECHANISM / ARGUMENT: The decisive contrast is between delay - cost - unequal access - weaker enforcement and [CURRENT] No comprehensive 2025-26 annual report was visible by 17 August 2026; no unverified pendency total is used.
CONSEQUENCE / CONTRAST: The exam-safe limitation is that Delay is not merely administrative.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that sLP-heavy apex docket.
ANSWER-GRABBING FORMULATION: The Supreme Court is among the world's strongest constitutional courts in legal authority, yet constitutional justice depends on affordable access, timely adjudication and executive compliance.
```
### 27. Answer-writing architecture

Answer-writing architecture denotes the constitutional rules and institutional links organised around answer the directive directly.
Answer-writing architecture operates through Article / case / statute / dated official control, connected with explain mechanism, consequence and significance.
The operative mechanism matters because counterpoint, institutional limit or status caution.
Its principal consequence is that graded answer to the exact demand.
The decisive contrast is between Directive fidelity and Directive Required operation Common failure.
The exam-safe limitation is that discuss Cover major dimensions with balance A case-law list.
...
A. sits in Delhi, but the CJI may appoint another place with the President's approval.
B. must hold one annual sitting in every State capital.
C. must sit only in Delhi in all circumstances.
D. may shift permanently by a resolution of the collegium alone.

**Answer: A.** [FACT] Delhi is the seat; another place requires action by the CJI with presidential approval.
...
C. A distinguished jurist in the President's opinion who is an Indian citizen
D. A non-citizen with twenty years of comparative-law teaching

**Answer: C.** [FACT] Distinguished jurist is an express Supreme Court eligibility route; no minimum appointment age is prescribed.

#### OM5. CJI convention

The practice of appointing the senior-most Supreme Court judge as CJI is:

A. a requirement introduced by the 99th Amendment.
B. decided by a vote of all High Court Chief Justices.
C. mandated by the Judges (Inquiry) Act, 1968.
D. a constitutional convention rather than an express Article 124 rule.

**Answer: D.** [FACT] Seniority is a convention, historically broken in 1973 and 1977.
...
A. CJI alone
B. Law Minister plus CJI plus Leader of Opposition
C. CJI plus four senior-most Supreme Court judges
D. CJI plus two senior-most High Court Chief Justices

**Answer: C.** [FACT] The 1998 Presidential Reference established plurality through the CJI plus four senior-most judges.

#### OM7. NJAC

Which statement correctly describes the NJAC episode?

A. The 99th Amendment and NJAC Act were struck down in 2015 on judicial-independence/basic-structure grounds.
B. The NJAC replaced judicial review of appointments permanently.
C. The NJAC judgment held that no appointment commission can ever be constitutional.
D. The NJAC was only an executive order.

**Answer: A.** [FACT] The specific design was invalidated. [LIMIT] The holding should not be converted into a ban on every possible commission model.
...
B. 100 Lok Sabha or 50 Rajya Sabha members
C. 75 Lok Sabha or 40 Rajya Sabha members
D. 100 members of either House

**Answer: B.** [FACT] These thresholds start the parliamentary inquiry process; admission by the presiding officer is not automatic.

#### OM9. Original jurisdiction

Article 131 principally concerns:

A. private commercial disputes involving a public-sector company.
B. appeals from every inter-State river tribunal.
C. legal-right disputes between constitutionally specified Union and State parties.
D. election petitions concerning all legislators.

**Answer: C.** [FACT] The parties and legal-right requirement make Article 131 a federal, not general, original jurisdiction.
...
B. Article 32 reaches every legal right, while Article 226 reaches only Fundamental Rights.
C. Neither jurisdiction forms part of the basic structure.
D. Article 226 is wider in purpose because it reaches Fundamental Rights and other legal rights.

**Answer: D.** [FACT] Article 32 is itself a Fundamental Right but is narrower in subject matter.
...
B. is discretionary and excludes courts or tribunals under Armed-Forces law.
C. is issued by the President on judicial advice.
D. is an automatic right after every High Court judgment.

**Answer: B.** [FACT] SLP is exceptional, plenary and discretionary, with the express Armed-Forces exclusion.

#### OM13. Advisory jurisdiction

Which statement is correct?

A. Every public-importance reference must be answered under Article 143(1).
B. Advisory jurisdiction creates a private right of appeal.
C. Only Parliament can send a reference to the Court.
D. An Article 143 advisory opinion is not binding like an ordinary judgment.

**Answer: D.** [FACT] The President refers; under Article 143(1) the Court may report its opinion.
...
B. abolishes finality of judgments.
C. gives High Courts power to review Supreme Court judgments.
D. permits the Supreme Court to review its own judgments or orders subject to law and rules.

**Answer: D.** [FACT] Review is a narrow self-correction mechanism, not a fresh appeal.

#### OM15. Curative petition

The curative petition is associated with:

A. *Rupa Ashok Hurra* and prevention of gross miscarriage after review
B. *Kesavananda Bharati* and amendment review
C. *S.P. Gupta* and locus standi
D. *Vishaka* and interim workplace norms

**Answer: A.** [FACT] The curative jurisdiction is extraordinary and follows dismissal of review.
...
B. The 1971 Act regulates contempt but cannot cut down the Court's constitutional power.
C. Parliament may abolish Article 129 power by ordinary law.
D. Fair criticism of a judgment automatically constitutes criminal contempt.

**Answer: B.** [FACT] Article 129 is the constitutional source; free expression and fair criticism remain relevant limits.

#### OM17. Article 141

Under Article 141:

A. every factual sentence in every order is binding law.
B. the law declared by the Supreme Court binds all courts in India.
...
**Answer: B.** [FACT] The binding rule is the ratio, read with bench-strength discipline.

#### OM18. Article 142

Which formula most accurately states the limit on Article 142?

A. It supplements existing law but cannot supplant substantive law or violate Fundamental Rights.
B. It authorises the Court to enact permanent codes.
C. It is available only in advisory references.
D. It can override any statute whenever equity requires.

**Answer: A.** [FACT] *Prem Chand Garg* and *SCBA* supply the two hard limits.

#### OM19. Article 144

Article 144 requires:

A. all civil and judicial authorities in India to act in aid of the Supreme Court.
B. the Supreme Court to seek executive permission before contempt action.
C. Parliament to approve every Supreme Court order.
D. only subordinate courts to follow Supreme Court procedure.

**Answer: A.** [FACT] Article 144 provides the cooperation bridge for implementation.
...
B. Article 145 supports Court-made procedural rules and the five-judge constitutional minimum.
C. Article 145 fixes the Court's sanctioned strength.
D. Supreme Court Rules need approval of all High Courts.

**Answer: B.** [FACT] Strength is statutory under Article 124 architecture; procedure and Constitution Bench rules lie in Article 145.
...
A. cannot plead or act before any court or authority within India.
B. cannot hold any public office whatsoever.
C. cannot write or teach law.
D. automatically becomes a Rajya Sabha member.

**Answer: A.** [FACT] The text is a practice bar, not a complete ban on every post-retirement role.
...
B. Post-24 April 1973 insertions are reviewable for rights impact damaging basic structure.
C. Every Ninth Schedule law is immune from all review.
D. Only the President may test Ninth Schedule laws.

**Answer: B.** [FACT] Reviewability and invalidity are different stages.

#### OM24. Tribunals

After *L. Chandra Kumar*:

A. tribunal decisions remain reviewable by a High Court Division Bench under Articles 226/227.
B. only the Supreme Court can review tribunal decisions.
C. every tribunal was abolished.
D. tribunal decisions are final and immune from constitutional courts.

**Answer: A.** [FACT] Tribunals supplement but cannot supplant constitutional review.

#### OM25. PIL standing

The defining access innovation of PIL was:

A. replacement of evidence with public opinion.
B. relaxation of locus standi for representation of those unable to approach the court.
C. mandatory admission of every letter.
D. abolition of the need for a legal injury.

**Answer: B.** [FACT] Standing was relaxed, not erased; courts still screen bona fides and legal injury.
...
C. respecting institutional competence and democratic choice while still enforcing constitutional limits.
D. accepting every government claim as conclusive.

**Answer: C.** [ANALYSIS] Restraint is disciplined review, not judicial surrender.
...
B. India has parliamentary sovereignty identical to the UK.
C. the UK has no courts using precedent.
D. Indian courts may invalidate unconstitutional legislation, while UK courts ordinarily cannot invalidate a Westminster Act.

**Answer: D.** [FACT] Both systems use precedent and executive review; legal sovereignty differs.
...
B. India: collegium recommendation; USA: presidential nomination and Senate confirmation
C. Both systems constitutionally require public legislative hearings
D. India: life tenure; USA: retirement at 65

**Answer: B.** [FACT] The systems embody different independence-accountability trade-offs.
...
C. a statutory body under the Advocates Act, 1961.
D. a constitutional court under Article 129.

**Answer: C.** [FACT] State Bar Councils enrol; the BCI performs national statutory regulatory functions.

#### OM33. Current strength caution

Which statement is safe as of the package control date?

A. The Constitution permanently fixes exactly 34 judges.
B. Vacancy figures never change during a year.
C. Sanctioned and working strength are always identical.
D. The sanctioned Supreme Court strength is 34 including the CJI, but working strength should be separately verified.

**Answer: D.** [CURRENT] The sanctioned total is stable; filled positions are live data.
...
B. Pendency can be solved by dashboards without judges or case management.
C. Digital-only filing should replace every physical access channel.
D. Technology should reduce transaction costs while preserving assisted access, privacy and cybersecurity.

**Answer: D.** [ANALYSIS] Digital reform must be capacity-enhancing and inclusion-sensitive.
...
### Remedial MCQs - strict C -> C -> A -> D rotation

#### RM1. Removal terminology

Which expression is technically accurate in constitutional writing?

A. Judicial no-confidence motion
B. Removal of a Supreme Court judge under Article 124(4)
C. Presidential recall of a judge
D. Automatic impeachment after inquiry

**Answer: B.** [FACT] “Impeachment” is common usage, but the Constitution prescribes removal.
...
A. Prohibition stops a jurisdictional wrong; certiorari quashes an order already made.
B. Certiorari is always preventive and prohibition always corrective.
C. Neither can be issued to a tribunal.
D. Both writs challenge occupation of public office.

**Answer: A.** [FACT] Timing and remedial operation distinguish the pair.
...
C. is supplementary and cannot supplant substantive law.
D. overrides Fundamental Rights in exceptional cases.

**Answer: C.** [FACT] *SCBA* supplies the controlling phrase.
...
B. can be requested by any private citizen.
C. is a constitutional amendment.
D. is advisory and not binding like an ordinary judgment.

**Answer: D.** [FACT] Authoritative reasoning and binding adjudication must be distinguished.
...
B. nine judges for every review petition.
C. three judges for every constitutional petition.
D. five judges for a substantial constitutional-interpretation question or Article 143 reference.

**Answer: D.** [FACT] Five is a minimum, not a universal constitutional-case size.
...
B. Tribunal decisions remain subject to High Court constitutional review.
C. Tribunals replace High Courts entirely.
D. Article 32 can be repealed by tribunal legislation.

**Answer: B.** [FACT] Review is the basic-structure floor.

#### RM9. Ninth Schedule trap

Which statement is correct?

A. *I.R. Coelho* abolished the Ninth Schedule.
B. All pre-1973 laws were declared unconstitutional.
C. Article 31B was inserted by the 42nd Amendment.
D. Post-24 April 1973 Ninth Schedule insertions are reviewable, not automatically invalid.

**Answer: D.** [FACT] The Court applies an impact-on-basic-structure test.

#### RM10. Contempt trap

The best constitutional formulation is:

A. Article 129 confers constitutional power; statute regulates without cutting it down.
B. The 1971 Act alone creates contempt power.
C. Fair criticism is automatically contempt.
D. Truth can never be considered.

**Answer: A.** [FACT] Power, regulation and free-expression limits must be held together.
...
```text
Judicial review + Article 141 + Article 142 + contempt
                         |
                   strong legal authority
                         |
              depends on Article 144 aid
                         |
executive implementation + legislative response + public legitimacy
```
...
```text
Is a constitutional violation established?
              |
Is ordinary one-time relief inadequate?
              |
Are benchmarks clear and administrable?
              |
Are responsible institutions reporting?
              |
Can supervision taper and exit?
```
...
- Official assent opinion: `https://api.sci.gov.in/supremecourt/2025/39157/39157_2025_1_1501_66169_Judgement_20-Nov-2025.pdf`.
...
| Case | Rule |
|---|---|
| *Subhash Kumar* | Article 21 pollution-free environment |
| *M.C. Mehta* Oleum | Absolute liability |
| *Vellore Citizens* | Precaution, polluter pays, sustainable development |
| *M.C. Mehta v. Kamal Nath* | Public trust |
| *T.N. Godavarman* | Forest interpretation + continuing mandamus |
...
#### ASCII MASTER FLOW — PANEL 1/9: Apex court inside one integrated judicial hierarchy
...
#### ASCII MASTER FLOW — PANEL 2/9: Appointment power, collegium evolution and the NJAC test
...
#### ASCII MASTER FLOW — PANEL 3/9: Qualifications, tenure, removal and independence firewall
...
#### ASCII MASTER FLOW — PANEL 4/9: Jurisdiction gateway: choose the constitutional route first
...
#### ASCII MASTER FLOW — PANEL 5/9: Review, curative power, court of record and contempt
...
#### ASCII MASTER FLOW — PANEL 6/9: Precedent, complete justice, assistance and bench discipline
...
#### ASCII MASTER FLOW — PANEL 7/9: Judicial review, Basic Structure, Ninth Schedule and tribunals
...
#### ASCII MASTER FLOW — PANEL 8/9: PIL, activism, restraint and social-transformation controls
...
#### ASCII MASTER FLOW — PANEL 9/9: Comparisons, delivery deficits, traps and the Mains spine
