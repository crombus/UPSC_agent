---
title: "Administrative Tribunals — Learner-v2 Refreshed"
topic_key: polity-46
cover_image: assets/polity-46_Teaching-Navigation_2026-08-25.png
---
...
![Refreshed teaching navigation](assets/polity-46_Teaching-Navigation_2026-08-25.png)
...
> Article 323A confines service tribunals to parliamentary creation, while Article 323B permits Parliament or State legislatures to establish tribunals for specified subjects within competence.
...
```closure-flow
SUBTOPIC: Snapshot
KEY TERMS / DEFINITIONS: Snapshot · Subject · Recruitment and service conditions of public servants · Law-maker · Parliament only · Parliament or a State Legislature within its competence
...
ANSWER-GRABBING FORMULATION: Article 323A confines service tribunals to parliamentary creation, while Article 323B permits Parliament or State legislatures to establish tribunals for specified subjects within competence.
```
...
> The Administrative Tribunals Act, 1985 provides for the Central Administrative Tribunal (CAT) and enables State/Joint Administrative Tribunals.
...
![Topic-specific visual map: Core architecture.](assets/02_core_architecture.png)
```text
...
KEY TERMS / DEFINITIONS: Core architecture · SPECIALISED · FASTER FORUM · Its principal consequence · Its · The decisive contrast
...
ANSWER-GRABBING FORMULATION: The Administrative Tribunals Act, 1985 provides for the Central Administrative Tribunal (CAT) and enables State/Joint Administrative Tribunals.
```
...
> The Tribunal Reforms Act 2021 created a common framework for covered tribunals, but later judgments invalidated important appointment and tenure provisions.
...
![Topic-specific visual map: Tribunal Reforms Act, 2021.](assets/03_tribunal_reforms_act_2021.png)
...
```closure-flow
SUBTOPIC: Tribunal Reforms Act, 2021
KEY TERMS / DEFINITIONS: Tribunal Reforms Act · Current legal baseline · 19 Nov 2025 · 2025 INSC 1330 · 9 Mar 2026 · 8 Sep 2026
...
ANSWER-GRABBING FORMULATION: The Tribunal Reforms Act 2021 created a common framework for covered tribunals, but later judgments invalidated important appointment and tenure provisions.
```
...
> The 2021 tribunal rationalisation promised consolidation but risked High Court burdens, vacancies and executive control unless independent appointments and capacity followed.
...
```closure-flow
SUBTOPIC: Verified PYQ application
KEY TERMS / DEFINITIONS: Verified PYQ application · route · Verified PYQ · GS-II · Comment · 2025 GS-II Q2 (10 marks, 150 words)
...
ANSWER-GRABBING FORMULATION: The 2021 tribunal rationalisation promised consolidation but risked High Court burdens, vacancies and executive control unless independent appointments and capacity followed.
```
### SESSION 5 — TRAPS
#### DEFINITION / WHAT THIS IS CALLED
...
> Tribunal tenure, age, vacancy and pecuniary limits remain amendment- and judgment-sensitive, making undated numerical claims unreliable.
...
![Topic-specific visual map: Traps.](assets/04_traps.png)
...
```closure-flow
SUBTOPIC: Traps
KEY TERMS / DEFINITIONS: Traps · Tribunal · High Court · They · Chandra Kumar · Articles
...
ANSWER-GRABBING FORMULATION: Tribunal tenure, age, vacancy and pecuniary limits remain amendment- and judgment-sensitive, making undated numerical claims unreliable.
```
...
> Tribunal analysis must separate specialised first-instance adjudication from constitutional supervision, testing efficiency gains against independence, access and judicial-review safeguards.
...
![Topic-specific visual map: 6.1 Demand and directive map.](assets/05_6_1_demand_and_directive_map.png)
...
KEY TERMS / DEFINITIONS: Demand · directive map · Tribunals vs ordinary courts · "curtail jurisdiction", How far, Discuss · CAT's adjudicatory independence · "independent judicial authority", Explain
...
ANSWER-GRABBING FORMULATION: Tribunal analysis must separate specialised first-instance adjudication from constitutional supervision, testing efficiency gains against independence, access and judicial-review safeguards.
```
...
KEY TERMS / DEFINITIONS: Qualified thesis options · Qualified · Constitutional · Its principal consequence · Its · 6.2 Qualified thesis options
...
ANSWER-GRABBING FORMULATION: The promise of tribunals — expertise, speed and access — is delivered only when their independence is secured; the recurring constitutional litigation since 2010 shows that appointment and tenure design, not jurisdiction, is the real battleground.
```
...
> Tribunal legitimacy depends on specialised adjudication, independent appointments, adequate capacity and preserved constitutional review rather than formal creation alone.
...
![Topic-specific visual map: 6.3 Mark-scaled structures.](assets/06_6_3_mark_scaled_structures.png)
...
KEY TERMS / DEFINITIONS: Mark-scaled structures · Thesis → two anchors (Article/Act + case) → one qualification → verdict · 3 units · 5–6 units · 7–8 units + an "independence vs capacity" paragraph · 6.3 Mark-scaled structures
...
ANSWER-GRABBING FORMULATION: Tribunal legitimacy depends on specialised adjudication, independent appointments, adequate capacity and preserved constitutional review rather than formal creation alone.
```
...
> Union of India v. R. Gandhi (2010) accepted tribunalisation of company law only with qualifications, selection and tenure safeguards preserving judicial independence.
...
```closure-flow
SUBTOPIC: Bank A — Constitutional design and the judicial-review settlement
KEY TERMS / DEFINITIONS: Bank A · Constitutional design · the judicial-review settlement · Claim · Provisions · Art 323A
...
ANSWER-GRABBING FORMULATION: Union of India v. R. Gandhi (2010) accepted tribunalisation of company law only with qualifications, selection and tenure safeguards preserving judicial independence.
```
...
The decisive contrast is between Constitutional rule and Constitutional rule.
The exam-safe limitation is that constitutional rule.
![Topic-specific visual map: 6.5 Bank B — Rationalisation, reform litigation and current status.](assets/07_6_5_bank_b_rationalisation_reform_litigation_and_cur.png)
...
> Ordinary Lok Adalats require consensual settlement, whereas arbitration is contractual adjudication; neither model can be described accurately through the other's procedure.
...
```closure-flow
SUBTOPIC: Bank C — Lok Adalats versus arbitration (the ADR distinction)
KEY TERMS / DEFINITIONS: Bank C · Lok Adalats versus arbitration (the ADR distinction) · Claim · Provision · Legal Services Authorities Act, 1987 · Art 39A
...
ANSWER-GRABBING FORMULATION: Ordinary Lok Adalats require consensual settlement, whereas arbitration is contractual adjudication; neither model can be described accurately through the other's procedure.
```
...
> Because government is a major tribunal litigant, executive control over appointments, tenure and finance can compromise the independence of the forum judging it.
...
The decisive contrast is between Constitutional rule and Constitutional rule.
The exam-safe limitation is that constitutional rule.
![Topic-specific visual map: 6.7 Mechanism, institutional incentives and consequences.](assets/08_6_7_mechanism_institutional_incentives_and_consequen.png)
...
```closure-flow
SUBTOPIC: Mechanism, institutional incentives and consequences
KEY TERMS / DEFINITIONS: institutional incentives · consequences · Why tribunals were created · National Tribunals Commission logic · Constitutional · 6.7 Mechanism, institutional incentives and consequences
...
ANSWER-GRABBING FORMULATION: Because government is a major tribunal litigant, executive control over appointments, tenure and finance can compromise the independence of the forum judging it.
```
...
> Rationalisation critique: abolishing appellate tribunals can merely shift pendency to already-burdened HCs/commercial courts unless benches, staff and records follow.
...
```closure-flow
SUBTOPIC: Criticism, counter-argument, variation and implementation constraints
KEY TERMS / DEFINITIONS: Criticism · counter-argument · variation · implementation constraints · Curtailment critique · Rationalisation critique
...
ANSWER-GRABBING FORMULATION: Rationalisation critique: abolishing appellate tribunals can merely shift pendency to already-burdened HCs/commercial courts unless benches, staff and records follow.
```
...
> Tribunals may replace ordinary courts at first instance, but L. Chandra Kumar preserves High Court review as a basic-structure floor that legislation cannot remove.
...
The decisive contrast is between Constitutional rule and Constitutional rule.
The exam-safe limitation is that constitutional rule.
![Topic-specific visual map: 6.9 Verdict scaffolds.](assets/09_6_9_verdict_scaffolds.png)
...
KEY TERMS / DEFINITIONS: Verdict scaffolds · Tribunals-vs-courts verdict · CAT-independence verdict · Rationalisation verdict · ADR verdict · 6.9 Verdict scaffolds
...
ANSWER-GRABBING FORMULATION: Tribunals may replace ordinary courts at first instance, but L. Chandra Kumar preserves High Court review as a basic-structure floor that legislation cannot remove.
```
...
> Articles 323A and 323B allocate different tribunal fields, while operative statutes and binding judgments determine the current appointment and review framework.
...
KEY TERMS / DEFINITIONS: Prelims close-option distinctions · Parliament only · Parliament or State · effective · basic structure · 42nd Amendment 1976
...
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that confusion pair Correct discrimination.
ANSWER-GRABBING FORMULATION: Articles 323A and 323B allocate different tribunal fields, while operative statutes and binding judgments determine the current appointment and review framework.
```
...
![Topic-specific visual map: 6.11 Factual-risk and current-status controls.](assets/10_6_11_factual_risk_and_current_status_controls.png)
...
> Articles 323A and 323B enable tribunal legislation but do not themselves create the CAT or every subject-specific tribunal.
...
![Topic-specific visual map: Articles 323A and 323B: exact constitutional distinction.](assets/11_articles_323a_and_323b_exact_constitutional_distinct.png)
...
```closure-flow
SUBTOPIC: Articles 323A and 323B: exact constitutional distinction
KEY TERMS / DEFINITIONS: Articles 323A · exact constitutional distinction · subject · recruitment and service conditions of public servants · law-maker · 323B
...
ANSWER-GRABBING FORMULATION: Articles 323A and 323B enable tribunal legislation but do not themselves create the CAT or every subject-specific tribunal.
```
...
**Technical definition:** BOUNDARIES specified constitutional officeholders and excluded services follow the Act's exact text; criminal prosecution, ordinary civil disputes and every public-employment question do not automatically become CAT matters.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> L. Chandra Kumar preserves High Court review over tribunal decisions, but a longer appellate chain makes first-instance quality essential to efficiency.
...
**How to use them:** Frame the answer through CAT process; define exclusions, connect judicial-review chain with Article 136 to explain the mechanism, and use CAT process, exclusions and judicial-review chain for the decisive comparison or qualification.
...
![Topic-specific visual map: CAT process, exclusions and judicial-review chain.](assets/12_cat_process_exclusions_and_judicial_review_chain.png)
SERVICE GRIEVANCE
...
```closure-flow
SUBTOPIC: CAT process, exclusions and judicial-review chain
KEY TERMS / DEFINITIONS: CAT process · exclusions · judicial-review chain · Article 136 · CAT process, exclusions and judicial-review chain · CAT
...
CONSEQUENCE / CONTRAST: BOUNDARIES specified constitutional officeholders and excluded services follow the Act's exact text; criminal prosecution, ordinary civil disputes and every public-employment question do not automatically become CAT matters.
...
ANSWER-GRABBING FORMULATION: L. Chandra Kumar preserves High Court review over tribunal decisions, but a longer appellate chain makes first-instance quality essential to efficiency.
```
...
#### ASCII MASTER FLOW — PANEL 1/9: Tribunalisation: specialist justice under constitutional supervision
...
#### ASCII MASTER FLOW — PANEL 2/9: Articles 323A and 323B compared
...
#### ASCII MASTER FLOW — PANEL 3/9: CAT and SAT institutional architecture
...
#### ASCII MASTER FLOW — PANEL 5/9: L. Chandra Kumar (1997) and the correct review chain
...
#### ASCII MASTER FLOW — PANEL 6/9: Tribunal-independence doctrine across five decisions
...
#### ASCII MASTER FLOW — PANEL 7/9: Rationalisation, abolition and access-to-justice consequences
...
#### ASCII MASTER FLOW — PANEL 8/9: CAT, courts, commissions and ADR distinguished
...
#### ASCII MASTER FLOW — PANEL 9/9: UPSC synthesis and reform architecture
