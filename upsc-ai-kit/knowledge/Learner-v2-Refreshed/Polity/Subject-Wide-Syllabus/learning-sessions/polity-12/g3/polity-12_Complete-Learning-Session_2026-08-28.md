...
**Plain-language definition:** Core thesis: Federalism is not measured by the weakness of the Union; it is measured by whether regional autonomy has constitutional, judicial and political protection.

**Technical definition:** The essence is constitutionally protected autonomy plus mechanisms of shared rule.
...
- **Meaning**
- **constitutionally protected autonomy plus mechanisms of shared rule**
- **Core thesis**
- **Source of regional power**
- **Constitution**
- **Central law/devolution**

**How to use them:** Frame the answer through Meaning; define constitutionally protected autonomy plus mechanisms of shared rule, connect Core thesis with Source of regional power to explain the mechanism, and use Constitution for the decisive comparison or qualification.
...
START / CONCEPT: Meaning: what makes a political system federal?
        |
        v
EXACT TERMS: Meaning · constitutionally protected autonomy plus mechanisms of shared rule · Core thesis · Source of regional power · Constitution · Central law/devolution
        |
        v
MECHANISM / ARGUMENT: The essence is constitutionally protected autonomy plus mechanisms of shared rule.
        |
        v
CONSEQUENCE / CONTRAST: A federation is not a confederation.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: in a federation, the Constitution creates one sovereign legal order.
        |
        v
ANSWER-GRABBING FORMULATION: Core thesis: Federalism is not measured by the weakness of the Union; it is measured by whether regional autonomy has constitutional, judicial and political protection.
```
### SESSION 2 — FORMATION: COMING TOGETHER AND HOLDING TOGETHER

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** India is best classified as a holding-together federation with a strong Union: federal distribution was chosen to govern diversity without creating a secession-based compact.

**Technical definition:** Article 1 calls India a Union of States, not a federation formed by an agreement among sovereign States.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 1 calls India a Union of States, not a federation formed by an agreement among sovereign States.
...
- **holding together**
- **Union of States**
- **holding-together federation with a strong Union**
- **Previously sovereign units pool authority**

**How to use them:** Frame the answer through Formation; define coming together, connect holding together with Union of States to explain the mechanism, and use holding-together federation with a strong Union for the decisive comparison or qualification.
...
START / CONCEPT: Formation: coming together and holding together
        |
        v
EXACT TERMS: Formation · coming together · holding together · Union of States · holding-together federation with a strong Union · Previously sovereign units pool authority
        |
        v
MECHANISM / ARGUMENT: Parliament may alter State areas, boundaries or names under Articles 2-4 through the constitutionally prescribed process; affected State views are sought but are not binding.
        |
        v
CONSEQUENCE / CONTRAST: “Indestructible Union of destructible States” is a useful summary, not constitutional text.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: india is best classified as a holding-together federation with a strong Union.
        |
        v
ANSWER-GRABBING FORMULATION: Article 1 calls India a Union of States, not a federation formed by an agreement among sovereign States.
```
### SESSION 3 — SEVEN FEDERAL FEATURES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Written Constitution: allocation and limits are available in an authoritative text.

**Technical definition:** Constitutional supremacy: Union and States are limited by the Constitution.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Written Constitution: allocation and limits are available in an authoritative text.
...
- **Rigidity in federal provisions**

**How to use them:** Frame the answer through Seven federal features; define Dual polity, connect Written Constitution with Division of powers to explain the mechanism, and use Constitutional supremacy for the decisive comparison or qualification.
...
START / CONCEPT: Seven federal features
        |
        v
EXACT TERMS: Seven federal features · Dual polity · Written Constitution · Division of powers · Constitutional supremacy · Rigidity in federal provisions
        |
        v
MECHANISM / ARGUMENT: Constitutional supremacy: Union and States are limited by the Constitution.
        |
        v
CONSEQUENCE / CONTRAST: Rajya Sabha representation is broadly population-weighted, not equal for every State as in the US Senate.
        |
        v
UPSC TRAP / ANSWER-USE: State autonomy is protected but not sovereign; Parliament has constitutionally enumerated routes into the State field.
        |
        v
ANSWER-GRABBING FORMULATION: Written Constitution: allocation and limits are available in an authoritative text.
```
### SESSION 4 — CENTRALISING FEATURES: WHY INDIA IS FEDERAL WITH A UNION BIAS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** These do not cancel federalism because each centralising power is itself constitutional, reviewable and politically contested.

**Technical definition:** Technically, Centralising features: why India is federal with a Union bias is analysed by relating Centralising features to Power, then testing the relationship through National coordination capacity and Residuary legislative power with Parliament.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> These do not cancel federalism because each centralising power is itself constitutional, reviewable and politically contested.
...
- **Residuary legislative power with Parliament**
- **Article 248 + Union Entry 97**
- **Territory**

**How to use them:** Frame the answer through Centralising features; define Power, connect National coordination capacity with Residuary legislative power with Parliament to explain the mechanism, and use Article 248 + Union Entry 97 for the decisive comparison or qualification.
...
START / CONCEPT: Centralising features: why India is federal with a Union bias
        |
        v
EXACT TERMS: Centralising features · Power · National coordination capacity · Residuary legislative power with Parliament · Article 248 + Union Entry 97 · Territory
        |
        v
MECHANISM / ARGUMENT: Do not call the Governor merely the “Centre's agent.” That phrase describes a misuse critique; the office is constitutionally the State's head.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that these do not cancel federalism because each centralising power is itself constitutional, reviewable and...
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: these do not cancel federalism because each centralising power is itself constitutional, reviewable and...
        |
        v
ANSWER-GRABBING FORMULATION: These do not cancel federalism because each centralising power is itself constitutional, reviewable and politically contested.
```
### SESSION 5 — LEGISLATIVE DISTRIBUTION: ARTICLES 245-255 AND THE SEVENTH SCHEDULE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 254 is not a universal conflict clause for every Union-State disagreement; it is principally a Concurrent List doctrine.

**Technical definition:** Article 246A separately creates special GST competence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 254 is not a universal conflict clause for every Union-State disagreement; it is principally a Concurrent List doctrine.
...
- **Defence, foreign affairs, currency, atomic energy**

**How to use them:** Frame the answer through Legislative distribution; define Articles 245-255, connect the Seventh Schedule with Union List to explain the mechanism, and use Parliament exclusive for the decisive comparison or qualification.
...
START / CONCEPT: Legislative distribution: Articles 245-255 and the Seventh Schedule
        |
        v
EXACT TERMS: Legislative distribution · Articles 245-255 · the Seventh Schedule · Union List · Parliament exclusive · Defence, foreign affairs, currency, atomic energy
        |
        v
MECHANISM / ARGUMENT: Article 246A separately creates special GST competence.
        |
        v
CONSEQUENCE / CONTRAST: Parliamentary law is not invalid merely for extra-territorial operation, though a real constitutional nexus is required.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: this explains why a literal visual count may differ from the standard subject count.
        |
        v
ANSWER-GRABBING FORMULATION: Article 254 is not a universal conflict clause for every Union-State disagreement; it is principally a Concurrent List doctrine.
```
### SESSION 6 — WHEN PARLIAMENT MAY LEGISLATE ON THE STATE LIST

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Articles 249 and 252 contain federal safeguards: the first uses the States' chamber; the second starts with State initiative.

**Technical definition:** Article 253 is powerful but remains subject to constitutional rights, judicial review and the actual treaty-implementation nexus.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Articles 249 and 252 contain federal safeguards: the first uses the States' chamber; the second starts with State initiative.

#### MUST-WRITE KEYWORDS

- **When Parliament may legislate on the State List**
- **Article 249**
- **Article 250**
- **Proclamation of Emergency in operation**
- **Law survives six months after Emergency ends**
- **Article 252**

**How to use them:** Frame the answer through When Parliament may legislate on the State List; define Article 249, connect Article 250 with Proclamation of Emergency in operation to explain the mechanism, and use Law survives six months after Emergency ends for the decisive comparison or qualification.
...
START / CONCEPT: When Parliament may legislate on the State List
        |
        v
EXACT TERMS: When Parliament may legislate on the State List · Article 249 · Article 250 · Proclamation of Emergency in operation · Law survives six months after Emergency ends · Article 252
        |
        v
MECHANISM / ARGUMENT: Article 253 is powerful but remains subject to constitutional rights, judicial review and the actual treaty-implementation nexus.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that article 253 is powerful but remains subject to constitutional rights, judicial review and the...
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: article 253 is powerful but remains subject to constitutional rights, judicial review and the...
        |
        v
ANSWER-GRABBING FORMULATION: Articles 249 and 252 contain federal safeguards: the first uses the States' chamber; the second starts with State initiative.
```
### SESSION 7 — A. ADMINISTRATIVE AND FINANCIAL DISTRIBUTION: THE MISSING OPERATIONAL BRIDGE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Answer-grabbing line: Indian federalism distributes not only law-making subjects but also administrative responsibility and usable fiscal capacity; autonomy without implementation machinery or predictable finance is merely formal.

**Technical definition:** Article 356 requires the President to be satisfied that State government cannot be carried on according to the Constitution; Article 357 governs exercise of legislative powers under such a proclamation.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Answer-grabbing line: Indian federalism distributes not only law-making subjects but also administrative responsibility and usable fiscal capacity; autonomy without implementation machinery or predictable finance is merely formal.

#### MUST-WRITE KEYWORDS

- **A. Administrative**
- **financial distribution**
- **the missing operational bridge**
- **grabbing line**
- **Article 256**
- **Article 257**

**How to use them:** Frame the answer through A. Administrative; define financial distribution, connect the missing operational bridge with grabbing line to explain the mechanism, and use Article 256 for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — A. ADMINISTRATIVE AND FINANCIAL DISTRIBUTION: THE MISSING OPERATIONAL BRIDGE

```text
START / CONCEPT: A. Administrative and financial distribution: the missing operational bridge
        |
        v
EXACT TERMS: A. Administrative · financial distribution · the missing operational bridge · grabbing line · Article 256 · Article 257
        |
        v
MECHANISM / ARGUMENT: Bommai subjects a proclamation to judicial review and permits restoration; House majority should ordinarily be tested on the floor rather than inferred by the Governor.
        |
        v
CONSEQUENCE / CONTRAST: Article 355 is not a free-standing licence for every coercive measure, and a difficulty under Article 355 does not automatically establish the Article 356 threshold.
        |
        v
UPSC TRAP / ANSWER-USE: Article 356 requires the President to be satisfied that State government cannot be carried on according to the Constitution; Article 357 governs exercise of legislative powers under such a proclamation.
        |
        v
ANSWER-GRABBING FORMULATION: Answer-grabbing line: Indian federalism distributes not only law-making subjects but also administrative responsibility and usable fiscal capacity; autonomy without implementation machinery or predictable finance is merely formal.
```
### SESSION 8 — FEDERALISM AS BASIC STRUCTURE: CASE CHRONOLOGY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Federalism as Basic Structure: case chronology comprises Federalism as Basic Structure, case chronology and Strong-Union description did not erase all State autonomy as its core connected dimensions.

**Technical definition:** Converts federalism from description into a constitutional limitation.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Shows that a strong Union remains bounded by constitutional federalism.

#### MUST-WRITE KEYWORDS

- **Federalism as Basic Structure**
- **case chronology**
- **Strong-Union description did not erase all State autonomy**
- **Kesavananda Bharati (1973)**
- **Federalism later becomes a named component**
- **Predates Bommai's stronger review framework**

**How to use them:** Frame the answer through Federalism as Basic Structure; define case chronology, connect Strong-Union description did not erase all State autonomy with Kesavananda Bharati (1973) to explain the mechanism, and use Federalism later becomes a named component for the decisive comparison or qualification.
...
START / CONCEPT: Federalism as Basic Structure: case chronology
        |
        v
EXACT TERMS: Federalism as Basic Structure · case chronology · Strong-Union description did not erase all State autonomy · Kesavananda Bharati (1973) · Federalism later becomes a named component · Predates Bommai's stronger review framework
        |
        v
MECHANISM / ARGUMENT: Converts federalism from description into a constitutional limitation.
        |
        v
CONSEQUENCE / CONTRAST: Supports floor tests where majority is disputed.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: allows restoration after an unconstitutional proclamation.
        |
        v
ANSWER-GRABBING FORMULATION: Shows that a strong Union remains bounded by constitutional federalism.
```
### SESSION 9 — HOW INDIAN FEDERALISM ACTUALLY WORKS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Indian federalism is not moving linearly from cooperation to confrontation.

**Technical definition:** Granville Austin's “cooperative federalism” identifies design aspiration; Morris-Jones's “bargaining federalism” better captures negotiated operation.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Indian federalism is not moving linearly from cooperation to confrontation.

#### MUST-WRITE KEYWORDS

- **How Indian federalism actually works**
- **Cooperative**
- **Joint rule-making or implementation**
- **GST Council, disaster response, centrally supported schemes**
- **Competitive**
- **States compete on outcomes and investment**

**How to use them:** Frame the answer through How Indian federalism actually works; define Cooperative, connect Joint rule-making or implementation with GST Council, disaster response, centrally supported schemes to explain the mechanism, and use Competitive for the decisive comparison or qualification.
...
START / CONCEPT: How Indian federalism actually works
        |
        v
EXACT TERMS: How Indian federalism actually works · Cooperative · Joint rule-making or implementation · GST Council, disaster response, centrally supported schemes · Competitive · States compete on outcomes and investment
        |
        v
MECHANISM / ARGUMENT: The health test is whether institutions convert confrontation into reasons, negotiation, adjudication and electoral accountability.
        |
        v
CONSEQUENCE / CONTRAST: Granville Austin's “cooperative federalism” identifies design aspiration; Morris-Jones's “bargaining federalism” better captures negotiated operation.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: indian federalism is not moving linearly from cooperation to confrontation.
        |
        v
ANSWER-GRABBING FORMULATION: Indian federalism is not moving linearly from cooperation to confrontation.
```
### SESSION 10 — INSTITUTIONS OF SHARED RULE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** GST Council recommendations are not binding commands on Parliament or State legislatures.

**Technical definition:** Article 246A gives simultaneous GST legislative power within its scheme. [CURRENT] The official GST Council continues to describe consultation and cooperative federalism as its operating aspiration; the 56th meeting was held in September 2025.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> GST Council recommendations are not binding commands on Parliament or State legislatures.

#### MUST-WRITE KEYWORDS

- **Institutions of shared rule**
- **Inter-State Council**
- **Article 263; established by presidential order**
- **Inquiry, discussion and recommendations on common interests**
- **Zonal Councils**
- **States Reorganisation Act, 1956**

**How to use them:** Frame the answer through Institutions of shared rule; define Inter-State Council, connect Article 263; established by presidential order with Inquiry, discussion and recommendations on common interests to explain the mechanism, and use Zonal Councils for the decisive comparison or qualification.
...
START / CONCEPT: Institutions of shared rule
        |
        v
EXACT TERMS: Institutions of shared rule · Inter-State Council · Article 263; established by presidential order · Inquiry, discussion and recommendations on common interests · Zonal Councils · States Reorganisation Act, 1956
        |
        v
MECHANISM / ARGUMENT: The Council works through political persuasion, structured voting and the need for harmonisation: cooperative federalism is dialogic, not hierarchical.
        |
        v
CONSEQUENCE / CONTRAST: This is a dated institutional illustration, not proof that every decision is unanimous or binding.
        |
        v
UPSC TRAP / ANSWER-USE: “Not binding” does not mean irrelevant; departure can create political, administrative and market costs.
        |
        v
ANSWER-GRABBING FORMULATION: GST Council recommendations are not binding commands on Parliament or State legislatures.
```
### SESSION 11 — ASYMMETRIC FEDERALISM

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Asymmetric federalism comprises Tribal areas in Assam, Meghalaya, Tripura and Mizoram, Governor and Tribes Advisory Council architecture and Autonomous District and Regional Councils as its core connected dimensions.

**Technical definition:** [CURRENT] The post-2019 constitutional and territorial arrangement must be described through current law, not the former Article 370 framework as if still operational.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The full legal chronology and Supreme Court decision belong to the dedicated Jammu and Kashmir topic; here it illustrates that territorial and asymmetric design can be constitutionally reconfigured and contested.

#### MUST-WRITE KEYWORDS

- **Asymmetric federalism**
- **Tribal areas in Assam, Meghalaya, Tripura and Mizoram**
- **Governor and Tribes Advisory Council architecture**
- **Autonomous District and Regional Councils**
- **Protective administration and modification of law**
- **Greater local legislative, judicial and administrative space**

**How to use them:** Frame the answer through Asymmetric federalism; define Tribal areas in Assam, Meghalaya, Tripura and Mizoram, connect Governor and Tribes Advisory Council architecture with Autonomous District and Regional Councils to explain the mechanism, and use Protective administration and modification of law for the decisive comparison or qualification.
...
START / CONCEPT: Asymmetric federalism
        |
        v
EXACT TERMS: Asymmetric federalism · Tribal areas in Assam, Meghalaya, Tripura and Mizoram · Governor and Tribes Advisory Council architecture · Autonomous District and Regional Councils · Protective administration and modification of law · Greater local legislative, judicial and administrative space
        |
        v
MECHANISM / ARGUMENT: [CURRENT] The post-2019 constitutional and territorial arrangement must be described through current law, not the former Article 370 framework as if still operational.
        |
        v
CONSEQUENCE / CONTRAST: Asymmetry is an integration device: it permits common citizenship while protecting distinct institutions, land relations, customary practices or administrative needs.
        |
        v
UPSC TRAP / ANSWER-USE: Asymmetry is not the same as arbitrary discrimination.
        |
        v
ANSWER-GRABBING FORMULATION: The full legal chronology and Supreme Court decision belong to the dedicated Jammu and Kashmir topic; here it illustrates that territorial and asymmetric design can be constitutionally reconfigured and contested.
```
### SESSION 12 — FISCAL FEDERALISM

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Fiscal federalism comprises equalisation, performance and political legitimacy, Tax assignment and 17 November 2025 as its core connected dimensions.

**Technical definition:** Technically, Fiscal federalism is analysed by relating equalisation, performance and political legitimacy to Tax assignment, then testing the relationship through 17 November 2025 and 2026-27 to 2030-31.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The detailed weights and grant architecture belong to Polity 29; in this chapter use the award to show that fiscal federalism balances equalisation, performance and political legitimacy.

#### MUST-WRITE KEYWORDS

- **Fiscal federalism**
- **equalisation, performance and political legitimacy**
- **Tax assignment**
- **17 November 2025**
- **2026-27 to 2030-31**
- **41% of the divisible pool**

**How to use them:** Frame the answer through Fiscal federalism; define equalisation, performance and political legitimacy, connect Tax assignment with 17 November 2025 to explain the mechanism, and use 2026-27 to 2030-31 for the decisive comparison or qualification.
...
START / CONCEPT: Fiscal federalism
        |
        v
EXACT TERMS: Fiscal federalism · equalisation, performance and political legitimacy · Tax assignment · 17 November 2025 · 2026-27 to 2030-31 · 41% of the divisible pool
        |
        v
MECHANISM / ARGUMENT: Transfers are therefore not charity; they are a structural feature of the constitutional division of revenue and responsibility.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that the detailed weights and grant architecture belong to Polity 29.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the detailed weights and grant architecture belong to Polity 29.
        |
        v
ANSWER-GRABBING FORMULATION: The detailed weights and grant architecture belong to Polity 29; in this chapter use the award to show that fiscal federalism balances equalisation, performance and political legitimacy.
```
### SESSION 13 — REPRESENTATIONAL FEDERALISM AND DELIMITATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** [CURRENT] The Constitution (131st Amendment) Bill, 2026 and connected delimitation Bills were introduced on 16 April 2026 and the constitutional Bill was defeated on 17 April 2026, receiving 298 votes in favour and 230 against, short of the special-majority requirement.

**Technical definition:** No delimitation date, State-wise seat projection or election date for operational women's reservation should be asserted.
...
- **16 April 2026**
- **17 April 2026**
- **298 votes in favour and 230 against**

**How to use them:** Frame the answer through Representational federalism; define delimitation, connect Democratic equality with 16 April 2026 to explain the mechanism, and use 17 April 2026 for the decisive comparison or qualification.
...
START / CONCEPT: Representational federalism and delimitation
        |
        v
EXACT TERMS: Representational federalism · delimitation · Democratic equality · 16 April 2026 · 17 April 2026 · 298 votes in favour and 230 against
        |
        v
MECHANISM / ARGUMENT: Lok Sabha seat allocation and constituency readjustment are governed by Articles 81 and 82, subject to constitutional freeze provisions.
        |
        v
CONSEQUENCE / CONTRAST: Women's representation: Article 334A creates a census-delimitation sequence; commencement is not the same as operational reservation.
        |
        v
UPSC TRAP / ANSWER-USE: Rajya Sabha represents States but not equally; Fourth Schedule allocation broadly reflects population.
        |
        v
ANSWER-GRABBING FORMULATION: [CURRENT] The Constitution (131st Amendment) Bill, 2026 and connected delimitation Bills were introduced on 16 April 2026 and the constitutional Bill was defeated on 17 April 2026, receiving 298 votes in favour and 230 against, short of the special-majority requirement.
```
### SESSION 14 — CURRENT FEDERAL-FRICTION CONTROLS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Best conclusion: India is neither administratively unitary nor a compact federation.

**Technical definition:** Technically, Current federal-friction controls is analysed by relating not to Best conclusion, then testing the relationship through Irregular consultation and Shared rule.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Do not use the superseded April 2025 timeline/deemed-assent position as current law.

#### MUST-WRITE KEYWORDS

- **Current federal-friction controls**
- **not**
- **Best conclusion**
- **Irregular consultation**
- **Shared rule**
- **Governor conflict**

**How to use them:** Frame the answer through Current federal-friction controls; define not, connect Best conclusion with Irregular consultation to explain the mechanism, and use Shared rule for the decisive comparison or qualification.
...
START / CONCEPT: Current federal-friction controls
        |
        v
EXACT TERMS: Current federal-friction controls · not · Best conclusion · Irregular consultation · Shared rule · Governor conflict
        |
        v
MECHANISM / ARGUMENT: The controversy demonstrates confrontational federalism through courts rather than extra-constitutional resistance.
        |
        v
CONSEQUENCE / CONTRAST: Best conclusion: India is neither administratively unitary nor a compact federation.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: prolonged unexplained inaction can attract limited judicial intervention directing the authority to act, without...
        |
        v
ANSWER-GRABBING FORMULATION: Do not use the superseded April 2025 timeline/deemed-assent position as current law.
```
