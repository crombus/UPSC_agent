---
title: "Directive Principles — Learner-v2 Refreshed"
topic_key: polity-08
cover_image: assets/polity-08_Teaching-Navigation_2026-08-24.png
---
# Directive Principles — Complete Uncompressed Learning Session
...
- [CURRENT] Legal status is controlled to **24 August 2026, Asia/Kolkata**. This package states only securely verified current positions and marks unsettled or time-sensitive matters.

- [CURRENT] **Six-month live audit, accessed 24 August 2026:** the official NALSA homepage continues to describe NALSA as the Legal Services Authorities Act, 1987 institution for free legal services to weaker sections and for Lok Adalats. It lists the serving Chief Justice of India as Patron-in-Chief and Justice Vikram Nath as Executive Chairman. This is used only as a current Article 39A institutional anchor; it does not alter the constitutional doctrine or statutory eligibility rules.
- [LIMIT] No later controlling official judgment or legislative change to Article 31C, Part IV or the statutory legal-services architecture was located in the 24 February-24 August 2026 audit window. The January 2026 Uttarakhand UCC Ordinance remains near-window context, not the six-month anchor.
...
| FR-DPSP harmony | *Champakam* to *Property Owners*; Article 31C | Replaces crude hierarchy with the current position |
...
![Refreshed teaching navigation](assets/polity-08_Teaching-Navigation_2026-08-24.png)

*Distinct embedded teaching-navigation image. The separate continuous Cārvāka-style flowchart package remains an independent at-a-glance artifact.*

### SESSION 1 — PART IV AS CONSTITUTIONAL ARCHITECTURE
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Part IV as constitutional architecture comprises Directive Principles of State Policy, Conscience of the Constitution and Order, security and revenue dominate as its core connected dimensions.

**Technical definition:** In Part IV, State has the same meaning as in Part III.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Part IV directs the same State restrained by Fundamental Rights toward welfare goals, linking limited government with social transformation.

#### MUST-WRITE KEYWORDS

- **Part IV as constitutional architecture**
- **Directive Principles of State Policy**
- **Conscience of the Constitution**
- **Order, security and revenue dominate**
- **Justice, capability, dignity and distribution become constitutional goals**
- **Government mainly restrains wrongdoing**

**How to use them:** Frame the answer through Part IV as constitutional architecture; define Directive Principles of State Policy, connect Conscience of the Constitution with Order, security and revenue dominate to explain the mechanism, and use Justice, capability, dignity and distribution become constitutional goals for the decisive comparison or qualification.

![Part IV moves from the Article 36 definition of State through substantive directives and Article 37 duty to legislation, institutions, political accountability and limited judicial effects.](assets/01_part_iv_architecture.png)
...
#### CLOSING RECALL FLOW — PART IV AS CONSTITUTIONAL ARCHITECTURE

```closure-flow
SUBTOPIC: Part IV as constitutional architecture
KEY TERMS / DEFINITIONS: Part IV as constitutional architecture · Directive Principles of State Policy · Conscience of the Constitution · Order, security and revenue dominate · Justice, capability, dignity and distribution become constitutional goals · Government mainly restrains wrongdoing
MECHANISM / ARGUMENT: In Part IV, State has the same meaning as in Part III.
CONSEQUENCE / CONTRAST: A welfare-state directive does not itself create an unlimited judicially enforceable benefit.
UPSC TRAP / ANSWER-USE: The directives are not a miscellaneous wish list.
ANSWER-GRABBING FORMULATION: Part IV directs the same State restrained by Fundamental Rights toward welfare goals, linking limited government with social transformation.
```
### SESSION 2 — ARTICLE 37: NON-JUSTICIABILITY, DUTY AND POLITICAL SANCTION
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 37: non-justiciability, duty and political sanction comprises Article 37, non-justiciability and duty as its core connected dimensions.

**Technical definition:** Article 37 converts flexibility into responsibility by retaining a constitutional duty and electoral sanction.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 37 makes Directive Principles non-justiciable but fundamental in governance, converting them from enforceable claims into legislative duties and political standards.
...
**How to use them:** Frame the answer through Article 37; define non-justiciability, connect duty with political sanction to explain the mechanism, and use shall not be enforceable by any court for the decisive comparison or qualification.

![Article 37 creates a force chain from non-enforceability to State duty, political sanction, interpretation and the narrow Article 31C shield.](assets/03_article_37_force_chain.png)
...
#### CLOSING RECALL FLOW — ARTICLE 37: NON-JUSTICIABILITY, DUTY AND POLITICAL SANCTION

```closure-flow
SUBTOPIC: Article 37: non-justiciability, duty and political sanction
KEY TERMS / DEFINITIONS: Article 37 · non-justiciability · duty · political sanction · shall not be enforceable by any court · fundamental in the governance of the country
MECHANISM / ARGUMENT: Article 37 converts flexibility into responsibility by retaining a constitutional duty and electoral sanction.
CONSEQUENCE / CONTRAST: A person cannot ordinarily obtain a writ merely because the State has not fully implemented Article 41, 44 or 47.
UPSC TRAP / ANSWER-USE: "Non-justiciable" is a rule about the remedy; it is not a verdict that the principle lacks constitutional status.
ANSWER-GRABBING FORMULATION: Article 37 makes Directive Principles non-justiciable but fundamental in governance, converting them from enforceable claims into legislative duties and political standards.
```
### SESSION 3 — COMPLETE ARTICLE-BY-ARTICLE COVERAGE: ARTICLES 38 TO 43B
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Articles 38 to 43B form the first welfare cluster of Part IV, covering justice, distribution, legal aid, village self-government, social security, humane work, living wages, worker participation and co-operatives.

**Technical definition:** The Articles 38 to 43B cluster directs distributive justice through Articles 38 and 39, access and decentralisation through Articles 39A and 40, and socio-economic security and participation through Articles 41 to 43B.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Articles 38 to 43B convert the Constitution's welfare commitment into linked directives on distributive justice, access to justice, local self-government, labour dignity, social security and democratic economic organisation.
...
**How to use them:** Define Articles 38 to 43B as a welfare map; contrast Article 39(b) resource distribution with Article 39(c) anti-concentration, then connect Article 39A, Article 41 and Article 43B to institutions and implementation limits.
...
| 43B | Promote voluntary formation, autonomous functioning, democratic control and professional management of co-operative societies | Added by the 97th Amendment; remains valid after *Rajendra N. Shah* |
...
> **Memory rule:** **L-R-C-P-H-C** = Livelihood -> Resources -> Concentration -> Pay -> Health -> Children.

#### CLOSING RECALL FLOW — COMPLETE ARTICLE-BY-ARTICLE COVERAGE: ARTICLES 38 TO 43B

```closure-flow
SUBTOPIC: Complete article-by-article coverage: Articles 38 to 43B
KEY TERMS / DEFINITIONS: Articles 38 to 43B · Article 39(b) · Article 39(c) · Article 39A · Article 41 · Article 43B
MECHANISM / ARGUMENT: The cluster moves from broad welfare and distribution to legal aid and panchayats, then to capacity-qualified social security, labour protection, living wages, worker participation and co-operative autonomy.
CONSEQUENCE / CONTRAST: Read together, these Articles require positive State action but leave the choice of legislation, expenditure and administrative sequencing subject to constitutional competence and capacity.
UPSC TRAP / ANSWER-USE: Do not treat Article 39(b) and Article 39(c) as synonyms, omit Article 41's economic-capacity qualifier, or claim that Article 43B makes every co-operative rule judicially enforceable.
ANSWER-GRABBING FORMULATION: Articles 38 to 43B convert the Constitution's welfare commitment into linked directives on distributive justice, access to justice, local self-government, labour dignity, social security and democratic economic organisation.
```
### SESSION 4 — COMPLETE ARTICLE-BY-ARTICLE COVERAGE: ARTICLES 44 TO 51
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Articles 44 to 51 form Part IV's second cluster, directing civil-law reform, early-childhood care, protection of weaker sections, public health, scientific agriculture, environmental and heritage protection, judicial independence and international peace.

**Technical definition:** The Articles 44 to 51 cluster links social capability and reform with ecological stewardship, institutional separation under Article 50 and the four international commitments contained in Article 51.
...
**How to use them:** Use Article 44 for civil reform, Article 45 and Article 46 for capability and weaker-section protection, Article 48A for ecology, Article 50 for judicial independence and Article 51 for international peace and law.
...
#### CLOSING RECALL FLOW — COMPLETE ARTICLE-BY-ARTICLE COVERAGE: ARTICLES 44 TO 51

```closure-flow
SUBTOPIC: Complete article-by-article coverage: Articles 44 to 51
KEY TERMS / DEFINITIONS: Article 44 · Article 45 · Article 46 · Article 48A · Article 50 · Article 51
MECHANISM / ARGUMENT: This cluster directs legislation and administration across personal law, child development, public health, agriculture, environment, heritage, judicial organisation and foreign relations.
CONSEQUENCE / CONTRAST: Its breadth shows that constitutional welfare includes equal civil status, human capability, ecological security, impartial institutions and responsible international conduct.
UPSC TRAP / ANSWER-USE: Do not place Article 51A duties in Part IV, reduce Article 51 to one peace clause, or ignore the Parliamentary-law qualification governing Article 49.
ANSWER-GRABBING FORMULATION: Article 49 is not a generic culture clause; it protects nationally important monuments, places and objects within the Parliamentary-law framework.
```
### SESSION 5 — CLASSIFICATION: USEFUL SCHOLARSHIP, NOT CONSTITUTIONAL TEXT
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 43 is socialistic for living wage and Gandhian for rural cottage industries.

**Technical definition:** Article 47 is socialistic for nutrition/public health and Gandhian for prohibition.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The socialistic, Gandhian and liberal-intellectual grouping aids revision, but overlapping provisions show that it is scholarly classification rather than constitutional text.
...
- **not**
- **Socialistic**
- **Social-economic justice, labour protection, welfare and redistribution**
- **Gandhian**

**How to use them:** Frame the answer through useful scholarship; define not constitutional text, connect not with Socialistic to explain the mechanism, and use Social-economic justice, labour protection, welfare and redistribution for the decisive comparison or qualification.

![The Socialistic, Gandhian and Liberal-intellectual labels are scholarly study aids; several Articles overlap honestly.](assets/02_article_category_matrix.png)
...
#### CLOSING RECALL FLOW — CLASSIFICATION: USEFUL SCHOLARSHIP, NOT CONSTITUTIONAL TEXT

```closure-flow
SUBTOPIC: Classification: useful scholarship, not constitutional text
KEY TERMS / DEFINITIONS: useful scholarship · not constitutional text · not · Socialistic · Social-economic justice, labour protection, welfare and redistribution · Gandhian
MECHANISM / ARGUMENT: Article 47 is socialistic for nutrition/public health and Gandhian for prohibition.
CONSEQUENCE / CONTRAST: The Constitution itself does not classify DPSP into three categories.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: article 48 is liberal-intellectual for scientific agriculture/animal husbandry and Gandhian for cattle protection.
ANSWER-GRABBING FORMULATION: The socialistic, Gandhian and liberal-intellectual grouping aids revision, but overlapping provisions show that it is scholarly classification rather than constitutional text.
```
### SESSION 6 — AMENDMENTS THAT CHANGED PART IV
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Part IXB invalid/inoperative for State co-operative societies; Part IXB operative for multi-State co-operative societies; Article 43B and the amendment to Article 19(1)(c) were not struck down.

**Technical definition:** The case demonstrates that implementing a DPSP cannot bypass federal amendment procedure.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The 97th Amendment's Part IXB altered that State legislative field without the ratification required by the proviso to Article 368(2).

#### MUST-WRITE KEYWORDS

- **Amendments that changed Part IV**
- **Not merely "income inequality"**
- **42nd Amendment, 1976**
- **44th Amendment, 1978**
- **86th Amendment, 2002**
- **97th Amendment, 2011**

**How to use them:** Frame the answer through Amendments that changed Part IV; define Not merely "income inequality", connect 42nd Amendment, 1976 with 44th Amendment, 1978 to explain the mechanism, and use 86th Amendment, 2002 for the decisive comparison or qualification.

![The 42nd, 44th, 86th and 97th Amendments expanded or restructured the Directive Principles.](assets/04_amendments_timeline.png)
...
| 97th Amendment, 2011 | Inserted Article 43B and Part IXB; expanded Article 19(1)(c) to co-operative societies | *Rajendra N. Shah* severed the invalid State-co-operative operation of Part IXB; Article 43B remains |
...
#### CLOSING RECALL FLOW — AMENDMENTS THAT CHANGED PART IV

```closure-flow
SUBTOPIC: Amendments that changed Part IV
KEY TERMS / DEFINITIONS: Amendments that changed Part IV · Not merely "income inequality" · 42nd Amendment, 1976 · 44th Amendment, 1978 · 86th Amendment, 2002 · 97th Amendment, 2011
MECHANISM / ARGUMENT: The case demonstrates that implementing a DPSP cannot bypass federal amendment procedure.
CONSEQUENCE / CONTRAST: Welfare purpose does not erase structural limits.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: part IXB invalid/inoperative for State co-operative societies.
ANSWER-GRABBING FORMULATION: The 97th Amendment's Part IXB altered that State legislative field without the ratification required by the proviso to Article 368(2).
```
### SESSION 7 — FUNDAMENTAL RIGHTS-DPSP CHRONOLOGY: CONFLICT TO HARMONY
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Fundamental Rights and DPSP are complementary constitutional commitments.

**Technical definition:** Technically, Fundamental Rights-DPSP chronology: conflict to harmony is analysed by relating Fundamental Rights-DPSP chronology to conflict to harmony, then testing the relationship through Do not write and Champakam Dorairajan (1951).

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Parliament may amend rights and legislate to implement Part IV, but the basic structure - including judicial review and harmony between Parts III and IV - limits that power.

#### MUST-WRITE KEYWORDS

- **Fundamental Rights-DPSP chronology**
- **conflict to harmony**
- **Do not write**
...
**How to use them:** Frame the answer through Fundamental Rights-DPSP chronology; define conflict to harmony, connect Do not write with Champakam Dorairajan (1951) to explain the mechanism, and use First Amendment (1951) for the decisive comparison or qualification.

![The chronology moves from Champakam's priority rule to Minerva Mills harmony, rights conversion through education and the 2024 Article 31C clarification.](assets/05_fr_dpsp_case_timeline.png)

| Stage | Constitutional development | Exact significance |
|---|---|---|
| *Champakam Dorairajan* (1951) | Communal reservation order could not override Article 29(2) by relying on Article 46 | FR prevailed in direct conflict; led to the First Amendment and Article 15(4) |
...
| *Golaknath* (1967) | Parliament could not abridge Fundamental Rights by amendment | Blocked FR amendment for DPSP implementation |
| 24th Amendment (1971) | Affirmed Parliament's constituent power to amend any provision | Response to *Golaknath*, subject later to basic structure |
...
| *Kesavananda Bharati* (1973) | Upheld constituent power subject to basic structure; upheld first part of 31C and invalidated the review-ouster | Ends cannot eliminate judicial review |
| 42nd Amendment (1976) | Extended Article 31C from 39(b)/(c) to every DPSP | Attempted Part IV primacy over Articles 14/19 |
| *Minerva Mills* (1980) | Invalidated that extension; balance between Parts III and IV is basic structure | Harmony, not absolute primacy, is controlling |
| *Unni Krishnan* (1993) | Read education up to 14 into Article 21 with support from Articles 41, 45 and 46 | DPSP illuminated an enforceable right |
| 86th Amendment (2002) | Inserted Article 21A and recast Article 45 | Textual constitutionalisation of the education floor |
| *I.R. Coelho* (2007) | Post-24 April 1973 Ninth Schedule insertions remain reviewable for damage to basic structure | Implementing laws cannot obtain absolute immunisation |
| *Property Owners Association* (2024) | Original Article 31C remains; 39(b) may include some private resources but not all automatically | Current Article 31C/resource control |
...
> **Do not write:** "Fundamental Rights always prevail over DPSP."  
> **Write:** "Enforceable rights retain primacy in ordinary conflict, but constitutional harmony, permissible amendment and the narrow Article 31C shield qualify any absolute hierarchy."

#### CLOSING RECALL FLOW — FUNDAMENTAL RIGHTS-DPSP CHRONOLOGY: CONFLICT TO HARMONY

```closure-flow
SUBTOPIC: Fundamental Rights-DPSP chronology: conflict to harmony
KEY TERMS / DEFINITIONS: Fundamental Rights-DPSP chronology · conflict to harmony · Do not write · Champakam Dorairajan (1951) · First Amendment (1951) · Golaknath (1967)
MECHANISM / ARGUMENT: Fundamental Rights and DPSP are complementary constitutional commitments.
CONSEQUENCE / CONTRAST: The specific surviving exception is Article 31C for laws genuinely giving effect to Article 39(b) or (c), which protects them from Articles 14 and 19 challenges while preserving judicial review of the nexus and constitutional boundaries.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: "Fundamental Rights always prevail over DPSP." Write.
ANSWER-GRABBING FORMULATION: Parliament may amend rights and legislate to implement Part IV, but the basic structure - including judicial review and harmony between Parts III and IV - limits that power.
```
### SESSION 8 — ARTICLE 31C AFTER PROPERTY OWNERS ASSOCIATION
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 31C is not a general licence for nationalisation, arbitrary redistribution or immunity from every Fundamental Right.

**Technical definition:** Its surviving textual shield is tied to Articles 39(b)/(c) and Articles 14/19.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 31C protects laws genuinely implementing Article 39(b) or (c) from Articles 14 and 19 challenges, but basic-structure review prevents unlimited insulation.

#### MUST-WRITE KEYWORDS

- **Article 31C after Property Owners Association**
- **of the community**
- **Article 31C**
- **Article 39**
- **Article**
...
**How to use them:** Frame the answer through Article 31C after Property Owners Association; define of the community, connect Article 31C with Article 39 to explain the mechanism, and use Article for the decisive comparison or qualification.

![Article 31C first asks whether a law genuinely implements Article 39(b) or (c), then applies a limited shield while retaining judicial review.](assets/06_article_31c_decision_tree.png)
...
#### CLOSING RECALL FLOW — ARTICLE 31C AFTER PROPERTY OWNERS ASSOCIATION

```closure-flow
SUBTOPIC: Article 31C after Property Owners Association
KEY TERMS / DEFINITIONS: Article 31C after Property Owners Association · of the community · Article 31C · Article 39 · Article · Kesavananda Bharati
MECHANISM / ARGUMENT: Article 31C remains in force to the extent upheld in Kesavananda Bharati.
CONSEQUENCE / CONTRAST: Does the law have a real and substantial connection to Article 39(b) or (c)?
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its surviving textual shield is tied to Articles 39(b)/(c) and Articles 14/19.
ANSWER-GRABBING FORMULATION: Article 31C protects laws genuinely implementing Article 39(b) or (c) from Articles 14 and 19 challenges, but basic-structure review prevents unlimited insulation.
```
### SESSION 9 — FROM DIRECTIVE TO ENFORCEABLE ENTITLEMENT
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** From directive to enforceable entitlement comprises constitutional conversion by mediation, Article 45 and Article 21 as its core connected dimensions.

**Technical definition:** The Legal Services Authorities Act, 1987 created institutional entitlement and delivery.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Unni Krishnan read education up to age 14 into Article 21, subject to the State's capacity beyond that stage.

#### MUST-WRITE KEYWORDS

- **From directive to enforceable entitlement**
- **constitutional conversion by mediation**
- **Article 45**
- **Article 21**
- **Article 21A**
- **Article 39A**

**How to use them:** Frame the answer through From directive to enforceable entitlement; define constitutional conversion by mediation, connect Article 45 with Article 21 to explain the mechanism, and use Article 21A for the decisive comparison or qualification.

![A DPSP may shape judicial interpretation, constitutional amendment, legislation and institutions without itself becoming directly enforceable.](assets/12_dpsp_to_fr_conversion_cycle.png)
...
#### CLOSING RECALL FLOW — FROM DIRECTIVE TO ENFORCEABLE ENTITLEMENT

```closure-flow
SUBTOPIC: From directive to enforceable entitlement
KEY TERMS / DEFINITIONS: From directive to enforceable entitlement · constitutional conversion by mediation · Article 45 · Article 21 · Article 21A · Article 39A
MECHANISM / ARGUMENT: The Legal Services Authorities Act, 1987 created institutional entitlement and delivery.
CONSEQUENCE / CONTRAST: Article 45 was recast for early childhood care and education below six.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: this is constitutional conversion by mediation, not automatic enforceability.
ANSWER-GRABBING FORMULATION: Unni Krishnan read education up to age 14 into Article 21, subject to the State's capacity beyond that stage.
```
### SESSION 10 — IMPLEMENTATION MAP: LAW, INSTITUTION, OUTCOME AND HONEST LIMITS
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Implementation map: law, institution, outcome and honest limits comprises Implementation map, law and institution as its core connected dimensions.

**Technical definition:** Technically, Implementation map: law, institution, outcome and honest limits is analysed by relating Implementation map to law, then testing the relationship through institution and outcome.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Implementation map: law, institution, outcome and honest limits comprises Implementation map, law and institution as its core connected dimensions.
...
**How to use them:** Frame the answer through Implementation map; define law, connect institution with outcome to explain the mechanism, and use honest limits for the decisive comparison or qualification.

![DPSP implementation spans redistribution, local government, legal aid, education, labour, health, environment and co-operatives.](assets/07_implementation_map.png)

| Directive | Named constitutional/statutory/institutional vehicle | What it proves | Honest limit |
|---|---|---|---|
| 38, 39(b)/(c) | Land-reform laws; First/Fourth/Seventeenth Amendments; Articles 31A/31B; Ninth Schedule | Redistribution and agrarian restructuring were treated as constitutional priorities | Ceiling, tenancy and redistribution outcomes vary; *I.R. Coelho* prevents absolute post-1973 Ninth Schedule immunity |
...
#### CLOSING RECALL FLOW — IMPLEMENTATION MAP: LAW, INSTITUTION, OUTCOME AND HONEST LIMITS

```closure-flow
SUBTOPIC: Implementation map: law, institution, outcome and honest limits
KEY TERMS / DEFINITIONS: Implementation map · law · institution · outcome · honest limits · 38, 39(b)/(c)
MECHANISM / ARGUMENT: This owner retains the Part IV constitutional mechanism needed to answer DPSP questions; it does not duplicate each specialist policy owner.
CONSEQUENCE / CONTRAST: Courts can enforce a floor more readily than manage a complex welfare system.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: a directive succeeds only when five links align.
ANSWER-GRABBING FORMULATION: Implementation map: law, institution, outcome and honest limits comprises Implementation map, law and institution as its core connected dimensions.
```
### SESSION 11 — ARTICLE 39A, FREE LEGAL AID AND NALSA
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 39A was inserted by the 42nd Amendment to secure equal justice and free legal aid so justice is not denied by economic or other disabilities.

**Technical definition:** Article 21 jurisprudence gives free legal representation an enforceable fair-procedure dimension in appropriate criminal cases; Article 39A supplies the constitutional value.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 39A was inserted by the 42nd Amendment to secure equal justice and free legal aid so justice is not denied by economic or other disabilities.
...
**How to use them:** Frame the answer through Article 39A; define free legal aid, connect NALSA with prima facie case to explain the mechanism, and use Achievements for the decisive comparison or qualification.

![Article 39A operates through NALSA, State and court committees, district authorities and Taluk-level delivery.](assets/08_nalsa_legal_aid_flow.png)
...
#### CLOSING RECALL FLOW — ARTICLE 39A, FREE LEGAL AID AND NALSA

```closure-flow
SUBTOPIC: Article 39A, free legal aid and NALSA
KEY TERMS / DEFINITIONS: Article 39A · free legal aid · NALSA · prima facie case · Achievements · Limits
MECHANISM / ARGUMENT: Article 21 jurisprudence gives free legal representation an enforceable fair-procedure dimension in appropriate criminal cases; Article 39A supplies the constitutional value.
CONSEQUENCE / CONTRAST: The reform priority is not another apex body.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: there is no single permanent national income ceiling applicable to every court and State....
ANSWER-GRABBING FORMULATION: Article 39A was inserted by the 42nd Amendment to secure equal justice and free legal aid so justice is not denied by economic or other disabilities.
```
### SESSION 12 — ORDINARY AND PERMANENT LOK ADALATS
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Ordinary and Permanent Lok Adalats comprises Ordinary, Permanent Lok Adalats and public utility services as its core connected dimensions.

**Technical definition:** If settlement fails, a pending case returns to the referring court at the stage already reached; pre-litigation parties are advised to pursue ordinary remedies.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Because an ordinary award is founded on settlement, absence of genuine consent attacks the foundation; the Act does not convert a failed conciliation into adjudication.
...
- **Close-option trap**
- **decision power after failed conciliation**
- **Subject**

**How to use them:** Frame the answer through Ordinary; define Permanent Lok Adalats, connect public utility services with Close-option trap to explain the mechanism, and use decision power after failed conciliation for the decisive comparison or qualification.

![Ordinary Lok Adalats settle only by consent; Permanent Lok Adalats for public utility services may decide on merits after conciliation fails.](assets/09_lok_adalat_comparison.png)
...
#### CLOSING RECALL FLOW — ORDINARY AND PERMANENT LOK ADALATS

```closure-flow
SUBTOPIC: Ordinary and Permanent Lok Adalats
KEY TERMS / DEFINITIONS: Ordinary · Permanent Lok Adalats · public utility services · Close-option trap · decision power after failed conciliation · Subject
MECHANISM / ARGUMENT: Because an ordinary award is founded on settlement, absence of genuine consent attacks the foundation; the Act does not convert a failed conciliation into adjudication.
CONSEQUENCE / CONTRAST: Close-option trap: "No appeal" does not make the two bodies identical.
UPSC TRAP / ANSWER-USE: Members are statutory conciliators, not judges deciding the dispute on their own.
ANSWER-GRABBING FORMULATION: Because an ordinary award is founded on settlement, absence of genuine consent attacks the foundation; the Act does not convert a failed conciliation into adjudication.
```
### SESSION 13 — ARTICLE 44 AND THE UNIFORM CIVIL CODE
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 44 and the Uniform Civil Code comprises Article 44, the Uniform Civil Code and citizens as its core connected dimensions.

**Technical definition:** Goa's family-law system, inherited from Portuguese civil law and subsequently adapted, is often cited as a common civil-law example.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Secular opt-in: Special Marriage Act, 1954 offers a civil marriage route but does not displace all personal law for everyone.
...
- **versus**
- **Mandatory phrasing**
- **observed, urged or expressed concern**

**How to use them:** Frame the answer through Article 44; define the Uniform Civil Code, connect citizens with versus to explain the mechanism, and use Mandatory phrasing for the decisive comparison or qualification.

![Article 44 requires an answer that balances equality, religious freedom, federal competence and democratic legitimacy.](assets/10_ucc_argument_tree.png)
...
|---|---|---|
| *Mohd. Ahmed Khan v. Shah Bano Begum* (1985) | Applied secular maintenance law to a divorced Muslim woman | Court observed that Article 44 remained unfulfilled; it did not enact a UCC |
| *Sarla Mudgal v. Union of India* (1995) | Conversion cannot be used to evade an existing Hindu marriage and contract a second valid marriage | Strong UCC observations were legislative exhortation, not mandamus |
| *John Vallamattom v. Union of India* (2003) | Invalidated discriminatory section 118 of the Indian Succession Act as applied to Christians | Article 44 observation accompanied an equality holding |
| *Shayara Bano v. Union of India* (2017) | By a 3:2 majority, invalidated/set aside instant triple talaq through differing opinions | It concerned a specific practice, not the validity of all personal-law systems and not a judicial UCC |
...
![India has used community-specific codification, a secular opt-in law, targeted equality correction and the common-code route.](assets/11_article_44_reform_routes.png)
...
#### CLOSING RECALL FLOW — ARTICLE 44 AND THE UNIFORM CIVIL CODE

```closure-flow
SUBTOPIC: Article 44 and the Uniform Civil Code
KEY TERMS / DEFINITIONS: Article 44 · the Uniform Civil Code · citizens · versus · Mandatory phrasing · observed, urged or expressed concern
MECHANISM / ARGUMENT: It is which civil rule causes constitutional harm, who has legislative competence, and whether the reform is proportionate, consultative and administratively workable.
CONSEQUENCE / CONTRAST: Secular opt-in: Special Marriage Act, 1954 offers a civil marriage route but does not displace all personal law for everyone.
UPSC TRAP / ANSWER-USE: Do not describe Goa as perfectly uniform across every community, institution and subject.
ANSWER-GRABBING FORMULATION: Secular opt-in: Special Marriage Act, 1954 offers a civil marriage route but does not displace all personal law for everyone.
```
### SESSION 14 — DIRECTIVES OUTSIDE PART IV
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Calling them "directives outside Part IV" is a study classification; do not relocate them into Articles 36-51.

**Technical definition:** These are constitutional directions but are not DPSP in Part IV.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Articles 335, 350A and 351 contain constitutional directions outside Part IV, but they do not acquire the Directive Principles' Article 37 framework.
...
**How to use them:** Frame the answer through Directives outside Part IV; define not, connect Part XVI with Part XVII to explain the mechanism, and use Article 37 for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — DIRECTIVES OUTSIDE PART IV

```closure-flow
SUBTOPIC: Directives outside Part IV
KEY TERMS / DEFINITIONS: Directives outside Part IV · not · Part XVI · Part XVII · Article 37 · 350A
MECHANISM / ARGUMENT: Articles 335, 350A and 351 have their own text, location, addressee and mechanism.
CONSEQUENCE / CONTRAST: These are constitutional directions but are not DPSP in Part IV.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: calling them "directives outside Part IV" is a study classification.
ANSWER-GRABBING FORMULATION: Articles 335, 350A and 351 contain constitutional directions outside Part IV, but they do not acquire the Directive Principles' Article 37 framework.
```
### SESSION 15 — CRITICISMS, DEFENDERS AND IMPLEMENTATION CONSTRAINTS
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Criticisms, defenders and implementation constraints comprises Criticisms, defenders and implementation constraints as its core connected dimensions.

**Technical definition:** Technically, Criticisms, defenders and implementation constraints is analysed by relating Criticisms to defenders, then testing the relationship through implementation constraints and K.T. Shah.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Directive Principles gain analytical force when named critics and defenders are tested against Article 37, institutional capacity and resource or federal constraints.
...
- **K.T. Shah**
- **"Pious superfluities"; cheque payable when bank resources permit**
- **T.T. Krishnamachari**

**How to use them:** Frame the answer through Criticisms; define defenders, connect implementation constraints with K.T. Shah to explain the mechanism, and use "Pious superfluities"; cheque payable when bank resources permit for the decisive comparison or qualification.

![Named critiques become analytical only when paired with constitutional mechanisms, counterarguments and implementation limits.](assets/13_criticism_defence_matrix.png)
...
#### CLOSING RECALL FLOW — CRITICISMS, DEFENDERS AND IMPLEMENTATION CONSTRAINTS

```closure-flow
SUBTOPIC: Criticisms, defenders and implementation constraints
KEY TERMS / DEFINITIONS: Criticisms · defenders · implementation constraints · K.T. Shah · "Pious superfluities"; cheque payable when bank resources permit · T.T. Krishnamachari
MECHANISM / ARGUMENT: DPSP are constitutionally indispensable but operationally incomplete.
CONSEQUENCE / CONTRAST: Their non-justiciability preserves democratic policy space, while Part III, judicial review and federal structure prevent welfare ends from consuming constitutional means.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: their non-justiciability preserves democratic policy space.
ANSWER-GRABBING FORMULATION: Directive Principles gain analytical force when named critics and defenders are tested against Article 37, institutional capacity and resource or federal constraints.
```
### 16. GS-II answer architecture

![A high-scoring DPSP answer moves from a direct thesis and exact text through mechanism, named evidence, limitations and a graded constitutional verdict.](assets/14_mains_answer_spine.png)

#### Universal answer spine

1. **Direct thesis:** answer whether Part IV is effective, harmonious, enforceable, contested or inadequately implemented.
2. **Exact text:** name Article 37 and the specific directive.
3. **Mechanism:** amendment, legislative competence, statute, institution and budget.
4. **Evidence:** case/statute/institution -> what it proves.
5. **Counterpoint:** rights, finance, federalism, institutional competence or delivery gap.
6. **Current control:** *Property Owners*, labour-code status, *Rajendra N. Shah* or Uttarakhand UCC only where relevant.
7. **Qualified conclusion:** harmony and workable implementation, not slogans.
...
> Answer placement is balanced, deterministic and non-patterned using a stable topic seed., repeated seven times.
...
- A. All four are correctly matched
- B. 1, 2 and 3 only
- C. 2 and 3 only
- D. 1 and 4 only
...
- B. Part IXB is operative for multi-State co-operative societies, but its application to State co-operative societies failed for want of ratification; Article 43B remains.
- C. Parliament has no competence over multi-State co-operative societies.
...
- C. It protects genuine Article 39(b)/(c) laws against Articles 14 and 19, while judicial review of the nexus and basic structure remains.
- D. It prevents courts from examining whether a law genuinely implements Article 39(b) or (c).
...
- A. Every private asset is automatically a material resource of the community.
- B. A privately owned resource may fall under Article 39(b) depending on its nature, community impact, scarcity, concentration and common-good dimension.
...
- A. Articles 41/45 informed *Unni Krishnan*; the 86th Amendment inserted Article 21A and recast Article 45; the RTE Act supplied a statutory mechanism.
- B. Article 46 alone created the enforceable right for every age group.
- C. Article 45 directly became enforceable without amendment or legislation.
...
- A. None of the four Labour Codes has commenced.
- B. An official 21 November 2025 announcement brought all four Labour Codes into effect, but enactment does not prove uniform compliance or State capacity.
...
- A. NALSA -> SLSA -> DLSA -> Taluk Legal Services Committee
- B. NALSA -> DLSA -> SLSA -> Taluk Committee
...
- A. The record returns to the referring court, which continues from the stage reached before reference.
- B. The dispute becomes non-justiciable.
- C. It must decide the dispute on merits.
- D. Its members may impose a compromise in the public interest.
...
- A. It can decide non-compoundable criminal offences.
- B. For a pre-litigation public-utility dispute, it may decide on merits after conciliation fails, provided the dispute does not relate to an offence.
...
- A. It directs the State to endeavour to secure a UCC for citizens throughout India; personal-law subjects lie in Concurrent List Entry 5.
- B. It applies only to criminal law, which remains non-uniform.
...
- B. *Shayara Bano* - Supreme Court ordered Parliament to enact a UCC within a fixed period
- C. *Sarla Mudgal* - conversion cannot be used to evade an existing marriage
...
- C. The 2024 Act received assent on 11 March 2024, commenced on 27 January 2025, and section 2 contains the verified Scheduled Tribe/customary-rights exclusion.
- D. Its reported 2026 Ordinance has a securely verified permanent replacement status.
...
- A. Articles 44, 50 and 350A
- B. Articles 335, 350A and 351
...
- B. Article 48A is a Fundamental Duty.
- C. Article 48A concerns scientific animal husbandry, while Article 48 concerns forests.
- D. Article 48 combines scientific agriculture/animal husbandry with cattle protection; Article 48A concerns environment, forests and wildlife.
...
- A. It treats nutrition, standard of living and public health as primary duties and also directs prohibition of intoxicants injurious to health except medicinal use.
- B. It only directs total prohibition and says nothing about nutrition.
- C. It creates an absolute Fundamental Right to health enforceable without legislation.
- D. It concerns animal husbandry and cattle breeds.
...
- A. Claim Ivor Jennings supported immediate judicial enforcement of every directive.
- B. Attribute "Conscience of the Constitution" to K.T. Shah.
- C. Use K.T. Shah's "pious superfluities" to introduce the no-remedy critique, then answer it with Article 37 duty, political sanction and interpretive force.
...
> Answer placement is balanced, deterministic and non-patterned using a stable topic seed., repeated twice.

#### R1. Which is the safest statement?

- A. DPSP have no constitutional force.
- B. Every DPSP is enforceable through Article 32.
- C. Article 37 applies only during an Emergency.
- D. DPSP are non-justiciable, but fundamental in governance and a State duty in law-making.
...
- B. binding on the Supreme Court
- C. a scholarly classification, not constitutional text
...
- A. the 42nd Amendment extension of 31C to all DPSP is invalid and Part III-Part IV balance is basic structure
- B. all of Article 31C is void
- C. Article 39(b)/(c) can never receive protection
- D. every DPSP overrides Articles 14 and 19

**Answer: A.**

**Explanation:** The original limited 39(d)/(a) protection survives.
...
- A. *Shayara Bano* enacted a national civil code.
- B. Entry 5 belongs exclusively to the Union List.
- C. Article 44 is directly enforceable.
- D. Courts have made legislative observations but have not ordered enactment of a UCC.
...
- A. Part IXB remains for multi-State co-operatives; its State-co-operative operation failed for want of ratification.
- B. co-operative societies ceased to be a constitutional subject.
...
- C. list only pre-Code statutes as if nothing changed
- D. use the four Labour Codes as in force from 21 Nov 2025, while qualifying State rules and delivery capacity
...
- C. gives a limited Articles 14/19 shield to genuine 39(b)/(c) laws while retaining review
- D. protects all DPSP laws from all review
...
#### ASCII MASTER FLOW — PANEL 1/9: Part IV's constitutional operating logic

```ascii-master
PART IV: DIRECTIVE PRINCIPLES OF STATE POLICY, ARTICLES 36-51
  |
  +-- ARTICLE 36: "STATE" carries the Part III / Article 12 meaning
  |     +-- the same public power is restrained by rights and directed toward welfare
  |
  +-- ARTICLE 37: THREE-PART CONSTITUTIONAL RULE
        ...
        +-- the State has a duty to apply them in making laws
              |
              +-- legislation + budget + administration + political accountability
...
#### ASCII MASTER FLOW — PANEL 2/9: Articles 38-43B: welfare, work and democratic economy
...
#### ASCII MASTER FLOW — PANEL 3/9: Articles 44-51: reform, capability and constitutional civilisation

```ascii-master
REFORM / CAPABILITY                 ECOLOGY / INSTITUTIONS / PEACE
...
46  weaker sections; especially     50 judiciary separated from executive
    Scheduled Castes and Tribes     51(a) international peace and security
47  nutrition, living standard,     51(b) just and honourable relations
    public health and prohibition   51(c) international law and treaty obligations
48  scientific agriculture and      51(d) arbitration of international disputes
    animal husbandry; cattle rule
...
#### ASCII MASTER FLOW — PANEL 4/9: Classification and amendment overlays
...
#### ASCII MASTER FLOW — PANEL 5/9: FR-DPSP evolution and the surviving Article 31C

```ascii-master
CHAMPAKAM DORAIRAJAN (1951) -> enforceable Fundamental Rights prevail over conflicting directives
  |
1st / 4th / 17th AMENDMENTS -> protective constitutional responses
  |
I.C. GOLAKNATH (1967) -> Parliament cannot amend Fundamental Rights
  |
1971 24th + 25th AMENDMENTS -> amendment power affirmed; Article 31C created
  |
KESAVANANDA BHARATI (1973) -> amend, but do not damage basic structure; first limb of 31C survives
  |
1976 42nd -> attempted extension of 31C to every DPSP
  |
MINERVA MILLS (1980) -> extension invalid; harmony between Parts III and IV is basic structure
  |
PROPERTY OWNERS ASSOCIATION (2024) -> surviving shield remains for genuine 39(b)/(c) laws

CURRENT SCOPE: shield against Articles 14 and 19; nexus and basic structure remain reviewable.
```

#### ASCII MASTER FLOW — PANEL 6/9: Implementation chain: directive to law, institution and outcome
...
#### ASCII MASTER FLOW — PANEL 7/9: Article 44: equality, pluralism and federal legislative design

```ascii-master
ARTICLE 44: STATE ENDEAVOUR TO SECURE A UNIFORM CIVIL CODE FOR CITIZENS
  |
  +-- LEGISLATIVE BASE: Concurrent List Entry 5
...
Directives outside Part IV must not be confused with Article 36-51 DPSP text.
```

#### ASCII MASTER FLOW — PANEL 8/9: Criticism, institutional limits and constitutional relevance

```ascii-master
CRITIQUE                              CONSTITUTIONAL RESPONSE
no direct judicial remedy             Article 37 creates duty and political sanction
broad, unevenly arranged aspirations  breadth permits democratic sequencing and adaptation
resource-dependent promises           Article 41 admits capacity; budgets expose trade-offs
judicial overreach risk               interpretation cannot become continuous administration
Centre-State friction                 competence, finance and institutions condition delivery
symbolic compliance                   test law + institution + implementation + outcome
...
#### ASCII MASTER FLOW — PANEL 9/9: Prelims traps, PYQ routes and the Mains answer spine
