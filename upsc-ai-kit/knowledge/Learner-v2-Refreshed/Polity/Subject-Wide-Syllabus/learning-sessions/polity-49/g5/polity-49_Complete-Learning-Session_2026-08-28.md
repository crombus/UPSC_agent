---
title: "Regulatory State and Quasi Judicial Institutions — Learner-v2 Refreshed"
topic_key: polity-49
cover_image: assets/polity-49_Teaching-Navigation_2026-08-28.png
---
...
![Refreshed teaching navigation](assets/polity-49_Teaching-Navigation_2026-08-28.png)
...
START / CONCEPT: CONSTITUTIONAL VERSUS STATUTORY
        |
        v
EXACT TERMS: Constitutional Versus Statutory · Mandate source · Constitutional article · Parent Act · Composition/powers · Constitution plus legislation/rules
        |
        v
...
```text
START / CONCEPT: FUNCTIONAL TAXONOMY
        |
        v
EXACT TERMS: Functional Taxonomy · Advisory/recommendatory · Investigative · Regulatory · Adjudicatory/quasi-judicial · Tribunal
        |
        v
...
UPSC TRAP / ANSWER-USE: Functions may be combined, but combination increases the need for internal separation, reasoned orders and appeal.
        |
        v
ANSWER-GRABBING FORMULATION: Functional taxonomy denotes the constitutional rules and institutional links organised around Function What it involves Typical institutions.
```
...
START / CONCEPT: THREE KINDS OF ACTION
        |
        v
EXACT TERMS: Three Kinds Of Action · Quasi-legislative · Quasi-judicial · General regulation/standard · Inspection/investigation/prosecution decision · Administrative/investigative
        |
        v
...
START / CONCEPT: CORE FEATURES
        |
        v
EXACT TERMS: Core Features · Constitution · Its principal consequence · Its · The decisive contrast · The exam-safe limitation
        |
        v
...
**Plain-language definition:** Central Design Tension is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The central design tension analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Central Design Tension becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through central; define design, connect tension with statutory to explain the mechanism, and use function for the decisive comparison or qualification.
...
START / CONCEPT: CENTRAL DESIGN TENSION
        |
        v
EXACT TERMS: central · design · tension · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the central design tension issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
        v
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Central Design Tension becomes exam-ready through precise classification rather than institutional labels.
```
...
**Plain-language definition:** National Commission Classification Trap is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The national commission classification trap analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> National Commission Classification Trap becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through national; define commission, connect statutory with function to explain the mechanism, and use procedure for the decisive comparison or qualification.
...
START / CONCEPT: NATIONAL COMMISSION CLASSIFICATION TRAP
        |
        v
EXACT TERMS: national · commission · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the national commission classification trap issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: National Commission Classification Trap becomes exam-ready through precise classification rather than institutional labels.
```
...
**Plain-language definition:** Consumer Commissions: Usable Adjudicatory Capsule is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The consumer commissions: usable adjudicatory capsule analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Consumer Commissions: Usable Adjudicatory Capsule becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through consumer; define commissions, connect usable with adjudicatory to explain the mechanism, and use statutory for the decisive comparison or qualification.
...
START / CONCEPT: A. CONSUMER COMMISSIONS: USABLE ADJUDICATORY CAPSULE
        |
        v
EXACT TERMS: consumer · commissions · usable · adjudicatory · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the consumer commissions: usable adjudicatory capsule issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Consumer Commissions: Usable Adjudicatory Capsule becomes exam-ready through precise classification rather than institutional labels.
```
...
**Plain-language definition:** Ipab Lesson is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The ipab lesson analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Ipab Lesson becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through ipab; define lesson, connect statutory with function to explain the mechanism, and use procedure for the decisive comparison or qualification.
...
START / CONCEPT: IPAB LESSON
        |
        v
EXACT TERMS: ipab · lesson · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the ipab lesson issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Ipab Lesson becomes exam-ready through precise classification rather than institutional labels.
```
...
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the decisive contrast is between constitutionally compliant legislation.
        |
        v
ANSWER-GRABBING FORMULATION: Tribunal-reform legal baseline denotes the constitutional rules and institutional links organised around On 19 November 2025 , the Supreme Court in Madras Bar Association v.
```
...
**Plain-language definition:** Appointment And Independence Design is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The appointment and independence design analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Appointment And Independence Design becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through appointment; define independence, connect design with statutory to explain the mechanism, and use function for the decisive comparison or qualification.
...
START / CONCEPT: APPOINTMENT AND INDEPENDENCE DESIGN
        |
        v
EXACT TERMS: appointment · independence · design · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the appointment and independence design issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Appointment And Independence Design becomes exam-ready through precise classification rather than institutional labels.
```
...
**Plain-language definition:** Regulatory Capture And Other Failure Modes is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The regulatory capture and other failure modes analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Regulatory Capture And Other Failure Modes becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through regulatory; define capture, connect other with failure to explain the mechanism, and use statutory for the decisive comparison or qualification.
...
START / CONCEPT: REGULATORY CAPTURE AND OTHER FAILURE MODES
        |
        v
EXACT TERMS: regulatory · capture · other · failure · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the regulatory capture and other failure modes issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Regulatory Capture And Other Failure Modes becomes exam-ready through precise classification rather than institutional labels.
```
### SESSION 31 — NHRC
...
**Plain-language definition:** Cic is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The cic analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Cic becomes exam-ready through precise classification rather than institutional labels.

#### MUST-WRITE KEYWORDS

- **CIC information commission**
- **CIC appeals**
- **statutory**
- **function**
- **procedure**
...
**How to use them:** Frame the answer through CIC information commission; define CIC appeals, connect statutory with function to explain the mechanism, and use procedure for the decisive comparison or qualification.
...
START / CONCEPT: CIC
        |
        v
EXACT TERMS: CIC information commission · CIC appeals · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the cic issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Cic becomes exam-ready through precise classification rather than institutional labels.
```
...
START / CONCEPT: NCBC
        |
        v
EXACT TERMS: Ncbc · This · The operative mechanism matters because nCBC · Its principal consequence · Its · The decisive contrast
        |
        v
...
UPSC TRAP / ANSWER-USE: This is a recurring Prelims trap and a Mains case study in and NCBC is now constitutional, not statutory.
        |
        v
ANSWER-GRABBING FORMULATION: Its principal consequence is that nCBC is now constitutional, not statutory.
```
### SESSION 35 — BCI VERSUS LAW COMMISSION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Bci Versus Law Commission is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The bci versus law commission analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Bci Versus Law Commission becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through versus; define commission, connect statutory with function to explain the mechanism, and use procedure for the decisive comparison or qualification.
...
START / CONCEPT: BCI VERSUS LAW COMMISSION
        |
        v
EXACT TERMS: versus · commission · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the bci versus law commission issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Bci Versus Law Commission becomes exam-ready through precise classification rather than institutional labels.
```
### SESSION 36 — CONSUMER COMMISSION VERSUS CCPA

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Consumer Commission Versus Ccpa is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The consumer commission versus ccpa analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Consumer Commission Versus Ccpa becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through consumer; define commission, connect versus with ccpa to explain the mechanism, and use statutory for the decisive comparison or qualification.
...
START / CONCEPT: CONSUMER COMMISSION VERSUS CCPA
        |
        v
EXACT TERMS: consumer · commission · versus · ccpa · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the consumer commission versus ccpa issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Consumer Commission Versus Ccpa becomes exam-ready through precise classification rather than institutional labels.
```
...
UPSC TRAP / ANSWER-USE: The exam-safe limitation is that thesis: Tribunals add expertise and speed but cannot constitutionally replace High Court judicial.
        |
        v
ANSWER-GRABBING FORMULATION: 17.1 2018 GS-II: tribunals and ordinary courts denotes the constitutional rules and institutional links organised around Thesis: Tribunals add expertise and speed but cannot constitutionally replace High Court judicial.
```
### SESSION 38 — GS-II: NCSC AND MINORITY EDUCATIONAL INSTITUTIONS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Ncsc And Minority Educational Institutions is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The ncsc and minority educational institutions analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Ncsc And Minority Educational Institutions becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through ncsc; define minority, connect educational with institutions to explain the mechanism, and use statutory for the decisive comparison or qualification.
...
START / CONCEPT: GS-II: NCSC AND MINORITY EDUCATIONAL INSTITUTIONS
        |
        v
EXACT TERMS: ncsc · minority · educational · institutions · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the ncsc and minority educational institutions issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Ncsc And Minority Educational Institutions becomes exam-ready through precise classification rather than institutional labels.
```
### SESSION 39 — GS-II: MULTIPLE COMMISSIONS AND AN UMBRELLA BODY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Multiple Commissions And An Umbrella Body is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The multiple commissions and an umbrella body analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Multiple Commissions And An Umbrella Body becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through multiple; define commissions, connect umbrella with body to explain the mechanism, and use statutory for the decisive comparison or qualification.
...
START / CONCEPT: GS-II: MULTIPLE COMMISSIONS AND AN UMBRELLA BODY
        |
        v
EXACT TERMS: multiple · commissions · umbrella · body · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the multiple commissions and an umbrella body issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Multiple Commissions And An Umbrella Body becomes exam-ready through precise classification rather than institutional labels.
```
### SESSION 40 — GS-II: CAT AND INDEPENDENT JUDICIAL AUTHORITY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Cat And Independent Judicial Authority is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The cat and independent judicial authority analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Cat And Independent Judicial Authority becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through independent; define judicial, connect authority with statutory to explain the mechanism, and use function for the decisive comparison or qualification.
...
START / CONCEPT: GS-II: CAT AND INDEPENDENT JUDICIAL AUTHORITY
        |
        v
EXACT TERMS: independent · judicial · authority · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the cat and independent judicial authority issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Cat And Independent Judicial Authority becomes exam-ready through precise classification rather than institutional labels.
```
...
START / CONCEPT: GS-II: RTI AMENDMENT AND INFORMATION COMMISSION AUTONOMY
        |
        v
EXACT TERMS: Gs-Ii · Rti Amendment · Information Commission Autonomy · RTI · Information Commission · CIC's
        |
        v
...
UPSC TRAP / ANSWER-USE: Explain state consent under DSPE and Distinguish CBI's executive origin from DSPE statutory powers.
        |
        v
ANSWER-GRABBING FORMULATION: 17.7 2021 GS-II: CBI jurisdiction and federalism denotes the constitutional rules and institutional links organised around Distinguish CBI's executive origin from DSPE statutory powers.
```
### SESSION 44 — GS-II: HUMAN RIGHTS COMMISSION LIMITATIONS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Human Rights Commission Limitations is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The human rights commission limitations analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Human Rights Commission Limitations becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through human; define rights, connect commission with limitations to explain the mechanism, and use statutory for the decisive comparison or qualification.
...
START / CONCEPT: GS-II: HUMAN RIGHTS COMMISSION LIMITATIONS
        |
        v
EXACT TERMS: human · rights · commission · limitations · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the human rights commission limitations issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Human Rights Commission Limitations becomes exam-ready through precise classification rather than institutional labels.
```
### SESSION 45 — GS-II: NCBC FROM STATUTORY TO CONSTITUTIONAL

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Ncbc From Statutory To Constitutional is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The ncbc from statutory to constitutional analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Ncbc From Statutory To Constitutional becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through ncbc; define from, connect statutory with constitutional to explain the mechanism, and use function for the decisive comparison or qualification.
...
START / CONCEPT: GS-II: NCBC FROM STATUTORY TO CONSTITUTIONAL
        |
        v
EXACT TERMS: ncbc · from · statutory · constitutional · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the ncbc from statutory to constitutional issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Ncbc From Statutory To Constitutional becomes exam-ready through precise classification rather than institutional labels.
```
...
**Plain-language definition:** Lok Adalat Versus Arbitration Tribunal is an institutional comparison that must identify legal source, function and limitation.

**Technical definition:** The lok adalat versus arbitration tribunal analysis applies statutory source, decisional character, procedure and remedy to the named institutions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Lok Adalat Versus Arbitration Tribunal becomes exam-ready through precise classification rather than institutional labels.
...
**How to use them:** Frame the answer through adalat; define versus, connect arbitration with tribunal to explain the mechanism, and use statutory for the decisive comparison or qualification.
...
START / CONCEPT: GS-II: LOK ADALAT VERSUS ARBITRATION TRIBUNAL
        |
        v
EXACT TERMS: adalat · versus · arbitration · tribunal · statutory · function · procedure · remedy
        |
        v
MECHANISM / ARGUMENT: Trace the lok adalat versus arbitration tribunal issue from legal source through function to review.
        |
        v
CONSEQUENCE / CONTRAST: This method produces a precise comparison with an express institutional limitation.
        |
...
UPSC TRAP / ANSWER-USE: Do not collapse the distinct bodies or assume that their similarly named powers are identical.
        |
        v
ANSWER-GRABBING FORMULATION: Lok Adalat Versus Arbitration Tribunal becomes exam-ready through precise classification rather than institutional labels.
```
...
START / CONCEPT: UNIVERSAL BODY-COMPARISON TEMPLATE
        |
        v
EXACT TERMS: Universal Body-Comparison Template · Mandate · Composition · Appointment and removal · Powers · Procedure
        |
        v
...
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the exam-safe limitation is that accountability.
        |
        v
ANSWER-GRABBING FORMULATION: Universal body-comparison template denotes the constitutional rules and institutional links organised around For any unfamiliar body, write.
```
...
START / CONCEPT: QUALIFIED THESIS OPTIONS
        |
        v
EXACT TERMS: Qualified Thesis Options · Qualified · Constitutional · Its principal consequence · Its · 21.2 Qualified thesis options
        |
        v
...
START / CONCEPT: INSTITUTIONAL INCENTIVES AND CAPTURE IN ANSWER-USE
        |
        v
EXACT TERMS: Institutional Incentives · Capture In Answer-Use · How to deploy §15 in an answer · Incentive logic · Consequence framing · Institutional
        |
        v
...
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the decisive contrast is between Constitutional rule and Constitutional rule.
        |
        v
ANSWER-GRABBING FORMULATION: 21.7 Institutional incentives and capture in answer-use denotes the constitutional rules and institutional links organised around Constitutional rule.
```
...
reproduce delay and weaken independence. In **L. Chandra Kumar**, the Supreme Court held that High
...
L. Chandra Kumar and the qualified conclusion.
...
absence of bias and a speaking order. A.K. Kraipak rejects a rigid administrative/quasi-judicial
divide; S.N. Mukherjee connects reasons to disciplined review. Procedure remains contextual:
...
**How to improve:** Mention L. Chandra Kumar for the constitutional floor.
