...
topic_key: polity-30
cover_image: assets/polity-30_Teaching-Navigation_2026-08-24.png
subject: Polity
...
![Refreshed teaching navigation](assets/polity-30_Teaching-Navigation_2026-08-24.png)
...
**Plain-language definition:** Why did India need a GST compact? denotes the constitutional rules and institutional links organised around Central excise at manufacture.

**Technical definition:** Article 269A supports this destination logic for inter-State supplies by placing levy and collection with the Government of India and requiring apportionment between Union and States under parliamentary law on Council recommendation.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Input-tax credit (ITC) reduces cascading only where the law permits credit and the taxpayer satisfies conditions.

#### MUST-WRITE KEYWORDS

- **input**
- **tax becomes cost**
- **eligible tax enters electronic credit**
- **production**
- **output liability less eligible input credit**
- **distribution**

**How to use them:** Frame the answer through input; define tax becomes cost, connect eligible tax enters electronic credit with production to explain the mechanism, and use output liability less eligible input credit for the decisive comparison or qualification.
...
![Topic-specific visual map: Why did India need a GST compact?.](assets/01_why_did_india_need_a_gst_compact.png)
...
```closure-flow
SUBTOPIC: Why did India need a GST compact?
KEY TERMS / DEFINITIONS: input · tax becomes cost · eligible tax enters electronic credit · production · output liability less eligible input credit · distribution
MECHANISM / ARGUMENT: Article 269A supports this destination logic for inter-State supplies by placing levy and collection with the Government of India and requiring apportionment between Union and States under parliamentary law on Council recommendation.
CONSEQUENCE / CONTRAST: The decisive contrast is between input tax becomes cost eligible tax enters electronic credit and production tax may be charged on cost including earlier tax output liability less eligible input credit.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that stage Without full credit With GST-style credit.
ANSWER-GRABBING FORMULATION: Input-tax credit (ITC) reduces cascading only where the law permits credit and the taxpayer satisfies conditions.
```
### SESSION 2 — THE 101ST AMENDMENT: CONSTITUTIONAL SURGERY, NOT A SINGLE TAX RATE
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The 101st Amendment: constitutional surgery, not a single tax rate denotes the constitutional rules and institutional links organised around exclusive tax entries + service-tax Article 268A.

**Technical definition:** The Constitution (One Hundred and First Amendment) Act, 2016 created the enabling architecture.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The 101st Amendment reworked tax entries and removed Article 268A, enabling a supply-based GST rather than merely introducing a single rate.

#### MUST-WRITE KEYWORDS

- **The 101st Amendment**
- **constitutional surgery**
- **not a single tax rate**
- **Union collection plus statutory apportionment**
- **246A**
- **269A**

**How to use them:** Frame the answer through The 101st Amendment; define constitutional surgery, connect not a single tax rate with Union collection plus statutory apportionment to explain the mechanism, and use 246A for the decisive comparison or qualification.
...
![Topic-specific visual map: The 101st Amendment: constitutional surgery, not a single tax rate.](assets/02_the_101st_amendment_constitutional_surgery_not_a_sin.png)
...
```closure-flow
SUBTOPIC: The 101st Amendment: constitutional surgery, not a single tax rate
KEY TERMS / DEFINITIONS: The 101st Amendment · constitutional surgery · not a single tax rate · Union collection plus statutory apportionment · 246A · 269A
MECHANISM / ARGUMENT: The Constitution (One Hundred and First Amendment) Act, 2016 created the enabling architecture.
CONSEQUENCE / CONTRAST: The decisive contrast is between Seventh Schedule and revenue-distribution changes and Article Core question answered One-line recall.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that article 366(12A).
ANSWER-GRABBING FORMULATION: The 101st Amendment reworked tax entries and removed Article 268A, enabling a supply-based GST rather than merely introducing a single rate.
```
### SESSION 3 — ARTICLE 246A: A SPECIAL SHARED TAXING POWER
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 246A: a special shared taxing power denotes the constitutional rules and institutional links organised around Supply field Parliament State legislature.

**Technical definition:** Technically, Article 246A: a special shared taxing power is analysed by relating Article 246A to a special shared taxing power, then testing the relationship through intra-State GST and yes.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 246A(1), notwithstanding Articles 246 and 254, gives Parliament and, subject to clause (2), every State legislature power to make laws on GST imposed by the Union or the State.

#### MUST-WRITE KEYWORDS

- **Article 246A**
- **a special shared taxing power**
- **intra-State GST**
- **yes**
- **yes, for State GST**
- **inter-State GST**

**How to use them:** Frame the answer through Article 246A; define a special shared taxing power, connect intra-State GST with yes to explain the mechanism, and use yes, for State GST for the decisive comparison or qualification.
...
![Topic-specific visual map: Article 246A: a special shared taxing power.](assets/03_article_246a_a_special_shared_taxing_power.png)
...
```closure-flow
SUBTOPIC: Article 246A: a special shared taxing power
KEY TERMS / DEFINITIONS: Article 246A · a special shared taxing power · intra-State GST · yes · yes, for State GST · inter-State GST
MECHANISM / ARGUMENT: It differs from a normal Concurrent List subject because Article 246A is a stand-alone competence and the ordinary Article 254 repugnancy template is not simply imported into it.
CONSEQUENCE / CONTRAST: Simultaneous legislative power does not mean identical territorial or transaction fields.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that alcohol for human consumption outside GST definition State excise/sales-tax...
ANSWER-GRABBING FORMULATION: Article 246A(1), notwithstanding Articles 246 and 254, gives Parliament and, subject to clause (2), every State legislature power to make laws on GST imposed by the Union or the State.
```
### SESSION 4 — ARTICLE 269A: IGST AND THE INTER-STATE BRIDGE
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 269A: IGST and the inter-State bridge denotes the constitutional rules and institutional links organised around SUPPLIER IN STATE A.

**Technical definition:** Article 269A(1) provides that GST on inter-State supplies is levied and collected by the Government of India and apportioned between Union and States in the manner Parliament provides by law on Council recommendation.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 269A makes IGST a clearing mechanism for inter-State supplies, allowing Union collection with destination-based apportionment rather than creating a separate final tax burden.

#### MUST-WRITE KEYWORDS

- **Article 269A**
- **IGST**
- **the inter-State bridge**
- **Constitution**
- **Articles 246A, 269A, 279A**
- **competence and federal structure**

**How to use them:** Frame the answer through Article 269A; define IGST, connect the inter-State bridge with Constitution to explain the mechanism, and use Articles 246A, 269A, 279A for the decisive comparison or qualification.
...
![Topic-specific visual map: Article 269A: IGST and the inter-State bridge.](assets/04_article_269a_igst_and_the_inter_state_bridge.png)
...
```closure-flow
SUBTOPIC: Article 269A: IGST and the inter-State bridge
KEY TERMS / DEFINITIONS: Article 269A · IGST · the inter-State bridge · Constitution · Articles 246A, 269A, 279A · competence and federal structure
MECHANISM / ARGUMENT: Article 269A(1) provides that GST on inter-State supplies is levied and collected by the Government of India and apportioned between Union and States in the manner Parliament provides by law on Council recommendation.
CONSEQUENCE / CONTRAST: A constitutional answer should not invent accounting formulae and Layer Example Function.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that dESTINATION STATE B receives apportioned revenue significance.
ANSWER-GRABBING FORMULATION: Article 269A makes IGST a clearing mechanism for inter-State supplies, allowing Union collection with destination-based apportionment rather than creating a separate final tax burden.
```
### SESSION 5 — ARTICLE 279A: EXACT COMPOSITION AND INSTITUTIONAL SUPPORT
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Article 279A: exact composition and institutional support denotes the constitutional rules and institutional links organised around The constitutional membership is.

**Technical definition:** Article 279A does not constitutionally create a permanent, separately independent Secretariat.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 279A fixes the Council's voting membership, while its Secretariat and non-voting invitees arise from administrative arrangements rather than additional constitutional seats.
...
**How to use them:** Frame the answer through Article 279A; define exact composition, connect institutional support with Union Finance Minister to explain the mechanism, and use Article 279A(2)(a) for the decisive comparison or qualification.
...
![Topic-specific visual map: Article 279A: exact composition and institutional support.](assets/05_article_279a_exact_composition_and_institutional_sup.png)
...
```closure-flow
SUBTOPIC: Article 279A: exact composition and institutional support
KEY TERMS / DEFINITIONS: Article 279A · exact composition · institutional support · Union Finance Minister · Article 279A(2)(a) · Union vote
MECHANISM / ARGUMENT: Article 279A does not constitutionally create a permanent, separately independent Secretariat.
CONSEQUENCE / CONTRAST: The decisive contrast is between UNION FINANCE MINISTER ---------------- Chairperson and UNION MoS, REVENUE OR FINANCE -------- Member.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that State members choose one among themselves as Vice-Chairperson for...
ANSWER-GRABBING FORMULATION: Article 279A fixes the Council's voting membership, while its Secretariat and non-voting invitees arise from administrative arrangements rather than additional constitutional seats.
```
### SESSION 6 — WHAT EXACTLY MAY THE COUNCIL RECOMMEND?
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** What exactly may the Council recommend? denotes the constitutional rules and institutional links organised around Bucket Exact constitutional subject.

**Technical definition:** Article 279A(5) separately requires the Council to recommend the date on which GST is levied on petroleum crude, high-speed diesel, petrol, natural gas and aviation turbine fuel.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The Council does not acquire a general power to legislate merely because an issue affects GST.
...
**How to use them:** Frame the answer through rates, including floor rates with bands; define any other GST-related matter the Council decides, connect Article 269A with Article 279A to explain the mechanism, and use Council for the decisive comparison or qualification.
...
![Topic-specific visual map: What exactly may the Council recommend?.](assets/06_what_exactly_may_the_council_recommend.png)
...
```closure-flow
SUBTOPIC: What exactly may the Council recommend?
KEY TERMS / DEFINITIONS: rates, including floor rates with bands · any other GST-related matter the Council decides · Article 269A · Article 279A · Council · Bucket Exact
MECHANISM / ARGUMENT: The Council does not acquire a general power to legislate merely because an issue affects GST.
CONSEQUENCE / CONTRAST: The decisive contrast is between 5 rates, including floor rates with bands and 6 special rates for a specified period during natural calamity or disaster.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: article 279A(5) separately requires the Council to recommend the date on which GST is...
ANSWER-GRABBING FORMULATION: The Council does not acquire a general power to legislate merely because an issue affects GST.
```
### SESSION 7 — FROM PROPOSAL TO LEGAL EFFECT
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** From proposal to legal effect denotes the constitutional rules and institutional links organised around officer/committee analysis + State/Union inputs.

**Technical definition:** Legal effect then depends on the constitutional/statutory route: parliamentary or State legislation, amendment of rules, or a Gazette notification by the competent government.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Legal effect then depends on the constitutional/statutory route: parliamentary or State legislation, amendment of rules, or a Gazette notification by the competent government.

#### MUST-WRITE KEYWORDS

- **From proposal to legal effect**
- **GST Council**
- **recommends common design**
- **Parliament or State legislature**
- **Parliament**
- **enacts CGST/IGST and related law**

**How to use them:** Frame the answer through From proposal to legal effect; define GST Council, connect recommends common design with Parliament or State legislature to explain the mechanism, and use Parliament for the decisive comparison or qualification.
...
![Topic-specific visual map: From proposal to legal effect.](assets/07_from_proposal_to_legal_effect.png)
...
```closure-flow
SUBTOPIC: From proposal to legal effect
KEY TERMS / DEFINITIONS: From proposal to legal effect · GST Council · recommends common design · Parliament or State legislature · Parliament · enacts CGST/IGST and related law
MECHANISM / ARGUMENT: Legal effect then depends on the constitutional/statutory route: parliamentary or State legislation, amendment of rules, or a Gazette notification by the competent government.
CONSEQUENCE / CONTRAST: Its principal consequence is that law / rule / notification / portal implementation.
UPSC TRAP / ANSWER-USE: The decisive contrast is between administration, litigation and feedback and Actor Constitutional/statutory role Cannot be confused with.
ANSWER-GRABBING FORMULATION: Legal effect then depends on the constitutional/statutory route: parliamentary or State legislation, amendment of rules, or a Gazette notification by the competent government.
```
### SESSION 8 — QUORUM, WEIGHTED VOTING AND COALITION ARITHMETIC
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Quorum, weighted voting and coalition arithmetic denotes the constitutional rules and institutional links organised around One-half of the total Council membership constitutes quorum.

**Technical definition:** Abstentions change the denominator because Article 279A(9) refers to members present and voting, not every member on the constitutional roll.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Therefore, when the Union supports a proposal, at least five-eighths of the State votes present and voting must support it, subject to rounding to a whole number of States.
...
- **yes**
- **passes**
- **1/3 + (13/20 x 2/3) = 0.7667**

**How to use them:** Frame the answer through Quorum; define weighted voting, connect coalition arithmetic with yes to explain the mechanism, and use passes for the decisive comparison or qualification.
...
![Topic-specific visual map: Quorum, weighted voting and coalition arithmetic.](assets/08_quorum_weighted_voting_and_coalition_arithmetic.png)
...
```closure-flow
SUBTOPIC: Quorum, weighted voting and coalition arithmetic
KEY TERMS / DEFINITIONS: Quorum · weighted voting · coalition arithmetic · yes · passes · 1/3 + (13/20 x 2/3) = 0.7667
MECHANISM / ARGUMENT: Abstentions change the denominator because Article 279A(9) refers to members present and voting, not every member on the constitutional roll.
CONSEQUENCE / CONTRAST: A decision requires not less than three-fourths of the weighted votes of members present and voting.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the decisive contrast is between Union yes = 1/3 = 4/12 and remaining weighted...
ANSWER-GRABBING FORMULATION: Therefore, when the Union supports a proposal, at least five-eighths of the State votes present and voting must support it, subject to rounding to a whole number of States.
```
### SESSION 9 — PROCEDURE, RECORDS AND INSTITUTIONAL ACCOUNTABILITY
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Procedure, records and institutional accountability denotes the constitutional rules and institutional links organised around STATE/UNION POSITIONS.

**Technical definition:** Its principal consequence is that aUDIT / LEGISLATIVE SCRUTINY / COURT REVIEW.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Reasoned records and timely publication strengthen GST Council accountability because tax coordination affects prices, revenue and State autonomy, although disclosure remains subject to lawful confidentiality.
...
- **Procedure, records and institutional accountability**
- **UNION POSITIONS**
- **Its principal consequence**

**How to use them:** Frame the answer through Procedure; define records, connect institutional accountability with Procedure, records and institutional accountability to explain the mechanism, and use UNION POSITIONS for the decisive comparison or qualification.
...
![Topic-specific visual map: Procedure, records and institutional accountability.](assets/09_procedure_records_and_institutional_accountability.png)
...
```closure-flow
SUBTOPIC: Procedure, records and institutional accountability
KEY TERMS / DEFINITIONS: Procedure · records · institutional accountability · Procedure, records and institutional accountability · UNION POSITIONS · Its principal consequence
MECHANISM / ARGUMENT: Its principal consequence is that aUDIT / LEGISLATIVE SCRUTINY / COURT REVIEW.
CONSEQUENCE / CONTRAST: The decisive contrast is between STATE/UNION POSITIONS and STATE/UNION POSITIONS.
UPSC TRAP / ANSWER-USE: A reform demand for fuller reasons must be labelled a proposal, not current constitutional law.
ANSWER-GRABBING FORMULATION: Reasoned records and timely publication strengthen GST Council accountability because tax coordination affects prices, revenue and State autonomy, although disclosure remains subject to lawful confidentiality.
```
### SESSION 10 — GST MECHANICS THE COUNCIL INFLUENCES BUT DOES NOT ITSELF LEVY
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** GST mechanics the Council influences but does not itself levy denotes the constitutional rules and institutional links organised around Transaction Broad levy form Revenue logic.

**Technical definition:** GST mechanics the Council influences but does not itself levy operates through intra-State supply CGST + SGST/UTGST shared tax base through parallel laws, connected with inter-State supply IGST Union collection with credit and settlement.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> CGST Act section 9(1) authorises notified rates on Council recommendation within the statutory ceiling.

#### MUST-WRITE KEYWORDS

- **intra-State supply**
- **CGST + SGST/UTGST**
- **shared tax base through parallel laws**
- **inter-State supply**
- **IGST**
- **Union collection with credit and settlement**

**How to use them:** Frame the answer through intra-State supply; define CGST + SGST/UTGST, connect shared tax base through parallel laws with inter-State supply to explain the mechanism, and use IGST for the decisive comparison or qualification.
...
![Topic-specific visual map: GST mechanics the Council influences but does not itself levy.](assets/10_gst_mechanics_the_council_influences_but_does_not_it.png)
#### 10.1 Dual GST
...
```closure-flow
SUBTOPIC: GST mechanics the Council influences but does not itself levy
KEY TERMS / DEFINITIONS: intra-State supply · CGST + SGST/UTGST · shared tax base through parallel laws · inter-State supply · IGST · Union collection with credit and settlement
MECHANISM / ARGUMENT: GST mechanics the Council influences but does not itself levy denotes the constitutional rules and institutional links organised around Transaction Broad levy form Revenue logic.
CONSEQUENCE / CONTRAST: Its principal consequence is that export/SEZ qualifying supply zero-rated under IGST law output burden relieved with credit/refund route subject to law.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the decisive contrast is between 2 Input-tax credit and INPUT PURCHASE.
ANSWER-GRABBING FORMULATION: CGST Act section 9(1) authorises notified rates on Council recommendation within the statutory ceiling.
```
### SESSION 11 — CONSTITUTIONAL AND STATUTORY BOUNDARIES: ALCOHOL, PETROLEUM AND ELECTRICITY
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Constitutional and statutory boundaries: alcohol, petroleum and electricity denotes the constitutional rules and institutional links organised around Item Legal position Correct wording.

**Technical definition:** Constitutional exclusion, deferred commencement, retained tax entry and notification-based exemption are distinct.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> State List Entry 54 retains taxes on sale of the specified petroleum products and alcoholic liquor for human consumption, subject to the entry's limits.
...
**How to use them:** Frame the answer through Constitutional; define statutory boundaries, connect alcohol with petroleum to explain the mechanism, and use electricity for the decisive comparison or qualification.
...
![Topic-specific visual map: Constitutional and statutory boundaries: alcohol, petroleum and electricity.](assets/11_constitutional_and_statutory_boundaries_alcohol_petr.png)
...
```closure-flow
SUBTOPIC: Constitutional and statutory boundaries: alcohol, petroleum and electricity
KEY TERMS / DEFINITIONS: Constitutional · statutory boundaries · alcohol · petroleum · electricity · alcoholic liquor for human consumption
MECHANISM / ARGUMENT: Constitutional exclusion, deferred commencement, retained tax entry and notification-based exemption are distinct.
CONSEQUENCE / CONTRAST: Its principal consequence is that item Legal position Correct wording.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the decisive contrast is between Item Legal position Correct wording and Item Legal position...
ANSWER-GRABBING FORMULATION: State List Entry 54 retains taxes on sale of the specified petroleum products and alcoholic liquor for human consumption, subject to the entry's limits.
```
### SESSION 12 — GST COMPENSATION: THE TRANSITION BARGAIN
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** GST compensation: the transition bargain denotes the constitutional rules and institutional links organised around The five-year compensation period ended in June 2022.

**Technical definition:** The Compensation to States Act defines the transition period as five years from the transition date.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> GST compensation was a five-year statutory transition guarantee that sustained federal trust, not a permanent constitutional entitlement directly administered by the Council.

#### MUST-WRITE KEYWORDS

- **GST compensation**
- **the transition bargain**
- **constitutional direction**
- **section 18 of 101st Amendment**
- **perpetual payment guarantee**
- **Compensation Act formula**

**How to use them:** Frame the answer through GST compensation; define the transition bargain, connect constitutional direction with section 18 of 101st Amendment to explain the mechanism, and use perpetual payment guarantee for the decisive comparison or qualification.
...
![Topic-specific visual map: GST compensation: the transition bargain.](assets/12_gst_compensation_the_transition_bargain.png)
...
```closure-flow
SUBTOPIC: GST compensation: the transition bargain
KEY TERMS / DEFINITIONS: GST compensation · the transition bargain · constitutional direction · section 18 of 101st Amendment · perpetual payment guarantee · Compensation Act formula
MECHANISM / ARGUMENT: Compensation was a statutory transition guarantee; it was not a permanent constitutional entitlement administered directly by the Council.
CONSEQUENCE / CONTRAST: The decisive contrast is between COMPENSATION PAYABLE, subject to audit and statutory calculation and 2017-2022 five-year transition protection.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: its principal consequence is that minus ACTUAL REVENUE defined by the Act.
ANSWER-GRABBING FORMULATION: GST compensation was a five-year statutory transition guarantee that sustained federal trust, not a permanent constitutional entitlement directly administered by the Council.
```
### SESSION 13 — UNION OF INDIA V. MOHIT MINERALS (2022)
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mohit Minerals is the controlling GST Council decision explaining that Council recommendations guide cooperative bargaining but do not command legislatures.

**Technical definition:** The Mohit Minerals doctrine distinguishes persuasive Article 279A recommendations from binding statutory conditions imposed on delegated executive action under GST legislation.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mohit Minerals preserves both sides of the GST compact: legislatures retain Article 246A authority, while Council recommendations remain central to coordinated fiscal decision-making.
...
**How to use them:** Use Mohit Minerals with Article 279A and Article 246A to distinguish persuasive recommendation, simultaneous legislative power and statute-bound delegated action before evaluating cooperative federalism.
...
![Topic-specific visual map: *Union of India v. Mohit Minerals* (2022).](assets/13_union_of_india_v_mohit_minerals_2022.png)
...
#### CLOSING RECALL FLOW — UNION OF INDIA V. MOHIT MINERALS (2022)

```closure-flow
SUBTOPIC: Union of India v. Mohit Minerals (2022)
KEY TERMS / DEFINITIONS: Mohit Minerals · Article 279A · Article 246A · persuasive recommendation · simultaneous legislative power · delegated action
...
ANSWER-GRABBING FORMULATION: Mohit Minerals preserves both sides of the GST compact: legislatures retain Article 246A authority, while Council recommendations remain central to coordinated fiscal decision-making.
```
### SESSION 14 — COOPERATIVE, COMPETITIVE AND CONFRONTATIONAL FEDERALISM
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Cooperative, competitive and confrontational federalism denotes the constitutional rules and institutional links organised around UNION gives up unilateral control over a fully central indirect-tax design.

**Technical definition:** The decisive contrast is between Mode GST example Value Risk and cooperative consensus on common rules and procedures harmonisation unequal bargaining may be hidden.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> State autonomy shifted from unilateral rate-setting toward negotiated rule-making plus retained legislative competence after Mohit Minerals.
...
- **pooled sovereignty**
- **consensus on common rules and procedures**
- **harmonisation**

**How to use them:** Frame the answer through Cooperative; define competitive, connect confrontational federalism with pooled sovereignty to explain the mechanism, and use consensus on common rules and procedures for the decisive comparison or qualification.
...
![Topic-specific visual map: Cooperative, competitive and confrontational federalism.](assets/14_cooperative_competitive_and_confrontational_federali.png)
...
```closure-flow
SUBTOPIC: Cooperative, competitive and confrontational federalism
KEY TERMS / DEFINITIONS: Cooperative · competitive · confrontational federalism · pooled sovereignty · consensus on common rules and procedures · harmonisation
MECHANISM / ARGUMENT: The decisive contrast is between Mode GST example Value Risk and cooperative consensus on common rules and procedures harmonisation unequal bargaining may be hidden.
CONSEQUENCE / CONTRAST: Its principal consequence is that GST is better described as pooled sovereignty than as either complete centralisation or complete State autonomy.
UPSC TRAP / ANSWER-USE: The exchange is real, not costless.
ANSWER-GRABBING FORMULATION: State autonomy shifted from unilateral rate-setting toward negotiated rule-making plus retained legislative competence after Mohit Minerals.
```
### SESSION 15 — RECURRING CONFLICTS AND ARTICLE 279A(11)
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Recurring conflicts and Article 279A(11) denotes the constitutional rules and institutional links organised around This is an intergovernmental dispute clause.

**Technical definition:** [CURRENT] No complete, separately published Article 279A(11) adjudicatory mechanism was located in the official public material reviewed for this control date.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 279A(11) requires an intergovernmental dispute mechanism for recommendation-related conflicts, but it is not the statutory appeal route for individual taxpayers.

#### MUST-WRITE KEYWORDS

- **Recurring conflicts**
- **Article 279A(11)**
- **Government of India versus one or more States**
- **yes**
- **two or more States**
- **taxpayer versus assessing officer**

**How to use them:** Frame the answer through Recurring conflicts; define Article 279A(11), connect Government of India versus one or more States with yes to explain the mechanism, and use two or more States for the decisive comparison or qualification.
...
```closure-flow
SUBTOPIC: Recurring conflicts and Article 279A(11)
KEY TERMS / DEFINITIONS: Recurring conflicts · Article 279A(11) · Government of India versus one or more States · yes · two or more States · taxpayer versus assessing officer
MECHANISM / ARGUMENT: [CURRENT] No complete, separately published Article 279A(11) adjudicatory mechanism was located in the official public material reviewed for this control date.
CONSEQUENCE / CONTRAST: Its principal consequence is that two or more States yes.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the decisive contrast is between taxpayer versus assessing officer no.
ANSWER-GRABBING FORMULATION: Article 279A(11) requires an intergovernmental dispute mechanism for recommendation-related conflicts, but it is not the statutory appeal route for individual taxpayers.
```
### SESSION 16 — INSTITUTIONAL COMPARISON
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Institutional comparison denotes the constitutional rules and institutional links organised around Dimension GST Council Finance Commission Inter-State Council Zonal Councils.

**Technical definition:** Technically, Institutional comparison is analysed by relating base to Article 279A, then testing the relationship through Article 280 and Article 263 enables establishment; 1990 order.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> The GST Council coordinates a shared tax base, while the Finance Commission, Inter-State Council and Zonal Councils perform distinct redistributive or deliberative federal functions.
...
- **Article 279A**
- **Article 280**
- **Article 263 enables establishment; 1990 order**
- **States Reorganisation Act, 1956**

**How to use them:** Frame the answer through Institutional comparison; define base, connect Article 279A with Article 280 to explain the mechanism, and use Article 263 enables establishment; 1990 order for the decisive comparison or qualification.
...
![Topic-specific visual map: Institutional comparison.](assets/15_institutional_comparison.png)
...
```closure-flow
SUBTOPIC: Institutional comparison
KEY TERMS / DEFINITIONS: Institutional comparison · base · Article 279A · Article 280 · Article 263 enables establishment; 1990 order · States Reorganisation Act, 1956
MECHANISM / ARGUMENT: Its principal consequence is that output recommendations recommendations to President advice/recommendations deliberative recommendations.
CONSEQUENCE / CONTRAST: The decisive contrast is between key trap does not devolve divisible pool does not set GST rates not a GST rate body statutory, not constitutional and GST RATE / EXEMPTION / MODEL LAW? ---------- GST COUNCIL.
UPSC TRAP / ANSWER-USE: They interact in fiscal federalism but perform different constitutional jobs.
ANSWER-GRABBING FORMULATION: The GST Council coordinates a shared tax base, while the Finance Commission, Inter-State Council and Zonal Councils perform distinct redistributive or deliberative federal functions.
```
### SESSION 17 — ACCOUNTABILITY AND REFORM AGENDA
#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Accountability and reform agenda denotes the constitutional rules and institutional links organised around Present law already supplies membership, quorum, weighted voting, recommendations, statutory implementation and judicial review.

**Technical definition:** Reform should improve evidence, reasons, federal trust and administrative simplicity without pretending that a proposal is enacted law.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Reform should improve evidence, reasons, federal trust and administrative simplicity without pretending that a proposal is enacted law.

#### MUST-WRITE KEYWORDS

- **Accountability**
- **reform agenda**
- **publish fuller minutes and reasons**
- **opaque trade-offs**
- **protect legitimately confidential taxpayer data**
- **independent revenue/distribution modelling**

**How to use them:** Frame the answer through Accountability; define reform agenda, connect publish fuller minutes and reasons with opaque trade-offs to explain the mechanism, and use protect legitimately confidential taxpayer data for the decisive comparison or qualification.
...
```closure-flow
SUBTOPIC: Accountability and reform agenda
KEY TERMS / DEFINITIONS: Accountability · reform agenda · publish fuller minutes and reasons · opaque trade-offs · protect legitimately confidential taxpayer data · independent revenue/distribution modelling
MECHANISM / ARGUMENT: Reform should improve evidence, reasons, federal trust and administrative simplicity without pretending that a proposal is enacted law.
CONSEQUENCE / CONTRAST: Its principal consequence is that operationalise Article 279A(11) unresolved intergovernmental disputes define jurisdiction, neutrality and review.
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the decisive contrast is between stable rate-review calendar frequent compliance change emergency flexibility retained...
ANSWER-GRABBING FORMULATION: Reform should improve evidence, reasons, federal trust and administrative simplicity without pretending that a proposal is enacted law.
```
...
B. by the Council Secretariat.
C. by State members from among themselves for a period they decide.
...
A. The Secretariat is an administrative arrangement supporting the constitutional Council.
B. The Constitution creates an independent permanent GST civil service.
C. The CBIC Chairperson carries the Union's one-third vote.
...
A. customs duty on crude oil.
B. permanent exclusion of every petroleum product.
C. the date for GST levy on five specified petroleum products.
...
B. one-third of voting States.
C. one-half of total Council members.
...
A. at least three-fourths of weighted votes present and voting.
B. simple majority of persons present.
C. unanimity.
...
C. Union one-third; States together two-thirds.
D. Union two-thirds; States one-third.
...
B. It is a preferred practice operating alongside the formal Article 279A(9) rule.
C. It requires judicial certification.
...
A. must be followed through the competent legal instrument for enforceable effect.
B. is equivalent to a Supreme Court order.
C. binds consumers before any effective date.
D. automatically amends every GST Act.
...
B. transfer GST Council votes.
C. replace every tax with a fee.
D. reduce cascading by crediting eligible input tax against output liability.
...
C. output is exported.
D. the input tax rate exceeds the output tax rate.
...
B. zero-rated supply under the IGST framework.
C. every non-GST supply.
D. every exempt domestic supply.
...
A. merely deferred under Article 279A(5).
B. zero-rated by Article 269A.
C. excluded from the GST definition by Article 366(12A).
...
B. Electricity duty was constitutionally converted into IGST.
C. Electricity is excluded by the same words as alcohol in Article 366(12A).
D. State List Entry 53 retains tax on consumption or sale of electricity; GST supply treatment also depends on law/notification.
...
A. 2017-18.
B. financial year ending 31 March 2016.
C. 2016-17.
D. 2019-20.
...
A. ten years from enactment.
B. permanent.
C. dependent on each Finance Commission.
D. five years from the transition date.
...
A. the executive must satisfy the statutory condition.
B. the recommendation automatically becomes primary law.
C. only States must comply.
D. the executive may ignore the condition.
...
A. imports cannot be inter-State supplies.
B. the Council lacked any power to discuss freight.
C. Article 279A was repealed.
D. it conflicted with the statutory composite-supply scheme and duplicated the freight component.
...
A. intergovernmental disputes arising from Council recommendations or implementation.
B. private commercial arbitration.
...
C. a broad advisory coordination forum enabled by Article 263.
D. a periodic expert tax commission.
...
A. Article 279A replaced State Finance Commissions.
B. Subsuming entry tax/octroi can affect local own-revenue space, requiring State-local fiscal adjustment.
...
B. the 55th meeting only.
C. no official release.
D. the 56th meeting release of 3 September 2025.
...
A. identify the applicable notification, classification, conditions and effective date.
B. rely only on coaching summaries.
C. assume every recommendation was notified unchanged.
...
A. unanimity.
B. two-thirds, so the proposal fails.
C. four-fifths.
D. three-fourths.
...
C. primary legislatures retain power, while delegated action remains governed by its statute.
D. States may ignore every statutory condition.
...
C. exempt and zero-rated always have identical ITC consequences.
D. zero-rating can preserve credit/refund pathways unlike ordinary exemption.
...
A. Article 279A makes the Secretariat a fourth constitutional government.
B. CBIC Chair is a non-voting permanent invitee.
C. the Secretariat supports Council proceedings.
D. Revenue Secretary is ex-officio Secretary by administrative arrangement.
...
A. “All 2025 recommendations were self-executing.”
B. “As of 24 August 2026, the latest official meeting release located is the 56th meeting release of 3 September 2025.”
...
B. it is excluded by Article 366(12A) exactly like alcohol.
C. State Entry 53 and applicable GST notifications must be distinguished.
...
#### ASCII MASTER FLOW — PANEL 1/9: From fragmented indirect taxes to the 101st Amendment compact
...
#### ASCII MASTER FLOW — PANEL 2/9: Articles 246A, 269A and 286: CGST, SGST and IGST legal architecture
...
#### ASCII MASTER FLOW — PANEL 3/9: Article 279A composition, quorum, weighted vote and recommendation fields
...
#### ASCII MASTER FLOW — PANEL 4/9: Secretariat, procedure, recommendation-to-law chain and disputes
...
#### ASCII MASTER FLOW — PANEL 5/9: Tax-base boundaries: alcohol, petroleum, electricity, rates and input credit
...
#### ASCII MASTER FLOW — PANEL 6/9: GST compensation bargain and dated post-transition boundary
...
#### ASCII MASTER FLOW — PANEL 7/9: Mohit Minerals (2022): persuasion, legislation and delegated action
...
#### ASCII MASTER FLOW — PANEL 8/9: Federal bargaining, Finance Commission comparison and technology-compliance loop
...
#### ASCII MASTER FLOW — PANEL 9/9: Current anchors, PYQ routes, traps and qualified synthesis
