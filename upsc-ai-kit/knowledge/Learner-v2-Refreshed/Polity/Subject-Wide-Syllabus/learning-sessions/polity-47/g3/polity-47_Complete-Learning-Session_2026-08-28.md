...
Use 48 hard application MCQs in strict A → B → C → D rotation. Distractors must test false equivalence, source-versus-operation, constitutional text, institutional powers and comparative consequences.

### Seed MCQ 1
Which statement best distinguishes India from the United Kingdom?
A. India combines parliamentary government with constitutional supremacy and judicial review.
B. Both locate unlimited legal sovereignty in Parliament.
C. UK courts routinely invalidate Westminster Acts.
D. India borrowed British parliamentary sovereignty without alteration.
**Answer: A.** India adopted responsible government within a written supreme Constitution.

### Seed MCQ 2
Which statement about territorial chambers is accurate?
A. All federal upper houses possess identical money-bill powers.
B. The Bundesrat represents Land governments, unlike Rajya Sabha's indirect legislative election.
C. Canada's Senate consists of provincial-government delegates.
D. Rajya Sabha and the US Senate give every State equal representation.
**Answer: B.** Selection and territorial mandate differ across upper houses.

### Seed MCQ 3
Which comparison of constitutional rights is most accurate?
A. Irish directive principles and South African socio-economic rights are identically enforceable.
B. The US Constitution contains an Indian-style DPSP chapter.
C. South Africa textually protects justiciable socio-economic rights, while India's DPSPs guide governance.
D. India's DPSPs are ordinary judicially enforceable claims.
**Answer: C.** Text, justiciability and remedy must remain distinct.

### Seed MCQ 4
Which statement best describes constitutional borrowing?
A. A shared source guarantees operational identity.
B. A borrowed title proves equal constitutional power.
C. Borrowed institutions remain insulated from local party systems.
D. Indian text, structure, doctrine and practice can transform a source influence into a distinct design.
**Answer: D.** Borrowing identifies ancestry; adaptation explains present operation.
