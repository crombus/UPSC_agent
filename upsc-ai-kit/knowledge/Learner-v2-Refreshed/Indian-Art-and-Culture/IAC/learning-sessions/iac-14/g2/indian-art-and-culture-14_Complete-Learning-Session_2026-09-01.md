---
title: "Heritage Conservation, Institutions and UNESCO — Learner-v2 Refreshed"
topic_key: indian-art-and-culture-14
cover_image: assets/indian-art-and-culture-14_Teaching-Navigation_2026-09-01.png
---
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Indian-Art-and-Culture\basic\14_Heritage-Conservation-Institutions-and-UNESCO.md`  
**Canonical topic owner:** `upsc-ai-kit\knowledge\Indian-Art-and-Culture\basic\14_Heritage-Conservation-Institutions-and-UNESCO.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Indian-Art-and-Culture\advanced\14_Heritage-Conservation-Institutions-and-UNESCO.md`  
...
- **Current-status note, rechecked 2026-09-01:** UNESCO's property page and the Ministry of Culture announcement were fetched on 2026-09-01. They describe the Maratha Military Landscapes as a serial network of twelve forts, mostly in Maharashtra with one in Tamil Nadu, and the Ministry page records the 2025 inscription as India's forty-fourth World Heritage entry. The package uses the named property, components and strategic-landscape logic; no later count or conservation outcome is inferred.

**Live/official context sources recorded by the predecessor generation:**

- `https://whc.unesco.org/en/list/1739`
- `https://culture.gov.in/latest-news/maratha-military-landscapes-india-added-unesco-world-heritage-list`



![Refreshed teaching navigation](assets/indian-art-and-culture-14_Teaching-Navigation_2026-09-01.png)
...
**Plain-language definition:** Evidence chain: Four-category firewall - World Heritage mechanism - Intangible heritage mechanism - Memory of the World mechanism - GI is domestic IP Qualified use: Prevent the most frequent heritage-status error.

**Technical definition:** World Heritage properties are inscribed under the 1972 Convention for cultural, natural or mixed outstanding universal value by the World Heritage Committee with advisory bodies; inscription is an obligation, not a transfer of sovereignty.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Evidence chain: Four-category firewall - World Heritage mechanism - Intangible heritage mechanism - Memory of the World mechanism - GI is domestic IP Qualified use: Prevent the most frequent heritage-status error.
...
**How to use them:** Frame the answer through FOUNDATION; define The four-category firewall, connect Evidence chain with Qualified use to explain the mechanism, and use World Heritage for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — THE FOUR-CATEGORY FIREWALL

```text
START / CONCEPT: FOUNDATION — The four-category firewall
        |
        v
EXACT TERMS: FOUNDATION · The four-category firewall · Evidence chain · Qualified use · World Heritage · Intangible Cultural Heritage
        |
        v
MECHANISM / ARGUMENT: World Heritage properties are inscribed under the 1972 Convention for cultural, natural or mixed outstanding universal value by the World Heritage Committee with advisory bodies; inscription is an obligation, not a transfer of sovereignty.
        |
        v
CONSEQUENCE / CONTRAST: The 2003 Convention covers living practices, expressions, knowledge and skills through the Representative List, Urgent Safeguarding List and Register of Good Safeguarding Practices; recognition alone does not ensure transmission.
        |
        v
UPSC TRAP / ANSWER-USE: A Geographical Indication is origin-linked intellectual property under India's GI Act and GI Registry, not a UNESCO programme or general heritage-quality mark.
        |
        v
ANSWER-GRABBING FORMULATION: Evidence chain: Four-category firewall - World Heritage mechanism - Intangible heritage mechanism - Memory of the World mechanism - GI is domestic IP Qualified use: Prevent the most frequent heritage-status error.
```
### SESSION 2 — FOUNDATION — WORLD HERITAGE AS CONDITIONAL OBLIGATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** World Heritage properties are inscribed under the 1972 Convention for cultural, natural or mixed outstanding universal value by the World Heritage Committee with advisory bodies; inscription is an obligation, not a transfer of sovereignty.

**Technical definition:** Evidence chain: World Heritage mechanism - Danger List conditionality Qualified use: Evaluate benefit, duty and Danger List leverage.
...
**How to use them:** Frame the answer through FOUNDATION; define World Heritage as conditional obligation, connect Evidence chain with Qualified use to explain the mechanism, and use World Heritage properties for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — WORLD HERITAGE AS CONDITIONAL OBLIGATION

```text
START / CONCEPT: FOUNDATION — World Heritage as conditional obligation
        |
        v
EXACT TERMS: FOUNDATION · World Heritage as conditional obligation · Evidence chain · Qualified use · World Heritage properties · World Heritage
        |
        v
MECHANISM / ARGUMENT: Evidence chain: World Heritage mechanism - Danger List conditionality Qualified use: Evaluate benefit, duty and Danger List leverage.
        |
        v
CONSEQUENCE / CONTRAST: Manas and Hampi were once on the List of World Heritage in Danger and were later removed after improvement, proving that inscription remains conditional on continuing management.
        |
        v
UPSC TRAP / ANSWER-USE: Inscription does not transfer sovereignty or guarantee permanence.
        |
        v
ANSWER-GRABBING FORMULATION: World Heritage properties are inscribed under the 1972 Convention for cultural, natural or mixed outstanding universal value by the World Heritage Committee with advisory bodies; inscription is an obligation, not a transfer of sovereignty.
```
### SESSION 3 — FOUNDATION — LIVING AND DOCUMENTARY HERITAGE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The 2003 Convention covers living practices, expressions, knowledge and skills through the Representative List, Urgent Safeguarding List and Register of Good Safeguarding Practices; recognition alone does not ensure transmission.

**Technical definition:** Evidence chain: Intangible heritage mechanism - Memory of the World mechanism Qualified use: Compare ICH and Memory of the World.
...
**How to use them:** Frame the answer through FOUNDATION; define Living, connect documentary heritage with Evidence chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — LIVING AND DOCUMENTARY HERITAGE

```text
START / CONCEPT: FOUNDATION — Living and documentary heritage
        |
        v
EXACT TERMS: FOUNDATION · Living · documentary heritage · Evidence chain · Qualified use · Convention
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Intangible heritage mechanism - Memory of the World mechanism Qualified use: Compare ICH and Memory of the World.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that the 2003 Convention covers living practices, expressions, knowledge and skills through the Representative List...
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the 2003 Convention covers living practices, expressions, knowledge and skills through the Representative List...
        |
        v
ANSWER-GRABBING FORMULATION: The 2003 Convention covers living practices, expressions, knowledge and skills through the Representative List, Urgent Safeguarding List and Register of Good Safeguarding Practices; recognition alone does not ensure transmission.
```
### SESSION 4 — CORE — ASI AND THE STATUTORY BASE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Evidence chain: ASI and its statutes Qualified use: Name the monument-and-antiquities owner precisely.

**Technical definition:** The Archaeological Survey of India was established in 1861 under Alexander Cunningham and functions through the AMASR Act, 1958 and Antiquities and Art Treasures Act, 1972 for monuments, archaeology and antiquities.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Evidence chain: ASI and its statutes Qualified use: Name the monument-and-antiquities owner precisely.
...
**How to use them:** Frame the answer through ASI; define the statutory base, connect Evidence chain with Qualified use to explain the mechanism, and use The Archaeological Survey for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — ASI AND THE STATUTORY BASE

```text
START / CONCEPT: CORE — ASI and the statutory base
        |
        v
EXACT TERMS: ASI · the statutory base · Evidence chain · Qualified use · The Archaeological Survey · India
        |
        v
MECHANISM / ARGUMENT: The Archaeological Survey of India was established in 1861 under Alexander Cunningham and functions through the AMASR Act, 1958 and Antiquities and Art Treasures Act, 1972 for monuments, archaeology and antiquities.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that aSI and its statutes Qualified use.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: aSI and its statutes Qualified use.
        |
        v
ANSWER-GRABBING FORMULATION: Evidence chain: ASI and its statutes Qualified use: Name the monument-and-antiquities owner precisely.
```
### SESSION 5 — CORE — AKADEMIS AND CULTURAL INSTITUTIONS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Evidence chain: Akademi mandate map - Documentary and research institutions Qualified use: Build an institution-by-function map.

**Technical definition:** Sahitya Akademi serves literature, Sangeet Natak Akademi performing arts and Lalit Kala Akademi fine arts; founding dates and programmes do not make their mandates interchangeable.
...
**How to use them:** Frame the answer through Akademis; define cultural institutions, connect Evidence chain with Qualified use to explain the mechanism, and use Sahitya Akademi for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — AKADEMIS AND CULTURAL INSTITUTIONS

```text
START / CONCEPT: CORE — Akademis and cultural institutions
        |
        v
EXACT TERMS: Akademis · cultural institutions · Evidence chain · Qualified use · Sahitya Akademi · Sangeet Natak Akademi
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Akademi mandate map - Documentary and research institutions Qualified use: Build an institution-by-function map.
        |
        v
CONSEQUENCE / CONTRAST: Overlapping projects do not erase primary mandates.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: sahitya Akademi serves literature, Sangeet Natak Akademi performing arts and Lalit Kala Akademi fine...
        |
        v
ANSWER-GRABBING FORMULATION: Sahitya Akademi serves literature, Sangeet Natak Akademi performing arts and Lalit Kala Akademi fine arts; founding dates and programmes do not make their mandates interchangeable.
```
### SESSION 6 — CORE — CONSTITUTIONAL HERITAGE DUTIES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Evidence chain: Constitutional heritage frame Qualified use: Give the domestic normative frame.

**Technical definition:** Articles have different right, State-duty and citizen-duty structures.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Evidence chain: Constitutional heritage frame Qualified use: Give the domestic normative frame.
...
**How to use them:** Frame the answer through Constitutional heritage duties; define Evidence chain, connect Qualified use with Article 29 to explain the mechanism, and use Article 49 for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — CONSTITUTIONAL HERITAGE DUTIES

```text
START / CONCEPT: CORE — Constitutional heritage duties
        |
        v
EXACT TERMS: Constitutional heritage duties · Evidence chain · Qualified use · Article 29 · Article 49 · Article 51A
        |
        v
MECHANISM / ARGUMENT: Articles have different right, State-duty and citizen-duty structures.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that evidence chain: Constitutional heritage frame Qualified use: Give the domestic normative frame.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: evidence chain: Constitutional heritage frame Qualified use: Give the domestic normative frame.
        |
        v
ANSWER-GRABBING FORMULATION: Evidence chain: Constitutional heritage frame Qualified use: Give the domestic normative frame.
```
### SESSION 7 — CORE — AMASR ZONES AND UNESCO BUFFERS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The generally prohibited first 100 metres and regulated next 200 metres around a centrally protected monument arise from Indian statute and are not UNESCO buffer zones mapped through nomination and management documents.

**Technical definition:** Evidence chain: AMASR zone firewall Qualified use: Prepare a close-option legal distinction.
...
**How to use them:** Frame the answer through AMASR zones; define UNESCO buffers, connect Evidence chain with Qualified use to explain the mechanism, and use Indian for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — AMASR ZONES AND UNESCO BUFFERS

```text
START / CONCEPT: CORE — AMASR zones and UNESCO buffers
        |
        v
EXACT TERMS: AMASR zones · UNESCO buffers · Evidence chain · Qualified use · Indian · UNESCO
        |
        v
MECHANISM / ARGUMENT: Evidence chain: AMASR zone firewall Qualified use: Prepare a close-option legal distinction.
        |
        v
CONSEQUENCE / CONTRAST: Domestic statutory distance is not an international management boundary.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the generally prohibited first 100 metres and regulated next 200 metres around a centrally...
        |
        v
ANSWER-GRABBING FORMULATION: The generally prohibited first 100 metres and regulated next 200 metres around a centrally protected monument arise from Indian statute and are not UNESCO buffer zones mapped through nomination and management documents.
```
### SESSION 8 — CORE — THREATS AND INSTRUMENT FIT

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Heritage threats require different responses because visitor pressure, construction, climate, illicit trade and transmission loss damage different cultural assets.

**Technical definition:** Heritage threat and instrument fit is the source-bounded assignment of each documented damage mechanism to the competent statute, conservation method, archive, cultural institution, funding tool or livelihood intervention.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Heritage policy succeeds when the response fits the mechanism of loss rather than when every institution is listed.
...
**How to use them:** Map visitor load to access management, urban construction and climate pressure to regulation and monitoring, illicit trade to antiquities law, and transmission loss to practitioner support; then qualify the instrument fit through capacity and community rights.
...
#### CLOSING RECALL FLOW — CORE — THREATS AND INSTRUMENT FIT

```text
START / CONCEPT: CORE — Threats and instrument fit
        |
        v
EXACT TERMS: visitor load · urban construction · climate pressure · illicit trade · transmission loss · instrument fit
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Threat-to-instrument matching Qualified use: Convert a generic threat list into policy analysis.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that convert a generic threat list into policy analysis.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: convert a generic threat list into policy analysis.
        |
        v
ANSWER-GRABBING FORMULATION: Heritage policy succeeds when the response fits the mechanism of loss rather than when every institution is listed.
```
### SESSION 9 — CORE — CONSERVATION VERSUS RESTORATION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Evidence chain: Conservation and restoration Qualified use: Explain authenticity and reversibility.

**Technical definition:** Conservation stabilises and retains fabric through minimum documented intervention, while restoration returns an object to a selected earlier state and therefore raises greater authenticity and reversibility risks.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Evidence chain: Conservation and restoration Qualified use: Explain authenticity and reversibility.
...
- **Conservation**
- **Qualified**
- **CORE — Conservation versus restoration**

**How to use them:** Frame the answer through Conservation versus restoration; define Evidence chain, connect Qualified use with Conservation to explain the mechanism, and use Qualified for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — CONSERVATION VERSUS RESTORATION

```text
START / CONCEPT: CORE — Conservation versus restoration
        |
        v
EXACT TERMS: Conservation versus restoration · Evidence chain · Qualified use · Conservation · Qualified · CORE — Conservation versus restoration
        |
        v
MECHANISM / ARGUMENT: Conservation stabilises and retains fabric through minimum documented intervention, while restoration returns an object to a selected earlier state and therefore raises greater authenticity and reversibility risks.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that conservation stabilises and retains fabric through minimum documented intervention.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: conservation stabilises and retains fabric through minimum documented intervention.
        |
        v
ANSWER-GRABBING FORMULATION: Evidence chain: Conservation and restoration Qualified use: Explain authenticity and reversibility.
```
### SESSION 10 — CORE — COMMUNITY RIGHTS AND LIVING USE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Evidence chain: Community rights in living sites Qualified use: Balance fabric, worship and livelihood.

**Technical definition:** Prelims: Retain the exact form, region, text, technique or institution attached to Community rights and living use.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Evidence chain: Community rights in living sites Qualified use: Balance fabric, worship and livelihood.
...
- **Evidence chain**
- **Qualified use**
- **Active worship, ancestor practice, access and livelihood**
- **Active**

**How to use them:** Frame the answer through Community rights; define living use, connect Evidence chain with Qualified use to explain the mechanism, and use Active worship, ancestor practice, access and livelihood for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — COMMUNITY RIGHTS AND LIVING USE

```text
START / CONCEPT: CORE — Community rights and living use
        |
        v
EXACT TERMS: Community rights · living use · Evidence chain · Qualified use · Active worship, ancestor practice, access and livelihood · Active
        |
        v
MECHANISM / ARGUMENT: Prelims: Retain the exact form, region, text, technique or institution attached to Community rights and living use.
        |
        v
CONSEQUENCE / CONTRAST: Access and ritual are conservation variables, not noise.
        |
        v
UPSC TRAP / ANSWER-USE: Active worship, ancestor practice, access and livelihood are conservation variables at sites such as Matangeshvara and Moidams; fabric protection cannot presume that a heritage place is socially empty.
        |
        v
ANSWER-GRABBING FORMULATION: Evidence chain: Community rights in living sites Qualified use: Balance fabric, worship and livelihood.
```
### SESSION 11 — CORE — MOIDAMS FORM AND STATUS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Moidams at Charaideo are Tai-Ahom mound-covered royal burial vaults with shrine and octagonal enclosure in a continuing funerary landscape, inscribed in 2024 under criteria (iii) and (iv).

**Technical definition:** Evidence chain: Moidams evidence Qualified use: Prepare the provisional 2026 route.
...
**How to use them:** Frame the answer through Moidams form; define status, connect Evidence chain with Qualified use to explain the mechanism, and use Moidams at Charaideo for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — MOIDAMS FORM AND STATUS

```text
START / CONCEPT: CORE — Moidams form and status
        |
        v
EXACT TERMS: Moidams form · status · Evidence chain · Qualified use · Moidams at Charaideo · Moidams
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Moidams evidence Qualified use: Prepare the provisional 2026 route.
        |
        v
CONSEQUENCE / CONTRAST: Funerary architecture and political history must remain distinct.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: evidence chain: Moidams evidence Qualified use: Prepare the provisional 2026 route.
        |
        v
ANSWER-GRABBING FORMULATION: Moidams at Charaideo are Tai-Ahom mound-covered royal burial vaults with shrine and octagonal enclosure in a continuing funerary landscape, inscribed in 2024 under criteria (iii) and (iv).
```
### SESSION 12 — CORE — RECENT WORLD HERITAGE CHRONOLOGY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Evidence chain: Recent World Heritage ledger Qualified use: Retain property and serial-component discipline.

**Technical definition:** Nalanda, Mumbai's Victorian Gothic and Art Deco ensembles, Dholavira, Ramappa, Santiniketan, the Hoysala ensembles, Moidams and the Maratha Military Landscapes form a dated 2016-2025 ledger; it is not India's complete list.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Evidence chain: Recent World Heritage ledger Qualified use: Retain property and serial-component discipline.
...
- **Qualified use**
- **Nalanda**
- **Mumbai's Victorian Gothic**
- **2016-2025**

**How to use them:** Frame the answer through Recent World Heritage chronology; define Evidence chain, connect Qualified use with Nalanda to explain the mechanism, and use Mumbai's Victorian Gothic for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — RECENT WORLD HERITAGE CHRONOLOGY

```text
START / CONCEPT: CORE — Recent World Heritage chronology
        |
        v
EXACT TERMS: Recent World Heritage chronology · Evidence chain · Qualified use · Nalanda · Mumbai's Victorian Gothic · 2016-2025
        |
        v
MECHANISM / ARGUMENT: Nalanda, Mumbai's Victorian Gothic and Art Deco ensembles, Dholavira, Ramappa, Santiniketan, the Hoysala ensembles, Moidams and the Maratha Military Landscapes form a dated 2016-2025 ledger; it is not India's complete list.
        |
        v
CONSEQUENCE / CONTRAST: A dated partial ledger is not a national total.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: recent World Heritage ledger Qualified use.
        |
        v
ANSWER-GRABBING FORMULATION: Evidence chain: Recent World Heritage ledger Qualified use: Retain property and serial-component discipline.
```
### SESSION 13 — CORE SYNTHESIS — INDIAN ICH CHRONOLOGY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The dated Indian ICH ledger runs from 2008 elements through Deepavali in 2025, includes the multinational Nowruz entry, and must keep inscription year separate from any changing total or latest-item question.

**Technical definition:** Evidence chain: Intangible heritage ledger Qualified use: Use inscription years rather than stale totals.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define Indian ICH chronology, connect Evidence chain with Qualified use to explain the mechanism, and use Indian ICH for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — INDIAN ICH CHRONOLOGY

```text
START / CONCEPT: CORE SYNTHESIS — Indian ICH chronology
        |
        v
EXACT TERMS: CORE SYNTHESIS · Indian ICH chronology · Evidence chain · Qualified use · Indian ICH · Deepavali
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Intangible heritage ledger Qualified use: Use inscription years rather than stale totals.
        |
        v
CONSEQUENCE / CONTRAST: Nowruz is multinational and latest-item answers are date-bound.
        |
        v
UPSC TRAP / ANSWER-USE: Mains: Use inscription years rather than stale totals.
        |
        v
ANSWER-GRABBING FORMULATION: The dated Indian ICH ledger runs from 2008 elements through Deepavali in 2025, includes the multinational Nowruz entry, and must keep inscription year separate from any changing total or latest-item question.
```
### SESSION 14 — CORE SYNTHESIS — SCHEMES, FUNDS AND STATUTES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Adopt a Heritage and Adarsh Smarak are executive amenity or participation schemes, the National Culture Fund is a funding mechanism, and AMASR and the Antiquities Act are statutes; none may be substituted for another.

**Technical definition:** Evidence chain: Schemes, funds and statutes Qualified use: Prevent institutional category errors.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define Schemes, connect funds with statutes to explain the mechanism, and use Evidence chain for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — SCHEMES, FUNDS AND STATUTES

```text
START / CONCEPT: CORE SYNTHESIS — Schemes, funds and statutes
        |
        v
EXACT TERMS: CORE SYNTHESIS · Schemes · funds · statutes · Evidence chain · Qualified use
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Schemes, funds and statutes Qualified use: Prevent institutional category errors.
        |
        v
CONSEQUENCE / CONTRAST: Amenities, finance, regulation and conservation are different functions.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: schemes, funds and statutes Qualified use.
        |
        v
ANSWER-GRABBING FORMULATION: Adopt a Heritage and Adarsh Smarak are executive amenity or participation schemes, the National Culture Fund is a funding mechanism, and AMASR and the Antiquities Act are statutes; none may be substituted for another.
```
### SESSION 15 — CORE SYNTHESIS — MARATHA LANDSCAPES, SAFEGUARDING PYQ AND FINAL SPINE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The direct routed Mains demand is 2018 safeguarding Indian art heritage; objective routes cover 2023 archaeologists, 2024 Santiniketan-Hoysalas and provisional 2026 Moidams, with no answer letter inferred.

**Technical definition:** Safeguarding demand: "Safeguarding is a present need not because heritage is old but because the specific pressures on it — visitor load, urban encroachment, climate action on fabric and the failure of transmission in living traditions — are current and measurable, and each requires a different instrument." UNESCO evaluation: "World Heritage status is best judged as a conditional obligation with reputational leverage: it attracts attention, funding and visitors, and it simultaneously raises the standard against which failure is measured — India's own Danger-List entries and removals prove both halves." Institutional demand: "India does not lack heritage institutions; it lacks the alignment of instrument, capacity and community consent, and the credible reform agenda is about that alignment rather than about new bodies.".

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> 728-729). ✅ As of July 2025 (per the book), no Indian site is on the Danger List. 📰 Recent inscription with criteria: UNESCO inscribed Moidams — the Mound-Burial System of the Ahom Dynasty at Charaideo on 26 July of mound-covered vaults created from the thirteenth to nineteenth centuries, recognised under criteria (iii) and (iv). ❌ Moidams are not ordinary earthen tumuli: UNESCO describes a mound over a hollow vault, with a shrine and octagonal wall, within a continuing funerary and ancestor-worship landscape. 📰 Most recent property: the Maratha Military Landscapes of India (2025) is India's 44th, a serial inscription. ❌ Do not repeat "43rd" without noting the current 44th. 📰 Living-practice recognition: Deepavali (2025) as the 16th Representative List element; Garba of Gujarat (2023); Kutiyattam (2008). 📰 Estate scale: ASI's live Monuments page states it protects and maintains 3,679 centrally protected monuments and archaeological sites (accessed 21 July 2026) — cite the live figure with its access date. ⚠️ Sovereignty rule: inscription confers international recognition and Convention-based protections; ownership, management and legal jurisdiction remain with India and its own institutions (ASI/AMASR).
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define Maratha Landscapes, connect safeguarding PYQ with final spine to explain the mechanism, and use Evidence chain for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — MARATHA LANDSCAPES, SAFEGUARDING PYQ AND FINAL SPINE

```text
START / CONCEPT: CORE SYNTHESIS — Maratha Landscapes, safeguarding PYQ and final spine
        |
        v
EXACT TERMS: CORE SYNTHESIS · Maratha Landscapes · safeguarding PYQ · final spine · Evidence chain · Qualified use
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Maratha Military Landscapes current link - Verified heritage PYQ routes Qualified use: Close with the direct 2018 demand and current UNESCO evidence.
        |
        v
CONSEQUENCE / CONTRAST: 983-985 (Law and Culture/constitutional provisions) — the direct spine for Sections 2-4. ⚠️ Extraction limit recorded: the book's own WHS list is presented as a wide table whose "Declared in / State" columns are truncated in the locally held PDF beyond the first row, so the dated ledger in §13.8A was not built from that table.
        |
        v
UPSC TRAP / ANSWER-USE: Thesis (§13.2 instrument-fit: protection fails from instrument mismatch, not from absent law) → the four-category firewall (§13.4 WHS, ICH, MoW, GI — four instruments, four bodies, four legal bases) → named threats with mechanisms (§13.7) → named instruments matched to them: AMASR for fabric, the akademis for transmission, NMM/National Archives for documents, GI for craft names, the NCF for funding and Adopt a Heritage/Monument Mitras for amenities (§§13.5, 13.8C) → a dated current anchor (Deepavali's ICH inscription, 10 December the gap (capacity thesis; the Hall of Nations demolished in 2017 because 20th-century architecture falls outside the AMASR antiquity threshold, topic 05) → verdict (§13.10). ⚠️ The strongest single move is the living-heritage point: India has 16 ICH elements and none on the Urgent Safeguarding List, which shows recognition is running ahead of any demonstrated transmission crisis — recognition is not safeguarding.
        |
        v
...
- **Must remember:** Heritage governance separates the 1972 World Heritage Convention, 2003 Intangible Heritage Convention, Memory of the World documentary programme, domestic GI law, ASI statutes and the three Akademi mandates.
- **Close distinction:** Tentative List is not inscription, UNESCO does not acquire sovereignty, recognition does not itself safeguard transmission, and Sahitya, Sangeet Natak and Lalit Kala Akademi mandates are not interchangeable.
- **Evidence / interpretation limit:** Every current list, count, danger status, institutional programme or law claim needs source, date and status; conservation must reconcile authenticity, living use, community rights, tourism and disaster risk.
...
MUST REMEMBER: Heritage governance separates the 1972 World Heritage Convention, 2003
  Intangible Heritage Convention, Memory of the World documentary programme, domestic GI law,
  ASI statutes and the three Akademi mandates.
```
...
CLOSE DISTINCTION: Tentative List is not inscription, UNESCO does not acquire sovereignty,
  recognition does not itself safeguard transmission, and Sahitya, Sangeet Natak and Lalit
  Kala Akademi mandates are not interchangeable.
```
...
EVIDENCE LIMIT: Every current list, count, danger status, institutional programme or law claim
  needs source, date and status; conservation must reconcile authenticity, living use,
  community rights, tourism and disaster risk.
```
