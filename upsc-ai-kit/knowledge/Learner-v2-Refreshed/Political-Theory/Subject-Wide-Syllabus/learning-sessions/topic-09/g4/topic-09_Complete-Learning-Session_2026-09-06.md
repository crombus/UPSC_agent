...
title: Interdisciplinary Political Analysis — Complete Topic Package
generation_identity: political-theory-09:learner-v2:g4
generated_on: 2026-09-06
---

# Interdisciplinary Political Analysis — Complete Topic Package
...
✅ **Fact (MoSPI/PIB, 29 June 2026):** On the twentieth Statistics Day, the Ministry of Statistics and Programme Implementation released the *Sustainable Development Goals — National Indicator Framework Progress Report, 2026*. It presents national time-series evidence for monitoring all seventeen SDGs and is intended for policymakers, planners and researchers.

⚠️ **Political-theory use:** The framework illustrates interdisciplinary evidence because development monitoring connects economic, social, demographic, environmental and institutional indicators. The indicators do not settle political priorities by themselves: selection, weighting, distribution and accountability still require institutional analysis and normative judgment.

**Official PIB source:** https://pib.gov.in/PressReleasePage.aspx?PRID=2279014&reg=6&lang=1  
**Official MoSPI report:** https://www.mospi.gov.in/publication/sustainable-development-goals-national-indicator-framework-progress-report-2026

### DEEP-REVIEW LEARNING CONTRACT

- **Learning goal:** move from an easy visual map through these ten stages: The Integrated Political Question; Definitions, Argument Spine and Purposeful Borrowing; Boundaries, Thinkers and Disciplinary Autonomy; Illustrations and the Five-Discipline Matrix; Trap Repair, Cross-Links, Revision and Sources; Anthropology, Law and Geography; Borrowed Models and Named Reductionisms; Objections and Integration Without Merger; Cautious Indian Application; Directive Decoding and Mark-Scaled Answer Architecture.
...
- **Answer-grabbing opening:** Interdisciplinary Political Analysis should be introduced through its controlling political question, not through biography or a dictionary list.
...
### SESSION 1 — The Integrated Political Question
...
> **Core area:** What history, economics, sociology, psychology and philosophy each contribute to political analysis without replacing political theory itself.
> **Grounded in:** O. P. Gauba, *An Introduction to Political Theory*, Fifth Edition (2009), Ch.5, PDF pp.135-146.
...
> *Companion: `Political-Theory/advanced/09_Interdisciplinary-Political-Analysis.md`.*
...
POLITICAL QUESTION
     |
     +--> HISTORY --> roots, sequences, verification over time
     +--> ECONOMICS --> production, distribution, conflict over resources
     +--> SOCIOLOGY --> groups, institutions, status, political culture
     +--> PSYCHOLOGY --> attitudes, personality, propaganda, leadership
     +--> PHILOSOPHY --> concepts, values, ends, moral evaluation
     |
     v
INTEGRATED POLITICAL ANALYSIS
     |
     +--> explains facts better
     +--> tests claims against wider evidence
     +--> keeps politics as the main focus
```

✅ Gauba defines an interdisciplinary approach as relying on more than one discipline for a given problem and drawing on related disciplines where phenomena overlap. (PDF p.136)

#### 2. Why this topic matters
- ✅ Political science studies politics as a social process, so it must use findings, theories and models from other social sciences where they illuminate political phenomena. (PDF pp.136-137)
- ✅ Interdisciplinary inquiry widens perspective, helps verify political claims through other social sciences, and also enables political science to contribute back to them. (PDF p.137)
- ✅ The chapter argues that single-discipline approaches are partial, whereas an interdisciplinary approach seeks an integrated view of politics. (PDF p.146)
- ⚠️ For UPSC, this topic prevents shallow answers that explain democracy, state action or mass behaviour through only law, only morality or only economics.

---

### SESSION 2 — Definitions, Argument Spine and Purposeful Borrowing

#### 3. Essential definitions
| Term | Exam-ready meaning |
|---|---|
| ✅ **Discipline** | A branch or field of learning. (PDF p.136) |
| ✅ **Interdisciplinary approach** | Use of more than one discipline to study a problem, especially where common or overlapping phenomena are involved. (PDF p.136) |
| ✅ **Empirical approach** | Focus on observable facts, explanation, correlation, generalization and prediction. (PDF p.138) |
| ✅ **Normative approach** | Focus on values, prescriptions and what ought to be done. (PDF p.138) |
| ✅ **Political economy** | Analysis of political aspects of economic policy-making and of the mutual impact of economic forces and political decisions. (PDF p.143) |
| ✅ **Political sociology** | Study of political institutions, processes and ideologies in relation to social structures and modes of thought. (PDF p.144) |
| ✅ **Political psychology** | Use of psychological models and techniques to analyse political behaviour, attitudes, learning, socialization, leadership and propaganda. (PDF p.145) |
| ✅ **Political philosophy** | Inquiry into moral and substantive dimensions of politics, including values, obligation, good life and the worth of political systems. (PDF p.146) |

#### 4. Core argument / chapter spine
1. ✅ Gauba begins by treating social sciences as related disciplines dealing with common human problems, which makes interdisciplinarity especially suitable to politics. (PDF p.136)
2. ✅ He insists that political inquiry should borrow from other disciplines purposefully, always to understand political problems, not randomly for their own sake. (PDF p.137)
3. ✅ Empirical orientation, behavioural analysis and systems analysis pushed political science toward other social sciences because real politics cannot be grasped by ideal-state speculation or formal institutions alone. (PDF pp.138-139)
4. ✅ Political science therefore uses data, theories and models from history, economics, sociology, psychology and philosophy. (PDF pp.139-146)
5. ✅ Yet the conclusion is not merger into one master science; the integrated approach keeps politics central while using all relevant disciplines for verification and understanding. (PDF p.146)

---

### SESSION 3 — Boundaries, Thinkers and Disciplinary Autonomy

#### 5. Essential distinctions
- ✅ **Interdisciplinary vs random borrowing:** Gauba warns that expansion across disciplines must be purposeful and well-conceived. (PDF p.137)
- ✅ **Empirical vs normative:** empirical inquiry asks what is; normative inquiry asks what ought to be. (PDF p.138)
- ✅ **Political science vs political philosophy:** scientific-behavioural studies help find facts and tools, while political philosophy helps determine goals of public policy. (PDF pp.145-146)
- ❌ **Interdisciplinary = dissolving political theory into economics or sociology.** Gauba rejects this; the approach integrates relevant disciplines but does not merge them into one master science. (PDF p.146)
- ⚠️ **Governance boundary:** governance explains delivery mechanisms; this topic uses governance-like evidence only when it sharpens a political concept.
- ⚠️ **Economy boundary:** economics explains market and production mechanisms; political theory uses it to understand conflict, welfare, class and policy choice, not to replace economics as a discipline.

#### 6. Thinkers and positions
- ✅ **Aristotle:** the classical approach treated politics as the "master science" and did not clearly separate normative from empirical analysis. (PDF p.146)
- ✅ **Marx and Engels:** Gauba credits them with an early systematic interdisciplinary approach by locating political behaviour in socio-economic factors such as production and class structure. (PDF p.137)
- ✅ **Heinz Eulau:** political behaviour analysis must be interdisciplinary because political action occurs in a wider social, cultural and personal context. (PDF p.139)
- ✅ **Seymour Martin Lipset:** political development cannot be studied without social mobilization, value change, kinship patterns, caste and class relations. (PDF p.140)
- ✅ **Auguste Comte:** science itself is rooted in philosophy; Gauba uses Comte to question any rigid opposition between science and philosophy. (PDF p.145)

---

### SESSION 4 — Illustrations and the Five-Discipline Matrix

#### 7. Illustrative examples
- ✅ Gauba says a political scientist assessing whether democracy will be sustained may need data on literacy, income distribution, ownership patterns, religious attitudes, family structure and rural-urban composition. (PDF p.139)
- ✅ Labour-management relations or crowd psychology should be studied politically only when they illuminate their impact on politics. (PDF p.137)
- ✅ Political development requires understanding social mobilization and value change, not merely constitutions or legal forms. (PDF p.140)
- ✅ Political communication, propaganda, charismatic leadership and public opinion formation draw directly on political psychology. (PDF pp.144-145)
- ⚠️ A good UPSC answer on welfare politics can therefore move from economic scarcity, to class/group conflict, to mass attitudes, and finally to philosophical evaluation of justice.

#### 8. Comparison table
| Discipline | What it mainly contributes | Typical political-theory use | Limit if used alone |
|---|---|---|---|
| ✅ **History** | Verification through past events, sequences and long-term causation. (PDF p.141) | Testing a theory about state formation or democracy against historical cases. | ❌ May become mere chronicle if not politically interpreted. |
| ✅ **Economics** | Insight into production, distribution, exchange, scarcity and economic conflict. (PDF pp.142-143) | Understanding welfare state claims, class conflict, policy choice and political economy. | ❌ Cannot by itself settle legitimacy or justice. |
| ✅ **Sociology** | Group life, institutions, status, attitudes, participation and political culture. (PDF pp.143-144) | Explaining political socialization, cleavage, leadership and legitimacy. | ❌ Risks reducing politics to social structure alone. |
| ✅ **Psychology** | Motives, attitudes, personality, propaganda and leadership appeal. (PDF pp.144-145) | Explaining extremist appeal, public opinion and charismatic authority. | ❌ Cannot alone explain institutions or economic conflict. |
| ✅ **Philosophy** | Conceptual clarification, values, moral foundations and ends of public life. (PDF pp.145-146) | Clarifying liberty, equality, obligation, justice and the goals of policy. | ❌ Without empirical grounding, it can become purely speculative. |

---

### SESSION 5 — Trap Repair, Cross-Links, Revision and Sources

#### 9. UPSC traps and corrections
- ❌ **"Interdisciplinary study means political science has lost its identity."** -> ✅ Gauba says political science remains focused on politics while using other disciplines for broader and better-grounded analysis. (PDF pp.137, 146)
- ❌ **"Empirical political science made philosophy irrelevant."** -> ✅ Gauba says political philosophy regained prominence after post-behaviouralism and still helps define policy goals. (PDF pp.145-146)
- ❌ **"History and political science are the same thing."** -> ✅ Gauba treats this older formula as an oversimplification; history is used selectively and critically. (PDF p.141)
- ❌ **"One discipline can fully explain politics."** -> ✅ The chapter concludes that philosophical, historical, legal, economic, sociological and psychological approaches are partial when used alone. (PDF p.146)

#### 10. Cross-links and boundaries
- ✅ Use `Political-Theory/advanced/09_Interdisciplinary-Political-Analysis.md` for the evidence-routing matrix and direct-book reconstruction of the chapter.
- ✅ Use `Political-Theory/00_Master-Framework.md` to place this topic beside `01`, `08` and later state, power and justice topics in the wider module architecture.
- ✅ Use `Political-Theory/README.md` for the numbered topic map and dated-source discipline for the whole folder.
- ⚠️ For economic mechanisms, refer outward to the Economy module in prose rather than reproducing technical economics here.
- ⚠️ For delivery and institutional performance, refer outward to the Governance module in prose rather than turning this topic into an administrative note.

#### 11. Revision capsule / answer spine
> ⚠️ **Answer spine:** Politics is an open, socially embedded process; therefore political analysis must borrow evidence and models from history, economics, sociology, psychology and philosophy, while still keeping the political question at the centre.

- ✅ Define interdisciplinarity as purposeful use of more than one discipline. (PDF p.136)
- ✅ Show why empirical orientation, behaviouralism and systems analysis pushed political science outward. (PDF pp.138-139)
- ✅ Explain the contribution of each major discipline in one line. (PDF pp.141-146)
- ✅ End with Gauba's conclusion: single-discipline approaches are partial; integration is necessary, but merger is not. (PDF p.146)
- ⚠️ In Mains, move from **evidence** -> **explanation** -> **normative evaluation**.
- ⚠️ In Prelims, remember the paired terms: political economy, political sociology, political psychology, political philosophy.

#### 12. Sources, metadata and tags
- ✅ Primary source used directly: Gauba, Ch.5, especially PDF pp.136-146, with page anchors preserved in the supplied text extraction.
...
### SESSION 6 — Anthropology, Law and Geography
...
### SESSION 7 — Borrowed Models and Named Reductionisms
...
### SESSION 8 — Objections and Integration Without Merger
...
### SESSION 9 — Cautious Indian Application
...
> **Core area:** Reconstructing Gauba's case for interdisciplinarity as a method of verification, explanation and evaluation in political analysis.
> **Grounded in:** O. P. Gauba, *An Introduction to Political Theory*, Fifth Edition (2009), Ch.5, PDF pp.135-146.
> **Source edition/cutoff:** Fifth Edition (2009); no post-2009 fact is assumed unless independently dated and tagged 📰.
> ✅ = source-grounded | ⚠️ = analytical inference/synthesis | 📰 = dated current anchor | ❌ = trap/misattribution.
> *Companion: `Political-Theory/basic/09_Interdisciplinary-Political-Analysis.md`.*
...
POLITICAL CLAIM
   |
   +--> HISTORICAL CHECK: did it hold across time/cases?
   +--> ECONOMIC CHECK: what resource conflicts and incentives shape it?
   +--> SOCIOLOGICAL CHECK: what groups, norms and structures carry it?
   +--> PSYCHOLOGICAL CHECK: what attitudes, fears and identities sustain it?
   +--> PHILOSOPHICAL CHECK: is it conceptually clear and normatively defensible?
   |
   v
INTEGRATED POLITICAL JUDGMENT
   = explanation + verification + evaluation
```

✅ Gauba's conclusion is that political inquiry should be based on and verified from all relevant social sciences, not on a single partial approach. (PDF p.146)

### 2. Scope, assumptions and conceptual boundary
- ✅ The chapter treats politics as a social process and the political system as an open system linked to a wider social environment. (PDF pp.137-139)
- ✅ Interdisciplinarity here means selective, purposive borrowing directed toward political understanding, not intellectual tourism across disciplines. (PDF p.137)
- ❌ It does **not** mean that political theory is absorbed into economics, sociology or psychology; Gauba explicitly rejects merger into a single master science. (PDF p.146)
- ⚠️ This file therefore stays at the level of concept-routing: how a political theorist chooses evidence and checks arguments.
- ⚠️ Boundary rule: governance can illustrate administrative consequences, and economics can explain material mechanisms, but this topic is about how those inputs are used in political analysis.

### 3. Direct-book argument reconstruction
1. ✅ Gauba first defines disciplines and then marks the social sciences as especially suited to interdisciplinary work because they study overlapping aspects of human society. (PDF p.136)
2. ✅ He then specifies three functions of interdisciplinarity in political science: use other disciplines' findings, verify political theories through them, and contribute back to their understanding. (PDF p.137)
3. ✅ He warns that such widening must remain focused on politics; labour relations or crowd psychology matter here only insofar as they affect political outcomes. (PDF p.137)
4. ✅ The methodological push comes from empirical orientation: observable facts, causal explanation, generalization and prediction displaced purely ideal-state speculation. (PDF p.138)
5. ✅ Behavioural analysis widened the unit of study from formal institutions to the behaviour of voters, elites, bureaucrats, judges and groups. (PDF pp.138-139)
6. ✅ Systems analysis further required study of inputs, outputs and feedback between political and social systems. (PDF p.137, PDF p.139)
7. ✅ Political science thus began using other disciplines' data, theories and models, including elite theory, base-superstructure analysis, structural-functionalism, problem-solving models and market analogies. (PDF pp.139-140)
8. ✅ Gauba then demonstrates the specific uses of history, economics, sociology, psychology and philosophy for political analysis. (PDF pp.141-146)
9. ✅ He ends by saying single-discipline approaches remain partial, while the interdisciplinary approach aims at an integrated view without abolishing disciplinary boundaries. (PDF p.146)

### 4. Definitions and distinctions
| Pair | Advanced distinction |
|---|---|
| ✅ **Empirical / Normative** | Empirical inquiry explains what exists through facts and causal relations; normative inquiry evaluates what ought to be through values and standards. (PDF p.138) |
| ✅ **Political science / Political philosophy** | Political science helps discover facts and operational tools; political philosophy clarifies goals, obligation, justice and the moral worth of systems. (PDF pp.145-146) |
| ✅ **Interdisciplinary / Single-discipline** | Interdisciplinary analysis checks a political claim against multiple relevant bodies of evidence; single-discipline analysis remains partial. (PDF p.146) |
| ✅ **Use of data / Use of models** | Data include literacy, income distribution, kinship patterns and attitudes; models include elite theory, structural-functionalism and economic bargaining analogies. (PDF pp.139-140) |
| ❌ **Broader scope / Loss of focus** | Gauba permits broader scope only when the main focus remains political. (PDF p.137) |

### 5. Thinker-by-thinker positions
- ✅ **Aristotle:** the classical "master science" image blurred normative and empirical aspects and did not sharply separate politics from wider social life. (PDF p.146)
- ✅ **Marx and Engels:** early systematic interdisciplinarians because they related politics to technology, production and class structure. (PDF p.137)
- ✅ **Heinz Eulau:** political behaviour must be studied within wider social, cultural and personal contexts. (PDF p.139)
- ✅ **Seymour Martin Lipset:** political development depends on social mobilization, value change, kinship structure and class/status relations. (PDF p.140)
- ✅ **Auguste Comte:** science itself emerges from philosophical foundations; Gauba uses this to soften a rigid philosophy/science divide. (PDF p.145)
- ✅ **David Easton:** his political-system framework is borrowed from sociology, showing direct interdisciplinary transfer into political science. (PDF p.140)
- ✅ **Harold Lasswell:** Gauba cites the problem-solving model as an example of psychology feeding political analysis. (PDF p.140)

### 6. Competing perspectives
- ✅ **Historical perspective:** treats the past as a storehouse of data and causal patterns for political verification. (PDF p.141)
- ✅ **Political-economic perspective:** looks at production, distribution, exchange, economic demands and the state's role in reconciling them. (PDF pp.142-143)
- ✅ **Political-sociological perspective:** studies the political subsystem in relation to social structures, norms, leadership and participation. (PDF pp.143-144)
- ✅ **Political-psychological perspective:** explains attitudes, personality, learning, propaganda and extremist appeal. (PDF pp.144-145)
- ✅ **Political-philosophical perspective:** clarifies ends, values, obligation, good life and the moral standing of political systems. (PDF pp.145-146)
- ⚠️ These are best seen as complementary lenses: explanation improves when their evidence is combined rather than ranked in a fixed hierarchy.

### 7. Internal debates and criticisms
- ✅ Gauba notes older claims like "history is past politics" as oversimplifications because political science has gained an independent identity. (PDF p.141)
- ✅ He also presents the science/philosophy split as exaggerated because science itself originates in philosophy and still requires philosophical validation of ends. (PDF p.145)
- ❌ **Economic reductionism:** Marxian or market models can illuminate politics, but the chapter does not say economics alone settles political analysis. (PDF pp.140, 142-143, 146)
- ❌ **Behaviouralist reductionism:** focus on observable behaviour corrected older formalism, but Gauba also records the later revival of justice, liberty, equality and community. (PDF pp.145-146)
- ⚠️ A useful criticism of pure interdisciplinarity is diffusion of focus; Gauba pre-empts this by insisting on purposeful relevance to politics. (PDF p.137)

### 8. Comparative matrix
#### Evidence-routing matrix
| Route | What it contributes | What it verifies or clarifies | Example political-theory use | What it cannot settle alone |
|---|---|---|---|---|
| ✅ **Historical verification** | Past cases, sequences, roots and patterns. (PDF p.141) | Whether a political theory survives rule-and-exception testing. (PDF p.141) | Testing claims about democracy, state formation or international conflict. | ❌ Present moral worth of a system. |
| ✅ **Political economy** | Production, distribution, exchange, resource conflict and policy incentives. (PDF pp.142-143) | Whether material interests and economic demands explain political conflict or policy. (PDF pp.142-143) | Welfare state, class conflict, planning, public control, development. | ❌ Full account of legitimacy or civic identity. |
| ✅ **Political sociology** | Social structures, status, values, institutions, participation and leadership. (PDF pp.143-144) | Whether a political arrangement fits the social basis that sustains it. (PDF pp.139, 143-144) | Political culture, socialization, group conflict, legitimacy. | ❌ Inner motive of a specific actor or final normative judgment. |
| ✅ **Political psychology** | Attitudes, personality, learning, propaganda and leadership style. (PDF pp.144-145) | Whether mass appeal, obedience or extremism can be traced to psychological mechanisms. (PDF pp.144-145) | Authoritarian personality, charisma, public opinion, propaganda. | ❌ Structural class or institutional explanation by itself. |
| ✅ **Philosophical clarification/evaluation** | Conceptual clarity, ends, values and moral appraisal. (PDF pp.145-146) | Whether concepts like justice, liberty or obligation are coherent and defensible. (PDF pp.145-146) | Evaluating policy goals or the moral worth of political systems. | ❌ Standalone explanation of actual behaviour without empirical evidence. |

### 9. Application without current-affairs dependence
- ⚠️ **Hypothetical 1:** "Why does one democracy survive while another collapses?" -> route through history for antecedents, economics for inequality, sociology for cleavages, psychology for authoritarian appeal, and philosophy for legitimacy.
- ⚠️ **Hypothetical 2:** "Should a state regulate markets for welfare?" -> route through economics for incentives and distribution, sociology for class effects, and philosophy for justice and common good.
- ⚠️ **Hypothetical 3:** "Why do citizens obey harmful propaganda?" -> route through psychology for attitude formation, sociology for group identity, and philosophy for truth and responsibility.
- ⚠️ The point is not to pile disciplines mechanically, but to ask which discipline supplies the missing evidence in a political argument.

### 10. UPSC answer-engine prompts
- ⚠️ **Prompt frame 1:** Define interdisciplinarity -> show empirical/behavioural push -> map five disciplines -> conclude with integration without merger.
- ⚠️ **Prompt frame 2:** If the question mentions political behaviour, immediately bring in sociology and psychology before discussing institutions.
- ⚠️ **Prompt frame 3:** If the question mentions justice, liberty or obligation, add philosophy explicitly instead of writing only empirical explanation.
- ⚠️ **Practice prompt:** "Why are single-cause theories of politics analytically weak?" 
- ⚠️ **Practice prompt:** "How does interdisciplinarity deepen but not destroy the autonomy of political theory?"

### 11. Cross-links and exclusions
- ✅ Companion file: `Political-Theory/basic/09_Interdisciplinary-Political-Analysis.md`.
- ✅ Wider frame: `Political-Theory/00_Master-Framework.md`.
- ✅ Folder method and tag policy: `Political-Theory/README.md`.
- ✅ The chapter naturally looks backward to behaviouralism and post-behaviouralism; use `Political-Theory/advanced/08_Approaches-Behaviouralism-and-Post-Behaviouralism.md` for that companion depth.
- ⚠️ The chapter also points outward to economics and governance as neighbouring domains; this file does not reproduce full economic theory or administrative case detail.

### 12. Factual-risk checks
- ✅ References to behaviouralism, post-behaviouralism and cited scholars belong to Gauba's 2009 exposition of twentieth-century debates. (PDF pp.138-146)
- ✅ Statements about what history, economics, sociology, psychology and philosophy contribute are source-grounded chapter summaries, not present-day disciplinary consensus claims beyond the book. (PDF pp.141-146)
- ❌ Do not present Gauba's disciplinary map as if it abolishes legal or geographical approaches; his conclusion is that single approaches are partial, not useless. (PDF p.146)
- ❌ Do not convert classic examples into current data claims; this chapter is methodological, not a live empirical survey.

### 13. Sources, metadata and tags
- ✅ Direct source window read in full across the assigned extraction range, with core anchors on PDF pp.136-146.
- ✅ Especially used: approach and method (PDF pp.136-140), history (PDF p.141), economics (PDF pp.142-143), sociology (PDF pp.143-144), psychology (PDF pp.144-145), philosophy and conclusion (PDF pp.145-146).
- ⚠️ All tables and answer-prompts are exam-oriented syntheses built from the chapter's explicit structure.
- ✅ Companion path in this folder: `Political-Theory/basic/09_Interdisciplinary-Political-Analysis.md`.
...
|---|---|
| Discipline | A branch or field of learning. |
| Interdisciplinary approach | Use of more than one discipline to study a problem, especially where common or overlapping phenomena are involved. |
| Empirical approach | Focus on observable facts, explanation, correlation, generalization and prediction. |
| Normative approach | Focus on values, prescriptions and what ought to be done. |
| Political economy | Analysis of political aspects of economic policy-making and of the mutual impact of economic forces and political decisions. |
| Political sociology | Study of political institutions, processes and ideologies in relation to social structures and modes of thought. |
| Political psychology | Use of psychological models and techniques to analyse political behaviour, attitudes, learning, socialization, leadership and propaganda. |
| Political philosophy | Inquiry into moral and substantive dimensions of politics, including values, obligation, good life and the worth of political systems. |
| Interdisciplinary vs random borrowing | Gauba warns that expansion across disciplines must be purposeful and well-conceived. |
| Empirical vs normative | empirical inquiry asks what is; normative inquiry asks what ought to be. |
| Political science vs political philosophy | scientific-behavioural studies help find facts and tools, while political philosophy helps determine goals of public policy. |
| Governance boundary | governance explains delivery mechanisms; this topic uses governance-like evidence only when it sharpens a political concept. |
...
- Interdisciplinary inquiry widens perspective, helps verify political claims through other social sciences, and also enables political science to contribute back to them. (PDF p.137)
- The chapter argues that single-discipline approaches are partial, whereas an interdisciplinary approach seeks an integrated view of politics. (PDF p.146)
- Empirical orientation, behavioural analysis and systems analysis pushed political science toward other social sciences because real politics cannot be grasped by ideal-state speculation or formal institutions alone. (PDF pp.138-139)
- Interdisciplinary vs random borrowing: Gauba warns that expansion across disciplines must be purposeful and well-conceived. (PDF p.137)
- Aristotle: the classical approach treated politics as the "master science" and did not clearly separate normative from empirical analysis. (PDF p.146)
- Marx and Engels: Gauba credits them with an early systematic interdisciplinary approach by locating political behaviour in socio-economic factors such as production and class structure. (PDF p.137)
- Show why empirical orientation, behaviouralism and systems analysis pushed political science outward. (PDF pp.138-139)
- Claim → evidence → significance → limit: Claim: political order does not require a Weberian state. Evidence: kinship/lineage-based dispute-resolution and authority structures documented across many non-state societies. Significance: tests and refines political theory's core concepts (authority, legitimacy, sovereignty) against non-state cases rather than assuming the modern state is the only unit of analysis. Limit: findings from small-scale societies cannot be mechanically transplanted onto large, complex modern states.
- Claim → evidence → significance → limit: Claim: legal materials are indispensable evidence for political analysis of institutions and rights. Evidence: constitutional provisions and case law define formal powers, limits and remedies. Significance: grounds political claims about institutional design in verifiable text rather than impression. Limit: legal text alone cannot explain informal power, bargaining or non-compliance — hence the need for sociology/psychology alongside it.
- Exam use: if the question specifically asks for an "interdisciplinary" answer without naming disciplines, a strong 15/20-mark response should be able to name at least six to seven disciplines (history, economics, sociology, psychology, philosophy, anthropology, law, geography) and give one distinct contribution for each, rather than repeating the same five from Gauba's chapter alone.

### HIGH-RISK TRAPS

- Trap repair: "Interdisciplinary study means political science has lost its identity." -> Gauba says political science remains focused on politics while using other disciplines for broader and better-grounded analysis. (PDF pp.137, 146)
- Trap repair: "Empirical political science made philosophy irrelevant." -> Gauba says political philosophy regained prominence after post-behaviouralism and still helps define policy goals. (PDF pp.145-146)
- Trap repair: "History and political science are the same thing." -> Gauba treats this older formula as an oversimplification; history is used selectively and critically. (PDF p.141)
- Trap repair: "One discipline can fully explain politics." -> The chapter concludes that philosophical, historical, legal, economic, sociological and psychological approaches are partial when used alone. (PDF p.146)
