---
title: "Decline of the Mughal Empire & the Eighteenth Century — Learner-v2 Refreshed"
topic_key: medieval-indian-history-25
cover_image: assets/medieval-indian-history-25_Teaching-Navigation_2026-08-30.png
---
# Decline of the Mughal Empire & the Eighteenth Century - Complete Topic Package

![Mughal decline successor states invasions and continuity cover](assets/00_00_cover.png)
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Medieval-Indian-History\basic\25_Decline-of-the-Mughal-Empire.md`  
**Canonical topic owner:** `upsc-ai-kit\knowledge\Medieval-Indian-History\basic\25_Decline-of-the-Mughal-Empire.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Medieval-Indian-History\advanced\25_Decline-of-the-Mughal-Empire.md`  
...
- **Current-status note, rechecked 2026-08-30:** Official conservation materials were rechecked on 30 August 2026 and provide only a bounded modern bridge to preserving monuments and archives. No genuinely topic-specific recent official event was found for Mughal successor states or the 1707-1761 transition. Heritage policy is not evidence for eighteenth-century causal claims; those remain controlled by canonical Markdown, OCR books and source criticism.
...
![Refreshed teaching navigation](assets/medieval-indian-history-25_Teaching-Navigation_2026-08-30.png)
...
![Visual 1: periodisation -- what this topic covers, and what it hands off](assets/01_01_periodisation_scope.png)
...
START / CONCEPT: Periodisation: what this topic covers, and what it hands off
        |
        v
EXACT TERMS: Periodisation · what this topic covers · what it hands off · A precise date frame · 1687-1707 · 1707-1761
        |
        v
MECHANISM / ARGUMENT: A second discipline follows from the first: this topic must not silently re-teach what neighbouring packages already own in depth.
        |
        v
CONSEQUENCE / CONTRAST: Aurangzeb's Deccan wars of 1687-1707 are pre-history to this topic's core problem, not its content: they are analysed in depth under Medieval Topics 22 and 23, and are used here only as the inherited strain that the post-1707 empire had to carry.
        |
        v
UPSC TRAP / ANSWER-USE: Topic 25 draws on both only as much as its own eighteenth-century argument requires, and hands its own conclusion forward to Modern History rather than absorbing that later material.
        |
        v
ANSWER-GRABBING FORMULATION: A precise date frame is the first discipline this topic requires.
```
...
![Visual 2: source-method wheel -- how this decline is actually known](assets/02_02_source_method_wheel.png)
...
![Visual 3: historiography ladder -- three overlapping explanatory strands](assets/03_03_historiography_matrix.png)
...
START / CONCEPT: Source method and the historiography ladder
        |
        v
EXACT TERMS: Source method · the historiography ladder · This topic's evidence base · This · Farman · Colonial-era
        |
        v
...
CONSEQUENCE / CONTRAST: These are overlapping emphases on a shared body of evidence, not a simple ladder in which each later view cancels the one before it, and this topic states each strand's evidential basis rather than picking a single winner.
        |
        v
UPSC TRAP / ANSWER-USE: ANALYSIS: it should be placed alongside, not simply above, an older Aurangzeb-centred reading associated with Jadunath Sarkar, and alongside more recent regional and agrarian-focused historians (named in the source material as Alam and Subrahmanyam) who stress continuing regional economic vitality and caution against reading the eighteenth century only as imperial breakdown.
        |
        v
...
![Visual 4: post-1707 succession and the wizarat, emperor by emperor](assets/04_04_succession_wizarat_timeline.png)
...
CONSEQUENCE / CONTRAST: The Sayyid period was not uniformly destructive: it abolished jizyah in 1713 and negotiated an important settlement with Shahu's Marathas over chauth and sardeshmukhi in the Deccan in exchange for military assistance, a bargain that itself shows how far central authority had already come to share power with a regional claimant.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: farrukhsiyar's own accession depended on the military support of two brothers, Sayyid Abdullah Khan...
        |
        v
...
![Visual 5: decline-causation system map -- a converging structural crisis](assets/05_05_decline_causation_map.png)
...
![Visual 6: jagirdari mechanics -- four terms not to confuse](assets/06_06_jama_hasil_paibaqi_bejagiri.png)
...
START / CONCEPT: Jagirdari mechanics: four terms not to confuse
        |
        v
EXACT TERMS: Jagirdari mechanics · four terms not to confuse · The jagirdari crisis · Jama · Hasil · Paibaqi
        |
        v
...
![Visual 7: the jagirdari feedback loop -- how be-jagiri became self-reinforcing](assets/07_07_jagirdari_feedback_loop.png)
...
![Visual 8: Deccan exhaustion -- the twenty-year "ulcer" and its legacy](assets/08_08_deccan_exhaustion_chain.png)
...
MECHANISM / ARGUMENT: The balanced position treats Deccan exhaustion as a serious contributing input feeding directly into subtopics 5 and 6's mechanism, not the single or sufficient explanation for everything that follows across the rest of this topic.
        |
        v
CONSEQUENCE / CONTRAST: A bounded answer therefore states the Deccan campaigns' fiscal-administrative legacy in one or two sentences and moves directly to its structural consequence (be-jagiri and factionalism), rather than narrating Deccan military history that Topics 22-23 already own in depth.
        |
        v
...
![Visual 9: noble factionalism -- rival blocs contesting the wizarat](assets/09_09_noble_factionalism.png)
...
![Visual 10: zamindar resistance -- structural, not lawlessness](assets/10_10_zamindar_resistance_spectrum.png)
...
![Visual 11: centre-region spectrum -- how directly did Delhi rule?](assets/11_11_centre_region_spectrum.png)
...
![Visual 12: successor states compared -- Bengal, Awadh, Hyderabad](assets/12_12_successor_state_comparison.png)
...
CONSEQUENCE / CONTRAST: All three begin as a Mughal subah (province) under a governor who, over one or two generations, converts a formally central appointment into a substantially hereditary regional authority - while continuing, for a considerable time, to seek nominal confirmation from Delhi and to remit at least token revenue or tribute.
        |
        v
UPSC TRAP / ANSWER-USE: ANALYSIS: what unites them is not identical method but a shared outcome - each converts real administrative and fiscal control into durable regional power while retaining a formal, legitimating link to Mughal authority for as long as it remained useful, illustrating the centre-region spectrum's middle-to-far zone in three distinct registers.
        |
        v
...
**How to use them:** Frame the answer through Bengal; define from jagir turnover to a stabilised revenue regime, connect Murshid Quli Khan with Diwan to explain the mechanism, and use Nawab for the decisive comparison or qualification.
...
![Visual 13: Bengal -- from jagir turnover to a stabilised revenue regime](assets/13_13_bengal_revenue_schematic.png)
...
START / CONCEPT: Bengal: from jagir turnover to a stabilised revenue regime
        |
        v
EXACT TERMS: Bengal · from jagir turnover to a stabilised revenue regime · Murshid Quli Khan · Diwan · Nawab · His
        |
        v
...
![Visual 14: Awadh -- accommodation with zamindars, then a frontier role](assets/14_14_awadh_accommodation_schematic.png)
...
MECHANISM / ARGUMENT: Awadh's mechanism - accommodation with the existing zamindari structure rather than its dismantling or Bengal's revenue-farming overhaul - shows a second, distinct route to the same substantive autonomy described in subtopic 11, and its frontier position exposed it directly to the external shocks examined in Part VII.
        |
        v
CONSEQUENCE / CONTRAST: Shuja-ud-Daulah's later defeat at Buxar in 1764, fighting alongside Shah Alam II and Mir Qasim, belongs to Modern History and is named here only as the bounded forward hand-off, not analysed in depth.
        |
        v
...
![Visual 15: Hyderabad -- Deccan subedari to de facto sovereignty](assets/15_15_hyderabad_subedari_schematic.png)
...
START / CONCEPT: Hyderabad: Deccan subedari to de facto sovereignty
        |
        v
EXACT TERMS: Hyderabad · Deccan subedari to de facto sovereignty · Nizam-ul-Mulk · Chin Qilich Khan · Asaf Jah · Muhammad Shah
        |
        v
MECHANISM / ARGUMENT: Hyderabad's mechanism - a top-ranking central noble converting personal military strength and a Deccan power base into self-standing regional sovereignty - is the most direct illustration in this topic of how the very people who staffed the imperial centre (Part IV) could also become its most consequential regional successors, and it completes the three-way comparison in subtopic 11 by showing personal-military conversion as a third distinct route, alongside Bengal's revenue-farming and Awadh's zamindar-accommodation.
        |
        v
CONSEQUENCE / CONTRAST: A precise answer on Hyderabad should note that Asaf Jah's autonomy grew out of his position as a central noble (linking back to Part IV's factionalism), rather than presenting Hyderabad's rise as unconnected to the wizarat politics examined earlier in this topic.
        |
        v
...
![Visual 16: Jats, Sikhs, Marathas -- a bounded snapshot](assets/16_16_jats_sikhs_marathas_snapshot.png)
...
![Visual 17: Maratha fiscal claims layered over the Mughal revenue base](assets/17_17_maratha_fiscal_claim.png)
...
![Visual 18: Nadir Shah's invasion, 1739 -- a schematic route sketch](assets/18_18_nadir_shah_route.png)
...
![Visual 19: Nadir Shah, 1739 -- why Delhi fell, and what the raid did](assets/19_19_nadir_shah_causes_consequences.png)
...
![Visual 20: Abdali's invasions, 1748-1761 -- a frontier under pressure](assets/20_20_abdali_invasions_timeline.png)
...
![Visual 21: Third Battle of Panipat, 1761 -- schematic coalition alignment](assets/21_21_panipat_coalition_map.png)
...
![Visual 22: Panipat III -- why the Marathas lost, and its limits](assets/22_22_panipat_causes_aftermath.png)
...
![Visual 23: central thesis -- fragmentation vs economic-cultural continuity](assets/23_23_fragmentation_vs_continuity.png)
...
![Visual 24: eighteenth-century economy -- continuity evidence](assets/24_24_trade_credit_craft.png)
...
![Visual 25: cultural patronage -- continuity through regional courts](assets/25_25_cultural_patronage.png)
...
![Visual 26: non-inevitability -- was British rule automatic?](assets/26_26_non_inevitability_tree.png)
...
![Visual 27: topic-boundary bridge -- what each package owns in depth](assets/27_27_topic_boundary_bridge.png)
...
> The first is teleological framing: presenting 1707-1761 as a story whose ending (British paramountcy) was already latent in its beginning, so that every event is narrated as a step "toward" a foreordained outcome.
...
![Visual 28: two wrong framings to name and reject in decline answers](assets/28_28_teleology_caution.png)
...
![Visual 29: PYQ route panel -- what is verified, adjacent, and honestly absent](assets/29_29_pyq_route_panel.png)
...
![Visual 30: fact-risk and source-discipline ledger](assets/30_30_fact_risk_ledger.png)
...
![Visual 34: UPSC traps -- common misreadings vs the defensible position](assets/34_34_upsc_traps_grid.png)
...
![Visual 5 repeat: decline-causation system map, previewed before broad practice](assets/05_05_decline_causation_map.png)
...
![Visual 28 repeat: two wrong framings, previewed before remedial practice](assets/28_28_teleology_caution.png)
...
![Visual 31: answer spine -- 10-mark: structural decline in four moves](assets/31_31_answer_spine_10.png)
...
![Visual 32: answer spine -- 15-mark: three strands, monocausality rejected](assets/32_32_answer_spine_15.png)
...
![Visual 33: answer spine -- 20-mark: full historiography-weighted verdict](assets/33_33_answer_spine_20.png)
...
![Visual 30 repeat: fact-risk ledger for answer drills](assets/30_30_fact_risk_ledger.png)
...
> *Companion: `basic/25_Decline-of-the-Mughal-Empire.md`. Chronology spine: `00_Master-Chronology.md`.*
...
| Date | Event |
|---|---|
| ✅ 1687–1707 | Aurangzeb's last Deccan phase — the "ulcer" that drained the empire |
| ✅ 1707 | Death of Aurangzeb; jagirdari crisis in the open |
| ✅ 1713–20 | Sayyid Brothers dominate the wizarat; reverse jizyah and bargain with Marathas |
| ✅ 1719 | Farrukhsiyar deposed and killed — imperial authority sharply reduced |
| ✅ 1739 | Nadir Shah sacks Delhi; Peacock Throne and Koh-i-Noor taken |
| ✅ 1740s | Maratha expansion and autonomous regional states reshape the political field |
| ✅ 1761 | Third Battle of Panipat — Peshwa's north Indian bid checked by Abdali |

### 1. Snapshot & core idea

**Deeper — the historiography of decline.**

✅ Satish Chandra's own contribution is the **"jagirdari crisis"** thesis: as the empire stopped expanding, the pool of revenue-yielding **jagirs (paibaqi)** could not keep pace with the **growing number of mansabdars**, producing a chronic **be-jagiri** (jagirlessness), fierce factionalism and predatory revenue extraction that alienated the **zamindars and peasantry**.
- ✅ He weighs the older **"Aurangzeb's responsibility"** view against evidence from the working of jagirs, rural power and the Deccan war, presenting decline as a **convergence** of administrative, fiscal, social, military and political strains.
- ✅ The **Deccan campaigns (1687–1707)** are pivotal: prolonged war swelled the nobility with defeated **Deccani/Maratha** entrants (widening the jagir shortage) while the emperor's absence from the north weakened administration there.

**Deeper — the eighteenth-century transition.**

- ✅ **Jagir transfers and shortfalls:** frequent transfers and jama-hasil gaps discouraged sustained improvement and pushed officials toward short-term extraction.
- ✅ **The Sayyid Brothers (Abdullah Khan and Husain Ali)** used the wizarat to dominate succession, abolished jizyah and bargained with the Marathas over chauth and sardeshmukhi.
- ✅ **Regional reorganisation:** Chandra asks whether a balance-of-power network of regional states could have emerged and stresses that economy and internal trade often remained vigorous despite imperial contraction.
- ✅ **Nadir Shah (1739)** and **Abdali** were both external shocks and evidence of frontier/central weakness; they cannot replace analysis of the preceding internal crisis.

### 2. Key classification / data

| Thesis | Core claim | Associated with |
|---|---|---|
| ✅ Jagirdari crisis | Jagir shortage vs swelling nobility → factional collapse | Satish Chandra |
| ✅ Aurangzeb-centred view | Deccan war and political choices overstretched the state | older debate, notably Jadunath Sarkar |
| ✅ Administrative-social crisis | Jama-hasil gap, zamindars, transfers and rural resistance | Satish Chandra's expanded jagirdari analysis |
| ✅ Regional reordering | Autonomous states plus continuing economy/internal trade | Part II conclusions |

| 18th-c power | Instrument of expansion |
|---|---|
| ⚠️ Marathas | Chauth & sardeshmukhi; confederacy |
| ⚠️ Sikhs | Misls in Punjab |
| ⚠️ Successor states | Autonomous provincial revenue regimes |

### 3. Study links

> **Study link:** ✅ Jagirdari crisis → `advanced/23` (Marathas/Deccan) & `advanced/22` (Aurangzeb).
> **Study link:** ⚠️ Mansabdari mechanics → `advanced/16`/`advanced/21`; 18th-c transition bridges to **Modern-Indian-History** (EIC ascendancy).

### 4. Must-Know Facts (Prelims)

- ✅ **Jagirdari crisis** = Satish Chandra's central explanatory frame; **be-jagiri** = jagirlessness.
- ✅ Decline is **multi-causal** (jagirdari + Deccan wars + agrarian strain), debated among historians.
- ✅ **Sayyid Brothers** deposed Farrukhsiyar (**1719**), abolished **jizyah** and bargained with Marathas.
- ✅ Maratha **chauth/sardeshmukhi** claims became instruments of fiscal and political expansion.
- ✅ **Nadir Shah 1739**; **Panipat III 1761** (Marathas vs Abdali).

### 5. UPSC Traps

> 🔑 Trap: Do not force one cause onto the decline: Chandra joins jagirdari malfunction, rural power, noble alienation, Deccan warfare, military limits and regionalisation.

- ❌ Satish Chandra blames decline solely on Aurangzeb's religious policy. → His distinctive thesis is the **jagirdari crisis** (structural/fiscal).
- ❌ The 18th century was pure "chaos and darkness." → Part II stresses regional state formation and continuing economic/internal-trade vitality alongside conflict.
- ❌ Chauth was a religious tax. → It was a **Maratha fiscal levy** (≈¼ of revenue), with **sardeshmukhi** an additional 10%.
- ❌ The Sayyid Brothers were provincial rebels. → They were **central king-makers** who controlled the throne itself.

### 6. 📰 Current link

📰 **Current linkage (verify live before use):** Safdarjung's tomb offers a tangible link between Mughal form and Awadh's autonomous elite. Verify any conservation partnership, budget or climate-adaptation claim officially.

### 7. Mains angles

- ⚠️ "The Mughal decline is better understood as a crisis of the jagirdari system than as the failure of individual emperors." Critically examine.
- ⚠️ Compare an emperor-centred explanation with Chandra's administrative-social jagirdari analysis.
- ⚠️ "The eighteenth century was one of transition and regional reordering, not merely decline." Discuss with reference to the successor states.

### ➕ Historiography ladder (PYQ-gap)

⚠️ Be ready to array the source-grounded debate: **Jadunath Sarkar's Aurangzeb-centred overexpansion argument** → **Satish Chandra's administrative-social jagirdari crisis** → **Part II's regional-state and continuing-economic-activity perspective**. Present these as overlapping emphases, not a simple supersession ladder.

## CONSOLIDATED REGISTER NOTES

### FINAL CONSOLIDATED REGISTER NOTES - TOPIC 25

![Visual 35: rapid recall -- the four anchor sets for final revision](assets/35_35_rapid_recall.png)
...
MUST REMEMBER: Mughal decline was multi-causal: jagirdari stress, succession, war, regional
  power and fiscal-military change interacted.
```
...
CLOSE DISTINCTION: Hyderabad, Awadh and Bengal were successor states that adapted Mughal
  institutions, not mere evidence of anarchy.
```
...
EVIDENCE LIMIT: The eighteenth century is a transition with regional growth and new
  competition, not a teleological prelude to British rule.
```
