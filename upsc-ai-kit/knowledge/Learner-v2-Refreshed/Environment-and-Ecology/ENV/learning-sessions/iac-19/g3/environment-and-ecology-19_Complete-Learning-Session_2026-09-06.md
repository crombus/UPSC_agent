...
- https://unfccc.int/process-and-meetings/what-is-the-united-nations-framework-convention-on-climate-change — attempted 2026-09-06; the official page returned only an Incapsula shell. No treaty article, party count, date or obligation was inferred.
- https://unfccc.int/kyoto_protocol — attempted 2026-09-06; the official page returned only an Incapsula shell. Kyoto dates, country groupings and mechanisms therefore remain bounded to repository owners and audited text.
- https://unfccc.int/process-and-meetings/the-paris-agreement — attempted 2026-09-06; the official page returned only an Incapsula shell. No article wording, ratification total or current NDC status was imported.
- https://unfccc.int/NCQG — attempted 2026-09-06; the official page returned only an Incapsula shell. Search discovery located official decision material, but the package treats a finance goal, pledge and verified delivery as distinct and asserts no delivery claim.
- https://unfccc.int/cop30/belem-political-package — attempted 2026-09-06; direct retrieval was blocked by Incapsula. Official-search discovery located the adopted-package page, but no proposal, roadmap or action-agenda statement was silently converted into a COP decision.
- https://unfccc.int/process/the-paris-agreement/status-of-ratification — attempted 2026-09-06; direct retrieval was blocked by Incapsula, so no current Party count or ratification status was quoted.
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Environment-and-Ecology\basic\19_UNFCCC-COP-Kyoto-Paris-Agreement.md`  
**Substantive canonical provenance owner:** `upsc-ai-kit\knowledge\Environment-and-Ecology\learning-sessions\v2\subject-wide-syllabus\environment-and-ecology-19_Learning-Session.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Environment-and-Ecology\advanced\19_UNFCCC-COP-Kyoto-Paris-Agreement.md`  
...
**Plain-language definition:** UNFCCC convention and COP CMP CMA framework explains how UNFCCC convention identity and COP-CMP-CMA boundary fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, UNFCCC convention and COP CMP CMA framework separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> UNFCCC convention and COP CMP CMA framework must be read through UNFCCC convention identity and COP-CMP-CMA boundary, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define UNFCCC, convention, framework; attach identity to its source, scale, instrument and status; then qualify the answer with this limit: Do not merge the UNFCCC convention with the Kyoto Protocol or Paris Agreement.
...
```closure-flow
START / CONCEPT: UNFCCC convention and COP CMP CMA framework
EXACT TERMS: UNFCCC | convention | framework | identity | COP-CMP-CMA | boundary
MECHANISM / ARGUMENT: connect UNFCCC convention identity and COP-CMP-CMA boundary through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Start with the Convention as framework and place every later instrument beneath it.
UPSC TRAP / ANSWER-USE: Do not merge the UNFCCC convention with the Kyoto Protocol or Paris Agreement.
ANSWER-GRABBING FORMULATION: UNFCCC convention and COP CMP CMA framework converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Adoption signature ratification and entry into force explains how Treaty-status sequence fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Adoption signature ratification and entry into force separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Adoption signature ratification and entry into force must be read through Treaty-status sequence, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Adoption, signature, ratification; attach entry to its source, scale, instrument and status; then qualify the answer with this limit: Do not attribute a CMP or CMA decision generically to the COP without precision.
...
```closure-flow
START / CONCEPT: Adoption signature ratification and entry into force
EXACT TERMS: Adoption | signature | ratification | entry | into | force
MECHANISM / ARGUMENT: connect Treaty-status sequence through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Attribute each decision to COP, CMP or CMA and the relevant instrument.
UPSC TRAP / ANSWER-USE: Do not attribute a CMP or CMA decision generically to the COP without precision.
ANSWER-GRABBING FORMULATION: Adoption signature ratification and entry into force converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Kyoto Protocol commitment architecture explains how Kyoto Protocol identity fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Kyoto Protocol commitment architecture separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Kyoto Protocol commitment architecture must be read through Kyoto Protocol identity, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Kyoto, Protocol, commitment; attach architecture to its source, scale, instrument and status; then qualify the answer with this limit: Do not merge adoption, signature, ratification and entry into force.
...
```closure-flow
START / CONCEPT: Kyoto Protocol commitment architecture
EXACT TERMS: Kyoto | Protocol | commitment | architecture | identity | operationalised
MECHANISM / ARGUMENT: connect Kyoto Protocol identity through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Use a legal-status timeline before claiming an instrument became operative.
UPSC TRAP / ANSWER-USE: Do not merge adoption, signature, ratification and entry into force.
ANSWER-GRABBING FORMULATION: Kyoto Protocol commitment architecture converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Annex I historical boundary explains how Annex I historical boundary fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Annex I historical boundary separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Annex I historical boundary must be read through Annex I historical boundary, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Annex, historical, boundary; attach Convention to its source, scale, instrument and status; then qualify the answer with this limit: Do not say Kyoto imposed identical binding targets on every country.
...
```closure-flow
START / CONCEPT: Annex I historical boundary
EXACT TERMS: Annex | historical | boundary | Convention | grouping | used
MECHANISM / ARGUMENT: connect Annex I historical boundary through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Define Kyoto by covered group, commitment period and quantified commitment architecture.
UPSC TRAP / ANSWER-USE: Do not say Kyoto imposed identical binding targets on every country.
ANSWER-GRABBING FORMULATION: Annex I historical boundary converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Non-Annex Kyoto commitment boundary explains how Non-Annex Kyoto boundary fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Non-Annex Kyoto commitment boundary separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Non-Annex Kyoto commitment boundary must be read through Non-Annex Kyoto boundary, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Non-Annex, Kyoto, commitment; attach boundary to its source, scale, instrument and status; then qualify the answer with this limit: Do not use Annex and non-Annex labels without the instrument and historical context.
...
```closure-flow
START / CONCEPT: Non-Annex Kyoto commitment boundary
EXACT TERMS: Non-Annex | Kyoto | commitment | boundary | Developing | Parties
MECHANISM / ARGUMENT: connect Non-Annex Kyoto boundary through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Use Annex terminology only with its treaty and historical function.
UPSC TRAP / ANSWER-USE: Do not use Annex and non-Annex labels without the instrument and historical context.
ANSWER-GRABBING FORMULATION: Non-Annex Kyoto commitment boundary converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Kyoto mechanisms and Doha Amendment status explains how Kyoto mechanisms and Doha Amendment status fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Kyoto mechanisms and Doha Amendment status separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Kyoto mechanisms and Doha Amendment status must be read through Kyoto mechanisms and Doha Amendment status, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Kyoto, mechanisms, Doha; attach Amendment to its source, scale, instrument and status; then qualify the answer with this limit: Do not merge CDM, Joint Implementation and international emissions trading.
...
```closure-flow
START / CONCEPT: Kyoto mechanisms and Doha Amendment status
EXACT TERMS: Kyoto | mechanisms | Doha | Amendment | status | International
MECHANISM / ARGUMENT: connect Kyoto mechanisms and Doha Amendment status through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Compare each Kyoto mechanism by participants, unit and transaction pathway.
UPSC TRAP / ANSWER-USE: Do not merge CDM, Joint Implementation and international emissions trading.
ANSWER-GRABBING FORMULATION: Kyoto mechanisms and Doha Amendment status converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Paris Agreement universal architecture explains how Paris Agreement identity fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Paris Agreement universal architecture separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Paris Agreement universal architecture must be read through Paris Agreement identity, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Paris, Agreement, universal; attach architecture to its source, scale, instrument and status; then qualify the answer with this limit: Do not treat amendment adoption as entry into force.
...
```closure-flow
START / CONCEPT: Paris Agreement universal architecture
EXACT TERMS: Paris | Agreement | universal | architecture | identity | under
MECHANISM / ARGUMENT: connect Paris Agreement identity through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Separate amendment text, ratification threshold, entry into force and period covered.
UPSC TRAP / ANSWER-USE: Do not treat amendment adoption as entry into force.
ANSWER-GRABBING FORMULATION: Paris Agreement universal architecture converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Nationally Determined Contribution boundary explains how NDC boundary fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Nationally Determined Contribution boundary separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Nationally Determined Contribution boundary must be read through NDC boundary, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Nationally, Determined, Contribution; attach boundary to its source, scale, instrument and status; then qualify the answer with this limit: Do not say Paris assigns the same substantive numerical target to all Parties.
...
```closure-flow
START / CONCEPT: Nationally Determined Contribution boundary
EXACT TERMS: Nationally | Determined | Contribution | boundary | communicated | Party
MECHANISM / ARGUMENT: connect NDC boundary through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Explain universal participation through nationally determined contributions.
UPSC TRAP / ANSWER-USE: Do not say Paris assigns the same substantive numerical target to all Parties.
ANSWER-GRABBING FORMULATION: Nationally Determined Contribution boundary converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Legally binding procedure and nationally determined ambition explains how Procedure-ambition distinction fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Legally binding procedure and nationally determined ambition separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Legally binding procedure and nationally determined ambition must be read through Procedure-ambition distinction, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Legally, binding, procedure; attach nationally to its source, scale, instrument and status; then qualify the answer with this limit: Do not merge legally binding procedural duties with nationally determined ambition.
...
```closure-flow
START / CONCEPT: Legally binding procedure and nationally determined ambition
EXACT TERMS: Legally | binding | procedure | nationally | determined | ambition
MECHANISM / ARGUMENT: connect Procedure-ambition distinction through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: List procedural duties separately from the self-determined target level.
UPSC TRAP / ANSWER-USE: Do not merge legally binding procedural duties with nationally determined ambition.
ANSWER-GRABBING FORMULATION: Legally binding procedure and nationally determined ambition converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** NDC progression and successive cycle explains how Progression and cycle fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, NDC progression and successive cycle separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> NDC progression and successive cycle must be read through Progression and cycle, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define progression, successive, cycle; attach NDCs to its source, scale, instrument and status; then qualify the answer with this limit: Do not turn progression into a mandatory universal percentage.
...
```closure-flow
START / CONCEPT: NDC progression and successive cycle
EXACT TERMS: progression | successive | cycle | NDCs | expected | represent
MECHANISM / ARGUMENT: connect Progression and cycle through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Connect progression, highest possible ambition and successive communication without inventing a rate.
UPSC TRAP / ANSWER-USE: Do not turn progression into a mandatory universal percentage.
ANSWER-GRABBING FORMULATION: NDC progression and successive cycle converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Transparency framework and Global Stocktake explains how Transparency-outcome boundary and Global Stocktake boundary fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Transparency framework and Global Stocktake separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Transparency framework and Global Stocktake must be read through Transparency-outcome boundary and Global Stocktake boundary, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Transparency, framework, Global; attach Stocktake to its source, scale, instrument and status; then qualify the answer with this limit: Do not treat transparency reporting as proof of target achievement.
...
```closure-flow
START / CONCEPT: Transparency framework and Global Stocktake
EXACT TERMS: Transparency | framework | Global | Stocktake | Transparency-outcome | boundary
MECHANISM / ARGUMENT: connect Transparency-outcome boundary and Global Stocktake boundary through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Treat transparency as evidence infrastructure rather than an achievement certificate.
UPSC TRAP / ANSWER-USE: Do not treat transparency reporting as proof of target achievement.
ANSWER-GRABBING FORMULATION: Transparency framework and Global Stocktake converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** CBDR-RC differentiation and equity explains how CBDR-RC continuity fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, CBDR-RC differentiation and equity separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> CBDR-RC differentiation and equity must be read through CBDR-RC continuity, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define CBDR-RC, differentiation, equity; attach continuity to its source, scale, instrument and status; then qualify the answer with this limit: Do not treat the Global Stocktake as a national compliance verdict.
...
```closure-flow
START / CONCEPT: CBDR-RC differentiation and equity
EXACT TERMS: CBDR-RC | differentiation | equity | continuity | Common | differentiated
MECHANISM / ARGUMENT: connect CBDR-RC continuity through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Use the stocktake for collective progress and subsequent national updating.
UPSC TRAP / ANSWER-USE: Do not treat the Global Stocktake as a national compliance verdict.
ANSWER-GRABBING FORMULATION: CBDR-RC differentiation and equity converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Article 6 cooperative architecture explains how Article 6 architecture fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Article 6 cooperative architecture separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Article 6 cooperative architecture must be read through Article 6 architecture, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Article, cooperative, architecture; attach approaches to its source, scale, instrument and status; then qualify the answer with this limit: Do not say Paris abolished CBDR-RC.
...
```closure-flow
START / CONCEPT: Article 6 cooperative architecture
EXACT TERMS: Article | cooperative | architecture | approaches | mechanism | non-market
MECHANISM / ARGUMENT: connect Article 6 architecture through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Apply differentiation through responsibility, capability and national circumstances.
UPSC TRAP / ANSWER-USE: Do not say Paris abolished CBDR-RC.
ANSWER-GRABBING FORMULATION: Article 6 cooperative architecture converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Mitigation adaptation loss and decision-delivery distinctions explains how Mitigation-adaptation-loss boundary and Decision-pledge-delivery distinction fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Mitigation adaptation loss and decision-delivery distinctions separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mitigation adaptation loss and decision-delivery distinctions must be read through Mitigation-adaptation-loss boundary and Decision-pledge-delivery distinction, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Mitigation, adaptation, loss; attach decision-delivery to its source, scale, instrument and status; then qualify the answer with this limit: Do not merge Article 6.2, 6.4 and 6.8.
...
```closure-flow
START / CONCEPT: Mitigation adaptation loss and decision-delivery distinctions
EXACT TERMS: Mitigation | adaptation | loss | decision-delivery | distinctions | Mitigation-adaptation-loss
MECHANISM / ARGUMENT: connect Mitigation-adaptation-loss boundary and Decision-pledge-delivery distinction through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Separate Article 6 pathways and then distinguish mitigation, adaptation and residual harm.
UPSC TRAP / ANSWER-USE: Do not merge Article 6.2, 6.4 and 6.8.
ANSWER-GRABBING FORMULATION: Mitigation adaptation loss and decision-delivery distinctions converts a precise environmental distinction into a qualified conclusion
```
...
**Plain-language definition:** Treaty decision pledge delivery and current-outcome audit explains how Treaty-decision hierarchy and Current-outcome evidence boundary fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Treaty decision pledge delivery and current-outcome audit separates the environmental system and receiving medium from the measured parameter, source or precursor, responsible actor, regulatory instrument, spatial scale, temporal stage, rule vintage and legal or scientific status attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Treaty decision pledge delivery and current-outcome audit must be read through Treaty-decision hierarchy and Current-outcome evidence boundary, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Treaty, decision, pledge; attach delivery to its source, scale, instrument and status; then qualify the answer with this limit: Do not merge mitigation, adaptation and loss and damage.
...
```closure-flow
START / CONCEPT: Treaty decision pledge delivery and current-outcome audit
EXACT TERMS: Treaty | decision | pledge | delivery | current-outcome | audit
MECHANISM / ARGUMENT: connect Treaty-decision hierarchy and Current-outcome evidence boundary through the source, pathway, instrument and evidence chain
CONSEQUENCE / CONTRAST: Close by ranking treaty text, adopted decision, announcement, finance goal and delivery evidence.
UPSC TRAP / ANSWER-USE: Do not merge mitigation, adaptation and loss and damage.
ANSWER-GRABBING FORMULATION: Treaty decision pledge delivery and current-outcome audit converts a precise environmental distinction into a qualified conclusion
```
...
**How to improve this answer:** For “AUDITED UNFCCC, KYOTO, PARIS, COP AND INDIA-COMMITMENT PYQ OWNERSHIP”, replace the weakest catalogue point with one exact mechanism or distinction, named law/institution/treaty/species, dated status, measurable outcome, implementation constraint and answer-specific qualification.
...
**Introduction and thesis:** **Claim:** Treaty-status sequence. **Named evidence/example:** Adoption, signature, ratification or accession, entry into force and domestic implementation are separate legal or political stages; completion of one stage does not prove another. **Analysis:** This identifies the environmental mechanism, system boundary, measured parameter, responsible actor and causal link that make the claim examinable. **Qualification:** The conclusion must retain the source's ecological or regulatory scale, temporal stage, rule vintage, legal status, metric and evidence boundary rather than generalise beyond the owner. **Claim:** Doha Amendment status. **Named evidence/example:** The Doha Amendment concerns Kyoto's second commitment period and has its own adoption and entry-into-force history; amendment adoption and operative legal status are not interchangeable. **Analysis:** This identifies the environmental mechanism, system boundary, measured parameter, responsible actor and causal link that make the claim examinable. **Qualification:** The conclusion must retain the source's ecological or regulatory scale, temporal stage, rule vintage, legal status, metric and evidence boundary rather than generalise beyond the owner. **Claim:** Treaty-decision hierarchy. **Named evidence/example:** The Convention, Protocol, Agreement, amendment, COP or CMA decision, rulebook guidance and national instrument have different legal functions; a later decision implements but does not silently rewrite treaty text. **Analysis:** This identifies the environmental mechanism, system boundary, measured parameter, responsible actor and causal link that make the claim examinable. **Qualification:** The conclusion must retain the source's ecological or regulatory scale, temporal stage, rule vintage, legal status, metric and evidence boundary rather than generalise beyond the owner.
...
9. **Claim and named evidence:** A presidency proposal, negotiating draft, roadmap, action-agenda release and adopted decision are not equivalent; current COP outcomes, Party counts, finance claims and NDC status require the final official source. **Analysis:** Connect the defined system/taxon and named evidence → ecological mechanism or legal/institutional instrument → implementation pathway → ecological and social consequence. **Qualification:** State scale, stock/flow, parameter/unit, source/date/status, jurisdiction, uncertainty, causal limit, exception or residual risk.
