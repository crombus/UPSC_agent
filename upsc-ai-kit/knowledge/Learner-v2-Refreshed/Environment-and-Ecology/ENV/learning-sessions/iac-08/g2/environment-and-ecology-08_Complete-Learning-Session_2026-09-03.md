---
title: "Wildlife Protection Act and Schedules — Learner-v2 Refreshed"
topic_key: environment-and-ecology-08
cover_image: assets/environment-and-ecology-08_Teaching-Navigation_2026-09-03.png
---
...
- https://www.indiacode.nic.in/indiacode/handle/123456789/12931?view_type=browse — attempted 2026-09-03; India Code returned HTTP 403, so no schedule placement, penalty or provision was imported.
- https://hpforest.gov.in/storage/files/1/Acts/Wild%20Life%20Act%20%202022%20New%20amendments.pdf — attempted 2026-09-03; an official state forest department copy of the 2022 amendment was retrievable only as raw PDF bytes, so it was logged but not text-mined.
- https://www.forests.tn.gov.in/frontend/gos/The_Wild_Life_(Protection)_Amendment_Act,_2022_123.pdf — attempted 2026-09-03; the official state forest department PDF was image/raw-byte content, so no section, schedule or penalty was transcribed.
- https://moef.gov.in/wildlife — attempted 2026-09-03; substantive MoEFCC text expressly linked WCCB to sections 38Y and 38Z. The page also contained visibly stale or erroneous material, so no species count, reserve count, penalty or schedule placement was taken from it.
- https://moef.gov.in/wildlife-wl — attempted 2026-09-03; substantive MoEFCC text confirmed the Wildlife Division's legal-policy role and the four protected-area categories. It was not used to infer a species schedule or a current legal amendment.
...
![Refreshed teaching navigation](assets/environment-and-ecology-08_Teaching-Navigation_2026-09-03.png)
...
**Plain-language definition:** Mechanism chain: Legal vintage first - Six schedules to four Qualified use: Open by fixing the pre- or post-2022 legal structure.

**Technical definition:** Every answer must identify whether it uses the pre-2022 six-schedule structure or the post-2022 four-schedule structure of the Wildlife Protection Act.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mechanism chain: Legal vintage first - Six schedules to four Qualified use: Open by fixing the pre- or post-2022 legal structure.

#### MUST-WRITE KEYWORDS

- **FOUNDATION**
- **Legal vintage**
- **six-to-four restructuring**
- **Mechanism chain**
- **Qualified use**
- **Protection Act. The Wildlife Protection Amendment Act 2022**

**How to use them:** Frame the answer through FOUNDATION; define Legal vintage, connect six-to-four restructuring with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — LEGAL VINTAGE AND SIX-TO-FOUR RESTRUCTURING

```text
START / CONCEPT: FOUNDATION — Legal vintage and six-to-four restructuring
        |
        v
EXACT TERMS: FOUNDATION · Legal vintage · six-to-four restructuring · Mechanism chain · Qualified use · Protection Act. The Wildlife Protection Amendment Act 2022
        |
        v
MECHANISM / ARGUMENT: Every answer must identify whether it uses the pre-2022 six-schedule structure or the post-2022 four-schedule structure of the Wildlife Protection Act.
        |
        v
CONSEQUENCE / CONTRAST: Do not answer a pre-2022 question with the post-2022 schedule count without qualification.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: legal vintage first - Six schedules to four Qualified use.
        |
        v
ANSWER-GRABBING FORMULATION: Mechanism chain: Legal vintage first - Six schedules to four Qualified use: Open by fixing the pre- or post-2022 legal structure.
```
### SESSION 2 — FOUNDATION — SCHEDULE I ANIMALS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Under the post-2022 owner framework, Schedule I lists animals receiving the greatest degree of protection; no species placement is assumed without the current schedule.

**Technical definition:** Mechanism chain: Schedule I Qualified use: State the highest animal-protection schedule without guessing species placement.
...
**How to use them:** Frame the answer through FOUNDATION; define Schedule I animals, connect Mechanism chain with Qualified use to explain the mechanism, and use Under for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — SCHEDULE I ANIMALS

```text
START / CONCEPT: FOUNDATION — Schedule I animals
        |
        v
EXACT TERMS: FOUNDATION · Schedule I animals · Mechanism chain · Qualified use · Under · Schedule
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Schedule I Qualified use: State the highest animal-protection schedule without guessing species placement.
        |
        v
CONSEQUENCE / CONTRAST: Do not say the current Act still has six schedules.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: do not say the current Act still has six schedules.
        |
        v
ANSWER-GRABBING FORMULATION: Under the post-2022 owner framework, Schedule I lists animals receiving the greatest degree of protection; no species placement is assumed without the current schedule.
```
### SESSION 3 — FOUNDATION — SCHEDULE II ANIMALS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: Schedule II Qualified use: Contrast Schedule II with Schedule I while retaining legal protection.

**Technical definition:** Technically, FOUNDATION — Schedule II animals is analysed by relating FOUNDATION to Schedule II animals, then testing the relationship through Mechanism chain and Qualified use.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mechanism chain: Schedule II Qualified use: Contrast Schedule II with Schedule I while retaining legal protection.
...
- **Qualified use**
- **Schedule**
- **Schedule II Qualified**

**How to use them:** Frame the answer through FOUNDATION; define Schedule II animals, connect Mechanism chain with Qualified use to explain the mechanism, and use Schedule for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — SCHEDULE II ANIMALS

```text
START / CONCEPT: FOUNDATION — Schedule II animals
        |
        v
EXACT TERMS: FOUNDATION · Schedule II animals · Mechanism chain · Qualified use · Schedule · Schedule II Qualified
        |
        v
MECHANISM / ARGUMENT: Do not assign a species to Schedule I from memory without checking the current text.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that contrast Schedule II with Schedule I while retaining legal protection.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: contrast Schedule II with Schedule I while retaining legal protection.
        |
        v
ANSWER-GRABBING FORMULATION: Mechanism chain: Schedule II Qualified use: Contrast Schedule II with Schedule I while retaining legal protection.
```
### SESSION 4 — CORE — SCHEDULE III PLANTS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Post-2022 Schedule III is the specified plant schedule; it is not a third animal-protection tier and replaces the function of old Schedule VI.

**Technical definition:** Mechanism chain: Schedule III Qualified use: Identify the plant schedule and its old Schedule VI lineage.
...
- **Mechanism chain**
- **Qualified use**
- **Post-2022 Schedule III**
- **Post**
- **Schedule III**

**How to use them:** Frame the answer through Schedule III plants; define Mechanism chain, connect Qualified use with Post-2022 Schedule III to explain the mechanism, and use Post for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — SCHEDULE III PLANTS

```text
START / CONCEPT: CORE — Schedule III plants
        |
        v
EXACT TERMS: Schedule III plants · Mechanism chain · Qualified use · Post-2022 Schedule III · Post · Schedule III
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Schedule III Qualified use: Identify the plant schedule and its old Schedule VI lineage.
        |
        v
CONSEQUENCE / CONTRAST: Do not describe Schedule II as unprotected wildlife.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: post-2022 Schedule III is the specified plant schedule.
        |
        v
ANSWER-GRABBING FORMULATION: Post-2022 Schedule III is the specified plant schedule; it is not a third animal-protection tier and replaces the function of old Schedule VI.
```
### SESSION 5 — CORE — SCHEDULE IV CITES SPECIMENS

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Post-2022 Schedule IV covers CITES-listed scheduled specimens for international trade regulation; it is not a higher protection rung than Schedule I or II.

**Technical definition:** Mechanism chain: Schedule IV Qualified use: Describe Schedule IV as trade regulation, not a protection rung.
...
**How to use them:** Frame the answer through Schedule IV CITES specimens; define Mechanism chain, connect Qualified use with Post to explain the mechanism, and use Schedule IV for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — SCHEDULE IV CITES SPECIMENS

```text
START / CONCEPT: CORE — Schedule IV CITES specimens
        |
        v
EXACT TERMS: Schedule IV CITES specimens · Mechanism chain · Qualified use · Post · Schedule IV · CITES-listed
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Schedule IV Qualified use: Describe Schedule IV as trade regulation, not a protection rung.
        |
        v
CONSEQUENCE / CONTRAST: Do not call post-2022 Schedule III an animal-protection tier.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: post-2022 Schedule IV covers CITES-listed scheduled specimens for international trade regulation.
        |
        v
ANSWER-GRABBING FORMULATION: Post-2022 Schedule IV covers CITES-listed scheduled specimens for international trade regulation; it is not a higher protection rung than Schedule I or II.
```
### SESSION 6 — CORE — SPECIES PLACEMENT AND VERMIN TIME POINT

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: Species placement discipline - Vermin time point Qualified use: Verify current notification and treat vermin through the correct legal vintage.

**Technical definition:** Exact species-to-schedule placement can change through the applicable legal process and must be checked against the current consolidated schedule or notification.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mechanism chain: Species placement discipline - Vermin time point Qualified use: Verify current notification and treat vermin through the correct legal vintage.
...
**How to use them:** Frame the answer through Species placement; define vermin time point, connect Mechanism chain with Qualified use to explain the mechanism, and use Exact for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — SPECIES PLACEMENT AND VERMIN TIME POINT

```text
START / CONCEPT: CORE — Species placement and vermin time point
        |
        v
EXACT TERMS: Species placement · vermin time point · Mechanism chain · Qualified use · Exact · Schedule
        |
        v
MECHANISM / ARGUMENT: Exact species-to-schedule placement can change through the applicable legal process and must be checked against the current consolidated schedule or notification.
        |
        v
CONSEQUENCE / CONTRAST: Do not call Schedule IV the highest domestic protection category.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the old Schedule V vermin list was omitted in 2022.
        |
        v
ANSWER-GRABBING FORMULATION: Mechanism chain: Species placement discipline - Vermin time point Qualified use: Verify current notification and treat vermin through the correct legal vintage.
```
### SESSION 7 — CORE — HUNTING PROHIBITION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The Act's baseline is prohibition of hunting protected wild animals; a legal exception must be traced to its statutory condition, authority and written permission.

**Technical definition:** Mechanism chain: Hunting prohibition Qualified use: Start from prohibition rather than exception.
...
**How to use them:** Frame the answer through Hunting prohibition; define Mechanism chain, connect Qualified use with The Act's baseline to explain the mechanism, and use The Act's for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — HUNTING PROHIBITION

```text
START / CONCEPT: CORE — Hunting prohibition
        |
        v
EXACT TERMS: Hunting prohibition · Mechanism chain · Qualified use · The Act's baseline · The Act's · CITES Appendix
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Hunting prohibition Qualified use: Start from prohibition rather than exception.
        |
        v
CONSEQUENCE / CONTRAST: Do not treat CITES Appendix change as an instantaneous Indian schedule amendment.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: start from prohibition rather than exception.
        |
        v
ANSWER-GRABBING FORMULATION: The Act's baseline is prohibition of hunting protected wild animals; a legal exception must be traced to its statutory condition, authority and written permission.
```
### SESSION 8 — CORE — PERMIT AND EXCEPTION ARCHITECTURE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: Permit and exception Qualified use: Name the purpose, permit, authority and statutory condition.

**Technical definition:** Scientific, educational, collection or management purposes do not create a free-standing right to hunt; the applicable permit and statutory conditions remain necessary.
...
**How to use them:** Frame the answer through Permit; define exception architecture, connect Mechanism chain with Qualified use to explain the mechanism, and use Scientific for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — PERMIT AND EXCEPTION ARCHITECTURE

```text
START / CONCEPT: CORE — Permit and exception architecture
        |
        v
EXACT TERMS: Permit · exception architecture · Mechanism chain · Qualified use · Scientific · Schedule
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Permit and exception Qualified use: Name the purpose, permit, authority and statutory condition.
        |
        v
CONSEQUENCE / CONTRAST: Do not say the old Schedule V vermin list still exists.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: scientific, educational, collection or management purposes do not create a free-standing right to hunt.
        |
        v
ANSWER-GRABBING FORMULATION: Scientific, educational, collection or management purposes do not create a free-standing right to hunt; the applicable permit and statutory conditions remain necessary.
```
### SESSION 9 — CORE — DANGEROUS OR BEYOND-RECOVERY ROUTE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The owner records narrow action where an animal is dangerous to human life or disabled or diseased beyond recovery, with the competent authority depending on schedule and provision.

**Technical definition:** Mechanism chain: Dangerous or beyond recovery route Qualified use: Use the narrow condition without converting it into a general culling power.
...
- **Mechanism chain**
- **Qualified use**
- **The owner records narrow action where an animal**
- **Dangerous**
- **Qualified**

**How to use them:** Frame the answer through Dangerous or beyond-recovery route; define Mechanism chain, connect Qualified use with The owner records narrow action where an animal to explain the mechanism, and use Dangerous for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — DANGEROUS OR BEYOND-RECOVERY ROUTE

```text
START / CONCEPT: CORE — Dangerous or beyond-recovery route
        |
        v
EXACT TERMS: Dangerous or beyond-recovery route · Mechanism chain · Qualified use · The owner records narrow action where an animal · Dangerous · Qualified
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: Dangerous or beyond recovery route Qualified use: Use the narrow condition without converting it into a general culling power.
        |
        v
CONSEQUENCE / CONTRAST: Do not convert a hunting exception into a general permission.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: use the narrow condition without converting it into a general culling power.
        |
        v
ANSWER-GRABBING FORMULATION: The owner records narrow action where an animal is dangerous to human life or disabled or diseased beyond recovery, with the competent authority depending on schedule and provision.
```
### SESSION 10 — CORE — CITES MANAGEMENT AUTHORITY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: CITES Management Authority Qualified use: Assign permits and certificates to the Management Authority.

**Technical definition:** The post-2022 framework requires a Management Authority for permits and certificates in international trade in scheduled specimens.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mechanism chain: CITES Management Authority Qualified use: Assign permits and certificates to the Management Authority.
...
- **CITES Management Authority Qualified**
- **Assign**

**How to use them:** Frame the answer through CITES Management Authority; define Mechanism chain, connect Qualified use with Management Authority to explain the mechanism, and use CITES Management Authority Qualified for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — CITES MANAGEMENT AUTHORITY

```text
START / CONCEPT: CORE — CITES Management Authority
        |
        v
EXACT TERMS: CITES Management Authority · Mechanism chain · Qualified use · Management Authority · CITES Management Authority Qualified · Assign
        |
        v
MECHANISM / ARGUMENT: The post-2022 framework requires a Management Authority for permits and certificates in international trade in scheduled specimens.
        |
        v
CONSEQUENCE / CONTRAST: Do not omit the competent authority and written-permission requirement.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: assign permits and certificates to the Management Authority.
        |
        v
ANSWER-GRABBING FORMULATION: Mechanism chain: CITES Management Authority Qualified use: Assign permits and certificates to the Management Authority.
```
### SESSION 11 — CORE — SCIENTIFIC AUTHORITY AND CHAPTER VB

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: CITES Scientific Authority - Chapter VB trade architecture Qualified use: Separate scientific advice from Chapter VB's wider trade machinery.

**Technical definition:** Technically, CORE — Scientific Authority and Chapter VB is analysed by relating Scientific Authority to Chapter VB, then testing the relationship through Mechanism chain and Qualified use.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mechanism chain: CITES Scientific Authority - Chapter VB trade architecture Qualified use: Separate scientific advice from Chapter VB's wider trade machinery.
...
**How to use them:** Frame the answer through Scientific Authority; define Chapter VB, connect Mechanism chain with Qualified use to explain the mechanism, and use Management Authority for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — SCIENTIFIC AUTHORITY AND CHAPTER VB

```text
START / CONCEPT: CORE — Scientific Authority and Chapter VB
        |
        v
EXACT TERMS: Scientific Authority · Chapter VB · Mechanism chain · Qualified use · Management Authority · CITES Scientific Authority
        |
        v
MECHANISM / ARGUMENT: Do not merge Management Authority and Scientific Authority functions.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that cITES Scientific Authority - Chapter VB trade architecture Qualified use.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: cITES Scientific Authority - Chapter VB trade architecture Qualified use.
        |
        v
ANSWER-GRABBING FORMULATION: Mechanism chain: CITES Scientific Authority - Chapter VB trade architecture Qualified use: Separate scientific advice from Chapter VB's wider trade machinery.
```
### SESSION 12 — CORE — INVASIVE ALIEN SPECIES POWER

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: Invasive alien species Qualified use: State the Central Government power without inventing a listed species.

**Technical definition:** Technically, CORE — Invasive alien species power is analysed by relating Invasive alien species power to Mechanism chain, then testing the relationship through Qualified use and WCCB.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mechanism chain: Invasive alien species Qualified use: State the Central Government power without inventing a listed species.
...
**How to use them:** Frame the answer through Invasive alien species power; define Mechanism chain, connect Qualified use with WCCB to explain the mechanism, and use Invasive for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — INVASIVE ALIEN SPECIES POWER

```text
START / CONCEPT: CORE — Invasive alien species power
        |
        v
EXACT TERMS: Invasive alien species power · Mechanism chain · Qualified use · WCCB · Invasive · Qualified
        |
        v
MECHANISM / ARGUMENT: Do not use WCCB as the authority for every wildlife-law decision.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that state the Central Government power without inventing a listed species.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: state the Central Government power without inventing a listed species.
        |
        v
ANSWER-GRABBING FORMULATION: Mechanism chain: Invasive alien species Qualified use: State the Central Government power without inventing a listed species.
```
### SESSION 13 — CORE SYNTHESIS — WCCB STATUTORY ROLE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: WCCB statutory role Qualified use: Use sections 38Y and 38Z only for the WCCB role confirmed by MoEFCC.

**Technical definition:** Mains: Use sections 38Y and 38Z only for the WCCB role confirmed by MoEFCC.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mechanism chain: WCCB statutory role Qualified use: Use sections 38Y and 38Z only for the WCCB role confirmed by MoEFCC.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define WCCB statutory role, connect Mechanism chain with Qualified use to explain the mechanism, and use MoEFCC's for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — WCCB STATUTORY ROLE

```text
START / CONCEPT: CORE SYNTHESIS — WCCB statutory role
        |
        v
EXACT TERMS: CORE SYNTHESIS · WCCB statutory role · Mechanism chain · Qualified use · MoEFCC's · WCCB
        |
        v
MECHANISM / ARGUMENT: Mains: Use sections 38Y and 38Z only for the WCCB role confirmed by MoEFCC.
        |
        v
CONSEQUENCE / CONTRAST: Do not attach a penalty amount without the applicable amendment and offence provision.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: moEFCC's retrievable page states that WCCB was constituted under section 38Y and lists section...
        |
        v
ANSWER-GRABBING FORMULATION: Mechanism chain: WCCB statutory role Qualified use: Use sections 38Y and 38Z only for the WCCB role confirmed by MoEFCC.
```
### SESSION 14 — CORE SYNTHESIS — STATE, CHIEF WILDLIFE WARDEN, NBWL AND NTCA ROLES

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: State and Chief Wildlife Warden - NBWL and NTCA Qualified use: Map each domestic authority to its own jurisdiction.

**Technical definition:** NBWL and NTCA exercise protected-area and tiger-specific roles under their respective provisions; they do not replace the Chief Wildlife Warden or CITES authorities.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define Chief Wildlife Warden, connect NBWL with NTCA roles to explain the mechanism, and use Mechanism chain for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — STATE, CHIEF WILDLIFE WARDEN, NBWL AND NTCA ROLES

```text
START / CONCEPT: CORE SYNTHESIS — State, Chief Wildlife Warden, NBWL and NTCA roles
        |
        v
EXACT TERMS: CORE SYNTHESIS · Chief Wildlife Warden · NBWL · NTCA roles · Mechanism chain · Qualified use
        |
        v
MECHANISM / ARGUMENT: Mechanism chain: State and Chief Wildlife Warden - NBWL and NTCA Qualified use: Map each domestic authority to its own jurisdiction.
        |
        v
CONSEQUENCE / CONTRAST: State wildlife departments and the Chief Wildlife Warden perform on-ground authorisation and enforcement functions; their jurisdiction must not be assigned to WCCB.
        |
        v
UPSC TRAP / ANSWER-USE: Do not equate an IUCN category, domestic schedule and CITES Appendix.
        |
        v
ANSWER-GRABBING FORMULATION: NBWL and NTCA exercise protected-area and tiger-specific roles under their respective provisions; they do not replace the Chief Wildlife Warden or CITES authorities.
```
### SESSION 15 — CORE SYNTHESIS — SCIENCE-LAW-TRADE AND AUDITED PYQ BOUNDARY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Mechanism chain: Science, law and trade - Audited PYQ vintage boundary Qualified use: Close by separating IUCN science, domestic law, CITES trade and PYQ vintage.

**Technical definition:** Technically, CORE SYNTHESIS — Science-law-trade and audited PYQ boundary is analysed by relating CORE SYNTHESIS to Science-law-trade, then testing the relationship through audited PYQ boundary and Mechanism chain.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Mechanism chain: Science, law and trade - Audited PYQ vintage boundary Qualified use: Close by separating IUCN science, domestic law, CITES trade and PYQ vintage.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define Science-law-trade, connect audited PYQ boundary with Mechanism chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — SCIENCE-LAW-TRADE AND AUDITED PYQ BOUNDARY

```text
START / CONCEPT: CORE SYNTHESIS — Science-law-trade and audited PYQ boundary
        |
        v
EXACT TERMS: CORE SYNTHESIS · Science-law-trade · audited PYQ boundary · Mechanism chain · Qualified use · Subject
        |
        v
MECHANISM / ARGUMENT: It is kept separate from the 2018-2023 block and does not convert an unkeyed/answer-free objective question into a solved answer. <!-- END GENERATED PYQ INTEGRATION: 2024-2025.
        |
        v
CONSEQUENCE / CONTRAST: IUCN category assesses extinction risk, Wildlife Protection Act schedules create domestic legal consequences, and CITES regulates international trade; the three systems are related but distinct.
        |
        v
UPSC TRAP / ANSWER-USE: Do not infer an objective answer key from a routed PYQ demand.
        |
        v
ANSWER-GRABBING FORMULATION: Mechanism chain: Science, law and trade - Audited PYQ vintage boundary Qualified use: Close by separating IUCN science, domestic law, CITES trade and PYQ vintage.
```
...
India Code returned HTTP 403 on 2026-09-03. Official state forest department copies of the 2022 amendment were retrievable only as raw or image PDF bytes and were not text-mined. MoEFCC's wildlife page was used narrowly for WCCB sections 38Y and 38Z; its stale or erroneous material was excluded. No species schedule, penalty or later amendment was inferred.
