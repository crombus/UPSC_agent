---
title: "Religion without God — Learner-v2 Refreshed"
topic_key: philosophy-paper-ii-philosophy-of-religion-07
cover_image: assets/topic-07_Teaching-Navigation_2026-08-23.png
---
...
> **Generation:** g13, 3 September 2026 · **Approval:** pending explicit topic approval  
...
![Refreshed teaching navigation](assets/topic-07_Teaching-Navigation_2026-08-23.png)

*Distinct embedded teaching-navigation image. The separate continuous Cārvāka-style flowchart package remains an independent at-a-glance artifact.*
### Local source and factual control

- Local John Hick, *Philosophy of Religion*, PDF p. 14, supports comparative definitions that include Theravada Buddhism without creator worship.
- The local *Oxford Handbook of Philosophy of Religion*, print pp. 59–79 (PDF pp. 71–90), controls theistic/non-theistic concept discrimination.
- Chatterjee–Datta, especially PDF pp. 37–39 and 144–146, and C. D. Sharma control Indian creator-denial and religion qualifications.
- No contemporary sociology or popularity claim is used to establish the definition of religion.
...
### SESSION 1 — THE PROBLEM OF RELIGION WITHOUT GOD

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Religion without God asks whether a personal creator is necessary for religion or whether sacred order, disciplined practice, community and transformation can suffice.

**Technical definition:** The necessity claim is tested by distinguishing theism, non-theism, atheism and agnosticism and by applying substantive, functional and multidimensional definitions.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> A personal creator is sufficient for many religions but not necessary for religion as such, provided a non-theistic tradition retains sacred orientation, disciplined practice and transformation.
...
**How to use them:** Use religion, God, non-theism and sacred order to test whether a personal creator is necessary, then compare soteriology and practice with atheistic denial.

⚠️ **Current-evidence policy:** modern naturalism is used only as a conceptual boundary case; Indian traditions remain the primary evidence.


![Non-theistic religion map](assets/non-theistic-religion-map.png)
...
```
> 🔑 **Mnemonic — "Religion = the 3 D's minus God: Discipline, Dharma, Deliverance."** A religion can offer a path, ethics and liberation without a creator deity; Buddhism is a strong counterexample to creator-necessity.

---

#### CLOSING RECALL FLOW — THE PROBLEM OF RELIGION WITHOUT GOD
```closure-flow
SUBTOPIC: THE PROBLEM OF RELIGION WITHOUT GOD
STARTING CONCEPT: THE PROBLEM OF RELIGION WITHOUT GOD
KEY TERMS / DEFINITIONS: religion · God · non-theism · atheism · sacred · soteriology
MECHANISM / ARGUMENT: Test whether God is necessary by comparing theism, non-theism, atheism and a disciplined sacred/soteriological cluster.
CONSEQUENCE / CONTRAST: Creator-belief is sufficient for many religions but actual non-theistic traditions challenge its necessity.
UPSC TRAP / ANSWER-USE: Do not equate non-theism with denial of every deity, sacred being or devotional practice.
ANSWER-GRABBING FORMULATION: A personal creator is sufficient for many religions but not necessary for religion as such, provided a non-theistic tradition retains sacred orientation, disciplined practice and transformation.
```
### SESSION 2 — FUNCTIONAL AND SUBSTANTIVE CRITERIA OF RELIGION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Substantive definitions identify religion by its object, while functional definitions identify orientation, practice and social role; neither automatically requires a creator God.

**Technical definition:** Religion is a disciplined orientation to an ultimate or sacred order through doctrine, practice, community and transformation; belief in a personal creator is not a necessary condition.
...
**How to use them:** Compare substantive definition and functional definition through Ninian Smart, ultimate concern, ritual and community, then police both against exclusion and over-breadth.

> **CORE DISTINCTION:** ANSWER-GRABBING LINE — WRITE/ADAPT IN THE EXAM (Recommended opening definition):** Religion is a disciplined orientation to an ultimate or sacred order through doctrine, practice, community and transformation; belief in a personal creator is not a necessary condition.
...
#### CLOSING RECALL FLOW — FUNCTIONAL AND SUBSTANTIVE CRITERIA OF RELIGION
```closure-flow
SUBTOPIC: FUNCTIONAL AND SUBSTANTIVE CRITERIA OF RELIGION
STARTING CONCEPT: FUNCTIONAL AND SUBSTANTIVE CRITERIA OF RELIGION
KEY TERMS / DEFINITIONS: substantive definition · functional definition · Ninian Smart · ultimate concern · ritual · community
MECHANISM / ARGUMENT: Substantive definitions identify religion's object, functional definitions its role and multidimensional definitions a cluster of doctrine, practice and community.
CONSEQUENCE / CONTRAST: A creator definition excludes Buddhism by stipulation, while an unrestricted functional definition can make nationalism or any commitment religious.
UPSC TRAP / ANSWER-USE: Do not adopt a definition too narrow for established traditions or too broad to distinguish religion from ideology.
...
```
### SESSION 3 — BUDDHISM AS A NON-THEISTIC RELIGION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Buddhism is non-theistic because a creator is absent from its diagnosis and path, while doctrine, ethics, meditation, community and liberation remain fully developed.

**Technical definition:** Dependent origination and karma explain conditioned arising; the Four Noble Truths, path, ritual community and nirvana supply a complete soteriological structure without creator-belief.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Buddhism is a complete non-creator religion because dependent origination explains suffering, the path disciplines life, the Saṅgha (Buddhist monastic and practitioner community) sustains practice and nirvāṇa (liberation from suffering) supplies the final goal.
...
**How to use them:** Use Buddhism, dependent origination, Four Noble Truths and non-theism to show how nirvana and ritual community organise religion without a creator while allowing non-creator deities.

> **CORE DEFINITION:** Buddhism is a complete non-creator religion because dependent origination explains suffering, the path disciplines life, the Saṅgha (Buddhist monastic and practitioner community) sustains practice and nirvāṇa (liberation from suffering) supplies the final goal.
- **Non-theistic:** early Buddhism does not make a creator part of its diagnosis or path. Dependent origination and karma explain conditioned arising, while gods remain impermanent beings rather than creators. ✅
...
- **What orients the religion:** Dharma, community and liberation organise doctrine and practice without functioning as one-for-one substitutes for a personal creator. Later devotion confirms that non-theism is not devotion-free. ⚠️
- **Verdict:** Buddhism is a strong counterexample to creator-necessity under a multidimensional rather than stipulative theistic definition. ✅

---

#### CLOSING RECALL FLOW — BUDDHISM AS A NON-THEISTIC RELIGION
```closure-flow
SUBTOPIC: BUDDHISM AS A NON-THEISTIC RELIGION
STARTING CONCEPT: BUDDHISM AS A NON-THEISTIC RELIGION
KEY TERMS / DEFINITIONS: Buddhism · dependent origination · Four Noble Truths · non-theism · nirvāṇa · ritual community
MECHANISM / ARGUMENT: Dependent origination and karma explain arising, while Four Noble Truths, path, community and nirvana organise a creator-independent soteriology.
CONSEQUENCE / CONTRAST: Buddhist gods may be impermanent cosmological beings without becoming creators or final saviours.
UPSC TRAP / ANSWER-USE: Do not reduce Buddhism to silence about God or call Dharma and nirvana one-for-one substitutes for a personal deity.
ANSWER-GRABBING FORMULATION: Buddhism is a complete non-creator religion because dependent origination explains suffering, the path disciplines life, the Saṅgha (Buddhist monastic and practitioner community) sustains practice and nirvāṇa (liberation from suffering) supplies the final goal.
```
### SESSION 4 — WESTERN CRITIQUES OF THEISTIC RELIGION

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** His critique targets religion AND its morality together. ✅ ⚠️ Ownership note: the printed 2025 Q5(c) — "Present an account of Nietzsche's criticism of religion and morality" — is owned by Religion and Morality §9.6, because the stem couples religion with morality.

**Technical definition:** Marx: religion = "the opium of the people" — a consoling illusion masking economic exploitation; it will dissolve with a just society. ✅ Freud: religion is an illusion, a wish-fulfilment / cosmic father-projection.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Feuerbach, Marx, Freud and Nietzsche challenge theistic religion respectively as projection, ideology, wish-fulfilment and a life-denying value-framework, but criticism of theism does not by itself construct a religion without God.
...
**How to use them:** Compare Feuerbach, Marx, Freud and Nietzsche on projection and the genealogy of God-belief, then test whether post-theistic meaning preserves religious functions.

> **CORE DEFINITION:** Feuerbach, Marx, Freud and Nietzsche challenge theistic religion respectively as projection, ideology, wish-fulfilment and a life-denying value-framework, but criticism of theism does not by itself construct a religion without God.
...
#### CLOSING RECALL FLOW — WESTERN CRITIQUES OF THEISTIC RELIGION
```closure-flow
SUBTOPIC: WESTERN CRITIQUES OF THEISTIC RELIGION
STARTING CONCEPT: WESTERN CRITIQUES OF THEISTIC RELIGION
KEY TERMS / DEFINITIONS: Feuerbach · Marx · Freud · Nietzsche · projection · post-theistic meaning
MECHANISM / ARGUMENT: Feuerbach, Marx and Freud explain God-belief through projection or social function, while Nietzsche diagnoses collapse of a value horizon.
CONSEQUENCE / CONTRAST: Explaining or criticising theism does not by itself establish a viable post-theistic religion.
UPSC TRAP / ANSWER-USE: Do not treat Marx or Nietzsche as founders of a religion of humanity or steal the religion-and-morality Nietzsche PYQ.
ANSWER-GRABBING FORMULATION: Feuerbach, Marx, Freud and Nietzsche challenge theistic religion respectively as projection, ideology, wish-fulfilment and a life-denying value-framework, but criticism of theism does not by itself construct a religion without God.
```
### SESSION 5 — AGNOSTICISM, ATHEISM AND SUSPENSION OF JUDGMENT

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Agnosticism suspends judgment about God, whereas atheism denies God; either stance may still engage religious ethics, practices or communities in qualified forms.

**Technical definition:** ✅ Nietzsche: "God is dead... and we have killed him." ✅ Marx: religion is "the opium of the people." ✅ Feuerbach: God is the projected essence of man — "theology is anthropology." ✅ Buddhist: the world runs by dependent origination — no first cause/creator needed. ⚠️ Huxley (coined "agnostic"): God's existence is unknown/unknowable.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Agnostic suspension differs from atheistic denial, and neither by itself determines whether ethical, contemplative or communal religious practice remains possible.
...
- **non-theistic commitment**

**How to use them:** Distinguish agnosticism, atheism and suspension of judgment, then ask how the unknown permits practical religiosity or non-theistic commitment without assent to God.

> **CORE DISTINCTION:** Agnosticism suspends judgement about God's existence or knowability; unlike atheism, it withholds assent rather than asserting denial.
...
#### CLOSING RECALL FLOW — AGNOSTICISM, ATHEISM AND SUSPENSION OF JUDGMENT
```closure-flow
SUBTOPIC: AGNOSTICISM, ATHEISM AND SUSPENSION OF JUDGMENT
STARTING CONCEPT: AGNOSTICISM, ATHEISM AND SUSPENSION OF JUDGMENT
KEY TERMS / DEFINITIONS: agnosticism · atheism · suspension of judgment · unknown · practical religiosity · non-theistic commitment
MECHANISM / ARGUMENT: Agnosticism suspends judgment, atheism denies, non-theism makes God non-central and practical religiosity organises life without assent.
CONSEQUENCE / CONTRAST: Epistemic uncertainty about God does not alone decide whether ritual, ethics or contemplative participation remains possible.
UPSC TRAP / ANSWER-USE: Do not use agnostic, atheistic, non-theistic and anti-theistic as synonyms.
ANSWER-GRABBING FORMULATION: Agnostic suspension differs from atheistic denial, and neither by itself determines whether ethical, contemplative or communal religious practice remains possible.
```
### SESSION 6 — RELIGIOUS PRACTICE, MEANING AND COMMUNITY WITHOUT GOD

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** [Buddhism] "State & evaluate Buddhism as a religion without God." (2024, 20m) → §2 + §9.2. [Nietzsche] "Nietzsche's criticism of religion and morality." (2025, 10m) → ⚠️ primary owner is Religion and Morality §9.6; use §3/§9.4 here only for the post-theistic bridge. [Agnosticism] "What is agnosticism?

**Technical definition:** Religion without God may retain ritual, ethical formation, community and orientation to liberation or ultimacy, although its account of worship and ultimate authority changes.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> [Buddhism] "State & evaluate Buddhism as a religion without God." (2024, 20m) → §2 + §9.2. [Nietzsche] "Nietzsche's criticism of religion and morality." (2025, 10m) → ⚠️ primary owner is Religion and Morality §9.6; use §3/§9.4 here only for the post-theistic bridge. [Agnosticism] "What is agnosticism?
...
**How to use them:** Use ritual, meaning, community and liberation to compare Mimamsa and religious naturalism, then identify which creator-dependent goods the theistic critic says are lost.
...
#### CLOSING RECALL FLOW — RELIGIOUS PRACTICE, MEANING AND COMMUNITY WITHOUT GOD
```closure-flow
SUBTOPIC: RELIGIOUS PRACTICE, MEANING AND COMMUNITY WITHOUT GOD
STARTING CONCEPT: RELIGIOUS PRACTICE, MEANING AND COMMUNITY WITHOUT GOD
KEY TERMS / DEFINITIONS: ritual · meaning · community · liberation · Mīmāṃsā · religious naturalism
MECHANISM / ARGUMENT: Ritual, meaning, community and liberation can be organised through authorless scripture, karmic law, nature, narrative or shared discipline.
CONSEQUENCE / CONTRAST: Petition, grace and providence require personal agency more directly than ritual, worship, morality or liberation.
UPSC TRAP / ANSWER-USE: Do not assume functional similarity makes an impersonal ultimate ontologically identical to God.
ANSWER-GRABBING FORMULATION: [Buddhism] "State & evaluate Buddhism as a religion without God." (2024, 20m) → §2 + §9.2. [Nietzsche] "Nietzsche's criticism of religion and morality." (2025, 10m) → ⚠️ primary owner is Religion and Morality §9.6; use §3/§9.4 here only for the post-theistic bridge. [Agnosticism] "What is agnosticism?
```
### SESSION 7 — OBJECTIONS, COMPARISONS AND EXAM VERDICT

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The debate over religion without God asks whether religious identity requires a supreme personal deity or can rest on liberation, sacred value, practice and community.

**Technical definition:** A non-theistic religion may retain soteriology, ritual, ethics, authoritative teaching and a sacred orientation while rejecting creator-God theism.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> God is sufficient for many forms of religion but not conceptually necessary for every religion, as Buddhist traditions demonstrate through non-theistic soteriology and disciplined practice.
...
**How to use them:** State the theistic objection through object of worship and ultimate meaning, test functional sufficiency against non-theistic religion, and finish with a qualified verdict separating religion from theism.

> **EXAM-READY LINE:** Non-theistic traditions replace different divine functions separately—creation, authority, moral causation, worship or salvation—so 'religion without God' names several arguments rather than one model.
...
#### CLOSING RECALL FLOW — OBJECTIONS, COMPARISONS AND EXAM VERDICT
```closure-flow
SUBTOPIC: OBJECTIONS, COMPARISONS AND EXAM VERDICT
STARTING CONCEPT: OBJECTIONS, COMPARISONS AND EXAM VERDICT
KEY TERMS / DEFINITIONS: theistic objection · functional sufficiency · object of worship · ultimate meaning · non-theistic religion · qualified verdict
MECHANISM / ARGUMENT: State the strongest theistic worship/grace objection, answer with concrete non-theistic traditions and test definition breadth.
CONSEQUENCE / CONTRAST: Religion without God is coherent where sacred orientation, disciplined practice, community and transformation survive.
UPSC TRAP / ANSWER-USE: Do not conclude that every philosophy, civil ritual or secular spirituality is therefore a religion.
ANSWER-GRABBING FORMULATION: God is sufficient for many forms of religion but not conceptually necessary for every religion, as Buddhist traditions demonstrate through non-theistic soteriology and disciplined practice.
```
...
#### Religion without God analytical demand — timed-paper upgrade

**How to improve this answer:** For the demand **Religion without God analytical demand**, state the verdict in the introduction, reconstruct the relevant argument as premises leading to a conclusion, attach at least one named text/argument or canonical example to each major claim, present the strongest objection and reply, and finish with a qualified judgment rather than a thinker-summary.
...
> **CORE DISTINCTION:** ANSWER-GRABBING LINE — WRITE/ADAPT IN THE EXAM (Recommended opening definition):** A defensible cross-cultural definition treats religion as organised relation to an ultimate or sacred order, thereby including recognised non-theistic traditions without classifying every ideology as religious.
...
> **EXAM-READY LINE:** Dependent origination and karma (action and moral causation) make a creator explanatorily unnecessary, while ethics, meditation, community and nirvāṇa (liberation from suffering) preserve a fully religious form of life.
...
> **EXAM-READY LINE:** Jainism, Mīmāṃsā (ritual-exegesis school) and Sāṃkhya (enumeration-based dualist school) show that liberation, scripture, ritual and cosmic explanation can be organised without a creator deity.
...
> **EXAM-READY LINE:** Nietzsche's 'death of God' is a diagnosis of the collapse of a value-horizon, not merely a proof of atheism; its unresolved task is the non-arbitrary revaluation of values.
...
> **EXAM-READY LINE:** Religious commitment may survive metaphysical uncertainty when ritual, community, reverence and transformation remain directed toward ultimacy within nature.
...
> **EXAM-READY LINE:** Cārvāka (materialist school) attacks supersensible religion by denying that inference can establish what perception cannot check; its moderate form is strongest against inference-based natural theology. ⚠️ This is the only owner-module in the folder for Cārvāka. Deep background: [Paper I — Cārvāka](../../paper-1/indian/Carvaka.md).
...
> **EXAM-READY LINE:** Mīmāṃsā (ritual-exegesis school) is a strong functional counterexample to God's necessity because apauruṣeya (authorless and not of human origin) scripture supplies authority and apūrva (unseen potency generated by ritual) links action with its delayed fruit.
- **Doctrine statement.** ✅ Classical Pūrva-Mīmāṃsā is a strong case of a **ritual and scriptural religious order in which no creator performs the main explanatory work**. The Veda is *apauruṣeya* — **authorless**, hence eternal, hence not dependent on any speaker's reliability; its injunctions (*codanā*) are self-validating (*svataḥ-prāmāṇya*); and the efficacy of ritual is secured internally by **apūrva**.
...
- **Verdict formula.** ⚠️ "Mīmāṃsā is a strong counterexample to creator-necessity under ritual, functional or multidimensional definitions. It keeps scripture, ritual, duty, merit and a soteriological goal, and replaces the deity with two devices — *apauruṣeya* authority and *apūrva* efficacy. What it thereby shows is that the religious functions God performs are **separable**: authority, efficacy and desert can each be secured otherwise."

#### 9.8 Religious naturalism and religious fictionalism

> **EXAM-READY LINE:** Religious naturalism retains ultimacy within nature, whereas religious fictionalism retains participation without literal assent; the decisive test is whether either preserves sincere transformation rather than mere aesthetics.
...
> **EXAM-READY LINE:** The central comparison is functional: ask which divine role each school removes, what replaces it and what religious good is consequently lost or retained.
...
> **EXAM-READY LINE:** The strongest objection is not that non-theism lacks religion by definition, but that petition, reciprocal worship and grace genuinely require a responsive personal God.
...
> **EXAM-READY LINE:** Religion does not logically require a personal creator, but it does require more than disbelief: an organised orientation to ultimacy, disciplined practice, transformation and community.
...
#### ASCII MASTER FLOW — PANEL 1/8: 1. Definition and possibility test

```ascii-master
CAN RELIGION EXIST WITHOUT A CREATOR GOD?
 religion may organise:
 ultimate concern | sacred value | ritual | community | moral discipline
 worldview | transformation | liberation
 SUFFICIENT CLUSTER: sacred order + disciplined practice + community + transformation
                         |
 THEISM is sufficient for many religions, not conceptually necessary for all
 test a tradition by doctrine + practice + soteriology, not by a Western creator template
 TRAP: non-theistic != atheistic; silence, irrelevance and denial are different positions.
```

#### ASCII MASTER FLOW — PANEL 2/8: 2. Four negative positions

```ascii-master
ATHEISM: denies that God exists
 AGNOSTICISM: suspends judgement because knowledge/evidence is insufficient
 NON-THEISM: God is absent or non-central to the path
 ANTI-THEISM: holds God-belief harmful or false in a stronger evaluative sense
                         |
 IGNOSTICISM: “God” must be made meaningful before existence is debated
 practical atheism: life organised without reference to God
 keep epistemic suspension separate from metaphysical denial.
```

#### ASCII MASTER FLOW — PANEL 3/8: 3. Buddhism

```ascii-master
FOUR NOBLE TRUTHS -> dependent origination -> eightfold path -> nirvāṇa
                         |
 no eternal creator is needed; suffering has conditioned causes, not divine decree
 devas may occur in cosmology but are impermanent and unsaving
 undeclared questions do not exhaust the case; creator-belief is non-central to the path
                         |
 objection: karma/order functions like hidden providence
 reply: causal-moral regularity is impersonal; no omnipotent allocator or creator follows.
```

#### ASCII MASTER FLOW — PANEL 4/8: 4. Jainism, Mīmāṃsā and Sāṃkhya

```ascii-master
JAINISM: eternal jīva/ajīva; karmic matter; tīrthaṅkara teaches, not creates
 MĪMĀṂSĀ: authorless eternal Veda; ritual action generates apūrva; no divine author needed
 SĀṂKHYA: prakṛti evolves for plural puruṣas; unconscious teleology without creator
                         |
 shared anti-creator pressure: if God is perfect, why create? if embodied, who made body?
 distinctions: Jainism retains worshipful exemplars; Mīmāṃsā centres dharma/ritual;
 Sāṃkhya centres discriminative metaphysics and kaivalya.
```

#### ASCII MASTER FLOW — PANEL 5/8: 5. Cārvāka as limit case

```ascii-master
CĀRVĀKA denies God, afterlife, karma, Vedic authority and mokṣa
 embodied this-worldly flourishing replaces salvation
                         |
 DOES IT COUNT AS RELIGION?
 doctrinal-historical member of Indian philosophical debate: YES
 sacred/transcendent/soteriological practice in robust sense: largely NO
                         |
 limit case shows that “philosophy without God” is easier than “religion without God”;
 Buddhism/Jainism better preserve ritual, community and liberation functions.
```

#### ASCII MASTER FLOW — PANEL 6/8: 6. Nietzsche and post-theism

```ascii-master
“GOD IS DEAD” = collapse of the Christian-metaphysical value horizon
                         |
 danger: nihilism, herd morality exposed, no transcendent guarantor
 task: revaluation of values -> self-overcoming -> life-affirmation
                         |
 not a simple empirical proof that no deity exists
 objection: self-created values risk arbitrariness or domination
 reply: genealogy tests inherited values; affirmative creation accepts responsibility
 POST-THEISM asks what religious depth survives after classical supernatural belief.
```

#### ASCII MASTER FLOW — PANEL 7/8: 7. Naturalism and fictionalism

```ascii-master
RELIGIOUS NATURALISM: nature is ultimate; awe, gratitude, ritual and ethics without supernaturalism
 FICTIONALISM: participate in God-language/practice without literal ontological assent
 SEA OF FAITH / non-realism: religious symbols shape life rather than report a transcendent entity
                         |
 objections: worship without real object is make-believe; prayer loses address; truth is sacrificed
 replies: symbols and communal narratives can disclose value and transform conduct
 pressure remains: can function alone preserve religion's claim to truth and transcendence?
```

#### ASCII MASTER FLOW — PANEL 8/8: 8. PYQ and qualified verdict

```ascii-master
DEFINE religion by clustered features -> distinguish four negative positions
 -> demonstrate Buddhism/Jainism/Mīmāṃsā/Sāṃkhya -> use Cārvāka boundary
 -> Nietzsche/post-theism -> naturalism/fictionalism -> objection on truth/object
                         |
 VERDICT BY CRITERION
 creator-belief necessary? NO | ultimate concern/ritual/transformation possible? YES
 petition, grace and providence preserved? normally NO
 CLOSE: religion without God is coherent, but not religion without any ultimate value,
 disciplined practice, communal form or account of transformation.
```
