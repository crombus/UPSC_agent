...
A. Non-believers cannot know that charity is right.
B. The Euthyphro dilemma has been empirically refuted.
C. Charity is right only if God commands it.
...
C. It treats every biological tendency as morally compulsory.
...
A. It proves all actions have identical consequences.
B. It removes intention from moral assessment.
C. It makes the moral worth of action depend solely on public reputation.
...
D. It requires belief in rebirth.
...
B. A person revises an inherited practice after moral reflection.
C. A person serves anonymously because compassion is spiritually central.
...
Extrinsic religiosity uses religion as an instrument. It is especially relevant to in-group bias and moral licensing. C is closer to intrinsic orientation; A to quest.
...
C. Treating doctrinal certainty as immune to every objection.
...
A. Each tradition permits unrestricted force under necessity.
B. All three are identical in doctrine and history.
...
D. Revelation alone explains every shared norm.
...
A. Its rules apply only when hatred is maximised.
...
A. A definition of religious language.
...
A. The question asks only whether violence exists.
B. The answer should defend one community.
C. Historical facts are never relevant to philosophy.
...
B. Eternal recurrence is a theory of divine punishment.
