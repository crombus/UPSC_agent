...
**Plain-language definition:** Every proof must be tested for validity, soundness and adequacy: whether the conclusion follows, the premises are true and the being reached is genuinely God.

**Technical definition:** Almost every UPSC critique question ("critically examine", "along with its criticism") is answered by locating the objection on one of these three tiers instead of shouting a general "the proof fails".
...
**How to use them:** Use Core argument to define the issue, connect Demonstration with Probable / explanatory inference to explain it, and use Practical postulate to distinguish or qualify the conclusion.
...
START / CONCEPT: THE THREE QUESTIONS EVERY PROOF MUST SURVIVE
        |
        v
EXACT TERMS: Core argument · Demonstration · Probable / explanatory inference · Practical postulate · A priori · A posteriori
        |
        v
...
**How to use them:** Use The Ontological Argument As A Reductio to define the issue, connect Recommended opening definition with more perfect to explain it, and use Crucial textual point to distinguish or qualify the conclusion.
...
START / CONCEPT: THE ONTOLOGICAL ARGUMENT AS A REDUCTIO
        |
        v
EXACT TERMS: The Ontological Argument As A Reductio · Recommended opening definition · more perfect · Crucial textual point · First form — Proslogion 2 · Second form — Proslogion 3
        |
        v
...
CONSEQUENCE / CONTRAST: It is the argument that has attracted the most sustained modern logical attention of all the proofs. ⚠️ Do not manufacture an "Indian ontological argument" out of Advaita.
        |
        v
UPSC TRAP / ANSWER-USE: Do not fuse the two; the causal one is not ontological.
        |
        v
...
**Plain-language definition:** ⚠️ Ways 1–3 constitute the cosmological family; Way 4 is the henological / degrees argument; Way 5 is the teleological one, treated in Subtopic 4.

**Technical definition:** ⚠️ Presupposition: the act–potency analysis of change, and the claim that derivative causal power must be traced to non-derivative power here and now.
...
**How to use them:** Use Recommended opening definition to define the issue, connect cosmological with henological / degrees to explain it, and use teleological to distinguish or qualify the conclusion.
...
START / CONCEPT: TWO KINDS OF CAUSAL SERIES (THE WHOLE ARGUMENT TURNS ON THIS)
        |
        v
EXACT TERMS: Recommended opening definition · cosmological · henological / degrees · teleological · Reconstruction · Presupposition
        |
        v
MECHANISM / ARGUMENT: ⚠️ Kant's objection, spelled out because it is frequently mis-stated: the cosmological argument concludes to a necessary being; but to move from "a necessary being" to "the most real being (ens realissimum), i.e.
        |
        v
CONSEQUENCE / CONTRAST: Kant's point is therefore an adequacy-tier attack: the cosmological argument's own resources take it only to "something necessary", and it borrows the rest.
        |
        v
...
**How to use them:** Use Recommended opening definition to define the issue, connect Why the difference matters with watch to explain it, and use never seen a watch made to distinguish or qualify the conclusion.
...
START / CONCEPT: THREE TELEOLOGIES THAT MUST NOT BE CONFUSED
        |
        v
EXACT TERMS: Recommended opening definition · Why the difference matters · watch · never seen a watch made · does not always work perfectly · parts whose function we cannot discover
        |
        v
...
**Technical definition:** Kant is the destroyer of the theistic proofs and the author of a moral argument, and he sees no contradiction because the two operate on different storeys.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Kant rejects speculative demonstrations of God while postulating God within practical reason as a condition of the highest good.
...
**How to use them:** Use Kant'S Two-Storey Structure to define the issue, connect Core argument with logical inference to explain it, and use Newman's version to distinguish or qualify the conclusion.
...
START / CONCEPT: KANT'S TWO-STOREY STRUCTURE
        |
        v
EXACT TERMS: Kant'S Two-Storey Structure · Core argument · logical inference · Newman's version · Hick's objection · sovereign claim
        |
        v
MECHANISM / ARGUMENT: Kant is the destroyer of the theistic proofs and the author of a moral argument, and he sees no contradiction because the two operate on different storeys.
        |
        v
CONSEQUENCE / CONTRAST: ✅ Hick's objection: the basic assumption of all such arguments is that moral values are not capable of naturalistic explanation — in terms of human needs, desires, ideals, self-interest, or the structure of human nature or society.
        |
        v
UPSC TRAP / ANSWER-USE: ⚠️ The whole examinable point is in the architecture, not the content.
        |
        v
ANSWER-GRABBING FORMULATION: Kant rejects speculative demonstrations of God while postulating God within practical reason as a condition of the highest good.
```
...
**How to use them:** Use Nyāya'S Cosmic Division Of Labour to define the issue, connect Recommended opening definition with preserver to explain it, and use destroyer to distinguish or qualify the conclusion.
...
START / CONCEPT: NYĀYA'S COSMIC DIVISION OF LABOUR
        |
        v
EXACT TERMS: Nyāya'S Cosmic Division Of Labour · Recommended opening definition · preserver · destroyer · omnipotent · omniscient
        |
        v
...
CONSEQUENCE / CONTRAST: God is creator, preserver and destroyer — hence theism, not deism.
        |
        v
UPSC TRAP / ANSWER-USE: ✅ God is the creator of the world in the sense of being the first efficient cause of the world and not its material cause — "a sort of demiurgus or a builder of the ordered universe". ✅ He is also the preserver, in so far as the world is kept in existence by the will of God, and the destroyer, who lets loose the forces of destruction when the exigencies of the moral world require it.
        |
        v
...
**How to use them:** Use High-value transition to define the issue, connect Creator-denial with Jainism to explain it, and use ⚠️ This to distinguish or qualify the conclusion.
...
START / CONCEPT: TWO COMPLETELY DIFFERENT SENSES OF "GOD" IN THE INDIAN DEBATE
        |
        v
EXACT TERMS: High-value transition · Creator-denial · Jainism · ⚠️ This · UPSC's · 2019
        |
        v
...
CONSEQUENCE / CONTRAST: UPSC's 2019 wording presupposes that Jainism has something to prove; the mature answer explains which sense of "God" Jainism proves and which it refutes.
        |
        v
UPSC TRAP / ANSWER-USE: Creator-denial must not be equated with denial of every religious ideal, because Jainism rejects a creator while affirming achieved godhead.
        |
        v
...
**Technical definition:** Jainism rejects a creator God but affirms liberated, omniscient souls as achieved godhead attained through self-effort.
...
**How to use them:** Use Part I to define the issue, connect Jainism with Recommended opening definition to explain it, and use creator to distinguish or qualify the conclusion.
...
START / CONCEPT: PART I — JAINISM
        |
        v
EXACT TERMS: Part I · Jainism · Recommended opening definition · creator · modes (paryāya) · Terminological caution that impresses examiners
        |
        v
MECHANISM / ARGUMENT: ✅ Jainism is "a religion without God" in the sense of a creator. ✅ There is no necessity of bringing in God to explain creation, for the world was never created: production, destruction and permanence characterise all substances; things have creation and dissolution because of their modes (paryāya), while the substances themselves are eternal.
        |
...
**How to use them:** Use Part Ii to define the issue, connect Buddhism with Recommended opening definition to explain it, and use Four core lines to distinguish or qualify the conclusion.
...
START / CONCEPT: PART II — BUDDHISM
        |
        v
EXACT TERMS: Part Ii · Buddhism · Recommended opening definition · Four core lines · eternal and unchanging · from desire or purpose
        |
        v
MECHANISM / ARGUMENT: ✅ If God is eternal and unchanging, genuine creation becomes difficult to explain, because willing or producing seems to involve change. ✅ If God creates from desire or purpose, that suggests lack, preference or incompleteness. ✅ The presence of suffering and evil sits uneasily with an omnipotent benevolent creator. ✅ Dependent origination (pratītyasamutpāda) already explains the arising of phenomena through conditions, making a creator unnecessary.
        |
...
**Technical definition:** ✅ The Veda is authoritative because it is apauruṣeya — eternal, authorless and self-valid.
...
**How to use them:** Use Part Iii to define the issue, connect Mīmāṃsā with Recommended opening definition to explain it, and use apauruṣeya to distinguish or qualify the conclusion.
...
START / CONCEPT: PART III — MĪMĀṂSĀ
        |
        v
EXACT TERMS: Part Iii · Mīmāṃsā · Recommended opening definition · apauruṣeya · The direct counter to Nyāya's proof 3 · And the direct counter to Nyāya's adṛṣṭa proof
        |
        v
MECHANISM / ARGUMENT: ✅ The Veda is authoritative because it is apauruṣeya — eternal, authorless and self-valid.
        |
        v
CONSEQUENCE / CONTRAST: They also record Max Müller's contention that if God were supposed to be the creator, He would be liable to the charges of cruelty and partiality; and Müller's further point that rejection of a creator-God is not necessarily rejection of God, since pantheisms such as Advaita and Spinoza's do not accept the reality of creation and yet are not fairly called atheistic. ⚠️ Their own verdict is more sceptical: judged by what the Mīmāṃsā itself does and says, the Vedic deities are not treated as objects of worship and are not believed to exist anywhere except in the mantras that describe them — "eternal and self-manifesting concepts", like the immortal characters of classical epics. ⚠️ In its anxiety to maintain the supremacy of the Vedas, the Mīmāṃsā "relegates God to an ambiguous position".
        |
        v
UPSC TRAP / ANSWER-USE: Prābhākara adds niyoga: the injunction itself creates obligation, so one ought to act because the Veda commands, not because a deity rewards.
        |
        v
...
A. Both establish exactly the same conclusion, the second being merely a rhetorical restatement
...
C. *Proslogion* 2 is directed at Gaunilo, while *Proslogion* 3 is directed at Kant

D. *Proslogion* 2 establishes necessary existence, while *Proslogion* 3 establishes existence in the understanding

**Answer: B**

**Explanation:** The second form upgrades the modal status of the conclusion from bare existence to necessary existence, grounded in God's self-existence; since God as infinitely perfect is not limited by time, both coming-to-be and ceasing-to-be are excluded. D inverts the two forms. A misses the point on which Anselm's whole reply to Gaunilo depends. C is anachronistic in both directions — Gaunilo replies *after* the *Proslogion*, and Kant is seven centuries later.
...
A. The stick moves the stone only while the hand moves the stick

B. A triangle must have three angles equal to two right angles, so its properties are necessary
...
**Explanation:** The thaler illustration is Kant's own, and it isolates precisely the step Anselm and Descartes need — that adding existence to a concept makes it *greater*. Chatterjee and Datta restate the same point with a hundred rupees imagined in one's pocket. B is Descartes' analogy *for* the argument, not against it; D is Paley; A is Aquinas' illustration of an essentially ordered series.
...
A. The Kalām concerns degrees of perfection while Aquinas' Second Way concerns motion

B. The Kalām concludes to an impersonal principle while Aquinas concludes to a personal creator

C. The Kalām is a priori while Aquinas' Second Way is a posteriori
...
**Explanation:** This is the structural difference. Because the Kalām's second premise asserts a temporal beginning, it engages directly with cosmology; Aquinas' argument is deliberately neutral on that question. C is false — both are a posteriori. A misdescribes both. B reverses the usual position, since Kalām defenders typically argue that only agency explains a temporal effect from a timeless cause.
...
D. A theological argument for a limited deity
...
A. It is an a priori argument from the concept of a designer, refuted by Kant

B. It is a deductive proof from the constants of physics, refuted by the fallacy of composition
...
D. It is an analogical argument from artefacts, refuted by Darwin

**Answer: C**

**Explanation:** Fine-tuning arguments are Bayesian or explanatory rather than analogical or deductive, and their live competitors are cosmological rather than biological. D confuses fine-tuning with Paley; A misclassifies it as a priori; B misdescribes both its logical form and the relevant objection.
...
A. Confuses the moral law with the categorical imperative
...
C. Relies on an unestablished possibility premise

D. Contradicts the doctrine of divine simplicity

**Answer: B**

**Explanation:** The inference from conscience to a divine addressee requires that conscience not be naturalistically explicable, which is precisely what is in dispute; from the naturalistic sceptic's standpoint nothing has been established. D is irrelevant; A confuses two Kantian items; C belongs to the modal ontological argument.
...
A. God creates the world at a moment and thereafter has no concern with it, intervening only in emergencies
...
**Explanation:** Nyāya's God is a *demiurgus* or builder, not a material source. D is a Vedāntic transformation model; A is deism, which Chatterjee and Datta explicitly distinguish from Nyāya theism on the ground that God maintains a continuous relation with the world; B is Rāmānuja's Viśiṣṭādvaita.
...
A. Without God the law of karma would produce no effects at all

B. The Vedas declare that *adṛṣṭa* is created afresh by God at the start of each world-cycle
...
**Explanation:** *Adṛṣṭa* is the stock of merit (*puṇya*) and demerit (*pāpa*) generated by the soul's own past actions, introduced to bridge the time-gap between act and consequence. The argument turns on its unconsciousness. D inverts the doctrine; A overstates the claim, which concerns determinate allocation rather than efficacy as such; B contradicts *adṛṣṭa*'s origin in the agent's own karma.
...
A. Kant proved immortality but not God
...
D. Aquinas proves a beginning, but by the Third Way rather than the Second
...
A. "Thus the arguments are interesting but inconclusive, and the matter remains a personal belief."

B. "Thus God's existence is proved beyond doubt by the cumulative weight of the arguments."
...
D. "Thus no argument works and religion is irrational."
...
START / CENTRAL QUESTION
  Almost every UPSC critique question ("critically examine", "along with its criticism") is answered by locating the objection on one of these three tiers instead of shouting a general "the proof fails".
        |
        v
+-- SESSION 01: THE THREE QUESTIONS EVERY PROOF MUST SURVIVE
|   DEFINITION / TERMS : Almost every UPSC critique question ("critically examine", "along with its criticism") is answered by locating the objection on one of these three tiers instead of shouting a general "the proof fails".
|   MECHANISM / ARGUMENT: Almost every UPSC critique question ("critically examine", "along with its criticism") is answered by locating the objection on one of these three tiers instead of shouting a general "the proof fails".
|   CONSEQUENCE / CONTRAST: ⚠️ Do not treat "proof" univocally: demonstration, probable inference and practical postulate have different success conditions. ⚠️ Do not say the ontological argument is a posteriori because Anselm "observes" that people have the idea of God — the premise is conceptual. ⚠️ Do not equate "a priori" with "certain" and "a posteriori" with "uncertain"; a priori reasoning can be invalid, and a posteriori reasoning can be strong. ⚠️ Distinguish validity from soundness from adequacy of the God established.
...
|   MECHANISM / ARGUMENT: ⚠️ Distinction to state in the answer: Anselm argues by reductio from a comparative ("greater than"); Descartes argues from essence containment ("existence is a perfection").
|   CONSEQUENCE / CONTRAST: It is the argument that has attracted the most sustained modern logical attention of all the proofs. ⚠️ Do not manufacture an "Indian ontological argument" out of Advaita.
|   TRAP / ANSWER-USE: Do not fuse the two; the causal one is not ontological.
...
|   DEFINITION / TERMS : ⚠️ Presupposition: the act–potency analysis of change, and the claim that derivative causal power must be traced to non-derivative power here and now.
|   MECHANISM / ARGUMENT: ⚠️ Kant's objection, spelled out because it is frequently mis-stated: the cosmological argument concludes to a necessary being; but to move from "a necessary being" to "the most real being (ens realissimum), i.e.
|   CONSEQUENCE / CONTRAST: Kant's point is therefore an adequacy-tier attack: the cosmological argument's own resources take it only to "something necessary", and it borrows the rest.
...
|   DEFINITION / TERMS : Its premise is that things which lack cognition nevertheless act for an end, and do so with regularity — which cannot be chance.
|   MECHANISM / ARGUMENT: That chronological point is a genuine fact worth stating, because it forestalls the naive assumption that Hume was replying to Paley.
|   CONSEQUENCE / CONTRAST: ⚠️ ✅ The trap: Hume does not claim to prove that no designer exists.
...
|   DEFINITION / TERMS : Kant is the destroyer of the theistic proofs and the author of a moral argument, and he sees no contradiction because the two operate on different storeys.
|   MECHANISM / ARGUMENT: Kant is the destroyer of the theistic proofs and the author of a moral argument, and he sees no contradiction because the two operate on different storeys.
|   CONSEQUENCE / CONTRAST: ✅ Hick's objection: the basic assumption of all such arguments is that moral values are not capable of naturalistic explanation — in terms of human needs, desires, ideals, self-interest, or the structure of human nature or society.
|   TRAP / ANSWER-USE: ⚠️ The whole examinable point is in the architecture, not the content.
|   EXAM OPENING: Kant rejects speculative demonstrations of God while postulating God within practical reason as a condition of the highest good.
+--
        |
        v
...
|   MECHANISM / ARGUMENT: ⚠️ Nyāya's God is the efficient, never the material, cause.
|   CONSEQUENCE / CONTRAST: God is creator, preserver and destroyer — hence theism, not deism.
|   TRAP / ANSWER-USE: ✅ God is the creator of the world in the sense of being the first efficient cause of the world and not its material cause — "a sort of demiurgus or a builder of the ordered universe". ✅ He is also the preserver, in so far as the world is kept in existence by the will of God, and the destroyer, who lets loose the forces of destruction when the exigencies of the moral world require it.
...
|   MECHANISM / ARGUMENT: ⚠️ This is the single most important interpretive move in the entire subtopic.
|   CONSEQUENCE / CONTRAST: UPSC's 2019 wording presupposes that Jainism has something to prove; the mature answer explains which sense of "God" Jainism proves and which it refutes.
|   TRAP / ANSWER-USE: Creator-denial must not be equated with denial of every religious ideal, because Jainism rejects a creator while affirming achieved godhead.
...
|   DEFINITION / TERMS : Jainism rejects a creator God but affirms liberated, omniscient souls as achieved godhead attained through self-effort.
|   MECHANISM / ARGUMENT: ✅ Jainism is "a religion without God" in the sense of a creator. ✅ There is no necessity of bringing in God to explain creation, for the world was never created: production, destruction and permanence characterise all substances; things have creation and dissolution because of their modes (paryāya), while the substances themselves are eternal.
|   CONSEQUENCE / CONTRAST: ✅ "Though Jainism denies God, it does not deny godhead.
...
|   DEFINITION / TERMS : Buddhism rejects a permanent creator and explains suffering through conditioned arising rather than divine production.
|   MECHANISM / ARGUMENT: ✅ If God is eternal and unchanging, genuine creation becomes difficult to explain, because willing or producing seems to involve change. ✅ If God creates from desire or purpose, that suggests lack, preference or incompleteness. ✅ The presence of suffering and evil sits uneasily with an omnipotent benevolent creator. ✅ Dependent origination (pratītyasamutpāda) already explains the arising of phenomena through conditions, making a creator unnecessary.
|   CONSEQUENCE / CONTRAST: If God determines all, karma and moral effort are meaningless; if God does not determine all, God is not the sufficient cause and the theistic explanation is redundant. ⚠️ The Dharmakīrti / Śāntarakṣita line.
...
+--
        ...
        v
+-- SESSION 10: PART III — MĪMĀṂSĀ
|   DEFINITION / TERMS : ✅ The Veda is authoritative because it is apauruṣeya — eternal, authorless and self-valid.
|   MECHANISM / ARGUMENT: ✅ The Veda is authoritative because it is apauruṣeya — eternal, authorless and self-valid.
|   CONSEQUENCE / CONTRAST: They also record Max Müller's contention that if God were supposed to be the creator, He would be liable to the charges of cruelty and partiality; and Müller's further point that rejection of a creator-God is not necessarily rejection of God, since pantheisms such as Advaita and Spinoza's do not accept the reality of creation and yet are not fairly called atheistic. ⚠️ Their own verdict is more sceptical: judged by what the Mīmāṃsā itself does and says, the Vedic deities are not treated as objects of worship and are not believed to exist anywhere except in the mantras that describe them — "eternal and self-manifesting concepts", like the immortal characters of classical epics. ⚠️ In its anxiety to maintain the supremacy of the Vedas, the Mīmāṃsā "relegates God to an ambiguous position".
|   TRAP / ANSWER-USE: Prābhākara adds niyoga: the injunction itself creates obligation, so one ought to act because the Veda commands, not because a deity rewards.
