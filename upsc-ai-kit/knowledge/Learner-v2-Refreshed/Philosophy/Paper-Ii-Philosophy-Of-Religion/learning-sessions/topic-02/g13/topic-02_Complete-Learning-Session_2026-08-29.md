...
**How to use them:** Assess every proof at three levels: whether the inference is valid, whether its premises are credible, and whether its conclusion establishes a religiously adequate God.
...
CONSEQUENCE / CONTRAST: Do not treat "proof" univocally: demonstration, probable inference and practical postulate have different success conditions. ⚠️ Do not say the ontological argument is a posteriori because Anselm "observes" that people have the idea of God — the premise is conceptual.
...
**How to use them:** Reconstruct the move from the concept of the greatest conceivable being to necessary existence, then test whether existence can function as a predicate or perfection.
...
MECHANISM / ARGUMENT: Distinction to state in the answer: Anselm argues by reductio from a comparative ("greater than"); Descartes argues from essence containment ("existence is a perfection").
...
UPSC TRAP / ANSWER-USE: Gaunilo offers a parody (the form proves too much); Kant offers a diagnosis (the form uses "existence" illegitimately). ⚠️ Do not attribute the island example to Kant, or the thaler example to Gaunilo.
...
**How to use them:** Distinguish a present dependence-series from a merely temporal sequence, since cosmological arguments require the former to avoid a simplistic first-event claim.
...
MECHANISM / ARGUMENT: They start from different features and terminate in differently described conclusions. ⚠️ "First" means explanatory priority, not chronological firstness. ⚠️ Aquinas does not argue that the universe began in time; he holds that its beginning is known by faith.
CONSEQUENCE / CONTRAST: Kant's objection, spelled out because it is frequently mis-stated: the cosmological argument concludes to a necessary being; but to move from "a necessary being" to "the most real being (ens realissimum), i.e.
...
CONSEQUENCE / CONTRAST: The trap: Hume does not claim to prove that no designer exists.
...
UPSC TRAP / ANSWER-USE: This is the topic's most penalised error. ⚠️ Three postulates — freedom, immortality, God — not one. ⚠️ Newman's conscience argument is not Kant's; keep the two forms separate. ⚠️ God is not the source of moral obligation for Kant; the moral law is autonomous.
...
**How to use them:** Treat Udayana's proofs as mutually supporting inferences to an omniscient efficient cause, while noting that eternal atoms and karma perform distinct explanatory roles.
...
KEY TERMS / DEFINITIONS: Nyāya Lord (Īśvara) · Udayana · efficient causation · atom-order · karmic distribution · cumulative case
MECHANISM / ARGUMENT: Nyāya's God is the efficient, never the material, cause.
CONSEQUENCE / CONTRAST: God is creator, preserver and destroyer — hence theism, not deism.
UPSC TRAP / ANSWER-USE: Atoms are the eternal material causes. ⚠️ Nyāya theism is theism, not deism — God preserves and destroys as well as creates. ⚠️ Eternal intelligence is an inseparable attribute of God in Nyāya, not His essence as in Advaita.
...
**How to use them:** Distinguish a creator and cosmic governor from revered or liberated beings, because rejecting the first does not entail denying every religious use of divine language.
...
MECHANISM / ARGUMENT: This is the single most important interpretive move in the entire subtopic.
...
MECHANISM / ARGUMENT: Jainism is "a religion without God" in the sense of a creator.
CONSEQUENCE / CONTRAST: "Though Jainism denies God, it does not deny godhead.
UPSC TRAP / ANSWER-USE: In that Vedic sense Jainism and Buddhism are nāstika; but they are intensely spiritual and ethical, and denial of God does not amount to atheism in the Western sense — otherwise Sāṃkhya and Mīmāṃsā, which likewise do not believe in a creator God, could not have.
...
MECHANISM / ARGUMENT: If God is eternal and unchanging, genuine creation becomes difficult to explain, because willing or producing seems to involve change. ✅ If God creates from desire or purpose, that suggests lack, preference or incompleteness.
...
UPSC TRAP / ANSWER-USE: Answering the 2019 question with "Jainism is atheistic" misreads it. ⚠️ Jaina godhood is plural, achieved and non-creative; a siddha has no cosmic function. ⚠️ Jaina karma is material (pudgala); do not equate it with Nyāya's adṛṣṭa or a generic moral force.
