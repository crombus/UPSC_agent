...
A. Every ultimate reality is a personal deity.
B. All religious sentences have exactly the same meaning.
...
D. Distinct religions should disappear into one institution.
...
A. exclusive reliance on scriptural literalism.
B. denial of any experiential dimension in religion.
C. political coexistence without a view of truth.
...
B. state establishment of all religions.
C. proof that all religious propositions are identical.
...
A. Different traditions may produce moral transformation.
B. Every religious claim is true merely because some community affirms it.
C. Political equality does not require doctrinal agreement.
...
A. only the right of established communities.
...
A. the decline of all community identities.
B. the impossibility of any individual right.
C. the inability of majorities to practise religion.
...
A. Assume religion is always merely decorative.
B. Count every war involving believers as caused by theology.
C. Ask whether religion is the cause, marker, mobiliser or legitimiser in each case.
D. Treat religious and secular violence as timeless natural kinds.
...
B. theological disagreement is always the sufficient cause of war.
C. every person has only one authentic identity.
...
C. Neither concerns epistemic warrant.
...
B. All religions use different words for exactly the same propositions.
C. Every religious difference is caused by translation.
...
A. globalisation makes religion irrelevant.
...
D. religion never unites because conflicts occurred.
...
A. Aśoka formulated Hick's soteriological criterion.
B. Rock Edict XII is irrelevant to religion.
C. Aśoka established one metaphysical Real.
...
B. Fogelin proves one religion uniquely true.
C. Deep disagreement applies only to mathematics.
