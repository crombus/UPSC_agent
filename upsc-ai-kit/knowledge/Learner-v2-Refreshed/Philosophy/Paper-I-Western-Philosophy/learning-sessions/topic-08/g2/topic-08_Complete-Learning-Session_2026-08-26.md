...
cover_image: assets/Later-Wittgenstein-Practice-Map.png
variant: learner-v2
generation: 2
...
![Later Wittgenstein practice map](assets/Later-Wittgenstein-Practice-Map.png)
...
```text
   ...
   =====================================================================
     ...
     ONE hidden essence (logical form) |  NO essence - FAMILY RESEMBLANCE
...
|---|---|
| Meaning = use in the language | meaning = the object a word names |
...
- Four flips: picturing -> **use**; one essence -> **family resemblance**; ideal language -> **ordinary language in order**; private reference -> **private language impossible**. - Reasons for the shift: **colour-exclusion problem (1929)**, the **Augustinian picture** is too narrow, philosophy needs **description not theory**. - Method slogan: **"Don't think, but look."** Philosophy **describes**, it does not explain. - **Provenance trap:** the *Investigations* is **posthumous, 1953**, edited by Anscombe and Rhees; do not say "Wittgenstein published" it. - Ownership: **7** owned parts 2018-2025; **2021** is the empty year. - **Practice link:** MCQs 1-3; PYQs 2023 Q4(c), 2025 Q3(a).
...
- **Language-game (Sprachspiel)** = language + the activities into which it is woven; **countless** games, each with its own rules/purpose. - **Builders' example:** "Slab!" -> brings a slab; a **complete** primitive language, not a broken bit of ours - meaning needs a *role in a practice*, not logical form.
...
- **2023 Q4(c), 15 marks** asks directly for the *main reasons* Wittgenstein shifted from the picture-theory to the use-theory. Structure: name the two theories -> colour-exclusion crack -> Augustinian critique -> "ordinary language in order" -> description-not-theory -> one line of assessment (the shift trades system for faithfulness to practice).
...
**Use in private-language answers:** paradox -> regress -> practice/going on -> "so a purely private rule is no rule" -> private language impossible.
...
- **The Augustinian picture is too narrow.** Naming-an-object works for "table" but collapses for "the", "if", "five", "pain", "meaning", "perhaps". If one model cannot cover these, meaning cannot be *one* thing.
