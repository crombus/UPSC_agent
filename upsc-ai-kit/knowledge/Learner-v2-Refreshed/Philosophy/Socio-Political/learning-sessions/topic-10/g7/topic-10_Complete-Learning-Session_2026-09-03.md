---
title: "Caste Discrimination: Gandhi and Ambedkar — Learner-v2"
topic_key: philosophy-paper-ii-socio-political-philosophy-10
cover_image: assets/philosophy-paper-ii-socio-political-philosophy-10/caste-gandhi-ambedkar-map.png
variant: learner-v2
generation: 7
...
![Caste Discrimination: Gandhi and Ambedkar concept map](assets/philosophy-paper-ii-socio-political-philosophy-10/caste-gandhi-ambedkar-map.png)
...
- [Gandhi Heritage Portal, *Collected Works of Mahatma Gandhi*](https://www.gandhiheritageportal.org/cwmg), used to control the evolving-position claim.
...
### SESSION 3 — Gandhi I: Periodising Hereditary Duty, Caste and Untouchability
...
**How to use them:** Periodise Gandhi's evolving position: state the idealised hereditary duty-order (*varna*) and birth allocation, then the anti-untouchability campaign and later support for inter-caste marriage; flag the contested terminology; finally assess whether the later movement overcomes the hereditary-structure objection.
...
#### CLOSING RECALL FLOW — Gandhi I: Periodising Hereditary Duty, Caste and Untouchability

```closure-flow
SUBTOPIC: Gandhi I: Periodising Hereditary Duty, Caste and Untouchability
STARTING CONCEPT: Gandhi I: Periodising Hereditary Duty, Caste and Untouchability
...
**Reply:** Gandhi's constructive programme and non-violent truth-force (*satyāgraha*) are social practices, not private sentiment alone. ⚠️ Yet enforceable rights are still required.
...
✅ Buddhism as a new vehicle (*Navayāna*) reconstructs religion as an ethical-social practice of liberty, equality, fraternity and compassion. It contrasts with a religion of immutable rank and links this file to Buddhist ethics without collapsing Ambedkar into classical doctrinal exegesis.
...
| **Conversion** ✅ | exit from a religious order that sanctifies hierarchy; the embrace of Buddhism as a new vehicle (*Navayāna*), a moral community founded on equality | places the remedy outside the state altogether |
...
### 3. Gandhi I: Periodising Hereditary Duty, Caste and Untouchability
