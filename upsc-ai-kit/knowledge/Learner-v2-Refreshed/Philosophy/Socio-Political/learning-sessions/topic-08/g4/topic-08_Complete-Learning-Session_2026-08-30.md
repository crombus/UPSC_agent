---
title: "Development and Social Progress — Learner-v2"
topic_key: philosophy-paper-ii-socio-political-philosophy-08
cover_image: assets/philosophy-paper-ii-socio-political-philosophy-08/development-and-social-progress-map.png
variant: learner-v2
generation: 4
...
>
> **Generation:** g4, 30 August 2026 · **Approval:** false pending explicit topic approval
>
...
![Development and Social Progress concept map](assets/philosophy-paper-ii-socio-political-philosophy-08/development-and-social-progress-map.png)
...
- **Canonical doctrine source:** `upsc-ai-kit/knowledge/Philosophy/paper-2/socio-political/Development-Social-Progress.md` (7,593 words), sliced verbatim into the CORE UPSC layers (each canonical teaching passage exactly once) and preserved again, in full, in the canonical apparatus block.
- **Doctrine grounding (in the canonical file):** the growth / economic development / human development / capability / social progress concept grid and the discriminating test; the economistic model with its instrumental-and-conversion-dependent reply; human development (Mahbub ul Haq and the UNDP framework); Amartya Sen's development as freedom (functioning, capability, resource, utility, agency, adaptive preferences); Nussbaum's capability threshold and the Sen-Nussbaum distinction; dependency and post-development critiques; sustainable development and its philosophical bases; social progress as normative and multidimensional and the argument against inevitability; the criteria of progress; the necessary/sufficient analysis with the material-threshold nuance; redistribution and recognition; participation as instrumental and constitutive; technology and ethical standards; skill education and its limits; Gandhian social development (sarvodaya, swaraj, trusteeship, dignity of labour, restraint of wants) with the Ambedkar objection; development and tribal values with the reconciliation model and the Indian legal illustrations; the ecological political-philosophy module (anthropocentric/biocentric/ecocentric moral standing, Naess's shallow/deep ecology, productivism and degrowth, intergenerational justice and the non-identity problem, the environmentalism of the poor, the eco-authoritarian risk and the just-transition reply, and the four-test binding to tribal development); the inter-school debates; the criticisms with replies; the ten traps; and the selectable evidence bank D1-D15. No book claim is added beyond what the canonical file already grounds.
...
### SESSION 7 — Gandhian Social Development: Sarvodaya, Swaraj and its Test
...
- Spokes = **swaraj, trusteeship, restraint of wants, dignity of labour, decentralisation.**
...
- Ten traps = the examiner's failure modes; avoid them explicitly.
...
```text
STATE   : sarvodaya (hub) + swaraj + trusteeship + restraint + dignity of labour
...
- Model solutions authored at examiner grade: thesis -> doctrine in canonical terms -> named evidence unit (D1-D15) or Indian legal example -> objection/reply/residual -> graded verdict, each closing with a "Why this earns marks" note.
...
```text
DIRECTIVE -> THESIS -> DOCTRINE -> NAMED EVIDENCE (D1-D15) / EXAMPLE -> OBJECTION / REPLY /
  RESIDUAL -> VERDICT
```
...
**Provenance caution**
- Gandhi is represented **by position and standard vocabulary** (*sarvodaya, swaraj, trusteeship*); no work is quoted and no line is fabricated. The Ambedkar objection is stated as a *position*, not a citation.
...
**Criticisms and replies + the ten traps (canonical §7-§8, in the core above)**
