...
**Plain-language definition:** Prelims: Retain the exact unit, named scholar, official category, dated statistic or legal boundary attached to How women's organising is layered.

**Technical definition:** Women's organising in India runs through social reform, early national bodies, post-Independence rights mobilisation, informal-sector labour organising and savings-and-credit federations, and these streams overlap and coexist rather than replacing one another in a single linear movement.
...
**How to use them:** Frame the answer through FOUNDATION; define How women's organising is layered, connect Evidence chain with Qualified use to explain the mechanism, and use Women's for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — HOW WOMEN'S ORGANISING IS LAYERED

```text
START / CONCEPT: FOUNDATION — How women's organising is layered
        |
        v
EXACT TERMS: FOUNDATION · How women's organising is layered · Evidence chain · Qualified use · Women's · India
        |
        v
MECHANISM / ARGUMENT: Women's organising in India runs through social reform, early national bodies, post-Independence rights mobilisation, informal-sector labour organising and savings-and-credit federations, and these streams overlap and coexist rather than replacing one another in a single linear movement.
        |
        v
CONSEQUENCE / CONTRAST: Evidence chain: Layered organisational history Qualified use: Open a women's-movement answer with organisational forms rather than a chronology of names.
        |
        v
UPSC TRAP / ANSWER-USE: The streams overlap and coexist rather than replacing one another in a single linear movement.
        |
        v
ANSWER-GRABBING FORMULATION: Prelims: Retain the exact unit, named scholar, official category, dated statistic or legal boundary attached to How women's organising is layered.
```
### SESSION 2 — FOUNDATION — EARLY NATIONAL BODIES AND THE PRECEDENCE RULE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Precedence is a factual boundary, so the 1927 body may be called influential but never the first.

**Technical definition:** Evidence chain: Women's Indian Association precedence - All India Women's Conference, 1927 Qualified use: Protect a history answer from the commonest close-option error in this owner.
...
- **FOUNDATION**
- **Early national bodies**
- **the precedence rule**
- **Evidence chain**
- **Qualified use**
- **The Women's Indian Association**

**How to use them:** Frame the answer through FOUNDATION; define Early national bodies, connect the precedence rule with Evidence chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — EARLY NATIONAL BODIES AND THE PRECEDENCE RULE

```text
START / CONCEPT: FOUNDATION — Early national bodies and the precedence rule
        |
        v
EXACT TERMS: FOUNDATION · Early national bodies · the precedence rule · Evidence chain · Qualified use · The Women's Indian Association
        |
        v
MECHANISM / ARGUMENT: Precedence is a factual boundary, so the 1927 body may be called influential but never the first.
        |
        v
CONSEQUENCE / CONTRAST: Evidence chain: Women's Indian Association precedence - All India Women's Conference, 1927 Qualified use: Protect a history answer from the commonest close-option error in this owner.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the All India Women's Conference was founded in 1927, focused initially on women's education...
        |
        v
...
**Plain-language definition:** The National Federation of Indian Women is a post-Independence organisation associated with the broader left movement that mobilised around legal rights, wages and anti-dowry campaigns, which places it in the rights-and-wage organisational model rather than the economic-participation model.

**Technical definition:** Evidence chain: National Federation of Indian Women Qualified use: Supply the post-Independence organisational form by name and mechanism.
...
- **FOUNDATION**
- **Rights**
- **wage organising after Independence**
- **Evidence chain**
- **Qualified use**
- **The National Federation of Indian Women**

**How to use them:** Frame the answer through FOUNDATION; define Rights, connect wage organising after Independence with Evidence chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — FOUNDATION — RIGHTS AND WAGE ORGANISING AFTER INDEPENDENCE

```text
START / CONCEPT: FOUNDATION — Rights and wage organising after Independence
        |
        v
EXACT TERMS: FOUNDATION · Rights · wage organising after Independence · Evidence chain · Qualified use · The National Federation of Indian Women
        |
        v
MECHANISM / ARGUMENT: Evidence chain: National Federation of Indian Women Qualified use: Supply the post-Independence organisational form by name and mechanism.
        |
        v
CONSEQUENCE / CONTRAST: This is a rights-and-wage model and must not be merged with the economic-participation model.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the National Federation of Indian Women is a post-Independence organisation associated with the broader...
        |
        v
...
**Plain-language definition:** The Self Employed Women's Association, founded in Gujarat, is registered as a trade union of self-employed women workers and functions with cooperative institutions, organising informal-sector women around economic rights, credit access and collective bargaining rather than legal advocacy alone.

**Technical definition:** Evidence chain: Self Employed Women's Association Qualified use: Give the economic-participation model that a lower-strata reach argument needs.
...
- **Evidence chain**
- **Qualified use**
- **The Self Employed Women's Association, founded in Gujarat,**
- **The Self Employed Women's Association**
- **Gujarat**

**How to use them:** Frame the answer through Economic organising through a trade union; define Evidence chain, connect Qualified use with The Self Employed Women's Association, founded in Gujarat, to explain the mechanism, and use The Self Employed Women's Association for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — ECONOMIC ORGANISING THROUGH A TRADE UNION

```text
START / CONCEPT: CORE — Economic organising through a trade union
        |
        v
EXACT TERMS: Economic organising through a trade union · Evidence chain · Qualified use · The Self Employed Women's Association, founded in Gujarat, · The Self Employed Women's Association · Gujarat
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Self Employed Women's Association Qualified use: Give the economic-participation model that a lower-strata reach argument needs.
        |
        v
CONSEQUENCE / CONTRAST: Trade-union and cooperative registration is a structural fact, not a stylistic description.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the Self Employed Women's Association, founded in Gujarat, is registered as a trade union...
        |
        v
ANSWER-GRABBING FORMULATION: The Self Employed Women's Association, founded in Gujarat, is registered as a trade union of self-employed women workers and functions with cooperative institutions, organising informal-sector women around economic rights, credit access and collective bargaining rather than legal advocacy alone.
```
...
- **Federated savings**
- **credit as the mass form**
- **Evidence chain**
- **Qualified use**
- **Self-help group federations**
- **Self-help**

**How to use them:** Frame the answer through Federated savings; define credit as the mass form, connect Evidence chain with Qualified use to explain the mechanism, and use Self-help group federations for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — FEDERATED SAVINGS AND CREDIT AS THE MASS FORM

```text
START / CONCEPT: CORE — Federated savings and credit as the mass form
        |
        v
EXACT TERMS: Federated savings · credit as the mass form · Evidence chain · Qualified use · Self-help group federations · Self-help
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Self-help group federations Qualified use: Name the most widespread contemporary organisational form without borrowing another owner's theory.
        |
        v
CONSEQUENCE / CONTRAST: The social-capital mechanism is owned by Governance and is cross-linked rather than re-derived.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: name the most widespread contemporary organisational form without borrowing another owner's theory.
        |
        v
ANSWER-GRABBING FORMULATION: Self-help group federations are savings-and-credit groups that federate upward into larger bodies and have become the most widespread contemporary grassroots women's organisational form, and the bonding, bridging and linking social-capital mechanism that explains their effectiveness is owned by Governance and cross-linked rather than re-derived here.
```
...
**Plain-language definition:** Gender equity means context-responsive measures that address structural disadvantage and unequal starting conditions, such as credit access, mobility support, childcare or collective bargaining, and it is a means toward fair substantive equality rather than a synonym for privilege.

**Technical definition:** Evidence chain: Gender equality - Gender equity - Women's empowerment Qualified use: Convert a distinguish directive into three precise one-line definitions.
...
**How to use them:** Frame the answer through Equality; define equity, connect empowerment defined with Evidence chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — EQUALITY, EQUITY AND EMPOWERMENT DEFINED

```text
START / CONCEPT: CORE — Equality, equity and empowerment defined
        |
        v
EXACT TERMS: Equality · equity · empowerment defined · Evidence chain · Qualified use · Gender equality
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Gender equality - Gender equity - Women's empowerment Qualified use: Convert a distinguish directive into three precise one-line definitions.
        |
        v
CONSEQUENCE / CONTRAST: Gender equality means equal rights, status and opportunity regardless of gender, covering formal equality before the law and the pursuit of substantive equality in lived outcomes, and it is the rights baseline against which the other two terms are measured.
        |
        v
UPSC TRAP / ANSWER-USE: Women's empowerment is the process and outcome of expanded agency, capability, resources and voice, so it is established by evidence of exercised choice and recognised authority and never by the existence of a legal right or the coverage of a programme.
        |
        v
...
**Plain-language definition:** Equality, equity and empowerment interact rather than forming a mechanical one-way ladder, because coverage without uptake and uptake without follow-through support both stall the chain before agency is reached, which is exactly the testing point the trichotomy demand carries.

**Technical definition:** Prelims: Retain the exact unit, named scholar, official category, dated statistic or legal boundary attached to Why the trichotomy is not a ladder.
...
**How to use them:** Frame the answer through Evidence chain; define Qualified use, connect Equality with Retain to explain the mechanism, and use Why for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — WHY THE TRICHOTOMY IS NOT A LADDER

```text
START / CONCEPT: CORE — Why the trichotomy is not a ladder
        |
        v
EXACT TERMS: Evidence chain · Qualified use · Equality · Retain · Why · Interaction
        |
        v
MECHANISM / ARGUMENT: Equality, equity and empowerment interact rather than forming a mechanical one-way ladder, because coverage without uptake and uptake without follow-through support both stall the chain before agency is reached, which is exactly the testing point the trichotomy demand carries.
        |
        v
CONSEQUENCE / CONTRAST: Evidence chain: Interaction rather than a sequence Qualified use: State the interaction that turns a definitional answer into an analytical one.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: retain the exact unit, named scholar, official category, dated statistic or legal boundary attached...
        |
        v
ANSWER-GRABBING FORMULATION: Prelims: Retain the exact unit, named scholar, official category, dated statistic or legal boundary attached to Why the trichotomy is not a ladder.
```
### SESSION 8 — CORE — MEMBERSHIP AGAINST SUBSTANTIVE VOICE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Formal membership of a women's organisation or a self-help group is an input and coverage measure, while substantive voice requires that economic participation be converted into recognised decision-making inside the household and community, so enrolment counts can overstate empowerment.

**Technical definition:** Evidence chain: Membership against substantive voice Qualified use: Supply the measurement distinction that a programme-evaluation demand rewards.
...
**How to use them:** Frame the answer through Membership against substantive voice; define Evidence chain, connect Qualified use with Formal to explain the mechanism, and use Enrolment for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — MEMBERSHIP AGAINST SUBSTANTIVE VOICE

```text
START / CONCEPT: CORE — Membership against substantive voice
        |
        v
EXACT TERMS: Membership against substantive voice · Evidence chain · Qualified use · Formal · Enrolment · Membership
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Membership against substantive voice Qualified use: Supply the measurement distinction that a programme-evaluation demand rewards.
        |
        v
CONSEQUENCE / CONTRAST: Enrolment is an input measure and can overstate an agency outcome.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: formal membership of a women's organisation or a self-help group is an input and...
        |
        v
...
**Plain-language definition:** Unpaid care and domestic work impose a time constraint that limits schooling, paid work, mobility and organisational participation, which is why a programme that assumes equal available time silently excludes the women it is meant to reach.

**Technical definition:** Evidence chain: Time poverty and the care burden Qualified use: Give the temporal half of a challenges-across-time-and-space answer.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Evidence chain: Time poverty and the care burden Qualified use: Give the temporal half of a challenges-across-time-and-space answer.
...
**How to use them:** Frame the answer through Time poverty; define the care burden, connect Evidence chain with Qualified use to explain the mechanism, and use Unpaid for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — TIME POVERTY AND THE CARE BURDEN

```text
START / CONCEPT: CORE — Time poverty and the care burden
        |
        v
EXACT TERMS: Time poverty · the care burden · Evidence chain · Qualified use · Unpaid · Give
        |
        v
MECHANISM / ARGUMENT: Unpaid care and domestic work impose a time constraint that limits schooling, paid work, mobility and organisational participation, which is why a programme that assumes equal available time silently excludes the women it is meant to reach.
        |
        v
CONSEQUENCE / CONTRAST: Mains: Give the temporal half of a challenges-across-time-and-space answer.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: time poverty and the care burden Qualified use.
        |
        v
ANSWER-GRABBING FORMULATION: Evidence chain: Time poverty and the care burden Qualified use: Give the temporal half of a challenges-across-time-and-space answer.
```
### SESSION 10 — CORE — MOBILITY, SAFETY AND CONTESTED SPACE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Women's presence in public, workplace and digital space is conditioned by mobility limits, harassment and safety concerns, so the challenge is spatial as well as temporal and any answer about women across time and space must treat both dimensions explicitly.

**Technical definition:** Evidence chain: Mobility, safety and contested space Qualified use: Give the spatial half of the same answer instead of repeating the temporal half.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Evidence chain: Mobility, safety and contested space Qualified use: Give the spatial half of the same answer instead of repeating the temporal half.
...
- **Evidence chain**
- **Qualified use**
- **Women's presence in public, workplace and digital space**

**How to use them:** Frame the answer through Mobility; define safety, connect contested space with Evidence chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — MOBILITY, SAFETY AND CONTESTED SPACE

```text
START / CONCEPT: CORE — Mobility, safety and contested space
        |
        v
EXACT TERMS: Mobility · safety · contested space · Evidence chain · Qualified use · Women's presence in public, workplace and digital space
        |
        v
MECHANISM / ARGUMENT: Women's presence in public, workplace and digital space is conditioned by mobility limits, harassment and safety concerns, so the challenge is spatial as well as temporal and any answer about women across time and space must treat both dimensions explicitly.
        |
        v
CONSEQUENCE / CONTRAST: The resulting consequence is that mobility, safety and contested space Qualified use.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: mobility, safety and contested space Qualified use.
        |
        v
ANSWER-GRABBING FORMULATION: Evidence chain: Mobility, safety and contested space Qualified use: Give the spatial half of the same answer instead of repeating the temporal half.
```
### SESSION 11 — CORE — READING ACCESS INDICATORS HONESTLY

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Access indicators measure reach and are silent about control over assets and decisions.

**Technical definition:** Evidence chain: Dated access indicators Qualified use: Cite a dated survey anchor without converting reach into agency.
...
- **Access indicators measure reach and**
- **2019-21**

**How to use them:** Frame the answer through Reading access indicators honestly; define Evidence chain, connect Qualified use with The National Family Health Survey to explain the mechanism, and use Access indicators measure reach and for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — READING ACCESS INDICATORS HONESTLY

```text
START / CONCEPT: CORE — Reading access indicators honestly
        |
        v
EXACT TERMS: Reading access indicators honestly · Evidence chain · Qualified use · The National Family Health Survey · Access indicators measure reach and · 2019-21
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Dated access indicators Qualified use: Cite a dated survey anchor without converting reach into agency.
        |
        v
CONSEQUENCE / CONTRAST: The National Family Health Survey round five, covering 2019-21, recorded that 78.6 per cent of women aged 15-49 had a bank or savings account that they themselves used and that 33.3 per cent had ever used the internet, and after the release of the sixth round on 29 May 2026 these remain dated access indicators that measure reach rather than control over assets, income or decisions.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: cite a dated survey anchor without converting reach into agency.
        |
        v
ANSWER-GRABBING FORMULATION: Access indicators measure reach and are silent about control over assets and decisions.
```
### SESSION 12 — CORE — THE INTERSECTIONALITY CUT

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** The intersectionality critique raised by Dalit and tribal women's organisations holds that caste, class, tribe and religion shape women's experience differently, so a strategy effective for urban middle-class women may not address a Dalit agricultural labourer's constraints, and the emergence of separate organisations is a corrective rather than a fragmentation of the movement.

**Technical definition:** Evidence chain: Intersectionality critique Qualified use: Substantiate a reach claim with organisational evidence rather than assertion.
...
- **Qualified use**
- **Dalit**
- **Separate Dalit and tribal organisations**
- **Separate Dalit**

**How to use them:** Frame the answer through The intersectionality cut; define Evidence chain, connect Qualified use with Dalit to explain the mechanism, and use Separate Dalit and tribal organisations for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE — THE INTERSECTIONALITY CUT

```text
START / CONCEPT: CORE — The intersectionality cut
        |
        v
EXACT TERMS: The intersectionality cut · Evidence chain · Qualified use · Dalit · Separate Dalit and tribal organisations · Separate Dalit
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Intersectionality critique Qualified use: Substantiate a reach claim with organisational evidence rather than assertion.
        |
        v
CONSEQUENCE / CONTRAST: Separate Dalit and tribal organisations are a corrective rather than a fragmentation.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: the intersectionality critique raised by Dalit and tribal women's organisations holds that caste, class...
        |
        v
ANSWER-GRABBING FORMULATION: The intersectionality critique raised by Dalit and tribal women's organisations holds that caste, class, tribe and religion shape women's experience differently, so a strategy effective for urban middle-class women may not address a Dalit agricultural labourer's constraints, and the emergence of separate organisations is a corrective rather than a fragmentation of the movement.
```
...
**Plain-language definition:** All three are illustrative group-level cases carrying no invented income or prevalence figure.

**Technical definition:** A woman with full legal voting and property rights but no independent income, childcare support or mobility support illustrates equality existing without equity and therefore without empowerment, which is the boundary case that defeats a rights-only answer.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define Three boundary cases, connect Evidence chain with Qualified use to explain the mechanism, and use Self Employed Women's Association for the decisive comparison or qualification.
...
START / CONCEPT: CORE SYNTHESIS — Three boundary cases
        |
        v
EXACT TERMS: CORE SYNTHESIS · Three boundary cases · Evidence chain · Qualified use · Self Employed Women's Association · Dalit
        |
        v
MECHANISM / ARGUMENT: Evidence chain: Equality without equity - Equity without empowerment - Full chain and compounded disadvantage Qualified use: Prove the trichotomy analytically by showing where the chain breaks.
        |
        v
CONSEQUENCE / CONTRAST: A self-help group member who receives credit while her husband continues to control loan-use decisions illustrates an equity instrument reaching a woman without translating into substantive agency, which is the boundary case that defeats a coverage-only answer.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: all three are illustrative group-level cases carrying no invented income or prevalence figure.
        |
        v
ANSWER-GRABBING FORMULATION: A woman with full legal voting and property rights but no independent income, childcare support or mobility support illustrates equality existing without equity and therefore without empowerment, which is the boundary case that defeats a rights-only answer.
```
### SESSION 14 — CORE SYNTHESIS — THE GIG-ECONOMY TEST

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Evidence chain: Gig-economy boundary Qualified use: Answer an examine directive with a two-sided verdict rather than a position.

**Technical definition:** Platform-worker legal status and social security are owned by Social Justice and are not claimed here.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Evidence chain: Gig-economy boundary Qualified use: Answer an examine directive with a two-sided verdict rather than a position.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define The gig-economy test, connect Evidence chain with Qualified use to explain the mechanism, and use Platform for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — THE GIG-ECONOMY TEST

```text
START / CONCEPT: CORE SYNTHESIS — The gig-economy test
        |
        v
EXACT TERMS: CORE SYNTHESIS · The gig-economy test · Evidence chain · Qualified use · Platform · Social Justice
        |
        v
MECHANISM / ARGUMENT: Platform-worker legal status and social security are owned by Social Justice and are not claimed here.
        |
        v
CONSEQUENCE / CONTRAST: Platform and gig work can widen entry and offer flexible hours while simultaneously carrying income volatility, algorithmic control and weak social protection, so it is neither automatic liberation nor automatic exploitation, and the legal status and social-security architecture of platform workers is owned by Social Justice and is not claimed here.
        |
        v
UPSC TRAP / ANSWER-USE: Do not miss this limiting distinction: platform-worker legal status and social security are owned by Social Justice and are not...
        |
        v
ANSWER-GRABBING FORMULATION: Evidence chain: Gig-economy boundary Qualified use: Answer an examine directive with a two-sided verdict rather than a position.
```
### SESSION 15 — CORE SYNTHESIS — EVIDENCE RESTRAINT AND THE ANSWER SPINE

#### DEFINITION / WHAT THIS IS CALLED

**Plain-language definition:** Evidence chain: Evidence restraint and verified direct Mains demands Qualified use: Assemble the answer spine with a named official prevention frame and causal restraint.

**Technical definition:** T3: ⚠️ Any account of self-harm requires extreme causal restraint: social stressors may be analysed, but a reported category or trend cannot establish one cause.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Evidence chain: Evidence restraint and verified direct Mains demands Qualified use: Assemble the answer spine with a named official prevention frame and causal restraint.
...
**How to use them:** Frame the answer through CORE SYNTHESIS; define Evidence restraint, connect the answer spine with Evidence chain to explain the mechanism, and use Qualified use for the decisive comparison or qualification.
...
#### CLOSING RECALL FLOW — CORE SYNTHESIS — EVIDENCE RESTRAINT AND THE ANSWER SPINE

```text
START / CONCEPT: CORE SYNTHESIS — Evidence restraint and the answer spine
        |
        v
EXACT TERMS: CORE SYNTHESIS · Evidence restraint · the answer spine · Evidence chain · Qualified use · Subject
        |
        v
MECHANISM / ARGUMENT: T3: ⚠️ Any account of self-harm requires extreme causal restraint: social stressors may be analysed, but a reported category or trend cannot establish one cause.
        |
        v
CONSEQUENCE / CONTRAST: NFHS-5 (2019-21) values below are historical comparators, not the latest national NFHS result.
        |
        v
UPSC TRAP / ANSWER-USE: Do not quote an NFHS-6 metric unless taken directly from its released national fact sheet; neither NFHS round is a Census stock or by itself proof of causation.
        |
        v
ANSWER-GRABBING FORMULATION: Evidence chain: Evidence restraint and verified direct Mains demands Qualified use: Assemble the answer spine with a named official prevention frame and causal restraint.
```
