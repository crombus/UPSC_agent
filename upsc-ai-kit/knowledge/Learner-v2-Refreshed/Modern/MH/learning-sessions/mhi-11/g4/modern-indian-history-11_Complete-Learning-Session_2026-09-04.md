...
- **Current-status note, rechecked 2026-09-04:** A 2026 search found no sufficiently specific official memorial update to force into the historical narrative. The Haryana archaeology gateway is used only as a bounded public-history method link; no disputed claim about the revolt's starting point or memorial scale is imported.
