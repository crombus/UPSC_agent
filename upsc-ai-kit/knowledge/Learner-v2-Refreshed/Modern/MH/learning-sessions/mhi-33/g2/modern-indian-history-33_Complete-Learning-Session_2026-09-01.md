...
- **Current-status note, rechecked 2026-09-01:** No verified live current-affairs item is pegged to this topic. The owner's own material treats the Congress system and party fragmentation as an evergreen analytical theme rather than a dated news event, and that bounded framing is preserved rather than inventing a specific live source or date.
