"""Build Economy learner-v2 Topic 22 in authoring-only mode."""

from pathlib import Path

import generate_economy_21_sequential as previous
import generate_economy_common as common
from economy_20_23_data import TOPIC_22
...
TOPICS = [TOPIC_22]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-22-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 22", previous=previous, previous_keys=["economy-21"])
