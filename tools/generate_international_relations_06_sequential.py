"""Build International Relations learner-v2 Topic 06 in authoring-only mode."""
...
import generate_international_relations_05_sequential as previous_batch
from international_relations_06_data import TOPIC_06
...
TOPICS = [TOPIC_06]
PREVIOUS_KEYS = ["international-relations-05"]
...
def main() -> int:
    return common.run_batch(
        ...
        scope="International Relations learner-v2 Topic 06",
