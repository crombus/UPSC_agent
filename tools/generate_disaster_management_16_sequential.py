"""Build Disaster Management learner-v2 Topic 16 in authoring-only mode."""

from pathlib import Path

import generate_disaster_management_15_sequential as previous
import generate_disaster_management_common as common
from disaster_management_16_data import TOPIC_16
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / f"disaster-management-16-{DATE}-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Disaster Management learner-v2 Topic 16",
        previous=previous,
        previous_keys=["disaster-management-15"],
    )
