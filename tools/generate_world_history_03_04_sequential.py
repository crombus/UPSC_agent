"""Build World History learner-v2 Topics 03-04 in authoring-only mode."""
...
from world_history_01_05_data import TOPIC_03, TOPIC_04
...
def main() -> int:
    return common.run_batch(
        ...
        scope="World History learner-v2 Topics 03-04",
        previous=previous,
        previous_keys=["world-history-01", "world-history-02"],
    )
