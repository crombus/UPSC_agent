"""Build World History learner-v2 Topic 15 in authoring-only mode."""
...
from world_history_11_15_data import TOPIC_15
...
def main() -> int:
    return common.run_batch(
        ...
        scope="World History learner-v2 Topic 15",
        previous=previous,
        previous_keys=["world-history-13", "world-history-14"],
    )
