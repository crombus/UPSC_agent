"""Build Essay learner-v2 Topic 02 in authoring-only mode."""

from pathlib import Path

import generate_essay_01_sequential as previous
import generate_essay_common as common
from essay_02_data import TOPIC_02
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / f"essay-02-{DATE}-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Essay learner-v2 Topic 02",
        previous=previous,
        previous_keys=['essay-01'],
    )
