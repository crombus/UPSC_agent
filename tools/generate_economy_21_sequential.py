"""Build Economy learner-v2 Topic 21 in authoring-only mode."""

from pathlib import Path

import generate_economy_20_sequential as previous
import generate_economy_common as common
from economy_20_23_data import TOPIC_21
...
TOPICS = [TOPIC_21]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-21-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 21", previous=previous, previous_keys=["economy-20"])
