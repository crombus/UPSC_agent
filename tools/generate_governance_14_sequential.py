"""Build Governance learner-v2 Topic 14 in authoring-only mode."""
...
from governance_13_14_data import TOPIC_14
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Governance learner-v2 Topic 14",
        previous=previous,
        previous_keys=["governance-13"],
    )
