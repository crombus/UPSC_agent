"""Build Social Justice learner-v2 Topic 03 in authoring-only mode."""

from __future__ import annotations

from pathlib import Path

import generate_social_justice_02_sequential as previous
import generate_social_justice_common as common
from social_justice_03_04_data import TOPIC_03
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Social Justice learner-v2 Topic 03",
        previous=previous,
        previous_keys=["social-justice-02"],
    )
