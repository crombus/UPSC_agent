"""Build Economy learner-v2 Topic 16 in authoring-only mode."""

from pathlib import Path

import generate_economy_15_sequential as previous
import generate_economy_common as common
from economy_16_19_data import TOPIC_16
...
TOPICS = [TOPIC_16]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-16-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 16", previous=previous, previous_keys=["economy-15"])
