"""Build Science and Technology learner-v2 Topic 22 in authoring-only mode."""

from pathlib import Path

import generate_science_and_technology_common as common
from science_and_technology_22_data import TOPIC_22
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "science-and-technology-22-2026-09-04-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Science and Technology learner-v2 Topic 22",
        previous=None,
    )
