"""Write the exhaustive changed-files manifest for the Individual and State run.
...
``philosophy-paper-ii-socio-political-philosophy-03:learner-v2:g2``, grouped by
...
GROUPS: tuple[tuple[str, re.Pattern[str]], ...] = (
    (
        "Tooling (generator, content spec, reset helper, changed-files "
        "reporter, shared validator and test)",
        re.compile(r"^tools\\"),
    ),
    (
