"""Build Science and Technology learner-v2 Topic 06 in authoring-only mode."""

from pathlib import Path

import generate_science_and_technology_05_sequential as previous_batch
import generate_science_and_technology_common as common
from science_and_technology_06_10_data import TOPIC_06
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "science-and-technology-06-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Science and Technology learner-v2 Topic 06",
        previous=previous_batch,
        previous_keys=["science-and-technology-05"],
    )
