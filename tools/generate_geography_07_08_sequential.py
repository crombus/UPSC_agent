"""Build Geography learner-v2 Topics 07-08 in authoring-only mode."""
...
from geography_05_09_data import TOPIC_07, TOPIC_08
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topics 07-08",
        previous=previous,
        previous_keys=["geography-05", "geography-06"],
    )
