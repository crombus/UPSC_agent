"""Build World History learner-v2 Topic 05 in authoring-only mode."""
...
from world_history_01_05_data import TOPIC_05
...
def main() -> int:
    return common.run_batch(
        ...
        scope="World History learner-v2 Topic 05",
        previous=previous,
        previous_keys=["world-history-03", "world-history-04"],
    )
