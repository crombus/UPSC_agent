"""Build Social Justice learner-v2 Topic 07 in authoring-only mode."""

from __future__ import annotations

from pathlib import Path

import generate_social_justice_06_sequential as previous
import generate_social_justice_common as common
from social_justice_07_08_data import TOPIC_07
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Social Justice learner-v2 Topic 07",
        previous=previous,
        previous_keys=["social-justice-06"],
    )
