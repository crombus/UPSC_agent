"""Build Indian Art and Culture learner-v2 Topics 13-14 in authoring-only mode."""
...
from indian_art_culture_11_15_data import TOPIC_13, TOPIC_14
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Art and Culture learner-v2 Topics 13-14",
        previous=previous,
        previous_keys=[
            "indian-art-and-culture-11",
            "indian-art-and-culture-12",
        ],
    )
