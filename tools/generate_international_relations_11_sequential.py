"""Build International Relations learner-v2 Topic 11 in authoring-only mode."""
...
import generate_international_relations_10_sequential as previous_batch
from international_relations_11_data import TOPIC_11
...
TOPICS = [TOPIC_11]
PREVIOUS_KEYS = ["international-relations-10"]
...
def main() -> int:
    return common.run_batch(
        ...
        scope="International Relations learner-v2 Topic 11",
