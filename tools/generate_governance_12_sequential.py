"""Build Governance learner-v2 Topic 12 in authoring-only mode."""
...
from governance_11_12_data import TOPIC_12
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Governance learner-v2 Topic 12",
        previous=previous,
        previous_keys=["governance-11"],
    )
