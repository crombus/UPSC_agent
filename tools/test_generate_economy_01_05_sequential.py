"""Regression tests for Economy learner-v2 Topics 01-05."""
...
import generate_economy_01_sequential as economy01  # noqa: E402
import generate_economy_02_sequential as economy02  # noqa: E402
import generate_economy_03_sequential as economy03  # noqa: E402
import generate_economy_04_sequential as economy04  # noqa: E402
import generate_economy_05_sequential as economy05  # noqa: E402
...
class EconomySequentialTests(unittest.TestCase):
    generators = [economy01, economy02, economy03, economy04, economy05]
        ...
        for generator in self.generators:
            ...
            spec = json.loads(
                (
                    ...
                    / f"{key}-new-topic-2026-09-03.json"
                ).read_text(encoding="utf-8")
            )
    ...
    def test_topic_01_uses_legacy_history_without_regeneration_flag(self) -> None:
        spec = json.loads(
            (
                common.EXPORT_DIR / "economy-01-new-topic-2026-09-03.json"
            ).read_text(encoding="utf-8")
        )
        self.assertFalse(spec["allow_existing_history"])
        self.assertEqual(1, spec["generation"])

    def test_exact_economy_distinctions_survive(self) -> None:
        expected = {
            "economy-01": ["2022-23-base", "First Advance Estimate", "Purchasing Power Parity", "intangible"],
            "economy-02": ["MPI = H", "IHDI", "geometric mean", "2021 PPP prices"],
            "economy-03": ["2024=100", "2022-23-base WPI", "disinflation", "stagflation"],
            "economy-04": ["weighted average call rate", "plus or minus 2", "uncollateralised", "statutory body"],
            "economy-05": ["40 per cent", "Master Directions", "Access, Usage and Quality", "five lakh rupees"],
        }
        for generator in self.generators:
