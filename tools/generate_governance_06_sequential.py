"""Build Governance learner-v2 Topic 06 in authoring-only mode."""
...
from governance_05_06_data import TOPIC_06
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Governance learner-v2 Topic 06",
        previous=previous,
        previous_keys=["governance-05"],
    )
