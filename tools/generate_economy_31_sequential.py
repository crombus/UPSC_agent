"""Build Economy learner-v2 Topic 31 in authoring-only mode."""

from pathlib import Path

import generate_economy_30_sequential as previous
import generate_economy_common as common
from economy_28_31_data import TOPIC_31
...
TOPICS = [TOPIC_31]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-31-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 31", previous=previous, previous_keys=["economy-30"])
