"""Build Science and Technology learner-v2 Topic 21 in authoring-only mode."""

from pathlib import Path

import generate_science_and_technology_common as common
from science_and_technology_21_data import TOPIC_21
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "science-and-technology-21-2026-09-04-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Science and Technology learner-v2 Topic 21",
        previous=None,
    )
