"""Build Geography learner-v2 Topic 22 in authoring-only mode."""
...
from geography_20_22_data import TOPIC_22
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topic 22",
        previous=previous,
        previous_keys=["geography-21"],
    )
