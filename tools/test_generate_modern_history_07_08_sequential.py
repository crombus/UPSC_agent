"""Targeted tests for the Modern History 07-08 authoring generator."""
...
import generate_modern_history_07_08_sequential as generator
import notions_style_ascii_master as ascii_master


class ModernHistory0708GeneratorTests(unittest.TestCase):
    ...
    def test_generated_markdown_and_workbooks_pass_internal_contracts(self) -> None:
        expected_sessions = {
            "modern-indian-history-07": 22,
            "modern-indian-history-08": 16,
        }
