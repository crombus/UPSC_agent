"""Build International Relations learner-v2 Topic 08 in authoring-only mode."""
...
import generate_international_relations_07_sequential as previous_batch
from international_relations_08_data import TOPIC_08
...
TOPICS = [TOPIC_08]
PREVIOUS_KEYS = ["international-relations-07"]
...
def main() -> int:
    return common.run_batch(
        ...
        scope="International Relations learner-v2 Topic 08",
