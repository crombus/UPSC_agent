"""Build Internal Security learner-v2 Topic 10 in authoring-only mode."""

from pathlib import Path

import generate_internal_security_09_sequential as previous
import generate_internal_security_common as common
from internal_security_10_data import TOPIC_10
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "internal-security-10-2026-09-04-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Internal Security learner-v2 Topic 10",
        previous=previous,
        previous_keys=["internal-security-09"],
    )
