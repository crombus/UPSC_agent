"""Build Governance learner-v2 Topic 16 in authoring-only mode."""
...
from governance_15_16_data import TOPIC_16
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Governance learner-v2 Topic 16",
        previous=previous,
        previous_keys=["governance-15"],
    )
