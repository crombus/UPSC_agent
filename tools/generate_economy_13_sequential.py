"""Build Economy learner-v2 Topic 13 in authoring-only mode."""

from pathlib import Path

import generate_economy_12_sequential as previous
import generate_economy_common as common
from economy_11_15_data import TOPIC_13
...
TOPICS = [TOPIC_13]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-13-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 13", previous=previous, previous_keys=["economy-12"])
