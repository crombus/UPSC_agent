"""Regression tests for Economy learner-v2 Topics 06-10."""
...
import generate_economy_06_sequential as economy06  # noqa: E402
import generate_economy_07_sequential as economy07  # noqa: E402
import generate_economy_08_sequential as economy08  # noqa: E402
import generate_economy_09_sequential as economy09  # noqa: E402
import generate_economy_10_sequential as economy10  # noqa: E402
...
class EconomySequentialTests(unittest.TestCase):
    generators = [economy06, economy07, economy08, economy09, economy10]
    ...
    def test_exact_economy_distinctions_survive(self) -> None:
        expected = {
            "economy-06": ["more than 90 days", "CET1 5.5 per cent", "Access, Usage and Quality", "Inter-Creditor Agreement"],
            "economy-07": ["Stock Broker Connect", "Commercial Paper", "RTGS settles", "IFSCA"],
            "economy-08": ["symmetric obligations", "Participatory Notes", "sustainability bond", "Beta"],
            "economy-09": ["Article 112", "non-debt receipts", "Effective revenue deficit", "2026-27 Budget Estimates"],
            "economy-10": ["Article 279A", "three-fourths", "2017-2022", "2026-27 to 2030-31"],
        }
        for generator in self.generators:
