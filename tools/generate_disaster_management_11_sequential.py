"""Build Disaster Management learner-v2 Topic 11 in authoring-only mode."""

from pathlib import Path

import generate_disaster_management_10_sequential as previous
import generate_disaster_management_common as common
from disaster_management_11_data import TOPIC_11
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / f"disaster-management-11-{DATE}-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Disaster Management learner-v2 Topic 11",
        previous=previous,
        previous_keys=["disaster-management-10"],
    )
