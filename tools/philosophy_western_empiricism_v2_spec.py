"""Durable learner-v2 content and master-flow specification for Empiricism."""
...
SESSION_SPECS = (
    session(
        "Empiricist Project: Experience and the Locke-Berkeley-Hume Pressure Sequence",
        "Empiricism begins from experience, but Locke, Berkeley and Hume disagree about what can survive once every idea must be traced to experiential content.",
        ...
        "Open with experience and representative realism; move through immaterialism to sceptical naturalism; then show how the Locke-Berkeley-Hume sequence tests successive limits of justification.",
        "Each thinker applies experiential scrutiny to a claim preserved by the previous system: material support, active spirit, continuing self or necessary connection.",
        "The sequence moves from moderate realism through idealism to mitigated scepticism without becoming a simple story of philosophical decline.",
        "Do not say that empiricism denies reason, that Berkeley denies experienced reality, or that Hume doubts everything in ordinary life.",
        "The sequence may look like a self-refutation in which experience destroys the stable world, subject and causation needed to describe experience.",
        "The empiricists can answer that the project distinguishes what is experientially warranted from what custom, language or metaphysics adds.",
        "The reply explains epistemic discipline but does not by itself recover objective necessity or a persisting subject.",
        "For comparative questions, use the pressure sequence and matched axes rather than three parallel summaries.",
        [
        ...
        [
            visual(
                "Empiricist source-of-ideas and pressure pipeline",
    ...
    session(
        "Locke I: Innate Ideas, Sensation, Reflection and the Construction of Knowledge",
        "Locke rejects supplied mental content and treats the mind as receiving simple materials from outer and inner experience before actively combining them.",
        "Sensation supplies ideas from external objects; reflection supplies ideas of mental operations. Simple ideas are passively received, while complex ideas are formed through combination, comparison and abstraction as modes, substances and relations.",
        ...
        "Refute innate ideas, introduce tabula rasa, trace sensation and reflection into simple ideas, and show how combination forms complex ideas as modes, substances and relations.",
        "Experience supplies simple contents, after which mental operations build complex ideas without inventing any new simple sensory material.",
        "The account explains acquisition and classification while restricting knowledge to relations among ideas and to limited assurance about existence.",
        "Do not call reflection an innate source or describe the Lockean mind as passive at every stage.",
        "Dispositional innatism can answer that an innate capacity need not be a consciously entertained proposition.",
        "Locke can insist that his target is innate content and that ordinary cognitive capacities are compatible with an experiential origin of ideas.",
        "This qualification defeats crude innatism more securely than sophisticated rationalist dispositional accounts.",
        "Use the order rejection, positive source theory, simple-to-complex construction, knowledge and limits.",
        [
        ...
        [
            visual(
                "Locke's simple-to-complex construction",
            ...
            visual(
                "Locke's degrees and limits of knowledge",
    ...
    session(
        "Locke II: Abstraction, General Ideas and Real-Nominal Essence",
        "Locke explains general thought by making a particular idea represent many particulars after irrelevant circumstances are left out.",
        "Abstraction separates an idea from circumstances of time, place and accompanying determinations so that it can function as an abstract general idea; the nominal essence is the classificatory abstract idea, while the real essence is the usually unknown internal constitution.",
        ...
        "Explain the language problem, abstraction, nominal essence and real essence before presenting Berkeley's triangle objection and Locke's determinable reply.",
        "A particular experiential idea becomes general by selective omission and stands for a class under a general name.",
        "Classification becomes the workmanship of the understanding, while the hidden constitutions of natural kinds remain only partially known.",
        "Do not present Locke as a Platonic realist or treat nominal essence as the physical microstructure of a thing.",
        "Berkeley argues that a triangle that is neither equilateral nor scalene yet represents both cannot be imagined coherently.",
        "Locke can distinguish leaving angle-size undetermined from positively assigning contradictory angle-sizes.",
        "The reply is strongest if ideas are not merely mental pictures, which strains Locke's recurrent imagistic language.",
        "In an abstraction answer, reconstruct both positions and end with the ideational theory of meaning as the deeper disputed premise.",
        [
        ...
        [
            ...
            visual(
                "Locke-Berkeley abstraction dispute",
    ...
    session(
        "Locke III: Primary-Secondary Qualities, Representative Realism and Substratum",
        "Locke says ideas mediate perception, some ideas resemble object qualities, and clustered qualities lead us to suppose an unknown supporting substance.",
        "Primary qualities such as solidity, extension, figure, motion or rest and number are inseparable from body and are said to resemble their object-side qualities; secondary qualities are powers to produce colour, sound, taste and similar ideas that do not resemble their causes.",
        ...
        "Define both quality classes, state the resemblance thesis, map mediated perception, then explain substance as a supposed support rather than a known object.",
        "External bodies causally produce ideas; primary-quality ideas allegedly resemble their causes, while repeated co-instantiation motivates the supposition of a support.",
        "The theory preserves realism and scientific explanation but limits access to the inner nature of substance.",
        "Do not say Locke knows the substratum positively or that he denies substance exists.",
        "If the mind immediately perceives only ideas, it cannot step outside them to compare an idea with an unperceived material quality.",
        "A Lockean can defend causal or structural representation rather than pictorial resemblance and treat substance as an explanatory posit.",
        "Structural representation and stable powers reduce the sceptical force but leave substratum epistemically opaque.",
        "Use a quality matrix plus the object-to-idea chain and finish with the veil objection, best reply and residual opacity.",
        [
        ...
        [
            ...
            visual(
                "Representative realism and the veil objection",
    ...
    session(
        "Locke IV: Knowledge, Probability, Personal Identity and Demonstrative God",
        "Locke separates strict knowledge from probable belief, defines the person by continuity of consciousness, and argues demonstratively from our existence to God.",
        "Knowledge is perceived agreement or disagreement among ideas and is intuitive, demonstrative or sensitive; probability governs belief beyond certainty. Personal identity follows the same consciousness through memory and differs from identity of human animal or thinking substance. God's existence is treated as demonstratively knowable from the existence of a finite knowing self.",
        ...
        "Separate knowledge from probability, then distinguish person, human being and substance before explaining memory, responsibility and the proof of God.",
        "Conscious appropriation links present and past experiences for accountability, while demonstrative reasoning moves from existing knowing being to an eternal powerful cause.",
        "Identity becomes psychological and forensic rather than bodily or simply substantial, but memory and proof carry substantial burdens.",
        "Do not reduce Locke's person to a soul, a body or one present memory episode.",
        "Butler charges circularity and Reid's Brave Officer exposes a transitivity problem when later stages forget earlier ones.",
        "Overlapping chains of psychological continuity can preserve transitivity without requiring direct recollection of every episode.",
        "The repair develops Locke beyond a literal memory criterion and still depends on reliable causal continuity of consciousness.",
        "For self-and-God questions, keep personal identity, substantial identity and demonstrative theism analytically separate.",
        [
        ...
        [
            visual(
                "Locke's substance-self architecture",
    ...
    session(
        "Berkeley I: Anti-Abstraction, Anti-Matter and Immaterialist Direct Realism",
        "Berkeley keeps ordinary tables and trees but denies that they hide an unknowable material support behind the ideas directly perceived.",
        "Berkeley rejects abstract general ideas and material substance, identifies sensible objects with ordered collections of ideas, distinguishes passive ideas from active spirits, and states esse est percipi for sensible things.",
        ...
        "Move from Berkeley's nominalist use of particulars to the rejection of material substance, then explain sensible objects, spirits and direct perception.",
        "If all sensible qualities are ideas and no idea can resemble an unperceiving material original, matter adds no intelligible content to experienced objects.",
        "Objects remain real as publicly ordered ideas, while the metaphysical inventory becomes minds and their ideas.",
        "Do not translate esse est percipi as 'nothing exists unless a human currently looks at it.'",
        "The Master Argument may confuse conceiving a tree with conceiving the tree's dependence on the conceiver.",
        "Berkeley can reply that the target is an object conceived as wholly outside every possible mind, not a merely unattended human object.",
        "The reply supports anti-abstraction more securely than it conclusively proves idealism against every realist theory.",
        "Reconstruct the critique sequence; never offer esse est percipi as an unsupported slogan.",
        [
        ...
        [
            ...
            visual(
                "Locke and Berkeley on perceptual realism",
    ...
    session(
        "Berkeley II: Qualities, Spirits, God, World-Continuity and Objections",
        "Berkeley explains stable public experience through active spirits and the law-like ideas caused by God, not through matter or a human gaze.",
        "The relativity and inseparability arguments collapse Locke's primary-secondary distinction; finite spirits receive involuntary sensory ideas, while the infinite spirit, God, causes their regular order. The self is an active spirit known by notion rather than as a passive idea.",
        ...
        "Collapse the quality distinction, distinguish ideas from spirits, then map finite perception, divine causation, continuity and the self known by notion.",
        "Involuntary, vivid and coherent sensory ideas form a law-like order whose active cause cannot be a passive idea and is attributed to God.",
        "The account preserves continuity, objectivity and common life without matter but depends on a substantial theological inference.",
        "Do not say God is the collection of ideas, that finite minds create sensory order, or that Berkeley has an idea of spirit.",
        "Solipsism, illusion, pain, finite causation and the theological gap challenge the move from experienced order to one infinite spirit.",
        "Berkeley distinguishes ideas of sense from imagination by involuntariness and coherence, and treats natural regularities as divine signs.",
        "These distinctions answer crude solipsism and illusion but do not force the unique conclusion that God is the only adequate cause.",
        "Use the continuity model and include common-sense gain, theological cost and the notions issue.",
        [
        ...
        [
            visual(
                "Finite perceiver, ideas and divine continuity",
    ...
    session(
        "Hume I: Impressions, Ideas, Copy Principle, Fork, Substance, Self and God",
        "Hume inventories perceptions, traces ideas to impressions and refuses positive metaphysical content where no corresponding experiential source can be found.",
        "Perceptions divide into forceful impressions and fainter ideas; the Copy Principle traces simple ideas to simple impressions, while association proceeds by resemblance, contiguity and cause-effect. Hume's Fork distinguishes relations of ideas from matters of fact. Substance and the simple self lack impressions; personal identity is a bundle fiction aided by memory and imagination.",
        ...
        "Define impression and idea through force and vivacity, qualify the Copy Principle, explain association, relations of ideas and matters of fact, then apply the method to bundle theory and natural religion.",
        "Ideas inherit content from impressions; associative imagination connects them, but neither branch of the Fork supplies a perceived substance or a demonstrative inference to transcendent being.",
        "Metaphysical certainty contracts, while mathematics, experience, probability and natural belief remain.",
        "Do not say every idea is itself an impression, that the missing shade destroys the Copy Principle, or that Hume proves there is no self or God.",
        "The missing shade of blue and relational thought challenge an exceptionless copy rule; the bundle also seems to require a principle that unifies perceptions.",
        "Hume treats the missing shade as a rare exception and presents the Copy Principle as a critical test, while memory discovers rather than creates many relations.",
        "His Appendix concedes that he cannot explain the unity of the bundle, and his critique of religion limits proof more clearly than existence.",
        "Use the experiential test carefully: distinguish absence of justified idea or proof from a dogmatic proof of non-existence.",
        [
        ...
        [
            ...
            visual(
                "Bundle self and identity fiction",
    ...
    session(
        "Hume II: Causation, Constant Conjunction, Habit and the Problem of Induction",
        "Repeated sequences train expectation, but neither one case nor many cases reveal a necessary power binding cause to effect.",
        "Causal experience gives temporal priority, contiguity and constant conjunction; repetition produces an impression of reflective determination in the mind. Custom projects necessary connection and supports inductive inference, whose appeal to the uniformity of nature cannot be demonstratively or non-circularly justified.",
        ...
        "Begin with causation and necessary connection, derive constant conjunction and habit or custom, explain projection and both definitions of cause, then expose induction and the uniformity-of-nature circle.",
        "Observed regularity conditions the imagination to move from cause-idea to effect-idea; the future is inferred from the past only by the very inductive principle under question.",
        "Science and ordinary action retain probabilistic practice, but logical necessity and a non-circular proof of uniformity are unavailable.",
        "Do not reduce causation to accidental succession or say Hume recommends abandoning causal and inductive practice.",
        "A regularity account may confuse genuine causation with correlated sequences and cannot easily explain unobserved mechanisms or interventions.",
        "The Humean can allow refined regularities, counterfactual structure or theoretical modelling while denying a separately perceived necessary power.",
        "Such refinements may exceed Hume's own ontology and do not convert inductive success into demonstrative justification.",
        "A high-scoring answer separates what is observed, what habit adds, why induction is circular and what naturalism preserves.",
        [
        ...
        [
            visual(
                "Causation and induction habit loop",
            ...
            visual(
                "What Hume observes and what the mind adds",
    ...
    session(
        "Hume III and Comparative Synthesis: God, Miracles, Mitigated Scepticism and Answer Spine",
        "Hume limits speculative reason while allowing natural belief and disciplined inquiry to return us from excessive doubt to ordinary life.",
        "Antecedent or excessive scepticism undermines action and even its own reasoning, whereas mitigated scepticism confines inquiry to human capacities, probability and experience. Hume tests design by analogy and miracles by comparative testimony and probability; these arguments limit rational warrant rather than establish a simple global atheism.",
        ...
        "Distinguish types of scepticism, explain natural return, qualify religion arguments, then compare substance, qualities, self, God and scepticism across all three thinkers.",
        "Philosophical doubt exposes the limits of reason, while natural instinct and custom re-establish action under a disciplined, probabilistic standard of belief.",
        "Empiricism ends neither in dogmatic metaphysics nor paralysis but in proportioning assent to evidence and acknowledging the non-rational basis of unavoidable expectations.",
        "Do not call Hume a global sceptic, claim that he disproves God, or treat mitigated scepticism as certainty.",
        "If custom rather than reason governs basic belief, Hume appears to describe cognitive compulsion rather than justify knowledge.",
        "His naturalism can answer that philosophy should explain the conditions and limits of actual human cognition instead of demanding impossible foundations.",
        "Description and inevitability do not by themselves supply epistemic normativity, which motivates Kant and later responses.",
        "Use a matched comparison matrix, criticism-reply map and directive-specific answer spine with a qualified verdict.",
        [
        ...
        [
            visual(
                "Three-philosopher comparison on official syllabus axes",
...
ASCII_PANELS = (
    {
        "title": "Empiricist starting rule and Locke-Berkeley-Hume pressure sequence",
        "structural_type": "connected-doctrinal-sequence",
        "sessions": [1],
        "lines": [
    ...
    {
        "title": "Locke's source-of-ideas pipeline and limits of knowledge",
        "structural_type": "source-construction-and-certainty-ladder",
        "sessions": [2],
        "lines": [
    ...
    {
        "title": "Locke's abstraction, general ideas and real-nominal essence",
        "structural_type": "classification-flow-and-dispute",
        "sessions": [3],
        "lines": [
    ...
    {
        "title": "Locke's qualities, representative realism and unknown substratum",
        "structural_type": "quality-matrix-and-representation-chain",
        "sessions": [4],
        "lines": [
    ...
    {
        "title": "Locke's knowledge, probability, self, memory and demonstrative God",
        "structural_type": "identity-tree-and-objection-repair",
        "sessions": [5],
        "lines": [
    ...
    {
        "title": "Berkeley's anti-abstraction route to immaterialism and direct realism",
        "structural_type": "critique-sequence-and-ontology",
        "sessions": [6],
        "lines": [
    ...
    {
        "title": "Berkeley's spirits, God, world-continuity and objection ledger",
        "structural_type": "perceiver-continuity-network",
        "sessions": [7],
        "lines": [
    ...
    {
        "title": "Hume's impressions, ideas, Fork, substance, bundle self and religion limits",
        "structural_type": "perception-taxonomy-and-application-map",
        "sessions": [8],
        "lines": [
    ...
    {
        "title": "Hume's causation, induction and custom loop",
        "structural_type": "habit-loop-and-justification-dilemma",
        "sessions": [9],
        "lines": [
    ...
    {
        "title": "Comparative synthesis, scepticism, PYQ routes and answer spine",
        "structural_type": "matched-axis-matrix-and-exam-ledger",
        "sessions": [10],
        "lines": [
