"""Build Indian Art and Culture learner-v2 Topic 10 in authoring-only mode."""
...
from indian_art_culture_06_10_data import TOPIC_10
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Art and Culture learner-v2 Topic 10",
        previous=previous,
        previous_keys=[
            "indian-art-and-culture-08",
            "indian-art-and-culture-09",
        ],
    )
