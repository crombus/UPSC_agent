"""Build Economy learner-v2 Topic 19 in authoring-only mode."""

from pathlib import Path

import generate_economy_18_sequential as previous
import generate_economy_common as common
from economy_16_19_data import TOPIC_19
...
TOPICS = [TOPIC_19]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-19-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 19", previous=previous, previous_keys=["economy-18"])
