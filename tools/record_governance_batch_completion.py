"""Prove and record the batch completion manifest for one Governance run.

Reads the per-topic completion manifests, tracker records, ASCII panel specs and
graphical specs for a sequential Governance learner-v2 batch, re-proves every
...
import record_governance_completion as topic_record  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--baseline-topics", type=int, default=248)
    parser.add_argument("--baseline-panels", type=int, default=2848)
    parser.add_argument(
        "--also-changed",
        action="append",
        default=[],
