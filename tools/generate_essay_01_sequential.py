"""Build Essay learner-v2 Topic 01 in authoring-only mode."""

from pathlib import Path

import generate_essay_common as common
from essay_01_data import TOPIC_01
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / f"essay-01-{DATE}-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Essay learner-v2 Topic 01",
        previous=None,
    )
