"""Record the strict sequential Essay learner-v2 batch."""
...
import record_essay_completion as topic_record  # noqa: E402
...
def main() -> int:
    ...
    payload = {
        ...
        "scope": (
            f"Essay learner-v2 Topics {topic_range}, "
            "strictly sequential"
        ),
