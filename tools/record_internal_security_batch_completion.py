"""Record the strict sequential Internal Security learner-v2 batch."""
...
import record_internal_security_completion as topic_record  # noqa: E402
...
def main() -> int:
    ...
    payload = {
        ...
        "scope": (
            f"Internal Security learner-v2 Topics {topic_range}, "
            "strictly sequential"
        ),
