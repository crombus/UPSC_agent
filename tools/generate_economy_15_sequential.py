"""Build Economy learner-v2 Topic 15 in authoring-only mode."""

from pathlib import Path

import generate_economy_14_sequential as previous
import generate_economy_common as common
from economy_11_15_data import TOPIC_15
...
TOPICS = [TOPIC_15]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-15-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 15", previous=previous, previous_keys=["economy-14"])
