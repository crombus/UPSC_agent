"""Build Economy learner-v2 Topic 10 in authoring-only mode."""

from pathlib import Path

import generate_economy_09_sequential as previous
import generate_economy_common as common
from economy_06_10_data import TOPIC_10
...
TOPICS = [TOPIC_10]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-10-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 10", previous=previous, previous_keys=["economy-09"])
