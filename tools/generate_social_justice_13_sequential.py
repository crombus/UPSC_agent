"""Build Social Justice learner-v2 Topic 13 in authoring-only mode."""

from __future__ import annotations

from pathlib import Path

import generate_social_justice_12_sequential as previous
import generate_social_justice_common as common
from social_justice_13_14_data import TOPIC_13
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Social Justice learner-v2 Topic 13",
        previous=previous,
        previous_keys=["social-justice-12"],
    )
