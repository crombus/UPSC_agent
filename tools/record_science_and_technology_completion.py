"""Prove and record one finalised Science and Technology learner-v2 topic."""
...
import generate_science_and_technology_common as science  # noqa: E402
...
SHARED_FILES = [
    ...
    "upsc-ai-kit\\manifests\\v2\\science-and-technology--subject-wide-syllabus.json",
    "notes\\Science-and-Technology\\learning-session-v2\\subject-wide-syllabus\\indexes\\TOPIC-COVERAGE-INDEX.md",
    "notes\\Science-and-Technology\\learning-session-v2\\subject-wide-syllabus\\indexes\\NOTES-PDF-INDEX.md",
    "notes\\Science-and-Technology\\learning-session-v2\\subject-wide-syllabus\\indexes\\WORKBOOK-PDF-INDEX.md",
]
...
def prove(topic_key: str, record: dict[str, object]) -> dict[str, object]:
    ...
    graphical = json.loads(
        (
            science.GRAPHICAL_DIR / f"{topic_key}.json"
    ...
    metrics = {
        ...
        "ascii_atlas_after_register_body": (
            ...
            > max(register.rfind(item) for item in science.REGISTER_HEADINGS)
        ),
    ...
    gates = {
        ...
        "live_official_source_attempts_recorded": metrics["live_source_attempt_log_present"],
...
def changed_files(record: dict[str, object], also_changed: list[str] | None = None) -> list[str]:
    ...
    paths.update(
        ...
        for value in [
            ...
            f"upsc-ai-kit\\manifests\\retrofits\\carvaka-graphical-specs\\Science-and-Technology\\{topic_key}.json",
