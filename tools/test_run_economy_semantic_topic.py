"""Tests for the strictly sequential Economy semantic driver."""
...
class EconomySemanticTopicRunnerTests(unittest.TestCase):
    ...
    def test_driver_uses_complete_economy_catalogue(self) -> None:
        self.assertEqual(set(range(1, 32)), set(subject.runner.TOPIC_CHOICES))
        self.assertEqual(
    ...
    def test_live_sources_and_canonical_controls_cover_every_topic(self) -> None:
        self.assertEqual(set(range(1, 32)), set(deep.LIVE_OFFICIAL_SOURCES))
    ...
    def test_reports_and_inventories_use_requested_date(self) -> None:
        ...
        self.assertIn("Economy Semantic-Completeness Review", wrapper)
