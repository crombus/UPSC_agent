"""Prove and record the batch completion manifest for one Social Justice run.

Reads the per-topic completion manifests, tracker records, ASCII panel specs and
graphical specs for a sequential Social Justice learner-v2 batch, re-proves every
...
import record_social_justice_completion as topic_record  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--baseline-topics", type=int, default=264)
    parser.add_argument("--baseline-panels", type=int, default=3040)
    parser.add_argument(
        "--also-changed",
        action="append",
        default=[],
