"""Build Governance learner-v2 Topic 09 in authoring-only mode."""
...
from governance_09_10_data import TOPIC_09
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Governance learner-v2 Topic 09",
        previous=previous,
        previous_keys=["governance-08"],
    )
