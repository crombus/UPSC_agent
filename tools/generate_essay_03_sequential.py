"""Build Essay learner-v2 Topic 03 in authoring-only mode."""

from pathlib import Path

import generate_essay_02_sequential as previous
import generate_essay_common as common
from essay_03_data import TOPIC_03
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / f"essay-03-{DATE}-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Essay learner-v2 Topic 03",
        previous=previous,
        previous_keys=["essay-02"],
    )
