"""Tests for the strictly sequential Polity 31-35 semantic driver."""
...
import run_polity_31_35_semantic_topic as runner


class Polity3135SemanticTopicRunnerTests(unittest.TestCase):
    ...
    def test_driver_uses_topics_31_35_configuration(self) -> None:
        self.assertEqual(set(range(31, 36)), set(runner.runner.TOPIC_CHOICES))
        self.assertTrue(set(range(31, 36)).issubset(runner.runner.SLUGS))
        self.assertTrue(set(range(31, 36)).issubset(runner.runner.PYQ_STATUS))
