"""Build Governance learner-v2 Topic 10 in authoring-only mode."""
...
from governance_09_10_data import TOPIC_10
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Governance learner-v2 Topic 10",
        previous=previous,
        previous_keys=["governance-09"],
    )
