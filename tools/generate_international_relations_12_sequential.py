"""Build International Relations learner-v2 Topic 12 in authoring-only mode."""
...
import generate_international_relations_11_sequential as previous_batch
from international_relations_12_data import TOPIC_12
...
TOPICS = [TOPIC_12]
PREVIOUS_KEYS = ["international-relations-11"]
...
def main() -> int:
    return common.run_batch(
        ...
        scope="International Relations learner-v2 Topic 12",
