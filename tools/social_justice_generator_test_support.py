"""Shared assertions for Social Justice sequential generator tests."""
...
def assert_batch_contract(
    ...
    case.assertEqual("Social-Justice", manifest["subject"]["key"])
    case.assertEqual(
    ...
    for config in generator.TOPICS:
        ...
        case.assertEqual("Social-Justice", graphical["subject"], key)
