"""Prove and record completion manifests for one Indian Society learner-v2 topic.
...
SHARED_FILES = [
    ...
    "upsc-ai-kit\\manifests\\v2\\indian-society--subject-wide-syllabus.json",
    "upsc-ai-kit\\knowledge\\Indian-Society\\LEARNING-SESSION-COMMAND-INDEX.md",
    f"notes\\Indian-Society\\learning-session-v2\\{SECTION_KEY}\\indexes\\TOPIC-COVERAGE-INDEX.md",
    f"notes\\Indian-Society\\learning-session-v2\\{SECTION_KEY}\\indexes\\NOTES-PDF-INDEX.md",
    f"notes\\Indian-Society\\learning-session-v2\\{SECTION_KEY}\\indexes\\WORKBOOK-PDF-INDEX.md",
]
...
def prove(topic_key: str, record: dict[str, object]) -> dict[str, object]:
    ...
    register_headings = [
        ...
        "CURRENT-LINK AND DATA BOUNDARY",
    ]
