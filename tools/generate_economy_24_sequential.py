"""Build Economy learner-v2 Topic 24 in authoring-only mode."""

from pathlib import Path

import generate_economy_23_sequential as previous
import generate_economy_common as common
from economy_24_27_data import TOPIC_24
...
TOPICS = [TOPIC_24]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-24-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 24", previous=previous, previous_keys=["economy-23"])
