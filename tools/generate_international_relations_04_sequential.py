"""Build International Relations learner-v2 Topic 04 in authoring-only mode."""
...
import generate_international_relations_03_sequential as previous_batch
from international_relations_04_data import TOPIC_04
...
TOPICS = [TOPIC_04]
PREVIOUS_KEYS = ["international-relations-03"]
...
def main() -> int:
    return common.run_batch(
        ...
        scope="International Relations learner-v2 Topic 04",
