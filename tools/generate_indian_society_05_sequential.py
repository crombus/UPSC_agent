"""Build Indian Society learner-v2 Topic 05 in authoring-only mode."""
...
from indian_society_01_05_data import TOPIC_05
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Society learner-v2 Topic 05",
        previous=previous,
        previous_keys=["indian-society-04"],
    )
