"""Build Indian Society learner-v2 Topic 03 in authoring-only mode."""
...
from indian_society_01_05_data import TOPIC_03
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Society learner-v2 Topic 03",
        previous=previous,
        previous_keys=["indian-society-02"],
    )
