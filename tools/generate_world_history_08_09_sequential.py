"""Build World History learner-v2 Topics 08-09 in authoring-only mode."""
...
from world_history_06_10_data import TOPIC_08, TOPIC_09
...
def main() -> int:
    return common.run_batch(
        ...
        scope="World History learner-v2 Topics 08-09",
        previous=previous,
        previous_keys=["world-history-06", "world-history-07"],
    )
