"""Build Geography learner-v2 Topic 29 in authoring-only mode."""
...
from geography_26_27_29_data import TOPIC_29
...
def main() -> int:
    ...
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topic 29 rebuild",
        previous=previous,
        previous_keys=["geography-27"],
    )
