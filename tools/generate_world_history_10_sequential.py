"""Build World History learner-v2 Topic 10 in authoring-only mode."""
...
from world_history_06_10_data import TOPIC_10
...
def main() -> int:
    return common.run_batch(
        ...
        scope="World History learner-v2 Topic 10",
        previous=previous,
        previous_keys=["world-history-08", "world-history-09"],
    )
