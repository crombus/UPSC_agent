"""Build Indian Art and Culture learner-v2 Topics 03-04 in authoring-only mode."""
...
from indian_art_culture_01_05_data import TOPIC_03, TOPIC_04
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Art and Culture learner-v2 Topics 03-04",
        previous=previous,
        previous_keys=[
            "indian-art-and-culture-01",
            "indian-art-and-culture-02",
        ],
    )
