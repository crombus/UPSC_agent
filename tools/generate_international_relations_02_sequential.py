"""Build International Relations learner-v2 Topic 02 in authoring-only mode."""
...
import generate_international_relations_01_sequential as previous_batch
from international_relations_02_data import TOPIC_02
...
TOPICS = [TOPIC_02]
PREVIOUS_KEYS = ["international-relations-01"]
...
def main() -> int:
    return common.run_batch(
        ...
        scope="International Relations learner-v2 Topic 02",
