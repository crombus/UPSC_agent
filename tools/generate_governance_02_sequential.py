"""Build Governance learner-v2 Topic 02 in authoring-only mode."""
...
from governance_01_02_data import TOPIC_02
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Governance learner-v2 Topic 02",
        previous=previous,
        previous_keys=["governance-01"],
    )
