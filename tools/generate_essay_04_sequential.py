"""Build Essay learner-v2 Topic 04 in authoring-only mode."""

from pathlib import Path

import generate_essay_03_sequential as previous
import generate_essay_common as common
from essay_04_data import TOPIC_04
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / f"essay-04-{DATE}-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Essay learner-v2 Topic 04",
        previous=previous,
        previous_keys=["essay-03"],
    )
