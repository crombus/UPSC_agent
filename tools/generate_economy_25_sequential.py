"""Build Economy learner-v2 Topic 25 in authoring-only mode."""

from pathlib import Path

import generate_economy_24_sequential as previous
import generate_economy_common as common
from economy_24_27_data import TOPIC_25
...
TOPICS = [TOPIC_25]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-25-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 25", previous=previous, previous_keys=["economy-24"])
