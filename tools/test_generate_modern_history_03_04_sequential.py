"""Targeted tests for the Modern History 03-04 authoring generator."""
...
import generate_modern_history_03_04_sequential as generator
import notions_style_ascii_master as ascii_master


class ModernHistory0304GeneratorTests(unittest.TestCase):
    ...
    def test_generated_markdown_and_workbooks_pass_internal_contracts(self) -> None:
        expected_sessions = {
            "modern-indian-history-03": 28,
            "modern-indian-history-04": 16,
        }
    ...
    def test_graphical_specs_are_valid_and_have_twelve_core_stages(self) -> None:
        for key in generator.PANEL_DATA:
            ...
            self.assertEqual(12, len([stage for stage in spec["stages"] if stage["role"] != "extra"]))
