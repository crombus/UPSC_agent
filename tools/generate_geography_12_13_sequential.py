"""Build Geography learner-v2 Topics 12-13 in authoring-only mode."""
...
from geography_10_14_data import TOPIC_12, TOPIC_13
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topics 12-13",
        previous=previous,
        previous_keys=["geography-10", "geography-11"],
    )
