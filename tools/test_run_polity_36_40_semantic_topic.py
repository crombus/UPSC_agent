"""Tests for the strictly sequential Polity 36-40 semantic driver."""
...
import run_polity_36_40_semantic_topic as runner


class Polity3640SemanticTopicRunnerTests(unittest.TestCase):
    ...
    def test_driver_uses_topics_36_40_configuration(self) -> None:
        self.assertEqual(set(range(36, 41)), set(runner.runner.TOPIC_CHOICES))
        self.assertTrue(set(range(36, 41)).issubset(runner.runner.SLUGS))
        self.assertTrue(set(range(36, 41)).issubset(runner.runner.PYQ_STATUS))
