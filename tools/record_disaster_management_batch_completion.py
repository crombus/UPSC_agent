"""Record the strict sequential Disaster Management learner-v2 batch."""
...
import record_disaster_management_completion as topic_record  # noqa: E402
...
def main() -> int:
    ...
    payload = {
        ...
        "scope": (
            f"Disaster Management learner-v2 Topics {topic_range}, "
            "strictly sequential"
        ),
