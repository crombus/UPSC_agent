"""Tests for the strictly sequential Polity 41-45 semantic driver."""
...
import run_polity_41_45_semantic_topic as runner


class Polity4145SemanticTopicRunnerTests(unittest.TestCase):
    ...
    def test_driver_uses_topics_41_45_configuration(self) -> None:
        self.assertEqual(set(range(41, 46)), set(runner.runner.TOPIC_CHOICES))
        self.assertTrue(set(range(41, 46)).issubset(runner.runner.SLUGS))
        self.assertTrue(set(range(41, 46)).issubset(runner.runner.PYQ_STATUS))
