"""Prove and record one finalised Disaster Management learner-v2 topic."""
...
import generate_disaster_management_common as disaster  # noqa: E402
...
SHARED_FILES = [
    ...
    "upsc-ai-kit\\manifests\\v2\\disaster-management--subject-wide-syllabus.json",
    "notes\\Disaster-Management\\learning-session-v2\\subject-wide-syllabus\\indexes\\TOPIC-COVERAGE-INDEX.md",
    "notes\\Disaster-Management\\learning-session-v2\\subject-wide-syllabus\\indexes\\NOTES-PDF-INDEX.md",
    "notes\\Disaster-Management\\learning-session-v2\\subject-wide-syllabus\\indexes\\WORKBOOK-PDF-INDEX.md",
]
...
def prove(topic_key: str, record: dict[str, object]) -> dict[str, object]:
    ...
    graphical = json.loads(
        (
            disaster.GRAPHICAL_DIR / f"{topic_key}.json"
        ...
        "live_source_attempts_official": all(
            any(
                ...
                for domain in (
                    ...
                    "ndma.gov.in", "nidm.gov.in", "ndrf.gov.in",
                    "undrr.org", "wmo.int", "imd.gov.in", "incois.gov.in",
                    "cwc.gov.in", "isro.gov.in", "nrsc.gov.in",
                )
            )
...
def changed_files(record: dict[str, object], also_changed: list[str] | None = None) -> list[str]:
    ...
    paths.update(
        ...
        for value in [
            ...
            f"upsc-ai-kit\\manifests\\retrofits\\carvaka-graphical-specs\\Disaster-Management\\{topic_key}.json",
