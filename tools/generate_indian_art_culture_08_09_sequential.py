"""Build Indian Art and Culture learner-v2 Topics 08-09 in authoring-only mode."""
...
from indian_art_culture_06_10_data import TOPIC_08, TOPIC_09
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Art and Culture learner-v2 Topics 08-09",
        previous=previous,
        previous_keys=[
            "indian-art-and-culture-06",
            "indian-art-and-culture-07",
        ],
    )
