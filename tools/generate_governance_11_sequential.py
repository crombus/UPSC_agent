"""Build Governance learner-v2 Topic 11 in authoring-only mode."""
...
from governance_11_12_data import TOPIC_11
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Governance learner-v2 Topic 11",
        previous=previous,
        previous_keys=["governance-10"],
    )
