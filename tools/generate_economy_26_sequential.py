"""Build Economy learner-v2 Topic 26 in authoring-only mode."""

from pathlib import Path

import generate_economy_25_sequential as previous
import generate_economy_common as common
from economy_24_27_data import TOPIC_26
...
TOPICS = [TOPIC_26]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-26-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 26", previous=previous, previous_keys=["economy-25"])
