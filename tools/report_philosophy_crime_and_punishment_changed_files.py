"""Write the exhaustive changed-files manifest for the topic 7 run.
...
``philosophy-paper-ii-socio-political-philosophy-07:learner-v2:g2``, grouped by
...
def main() -> int:
    ...
    lines = [
        ...
        "- **Official syllabus (verbatim):** Crime and Punishment : "
