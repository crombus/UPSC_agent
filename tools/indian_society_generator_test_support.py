"""Shared assertions for Indian Society sequential generator tests."""
...
def assert_batch_contract(
    ...
    case.assertIn(
        "UPSC Mains 2025 GS Paper 1.pdf",
    ...
    case.assertEqual("Indian-Society", manifest["subject"]["key"])
    case.assertEqual(
    ...
    for config in generator.TOPICS:
        ...
        case.assertEqual("Indian-Society", graphical["subject"], key)
        ...
        case.assertIn(
            "books\\mains\\UPSC Mains 2025 GS Paper 1.pdf",
