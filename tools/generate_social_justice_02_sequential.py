"""Build Social Justice learner-v2 Topic 02 in authoring-only mode."""

from __future__ import annotations

from pathlib import Path

import generate_social_justice_01_sequential as previous
import generate_social_justice_common as common
from social_justice_01_02_data import TOPIC_02
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Social Justice learner-v2 Topic 02",
        previous=previous,
        previous_keys=["social-justice-01"],
    )
