"""Tests for the strictly sequential Polity 46-50 semantic driver."""
...
import run_polity_46_50_semantic_topic as runner


class Polity4650SemanticTopicRunnerTests(unittest.TestCase):
    ...
    def test_driver_uses_topics_46_50_configuration(self) -> None:
        self.assertEqual(set(range(46, 51)), set(runner.runner.TOPIC_CHOICES))
        self.assertTrue(set(range(46, 51)).issubset(runner.runner.SLUGS))
        self.assertTrue(set(range(46, 51)).issubset(runner.runner.PYQ_STATUS))
