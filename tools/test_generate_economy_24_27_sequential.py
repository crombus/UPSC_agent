"""Regression tests for Economy learner-v2 Topics 24-27."""
...
import generate_economy_24_sequential as economy24  # noqa: E402
import generate_economy_25_sequential as economy25  # noqa: E402
import generate_economy_26_sequential as economy26  # noqa: E402
import generate_economy_27_sequential as economy27  # noqa: E402
...
class EconomySequentialTests(unittest.TestCase):
    generators = [economy24, economy25, economy26, economy27]
    ...
    def test_measurement_and_status_boundaries_survive(self) -> None:
        expected = {
            "economy-24": ["direct RBI liability", "regulated entity's obligations", "phased implementation", "third party fulfils"],
            "economy-25": ["Social Cost of Carbon", "phased compliance-market", "green label alone", "flow addition"],
            "economy-26": ["First Advance Estimate", "BE, RE and actual", "May 2021 provisional", "January 2026 Survey vintage"],
            "economy-27": ["approval and sanctioned outlay", "federated Centre-state", "platform availability", "target has been achieved"],
        }
        for generator in self.generators:
    ...
    def test_verified_pyq_concepts_are_in_basic_and_practice(self) -> None:
        expected = {
            "economy-24": ["Merchant Discount Rate", "cryptocurrency", "digitalisation"],
            "economy-25": ["Social Cost of Carbon", "greenwashing", "sustainability bonds"],
            "economy-26": ["Global Competitiveness Report", "V-shaped"],
            "economy-27": ["100 Million Farmers", "e-Technology"],
        }
        for generator in self.generators:
            key = str(generator.TOPICS[0]["key"])
            text = (generator.SESSION_DIR / f"{key}_Learning-Session.md").read_text(encoding="utf-8")
