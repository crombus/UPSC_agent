"""Build Disaster Management learner-v2 Topic 06 in authoring-only mode."""

from pathlib import Path

import generate_disaster_management_05_sequential as previous
import generate_disaster_management_common as common
from disaster_management_06_data import TOPIC_06
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / f"disaster-management-06-{DATE}-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Disaster Management learner-v2 Topic 06",
        previous=previous,
        previous_keys=["disaster-management-05"],
    )
