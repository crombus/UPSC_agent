"""Build Internal Security learner-v2 Topic 01 in authoring-only mode."""

from pathlib import Path

import generate_internal_security_common as common
from internal_security_01_data import TOPIC_01
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "internal-security-01-2026-09-04-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Internal Security learner-v2 Topic 01",
        previous=None,
    )
