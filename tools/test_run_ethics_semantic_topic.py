"""Tests for the strictly sequential Ethics semantic driver."""
...
import run_ethics_semantic_topic as subject


class EthicsSemanticTopicRunnerTests(unittest.TestCase):
    ...
    def test_pyq_ledgers_cover_every_topic(self) -> None:
