"""Tests for the strictly sequential International Relations semantic driver."""
...
class InternationalRelationsSemanticTopicRunnerTests(unittest.TestCase):
    ...
    def test_driver_uses_complete_ir_catalogue(self) -> None:
        self.assertEqual(set(range(1, 13)), set(subject.runner.TOPIC_CHOICES))
        self.assertEqual(
    ...
    def test_live_sources_and_canonical_controls_cover_every_topic(self) -> None:
        self.assertEqual(set(range(1, 13)), set(deep.LIVE_OFFICIAL_SOURCES))
        self.assertEqual(set(range(1, 13)), set(deep.CANONICAL_OWNER_CONTROLS))
    ...
    def test_reports_and_inventories_use_requested_date(self) -> None:
        ...
        self.assertIn("International Relations Semantic-Completeness Review", wrapper)
