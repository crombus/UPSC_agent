"""Build Science and Technology learner-v2 Topic 02 in authoring-only mode."""

from pathlib import Path

import generate_science_and_technology_01_sequential as previous_batch
import generate_science_and_technology_common as common
from science_and_technology_01_05_data import TOPIC_02
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "science-and-technology-02-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Science and Technology learner-v2 Topic 02",
        previous=previous_batch,
        previous_keys=["science-and-technology-01"],
    )
