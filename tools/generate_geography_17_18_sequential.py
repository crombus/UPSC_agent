"""Build Geography learner-v2 Topics 17-18 in authoring-only mode."""
...
from geography_15_19_data import TOPIC_17, TOPIC_18
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topics 17-18",
        previous=previous,
        previous_keys=["geography-15", "geography-16"],
    )
