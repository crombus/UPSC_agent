"""Build Indian Art and Culture learner-v2 Topics 01-02 in authoring-only mode."""
...
from indian_art_culture_01_05_data import TOPIC_01, TOPIC_02
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Art and Culture learner-v2 Topics 01-02",
    )
