"""Build Geography learner-v2 Topic 14 in authoring-only mode."""
...
from geography_10_14_data import TOPIC_14
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topic 14",
        previous=previous,
        previous_keys=["geography-12", "geography-13"],
    )
