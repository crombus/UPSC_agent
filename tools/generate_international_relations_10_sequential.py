"""Build International Relations learner-v2 Topic 10 in authoring-only mode."""
...
import generate_international_relations_09_sequential as previous_batch
from international_relations_10_data import TOPIC_10
...
TOPICS = [TOPIC_10]
PREVIOUS_KEYS = ["international-relations-09"]
...
def main() -> int:
    return common.run_batch(
        ...
        scope="International Relations learner-v2 Topic 10",
