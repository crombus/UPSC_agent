"""Build International Relations learner-v2 Topic 03 in authoring-only mode."""
...
import generate_international_relations_02_sequential as previous_batch
from international_relations_03_data import TOPIC_03
...
TOPICS = [TOPIC_03]
PREVIOUS_KEYS = ["international-relations-02"]
...
def main() -> int:
    return common.run_batch(
        ...
        scope="International Relations learner-v2 Topic 03",
