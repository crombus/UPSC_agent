"""Build World History learner-v2 Topics 19-20 in authoring-only mode."""
...
from world_history_19_21_data import TOPIC_19, TOPIC_20
...
def main() -> int:
    return common.run_batch(
        ...
        scope="World History learner-v2 Topics 19-20",
        previous=previous,
        previous_keys=["world-history-18"],
    )
