"""Build World History learner-v2 Topics 06-07 in authoring-only mode."""
...
from world_history_06_10_data import TOPIC_06, TOPIC_07
...
def main() -> int:
    return common.run_batch(
        ...
        scope="World History learner-v2 Topics 06-07",
        previous=previous,
        previous_keys=["world-history-05"],
    )
