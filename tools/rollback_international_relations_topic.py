"""Roll back one International Relations learner-v2 generation.

Deletes only the learner-v2 output folders and the learner-v2 tracker records for
the given topic. Legacy-v1 records, legacy files and every other subject remain
untouched, so a rollback restores the exact pre-generation state for that topic.
"""
