"""Build Geography learner-v2 Topic 20 in authoring-only mode."""
...
from geography_20_22_data import TOPIC_20
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topic 20",
        previous=previous,
        previous_keys=["geography-19"],
    )
