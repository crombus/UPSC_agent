"""Build Geography learner-v2 Topic 23 in authoring-only mode."""
...
from geography_23_25_data import TOPIC_23
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topic 23",
        previous=previous,
        previous_keys=["geography-22"],
    )
