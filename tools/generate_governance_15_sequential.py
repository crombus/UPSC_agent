"""Build Governance learner-v2 Topic 15 in authoring-only mode."""
...
from governance_15_16_data import TOPIC_15
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Governance learner-v2 Topic 15",
        previous=previous,
        previous_keys=["governance-14"],
    )
