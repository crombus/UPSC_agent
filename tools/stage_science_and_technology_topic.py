"""Stage one Science and Technology learner-v2 topic without publishing tracker state."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--tests-scope",
        default="Science and Technology topic generator and shared refresh/manual-flow suites",
    )
