"""Build Geography learner-v2 Topics 05-06 in authoring-only mode."""
...
from geography_05_09_data import TOPIC_05, TOPIC_06
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topics 05-06",
    )
