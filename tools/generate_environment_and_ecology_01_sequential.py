"""Build Environment and Ecology learner-v2 Topic 01 in authoring-only mode."""
...
from environment_and_ecology_01_data import TOPIC_01
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Environment and Ecology learner-v2 Topic 01",
        previous=None,
        previous_keys=None,
    )
