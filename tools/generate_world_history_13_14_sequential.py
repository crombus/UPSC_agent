"""Build World History learner-v2 Topics 13-14 in authoring-only mode."""
...
from world_history_11_15_data import TOPIC_13, TOPIC_14
...
def main() -> int:
    return common.run_batch(
        ...
        scope="World History learner-v2 Topics 13-14",
        previous=previous,
        previous_keys=["world-history-11", "world-history-12"],
    )
