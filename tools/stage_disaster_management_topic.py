"""Stage one Disaster Management learner-v2 topic without publishing tracker state."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--tests-scope",
        default="Disaster Management topic generator and shared refresh/manual-flow suites",
    )
