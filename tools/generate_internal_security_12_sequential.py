"""Build Internal Security learner-v2 Topic 12 in authoring-only mode."""

from pathlib import Path

import generate_internal_security_11_sequential as previous
import generate_internal_security_common as common
from internal_security_12_data import TOPIC_12
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "internal-security-12-2026-09-04-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Internal Security learner-v2 Topic 12",
        previous=previous,
        previous_keys=["internal-security-11"],
    )
