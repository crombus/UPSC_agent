"""Build International Relations learner-v2 Topic 05 in authoring-only mode."""
...
import generate_international_relations_04_sequential as previous_batch
from international_relations_05_data import TOPIC_05
...
TOPICS = [TOPIC_05]
PREVIOUS_KEYS = ["international-relations-04"]
...
def main() -> int:
    return common.run_batch(
        ...
        scope="International Relations learner-v2 Topic 05",
