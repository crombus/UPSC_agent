"""Shared assertions for Indian Art and Culture sequential generator tests."""
...
def assert_batch_contract(
    ...
    case.assertIn(
        "Nitin Singhania's Indian Art and Culture.pdf",
    ...
    case.assertEqual("Indian-Art-and-Culture", manifest["subject"]["key"])
    case.assertEqual(
    ...
    for config in generator.TOPICS:
        ...
        generation = common.EXPORT_DIR / f"{key}-new-topic-2026-09-01.json"
        ...
        case.assertIn(
            "books\\Nitin Singhania's Indian Art and Culture.pdf",
