"""Build International Relations learner-v2 Topic 09 in authoring-only mode."""
...
import generate_international_relations_08_sequential as previous_batch
from international_relations_09_data import TOPIC_09
...
TOPICS = [TOPIC_09]
PREVIOUS_KEYS = ["international-relations-08"]
...
def main() -> int:
    return common.run_batch(
        ...
        scope="International Relations learner-v2 Topic 09",
