"""Build World History learner-v2 Topics 16-17 in authoring-only mode."""
...
from world_history_16_18_data import TOPIC_16, TOPIC_17
...
def main() -> int:
    return common.run_batch(
        ...
        scope="World History learner-v2 Topics 16-17",
        previous=previous,
        previous_keys=["world-history-15"],
    )
