"""Build Geography learner-v2 Topic 34 in authoring-only mode."""
...
from geography_31_33_37_data import TOPIC_34
...
def main() -> int:
    ...
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topic 34 sequential build",
    )
