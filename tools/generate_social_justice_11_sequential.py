"""Build Social Justice learner-v2 Topic 11 in authoring-only mode."""

from __future__ import annotations

from pathlib import Path

import generate_social_justice_10_sequential as previous
import generate_social_justice_common as common
from social_justice_11_12_data import TOPIC_11
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Social Justice learner-v2 Topic 11",
        previous=previous,
        previous_keys=["social-justice-10"],
    )
