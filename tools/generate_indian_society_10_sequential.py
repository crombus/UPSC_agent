"""Build Indian Society learner-v2 Topic 10 in authoring-only mode."""
...
from indian_society_06_10_data import TOPIC_10
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Society learner-v2 Topic 10",
        previous=previous,
        previous_keys=["indian-society-09"],
    )
