"""Build Indian Art and Culture learner-v2 Topic 05 in authoring-only mode."""
...
from indian_art_culture_01_05_data import TOPIC_05
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Art and Culture learner-v2 Topic 05",
        previous=previous,
        previous_keys=[
            "indian-art-and-culture-03",
            "indian-art-and-culture-04",
        ],
    )
