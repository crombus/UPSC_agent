"""Regression tests for Modern History learner-v2 Topics 14-15."""
...
import generate_modern_history_14_15_sequential as generator
import notions_style_ascii_master as ascii_master


class ModernHistory1415GeneratorTests(unittest.TestCase):
    ...
    def test_import_does_not_mutate_previous_generator_scope(self) -> None:
        import generate_modern_history_09_13_sequential as previous
