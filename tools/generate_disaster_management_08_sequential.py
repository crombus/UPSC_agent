"""Build Disaster Management learner-v2 Topic 08 in authoring-only mode."""

from pathlib import Path

import generate_disaster_management_07_sequential as previous
import generate_disaster_management_common as common
from disaster_management_08_data import TOPIC_08
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / f"disaster-management-08-{DATE}-sequential.json"
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Disaster Management learner-v2 Topic 08",
        previous=previous,
        previous_keys=["disaster-management-07"],
    )
