"""Build Economy learner-v2 Topic 29 in authoring-only mode."""

from pathlib import Path

import generate_economy_28_sequential as previous
import generate_economy_common as common
from economy_28_31_data import TOPIC_29
...
TOPICS = [TOPIC_29]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-29-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 29", previous=previous, previous_keys=["economy-28"])
