"""Tests for the strictly sequential Internal Security semantic driver."""
...
import run_internal_security_semantic_topic as subject


class InternalSecuritySemanticTopicRunnerTests(unittest.TestCase):
    ...
    def test_driver_uses_complete_authoritative_catalogue(self) -> None:
        ...
        self.assertEqual(
            [f"internal-security-{number:02d}" for number in range(1, 13)],
    ...
    def test_live_audit_covers_every_topic(self) -> None:
        ...
        self.assertEqual(12, len(payload["topics"]))
    ...
    def test_topic_configs_and_pyq_notes_are_complete(self) -> None:
        self.assertEqual(set(range(1, 13)), set(subject.CONFIGS))
        self.assertEqual(set(range(1, 13)), set(subject.runner.PYQ_STATUS))
