"""Build Environment and Ecology learner-v2 Topic 25 in authoring-only mode."""

from pathlib import Path

import generate_environment_and_ecology_24_sequential as previous_batch
import generate_environment_and_ecology_common as common
from environment_and_ecology_25_28_data import TOPIC_25
...
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "environment-and-ecology-25-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Environment and Ecology learner-v2 Topic 25", previous=previous_batch, previous_keys=["environment-and-ecology-24"])
