"""Build World History learner-v2 Topics 11-12 in authoring-only mode."""
...
from world_history_11_15_data import TOPIC_11, TOPIC_12
...
def main() -> int:
    return common.run_batch(
        ...
        scope="World History learner-v2 Topics 11-12",
        previous=previous,
        previous_keys=["world-history-10"],
    )
