"""Build Geography learner-v2 Topic 25 in authoring-only mode."""
...
from geography_23_25_data import TOPIC_25
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topic 25",
        previous=previous,
        previous_keys=["geography-24"],
    )
