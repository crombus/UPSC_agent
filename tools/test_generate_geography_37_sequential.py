"""Regression tests for Geography learner-v2 Topic 37."""
...
import generate_geography_37_sequential as generator
import validate_v2_export as validator
from geography_generator_test_support import assert_batch_contract, session_markdown


class Geography37GeneratorTests(unittest.TestCase):
    ...
    def test_cultural_and_density_boundaries(self) -> None:
        text = session_markdown(generator, "geography-37")
        for phrase in (
    ...
    def test_source_passes_deep_semantic_audit(self) -> None:
        audit = validator.deep_content_quality_audit_text(
            session_markdown(generator, "geography-37"),
