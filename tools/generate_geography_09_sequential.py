"""Build Geography learner-v2 Topic 09 in authoring-only mode."""
...
from geography_05_09_data import TOPIC_09
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topic 09",
        previous=previous,
        previous_keys=["geography-07", "geography-08"],
    )
