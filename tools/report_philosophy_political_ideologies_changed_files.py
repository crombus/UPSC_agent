"""Write the exhaustive changed-files manifest for the Political Ideologies run.
...
``philosophy-paper-ii-socio-political-philosophy-05:learner-v2:g2``, grouped by
...
def main() -> int:
    ...
    lines = [
        ...
        "- **Official syllabus (verbatim):** Political Ideologies: Anarchism; "
