"""Remove partial topic 6 learner-v2 targets before a clean re-run.

The reset is strictly scoped to Philosophy Paper II Socio-Political Philosophy
topic 06, ``Humanism; Secularism; Multi-culturalism.``  Topics 01-05, topics
07-10, every legacy-v1 package and all unrelated trees are never touched.
"""
