"""Build Geography learner-v2 Topic 19 in authoring-only mode."""
...
from geography_15_19_data import TOPIC_19
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topic 19",
        previous=previous,
        previous_keys=["geography-17", "geography-18"],
    )
