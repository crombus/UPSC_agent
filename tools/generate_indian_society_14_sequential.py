"""Build Indian Society learner-v2 Topic 14 in authoring-only mode."""
...
from indian_society_11_15_data import TOPIC_14
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Society learner-v2 Topic 14",
        previous=previous,
        previous_keys=["indian-society-13"],
    )
