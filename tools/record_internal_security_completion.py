"""Prove and record one finalised Internal Security learner-v2 topic."""
...
import generate_internal_security_common as security  # noqa: E402
...
SHARED_FILES = [
    ...
    "upsc-ai-kit\\manifests\\v2\\internal-security--subject-wide-syllabus.json",
    "notes\\Internal-Security\\learning-session-v2\\subject-wide-syllabus\\indexes\\TOPIC-COVERAGE-INDEX.md",
    "notes\\Internal-Security\\learning-session-v2\\subject-wide-syllabus\\indexes\\NOTES-PDF-INDEX.md",
    "notes\\Internal-Security\\learning-session-v2\\subject-wide-syllabus\\indexes\\WORKBOOK-PDF-INDEX.md",
]
...
def prove(topic_key: str, record: dict[str, object]) -> dict[str, object]:
    ...
    graphical = json.loads(
        (
            security.GRAPHICAL_DIR / f"{topic_key}.json"
...
def changed_files(record: dict[str, object], also_changed: list[str] | None = None) -> list[str]:
    ...
    paths.update(
        ...
        for value in [
            ...
            f"upsc-ai-kit\\manifests\\retrofits\\carvaka-graphical-specs\\Internal-Security\\{topic_key}.json",
