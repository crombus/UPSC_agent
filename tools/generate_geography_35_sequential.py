"""Build Geography learner-v2 Topic 35 in authoring-only mode."""
...
from geography_31_33_37_data import TOPIC_35
...
def main() -> int:
    ...
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topic 35 sequential build",
    )
