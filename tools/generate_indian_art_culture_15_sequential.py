"""Build Indian Art and Culture learner-v2 Topic 15 in authoring-only mode."""
...
from indian_art_culture_11_15_data import TOPIC_15
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Art and Culture learner-v2 Topic 15",
        previous=previous,
        previous_keys=[
            "indian-art-and-culture-13",
            "indian-art-and-culture-14",
        ],
    )
