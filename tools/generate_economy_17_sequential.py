"""Build Economy learner-v2 Topic 17 in authoring-only mode."""

from pathlib import Path

import generate_economy_16_sequential as previous
import generate_economy_common as common
from economy_16_19_data import TOPIC_17
...
TOPICS = [TOPIC_17]
ASCII_PATH = common.ROOT / "upsc-ai-kit" / "manifests" / "retrofits" / "ascii-panel-specs" / "economy-17-2026-09-03-sequential.json"
...
def main() -> int:
    return common.run_batch(topics=TOPICS, ascii_path=ASCII_PATH, scope="Economy learner-v2 Topic 17", previous=previous, previous_keys=["economy-16"])
