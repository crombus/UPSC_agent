"""Build Geography learner-v2 Topics 15-16 in authoring-only mode."""
...
from geography_15_19_data import TOPIC_15, TOPIC_16
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topics 15-16",
        previous=previous,
        previous_keys=["geography-14"],
    )
