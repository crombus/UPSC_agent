"""Build Governance learner-v2 Topic 04 in authoring-only mode."""
...
from governance_03_04_data import TOPIC_04
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Governance learner-v2 Topic 04",
        previous=previous,
        previous_keys=["governance-03"],
    )
