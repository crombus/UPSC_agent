"""Build Environment and Ecology learner-v2 Topic 06 in authoring-only mode."""

from __future__ import annotations

from pathlib import Path

import generate_environment_and_ecology_05_sequential as previous_batch
import generate_environment_and_ecology_common as common
from environment_and_ecology_06_data import TOPIC_06
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Environment and Ecology learner-v2 Topic 06",
        previous=previous_batch,
        previous_keys=["environment-and-ecology-05"],
    )
