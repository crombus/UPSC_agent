"""Build Indian Society learner-v2 Topic 11 in authoring-only mode."""
...
from indian_society_11_15_data import TOPIC_11
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Indian Society learner-v2 Topic 11",
        previous=previous,
        previous_keys=["indian-society-10"],
    )
