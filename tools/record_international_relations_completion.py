"""Prove and record completion manifests for one International Relations topic.
...
import generate_international_relations_common as international_relations  # noqa: E402
...
SHARED_FILES = [
    ...
    "upsc-ai-kit\\manifests\\v2\\international-relations--subject-wide-syllabus.json",
    "upsc-ai-kit\\knowledge\\International-Relations\\LEARNING-SESSION-COMMAND-INDEX.md",
    f"notes\\International-Relations\\learning-session-v2\\{SECTION_KEY}\\indexes\\TOPIC-COVERAGE-INDEX.md",
    f"notes\\International-Relations\\learning-session-v2\\{SECTION_KEY}\\indexes\\NOTES-PDF-INDEX.md",
    f"notes\\International-Relations\\learning-session-v2\\{SECTION_KEY}\\indexes\\WORKBOOK-PDF-INDEX.md",
]
...
def prove(topic_key: str, record: dict[str, object]) -> dict[str, object]:
    ...
    register_headings = list(international_relations.REGISTER_HEADINGS)
