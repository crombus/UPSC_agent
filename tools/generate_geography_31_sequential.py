"""Build Geography learner-v2 Topic 31 in authoring-only mode."""
...
from geography_31_33_37_data import TOPIC_31
...
def _configure_common() -> None:
    ...
    common.SUPERSEDES_TEMPLATE = "{key}:legacy-v1:g1"
...
def main() -> int:
    ...
    return common.run_batch(
        ...
        scope="Geography learner-v2 Topic 31 sequential build",
    )
