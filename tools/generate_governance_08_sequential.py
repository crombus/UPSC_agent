"""Build Governance learner-v2 Topic 08 in authoring-only mode."""
...
from governance_07_08_data import TOPIC_08
...
def main() -> int:
    return common.run_batch(
        ...
        scope="Governance learner-v2 Topic 08",
        previous=previous,
        previous_keys=["governance-07"],
    )
