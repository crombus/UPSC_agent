---
topic_key: ethics-16
title: Codes of Ethics and Codes of Conduct — Complete Topic Package
generation_identity: ethics-16:learner-v2:g1
...
- ✅ Fact: The official CCS framework includes Rule 3 general conduct and separate rules concerning political activity, media or public criticism, official information, gifts, private trade or employment and property.
- ✅ Fact: The live Rajya Sabha Committee on Ethics rules state that the Committee oversees members' moral and ethical conduct and prepares a Code of Conduct and proposed amendments.
- ✅ Fact: Those rules provide for a Register of Members' Interests and permit written complaints by any person concerning alleged unethical behaviour, breach of the Code or incorrect interest information.
- ✅ Fact: Where breach is found, the Committee may recommend censure, reprimand, suspension for a specified period or another appropriate sanction; the report then proceeds through Council consideration.
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Ethics\basic\16_Codes-of-Ethics-and-Codes-of-Conduct.md`  
**Canonical topic owner:** `upsc-ai-kit\knowledge\Ethics\basic\16_Codes-of-Ethics-and-Codes-of-Conduct.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Ethics\advanced\16_Codes-of-Ethics-and-Codes-of-Conduct.md`  
...
> **Scope:** aspirational Codes of Ethics, enforceable Codes of Conduct, values-to-rules
> translation, civil servants, Ministers, legislators, conflicts, implementation and fair
> enforcement. Full case-study method remains Topic 22-owned.
> **Core sources:** Second ARC, Fourth Report, *Ethics in Governance* (2007), Chapter 2;
> Central Civil Services (Conduct) Rules, 1964 (official DoPT updated page); official Rajya
> Sabha Committee on Ethics rules; official GS-IV papers for 2018, 2019, 2022, 2023, 2024
> and 2025.
...
```text
ENTRUSTED PUBLIC OFFICE
        |
        +--> authority, discretion, money, information, coercive power
        |
        v
STRICTER ROLE OBLIGATIONS THAN ORDINARY PRIVATE LIFE
        |
        +--------------------------+
        |                          |
        v                          v
CODE OF ETHICS               CODE OF CONDUCT
values and principles        specific acts and procedures
aspiration and judgment      compliance and discipline
        |                          |
        +------------+-------------+
                     v
      ETHICAL COMPETENCE + FAIR ACCOUNTABILITY
```

✅ The Second ARC explains that the public-action/private-interest interface creates a need
for both a Code of Ethics and a Code of Conduct. Public servants exercise powers and use
resources held for public purposes; conduct acceptable in ordinary private life may therefore
require disclosure, restriction or abstention in office.

⚠️ **Exam thesis:** an ethics system needs both a **compass** and **guardrails**. Values without
operational rules may become rhetoric; rules without values encourage literal, evasive or
...
|---|---|---|
| ✅ Core form | Broad guiding values and principles | Specific expected or prohibited behaviour |
...
✅ ARC paragraph 2.2.6 describes a Code of Ethics as covering broad guiding principles of good
behaviour and governance. A more specific Code of Conduct should state acceptable and
unacceptable behaviour and action precisely and unambiguously.

##### The most important qualification
⚠️ An aspirational Code of Ethics is **not legally self-executing**. A declaration that officers
should show integrity or empathy does not, by itself, define an offence, create dismissal power
or displace disciplinary procedure.
...
⚠️ Conversely, do not write that ethical values can **never** be enforceable. When a competent
rule validly incorporates integrity, neutrality or conflict duties, breach may become
disciplinary misconduct. The accurate distinction is between **aspirational language by itself**
and a **standard validly incorporated into an enforceable regime**.

> **UPSC trap:** “Code of Ethics has no sanction; Code of Conduct has sanction” is a useful first
> contrast but an unsafe absolute. Add the incorporation-and-due-process qualification.
...
```text
CONSTITUTIONAL / PUBLIC-SERVICE VALUE
                |
                v
     ROLE-SPECIFIC MEANING
       ...
       FORESEEABLE RISK
                |
                v
SPECIFIC RULE + EXCEPTION + PROCEDURE
                |
                v
 RECORD + ADVICE + MONITORING + REMEDY
                |
                v
       PERIODIC LEARNING
```
...
##### Translation matrix
| Value | Risk | Conduct expression | Operational mechanism |
|---|---|---|---|
| Integrity | benefit or obligation distorts duty | refuse/report gifts; disclose interests | gift register, approval, audit |
| Impartiality | relative or associate gains favour | declare and manage conflict | recusal, reassignment, reasons |
| Political neutrality | office becomes party instrument | restrict partisan activity and official-resource misuse | role separation, written directions |
| Openness | opaque discretion hides capture | record criteria and reasons | disclosure, appeal, audit trail |
| Accountability | no one owns failure | assign decision and supervisory responsibility | inquiry, corrective order, reporting |
| Service | formal process excludes vulnerable citizens | require courtesy, responsiveness and lawful assistance | accessible channel, grievance remedy |
| Stewardship | public resources used for private convenience | economy and public purpose | procurement control, utilisation audit |

⚠️ Translation must preserve the **purpose** of the value. A disclosure form that is never
reviewed does not institutionalise integrity. A public register that reveals unnecessary family
data may violate privacy without improving conflict control.
...
##### What exists
✅ **Civil servants:** the Central Civil Services (Conduct) Rules, 1964 and the All India
Services (Conduct) Rules, 1968 provide enforceable service-conduct frameworks for their
respective populations. Breaches are handled through the applicable disciplinary architecture.

✅ **Ministers:** India has a ministerial Code of Conduct. The Second ARC examined it and
recommended an additional ethical framework, monitoring and public reporting.

✅ **Legislators:** the Houses have ethics and conduct arrangements. The official Rajya Sabha
rules empower its Committee on Ethics to oversee moral and ethical conduct, prepare and revise
a Code, deal with interests and complaints, and recommend sanctions.

##### What must not be falsely claimed
⚠️ India does **not** lack all conduct control. The precise gap is that the Second ARC-recommended
comprehensive, coherent civil-service **Code of Ethics/public-service-values framework** has not
been implemented as a distinct national layer above the existing conduct rules.

✅ The official 2024 GS-IV Q5(a) itself states that a Code of Conduct is already in operation
whereas a Code of Ethics is not yet put in place.

> **Factual correction:** the direct “not yet put in place” question is **2024 GS-IV Q5(a)**.
> In the local official **2025** paper, Q5(a) concerns devotion to duty; the direct organisational
> code question is **2025 GS-IV Q6(a)**.
...
|---|---|
| ✅ Rule 3 | general conduct: integrity, devotion to duty, becoming conduct, high ethical standards, political neutrality, fairness, accountability, transparency and public interest |
...
⚠️ Exact thresholds, forms, classes of employees and amendment positions must be checked in the
current consolidated rule or notification. Do not invent a rupee amount from memory.

##### Rule 3 as the bridge between ethics and conduct
✅ Rule 3 contains general obligations such as absolute integrity and devotion to duty. Its
expanded standards include high ethical standards, political neutrality, merit, fairness,
impartiality, accountability, transparency, responsiveness, courtesy, public-interest decision,
efficient use of resources, conflict declaration and professionalism.

⚠️ This does not eliminate the conceptual need for a Code of Ethics. Rule 3 makes several values
enforceable as conduct duties; a full ethics code would explain the aspirational vision,
decision principles, examples and learning culture beyond a disciplinary rulebook.

##### Oral directions
✅ The Rule 3 supervisory framework expects official directions to be in writing where practicable
and requires a subordinate receiving an oral direction to seek written confirmation.
...
⚠️ The safeguard does not mean every oral operational instruction is invalid. Urgency may require
oral coordination; material directions should be regularised and recorded.
...
```text
BEFORE POLICY DECISION                AFTER LAWFUL DECISION
accurate facts                        competent implementation
candid options                        equal citizen treatment
warning about illegality              truthful communication
non-partisan advice                   no party favour
              \                      /
               \                    /
                PROFESSIONAL NEUTRALITY
```

⚠️ Neutrality is not moral emptiness. A civil servant remains bound by the Constitution, law,
evidence and public interest. Nor is it disloyalty to give unwelcome professional advice.

##### Public statements
✅ Conduct rules concerning media connection and criticism of Government protect discipline,
confidential information and the perceived neutrality of service.

⚠️ Apply them with lawful speech rights, authorised communication, academic roles, whistleblowing
channels and proportionality. An authorised spokesperson giving verified information is not
equivalent to a serving officer using departmental data for partisan attack.

##### Official information
✅ Unauthorised sharing of official information can breach conduct obligations and harm privacy,
security, procurement or deliberation.

⚠️ Confidentiality is not a licence to conceal illegality. The ethical route is lawful disclosure:
RTI processes, competent audit, vigilance, court, legislative or protected-reporting channels as
applicable. Whistleblowing also does not authorise indiscriminate publication of an entire file.
...
⚠️ Conflict of interest is a **risk condition**. It can exist without bribery, actual bias or a
completed corrupt decision.
...
⚠️ Disclosure is not always a cure. A procurement chair cannot merely announce that her spouse
controls a bidder and continue to cast the deciding vote.

⚠️ Recusal is also not automatic for every remote interest. A disclosed, widely diversified,
immaterial holding may be managed differently after independent assessment. Proportionality avoids
both capture and administrative paralysis.
...
⚠️ Do not quote a gift threshold unless verified against the current rule applicable to that
person. Ministerial, CCS, AIS, foreign-gift and institutional repository rules are not one
universal regime.

##### UPSC trap
❌ “Below the threshold means ethical.”
✅ A threshold may determine reporting or permission; it cannot legitimise a deliberately split
benefit or a benefit that creates an unmanaged conflict.

---

#### 9. Assets, outside employment and post-employment
##### Asset and property declarations
✅ Conduct frameworks use property returns and transaction reporting as preventive and
investigative inputs.

⚠️ Regimes differ in population, timing, content, authority, confidentiality and public access.
Do not merge:
...
⚠️ An asset anomaly is not conclusive proof of illicit enrichment. The proper route is comparison,
valuation, explanation, evidence, reasoned finding and applicable proceeding.
...
Possible controls include prior permission, disclosure, restriction, recusal, cooling-off and
case-specific prohibition. ⚠️ A blanket lifetime ban would often be disproportionate; restriction
should match the role, information and foreseeable risk.
...
#### 10. Ministers
##### Ethical content
✅ The ARC's ministerial framework includes:
...
⚠️ Ministerial consequence is often political. Resignation or removal may follow loss of
confidence even without criminal conviction. This must not be confused with civil-service
discipline or court punishment.

---

#### 11. Legislators
##### Rajya Sabha official structure
📰 The official Committee on Ethics rules, live-verified on 29 August 2026, state that the
Committee:
...
- may recommend censure, reprimand, suspension for a specified period or another appropriate
  sanction.

⚠️ The Committee **recommends** and reports; the House/Council process that follows must not be
collapsed into the Committee's inquiry.
...
⚠️ Advice and investigation may require separation. An adviser who encouraged candid consultation
should not automatically become witness, prosecutor and adjudicator without clear safeguards.
...
⚠️ Memorising gift limits is not ethical competence. An officer must recognise disguised
hospitality, benefits routed through relatives and situations in which disclosure alone is
insufficient.
...
⚠️ Fewer complaints do not necessarily mean better ethics. Reporting may have become dangerous or
inaccessible. Raw sanction numbers can also reward over-punishment.
...
Revisions should operate prospectively, with consultation and transition guidance. Retroactive
discipline under a newly clarified rule violates fairness.
...
⚠️ Due process is not softness. It makes consequences legitimate and resilient. Equally, a good
reputation or senior office cannot erase supported misconduct.
...
⚠️ General clauses must not become vague punishment devices. Anti-circumvention findings still
require a clear rule, evidence, reasons and fair hearing.
...
##### 📰 DoPT
✅ The Department of Personnel and Training currently hosts an official page titled **Central
Civil Services (Conduct) Rules, 1964 (Updated)**:

`https://dopt.gov.in/acts/central-civil-services-conduct-rules-1964-updated-0`

Use: proves a live official conduct-rule framework.
Limit: the hosted consolidated material and individual amendments must be checked before quoting
mutable thresholds or claiming a final amendment cut-off.

##### 📰 Rajya Sabha
✅ Official Committee on Ethics rules:

`https://cms.rajyasabha.nic.in/UploadedFiles/CommitteeSection/CommitteeRules/1626363812501.54_CommitteOnEthics.pdf`

Use: proves a live institutional architecture of code preparation, interests, complaint,
committee inquiry and recommended sanction.
Limit: it does not prove implementation of the ARC's proposed comprehensive civil-service Code of
Ethics or an independent Ethics Commissioner for every institution.
...
|---:|---|---|
| ✅ 2018 | Q1(b) | distinguish Code of Ethics and Code of Conduct with examples |
| ✅ 2018 | Q2(a) | public-interest principles and procedures |
| ✅ 2018 | Q3(a) | actual and potential conflicts of interest |
| ✅ 2018 | Q4(b) | limits of “not expressly prohibited” reasoning |
| ✅ 2019 | concluding Section B question | threats, ethical competence and integrity-promoting processes |
| ✅ 2022 | Q2(a) | purposive versus negative interpretation of common rules |
| ✅ 2023 | Q5(a) | conscience compared with laws, rules and regulations |
| ✅ 2024 | Q5(a) | direct model Code of Ethics; conduct exists, ethics code not put in place |
| ✅ 2025 | Q5(a) | devotion to duty, responsibility and fulfilment — internalisation route |
| ✅ 2025 | Q6(a) | value-based and compliance-based workplace culture |
...
> **Answer-grabbing line:** A mature ethics regime does not choose between values and compliance;
> it makes values usable before misconduct and compliance legitimate after it.

---

#### 20. Consolidated rapid-revision notes
- ✅ Ethics code = broad values, aspiration and judgment.
- ✅ Conduct code = specific role behaviour, procedure and enforceable consequence where validly issued.
- ⚠️ Aspirational ethics language is not legally self-executing.
- ✅ India has civil-service conduct rules, a Ministers' Code of Conduct and legislative ethics arrangements.
- ⚠️ The comprehensive ARC-recommended civil-service Code of Ethics remains unimplemented as a distinct national framework.
- ✅ Direct code-gap PYQ = **2024 Q5(a)**.
- ✅ 2025 Q5(a) = devotion to duty; 2025 Q6(a) = organisational Code of Ethics and work culture.
- ✅ CCS anchors: Rule 3, Rule 5, Rules 8-9, Rule 11, Rule 13, Rule 15, Rule 18.
- ⚠️ Verify current thresholds and forms; do not guess.
...
- **Must remember:** A code of ethics states aspirational values and reasoning commitments; a code of conduct translates duties into enforceable behavioural rules. Neither is self-executing without ownership, advice, disclosure, training, due process and sanctions.
- **Close distinction:** Conflict of interest, gifts, outside employment, post-retirement work, political neutrality, public statements, official information and ministerial standards need specific rules; apparent conflict can damage trust even without proven corruption.
- **Evidence / authority / application limit:** State whether a rule is statutory, service-rule based, executive or proposed; preserve presumption, notice, hearing, reasoned decision, proportional sanction, appeal and protection against selective enforcement.
...
MUST REMEMBER: A code of ethics states aspirational values and reasoning commitments; a...
```
...
CLOSE DISTINCTION: Conflict of interest, gifts, outside employment, post-retirement work,...
```
...
EVIDENCE / AUTHORITY / APPLICATION LIMIT: State whether a rule is statutory, service-rule...
```
