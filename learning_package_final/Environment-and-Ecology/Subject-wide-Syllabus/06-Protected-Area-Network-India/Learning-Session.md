...
- https://moef.gov.in/wildlife-wl — attempted 2026-09-06; substantive MoEFCC text confirmed the four protected-area categories and the separate support for wildlife outside protected areas. Its displayed count was not promoted as a latest figure because the page gives no reliable update date.
- http://www.wiienvis.nic.in/Database/Protected_Area_854.aspx — attempted 2026-09-06; the host could not be resolved, so no protected-area count, area or notification date was imported.
- https://moef.gov.in/esz-notifications — attempted 2026-09-06; the page returned substantive notification and map links, confirming that ESZ boundaries are notification-specific. No individual site's legal boundary was inferred.
- https://moef.gov.in/uploads/2017/06/1%20Guidelines%20for%20Eco-Sensitive%20Zones%20around%20Protected%20Areas.pdf — attempted 2026-09-06; the official PDF was retrievable only as raw PDF bytes, so no width, village list or activity classification was extracted.
- https://www.indiacode.nic.in/indiacode/handle/123456789/12931?view_type=browse — attempted 2026-09-06; India Code returned HTTP 403, so exact statutory text remains bounded to repository owners.
...
**Plain-language definition:** Four legal categories and National Park explains how Four protected-area categories and National Park fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Four legal categories and National Park separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Four legal categories and National Park must be read through Four protected-area categories and National Park, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Four, legal, categories; attach National to its source, ecological scale and status; then qualify the answer with this limit: Do not treat every protected area as a National Park.
...
```closure-flow
START / CONCEPT: Four legal categories and National Park
EXACT TERMS: Four | legal | categories | National | Park | protected-area
MECHANISM / ARGUMENT: connect Four protected-area categories and National Park through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Open with all four categories and the National Park regime.
UPSC TRAP / ANSWER-USE: Do not treat every protected area as a National Park.
ANSWER-GRABBING FORMULATION: Four legal categories and National Park converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Wildlife Sanctuary explains how Wildlife Sanctuary fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Wildlife Sanctuary separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Wildlife Sanctuary must be read through Wildlife Sanctuary, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Wildlife, Sanctuary, protects; attach habitat to its source, ecological scale and status; then qualify the answer with this limit: Do not assign National Park restrictions automatically to every Sanctuary.
...
```closure-flow
START / CONCEPT: Wildlife Sanctuary
EXACT TERMS: Wildlife | Sanctuary | protects | habitat | permitting | generally
MECHANISM / ARGUMENT: connect Wildlife Sanctuary through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Contrast Sanctuary rights and regulated activity with a National Park.
UPSC TRAP / ANSWER-USE: Do not assign National Park restrictions automatically to every Sanctuary.
ANSWER-GRABBING FORMULATION: Wildlife Sanctuary converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Conservation Reserve explains how Conservation Reserve fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Conservation Reserve separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Conservation Reserve must be read through Conservation Reserve, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Conservation, Reserve, statutory; attach connector to its source, ecological scale and status; then qualify the answer with this limit: Do not describe a Conservation Reserve as community-owned land by definition.
...
```closure-flow
START / CONCEPT: Conservation Reserve
EXACT TERMS: Conservation | Reserve | statutory | connector | buffer | category
MECHANISM / ARGUMENT: connect Conservation Reserve through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Use the connector or buffer function and government-land basis carefully.
UPSC TRAP / ANSWER-USE: Do not describe a Conservation Reserve as community-owned land by definition.
ANSWER-GRABBING FORMULATION: Conservation Reserve converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Community Reserve explains how Community Reserve fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Community Reserve separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Community Reserve must be read through Community Reserve, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Community, Reserve, consent-based; attach category to its source, ecological scale and status; then qualify the answer with this limit: Do not describe a Community Reserve without the consent and management role.
...
```closure-flow
START / CONCEPT: Community Reserve
EXACT TERMS: Community | Reserve | consent-based | category | private | land
MECHANISM / ARGUMENT: connect Community Reserve through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Use consent, tenure and local management as the distinguishing axis.
UPSC TRAP / ANSWER-USE: Do not describe a Community Reserve without the consent and management role.
ANSWER-GRABBING FORMULATION: Community Reserve converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Rights and activity gradient explains how Rights and activity gradient fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Rights and activity gradient separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Rights and activity gradient must be read through Rights and activity gradient, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Rights, activity, gradient; attach Permitted to its source, ecological scale and status; then qualify the answer with this limit: Do not infer permitted activity without the Act and site notification.
...
```closure-flow
START / CONCEPT: Rights and activity gradient
EXACT TERMS: Rights | activity | gradient | Permitted | activities | vary
MECHANISM / ARGUMENT: connect Rights and activity gradient through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Fix the category and notification before asserting an activity or right.
UPSC TRAP / ANSWER-USE: Do not infer permitted activity without the Act and site notification.
ANSWER-GRABBING FORMULATION: Rights and activity gradient converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** 2002 expansion and Tiger Reserve overlay explains how 2002 category expansion and Tiger Reserve overlay fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, 2002 expansion and Tiger Reserve overlay separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> 2002 expansion and Tiger Reserve overlay must be read through 2002 category expansion and Tiger Reserve overlay, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define expansion, Tiger, Reserve; attach overlay to its source, ecological scale and status; then qualify the answer with this limit: Do not date all four categories to the original 1972 enactment.
...
```closure-flow
START / CONCEPT: 2002 expansion and Tiger Reserve overlay
EXACT TERMS: expansion | Tiger | Reserve | overlay | category | attributes
MECHANISM / ARGUMENT: connect 2002 category expansion and Tiger Reserve overlay through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Explain the 2002 expansion and present Tiger Reserve as an overlay.
UPSC TRAP / ANSWER-USE: Do not date all four categories to the original 1972 enactment.
ANSWER-GRABBING FORMULATION: 2002 expansion and Tiger Reserve overlay converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Critical tiger habitat and buffer explains how Critical tiger habitat and buffer fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Critical tiger habitat and buffer separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Critical tiger habitat and buffer must be read through Critical tiger habitat and buffer, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Critical, tiger, habitat; attach buffer to its source, ecological scale and status; then qualify the answer with this limit: Do not call a Tiger Reserve a fifth generic protected-area land category.
...
```closure-flow
START / CONCEPT: Critical tiger habitat and buffer
EXACT TERMS: Critical | tiger | habitat | buffer | tiger-reserve | model
MECHANISM / ARGUMENT: connect Critical tiger habitat and buffer through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Keep core and buffer boundaries tied to the particular reserve.
UPSC TRAP / ANSWER-USE: Do not call a Tiger Reserve a fifth generic protected-area land category.
ANSWER-GRABBING FORMULATION: Critical tiger habitat and buffer converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Relocation and Forest Rights Act coordination explains how Relocation and rights fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Relocation and Forest Rights Act coordination separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Relocation and Forest Rights Act coordination must be read through Relocation and rights, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Relocation, Forest, Rights; attach coordination to its source, ecological scale and status; then qualify the answer with this limit: Do not treat core, buffer and ESZ as interchangeable boundaries.
...
```closure-flow
START / CONCEPT: Relocation and Forest Rights Act coordination
EXACT TERMS: Relocation | Forest | Rights | coordination | requires | voluntary
MECHANISM / ARGUMENT: connect Relocation and rights through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Pair habitat protection with consent, rehabilitation and tenure recognition.
UPSC TRAP / ANSWER-USE: Do not treat core, buffer and ESZ as interchangeable boundaries.
ANSWER-GRABBING FORMULATION: Relocation and Forest Rights Act coordination converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Elephant landscape model explains how Elephant landscape distinction fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Elephant landscape model separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Elephant landscape model must be read through Elephant landscape distinction, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Elephant, landscape, model; attach distinction to its source, ecological scale and status; then qualify the answer with this limit: Do not present relocation as automatic or rights-free.
...
```closure-flow
START / CONCEPT: Elephant landscape model
EXACT TERMS: Elephant | landscape | model | distinction | reserves | corridors
MECHANISM / ARGUMENT: connect Elephant landscape distinction through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Match reserve design to elephant ranging ecology and corridors.
UPSC TRAP / ANSWER-USE: Do not present relocation as automatic or rights-free.
ANSWER-GRABBING FORMULATION: Elephant landscape model converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Eco-Sensitive Zone statute explains how Eco-Sensitive Zone statute fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Eco-Sensitive Zone statute separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Eco-Sensitive Zone statute must be read through Eco-Sensitive Zone statute, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Eco-Sensitive, Zone, statute; attach separately to its source, ecological scale and status; then qualify the answer with this limit: Do not give Elephant Reserves the NTCA's statutory core-buffer structure.
...
```closure-flow
START / CONCEPT: Eco-Sensitive Zone statute
EXACT TERMS: Eco-Sensitive | Zone | statute | separately | notified | under
MECHANISM / ARGUMENT: connect Eco-Sensitive Zone statute through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Name the Environment Protection Act and separate ESZ from a PA category.
UPSC TRAP / ANSWER-USE: Do not give Elephant Reserves the NTCA's statutory core-buffer structure.
ANSWER-GRABBING FORMULATION: Eco-Sensitive Zone statute converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** ESZ extent and distinct spatial boundaries explains how ESZ extent and activities and Boundary and surrounding landscape fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, ESZ extent and distinct spatial boundaries separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> ESZ extent and distinct spatial boundaries must be read through ESZ extent and activities and Boundary and surrounding landscape, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define extent, distinct, spatial; attach boundaries to its source, ecological scale and status; then qualify the answer with this limit: Do not place ESZ notification under the Wildlife Protection Act.
...
```closure-flow
START / CONCEPT: ESZ extent and distinct spatial boundaries
EXACT TERMS: extent | distinct | spatial | boundaries | activities | Boundary
MECHANISM / ARGUMENT: connect ESZ extent and activities and Boundary and surrounding landscape through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Draw PA, ESZ and corridor as distinct, site-specific spatial layers.
UPSC TRAP / ANSWER-USE: Do not place ESZ notification under the Wildlife Protection Act.
ANSWER-GRABBING FORMULATION: ESZ extent and distinct spatial boundaries converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Landscape connectivity explains how Connectivity fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Landscape connectivity separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Landscape connectivity must be read through Connectivity, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Landscape, connectivity, Corridors; attach stepping-stone to its source, ecological scale and status; then qualify the answer with this limit: Do not apply a uniform ESZ width to every protected area.
...
```closure-flow
START / CONCEPT: Landscape connectivity
EXACT TERMS: Landscape | connectivity | Corridors | stepping-stone | habitats | compatible
MECHANISM / ARGUMENT: connect Connectivity through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Explain dispersal, stepping-stone habitat and outside-PA land use.
UPSC TRAP / ANSWER-USE: Do not apply a uniform ESZ width to every protected area.
ANSWER-GRABBING FORMULATION: Landscape connectivity converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Boundary safeguards explains how Boundary alteration safeguards fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Boundary safeguards separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Boundary safeguards must be read through Boundary alteration safeguards, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Boundary, safeguards, alteration; attach records to its source, ecological scale and status; then qualify the answer with this limit: Do not equate a legal boundary with the whole ecological landscape.
...
```closure-flow
START / CONCEPT: Boundary safeguards
EXACT TERMS: Boundary | safeguards | alteration | records | State | Legislature
MECHANISM / ARGUMENT: connect Boundary alteration safeguards through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Identify the applicable State Legislature, NBWL or NTCA safeguard.
UPSC TRAP / ANSWER-USE: Do not equate a legal boundary with the whole ecological landscape.
ANSWER-GRABBING FORMULATION: Boundary safeguards converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Authorities, jurisdiction and OECMs explains how Authorities and jurisdiction and OECM distinction fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Authorities, jurisdiction and OECMs separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Authorities, jurisdiction and OECMs must be read through Authorities and jurisdiction and OECM distinction, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Authorities, jurisdiction, OECMs; attach OECM to its source, ecological scale and status; then qualify the answer with this limit: Do not turn notification count into proof of connectivity or management quality.
...
```closure-flow
START / CONCEPT: Authorities, jurisdiction and OECMs
EXACT TERMS: Authorities | jurisdiction | OECMs | OECM | distinction | State
MECHANISM / ARGUMENT: connect Authorities and jurisdiction and OECM distinction through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Assign each institution and OECM to its correct jurisdiction.
UPSC TRAP / ANSWER-USE: Do not turn notification count into proof of connectivity or management quality.
ANSWER-GRABBING FORMULATION: Authorities, jurisdiction and OECMs converts a precise ecological distinction into a qualified conclusion
```
...
**Plain-language definition:** Live network and audited PYQ boundary explains how Live official network boundary and Audited PYQ and designation route fit into one examinable ecological mechanism.

**Technical definition:** In Environment and Ecology, Live network and audited PYQ boundary separates the ecosystem or landscape boundary from the ecological level, state variable, transfer process, trophic parameter, spatial scale, temporal stage, source status and legal or scientific designation attached to the claim.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Live network and audited PYQ boundary must be read through Live official network boundary and Audited PYQ and designation route, with the ecological level, system boundary and measured parameter fixed before the inference.
...
**How to use them:** Define Live, network, audited; attach boundary to its source, ecological scale and status; then qualify the answer with this limit: Do not infer a current protected-area count from an undated official page.
...
```closure-flow
START / CONCEPT: Live network and audited PYQ boundary
EXACT TERMS: Live | network | audited | boundary | official | designation
MECHANISM / ARGUMENT: connect Live official network boundary and Audited PYQ and designation route through ecological structure, transfer and feedback
CONSEQUENCE / CONTRAST: Close with dated evidence and no inferred network outcome or objective key.
UPSC TRAP / ANSWER-USE: Do not infer a current protected-area count from an undated official page.
ANSWER-GRABBING FORMULATION: Live network and audited PYQ boundary converts a precise ecological distinction into a qualified conclusion
```
...
MoEFCC's wildlife page was substantively retrieved on 2026-09-06 and used only to confirm the four categories and conservation outside PAs. Its undated count was not promoted as latest. WII ENVIS did not resolve, India Code returned HTTP 403, and ESZ material was used only to confirm notification-specific mapping, not a uniform width or individual boundary.
