...
| 2021 | *Union of India v. Rajendra N. Shah (2021)* | Federal ratification correction |
...
| 243ZS | Applies Part text to UTs with textual adaptations | Read with *Union of India v. Rajendra N. Shah (2021)* para 78 |
...
START / CONCEPT: MINISTRY OF COOPERATION, CENTRAL REGISTRAR AND CURRENT POLICY
        |
        v
EXACT TERMS: Ministry of Cooperation · Central Registrar · CRCS · Entry 32
        |
        v
MECHANISM / ARGUMENT: Executive policy cannot transfer Entry 32 competence; CRCS registration, election and ombudsman processes arise from the MSCS statute and must be described with dated official evidence.
        |
        v
CONSEQUENCE / CONTRAST: This division identifies the governing legal layer before drawing an institutional conclusion.
        |
...
UPSC TRAP / ANSWER-USE: Do not transfer a rule across State, multi-State, constitutional, banking or policy layers without checking competence and statutory scope.
        |
        v
ANSWER-GRABBING FORMULATION: The Ministry coordinates policy while the Central Registrar exercises statutory MSCS functions.
```
...
| *Thalappalam Service Cooperative Bank (2013)* | Kerala cooperatives not automatically RTI public authorities | Society-specific ownership/control/finance can change result |
...
[LIMIT] *Thalappalam Service Cooperative Bank (2013)* did not immunise all cooperatives from RTI forever. Ownership, pervasive control or substantial direct/indirect financing can alter the section 2(h) result; section 2(f) also preserves access to information that a public authority can lawfully obtain from a private body.
...
| Severability and UT reach | Official *Union of India v. Rajendra N. Shah (2021)* judgment, paras 77-80 | No blanket “all UT cooperatives” claim |
...
| Article 12/RTI | Official *Thalappalam Service Cooperative Bank (2013)* + settled cases | Unverified 2026 claim omitted |
...
- **Union of India v. Rajendra N. Shah (2021) control:** the Supreme Court's 2021 majority invalidated
...
- **Status tests:** Daman Singh addresses the statutory character of cooperative
  membership; Thalappalam Service Cooperative Bank (2013) holds that registration and ordinary regulatory
