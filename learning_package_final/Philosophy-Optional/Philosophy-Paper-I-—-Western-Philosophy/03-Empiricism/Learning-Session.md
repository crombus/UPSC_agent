...
cover_image: assets/Empiricism-Pressure-Sequence.png
variant: learner-v2
generation: 5
...
![Empiricist pressure-sequence map](assets/Empiricism-Pressure-Sequence.png)
...
- The criterion is NOT sameness of *soul-substance* (we might have the same soul without knowing it — that would not make us the same *person*) and NOT sameness of *body* (bodies change constantly). Personal identity extends as far as present consciousness can appropriate past experience; memory is its chief vehicle/evidence, not a separate substantial bearer. ✅
