---
title: "Persons with Disabilities — Learner-v2 Refreshed"
topic_key: social-justice-11
cover_image: assets/social-justice-11_Teaching-Navigation_2026-09-02.png
---
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Social-Justice\basic\11_Persons-with-Disabilities.md`  
**Substantive canonical provenance owner:** `upsc-ai-kit\knowledge\Social-Justice\11_Persons-with-Disabilities_Learner-V2-Complete-Topic-Package.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Social-Justice\advanced\11_Persons-with-Disabilities.md`  
...
![Refreshed teaching navigation](assets/social-justice-11_Teaching-Navigation_2026-09-02.png)
...
```closure-flow
START / CONCEPT: What the disability owner holds and how it is examined
EXACT TERMS: What | disability | holds | examined | this | demands
MECHANISM / ARGUMENT: relate What this owner holds and the exact demands routed to it through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that open a disability answer by naming the duty, recognition, accommodation or accessibility, that the question actually tests.
UPSC TRAP / ANSWER-USE: LIMIT: One Mains demand and one objective demand are routed here, and the objective key held locally is provisional.
ANSWER-GRABBING FORMULATION: What the disability owner holds and how it is examined converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: The statutory definition and its convention anchor
EXACT TERMS: statutory | convention | anchor | Rights | Persons | with
MECHANISM / ARGUMENT: relate The statutory definition and its convention anchor through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that anchor a disability answer in the statutory definition before any evaluation of delivery.
UPSC TRAP / ANSWER-USE: LIMIT: The disabling effect sits in the interaction between impairment and barriers, not in impairment alone.
ANSWER-GRABBING FORMULATION: The statutory definition and its convention anchor converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: Twenty-one categories and the expansion from seven
EXACT TERMS: Twenty-one | categories | expansion | from | seven | specified
MECHANISM / ARGUMENT: relate The twenty-one specified disabilities and the power to notify more and The move from seven categories to twenty-one through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that state an exact statutory count where close options are built on the number and the expandability.
UPSC TRAP / ANSWER-USE: LIMIT: The schedule is a statutory list that the government may extend, not a medical taxonomy.
ANSWER-GRABBING FORMULATION: Twenty-one categories and the expansion from seven converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: Benchmark disability and what it triggers
EXACT TERMS: Benchmark | disability | what | triggers | owners | define
MECHANISM / ARGUMENT: relate Benchmark disability and what it triggers through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that separate a definitional category from the threshold that creates an entitlement.
UPSC TRAP / ANSWER-USE: LIMIT: A person may be a person with disability under the Act without holding benchmark status.
ANSWER-GRABBING FORMULATION: Benchmark disability and what it triggers converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: Statutory reservation and its constitutional neighbour
EXACT TERMS: Statutory | reservation | constitutional | neighbour | Article | mandates
MECHANISM / ARGUMENT: relate Statutory reservation and why it is not Article 16(4) reservation through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that attribute an entitlement to its correct legal source before comparing it with another.
UPSC TRAP / ANSWER-USE: LIMIT: This reservation is created by ordinary legislation and is not governed by the ceiling jurisprudence of the constitutional mechanism.
ANSWER-GRABBING FORMULATION: Statutory reservation and its constitutional neighbour converts a dated official entitlement or indicator into a qualified capability argument
```
...
**How to use them:** Define Reasonable, accommodation, equality; cite duty as named evidence with its issuing body and dated edition or round; then apply this qualification: The duty carries a burden limb, so it is neither unlimited nor automatically refusable. Conclude by showing how the distinction supports this answer route: Argue accommodation as substantive equality with both limbs of the statutory definition stated..
...
```closure-flow
START / CONCEPT: Reasonable accommodation as an equality duty
EXACT TERMS: Reasonable | accommodation | equality | duty | that | denial
MECHANISM / ARGUMENT: relate Reasonable accommodation and the fact that its denial is discrimination through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that argue accommodation as substantive equality with both limbs of the statutory definition stated.
UPSC TRAP / ANSWER-USE: LIMIT: The duty carries a burden limb, so it is neither unlimited nor automatically refusable.
ANSWER-GRABBING FORMULATION: Reasonable accommodation as an equality duty converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: Three models and two design strategies
EXACT TERMS: Three | models | design | strategies | medical | rights
MECHANISM / ARGUMENT: relate The medical, social and rights models and Universal design against retrofitting through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that say which model a recommendation operates in before proposing it.
UPSC TRAP / ANSWER-USE: LIMIT: Universal design does not remove the need for individual accommodation.
ANSWER-GRABBING FORMULATION: Three models and two design strategies converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: The portable identity platform and its boundary
EXACT TERMS: portable | identity | platform | what | does | owners
MECHANISM / ARGUMENT: relate The portable identity platform and what it does not do through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that present an administrative reform for the friction it removes rather than the access it does not create.
UPSC TRAP / ANSWER-USE: LIMIT: Identification reform lowers a transaction cost without creating an entitlement.
ANSWER-GRABBING FORMULATION: The portable identity platform and its boundary converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: The accessibility framework and its present vehicle
EXACT TERMS: accessibility | present | vehicle | implementation | owners | record
MECHANISM / ARGUMENT: relate The accessibility framework and its present implementation vehicle through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that cite an accessibility claim with its implementation vehicle and its reporting date.
UPSC TRAP / ANSWER-USE: LIMIT: The earlier campaign label is not proof of a separate current programme after March 2024.
ANSWER-GRABBING FORMULATION: The accessibility framework and its present vehicle converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: Devices, delivery mode and the narrower trust statute
EXACT TERMS: Devices | delivery | mode | narrower | trust | statute
MECHANISM / ARGUMENT: relate The assistive-device scheme and its delivery modes and The 1999 trust statute and its four-condition scope through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that locate a reach failure in the delivery mode rather than in the size of the budget.
UPSC TRAP / ANSWER-USE: LIMIT: The 1999 statute covers four conditions only and is not a care system for all twenty-one categories.
ANSWER-GRABBING FORMULATION: Devices, delivery mode and the narrower trust statute converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: Grievance, accessibility and credit institutions kept apart
EXACT TERMS: Grievance | accessibility | credit | institutions | kept | apart
MECHANISM / ARGUMENT: relate The grievance and monitoring authorities under the 2016 Act through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that name each institution's function without merging regulator, mission and lender.
UPSC TRAP / ANSWER-USE: LIMIT: The routed objective demand turns on exactly this three-way institutional distinction.
ANSWER-GRABBING FORMULATION: Grievance, accessibility and credit institutions kept apart converts a dated official entitlement or indicator into a qualified capability argument
```
...
**Technical definition:** In social-justice analysis, The two recorded decisions on accommodation and dignity denotes the source-bounded relation among The two recorded cases on accommodation and dignity, described by the entitlement or claim that is asserted, the legal, statutory or purely administrative form that carries it, the delivery mechanism that is supposed to convert it into access, the measured outcome by which the conversion is tested, and the remedy or recommendation that follows when the conversion fails.
...
```closure-flow
START / CONCEPT: The two recorded decisions on accommodation and dignity
EXACT TERMS: recorded | decisions | accommodation | dignity | cases | owners
MECHANISM / ARGUMENT: relate The two recorded cases on accommodation and dignity through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that convert a statutory duty into an enforceable equality claim using named judicial evidence.
UPSC TRAP / ANSWER-USE: LIMIT: Neither holding may be extended beyond what the owners record.
ANSWER-GRABBING FORMULATION: The two recorded decisions on accommodation and dignity converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: The verified departmental statement on prevalence and categories
EXACT TERMS: departmental | statement | prevalence | categories | department's | dated
MECHANISM / ARGUMENT: relate The department's own dated prevalence statement through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that cite an official statement for exactly what it says and no further.
UPSC TRAP / ANSWER-USE: LIMIT: The verified page records the aim, the dated prevalence statement and the number of statutory types and nothing more.
ANSWER-GRABBING FORMULATION: The verified departmental statement on prevalence and categories converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: What a prevalence figure can and cannot prove
EXACT TERMS: What | prevalence | figure | prove | entitlement-to-participation | actually
MECHANISM / ARGUMENT: relate What a prevalence figure can and cannot prove and Where the entitlement-to-participation gap actually opens through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that use official data with its source, its year and its recorded limitation attached.
UPSC TRAP / ANSWER-USE: LIMIT: A self-reported 2011 share is not a current denominator and not proof of entitlement adequacy.
ANSWER-GRABBING FORMULATION: What a prevalence figure can and cannot prove converts a dated official entitlement or indicator into a qualified capability argument
```
...
```closure-flow
START / CONCEPT: Coverage against participation and the ownership statement
EXACT TERMS: Coverage | participation | ownership | statement | substantive | previous-year
MECHANISM / ARGUMENT: relate Coverage against substantive participation and The verified previous-year ownership stated precisely through claim, carrying instrument, delivery and measured outcome
CONSEQUENCE / CONTRAST: This relation supports the answer route that close with a participation verdict and an explicit ownership and answer-key boundary.
UPSC TRAP / ANSWER-USE: LIMIT: An output can be complete while the journey it was meant to enable remains impossible.
ANSWER-GRABBING FORMULATION: Coverage against participation and the ownership statement converts a dated official entitlement or indicator into a qualified capability argument
```
...
1. **Claim and named evidence:** The Department of Empowerment of Persons with Disabilities landing page, read on 2 September 2026, records that the department in the Ministry of Social Justice and Empowerment aims to facilitate the empowerment of persons with disabilities; that as per Census 2011 the number of persons with disabilities in the country is 2.68 crore, which is 2.21 per cent of the total population of the country; and that as per the Rights of Persons with Disabilities Act, 2016 there are twenty-one types of disabilities which include locomotor disability, visual impairment, hearing impairment, speech and language disability, intellectual disability, multiple disabilities, cerebral palsy and dwarfism among others; nothing beyond those recorded statements is claimed, and no certification, registration, reservation-fill, accessibility-compliance or device-distribution count is asserted. **Analysis:** Connect right or deprivation → institutional duty and eligibility rule → frontline implementation → differentiated access and outcome → grievance, audit or course correction. **Qualification:** State internal group and regional variation, legal/operative status, denominator, fiscal or causal limit, accessibility, dignity, privacy, portability or residual exclusion.
