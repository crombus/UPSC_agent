---
title: "Union Budget, Fiscal Policy and Deficit Indicators — Learner-v2 Refreshed"
topic_key: economy-09
cover_image: assets/economy-09_Teaching-Navigation_2026-09-03.png
---
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Economy\basic\09_Union-Budget-Fiscal-Policy-and-Deficit-Indicators.md`  
**Substantive canonical provenance owner:** `upsc-ai-kit\knowledge\Economy\09_Union-Budget-Fiscal-Policy-and-Deficit-Indicators_Learner-V2-Complete-Topic-Package.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Economy\advanced\09_Union-Budget-Fiscal-Policy-and-Deficit-Indicators.md`  
...
![Refreshed teaching navigation](assets/economy-09_Teaching-Navigation_2026-09-03.png)
...
**Plain-language definition:** Annual Financial Statement and revenue receipts explains how Annual Financial Statement and Revenue receipts fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Annual Financial Statement and revenue receipts separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Annual Financial Statement and revenue receipts must be read through Annual Financial Statement and Revenue receipts, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Annual, Financial, Statement; attach revenue to its named source, period and status; then qualify the answer with this limit: Do not classify all capital receipts as resources without future fiscal cost.
...
```closure-flow
START / CONCEPT: Annual Financial Statement and revenue receipts
EXACT TERMS: Annual | Financial | Statement | revenue | receipts | Article
MECHANISM / ARGUMENT: connect Annual Financial Statement and Revenue receipts through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: State every deficit formula, period, government perimeter and estimate vintage before inference.
UPSC TRAP / ANSWER-USE: Do not classify all capital receipts as resources without future fiscal cost.
ANSWER-GRABBING FORMULATION: Annual Financial Statement and revenue receipts converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Capital receipts and non-debt receipts explains how Capital receipts fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Capital receipts and non-debt receipts separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Capital receipts and non-debt receipts must be read through Capital receipts, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Capital, receipts, non-debt; attach create to its named source, period and status; then qualify the answer with this limit: Do not equate zero revenue deficit with zero fiscal deficit.
...
```closure-flow
START / CONCEPT: Capital receipts and non-debt receipts
EXACT TERMS: Capital | receipts | non-debt | create | liabilities | reduce
MECHANISM / ARGUMENT: connect Capital receipts through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Judge borrowing by expenditure composition, multiplier, financing conditions and debt feedback.
UPSC TRAP / ANSWER-USE: Do not equate zero revenue deficit with zero fiscal deficit.
ANSWER-GRABBING FORMULATION: Capital receipts and non-debt receipts converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Revenue and capital expenditure explains how Revenue and capital expenditure fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Revenue and capital expenditure separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Revenue and capital expenditure must be read through Revenue and capital expenditure, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Revenue, capital, expenditure; attach generally to its named source, period and status; then qualify the answer with this limit: Do not call fiscal deficit the stock of total public debt.
...
```closure-flow
START / CONCEPT: Revenue and capital expenditure
EXACT TERMS: Revenue | capital | expenditure | generally | supports | services
MECHANISM / ARGUMENT: connect Revenue and capital expenditure through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Combine fiscal rules with transparent escape clauses, contingent-liability disclosure and outcome scrutiny.
UPSC TRAP / ANSWER-USE: Do not call fiscal deficit the stock of total public debt.
ANSWER-GRABBING FORMULATION: Revenue and capital expenditure converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Revenue-deficit identity explains how Revenue deficit fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Revenue-deficit identity separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Revenue-deficit identity must be read through Revenue deficit, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Revenue-deficit, identity, Revenue; attach deficit to its named source, period and status; then qualify the answer with this limit: Do not subtract borrowings as non-debt receipts in the fiscal-deficit identity.
...
```closure-flow
START / CONCEPT: Revenue-deficit identity
EXACT TERMS: Revenue-deficit | identity | Revenue | deficit | equals | expenditure
MECHANISM / ARGUMENT: connect Revenue deficit through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: State every deficit formula, period, government perimeter and estimate vintage before inference.
UPSC TRAP / ANSWER-USE: Do not subtract borrowings as non-debt receipts in the fiscal-deficit identity.
ANSWER-GRABBING FORMULATION: Revenue-deficit identity converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Fiscal-deficit identity explains how Fiscal deficit fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Fiscal-deficit identity separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Fiscal-deficit identity must be read through Fiscal deficit, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Fiscal-deficit, identity, Fiscal; attach deficit to its named source, period and status; then qualify the answer with this limit: Do not merge primary deficit with fiscal deficit or interest payments.
...
```closure-flow
START / CONCEPT: Fiscal-deficit identity
EXACT TERMS: Fiscal-deficit | identity | Fiscal | deficit | equals | total
MECHANISM / ARGUMENT: connect Fiscal deficit through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Judge borrowing by expenditure composition, multiplier, financing conditions and debt feedback.
UPSC TRAP / ANSWER-USE: Do not merge primary deficit with fiscal deficit or interest payments.
ANSWER-GRABBING FORMULATION: Fiscal-deficit identity converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Primary deficit and effective revenue deficit explains how Primary deficit and Effective revenue deficit fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Primary deficit and effective revenue deficit separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Primary deficit and effective revenue deficit must be read through Primary deficit and Effective revenue deficit, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Primary, deficit, effective; attach revenue to its named source, period and status; then qualify the answer with this limit: Do not treat effective revenue deficit as proof of completed asset creation.
...
```closure-flow
START / CONCEPT: Primary deficit and effective revenue deficit
EXACT TERMS: Primary | deficit | effective | revenue | equals | fiscal
MECHANISM / ARGUMENT: connect Primary deficit and Effective revenue deficit through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Combine fiscal rules with transparent escape clauses, contingent-liability disclosure and outcome scrutiny.
UPSC TRAP / ANSWER-USE: Do not treat effective revenue deficit as proof of completed asset creation.
ANSWER-GRABBING FORMULATION: Primary deficit and effective revenue deficit converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Effective capital expenditure explains how Effective capital expenditure fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Effective capital expenditure separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Effective capital expenditure must be read through Effective capital expenditure, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Effective, capital, expenditure; attach adds to its named source, period and status; then qualify the answer with this limit: Do not equate Budget Estimates, Revised Estimates and Actuals.
...
```closure-flow
START / CONCEPT: Effective capital expenditure
EXACT TERMS: Effective | capital | expenditure | adds | grants | capital-asset
MECHANISM / ARGUMENT: connect Effective capital expenditure through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: State every deficit formula, period, government perimeter and estimate vintage before inference.
UPSC TRAP / ANSWER-USE: Do not equate Budget Estimates, Revised Estimates and Actuals.
ANSWER-GRABBING FORMULATION: Effective capital expenditure converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Budget Estimates, Revised Estimates and Actuals explains how BE, RE and Actuals fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Budget Estimates, Revised Estimates and Actuals separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Budget Estimates, Revised Estimates and Actuals must be read through BE, RE and Actuals, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Budget, Estimates, Revised; attach Actuals to its named source, period and status; then qualify the answer with this limit: Do not infer the whole general-government risk from the Union headline alone.
...
```closure-flow
START / CONCEPT: Budget Estimates, Revised Estimates and Actuals
EXACT TERMS: Budget | Estimates | Revised | Actuals | authorisations | projections
MECHANISM / ARGUMENT: connect BE, RE and Actuals through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Judge borrowing by expenditure composition, multiplier, financing conditions and debt feedback.
UPSC TRAP / ANSWER-USE: Do not infer the whole general-government risk from the Union headline alone.
ANSWER-GRABBING FORMULATION: Budget Estimates, Revised Estimates and Actuals converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** FRBM framework explains how FRBM framework fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, FRBM framework separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> FRBM framework must be read through FRBM framework, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define FRBM, framework, annual; attach fiscal to its named source, period and status; then qualify the answer with this limit: Do not assume every public capex programme automatically crowds in investment.
...
```closure-flow
START / CONCEPT: FRBM framework
EXACT TERMS: FRBM | framework | annual | fiscal | statements | impose
MECHANISM / ARGUMENT: connect FRBM framework through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Combine fiscal rules with transparent escape clauses, contingent-liability disclosure and outcome scrutiny.
UPSC TRAP / ANSWER-USE: Do not assume every public capex programme automatically crowds in investment.
ANSWER-GRABBING FORMULATION: FRBM framework converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Macro Economic Framework Statement explains how Macro Economic Framework Statement fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Macro Economic Framework Statement separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Macro Economic Framework Statement must be read through Macro Economic Framework Statement, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Macro, Framework, Statement; attach supplies to its named source, period and status; then qualify the answer with this limit: Do not quote Budget 2026-27 figures without the BE or RE vintage.
...
```closure-flow
START / CONCEPT: Macro Economic Framework Statement
EXACT TERMS: Macro | Framework | Statement | supplies | growth | inflation
MECHANISM / ARGUMENT: connect Macro Economic Framework Statement through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: State every deficit formula, period, government perimeter and estimate vintage before inference.
UPSC TRAP / ANSWER-USE: Do not quote Budget 2026-27 figures without the BE or RE vintage.
ANSWER-GRABBING FORMULATION: Macro Economic Framework Statement converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Debt anchor, deficit flow and debt stock explains how Debt anchor and glide path and Deficit and debt coverage fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Debt anchor, deficit flow and debt stock separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Debt anchor, deficit flow and debt stock must be read through Debt anchor and glide path and Deficit and debt coverage, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Debt, anchor, deficit; attach flow to its named source, period and status; then qualify the answer with this limit: Do not classify all capital receipts as resources without future fiscal cost.
...
```closure-flow
START / CONCEPT: Debt anchor, deficit flow and debt stock
EXACT TERMS: Debt | anchor | deficit | flow | stock | glide
MECHANISM / ARGUMENT: connect Debt anchor and glide path and Deficit and debt coverage through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Judge borrowing by expenditure composition, multiplier, financing conditions and debt feedback.
UPSC TRAP / ANSWER-USE: Do not classify all capital receipts as resources without future fiscal cost.
ANSWER-GRABBING FORMULATION: Debt anchor, deficit flow and debt stock converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Crowding-out channel explains how Crowding-out channel fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Crowding-out channel separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Crowding-out channel must be read through Crowding-out channel, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Crowding-out, channel, Government; attach borrowing to its named source, period and status; then qualify the answer with this limit: Do not equate zero revenue deficit with zero fiscal deficit.
...
```closure-flow
START / CONCEPT: Crowding-out channel
EXACT TERMS: Crowding-out | channel | Government | borrowing | raise | interest
MECHANISM / ARGUMENT: connect Crowding-out channel through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Combine fiscal rules with transparent escape clauses, contingent-liability disclosure and outcome scrutiny.
UPSC TRAP / ANSWER-USE: Do not equate zero revenue deficit with zero fiscal deficit.
ANSWER-GRABBING FORMULATION: Crowding-out channel converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Crowding in through public capex explains how Crowding-in through capex fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Crowding in through public capex separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Crowding in through public capex must be read through Crowding-in through capex, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Crowding, through, public; attach capex to its named source, period and status; then qualify the answer with this limit: Do not call fiscal deficit the stock of total public debt.
...
```closure-flow
START / CONCEPT: Crowding in through public capex
EXACT TERMS: Crowding | through | public | capex | Crowding-in | capital
MECHANISM / ARGUMENT: connect Crowding-in through capex through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: State every deficit formula, period, government perimeter and estimate vintage before inference.
UPSC TRAP / ANSWER-USE: Do not call fiscal deficit the stock of total public debt.
ANSWER-GRABBING FORMULATION: Crowding in through public capex converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Off-budget risk and Fiscal Health Index explains how Off-budget and contingent risk and Fiscal Health Index fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Off-budget risk and Fiscal Health Index separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Off-budget risk and Fiscal Health Index must be read through Off-budget and contingent risk and Fiscal Health Index, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Off-budget, risk, Fiscal; attach Health to its named source, period and status; then qualify the answer with this limit: Do not subtract borrowings as non-debt receipts in the fiscal-deficit identity.
...
```closure-flow
START / CONCEPT: Off-budget risk and Fiscal Health Index
EXACT TERMS: Off-budget | risk | Fiscal | Health | Index | contingent
MECHANISM / ARGUMENT: connect Off-budget and contingent risk and Fiscal Health Index through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Judge borrowing by expenditure composition, multiplier, financing conditions and debt feedback.
UPSC TRAP / ANSWER-USE: Do not subtract borrowings as non-debt receipts in the fiscal-deficit identity.
ANSWER-GRABBING FORMULATION: Off-budget risk and Fiscal Health Index converts a precise economic distinction into a qualified conclusion
```
...
**Plain-language definition:** Black money, household savings and Budget vintage explains how Black money and household savings and Union Budget 2026-27 vintage fit into one examinable economic mechanism.

**Technical definition:** In Economy analysis, Black money, household savings and Budget vintage separates the concept and accounting boundary from its unit, coverage, price basis, base year or basket, estimate vintage, institutional or legal source, crop and geography scope, eligibility, implementation stage, stock-flow boundary, transmission channel and distributional or stability consequence.

#### ANSWER-GRABBING OPENING — WRITE/ADAPT IN THE EXAM

> Black money, household savings and Budget vintage must be read through Black money and household savings and Union Budget 2026-27 vintage, with the formula or legal perimeter stated before the policy inference.
...
**How to use them:** Define Black, money, household; attach savings to its named source, period and status; then qualify the answer with this limit: Do not merge primary deficit with fiscal deficit or interest payments.
...
```closure-flow
START / CONCEPT: Black money, household savings and Budget vintage
EXACT TERMS: Black | money | household | savings | Budget | vintage
MECHANISM / ARGUMENT: connect Black money and household savings and Union Budget 2026-27 vintage through accounting, incentives and transmission
CONSEQUENCE / CONTRAST: Combine fiscal rules with transparent escape clauses, contingent-liability disclosure and outcome scrutiny.
UPSC TRAP / ANSWER-USE: Do not merge primary deficit with fiscal deficit or interest payments.
ANSWER-GRABBING FORMULATION: Black money, household savings and Budget vintage converts a precise economic distinction into a qualified conclusion
```
...
- **Official syllabus/index and owned core:** The Union Budget records receipts and expenditure under revenue/capital classifications; revenue, fiscal and primary deficits answer different financing questions and must be read with off-budget and contingent-liability risks.
- **Indispensable distinction and prerequisite taxonomy:** Allocation is not release or expenditure, capital receipt is not necessarily asset creation, fiscal deficit is not public debt, primary deficit excludes current interest, and accounting identity is not a growth guarantee.
- **Mechanism, implementation and evidence control:** Use one Budget year and document stage—BE, RE, Actual—consistently; show formula, units and GDP denominator, distinguish Union from general government, and trace multiplier, crowding, inflation, debt dynamics and federal incidence with lags.
- **✅ Verified current fact (official sources rechecked 5 September 2026):**
  Rechecked 6 September 2026 against the listed official publisher or regulator source. Both live India Budget attempts were blocked with HTTP 403. The package therefore preserves the repository owner's figures only with their exact Union Budget 2026-27 BE and 2025-26 RE labels and does not upgrade them to Actuals. Sources: https://www.indiabudget.gov.in/doc/frbm1.pdf; https://www.indiabudget.gov.in/
...
- **Verified PYQ ownership, 2018-2026:** Audited ledgers route Mains demands on public expenditure management, Capital versus Revenue Budget and the Fiscal Health Index, plus objective demands on Article 112, capital receipts, deficit computation, recession policy, opportunity cost, household savings and crowding out. Objective answer letters are not inferred.

### ECONOMY DEEP-REVIEW CORE CONTROL

- **Must remember:** The Union Budget records receipts and expenditure under revenue/capital classifications; revenue, fiscal and primary deficits answer different financing questions and must be read with off-budget and contingent-liability risks.
- **Close distinction:** Allocation is not release or expenditure, capital receipt is not necessarily asset creation, fiscal deficit is not public debt, primary deficit excludes current interest, and accounting identity is not a growth guarantee.
- **Formula / status / evidence / causal limit:** Use one Budget year and document stage—BE, RE, Actual—consistently; show formula, units and GDP denominator, distinguish Union from general government, and trace multiplier, crowding, inflation, debt dynamics and federal incidence with lags.
...
**Qualified conclusion:** **Revenue and capital expenditure:** Revenue expenditure generally supports current services and transfers, whereas capital expenditure creates assets or reduces liabilities; classification is accounting-based rather than a moral label. **BE, RE and Actuals:** Budget Estimates are policy authorisations or projections, Revised Estimates update the year's expected outcome, and Actuals record realised accounts; the three vintages are not interchangeable. **Off-budget and contingent risk:** Guarantees, extra-budgetary borrowing and delayed payments can understate genuine public-sector risk in the headline fiscal deficit; several historical items have since been moved on-budget. **Fiscal Health Index:** NITI Aayog's Fiscal Health Index compares state fiscal performance across dimensions including revenue mobilisation, expenditure quality, prudence and debt sustainability rather than one ratio alone. The answer therefore separates definition, mechanism, evidence and limitation, and does not infer an official model answer or objective key.
...
**Introduction and thesis:** **Revenue receipts:** Revenue receipts neither create a liability nor reduce a financial asset and include tax and non-tax revenue within the stated budget perimeter. **Capital receipts:** Capital receipts create liabilities or reduce financial assets; borrowings create liabilities, while recovery of loans and disinvestment are non-debt capital receipts. **Revenue and capital expenditure:** Revenue expenditure generally supports current services and transfers, whereas capital expenditure creates assets or reduces liabilities; classification is accounting-based rather than a moral label. **Effective capital expenditure:** Effective capital expenditure adds grants for capital-asset creation to the Centre's own capital expenditure. The answer therefore separates definition, mechanism, evidence and limitation, and does not infer an official model answer or objective key.

**Analytical body:**

1. **Claim and named evidence:** Demand: Distinguish the Capital Budget and Revenue Budget and explain their components. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** Status: Verified routed Mains demand; original model solution, not an official answer. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.

**Counter-position / limit:** An accounting identity, index movement, allocation, rate change, notification, platform count, WTO notification or chronological association cannot alone establish transmission, utilisation, distributional benefit or attributable outcome; test mechanism, lag, counterfactual, data vintage, implementation and external/federal constraints.

**Qualified conclusion:** **Revenue receipts:** Revenue receipts neither create a liability nor reduce a financial asset and include tax and non-tax revenue within the stated budget perimeter. **Capital receipts:** Capital receipts create liabilities or reduce financial assets; borrowings create liabilities, while recovery of loans and disinvestment are non-debt capital receipts. **Revenue and capital expenditure:** Revenue expenditure generally supports current services and transfers, whereas capital expenditure creates assets or reduces liabilities; classification is accounting-based rather than a moral label. **Effective capital expenditure:** Effective capital expenditure adds grants for capital-asset creation to the Centre's own capital expenditure. The answer therefore separates definition, mechanism, evidence and limitation, and does not infer an official model answer or objective key.
...
**Introduction and thesis:** **Deficit and debt coverage:** A fiscal deficit is a flow for a specified government and period, while debt is a stock; the Union Budget does not by itself capture states, local bodies and every public-sector liability. **Fiscal Health Index:** NITI Aayog's Fiscal Health Index compares state fiscal performance across dimensions including revenue mobilisation, expenditure quality, prudence and debt sustainability rather than one ratio alone. **Black money and household savings:** Undisclosed income narrows the declared tax base, while household financial savings influence how much public borrowing can be absorbed domestically without intensifying financing pressure. The answer therefore separates definition, mechanism, evidence and limitation, and does not infer an official model answer or objective key.

**Analytical body:**

1. **Claim and named evidence:** Demand: Explain the Fiscal Health Index as a tool for assessing state fiscal performance. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** Status: Verified routed Mains demand; original model solution, not an official answer. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.

**Counter-position / limit:** An accounting identity, index movement, allocation, rate change, notification, platform count, WTO notification or chronological association cannot alone establish transmission, utilisation, distributional benefit or attributable outcome; test mechanism, lag, counterfactual, data vintage, implementation and external/federal constraints.

**Qualified conclusion:** **Deficit and debt coverage:** A fiscal deficit is a flow for a specified government and period, while debt is a stock; the Union Budget does not by itself capture states, local bodies and every public-sector liability. **Fiscal Health Index:** NITI Aayog's Fiscal Health Index compares state fiscal performance across dimensions including revenue mobilisation, expenditure quality, prudence and debt sustainability rather than one ratio alone. **Black money and household savings:** Undisclosed income narrows the declared tax base, while household financial savings influence how much public borrowing can be absorbed domestically without intensifying financing pressure. The answer therefore separates definition, mechanism, evidence and limitation, and does not infer an official model answer or objective key.
...
**Demand decoding:** The directive **answer** requires a direct position on “Distinguish revenue receipts, capital receipts and borrowings. Answer in about 150 words.”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** **Claim:** Revenue receipts. **Named evidence/example:** Revenue receipts neither create a liability nor reduce a financial asset and include tax and non-tax revenue within the stated budget perimeter. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Capital receipts. **Named evidence/example:** Capital receipts create liabilities or reduce financial assets; borrowings create liabilities, while recovery of loans and disinvestment are non-debt capital receipts. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source.

**Analytical body:**

1. **Claim and named evidence:** Revenue receipts neither create a liability nor reduce a financial asset and include tax and non-tax revenue within the stated budget perimeter. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** Capital receipts create liabilities or reduce financial assets; borrowings create liabilities, while recovery of loans and disinvestment are non-debt capital receipts. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**How to improve this answer:** For “Distinguish revenue receipts, capital receipts and borrowings. Answer in about 150 words.”, replace the weakest catalogue point with one exact formula or classification, named institution/instrument, balance-sheet or incentive channel, lag, measurable outcome, distribution/federal effect and qualification.
...
**Demand decoding:** The directive **answer** requires a direct position on “Calculate and interpret revenue, fiscal and primary deficits. Answer in about 150 words.”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** **Claim:** Revenue deficit. **Named evidence/example:** Revenue deficit equals revenue expenditure minus revenue receipts. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Fiscal deficit. **Named evidence/example:** Fiscal deficit equals total expenditure minus non-debt receipts and broadly indicates the period's borrowing requirement rather than the stock of public debt. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Primary deficit. **Named evidence/example:** Primary deficit equals fiscal deficit minus interest payments and isolates the current fiscal gap after removing the burden of past-debt interest. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source.

**Analytical body:**

1. **Claim and named evidence:** Revenue deficit equals revenue expenditure minus revenue receipts. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** Fiscal deficit equals total expenditure minus non-debt receipts and broadly indicates the period's borrowing requirement rather than the stock of public debt. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
3. **Claim and named evidence:** Primary deficit equals fiscal deficit minus interest payments and isolates the current fiscal gap after removing the burden of past-debt interest. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**How to improve this answer:** For “Calculate and interpret revenue, fiscal and primary deficits. Answer in about 150 words.”, replace the weakest catalogue point with one exact formula or classification, named institution/instrument, balance-sheet or incentive channel, lag, measurable outcome, distribution/federal effect and qualification.
...
**Demand decoding:** The directive **explain** requires a direct position on “Explain effective revenue deficit and effective capital expenditure. Answer in about 250…”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** **Claim:** Effective revenue deficit. **Named evidence/example:** Effective revenue deficit equals revenue deficit minus grants-in-aid to states or Union Territories for creation of capital assets; it reclassifies the transfer but does not prove the asset was well used. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Effective capital expenditure. **Named evidence/example:** Effective capital expenditure adds grants for capital-asset creation to the Centre's own capital expenditure. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source.

**Analytical body:**

1. **Claim and named evidence:** Effective revenue deficit equals revenue deficit minus grants-in-aid to states or Union Territories for creation of capital assets; it reclassifies the transfer but does not prove the asset was well used. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** Effective capital expenditure adds grants for capital-asset creation to the Centre's own capital expenditure. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**How to improve this answer:** For “Explain effective revenue deficit and effective capital expenditure. Answer in about 250…”, replace the weakest catalogue point with one exact formula or classification, named institution/instrument, balance-sheet or incentive channel, lag, measurable outcome, distribution/federal effect and qualification.
...
**Demand decoding:** The directive **answer** requires a direct position on “Why must Budget Estimates, Revised Estimates and Actuals be separated? Answer in about 250…”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** **Claim:** BE, RE and Actuals. **Named evidence/example:** Budget Estimates are policy authorisations or projections, Revised Estimates update the year's expected outcome, and Actuals record realised accounts; the three vintages are not interchangeable. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Macro Economic Framework Statement. **Named evidence/example:** The Macro Economic Framework Statement supplies the growth, inflation and macro assumptions needed to interpret Budget numbers. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Union Budget 2026-27 vintage. **Named evidence/example:** The owner records Union Budget 2026-27 Budget Estimates of a 4.3 per cent fiscal deficit-to-GDP ratio and 12.22 lakh crore rupees of capital expenditure, alongside a 4.4 per cent fiscal-deficit ratio for 2025-26 Revised Estimates; these are dated BE or RE figures, not Actuals. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source.

**Analytical body:**

1. **Claim and named evidence:** Budget Estimates are policy authorisations or projections, Revised Estimates update the year's expected outcome, and Actuals record realised accounts; the three vintages are not interchangeable. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** The Macro Economic Framework Statement supplies the growth, inflation and macro assumptions needed to interpret Budget numbers. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
3. **Claim and named evidence:** The owner records Union Budget 2026-27 Budget Estimates of a 4.3 per cent fiscal deficit-to-GDP ratio and 12.22 lakh crore rupees of capital expenditure, alongside a 4.4 per cent fiscal-deficit ratio for 2025-26 Revised Estimates; these are dated BE or RE figures, not Actuals. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**How to improve this answer:** For “Why must Budget Estimates, Revised Estimates and Actuals be separated? Answer in about 250…”, replace the weakest catalogue point with one exact formula or classification, named institution/instrument, balance-sheet or incentive channel, lag, measurable outcome, distribution/federal effect and qualification.
...
**Demand decoding:** The directive **evaluate** requires a direct position on “Evaluate rule-based fiscal consolidation with countercyclical flexibility. Answer in about…”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** **Claim:** FRBM framework. **Named evidence/example:** The FRBM Act, 2003 and its annual fiscal statements impose medium-term targets, macro disclosure and deviation reporting rather than a guarantee that every announced path will be met. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Debt anchor and glide path. **Named evidence/example:** The N.K. Singh-led FRBM Review Committee advanced a debt-anchor and operational glide-path logic; its recommendations are advisory and not self-executing. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Crowding-out channel. **Named evidence/example:** Government borrowing may raise interest rates or absorb financial savings and crowd out private credit, but the effect depends on slack, liquidity, household savings and monetary conditions. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Crowding-in through capex. **Named evidence/example:** Public capital expenditure can crowd in private investment when it removes infrastructure bottlenecks and raises expected demand, subject to project selection and execution. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Off-budget and contingent risk. **Named evidence/example:** Guarantees, extra-budgetary borrowing and delayed payments can understate genuine public-sector risk in the headline fiscal deficit; several historical items have since been moved on-budget. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source.

**Analytical body:**

1. **Claim and named evidence:** The FRBM Act, 2003 and its annual fiscal statements impose medium-term targets, macro disclosure and deviation reporting rather than a guarantee that every announced path will be met. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** The N.K. Singh-led FRBM Review Committee advanced a debt-anchor and operational glide-path logic; its recommendations are advisory and not self-executing. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
3. **Claim and named evidence:** Government borrowing may raise interest rates or absorb financial savings and crowd out private credit, but the effect depends on slack, liquidity, household savings and monetary conditions. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
4. **Claim and named evidence:** Public capital expenditure can crowd in private investment when it removes infrastructure bottlenecks and raises expected demand, subject to project selection and execution. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
5. **Claim and named evidence:** Guarantees, extra-budgetary borrowing and delayed payments can understate genuine public-sector risk in the headline fiscal deficit; several historical items have since been moved on-budget. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**How to improve this answer:** For “Evaluate rule-based fiscal consolidation with countercyclical flexibility. Answer in about…”, replace the weakest catalogue point with one exact formula or classification, named institution/instrument, balance-sheet or incentive channel, lag, measurable outcome, distribution/federal effect and qualification.
...
**Demand decoding:** The directive **answer** requires a direct position on “Judge India's fiscal stance through composition, transparency and debt sustainability. Answer…”, every clause, exact formula/category, institution and policy status, a monetary-fiscal-real-external transmission chain with lags, named Indian evidence, distribution/federal effects, trade-offs and a qualified conclusion.

**Detailed examiner-grade model answer:**

**Introduction and thesis:** **Claim:** Revenue and capital expenditure. **Named evidence/example:** Revenue expenditure generally supports current services and transfers, whereas capital expenditure creates assets or reduces liabilities; classification is accounting-based rather than a moral label. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Deficit and debt coverage. **Named evidence/example:** A fiscal deficit is a flow for a specified government and period, while debt is a stock; the Union Budget does not by itself capture states, local bodies and every public-sector liability. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Crowding-in through capex. **Named evidence/example:** Public capital expenditure can crowd in private investment when it removes infrastructure bottlenecks and raises expected demand, subject to project selection and execution. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Off-budget and contingent risk. **Named evidence/example:** Guarantees, extra-budgetary borrowing and delayed payments can understate genuine public-sector risk in the headline fiscal deficit; several historical items have since been moved on-budget. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Fiscal Health Index. **Named evidence/example:** NITI Aayog's Fiscal Health Index compares state fiscal performance across dimensions including revenue mobilisation, expenditure quality, prudence and debt sustainability rather than one ratio alone. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source. **Claim:** Black money and household savings. **Named evidence/example:** Undisclosed income narrows the declared tax base, while household financial savings influence how much public borrowing can be absorbed domestically without intensifying financing pressure. **Analysis:** This identifies the economic mechanism, the relevant institution or accounting boundary, and the effect on output, prices, distribution or financial stability. **Qualification:** The conclusion must retain the stated period, estimate vintage, base year, basket, instrument eligibility or legal perimeter rather than generalise beyond the source.

**Analytical body:**

1. **Claim and named evidence:** Revenue expenditure generally supports current services and transfers, whereas capital expenditure creates assets or reduces liabilities; classification is accounting-based rather than a moral label. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
2. **Claim and named evidence:** A fiscal deficit is a flow for a specified government and period, while debt is a stock; the Union Budget does not by itself capture states, local bodies and every public-sector liability. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
3. **Claim and named evidence:** Public capital expenditure can crowd in private investment when it removes infrastructure bottlenecks and raises expected demand, subject to project selection and execution. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
4. **Claim and named evidence:** Guarantees, extra-budgetary borrowing and delayed payments can understate genuine public-sector risk in the headline fiscal deficit; several historical items have since been moved on-budget. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
5. **Claim and named evidence:** NITI Aayog's Fiscal Health Index compares state fiscal performance across dimensions including revenue mobilisation, expenditure quality, prudence and debt sustainability rather than one ratio alone. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
6. **Claim and named evidence:** Undisclosed income narrows the declared tax base, while household financial savings influence how much public borrowing can be absorbed domestically without intensifying financing pressure. **Analysis:** Connect the identity/category and named Indian evidence → instrument, price, quantity, balance-sheet or incentive channel → implementation and lag → growth, employment, distribution, stability, sustainability and federal effect. **Qualification:** State unit/denominator, stock/flow, nominal/real, authority and programme status, source-date-reference period, causal limit, counterfactual, trade-off or residual risk.
...
**How to improve this answer:** For “Judge India's fiscal stance through composition, transparency and debt sustainability. Answer…”, replace the weakest catalogue point with one exact formula or classification, named institution/instrument, balance-sheet or incentive channel, lag, measurable outcome, distribution/federal effect and qualification.
...
MUST REMEMBER: The Union Budget records receipts and expenditure under revenue/capital...
```
...
CLOSE DISTINCTION: Allocation is not release or expenditure, capital receipt is not...
```
...
EVIDENCE LIMIT: FORMULA / STATUS / CAUSATION: Use one Budget year and document stage—BE,...
```
