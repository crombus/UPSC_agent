---
title: "Drought, Heat Waves and Slow-Onset Risk — Learner-v2 Refreshed"
topic_key: disaster-management-09
cover_image: assets/disaster-management-09_Teaching-Navigation_2026-09-04.png
---
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Disaster-Management\basic\09_Drought-Heat-Waves-and-Slow-Onset-Risk.md`  
**Substantive canonical provenance owner:** `upsc-ai-kit\knowledge\Disaster-Management\learning-sessions\v2\subject-wide-syllabus\disaster-management-09_Learning-Session.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Disaster-Management\advanced\09_Drought-Heat-Waves-and-Slow-Onset-Risk.md`  
...
![Refreshed teaching navigation](assets/disaster-management-09_Teaching-Navigation_2026-09-04.png)
...
- **Must remember:** Drought and heat are slow-onset or compounding risks shaped by meteorological conditions, soil moisture, hydrology, crops, water demand, urban heat, health vulnerability and anticipatory action.
- **Close distinction:** Meteorological drought is not agricultural or hydrological drought; heat-wave criteria are not one universal temperature; forecast is not observed maximum; Heat Action Plan adoption is not implementation or mortality reduction.
- **Mechanism / status / evidence limit:** Preserve IMD threshold, station/region, anomaly, duration, date and unit; separate climate trend, event attribution, exposure, vulnerability and policy outcome.
...
**Introduction and thesis:** **Heat-wave hazard:** A heat wave is a meteorological hazard identified through IMD's station and departure or actual-temperature criteria; it is not synonymous with every hot day or every episode of heat illness. **Heat stress:** Heat stress is the physiological burden produced by temperature, humidity, radiation, wind, exertion, clothing, health and access to rest, water or cooling; exposure and vulnerability therefore mediate the hazard. **Wet-bulb boundary:** Wet-bulb temperature combines heat and humidity by representing evaporative-cooling potential; it is not an IMD heat-wave declaration threshold, and dangerous stress can occur below a theoretical upper-limit benchmark. **Exposure inequality:** Outdoor and informal workers, older persons, children, people with illness, poorly housed households and those lacking dependable water or cooling may face different risk under the same forecast temperature. The solution therefore answers the routed demand without inventing an official model answer or an objective answer key.
...
**Qualified conclusion:** **Heat-wave hazard:** A heat wave is a meteorological hazard identified through IMD's station and departure or actual-temperature criteria; it is not synonymous with every hot day or every episode of heat illness. **Heat stress:** Heat stress is the physiological burden produced by temperature, humidity, radiation, wind, exertion, clothing, health and access to rest, water or cooling; exposure and vulnerability therefore mediate the hazard. **Wet-bulb boundary:** Wet-bulb temperature combines heat and humidity by representing evaporative-cooling potential; it is not an IMD heat-wave declaration threshold, and dangerous stress can occur below a theoretical upper-limit benchmark. **Exposure inequality:** Outdoor and informal workers, older persons, children, people with illness, poorly housed households and those lacking dependable water or cooling may face different risk under the same forecast temperature. The solution therefore answers the routed demand without inventing an official model answer or an objective answer key.
...
**Demand decoding:** The directive **examine** requires a direct position on ‘Examine a Heat Action Plan through forecast, health, labour, water and urban-governance…’, each clause, risk mechanism, named Indian law/institution/event, dated status, implementation and qualification.
...
MUST REMEMBER: Drought and heat are slow-onset or compounding risks shaped by...
```
...
CLOSE DISTINCTION: Meteorological drought is not agricultural or hydrological drought;...
```
...
EVIDENCE LIMIT: MECHANISM / STATUS / CAUSATION: Preserve IMD threshold, station/region,...
```
