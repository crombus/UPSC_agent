---
title: "Cyclones, Storm Surge and Coastal Preparedness — Learner-v2 Refreshed"
topic_key: disaster-management-07
cover_image: assets/disaster-management-07_Teaching-Navigation_2026-09-04.png
---
...
**Canonical Basic/Core owner:** `upsc-ai-kit\knowledge\Disaster-Management\basic\07_Cyclones-Storm-Surge-and-Coastal-Preparedness.md`  
**Substantive canonical provenance owner:** `upsc-ai-kit\knowledge\Disaster-Management\learning-sessions\v2\subject-wide-syllabus\disaster-management-07_Learning-Session.md`  
**Optional Advanced owner:** `upsc-ai-kit\knowledge\Disaster-Management\advanced\07_Cyclones-Storm-Surge-and-Coastal-Preparedness.md`  
...
![Refreshed teaching navigation](assets/disaster-management-07_Teaching-Navigation_2026-09-04.png)
...
- **Must remember:** Cyclone disaster risk joins wind, storm surge, heavy rainfall, waves, river backflow, exposed coast, housing and livelihood vulnerability, forecast-based action, shelters, evacuation and resilient recovery.
- **Close distinction:** Cyclone category is not storm-surge height; forecast landfall is not observed landfall; warning is not evacuation; shelter capacity is not occupancy or safe access; preparedness input is not reduced mortality by itself.
- **Mechanism / status / evidence limit:** Use IMD terminology and timestamped bulletins precisely; source wind, rainfall, surge, casualty, evacuation and loss units and separate event fact from causal inference.
...
MUST REMEMBER: Cyclone disaster risk joins wind, storm surge, heavy rainfall, waves,...
```
...
CLOSE DISTINCTION: Cyclone category is not storm-surge height; forecast landfall is not...
```
...
EVIDENCE LIMIT: MECHANISM / STATUS / CAUSATION: Use IMD terminology and timestamped...
```
